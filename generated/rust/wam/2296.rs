pub const WAM_MD_BOOTSTRAP_HISTORY_DATA_DOWNLOADED: u32 = 2296;

#[derive(Debug, Default)]
pub struct MdBootstrapHistoryDataDownloadedEvent {
    ...
    pub md_hs_oldest_message_timestamp: Option<i64>,
    ...
    pub md_bootstrap_payload_thumbnails_size: Option<i64>,
}