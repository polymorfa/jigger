export enum SYSTEMMESSAGETYPETYPE {
  E2_E_ENCRYPTED_MESSAGES_CALLS = 1,
  E2_E_ENCRYPTED_MESSAGES = 2,
  E2_E_ENCRYPTED_BROADCAST_LIST = 3,
  E2_E_ENCRYPTED_MESSAGE_YOURSELF = 4,
