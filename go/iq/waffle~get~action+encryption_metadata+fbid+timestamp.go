// BuildWaffleEncryptedPayload builds <iq type="get" xmlns="waffle">. Replies with one of: Success, Error.
func BuildWaffleEncryptedPayload(smaxId int) waBinary.Node {
	return waBinary.Node{
		...
		Content: []waBinary.Node{
			...
			{Tag: "action", Attrs: waBinary.Attrs{}},
		},
	}
}