// BuildWaffleRefreshAccessTokens builds <iq type="get" xmlns="waffle">. Replies with one of: Success, Error.
func BuildWaffleRefreshAccessTokens(smaxId int) waBinary.Node {
