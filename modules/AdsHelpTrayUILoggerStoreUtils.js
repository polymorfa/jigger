__d("AdsHelpTrayUILoggerStoreUtils", [
	"ALToolTab",
	...
	function d(t, n, a, i) {
		var l, d = (e || (e = r("WebStorage"))).getSessionStorage(), m = window.sessionStorage && (l = window.sessionStorage.getItem(c)) != null ? l : "";
		m === "" && ((e || (e = r("WebStorage"))).setItemGuarded(d, c, r("BusinessUnifiedNavigationLoggingConfig").sessionID), m = r("BusinessUnifiedNavigationLoggingConfig").sessionID);
		var p = new (s || (s = (r("URI"))))(window.location.href).getQueryData(), _ = u != null ? u : p.act, f = o("ALToolTab").getCurrentToolTab();
