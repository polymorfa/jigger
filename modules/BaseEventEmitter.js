__d("BaseEventEmitter", [
	...
	var e, l = (function() {
		...
		return r.addListener = function(t, r, o) {
			...
			if (!this.$1) throw n("FBLogger")("emitter").mustfixThrow("Not in an emitting cycle; there is no current subscription");
			...
			if (e) {
				for (var n = Object.keys(e), r, o = 0; o < n.length; o++) {
					...
					if (i) {
						if (this.$1 = i, r == null) {
							r = [i, t];
							for (var l = 0, s = arguments.length <= 1 ? 0 : arguments.length - 1; l < s; l++) r[l + 2] = l + 1 < 1 || arguments.length <= l + 1 ? void 0 : arguments[l + 1];
						} else r[0] = i;
			...
			for (var t = arguments.length, a = new Array(t > 2 ? t - 2 : 0), i = 2; i < t; i++) a[i - 2] = arguments[i];
			(e || (e = n("ErrorGuard"))).applyWithGuard(r.listener, r.context, a, { name: "EventEmitter " + o + " event" });
		}, t;
	})();
	a.exports = l;
}), null);
