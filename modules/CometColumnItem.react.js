__d("CometColumnItem.react", [
	...
	var e = ["ref"], s = [
		...
		"placeholder",
		"verticalAlign"
	], u = ["fallback"], c = ["placeholder"], d, m, p = m || (m = o("react")), _ = m.useContext, f = {
		divider: {
	...
	function L(t) {
		var n, a, l, m, E = t.ref, k = babelHelpers.objectWithoutPropertiesLoose(t, e), I = (n = _(r("CometColumnContext"))) != null ? n : {}, T = k.align, D = T === void 0 ? (a = I.align) != null ? a : "stretch" : T, x = k.children, $ = k.expanding, P = $ === void 0 ? !1 : $, N = k.fallback, M = k.paddingHorizontal, w = M === void 0 ? (l = I.paddingHorizontal) != null ? l : 0 : M, A = k.paddingTop, F = k.paddingVertical, O = F === void 0 ? 0 : F, B = k.placeholder, W = k.verticalAlign, q = W === void 0 ? "top" : W, U = babelHelpers.objectWithoutPropertiesLoose(k, s), V = (d || (d = r("stylex"))).compose(k.xstyle), H = p.jsxs(p.Fragment, { children: [I.hasDividers === !0 && p.jsx(r("BaseView.react"), {
			...
			xstyle: [
				...
				I.spacing != null && [
					v[I.spacing],
					o("XPlatReactEnvironment").isWeb() && V.marginBottom == null && g.marginLastChild,
					o("XPlatReactEnvironment").isWeb() && V.marginTop == null && g.marginFirstChild
				],
				k.xstyle
			],
		...
		if (N !== void 0) {
			var G = k.fallback, z = babelHelpers.objectWithoutPropertiesLoose(k, u);
			N === null ? H = p.jsx(r("CometErrorBoundary.react"), { children: H }) : H = p.jsx(r("CometErrorBoundary.react"), {
				fallback: function(t, n) {
					return p.jsx(L, babelHelpers.extends({}, z, {
						ref: E,
		...
		if (B !== void 0) {
			var j = k.placeholder, K = babelHelpers.objectWithoutPropertiesLoose(k, c);
			H = p.jsx(r("CometPlaceholder.react"), {
				fallback: B != null ? p.jsx(L, babelHelpers.extends({}, K, {
					ref: E,
					children: B
				})) : null,
				name: i.id,
