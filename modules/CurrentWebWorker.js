__d("CurrentWebWorker", [
	...
	function d(t) {
		...
		switch (r.type) {
			...
			case "port":
				...
				break;
			case "ping":
				r.args.push(Date.now()), r.args.unshift("pong"), m.apply(null, r.args);
				break;
			case "defineModules":
				var a = r.args[0];
	...
	!t.onmessage || l(0, 2399), t.console || (t.console = {}, [
		"log",
		"error",
		"info",
		"debug",
	...
	var p = a.exports = {
		...
		setChannelHandler: function(t) {
			var e = t || n("emptyFunction"), r = u === null;
			return u = e, r && (c.forEach(function(e) {
				return e();
			}), c = []), p;
		},
		setMessageHandler: function(r) {
			var t = r || n("emptyFunction"), o = e === null;
			return e = t, o && (s.forEach(function(e) {
				return e();
			}), s = []), p;
		},
		terminate: function() {
