__d("EBDB", [
	...
	}, d = 1e4, m = [16, 32], p = new (o("WAResolvable")).Resolvable();
	function _(e, t, n, r, o) {
		return f.apply(this, arguments);
	}
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, a, i, l) {
			var s, u = (s = a == null ? void 0 : a.byteLength) != null ? s : 0, _ = o("QPLFlow").startQPLFlow(n, {
				annotations: {
					int: { env: i },
			...
			if (a == null || !m.includes(u)) {
				var f = "EBDB initialization failed: Invalid encryption key. Expected 16 or 32 bytes (128 or 256 bits), got " + u + " bytes.";
				r("FBLogger")("messenger_web").mustfix(f);
			}
			try {
				var g = "ebdb", y = new (o("WormEAR")).WormEAR(c, g, a), b = new (o("Worm")).WormDatabase(new (o("WormIDbDriver")).WormIDbDriver(t, g, c, y, l, {
				...
				throw _.endFail("error"), o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Error performing makeEBDB: ", ""])), t), p.reject(t), t;
			}
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield g();
			return e.runInTransaction(["device_state"], "readwrite", function(e) {
	...
	l.EBDBEnvironment = u, l.schema = c, l.makeEBDB = _, l.getEBDB = g, l.clearDeviceState = h, l.clearEbStores = C, l.clearAll = v;
}), 98);
