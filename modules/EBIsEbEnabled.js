__d("EBIsEbEnabled", [
	...
	var e, s;
	function u(t, n) {
		return o("MAWEncryptedBackupUtils").getBackupTenancy(t, n).then(function(t) {
			return t != null && (e || (e = o("I64"))).equal(t, (s || (s = o("LSIntEnum"))).ofNumber(r("LSEncryptedBackupsBackupTenancy").PRODUCTION));
		});
	}
	function c() {
		try {
			...
			return r("FBLogger")("wmi_eb").catching(r("getErrorSafe")(e)).mustfix("Failed to check EB enabled"), o("WAResultOrError").makeResult(!1);
		}
	}
	function d() {
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			if (!e) return r("FBLogger")("wmi_eb").warn("isEBEnabled: WASM not supported"), !1;
