__d("GeoVStack.react", [
	...
	function c(t) {
		...
		var g = l === void 0 ? null : l, h = s === void 0 ? "component" : s, y = c === void 0 ? "column" : c, C = d === void 0 ? "flex" : d, b = m === void 0 ? 1 : m, v = p === void 0 ? "unrelated" : p, S = _ === void 0 ? 1 : _, R = r("useGeoTheme")(), L = R.selectLayoutSpacing, E = y === "column" ? "vertical" : "vertical-reverse", k;
	...
	var d = o("GeoPrivateMakeComponent").makeGeoComponent("GeoVStack", c);
	l.default = d;
}), 98);
