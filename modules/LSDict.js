__d("LSDict", [
	...
	function s(t) {
		if (t != null) {
			...
			return n != null ? JSON.stringify([(e || (e = o("I64"))).to_string(n)]) : JSON.stringify(t);
		}
	}
	function u(t) {
		if (t != null) {
	...
	var c = (function() {
		function e(e) {
			this.size = 0;
			var t = new Map(Array.from(e || []).map(function(e) {
				var t = e[0], n = e[1];
				return t == null ? null : [s(t), n];
			}).filter(Boolean));
			this.$1 = t, Object.defineProperties(this, { size: { get: function() {
				return t.size;
			} } });
		}
		var t = e.prototype;
		return t.get = function(t) {
			...
			return r("LSVec").from(Array.from(this.$1.keys()).map(function(e) {
				return u(e);
			}));
		}, t.values = function() {
			...
			return Array.from(t.entries()).reduce(function(e, t) {
				var n, o = t[0], a = t[1];
				if (typeof o != "string") throw r("FBLogger")("messenger_web").mustfixThrow("Cannot convert dicts with mixed keys to records");
