__d("LocalDate", [
	...
	var e = (function() {
		...
		return t.equals = function(t) {
			...
			return e || (e = this.month - t.month, e) || (e = this.day - t.day), e;
			...
			var e = this.toInstant(o("Timezone").UTC) - this.startOfYear().toInstant(o("Timezone").UTC);
			return Math.round(e / r("PeriodUnit").getApproximateDuration(r("PeriodUnit").day));
			...
			return t.year == null || o("Instant").wholeYearRangeInYears.since <= t.year && t.year < o("Instant").wholeYearRangeInYears.until || s(0, 1638), t.month == null || 1 <= t.month && t.month <= 12 || s(0, 1639), t.day == null || 1 <= t.day && t.day <= 31 || s(0, 1640), this.$1(t);
		}, t.add = function(t) {
			var e = this;
			if (t.month || t.year) {
				var n = e.month + (t.month || 0) + (t.year || 0) * 12;
				e = e.$1({ month: n }), o("SharedDateUtils").divide(e.month, 12)[1] !== o("SharedDateUtils").divide(n, 12)[1] && (e = e.$1({ day: 0 }));
			}
			return t.week && (e = e.$1({ day: e.getDayOfMonth() + 7 * t.week })), t.day && (e = e.$1({ day: e.day + t.day })), e;
			...
			var e = this, n = e.toInstant(o("Timezone").UTC) - t.toInstant(o("Timezone").UTC);
			...
			return new Date(o("DateConsts").MS_PER_SEC * this.toInstant(o("Timezone").UTC));
		}, e.fromUTCDate = function(n) {
			return e.create(n.getUTCFullYear(), n.getUTCMonth() + 1, n.getUTCDate());
		}, t.toInstant = function(t) {
			var e = Date.UTC(this.year, this.month - 1, this.day) / o("DateConsts").MS_PER_SEC;
			...
			return r("DateTime").fromLegacyArgs(o("DateConsts").MS_PER_SEC * this.toInstant(t), t);
			...
			return Math.floor(e / r("PeriodUnit").getApproximateDuration(r("PeriodUnit").day));
