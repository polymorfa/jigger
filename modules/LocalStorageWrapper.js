__d("LocalStorageWrapper", [
	...
	"use strict";
	var e = r("requireDeferred")("PersistedQueue").__setRef("LocalStorageWrapper");
	function s(e) {
		var t = null;
		try {
			if (t = window.localStorage, t != null && typeof t.setItem == "function" && typeof t.removeItem == "function") {
				var n = "__test__" + Date.now();
				t.setItem(n, ""), t.removeItem(n);
			} else return null;
		} catch (n) {
			var a = r("getErrorSafe")(n);
			if (o("isQuotaExceededError").isStorageQuotaExceededError(t, a) === !1) return e("Failed to get localstorage"), null;
		}
		return t;
	}
	function u(e) {
	...
	function c(e) {
		try {
			...
			for (var r in e) if (Object.prototype.hasOwnProperty.call(e, r)) {
				...
				t += o, o / 1024 > 1e3 && (n[r.substr(0, 50)] = (o / 1024).toFixed(2));
			}
		...
		try {
			...
			if (o("CurrentMessengerUser").isEmployee()) {
				...
				e.onReady(function(e) {
					...
					i(s.message + " - Storage quota exceeded while setting " + n + ":" + a + ", queueActivateExp:" + t + " " + u);
				});
			} else i(s.message + " - Storage quota exceeded while setting " + n + ":" + a);
	...
	l.getStorage = s, l.isLocalStorageAvailable = u, l.setItemGuarded = d, l.removeItemGuarded = p, l.getItemGuarded = _;
}), 98);
