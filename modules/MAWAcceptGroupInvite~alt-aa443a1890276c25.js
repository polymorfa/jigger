__d("MAWAcceptGroupInvite", [
	...
	async function m(t) {
		...
		await o("WAWaitForComms").waitForComms(), o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["acceptGroupInvite called"])));
		...
		if (r != null && i != null) {
			...
			var g = await o("MAWGetGroupInviteApi").getGroupInvite(n, d, m);
		...
		})), y = await o("WADeprecatedSendIq").deprecatedSendIq(h, c);
		if (!y.success) {
		...
		return n != null && await o("MAWRemoveGroupInvitesApi").removeGroupInvites(n, m), !0;
	}
