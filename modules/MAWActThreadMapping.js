__d("MAWActThreadMapping", [
	...
	"use strict";
	var e, s, u, c, d = r("JSResourceForInteraction")("MAWSyncThreadDescriptionAdminMsg").__setRef("MAWActThreadMapping"), m = new Map(), p = null;
	function _(e, t, n, a) {
		...
		t.forEach(function(e) {
			return m.set(e, l.then(function(t) {
	...
	function f(e) {
		...
		return e.threads.forEach(function(e) {
			var r = m.get(e.chatJid), a = e.instanceKey;
	...
	function h(t, a) {
		r("FBLogger")("wmi").tags(["ThreadMapping"]).INFO(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			...
			"; ",
			""
		])), a.reason, a.threads.map(function(e) {
			return "JID: " + e.chatJid + ", key: " + e.authoritativeThreadKey + ";";
		}).join(" ")), p == null && (p = v(t));
		var i = f(a), l = i.cachedPromises, s = i.threadsToVerifyByJid;
		if (s.size === 0) return (c || (c = n("Promise"))).all(l);
		var u = o("MAWBridgeSendAndReceive").sendAndReceive("backend", "bulkMaybeCreateOrUpdateThread", babelHelpers.extends({}, a, { threads: Array.from(s.values()) }));
		return _(t, Array.from(s.keys()), a, u), (c || (c = n("Promise"))).all([u].concat(l)).then(function(e) {
			return e.flat(1);
		});
	}
	function y(e) {
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a) {
			if (a.threads.length !== 0) {
				var i = [], l = o("WAJids").extractUserId(o("MAWUserJidWrapper").getMyUserJid());
				yield (c || (c = n("Promise"))).all(a.threads.map(function(m) {
					var p = m.authoritativeThreadKey, _ = m.chatJid, f = m.instanceKey, g = t.get(_);
					if (g == null) return (c || (c = n("Promise"))).resolve();
					var h = [], y = g.adminMsgParams, C = g.clientThreadKey, b = g.folder, v = g.isCreated, S = g.participants;
					r("FBLogger")("wmi").tags(["ThreadMapping"]).INFO(s || (s = babelHelpers.taggedTemplateLiteralLoose([
						...
						", participants: ",
						""
					])), g.chatJid, C, b, v, S.length), S.forEach(function(e) {
					...
					h.push(L ? o("MAWBridgeGroupInviteLoadedHandler").callFromMainThread(e, _, l) : o("MAWBridgeOneToOneMessageRequestLoadedHandler").callFromMainThread(e, _));
					var E = o("WAJids").interpretAsUserJid(_);
					return E != null && h.push(r("MAWRemoveCorruptedParticipantsFromOneToOneChat")(e, (u || (u = o("I64"))).of_string(p), E, l)), v || h.push(R(e, p, b != null ? b : o("MAWFolderTypes").FOLDER_ID.INBOX)), y != null && h.push(d.load().then(function(t) {
						return t(e, _, p, y);
						...
						return o("MAWHandleActThread").handleActThreadWhenAuthoritativeInMI(e, {
							...
							description: (t = a.reason) != null ? t : "bulkCreateThreadWithoutAfterTxn",
							instanceKey: f,
							jid: _,
							optimisticThreadKey: C
						});
					});
				})), yield o("MAWBridgeParticipantsUpdatedHandler").callFromMainThread(e, i);
			}
	...
	function S(e, t) {
		m.clear(), o("WAArrayZip").zip(e, t).forEach(function(e) {
			var t = e[0], r = e[1];
			return m.set(t, new (c || (c = (n("Promise"))))(function(e, t) {
				return e(r);
			}));
		});
	}
	...
	l.bulkVerifyThreadExistsInWorker = h, l.executePromisesBlockedOnActThreadMapping = y, l.setCache_TEST_ONLY = S;
}), 98);
