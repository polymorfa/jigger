__d("MAWBlockUtils", [
	...
	function f() {
		var t = o("react-compiler-runtime").c(2), a = (e || (e = r("useReStore")))(), l;
		return t[0] !== a ? (l = function(t, l) {
			r("promiseDone")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = yield o("ReQL").firstAsync(o("ReQL").fromTableAscending(a.tables.participants).getKeyRange(t));
				if (e != null) {
					var n = yield o("ReQL").firstAsync(o("ReQL").fromTableAscending(a.tables.threads).getKeyRange(e.threadKey).filter(g));
					if (n != null) {
						var c = (s || (s = o("I64"))).equal(l, (u || (u = o("LSIntEnum"))).ofNumber(r("LSContactUserBlockAction").MN_BLOCK)) ? o("LSThreadBitOffset").clear(m, n.capabilities, n.capabilities2, n.capabilities3, n.capabilities4, n.capabilities5) : (s || (s = o("I64"))).equal(l, (u || (u = o("LSIntEnum"))).ofNumber(r("LSContactUserBlockAction").FB_BLOCK)) ? o("LSThreadBitOffset").clear(p, n.capabilities, n.capabilities2, n.capabilities3, n.capabilities4, n.capabilities5) : o("LSThreadBitOffset").set(_, n.capabilities, n.capabilities2, n.capabilities3, n.capabilities4, n.capabilities5), d = c[0], f = c[1];
						yield a.runInTransaction(function(e) {
