__d("MAWBridgeGroupInfoUpdatedHandler", [
	...
	async function p(t, n) {
		var r, a = await o("MAWMiActMappingTableAPI").getMappingRowForChatJid(t, n.chatJid);
		if (a == null) {
			m.WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Missing thread key for chatJid: ", ""])), n.chatJid);
			return;
		}
		var i = (r = n.threadName) != null ? r : void 0, l = a.serverThreadKey, p = t.threads, _ = await o("ReQL").firstAsync(o("ReQL").fromTableAscending(p).getKeyRange(l));
		if (_ == null) {
		...
		await p.put(babelHelpers.extends({}, _, {
