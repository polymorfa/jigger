__d("MAWBridgeHandlers", [
	...
	var e, s, u, c, d, m, p, _ = {
		...
		backupWriteCompletionHook: function() {
			return o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[messenger_e2ee_web] Handler not implemented and should not be used outside of Instamadillo"]))), (p || (p = n("Promise"))).resolve();
		},
		...
		dyiGetThreadList: function() {
			return o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[labyrinth_web][labyrinth_dyi] Attempted to call the old DYI V1 flow"]))), (p || (p = n("Promise"))).resolve();
		},
		...
		getAllThreadsAsJson: function() {
			return o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[labyrinth_web][labyrinth_dyi] Attempted to call the old DYI V1 flow"]))), (p || (p = n("Promise"))).resolve({});
		},
		...
		getRemotePublicIdentityKey: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAGetRemotePublicIdentity").getRemotePublicIdentity(e.deviceId, e.userId);
				return t == null ? null : { remotePublicIdentityKey: t };
			});
			function t(t) {
		...
		handleInstamadilloDYIRangeQueryRestore: function() {
			return o("WALogger").WARN(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[maw_core_lla] Handler not implemented and should not be used outside Instamadillo"]))), (p || (p = n("Promise"))).resolve();
		},
		...
		sendPoll: function(t) {
			return r("FBLogger")("wmi").mustfix("sendPoll is deprecated"), (p || (p = n("Promise"))).resolve(o("WAResultOrError").makeError({
				isRetriable: !1,
				type: "polls-not-supported"
			}));
		},
		sendPollUpdate: function(t) {
			return r("FBLogger")("wmi").mustfix("sendPollUpdate is deprecated"), (p || (p = n("Promise"))).resolve(o("WAResultOrError").makeError({
				isRetriable: !1,
				type: "polls-not-supported"
			}));
		},
		...
		startInstamadilloDYI: function() {
			return o("WALogger").WARN(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[maw_core_lla] Handler not implemented and should not be used outside Instamadillo"]))), (p || (p = n("Promise"))).resolve();
		},
