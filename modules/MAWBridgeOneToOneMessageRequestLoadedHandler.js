__d("MAWBridgeOneToOneMessageRequestLoadedHandler", [
	...
	function _(e) {
		(d || (d = o("ODS"))).bumpEntityKey(3185, "e2ee.message_request_loaded_failure", e, 1);
	}
	function f(e, t) {
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			...
			var a = o("MAWJids").convertChatJidToIntJid(r), i = yield o("MAWMiActMappingTableAPI").getThreadKeyForChatJid(t, r);
			if (i == null) {
				_("missing_thread_key");
				return;
			}
			var l = yield (e || (e = n("Promise"))).all([o("ReQL").firstAsync(o("ReQL").fromTableAscending(t.threads).getKeyRange(i)), o("ReQL").firstAsync(o("ReQL").fromTableAscending(t.contacts).getKeyRange(a))]), u = l[0], c = l[1];
			if (u == null) {
				_("missing_thread");
				return;
			}
			...
			var d = h(u, c), m = u.folderName === "pending" || u.folderName === "other" || u.folderName === "spam" || d;
			if (m) {
				var p = u.folderName === "inbox" ? s._(
					/*BTDS*/
					""
				).toString() : void 0, f = babelHelpers.extends({}, u, { additionalThreadContext: p }, y(u));
