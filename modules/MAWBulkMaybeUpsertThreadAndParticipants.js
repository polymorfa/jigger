__d("MAWBulkMaybeUpsertThreadAndParticipants", [
	...
	var e = (function() {
		var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = e.threads.filter(function(e) {
			...
			if (n.length > 0) {
				...
				var u = yield o("MawMpsThreadMsgInfo").bulkGetThreadMsgInfo(r);
				yield a;
				var c = yield s(babelHelpers.extends({ threads: n }, e), t, u);
				c.forEach(function(e) {
					e.status === "fulfilled" && o("MaybeCreateOrUpdateThreadResultCache").cache__I_KNOW_WHAT_I_AM_DOING.set(e.value.chatJid, e);
				});
			}
			return e.threads.map(function(t) {
				var n;
				return (n = o("MaybeCreateOrUpdateThreadResultCache").cache__I_KNOW_WHAT_I_AM_DOING.get(t.chatJid)) != null ? n : {
					jid: t.chatJid,
					reason: e.reason,
					status: "rejected"
				};
