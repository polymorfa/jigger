__d("MAWChatJid", [
	...
	function u(e, t) {
		try {
			...
			return r("FBLogger")("messenger_web").catching(a).warn("Invalid chatJid: " + t), (s || (s = n("Promise"))).reject(a);
		}
	}
	function c(e, t, n) {
	...
	function p(t, a) {
		try {
			return o("MAWMiActMappingTableAPI").getMappingRowForIntJid(t, a).then(function(e) {
				return e == null ? void 0 : e.serverThreadKey;
			});
		} catch (t) {
			var i = r("getErrorSafe")(t);
			return r("FBLogger")("messenger_web").catching(i).warn("Invalid integer jid: " + (e || (e = o("I64"))).to_string(a)), (s || (s = n("Promise"))).reject(i);
		}
	}
	l.toThreadKeyMaybe = u, l.toThreadKey = c, l.toThreadMaybe = d, l.toThreadKeyMaybeForChatJidInteger = p;
}), 98);
