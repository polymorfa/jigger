__d("MAWCommonSetup", [
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			_ = !0, o("MAWMIC").startMAWMICFlow(), o("MAWInit").MAWInit.start(), (u || (u = r("ExecutionEnvironment"))).isInBrowser && (yield o("MpsReverbInit").initReverb({
			...
			}), yield o("MAWCacheServiceDB").getOrSetupMAWCacheDB(), p != null && r("promiseDone")(p(), function() {}, function(e) {
			...
			try {
				o("MAWIssueNewUserVisibleErrors").deleteAllErrors(), yield o("MAWCommonBackendSetup").setupArmadilloBackend(o("MAWInit").MAWInit, function(e) {
					return l({
						logout: n,
						reregisterDevice: a,
			...
			var h = yield o("EBMinosCheckWasmFeatureSupport").checkWasmFeatureSupportAndEBInitJK();
			...
			var y = yield o("EBMinosCheckWasmFeatureSupport").checkWasmAndMinosRolloutKeyCreateGK();
