__d("MAWCommsConfig", [
	...
	async function d(e) {
		var t = e.authKeyPair, n = await o("MAWChatSocketPlatformDetails").getChatSocketPlatformDetails({ authKeyPair: t }), a = !1, i = !1, l = !1, d = null, m = new (o("WAResolvable")).Resolvable(), p = o("MAWReliabilityMonitor").MAWReliabilityMonitorSingleton.startMonitoring("MAWCommsConfig", function() {
			return {
