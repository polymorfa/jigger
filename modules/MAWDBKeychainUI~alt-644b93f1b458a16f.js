__d("MAWDBKeychainUI", [
	...
	var e = async function() {
		...
		try {
			var t, n;
			if (e = await o("MAWDBKeychain").checkMawDbExists(), !e || !e.backendDB().objectStoreNames.contains(o("MAWDBKeychain").STORENAME)) {
				var a;
				(a = e) == null || a.close(), o("MWEARKeychainV3").logMawInitPoint("maw_ear_waiting_missing_ear_table"), await o("MAWWaitForBackendSetup").waitForBackendSetup("maw-ear-ui-missing-ear-table");
			} else if (((t = e) == null ? void 0 : t.backendDB().objectStoreNames.contains(o("MAWDBKeychain").STORENAME)) === !0) {
				var i = await o("MAWDBKeychain").getEncryptionKeys(e.backendDB());
				e.close(), i.length === 0 && (o("MWEARKeychainV3").logMawInitPoint("maw_ear_waiting_missing_ear_data"), await o("MAWWaitForBackendSetup").waitForBackendSetup("maw-ear-ui-missing-ear-data"));
			}
			if ((n = e) == null || n.close(), e = await o("MAWDBKeychain").checkMawDbExists(), !e) throw r("FBLogger")("messenger_web").mustfixThrow("MAWDB is missing after worker setup.");
			var l = await o("MAWDBKeychain").getEncryptionKeys(e.backendDB());
			...
			var u = await o("MWEARKeychainV3").init("maw_ear", r("EARInitType").MAW_IN_UI_INIT);
			if (u.success === !1) {
				var c;
