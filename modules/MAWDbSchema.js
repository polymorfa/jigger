__d("MAWDbSchema", ["MAWDbVersionList"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e, s = [
		{
			autoIncrement: !0,
		...
		{
			autoIncrement: !0,
			indexes: { externalIdWithType: {
				columns: ["externalIdWithType"],
				unique: !1
			} },
		...
		},
		{
			...
			indexes: {
				...
				reactToExternalId: {
					columns: ["reactToExternalId"],
					unique: !1
				},
				reactToMsgId: {
					columns: ["reactToMsgId"],
					unique: !1
				},
				threadJid: {
					columns: ["threadJid"],
		...
		{
			autoIncrement: !0,
			indexes: { hashedPlaintextHash: { columns: ["hashedPlaintextHash"] } },
			name: "e2ee_chunk",
			primaryKey: ["chunkId"]
		},
		{
		...
		indexes: {
			...
			faviconMediaId: {
				columns: ["faviconMediaId"],
				unique: !1
			},
			headerMediaId: {
				columns: ["headerMediaId"],
				unique: !1
			},
			targetExpiringAtSec: {
		...
		autoIncrement: !0,
		indexes: { "[originalMsgExternalId+threadJid]": {
		...
		indexes: {
			...
			restorable: {
				columns: ["restorable", "timestampMs"],
				unique: !1
			}
		},
		...
		autoIncrement: !1,
		indexes: { plaintextHash: {
			columns: ["plaintextHash"],
			unique: !1
		} },
		name: "e2ee_mediaKeys",
