__d("MAWDebug", [
	...
	"use strict";
	var e = ["s2sInstanceKey", "s2sUserFlowQPLEvent"], s, u, c = {
		...
		addDeviceChangeAlerts: function(t) {
			return d(p({ deviceChangeAlerts: o("MAWTransactionMode").READWRITE })(o("MAWDbAddDeviceChangeAlertsTxn").addDeviceChangeAlertsTxn)(t));
		},
		...
		createTestPoll: function(t) {
			p({ poll: o("MAWTransactionMode").READWRITE })(function(e) {
				return e.poll.put({
					chatJid: t,
		...
		deleteGroupInvitesByThreadAndInvitedParticipant: function(t, n) {
			return d(p({ groupInvites: o("MAWTransactionMode").READWRITE })(o("MAWDbGroupInviteTxns").deleteGroupInvitesByThreadAndInvitedParticipant)(t, n));
		},
		...
		estimateStorage: async function() {
			var e = await o("WebStorageEstimator").estimateStorage();
			return e;
		},
		...
		fetchMessagesForSpamReport: async function(t, n) {
			var e = await o("WebMps").mps().spamReportLoadMessages({
				numMessages: n != null ? n : 30,
				threadId: t
			});
			return e;
		},
		...
		generateCipherTextMessagesForChat: function(t, n) {
			return Promise.all(Array.from({ length: n }).map(function(e, n) {
				...
				return p({ messages: o("MAWTransactionMode").READWRITE })(function(e) {
					return e.messages.add(i);
				})(i);
			}));
		},
		generateDuplicateMessagesForChat: function(t, n) {
			return c.generateMessagesForChat(t, n).then(function(e) {
		...
		getAppDatas: function(t) {
			return d(p({ appData: o("MAWTransactionMode").READONLY })(o("MAWDbAppDataTxns").bulkGetAppData)(t));
		},
		getAppMetaByKey: function(t) {
			return d(p({ appMeta: o("MAWTransactionMode").READONLY })(o("MAWDbMsgTypeVersionTxns").getAppMetaValue)(t));
		},
		getChunksByChunkId: function(t) {
			return d(p({ chunk: o("MAWTransactionMode").READONLY })(o("MAWDbChunkTxns").bulkGetChunks)(t));
		},
		...
		getDeviceChangeAlerts: function(t) {
			return d(p({ deviceChangeAlerts: o("MAWTransactionMode").READWRITE })(o("MAWDbGetDeviceChangeAlertsTxn").getDeviceChangeAlertsTxn)(t));
		},
		getDeviceChangeAlertsByOptions: function(t) {
			return d(p({ deviceChangeAlerts: o("MAWTransactionMode").READWRITE })(o("MAWDbGetDeviceChangeAlertsByOptionsTxn").getDeviceChangeAlertsByOptionsTxn)(t));
		},
		...
		getEBSMConsistency: async function() {
			return o("EBDBConsistencyApi").checkRegistrationConsistency((await o("EBLS").genLSClient()).db);
		},
		...
		getEditMsgHistoryByEditMsgHistoryId: function(t) {
			return d(p({ editMsgHistory: o("MAWTransactionMode").READONLY })(o("MAWDbEditMsgHistoryTxns").bulkGetEditMsgHistorys)(t));
		},
		getEditMsgHistoryByProtocolMsgId: function(t) {
			return d(p({ editMsgHistory: o("MAWTransactionMode").READONLY })(o("MAWDbEditMsgHistoryTxns").maybeGetEditMsgHistoryFromProtocolMsgId)(t));
		},
		getGroupInvite: function(t, n) {
			return d(p({ groupInvites: o("MAWTransactionMode").READONLY })(o("MAWDbGroupInviteTxns").maybeGetGroupInvite)(t, n));
		},
		getGroupInvitesByThreadAndInvitedParticipant: function(t, n) {
			return d(p({ groupInvites: o("MAWTransactionMode").READONLY })(o("MAWDbGroupInviteTxns").getGroupInvitesByThreadAndInvitedParticipant)(t, n));
		},
		...
		getMediaBackupForObjectId: function(t) {
			return d(p({ mediaBackup: o("MAWTransactionMode").READONLY })(o("MAWDbMediaTxns").maybeGetMediaBackupRowFromObjectId)(t));
		},
		getMediaByIdWithDecodedMediaEntries: async function(t) {
			var e = await p({ media: o("MAWTransactionMode").READONLY })(o("MAWDbMediaTxns").bulkGetMedias)(t);
		...
		getMediaByMediaId: function(t) {
			return d(p({ media: o("MAWTransactionMode").READONLY })(o("MAWDbMediaTxns").bulkGetMedias)(t));
		},
		getMediaByPlaintextHash: function(t) {
			return d(p({ media: o("MAWTransactionMode").READONLY })(o("MAWDbMediaTxns").maybeGetMediaFromPlaintextHash)(t));
		},
		getMessagesByMsgIds: function(t) {
			return d(p({ messages: o("MAWTransactionMode").READONLY })(function(e) {
		...
		getMsgsByMsgId: function(t) {
			return d(p({ messages: o("MAWTransactionMode").READONLY })(o("MAWDbMsgTxns").getMsgsByMsgIds)(t));
		},
		getMsgsByProtocolMsgId: function(t) {
			return d(p({ messages: o("MAWTransactionMode").READONLY })(o("MAWDbMsgTxns").getMsgsByProtocolMsgId)(t));
		},
		getNewDTSG: async function() {
			return (await o("MAWRotateDTSG").getNewDTSG()).token;
		},
		getParticipantsByParticipantKeys: function(t) {
			return d(p({ participants: o("MAWTransactionMode").READONLY })(o("MAWDbParticipantTxns").bulkGetParticipants)(t));
		},
		getPendingReceipts: function(t) {
			return d(p({ pendingReceipts: o("MAWTransactionMode").READONLY })(o("MAWDbPendingReceiptTxns").getPendingReceipts)(t));
		},
		...
		getReactionByReactToExternalId: function(t) {
			return d(p({ reactions: o("MAWTransactionMode").READONLY })(function(e) {
		...
		getReceiptByWAMsgId: function(t) {
			return d(_({ receipts: o("MAWTransactionMode").READONLY })(function(e, t) {
				return e.receipts.get({ waMsgId: t });
			})(t));
		},
		getThreadsByChatJids: function(t) {
			return d(p({ threads: o("MAWTransactionMode").READONLY })(o("MAWDbThreadTxns").getThreads)(t));
		},
		getUnArchivedDeviceChangeAlertsCount: function() {
			return d(p({ deviceChangeAlerts: o("MAWTransactionMode").READWRITE })(o("MAWDbGetUnArchivedDeviceChangeAlertsCountTxn").getUnArchivedDeviceChangeAlertsCountTxn)());
		},
		getUnrenderedMsgsByMsgId: function(t) {
			return d(p({ unrenderedMessages: o("MAWTransactionMode").READONLY })(o("MAWDbUnrenderedMsgTxns").getUnrenderedMsgsByMsgIds)(t));
		},
		getXMAByXMAId: function(t) {
			return d(p({ xma: o("MAWTransactionMode").READONLY })(o("MAWDbXMATxns").bulkGetXMAs)(t));
		},
		...
		loadMsgs: async function(t) {
			var e, n = await o("MAWLoadMsgsApi").loadMsgsFromTs(t.chatJid, (e = t.numMsgs) != null ? e : 10, t.direction, t.sortOrderMs, t.loadOriginalMsg, t.msgId, {
				admin: !0,
				editMsgHistory: !0,
				media: !0,
				polls: !0,
		...
		maybeGetXMAFromProtocolMsgId: function(t) {
			return d(p({ xma: o("MAWTransactionMode").READONLY })(o("MAWDbXMATxns").maybeGetXMAFromProtocolMsgId)(t));
		},
		...
		putGroupInvite: function(t) {
			return d(p({ groupInvites: o("MAWTransactionMode").READWRITE })(o("MAWDbGroupInviteTxns").putGroupInvite)(t));
		},
		...
		sendMessageTooAllExistingGroups: async function() {
			var e = await p({ groupInfo: o("MAWTransactionMode").READONLY })(function(e) {
				return e.groupInfo.toArray();
			})(), t = [];
			for (var n of e) t.push(c.sendMsg(n.groupJid, {
		...
		triggerSecureStorageKeyChangeAlert: function() {
			...
			return d(p({ deviceChangeAlerts: o("MAWTransactionMode").READWRITE })(o("MAWDbAddDeviceChangeAlertsTxn").addDeviceChangeAlertsTxn)(e));
		},
		updateDeviceChangeAlerts: function(t) {
			return d(p({ deviceChangeAlerts: o("MAWTransactionMode").READWRITE })(o("MAWDbUpdateDeviceChangeAlertsTxn").updateDeviceChangeAlertsTxn)(t));
		},
		...
		updateDeviceChangeAlertsLogInStatus: function(t) {
			return d(p({ deviceChangeAlerts: o("MAWTransactionMode").READWRITE })(o("MAWDbUpdateDeviceChangeAlertsLogInStatusTxn").updateDeviceChangeAlertsLogInStatusTxn)(t));
		},
		...
		writeRollbackCutoverThreadAdminMsg: function(t) {
			var e = p({ threads: o("MAWTransactionMode").READONLY })(o("MAWDbThreadTxns").getThread)(t);
			return e.then(function(e) {
				if (!e.success) return Promise.resolve();
				var t = e.value;
				return d(p({
	...
	if (r("gkx")("23903")) {
		var m = o("MAWUnsafeCoerce").unsafeCoerce(self);
		m.Debug = c, m.WAAPI = r("WAAPI");
	}
	function p(e) {
		return function(t) {
