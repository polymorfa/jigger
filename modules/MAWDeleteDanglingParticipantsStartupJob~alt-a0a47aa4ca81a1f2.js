__d("MAWDeleteDanglingParticipantsStartupJob", [
	...
	}), c = { run: async function() {
		if (r("gkx")("24027")) {
			s("Starting job..."), o("MAWODSProxy").odsBumpEntityKey({
				entity: o("WAOdsEnums").Entity.MAW_DELETE_DANGLING_PARTICIPANTS,
				key: "start"
			});
			var e = await o("MAWDbVersion").getDBVersion();
			if (e != null && e >= 85) {
				s("" + (e != null ? e : "null"));
				var t = await o("MAWQplProxy").measurePerfInQPL_USE_WITH_CARE(r("qpl")._(25310776, "6155"), "startup_job:delete_dangling_participants", function() {
					return u();
				});
