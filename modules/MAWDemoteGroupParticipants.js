__d("MAWDemoteGroupParticipants", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var i = [];
			try {
				yield o("E2EEMetadataMailboxDemoteGroupParticipantsMutation").demoteMISOTGroupParticipantsOverGraphQL({
			...
			return yield o("MAWChangeGroupParticipantAdminStatusApi").changeGroupParticipantAdminStatus(null, t, o("WAJids").AUTHOR_ME, i, "participant", o("WATimeUtils").unixTime()), o("WAResultOrError").makeResult({
				groupJid: t,
				participants: i,
				type: "default"
			});
