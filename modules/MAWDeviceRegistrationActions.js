__d("MAWDeviceRegistrationActions", [
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield o("WAGetRegistrationInfoApi").getRegistrationInfo(), t = e.deviceId, n = e.deviceUUID, a = e.fbid, i = e.identityCompareResult, l = e.identityKeyPair, s = e.lastSessionDeviceWasLinkedTo, u = e.lastSignedPrekeyId, c = e.regId, d = e.registrationUnixTime, y = e.registrationVersion;
			...
			var C = yield o("WASignedKeyApi").getSignedKey(u);
