			...
			if (!(f == null || f === "") && !(o("CurrentMessengerUser").isTestUser() && f.includes("twshared"))) {
				...
				if (h != null) {
					...
					if (y != null) {
						...
						((l = R) == null ? void 0 : l.success) === !0 ? (_.DEBUG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["LinkDeviceToTheSession success"]))), yield r("WAAPI").saveLastSessionDeviceWasLinkedTo({ sessionId: n })) : _.WARN(m || (m = babelHelpers.taggedTemplateLiteralLoose(["fetch result is not successful"])));
					}
				}
			}
