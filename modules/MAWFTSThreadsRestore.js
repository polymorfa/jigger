__d("MAWFTSThreadsRestore", [
	...
	var e, s, u, c = (function() {
		...
		var a = t.prototype;
		return a.startThreadsRestore = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				this.$4 || (this.$4 = !0, this.$6 = !0, yield o("MAWFTSRestoreSyncLogger").initLoggingSessionId(), yield this.$8(), yield this.$9());
			});
			function t() {
				return e.apply(this, arguments);
			}
			return t;
		})(), a.isThreadQueryInProgress = function() {
			return this.$6 || this.$7.size > 0;
		}, a.getInitialLastActivityTimeForThreadMs = function(t) {
			return this.$1.get(t);
		}, a.getThreadsHead = function() {
			return this.$2.getHead();
		}, a.hasThread = function(t) {
			return this.$2.has(t);
		}, a.insertIntoHead = function(t) {
			this.$2.insertToHead(t);
		}, a.removeThread = function(t) {
			this.$2.remove(t);
		}, a.$10 = function(t, n) {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var t = this, n = yield this.$12(), r = o("ReQL").fromTableAscending(n.tables.messenger_fts_threads_queries, [
					"hasNextPage",
					"nextPageCursor",
					"resultCount"
				]), a = { contents: function() {} };
				...
				var i = yield o("ReQL").firstAsync(r);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = this, t = yield this.$12(), n = o("ReQL").fromTableAscending(t.tables.messenger_fts_threads, [
					"threadId",
				...
				var r = yield o("ReQL").toArrayAsync(n);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				return this.$3 == null && (this.$3 = yield (s || (s = o("LSDatabaseSingleton"))).LSDatabaseSingleton), this.$3;
			});
			function t() {
				return e.apply(this, arguments);
			}
