__d("MAWFetchDeanonMetadataUsingCache", [
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.chatJid, n = e.db, r = e.direction, a = e.isFirstPage, i = e.logger, l = e.pageSize, u = e.range, d = e.sortFn;
			y(n);
			var m = h(t, r, i, u);
			if (m != null && (i == null || i.addQPLAnnotations({
				bool: { is_first_page: a },
				int: { deanon_cached_data_size: m == null ? void 0 : m.length }
			}), o("MAWDeanonDataCheck").hasEnoughDeanonData(m, l, a))) return c.LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["Using cached Deanon messages metadata for comparison to local data"]))), i == null || i.addQPLAnnotations({ bool: { is_deanon_cached_data_used: !0 } }), o("WAResultOrError").makeResult(m);
			var p = yield o("MAWFetchEBDeanonMessagesMetadata").fetchEBDeanonMessagesMetadata({
				chatJid: t,
				direction: r,
			...
			return p.success === !0 && (i == null || i.addQPLAnnotations({ bool: { is_deanon_data_fetched: !0 } }), b(t, r, i, p.value, u)), p;
	...
	function b(e, t, n, r, a) {
		if (r.length !== 0) {
			...
			C(e, t, r, l), n == null || n.markQPLPoint("deanon_cache_replace_end");
		}
	}
	function v(e, t) {
		if (t.length !== 0) {
	...
	function S(t, n) {
		var r = R(t, n);
		r != null && (c.LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Using init-sync deanon data for ", ""])), t), C(t, n, r.msgsMetadata, {
	...
	l.MAWFetchDeanonMetadataUsingCache = f, l.fetchDeanonDataFromCache = h, l.initDeanonCacheDescForThread = v;
}), 98);
