__d("MAWFilePressable.react", [
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(5), n = e.children, a = e.linkProps, i = e.onPress, l = e.testid, s;
		return t[0] !== n || t[1] !== a || t[2] !== i || t[3] !== l ? (s = u.jsx(r("MWXPressable.react"), {
			display: "inline",
			linkProps: a,
			onPress: i,
			overlayDisabled: !0,
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(5), n = e.children, a = e.linkProps, i = e.onPress, l = e.testid, s = r("useMWFileOnPress")(i), c;
		return t[0] !== n || t[1] !== a || t[2] !== s || t[3] !== l ? (c = u.jsx(_, {
			linkProps: a,
			onPress: s,
			testid: void 0,
			children: n
		}), t[0] = n, t[1] = a, t[2] = s, t[3] = l, t[4] = c) : c = t[4], c;
	}
	function g(e) {
