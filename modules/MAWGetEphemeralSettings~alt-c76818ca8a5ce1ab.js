__d("MAWGetEphemeralSettings", [
	...
	async function d(t, n) {
		if (o("WAJids").switchOnMsgrChatJidType(t, {
			...
			var a, i = await u.load(), l = await i(), d = n != null ? n : await o("MAWChatJid").toThreadKeyMaybe(l.tables, t), m = (a = r("qex")._("1083")) != null ? a : !1;
			if (d != null) {
				var p = await o("ReQL").firstAsync(o("ReQL").fromTableAscending(l.tables.threads).getKeyRange(d));
