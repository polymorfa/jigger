__d("MAWGroupSetMemberAddMode", [
	...
	async function e(e) {
		...
		try {
			...
			await o("E2EEMetadataMailboxSetGroupParticipantUpdateModeMutation").setMISOTGroupParticipantUpdateModeOverGraphQL({
		...
		return await o("MAWChangeGroupMemberAddModeApi").changeGroupMemberAddMode(t, o("WAGlobals").getMyUserJid(), n, o("WATimeUtils").unixTime(), "skip_admin_message"), o("WAResultOrError").makeResult();
	}
