__d("MAWIndexedDb", [
	...
	function c(e) {
		...
		return babelHelpers.extends({}, t, {
			getSignalDB: a,
			makeDB: async function(a, i, l) {
				var e = [o("MAWDbMutationMiddleware").getMAWDbMutationMiddleware];
				return e.push(o("MAWDbProtocolMsgIdMiddleware").MAWDbProtocolMsgIdMiddleware), e.push(r("MAWCacheServiceMiddleware")), i.enableDataSyncMiddleware && e.push(o("MAWDataSyncMiddleware").getDataSyncMiddleware), n("cr:3527") != null && e.push(n("cr:3527")), r("justknobx")._("4087") && await r("MAWLoadDbMigrationVersion")(a), t.makeDB(a, {
					autoOpen: !0,
					middleware: e,
