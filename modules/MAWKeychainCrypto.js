__d("MAWKeychainCrypto", [
	...
	"use strict";
	var e, s = o("MAWKeychainUtil").makeAAD(o("MAWCryptoConsts").VERSION, o("MAWCryptoConsts").CIPHER_ID);
	function u(e, t, n) {
		var a = o("MAWKeychainUtil").getBufferWithRandomValuesFromLength(o("MAWCryptoConsts").AES_GCM_IV_LENGTH_IN_BYTES), i = n || s;
		return o("MAWSubtleCrypto").MAWSubtleCrypto.encrypt({
			...
			throw r("FBLogger")("messenger_web").catching(n).mustfixThrow("Failed to encryptDataToStringBuffer", typeof e, e.constructor.name);
		});
	}
	function c(e, t) {
	...
	function p(t) {
		return (e || (e = n("Promise"))).all(m(t).map(function(e) {
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				var n = yield o("MAWSubtleCrypto").MAWSubtleCrypto.importKey("raw", t, { name: o("MAWCryptoConsts").HKDF }, !1, ["deriveKey"]);
				return n;
			} catch (e) {
