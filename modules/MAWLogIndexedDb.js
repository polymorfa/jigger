__d("MAWLogIndexedDb", [
	...
	function d() {
		if (s == null) throw r("FBLogger")("messenger_web").mustfixThrow("LogDB IndexDB should've been initialized");
		return s;
	}
	function m() {
		return u == null ? _().then(function() {
			return d();
		}) : u.then(function() {
			return d();
		});
	...
	function _(t) {
		...
		var a = o("MAWCurrentUser").getID(), i = o("MAWIndexedDbMetadata").logDbName(a), l = (r = t != null ? t : c()) != null ? r : p.length;
		return u = new (e || (e = (n("Promise"))))(function(e, t) {
	...
	function f(e, t) {
		var n = e.newVersion, r = e.oldVersion;
		return r < t && n >= t;
	}
	function g(e) {
		...
		return function(t) {
			return function() {
				...
				return m().then(function(n) {
					var r = function(r) {
						var t = n.transaction(e, r != null ? g(r) : a, { durability: "relaxed" });
					...
					var t = o("MAWErrorObject").getErrorObject(e), n = r("FBLogger")("maw_db");
					throw t instanceof Error ? n.catching(t).mustfixThrow("LOG - Error performing transaction in log transactor") : n.mustfixThrow("LOG - Error performing transaction in log transactor");
				});
			};
		};
	}
