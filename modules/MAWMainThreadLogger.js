__d("MAWMainThreadLogger", [
	...
	function g(e, t) {
		var n = o("WAJids").maybeSanitizeLogLineText(e);
		n = o("MAWLeakDetection").maybeReplaceVaultedString(n), d().tags(t.map(function(e) {
			return String(e);
		})).warn(n);
	}
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			var a = o("MAWLeakDetection").maybeReplaceVaultedString(o("WAJids").maybeSanitizeLogLineText(t)), i = o("MAWLoggingSwitches").removeLoggingFromBridge ? o("MAWSaveLogToDisk").getLastNEntries(r) : (e || (e = n("Promise"))).resolve([]), l = r === 0 ? [] : [].concat((yield i).map(function(e) {
				return e.args;
			}));
			return {
				logs: [].concat(l),
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i) {
			var l, s, u = o("MAWLeakDetection").maybeReplaceVaultedString(o("WAJids").maybeSanitizeLogLineText(e)), c = n != null ? n : r("err")(u), m = a != null ? a : n == null ? 2 : 0, p = i != null ? i : 0, _ = yield y(c.message, p), f = _.logs, g = _.sanitizedMessage, h = r("getErrorSafe")(c);
			try {
				c.message = g;
			} catch (e) {
				h = r("err")(g, c.fileName, c.lineNumber);
			}
			m !== 0 && (h.framesToPop = m), (l = d()) == null || (s = l.addMetadata("MESSENGER_E2EE_WEB", "APP_VERSION", o("MAWAppVersion").getVersionNumber()).tags(t.map(function(e) {
				return String(e);
	...
	var S = {
		...
		error: function(t, n, a) {
			r("promiseDone")(b(t, n, a)), o("MAWConsoleLogger").logToConsole("error", t, n);
		},
		info: function(t, n) {
	...
	function R() {
		return o("MAWLoggingSwitches").removeLoggingFromBridge ? o("MAWSaveLogToDisk").getEntriesFromDb() : (e || (e = n("Promise"))).resolve([]);
	}
	function L() {
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			o("MAWLoggingSwitches").removeLoggingFromBridge && (yield o("MAWDeleteOldLogsFromDisk").clearLogs());
	...
	l.__testClearLoggerSetup = u, l.setupMainWaLogger = c, l.logRestricted = m, l.count = _, l.info = f, l.warn = g, l.logError = h, l.getEntries = R, l.clearEntries = L, l.formatEntries = I;
}), 98);
