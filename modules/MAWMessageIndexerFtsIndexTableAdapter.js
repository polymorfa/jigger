	...
	var e = function(t) {
		...
		return t.$3 = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				return o("MAWFTSIndexedDb").makeMsgrFTSTransactor({ ftsIndexV3: o("MAWTransactionMode").READWRITE }, function(t) {
					return function() {
						return s(t, e);
					};
				})();
		...
		}, t.bulkRemoveByIndex = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				if (this.$1 != null) {
					yield d(this.$3(), e, t);
					return;
				}
				return o("MAWFTSIndexedDb").makeMsgrFTSTransactor({ ftsIndexV3: o("MAWTransactionMode").READWRITE }, function(n) {
					return function() {
						return d(n, e, t);
					};
				})();
