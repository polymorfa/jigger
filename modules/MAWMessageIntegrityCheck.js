__d("MAWMessageIntegrityCheck", [
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, a, i, l, v, R, L, I) {
			var x, P, N, M, w, A, F, O;
			if (C.LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
				...
				", pageSize: ",
				""
			])), (g || (g = o("I64"))).to_string(n), v == null ? "null" : (g || (g = o("I64"))).to_float(v.primarySortKey), l), o("WATimeUtils").millisTime() - I > y) {
			...
			var W = o("WATimeUtils").millisTime(), q = r("gkx")("1626"), U = o("MAWMessageIntegrityEBFetchStatus").hasEBFailure(n), V = o("MAWMessageIntegrityTruncateStatus").getThreadThuncateState(n), H = v != null ? {
				...
				timeOfSnapshotMs: S(R, I),
				type: "latestPageSnapshot"
			}, G = yield o("MAWMessageIntegrityFetchAndCompareData").fetchAndCompareMessagesData({
				db: t,
			...
			var j = k(z.uiVsEB), K = z.mpsVsEB != null ? k(z.mpsVsEB) : {}, Q = k(z.S518614_uiVsEB), X = z.S518614_mpsVsEB != null ? k(z.S518614_mpsVsEB) : {}, Y = T(R), J = yield o("MAWMessagesIntegrityEphemeralSettings").getEphemeralMessagesStatusForPage(t, n, Y), Z = yield D(t, n), ee = yield o("WAPromiseDelays").withTimeout($({ messages: [] }).catch(function(e) {
				return C.ERROR(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["Failed to get extra debug info: ", ""])), e), "error";
			}), 1e4, function() {
				return "timeout";
			}), te = {
				MPS_vs_EB_detailedResults: (x = K.detailedResults) != null ? x : "",
				...
				extraDebugInfo: ee,
				hasAdditionalData: E(q),
				hasEBFetchFailed: E(U),
				integrityCheckScheduleTimestampMs: I.toString(),
				isDogfooding: E(r("gkx")("2972")),
				isEbEnabled: E(B),
				isEbGraphQL: B ? "false" : E(r("gkx")("7083")),
				isHoldout_H2_2025: E(r("gkx")("15728")),
				isJidOptimisationInRestoreEnabled: E(r("gkx")("3137")),
				isMpsEnabled: "true",
				isUsingLsInitCache: E(r("gkx")("15958")),
				...
				version: B ? h : "0",
				waCommsIsConnected: E(o("WACommsConnectionState").WACommsConnectionState.isConnected())
			};
	...
	function k(e) {
		...
		return e.detailedResults.forEach(function(e) {
			...
			detailedResults: I(e.detailedResults),
	...
	function x() {
		return x = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield o("MAWMiActOnActThreadReady").waitForACTThreadReady(e.tables, t, "fetchAndCompareMessagesData"), r = n.chatJid, a = yield o("MAWBridgeSendAndReceive").sendAndReceive("backend", "getEBMetadataCacheDetailsForThread", { chatJid: r });
	...
	function P() {
		return P = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = {
				...
				worker: yield o("MAWBridgeSendAndReceive").sendAndReceive("backend", "getWorkerBasedMessageIntegrityDebugInfo", e)
			};
			return JSON.stringify(t);
		}), P.apply(this, arguments);
	}
	var N = { runMessageIntegrityCheck: R };
	l.default = N;
}), 98);
