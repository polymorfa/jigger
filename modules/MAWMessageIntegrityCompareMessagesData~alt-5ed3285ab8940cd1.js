__d("MAWMessageIntegrityCompareMessagesData", [
	...
	async function d(e, t) {
		var n = t.S518614_messagesBacktest, r = n.ebMessages, o = n.mpsMessages, a = n.uiMessages, i = t.S518614_pageSizeBacktest, l = t.messages, s = l.ebMessages, u = l.mpsMessages, c = l.uiMessages, d = t.pageSize, p = await m(e, s, u, c, d), _ = p.mpsVsEB, f = p.uiVsEB, g = await m(e, r, o, a, i, !0), h = g.mpsVsEB, y = g.uiVsEB;
		return {
			S518614_mpsVsEB: h,
			S518614_pageSize: i,
			S518614_uiVsEB: y,
	...
	function m(t, n, r, a, i, l) {
		...
		return d.result !== "consistent" && (l ? c.LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose([
			...
			", num of messages missing: ",
			""
		])), (u || (u = o("I64"))).to_float(t), d.result, d.numOfMissingMessages)), (d.result === "missing_in_target" || d.result === "missing_in_both") && (d.detailedResults = p(d.detailedResults, a)), {
			mpsVsEB: m,
			pageSize: i,
			uiVsEB: d
		};
