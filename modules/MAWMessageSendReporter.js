__d("MAWMessageSendReporter", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i, l) {
			var c = n.qplEventType, d = n.qplInstanceKey, p = s(l);
			try {
				r("QPLUserFlow").addPoint(c, "send_to_worker_start", { instanceKey: d }), p != null && r("QPLUserFlow").addAnnotations(c, { int: { in_flight_attachment_type_send_count: p } }, { instanceKey: d });
				var _ = yield t;
				if (_ == null) return;
				if (_.success) _.value != null ? o("MAWReportSendMessageSuccessResult").reportSendMessageSuccessResultFn(_.value, i) : r("QPLUserFlow").addPoint(c, "no-op", { instanceKey: d }), r("QPLUserFlow").endSuccess(c, { instanceKey: d });
				else {
				...
				if (r("MWLogSendToSentFailedError")({
					...
					instanceKey: d
				}), m(e, !1, a, C), r("FBLogger")("messenger_web").catching(C).mustfix("MAWMessageSendReporter"), typeof C == "object") {
