__d("MAWMpsMigrationProtobufCorrectnessChecker", [
	...
	async function e(e) {
		...
		if (!(o("Random").random() > 1 / t)) {
			...
			if (n === !0) {
				...
				try {
					var u = await o("WebMps").mps().loadMessage({
						config: {
					...
					if (!u.success) {
						a.addPoint("mps_fetch_failed", { string: { errorMessage: u.error } }), a.endSuccess();
						return;
					}
					if (u.value == null) {
				...
				var f = s(e.toplevelProtobuf.payload, i.toplevelProtobuf.payload);
				if (!f.success) {
	...
	function s(e, t) {
		...
		var a = u(n.proto.metadata, r.proto.metadata);
	...
	l.compareBinary = o("MAWMpsMigrationProtobufCorrectnessCheckerUtils").compareBinary, l.checkProtobufCorrectness = e, l.compareProtobufs = s;
}), 98);
