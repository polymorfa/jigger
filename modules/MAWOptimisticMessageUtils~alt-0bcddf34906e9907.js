__d("MAWOptimisticMessageUtils", [
	...
	async function c(t, n) {
		var r = await o("ReQL").firstAsync(o("ReQL").fromTableDescending(t.threads.index("lastActivityTimestampMs")));
		return r == null || (e || (e = o("I64"))).equal(r.threadKey, n) ? null : (e || (e = o("I64"))).add(r.lastActivityTimestampMs, e.one);
	}
	async function d(e, t) {
		var n = t.threadKey, r = await c(e, n);
		await o("MAWBumpThread").threadMutation_DEPRECATED({
	...
	async function m(e, t) {
		var n = t.optimisticMediaAttachment, r = t.threadKey, a = g(n.type);
		if (a != null) {
			var i = await c(e, r);
			await o("MAWBumpThread").threadMutation_DEPRECATED({
	...
	l.getOptimisticMessageTimestamp = u, l.getOptimisticThreadBumpTimestamp = c, l.optimisticBumpThread = d, l.optimisticBumpThreadMedia = m, l.buildMAWOptimisticBaseMsg = p, l.buildMAWBaseSendMsgArgs = _, l.buildOptimisticAttachment = f, l.lsAttachmentTypeToMsgType = h, l.getSpecialTextSize = y;
}), 98);
