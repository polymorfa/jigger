__d("MAWPromoteGroupParticipants", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var i = [];
			try {
				yield o("E2EEMetadataMailboxPromoteGroupParticipantsMutation").promoteMISOTGroupParticipantsOverGraphQL({
			...
			return yield o("MAWChangeGroupParticipantAdminStatusApi").changeGroupParticipantAdminStatus(null, t, o("WAJids").AUTHOR_ME, i, "admin", o("WATimeUtils").unixTime()), o("WAResultOrError").makeResult({
				groupJid: t,
				participants: i,
				type: "default"
			});
