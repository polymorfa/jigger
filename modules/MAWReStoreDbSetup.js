__d("MAWReStoreDbSetup", [
	...
	function d() {
		...
		return c == null && (c = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			try {
				var e = yield u();
				return yield e.runInTransaction(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {}), "readwrite", void 0, void 0, i.id + ":37"), e;
			} catch (e) {
