__d("MAWRemoveGroupParticipants", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = t.map(function(t) {
				return [e, t];
			}), r = yield m(n), a = o("WAArrayZip").zip(t, r);
	...
	var m = o("MAWIndexedDb").makeMsgrTransactor({ participants: o("MAWTransactionMode").READONLY }, "getParticipantsWithTransaction", function(e) {
		return function(t) {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (i.length > 0) {
				u(t, i);
				try {
					yield o("E2EEMetadataMailboxRemoveGroupParticipantsMutation").removeMISOTGroupParticipantsOverGraphQL({
			...
			return a.addPoint("start_remove_participant_txn"), yield o("MAWRemoveGroupParticipantsApi").removeGroupParticipants(null, t, o("WAJids").AUTHOR_ME, l, !0, o("WATimeUtils").unixTime()), a.addPoint("finish_remove_participant_txn"), a.endSuccess(), o("WAResultOrError").makeResult({
				groupJid: t,
				participants: l
			});
		}), _.apply(this, arguments);
	}
	l.removeGroupParticipants = s, l.removeGroupParticipantsImpl = p;
}), 98);
