__d("MAWRotateDTSG", [
	...
	"use strict";
	var e, s, u = o("MWFBLogger").MWLogger().tags(["RotateDTSG"]), c = (function() {
		var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			var i = yield a.text(), l = o("CSRFGuard").clean(i), s = JSON.parse(l), c = s == null || (t = s.payload) == null ? void 0 : t.token, d = s == null || (n = s.payload) == null ? void 0 : n.valid_for;
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			self.clearTimeout(d);
			try {
				var e = yield c(), t = e.token, n = e.validFor;
