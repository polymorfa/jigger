__d("MAWSaveLogToDisk", [
	...
	"use strict";
	var e, s = r("justknobx")._("1403"), u = r("justknobx")._("1404"), c = r("justknobx")._("1401");
	function d(e) {
	...
	var g = [], h = [], y = 5, C = 0, b = !1, v = function() {
		g.length = 0;
	}, S = function(t) {
		var e = I(t);
	...
	})(), k = r("throttle")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		if (!b) {
			b = !0;
			try {
				var e = [].concat(g);
	...
	}, T = o("MAWLogIndexedDb").makeLogMsgrTransactor("logs", o("MAWTransactionMode").READWRITE)(function(e, t) {
	...
	}), D = o("MAWLogIndexedDb").makeLogMsgrTransactor("logs", o("MAWTransactionMode").READONLY)(function(e) {
		var t = new (r("Deferred"))(), n = e(), o = n.getAll();
		return o.onsuccess = function(e) {
			var n = e.target.result, r = n.slice(Math.max(0, n.length - c));
			t.resolve(r);
	...
	}, P = o("MAWLogIndexedDb").makeLogMsgrTransactor("logs", o("MAWTransactionMode").READONLY)(function(e, t) {
	...
	l.joinTags = m, l.formatLog = _, l.formatErrorForLogging = f, l.clearLogEntryCache = v, l.saveLogEntry = L, l.forceCachedLogEntryPersist = E, l.getEntriesFromDb = x, l.getLastNEntries = $;
}), 98);
