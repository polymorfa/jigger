__d("MAWSecureThreadQPContainerLazyLoadedQuery.graphql", ["MAWSecureThreadQPContainerLazyLoadedQuery_facebookRelayOperation", "relay-runtime"], (function(t, n, r, o, a, i) {
	"use strict";
	var e = {
		fragment: {
			argumentDefinitions: [],
			kind: "Fragment",
			metadata: null,
			name: "MAWSecureThreadQPContainerLazyLoadedQuery",
			selections: [{
				args: null,
				kind: "FragmentSpread",
		...
		params: {
			id: n("MAWSecureThreadQPContainerLazyLoadedQuery_facebookRelayOperation"),
			metadata: {},
			name: "MAWSecureThreadQPContainerLazyLoadedQuery",
			operationKind: "query",
			text: null
