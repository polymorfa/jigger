__d("MAWSendExternalLinkXMAV2", [
	...
	async function s(t, n) {
		...
		var E = await o("MAWGetEphemeralSettings").getEphemeralSetting(m, R), k = void 0;
		if (C != null && o("MAWExternalLinkUtil").allowedPreviewTypes.includes(C.type)) {
			var I = new File([C], "preview", { type: C.type }), T = await o("MAWImagePreProcess").generateImageThumbnailInWorkerWithFallback(I, r("justknobx")._("2033")), D = new File([T.jpegThumbnail], "preview", { type: "image/jpeg" });
			k = {
				file: D,
				height: T.height,
				width: T.width
		...
		return _ == null || _.addMarkerPoint("sending_message_to_wajob_end", "AppTiming"), o("sendToSentQPLLogger").markSendToSentPoint(v, "sending_message_to_wajob_end"), await o("MAWMessageSendReporter").MAWMessageSendReporter({
			chatJid: m,
			externalId: M
		}, O, {
			qplEventType: r("qpl")._(25313175, "1551"),
