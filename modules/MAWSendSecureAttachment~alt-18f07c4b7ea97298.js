__d("MAWSendSecureAttachment", [
	...
	async function d(t, n, a, i, l, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E) {
		var k;
		...
		if (_ != null) {
			...
			T != null && (I = await o("MAWGetProtocolMsgIdByMsgIdInUI").getProtocolMsgIdByMsgIdUI(T)), o("sendToSentQPLLogger").markSendToSentPoint(h, "get_reply_message_end");
		}
		...
		var O = (k = d.plaintext) != null ? k : await o("WABlobToArrayBuffer").blobToArrayBuffer(d.file), B = r("gkx")("23705") && !r("UserAgent").isBrowser("Safari");
