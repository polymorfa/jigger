__d("MAWSubscribeToLSTruncateMetadataThreads", [
	...
	function u(t, n) {
		var a = o("react-compiler-runtime").c(5), i = r("useAsyncReStore")(), l, u;
		a[0] !== i || a[1] !== n || a[2] !== t ? (l = function() {
			...
			i,
			n
		], a[0] = i, a[1] = n, a[2] = t, a[3] = l, a[4] = u) : (l = a[3], u = a[4]), o("Int64Hooks").useEffectInt64(l, u);
	}
	function c(e) {
		return e();
	}
