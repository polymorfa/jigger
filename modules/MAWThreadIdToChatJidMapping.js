__d("MAWThreadIdToChatJidMapping", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, r) {
			...
			var a = yield o("ReQL").firstAsync(o("ReQL").fromTableAscending(t.mi_act_mapping_table.index("jid")).getKeyRange((c || (c = o("I64"))).of_string(n)));
			...
			var i = a.serverThreadKey, l = a.jid, m = yield o("ReQL").firstAsync(o("ReQL").fromTableAscending(t.threads).getKeyRange(i));
