__d("MAWUploadPayloadGenerator", [
	...
	"use strict";
	var e, s, u, c, d = o("EBLogger").EBLogger().tags(["MAWUploadPayloadGenerator"]);
	function m(e, t) {
		return p.apply(this, arguments);
	}
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			var a = yield (c || (c = n("Promise"))).allSettled(r.map(function(e) {
				...
				if (t.status === "rejected") {
					d.WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Failed to generate attachment payload: ", ""])), t.reason);
					return;
				}
				return t.value;
			});
			return o("EBWasmSerializeMessagesModule").serializeMessageBatchWasm(t, r, i);
		...
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (i != null) {
				...
				if (a = f({
					...
					var c = yield r("LSSerializeAttachmentBackupPayloadStoredProcedure")(r("LSFactory")(e), {
					...
					if (d != null) {
						...
						var g = o("LSShape").toRecord(m), h = g.error_code;
						n = JSON.stringify({
							failure: {
