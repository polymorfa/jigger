__d("MAWVisibilityRestoreGapUI.react", [
	...
	function m() {
		...
		if (!i) return null;
		var l;
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (l = { className: "x1eb86dx x9f619 x78zum5 xl56j7k x14vqqas xod5an3 x6ikm8r xmzvs34 xf159sx xh8yej3" }, e[0] = l) : l = e[0];
		var m, p, _, f, g;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (m = { className: "xlhe6ec x6nl9eh x1a5l9x9 x7vuprf x1mg3h75 x9f619 xt7dq6l x1jc70xm xyamay9 x1l90r2v xf7dkkf xv54qhq xh8yej3" }, p = { className: "x1qjc9v5 x78zum5 xdt5ytf x5yr21d x1nhvcw1 xh8yej3" }, _ = { className: "x6s0dn4 x78zum5 xdt5ytf x1h5wmu3 x1nhvcw1 xh8yej3" }, f = u.jsx(d, {}), g = { className: "x14vqqas xh8yej3" }, e[1] = m, e[2] = p, e[3] = _, e[4] = f, e[5] = g) : (m = e[1], p = e[2], _ = e[3], f = e[4], g = e[5]);
		var h, y;
		...
		var C, b, v;
		e[8] === Symbol.for("react.memo_cache_sentinel") ? (b = u.jsxs("div", babelHelpers.extends({}, _, { children: [
			f,
			h,
		...
		] })), v = { className: "x78zum5 xc9qbxq xh8yej3 xw7yly9" }, C = { className: "x1iyjqo2" }, e[8] = C, e[9] = b, e[10] = v) : (C = e[8], b = e[9], v = e[10]);
		var S;
		...
		var R;
		e[12] !== n ? (R = u.jsx("div", babelHelpers.extends({}, m, { children: u.jsxs("div", babelHelpers.extends({}, p, { children: [b, u.jsx("div", babelHelpers.extends({}, v, { children: u.jsx("div", babelHelpers.extends({}, C, { children: u.jsx(r("BaseTheme.react"), {
			config: c,
