__d("MAWWebWorkerLogger", [
	...
	var u = {
		...
		error: function(t, n, a) {
			...
			a ? _(e, n, a) : _("webworker", n, r("err")(o("WAJids").maybeSanitizeLogLineText(e))), o("MAWConsoleLogger").logToConsole("error", e, n);
		},
		info: function(t, n) {
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			yield o("MAWSaveLogToDisk").forceCachedLogEntryPersist();
