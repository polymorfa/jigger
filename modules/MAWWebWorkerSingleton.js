__d("MAWWebWorkerSingleton", [
	...
	var e, s = null, u = function(t) {
		...
		return s;
	}, d = g, m = new (o("WAResolvable")).Resolvable(), p = null;
	function _() {
		return o("shouldUseMAWSharedWorker").shouldUseMAWSharedWorker() ? (e || (e = n("Promise"))).all([o("SharedWorkerMigrationUtils").isStatusLockHeld(n("cr:6600").name), o("SharedWorkerV4MigrationUtils").isV4WorkerRunning(n("cr:6600").name)]).then(function(e) {
			var t = e[0], n = e[1];
			return t || n;
	...
	function f() {
		...
		if (t.isSharedWorker !== !0) return (e || (e = n("Promise"))).resolve(t.workerCreationPromiseExists === !0 ? {
			data: t,
		...
		if (t.nativeLocksSupported !== !0) return (e || (e = n("Promise"))).resolve({
			data: t,
		...
		return (e || (e = n("Promise"))).all([
			...
			r != null ? o("SharedWorkerMigrationUtils").isWorkerIdStatusLockHeld(n("cr:6600").name, r) : (e || (e = n("Promise"))).resolve(!1),
			o("SharedWorkerV4MigrationUtils").isV4WorkerRunning(n("cr:6600").name)
		]).then(function(e) {
			var n = e[0], r = e[1], o = e[2];
			return t.sharedLockHeld = n, t.workerIdLockHeld = r, t.v4Running = o, n && r ? {
				data: t,
	...
	function h(e) {
		return p ? (o("MAWMIC").addPoint(e + "_wait_on_worker_creation"), o("MAWInit").MAWInit.logPoint(e + "_wait_on_worker_creation"), p) : (o("MAWInit").MAWInit.logPoint(e + "_create_worker_start"), o("MAWMIC").addPoint(e + "_create_worker_start"), p = (o("shouldUseMAWSharedWorker").shouldUseMAWSharedWorker() ? y(e) : C().then(function(e) {
			return {
				worker: e,
				workerID: "dedicated"
			};
	...
	function y(e) {
		var t = function(t, n, o) {
			r("promiseDone")(m.promise.then(function() {
				return d(t, n, o);
			}));
		};
		o("MAWWorkerWatchdogRecovery").setRecoveryForWatchdog(t);
		var a = new (r("Deferred"))(), i = (function() {
			var i = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var i = yield o("SharedWorkerV4MigrationUtils").isV2WorkerRunning(n("cr:6600").name);
				if (o("MAWMIC").addBoolAnnotation("v2WorkerAlive", i), !i && "SharedWorker" in window && o("SharedWorkerMigrationUtils").supportsNativeWebLocks() && o("MawSharedWorkerV4Gating").isWorkerV4()) {
					...
					try {
						var l = yield o("SharedWorkerV4Resource").createSharedWorkerV4(n("cr:6600"), t, {
							onQPLEvent: o("MAWStartupLoggingUtils").logSharedWorkerQPLEvents,
							reason: e
						}), s = l.worker, c = l.workerID, d = l.workerType;
						return u(s), o("MAWMIC").addPoint("shared_worker_v4_created"), o("MAWMIC").addStringAnnotation("workerID", c), o("MAWMIC").addStringAnnotation("workerType", d), s.addEventListener("error", function(e) {
				...
				var m = r("gkx")("7313");
				o("MAWMIC").addBoolAnnotation("migrationEnabled", m), yield o("SharedWorkerV4MigrationUtils").detectAndTerminateV4Worker(n("cr:6600").name);
	...
	function C() {
		return (e || (e = n("Promise"))).resolve(o("WebWorkerV2Resource").createDedicatedV2WebWorker(n("cr:6600"))).then(function(e) {
	...
	l.getSharedWorkerInstance__TEST_ONLY = c, l.doesWorkerExist = _, l.getWorkerHealthStatus = f, l.resetWorkerCreation = g, l.createWorkerIfNone = h, l.setOnCloseForWorkerInstance = b;
}), 98);
