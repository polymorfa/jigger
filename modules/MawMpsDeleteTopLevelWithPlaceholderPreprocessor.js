__d("MawMpsDeleteTopLevelWithPlaceholderPreprocessor", [
	...
	var e, s = o("MpsPreprocessor").preprocessor((function() {
		var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var a = t.ctx, i = t.payloadList, l = new Map(), s = [], u = (function() {
				...
				return r === o("MpsTypes").ActionType.DeleteTopLevelWithPlaceholder ? u(e, t) : (s[t] = [e], null);
			}).filter(Boolean);
			return c.length !== 0 && (yield (e || (e = n("Promise"))).all(c)), {
				ctx: a,
				errors: l,
				payloadList: s.flat().filter(Boolean)
			};
		});
		return function(e) {
			return t.apply(this, arguments);
		};
	})(), "delete_top_level_with_placeholder");
	l.MawMpsDeleteTopLevelWithPlaceholderPreprocessor = s;
}), 98);
