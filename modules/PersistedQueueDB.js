__d("PersistedQueueDB", [
	"FBLogger",
	"PersistedQueuesSchema",
	"Promise",
	"WAResolvable",
	"WormEAR",
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				var m = o("PersistedQueuesSchema").makePersistedQueueSchema(i, d, a, l, function(t) {
				...
				throw r("FBLogger")("messenger_web").catching(r("getErrorSafe")(e)).mustfix("Error performing PersistedQueue init"), e;
			}
	...
	l.makePersistedQueues = c, l.getPersistedQueues = m;
}), 98);
