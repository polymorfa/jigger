__d("Promise", ["cr:6640"], (function(t, n, r, o, a, i) {
	...
	l.allSettled || (l.allSettled = function(e) {
		var t;
		if ((typeof Symbol == "function" ? Symbol.iterator : "@@iterator") in e) t = Array.from(e);
		else return new l(function() {
			var e = new TypeError("Promise.allSettled must be passed an iterable.");
			throw e.stack, e;
		});
		for (var n = Array(t.length), r = function() {
			var e = t[o], r = typeof e == "object" && e !== null && typeof e.then == "function";
