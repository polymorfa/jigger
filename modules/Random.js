__d("Random", ["Alea", "ServerNonce"], (function(t, n, r, o, a, i) {
	"use strict";
	var e = 4294967296, l = n("ServerNonce").ServerNonce, s;
	function u() {
		return s == null && (s = n("Alea")(l)), s;
	}
	var c = {
		random: (function() {
			var n = typeof Uint32Array == "function" ? new Uint32Array(1) : null, r = t.crypto || t.msCrypto;
			if (n != null) try {
