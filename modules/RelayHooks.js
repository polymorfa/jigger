__d("RelayHooks", [
	...
	"use strict";
	var e = n("ReactiveExecutorResolverFragments").readFragment, l = n("RelayFBEnvironmentActorID").useActorID, s = n("RelayFBEnvironmentActorID").useActorIDNullable, u = n("react-relay/relay-hooks/loadQuery").loadQuery, c = n("relay-runtime").fetchQuery, d = n("relay-runtime").graphql, m = n("relay-runtime").readInlineData;
	n("configureRelayForWWW")(), a.exports = {
		...
		preloadQuery_DEPRECATED: n("react-relay/relay-hooks/preloadQuery_DEPRECATED"),
		prepareEntryPoint_DEPRECATED: n("react-relay/relay-hooks/prepareEntryPoint_DEPRECATED"),
		readInlineData: m,
		useActorID: l,
