__d("SecureMessageListener", [
	...
	var e, s = (function() {
		function t(e, t) {
			var n = this;
			this.$3 = null, this.$4 = !1, this.$1 = e, this.$6 = t, this.$5 = function(e) {
				n.run(e);
			};
		}
		var n = t.prototype;
		return n.setEventHandler = function(t) {
			...
			if (this.$2) {
				var e = function(n) {
					o("SecurePostMessage").sendMessageToSpecificOrigin(t.source, n, t.origin);
				};
				this.$2(t, e);
			}
