__d("URI", [
	...
	var e, s, u, c = r("memoize")(function() {
	...
	var m = (function(a) {
		function i(t, n, i) {
			var l = o("UriNeedRawQuerySVChecker").isUriNeedRawQuery(t) ? r("PHPQuerySerializerNoEncoding") : e || (e = r("PHPQuerySerializer"));
			return a.call(this, t, l, n, i) || this;
		}
		babelHelpers.inheritsLoose(i, a);
		var l = i.prototype;
		return l.setPath = function(t) {
			...
			var e = t;
			return e == null ? e = c() : e instanceof i || (e = new i(e.toString())), a.prototype.isSameOrigin.call(this, e);
		}, i.goURIOnNewWindow = function(t) {
			i.goURIOnWindow(t, window.open("", "_blank"), !0);
		}, i.goURIOnWindow = function(t, n, r, o) {
			r === void 0 && (r = !1), o === void 0 && (o = !1), i.goURIOnWindowWithReference(t, n, r, o);
		}, i.goURIOnWindowWithReference = function(n, a, l, u) {
			l === void 0 && (l = !1), u === void 0 && (u = !1);
			var e = new i(n), c = l, d = !a || a === window;
			...
			var p = e.toString(), _ = a || window, f = window.location.href === p && _ === window;
			return !c && t.PageTransitions ? t.PageTransitions.go(p, u) : f ? o("ReloadPage").now() : u ? _.location.replace(p) : _.location.href = p, _;
		}, l.go = function(t, r) {
			if (n("cr:1078")) {
				n("cr:1078")(this, t, r);
				return;
			...
			var t = (u || (u = r("URIBase"))).tryParse(n, e || (e = r("PHPQuerySerializer")));
			return t ? new i(t) : null;
		}, i.isValidURI = function(n) {
			return (u || (u = r("URIBase"))).isValid(n, e || (e = r("PHPQuerySerializer")));
			...
			var e = d();
			return e ? e.getMostRecentURI().getQualifiedURI() : new i(window.location.href);
		}, i.getNextURI = function() {
			var e = d();
			return e ? e.getNextURI().getQualifiedURI() : new i(window.location.href);
			...
			return t != null && typeof t == "string" ? this.normalizeString(t) : new i(t).toString();
		}, i;
	})(u || (u = r("URIBase")));
	m.go = function(e, t, r) {
		n("cr:1080") && n("cr:1080")("URI.go"), m.goURIOnWindow(e, window, t, r);
	}, m.normalizeString = r("memoizeStringOnly")(function(e) {
		return new m(e).toString();
	}), m.expression = /(((\w+):\/\/)([^\/:]*)(:(\d+))?)?([^#?]*)(\?([^#]*))?(#(.*))?/, m.arrayQueryExpression = /^(\w+)((?:\[\w*\])+)=?(.*)/, l.default = m;
}), 98);
