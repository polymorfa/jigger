__d("VideoPlayerImplementationEngineVideoElementAPI", [
	...
	function m(e) {
		var t = [];
		try {
			for (var n = e.buffered, r = 0; r < n.length; ++r) t.push({
				endTime: n.end(r),
				startTime: n.start(r)
			});
		} catch (e) {}
	...
	function g(t) {
		var a = null, i = 0, l = function() {
			var e = o("VideoPlaybackQuality").getFramesSnapshot(t), n = e.droppedFrames, r = e.totalFrames;
			return {
				droppedFrameCount: n,
				totalFrameCount: r
			};
		...
		return {
			exitPictureInPicture: function() {
				window.document.exitPictureInPicture().catch(function(e) {
					r("FBLogger")("comet_video_player").catching(r("getErrorSafe")(e)).mustfix("Failed to exit picture-in-picture mode");
				});
			},
			...
			getCanPlayPromise: function() {
				return new (s || (s = (n("Promise"))))(function(e, n) {
					t.readyState === 4 ? e() : t.addEventListener("canplay", function() {
						return e();
					});
				});
			},
			...
			getFrameCounts: function() {
				if (u <= 0 || typeof (e || (e = r("performance"))).now != "function") return l();
			...
			getVideoPixelsDecodedDimensions: function() {
				var e = t.videoWidth, n = t.videoHeight;
				return e <= 0 || n <= 0 ? null : {
					height: n,
					width: e
				};
			...
			play: function() {
				var e = t.play(), r = e instanceof (s || (s = n("Promise"))) ? (s || (s = n("Promise"))).resolve(e) : null;
				return r;
			},
			requestPictureInPicture: function() {
				typeof t.requestPictureInPicture == "function" && t.requestPictureInPicture();
			},
			...
			setPlayheadPosition: function(n) {
				var e = n;
				if (n === 0) {
					var o = r("VideoPlayerOzWWWGlobalConfig").getNumber("clamp_seek_to_first_buffer_range_epsilon", 0);
					if (o > 0) {
						var a = f(t);
						a > 0 && a <= o && (e = a);
					}
	...
	l.getBufferedRangesFromVideoElement = m, l.createVideoPlayerImplementationEngineVideoElementAPI = g;
}), 98);
