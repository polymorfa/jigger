__d("VideoPlayerImplementationStateMachine", [
	"FBLogger",
	...
	"use strict";
	function e(e, t, n) {
		var a = t.type !== "dom_event_seeking", i = a ? n : e.uncontrolledState, l = !r("shallowEqual")(i, e.uncontrolledState), s = o("VideoPlayerControlledStateReducer").controlledStateReducer(e.controlledState, i, t, e.playerVersion), u = !r("shallowEqual")(s, e.controlledState);
		return l || u ? babelHelpers.extends({}, e, {
	...
	var s, u;
	function c(t) {
		var n = t.collectUncontrolledState, o = t.debugLogId, a = t.initialState, i = t.onDispatched, l = t.onFatalError, s = a, u = s, c = 0, d = !1, m = !1, p = !0, _ = !0;
		return {
			dispatch: function(o) {
				if (_) {
					var t = null, a = null;
					try {
						if (++c, c >= 10) {
							if (d) return;
							throw d = !0, r("FBLogger")("comet_video_player").mustfixThrow("Video player state machine loop detected");
						}
	...
	var d, m;
	function p(e) {
		var t = e.collectUncontrolledState, n = e.debugLogId, r = e.initialState, o = e.onFatalError, a = e.stateTransitionHandlers;
		function i(e, t, n) {
			try {
	...
	function _(e, t) {
		...
		return {
			...
			onProgress: i(function(e, t) {
				return {
					payload: { bufferedRanges: o("VideoPlayerImplementationEngineVideoElementAPI").getBufferedRangesFromVideoElement(t) },
	...
	l.createVideoPlayerImplementationStateMachine = c, l.createVideoPlayerImplementationStateMachineWithStateTransitionHandlers = p, l.createReactVideoElementCallbacksForStateMachine = _;
}), 98);
