__d("WAArmadilloXMA.pb", ["WACommon.pb", "WAProtoConst"], (function(t, n, r, o, a, i, l) {
	var e, s, u = {
		SENDER_COPY: 0,
		SERVER: 1,
		SIGNED_CLIENT: 2
	...
	_.name = "ExtendedContentMessage", _.internalSpec = {
		associatedMessage: [
			1,
	...
	}, f.name = "ExtendedContentMessage$CTA", f.internalSpec = {
		buttonType: [
			1,
			e.TYPES.ENUM,
			d
	...
	}, l.EXTENDED_CONTENT_MESSAGE_XMA_DATACLASS_TYPE = u, l.EXTENDED_CONTENT_MESSAGE_OVERLAY_ICON_GLYPH = c, l.EXTENDED_CONTENT_MESSAGE_CTA_BUTTON_TYPE = d, l.EXTENDED_CONTENT_MESSAGE_XMA_LAYOUT_TYPE = m, l.EXTENDED_CONTENT_MESSAGE_EXTENDED_CONTENT_TYPE = p, l.ExtendedContentMessageSpec = _, l.ExtendedContentMessage$CTASpec = f;
}), 98);
