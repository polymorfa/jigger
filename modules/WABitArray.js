__d("WABitArray", ["err"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = 8, s = (function() {
		function t(t) {
		...
		return n.get = function(t) {
			...
			if (n < 0 || n >= this.$1) throw r("err")("BitArray:index out of bounds");
			var t = Math.floor(n / e), o = n - t * e;
			return [t, o];
		}, t;
	})();
	l.default = s;
