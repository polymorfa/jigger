__d("WAComms", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $, P, N, M, w, A, F, O, B, W, q, U, V = null, H = function(t, n, r) {
		return new K(t, n, r);
	};
	function G(e) {
		H = e;
	...
	var j = 0, K = (function() {
		function t(t, r, a, i) {
			var l = this, E, k, I;
			this.$1 = null, this.$2 = 1, this.nextSocketId = 1, this.pendingIqs = new Map(), this.ackHandlers = [], this.pendingSmaxStanzas = new Map(), this.$4 = new (o("WAResolvable")).Resolvable(), this.socketAbortController = null, this.activePing = null, this.$5 = new Set(), this.$6 = 0, this.$7 = 0, this.socketId = j, this.socket = null, this.softCloseSocket = null, this.setOnBeforeCastStanzaForE2E = function(e) {
				l.config.handlers.onBeforeCastStanzaForE2E = e;
			}, this.getAndIncrementNextOrderedId = function() {
				return l.$2++;
			}, this.waitForNetworkHealth = function() {
				return l.$1 || (l.$1 = new (o("WAResolvable")).Resolvable()), l.$1.promise;
			}, this.handleStanza = function(t, r, a) {
				var i = o("WASmaxParseUtils").attrString(t, "id");
				if (i.success && t.tag !== "receipt") {
					var u = i.value, c = l.pendingSmaxStanzas.get(u);
					if (c) return l.pendingSmaxStanzas.delete(u), c.resolve(t), l.maybeScheduleHealthCheck(), (U || (U = n("Promise"))).resolve("NO_ACK");
				}
				var d = be(t);
				if (d != null) {
					var m = l.pendingIqs.get(d);
					m ? (l.pendingIqs.delete(d), m.resolve(t), l.maybeScheduleHealthCheck()) : (o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["handleIq no handler for iq with id ", ""])), d), o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose(["handleIq no handler for iq"]))));
				} else if (t.tag === "ack") l.handleAck(t);
				else return t.tag === "failure" && l.config.shouldBlockReceivingUntilSuccess ? l.$3(t, r, a) : l.$4.promise.then(function() {
					return l.$3(t, r, a);
				});
				return (U || (U = n("Promise"))).resolve("NO_ACK");
			}, this.deadSocketTimer = new (o("WAShiftTimer")).ShiftTimer(function(e) {
				e === l.socketId && (o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[comms] Socket ", " expired"])), e), l.softCloseSocket && l.softCloseSocket());
			}), this.healthCheckTimer = new (o("WAShiftTimer")).ShiftTimer(function() {
				l.socketId && l.sendPing();
			}), this.stopComms = function() {
				var e;
				l.socketLoop.endWithValue(), (e = l.socket) == null || e.close();
			}, this.closeSocketAndPreventRetry = function() {
				l.socketLoop.endWithValue(), l.socket && (o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[comms] closeSocketAndPreventRetry called"]))), l.socket.close());
			}, this.closeSocketAndPause = function() {
				l.socketLoop.pauseOnNextIteration(), l.socket && (o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[comms] closeSocketAndPause called"]))), l.socket.close());
			}, this.closeSocketAndResume = function() {
				l.socketLoop.unpause(), l.socket && (o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["[comms] closeSocketAndResume called"]))), l.socket.close());
			}, this.openSocketLoop = function() {
				l.socketLoop.start();
			}, this.maybeResetSocketLoop = function() {
				o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["[comms] maybeResetSocketLoop"]))), l.isSocketConnected() || l.socketLoop.reset();
			}, this.forceResetSocketLoop = function() {
				l.socketLoop.reset();
			}, this.forceAbortSocketConnection = function() {
				var e;
				(e = l.socketAbortController) == null || e.abort(), l.softCloseSocket == null || l.softCloseSocket();
			}, this.closeSocket = function() {
				l.socket && (o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["[comms] Socket ", " closed"])), l.socketId), o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["[comms] closeSocket called"]))), l.socket.close());
				...
				e && (o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["closeSocket called"]))), e.setOnClose(function() {
					var e = l.socketId;
					o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose(["[comms] Socket ", " closed"])), e), l.activePing && e === l.activePing.socketId && (l.activePing.handler.resolve(), l.activePing = null), l.filterPending(function(t) {
						return t.attachedToSocketId === e;
					}).forEach(function(e) {
						return void l.removeHandler(e);
					}), e === l.socketId && (l.socketId = j, l.socket = null, l.$8(!1, j));
				}), e.close());
				...
				var e, t = l.nextSocketId++;
				o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose(["[comms] Socket ", " opening"])), t);
				var n = function() {
					l.onConnectionChange("in_handshake");
				};
				return l.config.handlers.onSocketLoopIteration == null || l.config.handlers.onSocketLoopIteration(l.socketAbortController), typeof AbortController == "function" && (l.socketAbortController = new AbortController()), l.config.openChatSocket(n, (e = l.socketAbortController) == null ? void 0 : e.signal).then(function(e) {
					if (e.success) {
						var n = e.value;
						l.config.handlers.onSocketOpen == null || l.config.handlers.onSocketOpen();
						var r = new (o("WAResolvable")).Resolvable();
						return o("WALogger").LOG(C || (C = babelHelpers.taggedTemplateLiteralLoose(["[comms] Socket ", " opened"])), t), l.socketId = t, l.socket = n, l.$7 = self.performance.now(), l.$6 = 0, l.$8(!0, t), l.softCloseSocket = function() {
							l.softCloseSocket = null, l.socket && l.config.shouldCloseStaleSocket && (l.socket.close(), l.socket = null, l.$8(!1)), r.resolve();
						}, l.socketLoop.resetTimeoutAfter(1e4), l.deadSocketTimer.cancel(), l.maybeScheduleHealthCheck(), n.setOnFrame(function(e) {
							return l.parseAndHandleStanza(t, e);
						}), n.setOnClose(function() {
							o("WALogger").LOG(b || (b = babelHelpers.taggedTemplateLiteralLoose(["[comms] Socket ", " closed"])), t), l.activePing && t === l.activePing.socketId && (l.activePing.handler.resolve(), l.activePing = null), l.filterPending(function(e) {
								return e.attachedToSocketId === t;
							}).forEach(function(e) {
								return void l.removeHandler(e);
							}), t === l.socketId && (l.socketId = j, l.socket = null, l.$8(!1, t), l.onConnectionChange("disconnected"), l.config.handlers.onDisconnect == null || l.config.handlers.onDisconnect(), r.resolve());
						}), l.onConnectionChange("connected"), l.config.handlers.onConnect == null || l.config.handlers.onConnect(), l.filterPending(function(e) {
			...
			}, this.$8 = i != null ? i : function() {}, this.$3 = t, this.onConnectionChange = o("WANotifyConnectionChangeFactory").notifyConnectionChangeFactory((E = r.handlers.onConnectionChange) != null ? E : function() {}, (k = r.handlers.onOptimisticConnectionChange) != null ? k : function() {}), this.gzipInflate = a, this.config = r, this.socketLoop = new (o("WAPromiseRetryLoop")).PromiseRetryLoop({
				name: "MainSocketLoop",
				code: le,
				timer: (I = r.socketReconnectBackoffAlgo) != null ? I : {
					jitter: .1,
		...
		return a.setSocket = function(t) {
			...
			var e = this;
			try {
				var a, i, l = (a = (i = this.config.handlers).onBeforeCastStanzaForE2E) == null ? void 0 : a.call(i, t, r);
				if (l != null) return o("WALogger").DEV_XMPP(k || (k = babelHelpers.taggedTemplateLiteralLoose(["Dropping stanza since onBeforeCastStanza matched:\n", ". We return mock response directly."], ["Dropping stanza since onBeforeCastStanza matched:\\n", ". We return mock response directly."])), t), o("WALogger").DEV_XMPP(I || (I = babelHelpers.taggedTemplateLiteralLoose(["--- Receive (via SMAX+E2E) ---\n", ""], ["--- Receive (via SMAX+E2E) ---\\n", ""])), l), o("WALogger").ERROR(T || (T = babelHelpers.taggedTemplateLiteralLoose(["Dropping stanza since onBeforeCastStanza matched. We return mock response directly."]))), Array.isArray(l) ? (U || (U = n("Promise"))).all(l.map(function(t) {
					return (U || (U = n("Promise"))).resolve(e.handleStanza(t, e.socketId, j));
				})) : (this.handleStanza(l, this.socketId, j), (U || (U = n("Promise"))).resolve());
			} catch (e) {
			...
			try {
				return o("WALogger").DEV_XMPP(x || (x = babelHelpers.taggedTemplateLiteralLoose(["--- Sending ---\n", ""], ["--- Sending ---\\n", ""])), t), s.sendFrame(o("WAWap").encodeStanza(t)).then(function() {
					e.config.handlers.onCastStanza == null || e.config.handlers.onCastStanza(t, r);
				}).catch(function(e) {
					if (o("WALogger").ERROR($ || ($ = babelHelpers.taggedTemplateLiteralLoose(["castStanza async error ", ""])), e), e instanceof o("WAErrors").BufferTooLargeError) return (U || (U = n("Promise"))).reject(e);
				});
			} catch (e) {
			...
			var r = o("WAWap").decodeStanza(n, this.gzipInflate).catch(function(e) {
				...
				var a = e.activePing;
				return a && a.socketId === t && a.stanzaId === be(r) ? (e.activePing = null, a.handler.resolve(r), e.maybeScheduleHealthCheck(), "NO_ACK") : e.handleStanza(r, t, n.byteLength);
			}).then(function(n) {
				if (t === e.socketId) {
					if (n === "CLOSE_SOCKET") {
			...
			if (r === void 0 && (r = "disconnect"), t.type === "iq" || t.type === "smax") {
				...
				if (a === -1) return;
				o("WAArrayUtils").removeIndexWithoutPreservingOrder(this.ackHandlers, a);
			}
			r === "disconnect" ? t.resolve((U || (U = n("Promise"))).reject(new (o("WAErrors")).Disconnected())) : r === "abort" ? t.resolve((U || (U = n("Promise"))).reject(new (o("WAErrors")).Aborted())) : t.resolve((U || (U = n("Promise"))).reject(new (o("WAErrors")).MaxRetries()));
			...
			var e = this;
			return i === void 0 && (i = 0), s === void 0 && (s = "iq"), new (U || (U = (n("Promise"))))(function(u) {
				var c = t.attrs.id;
				if (!c || typeof c != "string") throw r("err")("[comms] sendIq given iq without id: " + String(t));
				var d = e.socketId;
				if (a && !d) {
					u((U || (U = n("Promise"))).reject(new (o("WAErrors")).Offline()));
					return;
				}
				var m = function(o) {
					o === void 0 && (o = "disconnect");
					var t = s === "iq" ? e.pendingIqs.get(c) : e.pendingSmaxStanzas.get(c);
					if (!t) {
						u((U || (U = n("Promise"))).reject(r("err")("[comms] _sendIq unexisting stanza to be cancelled: " + c)));
						return;
					}
					e.removeHandler(t, o);
				}, p = null;
				...
				if (l != null) if (l.aborted) {
					u((U || (U = n("Promise"))).reject(new (o("WAErrors")).Disconnected()));
					return;
				} else {
					var f = function() {
						m("abort");
					};
					l.addEventListener("abort", f), p = function() {
				...
				if (s === "iq") {
					...
					e.pendingIqs.set(c, h), e.config.handlers.onSendIq == null || e.config.handlers.onSendIq(t), e.maybeSendPendingStanza(h);
				} else {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				var r = Date.now();
				this.callStanza(e);
				var a = yield n.promise, i = Date.now();
				if (a) {
	...
	function ie() {
		var e, t;
		return (e = (t = V) == null ? void 0 : t.getMsSinceLastInboundRx()) != null ? e : -1;
	}
	function le() {
	...
	l.setCommsFactory = G, l.toSocketId = z, l.DEFAULT_SOCKET_ID = j, l.Comms = K, l.getComms = Q, l.startComms = X, l.stopComms = Y, l.closeSocketAndPreventRetry = J, l.closeSocketAndPause = Z, l.closeSocketAndResume = ee, l.openSocketLoop = te, l.maybeResetSocketLoop = ne, l.forceResetSocketLoop = re, l.forceAbortSocketConnection = oe, l.isSocketConnected = ae, l.getMsSinceLastInboundRx = ie, l.socketLoopIteration = le, l.closeSocket = se, l.onStreamErrorReceived = ue, l.waitForConnection = ce, l.castSmaxStanza = de, l.isActiveSocket = me, l._sendIq = pe, l.sendSmaxStanza = _e, l.sendPing = fe, l.startHandlingRequests = ge, l.cancelDeadSocketTimer = he, l.isCommsInitialized = ye, l.singletonOrThrowIfUninitialized = Ce, l.getAndIncrementNextOrderedId = ve, l.resetStateForTests = Se;
}), 98);
