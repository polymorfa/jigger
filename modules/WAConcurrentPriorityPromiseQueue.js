__d("WAConcurrentPriorityPromiseQueue", [
	...
	var e, s = (function() {
		...
		var o = t.prototype;
		return o.clearQueue = function() {
			this.$5.clear(), this.$4.clear();
		}, o.enqueue = function(r, o) {
			var t, a, i = new (e || (e = (n("Promise"))))(function(e, n) {
				t = e, a = n;
			});
			return this.$6(babelHelpers.extends({}, o, { run: (function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this, n = e.group, r = e.run, o = e.signal, a = this.$12(n);
				if (o != null && o.aborted) {
					setTimeout(function() {
						return t.$7();
					}, this.$3);
				...
				try {
					...
					a.delete(e), setTimeout(function() {
						return t.$7();
					}, this.$3);
				}
			});
