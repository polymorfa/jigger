__d("WAConcurrentPriorityPromiseQueue", [
	...
	var e = (function() {
		function e(e, t, n) {
			n === void 0 && (n = 0), this.$1 = e, this.$2 = t, this.$3 = n, this.$4 = new Map(), this.$5 = new Map();
		}
		var t = e.prototype;
		return t.clearQueue = function() {
			this.$5.clear(), this.$4.clear();
		}, t.enqueue = function(t, n) {
			var e, r, o = new Promise(function(t, n) {
				e = t, r = n;
			});
			return this.$6(babelHelpers.extends({}, n, { run: async function() {
				try {
					var n = await t();
					e(n);
				} catch (e) {
			...
			for (; this.getRunningTasksCount() < this.$1;) {
				...
				this.$11(e).catch(function(e) {
					r("FBLogger")("wmi_wa").catching(r("getErrorSafe")(e)).mustfix("WAConcurrentPriorityPromiseQueue: Task execution failed");
				});
			}
		}, t.$11 = async function(t) {
			var e = this, n = t.group, r = t.run, o = t.signal, a = this.$12(n);
			if (o != null && o.aborted) {
				setTimeout(function() {
					return e.$7();
				}, this.$3);
			...
			try {
				...
				a.delete(t), setTimeout(function() {
					return e.$7();
				}, this.$3);
			}
		}, t.$10 = function() {
