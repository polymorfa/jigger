__d("WACryptoPkcs7", ["WACryptoDependencies", "err"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e) {
	...
	function s(e) {
		var t = new Uint8Array(1);
		o("WACryptoDependencies").getCrypto().getRandomValues(t), u(e, (t[0] & 15) + 1);
	}
	function u(e, t) {
	...
	function c(e) {
		...
		var t = e[e.length - 1];
		if (t > e.length) throw r("err")("unpadPkcs7 given " + e.length + " bytes, but pad is " + t);
