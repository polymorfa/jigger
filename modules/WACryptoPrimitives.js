__d("WACryptoPrimitives", ["cr:8712"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e, s = {
	...
	l.lowlevel = s, l.keypairFromSecretKey = e.box.keyPair.fromSecretKey, l.keyPair = e.box.keyPair, l.signDetachedVerify = e.sign.detached.verify, l.hash = e.hash, l.scalarMult = e.scalarMult, l.secretbox = e.secretbox, l.verify = e.verify;
}), 98);
