__d("WACryptoSha256HmacBuilder", [
	...
	"use strict";
	function e() {
		return r("gkx")("24703") ? new (o("WACryptoSha256BuilderV2")).Sha256BuilderV2() : new (o("WACryptoSha256Builder")).Sha256Builder();
	}
	var s = (function() {
		function t(t) {
		...
		return n.reset = function(n) {
			this.$2 = new Uint8Array(64), n.length > 64 ? this.$2.set(e().update(n).finish(), 0) : this.$2.set(n, 0);
