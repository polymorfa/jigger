__d("WADanglingQueue", [
	...
	async function f() {
		var e = u;
		u = [], await d().addAndCommit(e);
	}
	function g() {
		return d().clear();
	}
	l.initDanglingQueue = c, l.isDanglingQueueEmpty = m, l.danglingQueueRead = p, l.danglingQueueAdd = _, l.danglingQueueCommit = f, l.danglingQueueClear = g;
}), 98);
