__d("WADefaultJobNoQueue", [
	...
	var e = (function() {
		...
		return t.init = function(t, n) {
			...
			this.$1 = n, this.$2 = !0;
		}, t.updateConfig = function(t) {}, t.isInitialized = function() {
			return this.$2;
		}, t.clearQueue = function() {}, t.clearQueueByPriority = function(t) {}, t.getSnapshot = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				var r, a, i = (r = n == null ? void 0 : n.jobId) != null ? r : o("WARandomHex").randomHex(8).substr(0, 64);
				this.$1.logJobCreated({
					jobId: i,
					jobName: e,
					jobPriority: (a = n == null ? void 0 : n.priority) != null ? a : o("WAJobOrchestratorTypes").JOB_PRIORITY.LOW,
					pendingJobsCount: 0
				});
				try {
