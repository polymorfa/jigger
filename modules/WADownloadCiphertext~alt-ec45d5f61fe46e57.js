__d("WADownloadCiphertext", [
	...
	var e, s, u, c, d, m, p;
	async function _(t) {
		var n = t.abortSignal, a = t.directPath, i = t.eventFlow, l = t.fileEncSha256, _ = t.fromBytes, f = t.mediaTypeDetails, h = t.plaintextHash, y = t.toBytes;
		o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Start download ciphertext for hash: ", ""])), o("WAHashUtils").sanitisePlaintextHash(h)), i.addPoint("create_retrier_start");
		var C = await o("WACreateMediaDownloadRetrier").createMediaDownloadRetrier({
			mediaTypeDetails: f,
			directPath: a,
			eventFlow: i,
			fileEncSha256: l
		...
		var b = C.value, v = b.mediaRouteDetails, S = b.retrier, R = await S.run(function(e, t, r) {
			...
			return o("WALogger").DEV_XMPP(s || (s = babelHelpers.taggedTemplateLiteralLoose([
				...
				". Attempt: ",
				""
			])), o("WAHashUtils").sanitisePlaintextHash(h), f, r), i.addPoint(p + "_start"), o("WAHttpDownloadMedia").httpDownloadMedia(f, {
				mediaMetrics: i,
				abortSignal: n,
		...
		if (R.success === !1) {
			...
			var E = R.value;
			return !g(_, y) && !o("WACryptoUtils").arrayBuffersEqual(await o("WACryptoSha256").sha256(E), l) ? o("WAResultOrError").makeError("ciphertext-hash-mismatch") : (i.addPoint("download_finish", {
				int: { byteLength: E.byteLength },
				bool: { isPartialDownload: g(_, y) }
			}), o("WAResultOrError").makeResult(E));
		}
	}
	var f = o("WAPromiseManagement").cacheWhilePending(function(e) {
