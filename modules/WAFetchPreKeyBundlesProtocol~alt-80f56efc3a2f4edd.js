__d("WAFetchPreKeyBundlesProtocol", [
	...
	async function m(t, n) {
		...
		var r = n != null ? n : !1, a = await o("WASmaxPreKeysFetchKeyBundlesRPC").sendFetchKeyBundlesRPC({
		...
		switch (a.name) {
			case "FetchKeyBundlesResponseSuccess": {
				...
				return a.value.listUser.map(function(e) {
					...
					t.name === "FetchKeyBundlesUserSuccess" && i.set(e.jid, p(t.value));
	...
	function p(e) {
		var t = o("WAConvertRegistrationIdMixin").registrationIdMixin(e), n = o("WASignalKeys").serializeIdentity(e.elementValue), r = o("WAConvertSignedPreKeyMixin").convertSignedPreKeyMixin(e), a = e.preKeyMixin ? _(e.preKeyMixin) : null, i = e.pQKeyMixin ? f(e.pQKeyMixin) : null, l = o("WATimeUtils").castToUnixTime(e.t || 0);
		return {
			keys: {
				regId: t,
				identity: n,
