__d("WAFlowsCartUtils.react", [
	...
	async function g(e, t, n, a) {
		var i, l, u = {
			...
			products: a,
			base_checkout_url: n
		}, c = { payload: { request: u } }, d = await r("WAFlowsExternalDataChannelRequest")(c, o("WAFlowsShoppingGetCheckoutUrlRequestType").GET_CHECKOUT_URL_REQUEST_DOC_ID, e), m = (i = d == null || (l = d.data) == null || (l = l.xwa_generate_whatsapp_checkout_url) == null ? void 0 : l.cart_url_suffix) != null ? i : "";
	...
	function C(e, t, n, r, a) {
		...
		var l = d(e, t, n), s = new Map(t.map(function(e) {
			...
			return {
				...
				quantity: e.quantity,
				amount: a === o("WAFlowsShoppingCustomActionCallbacks").FLOWJIntegratedShoppingClickActionType.APPLY_COUPON ? h((t = d == null ? void 0 : d.price) != null ? t : 0) : h((r = (i = e.price) != null ? i : d == null ? void 0 : d.price) != null ? r : 0),
				name: d.name,
				sale_amount: o("WAFlowsShoppingCustomActionCallbacks").FLOWJIntegratedShoppingClickActionType.APPLY_COUPON ? h((l = d == null ? void 0 : d.sale_price) != null ? l : 0) : h((u = (c = e == null ? void 0 : e.salePrice) != null ? c : d == null ? void 0 : d.sale_price) != null ? u : 0)
			};
		}), c = (i = r.internal) == null || (i = i.shopping) == null ? void 0 : i.shoppingCart, m = b(c);
		return {
			amount: m,
			products: u
		};
	...
	function b(e) {
		...
		}, d = u == null ? void 0 : u.discount, m = d !== void 0 ? h((i = d == null ? void 0 : d.price) != null ? i : 0) : {
			value: 0,
			offset: 0
	...
	function v(e, t, n, r, a, i, l, s, u, c) {
		var d;
		if (u === void 0 && (u = !1), c === void 0 && (c = !1), !(l == null || e == null)) {
			var m = function(t) {
				var e = {};
				return t.amount && (e.price = y(t.amount.value, t.amount.offset)), t.sale_amount && (e.salePrice = y(t.sale_amount.value, t.sale_amount.offset)), e;
			...
			if (h) {
				var C, b, v, S, R = {
					price: y((C = h.discount) == null ? void 0 : C.value, (b = h.discount) == null ? void 0 : b.offset),
			...
			if (k) {
				var I, T, D = {
					totalAmount: y((I = k.total_amount) == null ? void 0 : I.value, (T = k.total_amount) == null ? void 0 : T.offset),
					currency: k.currency
				};
	...
	async function R(e, t, n, r, a) {
		var i, l, s, u, c, d, m, p, _, f, h, y, C, b, v, R, L, E = e, k = E.flowInitData, I = k[0], T = k[1], D = S((i = I == null || (l = I.environment) == null ? void 0 : l.biz_jid) != null ? i : ""), x = (s = t.internal) == null ? void 0 : s.shopping, $ = E.actionOverrides, P = (u = (c = t.internal.shopping) == null || (c = c.shoppingCart) == null ? void 0 : c.items) != null ? u : [], N = (d = (m = t.external[o("WAFlowsShoppingNavigationUtils").getViewCartScreenIdForShoppingFlow(n)]) == null || (m = m.external_data) == null || (m = m.meta_catalog) == null ? void 0 : m.products) != null ? d : [], M = P.map(function(e) {
		...
		var q = (b = x == null || (v = x.offsiteCheckout) == null || (v = v.linkoutUrls) == null ? void 0 : v.get(o("WAFlowsShoppingStateUtils").LINKOUT_BASE_CHECKOUT_URL)) != null ? b : "", U = await g($, D, q, M), V = (R = x == null || (L = x.offsiteCheckout) == null || (L = L.linkoutUrls) == null ? void 0 : L.get(o("WAFlowsShoppingStateUtils").LINKOUT_BASE_CHECKOUT_URL)) != null ? R : "";
		return w !== "" ? V = w + "?cart_url_suffix=" + U : V += atob(U), V;
	}
	async function L(e, t) {
		var n = e == null ? void 0 : e.order_details, r = t.invoke;
		await o("WAFlowsShoppingJSBridges").openNativeIntegratedShopping(r, n);
	}
	function E(e, t, n) {
	...
	l.MM_DISCLOSURE_TITLE = e, l.getCartItemsCount = c, l.getInStockItems = d, l.getOutOfStockItems = m, l.filterCartItems = p, l.getSubtotalValue = _, l.getFormattedPrice = f, l.calculatePriceFromValueAndOffset = y, l.getIntegratedShoppingFlowCart = C, l.syncIntegratedShoppingCartWithStateCart = v, l.buildCheckoutUrl = R, l.cartCheckoutCallback = L, l.getShoppingInCartItems = E;
}), 98);
