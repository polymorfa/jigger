__d("WAFlowsResponseHandler", [
	...
	function x(e, t, n, r, a, i, l) {
		...
		if (e === o("WAFlowsInitEnvironmentTypes").ResponseViewer.CONSUMER && typeof t.version != "number") s.push({
			...
			}), r && e === o("WAFlowsInitEnvironmentTypes").ResponseViewer.SMB && s.push(O({
	...
	function P(e, t, n, a, i, l) {
		...
		if (e.value != null) {
			...
			return l && t === o("WAFlowsInitEnvironmentTypes").ResponseViewer.SMB && (f["on-click-action"] = {
				name: o("WAFlowsActionHandlerTypes").WELJActionType.COPY_TEXT,
				textToCopy: W(e.value),
				notificationTitle: o("WAFlowsLocalization").getItemCopyNotficationTitleFbt(W(e.label)).toString()
			}), f;
		}
	}
	function N(e) {
	...
	function F() {
		return F = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			if (a != null) {
				var i = yield r("JSResource")("goURI").__setRef("WAFlowsResponseHandler").load();
	...
	function W(e) {
		if (e == null) return "";
		if (o("WAFlowsNativeExperienceUtils").isMediaPickerFormValue(e)) return q(e.__wa_flows_uploaded_media__.map(function(e) {
			var t;
			return (t = e.file_name) != null ? t : "";
		}).join(","));
		if (o("WAFlowsFormValidationUtils").isComponentValueArrayOfStr(e)) return q(e.join(","));
		if (typeof e == "object") {
			if (Object.prototype.hasOwnProperty.call(e, "start-date") && Object.prototype.hasOwnProperty.call(e, "end-date")) {
				var t = r("unsafeCast")(e);
				return q(t["start-date"] + ", " + t["end-date"]);
			}
	...
	l.RESPONSE_SCREEN_ID = d, l.RESPONSE_SCREEN_LOGGING_CLICK_TYPE = m, l.buildResponseMessage = g, l.removeBase64EncodingsFromStateV2 = v, l.removeActionsFromStateData = R, l.buildResponseFlowJSON = x, l.isResponseFlow = w, l.redirectToResponse = A, l.getCSVFromResponse = B;
}), 226);
