__d("WAFlowsShoppingCustomActionCallbacks", [
	...
	function S(e, t) {
		var n, r = c(o("WAFlowsStateProvider.react").FlowStateDispatchContext), a = o("ReactRouterDOM").useHistory(), i = o("WAFlowsStateProvider.react").useWAFlowsMeta(), l = o("WAFlowsStateProvider.react").useWAFlowsState(), s = o("WAFlowsEnvContext.react").useWAFlowsEnv(), d = s.env, p = o("WAFlowsEntryPointControllerContext.react").useWAFlowsEntryPointController().actionOverrides, _ = x((n = i.getScreenIdByLayoutType(o("WAFlowsTypes").WA_FLOWS_LAYOUT_NAMES.CART)) != null ? n : "CART"), f = m(t);
	...
	function L(e) {
		var t = o("WAFlowsEnvContext.react").useWAFlowsEnv(), a = t.env, i = o("WAFlowsStateProvider.react").useWAFlowsMeta(), l = o("WAFlowsStateProvider.react").useWAFlowsState(), s = o("WAFlowsEntryPointControllerContext.react").useWAFlowsEntryPointController(), u = s.invoke;
		r("useAsyncEffect")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (!(!o("WAFlowsShoppingJSBridges").isNativeCartIntegrationEnabled(i) || o("WAFlowsShoppingStateUtils").isShoppingIntegratedShoppingMessageFlow(l))) {
				var t = yield o("WAFlowsShoppingJSBridges").getRawNativeCart(s.invoke, a.isJestTesting), n = yield E(s.invoke, t, e);
				n && o("WAFlowsSnackbarUtils").showSnackbar({ text: o("WAFlowsLocalization").getCartChangedSinceLastVisitFbt() }, u);
			}
		}), [
			e,
			s.invoke,
	...
	function k() {
		return k = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			for (var a of t.cart) {
				...
				(s == null || a.title !== s.name || a.max_available !== s.max_available || a.price_1000 !== Math.round(s.price * 1e3) || ((i = a.sale_price_1000) != null ? i : 0) !== Math.round(((l = s.sale_price) != null ? l : 0) * 1e3)) && (yield I(e, s, a), o = !0);
			}
			return o;
	...
	function T() {
		return T = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			if (t == null) yield o("WAFlowsShoppingJSBridges").setRawNativeShoppingCartItem(e, babelHelpers.extends({}, n, { quantity: 0 }));
			else {
				var r;
				yield o("WAFlowsShoppingJSBridges").setRawNativeShoppingCartItem(e, babelHelpers.extends({}, n, {
					title: t.name,
	...
	function D(e, t, a, i, l, s) {
		var u = e.invoke, c = p(!1), d = c[0], m = c[1], _ = p(null), f = _[0], g = _[1];
		function y(e) {
			return C.apply(this, arguments);
		}
		function C() {
			return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
				if (!d) {
					m(!0);
					try {
						if (n === h.GO_BACK) m(!1), yield o("WAFlowsShoppingJSBridges").sendShoppingFlowsMarketingDisclosureUserAction(u, { action: "go_back" });
						else {
							var c, p, _ = null;
							n === h.CHECKOUT ? _ = yield o("WAFlowsShoppingJSBridges").getShoppingFlowsMarketingDisclosureState(e.invoke, i.isJestTesting) : yield o("WAFlowsShoppingJSBridges").sendShoppingFlowsMarketingDisclosureUserAction(u, { action: "is_accepted" });
							var f = (c = (p = _) == null ? void 0 : p.show_disclosure) != null ? c : !1;
							if (!f || n === h.CONTINUE) {
								var y = yield o("WAFlowsCartUtils.react").buildCheckoutUrl(e, t, a, i, _), C = new URL(y);
								yield o("WAFlowsOpenExternalURI").openExternalURI(C, u), o("WAFlowsShoppingStateUtils").isShoppingIntegratedShoppingMessageFlow(t) || (yield o("WAFlowsShoppingJSBridges").clearNativeCartAndCloseFlow(u));
								var b = e.actionOverrides, v = r("WAFlowsNativeWAMLogger")(b), S = v.logWAMScreenActionEvent;
								S({
									flows_current_screen: l,
									flows_current_screen_layout_type: a.getScreenLayoutType(l),
								...
								var R, L;
								yield o("WAFlowsShoppingJSBridges").sendShoppingFlowsMarketingDisclosureUserAction(u, { action: "shown" }), s(o("WAFlowsWELJActionCreators").createShoppingMMDisclosureUpdateAction(_)), s(o("WAFlowsWELJActionCreators").createShoppingMMDisclosureShowAction((R = (L = _) == null ? void 0 : L.show_disclosure) != null ? R : !1)), m(!1);
							}
						}
					} catch (e) {
						g(r("getErrorSafe")(e)), m(!1);
					}
				}
	...
	l.FLOWJIntegratedShoppingClickActionType = g, l.FLOWJOffsiteCheckoutClickActionType = h, l.useCartUpdateCallback = y, l.useCategoryClickCallback = C, l.useItemClickCallback = b, l.useOnAddMoreClickCallback = v, l.useViewCartCallback = S, l.useLoadVariantProduct = R, l.useDetectCatalogChangesAndNotifyUser = L, l.useMarketingMessageCheckoutAsyncCallback = D, l.useCartCouponClickCallback = x, l.useSyncIntegratedShoppingCartWithState = $, l.useIntegratedShoppingCartClickCallback = P;
}), 98);
