	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a) {
			if (!e.isDataChannelLess()) {
				var i = o("WAFlowsWebNativeBridgeClientABPropsContext.react").clientABPropsHandler(n.invoke), l = i.getABProps, u = yield l(), c = (u == null ? void 0 : u.extensions_propagate_errors_via_datachannel_enabled.boolValue) === !0;
				if (c && t instanceof o("WAFlowsError").WAFlowsError) {
					...
					if (!f) return;
					var g = (a == null ? void 0 : a.environment.public_key) || ((d = yield r("WAFlowsPublicKey")({ force_refresh: !0 }, n.invoke)) == null ? void 0 : d.public_key) || "";
					g != null || s(0, 73970);
					var h = a == null || (m = a.environment) == null ? void 0 : m.www_proxy_secret;
					r("WAFlowsDataChannelRequest")({
						data: _(t, e, a),
						extensionId: (p = a == null ? void 0 : a.environment.flow_id) != null ? p : "",
						publicKey: g,
						maxRetries: 0
					}, n, h);
				}
