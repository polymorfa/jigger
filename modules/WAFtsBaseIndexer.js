__d("WAFtsBaseIndexer", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f = function() {}, g = function() {
		...
		var a = t.prototype;
		return a.__resetFullIndexingProgress = function() {
			...
			return (_ || (_ = n("Promise"))).reject(new (o("WACustomError")).UnimplementedMethod("BaseIndexer.__processBatch"));
			...
			return (_ || (_ = n("Promise"))).reject(new (o("WACustomError")).UnimplementedMethod("purge"));
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, a) {
				var i = this;
				if (t === void 0 && (t = g), this.isQueuedIndexingPending()) return r("nullthrows")(this.__currentQueuedIndexingOp);
				var l = new (o("WAResolvable")).Resolvable(), m = !0;
				try {
					for (this.__isProcessingBacklog = !0, this.__currentQueuedIndexingOp = l.promise, l.promise.finally(function() {
						i.__isProcessingBacklog = !1;
					}), o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["FTS:Indexer:indexQueuedBatch: Starting new batch size : ", ""])), this.batchSize); m;) {
						if (this.signaller != null && this.signaller.shouldTerminateAll()) {
							m = !1;
							break;
						}
						var p = this.scheduler;
						if (p) a == null && o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose(["FTS:Indexer:indexQueuedBatch: Priority is null"]))), yield p.run(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
							var e = yield i.messageSource.getBacklogged({ limit: i.batchSize });
							if (e == null) {
								m = !1;
								return;
							}
							e.length !== 0 && (yield i.__processBatch(e), o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["FTS:Indexer:indexQueuedBatch: Completed batch"]))), yield t(e.map(function(e) {
								return e.id;
							})));
						}), {
							...
							var _ = yield this.messageSource.getBacklogged({ limit: this.batchSize });
							if (_ == null) {
								m = !1;
								break;
							}
							_.length !== 0 && (yield this.__processBatch(_), o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["FTS:Indexer:indexQueuedBatch: Completed batch"]))), yield t(_.map(function(e) {
								return e.id;
							})));
						}
					}
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var a = this;
				if (e === void 0 && (e = f), this.__progressCallbacks.push(e), this.isFullIndexingPending()) return r("nullthrows")(this.__currentFullIndexingOp);
				this.__resetFullIndexingProgress(), this.__isFullIndexingPending = !0;
				var i = new (o("WAResolvable")).Resolvable();
				this.__currentFullIndexingOp = i.promise, i.promise.finally(function() {
					return a.__resetFullIndexingProgress();
				});
				try {
					for (var l = this.batchSize, s = 0, u = null, c = yield this.messageSource.size(), d = [performance.now()], _ = !0; s <= c && _;) {
						...
						if (h) yield h.run(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
							var e = yield t != null ? a.messageSource.getAllAfterId(t, {
								offset: s,
								limit: l,
								fromMessageId: u
							...
							var y = yield t != null ? this.messageSource.getAllAfterId(t, {
								offset: s,
								limit: l,
								fromMessageId: u
