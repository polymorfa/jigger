__d("WAGenerateAndUploadPreKeysProtocol", [
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var t = yield o("WAGlobals").getWaOneQueue().enqueue((function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
					var n = t.cryptoManager, r = yield o("WACryptoManager").generatePreKeys(n);
				...
				flush: !0,
				afterInit: !0
			}), r = t.value, a = r.preKeys, i = r.regInfo, l = r.signedPreKey, p = { identityKeyOrPQKeyBundleMixinGroupArgs: { identityKeyBundle: babelHelpers.extends({
				registrationElementValue: o("WAWap").BIG_ENDIAN_CONTENT(i.regId),
				anyElementValue: i.staticKeyPair.publicKey,
				keyArgs: a.map(f),
				hasKeyType: !0
			}, o("WAMakeSignedPreKeyMixin").makeSignedPreKeyMixin(l)) } }, _ = new (o("WAPromiseRetryLoop")).PromiseRetryLoop({
				name: "uploadKeys",
					...
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						...
						switch (t.name) {
							case "SetResponseSuccess": {
								m.LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["Keys are successfully uploaded"]))), e(o("WAResultOrError").makeResult({ preKeys: a }));
								return;
							}
							case "SetResponseRequestError": {
								m.WARN(c || (c = babelHelpers.taggedTemplateLiteralLoose(["Got Malformed upload keys IQ on upload pre keys attempt"]))), e(o("WAResultOrError").makeError("request-error"));
								return;
							}
							default: t.name, m.WARN(d || (d = babelHelpers.taggedTemplateLiteralLoose(["Got unexpected error: ", ", will retry after backoff"])), t.name);
						}
					});
					function t(t) {
