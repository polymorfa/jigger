__d("WAGenericStateManager", ["Promise", "WAPubSub"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e, s = (function() {
		function t(e) {
		...
		return r.onSet = function(t) {
			...
			var t = this;
			return this.$1 === r ? (e || (e = n("Promise"))).resolve() : new (e || (e = (n("Promise"))))(function(e) {
