__d("WALiboqsWasm", ["Promise"], (function $module_WALiboqsWasm(global, require, requireDynamic, requireLazy, module, exports) {
		...
		return (function(moduleArg) {
			...
			var FS = {
				...
				createSpecialDirectories: function createSpecialDirectories() {
					...
					FS.mount({ mount: function mount() {
						var node = FS.createNode(proc_self, "fd", 16384 | 511, 73);
						node.node_ops = { lookup: function lookup(parent, name) {
							var fd = +name;
							var stream = FS.getStreamChecked(fd);
							var ret = {
								parent: null,
								mount: { mountpoint: "fake" },
								node_ops: { readlink: function readlink() {
									return stream.path;
								} }
							};
							ret.parent = ret;
			...
			var _encaps = Module["_encaps"] = function(a0, a1, a2, a3) {
				return (_encaps = Module["_encaps"] = wasmExports["o"])(a0, a1, a2, a3);
			};
			var _decaps = Module["_decaps"] = function(a0, a1, a2, a3) {
				return (_decaps = Module["_decaps"] = wasmExports["p"])(a0, a1, a2, a3);
			};
	...
	if (typeof exports === "object" && typeof module === "object") module.exports = createLibOQS;
