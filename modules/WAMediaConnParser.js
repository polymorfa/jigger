__d("WAMediaConnParser", ["WADeprecatedWapParser", "WAServerMediaType"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = new (r("WADeprecatedWapParser"))("mediaConnParser", function(e) {
		var t, n, r = e.child("media_conn"), o = c(r);
		return {
			hosts: o,
	...
	function s(e) {
		var t, n;
		if (e.hasAttr("fallback_hostname")) return {
	...
	function u(e) {
		...
		return {
			...
			downloadBuckets: (t = (n = e.maybeChild("download_buckets")) == null ? void 0 : n.mapChildren(function(e) {
	...
	function d(e, t) {
		return e.hasChild(t) ? e.child(t).mapChildren(function(e) {
			var t = e.tag();
			return o("WAServerMediaType").castToServerMediaType(t);
		}).filter(Boolean) : o("WAServerMediaType").SERVER_MEDIA;
	}
	l.mediaConnParser = e;
}), 98);
