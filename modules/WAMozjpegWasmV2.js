__d("WAMozjpegWasmV2", ["Promise"], (function(t, n, r, o, a, i) {
	var e, l = (function(t) {
		var r = typeof document != "undefined" ? (t = document.currentScript) == null ? void 0 : t.src : void 0;
		return (function(t) {
			t === void 0 && (t = {});
			var o, a = t, i, l, s = new (e || (e = (n("Promise"))))(function(e, t) {
				i = e, l = t;
			}), u = !1, c = !0, d = Object.assign({}, a), m = "./this.program", p = function(t, n) {
				throw n;
			}, _ = "";
			function f(e) {
				return _ + e;
			...
			var g, h;
			_ = self.location.href, r && (_ = r), _.startsWith("blob:") ? _ = "" : _ = _.substr(0, _.replace(/[?#].*/, "").lastIndexOf("/") + 1), h = function(t) {
				var e = new XMLHttpRequest();
				return e.open("GET", t, !1), e.responseType = "arraybuffer", e.send(null), new Uint8Array(e.response);
			}, g = function(r) {
				return fetch(r, { credentials: "same-origin" }).then(function(t) {
					return t.ok ? t.arrayBuffer() : (e || (e = n("Promise"))).reject(new Error(t.status + " : " + t.url));
				});
			};
			var y = console.log.bind(console), C = console.error.bind(console);
			Object.assign(a, d), d = null;
			var b, v, S = !1, R, L, E, k, I, T, D, x, $;
			function P() {
				var e = v.buffer;
				a.HEAP8 = L = new Int8Array(e), a.HEAP16 = k = new Int16Array(e), a.HEAPU8 = E = new Uint8Array(e), a.HEAPU16 = I = new Uint16Array(e), a.HEAP32 = T = new Int32Array(e), a.HEAPU32 = D = new Uint32Array(e), a.HEAPF32 = x = new Float32Array(e), a.HEAPF64 = $ = new Float64Array(e);
			}
			var N = [], M = [], w = [], A = !1;
			function F() {
				le(N);
			...
			function O() {
				A = !0, !a.noFSInit && !it.init.initialized && it.init(), it.ignorePermissions = !1, Xe.init(), le(M);
			}
			function B() {
				le(w);
			}
			...
			function z(e) {
				if (q--, q == 0 && (U !== null && (clearInterval(U), U = null), V)) {
					var t = V;
					V = null, t();
				}
			}
			function j(e) {
				e = "Aborted(" + e + ")", C(e), S = !0, R = 1, e += ". Build with -sASSERTIONS for more info.";
				var t = new WebAssembly.RuntimeError(e);
				throw l(t), t;
			}
			var K = "data:application/octet-stream;base64,", Q = function(t) {
			...
			function Z(t) {
				return b ? (e || (e = n("Promise"))).resolve().then(function() {
					return J(t);
				}) : g(t).then(function(e) {
			...
			function te(e, t, n, r) {
				return !e && typeof WebAssembly.instantiateStreaming == "function" && !Q(t) && typeof fetch == "function" ? fetch(t, { credentials: "same-origin" }).then(function(e) {
					var o = WebAssembly.instantiateStreaming(e, n);
					return o.then(r, function(e) {
						return C("wasm streaming compile failed: " + e), C("falling back to ArrayBuffer instantiation"), ee(t, n, r);
					});
				}) : ee(t, n, r);
			}
			function ne() {
			...
			function re() {
				var e = ne();
				function t(e, t) {
					return St = e.exports, v = St.x, a.wasmMemory = v, P(), _t = St.A, W(St.y), z("wasm-instantiate"), St;
				}
				G("wasm-instantiate");
				function n(e) {
					t(e.instance);
			...
			var le = function(t) {
				...
				return $t();
			}, ce = [], de = 0, me = function(t) {
				var e = new _e(t);
				return e.get_caught() || (e.set_caught(!0), de--), e.set_rethrown(!1), ce.push(e), Pt(e.excPtr), e.get_exception_ptr();
			}, pe = 0, _e = (function() {
				"use strict";
				function e(e) {
			...
			var Ee = function() {
				...
				var e = v.buffer, n = (t - e.byteLength + 65535) / 65536;
				try {
					return v.grow(n), P(), 1;
				} catch (e) {}
			}, De = function(t) {
				...
				for (var r = function(t, n) {
					...
					var i = Math.min(n, r(Math.max(t, a), 65536)), l = Te(i);
					if (l) return !0;
				}
				return !1;
			}, xe = {}, $e = function() {
				...
				if (!Pe.strings) {
					...
					for (var n in xe) xe[n] === void 0 ? delete t[n] : t[n] = xe[n];
					var r = [];
				...
				var e = 0;
				return Pe().forEach(function(r, o) {
					var a = n + e;
				...
				normalize: function(t) {
					var e = qe.isAbs(t), n = t.substr(-1) === "/";
					return t = qe.normalizeArray(t.split("/").filter(function(e) {
						return !!e;
					}), !e).join("/"), !t && !e && (t = "."), t && n && (t += "/"), (e ? "/" : "") + t;
				},
				dirname: function(t) {
					var e = qe.splitPath(t), n = e[0], r = e[1];
				...
				resolve: function() {
					for (var e = "", t = !1, n = arguments.length - 1; n >= -1 && !t; n--) {
						var r = n >= 0 ? n < 0 || arguments.length <= n ? void 0 : arguments[n] : it.cwd();
						if (typeof r != "string") throw new TypeError("Arguments to path.resolve must be strings");
						if (!r) return "";
						e = r + "/" + e, t = qe.isAbs(r);
					}
					return e = qe.normalizeArray(e.split("/").filter(function(e) {
						return !!e;
					}), !t).join("/"), (t ? "/" : "") + e || ".";
				},
			...
			}, Ge = typeof TextDecoder != "undefined" ? new TextDecoder() : void 0, ze = function(t, n, r) {
				for (var e = n + r, o = n; t[o] && !(o >= e);) ++o;
				if (o - n > 16 && t.buffer && Ge) return Ge.decode(t.subarray(n, o));
				for (var a = ""; n < o;) {
					var i = t[n++];
					if (!(i & 128)) {
			...
			function Ke(e, t, n) {
				var r = n > 0 ? n : ve(e) + 1, o = new Array(r), a = Se(e, o, 0, o.length);
			...
			var Qe = function() {
				...
				stream_ops: {
					...
					read: function(t, n, r, o, a) {
						if (!t.tty || !t.tty.ops.get_char) throw new it.ErrnoError(60);
					...
					write: function(t, n, r, o, a) {
						if (!t.tty || !t.tty.ops.put_char) throw new it.ErrnoError(60);
						try {
				...
				default_tty_ops: {
					...
					put_char: function(t, n) {
						n === null || n === 10 ? (y(ze(t.output, 0)), t.output = []) : n != 0 && t.output.push(n);
					},
					fsync: function(t) {
						t.output && t.output.length > 0 && (y(ze(t.output, 0)), t.output = []);
					},
				...
				default_tty1_ops: {
					put_char: function(t, n) {
						n === null || n === 10 ? (C(ze(t.output, 0)), t.output = []) : n != 0 && t.output.push(n);
					},
					fsync: function(t) {
						t.output && t.output.length > 0 && (C(ze(t.output, 0)), t.output = []);
					}
				}
			}, Ye = function(t) {
				j();
				...
				createNode: function(t, n, r, o) {
					...
					return it.isDir(e.mode) ? (e.node_ops = Je.ops_table.dir.node, e.stream_ops = Je.ops_table.dir.stream, e.contents = {}) : it.isFile(e.mode) ? (e.node_ops = Je.ops_table.file.node, e.stream_ops = Je.ops_table.file.stream, e.usedBytes = 0, e.contents = null) : it.isLink(e.mode) ? (e.node_ops = Je.ops_table.link.node, e.stream_ops = Je.ops_table.link.stream) : it.isChrdev(e.mode) && (e.node_ops = Je.ops_table.chrdev.node, e.stream_ops = Je.ops_table.chrdev.stream), e.timestamp = Date.now(), t && (t.contents[n] = e, t.timestamp = e.timestamp), e;
				},
				...
				node_ops: {
					getattr: function(t) {
						var e = {};
						return e.dev = it.isChrdev(t.mode) ? t.id : 1, e.ino = t.id, e.mode = t.mode, e.nlink = 1, e.uid = 0, e.gid = 0, e.rdev = t.rdev, it.isDir(t.mode) ? e.size = 4096 : it.isFile(t.mode) ? e.size = t.usedBytes : it.isLink(t.mode) ? e.size = t.link.length : e.size = 0, e.atime = new Date(t.timestamp), e.mtime = new Date(t.timestamp), e.ctime = new Date(t.timestamp), e.blksize = 4096, e.blocks = Math.ceil(e.size / e.blksize), e;
					},
					setattr: function(t, n) {
						n.mode !== void 0 && (t.mode = n.mode), n.timestamp !== void 0 && (t.timestamp = n.timestamp), n.size !== void 0 && Je.resizeFileStorage(t, n.size);
					},
					lookup: function(t, n) {
					...
					rename: function(t, n, r) {
						if (it.isDir(t.mode)) {
							...
							if (e) for (var o in e.contents) throw new it.ErrnoError(55);
						}
						delete t.parent.contents[t.name], t.parent.timestamp = Date.now(), t.name = r, n.contents[r] = t, n.timestamp = t.parent.timestamp;
					},
					unlink: function(t, n) {
				...
				stream_ops: {
					...
					write: function(t, n, r, o, a, i) {
						...
						if (Je.expandFileStorage(e, a + o), e.contents.subarray && n.subarray) e.contents.set(n.subarray(r, r + o), a);
						else for (var l = 0; l < o; l++) e.contents[a + l] = n[r + l];
						return e.usedBytes = Math.max(e.usedBytes, a + o), o;
					},
					llseek: function(t, n, r) {
						var e = n;
						if (r === 1 ? e += t.position : r === 2 && it.isFile(t.node.mode) && (e += t.node.usedBytes), e < 0) throw new it.ErrnoError(28);
						return e;
					},
					allocate: function(t, n, r) {
						Je.expandFileStorage(t.node, n + r), t.node.usedBytes = Math.max(t.node.usedBytes, n + r);
					},
					mmap: function(t, n, r, o, a) {
						if (!it.isFile(t.node.mode)) throw new it.ErrnoError(43);
						var e, i, l = t.node.contents;
						if (!(a & 2) && l.buffer === L.buffer) i = !1, e = l.byteOffset;
						else {
							if ((r > 0 || r + n < l.length) && (l.subarray ? l = l.subarray(r, r + n) : l = Array.prototype.slice.call(l, r, r + n)), i = !0, e = Ye(n), !e) throw new it.ErrnoError(48);
							L.set(l, e);
						}
						return {
							ptr: e,
				...
				var e = n ? He.resolve(qe.join2(t, n)) : t, d = "cp " + e;
				function m(r) {
					function m(e) {
						c == null || c(), s || et(t, n, e, o, a, u), i == null || i(), z(d);
					}
					nt(r, e, m, function() {
						l == null || l(), z(d);
					}) || m(r);
				...
				if (typeof n == "undefined") throw new Error("Unknown file open mode: " + t);
				return n;
			}, at = function(t, n) {
				var e = 0;
				...
				FSNode: (function() {
					"use strict";
					function e(e, t, n, r) {
						e || (e = this), this.parent = e, this.mount = e.mount, this.mounted = null, this.id = it.nextInode++, this.name = t, this.mode = n, this.node_ops = {}, this.stream_ops = {}, this.rdev = r, this.readMode = 365, this.writeMode = 146;
					}
					return babelHelpers.createClass(e, [
						{
							key: "read",
				...
				lookupPath: function(t, n) {
					...
					if (n = Object.assign(e, n), n.recurse_count > 8) throw new it.ErrnoError(32);
					for (var r = t.split("/").filter(function(e) {
						return !!e;
					}), o = it.root, a = "/", i = 0; i < r.length; i++) {
						var l = i === r.length - 1;
						if (l && n.parent) break;
						if (o = it.lookupNode(o, r[i]), a = qe.join2(a, r[i]), it.isMountpoint(o) && (!l || l && n.follow_mount) && (o = o.mounted.root), !l || n.follow) for (var s = 0; it.isLink(o.mode);) {
							var u = it.readlink(a);
							a = He.resolve(qe.dirname(a), u);
							var c = it.lookupPath(a, { recurse_count: n.recurse_count + 1 });
				...
				hashRemoveNode: function(t) {
					...
					else for (var n = it.nameTable[e]; n;) {
						if (n.name_next === t) {
				...
				lookupNode: function(t, n) {
					...
					for (var r = it.hashName(t.id, n), o = it.nameTable[r]; o; o = o.name_next) {
						var a = o.name;
				...
				nodePermissions: function(t, n) {
					return it.ignorePermissions ? 0 : n.includes("r") && !(t.mode & 292) || n.includes("w") && !(t.mode & 146) || n.includes("x") && !(t.mode & 73) ? 2 : 0;
				},
				...
				mayOpen: function(t, n) {
					return t ? it.isLink(t.mode) ? 32 : it.isDir(t.mode) && (it.flagsToPermissionString(n) !== "r" || n & 512) ? 31 : it.nodePermissions(t, it.flagsToPermissionString(n)) : 44;
				},
				MAX_OPEN_FDS: 4096,
				nextfd: function() {
					for (var e = 0; e <= it.MAX_OPEN_FDS; e++) if (!it.streams[e]) return e;
				...
				createStream: function(t, n) {
					return n === void 0 && (n = -1), t = Object.assign(new it.FSStream(), t), n == -1 && (n = it.nextfd()), t.fd = n, it.streams[n] = t, t;
				},
				...
				dupStream: function(t, n) {
					...
					return (e = r.stream_ops) == null || e.dup == null || e.dup(r), r;
				},
				chrdev_stream_ops: {
					open: function(t) {
						var e = it.getDevice(t.node.rdev);
						t.stream_ops = e.stream_ops, t.stream_ops.open == null || t.stream_ops.open(t);
					},
					llseek: function() {
				...
				syncfs: function(t, n) {
					typeof t == "function" && (n = t, t = !1), it.syncFSRequests++, it.syncFSRequests > 1 && C("warning: " + it.syncFSRequests + " FS.syncfs operations in flight at once, probably just doing extra work");
					var e = it.getMounts(it.root.mount), r = 0;
					function o(e) {
				...
				mount: function(t, n, r) {
					...
					if (!e && !o) {
						...
						if (r = i.path, a = i.node, it.isMountpoint(a)) throw new it.ErrnoError(10);
					...
					return s.mount = l, l.root = s, e ? it.root = s : a && (a.mounted = l, a.mount && a.mount.mounts.push(l)), s;
				},
				unmount: function(t) {
					var e = it.lookupPath(t, { follow_mount: !1 });
					if (!it.isMountpoint(e.node)) throw new it.ErrnoError(28);
					var n = e.node, r = n.mounted, o = it.getMounts(r);
				...
				mknod: function(t, n, r) {
					var e = it.lookupPath(t, { parent: !0 }), o = e.node, a = qe.basename(t);
				...
				create: function(t, n) {
					return n = n !== void 0 ? n : 438, n &= 4095, n |= 32768, it.mknod(t, n, 0);
				},
				mkdir: function(t, n) {
					return n = n !== void 0 ? n : 511, n &= 1023, n |= 16384, it.mknod(t, n, 0);
				},
				...
				mkdev: function(t, n, r) {
					return typeof r == "undefined" && (r = n, n = 438), n |= 8192, it.mknod(t, n, r);
				},
				symlink: function(t, n) {
					if (!He.resolve(t)) throw new it.ErrnoError(44);
					var e = it.lookupPath(n, { parent: !0 }), r = e.node;
					if (!r) throw new it.ErrnoError(44);
					var o = qe.basename(n), a = it.mayCreate(r, o);
					if (a) throw new it.ErrnoError(a);
					if (!r.node_ops.symlink) throw new it.ErrnoError(63);
					return r.node_ops.symlink(r, o, t);
				},
				rename: function(t, n) {
					var e = qe.dirname(t), r = qe.dirname(n), o = qe.basename(t), a = qe.basename(n), i, l, s;
					if (i = it.lookupPath(t, { parent: !0 }), l = i.node, i = it.lookupPath(n, { parent: !0 }), s = i.node, !l || !s) throw new it.ErrnoError(44);
					if (l.mount !== s.mount) throw new it.ErrnoError(75);
					var u = it.lookupNode(l, o), c = He.relative(t, r);
					if (c.charAt(0) !== ".") throw new it.ErrnoError(28);
					if (c = He.relative(n, e), c.charAt(0) !== ".") throw new it.ErrnoError(55);
					var d;
					try {
						d = it.lookupNode(s, a);
					} catch (e) {}
					if (u !== d) {
						var m = it.isDir(u.mode), p = it.mayDelete(l, o, m);
						if (p) throw new it.ErrnoError(p);
						if (p = d ? it.mayDelete(s, a, m) : it.mayCreate(s, a), p) throw new it.ErrnoError(p);
						if (!l.node_ops.rename) throw new it.ErrnoError(63);
						if (it.isMountpoint(u) || d && it.isMountpoint(d)) throw new it.ErrnoError(10);
						if (s !== l && (p = it.nodePermissions(l, "w"), p)) throw new it.ErrnoError(p);
						it.hashRemoveNode(u);
						try {
				...
				rmdir: function(t) {
					var e = it.lookupPath(t, { parent: !0 }), n = e.node, r = qe.basename(t), o = it.lookupNode(n, r), a = it.mayDelete(n, r, !0);
					if (a) throw new it.ErrnoError(a);
				...
				readdir: function(t) {
					var e = it.lookupPath(t, { follow: !0 }), n = e.node;
					if (!n.node_ops.readdir) throw new it.ErrnoError(54);
					return n.node_ops.readdir(n);
				},
				unlink: function(t) {
					var e = it.lookupPath(t, { parent: !0 }), n = e.node;
					if (!n) throw new it.ErrnoError(44);
					var r = qe.basename(t), o = it.lookupNode(n, r), a = it.mayDelete(n, r, !1);
					if (a) throw new it.ErrnoError(a);
				...
				utime: function(t, n, r) {
					var e = it.lookupPath(t, { follow: !0 }), o = e.node;
					o.node_ops.setattr(o, { timestamp: Math.max(n, r) });
				},
				open: function(t, n, r) {
					if (t === "") throw new it.ErrnoError(44);
					n = typeof n == "string" ? ot(n) : n, n & 64 ? (r = typeof r == "undefined" ? 438 : r, r = r & 4095 | 32768) : r = 0;
					var e;
					...
					if (it.isChrdev(e.mode) && (n &= -513), n & 65536 && !it.isDir(e.mode)) throw new it.ErrnoError(54);
					if (!i) {
					...
					return s.stream_ops.open && s.stream_ops.open(s), a.logReadFiles && !(n & 1) && (it.readFiles || (it.readFiles = {}), t in it.readFiles || (it.readFiles[t] = 1)), s;
				},
				close: function(t) {
				...
				llseek: function(t, n, r) {
					if (it.isClosed(t)) throw new it.ErrnoError(8);
					if (!t.seekable || !t.stream_ops.llseek) throw new it.ErrnoError(70);
				...
				allocate: function(t, n, r) {
					...
					if ((t.flags & 2097155) === 0) throw new it.ErrnoError(8);
					if (!it.isFile(t.node.mode) && !it.isDir(t.node.mode)) throw new it.ErrnoError(43);
					if (!t.stream_ops.allocate) throw new it.ErrnoError(138);
					t.stream_ops.allocate(t, n, r);
				},
				mmap: function(t, n, r, o, a) {
					if ((o & 2) !== 0 && (a & 2) === 0 && (t.flags & 2097155) !== 2) throw new it.ErrnoError(2);
				...
				readFile: function(t, n) {
					...
					var e, r = it.open(t, n.flags), o = it.stat(t), a = o.size, i = new Uint8Array(a);
					return it.read(r, i, 0, a, 0), n.encoding === "utf8" ? e = ze(i, 0) : n.encoding === "binary" && (e = i), it.close(r), e;
				},
				writeFile: function(t, n, r) {
					r === void 0 && (r = {}), r.flags = r.flags || 577;
					var e = it.open(t, r.flags, r.mode);
					if (typeof n == "string") {
						var o = new Uint8Array(ve(n) + 1), a = Se(n, o, 0, o.length);
						it.write(e, o, 0, a, void 0, r.canOwn);
					} else if (ArrayBuffer.isView(n)) it.write(e, n, 0, n.byteLength, void 0, r.canOwn);
				...
				createDefaultDirectories: function() {
					it.mkdir("/tmp"), it.mkdir("/home"), it.mkdir("/home/web_user");
				},
				createDefaultDevices: function() {
					it.mkdir("/dev"), it.registerDevice(it.makedev(1, 3), {
						read: function() {
							return 0;
						},
						write: function(t, n, r, o, a) {
					...
					}), it.mkdev("/dev/null", it.makedev(1, 3)), Xe.register(it.makedev(5, 0), Xe.default_tty_ops), Xe.register(it.makedev(6, 0), Xe.default_tty1_ops), it.mkdev("/dev/tty", it.makedev(5, 0)), it.mkdev("/dev/tty1", it.makedev(6, 0));
					var e = new Uint8Array(1024), t = 0, n = function() {
						return t === 0 && (t = Ve(e).byteLength), e[--t];
					};
					it.createDevice("/dev", "random", n), it.createDevice("/dev", "urandom", n), it.mkdir("/dev/shm"), it.mkdir("/dev/shm/tmp");
				},
				createSpecialDirectories: function() {
					it.mkdir("/proc");
					var e = it.mkdir("/proc/self");
					it.mkdir("/proc/self/fd"), it.mount({ mount: function() {
						var t = it.createNode(e, "fd", 16895, 73);
						return t.node_ops = { lookup: function(t, n) {
							var e = +n, r = it.getStreamChecked(e), o = {
								parent: null,
				...
				createStandardStreams: function() {
					a.stdin ? it.createDevice("/dev", "stdin", a.stdin) : it.symlink("/dev/tty", "/dev/stdin"), a.stdout ? it.createDevice("/dev", "stdout", null, a.stdout) : it.symlink("/dev/tty", "/dev/stdout"), a.stderr ? it.createDevice("/dev", "stderr", null, a.stderr) : it.symlink("/dev/tty1", "/dev/stderr");
					var e = it.open("/dev/stdin", 0), t = it.open("/dev/stdout", 1), n = it.open("/dev/stderr", 1);
				},
				staticInit: function() {
					[44].forEach(function(e) {
						it.genericErrors[e] = new it.ErrnoError(e), it.genericErrors[e].stack = "<generic error, no stack>";
					}), it.nameTable = new Array(4096), it.mount(Je, {}, "/"), it.createDefaultDirectories(), it.createDefaultDevices(), it.createSpecialDirectories(), it.filesystems = { MEMFS: Je };
				},
				init: function(t, n, r) {
					it.init.initialized = !0, a.stdin = t || a.stdin, a.stdout = n || a.stdout, a.stderr = r || a.stderr, it.createStandardStreams();
				},
				quit: function() {
				...
				analyzePath: function(t, n) {
					...
					try {
						...
						r.parentExists = !0, r.parentPath = e.path, r.parentObject = e.node, r.name = qe.basename(t), e = it.lookupPath(t, { follow: !n }), r.exists = !0, r.path = e.path, r.object = e.node, r.name = e.node.name, r.isRoot = e.path === "/";
					} catch (e) {
						r.error = e.errno;
					}
					return r;
				...
				createFile: function(t, n, r, o, a) {
					var e = qe.join2(typeof t == "string" ? t : it.getPath(t), n), i = at(o, a);
					return it.create(e, i);
				},
				createDataFile: function(t, n, r, o, a, i) {
					var e = n;
					t && (t = typeof t == "string" ? t : it.getPath(t), e = n ? qe.join2(t, n) : t);
					var l = at(o, a), s = it.create(e, l);
					if (r) {
						if (typeof r == "string") {
						...
						it.chmod(s, l | 146);
						var m = it.open(s, 577);
						it.write(m, r, 0, r.length, 0, i), it.close(m), it.chmod(s, l);
					}
				},
				createDevice: function(t, n, r, o) {
					var e = qe.join2(typeof t == "string" ? t : it.getPath(t), n), a = at(!!r, !!o);
					it.createDevice.major || (it.createDevice.major = 64);
					var i = it.makedev(it.createDevice.major++, 0);
					return it.registerDevice(i, {
						open: function(t) {
							t.seekable = !1;
						},
						close: function(t) {
					...
					var e = (function() {
						...
						return t.get = function(t) {
							...
							var l = function(n, o) {
								...
								return e.response !== void 0 ? new Uint8Array(e.response || []) : Ke(e.responseText || "", !0);
							}, s = this;
							s.setDataGetter(function(e) {
								...
								return s.chunks[e];
							}), (a || !t) && (i = t = 1, t = this.getter(0).length, i = t, y("LazyFiles on gzip forces download of the whole file when length is accessed")), this.$1 = t, this.$2 = i, this.lengthKnown = !0;
						}, babelHelpers.createClass(e, [{
							key: "length",
							get: function() {
								return this.lengthKnown || this.cacheLength(), this.$1;
							}
						}, {
							key: "chunkSize",
							get: function() {
								return this.lengthKnown || this.cacheLength(), this.$2;
							}
						}]);
					})();
					if (typeof XMLHttpRequest != "undefined") var i = new e(), l = {
						isDevice: !1,
						contents: i
					};
					else var l = {
				...
				doStat: function(t, n, r) {
					var e = t(n);
					T[r >> 2] = e.dev, T[r + 4 >> 2] = e.mode, D[r + 8 >> 2] = e.nlink, T[r + 12 >> 2] = e.uid, T[r + 16 >> 2] = e.gid, T[r + 20 >> 2] = e.rdev, ae = [e.size >>> 0, (oe = e.size, +Math.abs(oe) >= 1 ? oe > 0 ? +Math.floor(oe / 4294967296) >>> 0 : ~~+Math.ceil((oe - +(~~oe >>> 0)) / 4294967296) >>> 0 : 0)], T[r + 24 >> 2] = ae[0], T[r + 28 >> 2] = ae[1], T[r + 32 >> 2] = 4096, T[r + 36 >> 2] = e.blocks;
					var o = e.atime.getTime(), a = e.mtime.getTime(), i = e.ctime.getTime();
					return ae = [Math.floor(o / 1e3) >>> 0, (oe = Math.floor(o / 1e3), +Math.abs(oe) >= 1 ? oe > 0 ? +Math.floor(oe / 4294967296) >>> 0 : ~~+Math.ceil((oe - +(~~oe >>> 0)) / 4294967296) >>> 0 : 0)], T[r + 40 >> 2] = ae[0], T[r + 44 >> 2] = ae[1], D[r + 48 >> 2] = o % 1e3 * 1e3, ae = [Math.floor(a / 1e3) >>> 0, (oe = Math.floor(a / 1e3), +Math.abs(oe) >= 1 ? oe > 0 ? +Math.floor(oe / 4294967296) >>> 0 : ~~+Math.ceil((oe - +(~~oe >>> 0)) / 4294967296) >>> 0 : 0)], T[r + 56 >> 2] = ae[0], T[r + 60 >> 2] = ae[1], D[r + 64 >> 2] = a % 1e3 * 1e3, ae = [Math.floor(i / 1e3) >>> 0, (oe = Math.floor(i / 1e3), +Math.abs(oe) >= 1 ? oe > 0 ? +Math.floor(oe / 4294967296) >>> 0 : ~~+Math.ceil((oe - +(~~oe >>> 0)) / 4294967296) >>> 0 : 0)], T[r + 72 >> 2] = ae[0], T[r + 76 >> 2] = ae[1], D[r + 80 >> 2] = i % 1e3 * 1e3, ae = [e.ino >>> 0, (oe = e.ino, +Math.abs(oe) >= 1 ? oe > 0 ? +Math.floor(oe / 4294967296) >>> 0 : ~~+Math.ceil((oe - +(~~oe >>> 0)) / 4294967296) >>> 0 : 0)], T[r + 88 >> 2] = ae[0], T[r + 92 >> 2] = ae[1], 0;
				},
			...
			function dt(e, t, n, r, o) {
				...
				try {
					...
					return it.llseek(i, a, r), ae = [i.position >>> 0, (oe = i.position, +Math.abs(oe) >= 1 ? oe > 0 ? +Math.floor(oe / 4294967296) >>> 0 : ~~+Math.ceil((oe - +(~~oe >>> 0)) / 4294967296) >>> 0 : 0)], T[o >> 2] = ae[0], T[o + 4 >> 2] = ae[1], i.getdents && a === 0 && r === 0 && (i.getdents = null), 0;
				} catch (e) {
					if (typeof it == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
				}
			...
			function pt(e, t, n, r) {
				try {
					var o = st.getStreamFromFD(e), a = mt(o, t, n);
					return D[r >> 2] = a, 0;
				} catch (e) {
					if (typeof it == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
