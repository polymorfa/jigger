				...
				var r = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
					...
					switch (r.name) {
						case "DeleteResponseSuccess": {
							d.LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["PQ prekeys deleted successfully"]))), n(o("WAResultOrError").makeResult(void 0));
							return;
						}
						case "DeleteResponseRequestError": {
							d.WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["PQ delete request error"]))), n(o("WAResultOrError").makeError("request-error"));
							return;
						}
						default: r.name, d.WARN(c || (c = babelHelpers.taggedTemplateLiteralLoose(["PQ delete error: ", ", will retry"])), r.name);
					}
				});
				function a(e) {
