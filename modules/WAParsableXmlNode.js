__d("WAParsableXmlNode", [
	...
	var s = (function() {
		function e(e, t) {
			var n = this;
			this.$1 = e, this.$2 = t, this.$3 = Array.isArray(t.content) ? t.content.map(function(t) {
		...
		return t.name = function() {
			...
			e !== n && this.throw("to have \"" + t + "\"=\"" + n + "\", but instead has \"" + e + "\"");
		}, t.attrString = function(t) {
			return r("WAHasProperty")(this.$2.attrs, t) ? this.decodeAsString(this.$2.attrs[t]) : this.throw("to have attribute \"" + t + "\"");
			...
			var e = new Set(n), o = this.attrString(t);
			if (!e.has(o)) {
				if (r != null) return r;
				var a = Array.from(e).join("|");
				return this.throw("to have \"" + t + "\"={" + a + "} but has value \"" + o + "\"");
			}
			return o;
			...
			if (!r("WAHasProperty")(n, e)) {
				...
				return this.throw("to have \"" + t + "\"={" + o + "} but has value \"" + e + "\"");
			}
			return n[e];
			...
			var e = parseInt(t, 10);
			return Number.isNaN(e) ? this.throw("to have \"" + n + "\"={integer} but has value \"" + t + "\"") : r !== void 0 && e < r ? this.throw("to have \"" + n + "\"={at least " + r + "} but has value " + e) : o !== void 0 && e >= o ? this.throw("to have \"" + n + "\"={below " + o + "} but has value " + e) : e;
		}, t.forEachChild = function(t) {
			var e = this.$3;
			if (e) e.forEach(function(e) {
				return t(e);
			});
			else if (this.$2.content != null) return this.throw("to have children");
			...
			var e = this.$3;
			return !e && this.$2.content != null ? this.throw("to have children") : e ? e.map(function(e) {
				return t(e);
			}) : [];
		}, t.mapChildrenWithTag = function(t, n) {
			var e = this.$3;
			return !e && this.$2.content != null ? this.throw("to have children") : e ? e.filter(function(e) {
				return e.tag() === t;
			}).map(function(e) {
				return n(e);
			}) : [];
			...
			var e = this.$3;
			return !e || e.length === 0 ? this.throw("to have children") : t(e[0]);
			...
			if (t === void 0 && (t = -1), this.$3) return this.throw("to have binary content, but has children instead");
			if (this.$2.content != null) {
				var e = this.$2.content;
				return t !== -1 && e.length !== t ? this.throw("to be " + t + " bytes, but got " + e.length + " instead") : e;
			} else return this.throw("to have content");
		}, t.contentString = function() {
			return this.$3 ? this.throw("to have string content, but has children instead") : this.$2.content != null ? this.$2.content : this.throw("to have content");
			...
			if (!r("WAHasProperty")(t, e)) {
				...
				return this.throw("to have content {" + n + "} but has value \"" + e + "\"");
			}
			return t[e];
		}, t.decodeAsString = function(t) {
			if (typeof t != "string") throw r("err")("decodeAsString: attribute is " + typeof t + " not a string: " + t);
			return t;
		}, t.throw = function(t) {
			throw new (o("WAXmlParsingFailure")).XmlParsingFailure(this.$1, "expected <" + this.$2.tag + "> " + t);
		}, t.toString = function() {
