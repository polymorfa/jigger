__d("WAPublishAppDataProtocol", [
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			}], d = yield o("WAGlobals").getWaOneQueue().enqueue(function(e) {
			...
			if (_) {
				var C = yield o("WAGetCurrentUserDeviceInfoApi").getCurrentUserDeviceInfo(), b = C == null ? void 0 : C.identityKey;
			...
			}, R = yield o("WASmaxAppdataPublishPeerRPC").sendPeerRPC(S);
			switch (R.name) {
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var d = Array.from(s.entries()).map(function(e) {
				...
				devicesInfo: d,
				user: o("WAGlobals").getMyUserJid()
			}], _ = yield o("WAGlobals").getWaOneQueue().enqueue(function(e) {
				var t = e.cryptoManager;
			...
			if (f) {
				...
				h = { deviceIdentityElementValue: b };
			}
			var v = l != null ? l : o("WAGlobals").getMyUserJid(), S = {
				messageId: t,
				deviceIdentityMixinArgs: h,
			...
			}, R = yield o("WASmaxMessagePublishIndividualRPC").sendIndividualRPC(S);
			switch (R.name) {
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var s = Array.from(l.entries()).map(function(e) {
				...
				devicesInfo: s,
				user: o("WAGlobals").getMyUserJid()
			}], c = yield o("WAGlobals").getWaOneQueue().enqueue(function(e) {
				var t = e.cryptoManager;
			...
			if (f) {
				var h = yield o("WAGetCurrentUserDeviceInfoApi").getCurrentUserDeviceInfo(), y = h == null ? void 0 : h.identityKey;
				if (y == null) throw m.ERROR(d || (d = babelHelpers.taggedTemplateLiteralLoose(["Failed to fetch current device public identity key"]))), r("FBLogger")("wmi").mustfixThrow("No public identity key");
				g = o("WAWap").wap("device-identity", null, y);
			}
			var C = o("WAWap").wap("message", {
				device_fanout: "false",
				...
				type: "skmsg",
				v: "2"
			}), _, g), S = yield o("WADeprecatedSendIq").deprecatedSendStanzaAndReturnAck(C, {
				id: t,
				class: "message",
				from: n,
				participant: null
			}), R = b.parse(S);
			return R.success ? v(R.success) : { type: "parsing_error" };
		}), C.apply(this, arguments);
	}
	var b = new (r("WADeprecatedWapParser"))("publishAppDataAsGroupMessageAck", function(e) {
	...
	l.publishAppData = p, l.publishAppDataAsMessage = g;
}), 98);
