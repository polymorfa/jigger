__d("WAReceiptUtils", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			r >= 3 && (yield o("WARequestPreKeyDigest").requestPreKeyDigestFn(function(e) {
				return e(t);
			}));
			var a = null;
			r >= 2 && (a = yield o("WACryptoManagerUtils").getSignalInfoForRetry(t.cryptoManager));
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			...
			a.type === "group" ? l = a.groupJid : (a.type, l = a.deviceJid), yield o("WADeprecatedSendIq").deprecatedSendStanzaAndWaitForAck(yield e(t, n), {
				id: r,
				class: "receipt",
				from: l,
				participant: i
	...
	l.makeRetryReceipt = e, l.sendRetryReceipt = u, l.calculateIdentitiesToDelete = m;
}), 98);
