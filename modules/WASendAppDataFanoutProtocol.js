		...
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a) {
			...
			if (r("gkx")("23056")) {
				var g = new Map([[o("WAGlobals").getMyUserJid(), new Map(Array.from(n.entries()).map(function(e) {
					var t = e[0], n = e[1];
					return [t, n.pubKey];
				}))]]), h = yield o("WAPublishAppDataProtocol").publishAppDataAsMessage({
					externalId: t,
					identities: g,
					messageBytes: l
				});
			...
			}], S = yield o("WAGlobals").getWaOneQueue().enqueue(function(e) {
			...
			if (L) {
				var T = yield o("WAGetCurrentUserDeviceInfoApi").getCurrentUserDeviceInfo(), D = T == null ? void 0 : T.identityKey;
			...
			}, P = yield o("WASmaxAppdataPublishPeerRPC").sendPeerRPC($);
			switch (P.name) {
