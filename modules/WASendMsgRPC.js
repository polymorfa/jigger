__d("WASendMsgRPC", [
		...
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a) {
			...
			if (t.type === "direct_user") {
				var s = { individualIndividualSingle: {
					...
					individualIndividualRetryMixinArgs: _(e.count, t.recipient),
					contentMixinsArgs: p(e, t.message),
					encTypeIndividualMixinArgs: f(t.message),
					encVersionArgs: g(t.message)
					...
					messageEditOrMessagePinOrRevokeMixinGroupArgs: h(e.messageType),
					clientFrankingTagMixinArgs: n != null && n.frankingTag ? { frankingTagElementValue: n.frankingTag } : null,
					hasMetaHideDecryptionPlaceholder: C(e.messageType) ? !0 : null,
				...
				var b = yield o("WASmaxMessagePublishIndividualRPC").sendIndividualRPC(c);
			...
			function $() {
				...
				}) : C(e.messageType) ? o("WAWap").wap("meta", { "decrypt-fail": "hide" }) : null;
			}
			...
			var F = null;
			t.message != null && (F = d(t.message, !0));
			...
			y(e.externalId), r == null || r.addPoint("send_stanza_and_return_ack");
			var B = yield o("WADeprecatedSendIq").deprecatedSendStanzaAndReturnAck(O, {
				id: e.externalId,
				class: "message",
				from: t.messageTo,
	...
	var m = new (r("WADeprecatedWapParser"))("sendMsgAck", function(e) {
