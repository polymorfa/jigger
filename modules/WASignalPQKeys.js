__d("WASignalPQKeys", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			var n = yield o("WAKemModule").generateKeyPair(), a = yield o("WASignalSignatures").signMsg(t, n.publicKey);
			return {
				id: e,
				keyPair: n,
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, r) {
			for (var a = [], i = 0; i < n; i++) {
				var l = (t + i) % o("WASignalPQTypes").PQ_PRE_KEY_NON_INCLUSIVE_UPPER_BORDER, s = yield e(l, r);
				a.push(s);
			}
			return a;
	...
	l.generateKyberPreKey = e, l.generateKyberPreKeys = u, l.generateKyberLastResortKey = d, l.serializeKyberPreKeyForUpload = p;
}), 98);
