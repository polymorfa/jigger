__d("WASmaxInBizMarketingMessageGetBusinessEligibilityResponseSuccess", [
	"WAResultOrError",
	...
	function u(e) {
		...
		var n = o("WASmaxParseUtils").attrStringEnum(e, "status", o("WASmaxInBizMarketingMessageEnums").ENUM_FAIL_SUCCESS);
		if (!n.success) return n;
		var r = o("WASmaxParseUtils").optional(o("WASmaxParseUtils").attrStringEnum, e, "v1_enabled", o("WASmaxInBizMarketingMessageEnums").ENUM_FALSE_TRUE);
		return r.success ? o("WAResultOrError").makeResult({
			status: n.value,
			v1Enabled: r.value
		}) : r;
	...
	function c(e) {
		...
		if (!t.success) return t;
		var n = o("WASmaxParseUtils").attrStringEnum(e, "status", o("WASmaxInBizMarketingMessageEnums").ENUM_FAIL_SUCCESS);
		return n.success ? o("WAResultOrError").makeResult({ status: n.value }) : n;
	}
	function d(e) {
	...
	function m(e) {
		...
		if (!t.success) return t;
		var n = o("WASmaxParseUtils").attrStringEnum(e, "status", o("WASmaxInBizMarketingMessageEnums").ENUM_ELIGIBLETOONBOARD_NOTELIGIBLE_ONBOARDED);
		return n.success ? o("WAResultOrError").makeResult({ status: n.value }) : n;
	}
	function p(t, n) {
		...
		var g = o("WASmaxInBizMarketingMessageHackBaseIQResultResponseMixin").parseHackBaseIQResultResponseMixin(t, n);
		return g.success ? o("WAResultOrError").makeResult(babelHelpers.extends({}, g.value, {
	...
	l.parseGetBusinessEligibilityResponseSuccessMetaVerified = e, l.parseGetBusinessEligibilityResponseSuccessMarketingMessages = s, l.parseGetBusinessEligibilityResponseSuccessGenai = u, l.parseGetBusinessEligibilityResponseSuccessGenaiImage = c, l.parseGetBusinessEligibilityResponseSuccessMetaOne = d, l.parseGetBusinessEligibilityResponseSuccessBbPro = m, l.parseGetBusinessEligibilityResponseSuccess = p;
}), 98);
