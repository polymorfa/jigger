__d("WASmaxInBlocklistsGetBlockListResponseForceMigratedSuccessWithMismatch", [
	"WAResultOrError",
	...
	function s(t, n) {
		...
		var m = o("WASmaxParseUtils").literal(o("WASmaxParseUtils").attrString, a.value, "addressing_mode", "lid");
		if (!m.success) return m;
		var p = o("WASmaxParseUtils").literal(o("WASmaxParseUtils").attrString, a.value, "dirty", "true");
		if (!p.success) return p;
		var _ = o("WASmaxParseUtils").mapChildrenWithTag(a.value, "item", 0, 64e3, e);
	...
	l.parseGetBlockListResponseForceMigratedSuccessWithMismatchListItem = e, l.parseGetBlockListResponseForceMigratedSuccessWithMismatch = s;
}), 98);
