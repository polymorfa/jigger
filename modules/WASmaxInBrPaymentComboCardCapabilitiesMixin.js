__d("WASmaxInBrPaymentComboCardCapabilitiesMixin", [
	"WAResultOrError",
	...
	function e(e) {
		...
		var r = o("WASmaxParseUtils").attrStringEnum(n.value, "p2m-credit-eligible", o("WASmaxInBrPaymentEnums").ENUM_0_1);
		if (!r.success) return r;
		var a = o("WASmaxParseUtils").attrStringEnum(n.value, "p2m-debit-eligible", o("WASmaxInBrPaymentEnums").ENUM_0_1);
