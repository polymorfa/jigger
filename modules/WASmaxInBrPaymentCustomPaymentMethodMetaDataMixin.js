__d("WASmaxInBrPaymentCustomPaymentMethodMetaDataMixin", ["WAResultOrError", "WASmaxParseUtils"], (function(t, n, r, o, a, i, l) {
	function e(e) {
	...
	function s(t) {
		...
		return n.success ? o("WAResultOrError").makeResult({ metadata: n.value }) : n;
	}
