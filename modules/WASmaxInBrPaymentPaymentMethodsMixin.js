__d("WASmaxInBrPaymentPaymentMethodsMixin", [
	"WAResultOrError",
	...
	function d(e) {
		...
		if (!t.success) return t;
		var n = o("WASmaxInBrPaymentCustomPaymentMethodMixin").parseCustomPaymentMethodMixin(e);
		return n.success, n;
	}
	function m(t, n) {
		var r = o("WASmaxParseUtils").assertTag(t, "account");
		if (!r.success) return r;
		var a = o("WASmaxParseReference").attrStringFromReference(n, ["account", "action"]);
		if (!a.success) return a;
		var i = o("WASmaxParseUtils").literal(o("WASmaxParseUtils").attrString, t, "action", a.value);
		if (!i.success) return i;
		var l = o("WASmaxParseUtils").optional(o("WASmaxParseUtils").attrIntRange, t, "version", 0, void 0);
		if (!l.success) return l;
		var m = o("WASmaxParseUtils").optional(o("WASmaxParseUtils").attrString, t, "instance-id");
		if (!m.success) return m;
		var p = o("WASmaxParseUtils").optional(o("WASmaxParseUtils").attrString, t, "wa-support-phone-number");
		...
		var g = o("WASmaxParseUtils").mapChildrenWithTag(t, "merchant", 0, 1 / 0, u);
		if (!g.success) return g;
		var h = o("WASmaxParseUtils").mapChildrenWithTag(t, "alias", 0, 100, c);
		if (!h.success) return h;
		var y = o("WASmaxParseUtils").mapChildrenWithTag(t, "custom_payment_method", 0, 5, d);
		return y.success ? o("WAResultOrError").makeResult({
			version: l.value,
			instanceId: m.value,
	...
	l.parsePaymentMethodsCard = e, l.parsePaymentMethodsBank = s, l.parsePaymentMethodsMerchant = u, l.parsePaymentMethodsAlias = c, l.parsePaymentMethodsCustomPaymentMethod = d, l.parsePaymentMethodsMixin = m;
}), 98);
