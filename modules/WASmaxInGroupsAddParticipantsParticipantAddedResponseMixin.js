__d("WASmaxInGroupsAddParticipantsParticipantAddedResponseMixin", [
	"WAResultOrError",
	...
	function e(e) {
		...
		var r = o("WASmaxParseUtils").optional(o("WASmaxParseUtils").attrIntRange, e, "join_time", 0, void 0);
		if (!r.success) return r;
		var a = o("WASmaxInGroupsPhoneNumberMixin").parsePhoneNumberMixin(e), i = o("WASmaxInGroupsUsernameAttMixin").parseUsernameAttMixin(e), l = o("WASmaxInGroupsAddParticipantsParticipantMixins").parseAddParticipantsParticipantMixins(e);
