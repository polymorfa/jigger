__d("WASmaxInGroupsDemoteNotificationRequest", [
	"WAResultOrError",
	...
	function s(t) {
		...
		if (!n.success) return n;
		var r = o("WASmaxParseUtils").flattenedChildWithTag(t, "demote");
		if (!r.success) return r;
		var a = o("WASmaxParseUtils").optionalChild(t, "missing_participant_identification");
		if (!a.success) return a;
		var i = o("WASmaxParseJid").attrUserJid(t, "participant");
		...
		return m.success ? o("WAResultOrError").makeResult(babelHelpers.extends({
			...
			demoteParticipant: m.value
		})) : m;
	}
	l.parseDemoteNotificationRequestDemoteParticipant = e, l.parseDemoteNotificationRequest = s;
}), 98);
