__d("WASmaxInGroupsGetGroupInfoResponseSuccess", [
	...
	function e(e) {
		...
		var n = o("WASmaxParseUtils").optional(o("WASmaxParseUtils").attrIntRange, e, "size", 0, 19999);
		...
		return o("WAResultOrError").makeResult(babelHelpers.extends({ size: n.value }, r.value, { dedupAttrsMixin: a.success ? a.value : null }));
	}
	function s(t, n) {
