__d("WASmaxInGroupsGetGroupProfilePicturesProfilePicturesResponseMixin", [
	"WAResultOrError",
	...
	function s(t) {
		...
		return r.success ? o("WAResultOrError").makeResult({ picturesPicture: r.value }) : r;
	}
	l.parseGetGroupProfilePicturesProfilePicturesResponsePicturesPicture = e, l.parseGetGroupProfilePicturesProfilePicturesResponseMixin = s;
}), 98);
