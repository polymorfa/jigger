__d("WASmaxInGroupsGroupMemberShareGroupHistoryModeMixin", [
	"WAResultOrError",
	...
	function e(e) {
		...
		return n.success ? o("WAResultOrError").makeResult({ memberShareGroupHistoryModeMemberShareGroupHistoryModes: n.value }) : n;
	}
