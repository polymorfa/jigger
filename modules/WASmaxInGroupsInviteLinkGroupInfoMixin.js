__d("WASmaxInGroupsInviteLinkGroupInfoMixin", [
	"WAResultOrError",
	...
	function s(e) {
		...
		return n.success ? o("WAResultOrError").makeResult({ numSubGroups: n.value }) : n;
	}
	function u(e) {
	...
	function p(t) {
		...
		var v = o("WASmaxInGroupsGroupInfoDescriptionMixin").parseGroupInfoDescriptionMixin(r.value), S = o("WASmaxInGroupsGroupInfoAttributesMixin").parseGroupInfoAttributesMixin(t);
		if (!S.success) return S;
		var R = o("WASmaxParseUtils").mapChildrenWithTag(t, "participant", 0, 19999, e);
		return R.success ? o("WAResultOrError").makeResult(babelHelpers.extends({
			size: b.value,
			descriptionGroupInfoDescriptionMixin: v.success ? v.value : null
		}, S.value, {
			parent: a.value,
