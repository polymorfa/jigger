__d("WASmaxInMdSetPrimaryEphemeralIdentityNotificationRequest", [
	"WAResultOrError",
	...
	function e(e) {
		...
		var n = o("WASmaxParseUtils").flattenedChildWithTag(e, "primary_ephemeral_identity");
		if (!n.success) return n;
		var r = o("WASmaxParseUtils").literal(o("WASmaxParseUtils").attrString, e, "type", "crsc_continuation");
		...
		var l = o("WASmaxInMdServerNotificationMixin").parseServerNotificationMixin(e);
