__d("WASmaxInNewslettersGetNewsletterResponsesResponseClientError", [
	"WAResultOrError",
	...
	function e(e, t) {
		...
		return r.success ? o("WAResultOrError").makeResult({ getNewsletterResponsesClientErrors: r.value }) : r;
	}
