__d("WASmaxInNewslettersNewsletterWamoEmptyContent", [
	"WAResultOrError",
	...
	function e(e) {
		var t = o("WASmaxInNewslettersNewsletterQuestionEmptyMixin").parseNewsletterQuestionEmptyMixin(e);
		if (t.success) return o("WAResultOrError").makeResult({
			name: "NewsletterQuestionEmpty",
			value: t.value
		});
		var n = o("WASmaxInNewslettersNewsletterQuestionReplyEmptyMixin").parseNewsletterQuestionReplyEmptyMixin(e);
		if (n.success) return o("WAResultOrError").makeResult({
			name: "NewsletterQuestionReplyEmpty",
			value: n.value
		});
		var r = o("WASmaxInNewslettersContentTypeTextMixin").parseContentTypeTextMixin(e);
		if (r.success) return o("WAResultOrError").makeResult({
			name: "ContentTypeText",
			value: r.value
		});
		var a = o("WASmaxInNewslettersContentTypeMediaMixin").parseContentTypeMediaMixin(e);
		if (a.success) return o("WAResultOrError").makeResult({
			name: "ContentTypeMedia",
			value: a.value
		});
		var i = o("WASmaxInNewslettersContentTypePollCreationMixin").parseContentTypePollCreationMixin(e);
		if (i.success) return o("WAResultOrError").makeResult({
			name: "ContentTypePollCreation",
			value: i.value
		});
		var l = o("WASmaxInNewslettersContentTypeQuizCreationMixin").parseContentTypeQuizCreationMixin(e);
