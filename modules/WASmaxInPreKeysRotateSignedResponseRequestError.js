__d("WASmaxInPreKeysRotateSignedResponseRequestError", [
	"WAResultOrError",
	...
	function e(e, t) {
		...
		return i.success ? o("WAResultOrError").makeResult(babelHelpers.extends({}, a.value, { errorRequestErrors: i.value })) : i;
	}
	l.parseRotateSignedResponseRequestError = e;
}), 98);
