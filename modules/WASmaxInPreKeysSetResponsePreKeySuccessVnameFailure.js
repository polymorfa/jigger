__d("WASmaxInPreKeysSetResponsePreKeySuccessVnameFailure", [
	"WAResultOrError",
	...
	function e(e, t) {
		...
		var l = o("WASmaxParseUtils").literal(o("WASmaxParseUtils").attrInt, r.value, "code", 207);
		if (!l.success) return l;
		var s = o("WASmaxParseUtils").attrIntRange(a.value, "code", 400, 599);
		if (!s.success) return s;
		var u = o("WASmaxInPreKeysIQErrorResponseMixin").parseIQErrorResponseMixin(e, t);
		...
		}, u.value, { errorErrorVnameFailures: c.value })) : c;
	}
