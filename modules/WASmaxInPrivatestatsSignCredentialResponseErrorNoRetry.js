__d("WASmaxInPrivatestatsSignCredentialResponseErrorNoRetry", [
	"WAResultOrError",
	...
	function e(e, t) {
		...
		return i.success ? o("WAResultOrError").makeResult(babelHelpers.extends({}, a.value, { errorSignCredentialNoRetryError: i.value })) : i;
	}
