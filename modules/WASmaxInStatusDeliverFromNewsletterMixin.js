__d("WASmaxInStatusDeliverFromNewsletterMixin", [
	...
	function e(e) {
		...
		var a = o("WASmaxParseUtils").attrIntRange(e, "t", 1577865600, 4102473600);
		if (!a.success) return a;
		var i = o("WASmaxParseUtils").optionalLiteral(o("WASmaxParseUtils").attrString, e, "is_sender", "true");
		if (!i.success) return i;
		var l = o("WASmaxInStatusDeliverStatusNewsletterContentMixin").parseStatusNewsletterContentMixin(e);
		...
		return o("WAResultOrError").makeResult(babelHelpers.extends({
			...
			t: a.value,
			isSender: i.value
		}, l.value, { offlineMixin: s.success ? s.value : null }));
	}
