__d("WASmaxInStatusDeliverStatusNewsletterMediaMixin", [
	...
	function e(e) {
		...
		var r = o("WASmaxParseUtils").attrStringEnum(n.value, "mediatype", o("WASmaxInStatusDeliverEnums").ENUM_AUDIO_GIF_IMAGE_VIDEO);
		if (!r.success) return r;
		var a = o("WASmaxInStatusDeliverNewsletterPlaintextPayloadMixin").parseNewsletterPlaintextPayloadMixin(n.value);
		if (!a.success) return a;
		var i = o("WASmaxInStatusDeliverStatusContentTypeMediaMixin").parseStatusContentTypeMediaMixin(e);
