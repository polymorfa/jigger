__d("WASmaxInUserNoticeSetResponseSuccess", [
	"WAResultOrError",
	...
	function e(e) {
		...
		return r.success ? o("WAResultOrError").makeResult(babelHelpers.extends({ t: n.value }, r.value)) : r;
	}
	function s(t, n) {
		...
		return i.success ? o("WAResultOrError").makeResult(babelHelpers.extends({}, i.value, { notice: a.value })) : i;
	}
