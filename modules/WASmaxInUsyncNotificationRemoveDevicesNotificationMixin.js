__d("WASmaxInUsyncNotificationRemoveDevicesNotificationMixin", [
	...
	function u(t) {
		...
		if (!n.success) return n;
		var r = o("WASmaxParseUtils").flattenedChildWithTag(t, "remove");
		if (!r.success) return r;
		...
		return u.success ? o("WAResultOrError").makeResult({
			removeDeviceHash: i.value,
			removeDeviceLidHash: l.value,
			removeKeyIndexList: a.value,
			removeDevice: u.value
		}) : u;
	}
	l.parseNotificationRemoveDevicesNotificationRemoveDevice = e, l.parseNotificationRemoveDevicesNotificationRemoveKeyIndexList = s, l.parseNotificationRemoveDevicesNotificationMixin = u;
}), 98);
