__d("WASmaxInVoipWaitingRoomToggleCallLinkResponseWaitingRoomToggleCallLinkAck", [
	"WAResultOrError",
	...
	function e(e, t) {
		...
		var r = o("WASmaxParseUtils").flattenedChildWithTag(e, "waiting_room_toggle");
		if (!r.success) return r;
		var a = o("WASmaxParseJid").literalJid(o("WASmaxParseJid").attrDomainJid, e, "from", "call");
		if (!a.success) return a;
		var i = o("WASmaxParseUtils").literal(o("WASmaxParseUtils").attrString, e, "type", "waiting_room_toggle");
