__d("WASmaxInWaffleEncryptedPayloadRequestResponseError", [
	"WAResultOrError",
	...
	function e(e, t) {
		...
		return i.success ? o("WAResultOrError").makeResult(babelHelpers.extends({}, a.value, { errorEncryptedPayloadRequestErrors: i.value })) : i;
	}
