__d("WASmaxInWaffleEncryptedPayloadRequestResponseSuccess", [
	"WAResultOrError",
	"WASmaxInWaffleEnums",
	...
	function s(t, n) {
		...
		return s.success ? o("WAResultOrError").makeResult(babelHelpers.extends({ encryptionMetadataRSAEncryptionMetadataMixin: l.value }, s.value, { wfDeleted: i.value })) : s;
	}
