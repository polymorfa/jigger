__d("WASmaxInWaffleGetCertificateErrors", [
	"WAResultOrError",
	...
	function e(e) {
		...
		var r = o("WASmaxInWaffleIQErrorNotAllowedMixin").parseIQErrorNotAllowedMixin(e);
		...
		var l = o("WASmaxInWaffleIQErrorServiceUnavailableMixin").parseIQErrorServiceUnavailableMixin(e);
		if (l.success) return o("WAResultOrError").makeResult({
			name: "IQErrorServiceUnavailable",
			value: l.value
		});
		var s = o("WASmaxInWaffleIQErrorFeatureNotImplementedMixin").parseIQErrorFeatureNotImplementedMixin(e);
