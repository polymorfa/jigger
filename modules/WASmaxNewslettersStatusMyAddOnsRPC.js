__d("WASmaxNewslettersStatusMyAddOnsRPC", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = o("WASmaxOutNewslettersStatusMyAddOnsRequest").makeStatusMyAddOnsRequest(e), r = yield o("WAComms").sendSmaxStanza(n, t), a = o("WASmaxInNewslettersStatusMyAddOnsResponseSuccess").parseStatusMyAddOnsResponseSuccess(r, n);
			if (a.success) return {
