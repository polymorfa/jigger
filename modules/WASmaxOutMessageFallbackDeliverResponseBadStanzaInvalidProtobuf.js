__d("WASmaxOutMessageFallbackDeliverResponseBadStanzaInvalidProtobuf", [
	"WASmaxAttrs",
	...
	function e(e, t) {
		var n = e.metaFailureReason, r = o("WASmaxParseReference").attrFromReference(o("WASmaxParseUtils").attrStanzaId, t, ["id"]);
		...
		var s = o("WASmaxJsx").smax("ack", {
			...
			error: "491"
		}, o("WASmaxJsx").smax("meta", { failure_reason: o("WAWap").INT(n) }));
		return s;
	}
	l.makeDeliverResponseBadStanzaInvalidProtobuf = e;
}), 98);
