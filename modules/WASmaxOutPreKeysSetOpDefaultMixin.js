__d("WASmaxOutPreKeysSetOpDefaultMixin", [
	"WASmaxAttrs",
	"WASmaxChildren",
	"WASmaxJsx",
	"WASmaxMixins",
	...
	function e(e) {
		var t = e.coexTokenElementValue, n = o("WASmaxJsx").smax("coex_token", null, t);
		return n;
	}
	function s(t) {
		var n = t.coexTokenArgs, r = t.opReason, a = o("WASmaxJsx").smax("iq", null, o("WASmaxJsx").smax("op", {
			mode: "set",
