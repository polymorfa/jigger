__d("WASmaxOutSpamNewsletterReportRequest", [
	"WASmaxChildren",
	"WASmaxJsx",
	...
	function e(e) {
		var t = e.messageFrom, n = o("WASmaxOutSpamMessageMixin").mergeMessageMixin(o("WASmaxJsx").smax("message", { from: o("WAWap").JID(t) }), e);
		return n;
	}
	function s(t) {
	...
	l.makeNewsletterReportRequestSpamListMessage = e, l.makeNewsletterReportRequest = s;
}), 98);
