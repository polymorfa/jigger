__d("WASmaxOutStatusDeliverStatusAckMixin", [
	...
	function e(e) {
		var t = o("WASmaxParseReference").attrFromReference(o("WASmaxParseJid").attrJidEnum, e, ["from"], o("WASmaxInStatusDeliverEnums").GROUPJID_NEWSLETTERJID_STATUSJID);
