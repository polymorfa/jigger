__d("WASmaxParseJid", [
	...
	function g(e, t, n) {
		...
		return o("WASmaxParseUtils").errorMessage(e, "to have \"" + t + "\"={" + a + "}, but instead has \"" + r.value + "\"");
	}
	function h(e, t, n, r) {
		var a = e(t, n);
	...
	l.attrUserJid = e, l.attrLidUserJid = s, l.attrDeviceJid = u, l.attrGroupJid = c, l.attrCallJid = d, l.attrDomainJid = m, l.attrBroadcastJid = p, l.attrStatusJid = _, l.attrNewsletterJid = f, l.attrJidEnum = g, l.literalJid = h, l.optionalLiteralJid = y;
}), 98);
