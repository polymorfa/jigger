__d("WASmaxPreKeysAddRPC", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = o("WASmaxOutPreKeysAddRequest").makeAddRequest(e), r = yield o("WAComms").sendSmaxStanza(n, t), a = o("WASmaxInPreKeysAddResponseSuccess").parseAddResponseSuccess(r, n);
			if (a.success) return {
