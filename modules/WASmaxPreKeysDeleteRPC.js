__d("WASmaxPreKeysDeleteRPC", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = o("WASmaxOutPreKeysDeleteRequest").makeDeleteRequest(e), r = yield o("WAComms").sendSmaxStanza(n, t), a = o("WASmaxInPreKeysDeleteResponseSuccess").parseDeleteResponseSuccess(r, n);
			if (a.success) return {
