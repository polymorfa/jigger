__d("WATheiaRaTls", [
	...
	var S = (function() {
		...
		return t.performHandshake = function(t, n, r) {
			...
			var e = E(this), n = e.tlsEncapsulate(t);
			return n;
		}, t.tlsDecapsulate = function(t) {
			var e = E(this), n = e.tlsDecapsulate(t);
			return n;
		}, t.getState = function() {
			var e = E(this), t = e.getState();
			return t;
		}, t.getAttestationBundles = function() {
			var e = E(this), t = e.getAttestationBundles();
			return t;
		}, t.getLocalServiceTransparencyReport = function() {
			var e = E(this), t = e.getLocalServiceTransparencyReport();
			return t;
		}, t.close = function() {
			var e = g.get(this);
		...
		return t.createSession = function(t, n) {
			n === void 0 && (n = {});
			var e = n, r = e.enableTheiaV2Mode, o = r === void 0 ? !1 : r, a = e.requestTransparencyReport, i = a === void 0 ? !1 : a, l = e.serializedTrustedNode, s = l === void 0 ? null : l, u = e.shouldVerifyCert, c = u === void 0 ? !0 : u, d = e.teeSessionId, m = d === void 0 ? null : d, p = L(t);
			try {
				var _ = new this.$1.TheiaRaTlsSession(p, c, o, i, s, m), f = new S(_);
				return f;
			} catch (e) {
				throw e;
			}
	...
	l.WATheiaRaTlsState = s, l.WATheiaRaTlsClientPolicy = u, l.loadWATheiaRaTls = h, l.WATheiaRaTlsSession = S, l.WATheiaRaTls = R;
}), 98);
