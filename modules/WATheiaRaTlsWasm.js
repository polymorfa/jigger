__d("WATheiaRaTlsWasm", ["Promise"], (function(t, n, r, o, a, i) {
	var e, l = (function() {
		...
		return (function(o) {
			...
			a.ready = new (e || (e = (n("Promise"))))(function(e, t) {
				...
				Object.getOwnPropertyDescriptor(a.ready, e) || Object.defineProperty(a.ready, e, {
					get: function() {
						return ue("You are getting " + e + " on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
					},
					set: function() {
						return ue("You are setting " + e + " on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
					}
				});
			});
			var s = Object.assign({}, a), u = [], c = "./this.program", d = function(t, n) {
				throw n;
			}, m = !0, p = !1, _ = !1, f = !1;
			if (a.ENVIRONMENT) throw new Error("Module.ENVIRONMENT has been deprecated. To force the environment, use the ENVIRONMENT compile-time option (for example, -sENVIRONMENT=web or -sENVIRONMENT=node)");
			var g = "";
			function h(e) {
				return a.locateFile ? a.locateFile(e, g) : g + e;
			}
			var y, C, b, v;
			if (typeof document != "undefined" && document.currentScript && (g = document.currentScript.src), r && (g = r), g.indexOf("blob:") !== 0 ? g = g.substr(0, g.replace(/[?#].*/, "").lastIndexOf("/") + 1) : g = "", !(typeof window == "object" || typeof importScripts == "function")) throw new Error("not compiled for this environment (did you build to HTML and try to run it not on the web, or set ENVIRONMENT to something - like node - and run it someplace else - like on the web?)");
			y = function(t) {
			...
			var S = a.print || console.log.bind(console), R = a.printErr || console.error.bind(console);
			Object.assign(a, s), s = null, Ao(), a.arguments && (u = a.arguments), Re("arguments", "arguments_"), a.thisProgram && (c = a.thisProgram), Re("thisProgram", "thisProgram"), a.quit && (d = a.quit), Re("quit", "quit_"), x(typeof a.memoryInitializerPrefixURL == "undefined", "Module.memoryInitializerPrefixURL option was removed, use Module.locateFile instead"), x(typeof a.pthreadMainPrefixURL == "undefined", "Module.pthreadMainPrefixURL option was removed, use Module.locateFile instead"), x(typeof a.cdInitializerPrefixURL == "undefined", "Module.cdInitializerPrefixURL option was removed, use Module.locateFile instead"), x(typeof a.filePackagePrefixURL == "undefined", "Module.filePackagePrefixURL option was removed, use Module.locateFile instead"), x(typeof a.read == "undefined", "Module.read option was removed (modify read_ in JS)"), x(typeof a.readAsync == "undefined", "Module.readAsync option was removed (modify readAsync in JS)"), x(typeof a.readBinary == "undefined", "Module.readBinary option was removed (modify readBinary in JS)"), x(typeof a.setWindowTitle == "undefined", "Module.setWindowTitle option was removed (modify setWindowTitle in JS)"), x(typeof a.TOTAL_MEMORY == "undefined", "Module.TOTAL_MEMORY has been renamed Module.INITIAL_MEMORY"), Re("asm", "wasmExports"), Re("read", "read_"), Re("readAsync", "readAsync"), Re("readBinary", "readBinary"), Re("setWindowTitle", "setWindowTitle"), x(!p, "worker environment detected but not enabled at build time.  Add 'worker' to `-sENVIRONMENT` to enable."), x(!_, "node environment detected but not enabled at build time.  Add 'node' to `-sENVIRONMENT` to enable."), x(!f, "shell environment detected but not enabled at build time.  Add 'shell' to `-sENVIRONMENT` to enable.");
			var L;
			a.wasmBinary && (L = a.wasmBinary), Re("wasmBinary", "wasmBinary");
			var E = a.noExitRuntime || !0;
			Re("noExitRuntime", "noExitRuntime"), typeof WebAssembly != "object" && ue("no native wasm support detected");
			var k, I, T = !1, D;
			function x(e, t) {
			...
			function q() {
				var e = k.buffer;
				a.HEAP8 = $ = new Int8Array(e), a.HEAP16 = N = new Int16Array(e), a.HEAP32 = w = new Int32Array(e), a.HEAPU8 = P = new Uint8Array(e), a.HEAPU16 = M = new Uint16Array(e), a.HEAPU32 = A = new Uint32Array(e), a.HEAPF32 = F = new Float32Array(e), a.HEAPF64 = W = new Float64Array(e), a.HEAP64 = O = new BigInt64Array(e), a.HEAPU64 = B = new BigUint64Array(e);
			}
			x(!a.STACK_SIZE, "STACK_SIZE can no longer be set at runtime.  Use -sSTACK_SIZE at link time"), x(typeof Int32Array != "undefined" && typeof Float64Array != "undefined" && Int32Array.prototype.subarray != null && Int32Array.prototype.set != null, "JS engine does not provide full typed array support"), x(!a.wasmMemory, "Use of `wasmMemory` detected.  Use -sIMPORTED_MEMORY to define wasmMemory externally"), x(!a.INITIAL_MEMORY, "Detected runtime INITIAL_MEMORY setting.  Use -sIMPORTED_MEMORY to define wasmMemory dynamically");
			var U;
			function V() {
				var e = Zo();
				x((e & 3) == 0), e == 0 && (e += 4), A[e >> 2] = 34821223, A[e + 4 >> 2] = 2310721022, A[0] = 1668509029;
			}
			function H() {
				if (!T) {
					var e = Zo();
					e == 0 && (e += 4);
					var t = A[e >> 2], n = A[e + 4 >> 2];
					(t != 34821223 || n != 2310721022) && ue("Stack overflow! Stack cookie has been overwritten at " + Oe(e) + ", expected hex dwords 0x89BACDFE and 0x2135467, but received " + Oe(n) + " " + Oe(t)), A[0] != 1668509029 && ue("Runtime error: The application has corrupted its heap memory area (address zero)!");
				}
			}
			(function() {
			...
			function Y() {
				x(!K), K = !0, H(), !a.noFSInit && !kt.init.initialized && kt.init(), kt.ignorePermissions = !1, dt.init(), xe(z);
			}
			function J() {
				if (H(), a.postRun) for (typeof a.postRun == "function" && (a.postRun = [a.postRun]); a.postRun.length;) te(a.postRun.shift());
				xe(j);
			}
			function Z(e) {
				G.unshift(e);
			...
			function le(e) {
				ne++, a.monitorRunDependencies && a.monitorRunDependencies(ne), e ? (x(!ae[e]), ae[e] = 1, re === null && typeof setInterval != "undefined" && (re = setInterval(function() {
					if (T) {
						clearInterval(re), re = null;
						return;
					}
					var e = !1;
					for (var t in ae) e || (e = !0, R("still waiting on run dependencies:")), R("dependency: " + t);
					e && R("(end of list)");
				}, 1e4))) : R("warning: run dependency added without ID");
			}
			function se(e) {
				if (ne--, a.monitorRunDependencies && a.monitorRunDependencies(ne), e ? (x(ae[e]), delete ae[e]) : R("warning: run dependency removed without ID"), ne == 0 && (re !== null && (clearInterval(re), re = null), oe)) {
					var t = oe;
					oe = null, t();
				}
			}
			function ue(e) {
				a.onAbort && a.onAbort(e), e = "Aborted(" + e + ")", R(e), T = !0, D = 1;
			...
			function pe(e) {
				return function() {
					x(K, "native function `" + e + "` called before runtime initialization");
					var t = I[e];
					return x(t, "exported native function `" + e + "` not found"), t.apply(null, arguments);
				};
			}
			var _e = (function(e) {
				"use strict";
			...
			})(babelHelpers.wrapNativeSuper(Error)), fe = (function(e) {
				"use strict";
				function t() {
					return e.apply(this, arguments) || this;
				}
			...
			function Ce(t) {
				return !L && (m || p) && typeof fetch == "function" ? fetch(t, { credentials: "same-origin" }).then(function(e) {
			...
			function be(e, t, n) {
				return Ce(e).then(function(e) {
					...
					R("failed to asynchronously prepare wasm: " + e), me(he) && R("warning: Loading from a file URI (" + he + ") is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing"), ue(e);
				});
			}
			function ve(e, t, n, r) {
				return !e && typeof WebAssembly.instantiateStreaming == "function" && !de(t) && typeof fetch == "function" ? fetch(t, { credentials: "same-origin" }).then(function(e) {
					...
					return o.then(r, function(e) {
						return R("wasm streaming compile failed: " + e), R("falling back to ArrayBuffer instantiation"), be(t, n, r);
					});
				}) : be(t, n, r);
			}
			function Se() {
				var e = {
					env: Fo,
					wasi_snapshot_preview1: Fo
				};
				function t(e, t) {
					var n = e.exports;
					return I = n, k = I.memory, x(k, "memory not found in wasm exports"), q(), U = I.__indirect_function_table, x(U, "table not found in wasm exports"), ee(I.__wasm_call_ctors), se("wasm-instantiate"), n;
				}
				le("wasm-instantiate");
				var n = a;
				function r(e) {
					x(a === n, "the Module object should not be replaced during async compilation - perhaps the order of HTML elements is wrong?"), n = null, t(e.instance);
				}
				if (a.instantiateWasm) try {
					return a.instantiateWasm(e, t);
				} catch (e) {
					R("Module.instantiateWasm callback failed with error: " + e), l(e);
				}
				return ve(L, he, e, r).catch(l), {};
			}
			function Re(e, t, n) {
				n === void 0 && (n = !0), Object.getOwnPropertyDescriptor(a, e) || Object.defineProperty(a, e, {
					configurable: !0,
					get: function() {
						...
						ue("`Module." + e + "` has been replaced by `" + t + "`" + r);
					}
				});
			}
			function Le(e) {
				Object.getOwnPropertyDescriptor(a, e) && ue("`Module." + e + "` was supplied but `" + e + "` not included in INCOMING_MODULE_JS_API");
			}
			function Ee(e) {
			...
			function Ie(e) {
				typeof globalThis != "undefined" && !Object.getOwnPropertyDescriptor(globalThis, e) && Object.defineProperty(globalThis, e, {
					...
					get: function() {
						...
						n.startsWith("_") || (n = "$" + e), t += " (e.g. -sDEFAULT_LIBRARY_FUNCS_TO_INCLUDE='" + n + "')", Ee(e) && (t += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), We(t);
					}
				}), Te(e);
			}
			function Te(e) {
				Object.getOwnPropertyDescriptor(a, e) || Object.defineProperty(a, e, {
					...
					get: function() {
						...
						Ee(e) && (t += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), ue(t);
					}
				});
			}
			function De(e) {
			...
			var xe = function(t) {
				...
				var e = ea(), n = t();
				return ta(e), n;
			}, Pe = typeof TextDecoder != "undefined" ? new TextDecoder("utf8") : void 0, Ne = function(t, n, r) {
				for (var e = n + r, o = n; t[o] && !(o >= e);) ++o;
				if (o - n > 16 && t.buffer && Pe) return Pe.decode(t.subarray(n, o));
				for (var a = ""; n < o;) {
					var i = t[n++];
					if (!(i & 128)) {
					...
					var s = t[n++] & 63;
					if ((i & 240) == 224 ? i = (i & 15) << 12 | l << 6 | s : ((i & 248) != 240 && We("Invalid UTF-8 leading byte " + Oe(i) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), i = (i & 7) << 18 | l << 12 | s << 6 | t[n++] & 63), i < 65536) a += String.fromCharCode(i);
					else {
						var u = i - 65536;
			...
			function Fe(e, t) {
				switch (t === void 0 && (t = "i8"), t.endsWith("*") && (t = "*"), t) {
					case "i1": return $[e >> 0];
					case "i8": return $[e >> 0];
					case "i16": return N[e >> 1];
					case "i32": return w[e >> 2];
					case "i64": return O[e >> 3];
					case "float": return F[e >> 2];
					case "double": return W[e >> 3];
					case "*": return A[e >> 2];
					default: ue("invalid type for getValue: " + t);
				}
			}
			var Oe = function(t) {
				return x(typeof t == "number"), t >>>= 0, "0x" + t.toString(16).padStart(8, "0");
			};
			function Be(e, t, n) {
				switch (n === void 0 && (n = "i8"), n.endsWith("*") && (n = "*"), n) {
					case "i1":
						$[e >> 0] = t;
						break;
					case "i8":
					...
					case "*":
						A[e >> 2] = t;
						break;
					default: ue("invalid type for setValue: " + n);
				}
			}
			var We = function(t) {
				We.shown || (We.shown = {}), We.shown[t] || (We.shown[t] = 1, R(t));
			}, qe = function(t, n, r, o) {
				ue("Assertion failed: " + Me(t) + ", at: " + [
			...
			function He(e) {
				var t = new je(e);
				return t.get_caught() || (t.set_caught(!0), Ve--), t.set_rethrown(!1), Ue.push(t), aa(t.excPtr), t.get_exception_ptr();
			}
			var Ge = 0;
			function ze() {
			...
			function Je() {
				...
				var t = e.excPtr;
				throw e.get_rethrown() || (Ue.push(e), e.set_rethrown(!0), e.set_caught(!1), Ve++), Ge = new ge(t), Ge;
			}
			function Ze(e, t, n) {
				var r = new je(e);
			...
			var tt = function(t) {
				...
				normalize: function(t) {
					var e = nt.isAbs(t), n = t.substr(-1) === "/";
					return t = nt.normalizeArray(t.split("/").filter(function(e) {
						return !!e;
					}), !e).join("/"), !t && !e && (t = "."), t && n && (t += "/"), (e ? "/" : "") + t;
				},
				dirname: function(t) {
					var e = nt.splitPath(t), n = e[0], r = e[1];
				...
				ue("no cryptographic support found for randomDevice. consider polyfilling it if you want to use something insecure like Math.random(), e.g. put this in a --pre-js: var crypto = { getRandomValues: (array) => { for (var i = 0; i < array.length; i++) array[i] = (Math.random()*256)|0 } };");
			}, ot = function(t) {
				return (ot = rt())(t);
			}, at = {
				resolve: function() {
					...
					return e = nt.normalizeArray(e.split("/").filter(function(e) {
						return !!e;
					}), !t).join("/"), (t ? "/" : "") + e || ".";
				},
				...
				for (var e = r, a = r + o - 1, i = 0; i < t.length; ++i) {
					...
					if (l <= 127) {
						...
						if (r + 3 >= a) break;
						l > 1114111 && We("Invalid Unicode code point " + Oe(l) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), n[r++] = 240 | l >> 18, n[r++] = 128 | l >> 12 & 63, n[r++] = 128 | l >> 6 & 63, n[r++] = 128 | l & 63;
					}
				}
				return n[r] = 0, r - e;
			};
			function ut(e, t, n) {
				var r = n > 0 ? n : lt(e) + 1, o = new Array(r), a = st(e, o, 0, o.length);
			...
			var ct = function() {
				...
				default_tty_ops: {
					...
					put_char: function(t, n) {
						n === null || n === 10 ? (S(Ne(t.output, 0)), t.output = []) : n != 0 && t.output.push(n);
					},
					fsync: function(t) {
						t.output && t.output.length > 0 && (S(Ne(t.output, 0)), t.output = []);
					},
				...
				default_tty1_ops: {
					put_char: function(t, n) {
						n === null || n === 10 ? (R(Ne(t.output, 0)), t.output = []) : n != 0 && t.output.push(n);
					},
					fsync: function(t) {
						t.output && t.output.length > 0 && (R(Ne(t.output, 0)), t.output = []);
					}
				}
			}, mt = function(t, n) {
				return P.fill(0, t, t + n), t;
			}, pt = function(t, n) {
				return x(n, "alignment argument is required"), Math.ceil(t / n) * n;
			}, _t = function(t) {
				t = pt(t, 65536);
				var e = jo(65536, t);
				return e ? mt(e, t) : 0;
				...
				createNode: function(t, n, r, o) {
					...
					return kt.isDir(e.mode) ? (e.node_ops = ft.ops_table.dir.node, e.stream_ops = ft.ops_table.dir.stream, e.contents = {}) : kt.isFile(e.mode) ? (e.node_ops = ft.ops_table.file.node, e.stream_ops = ft.ops_table.file.stream, e.usedBytes = 0, e.contents = null) : kt.isLink(e.mode) ? (e.node_ops = ft.ops_table.link.node, e.stream_ops = ft.ops_table.link.stream) : kt.isChrdev(e.mode) && (e.node_ops = ft.ops_table.chrdev.node, e.stream_ops = ft.ops_table.chrdev.stream), e.timestamp = Date.now(), t && (t.contents[n] = e, t.timestamp = e.timestamp), e;
				},
				...
				stream_ops: {
					read: function(t, n, r, o, a) {
						...
						if (x(i >= 0), i > 8 && e.subarray) n.set(e.subarray(a, a + i), r);
						else for (var l = 0; l < i; l++) n[r + l] = e[a + l];
						return i;
					},
					write: function(t, n, r, o, a, i) {
						if (x(!(n instanceof ArrayBuffer)), n.buffer === $.buffer && (i = !1), !o) return 0;
						var e = t.node;
						if (e.timestamp = Date.now(), n.subarray && (!e.contents || e.contents.subarray)) {
							if (i) return x(a === 0, "canOwn must imply no weird position inside the file"), e.contents = n.subarray(r, r + o), e.usedBytes = o, o;
					...
					mmap: function(t, n, r, o, a) {
						...
						var e, i, l = t.node.contents;
						if (!(a & 2) && l.buffer === $.buffer) i = !1, e = l.byteOffset;
						else {
							if ((r > 0 || r + n < l.length) && (l.subarray ? l = l.subarray(r, r + n) : l = Array.prototype.slice.call(l, r, r + n)), i = !0, e = _t(n), !e) throw new kt.ErrnoError(48);
							$.set(l, e);
						}
						return {
							ptr: e,
				...
				var e = o ? "" : ie("al " + t);
				C(t, function(r) {
					x(r, "Loading data file \"" + t + "\" failed (no arrayBuffer)."), n(new Uint8Array(r)), e && se(e);
				}, function(e) {
					if (r) r();
			...
			function Ct(e, t, n, r, o, a, i, l, s, u) {
				var c = t ? at.resolve(nt.join2(e, t)) : e, d = ie("cp " + c);
				function m(n) {
					function m(n) {
						u && u(), l || kt.createDataFile(e, t, n, r, o, s), a && a(), se(d);
					}
					yt(n, c, m, function() {
						i && i(), se(d);
					}) || m(n);
				}
				le(d), typeof n == "string" ? gt(n, function(e) {
					return m(e);
				}, i) : m(n);
			}
			function bt(e) {
			...
			function Lt(e) {
				return We("warning: build with -sDEMANGLE_SUPPORT to link in libcxxabi demangling"), e;
			}
			function Et(e) {
				var t = /\b_Z[\w\d_]+/g;
			...
			var kt = {
				...
				lookupPath: function(t, n) {
					if (n === void 0 && (n = {}), t = at.resolve(t), !t) return {
						path: "",
						node: null
					};
					var e = {
					...
					for (var r = t.split("/").filter(function(e) {
						...
						var l = i === r.length - 1;
						if (l && n.parent) break;
						if (o = kt.lookupNode(o, r[i]), a = nt.join2(a, r[i]), kt.isMountpoint(o) && (!l || l && n.follow_mount) && (o = o.mounted.root), !l || n.follow) for (var s = 0; kt.isLink(o.mode);) {
							var u = kt.readlink(a);
				...
				syncfs: function(t, n) {
					typeof t == "function" && (n = t, t = !1), kt.syncFSRequests++, kt.syncFSRequests > 1 && R("warning: " + kt.syncFSRequests + " FS.syncfs operations in flight at once, probably just doing extra work");
				...
				mknod: function(t, n, r) {
					var e = kt.lookupPath(t, { parent: !0 }), o = e.node, a = nt.basename(t);
				...
				symlink: function(t, n) {
					...
					var o = nt.basename(n), a = kt.mayCreate(r, o);
					if (a) throw new kt.ErrnoError(a);
					if (!r.node_ops.symlink) throw new kt.ErrnoError(63);
					return r.node_ops.symlink(r, o, t);
				},
				rename: function(t, n) {
					var e = nt.dirname(t), r = nt.dirname(n), o = nt.basename(t), a = nt.basename(n), i, l, s;
					...
					var u = kt.lookupNode(l, o), c = at.relative(t, r);
					if (c.charAt(0) !== ".") throw new kt.ErrnoError(28);
					if (c = at.relative(n, e), c.charAt(0) !== ".") throw new kt.ErrnoError(55);
					var d;
					try {
						d = kt.lookupNode(s, a);
					} catch (e) {}
				...
				rmdir: function(t) {
					var e = kt.lookupPath(t, { parent: !0 }), n = e.node, r = nt.basename(t), o = kt.lookupNode(n, r), a = kt.mayDelete(n, r, !0);
					if (a) throw new kt.ErrnoError(a);
				...
				unlink: function(t) {
					...
					var r = nt.basename(t), o = kt.lookupNode(n, r), a = kt.mayDelete(n, r, !1);
					if (a) throw new kt.ErrnoError(a);
				...
				open: function(t, n, r) {
					...
					n = typeof n == "string" ? bt(n) : n, r = typeof r == "undefined" ? 438 : r, n & 64 ? r = r & 4095 | 32768 : r = 0;
					var e;
					...
					return s.stream_ops.open && s.stream_ops.open(s), a.logReadFiles && !(n & 1) && (kt.readFiles || (kt.readFiles = {}), t in kt.readFiles || (kt.readFiles[t] = 1)), s;
				},
				close: function(t) {
				...
				msync: function(t, n, r, o, a) {
					return x(r >= 0), t.stream_ops.msync ? t.stream_ops.msync(t, n, r, o, a) : 0;
				},
				munmap: function(t) {
					return 0;
				},
				...
				readFile: function(t, n) {
					...
					return kt.read(r, i, 0, a, 0), n.encoding === "utf8" ? e = Ne(i, 0) : n.encoding === "binary" && (e = i), kt.close(r), e;
				},
				writeFile: function(t, n, r) {
					r === void 0 && (r = {}), r.flags = r.flags || 577;
					var e = kt.open(t, r.flags, r.mode);
					if (typeof n == "string") {
						var o = new Uint8Array(lt(n) + 1), a = st(n, o, 0, o.length);
				...
				createDefaultDevices: function() {
					...
					}), kt.mkdev("/dev/null", kt.makedev(1, 3)), dt.register(kt.makedev(5, 0), dt.default_tty_ops), dt.register(kt.makedev(6, 0), dt.default_tty1_ops), kt.mkdev("/dev/tty", kt.makedev(5, 0)), kt.mkdev("/dev/tty1", kt.makedev(6, 0));
				...
				createStandardStreams: function() {
					a.stdin ? kt.createDevice("/dev", "stdin", a.stdin) : kt.symlink("/dev/tty", "/dev/stdin"), a.stdout ? kt.createDevice("/dev", "stdout", null, a.stdout) : kt.symlink("/dev/tty", "/dev/stdout"), a.stderr ? kt.createDevice("/dev", "stderr", null, a.stderr) : kt.symlink("/dev/tty1", "/dev/stderr");
					var e = kt.open("/dev/stdin", 0), t = kt.open("/dev/stdout", 1), n = kt.open("/dev/stderr", 1);
					x(e.fd === 0, "invalid handle for stdin (" + e.fd + ")"), x(t.fd === 1, "invalid handle for stdout (" + t.fd + ")"), x(n.fd === 2, "invalid handle for stderr (" + n.fd + ")");
				},
				ensureErrnoError: function() {
					kt.ErrnoError || (kt.ErrnoError = function(t, n) {
						this.name = "ErrnoError", this.node = n, this.setErrno = function(e) {
							this.errno = e;
							for (var t in Rt) if (Rt[t] === e) {
								this.code = t;
								break;
							}
						}, this.setErrno(t), this.message = St[t], this.stack && (Object.defineProperty(this, "stack", {
				...
				staticInit: function() {
					kt.ensureErrnoError(), kt.nameTable = new Array(4096), kt.mount(ft, {}, "/"), kt.createDefaultDirectories(), kt.createDefaultDevices(), kt.createSpecialDirectories(), kt.filesystems = { MEMFS: ft };
				},
				init: function(t, n, r) {
					x(!kt.init.initialized, "FS.init was previously called. If you want to initialize later with custom parameters, remove any earlier calls (note that one is automatically added to the generated code)"), kt.init.initialized = !0, kt.ensureErrnoError(), a.stdin = t || a.stdin, a.stdout = n || a.stdout, a.stderr = r || a.stderr, kt.createStandardStreams();
				},
				quit: function() {
				...
				analyzePath: function(t, n) {
					...
					try {
						...
						r.parentExists = !0, r.parentPath = e.path, r.parentObject = e.node, r.name = nt.basename(t), e = kt.lookupPath(t, { follow: !n }), r.exists = !0, r.path = e.path, r.object = e.node, r.name = e.node.name, r.isRoot = e.path === "/";
					} catch (e) {
						r.error = e.errno;
					}
					return r;
				...
				createFile: function(t, n, r, o, a) {
					var e = nt.join2(typeof t == "string" ? t : kt.getPath(t), n), i = vt(o, a);
					return kt.create(e, i);
				},
				createDataFile: function(t, n, r, o, a, i) {
					var e = n;
					t && (t = typeof t == "string" ? t : kt.getPath(t), e = n ? nt.join2(t, n) : t);
					var l = vt(o, a), s = kt.create(e, l);
					if (r) {
						if (typeof r == "string") {
				...
				createDevice: function(t, n, r, o) {
					var e = nt.join2(typeof t == "string" ? t : kt.getPath(t), n), a = vt(!!r, !!o);
				...
				forceLoadFile: function(t) {
					...
					if (y) try {
						t.contents = ut(y(t.url), !0), t.usedBytes = t.contents.length;
					} catch (e) {
						throw new kt.ErrnoError(29);
					}
				...
				createLazyFile: function(t, n, r, o, a) {
					...
					if (e.prototype.get = function(t) {
						...
						var l = function(n, o) {
							...
							return e.response !== void 0 ? new Uint8Array(e.response || []) : ut(e.responseText || "", !0);
						}, s = this;
						s.setDataGetter(function(e) {
							...
							return s.chunks[e];
						}), (a || !t) && (i = t = 1, t = this.getter(0).length, i = t, S("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = t, this._chunkSize = i, this.lengthKnown = !0;
					...
					l.contents ? s.contents = l.contents : l.url && (s.contents = null, s.url = l.url), Object.defineProperties(s, { usedBytes: { get: function() {
						return this.contents.length;
					} } });
					var u = {}, c = Object.keys(s.stream_ops);
					...
					function d(e, t, n, r, o) {
						...
						if (x(i >= 0), a.slice) for (var l = 0; l < i; l++) t[n + l] = a[o + l];
						else for (var l = 0; l < i; l++) t[n + l] = a.get(o + l);
						return i;
					}
					return u.read = function(e, t, n, r, o) {
				...
				absolutePath: function() {
					ue("FS.absolutePath has been removed; use PATH_FS.resolve instead");
				},
				...
				mmapAlloc: function() {
					ue("FS.mmapAlloc has been replaced by the top level function mmapAlloc");
				},
				standardizePath: function() {
					ue("FS.standardizePath has been removed; use PATH.normalize instead");
				}
			}, It = {
				DEFAULT_POLLMASK: 5,
				...
				doStat: function(t, n, r) {
					try {
						...
						if (e && e.node && nt.normalize(n) !== nt.normalize(kt.getPath(e.node))) return -54;
						throw e;
					}
					w[r >> 2] = e.dev, w[r + 4 >> 2] = e.mode, A[r + 8 >> 2] = e.nlink, w[r + 12 >> 2] = e.uid, w[r + 16 >> 2] = e.gid, w[r + 20 >> 2] = e.rdev, O[r + 24 >> 3] = BigInt(e.size), w[r + 32 >> 2] = 4096, w[r + 36 >> 2] = e.blocks;
					var o = e.atime.getTime(), a = e.mtime.getTime(), i = e.ctime.getTime();
					return O[r + 40 >> 3] = BigInt(Math.floor(o / 1e3)), A[r + 48 >> 2] = o % 1e3 * 1e3, O[r + 56 >> 3] = BigInt(Math.floor(a / 1e3)), A[r + 64 >> 2] = a % 1e3 * 1e3, O[r + 72 >> 3] = BigInt(Math.floor(i / 1e3)), A[r + 80 >> 2] = i % 1e3 * 1e3, O[r + 88 >> 3] = BigInt(e.ino), 0;
				},
					...
					switch (t) {
						...
						case 21505: {
							...
							if (r.tty.ops.ioctl_tcgets) {
								var o = r.tty.ops.ioctl_tcgets(r), a = It.get();
								w[a >> 2] = o.c_iflag || 0, w[a + 4 >> 2] = o.c_oflag || 0, w[a + 8 >> 2] = o.c_cflag || 0, w[a + 12 >> 2] = o.c_lflag || 0;
								for (var i = 0; i < 32; i++) $[a + i + 17 >> 0] = o.c_cc[i] || 0;
								return 0;
							}
							return 0;
						}
						...
						case 21508: {
							...
							if (r.tty.ops.ioctl_tcsets) {
								for (var a = It.get(), l = w[a >> 2], s = w[a + 4 >> 2], u = w[a + 8 >> 2], c = w[a + 12 >> 2], d = [], i = 0; i < 32; i++) d.push($[a + i + 17 >> 0]);
						...
						case 21523: {
							...
							if (r.tty.ops.ioctl_tiocgwinsz) {
								var m = r.tty.ops.ioctl_tiocgwinsz(r.tty), a = It.get();
			...
			function Ut(e, t, n) {
				...
				t.forEach(function(e, t) {
					Object.prototype.hasOwnProperty.call(At, e) ? o[t] = At[e] : (a.push(e), Object.prototype.hasOwnProperty.call(wt, e) || (wt[e] = []), wt[e].push(function() {
			...
			function Vt(e, t, n) {
				n === void 0 && (n = {});
				var r = t.name;
				if (e || Bt("type \"" + r + "\" must have a positive integer typeid pointer"), Object.prototype.hasOwnProperty.call(At, e)) {
					if (n.ignoreDuplicateRegistrations) return;
					Bt("Cannot register type '" + r + "' twice");
				}
				if (At[e] = t, delete Ft[e], Object.prototype.hasOwnProperty.call(wt, e)) {
					var o = wt[e];
			...
			function zt(e, t, n, r, o) {
				t = Mt(t);
				var a = jt(n), i = t.indexOf("u") != -1;
				i && (o = (BigInt(1) << BigInt(64)) - BigInt(1)), Ht(e, {
					name: t,
					fromWireType: function(t) {
						return t;
					},
					toWireType: function(n, a) {
						if (typeof a != "bigint" && typeof a != "number") throw new TypeError("Cannot convert \"" + $t(a) + "\" to " + this.name);
						if (a < r || a > o) throw new TypeError("Passing a number \"" + $t(a) + "\" from JS side to C/C++ side to an argument of type \"" + t + "\", which is outside the valid range [" + r + ", " + o + "]!");
						return a;
					},
					argPackAdvance: 8,
			...
			function an() {
				var e = [];
				for (var t in mn) Object.prototype.hasOwnProperty.call(mn, t) && e.push(mn[t]);
				return e;
			}
			var ln = [];
			function sn() {
			...
			function dn() {
				a.getInheritedInstanceCount = on, a.getLiveInheritedInstances = an, a.flushPendingDeletes = sn, a.setDelayFunction = cn;
			}
			var mn = {};
			function pn(e, t) {
				for (t === void 0 && Bt("ptr should not be undefined"); e.baseClass;) t = e.upcast(t), e = e.baseClass;
				return t;
			}
			function _n(e, t) {
			...
			function fn(e, t) {
				(!t.ptrType || !t.ptr) && qt("makeClassHandle requires ptr and ptrType");
				var n = !!t.smartPtrType, r = !!t.smartPtr;
				return n !== r && qt("Both smartPtrType and smartPtr must be specified"), t.count = { value: 1 }, hn(Object.create(e, { $$: { value: t } }));
			}
			function gn(e) {
				...
				var a = this.registeredClass.getActualType(t), i = rn[a];
				...
				return s === null ? o.call(this) : this.isSmartPointer ? fn(l.registeredClass.instancePrototype, {
					ptrType: l,
					ptr: s,
					smartPtrType: this,
					smartPtr: e
			...
			var hn = function(t) {
				return typeof FinalizationRegistry == "undefined" ? (hn = function(t) {
					return t;
				}, t) : (Jt = new FinalizationRegistry(function(e) {
					e.leakWarning.stack.replace(/^Error: /, ""), tn(e.$$);
				}), hn = function(t) {
					var e = t.$$, n = !!e.smartPtr;
					if (n) {
						var r = { $$: e }, o = e.ptrType.registeredClass;
						r.leakWarning = new Error("Embind found a leaked C++ instance " + o.name + " <" + Oe(e.ptr) + ">.\nWe'll free it automatically in this case, but this functionality is not reliable across various environments.\nMake sure to invoke .delete() manually once you're done with the instance instead.\nOriginally allocated"), "captureStackTrace" in Error && Error.captureStackTrace(r.leakWarning, gn), Jt.register(t, r, t);
					}
					return t;
				}, Zt = function(t) {
			...
			function yn() {
				...
				var e = hn(Object.create(Object.getPrototypeOf(this), { $$: { value: Xt(this.$$) } }));
				return e.$$.count.value += 1, e.$$.deleteScheduled = !1, e;
			}
			function Cn() {
				this.$$.ptr || Yt(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && Bt("Object already scheduled for deletion"), Zt(this), tn(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
			}
			function bn() {
				return !this.$$.ptr;
			}
			function vn() {
				return this.$$.ptr || Yt(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && Bt("Object already scheduled for deletion"), ln.push(this), ln.length === 1 && un && un(sn), this.$$.deleteScheduled = !0, this;
			}
			function Sn() {
				Rn.prototype.isAliasOf = Qt, Rn.prototype.clone = yn, Rn.prototype.delete = Cn, Rn.prototype.isDeleted = bn, Rn.prototype.deleteLater = vn;
			}
			function Rn() {}
			var Ln = 48, En = 57;
			function kn(e) {
			...
			function Tn(e, t, n) {
				if (e[t].overloadTable === void 0) {
					var r = e[t];
					e[t] = function() {
						return Object.prototype.hasOwnProperty.call(e[t].overloadTable, arguments.length) || Bt("Function '" + n + "' called with an invalid number of arguments (" + arguments.length + ") - expects one of (" + e[t].overloadTable + ")!"), e[t].overloadTable[arguments.length].apply(this, arguments);
					}, e[t].overloadTable = [], e[t].overloadTable[r.argCount] = r;
				}
			}
			function Dn(e, t, n) {
				Object.prototype.hasOwnProperty.call(a, e) ? ((n === void 0 || a[e].overloadTable !== void 0 && a[e].overloadTable[n] !== void 0) && Bt("Cannot register public name '" + e + "' twice"), Tn(a, e, e), Object.prototype.hasOwnProperty.call(a, n) && Bt("Cannot register multiple overloads of a function with the same number of arguments (" + n + ")!"), a[e].overloadTable[n] = t) : (a[e] = t, n !== void 0 && (a[e].numArguments = n));
			}
			...
			function $n(e, t, n) {
				for (; t !== n;) t.upcast || Bt("Expected null or instance of " + n.name + ", got an instance of " + t.name), e = t.upcast(e), t = t.baseClass;
				return e;
			}
			function Pn(e, t) {
				if (t === null) return this.isReference && Bt("null is not a valid " + this.name), 0;
				t.$$ || Bt("Cannot pass \"" + $t(t) + "\" as a " + this.name), t.$$.ptr || Bt("Cannot pass deleted object as a pointer of type " + this.name);
				var n = t.$$.ptrType.registeredClass, r = $n(t.$$.ptr, n, this.registeredClass);
				return r;
			}
			function Nn(e, t) {
				var n;
				if (t === null) return this.isReference && Bt("null is not a valid " + this.name), this.isSmartPointer ? (n = this.rawConstructor(), e !== null && e.push(this.rawDestructor, n), n) : 0;
				t.$$ || Bt("Cannot pass \"" + $t(t) + "\" as a " + this.name), t.$$.ptr || Bt("Cannot pass deleted object as a pointer of type " + this.name), !this.isConst && t.$$.ptrType.isConst && Bt("Cannot convert argument of type " + (t.$$.smartPtrType ? t.$$.smartPtrType.name : t.$$.ptrType.name) + " to parameter type " + this.name);
				var r = t.$$.ptrType.registeredClass;
				if (n = $n(t.$$.ptr, r, this.registeredClass), this.isSmartPointer) switch (t.$$.smartPtr === void 0 && Bt("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
					case 0:
						t.$$.smartPtrType === this ? n = t.$$.smartPtr : Bt("Cannot convert argument of type " + (t.$$.smartPtrType ? t.$$.smartPtrType.name : t.$$.ptrType.name) + " to parameter type " + this.name);
						break;
					case 1:
						n = t.$$.smartPtr;
						break;
					case 2:
						if (t.$$.smartPtrType === this) n = t.$$.smartPtr;
							...
							var o = t.clone();
							n = this.rawShare(n, lr.toHandle(function() {
								o.delete();
							})), e !== null && e.push(this.rawDestructor, n);
						}
						break;
					default: Bt("Unsupporting sharing policy");
				}
				return n;
			}
			function Mn(e, t) {
				if (t === null) return this.isReference && Bt("null is not a valid " + this.name), 0;
				t.$$ || Bt("Cannot pass \"" + $t(t) + "\" as a " + this.name), t.$$.ptr || Bt("Cannot pass deleted object as a pointer of type " + this.name), t.$$.ptrType.isConst && Bt("Cannot convert argument of type " + t.$$.ptrType.name + " to parameter type " + this.name);
				var n = t.$$.ptrType.registeredClass, r = $n(t.$$.ptr, n, this.registeredClass);
				return r;
			}
			function wn(e) {
			...
			function Bn() {
				Wn.prototype.getPointee = An, Wn.prototype.destructor = Fn, Wn.prototype.argPackAdvance = 8, Wn.prototype.readValueFromPointer = wn, Wn.prototype.deleteObject = On, Wn.prototype.fromWireType = gn;
			}
			function Wn(e, t, n, r, o, a, i, l, s, u, c) {
				this.name = e, this.registeredClass = t, this.isReference = n, this.isConst = r, this.isSmartPointer = o, this.pointeeType = a, this.sharingPolicy = i, this.rawGetPointee = l, this.rawConstructor = s, this.rawShare = u, this.rawDestructor = c, !o && t.baseClass === void 0 ? r ? (this.toWireType = Pn, this.destructorFunction = null) : (this.toWireType = Mn, this.destructorFunction = null) : this.toWireType = Nn;
			}
			function qn(e, t, n) {
				Object.prototype.hasOwnProperty.call(a, e) || qt("Replacing nonexistant public symbol"), a[e].overloadTable !== void 0 && n !== void 0 ? a[e].overloadTable[n] = t : (a[e] = t, a[e].argCount = n);
			}
			var Un = [], Vn = function(t) {
				var e = Un[t];
				return e || (t >= Un.length && (Un.length = t + 1), Un[t] = e = U.get(t)), x(U.get(t) == e, "JavaScript-side Wasm function table mirror is out of date!"), e;
			};
			function Hn(e, t) {
				e = Mt(e);
				function n() {
				...
				var r = n();
				return typeof r != "function" && Bt("unknown function pointer with signature " + e + ": " + t), r;
			}
			function Gn(e, t) {
			...
			function Qn(e, t, n, r, o, a, i, l, s, u, c, d, m) {
				c = Mt(c), a = Hn(o, a), l && (l = Hn(i, l)), u && (u = Hn(s, u)), m = Hn(d, m);
				var p = kn(c);
				Dn(p, function() {
					...
					t = t[0];
					var n, o;
					r ? (n = t.registeredClass, o = n.instancePrototype) : o = Rn.prototype;
					var i = In(p, function() {
						if (Object.getPrototypeOf(this) !== s) throw new Ot("Use 'new' to construct " + c);
						if (d.constructor_body === void 0) throw new Ot(c + " has no accessible constructor");
						var e = d.constructor_body[arguments.length];
						if (e === void 0) throw new Ot("Tried to invoke ctor of " + c + " with invalid number of parameters (" + arguments.length + ") - expected (" + Object.keys(d.constructor_body).toString() + ") parameters instead!");
					...
					var _ = new Wn(c, d, !0, !1, !1), f = new Wn(c + "*", d, !1, !1, !1), g = new Wn(c + " const*", d, !1, !0, !1);
					return rn[e] = {
						pointerType: f,
						constPointerType: g
					}, qn(p, i), [
			...
			function Jn(e, t, n, r, o, a) {
				var i = t.length;
				i < 2 && Bt("argTypes array size mismatch! Must at least get return value and 'this' types!"), x(!a, "Async bindings are only supported with JSPI.");
				...
				return function() {
					arguments.length !== d && Bt("function " + e + " called with " + arguments.length + " arguments, expected " + d + " args!"), _.length = 0;
					var n;
			...
			function Zn(e, t, n, r, o, a) {
				x(t > 0);
				var i = Xn(t, n);
				o = Hn(r, o), Ut([], [e], function(e) {
					e = e[0];
					var n = "constructor " + e.name;
					if (e.registeredClass.constructor_body === void 0 && (e.registeredClass.constructor_body = []), e.registeredClass.constructor_body[t - 1] !== void 0) throw new Ot("Cannot register multiple constructors with identical number of parameters (" + (t - 1) + ") for class '" + e.name + "'! Overload resolution is currently only performed using the parameter count, not actual type info!");
					return e.registeredClass.constructor_body[t - 1] = function() {
						Kn("Cannot construct " + e.name + " due to unbound types", i);
					}, Ut([], i, function(r) {
						return r.splice(1, 0, null), e.registeredClass.constructor_body[t - 1] = Jn(n, r, null, o, a), [];
					}), [];
				});
			}
			function er(e, t, n, r, o, a, i, l, s) {
				var u = Xn(n, r);
				t = Mt(t), a = Hn(o, a), Ut([], [e], function(e) {
					e = e[0];
					var r = e.name + "." + t;
					...
					return d === void 0 || d.overloadTable === void 0 && d.className !== e.name && d.argCount === n - 2 ? (o.argCount = n - 2, o.className = e.name, c[t] = o) : (Tn(c, t, r), c[t].overloadTable[n - 2] = o), Ut([], u, function(o) {
			...
			function tr() {
				Object.assign(nr.prototype, {
					get: function(t) {
						return x(this.allocated[t] !== void 0, "invalid handle: " + t), this.allocated[t];
					},
					has: function(t) {
					...
					free: function(t) {
						x(this.allocated[t] !== void 0), this.allocated[t] = void 0, this.freelist.push(t);
					}
				});
			}
			function nr() {
			...
			function ar() {
				for (var e = 0, t = rr.reserved; t < rr.allocated.length; ++t) rr.allocated[t] !== void 0 && ++e;
				return e;
			}
			function ir() {
				rr.allocated.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), rr.reserved = rr.allocated.length, a.count_emval_handles = ar;
			}
			var lr = {
				toValue: function(t) {
					return t || Bt("Cannot use deleted val. handle = " + t), rr.get(t).value;
				},
				toHandle: function(t) {
					switch (t) {
			...
			function cr(e, t, n) {
				...
				t = Mt(t), Ht(e, {
					...
					toWireType: function(t, n) {
						if (typeof n != "number" && typeof n != "boolean") throw new TypeError("Cannot convert " + $t(n) + " to " + this.name);
						return n;
					},
					argPackAdvance: 8,
			...
			function dr(e, t, n, r, o) {
				...
				var s = t.includes("unsigned"), u = function(n, a) {
					if (typeof n != "number" && typeof n != "boolean") throw new TypeError("Cannot convert \"" + $t(n) + "\" to " + a);
					if (n < r || n > o) throw new TypeError("Passing a number \"" + $t(n) + "\" from JS side to C/C++ side to an argument of type \"" + t + "\", which is outside the valid range [" + r + ", " + o + "]!");
				}, c;
				s ? c = function(t, n) {
			...
			var pr = function(t, n, r) {
				return x(typeof r == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), st(t, P, n, r);
			};
			function _r(e, t) {
				t = Mt(t);
				var n = t === "std::string";
				Ht(e, {
					...
					fromWireType: function(t) {
						...
						if (n) for (var a = r, i = 0; i <= e; ++i) {
							...
							for (var c = new Array(e), i = 0; i < e; ++i) c[i] = String.fromCharCode(P[r + i]);
							o = c.join("");
						}
						return Uo(t), o;
					},
					toWireType: function(t, r) {
						...
						o || r instanceof Uint8Array || r instanceof Uint8ClampedArray || r instanceof Int8Array || Bt("Cannot pass non-string to std::string"), n && o ? e = lt(r) : e = r.length;
						var a = qo(4 + e + 1), i = a + 4;
						if (A[a >> 2] = e, n && o) pr(r, i, e + 1);
						else if (o) for (var l = 0; l < e; ++l) {
							var s = r.charCodeAt(l);
							s > 255 && (Uo(i), Bt("String has UTF-16 code units that do not fit in 8 bits")), P[i + l] = s;
						}
			...
			var fr = typeof TextDecoder != "undefined" ? new TextDecoder("utf-16le") : void 0, gr = function(t, n) {
				x(t % 2 == 0, "Pointer passed to UTF16ToString must be aligned to two bytes!");
				for (var e = t, r = e >> 1, o = r + n / 2; !(r >= o) && M[r];) ++r;
				if (e = r << 1, e - t > 32 && fr) return fr.decode(P.subarray(t, e));
				...
				if (x(n % 2 == 0, "Pointer passed to stringToUTF16 must be aligned to two bytes!"), x(typeof r == "number", "stringToUTF16(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), r === void 0 && (r = 2147483647), r < 2) return 0;
				r -= 2;
				...
				x(t % 4 == 0, "Pointer passed to UTF32ToString must be aligned to four bytes!");
				for (var e = 0, r = ""; !(e >= n / 4);) {
					var o = w[t + e * 4 >> 2];
					if (o == 0) break;
					if (++e, o >= 65536) {
				...
				if (x(n % 4 == 0, "Pointer passed to stringToUTF32 must be aligned to four bytes!"), x(typeof r == "number", "stringToUTF32(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), r === void 0 && (r = 2147483647), r < 4) return 0;
				...
				r = Mt(r);
				var e, o, a, i, l;
				n === 2 ? (e = gr, o = hr, i = yr, a = function() {
					return M;
				}, l = 1) : n === 4 && (e = Cr, o = br, i = vr, a = function() {
					return A;
				}, l = 2), Ht(t, {
					name: r,
					fromWireType: function(r) {
						for (var t = A[r >> 2], o = a(), i, s = r + 4, u = 0; u <= t; ++u) {
							var c = r + 4 + u * n;
							if (u == t || o[c >> l] == 0) {
								var d = c - s, m = e(s, d);
					...
					toWireType: function(t, a) {
						typeof a != "string" && Bt("Cannot pass non-string to C++ string type " + r);
						var e = i(a), s = qo(4 + e + n);
						return A[s >> 2] = e >> l, o(a, s + 4, e + n), t !== null && t.push(Uo, s), s;
					},
					argPackAdvance: 8,
					readValueFromPointer: wn,
					destructorFunction: function(t) {
			...
			function Pr() {
				...
				if (typeof $$$embind_global$$$ == "object" || (typeof t == "object" && e(t) ? $$$embind_global$$$ = t : typeof self == "object" && e(self) && ($$$embind_global$$$ = self), typeof $$$embind_global$$$ == "object")) return $$$embind_global$$$;
				throw Error("unable to get global object.");
			}
			function Nr(e) {
				return e === 0 ? lr.toHandle(Pr()) : (e = Dr(e), lr.toHandle(Pr()[e]));
			}
			function Mr(e) {
				var t = xr.length;
				return xr.push(e), t;
			...
			function wr(e, t) {
				for (var n = new Array(e), r = 0; r < e; ++r) n[r] = kr(A[t + r * 4 >> 2], "parameter " + r);
				return n;
			}
			var Ar = [];
			function Fr(e, t) {
				var n = wr(e, t), r = n[0], o = r.name + "_$" + n.slice(1).map(function(e) {
					return e.name;
				}).join("_") + "$", a = Ar[o];
				if (a !== void 0) return a;
				var i = new Array(e - 1), l = function(o, a, l, s) {
					for (var t = 0, u = 0; u < e - 1; ++u) i[u] = n[u + 1].readValueFromPointer(s + t), t += n[u + 1].argPackAdvance;
					for (var c = o[a].apply(o, i), u = 0; u < e - 1; ++u) n[u + 1].deleteObject && n[u + 1].deleteObject(i[u]);
					if (!r.isVoid) return r.toWireType(l, c);
				};
				return a = Mr(l), Ar[o] = a, a;
			}
			function Or(e, t) {
				return e = lr.toValue(e), t = lr.toValue(t), lr.toHandle(e[t]);
			}
			function Br(e) {
			...
			function Wr(e) {
				...
				return function(n, r, o) {
					...
					for (var a = 0; a < e; ++a) {
						...
						t[a + 1] = i.readValueFromPointer(o), o += i.argPackAdvance;
					}
			...
			function jr(e, t, n) {
				e = lr.toValue(e), t = lr.toValue(t), n = lr.toValue(n), e[t] = n;
			}
			function Kr(e, t) {
			...
			var Qr = 9007199254740992, Xr = -9007199254740992;
			function Yr(e) {
			...
			function Jr(e, t) {
				...
				w[t >> 2] = n.getUTCSeconds(), w[t + 4 >> 2] = n.getUTCMinutes(), w[t + 8 >> 2] = n.getUTCHours(), w[t + 12 >> 2] = n.getUTCDate(), w[t + 16 >> 2] = n.getUTCMonth(), w[t + 20 >> 2] = n.getUTCFullYear() - 1900, w[t + 24 >> 2] = n.getUTCDay();
			...
			var Zr = function(t) {
				...
				var c = u(o), d = u(a), m = Zr(c), p = Zr(d);
				l < i ? (A[r >> 2] = m, A[r + 4 >> 2] = p) : (A[r >> 2] = p, A[r + 4 >> 2] = m);
			}, to = function() {
			...
			var oo = function() {
				...
				var e = k.buffer, n = t - e.byteLength + 65535 >>> 16;
				try {
					return k.grow(n), q(), 1;
				} catch (n) {
					R("growMemory: Attempted to grow heap from " + e.byteLength + " bytes to " + t + " bytes, but got error: " + n);
				}
			}, io = function(t) {
				var e = P.length;
				t >>>= 0, x(t > e);
				var n = oo();
				if (t > n) return R("Cannot enlarge memory, asked to go up to " + t + " bytes, but the limit is " + n + " bytes!"), !1;
				for (var r = function(t, n) {
					return t + (n - t % n) % n;
				}, o = 1; o <= 4; o *= 2) {
					var a = e * (1 + .2 / o);
					a = Math.min(a, t + 100663296);
					var i = Math.min(n, r(Math.max(t, a), 65536)), l = ao(i);
					if (l) return !0;
				}
				return R("Failed to grow the heap from " + e + " bytes to " + i + " bytes, not enough memory!"), !1;
			}, lo = {}, so = function() {
				...
				if (!uo.strings) {
					...
					for (var n in lo) lo[n] === void 0 ? delete t[n] : t[n] = lo[n];
					var r = [];
				...
				for (var e = 0; e < t.length; ++e) x(t.charCodeAt(e) === (t.charCodeAt(e) & 255)), $[n++ >> 0] = t.charCodeAt(e);
				$[n >> 0] = 0;
			}, mo = function(t, n) {
				var e = 0;
				return uo().forEach(function(r, o) {
					var a = n + e;
			...
			function go(e, t, n, r) {
				try {
					var o = It.getStreamFromFD(e), a = fo(o, t, n);
					return A[r >> 2] = a, 0;
				} catch (e) {
					if (typeof kt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			function ho(e, t, n, r) {
				...
				try {
					...
					return kt.llseek(o, t, n), O[r >> 3] = BigInt(o.position), o.getdents && t === 0 && n === 0 && (o.getdents = null), 0;
				} catch (e) {
					if (typeof kt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
				}
			...
			function Co(e, t, n, r) {
				try {
					var o = It.getStreamFromFD(e), a = yo(o, t, n);
					return A[r >> 2] = a, 0;
				} catch (e) {
					if (typeof kt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			var bo = function(t) {
				...
				for (var e = new Date(t.getTime()); n > 0;) {
					var r = bo(e.getFullYear()), o = e.getMonth(), a = (r ? So : Ro)[o];
				...
				x(t.length >= 0, "writeArrayToMemory array must have a length (should be an array or typed array)"), $.set(t, n);
			}, ko = function(t, n, r, o) {
				var e = w[o + 40 >> 2], a = {
					tm_sec: w[o >> 2],
					tm_min: w[o + 4 >> 2],
				...
				function f(e) {
					var t = Lo(new Date(e.tm_year + 1900, 0, 1), e.tm_yday), n = new Date(t.getFullYear(), 0, 4), r = new Date(t.getFullYear() + 1, 0, 4), o = _(n), a = _(r);
				...
				var g = {
					...
					"%j": function(t) {
						return m(t.tm_mday + vo(bo(t.tm_year + 1900) ? So : Ro, t.tm_mon - 1), 3);
					},
					"%m": function(t) {
				...
				i = i.replace(/%%/g, "\0\0");
				for (var s in g) i.includes(s) && (i = i.replace(new RegExp(s, "g"), g[s](a)));
				i = i.replace(/\0\0/g, "%");
				var h = ut(i, !1);
			...
			function To(e) {
				var t = a["_" + e];
				return x(t, "Cannot call unknown function " + e + ", make sure it is exported"), t;
			}
			var Do = function(t) {
				var e = lt(t) + 1, n = na(e);
				return pr(t, n, e), n;
				...
				var l = To(t), s = [], u = 0;
				if (x(n !== "array", "Return type should not be \"array\"."), o) for (var c = 0; c < o.length; c++) {
					var d = e[r[c]];
			...
			Object.defineProperties(No.prototype, {
			...
			}), kt.FSNode = No, kt.createPreloadedFile = Ct, kt.staticInit(), Rt = {
				EPERM: 63,
				ENOENT: 44,
				ESRCH: 71,
				EINTR: 27,
				...
				EOWNERDEAD: 62,
				ESTRPIPE: 135
			}, Pt(), Ot = a.BindingError = (function(e) {
				"use strict";
				function t(t) {
					var n;
				...
				return babelHelpers.inheritsLoose(t, e), t;
			})(babelHelpers.wrapNativeSuper(Error)), Wt = a.InternalError = (function(e) {
				"use strict";
				function t(t) {
					var n;
				...
				return babelHelpers.inheritsLoose(t, e), t;
			})(babelHelpers.wrapNativeSuper(Error)), Sn(), dn(), Bn(), zn = a.UnboundTypeError = Gn(Error, "UnboundTypeError"), tr(), ir();
			function Ao() {
				Le("fetchSettings");
			}
			var Fo = {
				...
				invoke_vij: Ia,
				strftime_l: Io
			}, Oo = Se(), Bo = pe("__wasm_call_ctors"), Wo = pe("__cxa_free_exception"), qo = pe("malloc"), Uo = a._free = pe("free"), Vo = pe("__errno_location"), Ho = pe("__getTypeName"), Go = a.__embind_initialize_bindings = pe("_embind_initialize_bindings"), zo = a._fflush = pe("fflush"), jo = pe("emscripten_builtin_memalign"), Ko = pe("setThrew"), Qo = pe("setTempRet0"), Xo = function() {
			...
			}, ea = pe("stackSave"), ta = pe("stackRestore"), na = pe("stackAlloc"), ra = function() {
				return (ra = I.emscripten_stack_get_current)();
			}, oa = pe("__cxa_decrement_exception_refcount"), aa = pe("__cxa_increment_exception_refcount"), ia = a.___get_exception_message = pe("__get_exception_message"), la = pe("__cxa_can_catch"), sa = pe("__cxa_is_pointer_type");
			function ua(e, t, n) {
				var r = ea();
				try {
					return Vn(e)(t, n);
			...
			a.ccall = xo, a.cwrap = $o, a.setValue = Be, a.getValue = Fe, a.UTF8ToString = Me, a.allocateUTF8 = Po;
			var Wa = [
				"writeI53ToI64",
			...
			function Ha() {
				...
				function e() {
					Ua || (Ua = !0, a.calledRun = !0, !T && (Y(), i(a), a.onRuntimeInitialized && a.onRuntimeInitialized(), x(!a._main, "compiled without a main, but one is present. if you added it from JS, use Module[\"onRuntimeInitialized\"]"), J()));
				}
	...
	typeof i == "object" && typeof a == "object" ? a.exports = l : typeof define == "function" && define.amd && define([], function() {
		return l;
	});
}), null);
