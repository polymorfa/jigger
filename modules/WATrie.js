__d("WATrie", ["nullthrows"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = (function() {
		function e(e) {
		...
		var t = e.prototype;
		return t.addBackwardsString = function(n, r) {
			...
			var e = this._indices, t = Object.keys(this._children);
			return t.length === 1 && this._indices.length === 0 ? this._children[t[0]].getIndices() : e;
		}, t._optimize = function() {
			var e = this;
			if (!this.hasChildren()) return this;
			var t = Object.keys(this._children), n = this._children[t[0]]._indices;
			return t.forEach(function(t) {
				e._children[t]._optimize();
			}), t.length === 1 && this._indices.length === n.length && (this._indices = []), this;
