__d("WAWamPrivateStatsToken", ["WACryptoEd25519", "WACryptoPrimitives"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e, t) {
		return o("WACryptoEd25519").runInAllocationScope(function() {
			var n, r = (n = o("WACryptoEd25519")).p3Element(), a = n.allocate(Uint8Array, 32);
			a.set(t), u(a), o("WACryptoPrimitives").lowlevel.scalarbase(r, a);
			var i = n.hashToPoint(e), l = o("WACryptoPrimitives").lowlevel.add;
			l(i, r);
