__d("WAWebABPropCommandPalettePlugin", [
	...
	function c(e) {
		var t = o("react-compiler-runtime").c(27), a = e.abProp, i = o("WAWebCommandPaletteController").useCommandPalette(), l;
		t[0] !== a.name || t[1] !== i ? (l = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				yield r("WAWebDebug").overrideABProp(a.name, e), i.popPlugin();
			});
			return function(n) {
				return e.apply(this, arguments);
			};
		})(), t[0] = a.name, t[1] = i, t[2] = l) : l = t[2];
		var u = l, c;
		t[3] !== a.name || t[4] !== i ? (c = (function() {
		...
		var p;
		t[7] !== a.name ? (p = s.jsx(o("WAWebText.react").WAWebTextTitle, { children: a.name }), t[7] = a.name, t[8] = p) : p = t[8];
		var _;
		t[9] !== a.value || t[10] !== p ? (_ = s.jsx(r("WAWebCellV2.react"), {
			primary: p,
			secondary: a.value,
			interactive: !1,
			colorScheme: "lighter",
			size: "medium"
		}), t[9] = a.value, t[10] = p, t[11] = _) : _ = t[11];
		var f = i.input || "Type your new value into the command palette", g;
		t[12] === Symbol.for("react.memo_cache_sentinel") ? (g = s.jsx(o("WAWebPencilIcon.react").PencilIcon, {}), t[12] = g) : g = t[12];
		var h;
		t[13] !== i.input || t[14] !== u ? (h = function() {
			return u(i.input);
		}, t[13] = i.input, t[14] = u, t[15] = h) : h = t[15];
		var y;
		t[16] !== f || t[17] !== h ? (y = s.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
			optionId: "edit",
			primary: "New Value",
			secondary: f,
			detailLeft: g,
			onSelect: h
		}), t[16] = f, t[17] = h, t[18] = y) : y = t[18];
		var C;
		t[19] !== a.originalValue || t[20] !== a.overridden || t[21] !== d ? (C = a.overridden === !0 && s.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
			optionId: "reset",
			primary: "Reset",
			secondary: s.jsxs("span", { children: ["Set the value back to ", a.originalValue] }),
			detailLeft: s.jsx(o("WAWebRefreshIcon.react").RefreshIcon, {}),
			onSelect: d
		}), t[19] = a.originalValue, t[20] = a.overridden, t[21] = d, t[22] = C) : C = t[22];
		var b;
		return t[23] !== C || t[24] !== _ || t[25] !== y ? (b = s.jsx(o("WAWebLexicalWAWebMenu.react").LexicalWAWebMenu, { children: s.jsxs(o("WAWebFlex.react").FlexColumn, {
			padding: m,
			children: [
				_,
				y,
		...
		}) }), t[23] = C, t[24] = _, t[25] = y, t[26] = b) : b = t[26], b;
	}
	function d(e) {
