__d("WAWebABPropCommandPalettePlugin", [
	...
	function c(e) {
		var t = e.abProp, n = o("WAWebCommandPaletteController").useCommandPalette(), a = async function(o) {
			await r("WAWebDebug").overrideABProp(t.name, o), n.popPlugin();
		}, i = async function() {
			await r("WAWebDebug").resetABProp(t.name), n.popPlugin();
		};
		return s.jsx(o("WAWebLexicalWAWebMenu.react").LexicalWAWebMenu, { children: s.jsxs(o("WAWebFlex.react").FlexColumn, {
			...
			children: [
				...
				s.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
					optionId: "edit",
					primary: "New Value",
					secondary: n.input || "Type your new value into the command palette",
