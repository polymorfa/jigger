__d("WAWebABProps", [
	...
	function d(t) {
		var n, a = o("WAWebABPropsConfigs").ABPropConfigs[t];
		a == null && o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[abprops] config not defined, config name: ", "."])), t);
		var i = a[0], l = a[1], d = a[2], m = a[3], p = d;
		if (c == null) return !r("gkx")("26258") && !u.includes(t) && o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[abprops] impl must be set before first access: ", ""])), t), p;
	...
	l.usedBeforeInitializationConfigs = u, l.getABPropConfigValue = d, l.setGetABPropConfigValueImpl = m;
}), 98);
