__d("WAWebACSNetwork", [
	...
	"use strict";
	async function e(e) {
		var t = e.data, n = e.project, r = e.url, a = await s(n, t);
	...
	async function s(e, t) {
		if (o("WAWebABProps").getABPropConfigValue("acs_use_graphql_issuance") && o("WAWebCanonicalUtils").isCanonicalPresent()) {
			var n = await o("WAWebACSClient").redeemWithAPTClient(e);
			return t.set("acs_token", o("WABase64").encodeB64UrlSafe(n.credential, !0) + "+" + o("WABase64").encodeB64UrlSafe(n.tag, !0)), t.set("acs_project", e), t.set("acs_config_id", n.serverConfigId), t;
		}
