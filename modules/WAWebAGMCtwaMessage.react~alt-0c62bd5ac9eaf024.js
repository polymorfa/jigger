__d("WAWebAGMCtwaMessage.react", [
	...
	function d(t) {
		var n = t.chat, a = t.displayAuthor, i = t.displayType, l = t.msg, s = o("WAWebStateUtils").unproxy(l), d = s.ctwaContext, m = o("WAWebCtwaAGMUtils").extractAGMPayload(d);
		if (!o("WAWebBizCtwaAGMUtils").isAGMSupported(s)) return u.jsx(r("WAWebUnsupportedMessage"), {
			msg: s,
			displayAuthor: a,
			hideUpdateButton: !0
		});
		var p = o("WAWebMsgModelPropUtils").isTrusted(s.unsafe()), _, f = u.jsx(r("WAWebBizCtwaContext.react"), {
			msg: s.unsafe(),
		...
		if (m && y != null) {
			var C = m.ctaPayload, b = m.ctaText, v = m.ctaType, S = function() {
			...
			switch (v) {
				case o("WAWebCtwaAGMUtils").AGM_CTA_TYPE.URL: {
					C != null && C.length && (_ = u.jsx(r("WAWebBizAGMWebsiteCta.react"), {
						ctaText: b,
						link: C,
						onClick: S
					}));
				...
				case o("WAWebCtwaAGMUtils").AGM_CTA_TYPE.CALL: {
					_ = u.jsx(r("WAWebBizAGMCallCta.react"), {
						ctaText: b,
				...
				case o("WAWebCtwaAGMUtils").AGM_CTA_TYPE.CATALOG: {
					_ = u.jsx(r("WAWebBizAGMCatalogCta.react"), {
						ctaText: b,
						businessWid: l.from,
						chat: n,
						onClick: S
				...
				case o("WAWebCtwaAGMUtils").AGM_CTA_TYPE.FLOW: {
					C != null && C.length && (_ = u.jsx(r("WAWebBizAGMFlowCta.react"), {
						ctaText: b,
						chat: n,
						onClick: S,
						ctaPayload: C,
