__d("WAWebAboutCreationDailyWamEvent", ["WAWebWamCodegenUtils", "WAWebWamEnumAboutEntrypointType"], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ AboutCreationDaily: [
		6820,
		{
			aboutCreationStarted: [1, e.TYPES.INTEGER],
			aboutCreationVisit: [2, e.TYPES.INTEGER],
			aboutEntrypoint: [3, o("WAWebWamEnumAboutEntrypointType").ABOUT_ENTRYPOINT_TYPE],
