__d("WAWebAboutEditModal.react", [
	...
	function I(e) {
		var t = o("react-compiler-runtime").c(20), a = e.onClick, i = y(T), l = i[0], u = i[1], c = y(0), d = c[0], m = c[1], _;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (_ = function() {
			var e, t = (e = o("WAWebUserPrefsGeneral").getUserPrivacySettings().about) != null ? e : o("WAWebPrivacySettings").VISIBILITY.all;
			u(t);
		}, t[0] = _) : _ = t[0];
		var f = _;
		o("useWAWebListener").useListener(o("WAWebUserPrefsGeneral").privacySettingsEventEmitter, "all", f);
		var h, C;
		t[1] !== l ? (h = function() {
			if (l === o("WAWebPrivacySettings").VISIBILITY.contact_blacklist) {
				...
				return n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					...
					if (!e) {
						var n, r;
						m((n = (r = t.about) == null ? void 0 : r.disallowedList.length) != null ? n : 0);
					}
				})(), (function() {
					e = !0;
				});
			}
		}, C = [l], t[1] = l, t[2] = h, t[3] = C) : (h = t[2], C = t[3]), g(h, C);
		var b;
		t[4] !== l || t[5] !== d ? (b = l === o("WAWebPrivacySettings").VISIBILITY.all ? s._(
			/*BTDS*/
			""
		) : l === o("WAWebPrivacySettings").VISIBILITY.contacts ? s._(
			/*BTDS*/
			""
		) : l === o("WAWebPrivacySettings").VISIBILITY.contact_blacklist ? s._(
			/*BTDS*/
			"",
			[s._param("excluded_count", d)]
		) : l === o("WAWebPrivacySettings").VISIBILITY.none ? s._(
			/*BTDS*/
			""
		) : (function() {
			throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + l);
		})(), t[4] = l, t[5] = d, t[6] = b) : b = t[6];
		var v = b, S;
		t[7] === Symbol.for("react.memo_cache_sentinel") ? (S = { className: "x3nfvp2 x6s0dn4" }, t[7] = S) : S = t[7];
		var R;
		t[8] !== v ? (R = p.jsx(r("WDSText.react"), {
			type: "Body3Emphasized",
			colorName: "contentActionEmphasized",
			children: v
		}), t[8] = v, t[9] = R) : R = t[9];
		var E;
		t[10] === Symbol.for("react.memo_cache_sentinel") ? (E = p.jsx(r("WDSIconIcChevronRight.react"), {
			height: 20,
			width: 20,
			xstyle: L.privacyChevron
		}), t[10] = E) : E = t[10];
		var k;
		t[11] !== R ? (k = p.jsxs("span", babelHelpers.extends({}, S, { children: [R, E] })), t[11] = R, t[12] = k) : k = t[12];
		var I = k, D;
		t[13] === Symbol.for("react.memo_cache_sentinel") ? (D = { className: "x78zum5 x6s0dn4 x1tiyuxx x1nxh6w3 xhslqc4" }, t[13] = D) : D = t[13];
		var x;
		t[14] === Symbol.for("react.memo_cache_sentinel") ? (x = p.jsx(r("WDSIconIcLock.react"), {
			iconXstyle: L.grayColor,
			xstyle: L.privacyIcon
		}), t[14] = x) : x = t[14];
		var $;
		t[15] !== I ? ($ = p.jsx("span", { children: s._(
			/*BTDS*/
			"",
			[s._param("privacy_setting", I)]
		) }), t[15] = I, t[16] = $) : $ = t[16];
		var P;
		return t[17] !== a || t[18] !== $ ? (P = p.jsxs("div", babelHelpers.extends({}, D, {
			"data-testid": "privacy-info",
			children: [x, p.jsx(o("WAWebClickable.react").Clickable, {
				onClick: a,
				children: $
			})]
		})), t[17] = a, t[18] = $, t[19] = P) : P = t[19], P;
	}
	function T() {
		var e;
	...
	function B(t) {
		var a, i, l, m = y(function() {
		...
		}), _ = m[0], f = h(!1), T = r("useWAWebUnmountSignal")(), D = y([]), x = D[0], $ = D[1], P = function(t) {
			...
			$([].concat(v, n));
		}, M = o("WAWebUserPrefsMeUser").getMeUserOrThrow(), w = o("WAWebContactCollection").ContactCollection.assertGet(M), A = o("useWAWebContactValues").useContactValues(w.id, [
		...
		]), F = A[0], B = A[1], W = A[2], q = A[3], U = A[4], V = o("WAWebTextStatusUtils").hasTextStatusSet({
			textStatusEmoji: B,
			textStatusEphemeralDuration: W,
			textStatusExpiryTs: q,
			textStatusLastUpdateTime: U,
			textStatusString: F
		}), H = y(V ? F : null), G = H[0], z = H[1], j = y(V ? B : null), K = j[0], Q = j[1], X = y(V && W != null ? W : o("WAWebEphemeralAboutDurationsUtils").defaultTextStatusEphemeralDuration), Y = X[0], J = X[1];
		g(function() {
		...
		var re = function() {
			...
			de();
		}, he = (a = V ? F : null) != null ? a : null, ye = (i = V ? B : null) != null ? i : null, Ce = V && W != null ? W : o("WAWebEphemeralAboutDurationsUtils").defaultTextStatusEphemeralDuration, be = G != null && G.trim() ? G : null, ve = be === he && (K != null ? K : null) === ye && Y === Ce, Se = ve || !!K && be == null || G != null && G.length > b;
