__d("WAWebAbstractStore", ["asyncToGeneratorRuntime", "err"], (function(t, n, r, o, a, i, l) {
	var e = (function() {
		function e() {}
		var t = e.prototype;
		return t.open = function() {
			var e = this;
			return this.$2 ? this.$2 : this.$1 ? (this.$2 = this.$1.catch(function(t) {
				throw e.$2 = null, t;
			}).then(function() {
				return e.$2 = null, e.open();
			}), this.$2) : (this.$2 = this.doOpen().catch(function(t) {
				throw e.$2 = null, t;
			}).then(function() {
				e.$2 = null;
			}), this.$2);
			...
			var e = this;
			return this.$1 ? this.$1 : this.$2 ? (this.$1 = this.$2.catch(function(t) {
				throw e.$1 = null, t;
			}).then(function() {
				return e.$1 = null, e.close();
			}), this.$1) : (this.$1 = this.doClose().catch(function(t) {
				throw e.$1 = null, t;
			}).then(function() {
				e.$1 = null;
			}), this.$1);
