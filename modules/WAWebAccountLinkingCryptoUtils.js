__d("WAWebAccountLinkingCryptoUtils", [
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			var l = yield b(), s = yield o("WAWebDirectConnectionX509").validateCertificates([a, i], [l]);
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = new TextEncoder(), n = t.encode(e), r = self.crypto.getRandomValues(new Uint8Array(12)), o = yield _(), a = yield self.crypto.subtle.encrypt({
				name: "AES-GCM",
				iv: r,
				length: 256
	...
	function $() {
		return $ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			t === void 0 && (t = !1);
			var n = yield self.crypto.subtle.exportKey("spki", e), r = new Uint8Array(n), o = btoa(Array.from(r, function(e) {
	...
	function w() {
		return w = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield P(e, !1, ["encrypt"]), r = yield P(t, !0, ["decrypt"]);
			return {
				publicKey: n,
				privateKey: r
			};
	...
	function q() {
		return q = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i) {
			try {
	...
	function V() {
		return V = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, o, a) {
			var i = yield T(e, t), l = yield H(i), s = yield L(l, n, o, a), u = new TextDecoder("utf-8").decode(s), c = JSON.parse(u), d = c.data;
	...
	function G() {
		return G = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield self.crypto.subtle.importKey("raw", e, "AES-GCM", !0, ["encrypt", "decrypt"]);
			return t;
	...
	function j() {
		return j = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			var i = yield S(JSON.stringify(e)), l = i.cipherText, s = i.iv, u = i.key, c = i.tag, d = yield A(u), m = yield k(n, d);
			return {
				tag: c,
				nonce: s,
				cipherText: l,
	...
	function J() {
		return J = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			var r = new TextEncoder(), a = r.encode(e), i = self.crypto.getRandomValues(new Uint8Array(12)), l = yield _(), s = yield self.crypto.subtle.encrypt({
				name: "AES-GCM",
				iv: i,
				length: 256
			}, l, a), u = new Uint8Array(s), c = u.slice(-16), d = u.slice(0, -16), m = yield A(l), p = yield o("WAWebRSAPkcs1v15").rsaPkcs1v15Encrypt(t, m), f = p.length, g = 16 + f + 16 + d.length, h = new Uint8Array(g), y = 0, C = new DataView(h.buffer);
			h[y++] = 1, h[y++] = n % 256, h.set(i, y), y += 12, C.setUint16(y, f, !0), y += 2, h.set(p, y), y += f, h.set(c, y), y += 16, h.set(d, y);
	...
	function ee() {
		return ee = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield o("WAWebSignalProtocolStore").getSignalProtocolStore().getIdentityKeyPair();
			if (t == null) throw r("err")("Identity key pair not found");
			var n = {
				pubKey: t.pubKey.slice(1),
				privKey: t.privKey
			}, a = new TextEncoder().encode("1539" + e), i = yield o("WAWebCryptoCurve25519CalculateSignature").calculateSignature(n, a.buffer);
	...
	l.generateRSAKeys = m, l.generateAESKey = _, l.validateCertificateChain = g, l.importPayloadEncryptionKey = y, l.cryptoKeyToPem = x, l.convertTestKeys = M, l.decryptRSAEncryptedPayload = O, l.decryptRSAEncryptedData = W, l.wrapPayloadWithRSAAESEncryption = z, l.WAFFLE_AUTH_ENVELOPE_VERSION_V1 = K, l.serializeWaffleEncryptedEnvelope = X, l.encryptPassword = Y, l.computeIdSign = Z, l.importPasswordPublicKey = te;
}), 98);
