__d("WAWebAccountLinkingDBOperations_DO_NOT_USE_DIRECTLY", [
	...
	async function e(e) {
		await o("WAWebAccountLinkingSchema").getTable().createOrReplace(e), o("WAWebBackendApi").frontendFireAndForget("updateAccountLinkingStatus", {
	...
	async function s(e) {
		var t = await o("WAWebAccountLinkingSchema").getTable().get(o("WAWebAccountLinkingConstants").AccountLinkKey), n = babelHelpers.extends({}, t, { linkState: e });
		await o("WAWebAccountLinkingSchema").getTable().createOrReplace(n), o("WAWebBackendApi").frontendFireAndForget("updateAccountLinkingStatus", {
	...
	async function u(e, t) {
		var n = await o("WAWebAccountLinkingSchema").getTable().get(o("WAWebAccountLinkingConstants").AccountLinkKey);
		if (n != null) {
	...
	async function c(e, t) {
		var n = await p(), r = babelHelpers.extends({
	...
	async function m(e) {
		var t = await o("WAWebAccountLinkingSchema").getTable().get(o("WAWebAccountLinkingConstants").AccountLinkKey), n = e + Date.now() / 1e3, r = babelHelpers.extends({}, t, { pingInterval: n });
		return o("WAWebAccountLinkingSchema").getTable().createOrReplace(r);
	}
	async function p() {
		var e, t = await o("WAWebAccountLinkingSchema").getTable().get("AccountLinkKey");
	...
	async function f(e) {
		return o("WAWebModelStorageUtils").getStorage().lock(["account-linking"], async function(t) {
			var n = t[0], r = await n.get(o("WAWebAccountLinkingConstants").AccountLinkKey);
			if (r != null) {
				var a = babelHelpers.extends({}, r, { foAToWALinkEligibility: e.foAToWALinkEligibility });
				e.fbCrosspostingDestinationId != null && (a.fbCrosspostingDestinationId = e.fbCrosspostingDestinationId), e.igCrosspostingDestinationId != null && (a.igCrosspostingDestinationId = e.igCrosspostingDestinationId), await n.createOrReplace(a), o("WAWebBackendApi").frontendFireAndForget("updateAccountLinkingStatus", {
	...
	async function h(e) {
		var t = e.accesstoken, n = e.fbid, r = e.nonce, a = e.pingInterval, i = await p();
		if (i != null) {
	...
	async function y(e) {
		var t = await o("WAWebAccountLinkingSchema").getTable().get(o("WAWebAccountLinkingConstants").AccountLinkKey);
		if (t != null) {
	...
	async function C() {
		var e = await o("WAWebAccountLinkingSchema").getTable().get(o("WAWebAccountLinkingConstants").AccountLinkKey);
		return e == null ? void 0 : e.lastResyncTimestamp;
	}
	async function b() {
		await o("WAWebAccountLinkingSchema").getTable().clear(), o("WAWebBackendApi").frontendFireAndForget("updateAccountLinkingStatus", {
			isFBLinked: !1,
			isIGLinked: !1,
	...
	l.createOrUpdateAccountLinkingState = e, l.updateAccountLinkingState = s, l.updateAccountLinkingData = u, l.updateEntCreationData = c, l.updateAccesstoken = d, l.updatePingInterval = m, l.getAccountLinkingData = p, l.getPingExpirationTime = _, l.updateServiceData = f, l.updateDestinationIdentities = g, l.updateGenerateAccessTokensData = h, l.updateLastResyncTimestamp = y, l.getLastResyncTimestamp = C, l.purgeWaffleData = b, l.getAccountLinkingStatus = v;
}), 98);
