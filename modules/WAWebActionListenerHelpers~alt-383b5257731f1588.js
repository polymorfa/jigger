__d("WAWebActionListenerHelpers", [
	...
	var e, u, c, d, m = d || (d = o("react")), p = 4e3;
	function _(t) {
		switch (t) {
			case 1: return s._(
				/*BTDS*/
	...
	function f(e, t, n, a) {
		if (a === void 0 && (a = "LEFT"), !t || t.some(function(e) {
			return !e.id;
		})) return Promise.reject(new (o("WAWebMiscErrors")).ActionError());
		var i = r("isStringNullOrEmpty")(n) ? o("WAWebActionToast.react").genId() : n, l = t.length;
		if (o("WAWebChatGetters").getIsPSA(e)) {
			var c = 0;
			for (c; c < l; c++) o("WAWebWamChatPSALogger").logChatPSAStar(t[c]);
		}
		var d = new (o("WAWebActionToast.react")).ActionType(s._(
			/*BTDS*/
			"",
			[s._plural(l)]
		)), p = o("WAWebChatSendMessages").sendStarMsgs(e, t, !0).then(function() {
	...
	function g(e, t, n, a) {
		...
		var i = r("isStringNullOrEmpty")(n) ? o("WAWebActionToast.react").genId() : n, l = t.length, u = new (o("WAWebActionToast.react")).ActionType(s._(
			/*BTDS*/
			"",
			[s._plural(l)]
		)), d = o("WAWebChatSendMessages").sendStarMsgs(e, t, !1).then(function() {
			return new (o("WAWebActionToast.react")).ActionType(s._(
				/*BTDS*/
				"",
				[s._plural(l, "count")]
	...
	l.MESSAGE_DELETE_DELAY_DURATION = p, l.getMuteAllDurationLabel = _, l.handleSendStarMsgs = f, l.handleSendUnstarMsgs = g, l.logMessageDeleteActionsMetric = y, l.logSnackbarDeleteUndoMetric = C;
}), 226);
