__d("WAWebActionListener", [
	...
	function _(t) {
		var a, i, l = t.activeNavBarItem, d = t.updateActiveNavBarItem, _ = r("useWAWebUIM")(), f = function(t) {
			...
			if (i === void 0 && (i = !0), l === void 0 && (l = !0), n) {
				...
				if (i) {
					...
					var c = Number.POSITIVE_INFINITY, d = o("WAWebMuteExpirations").calculateMuteExpiration(c);
					e(d, c, a != null ? a : 0);
				}
			} else {
				...
				var p = a === 1 ? o("WAWebWamEnumMuteEntryPoint").MUTE_ENTRY_POINT.CHAT_LIST_SCREEN : a === 2 ? o("WAWebWamEnumMuteEntryPoint").MUTE_ENTRY_POINT.CONTACT_INFO : o("WAWebWamEnumMuteEntryPoint").MUTE_ENTRY_POINT.CONVERSATION_SCREEN;
				o("WAWebChatGetters").getIsPSA(t) && a !== 0 ? o("WAWebWamChatPSALogger").logChatPSAUnmute(p) : !o("WAWebChatGetters").getIsPSA(t) && !o("WAWebChatGetters").getIsNewsletter(t) && o("WAWebChatMuteLogger").logChatUnmute(t, p), (t.isBusinessGroup() || t.contact.isBusiness) && new (o("WAWebBusinessUnmuteWamEvent")).BusinessUnmuteWamEvent().commit();
			}
		}, b = function(t, n, a) {
			if (t) {
				var e = s._(
			...
			if (n) {
				var u = function(n, r) {
					t.mute({ expiration: n }), R(!1), o("WAWebToastManager").ToastManager.open(m.jsx(o("WAWebToast.react").Toast, {
				...
				var c = function() {
					t.unmute(), R(!0), o("WAWebModalManager").ModalManager.close(), o("WAWebToastManager").ToastManager.open(m.jsx(o("WAWebToast.react").Toast, {
						msg: i,
						id: o("WAWebToast.react").genId()
					}));
				};
			...
			if (o("WAWebChatAssignmentUtils").canAssignChat(t) === !1) {
				o("WAWebModalManager").ModalManager.open(m.jsx(r("WAWebBizChatAssignmentAiRepliesModal.react"), { chat: t }));
				return;
			}
			var e = o("WAWebChatAssignmentLogEvents.flow").ChatAssignmentEntryPointType.getName(n);
			o("WAWebQplFlowWrapper").QPL.markerStart(p, { annotations: { string: { CHAT_ASSIGNMENT_ENTRY_POINT: e } } }), o("WAWebModalManager").ModalManager.open(m.jsx(r("WAWebBizChatAssignmentModal.react"), {
				chats: [t],
				entryPoint: n
			}));
		}, A = function(t, n) {
			o("WAWebBizAiAgentStatusUtils").isChatEligibleForAiAgent(t) && (n ? o("WAWebModalManager").ModalManager.open(m.jsx(r("WAWebBizAiRepliesControlPopup.react"), { chat: t })) : o("WAWebAIAgentAIReplyUtils").mutateAiReplyStatus(t));
		}, F = function(a, i, l, u, d, p) {
			d === void 0 && (d = "LEFT");
			var t = i.list;
			if (!t || t.some(function(e) {
				return !e.id;
			})) return (c || (c = n("Promise"))).reject(new (o("WAWebMiscErrors")).ActionError());
			var _ = r("isStringNullOrEmpty")(u) ? o("WAWebActionToast.react").genId() : u, f = t.length, g = new AbortController(), h = g.signal, y;
			if (i.type !== "addon") {
				o("WAWebActionListenerHelpers").logSnackbarDeleteUndoMetric(a, i, "shown"), i.list.forEach(function(e) {
				...
				y = new (o("WAWebActionToast.react")).ActionType(v, {
					...
					actionHandler: (function() {
						var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
							g.abort(), i.list.forEach(function(e) {
								e.pendingDeleteForMe = !1;
							}), o("WAWebMessageAssociationUIUtils").makeParentMessagesVisibleInChat(i.list), a.pendingDeleteForMeCount -= i.list.length, o("WAWebActionListenerHelpers").logSnackbarDeleteUndoMetric(a, i, "undo"), yield M(i.list, _);
						});
						function t() {
			...
			} else y = new (o("WAWebActionToast.react")).ActionType(s._(
				/*BTDS*/
				"",
				[s._plural(f)]
			));
			var S = (c || (c = n("Promise"))).resolve();
			return i.type !== "addon" && (S = S.then(function() {
				...
				if (a.pendingDeleteForMeCount -= e, e === f) return o("WAWebActionListenerHelpers").logMessageDeleteActionsMetric(a, i, !1), i.type !== "addon" ? null : new (o("WAWebActionToast.react")).ActionType(s._(
					/*BTDS*/
					"",
					[s._plural(f, "count")]
				));
			...
			y && O(t, y);
			var C = f.length, b = new (o("WAWebActionToast.react")).ActionType(o("WAWebChatGetters").getIsNewsletter(t) ? s._(
				/*BTDS*/
				"",
				[s._plural(C)]
			) : s._(
			...
			a.type === "addon" ? v = o("WAWebChatSendMessages").sendRevokeMsgs(t, a, d) : o("WAWebChatGetters").getIsNewsletter(t) ? v = o("WAWebNewsletterRevokeMsgAction").sendNewsletterRevokeMsgs(t, a.list, d) : v = o("WAWebChatSendMessages").sendRevokeMsgs(t, a, d);
			...
			var e = t === void 0 ? {} : t, o = e.options, a = e.prefilledDescription, i = e.prefilledTitle;
			r("gkx")("9092") && r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		...
		return (a = o("useWAWebListener")).useListener((i = o("WAWebCmd")).Cmd, ["mute_all_reactions"], L), a.useListener(i.Cmd, ["mute_chat"], v), a.useListener(i.Cmd, ["mute_chat_multiselect"], b), a.useListener(i.Cmd, ["mute_chat_with_duration"], S), a.useListener(i.Cmd, ["mute_chat_from_entrypoint"], C), a.useListener(i.Cmd, ["archive_chat"], P), a.useListener(i.Cmd, ["archive_chat_from_entrypoint"], $), a.useListener(i.Cmd, ["clear_chat"], D), a.useListener(i.Cmd, ["clear_selected_chats"], x), a.useListener(i.Cmd, ["mark_chat_unread"], N), a.useListener(i.Cmd, ["pin_chat"], I), a.useListener(i.Cmd, ["assign_chat"], w), a.useListener(i.Cmd, ["favorite_chat"], T), a.useListener(i.Cmd, ["send_star_msgs"], o("WAWebActionListenerHelpers").handleSendStarMsgs), a.useListener(i.Cmd, ["send_unstar_msgs"], o("WAWebActionListenerHelpers").handleSendUnstarMsgs), a.useListener(i.Cmd, ["send_delete_msgs"], F), a.useListener(i.Cmd, ["send_revoke_msgs"], B), a.useListener(i.Cmd, ["delete_or_exit_chat"], k), a.useListener(i.Cmd, ["delete_or_exit_chat_from_entrypoint"], E), a.useListener(i.Cmd, ["product_image_viewer_modal"], g), a.useListener(i.Cmd, ["mute_all_reactions"], L), a.useListener(i.Cmd, ["attach_product"], f), a.useListener(i.Cmd, ["show_country_selector_popup"], q), a.useListener(i.Cmd, "show_merchant_details_entity_type_popup", W), a.useListener(i.Cmd, ["open_groups_v4_invite_request_flow"], h), a.useListener(i.Cmd, ["open_profile"], y), a.useListener(i.Cmd, ["open_command_palette"], U), r("useWAWebBotActionListeners")(l, d), r("useWAWebCommunityActionListeners")(), r("useWAWebNewsletterActionListeners")(), a.useListener(i.Cmd, ["trigger_bugreport_v2"], V), a.useListener(i.Cmd, ["open_event_info_drawer"], H), a.useListener(i.Cmd, ["change_ai_reply_status"], A), null;
	}
