__d("WAWebActionMenuItem.react", [
	...
	function c(t) {
		...
		var i;
		return n[3] !== r || n[4] !== a ? (i = u.jsx(o("WAWebCellMenuItem.react").CellV2MenuItem, babelHelpers.extends({ ref: a }, r, { type: "action" })), n[3] = r, n[4] = a, n[5] = i) : i = n[5], i;
	}
	l.ActionMenuItem = c;
}), 98);
