__d("WAWebAddCatalogItemForm.react", [
	...
	function p(e) {
		var t = e._countryOfOrigin, n = e._countryOfOriginError, a = e._onCountryOfOriginChange, i = e.containerRef, l = e.countriesOfOrigin, c = e.countryOfOriginName, p = e.currency, _ = e.description, f = e.descriptionError, g = e.hideItem, h = e.imageError, y = e.imagePanelRef, C = e.itemCode, b = e.itemCodeError, v = e.itemName, S = e.itemNameError, R = e.link, L = e.linkError, E = e.onDescriptionChange, k = e.onHideItemChange, I = e.onImageChange, T = e.onItemCodeChange, D = e.onItemNameChange, x = e.onLinkBlur, $ = e.onLinkChange, P = e.onPriceChange, N = e.onSalePriceChange, M = e.price, w = e.priceError, A = e.salePrice, F = e.salePriceError, O = m(""), B = O[0], W = O[1], q = m(!1), U = q[0], V = q[1], H = d(function() {
			var e = p !== "" ? o("WAWebCurrencyUtils").formatAmount1000ToParts(p, 0).symbol : "";
			return {
				priceInputLabel: s._(
					/*BTDS*/
					"",
		...
		}, [p]), G = H.priceInputLabel, z = H.salePriceInputLabel, j = d(function() {
			if (B === "") return l;
			var e = B.toLowerCase();
			return l.filter(function(t) {
				var n = t[0], r = t[1], o = typeof r == "string" ? r : n;
		...
		return u.jsxs("div", {
			...
			children: [
				...
				o("WAWebBizCatalogGatingUtils").isCountryOfOriginEnabled() && l.length > 0 && u.jsxs("div", {
					className: "x1n2onr6",
						...
						children: j.map(function(e) {
							...
							return u.jsx("div", {
								...
								onKeyDown: function(t) {
									(t.key === "Enter" || t.key === " ") && (t.preventDefault(), K(n));
								},
								role: "option",
								tabIndex: 0,
								"aria-selected": n === t,
				...
				u.jsx("div", {
					...
					children: u.jsxs(o("WAWebFlex.react").FlexRow, {
						align: "center",
						gap: 8,
						children: [u.jsx(r("WDSBaseCheckbox.react"), { value: g }), u.jsxs(o("WAWebFlex.react").FlexColumn, { children: [u.jsx(r("WDSText.react"), {
							colorName: "contentDefault",
							type: "Body1",
