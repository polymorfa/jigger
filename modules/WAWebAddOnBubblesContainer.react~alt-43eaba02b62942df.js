__d("WAWebAddOnBubblesContainer.react", [
	...
	function m(e) {
		var t, n = e.bubbleType, a = e.displayType, i = e.parentIds, l = o("WAWebAddOnBubblesContainerConditions").getForwardBubbleTargetMsg(i, a, n);
		if (!l) return null;
		var s = u.jsx(r("WDSIconIcFastForward.react"), {
			...
			l != null && o("WAWebMessageHandlers").handleOpenForwardFlow({
				msg: l,
				multiSelect: !1
			});
		}, m = l != null && l.forwardedNewsletterMessageInfo ? 0 : (t = l == null ? void 0 : l.forwardsCount) != null ? t : 0, p = m > 0 && o("WAWebNewsletterExtendedGatingUtils").shouldShowNewsletterForwardCounterBubble(o("WAWebFrontendMsgGetters").getChat(l)) ? u.jsx(r("WAWebRollerCounter.react"), {
			counter: m,
			shouldAnimate: !1,
