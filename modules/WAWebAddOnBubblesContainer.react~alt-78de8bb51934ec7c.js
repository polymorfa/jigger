__d("WAWebAddOnBubblesContainer.react", [
	...
	function m(e) {
		var t = o("react-compiler-runtime").c(12), n = e.bubbleType, a = e.displayType, i = e.parentIds, l, s, d, m;
		if (t[0] !== n || t[1] !== a || t[2] !== i) {
			m = Symbol.for("react.early_return_sentinel");
			e: {
				var p, _ = o("WAWebAddOnBubblesContainerConditions").getForwardBubbleTargetMsg(i, a, n);
				if (!_) {
					m = null;
					break e;
				}
				var f;
				t[7] === Symbol.for("react.memo_cache_sentinel") ? (f = u.jsx(r("WDSIconIcFastForward.react"), {
					directional: !0,
					iconXstyle: c.svgColorRefreshed,
					height: 20
				}), t[7] = f) : f = t[7], l = f, s = async function() {
					_ != null && o("WAWebMessageHandlers").handleOpenForwardFlow({
						msg: _,
						multiSelect: !1
					});
				};
				var g = _ != null && _.forwardedNewsletterMessageInfo ? 0 : (p = _ == null ? void 0 : _.forwardsCount) != null ? p : 0;
				d = g > 0 && o("WAWebNewsletterExtendedGatingUtils").shouldShowNewsletterForwardCounterBubble(o("WAWebFrontendMsgGetters").getChat(_)) ? u.jsx(r("WAWebRollerCounter.react"), {
					counter: g,
					shouldAnimate: !1,
			...
			t[0] = n, t[1] = a, t[2] = i, t[3] = l, t[4] = s, t[5] = d, t[6] = m;
		} else l = t[3], s = t[4], d = t[5], m = t[6];
		if (m !== Symbol.for("react.early_return_sentinel")) return m;
		var h = d, y;
		return t[8] !== l || t[9] !== h || t[10] !== s ? (y = u.jsx(r("WAWebAddOnBubble.react"), { children: u.jsxs(r("WAWebUnstyledButton.react"), {
			xstyle: c.button,
			onClick: s,
			children: [l, h]
		}) }), t[8] = l, t[9] = h, t[10] = s, t[11] = y) : y = t[11], y;
	}
	l.default = d;
}), 98);
