__d("WAWebAddOnsBridgeApi", [
	...
	var e = {
		updateAddOnCollectionAcks: function(t) {
			...
			o("WAWebAddOnsUpdateSendStatesAction").updateAddOnCollectionsSendStatesAction(e);
		},
		upsertVotesModelCollection: function(t) {
			var e = t.restoredFromDb, n = t.votes, r = t.votesToRemove;
			o("WAWebPollsUpsertVotesModelCollectionMsgAction").upsertVotesModelCollection(n, r, e);
		},
		...
		handleCommentNotification: function(t) {
			var e = t.comments, n = t.revokes;
			o("WAWebCommentAction").handleCommentNotification(e, n);
		},
		upsertEventResponsesModelCollection: function(t) {
			var e = t.eventResponses, n = t.eventResponsesToRemove;
			return o("WAWebUpsertEventResponsesModelCollectionAction").upsertEventResponsesModelCollection(e, n);
		},
		upsertCommentModelCollection: function(t) {
			var e = t.comments, n = t.commentsToRemove;
