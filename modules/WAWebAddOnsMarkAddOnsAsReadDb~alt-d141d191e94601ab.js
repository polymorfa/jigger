__d("WAWebAddOnsMarkAddOnsAsReadDb", [
	...
	async function s(e) {
		var t = new Map(), n = o("WAWebDBAddOnProviders").addOnProviders.map(async function(n) {
			var r = await (n.markAsRead == null ? void 0 : n.markAsRead(e));
			t.set(n.type, r != null ? r : []);
		}), r = [], a = o("WAWebDBMarkAsReadForTable").markAsReadForTable("message-orphans", e.map(String)).then(function(e) {
			r.push.apply(r, e);
