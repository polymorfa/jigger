__d("WAWebAddToListModal.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = o("react-compiler-runtime").c(11), n = e.isEditMode, r = e.onClose, a = e.preselectedChats, i;
		t[0] !== n ? (i = n === !0 ? s._(
			/*BTDS*/
			""
		) : s._(
		...
		var d;
		t[6] === Symbol.for("react.memo_cache_sentinel") ? (d = { surface: "smb-lists-picker" }, t[6] = d) : d = t[6];
		var m;
		return t[7] !== i || t[8] !== l || t[9] !== c ? (m = u.jsx(o("WAWebSelectModal.react").SelectModal, {
			...
			tsNavigationData: d
		}), t[7] = i, t[8] = l, t[9] = c, t[10] = m) : m = t[10], m;
	}
	l.default = c;
}), 226);
