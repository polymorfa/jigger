__d("WAWebAddonDBTable", [
	...
	var e = function(t) {
		...
		bulkGetByParentAndSender: async function(t, n) {
			return s.bulkGetByParentAndSender(o("WAWebAddonSelectUtils").getTableModeByMsgType(t), n);
		},
		getByMsgKey: async function(t, n) {
			return s.getByMsgKey(o("WAWebAddonSelectUtils").getTableModeByMsgType(t), n);
		}
	};
