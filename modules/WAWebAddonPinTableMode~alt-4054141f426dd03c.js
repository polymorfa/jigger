__d("WAWebAddonPinTableMode", [
	...
	var e = {
		...
		bulkUpsert: async function(t) {
			...
			await o("WAWebDBCRUDOperationsPinInChat").createOrUpdatePinInChat(t[0].id.remote, e);
		},
		...
		bulkGetByParentMsgKey: async function(t) {
			...
			return e == null ? [] : [o("WAWebPinsDbSerialization").deserializePinInChatMsgData(e)];
		},
		bulkGetByChatWid: async function(t) {
			var e = await o("WAWebPinInChatSchema").getTable().anyOf(["chatId"], t.map(function(e) {
				return e.toString();
			}));
			return e.map(o("WAWebPinsDbSerialization").deserializePinInChatMsgData);
		},
		bulkRemoveByMsgKey: async function(t) {
			await o("WAWebPinInChatSchema").getTable().bulkRemoveByIndex(["msgKey"], t.map(function(e) {
				return e.toString();
			}));
		},
		getByMsgKey: async function(t) {
			var e = (await o("WAWebPinInChatSchema").getTable().equals(["msgKey"], t.toString()))[0];
			return e == null ? e : o("WAWebPinsDbSerialization").deserializePinInChatMsgData(e);
		},
		updateAck: async function(t, n) {
			var e = o("WAWebPinsDbSerialization").serializePinInChatMsgData(o("WAWebCastToPinInChatMsg").assertPinInChatMsgData(t));
			await o("WAWebPinInChatSchema").getTable().merge(e.parentMsgKey, { ack: n });
		},
