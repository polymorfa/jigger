__d("WAWebAddonProcessRevokeDataUtils", [
	...
	function e(e, t) {
		var n, r = o("WAWebAddonCrossWindowUtils").getAddonProcessorType(t);
	...
	function s(e) {
		return babelHelpers.extends({}, o("WAWebProcessBaseMsgInfo").msgDataToBaseMsgInfo(e), { id: e.id }, o("WAWebMsgKeyUtils").msgKeyToTargetInfo(e.id, o("WAWebMsgKeyUtils").TranslateMsgKeyType.Addon), {
			type: o("WAWebMsgType").MSG_TYPE.REVOKED,
			kind: o("WAWebMsgType").MsgKind.RevokedAddon,
			subtype: e.subtype === "admin_revoke" ? "admin" : "sender",
	...
	l.revokeMsgInfoToRevokeMsgData = e, l.protocolRevokeToRevokeMsgData = s;
}), 98);
