__d("WAWebAddonProcessingError", [
	...
	var e = n("$InternalEnum")({
		...
		function t(t, n) {
			var r, a = "type: " + t + ", errorCode: " + String(n);
			return r = e.call(this, a, o("WAWebWamEnumE2eFailureReason").E2E_FAILURE_REASON.INVALID_MESSAGE) || this, r.name = "PlaceholderValidationError", r;
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(o("WAWebHandleMsgError").MessageValidationError);
	function u(t, n) {
		var r = t.threadMsgId, o = t.threadMsgSenderJid;
		if (r == null) throw new s(n, e.MISSING_THREAD_MESSAGE_ID);
		if (o == null) throw new s(n, e.MISSING_THREAD_MESSAGE_SENDER_JID);
		return {
			threadMsgId: r,
			threadMsgSenderJid: o
		};
	}
	l.validateMsgMeta = u;
}), 98);
