__d("WAWebAddonQueryUtils", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = yield o("WAWebDBMsgUtils").getMsgsByMsgKey(t.map(String)), a = new Map(n.map(function(e) {
			...
			return yield d(t, a), o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose([
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (n.size !== 0) {
				var l = yield o("WAWebDBMsgUtils").getMsgsByMsgKey(Array.from(n.keys()));
