__d("WAWebAddonSendProcess", [
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = o("WAWebAddonEncryptAddonMsgData").createDualEncryptionHelper(e, t), r = n ? yield n.decrypt() : e, a = o("WAWebAddonSelectUtils").getAddonTableMode(e);
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			...
			try {
				var l;
				if (!h.has(a)) throw new (o("WAWebAddonInfraError")).AddonInfraError(o("WAWebAddonInfraError").AddonInfraErrorCode.UnexpectedError);
				var _ = o("WAWebAddonProcessMsgsUtils").getParentMsgKey(t);
				if (o("WAWebAddonSendMsgData").isOptimisticAddonSendSupported(t)) i = yield o("WAWebAddonProcessMsgs").processOutgoingMsgOptimisticUpdate(a, t);
				else {
					var y;
					o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
						...
						" isLid=",
						""
					])), o("WAWebAddonCrossWindowUtils").getAddonProcessorType(t), t.type, t.id.id, _.id, (y = _.participant) == null ? void 0 : y.isLid());
					var C = yield o("WAWebAddonProcessMsgsUtils").queryAddonParentMsgs([t], a), b = C[0], v = C[1];
					if (i = {
						...
						S.convert.toDualEncryptedMsgData != null && (i.encryptedMsgData = yield S.convert.toDualEncryptedMsgData(i.decryptedMsgData, i.parent));
					}
					(a === o("WAWebAddonConstants").AddonProcessMode.Send || a === o("WAWebAddonConstants").AddonProcessMode.SendRetry) && (yield o("WAWebAddonProcessMsgs").processOutgoingMsg(a, i.encryptedMsgData, b, n));
				}
				yield o("WAWebAddonRetryRequestUtils").storeSelfMessageTypeRow(i.decryptedMsgData);
				...
				if (g(i, T)) throw o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["sendAddonMsgData: post-send validation failed, marking as failed"]))), r("err")("Post-send validation failed");
				return yield p(babelHelpers.extends({}, i.decryptedMsgData, { ack: f(i.encryptedMsgData) }), i.parent), o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose([
					"[addon-infra]: sent ",
					" addon, id: ",
					""
				...
				if (i == null) {
					if (o("WAWebAddonSendMsgData").isOptimisticAddonSendSupported(t)) try {
						var D = yield o("WAWebAddonProcessMsgsUtils").queryAddonParentMsgs([t], a), x = D[0], $ = o("WAWebAddonSelectUtils").createAddonParentSelector(x).getForAddon(t);
						yield p(babelHelpers.extends({}, t, { ack: o("WAWebAck").ACK.FAILED }), $);
					} catch (e) {
				...
				throw yield p(babelHelpers.extends({}, i.decryptedMsgData, { ack: o("WAWebAck").ACK.FAILED }), i.parent), o("WALogger").WARN(m || (m = babelHelpers.taggedTemplateLiteralLoose(["sendAddonMsgData: failure, msg: ", ""])), t.id.toString()), e;
			}
