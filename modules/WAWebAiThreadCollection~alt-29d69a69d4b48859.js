__d("WAWebAiThreadCollection", [
	...
	var e = (function(e) {
		function t() {
			...
			return t = e.call.apply(e, [this].concat(r)) || this, t.isInitialized = !1, babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		babelHelpers.inheritsLoose(t, e);
		var n = t.prototype;
		return n.initializeAiThreads = async function(t) {
			if (!this.isInitialized) {
				var e = await o("WAWebThreadMetadataJob").getAllAiThreadsFromChatId(o("WAWebWidToJid").widToChatJid(t));
				if (e != null) for (var n of e) {
					var a, i = new (r("WAWebAiThreadModel"))({
						id: n.threadId,
						...
						lastReceivedKey: n.lastReceivedKey != null ? r("WAWebMsgKey").fromString(n.lastReceivedKey) : null,
	...
	e.model = r("WAWebAiThreadModel"), e.comparator = r("WAWebAiThreadComparator"), l.AiThreadCollection = e;
}), 98);
