__d("WAWebAiThreadPinSyncUtils", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = o("WAWebWidFactory").createWid(e), n = o("WAWebThreadsMetadataIdUtils").craftThreadsMetadataInternalIdPrefixForChatAndThreadType(o("WAWebWidToJid").widToChatJid(t), o("WAWebThreadUtils").ThreadType.AiThread), a = yield o("WAWebSchemaThreadsMetadata").getThreadsMetadataTable().startsWithAnyOf(["internalId"], [n]), i = [];
			for (var l of a) {
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = yield o("WAWebSyncdDb").getSyncActionsRows(["action"], [o("WAWebSyncdConst").Actions.AiThreadPin]), a = [];
