__d("WAWebAiThreadRenameModal.react", [
	...
	function m(e) {
		var t, n = e.aiThread, a = e.chatId, i = c((t = n.title) != null ? t : ""), l = i[0], m = i[1], p = c(!1), _ = p[0], f = p[1], g = function() {
			f(!0), o("WAWebRenameAiThreadAction").renameAiThreadAction(n, l.trim(), a).then(o("WAWebModalManager").closeModalManager).catch(function(e) {
				f(!1);
			});
	...
	m.displayName = m.name + " [from " + i.id + "]", l.AiThreadRenameModal = m;
}), 226);
