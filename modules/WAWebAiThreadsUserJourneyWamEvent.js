__d("WAWebAiThreadsUserJourneyWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumMetaAiActionEntryPoint",
	"WAWebWamEnumThreadActionTypes"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ AiThreadsUserJourney: [
		7224,
		{
			...
			metaAiActionEntryPoint: [9, o("WAWebWamEnumMetaAiActionEntryPoint").META_AI_ACTION_ENTRY_POINT],
			rawBotEntryPoint: [7, e.TYPES.STRING],
			threadActionType: [8, o("WAWebWamEnumThreadActionTypes").THREAD_ACTION_TYPES]
		},
		[
			1,
			1,
