__d("WAWebAlbumsCreateAlbumParentMsgData", [
	"WAWebMsgDataUtils",
	"WAWebMsgModel",
	"WAWebMsgType",
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.chat, n = e.expectedImageCount, r = e.expectedVideoCount, a = babelHelpers.extends({}, yield o("WAWebMsgDataUtils").genOutgoingMsgData(t, o("WAWebMsgType").MSG_TYPE.ALBUM), {
