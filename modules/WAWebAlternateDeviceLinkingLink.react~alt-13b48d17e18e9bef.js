__d("WAWebAlternateDeviceLinkingLink.react", [
	...
	function _(t) {
		var n = t.codeType, a = t.enabled, i = a === void 0 ? !0 : a, l = t.onClick, s = n === o("WAWebLinkDeviceCodeViewCodeType").LinkDeviceCodeViewCodeType.PHONE_NUMBER_LINK_CODE ? p() : m(), u = c.jsxs(o("WAWebFlex.react").FlexRow, {
			paddingTop: 4,
			columnGap: 4,
			align: "start",
			...
			children: [c.jsx(o("WAWebFlex.react").FlexColumn, { children: s }), c.jsx(o("WAWebFlex.react").FlexColumn, { children: c.jsx(r("WAWebWaBrandArrowRightIconWrapper.react"), {}) })]
		});
		return i ? c.jsx(o("WAWebClickable.react").Clickable, {
			as: "div",
			dataTestId: "link-device-qrcode-alt-linking-hint",
			className: (e || (e = r("stylex")))([d.alternateLinkingMethod, r("WAWebEnvironment").isWindows && d.alternateLinkingMethodWindows]),
			onClick: l,
			children: u
		...
		}[!!r("WAWebEnvironment").isWindows << 0], { children: u }));
	}
