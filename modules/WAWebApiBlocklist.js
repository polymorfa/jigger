__d("WAWebApiBlocklist", [
	...
	function e() {
		return o("WAWebSchemaBlocklist").getBlocklistTable().all().then(function(e) {
	...
	function s(e) {
		...
		return o("WAWebModelStorageUtils").getStorage().lock(["blocklist"], function(e) {
			var n = e[0];
