__d("WAWebApiChatCommon", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield o("WAWebSchemaChat").getChatTable().equals(["historyChatId"], e, {
				shouldDecrypt: !1,
				limit: 1
			});
			return t[0];
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			return n.isRegularUserPn() && o("WAWebHistorySyncLidChatGating").isForcedHistoryLidChat() ? s(n.toString()) : e(n);
		}), d.apply(this, arguments);
	}
	l.getChatRecord = e, l.getChatRecordByHistoryChatId = s, l.getChatMaybeByHistory = c;
}), 98);
