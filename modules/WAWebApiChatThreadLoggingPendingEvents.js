__d("WAWebApiChatThreadLoggingPendingEvents", [
	...
	function m(e, t) {
		return o("WAWebSchemaChatThreadLoggingPendingEvents").getChatThreadLoggingPendingEventsTable().get([e, t]);
	}
	function p(e) {
		return o("WAWebSchemaChatThreadLoggingPendingEvents").getChatThreadLoggingPendingEventsTable().lessThan(["startTs"], e, { inclusive: !0 });
	}
	function _(e) {
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield o("WAWebSchemaChatThreadLoggingPendingEvents").getChatThreadLoggingPendingEventsTable().bulkDeleteRange(["startTs"], 0, e + 1);
			return t;
		}), f.apply(this, arguments);
	}
	l.createOrUpdateChatEvents = c, l.getChatEvent = m, l.getBeforeInclusive = p, l.deleteBeforeInclusive = _;
}), 98);
