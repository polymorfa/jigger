__d("WAWebApiChatThreadLoggingPendingEvents", [
	...
	function c(e) {
		return u.enqueue(async function() {
			var t = await o("WAWebSchemaChatThreadLoggingPendingEvents").getChatThreadLoggingPendingEventsTable().bulkGet(e.map(function(e) {
	...
	async function _(e) {
		var t = await o("WAWebSchemaChatThreadLoggingPendingEvents").getChatThreadLoggingPendingEventsTable().bulkDeleteRange(["startTs"], 0, e + 1);
		return t;
	}
