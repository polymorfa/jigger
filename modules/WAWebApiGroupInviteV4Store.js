__d("WAWebApiGroupInviteV4Store", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.expiration, n = e.from, r = e.groupId, a = e.to, i = yield o("WAWebSchemaGroupInviteV4").getGroupInviteV4Table().equals([
				"from",
				"to",
				"groupId"
			], [
			...
			return yield o("WAWebSchemaGroupInviteV4").getGroupInviteV4Table().bulkCreateOrReplace(i.map(function(e) {
	...
	l.persistGroupInviteV4Msg = e, l.persistGroupInviteV4Msgs = s, l.revokeGroupInvites = u, l.getPendingParticipantsDB = d;
}), 98);
