__d("WAWebApiOrphanReceipt", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var r = yield o("WAWebSchemaOrphanReceipt").getOrphanReceiptTable().bulkGet(t.map(String));
	...
	l.removeOrphanReceipt = e, l.getOrphanReceipt = s, l.createOrUpdateOrphanReceipt = c;
}), 98);
