__d("WAWebApiOrphanReceipt", [
	...
	async function s(e) {
		...
		var r = await o("WAWebSchemaOrphanReceipt").getOrphanReceiptTable().bulkGet(t.map(String));
		return r.find(function(e) {
			return e != null;
		});
	}
	function u(e, t, n) {
		return o("WAWebModelStorageUtils").getStorage().lock(["orphan-receipt"], function(r) {
			var o = r[0];
	...
	l.removeOrphanReceipt = e, l.getOrphanReceipt = s, l.createOrUpdateOrphanReceipt = u;
}), 98);
