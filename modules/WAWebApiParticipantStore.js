__d("WAWebApiParticipantStore", [
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.toString(), n = yield o("WAWebSchemaParticipant").getParticipantTable().get(t);
			return g(e, n);
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			var i = t == null ? void 0 : t.participants, l = t.rotateKey, s = t.senderKey, p = 0, _ = [], f = new Set();
			if (s.forEach(function(e, t) {
				...
				if (!t.includes("hosted")) {
					...
					try {
						...
						o("WALogger").ERROR(u || (u = babelHelpers.taggedTemplateLiteralLoose(["Participant filter error"])));
					}
					f = f.add(t);
					var l = o("WAWebWidFactory").asUserWidOrThrow(i), c = (r = s.get(l.toString())) != null ? r : !1;
					e && c ? a.push(i) : (n.push(i), i.isCompanion() && e && !c && (_.length < 3 && _.push(t), p++));
				}
			}), p > 0 && o("WALogger").WARN(c || (c = babelHelpers.taggedTemplateLiteralLoose([
				...
				g.length > 0 && o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose([
					"getGroupSenderKeyList: missing keys for ",
					": ",
					""
				])), g.length, g.join());
			}
			return r("gkx")("26258") || p > 0 && o("WALogger").WARN(m || (m = babelHelpers.taggedTemplateLiteralLoose(["getGroupSenderKeyList: missed ", " keys on primary"])), p).sendLogs("missing-sender-key-on-primary"), yield v(e, s.size), o("WAWebWamGroupMetricCache").cacheGroupMetrics(t), l ? {
				skDistribList: [].concat(n, a),
				skList: [],
				rotateKey: l
			} : {
				skDistribList: n,
	...
	function y(t, r) {
		...
		return o("WAWebModelStorageUtils").getStorage().lock(["participant"], (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var n = t[0], i = yield n.get(a);
				if (!i) {
					o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["markHasSenderKey: group participant info missing for group ", ""])), a);
					return;
				}
	...
	function C(e, t) {
		...
		return o("WAWebModelStorageUtils").getStorage().lock(["participant"], (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var n = e[0], a = yield n.get(r);
				if (!a) {
					o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["markForgetSenderKey: participant info missing ", ""])), r);
					return;
				}
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = e.map(function(e) {
				return e.id.toString();
			}), r = yield o("WAWebSchemaParticipant").getParticipantTable().bulkGet(n), a = e.map(function(e, n) {
				var a, i = r[n];
				if (!i) return e;
	...
	function E() {
		return o("WAWebModelStorageUtils").getStorage().lock(["participant"], (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = e[0], n = yield o("WAWebSchemaParticipant").getParticipantTable().all(), r = [], a = o("WATimeUtils").DAY_SECONDS * o("WAWebGroupConstants").PAST_PARTICIPANT_EXPIRATION_DAYS;
	...
	function x() {
		return x = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = k.get(e);
			if (t == null) {
				var n = yield o("WAWebSchemaParticipant").getParticipantTable().get(e), r = !!n && n.admins && n.admins.some(function(e) {
	...
	l.GroupUnSyncedError = p, l.getGroupSenderKeyList = _, l.getGroupSenderKeyListFromParticipantRecord = g, l.markHasSenderKey = y, l.markForgetSenderKey = C, l.injectPastParticipantsFromDB = R, l.pruneExpiredPastParticipants = E, l.setAdminshipCache = I, l.clearAdminshipCache = T, l.isCurrentUserGroupAdmin = D;
}), 98);
