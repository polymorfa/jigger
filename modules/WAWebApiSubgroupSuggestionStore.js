__d("WAWebApiSubgroupSuggestionStore", [
	...
	function d(t) {
		var r = t.newOwner, a = t.oldOwner, i = t.parentGroupId, l = t.subgroupSuggestions, s = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var t = yield (e || (e = n("Promise"))).all(l.map((function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						var t = yield o("WAWebSchemaSubgroupSuggestionV2").getSubgroupSuggestionTable().get([
							i.toString(),
							e.toString(),
							a.toString()
						]);
				...
				})())), s = t.filter(Boolean), u = s.map(function(e) {
	...
	var _ = o("WABatcher").batch({ delayMs: s }, (function() {
		var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
	...
	l.getSubgroupSuggestions = u, l.addSubgroupSuggestions = c, l.updateOwnerInSubgroupSuggestions = d, l.removeSubgroupSuggestions = m, l.removeAllSubgroupSuggestions = p, l.removeSubgroupSuggestionsWithOfflineOption = f;
}), 98);
