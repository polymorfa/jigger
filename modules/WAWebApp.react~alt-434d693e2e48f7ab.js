__d("WAWebApp.react", [
	...
	var e, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $, P, N, M = N || (N = o("react")), w = N, A = w.Component, F = w.createRef, O = r("requireDeferred")("WAWebEmojiAssetLoader").__setRef("WAWebApp.react"), B = r("requireDeferred")("WAWebEmojiAssetLoaderConfig").__setRef("WAWebApp.react"), W = r("requireDeferred")("WAWebMainWrapper").__setRef("WAWebApp.react"), q = (e = n("cr:17219")) != null ? e : {}, U = q.getWindowsBridge;
	n("WAWebSWBusInit");
	var V = n("cr:37105") != null ? n("cr:37105") : {}, H = V.EntryPointContainer, G = {}, z = window.gc;
	if (typeof z == "function") try {
		...
		}, window.gc = K, o("WAWebABPropsCache").waitForABPropConfigsReady().then(function() {
			o("WAWebABProps").getABPropConfigValue("web_anr_noop_gc_enabled") && (j = !0);
	...
	var Q = r("WAWebUserPrefsStore").get(o("WAWebUserPrefsKeys").UserPrefs.MutexBlockStrategy) === 1, X = [
	...
	function J() {
		return Y != null && Y.hasPendingActions();
	}
	function Z(e) {
		...
		return o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose([
			...
			", external=",
			""
		])), i, n), Y != null || u(0, 56382), i === "ADVERTISE" || i === "MANAGE_ADS" || i === "OPEN_CATALOG" ? !1 : Y.execApiCmd({
			cmdData: t,
			isExternal: n,
			sessionId: r
		});
	...
	var ne = 2e4, re = (function(e) {
		function t() {
			for (var t, n = arguments.length, a = new Array(n), i = 0; i < n; i++) a[i] = arguments[i];
			return t = e.call.apply(e, [this].concat(a)) || this, t.contextMenuRef = F(), t.animate = !0, t.$1 = !1, t.$2 = null, t.$3 = function() {
				if (!t.$1) {
				...
				if (n && n.nodeName === "A") {
					...
					if (!r("isStringNullOrEmpty")(a) && ee(n)) {
		...
		return a.componentDidMount = function() {
			var e = this;
			o("WAWebCrashlog").registerCrashlogUploadInformationalLoggingFunction(te), o("WAWebPwaEventListeners").registerPwaDisplayModeListener(), o("WAWebPwaEventListeners").registerPwaInstallListener(), o("WAWebPwaManifest").updatePwaManifestOnMacOS(), o("WAWebMiscGatingUtils").checkDeviceIdTestAbProp(), r("WAWebAppMutex").setShouldLaunchSocket(!Q), Q && o("WAWebLaunchSocket").launchSocket(r("WAWebAppMutex").waitForCompletion());
			var t = this.state.theme;
			o("WAWebThemeContext").applyThemeToUI(t), se().then(function(n) {
				...
				return o("WAWebCallsOnlyGating").isCallsOnlyModeEnabled() ? null : (P || (P = n("Promise"))).all([
					O.load(),
					B.load(),
					se()
				]);
			...
			}), a.add(o("WAWebStorageCmd").StorageCmd, "storage_not_enough_space", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				(yield o("WAWebModalManager").ModalManager.existsAsync()) || o("WAWebModalManager").ModalManager.open(M.jsx(r("WAWebStorageQuotaExceededPopup.react"), {}), { blockClose: !0 });
			})), a.add(o("WAWebStorageCmd").StorageCmd, "cache_storage_open_failed", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				(yield o("WAWebModalManager").ModalManager.existsAsync()) || o("WAWebModalManager").ModalManager.open(M.jsx(r("WAWebCacheStorageOpenFailedPopup.react"), {}), { blockClose: !0 });
			...
			}), a.add(o("WAWebCmd").Cmd, "unexpected_logout_modal_from_bridge", (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					if (!(yield o("WAWebModalManager").ModalManager.existsAsync())) {
						if (e == null || !X.includes(e)) {
							o("WAWebSocketModel").Socket.logout(e);
							return;
						}
						o("WAWebModalManager").ModalManager.open(M.jsx(r("WAWebUnexpectedFatalErrorModal.react"), {
							reason: e,
							children: s._(
								/*BTDS*/
								""
			...
			}), a.add(o("WAWebCmd").Cmd, "correct_passcode_lock_screen", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				e.setState({
					screenLocked: !1,
					stayInSync: !1
				});
			...
			}), a.add(o("WAWebStreamModel").Stream, "change:isHardRefresh", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				!r("WAWebEnvironment").isWindows && o("WAWebStreamModel").Stream.isHardRefresh && o("WAWebAppScreen").getScreen(e.state) === o("WAWebAppScreen").AppScreen.MAIN && !(yield o("WAWebModalManager").ModalManager.existsAsync()) && o("WAWebModalManager").ModalManager.open(M.jsx(r("WAWebHardRefreshModal.react"), {}));
			})), (n("cr:11133") == null ? void 0 : n("cr:11133")()) === !0) this.$2 = window.setTimeout(this.$3, ne);
			else {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = this;
				t === void 0 && (t = !1), t && o("WAWebUpdater").Updater.shouldForceUpdateOnTakeOver() && o("WAWebUpdater").Updater.restart();
				var a = t ? r("WAWebAppMutex").takeoverLocal(e) : r("WAWebAppMutex").init(e), i = (yield a.catch(function(e) {
					return n.setState({ takingOver: !0 }), n.$9(e, !0);
				})) === !0;
			...
			return Y != null && o("WAWebAppScreen").getScreen(this.state) === o("WAWebAppScreen").AppScreen.MAIN && ((n("cr:11133") == null ? void 0 : n("cr:11133")()) !== !0 || o("WAWebSocketModel").Socket.hasSynced === !0);
		}, a.$12 = function() {
			...
			if (n === o("WAWebAppScreen").AppScreen.MAIN && t != null && H != null) return M.jsx(H, {
				entryPointReference: t,
				props: G
			});
			var a = U == null || (e = U(r("WAWebWindowsHybridBridgeInitiator").WAWebApp)) == null ? void 0 : e.systemIntegrationsBridge;
			...
			u && Y != null && Y.notificationBackend.shutdownAsNeeded();
			var d = n === o("WAWebAppScreen").AppScreen.STARTUP || n === o("WAWebAppScreen").AppScreen.SYNCING, m = d ? "loading-screen" : this.state.locale;
			return M.jsx(o("WAWebThemeContext").ThemeContext.Provider, {
				value: this.$28({
					theme: this.state.theme,
					systemThemeMode: this.state.systemThemeMode
				}),
				children: M.jsxs(o("WAWebAppRootInteractionContext.react").WAWebAppRootInteractionContextProvider, { children: [o("WAWebPathfinderLogger").isPathfinderLoggingEnabled() ? M.jsx(r("WAWebPathfinder.react"), {}) : null, M.jsx(r("WAWebKeyboardContext").Provider, {
					value: {
						isKeyboardUser: i,
						setIsKeyboardUser: this.$11
					},
					children: M.jsx(r("WAWebWindowSizeProvider.react"), { children: M.jsx(o("WAWebDesktopSharerContext.react").WAWebDesktopSharerProviderGate, { children: M.jsx(o("WAWebPrivacyModeContext").WAWebPrivacyModeProvider, { children: M.jsx(o("WAWebErrorBoundary.react").ErrorBoundary, {
						name: "app-wrapper",
						type: "fatal",
						...
						children: M.jsx(o("WAWebUimUie.react").UIE, {
							...
							children: M.jsx(o("WAWebKeyboardHotKeys.react").HotKeys, {
								handlers: this.$19,
								className: c,
								...
								children: M.jsxs(M.Fragment, { children: [M.jsx(o("WAWebPopover.react").PopoverPortalBucket, {}), M.jsx(o("WDSContextualLayer.react").WDSContextualLayer, { children: s.map(function(e) {
	...
	})(A), oe = o("WAWebListenerHoc_DEPRECATED").ListenerHOC(re);
	function ae() {
		var e = o("WAWebFullScreenEntryPointContext").useWAWebFullScreenEntryPoint();
		return M.jsx(oe, { fullScreenEntryPoint: e });
	}
	...
	function le() {
		return le = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield (P || (P = n("Promise"))).all([W.load(), se()]), t = e[0], r = e[1];
			o("WAWebWamPageLoadReporter").mainScriptTimer.start(), Y = t(r), o("WAWebWamPageLoadReporter").mainScriptTimer.end();
		}), le.apply(this, arguments);
	}
	function se() {
		return o("WAWebConnModel").Conn.platform ? (P || (P = n("Promise"))).resolve(o("WAWebConnModel").Conn.platform) : new (P || (P = (n("Promise"))))(function(e) {
			var t = function() {
	...
	l.hasPendingActions = J, l.App = ae;
}), 226);
