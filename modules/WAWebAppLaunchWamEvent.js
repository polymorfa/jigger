__d("WAWebAppLaunchWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumAppLaunchDestinationType",
	"WAWebWamEnumAppLaunchType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ AppLaunch: [
		1094,
		{
			appContext: [22, e.TYPES.STRING],
			appContextBitfield: [23, e.TYPES.INTEGER],
			appLaunchCpuT: [2, e.TYPES.TIMER],
			appLaunchDestination: [7, o("WAWebWamEnumAppLaunchDestinationType").APP_LAUNCH_DESTINATION_TYPE],
