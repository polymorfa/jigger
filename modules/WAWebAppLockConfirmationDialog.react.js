__d("WAWebAppLockConfirmationDialog.react", [
	...
	function p() {
		var e = o("react-compiler-runtime").c(8), t = c(!1), n;
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (n = function() {
			t.current = !0, r("WAWebDialogEventLogger")({
		...
		}, e[1] = i) : i = e[1], o("useWAWebListener").useListener(o("WAWebModalManager").ModalManager, "close_modal", i);
		var l, p;
		e[2] === Symbol.for("react.memo_cache_sentinel") ? (l = {
			...
			/*BTDS*/
			""
		), e[2] = l, e[3] = p) : (l = e[2], p = e[3]);
		var _;
		e[4] === Symbol.for("react.memo_cache_sentinel") ? (_ = s._(
			/*BTDS*/
			""
		), e[4] = _) : _ = e[4];
		var f;
		e[5] === Symbol.for("react.memo_cache_sentinel") ? (f = s._(
			/*BTDS*/
			""
		), e[5] = f) : f = e[5];
		var g;
		e[6] === Symbol.for("react.memo_cache_sentinel") ? (g = u.jsx(r("WAWebFlexItem.react"), {
		...
		var h;
		return e[7] === Symbol.for("react.memo_cache_sentinel") ? (h = u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: l,
			title: p,
			onOK: a,
			okText: _,
			...
			children: [g, u.jsx(r("WDSText.react"), {
				type: "Body1",
				colorName: "contentDeemphasized",
				children: s._(
					/*BTDS*/
