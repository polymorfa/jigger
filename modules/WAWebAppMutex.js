__d("WAWebAppMutex", [
	...
	var e, s = (function() {
		function e() {
			...
			}), o("WAWebCmd").Cmd.on("ab_props_loaded_from_bridge", c), o("WAWebCmd").Cmd.on("on_ab_props_update_from_bridge", c);
		}
		var t = e.prototype;
	...
	function u(e) {
		r("WAWebUserPrefsStore").set(o("WAWebUserPrefsKeys").KEYS.MUTEX_PING_TIMEOUT_SECONDS, e);
	}
	function c() {
		u(1), o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[mutex] setMutexBlockStrategy: ", ""])), 0), r("WAWebUserPrefsStore").set(o("WAWebUserPrefsKeys").UserPrefs.MutexBlockStrategy, 0);
	}
	var d = new s();
	l.default = d;
}), 98);
