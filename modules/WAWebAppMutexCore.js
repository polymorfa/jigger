__d("WAWebAppMutexCore", [
	...
	var e, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L = 6e5, E = {
		INIT: "init",
		PING: "ping",
		PONG: "pong",
		...
		function t(e) {
			...
			this.$3 = !1, this.$4 = !0, this.$5 = new (o("WAResolvable")).Resolvable(), this.$6 = !1, this.$9 = function() {
				t.$11();
				var e = Date.now();
				o("WAWebUserPrefsTabMutex").setMutex(t.$1 = E.INIT + "_" + e), t.$2 = r("WAWebAlarm").setLocalTimeout(t.$9, e + L);
			}, this.$7 = e;
		}
		var a = t.prototype;
		return a.hasShownCallTakeoverModal = function() {
			return this.$6;
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				t === void 0 && (t = 0), this.$3 || (o("WAWebPageLoadLogging").startPageLoadQplMeasure("acquire_mutex"), this.$3 = !0);
				var n = t + 1;
				if (n > 3) return o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[app] AppMutex init generation: ", ""])), n), !0;
				var r = o("WAWebUserPrefsTabMutex").getNoTakeover();
				o("WAWebUserPrefsTabMutex").setNoTakeover();
				var a = yield this.$8();
				if (a) {
					var i, l;
					return this.$9(), o("WAWebPageLoadLogging").endPageLoadQplMeasure("acquire_mutex"), this.$4 && (yield this.$7.onAcquired()), this.$5.resolve(), (i = (l = this.$7).onAcquiredComplete) == null || i.call(l), !1;
				}
			...
			if (o("WAWebUserPrefsTabMutex").mutexFilter(t)) {
				...
				if (e) {
					if (e === E.TAKEOVER) return this.$11(), o("WAWebUserPrefsTabMutex").localTakeoverSuccess(), !0;
					if (e.indexOf(E.PING) === 0) o("WAWebUserPrefsTabMutex").setMutex(E.PONG + Math.random());
						...
						if (o("WAWebVoipGatingUtils").isCallingEnabled()) {
							...
							o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["app:storagePong: responding to active call check, hasCall: ", ""])), n), o("WAWebUserPrefsTabMutex").setMutex(E.ACTIVE_CALL_RESPONSE + "_" + String(n));
						}
					} else e.indexOf(E.FOCUS_REQUEST) === 0 && o("WAWebVoipGatingUtils").isCallingEnabled() && (o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["app:storagePong: received focus request, focusing window"]))), this.$12());
				}
			}
		}, a.$11 = function() {
			...
			if (e) {
				...
				var t = 1e3;
				if (e.indexOf("_") > 0) {
					var a = e.split("."), i = parseInt(a[a.length - 1], 10);
					if (Number.isFinite(i)) {
						var l = Date.now() - L * 1.5;
						i < l && (o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["[app] _pingForOtherLocalSession stale mutex"]))), t = 1e3);
					}
				}
				var s = o("WAPromiseTimeout").promiseTimeout(r("WAWebEventsWaitForEvent")(window, "storage", o("WAWebUserPrefsTabMutex").mutexFilter), t, "waitForOtherLocalSessionTimeout").then(function() {
				...
				}), o("WAWebUserPrefsTabMutex").setMutex(E.PING + Math.random()), s;
			}
			...
			var t = o("WAPromiseTimeout").promiseTimeout(r("WAWebEventsWaitForEvent")(window, "storage", function(e) {
				return o("WAWebUserPrefsTabMutex").mutexFilter(e) && e.newValue != null && e.newValue.indexOf(E.ACTIVE_CALL_RESPONSE) >= 0;
			...
			return o("WAWebUserPrefsTabMutex").setMutex(E.CHECK_ACTIVE_CALL + Math.random()), t;
			...
			o("WALogger").LOG(S || (S = babelHelpers.taggedTemplateLiteralLoose(["app:requestFocusOnOtherTab sending focus request"]))), o("WAWebUserPrefsTabMutex").setMutex(E.FOCUS_REQUEST + Math.random());
		}, a.$12 = function() {
