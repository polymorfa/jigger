__d("WAWebAppRatingStarButton.react", [
	...
	function m(e) {
		var t = e.currentRating, n = e.hoveredRating, r = e.value;
		return n >= r || t >= r ? s.jsx(o("WAWebStarIcon.react").StarIcon, {
			width: 35,
			height: 35
		}) : t > 0 && r > t ? s.jsx(d, {}) : s.jsx(o("WAWebStarOutlineIcon.react").StarOutlineIcon, { iconXstyle: c.starIconOutline });
	}
	m.displayName = m.name + " [from " + i.id + "]";
	function p(e) {
		var t = e.ariaLabel, n = e.currentRating, o = e.hoveredRating, a = e.onClick, i = e.onHover, l = e.onHoverEnd, d = e.testid, p = e.value, _ = u(!1), f = _[0], g = _[1], h = function() {
			a(p);
		}, y = function() {
			g(!0), i && i(p);
		}, C = function() {
		...
		return s.jsx(r("WAWebUnstyledButton.react"), {
			...
			children: s.jsxs(r("WAWebBox.react"), {
				...
				children: [s.jsx(r("WAWebBox.react"), { xstyle: [c.hoverCircle, f && c.hoverCircleVisible] }), s.jsx(r("WAWebBox.react"), {
