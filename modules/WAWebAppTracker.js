__d("WAWebAppTracker", ["$InternalEnum", "WAWebLogForCrash"], (function(t, n, r, o, a, i, l) {
	"use strict";
	...
	function s(e, t, n) {
		Object.hasOwn(e, "appContext") || (e.appContext = t != null ? d.getAppContextWithLookback(t, n) : d.getAppContext());
	}
	function u(e, t, n) {
		var r = t ? " " + String(t) + ":" : "", o = n != null ? " (" + n.toLocaleString() + "ms)" : "";
	}
	var c = (function() {
		function e() {
		...
		return t.$3 = function() {
			...
			o("WAWebLogForCrash").logForCrash("wa:appContext", this.getAppContext() || "none");
		}, t.start = function(t) {
			var e;
			(e = this.$1.get(t)) != null && e.isRunning || (u("Start Tracker", t), this.$1.set(t, {
			...
			return e.length === 0 ? "" : (e.sort(), this.$2 = e.join("+"), this.$2);
		}, t.getAppContextWithLookback = function(t, n) {
			n === void 0 && (n = self.performance.now());
			var e = n - t, r = [];
			for (var o of this.$1) {
				var a = o[0], i = o[1];
				i.startTime > n || (i.isRunning || i.endTime != null && i.endTime >= e) && r.push(a);
			}
