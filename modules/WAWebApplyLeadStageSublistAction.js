	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, a) {
			...
			if (!(a != null && n === a)) {
				...
				var c = (i = o("WAWebChatCollection").ChatCollection.get(t)) != null ? i : yield o("WAWebFindChatAction").findOrCreateLatestChat(o("WAWebWidFactory").createWid(t), "contactManager").then(function(e) {
					return e.chat;
				}).catch(function(e) {
				...
				c != null && (((l = c.labels) != null ? l : []).includes(u.id) || o("WAWebLabelCollection").LabelCollection.addOrRemoveLabels([{
					id: u.id,
					type: "add"
				}], [c]), yield r("WAWebLabelSublistSync").sendLabelSublistUpdate(o("WAWebLeadListConstants").LEAD_LIST_PREDEFINED_ID, t, n));
			}
