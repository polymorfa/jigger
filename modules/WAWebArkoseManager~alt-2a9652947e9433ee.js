__d("WAWebArkoseManager", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $ = { publicKey: r("gkx")("26258") ? "BB073E43-7F89-42BA-A162-8BB05F982ED9" : "77677C30-EC99-4608-90A9-D46B2A98A418" }, P = "https://iframe.arkoselabs.com", N = (function() {
		function t() {
		...
		return n.$1 = function() {
			...
			if (this.$1()) {
				...
				var t = n != null ? n : {}, r = t.config;
				this.config = r != null ? r : $, await this.loadIframe(), o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[Arkose] Arkose manager initialized"])));
			}
		}, n.loadIframe = async function() {
			var e = this;
			if (!(this.isIframeLoaded || this.isIframeLoading || !this.config)) {
				...
				try {
					var n, a, i = document.createElement("iframe");
					i.id = this.iframeId, i.src = P + "/" + (((n = this.config) == null ? void 0 : n.publicKey) || "") + "/lightbox.html", i.removeAttribute("sandbox"), i.style.display = "none", (a = i.sandbox).add.apply(a, ["allow-scripts", "allow-same-origin"]), this.secureMessageListener = new (r("SecureMessageListener"))(window).setSupportedOrigins(["arkoselabs.com"]).setEventHandler(function(t) {
						e.handleArkoseMessage(t);
					}), this.secureMessageListener.beginListening();
					var l = new Promise(function(t, n) {
						i.onload = function() {
							o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[Arkose] Iframe loaded successfully"]))), e.isIframeLoaded = !0, e.isIframeLoading = !1, e.iframeElement = i, t();
						}, i.onerror = function() {
					...
					document.body.appendChild(i), await l, this.isInitialized = !0, this.processPendingTriggers();
				} catch (e) {
		...
		}, n.handleArkoseMessage = function(t) {
			var e;
			if (t.origin === P && typeof t.data == "string") try {
		...
		}, n.handleSignalCollection = function(t) {
			try {
			...
			if (this.$1()) {
				...
				if (!this.isIframeLoaded || !this.iframeElement) return new Promise(function(n, r) {
					e.pendingTriggers.push({
						context: t,
						resolve: n,
						reject: r
					}), e.isIframeLoading || e.loadIframe();
				});
				try {
					this.currentTriggerContext = t, o("WALogger").LOG(k || (k = babelHelpers.taggedTemplateLiteralLoose(["[Arkose] Triggering detection for context: ", ""])), t);
					try {
						var n = {
							publicKey: this.config.publicKey,
							eventId: "challenge-open"
						};
						o("SecurePostMessage").sendMessageToSpecificOrigin(this.iframeElement.contentWindow, JSON.stringify(n), P), o("WALogger").LOG(I || (I = babelHelpers.taggedTemplateLiteralLoose(["[Arkose] Posted challenge-open message to iframe"])));
					} catch (e) {
		...
		}, n.processPendingTriggers = function() {
			var e = this;
		...
		}, n.setMdSessionId = function(t) {
			this.$1() && (this.mdSessionId = t);
		}, n.setMdClientSessionId = function(t) {
