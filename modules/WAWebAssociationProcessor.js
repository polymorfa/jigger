__d("WAWebAssociationProcessor", [
	...
	var e = r("justknobx")._("4912"), s = [
		...
		e ? o("WAWebDualUploadsAssociationProcessor").ImageDualUploadsAssociationProcessor : null,
		e ? o("WAWebDualUploadsAssociationProcessor").VideoDualUploadsAssociationProcessor : null,
		e ? o("WAWebDualUploadsAssociationProcessor").HevcDualUploadsAssociationProcessor : null
	].filter(Boolean);
	function u(e) {
		var t, n = e.associationType;
	...
	l.getAssociationProcessor = u, l.getAssociationProcessorByAssociationType = c;
}), 98);
