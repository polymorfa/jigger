	...
	function d(e) {
		...
		if (t[0] !== n || t[1] !== a) {
			var l = function() {
				...
				}), { blockClose: !0 }), o("WAWebPrepareMessageSendingAction").prepareChatForMessageSending(n), o("WAWebAttachmentMenuLogger").AttachmentMenuLogger.logAttachMenuClick(n, o("WAWebAttachmentMenuLogger").AttachmentMenuTarget.POLL);
			};
			i = function() {
				l();
			}, t[0] = n, t[1] = a, t[2] = i;
