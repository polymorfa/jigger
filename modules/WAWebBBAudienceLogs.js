__d("WAWebBBAudienceLogs", ["WAWebBBLoggerTypes"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e, t, n) {
		e({
	...
	function s(e, t, n) {
		e({
			...
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_RECIPIENT_PICKER,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.CONTACT_CHECKBOX
		});
	}
	function u(e, t) {
		e({
	...
	function c(e, t, n, r, a, i) {
		e({
			...
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_RECIPIENT_PICKER,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.SAVE_AUDIENCE_BUTTON
		});
	}
	...
	function m(e, t, n, r, a, i) {
		var l = r != null ? babelHelpers.extends({}, i, {
			contact_count: t,
			errorType: r,
			save_result: n
	...
	l.createAudienceViewed = e, l.createAudienceContactCheckboxClicked = s, l.createAudienceBackClicked = u, l.createAudienceSaveClicked = c, l.createAudienceSaveResult = d, l.importAudienceSaveResult = m;
}), 98);
