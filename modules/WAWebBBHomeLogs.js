__d("WAWebBBHomeLogs", ["WAWebBBLoggerTypes"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e, t) {
		e({
	...
	function s(e, t, n) {
		e({
			...
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_HOME,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.EXISTING_AUDIENCE_LIST_ITEM
		});
	}
	function u(e, t) {
		var n;
	...
	function c(e, t) {
		e({
			...
			entryPoint: t,
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_HOME,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.LEARN_MORE_LINK
		});
	}
	function d(e, t) {
		e({
			...
			entryPoint: t,
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_HOME,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.NEW_AUDIENCE_DROPDOWN
		});
	}
	function m(e, t) {
		e({
			...
			entryPoint: t,
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_HOME,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.OVERFLOW_MENU_BUTTON
		});
	}
	function p(e, t) {
		e({
			...
			entryPoint: t,
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_HOME,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.AUDIENCES_TAB_BUTTON
		});
	}
	function _(e, t) {
		e({
			...
			entryPoint: t,
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_HOME,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.BROADCASTS_TAB_BUTTON
		});
	}
	function f(e, t, n, r) {
		e({
			...
			surface: r,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.SUGGESTED_AUDIENCE_CARDS_IMPRESSION
		});
	}
	function g(e, t) {
		var n;
	...
	function R(e, t) {
		e({
			...
			entryPoint: t,
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_HOME,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.BROADCAST_ITEM_OVERFLOW_BUTTON
		});
	}
	function L(e, t, n, r) {
		e({
			...
			surface: r,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.ELIGIBILITY_GATE
		});
	}
	function E(e, t, n, r, a) {
		e({
			...
			surface: o("WAWebBBLoggerTypes").SURFACE_TYPE.BB_HOME,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.SUGGESTED_AUDIENCE_CARD_CLICK
		});
	}
	function k(e, t, n, r, a) {
		e({
			...
			surface: a,
			userActionTarget: o("WAWebBBLoggerTypes").UserActionTarget.SUGGESTED_AUDIENCE_CARD_ERROR
		});
	}
	l.bbHomePageViewed = e, l.newBusinessBroadcastAudienceListItemClicked = s, l.newChatFlowAudienceListItemClicked = u, l.homeLearnMoreClicked = c, l.homeNewAudienceDropdownClicked = d, l.homeOverflowMenuClicked = m, l.homeAudiencesTabClicked = p, l.homeBroadcastsTabClicked = _, l.suggestedAudienceCardsViewed = f, l.chatListContextMenuOpened = g, l.messageContextMenuOpened = h, l.conversationHeaderMenuOpened = y, l.broadcastChatListItemViewed = C, l.broadcastThreadViewed = b, l.tosReviewBannerViewed = v, l.tosReviewBannerClicked = S, l.broadcastItemOverflowClicked = R, l.eligibilityCheckResult = L, l.suggestedAudienceCardClicked = E, l.suggestedAudienceCardError = k;
}), 98);
