__d("WAWebBackendEventBusWorker", ["WAWebBackendApi", "WAWebSocketConstants"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = (function() {
		function e(e) {
			this.$2 = new Map(), this.$3 = new Map(), this.isMainStreamReadyMd = !1, this.isOfflineDeliveryEnd = !1, this.socketState = o("WAWebSocketConstants").SOCKET_STATE.UNLAUNCHED, this.$1 = e;
		}
		var t = e.prototype;
		return t.setState = function(t) {
			this.isMainStreamReadyMd = t.isMainStreamReadyMd, this.isOfflineDeliveryEnd = t.isOfflineDeliveryEnd, this.socketState = t.socketState;
		}, t.$4 = function(t, n) {
			var e, r = (e = this.$2.get(t)) != null ? e : [];
			return r.push(n), this.$2.set(t, r), this;
		}, t.$5 = function(t, n) {
			var e, r = (e = this.$3.get(t)) != null ? e : [];
			return r.push(n), this.$3.set(t, r), this;
		}, t.$6 = function(t) {
			for (var e, n, r = (e = this.$2.get(t)) != null ? e : [], o = arguments.length, a = new Array(o > 1 ? o - 1 : 0), i = 1; i < o; i++) a[i - 1] = arguments[i];
			...
			this.$1.fireAndForget("backendEventBus", "triggerAppStateSyncCompleted", { collectionDetails: t });
			...
			this.$1.fireAndForget("backendEventBus", "triggerInitialChatHistorySynced", void 0);
		}, t.triggerRecentChatHistorySynced = function() {
			this.$1.fireAndForget("backendEventBus", "triggerRecentChatHistorySynced", void 0);
		}, t.triggerFullChatHistorySynced = function() {
			this.$1.fireAndForget("backendEventBus", "triggerFullChatHistorySynced", void 0);
		}, t.triggerCriticalSyncDone = function() {
			this.$1.fireAndForget("backendEventBus", "triggerCriticalSyncDone", void 0);
		}, t.triggerStorageInitializationError = function() {
			this.$1.fireAndForget("backendEventBus", "triggerStorageInitializationError", void 0);
		}, t.triggerSocketStreamDisconnected = function() {
			this.$1.fireAndForget("backendEventBus", "triggerSocketStreamDisconnected", void 0);
		}, t.triggerOpenSocketStream = function() {
			this.$1.fireAndForget("backendEventBus", "triggerOpenSocketStream", void 0);
		}, t.triggerReconnectSocket = function() {
			this.$1.fireAndForget("backendEventBus", "triggerReconnectSocket", void 0);
		}, t.triggerSetSocketState = function(t) {
			this.$1.fireAndForget("backendEventBus", "triggerSetSocketState", { state: t });
		}, t.triggerMainStreamModeReady = function() {
			this.$1.fireAndForget("backendEventBus", "triggerMainStreamModeReady", void 0);
		}, t.triggerOfflineProcessReady = function() {
			this.$1.fireAndForget("backendEventBus", "triggerOfflineProcessReady", void 0);
		}, t.triggerOfflineDeliveryEnd = function() {
			this.$1.fireAndForget("backendEventBus", "triggerOfflineDeliveryEnd", void 0);
		}, t.triggerOfflineDeliveryStateReset = function() {
			this.$1.fireAndForget("backendEventBus", "triggerOfflineDeliveryStateReset", void 0);
			...
			this.$1.fireAndForget("backendEventBus", "triggerAbPropsLoaded", void 0);
		}, t.triggerPrimaryFeaturesSynced = function(t) {
			this.$1.fireAndForget("backendEventBus", "triggerPrimaryFeaturesSynced", { changedFeatures: Array.from(t) });
		}, t.triggerStartingLogout = function() {
			o("WAWebBackendApi").frontendFireAndForget("triggerStartingLogoutFromBridge", {});
		}, t.triggerHistorySyncChunkProcessed = function(t) {
			o("WAWebBackendApi").frontendFireAndForget("triggerHistorySyncChunkProcessedFromBridge", { chatsUpdated: Array.from(t) });
		}, t.triggerUpdateStatusPrivacySettings = function(t) {
			o("WAWebBackendApi").frontendFireAndForget("triggerUpdateStatusPrivacySettingsFromBridge", t);
		}, t.triggerUpdateCrosspostAutoShareSettings = function(t) {
			o("WAWebBackendApi").frontendFireAndForget("triggerUpdateCrosspostAutoShareSettingsFromBridge", t);
		}, t.triggerTemporaryBan = function(t) {
			o("WAWebBackendApi").frontendFireAndForget("triggerTemporaryBanFromBridge", t);
		}, t.triggerAccountSyncForPrivacy = function(t) {
			o("WAWebBackendApi").frontendFireAndForget("triggerAccountSyncForPrivacyFromBridge", t);
		}, t.triggerUnexpectedLogoutModal = function(t) {
			o("WAWebBackendApi").frontendFireAndForget("triggerUnexpectedLogoutModalFromBridge", { reason: t });
		}, t.triggerInitialLoadReady = function() {
			o("WAWebBackendApi").frontendFireAndForget("triggerInitialLoadReadyFromBridge", {});
		}, t.triggerServiceUnavailable = function() {
			o("WAWebBackendApi").frontendFireAndForget("triggerServiceUnavailableFromBridge", {});
		}, e;
	})();
	l.default = e;
}), 98);
