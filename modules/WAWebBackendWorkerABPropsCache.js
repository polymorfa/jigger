__d("WAWebBackendWorkerABPropsCache", [
	"WAResolvable",
	"WAWebABProps",
	"WAWebABPropsConfigs",
	...
	"use strict";
	var e = new Map(), s = new Set(), u = null, c = new (o("WAResolvable")).Resolvable(), d = "";
	function m(e) {
	...
	function p(t) {
		...
		if (n != null) {
			var r = n[0], a = n[1], i = n[2], l = n[3], c = i, d = e.get(r);
			if (!s.has(r) && e.has(r)) {
				var m;
				s.add(r), (m = u) == null || m.fireAndForget("abPropsExposure", "recordExposure", { configCode: r });
			}
