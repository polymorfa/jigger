__d("WAWebBackendWorkerInitState", [
	...
	function p(e) {
		c.dbInit.resolveWasCalled() || c.dbInit.resolve(babelHelpers.extends({}, e, { salt: new Uint8Array(e.salt) }));
	}
	function _(e) {
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield (s || (s = n("Promise"))).all([c.dbInit.promise, c.eventBusSyncState.promise]), r = t[0], a = t[1], i = o("WAWebUserPrefsBase").userPreferencesStoreBase.get(o("WAWebUserPrefsKeys").KEYS.ME_DISPLAY_NAME), l = o("WAWebUserPrefsBase").userPreferencesStoreBase.get(o("WAWebUserPrefsKeys").KEYS.LID);
			yield e.sendAndReceive("workerInit", "setup", {
				...
				e.fireAndForget("workerInit", "setAbProps", { abProps: d != null ? d : t });
			}), c.dbFinalKey.promise.then(function(t) {
				e.fireAndForget("workerInit", "setDbFinalKey", { dbFinalKey: t });
			});
		}), h.apply(this, arguments);
	}
	l.recordInitAbProps = m, l.recordInitDbInit = p, l.recordInitDbFinalKey = _, l.recordInitEventBusSyncState = f, l.sendInitState = g;
}), 98);
