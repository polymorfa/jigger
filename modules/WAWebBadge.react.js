__d("WAWebBadge.react", ["react", "react-compiler-runtime"], (function(t, n, r, o, a, i, l) {
	...
	function c(e) {
		var t = o("react-compiler-runtime").c(8), n = e.Icon, r = e.theme, a;
		t[0] !== r ? (a = {
		...
		}[(r === "pending") << 1 | (r === "warning") << 0], t[0] = r, t[1] = a) : a = t[1];
		var i = a, l;
		t[2] !== n || t[3] !== r ? (l = n ? s.jsx(n, { xstyle: [u.icon, r === "warning" && u.warningIcon] }) : null, t[2] = n, t[3] = r, t[4] = l) : l = t[4];
		var c = l, d;
		return t[5] !== i || t[6] !== c ? (d = s.jsx("div", {
			className: i,
			children: c
		}), t[5] = i, t[6] = c, t[7] = d) : d = t[7], d;
	}
	l.default = c;
}), 98);
