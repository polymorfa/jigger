__d("WAWebBadge.react", ["react"], (function(t, n, r, o, a, i, l) {
	...
	function c(e) {
		...
		}[(n === "pending") << 1 | (n === "warning") << 0], o = t ? s.jsx(t, { xstyle: [u.icon, n === "warning" && u.warningIcon] }) : null;
		return s.jsx("div", {
			className: r,
			children: o
		});
