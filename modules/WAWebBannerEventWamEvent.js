__d("WAWebBannerEventWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumBannerOperations",
	"WAWebWamEnumBannerTypes"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ BannerEvent: [
		1578,
		{
			bannerId: [3, e.TYPES.STRING],
			bannerOperation: [2, o("WAWebWamEnumBannerOperations").BANNER_OPERATIONS],
