__d("WAWebBaseCollection", [
	...
	var e, s, u, c, d, m, p, _, f, g = {
		...
		function a() {
			var e;
			return e = t.call(this) || this, e._inflight = {}, e._cachePolicy = o("WAWebCachePolicies").createCachePolicy(e, e.constructor.cachePolicy || y), e._cachePolicy.enableCaching(), e._cachePolicy.constructor.policy === o("WAWebBaseCachePolicy").CACHE_POLICY.LOAD && (e.listenTo(o("WAWebConnModel").Conn, "me_ready", e._updateFromCache), o("WAWebConnModel").Conn.meReadyTriggered && e._updateFromCache()), e;
		}
		...
		return i.initializeFromCache = function(t) {
			...
			return t ? this._query(g.FIND, t, a) : (o("WALogger").ERROR(u || (u = babelHelpers.taggedTemplateLiteralLoose(["Called find without an id"]))).sendLogs("find-without-id"), (f || (f = n("Promise"))).reject(r("err")("called find without an id")));
		}, i.update = function(t, a) {
			return t ? this._query(g.UPDATE, t, a) : (o("WALogger").ERROR(c || (c = babelHelpers.taggedTemplateLiteralLoose(["Called update without an id"]))).sendLogs("update-without-id"), (f || (f = n("Promise"))).reject(r("err")("called update without an id")));
		}, i.gadd = function(t, n) {
			...
			var e = this, l = o("WATypeUtils").isString(a) ? a : a.toString();
			l === h && (l = r("uniqueID")("collection_query_"));
			var s = t === g.QUERY ? void 0 : this.get(a), u = "force-" + l;
			return (this._inflight[u] && t === g.FIND || t === g.UPDATE) && (l = u), this._inflight[l] ? t === g.FIND && s && !s.stale ? (f || (f = n("Promise"))).resolve(s) : this._inflight[l] : !s || s.stale || t === g.UPDATE ? this._inflight[l] = this._serverQuery(t, a, i).finally(function() {
				...
				if (e instanceof C) o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["baseCollection:query query promise rejected: ", ""])), String(e));
				else throw e;
			}) : (f || (f = n("Promise"))).resolve(s);
		}, i._serverQuery = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				var r, a, i;
				e === g.UPDATE ? i = this._update(t, n) : e === g.FIND ? i = this.findImpl(t, n) : i = this.findQueryImpl(t);
				var l = yield i;
				this._markResultsNotStale(l);
				var s;
				if ((n == null ? void 0 : n.set) === !0 ? s = this.set(l) : s = this.add(l, { merge: !0 }), Array.isArray(l)) return s;
				if (s[0]) return s[0];
				throw new (o("WAWebMiscErrors")).ModelCreateError((r = (a = this.modelClass) == null ? void 0 : a.name) != null ? r : "Unknown", l);
			});
			function t(t, n, r) {
