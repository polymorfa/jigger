__d("WAWebBaseL10N", [
	...
	var e = new Set(["fa"]), s = "٠١٢٣٤٥٦٧٨٩".split(""), u = 1024 * 1024 * 1024, c = Math.pow(10, 6), d = Math.pow(10, 3), m = Math.pow(10, 4);
	function p(e) {
		return s[parseInt(e, 10)];
	}
	var _ = r("err")("Unimplemented method"), f = (function(t) {
		function n(e) {
			var n;
		...
		return a.getLocale = function() {
			...
			var e = t.replace(/-/g, "_").toLowerCase(), n = this.$WAWebBaseL10n$p_2(e);
			if (n) return n;
			for (var r = e; r;) {
			...
			return n === void 0 && (n = this.isRTL()), n ? this.embedRTL(t) : this.embedLTR(t);
			...
			var e = o("WAWebL10NNumbersPluginRegistry").l10nNumberFormattersRegister.get(this.getFullLocale());
			if (e != null && typeof t == "number") return e.format(t, this.getFullLocale());
			var a = typeof t == "number" && (t >= c || t >= d && t < m) ? 1 : 0;
			return this.n(t, n, babelHelpers.extends({}, r, {
				notation: "compact",
				roundingMode: "trunc",
			...
			return typeof t == "number" ? Intl.NumberFormat(this.getFullLocale(), r).format(t) : this.useArabicScriptDigits(n) ? t.toString().replace(/[0-9]/g, p) : t;
		}, a.filesizeWithParams = function(t, n) {
			var e = t > u ? 1 : 0, o = this.getFullLocale();
			return this.n(r("filesize")(t, {
				base: 2,
				round: e,
				locale: o,
				symbols: n
			...
			var e;
			(e = r("WAWeb-moment")).relativeTimeRounding(Math.floor), e.relativeTimeThreshold("s", 60), e.relativeTimeThreshold("m", 60), e.relativeTimeThreshold("h", 24);
		}, n;
	})(r("WAWebEventEmitter"));
	l.WAWebBaseL10n = f;
}), 98);
