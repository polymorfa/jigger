__d("WAWebBaseNewsletterVideo.react", [
	...
	function f(t) {
		var n, a = t.autoPlay, i = t.children, l = t.className, u = t.msg, m = t.ref, f = t.srcObject, g = babelHelpers.objectWithoutPropertiesLoose(t, e), h = g.videoCallbacks, y = babelHelpers.objectWithoutPropertiesLoose(g, s), C = p(r("WAWebNewsletterVideoPlayLoggingContext")), b = C.finishCount, v = C.setFinishCount, S = o("WAWebFrontendMsgGetters").getChat(u).id.toString().replace(/@.*/, ""), R = (n = u.serverId) != null ? n : 0, L = o("useWAWebCanPlaybackAudio").useCanPlaybackAudio(u), E = o("useWAWebNewsletterVideoPlayMetric").useWAWebNewsletterVideoPlayMetric(u, S, R.toString()), k = babelHelpers.extends({}, (c(E.videoProps), E.videoProps)), I = r("useWAWebBaseVideoCommon")({
			autoPlay: a,
			callbacks: {
			...
			src: g.src,
			srcObject: f
		}), T = I.getAudioDisabled, D = I.getBuffered, x = I.getCurrentTime, $ = I.getDuration, P = I.getMuted, N = I.getPaused, M = I.getPlaybackRate, w = I.getVolume, A = I.pause, F = I.pauseAndReset, O = I.play, B = I.setCurrentTime, W = I.setDuration, q = I.setMuted, U = I.setPlaybackRate, V = I.setRefVideo, H = I.setVolume, G = I.underlyingVideo, z = I.videoRef, j = I.wrappedProps, K = r("useWAWebStableCallback")(function() {
			return L ? T() : !0;
			...
			v(b + 1), k.onChannelVideoEnded == null || k.onChannelVideoEnded(z, b);
		});
		return _(m, function() {
			return {
				getAudioDisabled: K,
			...
			ee,
			Z
		]), d.jsx("video", babelHelpers.extends({}, h, {
			ref: V,
