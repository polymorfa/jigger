__d("WAWebBizAGMFlowCta.react", [
	...
	"use strict";
	var e, s, u = s || (s = o("react")), c = s.useCallback;
	function d(t) {
		var n = t.chat, a = t.ctaPayload, i = t.ctaText, l = t.msg, s = t.onClick, d = c(function() {
			var t = null;
			try {
				var i = JSON.parse(a);
				if (t = {
				...
				}, !o("WAWebGalaxyFlowsOpenDrawer").isValidGalaxyFlowBtnParamsJson(t)) throw r("err")("Missing required Galaxy Flow parameters");
			} catch (t) {
				o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Galaxy Flow: Invalid Flow configuration: ", ""])), t);
			}
			t != null ? (o("WAWebGalaxyFlowsOpenDrawer").openGalaxyFlowsDrawer(l, t, n, t.flowId)(), s()) : r("WAWebNoop")();
		}, [
			n,
			a,
			l,
			s
		]), m = o("useWAWebMsgValues").useMsgValues(l.id, [o("WAWebMsgGetters").getGalaxyFlowDisabled]), p = m[0], _ = l.id.fromMe || p === !0;
		return u.jsx(o("WAWebMessageBubbleActions.react").BubbleActions, { items: [{
			label: i,
			onClick: d,
