__d("WAWebBizAIBestsellersDrawer.react", [
	...
	function k(e) {
		...
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (d = [], t[0] = d) : d = t[0], h(I, d);
		var m;
		t[1] !== a ? (m = function(t) {
			return p.jsx(L, {
				onBack: a,
		...
		var _;
		t[3] !== a ? (_ = E(a), t[3] = a, t[4] = _) : _ = t[4];
		var g;
		t[5] !== n || t[6] !== a || t[7] !== i || t[8] !== l ? (g = l != null ? p.jsx(D, {
			onAddItems: n,
			onBack: a,
			onRetry: i,
			queryRef: l
		}) : E(a), t[5] = n, t[6] = a, t[7] = i, t[8] = l, t[9] = g) : g = t[9];
		var y;
	...
	var T = e !== void 0 ? e : e = n("WAWebBizAIBestsellersDrawerQuery.graphql");
	function D(e) {
		var t, n = o("react-compiler-runtime").c(66), a = e.onAddItems, i = e.onBack, l = e.onRetry, m = e.queryRef, _ = o("CometRelay").usePreloadedQuery(T, m), f = r("useWAWebBizAIQueryRefreshError")(m.source), g;
		if (n[0] !== ((t = _.xfb_meta_ai_biz_agent_wa_ai_home) == null || (t = t.knowledge) == null ? void 0 : t.bestsellers)) {
			var y, R, E;
			g = ((y = (R = _.xfb_meta_ai_biz_agent_wa_ai_home) == null || (R = R.knowledge) == null ? void 0 : R.bestsellers) != null ? y : []).map(P).filter($), n[0] = (E = _.xfb_meta_ai_biz_agent_wa_ai_home) == null || (E = E.knowledge) == null ? void 0 : E.bestsellers, n[1] = g;
		} else g = n[1];
		var k = g, I;
		n[2] === Symbol.for("react.memo_cache_sentinel") ? (I = [], n[2] = I) : I = n[2];
		var D = r("useWAWebAsync")(S, I), N;
		if (n[3] !== D.value) {
			var M;
			N = (M = D.value) != null ? M : [], n[3] = D.value, n[4] = N;
		} else N = n[4];
		var w = N, A;
		n[5] !== w ? (A = new Set(w.map(x)), n[5] = w, n[6] = A) : A = n[6];
		var F = A, O;
		...
		n[10] !== D.error ? (Y = function() {
			D.error != null && (o("WALogger").ERROR(u || (u = babelHelpers.taggedTemplateLiteralLoose(["bestseller catalog fetch failed"]))).catching(r("getErrorSafe")(D.error)).sendLogs("biz-ai-bestseller-catalog-fetch"), o("WAWebBizAiSaveUtils").showErrorToast());
		}, J = [D.error], n[10] = D.error, n[11] = Y, n[12] = J) : (Y = n[11], J = n[12]), h(Y, J);
		var Z;
		n[13] !== Q ? (Z = function(t) {
		...
		var Te;
		return n[60] !== ue || n[61] !== i || n[62] !== he || n[63] !== Ee || n[64] !== ke ? (Te = p.jsxs(L, {
			headerAction: ge,
			onBack: i,
			children: [
				he,
	...
	l.WAWebBizAIBestsellersDrawer = k, l.BestsellersDrawerQuery = T;
}), 226);
