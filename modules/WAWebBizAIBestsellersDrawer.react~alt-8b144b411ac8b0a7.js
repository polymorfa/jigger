__d("WAWebBizAIBestsellersDrawer.react", [
	...
	var k = e !== void 0 ? e : e = n("WAWebBizAIBestsellersDrawerQuery.graphql");
	function I(e) {
		var t = e.onAddItems, n = e.onBack, a = e.onRetry, i = e.queryRef, l = o("CometRelay").usePreloadedQuery(k, i), m = r("useWAWebBizAIQueryRefreshError")(i.source), _ = y(function() {
			var e, t;
		...
		}, [l.xfb_meta_ai_biz_agent_wa_ai_home]), f = r("useWAWebAsync")(S, []), L = y(function() {
			var e;
		...
		}, [L, _]), I = C(null), T = I[0], D = I[1], x = C(null), $ = x[0], P = x[1], N = C(!1), M = N[0], w = N[1], A = T != null ? T : E, F = $ != null ? $ : A;
		h(function() {
		...
		return L.length === 0 && t != null ? U = p.jsx("span", { children: p.jsx(r("WDSTooltip.react"), {
			label: s._(
				/*BTDS*/
				""
			),
		...
		}) }) : L.length > 0 && (U = p.jsx(r("WDSButton.react"), {
			variant: "filled",
			size: "small",
			label: s._(
				/*BTDS*/
	...
	I.displayName = I.name + " [from " + i.id + "]", l.WAWebBizAIBestsellersDrawer = E, l.BestsellersDrawerQuery = k;
}), 226);
