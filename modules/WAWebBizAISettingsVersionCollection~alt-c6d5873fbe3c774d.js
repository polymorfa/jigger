__d("WAWebBizAISettingsVersionCollection", [
	"WALogger",
	...
	var e, s, u = (function(t) {
		function n() {
			...
			return e = t.call.apply(t, [this].concat(r)) || this, e.findImpl = async function(t) {
				var n, r, a = o("WAWebBizAISettingsCategoryRegistry").getCategoryHandler(t);
				...
				return {
					...
					updatedAtMs: (r = i == null ? void 0 : i.updatedAtMs) != null ? r : 0
				};
			}, babelHelpers.assertThisInitialized(e) || babelHelpers.assertThisInitialized(e);
		}
		babelHelpers.inheritsLoose(n, t);
		var r = n.prototype;
		return r.handleNudge = function(n, r, a) {
			var t, i, l = String(n), u = this.get(l);
			if (u != null && u.version >= r && u.updatedAtMs >= a) {
				o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
					...
					"@",
					")"
				])), l, u.version, u.updatedAtMs, r, a);
				return;
			}
			var c = (t = u == null ? void 0 : u.version) != null ? t : 0, d = (i = u == null ? void 0 : u.updatedAtMs) != null ? i : 0;
			...
			m.markStale();
		}, r.incrementVersion = function(t, n) {
			var e, r = String(t), o = this.get(r), a = ((e = o == null ? void 0 : o.version) != null ? e : 0) + 1;
			return this.gadd({
				id: r,
				version: a,
				updatedAtMs: n
