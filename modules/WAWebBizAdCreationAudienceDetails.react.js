__d("WAWebBizAdCreationAudienceDetails.react", [
	...
	function f(e) {
		...
		return t[0] === Symbol.for("react.memo_cache_sentinel") ? (n = u.jsx(r("WDSIconIcEdit.react"), {
	...
	function g(e) {
		var t = o("react-compiler-runtime").c(25), n = e.currentAudienceData, a = e.adAccountID, l = e.currency, c = e.dailyBudget, d = e.legacyAccountID, p = e.selectedPublisherPlatforms, g = m(r("WAWebBizAdCreationLoggerContext")), h;
		t[0] !== a || t[1] !== l || t[2] !== n || t[3] !== c || t[4] !== d || t[5] !== p ? (h = {
			adAccountID: a,
			audienceData: n,
			currency: l,
			dailyBudget: c,
		...
		}, t[0] = a, t[1] = l, t[2] = n, t[3] = c, t[4] = d, t[5] = p, t[6] = h) : h = t[6];
		var y = r("useWAWebBizAdCreationOpenTargetingModal")(h), C;
		t[7] !== a || t[8] !== n.audienceID || t[9] !== n.audienceOption || t[10] !== g || t[11] !== y ? (C = function() {
		...
		}, t[7] = a, t[8] = n.audienceID, t[9] = n.audienceOption, t[10] = g, t[11] = y, t[12] = C) : C = t[12];
		var b = C, v;
		t[13] === Symbol.for("react.memo_cache_sentinel") ? (v = u.jsx(r("WAWebBizShimmerRows.react"), { count: 4 }), t[13] = v) : v = t[13];
		var S;
		t[14] !== n.audienceOption || t[15] !== n.targetSpec || t[16] !== d ? (S = u.jsx(o("WAWebFlex.react").FlexItem, {
			align: "stretch",
		...
		}), t[14] = n.audienceOption, t[15] = n.targetSpec, t[16] = d, t[17] = S) : S = t[17];
		var R, L;
		t[18] === Symbol.for("react.memo_cache_sentinel") ? (R = s._(
			...
			/*BTDS*/
			""
		), t[18] = R, t[19] = L) : (R = t[18], L = t[19]);
		var E;
		t[20] !== b ? (E = u.jsx(r("WDSButton.react"), {
			Icon: f,
			"aria-label": R,
			label: L,
			onPress: b,
			...
			variant: "outline",
			xstyle: _.endAddon
		}), t[20] = b, t[21] = E) : E = t[21];
		var k;
		return t[22] !== S || t[23] !== E ? (k = u.jsxs(o("WAWebFlex.react").FlexRow, {
			align: "center",
			gap: 16,
			justify: "all",
