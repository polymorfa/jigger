__d("WAWebBizAdCreationAudienceListRoot.react", [
	...
	function p(e) {
		var t = e.audienceData, n = e.lwiAudiences, o = e.savedAudiences, a = u(function() {
			if (n == null) return null;
			var e = new Map();
			Object.values(n).forEach(function(t) {
				e.set(t.audienceID, t);
			});
			var r = t.audienceID, a = o.find(function(e) {
				return e.audienceID === r;
			}), i = o.slice(0, d);
			return a != null && !i.some(function(e) {
				return e.audienceID === r;
			}) && (i = [].concat(i.slice(0, d - 1), [a])), i.length > 0 && i.forEach(function(t) {
				e.set(t.audienceID, t);
			}), e;
		}, [
			n,
		...
		return a == null ? s.jsx(m, {}) : s.jsx(r("WAWebBizAdCreationAudienceRadioGroup.react"), { audienceMap: a });
	}
