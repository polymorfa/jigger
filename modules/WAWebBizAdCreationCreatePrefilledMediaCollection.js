__d("WAWebBizAdCreationCreatePrefilledMediaCollection", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			yield a.processAttachments(n, void 0, o("WAWebBizAdCreationMediaValidationUtils").SUPPORTED_MEDIA_TYPES, o("WAWebBizAdCreationMediaValidationUtils").MAX_IMAGE_COUNT);
