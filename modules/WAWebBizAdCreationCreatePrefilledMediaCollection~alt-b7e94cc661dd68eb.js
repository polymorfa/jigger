__d("WAWebBizAdCreationCreatePrefilledMediaCollection", [
	"FBLogger",
	...
	async function e(e, t) {
		...
		await a.processAttachments(n, void 0, o("WAWebBizAdCreationMediaValidationUtils").SUPPORTED_MEDIA_TYPES, o("WAWebBizAdCreationMediaValidationUtils").MAX_IMAGE_COUNT);
		var i = a.getModelsArray().find(function(e) {
			return e.state === o("WAWebAttachMediaModel").ATTACH_MEDIA_STATE.ERROR;
		});
		if (i) throw i.exception ? i.exception : r("FBLogger")("wa_ctwa_web").mustfixThrow("createPrefilledMediaCollection: attachment failed to process");
		return a;
	}
	l.default = e;
}), 98);
