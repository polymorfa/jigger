__d("WAWebBizAdCreationCreativeDescriptionTextField.react", [
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(12), n = e.adAccountID, a = e.description, i;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (i = [r("getWAWebBizAdCreationCreativeCarouselReducer")], t[0] = i) : i = t[0];
		var l = r("useWAWebBizAdCreationSpecDispatcherContext")(i), c = m(r("WAWebBizAdCreationLoggerContext")), d = p(a != null ? a : ""), _;
		t[1] !== l ? (_ = function(t) {
			var e = t.length > o("WAWebBizAdCreationMediaValidationUtils").MAX_DESCRIPTION_LENGTH ? t.slice(0, o("WAWebBizAdCreationMediaValidationUtils").MAX_DESCRIPTION_LENGTH) : t;
			l({
				bodyText: e,
		...
		var f = _, g;
		t[3] !== n || t[4] !== a || t[5] !== c ? (g = function() {
			var e = a != null ? a : "", t = d.current;
			e !== t && (c != null && r("WAWebBizAdLogger").logCritical({
				adAccountID: n,
				event: "change_body_text",
				extra: { text_length: e.length },
				loggerContext: c
			}), d.current = e);
		}, t[3] = n, t[4] = a, t[5] = c, t[6] = g) : g = t[6];
		var h = g, y;
		...
		var C = a != null ? a : "", b;
		return t[8] !== h || t[9] !== f || t[10] !== C ? (b = u.jsx(r("WDSTextField.react"), {
			label: y,
			...
			value: C
		}), t[8] = h, t[9] = f, t[10] = C, t[11] = b) : b = t[11], b;
	}
