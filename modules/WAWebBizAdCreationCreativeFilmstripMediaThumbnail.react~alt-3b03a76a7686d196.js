__d("WAWebBizAdCreationCreativeFilmstripMediaThumbnail.react", [
	...
	function m(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.attachMedia, l = a.disabled, u = a.loading, m = a.onDeleteClick, p = a.onEditClick, _ = a.uploading, f = _ === void 0 ? !1 : _, g = d(!1), h = g[0], y = g[1], C = function(t) {
			l || p(o("WAWebStateUtils").unproxy(i), t);
		}, b = function(t) {
			l || m(o("WAWebStateUtils").unproxy(i), t);
		};
		return c.jsxs("div", {
			className: "xx42vgk xbogo7e x120ee7l x1vb5itz x6nvzda x4i4b9w xhl9efl xj65ea0 x13fuv20 x18b5jzi x1q0q8m5 x1t7ytsu x178xt8z x1lun4ml xso031l xpilrb4 x9f619 x1rg5ohu x2lah0s x6ikm8r x10wlt62 x1n2onr6 xxymvpz x1vjfegm",
			ref: n,
			"aria-busy": f,
			"aria-label": s._(
				/*BTDS*/
			...
			children: [
				...
				f ? null : c.jsxs("div", babelHelpers.extends({}, {
				...
				}[!!h << 0], { children: [c.jsx(r("WDSButton.react"), {
