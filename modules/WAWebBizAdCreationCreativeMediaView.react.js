__d("WAWebBizAdCreationCreativeMediaView.react", [
	...
	function m(e) {
		var t = o("react-compiler-runtime").c(19), a = e.mediaCollection, i = e.mediaMimeTypes, l = e.onMediaUploadComplete, c = e.onMediaUploadFailure, m = e.onRender, g = e.onSelectedMediaSave, h = e.suportedMediaTypes, y;
		t[0] !== a ? (y = function() {
		...
		var C = y, b = p, v;
		t[2] !== a || t[3] !== l || t[4] !== c || t[5] !== g ? (v = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (!b(e)) {
					c(), o("WAWebModalManager").ModalManager.closeMedia();
					return;
				}
				g(a), o("WAWebBizAdCreationStage1WAUploadUtils").uploadAdCreativeMediaToWA(a, l, c), o("WAWebModalManager").ModalManager.closeMedia();
			});
			return function(n) {
				return e.apply(this, arguments);
			};
		})(), t[2] = a, t[3] = l, t[4] = c, t[5] = g, t[6] = v) : v = t[6];
		var S = v, R;
		t[7] !== a || t[8] !== h ? (R = function(t) {
			var e = o("WAWebBizAdCreationMediaValidationUtils").maybePruneNewAttachments(a, t);
			for (var n of e.pruneActions) o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: o("WAWebBizAdCreationMediaValidationUtils").PRUNE_TOAST_MESSAGES[n]() }));
			return e.shouldClearExisting && a.reset(), a.processAttachments(e.attachments, void 0, h, o("WAWebBizAdCreationMediaValidationUtils").MAX_IMAGE_COUNT);
		}, t[7] = a, t[8] = h, t[9] = R) : R = t[9];
		var L = R, E;
		t[10] === Symbol.for("react.memo_cache_sentinel") ? (E = u.jsx("div", { className: "x1honnu5 x5yr21d x1o0tod xixxii4 x13vifvy xh8yej3 xbpklzw" }), t[10] = E) : E = t[10];
		var k;
		t[11] === Symbol.for("react.memo_cache_sentinel") ? (k = { surface: "ad-creation-flow-media-composer" }, t[11] = k) : k = t[11];
		var I;
		return t[12] !== C || t[13] !== L || t[14] !== S || t[15] !== a || t[16] !== i || t[17] !== m ? (I = u.jsxs(u.Fragment, { children: [E, u.jsx(o("WAWebFlex.react").FlexColumn, {
		...
		})] }), t[12] = C, t[13] = L, t[14] = S, t[15] = a, t[16] = i, t[17] = m, t[18] = I) : I = t[18], I;
	}
	function p(e) {
