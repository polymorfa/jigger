__d("WAWebBizAdCreationCreativeMediaView.react", [
	...
	function m(e) {
		var t = e.mediaCollection, a = e.mediaMimeTypes, i = e.onMediaUploadComplete, l = e.onMediaUploadFailure, m = e.onRender, _ = e.onSelectedMediaSave, f = e.suportedMediaTypes, g = c(function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				_(t), o("WAWebBizAdCreationStage1WAUploadUtils").uploadAdCreativeMediaToWA(t, i, l), o("WAWebModalManager").ModalManager.closeMedia();
			});
			return function(t) {
			...
			return e.shouldClearExisting && t.reset(), t.processAttachments(e.attachments, void 0, f, o("WAWebBizAdCreationMediaValidationUtils").MAX_IMAGE_COUNT);
		};
