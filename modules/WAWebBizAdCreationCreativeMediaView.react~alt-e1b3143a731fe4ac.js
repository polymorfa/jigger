__d("WAWebBizAdCreationCreativeMediaView.react", [
	...
	function m(e) {
		var t = e.mediaCollection, n = e.mediaMimeTypes, a = e.onMediaUploadComplete, i = e.onMediaUploadFailure, l = e.onRender, m = e.onSelectedMediaSave, _ = e.suportedMediaTypes, f = c(function() {
		...
		}, []), h = c(async function(e) {
			if (!g(e)) {
				i(), o("WAWebModalManager").ModalManager.closeMedia();
				return;
			}
			m(t), o("WAWebBizAdCreationStage1WAUploadUtils").uploadAdCreativeMediaToWA(t, a, i), o("WAWebModalManager").ModalManager.closeMedia();
		}, [
			g,
			a,
			i,
			...
			var e = o("WAWebBizAdCreationMediaValidationUtils").maybePruneNewAttachments(t, n);
			...
			return e.shouldClearExisting && t.reset(), t.processAttachments(e.attachments, void 0, _, o("WAWebBizAdCreationMediaValidationUtils").MAX_IMAGE_COUNT);
		};
		return u.jsxs(u.Fragment, { children: [u.jsx("div", { className: "x1honnu5 x5yr21d x1o0tod xixxii4 x13vifvy xh8yej3 xbpklzw" }), u.jsx(o("WAWebFlex.react").FlexColumn, {
			...
			children: u.jsx(o("WAWebMediaEditorLoadable.react").MediaEditorLoadable, {
				...
				tsNavigationData: { surface: "ad-creation-flow-media-composer" }
			})
		})] });
	}
