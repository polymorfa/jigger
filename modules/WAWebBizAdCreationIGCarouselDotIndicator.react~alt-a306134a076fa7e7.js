__d("WAWebBizAdCreationIGCarouselDotIndicator.react", [
	...
	function m(t) {
		var n = t.currentIndex, a = t.totalCount, i = function(t, n, r) {
			return Math.max(n, Math.min(t, r));
		}, l = Math.max(a - 3, 0), s = c(i(n - 1, 0, l)), m = s[0], p = s[1], _ = m;
		if (n > m + 2 ? _ = i(n - 2, 0, l) : n < m && (_ = i(n, 0, l)), _ !== m && p(_), a <= 1) return null;
		if (a <= 5) return u.jsx(o("WAWebFlex.react").FlexRow, {
		...
		return u.jsx(o("WAWebFlex.react").FlexRow, {
			...
			children: h.map(function(t, o) {
				var a = _ - 2 + o, i = t === "medium" ? d.dotMedium : t === "small" ? d.dotSmall : t === "hidden" ? d.dotHidden : t === "full" ? null : (function() {
					throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + t);
				})();
				return u.jsx("div", babelHelpers.extends({ "data-size": t }, (e || (e = r("stylex"))).props(d.dot, i, a === n ? d.dotSelected : d.dotUnselected)), o);
			})
		});
	}
