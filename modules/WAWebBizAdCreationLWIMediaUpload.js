__d("WAWebBizAdCreationLWIMediaUpload", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, a, i) {
			var l = e !== void 0 ? e : e = n("WAWebBizAdCreationLWIMediaUploadMutation.graphql"), s = yield o("WAWebFetchAdAccountToken").fetchToken();
			if (s.type === "success") {
				var u, c = t.map(function(e) {
					return e.fbid;
				}), d = yield o("WAWebRelayClient").commitMutation(l, {
					ad_account_id: i,
