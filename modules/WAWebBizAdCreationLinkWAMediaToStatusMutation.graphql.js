__d("WAWebBizAdCreationLinkWAMediaToStatusMutation.graphql", ["WAWebBizAdCreationLinkWAMediaToStatusMutation_facebookRelayOperation"], (function(t, n, r, o, a, i) {
	"use strict";
	var e = (function() {
		var e = [{
			defaultValue: null,
		...
		return {
			...
			params: {
				id: n("WAWebBizAdCreationLinkWAMediaToStatusMutation_facebookRelayOperation"),
				metadata: {},
				name: "WAWebBizAdCreationLinkWAMediaToStatusMutation",
