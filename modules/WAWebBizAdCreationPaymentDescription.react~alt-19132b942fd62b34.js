__d("WAWebBizAdCreationPaymentDescription.react", [
	...
	function f(e) {
		var t, a = e.openBillingWizard, i = e.paymentSectionRef, l = o("CometRelay").useFragment(p, i), s = m(r("WAWebBizAdCreationLoggerContext")), c = m(r("WAWebBizAdCreationSpecContext")), f = c == null || (t = c.currentValue) == null || (t = t.adAccountData) == null ? void 0 : t.id, g = d((function() {
		...
		return l.description == null ? null : u.jsx(o("WAWebFlex.react").FlexRow, { children: u.jsxs(r("WDSText.react"), {
