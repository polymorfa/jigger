__d("WAWebBizAdCreationSummarySection.react", [
	...
	function d() {
		...
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = u.jsx(r("WAWebBizSectionDivider.react"), {
			title: s._(
				/*BTDS*/
				""
			),
		...
		var n;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (n = u.jsx(r("WAWebBizShimmerRows.react"), {
			count: 1,
			height: 20
		}), e[1] = n) : n = e[1];
		var a, l;
		e[2] === Symbol.for("react.memo_cache_sentinel") ? (a = u.jsx(r("CometPlaceholder.react"), {
			fallback: n,
			name: i.id,
			children: u.jsx(r("WAWebBizAdCreationSummaryReachEstimationRow.react"), {})
		}), l = u.jsx(r("WAWebDivider.react"), { direction: "horizontal" }), e[2] = a, e[3] = l) : (a = e[2], l = e[3]);
		var d;
		e[4] === Symbol.for("react.memo_cache_sentinel") ? (d = u.jsx(m, {}), e[4] = d) : d = e[4];
		var p;
		return e[5] === Symbol.for("react.memo_cache_sentinel") ? (p = u.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "stretch",
	...
	function m() {
		...
		return e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = u.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "stretch",
			gap: 12,
			children: [
