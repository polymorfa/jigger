__d("WAWebBizAdCreationTargetingModalReducer", ["FBImmer", "WAWebBizAdCreationTargetingModalApplyTargetingAutomation"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e, t) {
		return o("FBImmer").produce(e, function(e) {
			switch (t.type) {
				...
				case "wa_web_biz_ad_creation_targeting_modal_reducer.update_age_range":
					t.ageRange != null ? e.age_range = t.ageRange : delete e.age_range;
					break;
				...
				case "wa_web_biz_ad_creation_targeting_modal_reducer.update_targeting_automation":
					r("WAWebBizAdCreationTargetingModalApplyTargetingAutomation")(e, t.enabled);
					break;
			}
		});
	}
