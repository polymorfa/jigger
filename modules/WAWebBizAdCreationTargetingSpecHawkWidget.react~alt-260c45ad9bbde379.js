__d("WAWebBizAdCreationTargetingSpecHawkWidget.react", [
	...
	function d(e) {
		var t = e.targetingSpec, n = c(!1), r = n[0], a = n[1], i = function() {
			a(!r);
		}, l = function(t) {
			return t == null ? "null" : typeof t == "object" ? JSON.stringify(t, null, 2) : String(t);
		}, d = function(t) {
			return t != null && typeof t == "object";
		}, m = [
			{
				label: "Age Min",
				value: t == null ? void 0 : t.age_min
			},
			{
				label: "Age Max",
				value: t == null ? void 0 : t.age_max
			},
			{
				label: "Age Range",
				value: t == null ? void 0 : t.age_range
			},
			{
				label: "Connections",
				value: t == null ? void 0 : t.connections
			},
			{
			...
			{
				label: "Exclusions",
				value: t == null ? void 0 : t.exclusions
			},
			{
				label: "Flexible Spec",
		...
		return u.jsxs("div", {
			className: "x1h3rtpe xx42vgk xbogo7e x120ee7l x1vb5itz xyi3aci xwf5gio x1p453bz x1suzm8a x13fuv20 x18b5jzi x1q0q8m5 x1t7ytsu x178xt8z x1lun4ml xso031l xpilrb4 x1phlbz0 xt7fyls x6ikm8r x10wlt62",
			children: [u.jsx("div", {
				...
				children: u.jsx("div", {
					...
					children: m.map(function(e, t) {
						...
						}[(t === m.length - 1) << 0], { children: u.jsxs(o("WAWebFlex.react").FlexRow, {
							align: "start",
							justify: "all",
							children: [u.jsx("div", {
