__d("WAWebBizAdCreationValidateSpecContextProviderQuery.graphql", ["WAWebBizAdCreationValidateSpecContextProviderQuery_facebookRelayOperation"], (function(t, n, r, o, a, i) {
	"use strict";
	var e = (function() {
		var e = [
			{
		...
		return {
			...
			params: {
				id: n("WAWebBizAdCreationValidateSpecContextProviderQuery_facebookRelayOperation"),
				metadata: {},
				name: "WAWebBizAdCreationValidateSpecContextProviderQuery",
				operationKind: "query",
				text: null
