__d("WAWebBizAdLogger", ["WAWebBizAdLoggerUtils", "requireDeferred"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = r("requireDeferred")("BoostedComponentFalcoEvent").__setRef("WAWebBizAdLogger"), s = {
		buildFalcoEvent: function(t) {
			var e, n, r, a, i, l = t.loggerContext;
			return {
				action: t.action,
				ad_account_id: (i = o("WAWebBizAdLoggerUtils")).toInt64(t.adAccountID),
				audience_id: i.toInt64(t.audienceID),
				budget_in_local: i.toInt64(t.budget),
				budget_type: i.budgetTypeToAdmanagerCampaignBudgetType((e = t.budgetType) != null ? e : "DAILY_BUDGET"),
				codebase: l == null ? void 0 : l.codebase,
				context: t.context,
				creative_spec: (n = t.creativeSpec) != null ? n : null,
				currency: t.currency,
				default_budget_in_local: o("WAWebBizAdLoggerUtils").toInt64(t.defaultBudget),
				default_duration_in_days: o("WAWebBizAdLoggerUtils").toInt64(t.defaultDuration),
				...
				extra_data: o("WAWebBizAdLoggerUtils").convertExtraData((l == null ? void 0 : l.recreateBoostId) != null ? babelHelpers.extends({}, (r = t.extra) != null ? r : {}, { recreate_ad_boost_id: l.recreateBoostId }) : t.extra),
		...
		buildValidationNoticeImpressionEvent: function(t) {
			...
			return {
				...
				extra_data: o("WAWebBizAdLoggerUtils").convertExtraData(babelHelpers.extends({}, (e = t.extra) != null ? e : {}, {
		...
		logImmediately: function(n) {
			e.onReady(function(e) {
				var t = s.buildFalcoEvent(n);
				t != null && e.logImmediately(function() {
					return t;
				});
			});
		},
