__d("WAWebBizAiChatHistoryFastSync", [
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			for (var i = yield o("WAWebDBMsgUtils").getMsgsByChatId(n), l = [], c = 0, p = i.length - 1; p >= 0; p--) {
				var h, y, C = i[p];
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var t = yield o("WAWebApiChat").getAllChatsDeserialized(), n = Math.floor(Date.now() / 1e3) - e, r = t.filter(function(e) {
