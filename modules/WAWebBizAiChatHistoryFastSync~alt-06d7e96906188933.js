__d("WAWebBizAiChatHistoryFastSync", [
	"WAWebApiChat",
	...
	var e = 7776e3, s = 200, u = 1e6, c = 1e6, d = new TextEncoder(), m = new Set([].concat(o("WAWebMsgType").SYSTEM_MESSAGE_TYPES, ["revoked", "ciphertext"])), p = {
		chat: "TEXT",
		image: "IMAGE",
		audio: "VOICE",
		ptt: "VOICE",
	...
	function g(e) {
		var t, n;
		if (e.isGroup() || e.server === "broadcast" || e.server === "bot") return null;
		var r = e.isLid() ? e.user : (t = o("WAWebLidMigrationUtils").toLid(e)) == null ? void 0 : t.user, a = e.server === "c.us" ? e.user : (n = o("WAWebLidMigrationUtils").toPn(e)) == null ? void 0 : n.user;
	...
	async function h(e, t) {
		...
		for (var i = await o("WAWebDBMsgUtils").getMsgsByChatId(n), l = [], c = 0, p = i.length - 1; p >= 0; p--) {
			var h, y, C = i[p];
		...
		return l.length === 0 ? null : (l.reverse(), {
			thread: {
				consumer_uid: a,
				messages: l
			},
	...
	async function y() {
		var t = await o("WAWebApiChat").getAllChatsDeserialized(), n = Math.floor(Date.now() / 1e3) - e, r = t.filter(function(e) {
