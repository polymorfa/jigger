__d("WAWebBizAiComponentInteractionWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumBizAiAssetMaterializationFailureType",
	"WAWebWamEnumBizAiRenderOutcomeType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ BizAiComponentInteraction: [
		8490,
		{
			bizAiAssetMaterializationAssetId: [5, e.TYPES.STRING],
			bizAiAssetMaterializationAssetType: [6, e.TYPES.STRING],
			bizAiAssetMaterializationFailureType: [7, o("WAWebWamEnumBizAiAssetMaterializationFailureType").BIZ_AI_ASSET_MATERIALIZATION_FAILURE_TYPE],
			...
			bizAiRenderOutcome: [4, o("WAWebWamEnumBizAiRenderOutcomeType").BIZ_AI_RENDER_OUTCOME_TYPE]
		},
		[
			1,
			1,
