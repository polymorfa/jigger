__d("WAWebBizAiPluginsForSurfaceQuery.graphql", ["WAWebBizAiPluginsForSurfaceQuery_facebookRelayOperation"], (function(t, n, r, o, a, i) {
	"use strict";
	var e = (function() {
		var e = [{
			kind: "Literal",
		...
		return {
			fragment: {
				...
				selections: [{
					...
					storageKey: "meta_ai_biz_agent_wa_plugins_for_surface(surface:\"WHATSAPP\")"
				}],
				type: "Query",
				abstractKey: null
			},
