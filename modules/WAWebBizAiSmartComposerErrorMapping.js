__d("WAWebBizAiSmartComposerErrorMapping", [], (function(t, n, r, o, a, i) {
	var e = new Map([
	...
	i.mapSuggestedReplyErrorToState = s, i.isAutoRetryableSuggestedReplyError = u, i.normalizeSuggestedReplyErrorCode = c;
}), 66);
