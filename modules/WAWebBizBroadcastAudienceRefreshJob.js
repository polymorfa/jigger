	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (o("WAWebABProps").getABPropConfigValue("m2_audience_dynamic_rules")) {
				var t = yield o("WAWebSchemaBroadcastMetadata").getBroadcastMetadataTable().all(), a = t.filter(function(e) {
					var t;
				...
				if (a.length !== 0) {
					...
					yield (u || (u = n("Promise"))).all(a.map((function() {
						var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
							try {
								var n = yield o("WAWebAudienceResolver").resolveAudienceExpression(t.audienceExpression), a = t.recipients;
								if (d(a, n)) return;
								yield o("WAWebSchemaBroadcastMetadata").getBroadcastMetadataTable().createOrReplace(babelHelpers.extends({}, t, { recipients: n })), i++;
								var s = new Set(a), u = new Set(n), m = r("countWhere")(n, function(e) {
									return !s.has(e);
								...
								new (o("WAWebAudienceManagementWamEvent")).AudienceManagementWamEvent({
									...
									audiencePredicateType: t.audienceExpression.type === o("WAWebAudienceExpressionTypes").EXPRESSION_TYPE_PREDICATE ? c(t.audienceExpression.predicateType) : o("WAWebWamEnumAudiencePredicateTypeEnum").AUDIENCE_PREDICATE_TYPE_ENUM.UNKNOWN,
									audienceResolutionTrigger: o("WAWebWamEnumAudienceResolutionTriggerType").AUDIENCE_RESOLUTION_TRIGGER_TYPE.PERIODIC_REFRESH
								}).commit();
							} catch (n) {
								l++, o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose([
						...
						" errors=",
						""
					])), a.length, i, l).tags("wa-smb", "business-broadcast", "audience-refresh"), new (o("WAWebAudienceManagementWamEvent")).AudienceManagementWamEvent({
						audienceExtraData: JSON.stringify({
