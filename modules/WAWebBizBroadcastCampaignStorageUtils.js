__d("WAWebBizBroadcastCampaignStorageUtils", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = o("WAWebSchemaBusinessBroadcastCampaign").getBusinessBroadcastCampaignTable(), a = yield n.get(e);
			...
			if (i) {
				if (t != null) {
					var l = yield n.get(t);
					l != null && !o("WAWebValidationUtils").validateUUID(l.campaignId) && (yield y(l.campaignId));
				}
				return {
					action: "merge",
					existing: a
			...
			var s = yield _(e);
			return s != null ? (a != null && (yield y(e)), { action: "skip" }) : {
				action: "merge",
				existing: a
			};
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = o("WAWebSchemaBusinessBroadcastCampaign").getBusinessBroadcastCampaignTable(), r = o("WAWebSchemaBusinessBroadcastCampaign").canUseAdIdIndex() ? yield n.equals(["adId"], e) : (yield n.all()).filter(function(t) {
				return t.adId === e;
			});
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, a) {
			...
			try {
				var c, d, p, _, f, g, h, y, C, b, v, S, R, L = yield m(t, n.adId);
				if (L.action === "skip") {
					o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[broadcast:campaign-storage] skip adId-keyed ", ", UUID exists"])), t);
					return;
				}
				var E = L.existing;
				yield o("WAWebSchemaBusinessBroadcastCampaign").getBusinessBroadcastCampaignTable().createOrReplace({
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			try {
				yield o("WAWebSchemaBusinessBroadcastCampaign").getBusinessBroadcastCampaignTable().remove(e);
			} catch (t) {
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, r) {
			yield o("WAWebSyncdCoreApi").lockForSync(["biz-broadcast-campaigns"], r, (function() {
				var r = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
					var r = n[0], o = yield r.get(e);
					o != null ? yield r.createOrReplace(babelHelpers.extends({}, o, t)) : yield r.create(babelHelpers.extends({ campaignId: e }, t));
				});
				return function(e) {
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			yield o("WAWebSyncdCoreApi").lockForSync(["biz-broadcast-campaigns"], t, (function() {
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield o("WAWebSchemaBusinessBroadcastCampaign").getBusinessBroadcastCampaignTable().get(e);
			(t == null ? void 0 : t.pendingBroadcastMessageId) != null && (yield o("WAWebSchemaPendingBusinessBroadcastMessage").getPendingBusinessBroadcastMessageTable().remove(t.pendingBroadcastMessageId));
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n, r, a, i, l, s = yield o("WAWebSchemaBusinessBroadcastCampaign").getBusinessBroadcastCampaignTable().get(e);
			if (s != null) {
	...
	l.upsertCampaignStorage = g, l.removeCampaignStorage = y, l.updateCampaignWithSync = b, l.removeCampaignWithSync = S, l.cleanupPendingCampaignData = L, l.updateCampaignStatusWithSync = k;
}), 98);
