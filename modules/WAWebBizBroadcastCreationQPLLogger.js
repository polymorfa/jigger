__d("WAWebBizBroadcastCreationQPLLogger", [
	"$InternalEnum",
	"WAWebQplFlowWrapper",
	"qpl"
	...
	}), u = r("qpl")._(183054996, "1362"), c = "web", d = (function() {
		function e() {
			this.$1 = null, this.$2 = new Set();
		}
		var t = e.prototype;
		return t.start = function(t, n) {
			this.$1 != null && this.$1.drop(), this.$2 = new Set(), this.$1 = o("WAWebQplFlowWrapper").QPL.markerStart(u, { annotations: {
			...
			this.$1 != null && (this.$1.end(t), this.$1 = null, this.$2 = new Set());
		}, t.drop = function() {
			this.$1 != null && (this.$1.drop(), this.$1 = null, this.$2 = new Set());
		}, e;
	})(), m = new d();
	l.CreateBroadcastQPLPoints = e, l.CreateBroadcastEntryPoint = s, l.BizBroadcastCreationQPLLogger = m;
}), 98);
