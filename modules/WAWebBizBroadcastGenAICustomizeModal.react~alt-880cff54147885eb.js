__d("WAWebBizBroadcastGenAICustomizeModal.react", [
	...
	function f(e) {
		var t = e.followUps, n = e.numAiSuggestions, a = e.onAuthFailure, i = e.onBack, l = e.onUseMessage, c = e.selectedSuggestion, f = r("WAWebL10N").isRTL(), h = t.length > 0 ? t : o("WAWebBizBroadcastGenAIRecommendationModel").DEFAULT_REFINEMENT_CHIPS, y = _(function() {
			return o("WAWebBizBroadcastGenAIRecommendationModel").createRefinementHistory(c.message);
		}), C = y[0], b = y[1], v = _(""), S = v[0], R = v[1], L = _(!1), E = L[0], k = L[1];
		m(function() {
			o("WAWebBizBroadcastGenAIQPLLogger").qplGenAIAnnotate({ string: { tone: c.tone } }), o("WAWebBizBroadcastGenAIQPLLogger").qplGenAIPoint(o("WAWebBizBroadcastGenAIQPLLogger").GenAIQPLPoints.CUSTOMIZE_OPEN), o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.genAICustomizeOpened(n);
		}, [n, c.tone]);
		var I = p(!1), T = p(C);
		m(function() {
			T.current = C;
		...
		var D = d(function(e) {
			...
			R(e), I.current = !0, o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.genAIChipTapped(e);
		}, []), $ = d(function(e) {
			R(e), I.current = !1;
		}, []), P = d(async function() {
			var e = S.trim();
			if (!(e.length === 0 || E)) {
				var t = I.current ? "chip" : "custom";
				...
				var n = T.current.entries.length;
				o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.genAIRefinementSubmitted(t, o("WAWebBizBroadcastGenAIGating").getGenAIModel(), n), k(!0), o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.genAIRefinementLoading();
				var r = Date.now();
				try {
					var i, l = o("WAWebBizBroadcastGenAIRecommendationModel").getCurrentEntry(T.current).message, s = await o("WAWebBizBroadcastGenAIRecommendationJob").fetchBroadcastGenAIRecommendation({
						model: o("WAWebBizBroadcastGenAIGating").getGenAIModel(),
						userMessageDraft: l,
						userPrompt: e
					});
					if (s.type === "auth-failure") {
						o("WAWebBizBroadcastGenAIQPLLogger").qplGenAIAnnotate({ string: { error_type: "auth_failure" } }), o("WAWebBizBroadcastGenAIQPLLogger").qplGenAIPoint(o("WAWebBizBroadcastGenAIQPLLogger").GenAIQPLPoints.REFINEMENT_ERROR), o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.genAIRefinementFailed("auth_failure"), a();
						return;
					}
					...
					var m = (i = s.toneMessagePairs[0].message) != null ? i : "";
					o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.genAIRefinementCompleted(d), b(function(t) {
			...
			var e = T.current, t = e.entries.length - 1;
			o("WAWebBizBroadcastGenAIQPLLogger").qplGenAIAnnotate({ int: { refinement_count: t } }), o("WAWebBizBroadcastGenAIQPLLogger").qplGenAIPoint(o("WAWebBizBroadcastGenAIQPLLogger").GenAIQPLPoints.CUSTOMIZE_BACK), o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.genAICustomizeBack(t), i();
		}, [i]), M = d(function() {
			var e = T.current, t = o("WAWebBizBroadcastGenAIRecommendationModel").getCurrentEntry(e).message, n = e.entries.length - 1, r = e.currentIndex;
			o("WAWebBizBroadcastGenAIQPLLogger").qplGenAIAnnotate({ int: {
				card_index: r,
				refinement_count: n
			} }), o("WAWebBizBroadcastGenAIQPLLogger").qplGenAIPoint(o("WAWebBizBroadcastGenAIQPLLogger").GenAIQPLPoints.CUSTOMIZE_USE_MESSAGE), o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.genAICustomizeUseMessage(n, r, r === 0), l(t);
		}, [l]);
		return u.jsxs(o("WAWebFlex.react").FlexColumn, {
			...
			children: [
				...
				}[!!E << 0], { children: u.jsx(r("WAWebBizBroadcastGenAIChips.react"), {
					chips: h,
					disabled: E,
					onChipTap: x
				}) })),
				u.jsxs(o("WAWebFlex.react").FlexRow, {
					align: "center",
					xstyle: [g.inputSection, E && g.dimmed],
					children: [u.jsx(o("WAWebFlex.react").FlexItem, {
						...
						disabled: S.trim().length === 0 || E,
						onPress: function() {
							P();
						},
						size: "small",
						variant: "outline",
						xstyle: S.trim().length === 0 || E ? g.sendButton : [g.sendButton, g.sendButtonActive]
					})]
				}),
