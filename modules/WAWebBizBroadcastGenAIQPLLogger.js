__d("WAWebBizBroadcastGenAIQPLLogger", [
	"$InternalEnum",
	"WAWebQplFlowWrapper",
	"qpl"
	...
	function u(e) {
		o("WAWebQplFlowWrapper").QPL.markerStart(s, e != null ? { annotations: e } : void 0);
	}
	function c(e) {
	...
	l.GenAIQPLPoints = e, l.qplGenAIStart = u, l.qplGenAIPoint = c, l.qplGenAIAnnotate = d, l.qplGenAIEnd = m, l.qplGenAIDrop = p;
}), 98);
