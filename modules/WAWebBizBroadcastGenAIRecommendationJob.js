__d("WAWebBizBroadcastGenAIRecommendationJob", [
	"WALogger",
	...
	var e, s, u = e !== void 0 ? e : e = n("WAWebBizBroadcastGenAIRecommendationJobQuery.graphql");
	function c(e) {
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var n = t.token;
			try {
				var a = yield o("WAWebRelayClient").fetchQuery(u, { data: {
					actor_id: n.bp_id,
					model: e.model,
				...
				return o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[broadcast:genai] failed with error"]))), e instanceof o("WAWebGraphQLServerError").GraphQLServerError ? {
					error: e,
					type: "graphql-error"
				} : { type: "error" };
			}
	...
	function m(e) {
		var t = e == null ? void 0 : e.xwa_business_broadcast_genai_recommendation, n = t == null ? void 0 : t.response;
		if (n == null) return { type: "error" };
		if (n.tone_message_pair != null) {
			var r, o = [], a = n.tone_message_pair;
			for (var i of a) i != null && o.push({
				message: i.message,
				tone: i.tone
			});
			return {
