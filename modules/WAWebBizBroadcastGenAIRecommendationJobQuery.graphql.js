__d("WAWebBizBroadcastGenAIRecommendationJobQuery.graphql", ["WAWebBizBroadcastGenAIRecommendationJobQuery_facebookRelayOperation"], (function(t, n, r, o, a, i) {
	"use strict";
	var e = (function() {
		var e = [{
			defaultValue: null,
		...
		return {
			fragment: {
				...
				selections: [{
					alias: null,
					args: t,
					concreteType: "XWAWhatsAppBusinessBroadcastGenAIRecommendationResponse",
					kind: "LinkedField",
			...
			params: {
				id: n("WAWebBizBroadcastGenAIRecommendationJobQuery_facebookRelayOperation"),
				metadata: {},
				name: "WAWebBizBroadcastGenAIRecommendationJobQuery",
				operationKind: "query",
				text: null
