__d("WAWebBizBroadcastGenAISuggestionsModal.react", [
	...
	function g(e) {
		var t = e.broadcastJids, n = e.draftMessage, a = e.onAuthFailure, i = e.onBack, l = e.onClose, c = e.onUseMessage, f = _({ type: "loading" }), g = f[0], y = f[1], v = _(-1), S = v[0], R = v[1], L = p(-1), E = p(0), k = p(0), I = p(!1), T = d(async function() {
			y({ type: "loading" }), R(-1), L.current = -1, E.current = Date.now();
			try {
