__d("WAWebBizBroadcastNewBroadcastDrawer.react", [
	...
	function b(e) {
		var t, n = o("react-compiler-runtime").c(15), r = e.entryPoint, a = e.onBack, i = e.onOpenExistingAudiences, l = e.onOpenImportAudience, s = e.onOpenUpsertAudience, u = e.onSendSuccess, c = e.onSuggestedAudiencePress, d = e.ref, p = e.selectedCardIds, _ = e.selectedChats, f = e.setSelectedChats, g = e.sourceBroadcastMessageData, h = e.title, y = (t = g == null ? void 0 : g.campaignId) != null ? t : "new", C;
		return n[0] !== r || n[1] !== a || n[2] !== i || n[3] !== l || n[4] !== s || n[5] !== u || n[6] !== c || n[7] !== d || n[8] !== p || n[9] !== _ || n[10] !== f || n[11] !== g || n[12] !== y || n[13] !== h ? (C = m.jsx(o("WAWebBizBroadcastBusinessInfoContext.react").WAWebBizBroadcastBusinessInfoProvider, { children: m.jsx(v, {
			sourceBroadcastMessageData: g,
			entryPoint: r,
			innerRef: d,
			onBack: a,
			onOpenExistingAudiences: i,
			onOpenImportAudience: l,
			onOpenUpsertAudience: s,
			onSendSuccess: u,
			...
			setSelectedChats: f,
			title: h
		}, y) }), n[0] = r, n[1] = a, n[2] = i, n[3] = l, n[4] = s, n[5] = u, n[6] = c, n[7] = d, n[8] = p, n[9] = _, n[10] = f, n[11] = g, n[12] = y, n[13] = h, n[14] = C) : C = n[14], C;
	}
	function v(t) {
