__d("WAWebBizBroadcastsDialog.react", [
	...
	function d(e) {
		var t = e.children, n = e.onClose, a = e.primaryAction, i = e.testid, l = i === void 0 ? "biz-broadcasts-dialog" : i, d = e.title;
		return s.jsxs(r("WAWebDrawer.react"), {
			testid: l,
			tsNavigationData: u,
			xstyle: c.container,
			children: [s.jsxs("header", {
				className: "x6s0dn4 x78zum5 x1q0g3np x2lah0s x8a3fw1 x1aj3ljl x1peatla x1nhvcw1 xexx8yu x18d9i69 x1iw51ew xde1mab",
				children: [
