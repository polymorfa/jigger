__d("WAWebBizBroadcastsDocumentPreview.react", [
	...
	function c(e) {
		var t = e.documentData, n = t.fileExt, a = t.fileName, i = t.mimetype, l = t.previewUrl, c = i === "application/pdf";
			...
			children: s.jsxs(o("WAWebFlex.react").FlexColumn, {
				...
				children: [c && l != null && s.jsx("img", {
					...
					children: [s.jsxs(o("WAWebFlex.react").FlexRow, {
						...
						grow: 1,
						children: s.jsx(r("WAWebBizBroadcastsDocumentPreviewMetadata.react"), { documentData: t })
					})]
				})]
			})
		});
