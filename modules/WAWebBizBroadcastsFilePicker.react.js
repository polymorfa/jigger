__d("WAWebBizBroadcastsFilePicker.react", [
	...
	function d(t) {
		var a = t.acceptTypes, i = t.buttonText, l = t.entryPoint, s = t.onFileSelected, d = t.testid, m = c(null), p = function() {
			var e;
			o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.fileUploadClicked(l), (e = m.current) == null || e.open();
		}, _ = function(r) {
			var t = r.target.files[0];
			t && n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.fileOpenClicked(l), yield s(t);
				} catch (t) {
