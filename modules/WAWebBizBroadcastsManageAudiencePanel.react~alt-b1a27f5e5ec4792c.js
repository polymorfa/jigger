__d("WAWebBizBroadcastsManageAudiencePanel.react", [
	...
	function _(e) {
		var t = e.entryPoint, n = e.errorList, a = e.importLoggingContext, i = e.validContactsData, l = m(o("WAWebBizBroadcastsDrawerReducer").reducer, {
			errorList: n,
			validContactsData: i
		}), c = l[0], _ = l[1];
		d(function() {
			o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.importedContactWizardViewed({
				...
				num_total_contacts: i.length + n.length
			}, t);
		}, [
			t,
			i,
		...
		}), g = f[0], h = f[1], y = p(null), C = y[0], b = y[1], v = c.errorList, S = c.validContactsData;
		function R() {
			C == null ? o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.importedContactWizardCancelClicked(t) : o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.contactImportSuccessCancelClicked(t), o("WAWebDrawerManager").DrawerManager.closeDrawerMid();
		}
		var L;
		C != null ? L = u.jsx(r("WAWebBizBroadcastsManageAudienceListCreationSuccessPanel.react"), {
			broadcastListName: C.name,
			broadcastListRecipientCount: C.recipientCount
		}) : L = u.jsxs(u.Fragment, { children: [u.jsx("div", {
			...
			children: [u.jsx(r("WAWebBizBroadcastsErrorDetailsSection.react"), {
				...
				onDeleteErrorItem: function(n) {
					o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.errorContactDeleteClicked(t), _({
						payload: { errorItem: n },
						type: "DELETE_ERROR_ITEM"
					});
				},
				onDeleteAllErrorItems: function() {
					o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.allErrorContactsDeleteClicked(t), _({ type: "DELETE_ALL_ERROR_ITEMS" });
				},
				onUpdateContact: function(n, r) {
					o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.errorContactEditClicked(t), _({
						payload: {
							editedContact: n,
							originalIndex: r
						},
				...
				actions: function(n) {
					return u.jsx(r("WDSButton.react"), {
						...
						onPress: function() {
							o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.contactDeleteClicked(t), _({
								payload: { contact: n },
								type: "DELETE_CONTACT"
							});
						}
		...
		var E = v.length > 0 || g.length === 0 || g.length > o("WAWebBizBroadcastsAudienceUtils").MAX_AUDIENCE_NAME_LENGTH;
		return u.jsx(r("WAWebBizBroadcastsDialog.react"), {
			...
			primaryAction: C == null && u.jsx(r("WDSTooltip.react"), {
				disabled: !E,
				label: s._(
					/*BTDS*/
					""
				...
				children: u.jsx(r("WDSButton.react"), {
					...
					onPress: function() {
						var e = function(n) {
							b(n), o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.contactImportSuccessViewed({
						...
						(async function() {
							try {
								...
								o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.importAudienceSaveResult(S.length, "success", void 0, t, o("WAWebBizBroadcastsImportLoggingUtils").getImportAudienceSuccessLoggingExtraAttributes(a, {
									audienceCount: 1,
								...
								var i = e instanceof Error ? e.message : "unknown";
								o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.importAudienceSaveResult(S.length, "failure", i, t, o("WAWebBizBroadcastsImportLoggingUtils").getImportAudienceLoggingExtraAttributes(a));
							}
						})();
					},
