__d("WAWebBizBroadcastsMessageDocumentSection.react", [
	...
	function p(e) {
		var t = e.entryPoint, n = e.onRemoveMedia, a = e.selectedDocumentData, i = a.fileExt, l = a.fileName, u = a.mimetype, p = d(!1), _ = p[0], f = p[1], g = c(function() {
			f(!0);
		}, []), h = c(function() {
			f(!1);
		}, []), y = c(function() {
		...
		return s.jsx(o("WAWebErrorBoundary.react").ErrorBoundary, {
			...
			children: s.jsxs("div", babelHelpers.extends({ role: "group" }, {
				...
				children: [s.jsxs(o("WAWebFlex.react").FlexRow, {
					...
					children: [s.jsx("div", babelHelpers.extends({}, {
					...
					}[!!_ << 0], { children: s.jsx(r("WAWebDocumentFileIcon"), {
						width: 24,
						mimeType: u,
						ext: i != null ? i : ""
						...
						children: [s.jsx(r("WDSText.react"), {
							...
							children: l
						}), s.jsx(r("WAWebBizBroadcastsDocumentPreviewMetadata.react"), { documentData: a })]
					})]
					...
					children: [s.jsx(r("WDSButton.react"), {
						...
						onPress: function() {
							o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.attachmentPreviewButtonClicked(t, o("WAWebBBLoggerTypes").UserActionTarget.ATTACHMENT_DOCUMENT_PREVIEW_BUTTON, a.fileExt, a.fileSize), y();
						},
						...
						onPress: function() {
							o("WAWebBusinessBroadcastUserJourneyLogger").BusinessBroadcastUserJourneyLogger.attachmentRemoveButtonClicked(t, o("WAWebBBLoggerTypes").UserActionTarget.ATTACHMENT_DOCUMENT_REMOVE_BUTTON, a.fileExt, a.fileSize), n();
						},
