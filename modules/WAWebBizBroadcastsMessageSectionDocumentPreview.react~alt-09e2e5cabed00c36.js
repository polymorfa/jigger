__d("WAWebBizBroadcastsMessageSectionDocumentPreview.react", [
	...
	function c(e) {
		var t = e.onClose, n = e.onRemoveMedia, a = e.selectedDocumentData, i = a.previewUrl;
		return s.jsx(o("WAWebFlex.react").FlexColumn, {
			xstyle: u.documentModalContainer,
			children: s.jsxs(o("WAWebFlex.react").FlexColumn, {
				grow: 1,
				className: "x1280gxy x1vb5itz x1t7ytsu xpilrb4 xhslqc4 x1r8uery x1iyjqo2 xs83m0k x5yr21d x1bifzbx x1htk8sl xh8yej3",
				align: "stretch",
				children: [o("WAWebMimeTypes").previewType(a.mimetype) === "pdf" && i != null ? s.jsx(r("WAWebMediaEditorPreviewPdf.react"), {
					...
					children: s.jsx(r("WDSButton.react"), {
						...
						size: "medium",
						type: "destructive",
						label: o("WAWebBizBroadcastsCreationStrings").getDocumentPreviewRemoveDocumentLabel(),
						onPress: function() {
							n(), t();
						}
					})
