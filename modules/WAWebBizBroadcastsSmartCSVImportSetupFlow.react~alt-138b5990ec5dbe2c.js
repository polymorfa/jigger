__d("WAWebBizBroadcastsSmartCSVImportSetupFlow.react", [
	...
	function f(e) {
		var t = e.config, n = e.maxContactsPerAudience, a = e.onBack, i = function(n) {
			n.length !== 0 && (o("WAWebModalManager").ModalManager.close(), t.onReviewAudiences(n));
		};
		return s.jsx(r("WAWebBizBroadcastsSmartCSVImportSegmentAudienceScreen.react"), {
			contacts: t.contacts,
			context: t.context,
			errorList: t.errorList,
			maxContactsPerAudience: n,
			onBack: a,
			onContinue: i,
			onSkip: function() {
				o("WAWebModalManager").ModalManager.close(), t.onReviewAudience(t.contacts, t.errorList);
			}
		});
	}
