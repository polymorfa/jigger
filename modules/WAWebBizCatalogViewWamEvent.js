__d("WAWebBizCatalogViewWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ BizCatalogView: [
		3006,
		{
			...
			catalogEntryPoint: [2, o("WAWebWamEnumCatalogEntryPoint").CATALOG_ENTRY_POINT],
			...
			catalogViewAction: [1, o("WAWebWamEnumCatalogViewAction").CATALOG_VIEW_ACTION],
			collectionId: [15, e.TYPES.STRING],
			collectionIndex: [16, e.TYPES.STRING],
			deepLinkOpenFrom: [12, o("WAWebWamEnumDeepLinkOpenFrom").DEEP_LINK_OPEN_FROM],
			entryPointConversationInitiated: [22, o("WAWebWamEnumEntryPointConversationInitiated").ENTRY_POINT_CONVERSATION_INITIATED],
