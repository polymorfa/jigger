__d("WAWebBizChatAssignmentModal.react", [
	...
	function C() {
		...
		return e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = c.jsx(r("WAWebFlexItem.react"), { grow: 1 }), e[0] = t) : t = e[0], t;
	}
	var b = r("qpl")._(701185297, "3420"), v = r("qpl")._(701183376, "3423");
	function S(t) {
		var a = t.chats, i = t.entryPoint, l = t.onSave, u = function() {
		...
		var S = function() {
			var e = f.get(a[0].id.toString()), t = !0;
		...
		}, R = p(S().commonlyAssignedAgentId), L = R[0], E = R[1], k = p(h()), I = k[0], T = k[1];
		...
		var D = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					o("WAWebQplFlowWrapper").QPL.markerStart(b, { annotations: { int: { chats_count: a.length } } }), yield o("WAWebBizChatAssignmentAction").changeChatAssignment(a.map(function(e) {
						return {
							agentId: L,
							chat: e
						};
					}), i), o("WAWebQplFlowWrapper").QPL.markerEnd(b, 2), l == null || l();
				} catch (t) {
			...
			var e = S(), t = e.areAllChatsUnassigned, n = e.commonlyAssignedAgentId;
