__d("WAWebBizCreateProductInquiry", [
	"WATimeUtils",
	"WAWebAck",
	...
	function e(e) {
		var t = e.catalogWid, n = e.chatId, a = e.mediaData, i = e.product, l = e.sessionId, s = {
			...
			body: a.preview instanceof r("WAWebMediaOpaqueData") ? a.preview.getBase64() : null,
			currencyCode: i.currency,
			priceAmount1000: i.priceAmount1000,
			salePriceAmount1000: o("WAWebProductSelectors").isSalePriceActive(i) ? i.salePriceAmount1000 : null,
			sessionId: l,
