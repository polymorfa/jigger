__d("WAWebBizEditProductFlow", [
	...
	function f(e) {
		var t = e.catalog, n = e.newProduct, a = e.onCreate, i = e.onDelete, l = p(e.product), c = l[0], f = l[1], g = function(n) {
			var e = t.productCollection.get(n);
			e != null ? f(e) : t.getCollection().findProduct({
				catalogWid: t.id,
				productId: n.toString()
			}).then(function() {
				var e = t.productCollection.get(n);
				e && f(e);
			}).catch(function(e) {
		...
		}, h = o("useWAWebFlow").useFlow(n ? _.EditNewProduct : _.ProductInfo), y = h[0], C = h[1], b = d(function(e) {
			c.id === e.id && o("WAWebDrawerManager").DrawerManager.closeDrawerMid(), i == null || i();
		}, [i, c.id]);
		m(function() {
			return t.productCollection.on("remove", b), function() {
				return void t.productCollection.off("remove", b);
			};
		}, [b, t.productCollection]);
		var v = function() {
			o("WAWebUtilsLogQplEvents").qplStartProductView("EditProduct"), C.push(_.ProductInfo);
		}, S = function() {
