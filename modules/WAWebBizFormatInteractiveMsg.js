__d("WAWebBizFormatInteractiveMsg", [
	"fbt",
	...
	function e(e, t) {
		var n, o, a = t === void 0 ? {} : t, i = a.formatAsSearchResult, l = i === void 0 ? !1 : i;
		if (e.interactiveType === r("WAWebInteractiveMessageType").SHOPS_STOREFRONT) {
			var s;
			return e.caption || ((s = e.interactiveHeader) == null ? void 0 : s.title) || "";
		}
		...
		if (e.nativeFlowName === r("WAWebInteractiveMessagesNativeFlowName").ORDER_STATUS) {
			var _ = c(e);
			if (_ != null) return _;
		}
		var f = [
		...
		if (f === "") {
			var g, h;
			return (g = (h = e.bloksWidget) == null ? void 0 : h.fallback) != null ? g : "";
		}
		return f;
	}
	function u(e) {
	...
	function c(e) {
		...
		if (r != null) {
			var a = u(n).toString(), i = e.caption, l = o("WAWebGetInteractiveFooterText").getInteractiveFooterText(e), c = s._(
				/*BTDS*/
				"",
	...
	function d(e) {
		...
		if (o("WAWebOrderStatus").hasOrderStatusButton(e)) {
			var r = u(n).toString(), a = e.caption;
	...
	function m(e) {
		...
		if (t == null) return null;
		var n = t.currency, r = t.items, a = t.totalAmount, i = o("WAWebCurrencyUtils").formatAmount({
			amount: a,
			currency: n
		});
		return r.length !== 0 ? r[0].name + " · " + i : i;
	}
	function p(e) {
		var t, n, r, a = o("WAWebOrderDetails").getOrderInfo(e);
		if (a == null) return null;
		var i = a.paymentSettings, l = s._(
			/*BTDS*/
			""
		), u = i == null || (t = i.at(0)) == null ? void 0 : t[o("WAWebBizOrderDetailsParams").PaymentSettingType.PIX_STATIC_CODE], c = (n = u == null ? void 0 : u.merchant_name) != null ? n : "", d = (r = u == null ? void 0 : u.key) != null ? r : "", m = o("WAWebUserPrefsTypes").PixKeyType.cast(u == null ? void 0 : u.key_type);
		return c + " · " + l.toString() + ": " + o("WAWebBrazilPixKeyFormattingUtils").getFormattedPixKey(d, m);
	}
	function _(e) {
		var t = o("WAWebOrderPaymentStatus").getOrderPaymentStatusInfoFromNativeFlow(e);
		return t == null ? null : h(e.caption, t == null ? void 0 : t.paymentStatus).toString();
	}
	function f(e) {
		var t = o("WAWebOrderPaymentStatus").getOrderPaymentStatusInfoFromNativeFlow(e);
	...
	function g(e, t) {
		...
		return e != null && e.toLowerCase().includes(n.toString().toLowerCase()) ? e || "" : (n.toString() + "\n" + (e || "")).trim();
	}
	function h(e, t) {
		var n = "";
		switch (t) {
	...
	l.formatInteractive = e, l.getOrderStatusButtonBodyTitle = u, l.formatOrderStatusMessagePreview = c, l.formatOrderStatusMessageBody = d, l.formatOrderDetailsMessagePreview = m, l.formatPaymentInfoMessagePreview = p, l.formatOrderPaymentStatusMessage = _, l.formatOrderPaymentMethodMessage = f, l.appendPrefilledMsg = g, l.appendPrefilledOrderPaymentMsg = h;
}), 226);
