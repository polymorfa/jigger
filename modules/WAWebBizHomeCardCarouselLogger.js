__d("WAWebBizHomeCardCarouselLogger", [
	"$InternalEnum",
	...
	var e = {
		...
		function t() {}
		var n = t.prototype;
		return n.setEntryPoint = function(t) {
			o("WAWebSMBUserJourneyLogger").SMBUserJourneyLogger.setEntryPoint(t, o("WAWebWamEnumSmbFeatureNameEnum").SMB_FEATURE_NAME_ENUM.BUSINESS_TOOLS_REC_CARD);
		}, n.logViewBusinessTools = function(t) {
			o("WAWebSMBUserJourneyLogger").SMBUserJourneyLogger.log({
				extraAttributes: { num_cards_loaded: t },
				featureName: o("WAWebWamEnumSmbFeatureNameEnum").SMB_FEATURE_NAME_ENUM.BUSINESS_TOOLS_REC_CARD,
			...
			var e = t.cardSeqId, n = t.insightCardId, r = t.userActionTarget, a = t.userActionType;
			o("WAWebSMBUserJourneyLogger").SMBUserJourneyLogger.log({
				extraAttributes: {
					insight_card_id: n,
					card_seq_id: e
