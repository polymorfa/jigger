__d("WAWebBizLabelChooseColorModal.react", [
	...
	function _(e) {
		var t, a = e.label, i = c((t = a == null ? void 0 : a.colorIndex) != null ? t : o("WAWebLabelCollection").LabelCollection.getNextAvailableColor()), l = i[0], _ = i[1], f = function(t) {
			_(t);
		}, g = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = l !== a.colorIndex;
				yield o("WAWebBizLabelEditingAction").labelEditAction(a.id, a.name, a.predefinedId, l), e && o("WAWebWamSmbListEventReporter").logSmbListEvent({
		...
		}, C = r("chunkArray")(o("WAWebListUtils").getSelectableLabelColors(), 5);
