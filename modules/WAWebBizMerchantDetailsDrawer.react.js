__d("WAWebBizMerchantDetailsDrawer.react", [
	...
	function f(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, u), l = i.contactId, c = _(void 0), m = c[0], f = c[1], g = _(!0), h = g[0], y = g[1];
		p(function() {
			var t = (function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var t = yield o("WAWebBusinessProfileCollection").BusinessProfileCollection.update(l, { getMerchantCompliance: !0 }), n = Array.isArray(t) ? t[0] : t, r = n.serialize();
					r ? (f(r.legalEntityDetails || void 0), y(!1)) : o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["compliance: cannot fetch business details (", ")"])), l.toString());
				});
				return function() {
		...
		var C = m != null ? m : {}, b = C.customerCareDetails, v = C.entityName, S = C.grievanceOfficerDetails, R = o("WAWebBizComplianceUtil").getEntityTypeText(m);
		return d.jsxs(r("WAWebDrawer.react"), {
			...
			children: [d.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				children: h ? d.jsx(o("WAWebComplianceInfo.react").ComplianceInfoLoading, {}) : d.jsxs(d.Fragment, { children: [
