__d("WAWebBizMerchantDetailsFormFlow.react", [
	...
	function T(e) {
		var t = e.errorFn, n = e.onAfterSave, a = e.onError, i = e.rawBusinessProfile, l = e.validate, s = f(), c = s[0], d = s[1], p = f(i == null ? void 0 : i.address), _ = p[0], g = p[1], h = f(), y = h[0], C = h[1], b = i || {}, v = b.latitude, S = b.longitude, R = f(I(_, S, v)), L = R[0], E = R[1];
		return m(function() {
			return E(I(_, S, v));
		}, [
			_,
			...
			l(_) && C(null);
		}, [_, l]), i == null || L == null ? null : u.jsx(o("WAWebBusinessProfileIconSection.react").IconSection, {
			Icon: r("WDSIconIcLocationOn.react"),
			theme: o("WAWebBusinessProfileIconSection.react").IconSectionTheme.NoMargin,
			content: u.jsx(r("WAWebEditFormBusinessAddressField.react"), {
				businessProfile: L,
				activeField: c,
				rawBusinessProfile: i,
				value: _,
				validate: l,
				error: y,
				lowProfile: !1,
				...
				onSaveBusinessProfile: async function() {
					await o("WAWebBusinessProfileEdit").editBusinessProfile({ address: _ }), await n(babelHelpers.extends({}, i, { address: _ }));
				},
				onError: function() {
					C(t(_)), a == null || a();
				}
