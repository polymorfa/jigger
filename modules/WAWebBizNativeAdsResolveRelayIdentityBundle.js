__d("WAWebBizNativeAdsResolveRelayIdentityBundle", [
	...
	var e, s = r("requireDeferred")("WAWebBizAdCreationRoot.entrypoint").__setRef("WAWebBizNativeAdsResolveRelayIdentityBundle");
	function u() {
		return c.apply(this, arguments);
	}
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("CometRelay").__setRef("WAWebBizNativeAdsResolveRelayIdentityBundle").load();
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebResolveAccountTypeAndAdPage").__setRef("WAWebBizNativeAdsResolveRelayIdentityBundle").load();
			return {
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebWAAOnboarding").__setRef("WAWebBizNativeAdsResolveRelayIdentityBundle").load();
			return e;
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var o = t.existingBundle, a = t.flowID, i = t.options, l = yield (e || (e = n("Promise"))).all([
				d(),
				s.load(),
				u()
			]), c = l[0], m = c.resolveAdsPage, p = c.resolveIdentityForAccountType, _ = l[1], f = l[2], g = yield p(o.accountType);
			if (g == null) throw r("FBLogger")("wa_ctwa_web").mustfixThrow("Failed to resolve identity for ad creation prep (account type: " + o.accountType + ")");
			var h = yield m(g, o.linkedPagesInfo), y = h.pageId, C = h.pageType, b = f({ getEnvironment: function() {
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, a, i, l, c) {
			try {
				var m, _, g;
				...
				var h = yield d(), y = h.resolveAdsPage, C = h.resolveIdentityForAccountType, b = c != null ? c : yield C(t);
				...
				if (b.type === "WAA") {
					...
					var L = yield f();
					R = yield L(a), g.adsManagementQplAddPoint(g.AdsManagementQplPoint.ONBOARD_WAA_END);
				}
				...
				var E = yield (e || (e = n("Promise"))).all([r("WAWebGetAdsRelayEnvironment")(b), i != null ? i : o("WAWebLinkedAccountsJob").queryLinkedPagesInfo()]), k = E[0], I = E[1];
				...
				if (l === !0) {
					...
					P = F.pageId, N = F.pageType, $ = A({ getEnvironment: function() {
						return k;
					} }, w, {
						ad_account_id: R,
						ad_account_type: t,
				...
				var O = {
					draftPageId: S(t, I),
					pageId1: (m = (_ = I.fbPageId) != null ? _ : I.waPageId) != null ? m : "",
					pageId2: I.fbPageId != null && I.waPageId != null ? I.waPageId : null
				}, B = null, W = r("justknobx")._("897") && O.pageId1 === "";
				if (!W) {
					var g;
					(g = o("WAWebBizNativeAdsQplHelpers")).adsManagementQplAddPoint(g.AdsManagementQplPoint.PRELOAD_AD_MGMT_QUERY_START);
					var q = yield p();
					B = q(k, r("WAWebBizAdManagementRootQuery$Parameters"), {
						after: null,
				...
				if (v(U, t), t === "FB") return o("WAWebBizNativeAdsStoredFBIdentityStore").clearStoredFBIdentity(), null;
				throw e;
			}
	...
	l.prepareDeferredAdCreationEntrypoint = h, l.resolveBizNativeAdsRelayIdentityBundle = C, l.resolveDraftPageId = S;
}), 98);
