__d("WAWebBizOrderCreationFlow.react", [
	...
	function b(e) {
		var t, a, i = e.chat, l = e.entryPoint, u = e.onBack, b = e.onCancel, v = e.onDeclineOrder, S = e.onSend, R = e.order, L = e.ref, E = r("useWAWebUnmountSignal")(), k = (l === r("WAWebBizEntryPoint").FROM_CART || l === r("WAWebBizEntryPoint").ORDER_REQUEST_LIST) && o("WAWebOrderGatingUtils").isSellerOrderRevampEnabled(), I = k ? _.ORDER_REQUEST : _.ORDER_SUMMARY, T = p(I), D = T[0], x = T[1], $ = p(null), P = $[0], N = $[1], M = p(!1), w = M[0], A = M[1], F = p(function() {
			return y(R);
		}), O = F[0], B = F[1], W = p({}), q = W[0], U = W[1], V = p(null), H = V[0], G = V[1], z = r("useLazyRef")(function() {
			return new (r("WAWebMultiSelection"))([], function(e) {
				return e.id.toString();
			});
		}), j = z.current, K = o("WAWebCatalogCollection").CatalogCollection.get(o("WAWebUserPrefsMeUser").getMeUserOrThrow()), Q = function(t, n) {
			U(function(e) {
				var r;
			...
			return r("sumBy")(O, function(e) {
				var t, n;
				return ((t = (n = q[e.id]) != null ? n : e.price) != null ? t : 0) * e.quantity;
			});
		}, [O, q]), Y = o("WAWebOrderDetailMath").calculateFlatAmounts({
		...
		}), J = o("WAWebUserPrefsMeUser").getMeUserOrThrow(), Z = o("WAWebBusinessProfileUtils").hasCatalog(o("WAWebBusinessProfileCollection").BusinessProfileCollection.get(J)), ee = g(), te = o("WAWebOrdersExpansionCountries").getOrdersExpansionAllowedCurrencies(i.contact.id.user), ne = (t = (a = O.at(0)) == null ? void 0 : a.currency) != null ? t : ee, re = C(), oe = function() {
			var e = O.some(function(e) {
				return q[e.id];
			});
			l != null && o("WAWebOrderDetailsCreationActionWamEventUtil").createSendOrderDetailsWamEvent(i, l, O, Y, Z, e, re, ne).commit();
			var t = R != null ? R : o("WAWebOrderCollection").OrderCollection.addOrder();
			t.products = O.map(function(e) {
				var t, n;
				return e.price = (t = q[e.id]) != null ? t : e.price, e.currency = (n = e.currency) != null ? n : ee, e;
			}), t.currency = ne, t.subtotal = X, t.triggerItemCollectionUpdate(), o("WAWebBizSendOrderAction").sendOrderDetailsMessageAsMerchant({
				chat: i,
				discount: Y.discount,
				...
				tax: Y.tax,
				total: Y.total
			}), S == null || S(), o("WAWebDrawerManager").DrawerManager.closeDrawerRight();
		}, ae = r("useWAWebCallbackOnce")(function() {
			u ? u() : (o("WAWebDrawerManager").DrawerManager.closeDrawerRight(), b == null || b());
		}), ie = function() {
			h(R, O, q) ? o("WAWebModalManager").ModalManager.open(s.jsx(r("WAWebOrderConfirmDiscardModal"), { onOK: ae })) : ae();
		}, le = function(t) {
			E.aborted || (t !== !0 && o("WAWebOrderEnterPriceToastMessage").notifyIfAnyProductMissesPrice(O, q), x(I));
		}, se = function() {
			x(_.CATALOG_PRODUCTS_FORM);
		}, ue = function(t, n) {
			var e = Number.isInteger(t) ? t : null;
			N(e), A(n === !0), x(e == null || O[e].isCustomItem ? _.CUSTOM_ITEM_FORM : _.CATALOG_PRODUCTS_FORM);
		}, ce = function() {
			...
			var e = K == null ? void 0 : K.productCollection.getProductModels(), o = new Set(n.map(function(e) {
				var t = e.id;
				return t;
			...
			t === void 0 && (t = !0), Z && B(function(e) {
				var n = j.getSelected(), r = me(n), a = pe(r, n, e);
				return t && o("WAWebOrderEnterPriceToastMessage").notifyIfAnyProductMissesPrice(a, q), de(e, a);
			});
		}, fe = function(t) {
			...
			B(function(t) {
				var o = de(t, [].concat(t, [new (r("WAWebOrderItemModel"))({
					currency: e,
					id: s,
					isCustomItem: !0,
					isQuantitySet: n,
			...
			l != null && o("WAWebOrderDetailsCreationActionWamEventUtil").createClickAddItemWamEvent({
				entryPoint: l,
				hasAddedPrice: e,
				hasCatalog: Z
			}).commit(), Z && o("WAWebOrderGatingUtils").orderDetailsFromCatalogEnabled() ? se() : ue();
		}, Se = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (!(K == null || J == null)) for (var t = K.productCollection.getProductModels(), n, r = t.length, a = 0; (!n || !j.isSelected(n)) && a < r;) {
					var i;
					yield o("WAWebCatalogCollection").CatalogCollection.update(J), a = r, t = K.productCollection.getProductModels(), n = (i = t) == null ? void 0 : i.find(function(t) {
						return t.id === e.id;
					}), n && he(n, e.quantity), r = t.length;
				}
			});
			return function(n) {
			...
			if (R) {
				var e = K == null ? void 0 : K.productCollection.getProductModels(), t = function(n) {
			...
			if (_e(), le(!0), l) {
				...
				o("WAWebOrderDetailsCreationActionWamEventUtil").createClickAddItemsWamEvent(l, Z, e).commit();
			}
		}, Ee = function(t) {
			switch (t) {
				...
				case _.CUSTOM_ITEM_FORM: return s.jsx(r("WAWebOrderCustomItemFormDrawer"), {
					currency: ne,
					eligibleCurrencies: O.length === 0 && j.getSelected().length === 0 ? te : [],
					onBack: w ? se : le,
