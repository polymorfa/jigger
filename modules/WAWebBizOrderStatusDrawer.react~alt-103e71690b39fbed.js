__d("WAWebBizOrderStatusDrawer.react", [
	...
	function S(e) {
		...
		var V;
		t[13] !== C.length || t[14] !== T ? (V = C.length > 0 ? p.jsx(o("WAWebMenuBar.react").MenuBarItem, {
			icon: p.jsx(r("WDSIconIcMoreVert.react"), {}),
			title: N,
			onClick: T
		}) : null, t[13] = C.length, t[14] = T, t[15] = V) : V = t[15];
		var H;
	...
	function R(e) {
		...
		var N;
		t[18] !== I ? (N = p.jsx(o("WAWebEmojiText.react").EmojiText, {
			text: I,
			className: $,
			direction: "auto",
			titlify: !0
		}), t[18] = I, t[19] = N) : N = t[19];
		var M;
		...
		var w;
		return t[22] !== M || t[23] !== T || t[24] !== x || t[25] !== N ? (w = p.jsx(r("WAWebCellV2.react"), {
			size: "medium",
			onClick: T,
			primary: x,
			secondary: N,
			detailLeft: M,
			isRefresh: !0
		}), t[22] = M, t[23] = T, t[24] = x, t[25] = N, t[26] = w) : w = t[26], w;
	}
	function L(e) {
	...
	function E(e) {
		...
		var P;
		return t[26] !== T || t[27] !== D || t[28] !== b || t[29] !== E || t[30] !== I ? (P = p.jsxs(p.Fragment, { children: [
			b,
			E,
			I,
			T,
			D
		] }), t[26] = T, t[27] = D, t[28] = b, t[29] = E, t[30] = I, t[31] = P) : P = t[31], P;
	}
	async function k(e) {
		var t = e.textToCopy, n = e.toastMessage, r = e.toastPosition, a = r === void 0 ? o("WAWebToastManager").ToastPosition.RIGHT : r, i = await o("WAWebCopyToClipboard").copyTextToClipboard(t);
					...
					return p.jsx("div", babelHelpers.extends({ onClick: function() {
						...
						children: [
							p.jsxs(o("WAWebFlex.react").FlexColumn, {
								...
								shrink: 0,
								children: [p.jsx(T, { item: e }), e.quantity > 1 && p.jsx(o("WAWebFlex.react").FlexColumn, {
									align: "center",
									justify: "center",
									shrink: 0,
									xstyle: C.quantity,
	...
	function D(e) {
		...
		e: {
			...
			var h;
			t[4] !== n ? (h = N(n), t[4] = n, t[5] = h) : h = t[5], f = h;
		}
		var y = f;
