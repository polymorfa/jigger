__d("WAWebBizOrderStatusDrawer.react", [
	...
	function E(e) {
		var t = e.chat, a = e.message, i = e.orderStatusButton, l = i.order, u = l.contact_info, c = l.order_creator_surface, d = l.shipping_method, m = l.status, _ = l.tracking, f = c === "biz_inbox" && o("WAWebABProps").getABPropConfigValue("utility_order_view_mbs_enabled"), g = (function() {
		...
		return p.jsxs(p.Fragment, { children: [
			p.jsx(o("WAWebFlex.react").FlexColumn, {
				...
				shrink: 0,
				children: o("WAWebBizFormatInteractiveMsg").getOrderStatusButtonBodyTitle(m)
			}),
			p.jsx(L, {
				title: s._(
					/*BTDS*/
				...
				onCopyClick: function() {
					o("WAWebRichOrderStatusLogger").logRichOrderStatusInteraction(a.unsafe(), o("WAWebRichOrderStatusLogger").RichOrderStatusActionType.ORDER_NUMBER_COPY), g({
			...
			!f && (_ ? p.jsx(L, {
				...
				onCopyClick: function() {
					o("WAWebRichOrderStatusLogger").logRichOrderStatusInteraction(a.unsafe(), o("WAWebRichOrderStatusLogger").RichOrderStatusActionType.TRACKING_NUMBER_COPY), g({
			...
			o("WAWebOrderStatus").shouldShowTrackingInfo(i) && (_ == null ? void 0 : _.tracking_url) && p.jsx(L, {
				title: s._(
					/*BTDS*/
					""
				),
			...
			((u == null ? void 0 : u.email) != null || (u == null ? void 0 : u.phone_number) != null || (u == null ? void 0 : u.support_url) != null) && p.jsx(L, {
				title: s._(
					/*BTDS*/
					""
				),
