__d("WAWebBizPaymentDetail.react", [
	...
	function d(e) {
		var t, n = e.contactAndOrderInfo, a = e.orderPaymentStatusInfo, i = r("useWAWebUIM")(), l = function() {
			var e = n.interactiveMsg;
			e && (o("WAWebSyncdMdSyncFieldstatMeta").MdSyncFieldStatsMeta.getMdSessionId().then(function(e) {
			...
			}), o("WAWebBizOrderDetailAction").openOrderDetailDrawer(e, i, r("WAWebBizEntryPoint").FROM_CHAT, !0));
		}, c = n.interactiveMsg;
					...
					children: [s.jsx(o("WAWebFlex.react").FlexColumn, {
						...
						children: [s.jsxs(o("WAWebFlex.react").FlexRow, {
							...
							children: [s.jsx(r("WDSText.react"), {
								...
								type: "Body1",
								colorName: "contentDefault",
								xstyle: a === o("WAWebOrderPaymentStatus").OrderPaymentStatus.Failed ? u.strikethrough : void 0,
								children: o("WAWebCurrencyUtils").formatAmount({
									amount: (t = n.orderInfo.totalAmount) != null ? t : 0,
									currency: n.orderInfo.currency
								})
							})]
						}), s.jsx(o("WAWebFlex.react").FlexColumn, {
							xstyle: u.orderSubDetails,
							children: s.jsx(r("WAWebBizPaymentStatusInfoLabel.react"), { orderPaymentStatusInfo: a })
						})]
					})]
				})
			})]
	...
	d.displayName = d.name + " [from " + i.id + "]", l.extractPaymentStatus = c, l.WAWebBizPaymentDetail = d;
}), 98);
