__d("WAWebBizPaymentsHomeManagementFlow.react", [
	...
	function h(e) {
		var t = e.isInitialStep, n = e.ref, a = e.referral, i = a === void 0 ? "from_business_tools" : a, l = o("useWAWebFlow").useFlow(_.Payments, { transitions: o("useWAWebFlow").FlowTransitions.DrawerRight }), c = l[0], h = l[1], C = r("useWAWebNux")(o("WAWebNux").NUX.BRAZIL_CONTACTS_RESTRICTION_BANNER), b = C[0], v = C[2], S = function(t, n) {
			o("WAWebDrawerManager").DrawerManager.closeDrawerLeft(), o("WAWebFindChatAction").findOrCreateLatestChat(t.id, n).then(function(e) {
				var t = e.chat;
			...
			e != null && (o("WAWebDrawerManager").DrawerManager.closeDrawerLeft(), o("WAWebFindChatAction").findOrCreateLatestChat(t.id, n).then(function(t) {
				var n = t.chat;
				o("WAWebCmd").Cmd.openChatFromUnread({
					chat: n,
					chatEntryPoint: o("WAWebChatEntryPoint").ChatEntryPoint.BizPayment
			...
			return function(e) {
				...
				o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebModal.react").Modal, {
					...
					children: u.jsx(r("WAWebContactEditDrawer.react"), {
						...
						onSave: function(n) {
							var e = o("WAWebContactCollection").ContactCollection.assertGet(n.contactId);
		...
		switch (h.step) {
			...
			case _.SeeAllPayments:
				k = u.jsx(r("WAWebBizSeeAllPaymentsDrawer.react"), { onBack: function() {
					return h.pop();
				} });
				break;
			case _.SelectContact: {
				var I = o("WAWebPixPaymentRequestFeature").isPixPaymentRequestEnabled(), T = I ? function(e) {
