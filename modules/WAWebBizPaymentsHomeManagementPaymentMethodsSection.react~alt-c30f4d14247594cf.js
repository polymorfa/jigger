__d("WAWebBizPaymentsHomeManagementPaymentMethodsSection.react", [
	"fbt",
	...
	var e, u = e || (e = o("react")), c = {
		...
		children: u.jsx("div", { children: o("WAWebUserPrefsCustomPaymentMethods").isPIXValid() ? s._(
			/*BTDS*/
			""
		) : s._(
			/*BTDS*/
		...
		var e = o("WAWebUserPrefsCustomPaymentMethods").isPIXValid(), t = await o("WAWebSyncdMdSyncFieldstatMeta").MdSyncFieldStatsMeta.getMdSessionId();
		o("WAWebPaymentsUserActionLogging").logPaymentsHomeEvent({
			actionTarget: o("WAWebWamEnumPaymentActionTargets").PAYMENT_ACTION_TARGETS.PAYMENTS_HOME_PIX_KEY,
			...
			paymentsEventId: await o("WAWebSyncdMdSyncFieldstatMeta").MdSyncFieldStatsMeta.getMdSessionId(),
			previousScreenName: "payment_home",
			referral: "payment_home.add_payment_method",
			screen: "add_non_native_p2m_payment_method"
		}), o("WAWebBizFrontendGatingUtils").isPixOnWebEnabled() ? o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebPaymentOnboardingFlowLoadable").PaymentOnboardingFlowLoadable, {
			previousScreen: "payment_home",
			referral: "payment_home.add_payment_method"
		}), { transition: "modal-flow" }) : o("WAWebModalManager").ModalManager.open(d);
	};
	function p() {
	...
	function _() {
		...
		return o("useWAWebListener").useListener(o("WAWebCustomPaymentMethods").CustomPaymentMethods, o("WAWebCustomPaymentMethods").CUSTOM_PAYMENT_METHODS_CHANGE_EVENT, e), o("WAWebBizFrontendGatingUtils").isCustomPaymentMethodsSyncEnabled() ? u.jsxs(r("WAWebDrawerSection.react"), {
			...
			children: [u.jsx(r("WDSText.react"), {
				...
				icon: u.jsx(r("WAWebRoundShape.react"), {
					...
					children: o("WAWebUserPrefsCustomPaymentMethods").isPIXValid() ? u.jsx(o("WAWebPixLogoIcon.react").PixLogoIcon, {
						height: 38,
						width: 38,
						innerStyles: {
