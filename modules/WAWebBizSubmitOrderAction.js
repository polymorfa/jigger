__d("WAWebBizSubmitOrderAction", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			var a = yield o("WAWebBizOrderAction").createOrder(t.id, e.cartItemCollection.toArray());
			return yield r("WAWebSendOrderChatAction")(t, a, e.itemCount, u(e), e.message, n == null ? void 0 : n.getCatalogType()), o("WAWebBizCartBridge").updateCart(e), a.id;
