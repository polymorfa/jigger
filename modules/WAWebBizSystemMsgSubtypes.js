__d("WAWebBizSystemMsgSubtypes", [], (function(t, n, r, o, a, i) {
	var e = [
	...
	], l = ["biz_privacy_mode_init_fb", "biz_privacy_mode_init_bsp"], s = ["biz_privacy_mode_to_fb", "biz_privacy_mode_to_bsp"], u = [].concat(l, s), c = [
	...
	i.BIZ_SYSTEM_MSG_SUBTYPES = e, i.BIZ_SYSTEM_MSG_SUBTYPES_V2_INIT = l, i.BIZ_SYSTEM_MSG_SUBTYPES_V2 = u, i.COEX_MSG_SUBTYPES = c, i.PRODUCT_INQUIRY_TYPE = d;
}), 66);
