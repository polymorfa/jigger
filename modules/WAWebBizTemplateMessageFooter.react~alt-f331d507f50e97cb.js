__d("WAWebBizTemplateMessageFooter.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = e.dir, n = e.footer, a = e.isShown, i = e.msg, l = e.rtl, u = e.trusted, c = e.type, d = l !== r("WAWebL10N").isRTL();
		if (a && n != null) {
			var m = i.isDynamicReplyButtonsMsg ? o("WAWebFormatHeaderFooter").enableHeaderAndFooterFormatting(o("WAWebMsgLinks").getFooterLinks(i), u === !0) : {}, p = m.formatters, _ = m.selectable;
