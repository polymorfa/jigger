__d("WAWebBizToolsUtils", [
	...
	function e(e) {
		new (o("WAWebBusinessToolsEntryWamEvent")).BusinessToolsEntryWamEvent({
			...
			businessToolsSequenceNumber: o("WAWebBizToolsSessionModel").getSequence(),
			businessToolsSessionId: o("WAWebBizToolsSessionModel").getSession()
		}).commit();
	}
	function s(e) {
		new (o("WAWebBusinessToolsImpressionWamEvent")).BusinessToolsImpressionWamEvent({
			businessToolsEntryPoint: e,
			businessToolsSequenceNumber: o("WAWebBizToolsSessionModel").getSequence(),
			businessToolsSessionId: o("WAWebBizToolsSessionModel").getSession()
		}).commit();
	...
	l.logBizToolsEntry = e, l.logBizToolsImpression = s, l.logBizToolsClick = u;
}), 98);
