__d("WAWebBizUpdatePreferenceJob", ["WALogger", "WASmaxBizMsgUserFeedbackUpdatePreferenceRPC"], (function(t, n, r, o, a, i, l) {
	var e, s;
	async function u(t, n, r) {
		...
		}, i = await o("WASmaxBizMsgUserFeedbackUpdatePreferenceRPC").sendUpdatePreferenceRPC(a);
		switch (i.name) {
			case "UpdatePreferenceResponseServerError": {
				var l = i.value.errorUpdatePreferenceServerErrors.value, u = l.code, c = l.text;
			...
			case "UpdatePreferenceResponseInvalidRequest": {
				var d = i.value.errorUpdatePreferenceReqErrors.value, m = d.code, p = d.text;
