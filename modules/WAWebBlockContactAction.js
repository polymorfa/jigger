__d("WAWebBlockContactAction", [
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield o("WAWebUpdateBlocklistDbJob").updateBlockingStatusForPSAUser(e), n = e;
	...
	function y(e, t, r, a, i) {
		var l = e.isContactBlocked, s = t && l, u = !t && !l;
		if (s || u) return (d || (d = n("Promise"))).resolve();
		var c = b(e, t ? "block" : "unblock", r, a).then((function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (e && e.errorCode != null) throw new (o("WAWebBackendErrors")).ServerStatusCodeError(e.errorCode, e.errorText);
				var n = e.targetWid;
				yield o("WAWebUpdateBlocklistDbJob").updateBlocklistDbJob(n, t), t ? o("WAWebBlocklistCollection").BlocklistCollection.add({ id: n }) : o("WAWebBlocklistCollection").BlocklistCollection.remove(n);
			});
			return function(t) {
	...
	function C(t) {
		var n = t.action, r = t.block, a = t.contact, i = t.redo, l = t.toastId, u = l === void 0 ? o("WAWebActionToast.react").genId() : l, c = t.undo, d = o("WAWebFrontendContactGetters").getFormattedName(a), m = r ? new (o("WAWebActionToast.react")).ActionType(s._(
			/*BTDS*/
			"",
			[s._param("member", d)]
		...
		o("WAWebToastManager").ToastManager.open(p.jsx(o("WAWebActionToast.react").ActionToast, {
			id: u,
			initialAction: m,
			pendingAction: _
		}));
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r) {
			...
			if (o("WAWebBlocklistMigration").isBlocklistMigrated()) {
				var i = S(e, n), l = yield o("WAWebBlockUserJob").blockUnblockUser({
					lid: i,
					action: t,
					bizOptOutArgs: r
				});
			...
			var s = e.id, u = e.phoneNumber, c = t === "block" && s.isLid(), d = c && u != null ? u : s, m = yield o("WAWebBlockUserJob").blockUnblockUser({
				wid: d,
				action: t,
				bizOptOutArgs: r
			});
	...
	l.blockContact = _, l.unblockContact = f, l.updatePSAUserBlockingStatus = g;
}), 226);
