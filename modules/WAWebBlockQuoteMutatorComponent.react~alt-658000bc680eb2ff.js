__d("WAWebBlockQuoteMutatorComponent.react", [
	...
	function d(t) {
		var n = t.children, a = n === void 0 ? "" : n, i = t.inline, l = i === void 0 ? !1 : i, s = t.quoted, d = s === void 0 ? !1 : s, m = t.selectable, p = t.text, _ = o("WABidi").bidiDir(p), f = _ === "rtl" !== r("WAWebL10N").isRTL(), g = "> ";
		return l ? u.jsx(o("WAWebCopyPasteSelectable.react").SelectableSpan, {
			dir: _,
			selectable: m,
			prePlainText: g,
			className: {
			...
			}[!!f << 1 | !!d << 0])), u.jsx("div", babelHelpers.extends({}, {
				0: { className: "x1rg5ohu x1gx403c xj0a0fe xeaf4i8" },
				1: { className: "x1rg5ohu xj0a0fe xeaf4i8 x1c1uobl x1q3ajuy" }
			}[!!f << 0], { children: o("WAWebFormatComponentUtils").removeFirstLeadingSpace(a) }))]
		});
	}
