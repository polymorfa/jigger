__d("WAWebBlockedDrawer.react", [
	...
	function d(e) {
		...
		var l = r("useWAWebEventTargetValue")(o("WAWebBlocklistCollection").BlocklistCollection, i, h), d = c(g), _ = d[0], y = f, b = p, v;
		...
		var S = v, R;
		t[2] !== _ || t[3] !== l ? (R = o("WAWebBlocklistCollection").BlocklistCollection.length > 0 ? u.jsx(r("WAWebFlatListContainer.react"), {
		...
		}) : u.jsx(o("WAWebEmptyState.react").Blocked, { onAddBlockedContact: S }), t[2] = _, t[3] = l, t[4] = R) : R = t[4];
		var L = R, E;
	...
	function h() {
		return o("WAWebBlocklistCollection").BlocklistCollection.dedupedList().map(y);
	}
	function y(e) {
		return {
