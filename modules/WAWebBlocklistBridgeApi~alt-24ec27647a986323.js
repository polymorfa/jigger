__d("WAWebBlocklistBridgeApi", [
	...
	var e = {
		...
		restoreBlocklist: async function() {
			...
			o("WAWebBlocklistCollection").BlocklistCollection.replaceAllWith([]), o("WAWebBlocklistCollection").BlocklistCollection.initializeFromCache(o("WAWebApiHydrateWidsUtil").hydrateWids(e));
		}
	};
