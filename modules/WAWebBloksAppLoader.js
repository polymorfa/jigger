__d("WAWebBloksAppLoader", [
	...
	var e = "/async/wbloks/fetch/", s = (function(t) {
		...
		var i = a.prototype;
		return i.fetchApp = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n, r = yield this.$WAWebBloksAppLoader$p_1(e, t, "app");
				...
				return ((n = r.payload) == null || (n = n.layout) == null ? void 0 : n.bloks_payload) != null ? o("WebBloksUtils").normaliseBloksPayload(r.payload) : o("WebBloksUtils").normaliseBloksPayload(r);
			});
			function t(t, n) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				...
				var s = yield o("WAWebXControllerFetchUtils").fetchFromXController(n.toString(), { method: "POST" });
				if (!s.ok) throw r("err")("HTTP error! status: " + s.status);
				var u = yield o("WAWebXControllerFetchUtils").extractJsonFromResponse(s);
