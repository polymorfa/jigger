	...
	function e(e) {
		...
		return t[0] !== e ? (n = function() {
			return o("WebBloksHasteEnvironment").createWebBloksHasteEnvironment({
				...
				screenQueryTemplate: o("WebBloksUtils").cast(o("WAWebUnifiedResponseLoaderTemplate").LOADER_TEMPLATE)
			}, e);
		}, t[0] = e, t[1] = n) : n = t[1], o("WebBloksEnvironment").useWebBloksEnvironmentStore(n);
	}
