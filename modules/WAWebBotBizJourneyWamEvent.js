__d("WAWebBotBizJourneyWamEvent", [
	...
	var e = o("WAWebWamCodegenUtils").defineEvents({ BotBizJourney: [
		4868,
		{
			appSessionId: [1, o("WAWebWamCodegenUtils").TYPES.STRING],
			botBizActionType: [5, o("WAWebWamEnumBotBizActionType").BOT_BIZ_ACTION_TYPE],
			botBizEntryPoint: [6, o("WAWebWamEnumBotBizEntryPoint").BOT_BIZ_ENTRY_POINT],
