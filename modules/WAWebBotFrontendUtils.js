__d("WAWebBotFrontendUtils", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield P(), n = yield o("WAWebCmd").Cmd.openChatFromUnread({
				chat: t,
				chatEntryPoint: e
			});
	...
	function k() {
		return k = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n, r;
			if (o("WAWebBotGating").isImplicitThreadRoutingEnabled()) n = o("WAWebResolveThreadForEntryPoint").resolveThreadIdForEntryPoint(e), x(e, n), r = null;
			else {
				var a, i, l = (a = e.aiThreads) == null ? void 0 : a.head();
				n = (i = l == null ? void 0 : l.id) != null ? i : T(e), r = l == null ? void 0 : l.creationTimestamp;
			}
	...
	function I(e, t, n) {
		var r;
		o("WAWebBotGating").isImplicitThreadRoutingEnabled() ? (r = o("WAWebResolveThreadForEntryPoint").resolveThreadIdForEntryPoint(e), x(e, r), o("WAWebCmd").Cmd.openChatBottom({
			chat: e,
			chatEntryPoint: n,
			threadId: r
		})) : r = D(e, n);
	...
	function N() {
		return N = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				var e = yield o("WAWebFindChatAction").findOrCreateLatestChat(o("WAWebBotUtils").META_BOT_PN_WID, "metaBotChatListShortcut"), t = e.chat;
	...
	l.openMetaBotChat = m, l.sendMetaBotQuery = _, l.metaAiLlamaVersionTitleFbs = g, l.getBotMsgBodyLength = h, l.isMetaAiChatEmpty = y, l.maybeGetTopMetaAiRow = b, l.getMetaAiContact = v, l.getHatchContact = S, l.maybeGetTopHatchRow = R, l.getBotNuxOriginType = L, l.openLatestOrNewMetaAiThread = E, l.openMetaAiThreadAndSendQuery = I, l.createNewMetaAiThread = T, l.createAndOpenNewMetaAiThread = D, l.ensureThreadModelExists = x, l.runMetaAiThreadsFlow = $, l.getMetaAiChat = P, l.getMetaAiTEEBotDisplayName = M;
}), 226);
