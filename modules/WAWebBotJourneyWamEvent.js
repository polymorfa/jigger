__d("WAWebBotJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ BotJourney: [
		4630,
		{
			actionType: [1, o("WAWebWamEnumChatFilterActionTypes").CHAT_FILTER_ACTION_TYPES],
			...
			botDiscoveryPath: [8, o("WAWebWamEnumBotDiscoveryPathType").BOT_DISCOVERY_PATH_TYPE],
			botEntryPoint: [7, o("WAWebWamEnumBotEntryPointType").BOT_ENTRY_POINT_TYPE],
			botPersonaId: [5, e.TYPES.STRING],
			botPromptType: [49, o("WAWebWamEnumBotPromptType").BOT_PROMPT_TYPE],
			...
			discoveryOrigin: [19, o("WAWebWamEnumDiscoveryOriginType").DISCOVERY_ORIGIN_TYPE],
			...
			inlineTosStatus: [21, o("WAWebWamEnumInlineTosStatus").INLINE_TOS_STATUS],
			...
			promptTriggerPoint: [50, o("WAWebWamEnumPromptTriggerPoint").PROMPT_TRIGGER_POINT],
