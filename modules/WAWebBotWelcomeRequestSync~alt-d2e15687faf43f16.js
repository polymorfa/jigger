__d("WAWebBotWelcomeRequestSync", [
	...
	var e, s, u = (function(t) {
		...
		return r.getVersion = function() {
				...
				try {
					e: {
						...
						if ((typeof n == "object" && n !== null || typeof n == "function") && n.operation === "set" && "indexParts" in n && "value" in n) {
							...
							var c = (i = s.botWelcomeRequestAction) == null ? void 0 : i.isSent;
							if (c == null) return r++, o("WAWebSyncdIndexUtils").malformedActionValue(t.collectionName);
							var d = await o("WAWebSyncdGetChat").resolveChatForMutationIndex(o("WAWebWidFactory").createWid(u));
							if (!d.success) return {
								actionState: o("WAWebSyncdConst").SyncActionState.Orphan,
								orphanModel: d.orphanModel
							};
							var m = o("WAWebWidFactory").createWid(d.chat.id);
							return await o("WAWebDBUpdateChatTable").updateChatTable(m, { hasRequestedWelcomeMsg: c }), o("WAWebBackendApi").frontendFireAndForget("chatCollectionUpdate", { updates: [{
								id: m,
			...
			return r > 0 && o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[BotWelcomeRequestSync] ", " malformed: isSent not bool"])), r), a > 0 && o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[BotWelcomeRequestSync] ", " operations not supported"])), a), i;
		}, r.getBotWelcomeRequestSetMutation = async function(t, n) {
			var e = { botWelcomeRequestAction: { isSent: n } }, r = o("WAWebSyncdActionUtils").buildPendingMutation({
				collection: this.collectionName,
				indexArgs: [await o("WAWebSyncdGetChat").getChatJidMutationIndexForChat(t, o("WAWebSyncdConst").Actions.BotWelcomeRequest)],
				value: e,
