__d("WAWebBrazilPixKeyValidationUtils", ["WAWebValidationUtils"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e) {
		var t = /\+55\d{10,11}$/;
		return t.test(e);
	...
	function s(e) {
		...
		var n = e.replace(/[^0-9]/g, "").split("").map(Number);
	...
	function g(t, n) {
		...
		switch (t) {
			case "PHONE": return e(n);
			case "CPF": return s(n);
			case "EMAIL": return o("WAWebValidationUtils").validateEmail(n);
			case "CNPJ": return f(n);
			case "EVP": return o("WAWebValidationUtils").validateUUID(n);
			default: return !1;
		}
	}
	function h(e) {
	...
	l.isValidPhoneNumber = e, l.validateCPF = s, l.validateCNPJ = f, l.validatePixKey = g, l.isPixDisplayNameValid = h;
}), 98);
