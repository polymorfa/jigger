__d("WAWebBroadcastEphemeralUtils", [
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, r, a = yield o("WAWebSchemaChat").getChatTable().get(e.toString(), !1);
			if (a != null) {
				var i, l;
				return {
			...
			var s = yield (d || (d = n("Promise"))).all([o("WAWebApiContact").getContactRecord(o("WAWebUserPrefsMeUser").getMePnUserOrThrow_DO_NOT_USE()), o("WAWebApiContact").getContactRecord(e)]), u = s[0], c = s[1];
			if (c != null && o("WAWebEphemeralityUtils").isEphemeralityDisabledForMessagingWithContact(c)) return {
				duration: 0,
				timestamp: 0
			};
			...
			return {
				...
				timestamp: (r = m == null ? void 0 : m.settingTimestamp) != null ? r : 0
			};
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = t.authorId, r = t.broadcastJid, a = t.proto, i = t.recipient, l = yield p(i), c = l.duration, d = l.timestamp;
			...
			var _ = o("WAWebEphemeralEncodeBroadcastSetting").generateEphemeralSharedSecret(), f = m(a, _), g = f.injected, h = f.proto;
			...
			var y = yield o("WAWebEphemeralEncodeBroadcastSetting").encodeBroadcastEphemeralSetting({
				broadcastJid: r,
				duration: c,
				recipient: i,
				sender: n,
			...
			return o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose([
				...
				" len=",
				""
			])), i.toString(), r.toString(), c, d, y.length).tags("messaging"), {
				content: h,
				ephSetting: y
			};
		}), g.apply(this, arguments);
	}
	l.addSharedSecretToProto = m, l.getBroadcastEphemeralSettingForRecipient = p, l.buildBroadcastRetryEphemeral = f;
}), 98);
