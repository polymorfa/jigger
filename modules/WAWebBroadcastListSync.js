	...
	var e, s, u = (function(t) {
		...
		return a.getVersion = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var r = this, a = 0, i = yield (s || (s = n("Promise"))).all(t.map((function() {
						...
						try {
							...
							e: {
								...
								if ((typeof i == "object" && i !== null || typeof i == "function") && i.operation === "set" && "value" in i) {
									...
									return yield o("WAWebBroadcastListStorageUtils").updateBroadcastListStorage({
								...
								if ((typeof i == "object" && i !== null || typeof i == "function") && i.operation === "remove") {
									return yield o("WAWebBroadcastListStorageUtils").removeBroadcastListStorage(n), { actionState: o("WAWebSyncdConst").SyncActionState.Success };
									break e;
								}
				...
				return a > 0 && o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["broadcast list sync: ", " malformed mutations"])), a), i;
			});
			function r(e) {
