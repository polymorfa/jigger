__d("WAWebBugReportFlowMediaView.react", [
	...
	function m(t) {
		var a = t.customCloseMediaModal, i = t.maxItems, l = t.mediaCollection, u = t.mediaMimeTypes, m = t.onRender, _ = t.onSend, f = t.suportedMediaTypes, g = d(function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (h(e)) return n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					_(e.map(function(e) {
						return e.media;
					})).finally(r("WAWebNoop")), a != null ? a() : o("WAWebModalManager").ModalManager.closeMedia();
				})();
			});
			return function(t) {
