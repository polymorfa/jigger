__d("WAWebBugReportSessionWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumBugReportEntryPointName",
	"WAWebWamEnumBugReportFlowAction"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ BugReportSession: [
		3850,
		{
			bugReportErrorMessage: [2, e.TYPES.STRING],
			bugReportFlowAction: [1, o("WAWebWamEnumBugReportFlowAction").BUG_REPORT_FLOW_ACTION],
			...
			bugReportingEntryPoint: [12, o("WAWebWamEnumBugReportEntryPointName").BUG_REPORT_ENTRY_POINT_NAME],
