__d("WAWebBugnubScreenshotUpload.react", [
	...
	function _(t) {
		var a = t.customCloseMediaModal, i = t.customOpenMediaModal, l = t.customOpenSupportModal, s = t.mediaState, _ = t.onChangeState, f = function(t) {
			new (o("WAWebBugReportSessionWamEvent")).BugReportSessionWamEvent({ bugReportFlowAction: t }).commit();
		}, g = c(0), h = g[0], y = g[1], C = c(null), b = C[0], v = C[1], S = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				if (t.length > 0) {
					...
					f(o("WAWebWamEnumBugReportFlowAction").BUG_REPORT_FLOW_ACTION.MEDIA_UPLOAD_SUCCESSFUL), y(0), _({
						state: "success",
			...
			f(o("WAWebWamEnumBugReportFlowAction").BUG_REPORT_FLOW_ACTION.ADD_SCREENSHOT_CLICK);
			...
			l != null ? l(e) : o("WAWebModalManager").ModalManager.openSupportModal(e);
		}, L = function(t) {
			f(o("WAWebWamEnumBugReportFlowAction").BUG_REPORT_FLOW_ACTION.REMOVE_SCREENSHOT_CLICK);
			...
			var e = s.mediaFiles[t], l = e.originalFile;
			if (l != null) {
				var c = new File([l], e.filename, { type: l.type }), d = (function() {
						...
						if (n.length !== 0) {
							...
							if (l instanceof Blob) {
								var u = o("WAWebStartMediaUploadQpl").startMediaUploadQpl({
									...
									isViewOnce: !1,
									uploadQpl: u
								}), d = yield r("WAWebCryptoCreateMediaKeys")(i, c.mediaKey), m = [].concat(s.mediaFiles);
								a.file instanceof Blob && e.previewUrl && URL.revokeObjectURL(e.previewUrl), m[t] = {
									url: c.url,
									iv: d.iv,
									encKey: d.encKey,
								...
								}, f(o("WAWebWamEnumBugReportFlowAction").BUG_REPORT_FLOW_ACTION.MEDIA_UPLOAD_SUCCESSFUL), _({
									state: "success",
									mediaFiles: m
								});
							}
				...
				})(), m = new Set([o("WAWebMsgType").MSG_TYPE.IMAGE, o("WAWebMsgType").MSG_TYPE.VIDEO]), p = [o("WAWebMimeTypes").IMAGE_MIMES, o("WAWebMimeTypes").VIDEO_MIMES].join(","), g = new (r("WAWebAttachMediaCollection"))({ chatParticipantCount: 1 }), h = { file: c }, y = function() {
					g.processAttachments([h], void 0, m, 1);
				...
				i != null ? i(C, b) : o("WAWebModalManager").ModalManager.openMedia(C, b);
			}
		};
		return u.jsxs(r("WAWebBox.react"), {
			...
			children: [
				s.mediaFiles.map(function(e, t) {
					return u.jsxs(r("WAWebUnstyledButton.react"), {
						...
						children: [u.jsxs(r("WAWebBox.react"), {
							...
							}), u.jsx(r("WAWebBox.react"), { xstyle: [d.hoverOverlay, b === t && d.hoverOverlayVisible] })]
				...
				s.state === "uploading" && Array.from({ length: h }, function(e, t) {
				...
				s.state !== "uploading" && s.mediaFiles.length < m && u.jsxs(r("WAWebUnstyledButton.react"), {
					...
					title: s.state === "error" ? "Error uploading files. Click to retry." : "Add screenshot or video",
					children: [u.jsx(o("WAWebIcAddPhotoAlternateIcon.react").IcAddPhotoAlternateIcon, {
						height: 24,
						width: 24
					}), u.jsx(r("WAWebBox.react"), { xstyle: [d.mediaContainerHover, b === -1 && d.mediaContainerHoverVisible] })]
				})
			]
		});
	}
