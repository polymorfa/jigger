__d("WAWebBusinessCategoryList.react", [
	"fbt",
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(6), n = e.onRemoveItem, a = e.selectedCategories, i;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (i = r("WAWebL10N").isRTL(), t[0] = i) : i = t[0];
		var l = i, d;
		t[1] !== n || t[2] !== a ? (d = a != null && a.length > 0 && u.jsxs(u.Fragment, { children: [u.jsx(o("WAWebFlex.react").FlexRow, {
		...
		}), u.jsx(r("WAWebGroupInfoSeparator.react"), {})] }), t[1] = n, t[2] = a, t[3] = d) : d = t[3];
		var m;
		return t[4] !== d ? (m = u.jsx(u.Fragment, { children: d }), t[4] = d, t[5] = m) : m = t[5], m;
	}
	l.default = d;
}), 226);
