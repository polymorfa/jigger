__d("WAWebBusinessHoursModal.react", [
	...
	function h(e) {
		var t, n, a, i, l, d, h = p((t = (n = e.businessHours) == null ? void 0 : n.mode) != null ? t : "specific_hours"), C = h[0], b = h[1], v = p((a = (i = e.businessHours) == null ? void 0 : i.days) != null ? a : []), S = v[0], R = v[1], L = (l = e.businessHours) == null ? void 0 : l.days, E = (d = e.businessHours) == null ? void 0 : d.mode, k = p(L), I = k[0], T = k[1], D = p(E), x = D[0], $ = D[1];
		e.businessHours && (L !== I || E !== x) && (T(L), $(E), b(E != null ? E : "specific_hours"), R(L != null ? L : []));
		var P = async function(n) {
			var t = [];
			S.forEach(function(e) {
				var n = e.closed, r = e.dayKey, a = e.hours;
				if (!n && o("WAWebBusinessProfileTypes").isBusinessHoursDayName(r)) {
					var i = _[r], l = f[C];
					i != null && l != null && (C === "specific_hours" && a ? a.forEach(function(e) {
						var n = e[0], r = e[1], a = o("WAWebSmbUtilsTimeUtils").timeStringToMinutes(n), s = o("WAWebSmbUtilsTimeUtils").timeStringToMinutes(r);
						a != null && s != null || u(0, 151315), t.push({
							close_time: s,
							day_of_week: i,
							mode: l,
							open_time: a
			...
			try {
				var r;
				return await e.saveBusinessProfileGraphQL({ business_hours: {
			...
			if (o("WAWebBizProfileGatingUtils").bizProfileGraphQLMigrationEnabled()) return P(i);
			var l = {};
			S.forEach(function(e) {
				var t = e.dayKey, n = e.closed, r = e.hours;
				if (!n && o("WAWebBusinessProfileTypes").isBusinessHoursDayName(t)) {
					var a = { mode: C };
					C === "specific_hours" && r && (a.hours = r.map(function(e) {
						var t = e[0], n = e[1];
			...
			try {
				return await e.saveBusinessProfile({ businessHours: s }), null;
			} catch (e) {
				return "Failed to save business hours";
			}
		}, M = function(t) {
			b(t), t === "specific_hours" && R(function(e) {
			...
			R(function(e) {
				return e.map(function(e) {
					if (e.dayKey === t) {
						var n = !e.closed;
						return C === "specific_hours" && e.closed && !n && (!e.hours || e.hours.length === 0) ? babelHelpers.extends({}, e, {
							closed: n,
			...
			if (C !== a || S.length !== i.length) return !0;
			...
			if (C === "specific_hours") for (var e of S) {
			...
			return a ? S.every(function(e) {
				return e.closed;
			}) && (r = o("WAWebBusinessProfileSMBUserJourneyLogger").OperationType.REMOVE) : r = o("WAWebBusinessProfileSMBUserJourneyLogger").OperationType.ADD, o("WAWebBusinessProfileSMBUserJourneyLogger").BusinessProfileUserJourneyLogger.saveBusinessHours(r), N();
		};
			...
			children: [
				...
				c.jsx("div", {
					...
					children: c.jsx(o("WAWebMenuBar.react").MenuBarItem, {
						...
						text: o("WAWebBusinessHoursUtils").getModeDisplayName(C).toString(),
						title: o("WAWebBusinessHoursUtils").getModeDisplayName(C),
