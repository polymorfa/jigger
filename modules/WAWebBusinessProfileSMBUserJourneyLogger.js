__d("WAWebBusinessProfileSMBUserJourneyLogger", [
	"$InternalEnum",
	...
	var e = {
		...
		function t() {}
		var n = t.prototype;
		return n.viewProfile = function(t) {
			this.$1(babelHelpers.extends({ action: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.VIEW }, t != null ? { entryPoint: t } : {}));
		}, n.clickBusinessName = function() {
			this.$1({
				action: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.CLICK,
			...
			r != null && (t.radius = r), a != null && (t.has_location_notes = a), this.$1({
				action: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.CLICK,
				extraAttributes: t,
			...
			var e = o("WAWebBusinessProfileUtils").getEditOperationType(t.description, n.description);
			e != null && this.saveBizDescription(e);
			var r = o("WAWebBusinessProfileUtils").getEditOperationType(t.address, n.address), a = t.serviceAreaRadius !== n.serviceAreaRadius, i = t.locationNotes !== n.locationNotes;
			if (r != null || a || i) {
				var l = n.locationNotes != null && n.locationNotes !== "";
				this.saveAddress(r != null ? r : s.UNCHANGED, n.serviceAreaRadius, l);
			}
			var u = o("WAWebBusinessProfileUtils").getEditOperationType(t.email, n.email);
			u != null && this.saveEmail(u);
			var c = o("WAWebBusinessProfileUtils").getEditOperationType(t.primaryWebsite, n.primaryWebsite);
			c != null && this.savePrimaryWebsite(c);
			var d = o("WAWebBusinessProfileUtils").getEditOperationType(t.secondaryWebsite, n.secondaryWebsite);
			d != null && this.saveSecondaryWebsite(d);
			var m = function(t) {
				return t === "0" ? "" : t;
			}, p = o("WAWebBusinessProfileUtils").getEditOperationType(m(t.priceTier), m(n.priceTier));
			p != null && this.savePriceRange(p);
		}, n.$1 = function(t) {
			o("WAWebSMBUserJourneyLogger").SMBUserJourneyLogger.log({
				entryPoint: t.entryPoint,
				extraAttributes: t.extraAttributes,
				featureName: o("WAWebWamEnumSmbFeatureNameEnum").SMB_FEATURE_NAME_ENUM.BUSINESS_PROFILE,
				surface: o("WAWebWamEnumSurfaceType").SURFACE_TYPE.EDIT_BIZ_PROFILE,
