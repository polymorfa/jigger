__d("WAWebBuyerEventLogger", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = t.attributes, r = t.bizPlatform, a = t.interaction, i = t.isLoggingEnabled, l = t.psFunnelId;
			if (i) {
				var s = new (o("WAWebP2XFunnelIdGenerator")).P2XFunnelIdGenerator(l, e), u = yield s.genFunnelInfo(), c = u.funnel_id, d = o("WAWebBuyerEventAttributes").buyerEventAttributesToObject(n);
				d.order_funnel_id = c;
				var m = new (o("WAWebStructuredMessageBuyerInteractionWamEvent")).StructuredMessageBuyerInteractionWamEvent({
					bizPlatform: r,
