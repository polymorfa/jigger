__d("WAWebCTWABizDataSharingJob", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var t = yield o("WASmaxBizSettingsGetPrivacySettingRPC").sendGetPrivacySettingRPC();
			e: {
				var n = t;
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = t != null ? {
				anyValue: e,
				anyVersion: t
			} : { anyValue: e }, r = { smbDataSharingSettingMixinArgs: n }, a = yield o("WASmaxBizSettingsSetPrivacySettingRPC").sendSetPrivacySettingRPC(r);
			switch (a.name) {
	...
	l.getCtwaBizDataSharingSettingJob = c, l.setCtwaBizDataSharingSettingJob = m;
}), 98);
