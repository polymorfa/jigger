__d("WAWebCTWASuggestionCollection", [
	"WATimeUtils",
	"WAWebBaseCollection",
	...
	var e = (function(e) {
		...
		var n = t.prototype;
		return n.findFirstNotExpired = function() {
			...
			var e = this.get(t);
			e != null && e.set("suggestion", babelHelpers.extends({}, e.suggestion, { nuxData: n }));
		}, n.updateTrackingCoolOffData = function(t, n) {
			var e = this.get(t);
			e != null && e.set("suggestion", babelHelpers.extends({}, e.suggestion, { coolOffData: n }));
		}, t;
