__d("WAWebCallInfoUserJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ CallInfoUserJourney: [
		6034,
		{
			appSessionId: [1, e.TYPES.STRING],
			callGroupSizeBucket: [2, o("WAWebWamEnumCallSizeBucket").CALL_SIZE_BUCKET],
			...
			participantActionSource: [10, o("WAWebWamEnumParticipantActionSource").PARTICIPANT_ACTION_SOURCE],
			preCallActionType: [5, o("WAWebWamEnumPreCallActionType").PRE_CALL_ACTION_TYPE],
