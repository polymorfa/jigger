__d("WAWebCallLinkActionEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ CallLinkActionEvent: [
		3852,
		{
			appSessionId: [5, e.TYPES.STRING],
			callLinkAction: [1, o("WAWebWamEnumCallLinkAction").CALL_LINK_ACTION],
			callLinkActionEntryPoint: [2, o("WAWebWamEnumCallLinkActionEntryPoint").CALL_LINK_ACTION_ENTRY_POINT],
			callLinkMedia: [3, o("WAWebWamEnumCallLinkMedia").CALL_LINK_MEDIA],
			callLinkShareChatType: [6, o("WAWebWamEnumCallLinkShareChatType").CALL_LINK_SHARE_CHAT_TYPE],
