__d("WAWebCallLinkDownloadArrowIcon.react", ["react", "react-compiler-runtime"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = o("react-compiler-runtime").c(5), n = e.height, r = e.width, a = n === void 0 ? 16 : n, i = r === void 0 ? 16 : r, l, u;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (l = s.jsx("path", {
			fillRule: "evenodd",
			clipRule: "evenodd",
			...
			fill: "currentColor"
		}), t[0] = l, t[1] = u) : (l = t[0], u = t[1]);
		var c;
		return t[2] !== a || t[3] !== i ? (c = s.jsxs("svg", {
			"aria-hidden": !0,
			width: i,
			height: a,
			viewBox: "0 0 16 16",
