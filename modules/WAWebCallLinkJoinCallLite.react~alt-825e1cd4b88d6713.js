__d("WAWebCallLinkJoinCallLite.react", [
	...
	function C(t) {
		var a = t.callType, i = t.idHash, l = t.locales;
		h(a, i);
		var u = o("useWAWebTimeout").useManualTimeout(function() {
			document.visibilityState === "visible" && (window.location.href = _);
		}), d = u[0], p = m(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			window.location.href = b(a, i), d(g);
		}), [
			a,
			i,
			d
		]), C = m(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			window.location.href = _;
		}), []), v = m(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
