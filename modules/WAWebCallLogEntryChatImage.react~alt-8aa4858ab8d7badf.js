__d("WAWebCallLogEntryChatImage.react", [
	...
	function m(e) {
		var t, n, a = e.msg, i = e.size, l = i === void 0 ? "small" : i, c = u(r("WAWebVoipUiContext")), m = c.uiHeight, p = o("useWAWebMsgValues").useMsgValues(a.id, [
			o("WAWebMsgGetters").getIsGroupMsg,
			o("WAWebMsgGetters").getCallParticipants,
			o("WAWebMsgGetters").getCallOutcome
		]), _ = p[0], f = p[1], g = p[2], h = o("WAWebFrontendMsgGetters").getChat(a), y = (t = f == null ? void 0 : f.some(function(e) {
			return e.participant.isLid();
		})) != null ? t : !1, C = y ? o("WAWebUserPrefsMeUser").getMeLidUserOrThrow() : o("WAWebUserPrefsMeUser").getMePnUserOrThrow_DO_NOT_USE(), b = l === "small" ? 49 : l === "large" ? 100 : l === "auto" ? null : (function() {
			throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + l);
		})(), v = (n = f == null ? void 0 : f.map(function(e) {
			return e.participant;
		}).filter(function(e) {
			return !e.equals(C);
		})) != null ? n : [];
		if (v.length > 0 && !h.id.isGroup() && g !== o("WAWebCallLogMsgData.flow").CallOutcome.Ongoing) {
		...
		var R = l === "small" ? o("WAWebDetailImage.react").DetailImageQuality.Low : l === "large" || l === "auto" ? o("WAWebDetailImage.react").DetailImageQuality.High : (function() {
			throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + l);
