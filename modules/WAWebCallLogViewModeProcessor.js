__d("WAWebCallLogViewModeProcessor", [
	"WAWebBoolFunc",
	"WAWebCreateViewModeProcessor",
	"WAWebMsgType",
	"WAWebViewMode.flow"
], (function(t, n, r, o, a, i, l) {
	var e, s, u, c, d = (e = o("WAWebCreateViewModeProcessor")).createViewModeProcessor({
		type: (s = o("WAWebViewMode.flow")).ViewModeType.HISTORY_SYNCED_CALL_LOG,
	...
	l.HistorySyncedCallLogViewModeProcessor = d, l.CallLogOfflineResumeViewModeProcessor = m, l.CallLogOfflineResumePromotedViewModeProcessor = p, l.CallLogAdHocGroupCallViewModeProcessor = _;
}), 98);
