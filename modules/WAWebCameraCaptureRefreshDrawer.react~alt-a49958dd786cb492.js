__d("WAWebCameraCaptureRefreshDrawer.react", [
	...
	function _() {
		var e = p(null), t = e[0], n = e[1], r = d(function(e) {
			n(e);
		}, []);
		return [t, r];
	}
	...
	function y(e) {
		var t = e.onClose, n = e.onDownload, o = e.toolbarRef;
		return u.jsxs("header", {
			className: "x9f619 x78zum5 x1okw0bk x6s0dn4 x1qughib x1peatla x1280gxy x1iw51ew xde1mab",
			children: [
	...
	function C(e) {
		var t = e.onClick;
		return u.jsx("div", {
			className: "x10l6tqk x1ey2m1c xbudbmw xuuh30 xzkaem6 x15yg21f xnnlda6 x1c9tyrk xeusxvb x1pahc9y x1ertn4p x6ikm8r x10wlt62 xapdjt xr6f91l x5rv0tg x1akc3lz xikp0eg x1xl5mkn x1mfml39 x1l5mzlr xgmdoj8 x1f1wgk5 x1x3ic1u x1vwxpen",
			children: u.jsx(r("WAWebUnstyledButton.react"), {
				...
				onClick: t,
				children: u.jsx(r("WDSIconIcDelete.react"), { "aria-hidden": !0 })
			})
		});
	}
	C.displayName = C.name + " [from " + i.id + "]";
	function b(e) {
		var t = e.isActive, n = e.label;
		return u.jsx(r("WAWebUnstyledButton.react"), {
			xstyle: [g.modeBtn, t ? g.modeBtnActive : g.modeBtnHover],
