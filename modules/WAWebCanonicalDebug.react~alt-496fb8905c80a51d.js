__d("WAWebCanonicalDebug.react", [
	...
	function y() {
		var e = _("idle"), t = e[0], a = e[1], i = _("idle"), l = i[0], s = i[1], c = _(null), g = c[0], h = c[1], y = d(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			a("validating");
			var e = yield o("WAWebCanonicalUserValidQuery").fetchCanonicalUserValid();
			a(e);
		}), []), C = d(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			s("sending"), h(null);
			try {
				o("WAWebCanonicalUtils").setDebugForceTokenRefresh(!0), yield o("WAWebCanonicalRecoveryActions").requestNonceFromPrimary(), s("awaiting_response"), self.setTimeout(function() {
					s(function(e) {
						return e === "awaiting_response" ? "timed_out" : e;
					});
				}, f);
			} catch (e) {
				o("WAWebCanonicalUtils").setDebugForceTokenRefresh(!1), s("idle"), h(String(e));
			}
		}), []), S = p(null);
		m(function() {
			if (l !== "awaiting_response") {
				S.current != null && (self.clearInterval(S.current), S.current = null);
				return;
			}
			return S.current = self.setInterval(function() {
			...
			children: [
				...
				u.jsxs(o("WAWebFlex.react").FlexRow, {
					...
					children: [
						...
						l === "received" && u.jsx(r("WDSButton.react"), {
							onPress: k,
							label: "Reload App"
						})
					]
				...
				l === "sending" && u.jsxs(o("WAWebFlex.react").FlexRow, {
					xstyle: I.spinnerRow,
				...
				l === "awaiting_response" && u.jsxs("div", {
