__d("WAWebCanonicalEntRecoveryCompanionWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumCanonicalEntEventMarker",
	"WAWebWamEnumCanonicalEntRecoveryCompanionEvent"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ CanonicalEntRecoveryCompanion: [
		7434,
		{
			canonicalEntEventCompanionMarker: [1, o("WAWebWamEnumCanonicalEntEventMarker").CANONICAL_ENT_EVENT_MARKER],
			canonicalEntFeatureName: [8, e.TYPES.STRING],
			canonicalEntRecoveryCompanionEvent: [2, o("WAWebWamEnumCanonicalEntRecoveryCompanionEvent").CANONICAL_ENT_RECOVERY_COMPANION_EVENT],
			...
			canonicalEntSequenceNumberSinceLastRegistration: [7, e.TYPES.INTEGER],
