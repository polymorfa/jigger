__d("WAWebCanonicalHatchLinkedStatusGetQuery", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e, t, n, r, a, i = yield o("WAWebRelayClient").fetchQuery(s, {}, { environmentType: "whatsapp_web" }), l = i == null || (e = i.wa_genai_hatch_channel_metadata) == null ? void 0 : e.linked_status;
			return l == null ? null : {
