__d("WAWebCappingWarningBannerLoadable", [
	...
	var e, s = e || (e = o("react")), u = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebCappingWarningBanner.react").__setRef("WAWebCappingWarningBannerLoadable").load();
		return e.CappingWarningBanner;
	}), "CappingWarningBanner"), c = r("WAWebLoadable")({
		loader: u,
		loading: function(t) {
