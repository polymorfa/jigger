__d("WAWebCaptureDrawer.react", [
	...
	function k(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, p), l = i.chat, _ = i.disposeStream, g = i.onBack, v = i.onCaptured, k = i.onSend, I = s._(
			/*BTDS*/
			""
		), T = C(null), D = C(null), x = C(null), $ = C(null), P = b(void 0), N = P[0], M = P[1], w = b(void 0), A = w[0], F = w[1], O = b(o("WAWebCaptureTypes").CaptureState.ANIMATING), B = O[0], W = O[1], q = b(void 0), U = q[0], V = q[1], H = r("useWAWebStableCallback")(function(e, t) {
			if (!e) {
				B === o("WAWebCaptureTypes").CaptureState.ANIMATING && W(o("WAWebCaptureTypes").CaptureState.LOADING);
				return;
			}
			D.current == null || D.current(), D.current = t, W(o("WAWebCaptureTypes").CaptureState.LOADING), V(e), o("WAWebMediaCapture").isSrcObjectInVideoElement() || (e ? (E(x), x.current = window.URL.createObjectURL(e)) : E(x));
			...
			return new (o("WAShiftTimer")).ShiftTimer(function(e) {
				var t = e.disposeStream, n = e.stream;
				n && t && (D.current == null || D.current()), o("WAWebMediaCapture").isSrcObjectInVideoElement() || E(x);
			});
		}), j = function() {
			l && l.setAttachMediaContents(null);
		}, K = r("useWAWebUnmountSignal")();
		h(function() {
			return G.current.onOrBefore(300, {
				stream: i.stream,
				disposeStream: i.disposeStream
			}), l && l.setIsCameraCaptureDrawerOpen(!0), function() {
				G.current.cancel(), E(x), _ == null || _(), T.current && T.current.logCancel(), l && l.setIsCameraCaptureDrawerOpen(!1), j();
			};
		}, []), h(function() {
		...
		var X = function() {
			...
			if (t != null) {
				...
				if (n != null) {
					...
					if (i.translate(a.width, 0), i.scale(-1, 1), t.drawFrameToContext(i, 0, 0, n.width, n.height), v) o("WAWebCanvasUtils").canvasToBlob(a).then(function(e) {
						K.aborted || v(e);
					});
					else {
						z.current.onOrBefore(500, {
							stream: U,
							disposeStream: _
						});
						var s = new (o("WAWebWamMediaPickerStatsLogger")).MediaPickerStatsLogger();
						s.logAdd(L, "image", o("WAWebWamEnumMediaPickerOriginType").MEDIA_PICKER_ORIGIN_TYPE.MENU_CAMERA_CAPTURE), s.chatRecipients = l != null && l.groupMetadata ? l.groupMetadata.participants.length : 1, T.current = s;
						var u = a.toDataURL("image/jpeg"), c = o("WAWebDataUrlToBlob").dataURLtoBlob(u);
						if (l) {
							l.attachMediaContents || l.setAttachMediaContents(new (r("WAWebAttachMediaCollection"))({ chatParticipantCount: l.getParticipantCount() }));
							var d = r("nullthrows")(l.attachMediaContents);
							d.processAttachmentsForChat([{ file: o("WAWebFileUtils").createFile([c], "", { type: "image/jpeg" }) }], void 0, l);
						}
						M(u), W(o("WAWebCaptureTypes").CaptureState.SENDING), V(void 0);
					}
				}
			}
		}, Y = function() {
			...
			D.current = n, t.then(function(e) {
				e && (o("WAWebMediaCapture").isSrcObjectInVideoElement() || (x.current = window.URL.createObjectURL(e)), V(e));
			}).catch(o("WAFilteredCatch").filteredCatch(o("WAWebGetUserMediaErrors").NotAllowedError, function() {
				var e;
				g(), o("WAWebModalManager").ModalManager.open(f.jsx((e = o("WAWebGuidePopup.react")).GuidePopup, {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				...
				var n = (t == null ? void 0 : t.isViewOnce) === !0, a = (t == null ? void 0 : t.isWamoSub) === !0;
				if (!k) o("WALogger").ERROR(c || (c = babelHelpers.taggedTemplateLiteralLoose(["Assertion failed!"]))).sendLogs("capture-drawer-no-onSend");
				else if (e.length === 0) o("WALogger").ERROR(d || (d = babelHelpers.taggedTemplateLiteralLoose(["Assertion failed!"]))).sendLogs("capture-drawer-no-img");
				else {
					var i = r("nullthrows")(e[0]), s = i.groupMentions, u = i.media, m = i.mentionedJidList, p = u.file;
		...
		var ee, te, ne, re, oe = i.theme === "capture-cover" ? "cover" : "contain";
		switch (B) {
			case o("WAWebCaptureTypes").CaptureState.ANIMATING:
			case o("WAWebCaptureTypes").CaptureState.LOADING: if (re = f.jsx(o("WAWebSpinner.react").Spinner, {
				stroke: 4,
				size: 50
			}), B === o("WAWebCaptureTypes").CaptureState.ANIMATING) break;
			case o("WAWebCaptureTypes").CaptureState.RECORDING: {
				...
				}[!!(U && B === o("WAWebCaptureTypes").CaptureState.LOADING) << 0], ie = U ? f.jsx(r("WAWebVideo.react"), {
					autoPlay: !0,
					ref: $,
					onPlaying: Y,
				...
				}, "webcam") : null, ee = B === o("WAWebCaptureTypes").CaptureState.RECORDING ? f.jsx("div", {
			...
			case o("WAWebCaptureTypes").CaptureState.SENDING: {
				if (ne = f.jsx(r("WAWebObjectFit.react"), {
					type: oe,
					size: A,
					children: f.jsx("img", {
						alt: "",
					...
					var le = r("nullthrows")(l.attachMediaContents);
					ne = f.jsx(o("WAWebMediaEditorForChatLoadable.react").MediaEditorForChatLoadable, {
			...
			default: o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["captureDrawer:render Unhandled video capture state ", ""])), B);
		}
		var se = f.jsx("div", {
