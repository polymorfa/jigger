__d("WAWebCaptureMediaDrawerLoadable", [
	...
	var e, s = e || (e = o("react")), u = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebCaptureMediaDrawer.react").__setRef("WAWebCaptureMediaDrawerLoadable").load();
		return e;
	}), "CaptureMediaDrawer"), c = r("react-loadable")({
		loader: u,
		loading: function(t) {
