__d("WAWebCatalogBizWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ CatalogBiz: [
		1722,
		{
			adId: [19, e.TYPES.STRING],
			cartToggle: [13, e.TYPES.BOOLEAN],
			catalogAppealReason: [4, e.TYPES.STRING],
			catalogBizAction: [1, o("WAWebWamEnumCatalogBizAction").CATALOG_BIZ_ACTION],
			catalogEntryPoint: [7, o("WAWebWamEnumCatalogEntryPoint").CATALOG_ENTRY_POINT],
			...
			deepLinkOpenFrom: [8, o("WAWebWamEnumDeepLinkOpenFrom").DEEP_LINK_OPEN_FROM],
			...
			lastMessageDirection: [21, o("WAWebWamEnumLastMessageDirection").LAST_MESSAGE_DIRECTION],
