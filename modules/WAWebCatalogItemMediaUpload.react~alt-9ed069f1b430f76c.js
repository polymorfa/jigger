__d("WAWebCatalogItemMediaUpload.react", [
	...
	function C(t) {
		var a = t.error, i = t.maxImageCount, l = i === void 0 ? h : i, s = t.onChange, c = t.ref, f = _([]), g = f[0], C = f[1], b = p(null), v = p(null);
		d(function() {
			return function() {
		...
		var S = function() {
			...
			if (e.length !== 0) {
				var n = l - g.length, r = e.slice(0, n), o = r.map(function(e) {
					return {
						file: e,
						url: URL.createObjectURL(e)
					};
				}), a = [].concat(g, o);
				C(a), s(a.map(function(e) {
					return e.file;
				}));
			}
		}, L = function(t) {
			...
			children: [
				u.jsxs("div", {
					...
					children: [g.map(function(e, t) {
						...
						"data-invalid": a != null ? "true" : void 0,
						"aria-describedby": a != null ? "biz_catalog_media_upload_error" : void 0,
