	...
	var e = (function(e) {
		...
		return a.initialize = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t, n = this.id;
				this.maybeUpdateLastUsedCountryCode((t = e.complianceInfo) == null ? void 0 : t.countryCodeOrigin);
				var a = yield o("WAWebBizProductCatalogAction").addProduct({ product: e });
				a.catalogWid = n;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t, n = yield o("WAWebBizProductCatalogAction").editProduct(e);
				this.maybeUpdateLastUsedCountryCode((t = e.complianceInfo) == null ? void 0 : t.countryCodeOrigin);
				var a = this.productCollection.add(n, { merge: !0 })[0];
				return this.collections && this.collections.forEach(function(t) {
					t.productCollection.get(e.id) && t.productCollection.add(n, { merge: !0 });
				}), r("nullthrows")(a);
			});
			function t(t) {
				return e.apply(this, arguments);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				t && (t.stale = !0);
				var n = yield o("WAWebBizProductCatalogAction").queryProduct(this.id, e);
				if (n.data != null) {
					var r = o("WAWebBizProductCatalogBridge").mapProductResponseToModel(n.data, this.id);
					t && this.productCollection.add(r, { merge: !0 }), this.collections && this.collections.forEach(function(t) {
						t.productCollection.get(e) && t.productCollection.add(r, { merge: !0 });
					});
				}
			});
			function t(t) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = yield o("WAWebBizProductCatalogAction").queryProduct(this.id, e, void 0, void 0, void 0, t);
				if (n.error === "NOT_FOUND" && this.productCollection.remove(e), n.data != null) {
					var r = new (o("WAWebProductModel")).Product(o("WAWebBizProductCatalogBridge").mapProductResponseToModel(n.data, this.id));
