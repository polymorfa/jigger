__d("WAWebCatalogModel", [
	...
	var e = (function(e) {
		...
		return n.initialize = function() {
			...
			this._products && this.productCollection.add(this._products, { merge: !0 }), this._products = void 0;
		}, n.triggerMsgUpdate = function() {
			this._msgs && this.msgProductCollection.add(this._msgs, { merge: !0 }), this._msgs = void 0;
			...
			var e, n = this.id;
			this.maybeUpdateLastUsedCountryCode((e = t.complianceInfo) == null ? void 0 : e.countryCodeOrigin);
			var a = await o("WAWebBizProductCatalogAction").addProduct({ product: t });
			a.catalogWid = n;
			var i = this.productCollection.add(a, {
				merge: !0,
				at: 0
			})[0];
			return r("nullthrows")(i);
		}, n.editProduct = async function(t) {
			var e, n = await o("WAWebBizProductCatalogAction").editProduct(t);
			this.maybeUpdateLastUsedCountryCode((e = t.complianceInfo) == null ? void 0 : e.countryCodeOrigin);
			var a = this.productCollection.add(n, { merge: !0 })[0];
			return this.collections && this.collections.forEach(function(e) {
				e.productCollection.get(t.id) && e.productCollection.add(n, { merge: !0 });
			}), r("nullthrows")(a);
		}, n.refreshProduct = async function(t) {
			var e = this.productCollection.get(t);
			e && (e.stale = !0);
			var n = await o("WAWebBizProductCatalogAction").queryProduct(this.id, t);
			if (n.data != null) {
				var r = o("WAWebBizProductCatalogBridge").mapProductResponseToModel(n.data, this.id);
				e && this.productCollection.add(r, { merge: !0 }), this.collections && this.collections.forEach(function(e) {
					e.productCollection.get(t) && e.productCollection.add(r, { merge: !0 });
				});
			}
		}, n.maybeUpdateLastUsedCountryCode = function(t) {
			t != null && (this.lastUsedCountryCode = t);
		}, n.pullProduct = async function(t, n) {
			var e = await o("WAWebBizProductCatalogAction").queryProduct(this.id, t, void 0, void 0, void 0, n);
			if (e.error === "NOT_FOUND" && this.productCollection.remove(t), e.data != null) {
				var r = new (o("WAWebProductModel")).Product(o("WAWebBizProductCatalogBridge").mapProductResponseToModel(e.data, this.id));
				r.variantInfo != null && this.productCollection.get(r.id) == null && (r.displayPriority = 1), this.updateProduct(r);
			}
		}, n.updateProduct = function(t) {
			if (this.productCollection.add(t, { merge: !1 }), t.variantInfo != null) {
			...
			return this.productCollection.findFirst(function(e) {
				return !e.isHidden && e.isSanctioned !== !0 && e.reviewStatus === "APPROVED";
			});
		}, t;
