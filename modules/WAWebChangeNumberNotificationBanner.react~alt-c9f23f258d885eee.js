__d("WAWebChangeNumberNotificationBanner.react", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield o("WAWebFindChatAction").findOrCreateLatestChat(e, "changeNumberNotificationClick"), r = n.chat;
	...
	l.onChangeNumberNotificationClick = d, l.ChangeNumberNotificationBanner = p, l.useChangeNumberNotificationBanner = _;
}), 226);
