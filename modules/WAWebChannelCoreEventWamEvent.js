__d("WAWebChannelCoreEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ChannelCoreEvent: [
		4692,
		{
			channelCoreEventSequenceNumber: [8, e.TYPES.INTEGER],
			channelCoreEventType: [1, o("WAWebWamEnumChannelEventType").CHANNEL_EVENT_TYPE],
			...
			channelEntryPoint: [2, o("WAWebWamEnumChannelEntryPoint").CHANNEL_ENTRY_POINT],
			channelEntryPointApp: [3, o("WAWebWamEnumChannelEntryPointApp").CHANNEL_ENTRY_POINT_APP],
			channelEntryPointMetadata: [10, o("WAWebWamEnumChannelEntryPointMetadata").CHANNEL_ENTRY_POINT_METADATA],
			channelEventUnit: [12, o("WAWebWamEnumChannelEventUnit").CHANNEL_EVENT_UNIT],
			channelRequestMetadata: [19, e.TYPES.STRING],
			cid: [4, e.TYPES.STRING],
			coreEventTrigger: [21, o("WAWebWamEnumCoreEventTriggerType").CORE_EVENT_TRIGGER_TYPE],
			...
			eventSurface: [6, o("WAWebWamEnumChannelEventSurface").CHANNEL_EVENT_SURFACE],
