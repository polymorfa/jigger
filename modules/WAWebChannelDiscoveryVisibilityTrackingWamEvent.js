__d("WAWebChannelDiscoveryVisibilityTrackingWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ChannelDiscoveryVisibilityTracking: [
		5766,
		{
			...
			channelEventUnit: [4, o("WAWebWamEnumChannelEventUnit").CHANNEL_EVENT_UNIT],
			...
			pillSelected: [11, o("WAWebWamEnumChannelDirectoryPillSelected").CHANNEL_DIRECTORY_PILL_SELECTED],
