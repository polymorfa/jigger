__d("WAWebChannelMessageVisibilityTrackingWamEvent", ["WAWebWamCodegenUtils", "WAWebWamEnumChannelUserType"], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ChannelMessageVisibilityTracking: [
		5998,
		{
			aiProvenanceLabelEnabled: [13, e.TYPES.BOOLEAN],
			aiProvenanceLabelShown: [14, e.TYPES.BOOLEAN],
			channelUserType: [10, o("WAWebWamEnumChannelUserType").CHANNEL_USER_TYPE],
