__d("WAWebChannelOpenWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ChannelOpen: [
		4316,
		{
			...
			channelEntryPoint: [1, o("WAWebWamEnumChannelEntryPoint").CHANNEL_ENTRY_POINT],
			channelEntryPointMetadata: [9, o("WAWebWamEnumChannelEntryPointMetadata").CHANNEL_ENTRY_POINT_METADATA],
			channelSessionId: [3, e.TYPES.INTEGER],
			channelUserType: [4, o("WAWebWamEnumChannelUserType").CHANNEL_USER_TYPE],
			cid: [6, e.TYPES.STRING],
			deeplinkSource: [20, o("WAWebWamEnumDeeplinkSource").DEEPLINK_SOURCE],
