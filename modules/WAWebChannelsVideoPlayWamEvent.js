__d("WAWebChannelsVideoPlayWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumVideoPlayOrigin",
	"WAWebWamEnumVideoPlayResult",
	"WAWebWamEnumVideoPlayType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ChannelsVideoPlay: [
		6556,
		{
			...
			videoPlayOrigin: [7, o("WAWebWamEnumVideoPlayOrigin").VIDEO_PLAY_ORIGIN],
			videoPlayResult: [8, o("WAWebWamEnumVideoPlayResult").VIDEO_PLAY_RESULT],
			videoPlayT: [9, e.TYPES.INTEGER],
			videoPlayType: [10, o("WAWebWamEnumVideoPlayType").VIDEO_PLAY_TYPE],
