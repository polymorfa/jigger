	...
	var e = (function(e) {
		...
		return n.getVersion = function() {
			...
			var e = this, n = o("WATimeUtils").unixTimeMs(), r = await Promise.all(t.map(async function(t) {
				var r = t.agentId, a = t.chatId, i = t.chatOpenedByAgent, l = { chatAssignmentOpenedStatus: { chatOpened: i } };
				return o("WAWebSyncdActionUtils").buildPendingMutation({
					timestamp: n,
					collection: e.collectionName,
					operation: o("WAWebProtobufsServerSync.pb").SyncdMutation$SyncdOperation.SET,
					indexArgs: [await o("WAWebSyncdGetChat").getChatJidMutationIndexForChat(o("WAWebWidFactory").createWid(a), o("WAWebSyncdConst").Actions.ChatAssignmentOpenedStatus), r],
					value: l,
			...
			var e = this, n = [], r = await Promise.all(t.map(async function(t) {
				try {
					var r = t.indexParts, a = r[1], i = r[2];
					if (a == null || i == null) return e.malformedActionIndex();
					if (t.operation === "set") {
						var l = await o("WAWebSyncdGetChat").resolveChatForMutationIndex(o("WAWebWidFactory").createWid(a));
						if (!l.success) return {
							actionState: o("WAWebSyncdConst").SyncActionState.Orphan,
							orphanModel: l.orphanModel
						};
						var s = o("WAWebWidFactory").createWid(l.chat.id), u = t.value.chatAssignmentOpenedStatus;
						if (!u) return o("WAWebSyncdIndexUtils").malformedActionValue(e.collectionName);
						var c = u.chatOpened;
						if (c == null) return o("WAWebSyncdIndexUtils").malformedActionValue(e.collectionName);
			...
			return await o("WAWebBizChatAssignmentOpenedAction").updateLocalOpenedState(n), r;
		}, t;
