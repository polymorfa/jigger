__d("WAWebChatAssignmentSync", [
	...
	var e, s = (function(t) {
		...
		return i.getVersion = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var r = this, a = o("WATimeUtils").unixTimeMs(), i = yield (e || (e = n("Promise"))).all(t.map((function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						var t = e.agentId, n = e.chatId, i = { chatAssignment: { deviceAgentId: t } };
						return o("WAWebSyncdActionUtils").buildPendingMutation({
							timestamp: a,
							collection: r.collectionName,
							operation: o("WAWebProtobufsServerSync.pb").SyncdMutation$SyncdOperation.SET,
							indexArgs: [yield o("WAWebSyncdGetChat").getChatJidMutationIndexForChat(o("WAWebWidFactory").createWid(n), o("WAWebSyncdConst").Actions.ChatAssignment)],
							value: i,
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var a = this, i = [], l = [], s = [], u = yield (e || (e = n("Promise"))).all(t.map((function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						try {
							var t = e.indexParts, n = t[1];
							if (!n) return a.malformedActionIndex();
							if (e.operation === "set") {
								var u, c = e.value.chatAssignment;
								if (!c) return o("WAWebSyncdIndexUtils").malformedActionValue(a.collectionName);
								...
								var p = yield o("WAWebSyncdGetChat").resolveChatForMutationIndex(o("WAWebWidFactory").createWid(n));
								if (!p.success) return {
									actionState: o("WAWebSyncdConst").SyncActionState.Orphan,
								...
								return o("WAWebChatAssignmentCollection").ChatAssignmentCollection.getAgentCollectionForChatId(_).filter(function(e) {
									...
									agentId: d,
									chatOpenedByAgent: !1
								}), r("WAWebSyncBootstrap").isSyncDBootstrapInProcess() || s.push({
									chatId: _,
									agent: m,
				...
				yield o("WAWebSchemaChatAssignment").getChatAssignmentTable().bulkCreateOrMerge(i), o("WAWebChatAssignmentCollection").ChatAssignmentCollection.processChatAssignments(i), yield o("WAWebSchemaChatAssignment").getChatAssignmentTable().bulkRemove(l), o("WAWebChatAssignmentCollection").ChatAssignmentCollection.remove(l), o("WAWebBizChatAssignmentAction").createChatAssignmentSystemMsgs(s), o("WAWebBizChatAssignmentAction").triggerChatAssignmentNotification(i, t.map(function(e) {
					return e.timestamp;
				}).join("-"));
