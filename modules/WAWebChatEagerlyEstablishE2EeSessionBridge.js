	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			if (o("WAWebChatGetters").getIsGroup(t)) {
				var i = yield o("WAWebApiParticipantStore").getGroupSenderKeyList(t.id);
				...
				var p = yield o("WAWebSendMsgDatabaseJob").getFanOutListJob([].concat(l.list, [m]), void 0, !0), _ = yield r("WAWebUserPrefsStatus").getStatusSkDistribList(p, { isFullAudience: !1 }), f = _.skDistribList;
				...
				n = yield o("WAWebSendMsgDatabaseJob").getFanOutListJob([g, o("WAWebUserPrefsMeUser").getMeDeviceLidOrThrow()]);
			}
			try {
				var h = t.id.isStatus() && o("WAWebStatusSessionGatingUtils").shouldUseStatusSessionForOutgoingMessage() ? o("WAWebSessionScope").SessionScope.STATUS : o("WAWebSessionScope").SessionScope.DEFAULT, y = yield o("WAWebManageE2ESessionsJob").ensureE2ESessions({
					identityChanged: !1,
					sessionScope: h,
					wids: n
				});
