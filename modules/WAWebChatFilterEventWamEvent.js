__d("WAWebChatFilterEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ChatFilterEvent: [
		1616,
		{
			actionType: [1, o("WAWebWamEnumChatFilterActionTypes").CHAT_FILTER_ACTION_TYPES],
			activitySessionId: [6, e.TYPES.STRING],
			filterType: [2, o("WAWebWamEnumChatFilterTypes").CHAT_FILTER_TYPES],
			...
			searchResultType: [4, o("WAWebWamEnumChatSearchResultType").CHAT_SEARCH_RESULT_TYPE],
			sessionId: [3, e.TYPES.INTEGER],
			targetScreen: [5, o("WAWebWamEnumChatFilterTargetScreen").CHAT_FILTER_TARGET_SCREEN],
