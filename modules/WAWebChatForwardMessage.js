__d("WAWebChatForwardMessage", [
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var a = t.appendedText, i = t.associationOptions, l = t.chat, u = t.includeCaption, c = u === void 0 ? !1 : u, d = t.msg, f = t.multicast, g = f === void 0 ? !1 : f;
			if (p(d) || o("WAWebFileUtils").isDocument(d)) return o("WAWebMediaForwardMediaMsg").forwardMediaMsg({
				appendedText: a,
				chat: l,
				includeCaption: c,
				msg: d,
			...
			var y = k(d, l);
			if (L(d) && (y.body == null || y.body === "")) return o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[chat forward message] skipping Hatch forward with empty body"]))).sendLogs("forward-hatch-empty-body"), null;
			if (o("WAWebBotUtils").isMetaAiBot(l.id)) {
				if (a != null && a !== "") {
					var C = y.body || "";
					C === "" ? y.body = a : y.body = C + _ + a;
				}
				if (o("WAWebBotGating").isAiChatThreadsEnabled()) return o("WAWebBotFrontendUtils").runMetaAiThreadsFlow(l, {
					type: "MetaAiForward",
					query: y.body
				});
			}
			var b = yield o("WAWebMsgDataUtils").genOutgoingMsgData(l, d.type), v = b.type, S = babelHelpers.objectWithoutPropertiesLoose(b, e), R = Object.assign(y, babelHelpers.extends({}, S, {
				participant: void 0,
				star: !1,
				isForwarded: o("WAWebMsgGetters").getShouldDisplayAsForwarded(d),
				forwardedFromWeb: !0,
				forwardingScore: o("WAWebMsgModelUtils").getMsgForwardingScoreWhenForwarded(d),
				multicast: g,
				messageSecret: o("WAWebMessagingGatingUtils").isReportingTokenSendingEnabled() && self.crypto.getRandomValues(new Uint8Array(32))
			}));
			if (r("WAWebWid").isNewsletter(l.id)) return o("WAWebNewsletterSendMsgAction").forwardNewsletterMessage(l, o("WAWebGetNewsletterContextForForwardedMsg").maybeStripNewsletterForwardMetadata({
				isQuestionOrQuestionReply: d.isQuestion || d.questionReplyQuotedMessage != null,
				forwardable: R,
				destination: l.id,
				source: d.id.remote,
				isOriginalMsgForwarded: d.isForwarded
			}));
			var E = yield h(R), I = o("WAWebSendMsgChatAction").addAndSendMsgToChat(l, E), T = I[0], D = I[1], x = yield (m || (m = n("Promise"))).all([T, D]), $ = x[0], P = x[1];
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				var i, l = yield r("WAWebMediaUploadMmsThumbnail")({
					thumbnail: yield r("WAWebMediaOpaqueData").createFromBase64Jpeg(a),
				...
				return (u == null ? void 0 : u.getMediaKey()) == null ? C(e) : babelHelpers.extends({}, e, {
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.appendedText, n = e.chat, a = e.includeCaption, i = a === void 0 ? !1 : a, l = e.msgs, s = e.multicast, u = s === void 0 ? !1 : s, m = n.contact;
			if (o("WAWebContactGetters").getIsUser(m) && m.isContactBlocked) throw new (r("WAWebContactBlockedErrorAction"))("Forwarded to contact is blocked", m);
			var _ = [];
			for (var g of l) {
				...
				try {
					...
					o("WAWebIncrementNewsletterForwardCounterAction").incrementNewsletterForwardCounter(g, n), b({
						chat: n,
						multicast: u,
						includeCaption: h,
						originalMsg: g,
						forwardedParentMsgId: C == null || (y = C.msg) == null ? void 0 : y.id
					}).catch(function(e) {
					...
					o("WALogger").WARN(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[chat forward message] error during forwarding message"]))), p(g) && _.push(g);
				}
			}
			return _;
	...
	function E(e, t) {
		var n;
		return L(e) ? (t.body = (n = o("WAWebGetPlainTextFromBotMsg").getPlainTextFromBotMsg(e, { includeBodyFallback: !1 })) != null ? n : "", t.type = o("WAWebMsgType").MSG_TYPE.CHAT, t.kind = o("WAWebMsgType").MsgKind.Chat, t.richResponse = void 0, t.unifiedResponse = void 0, t.unifiedResponseRawData = void 0, t.botSignatureVerificationMetadata = void 0, !0) : !1;
	}
	function k(e, t) {
		var n, a, i, l = new Set([
			"buttons",
