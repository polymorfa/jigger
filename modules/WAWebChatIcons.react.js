__d("WAWebChatIcons.react", [
	...
	function p(e) {
		var t = o("react-compiler-runtime").c(6), n = e.noMargin, r = e.noMarginRight, a = e.ref, i;
		t[0] !== n || t[1] !== r ? (i = {
		...
		}[(r === !0) << 1 | (n === !0) << 0], t[0] = n, t[1] = r, t[2] = i) : i = t[2];
		var l;
		return t[3] !== a || t[4] !== i ? (l = d.createElement("div", babelHelpers.extends({ ref: a }, i, {
			key: "icon-unread",
			"data-testid": "icon-unread-indicator",
			"aria-hidden": "true"
		})), t[3] = a, t[4] = i, t[5] = l) : l = t[5], l;
	}
	function _(t) {
