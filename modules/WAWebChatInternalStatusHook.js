__d("WAWebChatInternalStatusHook", [
	...
	function C(e) {
		var t = o("react-compiler-runtime").c(18), n = d(""), a = n[0], i = n[1], l;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (l = [], t[0] = l) : l = t[0];
		var s = d(l), f = s[0], h = s[1], C = c(), b = r("useWAWebUnmountSignal")(), v, S;
		t[1] !== e || t[2] !== b ? (v = function() {
			if (i(""), !!e.isRegularUser()) return r("WAPromiseRaceAbort")(o("WAWebTextStatusCollection").TextStatusCollection.find(e), b).then(function(e) {
				...
				t(), e.on(_, t), C.current = function() {
					return e.off(_, t);
				};
			}).catch(o("WAAbortError").catchAbort(r("WAWebNoop"))), (function() {
				C.current == null || C.current();
			});
		}, S = [e, b], t[1] = e, t[2] = b, t[3] = v, t[4] = S) : (v = t[3], S = t[4]), u(v, S);
		var R, L;
		if (t[5] !== a) {
			var E = a == null ? void 0 : a.match(/@(\w*)\b/);
			R = E == null ? void 0 : E[1].toLowerCase(), L = R != null && p.includes(R), t[5] = a, t[6] = R, t[7] = L;
		} else R = t[6], L = t[7];
		var k = L, I;
		t[8] !== k || t[9] !== a ? (I = k ? y(a) : !1, t[8] = k, t[9] = a, t[10] = I) : I = t[10];
		var T = I, D = R != null && T ? m[R] : null, x = !!D, $;
		return t[11] !== f || t[12] !== T || t[13] !== x || t[14] !== k || t[15] !== D || t[16] !== a ? ($ = {
			status: a,
			hasStatus: k,
			hasActiveStatus: T,
			overlay: D,
			hasOverlay: x,
			addons: f
		}, t[11] = f, t[12] = T, t[13] = x, t[14] = k, t[15] = D, t[16] = a, t[17] = $) : $ = t[17], $;
	}
	l.default = C;
}), 98);
