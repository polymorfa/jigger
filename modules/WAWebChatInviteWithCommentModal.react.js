__d("WAWebChatInviteWithCommentModal.react", [
	"fbt",
	"Promise",
	...
	var e = ["ref"], u, c, d = c || (c = o("react")), m = c, p = m.useRef, _ = m.useState, f = { onSendInvite: {
		position: "x10l6tqk",
	...
	function g(t) {
		var a, i = t.ref, l = babelHelpers.objectWithoutPropertiesLoose(t, e), c = l.onClose, m = l.onSend, g = l.wid, h = p(null), y = p(null), C = _(l.initialInviteComment.toString()), b = C[0], v = C[1], S = function() {
			c();
		}, R = function() {
			var e = o("WAWebProfilePicThumbCollection").ProfilePicThumbCollection.get(g);
			return new (u || (u = (n("Promise"))))(function(t) {
				if (!e || !e.img) {
					t(void 0);
					return;
				}
				r("WAWebPonyfillsFetch")(e.img).then(function(e) {
					if (!e.ok) {
						t(void 0);
						return;
					}
		...
		}), I = d.jsx(o("WAWebDetailImage.react").DetailImage, { id: l.wid }), T = d.jsx(o("WAWebEmojiText.react").EmojiText, { text: l.chatName });
		return d.jsx(o("WAWebModal.react").Modal, {
			ref: i,
			type: o("WAWebModal.react").ModalTheme.Invite,
			testid: "chat-invite-modal",
			children: d.jsxs(r("WAWebDrawer.react"), {
				...
				children: [d.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
					...
					title: (a = l.customTitle) != null ? a : s._(
						/*BTDS*/
						""
					),
					onCancel: S
					...
					l.customHeader,
					l.hideParticipantList === !0 ? null : d.jsx("div", {
						className: "xkgu5aw xyamay9 xgws4yx xxbrewl xzm8p2n x1odjw0f x1280gxy xso031l x1q0q8m5 x120ee7l",
					...
					d.jsx("div", {
						...
						children: d.jsx(o("WAWebRichTextField.react").RichTextField, {
							testid: "invite-message-caption-input",
							ref: y,
							value: b,
							showRemaining: !0,
							maxLength: o("WAWebMediaCaptionConstants").MAX_CAPTION_LENGTH,
							onChange: E,
