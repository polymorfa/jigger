__d("WAWebChatKeptByMsgInfoCell.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = e.contact, n = e.kicTimestampMs, a = e.theme, i = o("useWAWebContactValues").useContactValues(t.id, [
		...
		]), l = i[0], u = i[1], c = i[2], d = i[3], m = s.jsx(o("WAWebDetailImage.react").DetailImage, { id: l }), p;
		n != null && (p = o("WAWebClock").Clock.relativeDateAndTimeStr(n / 1e3));
		var _ = s.jsx("span", {
			title: p,
			children: p
		}), f;
		return !u && d && (f = s.jsx(o("WAWebEmojiText.react").EmojiText, {
			className: "xxayilr",
			direction: "auto",
			text: d
