__d("WAWebChatListFilters.react", [
	...
	function B(e) {
		var t = e.ref, n = babelHelpers.objectWithoutPropertiesLoose(e, y);
		return (!o("WAWebMobilePlatforms").isSMB() || o("WAWebListsGatingUtils").isListsEnabled()) && r("justknobx")._("2386") && o("WAWebABProps").getABPropConfigValue("wa_web_lists_full_width_filters") ? b.jsx(r("WAWebChatListFiltersDynamic.react"), babelHelpers.extends({ ref: t }, n)) : b.jsx(O, babelHelpers.extends({ ref: t }, n));
	}
