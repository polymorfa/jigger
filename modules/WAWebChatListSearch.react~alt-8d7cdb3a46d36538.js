__d("WAWebChatListSearch.react", [
	...
	function N(e) {
		var t = e.icon, n = e.iconContainerClass, r = e.kind, a = e.label, i = e.onClick, l = "chat_filter_" + (r || "");
		return b.jsx(o("WAWebDropdownItem.react").DropdownItem, {
			action: i,
			testid: l,
			children: b.jsxs("div", {
				className: "x9f619 x78zum5 x6s0dn4 x193iq5w x16ovd2e x1evaxtz x12xbjc7 xb0esv5 x6ikm8r x10wlt62 xhslqc4 x1ypdohk",
				children: [b.jsx("div", {
					className: n,
					children: t
				}), b.jsx("div", {
	...
	function M(e) {
		var t = e.updateSearchFilter, n = [];
		n.push(b.jsx(N, {
			icon: b.jsx(o("WAWebSearchUnreadIcon.react").SearchUnreadIcon, { iconXstyle: D.icon }),
			...
			onClick: function() {
				return t({ kind: o("WAWebChatSearchFilters").SearchFilters.UNREAD });
			}
		}, "unread")), o("WAWebInboxFiltersGatingUtils").inboxFavoritesEnabled() && n.push(b.jsx(N, {
			icon: b.jsx(r("WDSIconIcPerson.react"), { iconXstyle: D.icon }),
			...
			onClick: function() {
				return t({ kind: o("WAWebChatSearchFilters").SearchFilters.FAVORITES });
			}
		}, "favorites"));
		var a = r("useWAWebGetFeatureFlag")(o("WAWebFeatureFlagName").FeatureFlagName.CHAT_ASSIGNMENT).enabled;
		return a && n.push(b.jsx(N, {
			icon: b.jsx(r("WDSIconWdsIcTransferOwnership.react"), { iconXstyle: D.icon }),
			...
			onClick: function() {
				return t({ kind: o("WAWebChatSearchFilters").SearchFilters.ASSIGNED_TO_YOU });
			}
		}, "assigned-to-you")), o("WAWebListsLabelGatingUtils").smartFiltersEnabled() && n.push(b.jsx(N, {
			icon: b.jsx(r("WDSIconIcPerson.react"), { iconXstyle: D.icon }),
			...
			onClick: function() {
				return t({ kind: o("WAWebChatSearchFilters").SearchFilters.CONTACT });
			}
		}, "contact"), b.jsx(N, {
			icon: b.jsx(o("WAWebNonContactsIcon.react").NonContactsIcon, { iconXstyle: D.icon }),
			...
			onClick: function() {
				return t({ kind: o("WAWebChatSearchFilters").SearchFilters.NON_CONTACT });
			}
		}, "non_contact")), n.push(b.jsx(N, {
			icon: b.jsx(r("WDSIconWdsIcCommunities.react"), {
				height: 24,
				width: 24,
				iconXstyle: D.icon
			}),
			...
			onClick: function() {
				return t({ kind: o("WAWebChatSearchFilters").SearchFilters.GROUP });
			}
		}, "group")), [b.jsx("div", {
		...
		}, "chat_filter_kind_header")].concat(n);
	}
	M.displayName = M.name + " [from " + i.id + "]";
	function w(e) {
		var t = e.active, n = e.onClick, r = o("WAWebConnModel").Conn.isSMB ? s._(
			/*BTDS*/
			""
		) : s._(
			/*BTDS*/
		...
		return b.jsx("button", {
			...
			children: b.jsx(o("WAWebFlex.react").FlexRow, {
				align: "center",
				className: {
				...
				justify: "center",
				children: b.jsx(o("WAWebFilterIcon.react").FilterIcon, {
					height: 20,
					width: 20
				})
			})
