__d("WAWebChatLockedEntryPoint.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = o("react-compiler-runtime").c(10), a = e.onOpen, i = o("useWAWebChatLockEvents").useChatLockEvents(), l = o("useWAWebChatLockSettings").useChatLockSettings(), c = l.hideLockedChats, d = c ? "always" : "bypass", m;
		t[0] !== d ? (m = {
		...
		}, t[0] = d, t[1] = m) : m = t[1], o("useWAWebChatLockRestriction").useChatLockRestriction(m);
		var p;
		i ? p = r("WDSIconWdsIcChatlockUnlockedOutline.react") : p = r("WDSIconWdsIcChatlockOutline.react");
		var _;
		...
		t[5] !== a ? (y = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				e && (o("WAWebDrawerManager").DrawerManager.openDrawerLeft(u.jsx(r("WAWebLockedChatsDrawer.react"), {
					...
					entryPoint: o("WAWebWamEnumActionEntryPoint").ACTION_ENTRY_POINT.CHAT_LIST,
					unlockEntryPoint: o("WAWebWamEnumUnlockEntryPoint").UNLOCK_ENTRY_POINT.CHAT_LIST
				}), { focusType: o("WAWebKeyboardTabUtils").FocusType.CUSTOM }), a == null || a());
			});
			return function() {
		...
		var C = y, b;
		return t[7] !== C || t[8] !== f ? (b = u.jsx(r("WAWebChatlistPanelDrawerButton.react"), {
			dataTab: o("WAWebTabOrder").TAB_ORDER.ARCHIVED_ENTRY_POINT,
			onClick: C,
			primary: h,
			icon: f,
			ariaLabel: h
		}), t[7] = C, t[8] = f, t[9] = b) : b = t[9], b;
	}
	l.default = c;
}), 226);
