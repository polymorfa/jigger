__d("WAWebChatLockedEntryPoint.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = e.onOpen, a = o("useWAWebChatLockEvents").useChatLockEvents(), i = o("useWAWebChatLockSettings").useChatLockSettings(), l = i.hideLockedChats;
		...
		var c;
		a ? c = r("WDSIconWdsIcChatlockUnlockedOutline.react") : c = r("WDSIconWdsIcChatlockOutline.react");
		var d = u.jsx(c, {}), m = s._(
			/*BTDS*/
			""
		), p = (function() {
