__d("WAWebChatMessage.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t, n = e.chat, a = e.filterPreset, i = e.msg, l = e.onClick, u = e.searchQuery, c = e.testid, d = o("useWAWebMsgValues").useOptionalMsgValues(e.msg.id, [
			...
			t.getType,
			t.getLabels
		]), m = d != null ? d[0] : e.msg.id, p = d != null ? d[8] : [], _ = o("useWAWebChatValues").useChatValues(e.chat.id, [
		...
		]), f = _[0], g = _[1], h = _[2], y = _[3], C = _[4], b = _[5], v = r("useWAWebActiveSelection")(e.active, m.toString()), S = v[0], R = v[1], L = o("useWAWebSearchQuery").useHighlightedText(u), E = function(t) {
			if (o("WATypeUtils").isFunction(l)) {
				var e, r, a = o("WAWebMsgCollection").MsgCollection.assertGet(m), i = o("WAWebThreadMsgUtils").getMsgAiThread(a);
		...
		}, T = s.jsx(r("WAWebChatTimestamp.react"), { msg: i }), D = s.jsx(r("WAWebChatLastMsg.react"), {
			msg: i.safe(),
			msgType: "FTSMessage",
			searchQuery: L
		});
