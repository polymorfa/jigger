__d("WAWebChatOpenMetricsStore", [
	...
	var e = r("qpl")._(891425633, "3259"), s = new Map();
	function u(t) {
		var n = o("WAWebLidMigrationUtils").chatIsLid(t), a = r("WAWebRenderCursorGetWindowHeight")(), i = new (o("WAWebUiActionWamEvent")).UiActionWamEvent({
			...
			annotations: { int: {
				unreadMessageCount: t.unreadCount,
				windowHeight: a
			} },
			cancelExisting: !0,
			cancelOnUnload: !0
