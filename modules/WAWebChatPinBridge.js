__d("WAWebChatPinBridge", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e._lastPinTime, n = e.chatId, r = e.newPinTime, a = e.timestamp, i = r !== 0, l = yield o("WAWebPinChatSync").PinChatSync.getMutationsForPin(a, i, n);
	...
	l.setPin = e, l.getNumNewslettersPinned = c, l.getNumConversationsPinned = d, l.getPinLimit = m, l.unpinAllConversations = p;
}), 98);
