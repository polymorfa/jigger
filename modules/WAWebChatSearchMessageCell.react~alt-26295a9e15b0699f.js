__d("WAWebChatSearchMessageCell.react", [
	...
	function m(e) {
		var t, n, a = e.author, i = e.msg, l = e.onClick, u = e.searchText, m = o("useWAWebMsgValues").useMsgValues(e.msg.id, [
			...
			t.getType,
			t.getT
		]), p = m[0], _ = m[1], f = m[2], g = m[3], h = m[4], y = m[5], C = m[6], b = n.getChat(i), v = c(null), S = c(null), R = d(function() {
			return e.active ? e.active.value === i : !1;
		}), L = R[0], E = R[1], k = function(t, n) {
			if (t === "focus") {
				var e = S.current;
		...
		var I = function(t) {
			if (o("WATypeUtils").isFunction(l)) {
				...
				u != null && (n.highlightTerms = u.toLowerCase().split(" ")), ((e = n.msg) == null ? void 0 : e.type) !== o("WAWebMsgType").MSG_TYPE.ALBUM && (n.msg = i), l({
					c: b,
					e: t,
					msg: i,
					msgContext: n
		...
		}, D = s.jsx(r("WAWebChatTimestamp.react"), { msg: i }), x = s.jsx(r("WAWebChatLastMsg.react"), {
			msg: i.safe(),
			msgType: "Search",
			author: a,
