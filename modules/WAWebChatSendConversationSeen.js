__d("WAWebChatSendConversationSeen", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (i === -1) {
				var s = yield r("WAWebMarkChatAsReadSync").getMarkChatAsReadMutation(l, !0, t.id), u = t.id.toString();
				...
				}), yield o("WAWebApiChat").updateChatForMarkAsReadSync(u), { fullyReadThreadIds: [] };
			}
