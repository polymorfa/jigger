__d("WAWebChatSendMessages", [
	...
	function _(t) {
		...
		if (r.promises.sendDismissChangeNumber) return r.promises.sendDismissChangeNumber;
		var a = (d || (d = n("Promise"))).resolve({ status: 200 });
		r.promises.sendDismissChangeNumber = a;
		var i = new (o("WAWebActionToast.react")).ActionType(s._(
			/*BTDS*/
			""
		)), l = a.then(function(e) {
		...
		return o("WAWebToastManager").ToastManager.open(p.jsx(o("WAWebActionToast.react").ActionToast, {
			...
			if (e.status === 200) return o("WAWebDBUpdateChatTable").updateChatTable(r.id, {
	...
	function g(e, t, r) {
		...
		var i, l = [];
		return t.type === "addon" ? i = t.list.map((function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				return l = yield o("WAWebAssociatedMessagesRevokeUtils").getAssociatedChildMessageRevokePromises(e, function(e) {
					return o("WAWebRevokeMsgAction").sendAssociatedChildMsgRevoke(e, t, r);
		...
		})()), a.promises.sendRevokeMsgs = (d || (d = n("Promise"))).all([].concat(i, l)).finally(function() {
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var a, i = o("WAWebMsgGetters").getBotPluginSearchUrl(e) != null || o("WAWebMsgGetters").getBotPluginMaybeParent(e);
			if (i) {
				o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[bot revoke] handling sendAssociatedBotPluginRevoke"])));
				var l = yield o("WAWebSchemaMessage").getMessageTable().get(e.id.toString());
				if (!(l == null || l.internalId == null || l.botResponseTargetId == null)) {
					var s = yield o("WAWebDBStoreRevokeMsgs").findAssociatedPluginMsgs({
						internalId: l.internalId,
						targetId: l.botResponseTargetId
					});
					s == null || (a = s.pluginLinkMsgIds) == null || a.forEach((function() {
						var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
							var n = o("WAWebMsgCollection").MsgCollection.get(r("WAWebMsgKey").fromString(e));
							if (n != null) {
								var a;
								n = (a = yield o("WAWebMsgCollection").MsgCollection.getMessagesById([e])) == null || (a = a.messages) == null ? void 0 : a[0];
							}
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, r = e.chat_, a = e.clearMedia, i = e.record, l = o("WAWebStateUtils").unproxy(r);
			if (l.promises.sendDeleteMsgs) return l.promises.sendDeleteMsgs;
			if (i.type === "addon") {
				var s = i.list;
				l.promises.sendDeleteMsgs = o("WAWebAddonDeleteAddons").sendDeleteAddonsForMe(s, a).then(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					return s.length;
				})).finally(function() {
			...
			if (i.type === "message") {
				var u = i.list, c = [];
				o("WAWebMessageAssociationGatingUtils").isMessageAssociationInfraEnabled() && (c = yield o("WAWebAssociatedMessagesRevokeUtils").getHydratedAssociatedChildMessageModelsFromParentMsgs(u)), l.promises.sendDeleteMsgs = o("WAWebChatSendDeleteMsgsBridge").sendDeleteMsgs([].concat(u, c), a, l.id).then(function() {
			...
			return (t = l.promises.sendDeleteMsgs) != null ? t : (d || (d = n("Promise"))).resolve(0);
	...
	l.sendDismissChangeNumber = _, l.sendStarMsgs = f, l.sendRevokeMsgs = g, l.sendDeleteMsgs = C, l.sendGroupInviteMessage = v;
}), 226);
