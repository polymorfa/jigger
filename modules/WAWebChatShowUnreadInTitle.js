__d("WAWebChatShowUnreadInTitle", [
	"WAWebBotBaseGating",
	...
	function e(e) {
		...
		if (e.id.isBot() && !o("WAWebBotBaseGating").isBotEnabled() && !o("WAWebBotFrontendGating").isManusIntegrationEnabled()) {
			e.showUnreadInTitle = !1;
			return;
		}
		...
		if (((t = e.groupMetadata) == null ? void 0 : t.groupType) === o("WAWebGroupType").GroupType.COMMUNITY) {
			e.showUnreadInTitle = !1;
			return;
		}
		if (!n) {
		...
		for (var r = !1, a = e.msgs, i = o("WAWebFrontendChatGetters").getOptimisticUnreadCount(e), l = Math.max(0, a.length - i); l < a.length; l++) {
			var s = e.msgs.at(l);
