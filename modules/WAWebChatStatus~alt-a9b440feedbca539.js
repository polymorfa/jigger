__d("WAWebChatStatus", [
	...
	function f(e) {
		var t = e.status, n = e.waitIdle, a = o("useWAWebModelValues").useModelValues(t, [
			"id",
			"stale",
			"status"
		], { isStrong: !1 }), i = u.jsx(o("WAWebEmojiText.react").EmojiText, {
			direction: "auto",
			selectable: !0,
			titlify: !0,
			text: a.status,
			...
			return a.id.isRegularUser() ? (o("WAWebTextStatusCollection").TextStatusCollection.find(a.id), a.status === void 0 ? p : a.isValidTextStatus() ? i : u.jsx(u.Fragment, {})) : o("WAWebBotUtils").isMetaAiBot(a.id) ? _ : p;
