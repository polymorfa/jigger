__d("WAWebChatThreadLoggingUtils", [
	...
	function P(e) {
		...
		return n.has(e.type) || n.has((t = e.quotedMsg) == null ? void 0 : t.type) || !!(e.matchedText != null && e.matchedText !== "" && N(e.matchedText)) || e.type === o("WAWebMsgType").MSG_TYPE.NATIVE_FLOW && (e.nativeFlowName === r("WAWebInteractiveMessagesNativeFlowName").ORDER_DETAILS || e.nativeFlowName === r("WAWebInteractiveMessagesNativeFlowName").ORDER_STATUS);
	}
	function N(e) {
	...
	function O() {
		return O = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = o("WAWebUserPrefsMeUser").getMeLidUserOrThrow(), t = yield r("WAWebLidAwareContactsDB").get(e.toJid());
	...
	function U() {
		return U = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			return z(t) ? null : o("WAWebModelStorageUtils").getStorage().lock(["contact"], n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var n, a;
				if (t.isLid()) {
				...
				return l == null ? (o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[getOppositeVisibleIdentificationType] contact not found ", ""])), t), null) : V(l, a);
			}));
	...
	function G() {
		return G = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			return z(e) ? null : o("WAWebModelStorageUtils").getStorage().lock(["chat"], (function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
					var n = t[0], r = e.toString(), a = yield n.get(r);
					if (a == null) {
	...
	l.generateThreadID = p, l.generateThreadIDHMAC = f, l.CTWA_3PD_AGGREGATED_THREAD_ID_HMAC_SALT = h, l.generateCtwa3pdAggregatedThreadIDHMAC = y, l.generateMessageIDHMAC = b, l.generateUserThreadIDHMAC = S, l.getThreadDs = k, l.getThreadDsForDb = I, l.getThreadMonthDs = T, l.computeStartTs = D, l.shouldUpdateChatEvent = x, l.shouldIncrementMsgSendAndReceive = $, l.isCommerceMessage = P, l.getWamDisappearingModeTrigger = M, l.getWamDisappearingModeTriggerGroups = w, l.getWamDisappearingModeInitiatedByMe = A, l.getMeHasUsername = F, l.getMeHasUsernamePin = B, l.getOppositeVisibleIdentification = q, l.getOppositeVisibleIdentificationType = V, l.getChatOriginType = H;
}), 98);
