__d("WAWebChatlistUtils", [
	...
	function g(e) {
		var t = e.adCreationUrlInput, a = e.lwiEntryPoint, i = e.waCampaignId, l = t.activeAccountInfo, s = t.sourceAdCreation, u = l !== "not-linked" && l.hasFacebookPage, d = s === "whatsapp_smb_web_catalog" || s === "whatsapp_smb_web_catalog_product", m = (o("WAWebBizNativeAdsGatingUtils").nativeAdsDogfoodEnabled() || o("WAWebBizNativeAdsGatingUtils").nativeAdsWebCreationEnabled()) && (!d || o("WAWebBizNativeAdsGatingUtils").nativeAdsCatalogBoostEnabled()), p;
		if (m ? p = r("WAWebPonyfillsCryptoRandomUUID")() : (o("WAWebUserPrefsCTWA").resetAdCreationSequenceNumber(), p = o("WAWebUserPrefsCTWA").generateAdCreationFlowId()), o("WAWebBizNativeAdsEntryTapLogger").logEntryTap({
			lwiEntryPoint: a,
			lwiExtras: JSON.stringify({ uses_native_ads: m }),
			lwiFlowId: p,
			userHasLinkedFbPage: u,
			waCampaignId: i,
			webFlowType: m ? o("WAWebWamEnumWebFlowType").WEB_FLOW_TYPE.NATIVE_WEB : o("WAWebWamEnumWebFlowType").WEB_FLOW_TYPE.EXTERNAL_WEB
		...
		var g = l !== "not-linked" && l.type === "whatsapp", h = o("WAWebAdCreationLogger").getLwiAdsIdentityTypeFromActiveAccountInfo(l);
		o("WAWebAdCreationLogger").logLwiAdCreationNuxScreen(o("WAWebWamEnumLwiScreenAction").LWI_SCREEN_ACTION.LWI_ACTION_VIEW, h, u);
		var y = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				o("WAWebAdCreationLogger").logLwiAdCreationNuxScreen(o("WAWebWamEnumLwiScreenAction").LWI_SCREEN_ACTION.LWI_ACTION_NUX_CONTINUE_TAPPED, h, u);
				try {
					var e = yield o("WAWebBusinessAdCreationUtils").getWhatsappAdCreationUrl(babelHelpers.extends({}, t, { flowId: p }));
		...
		o("WAWebModalManager").ModalManager.open(c.jsx(r("WAWebBizAdCreationEntryPointModal.react"), {
			onOK: y,
			onClose: function() {
				return o("WAWebAdCreationLogger").logLwiAdCreationNuxScreen(o("WAWebWamEnumLwiScreenAction").LWI_SCREEN_ACTION.LWI_ACTION_CANCEL_DIALOG_BUTTON_TAPPED, h, u);
			},
			onLearnMore: function() {
				return o("WAWebAdCreationLogger").logLwiAdCreationNuxScreen(o("WAWebWamEnumLwiScreenAction").LWI_SCREEN_ACTION.LWI_ACTION_LEARN_MORE_TAPPED, h, u);
			},
			isPagelessAd: g
		}));
	}
