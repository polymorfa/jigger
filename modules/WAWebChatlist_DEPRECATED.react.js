__d("WAWebChatlist_DEPRECATED.react", [
	...
	function C(e) {
		...
		var m = d, _ = m.forceActive, f = m.activeStyleType;
		if (s) {
			var g = u.forceActive === !0, y = m.activeStyleType === "BORDER";
			g && y ? (_ = !0, f = "BOTH") : g ? (_ = !0, f = "DEFAULT") : y && (f = "BORDER");
		}
		var C;
		return t[8] !== f || t[9] !== n || t[10] !== a || t[11] !== _ || t[12] !== m.onContextMenuChange ? (C = p.jsx(h, babelHelpers.extends({ chat: n }, a, {
			forceActive: _,
			activeStyleType: f,
			onContextMenuChange: m.onContextMenuChange
		})), t[8] = f, t[9] = n, t[10] = a, t[11] = _, t[12] = m.onContextMenuChange, t[13] = C) : C = t[13], C;
	}
	function b(e, t) {
		t === void 0 && (t = {});
	...
	var v = (function(t) {
		function a(a) {
			...
			return i = t.call(this, a) || this, i.$2 = new Map(), i.$5 = 0, i.disableChatSwitching = !1, i.$6 = o("WAWebABProps").getABPropConfigValue("wa_web_chatlist_render_chat_open"), i.$7 = null, i.$8 = r("WAMemoizeOne")(function(e) {
			...
			}), i.$9 = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				var e = yield o("WAWebEventUtils").getUpcomingEvents(), t = yield o("WAWebEventUtils").getUpcomingEventsForCallsTab(), n = t.slice(0, 1);
				i.setState({
					upcomingEvents: n,
					allUpcomingEvents: e
				});
	...
	function R(e) {
		var t = o("react-compiler-runtime").c(10), n = e.emphasized, a = e.header, i = e.testid, l = e.xstyle, s = i != null ? i : "section-header", u;
		t[0] !== l ? (u = (d || (d = r("stylex"))).props(S.container, l), t[0] = l, t[1] = u) : u = t[1];
		var c = n === !0 ? "Body1Emphasized" : "Body2", m = n === !0 ? "contentDefault" : "contentDeemphasized", _;
		t[2] !== a || t[3] !== c || t[4] !== m ? (_ = p.jsx(r("WDSText.react"), {
			type: c,
			colorName: m,
			children: a
		}), t[2] = a, t[3] = c, t[4] = m, t[5] = _) : _ = t[5];
		var f;
		return t[6] !== s || t[7] !== u || t[8] !== _ ? (f = p.jsx("div", babelHelpers.extends({ "data-testid": s }, u, { children: _ })), t[6] = s, t[7] = u, t[8] = _, t[9] = f) : f = t[9], f;
	}
