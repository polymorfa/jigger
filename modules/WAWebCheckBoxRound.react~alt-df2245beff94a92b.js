__d("WAWebCheckBoxRound.react", [
	...
	function g(t) {
		var n = t.ariaLabel, a = t.checked, i = t.disabled, l = t.hover, s = t.onClick, c = t.radio, g = t.systemUncheckedColor, h = t.testid, y = p(null), C = p(!0), b = _(!1), v = b[0], S = b[1];
		m(function() {
			C.current === !1 && a === !0 && r("WAWebFocusTracer").focus(y.current), C.current = !1;
		}, [a]);
		var R = function(t) {
			i !== !0 && (t && t.stopPropagation(), s());
		}, L, E;
		a ? (c === !0 ? E = null : E = o("WAWebCheckboxRoundCheckedIcon.react").CheckboxRoundCheckedIcon, L = "checked") : (L = "unchecked", E = l ? o("WAWebCheckboxRoundUncheckedIcon.react").CheckboxRoundUncheckedIcon : null);
		var k = a ? [f.checkedSvgStyle, i === !0 && f.disabledCheckedSvgStyle] : [
			f.uncheckedSvgStyle,
			...
			return S(!1);
		}, []), D = r("useWAWebIsKeyboardUser")(), x = D.isKeyboardUser, $ = E != null ? u.jsx(E, { iconXstyle: k }) : a ? u.jsx(r("WDSIconIcRadioButtonChecked.react"), {
			iconXstyle: k,
			height: 20,
			width: 20,
		...
		return u.jsx(r("WAWebVelocityTransitionGroup"), {
			...
			transitionName: "pop",
			children: u.createElement("button", babelHelpers.extends({
				ref: y,
				role: c === !0 ? "radio" : "checkbox"
			}, (e || (e = r("stylex"))).props(f.roundIcon, x && o("WDSFocusStateStyles").WDSFocusStateStyles.genericFocus), {
				"aria-checked": a,
				"aria-label": n || "",
				key: L,
				onClick: R,
