__d("WAWebCheckUpdateOrphanReactions", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			try {
				var n = yield o("WAWebDBChangeOrphanStateReactions").changeOrphanStateReactions(t), r = yield o("WAWebAddonProcessMsgs").processMsgsAndGetOrphans(n.map(function(e) {
