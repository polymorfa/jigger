__d("WAWebClearSelectedChatsPopup.react", [
	...
	function m(e) {
		var t = e.chats, a = e.onComplete, i = t.length, l = c(o("WAWebBoolFunc").returnFalse), m = l[0], p = l[1], _ = function() {
			p(!m);
		}, f = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAWebClearSelectedChatsAction").clearSelectedChats(t, { keepStarred: m }), o("WAWebModalManager").ModalManager.close(), a == null || a();
			});
			return function() {
