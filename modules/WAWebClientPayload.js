__d("WAWebClientPayload", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = o("WAWebUserPrefsMeUser").getMeDevicePnOrThrow_DO_NOT_USE(), r = babelHelpers.extends({}, yield f(t), {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			var r = h(), a = yield y(), i = babelHelpers.extends({}, yield f(n), { devicePairingData: {
				buildHash: r,
				deviceProps: a,
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			if (i) a = babelHelpers.extends({}, a, { fullSyncDaysLimit: 365 });
				...
				var l = yield o("WAWebSyncdMdSyncFieldstatMeta").MdSyncFieldStatsMeta.getStorageEstimation();
			...
			var u = r("WAWebEnvironment").isWindows ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.UWP : R(e.name), c = {
				os: e.os,
				version: t,
				platformType: u,
				requireFullSync: i,
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield o("WAWebBackendApi").frontendSendAndReceive("getDeviceInfo", void 0), t = {
				appVersion: {
	...
	l.incrementSuccessfulLoginCounter = c, l.getClientPayloadForLogin = d, l.getClientPayloadForRegistration = p, l.setClientPayloadOverride = b;
}), 98);
