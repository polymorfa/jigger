__d("WAWebClientPayload", [
	...
	async function d(t) {
		var n = o("WAWebUserPrefsMeUser").getMeDevicePnOrThrow_DO_NOT_USE(), r = babelHelpers.extends({}, await p(t), {
		...
		return o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[comms] getClientPayloadForLogin: connectAttemptCount=", ""])), u).tags("launch-socket-chat"), o("encodeProtobuf").encodeProtobuf(o("WAWebProtobufsWa6.pb").ClientPayloadSpec, r).readByteArrayView();
	}
	async function m(e, t, n) {
		var r = _(), a = await f(), i = babelHelpers.extends({}, await p(n), { devicePairingData: {
			buildHash: r,
			deviceProps: a,
		...
		return o("encodeProtobuf").encodeProtobuf(o("WAWebProtobufsWa6.pb").ClientPayloadSpec, i).readByteArrayView();
	}
	async function p(e) {
		var t, n;
		return {
			...
			connectReason: o("WAWebProtobufsWa6.pb").ClientPayload$ConnectReason.USER_ACTIVATED,
			userAgent: await h(),
			webInfo: { webSubPlatform: C() }
		};
	}
	function _() {
		var e = o("WABase64").decodeB64(o("WAMd5").md5(o("WAWebBuildConstants").VERSION_BASE)), t = new Uint8Array(e);
		return t;
	}
	async function f() {
		var e = r("WAWebBrowserInfo")(), t;
		if (e.version && e.version !== "") {
			var n = e.version.split(".");
			n.length > 0 && e.version && /^[0-9\.]+$/.test(e.version) && (t = {
		...
		}, i = o("WAWebClientFeatureFlags").isFeatureEnabled("debug_1_year_history_sync");
		if (i) a = babelHelpers.extends({}, a, { fullSyncDaysLimit: 365 });
		else {
			var l = await o("WAWebSyncdMdSyncFieldstatMeta").MdSyncFieldStatsMeta.getStorageEstimation();
			l.mdStorageQuotaBytes !== o("WAWebSyncdMdSyncFieldstatMeta").STORAGE_QUOTA_UNAVAILABLE && (a = babelHelpers.extends({}, a, { storageQuotaMb: Math.trunc(l.mdStorageQuotaBytes / 1024 / 1024) }));
		}
		var s = r("WAWebEnvironment").isWindows && !r("justknobx")._("1836");
		s && (a.onDemandReady = !0, a.completeOnDemandReady = !0);
		var u = r("WAWebEnvironment").isWindows ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.UWP : y(e.name), c = {
			os: e.os,
			version: t,
			platformType: u,
			requireFullSync: i,
			historySyncConfig: a
		}, d = o("encodeProtobuf").encodeProtobuf(o("WAWebProtobufsCompanionReg.pb").DevicePropsSpec, c).readByteArrayView();
		return d;
	}
	function g(e) {
		s = e;
	...
	async function h() {
		var e = await o("WAWebBackendApi").frontendSendAndReceive("getDeviceInfo", void 0), t = {
			appVersion: {
		...
		if (r("WAWebEnvironment").isWindows) {
			...
			}, (o("WAWebBuildConstants").WINDOWS_BUILD == null ? void 0 : o("WAWebBuildConstants").WINDOWS_BUILD.length) === 6 && (t.mcc = o("WAWebBuildConstants").WINDOWS_BUILD.substr(0, 3), t.mnc = o("WAWebBuildConstants").WINDOWS_BUILD.substr(3, 3));
		}
		return t;
	}
	function y(e) {
		return e === "Chrome" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.CHROME : e === "Firefox" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.FIREFOX : e === "IE" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.IE : e === "Opera" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.OPERA : e === "Safari" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.SAFARI : e === "Edge" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.EDGE : e === "electron" || e === "Desktop" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.DESKTOP : e === "ipad" || e === "iPad" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.IPAD : e === "tablet" || e === "Android tablet" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.ANDROID_TABLET : e === "Ohana" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.OHANA : e === "Aloha" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.ALOHA : e === "Catalina" ? o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.CATALINA : o("WAWebProtobufsCompanionReg.pb").DeviceProps$PlatformType.UNKNOWN;
	}
	function C() {
		return (function(e) {
			if (e === "WEB" || e === "PWA") return o("WAWebProtobufsWa6.pb").ClientPayload$WebInfo$WebSubPlatform.WEB_BROWSER;
			if (e === "DARWIN" || e === "DARWIN_BETA") return o("WAWebProtobufsWa6.pb").ClientPayload$WebInfo$WebSubPlatform.DARWIN;
			if (e === "MACSTORE") return o("WAWebProtobufsWa6.pb").ClientPayload$WebInfo$WebSubPlatform.APP_STORE;
			if (e === "WIN_HYBRID") return o("WAWebProtobufsWa6.pb").ClientPayload$WebInfo$WebSubPlatform.WIN_HYBRID;
			throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + e);
		})(o("WAWebWamPlatform").getWamPlatform());
	}
	l.incrementSuccessfulLoginCounter = c, l.getClientPayloadForLogin = d, l.getClientPayloadForRegistration = m, l.setClientPayloadOverride = g;
}), 98);
