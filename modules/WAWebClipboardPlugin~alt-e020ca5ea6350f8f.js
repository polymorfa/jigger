__d("WAWebClipboardPlugin", [
	...
	function c(t) {
		var a = t.ignoreLineBreakOnPaste, i = a === void 0 ? !1 : a, l = t.onFiles, c = t.onTextPaste, p = t.pasteFromHTML, _ = p === void 0 ? !1 : p, f = o("LexicalComposerContext").useLexicalComposerContext(), h = f[0], y = r("useWAWebStableCallback")((function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				if (t.preventDefault(), t.stopPropagation(), !!t.clipboardData) {
					...
					u != null ? p = u : d != null && _ && n("cr:6842") ? p = n("cr:6842")(d) : m != null && (p = m), p != null && (c == null ? void 0 : c(p)) !== !0 && h.dispatchCommand(s, p);
				}
			});
			return function(e) {
			...
			var t;
			i ? t = [e.replace(u, "")] : t = e.split(u), h.update(function() {
		...
		return o("useWAWebLexicalEvent").useLexicalCommandListener(h, o("Lexical").CUT_COMMAND, function(e) {
			return e instanceof ClipboardEvent ? (e.preventDefault(), e.stopPropagation(), d(e), m(h), !0) : !1;
		}), o("useWAWebLexicalEvent").useLexicalCommandListener(h, o("Lexical").PASTE_COMMAND, function(e) {
			return y(e), !0;
