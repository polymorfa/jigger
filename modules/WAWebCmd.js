__d("WAWebCmd", [
	...
	var e, s, u, c, d, m, p, _, f, g, h, y, C = 1300, b = 400, v = (function(t) {
		function a() {
			var e;
			return e = t.call(this) || this, e.isMainStreamReadyMd = !1, e.isOfflineDeliveryEnd = !1, e.$CmdImpl$p_1 = null, o("WAWebUiIdleEventBus").UiIdleEventBus.setDeferUntilDocumentFlushed(S), e;
		}
		babelHelpers.inheritsLoose(a, t);
		var i = a.prototype;
		return i.muteAllReactions = function(t, n, r) {
			...
			var e = this, a = o("WAWebStateUtils").unproxy(t.chat);
			if (!(a.id.isBot() && !o("WAWebBotUtils").isBotChannelFBID(a.id) && (!o("WAWebBotUtils").isMetaAiBot(a.id) || !(o("WAWebBotGating").isAnyMetaAiMediaInputEnabled() || o("WAWebBotGating").isMetaAiDocUploadEnabled())))) {
				if (o("WAWebBotUtils").isMetaAiBot(a.id)) {
					var i = t.attachments;
					if (i != null) {
						(y || (y = n("Promise"))).all(i).then((function() {
							var o = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
								var o = yield r("JSResourceForInteraction")("WAWebBotMultiModalUtils").__setRef("WAWebCmd").load(), i = o.showMetaAiAttachmentErrors, l = o.validateMetaAiAttachments, s = l(n, a.id), u = s.errors, c = s.validAttachments;
			...
			var t = this, a = r.chat, i = r.chatEntryPoint, l = r.msgContext, u = r.threadId, c = this.$CmdImpl$p_1 != null && this.$CmdImpl$p_1 === a.id;
			return c ? o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
				"openChat: preserving entry point ",
				", skipping ",
				" for same chat"
			])), a.chatEntryPoint, i) : a.chatEntryPoint = i, this.$CmdImpl$p_1 = a.id, o("WAWebWamMemoryStat").uploadMemoryIfChatWasOpened(a.id), new (y || (y = (n("Promise"))))(function(e) {
				t.trigger("open_chat", {
					chat: a,
					msgContext: l,
					chatEntryPoint: i,
					...
					onComplete: (function() {
						var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
							var n, r = o("WAWebDrawerManagerGlobalContext").getGlobalDrawerManager("right"), a = (n = r == null ? void 0 : r.existsDrawer()) != null ? n : !1;
							a && window.matchMedia("(max-width: " + C + "px)").matches && (r == null || r.closeDrawer()), e(t);
						});
						function r(e) {
			...
			var e = this, r = t.chat, a = t.chatEntryPoint, i = t.msgContext, l = t.noFocus, s = t.onSuccess, u = t.threadId, c = o("WAWebStateUtils").unproxy(r);
			if (!i) return this.openChatBottom({
				chat: c,
				chatEntryPoint: a
			});
			...
			var d = this.$CmdImpl$p_3({
				...
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
					var r, o, a = i.enableAnimation != null ? i.enableAnimation : !0;
					if (t) if (t.wasVisible) r = function() {
				...
				var t;
				if ((i == null || (t = i.msg) == null ? void 0 : t.botPluginReferenceIndex) != null) {
					var n, r = i == null || (n = i.msg) == null ? void 0 : n.botResponseTargetId;
					r != null && e.botTogglePluginSearchDetailsToggle(r, !0);
				}
				(i == null ? void 0 : i.highlightMsg) === !0 && e.flashFocusedMsg(i.highlightMentionMsg, l);
			}).then(function() {
				if (s) {
					var e = s.mediaMsgToOpenInMediaViewer, t = s.onScrollToQuotedCarouselCard;
					e && o("WAPromiseDelays").delayMs(500).then(function() {
						R.openMediaViewerForAlbumMedia(o("WAWebStateUtils").unproxy(e)), t == null || t();
					});
				}
				return !0;
			}).then(function(t) {
			...
			var e = this, a = t.chat, i = t.chatEntryPoint, l = t.threadId, s = o("WAWebStateUtils").unproxy(a);
			if (!r("gkx")("26258")) {
				window.chat = s;
				var c = s.unreadMsgAnchor && s.unreadMsgAnchor.id.toString() || "No unreadMsgAnchor found";
			...
			var d, m = o("WAWebThreadModelResolver").resolveThreadOrChat(s, l);
			if (m.unreadMsgAnchor && (d = {
				collection: m.unreadMsgAnchor.getMsgChunk(m !== s ? l : void 0),
		...
		}, i.windowError = function(t) {}, i.onPanesWillChange = function(t) {
	...
	var R = new v();
	l.Revoke = o("WAWebCmd.flow").Revoke, l.CmdImpl = v, l.deferUntilDocumentFlushed = S, l.Cmd = R;
}), 98);
