__d("WAWebCmd", [
	...
	var e, s, u, c, d, m, p, _, f, g, h, y = 1300, C = 400, b = (function(t) {
		function n() {
			var e;
			return e = t.call(this) || this, e.isMainStreamReadyMd = !1, e.isOfflineDeliveryEnd = !1, e.$CmdImpl$p_1 = null, o("WAWebUiIdleEventBus").UiIdleEventBus.setDeferUntilDocumentFlushed(v), e;
		}
		babelHelpers.inheritsLoose(n, t);
		var a = n.prototype;
		return a.muteAllReactions = function(t, n, r) {
			...
			this.trigger("favorite_chat", o("WAWebStateUtils").unproxy(t), n, r);
		}, a.markChatUnread = function(t, n) {
			this.trigger("mark_chat_unread", o("WAWebStateUtils").unproxy(t), n);
			...
			this.trigger("ctwa_ad_preview_drawer", o("WAWebStateUtils").unproxy(t), n, r);
		}, a.galaxyFlowDrawer = function(t) {
			var e = t.chat, n = t.messageData, r = t.msg, o = t.onClose;
			this.trigger("galaxy_flows_drawer", e, n, r, o);
		}, a.chatInfoDrawer = function(t, n) {
			this.trigger("chat_info_drawer", o("WAWebStateUtils").unproxy(t), n == null ? void 0 : n.showFullGroupDescription, n == null ? void 0 : n.scrollToParticipantList, n == null ? void 0 : n.sourceGroupChatOrNewsletter, n == null ? void 0 : n.focusNewsletterDescriptionOnMount, n == null ? void 0 : n.focusGroupSubjectOnMount, n == null ? void 0 : n.focusGroupDescriptionOnMount, n == null ? void 0 : n.threadId);
		}, a.newsletterDeleteDrawer = function(t) {
			this.trigger("delete_newsletter_drawer", o("WAWebStateUtils").unproxy(t));
			...
			var e = this, n = o("WAWebStateUtils").unproxy(t.chat);
			if (!(n.id.isBot() && !o("WAWebBotUtils").isBotChannelFBID(n.id) && (!o("WAWebBotUtils").isMetaAiBot(n.id) || !(o("WAWebBotGating").isAnyMetaAiMediaInputEnabled() || o("WAWebBotGating").isMetaAiDocUploadEnabled())))) {
				if (o("WAWebBotUtils").isMetaAiBot(n.id)) {
					var a = t.attachments;
					if (a != null) {
						Promise.all(a).then(async function(o) {
							var a = await r("JSResourceForInteraction")("WAWebBotMultiModalUtils").__setRef("WAWebCmd").load(), i = a.showMetaAiAttachmentErrors, l = a.validateMetaAiAttachments, s = l(o, n.id), u = s.errors, c = s.validAttachments;
							i(u), c.length !== 0 && e.$CmdImpl$p_2(babelHelpers.extends({}, t, { attachments: c.map(function(e) {
								return e;
							}) }), n);
						});
						return;
			...
			var e = function(r) {
				r.length > 0 && o("WAWebComposeBoxActions").ComposeBoxActions.setTextContent(n, r.join(`
...
`)), t.onCancel == null || t.onCancel();
			...
			var e = t.currentTime, n = t.getZoomNode, r = t.highlightedMsgIds, o = t.msg, a = t.shouldShowAllMedia, i = t.shouldShowNumberText;
			...
			this.trigger("send_star_msgs", o("WAWebStateUtils").unproxy(t), n, r, a);
		}, a.sendUnstarMsgs = function(t, n, r, a) {
			this.trigger("send_unstar_msgs", o("WAWebStateUtils").unproxy(t), n, r, a);
		}, a.sendDeleteMsgs = function(t, n, r, a, i, l) {
			this.trigger("send_delete_msgs", o("WAWebStateUtils").unproxy(t), n, r, a, i, l);
		}, a.sendRevokeMsgs = function(t, n, r) {
			this.trigger("send_revoke_msgs", o("WAWebStateUtils").unproxy(t), n, r);
		}, a.$CmdImpl$p_3 = function(n) {
			var t = this, r = n.chat, a = n.chatEntryPoint, i = n.msgContext, l = n.threadId, u = this.$CmdImpl$p_1 != null && this.$CmdImpl$p_1 === r.id;
			return u ? o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
				"openChat: preserving entry point ",
				", skipping ",
				" for same chat"
			])), r.chatEntryPoint, a) : r.chatEntryPoint = a, this.$CmdImpl$p_1 = r.id, o("WAWebWamMemoryStat").uploadMemoryIfChatWasOpened(r.id), new Promise(function(e) {
				t.trigger("open_chat", {
					chat: r,
					msgContext: i,
					chatEntryPoint: a,
					...
					onComplete: async function(n) {
						var t, r = o("WAWebDrawerManagerGlobalContext").getGlobalDrawerManager("right"), a = (t = r == null ? void 0 : r.existsDrawer()) != null ? t : !1;
						a && window.matchMedia("(max-width: " + y + "px)").matches && (r == null || r.closeDrawer()), e(n);
					}
				});
			}).catch(function(e) {
				throw o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["Unexpected openChat error: ", ""])), String(e)), e;
			});
		}, a.openChatAt = function(t) {
			var e = this, n = t.chat, r = t.chatEntryPoint, a = t.msgContext, i = t.noFocus, l = t.onSuccess, s = t.threadId, u = o("WAWebStateUtils").unproxy(n);
			if (!a) return this.openChatBottom({
				chat: u,
				chatEntryPoint: r
			});
			...
			var c = this.$CmdImpl$p_3({
				...
				var n, r, o = a.enableAnimation != null ? a.enableAnimation : !0;
				if (t) if (t.wasVisible) n = function() {
				...
				var t;
				if ((a == null || (t = a.msg) == null ? void 0 : t.botPluginReferenceIndex) != null) {
					var n, r = a == null || (n = a.msg) == null ? void 0 : n.botResponseTargetId;
					r != null && e.botTogglePluginSearchDetailsToggle(r, !0);
				}
				(a == null ? void 0 : a.highlightMsg) === !0 && e.flashFocusedMsg(a.highlightMentionMsg, i);
			}).then(function() {
				if (l) {
					var e = l.mediaMsgToOpenInMediaViewer, t = l.onScrollToQuotedCarouselCard;
					e && o("WAPromiseDelays").delayMs(500).then(function() {
						S.openMediaViewerForAlbumMedia(o("WAWebStateUtils").unproxy(e)), t == null || t();
					});
				}
				return !0;
			}).then(function(t) {
				return e.$CmdImpl$p_5(a), t;
			}).catch(o("WAAbortError").catchAbort(o("WAWebBoolFunc").returnFalse));
			return c.finally(function() {
				o("WAWebUiIdleEventBus").UiIdleEventBus.setUiBusy(!1);
			}), c;
		}, a.openChatFromUnread = function(t) {
			var e = this, n = t.chat, a = t.chatEntryPoint, i = t.threadId, l = o("WAWebStateUtils").unproxy(n);
			if (!r("gkx")("26258")) {
				window.chat = l;
				var s = l.unreadMsgAnchor && l.unreadMsgAnchor.id.toString() || "No unreadMsgAnchor found";
			...
			var c, d = o("WAWebThreadModelResolver").resolveThreadOrChat(l, i);
			if (d.unreadMsgAnchor && (c = {
				collection: d.unreadMsgAnchor.getMsgChunk(d !== l ? i : void 0),
				...
				}).then(o("WAWebBoolFunc").returnTrue).catch(o("WAAbortError").catchAbort(o("WAWebBoolFunc").returnFalse));
			...
			var e = this, n = t.chat, r = t.chatEntryPoint, a = t.threadId, i = o("WAWebStateUtils").unproxy(n);
			o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["openChatBottom"]))), i.id.isLid() && o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["openChatBottom. entry point: ", ""])), r), o("WAWebUiIdleEventBus").UiIdleEventBus.setUiBusy(!0);
			var l, s = o("WAWebThreadModelResolver").resolveThreadOrChat(i, a), u = s.msgs;
			if (u.length > 0) {
				var m;
				s !== i ? m = u.last() : a != null ? m = i.msgs.findLast(function(e) {
			...
			return new Promise(function(n) {
				...
				o("WALogger").WARN(m || (m = babelHelpers.taggedTemplateLiteralLoose(["Unexpected_scrollToFocusedMsg error: ", ""])), String(e));
			});
			...
			return new Promise(function(t) {
				...
				o("WALogger").WARN(p || (p = babelHelpers.taggedTemplateLiteralLoose(["Unexpected scrollChatToBottom error: ", ""])), String(e));
			});
			...
			self.setTimeout(function() {
				e.trigger("flash_focused_msg", n), t && e.trigger("flash_mention_msg");
			}, 0);
			...
			var e = o("WAWebStateUtils").unproxy(t);
			this.$CmdImpl$p_1 != null && this.$CmdImpl$p_1 === e.id && (this.$CmdImpl$p_1 = null), this.trigger("close_chat", e), o("WAWebWamMemoryStat").uploadMemoryInfoOnChatClose();
			...
			if (!r("gkx")("26258")) try {
				throw r("err")("Non Error - CMD logout, thrown only for getting logout stack trace");
			} catch (e) {
				e instanceof Error && o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose([`CMD.onLogoutFromBridge debug: 
 `, ""], ["CMD.onLogoutFromBridge debug: \\n ", ""])), e.stack).verbose();
			}
			o("WAWebAppTracker").AppTracker.mark(o("WAWebAppTracker").AppTrackerType.Logout), this.trigger("logout_from_bridge");
		...
		}, a.windowError = function(t) {}, a.onPanesWillChange = function(t) {
			...
			t === void 0 && (t = !1), this.trigger("close_long_link_modal", t);
			...
			this.isOfflineDeliveryEnd = !0, this.trigger("offline_delivery_end_from_bridge");
		}, a.onOfflineDeliveryStateResetFromBridge = function() {
			this.isOfflineDeliveryEnd = !1, this.trigger("offline_delivery_state_reset_from_bridge");
		}, a.onMainStreamModeReadyFromBridge = function() {
			o("WAWebPageLoadLogging").addPageLoadQplPoint("main_stream_mode_ready"), this.isMainStreamReadyMd = !0, o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["Cmd: onMainStreamModeReadyFromBridge"]))), this.trigger("main_stream_mode_ready_from_bridge");
			...
			o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["Cmd: onInitialLoadReadyFromBridge"]))), this.trigger("initial_load_ready_from_bridge");
		...
		}, a.onScheduledMsgChangedFromBridge = function(t) {
		...
		}, a.contactInfoCardRendered = function(t) {
			this.trigger("contact_info_card_rendered", t);
		}, a.botTogglePluginSearchDetailsToggle = function(t, n) {
			if (t == null) {
				o("WALogger").WARN(h || (h = babelHelpers.taggedTemplateLiteralLoose(["botTogglePluginSearchDetailsToggle: null target id"])));
				return;
			}
			this.trigger("bot_toggle_plugin_search_details_for_target_id_" + t, n);
			...
			t.highlightTerms != null && t.highlightTerms.length > 0 && this.trigger("set_msg_highlight_terms", t.highlightTerms, t.key);
		}, n;
	})(r("WAWebEventEmitter"));
	function v(e) {
		var t, n = function() {
			if (!t) {
				...
				var n = t, r = n.signal;
				o("WAWebDocumentFlushed").documentFlushed({ signal: r }).then(function() {
					r.aborted || (t = null, e());
				}, function(e) {
					if (!(e instanceof Error && e.name === o("WAAbortError").ABORT_ERROR)) throw e;
				});
			}
		};
	...
	var S = new b();
	l.Revoke = o("WAWebCmd.flow").Revoke, l.CmdImpl = b, l.deferUntilDocumentFlushed = v, l.Cmd = S;
}), 98);
