__d("WAWebCoexSystemMessageModalContent.react", [
	"fbt",
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = e.faqUrl, n = e.lid, a = e.onClose, i = e.onVerificationClick, l = e.shouldHideVerificationButton, c = l === void 0 ? !1 : l, d = e.text, m = e.textLast, p = e.wid, _ = function() {
			...
			onClick: function() {
				...
				o("WAWebCmd").Cmd.verificationDrawer({
					wid: p,
					lid: n
				});
			},
