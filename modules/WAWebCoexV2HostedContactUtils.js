__d("WAWebCoexV2HostedContactUtils", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				return o("WAWebBlocklistMigration").applyBlocklistV2Rules() ? yield p(e) : yield f(e);
			} catch (e) {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (e.isRegularUserPn()) {
				var t, n = (t = yield o("WAWebApiChatCommon").getChatRecord(e)) == null ? void 0 : t.accountLid;
				return n == null ? !1 : (yield o("WAWebSchemaBlocklist").getBlocklistTable().get(n)) != null;
			}
			return h(e);
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			return (yield o("WAWebSchemaBlocklist").getBlocklistTable().get(e.toString())) != null;
