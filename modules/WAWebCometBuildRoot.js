__d("WAWebCometBuildRoot", [
	...
	function c() {
		...
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = s.jsx(r("CometToasterRoot.react"), {}), n = s.jsx(r("CometPageTransitioning.react"), {}), e[0] = t, e[1] = n) : (t = e[0], n = e[1]);
		var a;
		return e[2] === Symbol.for("react.memo_cache_sentinel") ? (a = s.jsxs(r("CometAppShell.react"), {
			toaster: t,
			children: [n, s.jsx(r("CometAppViewStack.react"), { baseView: s.jsx(r("CometAppMainContentAreaRenderer.react"), {
