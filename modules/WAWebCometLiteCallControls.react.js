__d("WAWebCometLiteCallControls.react", [
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			t != null && t.type === "web" && (yield t.setCallMute(!e));
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (!(n == null || n.type !== "web")) {
				var r = !e || t;
				r && !(yield o("WAWebVoipAcquireMediaStream").checkVoipDevicePermissions(!0)) || (e ? yield n.setCallVideoMute(!t) : yield n.requestVideoUpgrade());
			}
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			if (!(e == null || e.type !== "web")) {
				...
				t != null && (t.userEndedCall = !0), yield e.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Self, !0);
			}
