__d("WAWebCommandCollection", [
	...
	var s = (function(e) {
		...
		var n = t.prototype;
		return n.initializeCommands = function() {
			this.addCommandsFromActions(), this.addCommandsFromSettings();
		}, n.query = function(t) {
			var e = o("WAWebL10NAccentFold").accentFold(t.query.toLowerCase());
			return this.filter(function(n) {
				var r = o("WAWebL10NAccentFold").accentFold(n.label.toLowerCase()), a = r.includes(e), i = t.type === n.type;
				return a && i;
			});
		}, n.addCommandsFromActions = function() {
			for (var e of o("WAWebActions").Action.members()) this.add({
				name: e,
				id: e,
			...
			for (var e of Array.from(o("WAWebSettings").SettingsSteps.members()).filter(function(e) {
