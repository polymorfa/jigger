__d("WAWebCommandPaletteInput.react", [
	...
	function c() {
		var e, t = o("WAWebCommandPaletteController").useCommandPalette(), n = t.activePlugin, a = (e = n == null ? void 0 : n.placeholder) != null ? e : "Search chats, messages, settings, and more", i = t.pluginStack.length ? s.jsx("div", {
			className: "x78zum5 x1q0g3np x6s0dn4",
			children: t.pluginStack.filter(function(e) {
