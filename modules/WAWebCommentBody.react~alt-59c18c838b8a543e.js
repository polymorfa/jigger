			...
			children: u.jsx(o("WAWebExpandableText.react").ExpandableText, {
				...
				children: function(t) {
					var e = t.textLimit, r = o("WAWebFormatConfigurationConversation").Conversation({
						...
						links: o("WAWebCommentFrontendUtils").getLinksFromComment(o("WAWebStateUtils").unproxy(n), o("WAWebMsgGetters").INITIAL_PAGE_SIZE),
						phoneNumbers: o("WAWebCommentFrontendUtils").getPhoneNumbersFromComment(o("WAWebStateUtils").unproxy(n), o("WAWebMsgGetters").INITIAL_PAGE_SIZE),
						selectable: !0,
						parseInlineCode: !0,
						parseQuotes: !0,
						parseLists: !0
