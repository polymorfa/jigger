__d("WAWebCommentFrontendUtils", [
	...
	function u(e) {
		...
		if (t != null && o("WAWebFrontendContactGetters").getIsMyContact(t)) return !0;
		var n = o("WAWebChatCollection").ChatCollection.get(e.parentMsgKey.remote);
		return n != null ? n.isTrusted() && n.notSpam : !1;
	}
	function c(e) {
		return e.length > 1 && o("WAWebFrontendMsgGetters").getAsAlbumAsset(e[0]) != null;
	}
	l.getLinksFromComment = e, l.getPhoneNumbersFromComment = s, l.isTrustedComment = u, l.isAlbumMessageContainer = c;
}), 98);
