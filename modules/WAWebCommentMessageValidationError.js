__d("WAWebCommentMessageValidationError", ["$InternalEnum", "WAWebHandleMsgError"], (function(t, n, r, o, a, i, l) {
	var e = n("$InternalEnum")({
		...
		function t() {
			...
			return t = e.call.apply(e, [this].concat(r)) || this, t.name = "CommentMessageValidationError", babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(o("WAWebHandleMsgError").MessageValidationError);
	l.CommentMessageValidationErrorCode = e, l.CommentMessageValidationError = s;
}), 98);
