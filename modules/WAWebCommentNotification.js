__d("WAWebCommentNotification", [
	...
	var e = (function(e) {
		...
		return a.shouldMute = function(t) {
			...
			return {
				...
				body: o("WAWebGetNotificationStrings").getNotificationBody(babelHelpers.extends({}, u(this.commentMsg)))
			};
		}, a.buildKey = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				return {
					uiNotificationType: o("WAWebWamEnumNotificationTypeEnum").NOTIFICATION_TYPE_ENUM.OTHER,
	...
	function u(e) {
		var t = o("WAWebContactCollection").ContactCollection.get(r("nullthrows")(e.author, "comment author cannot be null")), n = t ? o("WAWebFrontendContactGetters").getFormattedUser(t) : "", a = s._(
			/*BTDS*/
			"",
			[s._param("name", n)]
		);
