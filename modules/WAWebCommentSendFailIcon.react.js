__d("WAWebCommentSendFailIcon.react", [
	"fbt",
	"WAWebDisplayType",
	"WAWebFailIcon.react",
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = o("react-compiler-runtime").c(7), n = e.comment, a;
		...
		var c = l, d;
		return t[3] !== n.id || t[4] !== n.isFailed || t[5] !== c ? (d = n.isFailed ? u.jsx(r("WAWebFailIcon.react"), {
		...
		}) : null, t[3] = n.id, t[4] = n.isFailed, t[5] = c, t[6] = d) : d = t[6], d;
	}
	l.default = c;
}), 226);
