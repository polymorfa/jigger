__d("WAWebCommonCTWALogging", [
	...
	function e(e) {
		var t, n;
		if (o("WAWebConnModel").Conn.isSMB && e.ctwaContext != null && o("WAWebGetCTWAEligibilityFromConversion").getCTWAEligibilityFromConversion({
			...
			var r = (t = o("WAWebUserPrefsMeUser").getMaybeMePnUser()) == null ? void 0 : t.toString();
