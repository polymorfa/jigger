__d("WAWebCommonGroupSubtitle.react", [
	"fbt",
	...
	function d(e) {
		var t = e.commonGroup, n = e.searchQuery, r = t[1], a = r.slice(0, 2), i = c(a, { formatString: "*" }), l = c(a).toString(), s = o("WAWebFormatConfiguration").Search({ terms: [n == null ? void 0 : n.trimmed()] });
