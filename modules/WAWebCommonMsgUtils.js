__d("WAWebCommonMsgUtils", [
	...
	function u(e, t) {
		switch (e) {
			...
			case o("WAWebMsgType").MSG_TYPE.POLL_ADD_OPTION_DECRYPTED: return !0;
			case o("WAWebMsgType").MSG_TYPE.PROTOCOL: return t === "ephemeral_setting" || t === "share_phone_number" || t === "event_edit_decrypted" || t === "limit_sharing_system_message";
			default: return !1;
		}
	}
	function c(e) {
		return e === o("WAWebMsgType").MSG_TYPE.CIPHERTEXT || e === o("WAWebMsgType").MSG_TYPE.DEBUG_PLACEHOLDER;
	}
	function d(e) {
	...
	function _(e) {
		...
		return n === o("WAWebRichResponse.flow").RichResponseParseState.Partial || n === o("WAWebRichResponse.flow").RichResponseParseState.Parsed;
	}
	function f(e) {
	...
	function g(t) {
		...
		}), r > 0 && o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			"undefined message type count::",
			" msgIds::",
			""
		])), r, n).sendLogs("undefined-msg-type", { sampling: .01 });
	}
	l.EventType = s, l.isNotificationType = u, l.isPlaceholderMsg = c, l.isQuarantinedMsg = d, l.isFutureproofMsg = m, l.isRichResponseMsg = p, l.isSomewhatParsedRichResponseMsg = _, l.isCallLogMsg = f, l.logUndefinedMessage = g;
}), 98);
