__d("WAWebCommonNewsletterEnums", ["$InternalEnum"], (function(t, n, r, o, a, i) {
	var e, l = (e = n("$InternalEnum"))({
		...
		PINNED_MESSAGES: 21
	}), f = e.Mirrored(["ACTIVE", "INACTIVE"]), g = e.Mirrored([
		"ENFORCEMENT",
		"REPORT",
		"RESPONSE_REPORT",
		"STATUS_REPORT"
	]), h = e.Mirrored(["MESSAGE", "STATUS"]), y = e.Mirrored([
		"Bootstrap",
		"DirtyBit",
		"Debug"
	]);
	i.NewsletterMembershipType = l, i.NewsletterPrivacy = s, i.NewsletterState = u, i.NewsletterReactionCodesSetting = c, i.EnforcementType = d, i.AlertScreen = m, i.NewsletterDSADecisionModalCategory = p, i.NewsletterCapability = _, i.WamoSubStatus = f, i.ReviewType = g, i.ViolatingContentType = h, i.NewsletterMetadataUpdateEntryPoint = y;
}), 66);
