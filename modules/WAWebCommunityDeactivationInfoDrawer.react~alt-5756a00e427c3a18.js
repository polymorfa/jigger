__d("WAWebCommunityDeactivationInfoDrawer.react", [
	...
	function f(e) {
		var t = e.chat, n = e.onBack, a = e.ref, i = o("useWAWebModelValues").useModelValues(t.contact, ["id", "name"]), l = d(o("WAWebThemeContext").ThemeContext), c = l.theme, f = p();
		m(function() {
		...
		var g = c === "dark", h = g ? o("WAWebDeactivateBadgeDarkIcon.react").DeactivateBadgeDarkIcon : o("WAWebDeactivateBadgeIcon.react").DeactivateBadgeIcon, y = s._(
			/*BTDS*/
			"",
			[s._param("community-name", u.jsx(o("WAWebEmojiText.react").EmojiText, { text: i.name }))]
		), C = s._(
			/*BTDS*/
			""
		), b = [
			...
			o("WAWebModalManager").ModalManager.open(u.jsx(r("WAWebCommunityDeactivationPopup.react"), { chat: t }));
		};
