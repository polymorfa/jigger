__d("WAWebCommunityGroupJourneyEventImpl", [
	"WALogger",
	...
	var e, s = (function() {
		function t(e) {
			var t = e.action, n = e.chat, r = e.surface;
			this.action = t, this.surface = r, this.chat = n, this.sessionId = o("WAWebGetSharedSessionId").getSharedSessionId();
		}
		t.inviteModalSourceToSurface = function(n) {
			...
			e: {
				...
				if (n === "other") {
					o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["No relevant communtiy journey log for this invite modal"]))), t = null;
					break e;
				}
		...
		var n = t.prototype;
		return n.shouldLogThreadType = function() {
			switch (this.surface) {
				...
				case o("WAWebWamEnumSurfaceType").SURFACE_TYPE.COMMUNITY_NAV_SHEET:
				case o("WAWebWamEnumSurfaceType").SURFACE_TYPE.COMMUNITY_SETTINGS:
				case o("WAWebWamEnumSurfaceType").SURFACE_TYPE.GROUP_INFO: return !0;
				default: return !1;
			}
		}, n.getThreadType = function() {
			var e;
			return !this.shouldLogThreadType() || ((e = this.chat) == null ? void 0 : e.groupMetadata) == null ? null : o("WAWebGetThreadType").getThreadType(this.chat);
		}, n.getGroupSize = function() {
			var e, t, n = (e = this.chat) == null ? void 0 : e.groupMetadata;
