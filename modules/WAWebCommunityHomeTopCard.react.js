__d("WAWebCommunityHomeTopCard.react", [
	...
	function b(e) {
		var t = o("react-compiler-runtime").c(26), a = e.chat, i;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (i = ["name"], t[0] = i) : i = t[0];
		var l = o("useWAWebModelValues").useModelValues(a.contact, i), s;
		t[1] !== a.groupMetadata ? (s = r("nullthrows")(a.groupMetadata), t[1] = a.groupMetadata, t[2] = s) : s = t[2];
		var u;
		t[3] === Symbol.for("react.memo_cache_sentinel") ? (u = ["creation", "restrict"], t[3] = u) : u = t[3];
		var c = o("useWAWebModelValues").useModelValues(s, u), d = r("useWAWebUnmountSignal")(), m = _(!1), f = m[0], h = m[1], y = r("useWAWebShowCommunitySubjectSyncIssue")(a), C;
		t[4] !== a || t[5] !== l.name || t[6] !== d ? (C = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = e;
				t.trim() !== l.name && (yield r("WAPromiseRaceAbort")(o("WAWebSetSubjectGroupAction").setGroupSubject(a, t), d).catch(o("WAAbortError").catchAbort(r("WAWebNoop"))).catch(S));
			});
			return function(n) {
				return e.apply(this, arguments);
			};
		})(), t[4] = a, t[5] = l.name, t[6] = d, t[7] = C) : C = t[7];
		var b = C, R = v, L;
		t[8] !== a ? (L = function() {
		...
		var E = L, k;
		t[10] !== f || t[11] !== c || t[12] !== y ? (k = y && !f ? !1 : c.canSetSubject(), t[10] = f, t[11] = c, t[12] = y, t[13] = k) : k = t[13];
		var I = c.restrict ? R : void 0, T;
		t[14] !== l.name || t[15] !== b || t[16] !== k || t[17] !== I ? (T = p.jsx(r("WAWebGroupInfoSubjectInput.react"), {
			testid: "community-home-subject-input",
			subject: l.name,
			onSave: b,
			editable: k,
			editRestrictionInfo: I
		}), t[14] = l.name, t[15] = b, t[16] = k, t[17] = I, t[18] = T) : T = t[18];
		var D;
		t[19] !== f || t[20] !== E || t[21] !== y ? (D = y && !f ? p.jsx(r("WAWebUnstyledButton.react"), {
			onClick: E,
		...
		}) : null, t[19] = f, t[20] = E, t[21] = y, t[22] = D) : D = t[22];
		var x;
		return t[23] !== T || t[24] !== D ? (x = p.jsxs(o("WAWebFlex.react").FlexRow, {
			xstyle: g.subjectInputFlex,
			children: [T, D]
		}), t[23] = T, t[24] = D, t[25] = x) : x = t[25], x;
	}
	function v() {
