__d("WAWebCommunityHomeTopCard.react", [
	...
	function b(e) {
		var t = e.chat, a = o("useWAWebModelValues").useModelValues(t.contact, ["name"]), i = o("useWAWebModelValues").useModelValues(r("nullthrows")(t.groupMetadata), ["creation", "restrict"]), l = r("useWAWebUnmountSignal")(), c = _(!1), d = c[0], m = c[1], f = r("useWAWebShowCommunitySubjectSyncIssue")(t), h = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var n = e;
				n.trim() !== a.name && (yield r("WAPromiseRaceAbort")(o("WAWebSetSubjectGroupAction").setGroupSubject(t, n), l).catch(o("WAAbortError").catchAbort(r("WAWebNoop"))).catch(function(e) {
		...
		return p.jsxs(o("WAWebFlex.react").FlexRow, {
			...
			children: [p.jsx(r("WAWebGroupInfoSubjectInput.react"), {
				...
				subject: a.name,
				onSave: h,
				editable: f && !d ? !1 : i.canSetSubject(),
				editRestrictionInfo: i.restrict ? y : void 0
			}), f && !d ? p.jsx(r("WAWebUnstyledButton.react"), {
				onClick: C,
