__d("WAWebCommunityPopupNux.react", [
	"fbt",
	"WAWebCmd",
	...
	function _(e) {
		var t = e.onClose, n = e.parentChat, a = m(), i = function() {
			o("WAWebModalManager").ModalManager.close(), t == null || t();
		}, l = function() {
			o("WAWebCmd").Cmd.openCommunityHome(n.id), o("WAWebModalManager").ModalManager.close(), t == null || t();
		}, c = s._(
			/*BTDS*/
			""
			...
			" ",
			o("WAWebCommunityGatingUtils").communityCreatePrivacyEnabled() ? null : u.jsx(o("WAWebExternalLink.react").ExternalLink, {
		...
		return d(function() {
			...
			children: [
				...
				n.formattedTitle != null ? u.jsx(o("WAWebFlex.react").FlexRow, {
					align: "center",
					justify: "center",
					children: u.jsx(o("WAWebText_DONOTUSE.react").TextParagraph, { children: n.formattedTitle })
				}) : null,
				u.jsx(o("WAWebFlex.react").FlexRow, {
					align: "center",
					justify: "center",
				...
				u.jsx(o("WAWebFlex.react").FlexRow, {
					...
					children: u.jsx(o("WAWebText_DONOTUSE.react").TextParagraph, {
						xstyle: p.disclaimer,
						size: "13",
						children: o("WAWebCommunityGatingUtils").communityCreatePrivacyEnabled() ? h : g
					})
				})
			]
		});
