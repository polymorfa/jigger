__d("WAWebCommunityRemoveSubgroup", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(21), n = e.handleRemove, a = e.removeDisclaimer, i = e.removeParticipantOption, l = i === void 0 ? !1 : i, d = r("useWAWebToggle")(!1), m = d[0], p = d[1], _, f;
		...
		if (l) {
			var h;
			t[1] === Symbol.for("react.memo_cache_sentinel") ? (h = { className: "x1rg5ohu x1okw0bk x1uuroth x19991ni x1d8287x xwji4o3 x1sa5p1d" }, t[1] = h) : h = t[1];
			var y;
			t[2] !== m || t[3] !== p ? (y = u.jsx("div", babelHelpers.extends({ "data-testid": "checkbox-remove-orphan-members" }, h, { children: u.jsx(o("WAWebCheckBox.react").CheckBox, {
				onChange: p,
				checked: m,
				id: "checkbox-remove-orphan-members"
			}) })), t[2] = m, t[3] = p, t[4] = y) : y = t[4];
			var C = y, b;
			...
			var v = b, S;
			t[6] !== a ? (S = u.jsx(o("WAWebText.react").WAWebTextMuted, {
			...
			var L;
			t[9] !== C ? (L = u.jsxs(o("WAWebFlex.react").FlexRow, {
				xstyle: R,
				children: [C, v]
			}), t[9] = C, t[10] = L) : L = t[10];
			var E;
			t[11] !== S || t[12] !== L ? (E = u.jsxs(u.Fragment, { children: [S, L] }), t[11] = S, t[12] = L, t[13] = E) : E = t[13], _ = E;
		}
		var k;
		t[14] !== m || t[15] !== n ? (k = function() {
			return n(m);
		}, t[14] = m, t[15] = n, t[16] = k) : k = t[16];
		var I;
		t[17] === Symbol.for("react.memo_cache_sentinel") ? (I = s._(
			/*BTDS*/
			""
		), t[17] = I) : I = t[17];
		var T = l ? _ : a, D;
		return t[18] !== k || t[19] !== T ? (D = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			onOK: k,
