__d("WAWebCommunitySubgroupImage.react", [
	...
	function g(t) {
		var n = t.chat, a = t.isHovered, i = t.parentGroupChat, l = t.selection, s = t.size, g = r("useWAWebActiveSelection")(l, n.id.toString()), h = g[1], y = 32, C;
		switch (s) {
			case 38:
				y = 26, C = _;
				break;
		...
		return u.jsxs("div", babelHelpers.extends({ "data-testid": "subgroup-identity" }, (e || (e = r("stylex"))).props([c.container, C.container]), { children: [u.jsx(o("WAWebDetailImage.react").DetailImage, {
			shape: o("WAWebDetailImage.react").DetailImageShape.Squircle,
			id: i.id,
			size: y
		}), u.jsx("div", babelHelpers.extends({}, e.props(c.subgroupImage, C.subgroupImage), { children: u.jsx(o("WAWebDetailImage.react").DetailImage, {
			id: n.id,
			size: y,
