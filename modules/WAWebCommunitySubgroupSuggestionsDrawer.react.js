__d("WAWebCommunitySubgroupSuggestionsDrawer.react", [
	...
	function h(e) {
		var t = o("react-compiler-runtime").c(10), n = e.isAdmin, a = e.onSubgroupSuggestionAction, i = e.suggestions, l = e.title, s;
		...
		var u;
		t[1] !== l ? (u = c.jsx(r("WAWebSectionHeader.react"), {
			header: l,
			xstyle: s
		}), t[1] = l, t[2] = u) : u = t[2];
		var d;
		t[3] !== n || t[4] !== a || t[5] !== i ? (d = i == null ? void 0 : i.map(function(e) {
			return c.jsx(r("WAWebCommunitySubgroupSuggestion.react"), {
				subgroupSuggestion: e,
				isAdmin: n,
				onSubgroupSuggestionAction: a
			}, e.id);
		}), t[3] = n, t[4] = a, t[5] = i, t[6] = d) : d = t[6];
		var m;
		return t[7] !== u || t[8] !== d ? (m = c.jsxs(r("WAWebDrawerSection.react"), {
