__d("WAWebCompanionInviteContactWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumCompanionInviteActionType",
	"WAWebWamEnumCompanionInviteMethodType",
	"WAWebWamEnumCompanionInviteOriginType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ CompanionInviteContact: [
		8230,
		{
			companionInviteAction: [8, o("WAWebWamEnumCompanionInviteActionType").COMPANION_INVITE_ACTION_TYPE],
			companionInviteCodeError: [1, e.TYPES.STRING],
			companionInviteMethod: [2, o("WAWebWamEnumCompanionInviteMethodType").COMPANION_INVITE_METHOD_TYPE],
			companionInviteNumContactsAddressBook: [3, e.TYPES.INTEGER],
			companionInviteNumContactsWa: [4, e.TYPES.INTEGER],
			companionInviteOrigin: [5, o("WAWebWamEnumCompanionInviteOriginType").COMPANION_INVITE_ORIGIN_TYPE],
