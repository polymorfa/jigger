__d("WAWebComposeBox.react", [
	...
	var A = w;
	function F(e) {
		var t = o("react-compiler-runtime").c(3), n = e.chat, r = e.handleFocus, a;
		t[0] !== n.id ? (a = n.id.toString(), t[0] = n.id, t[1] = a) : a = t[1];
		var i = a;
		o("useWAWebListener").useListener(o("WAWebComposeBoxActions").ComposeBoxActions, "focus_" + i, r), o("useWAWebListener").useListener(o("WAWebComposeBoxActions").ComposeBoxActions, "focus", r);
		var l;
		return t[2] === Symbol.for("react.memo_cache_sentinel") ? (l = C.jsx(o("WAWebUimUie.react").UIE, { displayName: "PlaceholderComposeBox" }), t[2] = l) : l = t[2], l;
	}
	l.ComposeBox = A, l.PlaceholderComposeBox = F;
}), 226);
