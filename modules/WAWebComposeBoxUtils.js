__d("WAWebComposeBoxUtils", [
	...
	function m(t) {
		var a = t.accessibilityLabel, i = t.attribution, l = t.filename, s = t.gifUrl;
		return r("WAWebPonyfillsFetch")(s, { headers: { Accept: "video/mp4" } }).then(function(t) {
