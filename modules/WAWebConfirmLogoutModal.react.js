__d("WAWebConfirmLogoutModal.react", [
	...
	function m(e) {
		var t = o("react-compiler-runtime").c(16), n = e.checkUnsent, a;
		...
		var y = h, C;
		t[6] === Symbol.for("react.memo_cache_sentinel") ? (C = i ? {
			text: s._(
				/*BTDS*/
				""
			),
		...
		var E;
		t[11] !== l ? (E = i ? u.jsx(r("WDSText.react"), {
			type: "Body1",
			colorName: "contentDeemphasized",
			children: l
		}) : l, t[11] = l, t[12] = E) : E = t[12];
		var k;
		t[13] === Symbol.for("react.memo_cache_sentinel") ? (k = u.jsx("br", {}), t[13] = k) : k = t[13];
		var I;
		return t[14] !== E ? (I = u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: v,
			title: S,
			onOK: _,
			okText: R,
