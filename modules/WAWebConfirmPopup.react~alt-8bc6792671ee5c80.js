__d("WAWebConfirmPopup.react", [
	...
	function m(e) {
		var t = o("react-compiler-runtime").c(8), n = e.disabled, r = e.onClick, a = e.primary, i = e.spinner, l = e.text, s = e.type, u = n === void 0 ? !1 : n, d = a === void 0 ? !1 : a, m;
		t[0] !== r ? (m = function(t) {
			t.stopPropagation(), t.preventDefault(), r();
		}, t[0] = r, t[1] = m) : m = t[1];
		var p = m, _ = s != null ? s : d ? "primary" : "secondary", f;
		return t[2] !== u || t[3] !== p || t[4] !== i || t[5] !== _ || t[6] !== l ? (f = c.jsx(o("WAWebButton.react").Button, {
