__d("WAWebContactImportFileProcessor", [
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield e.arrayBuffer(), r = yield o("WAWebContactImportXLSXParsingUtils").loadXLSX(n);
			return v(r, t);
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield e.text(), r = yield o("WAWebContactImportCSVParsingUtils").loadPapaParse(n);
			return v(r.data, t);
	...
	function x() {
		return x = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			}), a = r.slice(0, f), i = o("WAWebContactImportSmartColumnDetection").smartDetectColumns(n, a), l = yield $(i, n, a, t.onConfirmDetection);
	...
	function B() {
		return B = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = e.map(function(e) {
				return {
					contact: e,
					normalizedPhone: F(e.phone)
				};
			}), r = n.map(function(e) {
				var t = e.normalizedPhone;
				return t;
			}), a = yield o("WAWebContactImportContactVerifier").verifyWhatsAppUsers(r, t), i = [], l = [];
		...
		return q = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, r) {
			...
			try {
				...
				o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose([
					...
					"+ ",
					"-"
				])), I.length, x.length), n.onComplete(I, x);
			} catch (e) {
				var $ = e instanceof Error ? e.name : typeof e, P = e instanceof Error ? e.message : String(e), N = e instanceof o("WAWebContactImportTypedError").WAWebContactImportTypedError ? String(e.type) : "none";
				o("WALogger").ERROR(_ || (_ = babelHelpers.taggedTemplateLiteralLoose([
					...
					" type=",
					""
				])), a, t.name, $, P, N).verbose().sendLogs("contact-import-file-processing-failed", { sampling: 1 }), n.onError(e);
			}
