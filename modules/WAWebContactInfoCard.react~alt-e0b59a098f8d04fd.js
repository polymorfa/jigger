__d("WAWebContactInfoCard.react", [
	...
	function C(e) {
		...
		var i = o("useWAWebContactValues").useContactValues(r.id, a), l = i[0], s = i[1], c = i[2];
		if (l) {
			var d = s != null && s !== "" ? s : c.displayName, m;
			return t[1] !== d ? (m = u.jsx(b, { contactName: d }), t[1] = d, t[2] = m) : m = t[2], m;
		}
		var p;
		return t[3] !== n ? (p = u.jsx(v, { chat: n }), t[3] = n, t[4] = p) : p = t[4], p;
	}
	function b(e) {
