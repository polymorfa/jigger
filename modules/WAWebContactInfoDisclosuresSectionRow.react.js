__d("WAWebContactInfoDisclosuresSectionRow.react", [
	...
	function d() {
		...
		var n = t, r;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (r = u.jsx(o("WAWebSingleChevronInCircleIcon.react").SingleChevronInCircleIcon, {
			iconXstyle: c.secondaryColor,
			height: 22,
			width: 22
		}), e[1] = r) : r = e[1];
		var a;
		e[2] === Symbol.for("react.memo_cache_sentinel") ? (a = u.jsx(o("WAWebText.react").WAWebTextMuted, {
			testid: "contact-info-ads-disclosure-setting-row-subtitle",
			children: n
		}), e[2] = a) : a = e[2];
		var i;
		return e[3] === Symbol.for("react.memo_cache_sentinel") ? (i = u.jsx(o("WAWebChatInfoDrawerRow.react").ChatInfoDrawerRow, {
			icon: r,
