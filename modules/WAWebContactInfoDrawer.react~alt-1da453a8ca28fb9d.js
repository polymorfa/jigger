__d("WAWebContactInfoDrawer.react", [
	...
	function S(e) {
		var t = e.catalogContext, n = e.contact, a = e.onProductCatalog, i = e.onProductDetail, l = o("WAWebCatalogCollection").CatalogCollection.get(n.id);
		if (!l) return null;
		var u = s._(
			/*BTDS*/
			""
		), c = !0, d = t.session;
		return d.isAccidental() ? null : o("WAWebBusinessProfileUtils").hasShop(n.businessProfile) ? o("WAWebBusinessProfileUtils").isShopBanned(n.businessProfile) ? null : m.jsx(r("VultureJSDeadComponent.react"), { name: "WAWebProductCatalogShopsCatalogDrawerSection" }) : m.jsx(r("WAWebProductCatalogCatalogDrawerSection.react"), {
			onProductDetail: i,
			onProductCatalog: a,
			catalog: l,
			subtitle: u,
	...
	function L(e) {
		var t = e.chat;
		return t != null ? m.jsx(r("WAWebContactInfoChatTabFull.react"), { chat: t }) : m.jsx(r("WAWebDrawerBody.react"), { children: m.jsx("div", {
	...
	function E(e) {
		var t = e.chatId, n = e.handleClick, a = e.isRefresh, i = h(function() {
			return o("WAWebChatCollection").ChatCollection.get(t) != null;
		}), l = i[0], u = i[1];
		if (o("useWAWebListener").useListener(o("WAWebChatCollection").ChatCollection, "remove", function(e) {
			e.id.equals(t) && u(!1);
		}), !l) return null;
		var c = "li-delete-chat", d = s._(
			/*BTDS*/
			""
		);
		return a === !0 ? m.jsx(o("WAWebChatInfoDrawerSection.react").ChatInfoDrawerButtonsSection, { children: m.jsx("div", {
			className: "x1280gxy",
			children: m.jsx(r("WAWebDrawerButtonRefreshed.react"), {
				testid: c,
				icon: m.jsx(o("WAWebDeleteRefreshedIcon.react").DeleteRefreshedIcon, {}),
				danger: !0,
				onClick: n,
				children: d
			})
		}) }) : m.jsx(o("WAWebChatInfoDrawerSection.react").ChatInfoDrawerButtonsSection, { children: m.jsx(o("WAWebDrawerButton.react").DrawerButtonSimple, {
			testid: c,
