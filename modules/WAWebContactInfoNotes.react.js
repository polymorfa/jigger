__d("WAWebContactInfoNotes.react", [
	...
	function S(e) {
		var t, a, i, l = o("react-compiler-runtime").c(15), s = e.chatJid, u = e.contact, d = L(s), m = d.value, p = (t = m == null ? void 0 : m.content) != null ? t : "", _ = (a = m == null ? void 0 : m.createdAt) != null ? a : null, f = (i = m == null ? void 0 : m.modifiedAt) != null ? i : null, g;
		l[0] !== s || l[1] !== u || l[2] !== m || l[3] !== p ? (g = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (e !== p) return o("WAWebNotesLogEvents").logNoteSaved(u, {
					content_existed: p !== "",
					has_content: e !== "",
					length: e.length,
					previous_length: p.length
				}), m == null ? o("WAWebNoteAction").noteAddAction({
					chatJid: s,
					content: e,
					type: "unstructured"
				}) : o("WAWebNoteAction").noteEditAction(m.id, "unstructured", s, e, m.createdAt);
			});
			return function(n) {
				return e.apply(this, arguments);
			};
		})(), l[0] = s, l[1] = u, l[2] = m, l[3] = p, l[4] = g) : g = l[4];
		var h = g, y = r("useWAWebAsyncSaving")(h), C = y[0], b = y[1];
		if (!(d.error != null || d.loading)) {
			var v;
			l[5] !== u || l[6] !== _ || l[7] !== f || l[8] !== p || l[9] !== b || l[10] !== C ? (v = c.jsx(R, {
				contact: u,
				createdAt: _,
				modifiedAt: f,
				note: p,
				saveNote: b,
				savingNote: C
			}), l[5] = u, l[6] = _, l[7] = f, l[8] = p, l[9] = b, l[10] = C, l[11] = v) : v = l[11];
			var S;
			return l[12] !== u || l[13] !== v ? (S = c.jsx(I, {
				contact: u,
				children: v
			}), l[12] = u, l[13] = v, l[14] = S) : S = l[14], S;
		}
	}
	function R(e) {
