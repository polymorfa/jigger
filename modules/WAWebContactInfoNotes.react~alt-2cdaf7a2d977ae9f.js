__d("WAWebContactInfoNotes.react", [
	...
	function S(e) {
		var t, a, i, l = e.chatJid, s = e.contact, u = L(l), d = u.value, p = (t = d == null ? void 0 : d.content) != null ? t : "", _ = (a = d == null ? void 0 : d.createdAt) != null ? a : null, f = (i = d == null ? void 0 : d.modifiedAt) != null ? i : null, g = m((function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (e !== p) return o("WAWebNotesLogEvents").logNoteSaved(s, {
					content_existed: p !== "",
					has_content: e !== "",
					length: e.length,
					...
					content: e,
					type: "unstructured"
				}) : o("WAWebNoteAction").noteEditAction(d.id, "unstructured", l, e, d.createdAt);
			});
			return function(t) {
			...
			d,
			p
		]), h = r("useWAWebAsyncSaving")(g), y = h[0], C = h[1];
		if (!(u.error != null || u.loading)) return c.jsx(I, {
			contact: s,
			children: c.jsx(R, {
				contact: s,
				createdAt: _,
