__d("WAWebContactInfoNotes.react", [
	...
	function v(e) {
		var t, n, r = e.contact, a = o("WAJids").validateChatJid((t = r == null || (n = r.id) == null ? void 0 : n.toJid()) != null ? t : "");
		return r == null || a == null ? null : c.jsx(S, {
			contact: r,
			chatJid: a
		});
	}
	...
	function S(e) {
		var t, n, a, i = e.chatJid, l = e.contact, s = L(i), u = s.value, d = (t = u == null ? void 0 : u.content) != null ? t : "", p = (n = u == null ? void 0 : u.createdAt) != null ? n : null, _ = (a = u == null ? void 0 : u.modifiedAt) != null ? a : null, f = m(async function(e) {
			if (e !== d) return o("WAWebNotesLogEvents").logNoteSaved(l, {
				content_existed: d !== "",
				has_content: e !== "",
				length: e.length,
				previous_length: d.length
			}), u == null ? o("WAWebNoteAction").noteAddAction({
				chatJid: i,
				content: e,
				type: "unstructured"
			}) : o("WAWebNoteAction").noteEditAction(u.id, "unstructured", i, e, u.createdAt);
		}, [
			i,
			l,
			u,
			d
		]), g = r("useWAWebAsyncSaving")(f), h = g[0], y = g[1];
		if (!(s.error != null || s.loading)) return c.jsx(I, {
			contact: l,
			children: c.jsx(R, {
				contact: l,
				createdAt: p,
	...
	function k(e, t) {
		...
		var r = m(function(t) {
			n.current || (o("WAWebNotesLogEvents").logStartedTypingNote(e, { content_existed: t }), n.current = !0);
		}, [e]);
		return r;
	}
	function I(e) {
		var t = e.children, n = e.contact, a = f(!1), i = f(), l = r("useWAWebOnScreen")(i, r("WAWebNoop"));
		return p(function() {
			l && !a.current && (o("WAWebNotesLogEvents").logNoteViewed(n), a.current = !0);
		}, [n, l]), c.jsx("span", {
			ref: i,
			children: t
		});
