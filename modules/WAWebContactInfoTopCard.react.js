__d("WAWebContactInfoTopCard.react", [
	...
	function g(e) {
		var t = o("react-compiler-runtime").c(94), n = e.contact, a = e.displayRequestPhoneNumber, i = e.isMessageYourselfChat, l = e.onContactInfoAction, u = e.onDetailImageClick, c = e.onDetailImageLoad, m = e.onOpenChatTabInContactManager, _ = e.onSaveContact, g = e.onSearchMsgs, y = e.sourceChat, C = r("useWAWebVideoAvatarUrl")(n.id), b;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (b = [o("WAWebFrontendContactGetters").getPhoneNumber, o("WAWebContactGetters").getShowBusinessCheckmarkAsPrimary], t[0] = b) : b = t[0];
		var R = o("useWAWebContactValues").useContactValues(n.id, b), L = R[0], E = R[1], k;
		if (t[1] !== n || t[2] !== L) {
		...
		var ke;
		t[77] !== n || t[78] !== _e || t[79] !== i || t[80] !== l || t[81] !== m || t[82] !== _ || t[83] !== g ? (ke = !i && !o("WAWebBotUtils").isWidTeeGroupMetaBotFbidWid(n.id) && d.jsx(v, {
			contact: n,
	...
	function v(t) {
		var n = t.contact, a = t.displayRequestPnButton, i = t.onContactInfoAction, l = t.onOpenChatTabInContactManager, u = t.onSaveContact, c = t.onSearchMsgs, m = o("useWAWebVoipIsCallingEnabledAndInited").useWAWebVoipIsCallingEnabledAndInited(), p = m.inited, _ = r("useWAWebEventTargetValue")(r("WAWebCallCollection"), "change:activeCall", function() {
			...
			i == null || i("message"), C(n.id);
		}, g = [], h = o("WAWebContactGetters").getIsAiHub(n), y = o("WAWebChatCollection").ChatCollection.getActive(), b = !h && (l != null || !(y != null && y.id.equals(n.id)));
		b && g.push({
