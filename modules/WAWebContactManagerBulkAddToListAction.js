__d("WAWebContactManagerBulkAddToListAction", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			var a = yield (s || (s = n("Promise"))).allSettled(Array.from(t).map(function(e) {
			...
			u > 0 && o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose([
				"[customer_manager] bulkAddToList: ",
				" of ",
				" find-or-create calls failed"
			])), u, a.length).sendLogs("customer_manager_bulk_add_to_list_find_or_create_failed"), i.length !== 0 && o("WAWebLabelCollection").LabelCollection.addOrRemoveLabels([{
				id: r,
				type: "add"
			}], i);
