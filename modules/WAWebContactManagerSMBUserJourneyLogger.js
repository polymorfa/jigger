__d("WAWebContactManagerSMBUserJourneyLogger", [
	"$InternalEnum",
	...
	var e = {
		...
		return n.$1 = function(t) {
			o("WAWebSMBUserJourneyLogger").SMBUserJourneyLogger.log(babelHelpers.extends({}, t, { featureName: o("WAWebWamEnumSmbFeatureNameEnum").SMB_FEATURE_NAME_ENUM.CUSTOMER_MANAGER }));
		}, n.viewList = function(t, n) {
			this.$1(babelHelpers.extends({}, t != null ? { entryPoint: t } : {}, {
				extraAttributes: n,
				surface: o("WAWebWamEnumSurfaceType").SURFACE_TYPE.CUSTOMER_MANAGER_LIST,
			...
			this.$1({
				...
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.DISMISS
			});
			...
			this.$1({
				...
				surface: t === "pipeline" ? o("WAWebWamEnumSurfaceType").SURFACE_TYPE.CUSTOMER_MANAGER_PIPELINE : o("WAWebWamEnumSurfaceType").SURFACE_TYPE.CUSTOMER_MANAGER_LIST,
				userActionTarget: n === "list" ? e.VIEW_TOGGLE_LIST : e.VIEW_TOGGLE_PIPELINE,
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.CLICK
			});
			...
			this.$1({
				...
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.SEARCH
			});
			...
			this.$1({
				...
				surface: o("WAWebWamEnumSurfaceType").SURFACE_TYPE.CUSTOMER_MANAGER_COLUMNS_MENU,
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.VIEW
			});
			...
			this.$1({
				...
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.EDIT
			});
			...
			this.$1({
				surface: o("WAWebWamEnumSurfaceType").SURFACE_TYPE.CUSTOMER_MANAGER_ACTIONS_MENU,
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.VIEW
			});
			...
			this.$1({
				...
				surface: o("WAWebWamEnumSurfaceType").SURFACE_TYPE.CUSTOMER_MANAGER_PIPELINE,
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.VIEW
			});
			...
			this.$1({
				...
				surface: o("WAWebWamEnumSurfaceType").SURFACE_TYPE.CUSTOMER_MANAGER_ADD_CUSTOMER,
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.VIEW
			});
			...
			this.$1({
				...
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.ENTER
			});
			...
			this.$1({
				...
				surface: o("WAWebWamEnumSurfaceType").SURFACE_TYPE.CUSTOMER_MANAGER_REMOVE_CONFIRM,
				userActionType: o("WAWebWamEnumSmbUserActionTypeEnum").SMB_USER_ACTION_TYPE_ENUM.VIEW
			});
	...
	l.SaveResult = s, l.RemoveResult = u, l.RemoveTrigger = c, l.ContactManagerUserJourneyLogger = m;
}), 98);
