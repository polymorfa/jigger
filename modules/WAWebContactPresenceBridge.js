__d("WAWebContactPresenceBridge", [
	...
	function u(e) {
		return o("WAWebSendPresenceSubscriptionJob").sendUserPresenceSubscription(e);
	}
	function c(e) {
		o("WAWebSendPresenceSubscriptionJob").sendGroupPresenceSubscription(e);
	}
	l.setPresenceAvailable = e, l.setPresenceUnavailable = s, l.subscribeUserPresence = u, l.subscribeGroupPresence = c;
}), 98);
