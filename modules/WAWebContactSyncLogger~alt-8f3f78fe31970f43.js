__d("WAWebContactSyncLogger", ["WAWebBackendErrors", "WAWebContactSyncEventWamEvent"], (function(t, n, r, o, a, i, l) {
	var e = {
		UNKNOWN: 0,
		PERIODIC_SYNC: 6,
		CONTACT_SAVE: 7,
	...
	var f = (function() {
		function e() {}
		var t = e.prototype;
		return t.createEventContext = function(t) {
			return {
			...
			var e = Date.now(), a = _(n.error), i = new (o("WAWebContactSyncEventWamEvent")).ContactSyncEventWamEvent({
				...
				contactSyncStatusResponseNew: r == null ? void 0 : r.statusChange,
				contactSyncDeviceResponseNew: r == null ? void 0 : r.deviceChange,
				contactSyncBusinessResponseNew: r == null ? void 0 : r.businessChange,
				contactSyncDisappearingModeResponseNew: r == null ? void 0 : r.disappearingModeChange
			});
			i.commit();
		}, t.logFailure = function(t, n, r, a) {
			var e, i = Date.now(), l = r ? _(r.error) : 0, s = n === 429 && a != null ? a : n, u = new (o("WAWebContactSyncEventWamEvent")).ContactSyncEventWamEvent({
				contactSyncType: t.syncType,
				contactSyncRequestOrigin: t.requestOrigin,
				...
				contactSyncRequestedCount: t.requestedCount,
				contactSyncResponseCount: (e = r == null ? void 0 : r.list.length) != null ? e : 0,
				contactSyncRequestProtocol: t.requestProtocolBitmask,
			...
			try {
				...
				var e = n instanceof o("WAWebBackendErrors").ServerStatusCodeError ? n.statusCode : void 0;
				throw this.logFailure(t, e, void 0, r), n;
			}
		}, e;
	})(), g = new f();
	l.SYNC_REQUEST_ORIGIN = e, l.createUpdateCounter = u, l.createUpdateCounterWith = c, l.getSyncTypeString = d, l.contactSyncLogger = g;
}), 98);
