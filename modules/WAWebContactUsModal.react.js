__d("WAWebContactUsModal.react", [
	...
	function y(t) {
		var a = t.entityId, i = t.onCancel, l = t.onEmail, u = t.onFailure, d = t.onSend, y = t.supportTag, b = r("useWAWebUnmountSignal")(), v = _(""), S = v[0], R = v[1], L = _(null), E = L[0], k = L[1], I = _(!1), T = I[0], D = I[1], x = _(!1), $ = x[0], P = x[1], N = p(null);
		m(function() {
			var e;
			(e = N.current) == null || e.restoreFocus(), P(o("WAWebABPropsSaga").getIsSagaV1Enabled());
		}, []);
		var M = function(t) {
			return t.length >= f;
		}, w = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				if (t) {
					...
					var n = o("WAWebABPropsSaga").getIsSagaV1Enabled(), a = yield B(n), i = JSON.stringify(a);
					o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
						"InAppSupport: Sending support request with deviceInfo=",
						":",
						""
					])), !0, i != null ? i : "n/a"), r("WAPromiseRaceAbort")(o("WAWebSendSupportRequestJob").sendSupportRequest(S, i), b).then(function(e) {
						if (e.message != null) {
			...
			l && (o("WAWebModalManager").ModalManager.close(), l({ description: S }));
		}, B = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				return e && (n = "saga"), n && (t.sagaKey = n), t.saga_copy = $, t;
			});
			return function(n) {
				...
				children: c.jsxs(o("WAWebFlex.react").FlexColumn, {
					...
					children: [
						...
						c.jsxs(r("WAWebFlexItem.react"), {
							...
							grow: 1,
							children: [
								$ ? C() : o("WAWebSupportChatStrings").SupportChatDeviceInfoDisclaimer(),
								" ",
