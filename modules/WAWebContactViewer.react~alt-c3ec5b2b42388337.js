__d("WAWebContactViewer.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = e.onSaveContact, n = e.username, a = e.vcard;
		return u.jsx(o("WAWebModal.react").Modal, {
			...
			children: u.jsxs(r("WAWebDrawer.react"), {
				...
				}), u.jsx(r("WAWebDrawerBody.react"), { children: u.jsx(o("WAWebKeyboardHotKeys.react").HotKeys, { children: u.jsx(r("WAWebVcardModalDetails.react"), {
					parsedVcard: a,
