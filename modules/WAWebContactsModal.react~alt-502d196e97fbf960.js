__d("WAWebContactsModal.react", [
	...
	function h(e) {
		var t, n = e.active, a = e.contextEnabled, i = e.contextMenu, l = e.data, s = e.elevatedPushNamesEnabled, c = e.filter, m = e.listenForAdminChange, g = e.loadOnlyContactPictures, h = g === void 0 ? !1 : g, y = e.newsletterRoles, C = e.onContext, b = e.onSelect, v = e.openContextOnClick, S = e.participantCollection, R = e.showMemberLabel, L = e.showNotifyName, E = e.showStatusRingAroundProfilePhoto, k = e.sourceChat;
		switch (l.type) {
			...
			case p.ROW: {
				var I = !!v, T = o("WATypeUtils").isString(c(l.contact)), D = T ? "group-modal" : null, x = T ? c(l.contact) : null, $ = y && o("WAWebContactGetters").getIsMe(l.contact) ? d.jsx(o("WAWebNewsletterSubscriberList.react").YouArentVisibleToYourFollowersLabel, {}) : x, P = C && i && a ? {
				...
				h && (N = o("WAWebFrontendContactGetters").getIsMyContact(l.contact));
				var M;
				if (I && C) M = C;
				else if (T) M = void 0;
				else if (b) {
				...
				var A = o("WAWebBotUtils").isWidTeeGroupMetaBotFbidWid(l.contact.id) ? o("WAWebBotFrontendUtils").getMetaAiTEEBotDisplayName() : void 0, F = l.newsletterAdminProfile ? d.jsx(o("WAWebNewsletterAdminProfilePicture.react").WAWebNewsletterAdminProfilePicture, {
				...
				return d.jsx(f, babelHelpers.extends({
					contact: l.contact,
					active: n,
					theme: D,
					secondary: $,
			...
			case p.BUTTON: return d.jsx(o("WAWebListButton.react").ListButton, {
				active: n,
				id: l.itemKey,
				onClick: l.onClick,
				children: l.text
