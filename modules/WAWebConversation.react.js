	...
	function y(e) {
		...
		var M = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAPromiseDelays").delayMs(500), !(window.document && !document.hasFocus()) && (o("WAWebStreamModel").Stream.markAvailable(), u != null && (o("WAWebChatGetters").getIsUser(u) || o("WAWebChatGetters").getIsGroup(u)) && u.presence.subscribe());
			});
			return function() {
