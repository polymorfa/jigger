__d("WAWebConversationDeprecatedLidChatBanner.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(6), a = e.latestLid, i;
		...
		if (t[2] !== a) {
			var f = (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					o("WAWebFindChatAction").findOrCreateLatestChat(a, "deprecatedLidOrPnChat").then(p).catch(m);
				});
				return function() {
					return e.apply(this, arguments);
				};
			})();
			_ = c.jsx(o("WAWebButton.react").WAWebButtonSecondary, {
				onClick: f,
				icon: o("WAWebRoundSendInvIcon.react").RoundSendInvIcon,
				children: d
			}, "go_to_latest_lid_chat"), t[2] = a, t[3] = _;
		} else _ = t[3];
		var g = _, h;
		return t[4] !== g ? (h = c.jsx(r("WAWebConversationNewBanner.react"), {
			primaryText: l,
			buttons: [g]
		}), t[4] = g, t[5] = h) : h = t[5], h;
	}
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.chat, n = yield o("WAWebCmd").Cmd.openChatFromUnread({
				chat: t,
