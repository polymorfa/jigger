	...
	function e(e, t) {
		var r = o("WABatcher").createBatcher(function(e) {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				...
				if (!(n - t >= e.maxWindowMs)) {
					...
					if (!(r <= 0)) {
						...
						yield o("WAPromiseDelays").delayMs(Math.min(r, a)), yield s(t);
					}
				}
			});
			return function(n) {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				var t = Date.now() - l;
				t < e.cooldownMs && (yield o("WAPromiseDelays").delayMs(e.cooldownMs - t)), l = Date.now(), a = !1, r.runActiveBatch();
			});
			return function() {
				return t.apply(this, arguments);
			};
