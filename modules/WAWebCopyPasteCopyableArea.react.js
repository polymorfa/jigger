__d("WAWebCopyPasteCopyableArea.react", [
	...
	function d(t) {
		...
		n[0] !== t ? (r = t.canCut, a = t.children, i = t.className, s = t.ref, d = t.testid, l = babelHelpers.objectWithoutPropertiesLoose(t, e), n[0] = t, n[1] = r, n[2] = a, n[3] = i, n[4] = l, n[5] = s, n[6] = d) : (r = n[1], a = n[2], i = n[3], l = n[4], s = n[5], d = n[6]);
		var m;
		n[7] !== i ? (m = o("WAWebClassnames").classnamesConvertMeToStylexPlease(i, "xnpuxes", c), n[7] = i, n[8] = m) : m = n[8];
		var f = r ? _ : void 0, g;
		n[9] !== l || n[10] !== m || n[11] !== f ? (g = babelHelpers.extends({}, l, {
			className: m,
			onCopy: p,
			onCut: f
		}), n[9] = l, n[10] = m, n[11] = f, n[12] = g) : g = n[12];
		var h = g, y;
		return n[13] !== a || n[14] !== h || n[15] !== s || n[16] !== d ? (y = u.jsx("div", babelHelpers.extends({}, h, {
			ref: s,
			"data-testid": d,
			children: a
		})), n[13] = a, n[14] = h, n[15] = s, n[16] = d, n[17] = y) : y = n[17], y;
	}
	function m(e, t) {
