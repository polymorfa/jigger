__d("WAWebCountriesUtils", ["WAWebLocaleModules", "asyncToGeneratorRuntime"], (function(t, n, r, o, a, i, l) {
	var e, s = Object.freeze({
		META_RECOGNIZED: "META_RECOGNIZED",
		WHATSAPP_REGISTRATION: "WHATSAPP_REGISTRATION"
	}), u = (e = {}, e[s.META_RECOGNIZED] = [
		"AC",
		"CP",
		"DG",
		"EA",
	...
	function c(e, t, n) {
		if (!(e == null || e === "") && n != null && !(t && u[t].includes(e.toUpperCase()))) return n[e.toUpperCase()];
	}
	function d(e, t) {
	...
	function p(e) {
		...
		var t = Object.entries(e.countriesMap).filter(function(t) {
			var n = t[0];
		...
		return e.prependWith != null && t.unshift([e.prependWith[0], e.prependWith[1].toJSON()]), t.map(function(e) {
			var t = e[0], n = e[1];
			return [t, n];
		});
	}
	...
	l.COUNTRY_FILTER_TYPE = s, l.getCountryNameWithMap = c, l.getCountryNameFromCountryCode = d, l.getCountriesWithMap = p, l.getCountries = _;
}), 98);
