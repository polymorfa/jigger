__d("WAWebCreateGroupAction", [
	...
	function p(t) {
		var a = t.createGroupArgs, i = t.groupCreateEntryPoint, l = t.outContacts, c = l === void 0 ? [] : l, m = t.participants, f = t.toastId, g = f === void 0 ? o("WAWebActionToast.react").genId() : f, h = a.full, y = a.parentGroupId, C = a.thumb, b = a.title, v;
		try {
			v = m.map(function(e) {
				return o("WAWebGroupMutationParticipantUtils").getGroupMutationParticipant(e, !0, "createGroup");
			});
		} catch (e) {
			return o("WAWebCoreActionsODS").logGroupCreateError(), (u || (u = n("Promise"))).resolve(void 0);
		}
		var S = c.map(function(e) {
			return o("WAWebJidToWid").userJidToUserWid(e.id);
		}), R = o("WAWebGroupCreateJob").createGroup(a, v, S).then(function(e) {
			var t = o("WAWebWidFactory").asGroupWidOrThrow(e.wid);
			o("WAWebCoreActionsODS").logGroupCreate(), i != null && new (o("WAWebGroupCreateWamEvent")).GroupCreateWamEvent({
		...
		return o("WAWebToastManager").ToastManager.open(d.jsx(o("WAWebActionToast.react").ActionToast, {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t, n = (t = e.invitedOutContacts) != null ? t : [], a = e.participants.some(function(e) {
					...
					if (l.length > 0) {
						o("WAWebModalManager").ModalManager.open(d.jsx(r("WAWebOutContactSmsInviteConfirmModal.react"), {
							names: l.map(function(e) {
								return e.getName();
							}),
							onConfirm: function() {
								o("WAWebOutContactInviteAction").sendMultiGroupInvite(l.map(function(e) {
				...
				if (a ? o("WAWebSendForNeededAddRequest").sendForNeededAddRequest(e, b, void 0, u) : u(), y == null && e.gid && o("WAWebFindChatAction").findOrCreateLatestChat(e.gid, "createGroupAction").then(function(t) {
					var n = t.chat;
					...
					}), (b === "" || o("WAWebGroupGatingUtils").isAnyoneCanLinkToGroupsM2Enabled()) && o("WAWebGroupQueryBridge").sendQueryGroup(e.gid).finally(r("WAWebNoop"));
				}), C != null && h != null) {
					var m = o("WAWebProfilePicThumbCollection").ProfilePicThumbCollection.gadd(e.gid);
					yield o("WAWebProfilePicThumbAction").setProfilePic(m, C, h).then(function() {
						return e.gid;
					});
				}
	...
	function _(e) {
		e !== 0 && o("WAWebToastManager").ToastManager.open(d.jsx(o("WAWebToast.react").Toast, { msg: o("WAWebOutContactInviteUtils").getGroupInviteAddFailedToastText(e) }));
	}
	l.createGroup = m;
}), 226);
