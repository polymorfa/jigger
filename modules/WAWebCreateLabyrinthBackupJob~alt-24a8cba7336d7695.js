__d("WAWebCreateLabyrinthBackupJob", [
	"WAWebCreateLabyrinthBackupJobMutation.graphql",
	"WAWebLabyrinthDebugStateCache",
	"WAWebRelayClient",
	"err"
], (function(t, n, r, o, a, i, l) {
	var e, s = 1, u = e !== void 0 ? e : e = n("WAWebCreateLabyrinthBackupJobMutation.graphql");
	function c(e, t) {
		var n = e.device, r = e.epoch0, o = e.mailboxRootKey, a = e.virtualDevice, i = a.encryptedSecretValues;
		return {
			device: {
			...
			virtual_device: {
				...
				encrypted_secret_values: JSON.stringify({
					...
					encrypted_epoch_storage_private_key: i.encryptedEpochStoragePrivateKey,
					encrypted_mailbox_root_key_blob: i.encryptedMailboxRootKeyBlob,
					encrypted_oblivious_validation_token_blob: i.encryptedObliviousValidationTokenBlob,
	...
	async function d(e, t) {
		var n = c(e, t), a = { input: n }, i = await o("WAWebRelayClient").commitMutation(u, a, { environmentType: "whatsapp_web" });
		if (i == null) throw r("err")("Native Labyrinth create-backup GraphQL response was empty");
		return m(e, i), i;
	}
	function m(e, t) {
		var n = t.wa_labyrinth_create_backup;
		(n == null ? void 0 : n.__typename) === "WALabyrinthCreateBackupData" && o("WAWebLabyrinthDebugStateCache").setLabyrinthDebugKeyMaterialCache({
