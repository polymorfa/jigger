__d("WAWebCreateOrEditListDrawer.react", [
	...
	function C() {
		...
		r("useWAWebOnUnmount")(function() {
			t != null && document.body != null && document.body.contains(t) && t.focus();
		});
	}
	function b(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, e);
		C();
		var l = i.entryPoint, u = i.listId, d = i.onBack, p = i.onClose, b = i.preselectedChats, S = h(!1), R = S[0], L = S[1], E = o("WAWebMobilePlatforms").isSMB(), k = o("WDSToast.react").useWDSToast(), I = k.showToast, T = u != null, D = f(function() {
			if (u == null) {
	...
	function v(e) {
		var t = e.chat, n = e.disableRemove, a = e.onRemove, i = e.showRemove, l = function() {
			a(t);
		}, c = 40, d = m.jsx(o("WAWebDetailImage.react").DetailImage, {
			id: t.id,
			size: c,
			waitIdle: !0
		}), p = o("WAWebChatGetters").getIsGroup(t) ? m.jsx(r("WAWebGroupChatImage.react"), {
			chat: t,
			regularChatImage: d,
			showCommunityInfo: !1,
			size: c,
		...
		return o("WAWebChatGetters").getIsGroup(t) ? f = m.jsx(o("WAWebName.react").Name, {
			chat: t,
			ellipsify: !0,
			titlify: !0
		}) : f = _ != null ? m.jsx(o("WAWebName.react").Name, {
			contact: _,
			ellipsify: !0,
			showBusinessCheckmark: o("WAWebContactGetters").getShowBusinessCheckmarkAsPrimary(_),
			titlify: !0,
			you: !0
		}) : null, m.jsx(r("WAWebCellV2.react"), {
			size: "medium",
			interactive: !1,
			detailLeft: m.jsx(o("WAWebErrorBoundary.react").ErrorBoundary, {
				name: "chat-cell-image",
				children: p
			}),
			primary: m.jsx(o("WAWebText.react").WAWebTextTitle, { children: f }),
			secondary: m.jsx("span", babelHelpers.extends({}, (u || (u = r("stylex"))).props(y.mutedTextColor, o("WDSFontTokenStyles").WDSFontTokenStyles.Body2), { children: m.jsx(r("WAWebChatstateInfo.react"), { chat: t }) })),
			detailRight: i ? m.jsx(r("WDSButton.react"), {
				Icon: r("WDSIconIcDelete.react"),
				variant: "borderless",
				size: "small",
				type: "destructive",
