__d("WAWebCreateOrEditListDrawer.react", [
	...
	function C(t) {
		...
		y();
		var i = a.entryPoint, l = a.listId, u = a.onBack, c = a.onClose, m = a.preselectedChats, C = g(!1), v = C[0], S = C[1], R = o("WAWebMobilePlatforms").isSMB(), L = o("WDSToast.react").useWDSToast(), E = L.showToast, k = l != null, I = _(function() {
			if (l == null) {
	...
	function b(e) {
		var t = e.chat, n = e.disableRemove, a = e.onRemove, i = e.showRemove, l = function() {
			a(t);
		}, c = 40, m = d.jsx(o("WAWebDetailImage.react").DetailImage, {
			id: t.id,
			size: c,
			waitIdle: !0
		}), p = o("WAWebChatGetters").getIsGroup(t) ? d.jsx(r("WAWebGroupChatImage.react"), {
			chat: t,
			regularChatImage: m,
			showCommunityInfo: !1,
			size: c,
		...
		return o("WAWebChatGetters").getIsGroup(t) ? f = d.jsx(o("WAWebName.react").Name, {
			chat: t,
			ellipsify: !0,
			titlify: !0
		}) : f = _ != null ? d.jsx(o("WAWebName.react").Name, {
			contact: _,
			ellipsify: !0,
			showBusinessCheckmark: o("WAWebContactGetters").getShowBusinessCheckmarkAsPrimary(_),
			titlify: !0,
			you: !0
		}) : null, d.jsx(r("WAWebCellV2.react"), {
			size: "medium",
			interactive: !1,
			...
			primary: d.jsx(o("WAWebText.react").WAWebTextTitle, { children: f }),
			secondary: d.jsx("span", babelHelpers.extends({}, (u || (u = r("stylex"))).props(h.mutedTextColor, o("WDSFontTokenStyles").WDSFontTokenStyles.Body2), { children: d.jsx(r("WAWebChatstateInfo.react"), { chat: t }) })),
			detailRight: i ? d.jsx(r("WDSButton.react"), {
				Icon: r("WDSIconIcDelete.react"),
				variant: "borderless",
				size: "small",
				type: "destructive",
