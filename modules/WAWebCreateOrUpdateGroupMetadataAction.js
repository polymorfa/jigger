__d("WAWebCreateOrUpdateGroupMetadataAction", [
	...
	function e(e) {
		...
		if (o("WAWebGroupQueryBridge").updateSubject(e.id, e.subject), r("WAWebGroupMetadataCollection").gadd(babelHelpers.extends({
			id: e.id,
			owner: e.owner,
			subject: e.subject,
			creation: e.creation,
			...
			participants: o("WAWebGroupHistoryParticipantStateHydration").guardGroupHistorySentStateDowngrade(e.id, e.participants),
			pastParticipants: e.pastParticipants,
			support: (n = e.support) != null ? n : !1,
			suspended: (a = e.suspended) != null ? a : !1,
			suspendAppealStatus: (i = e.suspendAppealStatus) != null ? i : null,
			suspendAppealUpdateTime: (l = e.suspendAppealUpdateTime) != null ? l : null,
			...
			var f;
			(f = r("WAWebGroupMetadataCollection").get(e.id)) == null || f.set({ isInternal: e.isInternal });
		}
	}
