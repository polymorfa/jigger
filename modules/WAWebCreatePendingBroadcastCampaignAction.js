__d("WAWebCreatePendingBroadcastCampaignAction", [
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			h != null ? (f = yield h.arrayBuffer(), g = JSON.stringify({
			...
			yield o("WAWebBizBroadcastCampaignStorageUtils").updateCampaignWithSync(m, {
				adGroupId: n,
				adId: null,
				broadcastJid: a,
				campaignId: m,
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var t = [], r = 0, a = yield (p || (p = n("Promise"))).all(e.audiences.map(function(t) {
			...
			for (var i of a) {
				var l = i.audience, f = i.campaignResult, g = f == null ? void 0 : f.ad_group_id;
				if (g == null) {
					r++, o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[broadcast:pending-campaign] no ad_group_id, skip ", ""])), l.broadcastJid);
					continue;
				}
				t.push({
					adGroupId: g,
			...
			try {
				...
				var h = new Set(t.map(function(e) {
					return e.broadcastJid;
				}));
				return yield p.all(Array.from(h, function(e) {
