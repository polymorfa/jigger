__d("WAWebCreateSubgroupSuggestionAction", [
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			try {
				var r;
				yield o("WAWebApiSubgroupSuggestionStore").addSubgroupSuggestions(t.id, [n]), (r = t.groupMetadata) == null || (r = r.subgroupSuggestions) == null || r.add(babelHelpers.extends({}, n, {
	...
	l.createExistingGroupsSubgroupSuggestionsAction = f, l.createNewGroupSubgroupSuggestionAction = h;
}), 226);
