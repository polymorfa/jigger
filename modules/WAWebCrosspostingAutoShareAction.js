__d("WAWebCrosspostingAutoShareAction", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, a) {
			t === "fb" ? (yield r("WAWebUserPrefsStatus").persistShareToFB(a), r("WAWebSettingsModel").shareToFB = a) : t === "ig" && (yield r("WAWebUserPrefsStatus").persistShareToIG(a), r("WAWebSettingsModel").shareToIG = a);
			...
			]), l = i[0], u = i[1], c = i[2], d = i[3], m = i[4], p = [];
			e: {
				if (l === o("WAWebUserPrefsStatusType").StatusPrivacySettingType.AllowList) {
					p = u;
					break e;
				}
				if (l === o("WAWebUserPrefsStatusType").StatusPrivacySettingType.DenyList) {
					p = c;
					break e;
				}
				if (l === o("WAWebUserPrefsStatusType").StatusPrivacySettingType.Contact) break e;
				throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + l);
			}
			var _ = t === "fb" ? a : d, f = t === "ig" ? a : m;
			try {
