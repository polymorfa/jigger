__d("WAWebCrosspostingDBOperations", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield o("WAWebCrosspostingSchema").getTable().anyOf(["statusMessageId"], [e]);
	...
	function p(t) {
		var a = t.crosspostingDestination, i = t.crosspostingState, l = t.directUrlPath, s = t.statusMessageId, u = t.uniqueId;
		return i === o("WAWebCrossposting.flow").CrosspostingState.SUCCESS ? l == null ? (e || (e = n("Promise"))).reject(r("err")("directUrlPath is required when crosspostingState is CROSSPOSTING_REQUEST_SUCCESS")) : o("WAWebCrosspostingSchema").getTable().createOrMerge([s, a], {
			statusMessageId: s,
	...
	function g(t) {
		var a = t.crosspostingDestination, i = t.crosspostingState, l = t.directUrlPath, s = t.statusMessageId;
		return i === o("WAWebCrossposting.flow").CrosspostingState.SUCCESS ? l == null ? (e || (e = n("Promise"))).reject(r("err")("directUrlPath is required when crosspostingState is CROSSPOSTING_REQUEST_SUCCESS")) : o("WAWebCrosspostingSchema").getTable().merge([s, a], {
			statusMessageId: s,
			crosspostingDestination: a,
			crosspostingState: i,
			directUrlPath: l
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			if (t.length !== 0) {
				...
				}), a = yield o("WAWebCrosspostingSchema").getTable().bulkGet(r), i = [], l = 0; l < t.length; l++) {
					var s = t[l], u = a[l];
					u == null || u.crosspostingStatusUniqueId !== s.uniqueId || i.push(o("WAWebCrosspostingSchema").getTable().merge([s.statusMessageId, s.crosspostingDestination], {
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var t = yield o("WAWebCrosspostingSchema").getTable().anyOf(["statusMessageId"], e), n = new Map();
			for (var r of t) {
