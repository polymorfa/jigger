__d("WAWebCrosspostingMsgHydration", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (o("WAWebMsgGetters").getIsStatus(e)) {
				var t = e.id.toString(), n = yield o("WAWebCrosspostingDBOperations").getCrosspostingInfoForMessage(t);
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (e.length !== 0) {
				...
				}), n = yield o("WAWebCrosspostingDBOperations").getCrosspostingInfoForMessagesBulk(t);
				for (var r of e) {
