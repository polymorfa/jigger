__d("WAWebCryptoCalculateStreamingSidecar", [
	"Promise",
	"WAArrayBuffersConcat",
	"WACryptoHmac",
	"asyncToGeneratorRuntime"
], (function(t, n, r, o, a, i, l) {
	var e, s = 65536, u = 16, c = 10;
	function d(e, t) {
		return m.apply(this, arguments);
	}
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			var a = t instanceof ArrayBuffer ? t.byteLength : t.buffer.byteLength, i = a - u, l = Math.ceil(i / s), d = Array.from({ length: l }, function(e, n) {
				var a = n * s, i = a + u + s, l = t.slice(a, i);
