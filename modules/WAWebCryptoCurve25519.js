__d("WAWebCryptoCurve25519", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t;
			return e === void 0 ? (t = new Uint8Array(32), self.crypto.getRandomValues(t)) : t = new Uint8Array(e), t[0] &= 248, t[31] &= 127, t[31] |= 64, R({
				pubKey: 32,
				privKey: t,
				basepoint: c
			}, function(e) {
	...
	function g(e) {
		...
		var t = h(e.pubKey), n = new Uint8Array(32);
	...
	function v(e) {
		...
		var t = new Uint8Array(e.buffer || e), n = s._malloc(t.length);
	...
	l.keyPair = d, l.sharedSecret = p, l.toSignalCurveKeyPair = g, l.toSignalCurvePubKey = h, l.toCurveKeyPair = C, l.toCurveKeyPubKey = b;
}), 98);
