__d("WAWebCryptoCurve25519", ["WAWeb-curve25519-donna", "err"], (function(t, n, r, o, a, i, l) {
	var e;
	function s() {
	...
	async function c(t) {
		var n;
		return t === void 0 ? (n = new Uint8Array(32), self.crypto.getRandomValues(n)) : n = new Uint8Array(t), n[0] &= 248, n[31] &= 127, n[31] |= 64, v({
			pubKey: 32,
			privKey: n,
			basepoint: u
		}, function(t) {
	...
	function _(e) {
		if (p(e)) return e;
		if (e.pubKey.byteLength !== 32 || e.privKey.byteLength !== 32) throw r("err")("Invalid key pair type");
		var t = f(e.pubKey), n = new Uint8Array(32);
		return n.set(new Uint8Array(e.privKey)), {
			pubKey: t,
			privKey: n.buffer
		};
	}
	...
	function h(e) {
		if (g(e)) return e;
		if (e.pubKey.byteLength !== 33 || e.privKey.byteLength !== 32) throw r("err")("Invalid key pair type");
		var t = new Uint8Array(32), n = new Uint8Array(32);
		return t.set(new Uint8Array(e.pubKey).subarray(1)), n.set(new Uint8Array(e.privKey)), {
			pubKey: t.buffer,
			privKey: n.buffer
		};
	}
	...
	function C(t) {
		...
		var n = new Uint8Array(t.buffer || t), r = e._malloc(n.length);
	...
	l.keyPair = c, l.sharedSecret = d, l.toSignalCurveKeyPair = _, l.toSignalCurvePubKey = f, l.toCurveKeyPair = h, l.toCurveKeyPubKey = y;
}), 98);
