	...
	var e, s, u = {
		computeHmac: (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var n = t.data, r = t.length, a = t.macKey, i = t.plaintextByteLength;
				if (o("WAWebPREGatingUtils").shouldUseWorkerForFileSizeBytes(i)) {
					var l = yield o("WAWebMediaWorkerProxy").hmacSha256InWorker(a, n, r), s = l.result, u = l.transferredBuffer, c = l.transferredKeyBuffer;
					return s.success ? {
						hmac: s.value.hmac,
						macKey: c,
						data: u
		...
		computeFilehash: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = e.ciphertextHmac, n = e.plaintextByteLength;
				if (o("WAWebPREGatingUtils").shouldUseWorkerForFileSizeBytes(n)) {
					var r = yield o("WAWebMediaWorkerProxy").calculateFilehashInWorker(t), a = r.result, i = r.transferredBuffer;
					return a.success ? {
						...
						hash: yield o("WAMediaCalculateFilehash").calculateFilehash(i),
						ciphertextHmac: i
					});
				}
				return {
