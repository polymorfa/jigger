__d("WAWebCryptoLibrarySessionApi", ["WAWebCryptoLibrary"], (function(t, n, r, o, a, i, l) {
	function e(e) {
		return o("WAWebCryptoLibrary").getRemoteRegId(e).then(function(e) {
	...
	l.getRemoteRegId = e, l.createSignalSession = s, l.createGroupSenderSignalSession = u;
}), 98);
