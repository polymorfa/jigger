__d("WAWebCtwa1pdConversionWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumBizPlatform",
	"WAWebWamEnumCtwa1pdConversionType",
	"WAWebWamEnumCtwaDirectionFrom"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ Ctwa1pdConversion: [
		5140,
		{
			...
			ctwa1pdConversionType: [1, o("WAWebWamEnumCtwa1pdConversionType").CTWA_1PD_CONVERSION_TYPE],
			ctwaConversationDepth: [10, e.TYPES.INTEGER],
			ctwaConversationRepeat: [11, e.TYPES.INTEGER],
			ctwaDirectionFrom: [12, o("WAWebWamEnumCtwaDirectionFrom").CTWA_DIRECTION_FROM],
