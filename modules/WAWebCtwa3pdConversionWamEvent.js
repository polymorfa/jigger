__d("WAWebCtwa3pdConversionWamEvent", ["WAWebWamCodegenUtils", "WAWebWamEnumCtwaDirectionFrom"], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ Ctwa3pdConversion: [
		5138,
		{
			...
			ctwaDirectionFrom: [10, o("WAWebWamEnumCtwaDirectionFrom").CTWA_DIRECTION_FROM],
