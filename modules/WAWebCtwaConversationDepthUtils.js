__d("WAWebCtwaConversationDepthUtils", ["WAWebConversionTupleCollection", "WAWebMsgType"], (function(t, n, r, o, a, i, l) {
	var e, s = new Set([
	...
	function u(e) {
		var t = 0, n = null;
		for (var r of e.msgs.getModelsArray()) if (s.has(r.type)) {
			var o = r.id.fromMe;
			o && n === !1 && t++, n = o;
		}
		return t;
	...
	function c(e) {
		var t = 0, n = null;
		for (var r of e.msgs.getModelsArray()) if (s.has(r.type)) {
			var o = r.id.fromMe, a = o && n === !1;
			n != null && !a && t++, n = o;
		}
		return t;
	}
	function d(e, t) {
		var n = e.depth, r = e.lastMessageFromMe, o = e.repeat;
		return r == null ? {
			depth: n,
			repeat: 0,
			lastMessageFromMe: t
	...
	function m(e, t) {
		var n, o, a = r("WAWebConversionTupleCollection").get(e.id);
		if (a != null) {
			var i = d({
	...
	l.CTWA_CONVERSATION_COUNTER_MSG_TYPES = s, l.getCtwaConversationDepth = u, l.getCtwaConversationRepeat = c, l.nextCtwaConversationCounters = d, l.advanceCtwaConversationCounters = m;
}), 98);
