__d("WAWebCustomLabel3pdEventQuery", [
	...
	"use strict";
	var e, s, u, c = { type: "error" }, d = e !== void 0 ? e : e = n("WAWebCustomLabel3pdEventQuery.graphql");
	function m(e, t) {
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			try {
				...
				return o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["getCustomLabel3pdEvent: success"]))), i;
			} catch (e) {
				return o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["getCustomLabel3pdEvent: failed with error"]))), e instanceof o("WAWebGraphQLServerError").GraphQLServerError ? {
					type: "graphql-error",
					error: e
				} : c;
			}
