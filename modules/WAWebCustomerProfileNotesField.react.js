__d("WAWebCustomerProfileNotesField.react", [
	...
	function b(e) {
		var t, a = o("react-compiler-runtime").c(12), i = e.chatJid, l = e.contact, s = e.noteAsyncState, c = s.value, d = (t = c == null ? void 0 : c.content) != null ? t : "", m;
		a[0] !== i || a[1] !== l || a[2] !== c || a[3] !== d ? (m = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				}), c == null ? o("WAWebNoteAction").noteAddAction({
					chatJid: i,
					content: e,
					type: "unstructured"
				}) : o("WAWebNoteAction").noteEditAction(c.id, "unstructured", i, e, c.createdAt);
			});
			return function(n) {
				return e.apply(this, arguments);
			};
		})(), a[0] = i, a[1] = l, a[2] = c, a[3] = d, a[4] = m) : m = a[4];
		var p = m, _ = r("useWAWebAsyncSaving")(p), f = _[1];
		if (s.error != null || s.loading) return null;
		var g;
		a[5] !== l || a[6] !== d || a[7] !== f ? (g = u.jsx(v, {
			contact: l,
			noteContent: d,
			saveNote: f
		}), a[5] = l, a[6] = d, a[7] = f, a[8] = g) : g = a[8];
		var h;
		return a[9] !== l || a[10] !== g ? (h = u.jsx(R, {
			contact: l,
			children: g
		}), a[9] = l, a[10] = g, a[11] = h) : h = a[11], h;
	}
	function v(e) {
