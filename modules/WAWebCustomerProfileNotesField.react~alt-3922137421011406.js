__d("WAWebCustomerProfileNotesField.react", [
	...
	function b(e) {
		var t, a = e.chatJid, i = e.contact, l = e.noteAsyncState, s = l.value, c = (t = s == null ? void 0 : s.content) != null ? t : "", m = d((function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (e !== c) return o("WAWebNotesLogEvents").logNoteSaved(i, {
					content_existed: c !== "",
					has_content: e !== "",
					length: e.length,
					...
					content: e,
					type: "unstructured"
				}) : o("WAWebNoteAction").noteEditAction(s.id, "unstructured", a, e, s.createdAt);
			});
			return function(t) {
			...
			s,
			c
		]), p = r("useWAWebAsyncSaving")(m), _ = p[1];
		return l.error != null || l.loading ? null : u.jsx(R, {
			contact: i,
			children: u.jsx(v, {
				contact: i,
				noteContent: c,
