__d("WAWebCustomerProfileNotesField.react", [
	...
	function C(e) {
		var t, n, r = e.contact, a = e.noteAsyncState, i = o("WAJids").validateChatJid((t = (n = r.id) == null ? void 0 : n.toJid()) != null ? t : "");
		return i == null ? null : u.jsx(b, {
			contact: r,
			chatJid: i,
			noteAsyncState: a
		});
	...
	function b(e) {
		var t, n = e.chatJid, a = e.contact, i = e.noteAsyncState, l = i.value, s = (t = l == null ? void 0 : l.content) != null ? t : "", c = d(async function(e) {
			if (e !== s) return o("WAWebNotesLogEvents").logNoteSaved(a, {
				content_existed: s !== "",
				has_content: e !== "",
				length: e.length,
				previous_length: s.length
			}), l == null ? o("WAWebNoteAction").noteAddAction({
				chatJid: n,
				content: e,
				type: "unstructured"
			}) : o("WAWebNoteAction").noteEditAction(l.id, "unstructured", n, e, l.createdAt);
		}, [
			n,
			a,
			l,
			s
		]), m = r("useWAWebAsyncSaving")(c), p = m[1];
		return i.error != null || i.loading ? null : u.jsx(R, {
			contact: a,
			children: u.jsx(v, {
				contact: a,
				noteContent: s,
	...
	function R(e) {
		var t = e.children, n = e.contact, a = _(!1), i = _(), l = r("useWAWebOnScreen")(i, r("WAWebNoop"));
		return m(function() {
