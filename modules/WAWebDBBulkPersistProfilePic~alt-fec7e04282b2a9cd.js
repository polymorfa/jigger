__d("WAWebDBBulkPersistProfilePic", ["WABatcher", "WAWebSchemaProfilePicThumb"], (function(t, n, r, o, a, i, l) {
	...
	async function u(e) {
		...
		await o("WAWebSchemaProfilePicThumb").getProfilePicThumbTable().bulkCreateOrMerge(t);
	}
