__d("WAWebDBCommentAddOnProvider", [
	"Promise",
	...
	var e, s = {
		...
		matchesFutureproof: function(t) {
			return t.type === o("WAWebMsgType").MSG_TYPE.UNKNOWN && t.futureproofType === o("WAWebMsgType").MSG_TYPE.COMMENT;
		},
		...
		updateAcks: function(t, n) {
			return o("WAWebDBUpdateAddOnAcksForTable").updateAddOnAcksForTable("comments", t, n);
		},
		markAsRead: function(t) {
			return o("WAWebDBMarkAsReadForTable").markAsReadForTable("comments", t.map(String));
		}
	};
