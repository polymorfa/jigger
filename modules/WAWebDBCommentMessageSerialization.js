__d("WAWebDBCommentMessageSerialization", [
	...
	function e(e) {
		...
		return o("WAWebDBMessageSerialization").movEncFieldToOpaqueData(t), babelHelpers.extends({}, t, {
	...
	function s(e) {
		...
		return {
			...
			sender: r("nullthrows")(o("WAWebMsgGetters").getSender(e), "undefined sender").toString(),
	...
	function c(e) {
		var t, n = r("WAWebMsgKey").from(e.msgKey), a = r("WAWebMsgKey").from(e.parentMsgKey), i = babelHelpers.extends({
			id: n,
			parentMsgKey: a,
			ack: e.ack,
			t: e.t
		}, o("WAWebMsgKeyUtils").msgKeyToTargetInfo(n, o("WAWebMsgKeyUtils").TranslateMsgKeyType.Addon), { viewMode: o("WAWebViewMode.flow").ViewModeType.VISIBLE });
		if (e.isOverwrittenByRevoke === !0) {
			...
			return babelHelpers.extends({}, i, {
				...
				protocolMessageKey: r("WAWebMsgKey").from(r("nullthrows")(e.protocolMessageKey, "undefined protocolMessageKey"))
			});
		}
		if (e.isPlaceholder === !0) return babelHelpers.extends({}, i, {
		...
		return o("WAWebDBMessageSerialization").movFieldFromOpaqueDataBackToMsg(s), babelHelpers.extends({}, i, {
	...
	l.dbRowFromCommentMessage = e, l.dbRowFromRevokedMsgData = s, l.dbRowFromPlaceholderAddon = u, l.commentMessageFromDbRow = c;
}), 98);
