__d("WAWebDBGetReactions", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = yield o("WAWebSchemaReactions").getReactionsTable().equals(["parentMsgKey"], t), a = {
				reactions: [],
				reactionByMe: null
			}, i = new Map();
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var r = new Map();
			return yield o("WAWebModelStorageUtils").getStorage().lock(["reactions"], (function() {
				var o = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
					var o = n[0], a = yield o.anyOf(["parentMsgKey"], t);
					a.forEach(function(t) {
						var n = t.orphan, o = t.reactionText;
						if (o !== e && n !== 1) {
							var a, i = (a = r.get(t.parentMsgKey)) != null ? a : [];
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var _ = yield o("WAWebSchemaReactions").getReactionsTable().anyOf(["parentMsgKey", "senderUserJid"], l, { limit: 1 });
			return _[0];
		}), _.apply(this, arguments);
	}
	l.REVOKED_REACTION_TEXT = e, l.getReactions = s, l.getFilteredReactionsFromParentMsgs = c, l.getAllReactionsFromParentMsgs = m, l.existsReactionAddressingModeInsensitive = p;
}), 98);
