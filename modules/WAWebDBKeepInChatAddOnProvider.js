__d("WAWebDBKeepInChatAddOnProvider", [
	"WALogger",
	"WAWebBackendApi",
	...
	var e, s = {
		...
		matchesFutureproof: function(t) {
			return t.type === o("WAWebMsgType").MSG_TYPE.UNKNOWN && t.futureproofType === o("WAWebMsgType").MSG_TYPE.KEEP_IN_CHAT;
		},
		...
		processOrphansForNewMsg: (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
				...
				}), a = o("WAWebEphemeralKeepInChatUtils").runKeepInChatTieBreaker(r);
				if (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["keepInChatAddOnProvider: found orphan"]))), a != null) {
