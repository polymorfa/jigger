__d("WAWebDBMessageRange", [
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var a, i, l = o("WAWebSchemaMessage").getMessageTable().between(["messageRangeIndex"], (a = o("WAWebDBMessageStoreUtils")).beginningOfMessageRange(e, (i = o("WAWebDBMessageUtils")).MessagePropertyType.Outgoing, t), a.endOfMessageRange(e, i.MessagePropertyType.Outgoing), {
				reverse: !0,
				shouldDecrypt: !1
			}), s = o("WAWebSchemaMessage").getMessageTable().anyOf(["messageRangeIndex"], [
				a.beginningOfMessageRange(e, i.MessagePropertyType.IncomingChatMessage, t),
				a.beginningOfMessageRange(e, i.MessagePropertyType.Outgoing, t),
				...
				return i.map(l);
			}), m = h(u, d), p = m.messages, _ = m.newLastMessageTimestamp;
			return {
				messages: p,
				newLastMessageTimestamp: _
			};
	...
	function h(e, t) {
		...
		var i = n.sort(y).slice(0, t), l = i[i.length - 1];
		return I(l.timestamp, "smallestTimestampMessage"), {
			messages: i.concat(a),
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r) {
			var a = yield o("WAWebSchemaMessage").getMessageTable().between(["messageRangeIndex"], o("WAWebDBMessageStoreUtils").beginningOfMessageRange(e, n), o("WAWebDBMessageStoreUtils").beginningOfMessageRange(e, n, o("WALongInt").numberOrThrowIfTooLarge(t)), {
				lowerInclusive: !0,
				upperInclusive: !0,
				shouldDecrypt: !1
			});
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = o("WAWebDBMessageUtils").beginningOfChat(e), n = o("WAWebDBMessageUtils").endOfChat(e), r = yield o("WAWebSchemaMessage").getMessageTable().between(["messageRangeIndex"], t, n, {
				lowerInclusive: !0,
				shouldDecrypt: !1
			});
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var s = yield o("WAWebSchemaMessage").getMessageTable().bulkGet(i.concat(l)), u = [];
	...
	function E(e) {
		var t = e.chatId, r = e.options, a = e.range, i = a.lastMessageTimestamp, l = a.lastSystemMessageTimestamp, s = a.messages;
		return o("WAWebModelStorageUtils").getStorage().lock(["message", "message-association"], (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var a, u = e[0], d = [], m = [];
				i != null && (m.push(C(t, i, o("WAWebDBMessageUtils").MessagePropertyType.IncomingChatMessage, r)), m.push(C(t, i, o("WAWebDBMessageUtils").MessagePropertyType.Outgoing, r)));
				var p = l != null ? l : i;
				p != null && m.push(C(t, p, o("WAWebDBMessageUtils").MessagePropertyType.SystemMessage, r)), m.push(R({
					chatId: t,
					messages: s,
					options: r
				})), (r == null ? void 0 : r.deleteAutomatedGreetingMessages) === !0 && m.push(v(t));
				var _ = yield (c || (c = n("Promise"))).all(m);
				d = (a = d).concat.apply(a, _);
				var f = r == null ? void 0 : r.skipMessages;
				f && (d = d.filter(function(e) {
					return !f.has(e);
				}));
				var g = [u.bulkRemove(d)];
				return o("WAWebMessageAssociationGatingUtils").isMessageAssociationInfraEnabled() && g.push(o("WAWebDBDeleteAssociatedMsgsByMsgKey").bulkDeleteMessagesByMsgKeys(d)), yield c.all(g), d;
			});
			return function(t) {
	...
	function k(t) {
		...
		if (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["syncd: additionalMessages length: ", ""])), a.length), a.length > d) {
			var l = h(a, d), s = l.messages, u = l.newLastMessageTimestamp;
			u != null && (i.lastMessageTimestamp = u, I(i.lastMessageTimestamp, "resultantRange")), i.messages = s;
		}
	...
	l.getLastMessageTimestamp = m, l.getLastSystemMessageTimestamp = p, l.getFirstSystemMessageTimestamp = _, l.getAdditionalMessages = f, l.timestampComparison = y, l.deleteMessagesInMessageRange = E, l.fixMessageRange = k, l.logMaybeMillisecondTimestamp = I, l._test = T;
}), 98);
