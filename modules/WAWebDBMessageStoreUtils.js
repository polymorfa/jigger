__d("WAWebDBMessageStoreUtils", [
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			var r = yield o("WAWebSchemaMessage").getMessageTable().between(["internalId"], e, t, n), a = r.filter(function(e) {
				return L(e);
			});
			return yield E(a), a;
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield o("WAWebSchemaMessage").getMessageTable().startsWithAnyOf(["internalId"], [o("WAWebDBMessageUtils").InternalIdPrefix.GroupStatus]);
			return e;
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield o("WAWebSchemaMessage").getMessageTable().startsWithAnyOf(["internalId"], [o("WAWebDBMessageUtils").InternalIdPrefix.NewsletterStatus]);
			return e;
	...
	function L(e, t) {
		t === void 0 && (t = []);
		var n = o("WAWebDBMessageSerialization").messageFromDbRow(e), r = D(e), a = o("WAWebDBAddOnProviders").getAddOnProviderForFutureproofMsg(n);
		return !(r || R(e) && e.futureproofReparsed === !0 || a && a.canRenderInUi(n) && !t.includes(e.id.toString()) || e.type === o("WAWebMsgType").MSG_TYPE.DEBUG || !o("WAWebBotBaseGating").isBizBot1pEnabled() && e.type === o("WAWebMsgType").MSG_TYPE.NOTIFICATION_TEMPLATE && e.subtype === "biz_bot_1p_disclosure");
	}
	function E(e) {
	...
	function k() {
		return k = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = I(e);
			if (t.length !== 0) {
				var n = yield o("WAWebApiMessageInfoStore").getHighestMsgAcks(t.map(function(e) {
					return r("WAWebMsgKey").from(e.id);
				})), a = [];
				t.forEach(function(e) {
					var t = e.ack, r = e.id, o = n.get(r);
					o != null && o > t && (a.push({
						id: r,
						ack: o
					}), e.ack = o);
				}), a.length > 0 && (o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["maybeUpdateMsgAck: storing ack updates ", ""])), JSON.stringify(a)).tags("message-store"), o("WAWebSchemaMessage").getMessageTable().bulkCreateOrMerge(a));
			}
		}), k.apply(this, arguments);
	}
	function I(t) {
		var n = [], a = t.filter(function(e) {
			...
			if (t.remote.isGroup() && (e.rowId != null && e.rowId < d || e.count == null)) return n.length < 3 && n.push(e.id), !1;
			if (o("WAWebMsgGetters").getIsAckPlayable(e)) {
				if (e.ack === o("WAWebAck").ACK.PLAYED) return !1;
			} else if (e.ack === o("WAWebAck").ACK.READ) return !1;
			return !0;
		});
		return n.length > 0 && o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			"getMsgMayNeedAckUpdate: skipped ",
			" history group messages => ",
			""
		])), n.length, n).tags("message-store"), a;
	}
	function T(e, t) {
		var n, r = self.performance.now(), a = o("WAWebABProps").getABPropConfigValue("web_init_chat_max_unread_message_count"), i, l = e.unreadCount, u = (n = e.unreadDividerOffset) != null ? n : 0, d = void 0, m = void 0, p = void 0, _ = 0, f = [], g = 0, h = function(r) {
			if (S(r) || (_++, r.type === o("WAWebMsgType").MSG_TYPE.PROTOCOL && r.subtype !== "ephemeral_setting")) return !1;
			var n = o("WAWebDBMessageSerialization").messageFromDbRow(r), h = D(r);
			if (h) return !1;
			if (R(r)) {
				var y = o("WAWebDBAddOnProviders").getAddOnProviderForFutureproofMsg(n);
				if (r.futureproofReparsed === !0) return !1;
				if (!t) f.push(r);
				else if (y != null && y.canRenderInUi(n)) return a !== 0 && g >= a ? (p == null && (p = r.id), m || (o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[init-from-storage] getKeyMsgsFromChatHistory: non-fp limit ", ""])), a), m = r), !0) : (g++, !1);
			}
			...
			if (l === 0 && u > 0) if (r.type === o("WAWebMsgType").MSG_TYPE.REVOKED) {
				if (u -= 1, u === 0) return i = r.id.toString(), !0;
			} else return !0;
			return !!((l === 0 && u === 0 || a !== 0 && e.unreadCount >= a) && d || l > 0 && o("WAWebMsgGetters").getIsUnreadType(r) && (l -= 1, l === 0 && (i = r.id.toString(), u === 0)));
		};
	...
	function $(e) {
		var t;
		return ((t = x.get(e.type)) == null ? void 0 : t.includes(e.subtype)) || !1;
	}
	function P(e, t) {
	...
	l.extractC2STimestampFromMessageRangeIndex = p, l.beginningOfMessageRange = _, l.endOfMessageRange = f, l.queryChatMessageHelper = g, l.queryGroupStatusMsgsHelper = y, l.queryNewsletterStatusMsgsHelper = b, l.isInvalidCAGSystemMessage = S, l.isFutureproof = R, l.shouldRenderInUI = L, l.maybeUpdateMsgAck = E, l.getKeyMsgsFromChatHistory = T, l.isSecuritySensitiveMessage = $, l.getMessagesBefore = P, l.isInitialEncryptionMessage = N, l.isBizBotDisclosureMessage = M;
}), 98);
