__d("WAWebDBProcessReplyMsgs", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (e.length) {
				var t = yield o("WAWebModelStorageUtils").getStorage().lock(["message"], (function() {
					var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
						...
						var i = (yield o("WAWebDBMsgUtils").getMsgsByMsgKey(Array.from(a.values()))).filter(function(e) {
						...
						if (s.length) {
							...
							if (s.forEach(function(e) {
								...
								if (t !== "missing-stanza-id") {
									...
									e.quotedMsg == null ? c.push(babelHelpers.extends({}, e, { quotedMsg: n })) : d(r("nullthrows")(e.quotedMsg), n) && c.push(babelHelpers.extends({}, e, { quotedMsg: n }));
								}
							}), !!c.length) return yield n.bulkCreateOrMerge(c.map(function(e) {
