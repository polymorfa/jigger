__d("WAWebDBQueryAndRemoveMessageHistory", [
	...
	async function e(e) {
		...
		var a = r[0].rowId, i = await o("WAWebSchemaMessage").getMessageTable().between(["internalId"], t, n, {
			lowerInclusive: !1,
			upperInclusive: !1,
			limit: 1,
			reverse: !0
	...
	l.getBoundsForChat = e, l.queryAndRemoveMessagesInMessageRange = s, l.queryAndRemoveMessageHistory = u;
}), 98);
