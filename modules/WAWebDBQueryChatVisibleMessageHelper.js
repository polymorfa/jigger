__d("WAWebDBQueryChatVisibleMessageHelper", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = t.lowerBound, r = t.upperBound, a = t.options, i = t.count, l = t.addOnReparseExclusionList, u = l === void 0 ? [] : l, c = t.index, m = a.limit, p = babelHelpers.objectWithoutPropertiesLoose(a, s), _ = o("WAWebABProps").getABPropConfigValue("web_init_chat_max_unread_message_count"), f = [], g = [], h = 0, y = 0, C = !1, b = function(t) {
			...
			}, v = self.performance.now(), S = yield o("WAWebSchemaMessage").getMessageTable().between(c != null ? c : ["internalId"], n, r, p, b);
			...
			return yield o("WAWebDBMessageStoreUtils").maybeUpdateMsgAck(R), f.length && o("WAWebFutureproofReparseMsgsAction").processFutureproof(f), g.length && o("WAWebReparseRichResponseMsgs").reparseRichResponseMsgs(g), R;
