__d("WAWebDBTableUsage", ["WAWebDBStats", "WAWebWebDbTableUsageWamEvent"], (function(t, n, r, o, a, i, l) {
	var e = new Map(), s = 50, u = new Map();
	function c(t) {
		var n = t.offlineSessionId, r = t.tablesToLog, a = t.webScenario, i = new Map(), l = new Map();
		for (var c of r) {
			...
			for (var a of i.entries()) {
				var l = a[0], c = a[1];
				{
					var d = o("WAWebDBStats").dbStats.getStats(l) || {
						...
						startReadCount: 0,
						startWriteCount: 0
					}, _ = d.readCount - m.startReadCount, f = d.writeCount - m.startWriteCount;
					c.webTableReadCount = _, c.webTableWriteCount = f, (_ > s || f > s || c.webTable === "message") && c.commit();
				}
			}
	...
	function d(t, n) {
		for (var r of e) {
			...
			if (i != null) {
				...
				l && (n === "read" ? i.webTableReadCount = l.readCount : i.webTableWriteCount = l.writeCount);
			}
		}
	}
