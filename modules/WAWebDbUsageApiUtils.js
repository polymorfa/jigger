__d("WAWebDbUsageApiUtils", ["Promise", "asyncToGeneratorRuntime"], (function(t, n, r, o, a, i) {
	var e;
	function l(e) {
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = yield s(e.open("__dbnames"));
			if ((t = n.objectStoreNames) != null && t.length) {
				var r = n.transaction(n.objectStoreNames, "readonly"), o = r.objectStore(r.objectStoreNames[0]), a = yield s(o.getAll());
				return a;
	...
	i.convertToMBToString = l, i.promisifyRequest = s, i.getAllDatabases = u, i.getDatabase = d, i.objectStoreIterator = p;
}), 66);
