__d("WAWebDebugDB", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = yield o("WAWebSchemaMessage").getMessageTable().all({ returnKeyType: "primary_key" }), r = n.find(function(e) {
				return e.match(t);
			});
			return r == null ? (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Could not find a message key that contains Stanza ID \"", "\""])), t), null) : c(r);
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = typeof e == "string" ? e : e.toString(), n = yield o("WAWebSchemaMessage").getMessageTable().get(t);
			if (n) {
	...
	var g = {
		...
		getChatFromDBById: m,
		getContactTable: o("WAWebSchemaContact_DO_NOT_USE_DIRECTLY").getContactTable,
