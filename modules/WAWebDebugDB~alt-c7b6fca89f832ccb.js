__d("WAWebDebugDB", [
	...
	var e;
	async function s(t) {
		var n = await o("WAWebSchemaMessage").getMessageTable().all({ returnKeyType: "primary_key" }), r = n.find(function(e) {
			return e.match(t);
		});
		return r == null ? (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Could not find a message key that contains Stanza ID \"", "\""])), t), null) : u(r);
	}
	s.doc = "get message row and decrypted data from DB";
	async function u(e) {
		var t = typeof e == "string" ? e : e.toString(), n = await o("WAWebSchemaMessage").getMessageTable().get(t);
		if (n) {
