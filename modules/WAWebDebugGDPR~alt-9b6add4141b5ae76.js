__d("WAWebDebugGDPR", [
	...
	async function e(e) {
		...
		var n = o("WAWebGdprHookUtils").getGdprIq(o("WAWap").generateId(), t, "delete");
		return o("WADeprecatedSendIq").deprecatedSendIq(n, o("useWAWebGdprStatus").GdprStatusWapParser);
	}
