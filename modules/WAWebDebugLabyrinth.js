__d("WAWebDebugLabyrinth", [
	...
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $, P, N = "hello labyrinth", M = 20, w = 20, A = 20, F = 20, O = "Call Debug.labyrinthCreateBackupNativeWasm() first";
	...
	function V() {
		return V = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			return (P || (P = n("Promise"))).all(e.map((function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					return babelHelpers.extends({}, e, { messages: yield z(e.messages, t, e.threadId) });
				});
				return function(t) {
	...
	function G() {
		return G = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, r) {
			return (P || (P = n("Promise"))).all(e.map((function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					return babelHelpers.extends({}, e, { messages: yield z(e.messages, t, r) });
				});
				return function(t) {
					return e.apply(this, arguments);
				};
	...
	function j() {
		return j = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a) {
			var i = r("nullthrows")(t.epochRootKey), l = r("nullthrows")(t.epochAnonId), u = new Uint8Array(o("WABase64").decodeB64(l)), c = new Uint8Array(o("WABase64").decodeB64(i));
			return (P || (P = n("Promise"))).all(e.map((function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = null, n = null;
					try {
						var i = r("nullthrows")(e.encryptedPayload), l = r("nullthrows")(e.encryptionVersion), d = new Uint8Array(o("WABase64").decodeB64(i));
						t = l;
						var m = yield o("WAWebLabyrinthWasmDecryptMessage").decryptMessageWasm({
							ciphertext: d,
							encryptionVersion: l,
							epochAnonId: u,
							epochRootKey: c,
						...
						if (!m.success) throw n = String(m.error), r("err")("decryptMessageWasm failed: " + n);
						...
						return o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose([
							...
							"; subtype ",
							""
						])), e.messageId, a, String(n != null ? n : _.name)).catching(_), {
							messageId: e.messageId,
	...
	function Q() {
		return Q = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n, a = Math.min((t = e == null ? void 0 : e.numMsgs) != null ? t : M, A), i = Math.min((n = e == null ? void 0 : e.numThreads) != null ? n : w, F);
			try {
				var l = yield o("WAWebDebugLabyrinthInboxSnapshotQuery").fetchLabyrinthInboxSnapshot({
					numMsgs: a,
					numThreads: i
	...
	K.doc = "Fetches WA Labyrinth inbox snapshot threads/messages, logs the simplified response, and returns it.", K.paramsToExecute = [];
	function X(e) {
		return Y.apply(this, arguments);
	}
	function Y() {
		return Y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = r("nullthrows")(e.threadId), n = B(), a = r("nullthrows")(n.ebDeviceId), i = r("nullthrows")(n.orfClientState);
			try {
				var l = yield o("WAWebLabyrinthWasmOrfThreadId").labyrinthOrfThreadIdWasm({
				...
				var s = yield o("WAWebDebugLabyrinthRangeQuery").fetchLabyrinthRangeQuery({
					ebDeviceId: a,
	...
	X.doc = "Fetches WA Labyrinth messages for a plain thread id, internally maps it to partial_thread_id, logs the simplified response, and returns it. Do not pass snapshot.threadId. Example: Debug.labyrinthRangeQuery({threadId, numMessages: 10})", X.paramsToExecute = [];
	function J(e) {
		return Z.apply(this, arguments);
	}
	function Z() {
		return Z = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = (t = r("nullthrows"))(e.threadId), a = B(), i = t(a.epochAnonId), l = t(a.epochRootKey), s = t(a.orfClientState);
			try {
				var u = yield o("WAWebLabyrinthWasmOrfThreadId").labyrinthOrfThreadIdWasm({
				...
				var c = yield o("WAWebLabyrinthWasmDeriveMessageKey").deriveMessageKeyWasm({
	...
	J.doc = "Given a plain threadId, returns base64 partialThreadId and base64 messageKey for CLI decrypt flow. Example: Debug.labyrinthDecryptFlowInputs({threadId})", J.paramsToExecute = [];
	function ee() {
	...
	function te() {
		return te = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				var n = yield o("WAWebCreateLabyrinthBackupJob").createLabyrinthBackup(e.value, t), a = n.wa_labyrinth_create_backup;
	...
	ee.doc = "Create backup (native): generate Labyrinth backup data with Wasm and call wa_labyrinth_create_backup";
	function ne(e) {
		return re.apply(this, arguments);
	}
	function re() {
		return re = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.msg, a = e.repeat, i = a === void 0 ? 1 : a, l = e.threadId, s = e.threadType, u = s === void 0 ? "ONE_TO_ONE" : s, c = B(), d = r("nullthrows")(W()), m = r("nullthrows")(c.backupId), p = r("nullthrows")(c.epochId), _ = r("nullthrows")(l), f = t != null ? t : N, g = r("nullthrows")(c.epochRootKey), h = r("nullthrows")(c.mailboxRootKey), y = r("nullthrows")(c.orfClientState), C = r("nullthrows")(c.epochAnonId), b = o("WAWebLabyrinthCanonicalUserFbid").getWaCanonicalUserFbid(), v = Math.max(1, Math.floor(i)), S = yield (P || (P = n("Promise"))).all(Array.from({ length: v }, function() {
			...
			for (var L of S.entries()) {
				var M = L[0], w = L[1];
				if (!w.success) return o("WALogger").ERROR(E || (E = babelHelpers.taggedTemplateLiteralLoose(["[Debug][Labyrinth] encryptMessageWasm failed"]))), w;
				R.push(w.value);
			}
			...
			var A = {
				...
				epochId: p,
				familyDeviceId: d
			}, F = o("WAWebUploadLabyrinthMessagesJob").wasmResultsToUploadLabyrinthMessagesInput(R, A);
	...
	ne.doc = "Upload messages (native): encrypt one text message one or more times for a thread with Wasm and batch-upload it through wa_labyrinth_upload_messages. Example: Debug.labyrinthEncryptAndUploadMessageNative({threadId, msg, repeat: 3, threadType: \"ONE_TO_ONE\"})";
	var oe = {
