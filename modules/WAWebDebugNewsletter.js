__d("WAWebDebugNewsletter", [
	...
	var e, s, u = s || (s = o("react")), c = function(t) {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			yield o("WAWebQueryAndUpdateAllNewslettersMetadataAction").queryAndUpdateAllNewsletterMetadataAction(o("WAWebCommonNewsletterEnums").NewsletterMetadataUpdateEntryPoint.Debug);
	...
	var g = {
		...
		createAndOpenNewsletter: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAWebNewsletterCreateAction").createNewsletterAction(e);
		...
		inviteUserToAdminChannel: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = o("WAWebContactCollection").ContactCollection.getModelsArray(), a = n.find(function(e) {
					return e.searchMatchExact(t, t) != null;
				}), i = r("WAWebNewsletterCollection").get(e);
				if (a == null || i == null) return !1;
				var l = yield o("WAWebNewsletterBulkSendAdminInviteAction").sendBulkNewsletterAdminInviteAction({
					invitees: [a],
					chat: i,
		...
		sendMuteNotification: function(t) {
			t === void 0 && (t = "123@newsletter"), m(t, o("WAWap").makeWapNode("metadata", null, o("WAWap").makeWapNode("muted", { state: "on" })));
		},
		sendUnmuteNotification: function(t) {
			t === void 0 && (t = "123@newsletter"), m(t, o("WAWap").makeWapNode("metadata", null, o("WAWap").makeWapNode("muted", { state: "off" })));
		},
		sendJoinNotification: function(t) {
			t === void 0 && (t = "123@newsletter"), m(t, o("WAWap").makeWapNode("join", null, o("WAWap").makeWapNode("metadata", null, [o("WAWap").makeWapNode("name", {
				id: "1",
		...
		sendLeaveNotification: function(t) {
			t === void 0 && (t = "123@newsletter"), m(t, o("WAWap").makeWapNode("leave", null));
		},
		...
		loadNewsletterPreviewChat: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAWebLoadNewsletterPreviewChatAction").loadNewsletterPreviewChat(e);
				t != null && (yield o("WAWebCmd").Cmd.openChatBottom({
					chat: t,
		...
		getNewsletterDirectoryList: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAWebNewsletterDirectorySearchAction").getNewsletterDirectoryListAction(babelHelpers.extends({}, e, { skipSubscribedNewsletters: !1 })), n = t.newsletters;
				return n;
			});
			function t(t) {
				return e.apply(this, arguments);
		...
		getNewsletterDirectorySearchResults: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAWebNewsletterDirectorySearchAction").getNewsletterDirectorySearchResultsAction(babelHelpers.extends({}, e, { skipSubscribedNewsletters: !1 })), n = t.newsletters;
				return n;
			});
			function t(t) {
				return e.apply(this, arguments);
		...
		getNewsletterDirectoryCategoriesPreview: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				return o("WAWebNewsletterDirectorySearchAction").getNewsletterDirectoryCategoriesPreviewAction(e);
			});
			function t(t) {
				return e.apply(this, arguments);
			}
		...
		getRecommendedNewsletters: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = yield o("WAWebNewsletterGetRecommendedNewslettersAction").getRecommendedNewslettersAction();
				return e;
			});
			function t() {
				return e.apply(this, arguments);
		...
		mexFetchSubscriberList: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = yield o("WAWebMexFetchNewsletterFollowersJob").mexFetchNewsletterFollowers(e, t);
			});
			function t(t, n) {
				return e.apply(this, arguments);
			}
		...
		mexFetchNewsletterReactionSenderList: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = yield o("WAWebMexFetchNewsletterMessageReactionSenderListJob").mexFetchNewsletterMessageReactionSenderList(e, t);
			});
			function t(t, n) {
				return e.apply(this, arguments);
			}
		...
		mexFetchNewsletterIsDomainPreviewable: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAWebMexFetchNewsletterIsDomainPreviewableJob").mexFetchNewsletterIsDomainPreviewable(e);
			});
			function t(t) {
				return e.apply(this, arguments);
			}
		...
		mexFetchNewsletterPendingInvites: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAWebMexFetchNewsletterPendingInvitesJob").mexFetchNewsletterPendingInvites(e);
			});
			function t(t) {
				return e.apply(this, arguments);
			}
		...
		sendNewsletterAdminInviteMessage: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = o("WAWebDebugUtils").getSelectedChat(), n = o("WAWebDecodeJid").strictDecodeJid(e);
				if (t == null || n == null) throw r("err")("No selected chat or invalid jid");
				yield o("WAWebNewsletterSendMsgAction").sendNewsletterAdminInviteMessage(t, {
					newsletterWid: n,
		...
		sendNewsletterFollowerInviteMessage: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = o("WAWebDebugUtils").getSelectedChat(), a = o("WAWebDecodeJid").strictDecodeJid(e);
				if (n == null || a == null) throw r("err")("No selected chat or invalid jid");
				yield o("WAWebNewsletterSendMsgAction").sendNewsletterFollowerInviteMessage(n, {
					newsletterWid: a,
		...
		getNewsletterReports: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAWebNewsletterGetReportsAction").getNewsletterReportsAction();
			});
			function t() {
				return e.apply(this, arguments);
			}
		...
		changeNewsletterOwner: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = o("WAWebContactCollection").ContactCollection.get(t), a = r("WAWebNewsletterCollection").get(e);
				n == null || a == null || (yield o("WAWebChangeNewsletterOwnerAction").changeNewsletterOwnerAction(a, n));
			});
			function t(t, n) {
				return e.apply(this, arguments);
			}
		...
		getNewsletterMessages: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				try {
					var n = yield o("WASmaxNewslettersGetNewsletterMessagesRPC").sendGetNewsletterMessagesRPC({
						queryNewsletterParamsMixinArgs: { queryNewsletterParamsArgs: { queryNewsletterJIDParams: { anyJid: e } } },
		...
		getNewsletterQuestionResponses: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				try {
					var r = yield o("WASmaxNewslettersGetNewsletterResponsesRPC").sendGetNewsletterResponsesRPC({
						iqTo: e,
		...
		sendDummyMilestoneNotification: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i) {
				e === void 0 && (e = "MESSAGE_REACTIONS"), t === void 0 && (t = 100), n === void 0 && (n = "❤️");
				var l = yield o("WAWebNewsletterDBUtils").getMessageByServerId(Number(i), a);
		...
		addProfilePictureDeletionAlertForSelectedChat: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				yield o("WAWebNewsletterBridgeApi").NewsletterBridgeApi.updateProfilePictureDeletionAlertState({ newsletterWid: o("WAWebWidFactory").asNewsletterWidOrThrow(e.id) });
			});
			function t() {
				return e.apply(this, arguments);
			}
		...
		setNewsletterSubscriberCountForSelectedChat: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				if (t == null) throw r("err")("setNewsletterSubscriberCountForSelectedChat: no selected chat");
				yield o("WAWebNewsletterBridgeApi").NewsletterBridgeApi.updateNewsletterSubscriberCount({
					id: t.id,
		...
		openNewsletterStatusTextComposer: function() {
			o("WAWebModalManager").ModalManager.openMedia(u.createElement(r("WAWebCreateTextStatusFlow.react"), {
