__d("WAWebDebugPanelPlugin.react", [
	...
	function b(e) {
		var t = o("react-compiler-runtime").c(20), n = h(), a = n[0], i = n[1], l = r("useWAWebToggle")(!1), s = l[0], u = l[1], c = h(!1), d = c[0], m = c[1], _;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (_ = {
			all: [],
			last: []
		}, t[0] = _) : _ = t[0];
		var f = g(_), y;
		t[1] === Symbol.for("react.memo_cache_sentinel") ? (y = function() {
			var e = f.current, t = r("sumBy")(e.all, o("WAWebIdentityFunction").identityFunction), n = Math.round(t / e.all.length * 100) / 100, a = r("sumBy")(e.last, o("WAWebIdentityFunction").identityFunction), l = Math.round(a / e.last.length * 100) / 100;
			i({
				last: l,
				avg: n
			}), m(!1), f.current.last = [];
		}, t[1] = y) : y = t[1];
		var C = o("useWAWebTimeout").useTimeout(y, 2e3), b = C[0], v;
		t[2] !== b || t[3] !== s ? (v = function() {
			if (s) {
				m(!0);
		...
		}, t[2] = b, t[3] = s, t[4] = v) : v = t[4];
		var S = v;
		o("useWAWebListener").useListener(window, "beforeinput", S);
		var R;
		t[5] !== e ? (R = e.getRootElement(), t[5] = e, t[6] = R) : R = t[6];
		var L;
		t[7] === Symbol.for("react.memo_cache_sentinel") ? (L = { capture: !0 }, t[7] = L) : L = t[7], o("useWAWebListener").useListener(R, "paste", S, L);
		var E = s ? "[type something first]" : "[disabled]";
		a && !d ? E = a.last + "ms (avg: " + a.avg + "ms)" : d && (E = "...");
		var k;
		t[8] === Symbol.for("react.memo_cache_sentinel") ? (k = { className: "x78zum5 x1qughib x6s0dn4" }, t[8] = k) : k = t[8];
		var I;
		t[9] !== E ? (I = p.jsxs("span", { children: [
			"Response time: ",
			E,
			" "
		] }), t[9] = E, t[10] = I) : I = t[10];
		var T;
		t[11] !== u || t[12] !== s ? (T = p.jsx(r("WDSSwitch.react"), {
			value: s,
			onChange: u
		}), t[11] = u, t[12] = s, t[13] = T) : T = t[13];
		var D;
		t[14] !== I || t[15] !== T ? (D = p.jsxs("div", babelHelpers.extends({}, k, { children: [I, T] })), t[14] = I, t[15] = T, t[16] = D) : D = t[16];
		var x = D, $;
		return t[17] !== x || t[18] !== s ? ($ = {
			metricsElement: x,
			trackingEnabled: s
		}, t[17] = x, t[18] = s, t[19] = $) : $ = t[19], $;
	}
	function v(t) {
