__d("WAWebDebugQuickPromotions", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n;
			if (t === "") return "no-id";
			var r = yield o("WAWebSchemaQuickPromotions").getQuickPromotionsTable().get(t);
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var n = o("WATimeUtils").unixTime(), r = o("WAWebMobilePlatforms").isSMB() ? yield o("WAWebQuickPromotionActionMutation").executeQuickPromotionActionMutation({
				event: "VIEW",
				promotion_id: e,
	...
	f.doc = "Log a QP VIEW (impression) via the GraphQL action mutation; returns the server result type.", f.paramsToExecute = [""];
	function h(e) {
	...
	h.doc = "Log a QP primary action click via the GraphQL action mutation; returns the server result type.", h.paramsToExecute = [""];
	function C(e) {
	...
	C.doc = "Log a QP dismiss via the GraphQL action mutation; returns the server result type.", C.paramsToExecute = [""];
	function v(e) {
