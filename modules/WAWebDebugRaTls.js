__d("WAWebDebugRaTls", [
	...
	var e, s, u, c, d, m = new Uint8Array(0), p = 100, _ = 1e4, f = 3e4, g = 32, h = Object.freeze({
		0: "CONNECTING",
		1: "OPEN",
		2: "CLOSING",
		3: "CLOSED"
	}), y = Object.freeze((e = {}, e[(d = o("WATheiaRaTls")).WATheiaRaTlsState.INIT.valueOf()] = "INIT", e[d.WATheiaRaTlsState.CONNECTING.valueOf()] = "CONNECTING", e[d.WATheiaRaTlsState.CONNECTED.valueOf()] = "CONNECTED", e[d.WATheiaRaTlsState.CLOSED.valueOf()] = "CLOSED", e[d.WATheiaRaTlsState.ERROR.valueOf()] = "ERROR", e)), C = "wss://teellm.meta.com?x-tee-node-token=<redacted>", b = 1;
	function v(e, t, n, r) {
		return S.apply(this, arguments);
	}
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a) {
			e === void 0 && (e = o("WATheiaRaTls").WATheiaRaTlsClientPolicy.DEBUG), t === void 0 && (t = !0), n === void 0 && (n = "rc"), a === void 0 && (a = !1);
			var i = b++, l = null, c = null;
			try {
				var d = yield o("WAWebTEENodeTokenThriftFetcher").fetchNodeTokenViaThrift(n, a), m = d.nodeToken, p = L(o("WABase64").encodeB64(m)), _ = yield o("WATheiaRaTls").loadWATheiaRaTls();
				l = _.createSession(e, {
					enableTheiaV2Mode: !0,
					requestTransparencyReport: !0,
					shouldVerifyCert: t
				}), c = yield R(p, i);
				var f = yield E(l, c, i), g = A(l, e, f);
	...
	v.doc = "Full flow: fetch a TEE node token via the dev-only thrift endpoint, then run a browser RA-TLS WASM handshake against the teellm WebSocket endpoint. Optional args: clientPolicy, shouldVerifyCert, env, useAcs.", v.paramsToExecute = [];
	function R(e, t) {
		return new (c || (c = (n("Promise"))))(function(n, o) {
			...
			}, _), a.addEventListener("open", s), a.addEventListener("error", u), a.addEventListener("close", c);
		});
	}
	function L(e) {
	...
	function k() {
		return k = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, o) {
			var a = P(t, o), i = null, l = new (c || (c = (n("Promise"))))(function(e, t) {
				i = self.setTimeout(function() {
	...
	function x() {
		return x = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i) {
			var l = e.getState();
			if (l !== o("WATheiaRaTls").WATheiaRaTlsState.CONNECTED.valueOf()) {
				if (a.handshakeSteps >= p) throw r("err")("RA-TLS handshake did not connect after " + String(a.handshakeSteps) + " steps");
				var s;
				try {
					s = yield n.read();
				} catch (e) {
	...
	function $(e, t, n, a, i) {
		...
		var l = e.getState();
		if (n.sentBytes += w(t, a.sendBuffer, i, n.handshakeSteps), l === o("WATheiaRaTls").WATheiaRaTlsState.ERROR.valueOf()) throw r("err")("RA-TLS handshake failed with code " + String(a.additionalErrorCode));
	}
	function P(e, t) {
		var o = [], a = [], i = null, l = function() {
			for (; o.length > 0 && a.length > 0;) {
				var e = o.shift(), t = a.shift();
		...
		return e.addEventListener("message", u), e.addEventListener("error", d), e.addEventListener("close", m), {
			read: function() {
				var e = o.shift();
				return e != null ? (c || (c = n("Promise"))).resolve(e) : i != null ? (c || (c = n("Promise"))).reject(i) : new (c || (c = (n("Promise"))))(function(e, t) {
					a.push({
						resolve: e,
						reject: t
					});
			...
			dispose: function() {
				e.removeEventListener("message", u), e.removeEventListener("error", d), e.removeEventListener("close", m), s(r("err")("RA-TLS WebSocket byte reader disposed"));
			}
		};
	}
	function N(e) {
	...
	function M() {
		return M = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (Blob !== void 0 && e instanceof Blob) return new Uint8Array(yield e.arrayBuffer());
	...
	function O(e) {
		return r("err")("RA-TLS WebSocket closed before handshake completed " + Q(e));
	}
	function B(e) {
		try {
			var t = new URL(e), n = [];
