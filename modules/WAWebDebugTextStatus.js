__d("WAWebDebugTextStatus", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			if (!(!e || e.length === 0)) {
				...
				yield r("WAWebLidAwareContactsDB").bulkCreateOrMerge(t, "DebugTextStatus.resetAllTextStatus"), o("WAWebContactCollection").ContactCollection.forEach(function(e) {
					e.set({
						textStatusString: null,
						textStatusEmoji: null,
						textStatusEphemeralDuration: null,
						textStatusLastUpdateTime: o("WAWebTextStatusUtils").TEXT_STATUS_NOT_FETCHED,
	...
	e.doc = "Resets text status (About 2.0) for all contacts to \"not fetched\" state, forcing re-fetch on next render";
