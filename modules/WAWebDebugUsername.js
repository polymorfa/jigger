__d("WAWebDebugUsername", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = "debug", n = yield o("WAWebMexUsernameAvailability").mexCheckUsernameAvailabilityQueryJob(e, t);
			return n;
		}), c.apply(this, arguments);
	}
	u.doc = "Check if a username is available. Usage: usernameCheckDebug(\"my_username\")";
	function d(e) {
		return m.apply(this, arguments);
	}
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.reserved, n = e.sessionId, r = e.source, a = e.username, i = yield o("WAWebMexSetUsernameJob").mexSetUsernameQueryJob({
				input: a,
				reserved: t,
				source: r,
				session_id: n
	...
	d.doc = "Set/delete a username. Usage: usernameSetDebug({username: \"my_username\", reserved: false, source: \"USER_INPUT\"}) or usernameSetDebug({username: null}) to delete";
	function p(e, t) {
	...
	p.doc = "Reserve a username without activating it. Usage: usernameReserveDebug(\"my_username\", \"FB\")";
	var f = {
		usernameGetDebug: e,
