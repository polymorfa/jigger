__d("WAWebDeleteChatAction", [
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield r("JSResourceForInteraction")("WAWebBizRemoveDirectConnectionKeysBridge").__setRef("WAWebDeleteChatAction").load(), n = t.removeDirectConnectionKeys;
			yield n(e);
	...
	function h(t, r) {
		...
		var a = t.getLastMsgKeyForAction(), i = a ? t.msgs.get(a) : void 0, l = t.promises.sendDelete = o("WAWebChatDeleteBridge").sendConversationDelete({
			id: t.id,
			tcToken: t.tcToken,
			tcTokenTimestamp: t.tcTokenTimestamp
		}), u = o("WAWebFrontendChatGetters").getKind(t), m = l.then((function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (e.status === 200) {
					if (o("WAWebLabelCollection").LabelCollection.removeAllLabelsMD(t), u === o("WAWebChatFlowTypes").ChatKindType.Chat && (yield f(t.id)), u != null) switch (d.includes(u) && (yield o("WAWebBizChatAssignmentAction").removeChatAssignmentsForChat(t.id)), o("WAWebMaybeClearChatAiThreads").maybeClearAiThreadsForChat(t), u) {
				...
				} else if (e.status >= 400 && u != null) switch (u) {
					case o("WAWebChatFlowTypes").ChatKindType.Community: return new (o("WAWebActionToast.react")).ActionType(s._(
						/*BTDS*/
						""
					));
		...
		return r && o("WAWebToastManager").ToastManager.open(c.jsx(o("WAWebActionToast.react").ActionToast, {
			initialAction: _(u),
			pendingAction: m
		})), l.then(function(e) {
			if (e.status === 200) {
				var n = t.getLastMsgKeyForAction();
				a && a.equals(n) || a === n ? t.delete() : y(t, i), o("WAWebFrontendChatGetters").getKind(t) === o("WAWebChatFlowTypes").ChatKindType.Community && o("WAWebContactCollection").ContactCollection.remove(t.id.toString());
			}
		}).finally(function() {
