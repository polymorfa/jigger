__d("WAWebDeleteGuestSessionOnWebLoad", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (o("WAWebGuestCoreLocalStorage").getGuestExperienceType() !== "") {
				o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[guest] nuking existing guest session on this browser"]))), p(), r("WAWebLocalStorage") == null || r("WAWebLocalStorage").clear(), r("WAWebLocalStorage") == null || r("WAWebLocalStorage").setItem(o("WAWebUserPrefsKeys").KEYS.LOGOUT_DIRTY_BIT, "1");
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			try {
				...
				if (t == null) return;
				var r = [];
				for (var a of t) f(a.scope) && r.push(a.unregister().catch(function(e) {
	...
	l.maybeDeleteGuestSessionOnWebLoad = d, l.unregisterGuestServiceWorkers = p;
}), 98);
