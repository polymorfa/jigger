__d("WAWebDeleteLastAddOnsPreview", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			})), n = yield o("WAWebShouldUpdateLastAddOnPreview").bulkGetChatLastAddOnPreviewMap(Array.from(t)), a = new Map();
			n.forEach(function(t, n) {
				var r = t == null ? void 0 : t.parentMsgKey;
				r != null && e.includes(r) && a.set(n, void 0);
			}), yield o("WAWebApiBulkUpdateChatLastAddOnPreview").bulkUpdateChatLastAddOnPreview(a);
