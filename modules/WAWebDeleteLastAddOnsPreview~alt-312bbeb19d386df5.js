__d("WAWebDeleteLastAddOnsPreview", [
	...
	async function e(e) {
		...
		})), n = await o("WAWebShouldUpdateLastAddOnPreview").bulkGetChatLastAddOnPreviewMap(Array.from(t)), a = new Map();
		n.forEach(function(t, n) {
			var r = t == null ? void 0 : t.parentMsgKey;
			r != null && e.includes(r) && a.set(n, void 0);
		}), await o("WAWebApiBulkUpdateChatLastAddOnPreview").bulkUpdateChatLastAddOnPreview(a);
	}
