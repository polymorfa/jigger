__d("WAWebDeleteNewsletterMsgModal.react", [
	...
	function m(t) {
		...
		n[4] !== l || n[5] !== u.length ? (h = l === !0 ? s._(
			...
			"",
			[s._plural(u.length)]
		), n[4] = l, n[5] = u.length, n[6] = h) : h = n[6];
		var y = h, C;
		n[7] !== u ? (C = u.every(p) ? s._(
			/*BTDS*/
			""
		) : s._(
			/*BTDS*/
		...
		var b = C, v;
		return n[9] !== b || n[10] !== m || n[11] !== f || n[12] !== a || n[13] !== y ? (v = c.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			title: y,
			okText: b,
			onOK: f,
			...
			onCancel: m,
			ref: a
		}), n[9] = b, n[10] = m, n[11] = f, n[12] = a, n[13] = y, n[14] = v) : v = n[14], v;
	}
	function p(e) {
