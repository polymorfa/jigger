__d("WAWebDeleteUnblockMsgBar.react", [
	"fbt",
	...
	function c(e) {
		var t = e.chat, n = function() {
			...
			children: u.jsx(r("WDSButton.react"), {
				...
				type: "destructive",
				onPress: n,
				testid: "blocked-contact-msgbar-delete-chat-btn",
		...
		}), i = u.jsx(o("WAWebFlex.react").FlexColumn, { children: u.jsx(r("WDSButton.react"), {
			variant: "outline",
			type: "default",
			onPress: function() {
				return o("WAWebBlockContactUtils").handleUnblock(t.contact, o("WAWebBlockContants").BlockEntryPoint.OneToOneBlockedChatComposer);
			},
			testid: "blocked-contact-msgbar-unblock-btn",
