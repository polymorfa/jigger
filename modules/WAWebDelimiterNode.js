__d("WAWebDelimiterNode", [
	...
	var e = (function(e) {
		...
		babelHelpers.inheritsLoose(t, e), t.getType = function() {
			return "delimiter";
		}, t.clone = function(n) {
		...
		return n.createDOM = function(n) {
			...
			return t.className = o("WAWebClassnames").classnamesConvertMeToStylexPlease(t.className, "xgkkfiv"), t;
		}, n.isOpen = function() {
			...
			return babelHelpers.extends({}, e.prototype.exportJSON.call(this), { type: "delimiter-node" });
		}, t;
	})(o("Lexical").TextNode);
	function s(t, n) {
		return new e(t, n);
	...
	l.DelimiterNode = e, l.$createDelimiterNode = s, l.$isDelimiterNode = u, l.$transformToDelimiterNode = c;
}), 98);
