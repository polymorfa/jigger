__d("WAWebDeprecatedSendIqWorkerProxy", [
	"Promise",
	"WAWap",
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			var a = o("WAWap").encodeStanza(t), i = yield o("WAWebBackendWorkerClient").getBackendWorkerBridge().then(function(e) {
				return e.sendAndReceive("comms", "deprecatedSendStanzaAndReturnAck", {
					stanza: a,
					expectedAck: r
				}, void 0, void 0, void 0, [a.buffer]);
			});
