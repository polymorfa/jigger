__d("WAWebDesktopSharerContext.react", [
	...
	function $(e) {
		var t = e.handleIframeRef, n = e.inline, a = e.sessionId, i = _(function(e) {
			return t(a, e);
		}, [a, t]);
		return d.jsx("iframe", babelHelpers.extends({
			ref: i,
			src: n ? o("WAWebTPFrameUrlBuilder").getWAWebTPPdfInlineSharerUrl() : o("WAWebTPFrameUrlBuilder").getWAWebTPPdfSharerUrl(),
			sandbox: S,
			"data-testid": n ? r("WAWebPdfViewerTestIds").EDIT_INLINE_IFRAME : r("WAWebPdfViewerTestIds").EDIT_MODAL_IFRAME
		}, {
	...
	function P(e) {
		var t = e.children;
		return r("WAWebEnvironment").isWindows ? d.jsx(x, { children: t }) : d.jsx(d.Fragment, { children: t });
	}
