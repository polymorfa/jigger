__d("WAWebDesktopUpsellAnimationDataV2", [
	...
	function e() {
		return {
			...
			layers: [
				...
				o("WAWebDesktopUpsellAnimationDataV2LaptopLayers").createLaptopLayer(),
				o("WAWebDesktopUpsellAnimationDataV2LaptopLayers").createLaptopTopLayer()
			],
			markers: [],
			props: {}
		};
