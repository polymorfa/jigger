__d("WAWebDesktopUpsellUtils", [
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			if (h != null) return h;
			var n = yield (e = self.navigator) == null || (e = e.userAgentData) == null ? void 0 : e.getHighEntropyValues(["platformVersion"]);
			if ((n == null ? void 0 : n.platformVersion) != null && ((t = n.platform) == null ? void 0 : t.toLowerCase()) === "windows" && n.platformVersion != null) h = R(_, n.platformVersion) <= 0;
			else {
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			if (y != null) return y;
			var n = yield (e = self.navigator) == null || (e = e.userAgentData) == null ? void 0 : e.getHighEntropyValues(["platformVersion"]);
			return (n == null ? void 0 : n.platformVersion) != null && ((t = n.platform) == null ? void 0 : t.toLowerCase()) === "macos" && n.platformVersion != null && (y = R(g, n.platformVersion) <= 0), y != null ? y : !1;
	...
	l.UserDesktopOs = e, l.EmptyStateUpsellBannerVariantEnum = u, l.isEmptyStateUpsellBannerVariantEnabled = c, l.getEmptyStateUpsellBannerVariant = d, l.getUserDesktopOs = m, l.isWebUserOnSupportedWindowsOSForUWPAsync = C, l.isWebUserOnSupportedMacOSForCatalystAsync = v;
}), 98);
