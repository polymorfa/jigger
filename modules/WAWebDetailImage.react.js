__d("WAWebDetailImage.react", [
	...
	function I(e) {
		...
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (n = ["imgFull"], t[0] = n) : n = t[0];
		var r = o("useWAWebModelValues").useModelValues(e.profilePicThumb, n), a;
		return t[1] !== r.imgFull || t[2] !== e ? (a = c.jsx(k, babelHelpers.extends({}, e, { profilePicThumbImg: r.imgFull })), t[1] = r.imgFull, t[2] = e, t[3] = a) : a = t[3], a;
	}
	function T(e) {
		var t = o("react-compiler-runtime").c(4), n;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (n = ["img"], t[0] = n) : n = t[0];
		var r = o("useWAWebModelValues").useModelValues(e.profilePicThumb, n), a;
		return t[1] !== r.img || t[2] !== e ? (a = c.jsx(k, babelHelpers.extends({}, e, { profilePicThumbImg: r.img })), t[1] = r.img, t[2] = e, t[3] = a) : a = t[3], a;
	}
	function D(e) {
	...
	function N(e) {
		var t = o("react-compiler-runtime").c(10), n = e.iconScheme, a = e.shouldShowAdsDataSharingIcon, i = e.shouldShowAIGroupIcon, l = e.shouldShowBizAiDataSharingIcon, s = e.shouldShowEphemeralIcon, u = e.shouldShowHiddenSubgroupIcon, d = a === void 0 ? !1 : a, m = i === void 0 ? !1 : i, p = l === void 0 ? !1 : l, _ = s === void 0 ? !1 : s, f = u === void 0 ? !1 : u;
		if (p) {
			var g;
			return t[0] === Symbol.for("react.memo_cache_sentinel") ? (g = c.jsx(r("WDSIconWdsIcMetaDataDoubleChevron.react"), {
				iconXstyle: [
					L.svgSize,
					L.badgeIconSVG,
		...
		if (d) {
			var h;
			return t[1] === Symbol.for("react.memo_cache_sentinel") ? (h = c.jsx(o("WAWebSingleChevronInCircleIcon.react").SingleChevronInCircleIcon, { iconXstyle: [
				L.svgSize,
				L.badgeIconSVG,
				L.dataSharingNewStyleIcon
			] }), t[1] = h) : h = t[1], h;
		}
		if (o("WAWebBotGroupGatingUtils").isOpenGroupBotParticipantAddEnabled() && m) {
			var y;
			return t[2] === Symbol.for("react.memo_cache_sentinel") ? (y = c.jsx(r("WAWebMetaAIIcon.react"), {
				height: 17,
				width: 17
			}), t[2] = y) : y = t[2], y;
		}
		var C = o("WAWebMiscGatingUtils").isBlueEnabled() ? o("WAWebPsaVerifiedBlueIcon.react").PsaVerifiedBlueIcon : o("WAWebPsaVerifiedIcon.react").PsaVerifiedIcon, b;
		_ === !0 ? b = r("WDSIconWdsIcDisappearingMessages.react") : f ? b = r("WDSIconIcVisibilityOff.react") : b = C;
		var v = n === "subgroup-join-modal" && L.subgroupJoinModalSvgStyle, S;
		t[3] !== v ? (S = {
		...
		if (_ === !0) {
			var E;
			return t[5] !== R ? (E = c.jsx(r("WDSIconWdsIcDisappearingMessages.react"), babelHelpers.extends({ testid: "disappearing-messages-refreshed" }, R)), t[5] = R, t[6] = E) : E = t[6], E;
		}
		var k;
		return t[7] !== b || t[8] !== R ? (k = c.jsx(b, babelHelpers.extends({}, R)), t[7] = b, t[8] = R, t[9] = k) : k = t[9], k;
	}
	function M(t) {
		var n = o("react-compiler-runtime").c(63), a = t.authorColor, i = t.groupType, l = t.id, s = t.quoted, u = t.shape, d = t.theme, m = t.xstyle, p = o("useWAWebDefaultProfileColors").useDefaultProfileColors(l), _ = p.background, f = p.foreground, g = o("useWAWebGroupColors").useGroupsColorStyle(a != null ? a : 1, "color"), h;
		n[0] !== _ || n[1] !== m ? (h = [
			L.svgSize,
			...
			_,
			m
		], n[0] = _, n[1] = m, n[2] = h) : h = n[2];
		var y = f != null ? f : L.primaryFill, C;
		n[3] !== y ? (C = { primary: y }, n[3] = y, n[4] = C) : C = n[4];
		var b;
		n[5] !== h || n[6] !== C ? (b = c.jsx(o("WAWebDefaultContactRefreshedIcon.react").DefaultContactRefreshedIcon, {
			iconXstyle: h,
			"aria-hidden": !0,
			innerStyles: C
		}), n[5] = h, n[6] = C, n[7] = b) : b = n[7];
		var v = b;
		if (r("WAWebWid").isUser(l) && !r("WAWebWid").isPSA(l) && s) {
			var E;
			n[8] !== m ? (E = [L.svgSize, m], n[8] = m, n[9] = E) : E = n[9];
			var k;
			n[10] === Symbol.for("react.memo_cache_sentinel") ? (k = {
				primary: L.primaryFill,
				background: L.backgroundFill
			}, n[10] = k) : k = n[10];
			var I;
			n[11] !== E ? (I = c.jsx(o("WAWebDefaultUserSquareIcon.react").DefaultUserSquareIcon, {
				iconXstyle: E,
				"aria-hidden": !0,
				innerStyles: k
			}), n[11] = E, n[12] = I) : I = n[12], v = I;
		} else if (r("WAWebWid").isGroup(l)) if (i === o("WAWebGroupType").GroupType.LINKED_ANNOUNCEMENT_GROUP) {
			var T;
			n[13] !== m ? (T = c.jsx(r("WDSIconIcCampaignMegaphoneFilled.react"), {
				directional: !0,
				iconXstyle: [
					L.svgSize,
				...
				"aria-hidden": !0
			}), n[13] = m, n[14] = T) : T = n[14], v = T;
		} else if (i === o("WAWebGroupType").GroupType.COMMUNITY || u === S.Squircle) {
			var D;
			n[15] === Symbol.for("react.memo_cache_sentinel") ? (D = { className: "x1n2onr6 xh8yej3 x5yr21d x1f2iure" }, n[15] = D) : D = n[15];
			var x;
			n[16] !== _ ? (x = (e || (e = r("stylex"))).props(L.squircleIconBackground, _), n[16] = _, n[17] = x) : x = n[17];
			var $;
			n[18] !== m ? ($ = [
				L.svgSize,
				L.communitySquircle,
			...
			var P = f != null ? f : L.primaryFill, N;
			n[20] !== P ? (N = { primary: P }, n[20] = P, n[21] = N) : N = n[21];
			var M;
			n[22] !== $ || n[23] !== N ? (M = c.jsx(o("WAWebDefaultCommunityRefreshedIcon.react").DefaultCommunityRefreshedIcon, {
				iconXstyle: $,
				"aria-hidden": !0,
				innerStyles: N
			}), n[22] = $, n[23] = N, n[24] = M) : M = n[24];
			var w;
			n[25] !== M || n[26] !== x ? (w = c.jsx("div", babelHelpers.extends({}, x, { children: M })), n[25] = M, n[26] = x, n[27] = w) : w = n[27];
			var A;
			n[28] === Symbol.for("react.memo_cache_sentinel") ? (A = c.jsx(r("WAWebSquircleStroke.react"), {}), n[28] = A) : A = n[28];
			var F;
			n[29] !== w ? (F = c.jsxs("div", babelHelpers.extends({}, D, { children: [w, A] })), n[29] = w, n[30] = F) : F = n[30], v = F;
		} else if (i === o("WAWebGroupType").GroupType.LINKED_GENERAL_GROUP) {
			var O;
			n[31] === Symbol.for("react.memo_cache_sentinel") ? (O = c.jsx(o("WAWebCommunityGeneralChatImage.react").CommunityGeneralChatImage, {}), n[31] = O) : O = n[31], v = O;
		} else {
			var B;
			n[32] !== _ || n[33] !== m ? (B = [
				L.svgSize,
				...
				_,
				m
			], n[32] = _, n[33] = m, n[34] = B) : B = n[34];
			var W = f != null ? f : L.primaryFill, q;
			n[35] !== W ? (q = { primary: W }, n[35] = W, n[36] = q) : q = n[36];
			var U;
			n[37] !== B || n[38] !== q ? (U = c.jsx(o("WAWebDefaultGroupRefreshedIcon.react").DefaultGroupRefreshedIcon, {
				iconXstyle: B,
				"aria-hidden": !0,
				innerStyles: q
			}), n[37] = B, n[38] = q, n[39] = U) : U = n[39], v = U;
		}
		else if (r("WAWebWid").isBroadcast(l)) {
			var V;
			n[40] !== m ? (V = (e || (e = r("stylex"))).props(L.svgSize, L.circleIconRefreshed, L.profilePictureOutlineRefreshed, L.broadcastIconContainer, m), n[40] = m, n[41] = V) : V = n[41];
			var H;
			n[42] === Symbol.for("react.memo_cache_sentinel") ? (H = c.jsx(r("WDSIconWdsIcBroadcastMessageFill.react"), {
				xstyle: L.broadcastIconOuter,
				iconXstyle: L.svgSize,
				"aria-hidden": !0
			}), n[42] = H) : H = n[42];
			var G;
			n[43] !== V ? (G = c.jsx("div", babelHelpers.extends({}, V, { children: H })), n[43] = V, n[44] = G) : G = n[44], v = G;
		} else if (r("WAWebWid").isPSA(l)) {
			var z;
			n[45] !== m ? (z = c.jsx(o("WAWebWaChatPsaIcon.react").WaChatPsaIcon, {
				iconXstyle: [
					L.svgSize,
					L.avatarDefaultPSA,
					m
			...
			n[47] !== m ? (j = [
				...
				L.newsletter,
				m
			], n[47] = m, n[48] = j) : j = n[48];
			var K;
			n[49] === Symbol.for("react.memo_cache_sentinel") ? (K = {
				primary: L.primaryFill,
				background: L.backgroundFill
			}, n[49] = K) : K = n[49];
			var Q;
			n[50] !== j ? (Q = c.jsx(o("WAWebDefaultNewsletterIcon.react").DefaultNewsletterIcon, {
				iconXstyle: j,
				"aria-hidden": !0,
				innerStyles: K
			}), n[50] = j, n[51] = Q) : Q = n[51], v = Q;
		}
		var X;
		n[52] !== d ? (X = {
		...
		}[(d === R.Status) << 2 | (d === R.MediaHub) << 1 | (d === R.GroupStatus) << 0], n[52] = d, n[53] = X) : X = n[53];
		var Y;
		n[54] !== v || n[55] !== X ? (Y = c.createElement("div", babelHelpers.extends({}, X, { key: "default" }), v), n[54] = v, n[55] = X, n[56] = Y) : Y = n[56];
		var J = Y;
		if (d === R.GroupChatProfilePicture) {
			var Z;
			n[57] === Symbol.for("react.memo_cache_sentinel") ? (Z = { className: "x10l6tqk x13vifvy x1o0tod x78zum5 x6s0dn4 xl56j7k xh8yej3 x5yr21d" }, n[57] = Z) : Z = n[57];
			var ee;
			n[58] !== m ? (ee = [L.svgSize, m], n[58] = m, n[59] = ee) : ee = n[59];
			var te;
			n[60] !== g || n[61] !== ee ? (te = c.createElement("div", babelHelpers.extends({}, Z, { key: "default" }), c.jsx(o("WAWebDefaultUserColorIcon.react").DefaultUserColorIcon, {
				iconXstyle: ee,
				xstyle: g
			})), n[60] = g, n[61] = ee, n[62] = te) : te = n[62], J = te;
		}
		return J;
	}
	function w(e, t) {
