__d("WAWebDeveloperMenuAbPropsDrawer.react", [
	...
	function h(t) {
		var a = o("react-compiler-runtime").c(47), i, l;
		a[0] !== t ? (l = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, e), a[0] = t, a[1] = i, a[2] = l) : (i = a[1], l = a[2]);
		var u = i, d = u.onBack, h = o("useWAWebSearchModel").useSearchModel(b), C = h.query, v = h.results, S = h.searchInstance, R = _(f), L = R[0], E = R[1], k = L[0], I = L[1], T;
		a[3] !== (v == null ? void 0 : v.results) ? (T = function() {
			E(f(v == null ? void 0 : v.results));
		}, a[3] = v == null ? void 0 : v.results, a[4] = T) : T = a[4];
		var D;
		a[5] !== v ? (D = [v], a[5] = v, a[6] = D) : D = a[6], m(T, D);
		var x, $, P, N;
		a[7] !== C || a[8] !== (v == null ? void 0 : v.query) || a[9] !== S ? ($ = (function() {
			...
			e !== "bool" || s(0, 74916), o("WAWebModalManager").ModalManager.open(c.jsx(g, {
				...
				onChange: (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						yield r("WAWebDebug").overrideABProp(t.name, e), yield P();
					});
					return function(t) {
						return e.apply(this, arguments);
					};
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e;
				S.preloadData(), yield C((e = v == null ? void 0 : v.query.searchText) != null ? e : "");
			});
			return function() {
				return e.apply(this, arguments);
			};
		...
		})(), a[7] = C, a[8] = v == null ? void 0 : v.query, a[9] = S, a[10] = x, a[11] = $, a[12] = P, a[13] = N) : (x = a[10], $ = a[11], P = a[12], N = a[13]);
		var M = N, w;
		if (a[14] !== I || a[15] !== k) {
			if (w = [], k.length) {
				var A, F;
				a[17] === Symbol.for("react.memo_cache_sentinel") ? (F = {
					...
					static: !0
				}, a[17] = F) : F = a[17], (A = w).push.apply(A, [F].concat(k));
			}
			if (I.length) {
				var O, B;
				a[18] === Symbol.for("react.memo_cache_sentinel") ? (B = {
					itemKey: "#HEADING_ALL",
					height: 56,
					data: {
					...
					static: !0
				}, a[18] = B) : B = a[18], (O = w).push.apply(O, [B].concat(I));
			}
		...
		})(), a[19] = P, a[20] = W) : W = a[20];
		var q = W, U = y, V = p(null), H;
		a[21] === Symbol.for("react.memo_cache_sentinel") ? (H = c.jsx(o("WAWebMenuIcon.react").MenuIcon, {}), a[21] = H) : H = a[21];
		var G;
		a[22] === Symbol.for("react.memo_cache_sentinel") ? (G = c.jsx(o("WAWebRefreshIcon.react").RefreshIcon, {}), a[22] = G) : G = a[22];
		var z;
		a[23] !== q ? (z = c.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
			optionId: "fetch",
			detailLeft: G,
			secondary: "Fetch all from server",
			onSelect: q
		}), a[23] = q, a[24] = z) : z = a[24];
		var j;
		a[25] === Symbol.for("react.memo_cache_sentinel") ? (j = c.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
			optionId: "changelog",
			secondary: "Show ABProp Changelog",
			onSelect: U
		}), a[25] = j) : j = a[25];
		var K;
		a[26] !== z ? (K = c.jsx(o("WAWebFlex.react").FlexItem, {
			marginStart: 8,
			children: c.jsxs(r("WAWebUnstyledButton.react"), {
				ref: V,
				children: [H, c.jsxs(o("WAWebDropdownV2.react").DropdownV2Menu, {
					material: !0,
					target: V,
		...
		}), a[26] = z, a[27] = K) : K = a[27];
		var Q = K, X;
		a[28] === Symbol.for("react.memo_cache_sentinel") ? (X = o("WAWebSettingsFBT").developerABPropsTitle(), a[28] = X) : X = a[28];
		var Y;
		a[29] !== d ? (Y = c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			title: X,
			onBack: d,
			type: o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.SMALL
		}), a[29] = d, a[30] = Y) : Y = a[30];
		var J;
		a[31] !== x || a[32] !== M || a[33] !== $ || a[34] !== (v == null ? void 0 : v.query) ? (J = function(t) {
			var e;
			...
			return c.jsxs(o("WAWebFlex.react").FlexRow, {
				...
				children: [c.jsx(o("WAWebFlex.react").FlexItem, {
					...
					children: c.jsx(o("WAWebABPropCommandPalettePlugin").ABPropMenuItem, {
						...
						onToggle: $,
						onEdit: x,
						highlightText: (e = v == null ? void 0 : v.query.searchText) != null ? e : ""
					}, n.name)
		...
		}, a[31] = x, a[32] = M, a[33] = $, a[34] = v == null ? void 0 : v.query, a[35] = J) : J = a[35];
		var Z;
		a[36] !== w || a[37] !== J ? (Z = c.jsx(o("WAWebLexicalWAWebMenu.react").LexicalWAWebPerformantMenu, {
			material: !0,
			colorScheme: "lightest",
			data: w,
			renderItem: J
		}), a[36] = w, a[37] = J, a[38] = Z) : Z = a[38];
		var ee;
		a[39] !== Q || a[40] !== C || a[41] !== Z ? (ee = c.jsx(o("WAWebSearchInput").DrawerSearchInput, {
			focusOnMount: !0,
			placeholder: "Search AB Props",
			detailRight: Q,
			onSearch: C,
			children: Z
		}), a[39] = Q, a[40] = C, a[41] = Z, a[42] = ee) : ee = a[42];
		var te;
		return a[43] !== l || a[44] !== Y || a[45] !== ee ? (te = c.jsxs(r("WAWebDrawer.react"), {
			ref: l,
			theme: "settings",
			testid: "ab-props-drawer",
			children: [Y, ee]
		}), a[43] = l, a[44] = Y, a[45] = ee, a[46] = te) : te = a[46], te;
	}
	function y() {
