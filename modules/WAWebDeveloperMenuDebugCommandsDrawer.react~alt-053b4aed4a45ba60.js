__d("WAWebDeveloperMenuDebugCommandsDrawer.react", [
	...
	function m(e) {
		var t = e.command, n = t.doc, a = t.id, i = t.paramsToExecute, l = c(!1), s = l[0], m = l[1], p = function() {
			i != null && o("WAWebDeveloperMenuUtils").executeDebugCommand(t);
		};
		return u.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
			detailRight: i != null ? u.jsx(o("WAWebWdsIcSendFilledIcon.react").WdsIcSendFilledIcon, {
	...
	function p(t) {
		...
		}), s = l.query, c = l.results, d = (c == null ? void 0 : c.results.map(function(e) {
			return {
				itemKey: e.id,
				data: e.data
			};
		...
		return u.jsxs(r("WAWebDrawer.react"), {
			...
			children: [u.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				children: d.length === 0 ? u.jsx(o("WAWebEmptyState.react").Empty, {
