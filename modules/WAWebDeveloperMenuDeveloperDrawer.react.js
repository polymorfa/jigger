__d("WAWebDeveloperMenuDeveloperDrawer.react", [
	...
	function c(e) {
		var t = o("react-compiler-runtime").c(62), n = e.onABProps, a = e.onDebugCommands, i = e.onGroupABProps, l = e.onMetaConfig, s = e.onNuxManager, c = e.onQuickPromotionsManager, d = e.onSimulateNativeANR, _ = e.onTeeDebugInspector, g = e.onVoipUiDebug, y = e.onVoipWasmSamples, b = e.onWasaHatchDebug, R;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (R = u.jsx(o("WAWebMenuItems.react").MenuHeading, { children: "Common" }), t[0] = R) : R = t[0];
		var E;
		t[1] === Symbol.for("react.memo_cache_sentinel") ? (E = u.jsx(o("WAWebDeveloperMenuDeveloperMenuIcons.react").ABPropsIcon, {}), t[1] = E) : E = t[1];
		var I;
		t[2] !== n ? (I = u.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
			optionId: "ab-props",
			testid: "li-abprops",
			detailLeft: E,
			onSelect: n,
		...
		var ee;
		t[30] !== b ? (ee = u.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
		...
		var ie;
		t[37] !== _ ? (ie = u.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
		...
		var ge;
		t[48] !== d || t[49] !== g || t[50] !== y ? (ge = o("WAWebVoipGatingUtils").isCallingEnabled() ? u.jsxs(u.Fragment, { children: [
		...
		] }) : null, t[48] = d, t[49] = g, t[50] = y, t[51] = ge) : ge = t[51];
		var he;
		return t[52] !== O || t[53] !== j || t[54] !== Q || t[55] !== ee || t[56] !== I || t[57] !== ie || t[58] !== ge || t[59] !== N || t[60] !== w ? (he = u.jsxs(o("WAWebMenu.react").WAWebMenu, {
			size: "medium",
			colorScheme: "default",
			material: !0,
			children: [
		...
		}), t[52] = O, t[53] = j, t[54] = Q, t[55] = ee, t[56] = I, t[57] = ie, t[58] = ge, t[59] = N, t[60] = w, t[61] = he) : he = t[61], he;
	}
	function d(t) {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebIconBenchmark.react").__setRef("WAWebDeveloperMenuDeveloperDrawer.react").load();
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebWDSIconBenchmark.react").__setRef("WAWebDeveloperMenuDeveloperDrawer.react").load();
			o("WAWebModalManager").ModalManager.open(u.jsx(e, {}));
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebMessageWrapperBenchmark.react").__setRef("WAWebDeveloperMenuDeveloperDrawer.react").load();
			o("WAWebModalManager").ModalManager.open(u.jsx(e, {}));
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebMexPlaygroundModal").__setRef("WAWebDeveloperMenuDeveloperDrawer.react").load(), t = e;
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebShowroomModal.react").__setRef("WAWebDeveloperMenuDeveloperDrawer.react").load(), t = e.openShowroom;
			t();
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebDeveloperMenuDesignTemplatesDrawer.react").__setRef("WAWebDeveloperMenuDeveloperDrawer.react").load();
			o("WAWebModalManager").ModalManager.open(u.jsx(e, {}));
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("JSResourceForInteraction")("WAWebMessageBubbleShowroom.react").__setRef("WAWebDeveloperMenuDeveloperDrawer.react").load();
			o("WAWebModalManager").ModalManager.open(u.jsx(e, {}));
