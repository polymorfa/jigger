__d("WAWebDeveloperMenuGroupAbPropsDrawer.react", [
	...
	function b(t) {
		var a = o("react-compiler-runtime").c(57), i, l;
		a[0] !== t ? (l = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, e), a[0] = t, a[1] = i, a[2] = l) : (i = a[1], l = a[2]);
		var c = i, m = c.onBack, p = R, b = g(p), L = b[0], E = b[1], k;
		a[3] === Symbol.for("react.memo_cache_sentinel") ? (k = function() {
			E(p());
		}, a[3] = k) : k = a[3], o("useWAWebListener").useListener(o("WAWebChatCollection").ChatCollection, "add remove reset", k);
		var I = g(null), T = I[0], D = I[1], x = o("useWAWebSearchModel").useSearchModel(S), $ = x.query, P = x.results, N = x.searchInstance, M = g(h), w = M[0], A = M[1], F = w[0], O = w[1], B;
		a[4] !== (P == null ? void 0 : P.results) ? (B = function() {
			A(h(P == null ? void 0 : P.results));
		}, a[4] = P == null ? void 0 : P.results, a[5] = B) : B = a[5];
		var W;
		a[6] !== P ? (W = [P], a[6] = P, a[7] = W) : W = a[7], _(B, W);
		var q;
		a[8] !== $ || a[9] !== N ? (q = function(t) {
			D(t), N.updateGroupJid(t), $("");
		}, a[8] = $, a[9] = N, a[10] = q) : q = a[10];
		var U = q, V, H, G;
		a[11] !== $ || a[12] !== (P == null ? void 0 : P.query) || a[13] !== N || a[14] !== T ? (H = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				T != null || u(0, 136815), yield r("WAWebDebug").overrideGroupABProp(T, e.name, t), yield G();
			});
			return function(n, r) {
			...
			o("WAWebModalManager").ModalManager.open(d.jsx(y, {
				...
				onChange: (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						yield r("WAWebDebug").overrideGroupABProp(a, t.name, e), yield G();
					});
					return function(t) {
						return e.apply(this, arguments);
					};
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e;
				N.preloadData(), yield $((e = P == null ? void 0 : P.query.searchText) != null ? e : "");
			});
			return function() {
				return e.apply(this, arguments);
			};
		})(), a[11] = $, a[12] = P == null ? void 0 : P.query, a[13] = N, a[14] = T, a[15] = V, a[16] = H, a[17] = G) : (V = a[15], H = a[16], G = a[17]);
		var z;
		a[18] !== G || a[19] !== T ? (z = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				T != null || u(0, 136815), yield r("WAWebDebug").resetGroupABProp(T, e.name), yield G();
			});
			return function(n) {
				return e.apply(this, arguments);
			};
		})(), a[18] = G, a[19] = T, a[20] = z) : z = a[20];
		var j = z, K;
		if (a[21] !== O || a[22] !== F) {
			if (K = [], F.length) {
				var Q, X;
				a[24] === Symbol.for("react.memo_cache_sentinel") ? (X = {
					...
					static: !0
				}, a[24] = X) : X = a[24], (Q = K).push.apply(Q, [X].concat(F));
			}
			if (O.length) {
				var Y, J;
				a[25] === Symbol.for("react.memo_cache_sentinel") ? (J = {
					itemKey: "#HEADING_ALL",
					height: 56,
					data: {
					...
					static: !0
				}, a[25] = J) : J = a[25], (Y = K).push.apply(Y, [J].concat(O));
			}
			a[21] = O, a[22] = F, a[23] = K;
		} else K = a[23];
		var Z;
		a[26] !== G || a[27] !== T ? (Z = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				T != null && (yield r("WAWebDebug").syncGroupABProps(T), yield G());
			});
			return function() {
				return e.apply(this, arguments);
			};
		})(), a[26] = G, a[27] = T, a[28] = Z) : Z = a[28];
		var ee = Z, te = f(null), ne;
		a[29] === Symbol.for("react.memo_cache_sentinel") ? (ne = d.jsx(o("WAWebMenuIcon.react").MenuIcon, {}), a[29] = ne) : ne = a[29];
		var re;
		a[30] === Symbol.for("react.memo_cache_sentinel") ? (re = d.jsx(o("WAWebRefreshIcon.react").RefreshIcon, {}), a[30] = re) : re = a[30];
		var oe;
		a[31] !== ee ? (oe = d.jsx(o("WAWebFlex.react").FlexItem, {
			marginStart: 8,
			children: d.jsxs(r("WAWebUnstyledButton.react"), {
				ref: te,
				children: [ne, d.jsx(o("WAWebDropdownV2.react").DropdownV2Menu, {
					material: !0,
					target: te,
		...
		}), a[31] = ee, a[32] = oe) : oe = a[32];
		var ae = oe, ie;
		a[33] === Symbol.for("react.memo_cache_sentinel") ? (ie = s._(
			/*BTDS*/
			""
		), a[33] = ie) : ie = a[33];
		var le;
		...
		var se;
		a[36] !== U || a[37] !== le ? (se = d.jsx(o("WAWebFlex.react").FlexColumn, {
			paddingTop: 8,
			paddingBottom: 8,
			paddingStart: 16,
			paddingEnd: 16,
		...
		}), a[36] = U, a[37] = le, a[38] = se) : se = a[38];
		var ue = se, ce;
		a[39] === Symbol.for("react.memo_cache_sentinel") ? (ce = s._(
			/*BTDS*/
			""
		), a[39] = ce) : ce = a[39];
		var de;
		a[40] !== m ? (de = d.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			title: ce,
			onBack: m,
			type: o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.SMALL
		}), a[40] = m, a[41] = de) : de = a[41];
		var me;
		a[42] !== V || a[43] !== j || a[44] !== H || a[45] !== K || a[46] !== ae || a[47] !== $ || a[48] !== T ? (me = T != null ? d.jsx(o("WAWebSearchInput").DrawerSearchInput, {
			focusOnMount: !1,
		...
		}) : null, a[42] = V, a[43] = j, a[44] = H, a[45] = K, a[46] = ae, a[47] = $, a[48] = T, a[49] = me) : me = a[49];
		var pe;
		a[50] !== ue || a[51] !== me ? (pe = d.jsxs(r("WAWebDrawerBody.react"), { children: [ue, me] }), a[50] = ue, a[51] = me, a[52] = pe) : pe = a[52];
		var _e;
		return a[53] !== l || a[54] !== de || a[55] !== pe ? (_e = d.jsxs(r("WAWebDrawer.react"), {
			ref: l,
			theme: "settings",
			testid: "group-ab-props-drawer",
			children: [de, pe]
		}), a[53] = l, a[54] = de, a[55] = pe, a[56] = _e) : _e = a[56], _e;
	}
	function v(e) {
