__d("WAWebDeveloperMenuPromotedDebugCommands.react", [
	...
	function D() {
		var e = g(0), t = e[0], a = e[1], i = g("unknown"), l = i[0], s = i[1], u = g(0), c = u[0], m = u[1], h = f([]), y = f(null);
		_(function() {
			for (var e, n = (e = T[t]) != null ? e : 0; h.current.length > n;) {
				var a = h.current.pop();
				a != null && (a.postMessage({ type: "stop" }), a.terminate());
			}
			for (; h.current.length < n;) try {
			...
			return m(h.current.length), "" + t + h.current.length, function() {
				for (var e of h.current) e.postMessage({ type: "stop" }), e.terminate();
				h.current = [];
			};
		}, [t]), _(function() {
			var e = null, r = "nominal", o = (function() {
				var o = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					if (!(self == null || !("PressureObserver" in self))) try {
						...
						yield n.observe("cpu", { sampleInterval: 1e3 }), y.current = n, e = window.setInterval(function() {
			...
			children: [
				...
				d.jsxs("div", {
					...
					children: [d.jsx(r("WDSText.react"), {
						type: "Body2",
						colorName: "contentDefault",
						children: t === 0 ? "Stress test off" : "Level " + t + ": " + c + " parallel workers"
