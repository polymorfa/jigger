__d("WAWebDeveloperMenuSVG.react", [
	...
	function u() {
		return s.jsx(o("WAWebModal.react").Modal, {
			...
			children: s.jsxs(r("WAWebDrawer.react"), { children: [s.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				children: s.jsx("div", {
					...
					children: s.jsxs(o("WAWebCopyPasteSelectable.react").SelectableDiv, {
						selectable: !0,
						children: [
							s.jsxs("h2", {
