__d("WAWebDeveloperToolsDBViewerBaseTable.react", [
	...
	function y(e) {
		var t = o("react-compiler-runtime").c(5), a = e.copyValue, i = e.displayValue, l;
		t[0] !== a ? (l = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAWebCopyToClipboard").copyTextToClipboard(typeof a == "string" ? a : JSON.stringify(a)), o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: b(a) + " copied" }));
			});
			return function() {
		...
		var s;
		return t[2] !== i || t[3] !== l ? (s = u.jsx(r("WAWebUnstyledButton.react"), {
			onClick: l,
			xstyle: c.cell,
			children: i
