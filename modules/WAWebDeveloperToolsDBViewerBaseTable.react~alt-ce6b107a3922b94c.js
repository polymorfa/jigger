__d("WAWebDeveloperToolsDBViewerBaseTable.react", [
	...
	function g(e) {
		var t = e.copyValue, a = e.displayValue;
		return u.jsx(r("WAWebUnstyledButton.react"), {
			onClick: n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAWebCopyToClipboard").copyTextToClipboard(typeof t == "string" ? t : JSON.stringify(t)), o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: y(t) + " copied" }));
			}),
			xstyle: c.cell,
			children: a
		});
