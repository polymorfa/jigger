__d("WAWebDeveloperToolsSerializer", [
	"WAAckLevel",
	"WAWebWid",
	"react",
	"stylex"
	...
	var e, s, u = s || (s = o("react")), c = {
		...
		true: {
			backgroundColor: "xs9v28o",
			$$css: !0
		},
		false: {
			backgroundColor: "x17v13r8",
			$$css: !0
		},
		paddingHoriz4: {
	...
	function m(e) {
		if (typeof e == "number" && e) {
			var t = new Date(e);
			return t.getFullYear() === 1970 ? new Date(e * 1e3).toUTCString() : t.toUTCString();
		}
		return f(e);
	}
	function p(e) {
	...
	function f(t) {
		return u.jsx("span", babelHelpers.extends({}, (e || (e = r("stylex"))).props(c.span, t == null && c.unset, typeof t == "boolean" && c.boolean, typeof t == "boolean" && c.paddingHoriz4, typeof t == "boolean" && (t === !0 ? c.true : c.false)), { children: typeof t == "string" ? String(t) : JSON.stringify(t) }));
	}
