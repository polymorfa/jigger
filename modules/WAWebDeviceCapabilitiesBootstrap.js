__d("WAWebDeviceCapabilitiesBootstrap", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (!u) {
				...
				if (yield o("WAWebBizBroadcastsDeviceCapability").bootstrapBizBroadcastPrimaryCapability(), yield m(), yield r("WAWebDeviceCapabilitiesSync").sendMutation(n), o("WAWebABProps").getABPropConfigValue("device_capabilities_v2_sync_enabled")) try {
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield o("WAWebPrimaryDeviceCapabilities").getPrimaryDeviceCapabilities();
			if (e == null) {
