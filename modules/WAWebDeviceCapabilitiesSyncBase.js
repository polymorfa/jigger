	...
	var p = (function(t) {
		...
		return i.getVersion = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this, n = yield o("WAWebSyncdDb").getSyncActionsRows(["index"], [e.index]), r = n.reduce(function(e, n) {
					if (n.actionState === o("WAWebSyncdConst").SyncActionState.Success) {
						var r = o("decodeProtobuf").decodeProtobuf(o("WAWebProtobufSyncAction.pb").SyncActionDataSpec, n.binarySyncData), a = r.value, i = t.getCapabilitiesFromValue(a);
						if (i) return i;
					}
				}, {}), a = this.getCapabilitiesFromValue(o("decodeProtobuf").decodeProtobuf(o("WAWebProtobufSyncAction.pb").SyncActionValueSpec, e.binarySyncAction));
				return {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var n = this, r = 0, a = t.map(function(e) {
					if (e.operation === "set") {
						var t = n.getCapabilitiesFromValue(e.value);
						if (t != null) {
							var a = e.indexParts[d], i = a != null ? m(a) : null;
							if (i === c) {
								var l, s = o("WAWebUserPrefsDeviceCapabilities").mapProtobufToAllDeviceCapabilities(t);
								o("WAWebUserPrefsDeviceCapabilities").mergeDeviceCapabilitiesToStorage(s, "primary"), r++;
								var u = (l = s.aiThread) == null ? void 0 : l.supportLevel;
								if ((u === o("WAWebProtobufsDeviceCapabilities.pb").DeviceCapabilities$AiThread$SupportLevel.INFRA || u === o("WAWebProtobufsDeviceCapabilities.pb").DeviceCapabilities$AiThread$SupportLevel.FULL) && o("WAWebBackendApi").frontendFireAndForget("initializeMetaAiBotAiThreads", {}), o("WAWebMobilePlatforms").isSMB()) {
									var p = t.businessBroadcast, _ = !!(p != null && p.companionSupportEnabled) && !!(p != null && p.campaignSyncEnabled), f = o("WAWebBizBroadcastDeviceCapabilityCommon").getPrimarySupportsBusinessBroadcast();
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this.getMutation(o("WATimeUtils").unixTimeMs(), e), r = yield this.capabilitiesHaveChanged(t);
				if (!r.hasChanged) {
