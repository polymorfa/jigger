	...
	var e = (function(e) {
		...
		return r.getAction = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				return o("WAWebABProps").getABPropConfigValue("device_capabilities_v2_sync_enabled") ? e.prototype.applyMutations.call(this, t) : t.map(function() {
