__d("WAWebDirectMessagesNotificationsDrawer.react", [
	...
	function _(e) {
		...
		}), u = o("useWAWebSettingSync").useSettingSync("isMessagesNotificationEnabled", function(e) {
			o("WAWebMuteCollection").MuteCollection.setGlobalNotificationsEnabled(e);
		}), d = o("useWAWebSettingSync").useSettingSync("isReactionsNotificationEnabled", function(e) {
