__d("WAWebDisappearingMessageKeepInChatWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ DisappearingMessageKeepInChat: [
		3482,
		{
			...
			kicActionName: [5, o("WAWebWamEnumKicActionNameType").KIC_ACTION_NAME_TYPE],
			kicActor: [6, o("WAWebWamEnumKicActorType").KIC_ACTOR_TYPE],
			kicEntryPoint: [7, o("WAWebWamEnumKicEntryPointType").KIC_ENTRY_POINT_TYPE],
