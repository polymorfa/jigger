__d("WAWebDisappearingModeSettingChangeWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumDisappearingModeEntryPointType",
	"WAWebWamEnumPreviousEphemeralityType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ DisappearingModeSettingChange: [
		3056,
		{
			afterReadDuration: [5, e.TYPES.INTEGER],
			disappearingModeEntryPoint: [4, o("WAWebWamEnumDisappearingModeEntryPointType").DISAPPEARING_MODE_ENTRY_POINT_TYPE],
			...
			previousEphemeralityType: [10, o("WAWebWamEnumPreviousEphemeralityType").PREVIOUS_EPHEMERALITY_TYPE]
		},
		[
			1,
			1,
