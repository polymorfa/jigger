__d("WAWebDoNotDisturbSettings.react", [
	...
	function E(e) {
		var t, a, i = e.isNotificationsEnabledInSystem, l = i === void 0 ? !0 : i, u = e.onOpenCalls, c = e.onOpenDirectMessages, d = e.onOpenGroupMessages, m = e.onOpenStatusUpdates, f = e.onShowNotificationBannerClick, b = e.onTaskbarNotificationSettingsClick, S = e.reactionsMute, E = e.ref, I = o("useWAWebMuteValues").useMuteValues(S.id, [
		...
		var A = r("useWAWebToggle")(function() {
		...
		}), F = A[0], O = A[1], B = r("useWAWebToggle")(function() {
			return o("WAWebMuteCollection").MuteCollection.getGlobalSounds();
		}, function(e) {
			return o("WAWebMuteCollection").MuteCollection.setGlobalSounds(e);
		}), W = B[0], q = B[1], U = o("useWAWebSettingSync").useSettingSync("isTextPreviewForNotificationEnabled", function(e) {
		...
		}, U), H = V[0], G = V[1], z = o("useWAWebSettingSync").useSettingSync("isCallsNotificationEnabled", function(e) {
		...
		}, z), K = j[0], Q = j[1], X = r("useWAWebToggle")(function() {
		...
		}), Y = X[0], J = X[1], Z = r("useWAWebToggle")(function() {
		...
		}), ee = Z[0], te = Z[1], ne = o("useWAWebSettingSync").useSettingSync("isMessagesNotificationEnabled", function(e) {
			var t;
			if (o("WAWebMuteCollection").MuteCollection.setGlobalNotifications(e), e ? (H || G(), T && o("WAWebCmd").Cmd.muteAllReactions(o("WAWebStateUtils").unproxy(S), !1, !0)) : o("WAWebUserPrefsNotifications").setWebNotificationsBBStatus({
				isDismissed: !0,
				lastDismissTime: o("WATimeUtils").unixTime()
			}), e && !r("WAWebEnvironment").isWindows && ((t = window.Notification) == null ? void 0 : t.permission) !== o("WAWebNotificationConstants").PERMISSION_ALLOWED) {
		...
		}, ne), oe = re[0], ae = re[1], ie = o("useWAWebSettingSync").useMappedSettingSync({
			settingName: "defaultNotificationToneId",
			originalSetter: function(t) {
				C == null || C(t);
			},
			toProtobufValue: function(t) {
				return t;
			}
		}), le = o("useWAWebSettingSync").useMappedSettingSync({
			...
			o("WAWebCmd").Cmd.muteAllReactions(o("WAWebStateUtils").unproxy(S), !T);
			...
			onChange: ae,
			ariaLabel: o("WAWebSettingsFBT").messageNotificationsTitle().toString() + ". " + o("WAWebSettingsFBT").messageNotificationsSubtitle().toString(),
			children: [o("WAWebSettingsFBT").messageNotificationsTitle(), p.jsx(o("WAWebText.react").WAWebTextMuted, { children: o("WAWebSettingsFBT").messageNotificationsSubtitle() })]
		}), ce = o("WAWebABProps").getABPropConfigValue("wa_web_enable_granular_notifications"), de = p.jsxs(o("WAWebSettingsCheckList.react").SettingsCheckListItem, {
			...
			checkboxRightAligned: !0,
			children: [o("WAWebSettingsFBT").showPreviewsTitle(), ce ? p.jsx(o("WAWebText.react").WAWebTextMuted, { children: o("WAWebSettingsFBT").showPreviewsSubtitle() }) : null]
		}), me;
		if (o("WAWebPushNotificationsGatingUtils").canEnableOfflineNotifications() && window.Notification) {
			...
			me = p.jsxs(o("WAWebSettingsCheckList.react").SettingsCheckListItem, {
				...
				checkboxRightAligned: !0,
				onChange: w,
				ariaLabel: pe.toString() + ". " + o("WAWebSettingsFBT").offlineSyncSubtitle().toString(),
				children: [pe, p.jsx(o("WAWebText.react").WAWebTextMuted, { children: o("WAWebSettingsFBT").offlineSyncSubtitle() })]
			});
		}
		var _e;
		if (!r("gkx")("26258")) {
		...
		var ge = s._(
			...
			testid: "option-outgoing-message-sound",
			id: "outgoing-message-sound",
			checked: F,
			checkboxRightAligned: !0,
			onChange: O,
			ariaLabel: ge.toString() + ". " + o("WAWebSettingsFBT").outgoingAudioToneSubtitle().toString(),
			children: [ce ? he : ge, ce ? null : p.jsx(o("WAWebText.react").WAWebTextMuted, { children: o("WAWebSettingsFBT").outgoingAudioToneSubtitle() })]
			...
			checkboxRightAligned: !0,
			onChange: Q,
			ariaLabel: o("WAWebSettingsFBT").showCallsTitle().toString() + ". " + o("WAWebSettingsFBT").showCallsSubtitle().toString(),
			children: [o("WAWebSettingsFBT").showCallsTitle(), p.jsx(o("WAWebText.react").WAWebTextMuted, { children: o("WAWebSettingsFBT").showCallsSubtitle() })]
			...
			checkboxRightAligned: !0,
			onChange: J,
			ariaLabel: o("WAWebSettingsFBT").playCallRingtoneTitle().toString() + ". " + o("WAWebSettingsFBT").playCallRingtoneSubtitle().toString(),
			children: [o("WAWebSettingsFBT").playCallRingtoneTitle(), p.jsx(o("WAWebText.react").WAWebTextMuted, { children: o("WAWebSettingsFBT").playCallRingtoneSubtitle() })]
			...
			checkboxRightAligned: !0,
			onChange: q,
			ariaLabel: o("WAWebSettingsFBT").soundsTitle().toString() + ". " + o("WAWebSettingsFBT").soundsSubtitle().toString(),
			children: [o("WAWebSettingsFBT").soundsTitle(), p.jsx(o("WAWebText.react").WAWebTextMuted, { children: o("WAWebSettingsFBT").soundsSubtitle() })]
		}), Re = n("cr:6005") ? p.jsx(n("cr:6005"), {}) : null, Le = s._(
			/*BTDS*/
			""
		), Ee = s._(
			/*BTDS*/
			...
			/*BTDS*/
			""
		), Ne = p.jsx(o("WAWebDevOnlyBadge.react").DevOnlyBadge, { label: s._(
			/*BTDS*/
			""
		) }), Me = n("cr:8361") && f ? p.jsx(n("cr:8361"), {
			onClick: f,
			isNotificationsEnabledInSystem: l
		}) : null, we = n("cr:3176") && b ? p.jsx(n("cr:3176"), { onClick: b }) : null, Ae = n("cr:545") ? p.jsx(n("cr:545"), { isNotificationEnabled: !P && oe }) : null, Fe = (a = R == null ? void 0 : R()) != null ? a : !1, Oe = n("cr:7206") && Fe ? p.jsx(n("cr:7206"), {
		...
		}) : null, Be = n("cr:7206") && Fe ? p.jsx(n("cr:7206"), {
		...
		}) : null, We = p.jsxs(r("WAWebDrawerSection.react"), {
			theme: "padding-small-horizontal-no-vertical",
			titleXStyle: L.drawerTitle,
			animation: !1,
			children: [Me, we]
		}), qe = o("WAWebVoipGatingUtils").isCallingEnabled() ? p.jsxs(r("WAWebDrawerSection.react"), {
			theme: "padding-no-vertical",
			title: $e,
			titleXStyle: L.drawerTitle,
			animation: !1,
			children: [be, p.jsx("div", {
				className: "xso031l x1q0q8m5 x120ee7l",
				children: ve
			})]
		}) : null, Ue = r("gkx")("26258") ? null : p.jsxs(r("WAWebDrawerSection.react"), {
			theme: "padding-no-vertical",
			title: Ne,
			titleXStyle: L.drawerTitle,
			animation: !1,
		...
		if (ce) {
			...
			return p.jsxs("div", { children: [
				...
				p.jsxs(r("WAWebDrawerSection.react"), {
					...
					children: [
						p.jsxs(o("WAWebDrawerButton.react").DrawerButtonSimple, {
							...
							children: [Ve, p.jsx(o("WAWebText.react").WAWebTextMuted, { children: ke() })]
						}),
						p.jsxs(o("WAWebDrawerButton.react").DrawerButtonSimple, {
							...
							children: [He, p.jsx(o("WAWebText.react").WAWebTextMuted, { children: Ie() })]
						}),
						p.jsxs(o("WAWebDrawerButton.react").DrawerButtonSimple, {
							...
							children: [Ge, p.jsx(o("WAWebText.react").WAWebTextMuted, { children: Te() })]
						}),
						o("WAWebVoipGatingUtils").isCallingEnabled() ? p.jsxs(o("WAWebDrawerButton.react").DrawerButtonSimple, {
							...
							children: [$e, p.jsx(o("WAWebText.react").WAWebTextMuted, { children: De() })]
						}) : null
					]
				}),
				p.jsxs(r("WAWebDrawerSection.react"), {
				...
				p.jsxs(r("WAWebDrawerSection.react"), {
					theme: "padding-no-vertical",
					animation: !1,
					children: [p.jsx("div", { className: "x178xt8z x13fuv20 xx42vgk" }), p.jsx("div", {
						className: "xso031l x1q0q8m5 x120ee7l",
						children: me
					})]
				}),
				Ue,
				r("WAWebEnvironment").isWindows ? null : p.jsxs(r("WAWebDrawerSection.react"), {
					theme: "padding-no-vertical",
					animation: !1,
					children: [Ue != null ? p.jsx("div", { className: "x178xt8z x13fuv20 xx42vgk" }) : null, p.jsx(r("WDSText.react"), {
						type: "Body3",
