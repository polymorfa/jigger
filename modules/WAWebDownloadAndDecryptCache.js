	...
	var c = (function() {
		...
		return a.get = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
				var a = n.downloadQpl;
				if (!o("WAWebMediaDataUtils").shouldUseLruMediaStore(n.type)) return null;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				...
				if (o("WAWebMediaDataUtils").shouldUseLruMediaStore(n.type)) {
					var i = yield o("WAWebMediaStore").LruMediaStore.getName();
					try {
						a.addPoint("lru_cache_write_start", { int: { byteLength: t.byteLength } }), yield o("WAWebMediaStore").LruMediaStore.put(u(n), t), a.addPoint("lru_cache_write_end", { string: {
							lruCacheBackend: i,
							lruCacheWriteResult: "completed"
						} });
					} catch (e) {
						a.addPoint("lru_cache_write_fail", { string: {
							lruCacheBackend: i,
