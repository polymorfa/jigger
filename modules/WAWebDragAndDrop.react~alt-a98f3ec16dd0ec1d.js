__d("WAWebDragAndDrop.react", [
	...
	function f(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.disableFromWithin, l = a.onDragChange, s = a.onDrop, c = p(!1), f = c[0], g = c[1], h = p(!1), y = h[0], C = h[1], b = p(!1), v = b[0], S = b[1], R = o("useWAWebTimeout").useTimeout(function() {
			C(!1), S(!1);
		}, 250), L = R[0], E = R[1], k = r("useWAWebPrevious")(y), I = function(t) {
			i && g(!0);
		}, T = function(t) {
			i && g(!1);
		}, D = function(t) {
			...
			t.preventDefault(), t.stopPropagation(), E(), !(y || f) && (C(!0), S(!1), _(t));
		}, $ = function(t) {
