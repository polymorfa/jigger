__d("WAWebDrawerItem.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = e.children, n = e.dataTab, a = e.disabled, i = e.disableKeydownHandling, l = e.icon, c = e.isLastItem, d = e.onClick, m = e.onDisabledClick, p = e.tabIndex, _ = p === void 0 ? 0 : p, f = e.testid, g = e.theme, h = g === void 0 ? "default" : g, y = e.title, C = {
		...
		}[!!r("WAWebL10N").isRTL() << 2 | (l != null) << 1 | (c === !0) << 0], b = {
			0: "",
			1: "x98rzlu"
		}[(l != null) << 0], v = {
			0: "",
			1: "xhslqc4 x1okw0bk"
		}[(l != null) << 0], S = r("useWAWebIsKeyboardUser")(), R = S.isKeyboardUser, L = a === !0 ? m : d, E = L != null, k = a === !0 ? { "aria-label": s._(
			/*BTDS*/
			""
		) } : {};
