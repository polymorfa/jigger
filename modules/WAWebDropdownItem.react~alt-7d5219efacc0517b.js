__d("WAWebDropdownItem.react", [
	...
	function y(e) {
		var t = e.action, n = e.children, a = e.disabled, i = e.icon, l = e.testid, u = e.theme, d = e.tooltip, m = e.xstyle;
		return c.jsx("div", babelHelpers.extends({}, {
			0: {},
			1: { className: "xti2d7y x1h6gzvc" }
		}[(a === !0) << 0], { children: c.jsx(h, {
			testid: l,
			...
			children: c.jsxs(o("WAWebFlex.react").FlexRow, {
				...
				children: [c.jsx(o("WAWebFlex.react").FlexRow, {
					...
					children: i
				}), c.jsx("span", babelHelpers.extends({}, (s || (s = r("stylex"))).props(g.textSlot, o("WDSMargins.stylex").wdsMargins.marginEnd24, m), { children: n }))]
			})
		}) }));
	}
	y.displayName = y.name + " [from " + i.id + "]";
	function C(t) {
		var n = t.icon, r = babelHelpers.objectWithoutPropertiesLoose(t, e);
		return n ? c.jsx(y, {
			action: r.action,
			disabled: r.disabled,
			icon: n,
			...
			xstyle: r.xstyle,
			children: r.children
		}) : c.jsx(h, babelHelpers.extends({}, r, { children: r.children }));
	}
	C.displayName = C.name + " [from " + i.id + "]", l.DropdownItemThemeType = f, l.DropdownItem = C;
}), 98);
