__d("WAWebE2eRetryRejectWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ E2eRetryReject: [
		3578,
		{
			e2eSenderType: [10, o("WAWebWamEnumE2eDeviceType").E2E_DEVICE_TYPE],
			encryptionType: [9, o("WAWebWamEnumEncryptionTypeCode").ENCRYPTION_TYPE_CODE],
			invisibleMessageCategory: [6, o("WAWebWamEnumInvisibleMessageCategoryType").INVISIBLE_MESSAGE_CATEGORY_TYPE],
			...
			pqFallbackReason: [13, o("WAWebWamEnumPqFallbackReason").PQ_FALLBACK_REASON],
			retryRejectReason: [3, o("WAWebWamEnumRetryRejectReason").RETRY_REJECT_REASON],
			retryRevoke: [4, e.TYPES.BOOLEAN],
			senderDeviceType: [5, o("WAWebWamEnumDeviceType").DEVICE_TYPE],
			sessionScope: [12, o("WAWebWamEnumSessionScopeType").SESSION_SCOPE_TYPE]
		},
		[
			1,
			1,
