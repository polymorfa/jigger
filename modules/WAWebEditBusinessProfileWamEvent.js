__d("WAWebEditBusinessProfileWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumBusinessProfileEntryPoint",
	"WAWebWamEnumBusinessProfileField",
	"WAWebWamEnumEditProfileAction"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ EditBusinessProfile: [
		1466,
		{
			businessProfileEntryPoint: [10, o("WAWebWamEnumBusinessProfileEntryPoint").BUSINESS_PROFILE_ENTRY_POINT],
			editBusinessProfileSessionId: [2, e.TYPES.STRING],
			editProfileAction: [1, o("WAWebWamEnumEditProfileAction").EDIT_PROFILE_ACTION],
			editProfileActionField: [9, o("WAWebWamEnumBusinessProfileField").BUSINESS_PROFILE_FIELD],
