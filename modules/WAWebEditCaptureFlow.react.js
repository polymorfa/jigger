__d("WAWebEditCaptureFlow.react", [
	"fbt",
	"$InternalEnum",
	"WAFilteredCatch",
	...
	function f(e) {
		var t = p(null), n = t[0], a = t[1], i = m(null), l = m(), c = o("useWAWebFlow").useFlow(_.Capture), f = c[0], g = c[1], h = function() {
			...
			l.current = n, t.then(function(e) {
				i.current || g.pop("modal"), e && i.current && i.current.loadNewStream(e, n);
			}).catch(o("WAFilteredCatch").filteredCatch(o("WAWebGetUserMediaErrors").NotAllowedError, function() {
				var e;
				g.end(), o("WAWebModalManager").ModalManager.open(u.jsx((e = o("WAWebGuidePopup.react")).GuidePopup, {
