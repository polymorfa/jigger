__d("WAWebEditGroupProfileDrawer.react", [
	...
	function T(e) {
		var t, a, i, l, u = e.onCancel, d = e.onFinished, T = e.sendEmojiStickerPanelOpenLoggingEvent, D = e.title, x = _(null), $ = x[0], P = x[1], N = _(null), M = N[0], w = N[1], A = _(null), F = A[0], O = A[1], B = _(0), W = B[0], q = B[1], U = _(null), V = U[0], H = U[1], G = _([]), z = G[0], j = G[1], K = p(null), Q = p(null), X = p(!1), Y = {
			EMOJI: 0,
			STICKER: 1
		}, J = p((t = {}, t[Y.EMOJI] = r("WAWebNoop"), t[Y.STICKER] = r("WAWebNoop"), t)), Z = p([]), ee = p(null), te = s._(
			/*BTDS*/
			""
		);
		m(function() {
			...
			var e = ee.current;
			if (e != null) for (var t = E(te.toString()), n = k(t, e.textArr); e.getHeight() > R.height || n;) e.fontSize(e.fontSize() - 1), n = k(t, e.textArr);
		}, [te]);
		var ne = c.jsx(o("ReactKonva").Stage, {
			...
			children: c.jsxs(o("ReactKonva").Layer, { children: [c.jsx(o("ReactKonva").Rect, {
				...
				y: v / 2,
				image: $,
				filters: M === g.EMOJI && X.current ? [r("WAWebUtilsSharpenFilter")] : []
			})] })
		});
		Object.values(Y).forEach(function(e) {
			typeof e == "number" && (J.current[e] = function() {
				F === e && O(null);
			});
		});
		var re = function(t) {
				...
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					try {
						...
						if (t != null) j(null), H(t);
							...
							var n;
							H(null), j((n = a == null ? void 0 : a.mediaData.emojis) != null ? n : []);
						}
						if (t != null) {
							var i = yield o("WAWebMediaEditorUtilsCreateCanvasAndImage").createImageFromEmoji(t);
							i && (P(i), X.current = i.naturalWidth <= f && i.naturalHeight <= f, w(g.EMOJI), e && J.current[Y.EMOJI]());
						} else if (a != null) {
							var l = yield o("WAWebMediaEditorUtilsCreateCanvasAndImage").createImageFromSticker(a);
			...
			if ($ == null) o("WAWebToastManager").ToastManager.open(c.jsx(o("WAWebToast.react").Toast, {
				msg: s._(
					/*BTDS*/
					""
				),
				...
				var e, t, n, a, i = (e = (t = K.current) == null ? void 0 : t.toDataURL({
					mimeType: "image/jpeg",
					pixelRatio: o("WAWebProfileCropConstants").PROF_PIC_THUMB_SIDE / v,
					quality: 0,
					width: v,
					height: v
				})) != null ? e : "", l = (n = (a = K.current) == null ? void 0 : a.toDataURL({
					mimeType: "image/jpeg",
			...
			children: c.jsx(r("WDSButton.react"), {
				...
				size: "large",
				onPress: ae,
				xstyle: $ == null ? h.submitButtonDisabledLook : void 0,
		...
		}, "btn-submit"), le = V != null ? s._(
			/*BTDS*/
			"",
			[s._param("emoji name", V), s._param("color name", I(b[W]))]
		) : null, se = null;
		if (Array.isArray(z)) if (z.length > 0) {
			var ue;
			se = s._(
				/*BTDS*/
				"",
		...
		return c.jsxs(r("WAWebDrawer.react"), {
			...
			children: [c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				children: [
							...
							children: c.jsxs(o("WAWebFlex.react").FlexColumn, {
								...
								children: [
									...
									c.jsx(r("WAWebFlexItem.react"), { children: c.jsx(r("WAWebIconTabs.react"), {
										...
										selectedIndex: F,
										onSelect: function(t) {
											t !== F && (O(t), re(t === Y.EMOJI ? g.EMOJI : g.STICKER));
										},
										tabConfigs: [{
					...
					F === Y.EMOJI && c.jsx(o("WAWebEditGroupProfileDrawerEmojiStickerPanelPopup.react").EmojiPanelPopup, {
						anchor: r("nullthrows")((i = Z.current[Y.EMOJI]) == null ? void 0 : i.current),
						onSelect: oe,
						onClose: function() {
							return J.current[Y.EMOJI]();
						}
					}),
					F === Y.STICKER && c.jsx(o("WAWebEditGroupProfileDrawerEmojiStickerPanelPopup.react").StickerPanelPopup, {
						anchor: r("nullthrows")((l = Z.current[Y.STICKER]) == null ? void 0 : l.current),
						onSelect: function(t) {
							return oe(null, t);
						},
						onClose: function() {
