__d("WAWebEditGroupProfileDrawerEmojiStickerPanelPopup.react", [
	...
	function c(e) {
		var t = e.anchor, n = e.anchorRef, a = e.onClose, i = e.onSelect, l = s.jsx(r("WAWebEmojiPanel.react"), {
			onEmoji: i,
			onFocusNext: a,
			onFocusPrev: a
		});
	...
	function d(e) {
		var t = e.anchor, n = e.onClose, a = e.onSelect, i = s.jsx("div", {
			className: "xjp7ctv",
		...
		return i ? s.jsx(o("WAWebUimUie.react").UIE, {
	...
	d.displayName = d.name + " [from " + i.id + "]", l.EmojiPanelPopup = c, l.StickerPanelPopup = d;
}), 98);
