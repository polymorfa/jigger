__d("WAWebEmojiCompile", [
	"WATrie",
	"escapeRegex",
	"isStringNullOrEmpty"
], (function(t, n, r, o, a, i, l) {
	function e(e) {
		var t = r("WATrie").fromForwardsStrings(e.sort(function(e, t) {
	...
	function s(e, t, n, o, a) {
		var i = [], l = !1, d = a;
		if (d == null && !r("isStringNullOrEmpty")(e)) if (o === 1) {
			var m = c.has(e);
			m && (d = !0);
		...
		var p = e === String.fromCodePoint(65039) && n != null && d !== !0 ? String.fromCodePoint(65039) + "?" : r("escapeRegex")(e || ""), _ = i.length === 0 ? "" : "(?:" + i.join("|") + ")";
		return _ && l && (_ += "?"), "" + p + _;
	}
	var u = "\n", c = new Set([
