__d("WAWebEmojiPanelContent.react", [
	...
	function b(e) {
		var t = o("react-compiler-runtime").c(15), n = e.displayLocation, a = e.onFocusUp, i = e.onSearchChange, l = e.onSearchDownKey, u = e.onSearchEnterKey, c = e.searchInputRef, m = e.searchText, p = e.transitionName, _;
		...
		var f = _, g;
		t[2] !== a || t[3] !== l ? (g = function(t) {
			if (t.key === "ArrowUp") return a(), !1;
			if (t.key === "ArrowDown") return l(), !1;
		}, t[2] = a, t[3] = l, t[4] = g) : g = t[4];
		var y = g, C;
		t[5] !== y || t[6] !== i || t[7] !== u || t[8] !== c || t[9] !== f || t[10] !== m ? (C = d.jsx(r("WDSSearchBar.react"), {
			hintText: f,
			onValueChange: i,
			onKeyDown: y,
			onEnter: u,
		...
		}), t[5] = y, t[6] = i, t[7] = u, t[8] = c, t[9] = f, t[10] = m, t[11] = C) : C = t[11];
		var b;
		return t[12] !== C || t[13] !== p ? (b = d.jsx(r("WAWebVelocityTransitionGroup"), {
			transitionName: p,
			xstyle: h.search,
			children: C
	...
	function v(e) {
		var t = o("react-compiler-runtime").c(10), n = e.data, r = e.displayLocation, a = e.onEmoji, i = e.onEmojiFocus, l = e.onSearchResultsFocusAbove, s = e.searchResultsRef, u = e.targetWindow, c = e.width, m;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (m = { className: "x1n2onr6 xupqr0c x1iyjqo2 xs83m0k x1r8uery x2lwn1j" }, t[0] = m) : m = t[0];
		var p;
		return t[1] !== n || t[2] !== r || t[3] !== a || t[4] !== i || t[5] !== l || t[6] !== s || t[7] !== u || t[8] !== c ? (p = d.jsx("div", babelHelpers.extends({}, m, { children: d.jsx(o("WAWebEmojiPanelContentSectionScrollList.react").EmojiSectionScrollList, {
			data: n,
			width: c,
			initialScrollTop: 0,
			...
			displayLocation: r,
			targetWindow: u
		}) })), t[1] = n, t[2] = r, t[3] = a, t[4] = i, t[5] = l, t[6] = s, t[7] = u, t[8] = c, t[9] = p) : p = t[9], p;
	}
	function S(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, e), l = i.displayLocation, s = i.onChange, c = i.onEmoji, m = i.onFocusNext, h = i.onFocusPrev, S = i.onFocusUp, E = i.onSection, k = i.sectionIds, I = i.width, T = f(null), D = f(null), x = f(null), $ = f(null), P = f(!1), N = f(!1), M = f(!1), w = f(i.displayCache.scrollTop), A = f(i.displayCache.sectionId), F = g(i.defaultSearchText || ""), O = F[0], B = F[1], W = g(i.displayCache.showSearchInput), q = W[0], U = W[1], V = g(function() {
		...
		}), H = V[0], G = o("useWAWebTimeout").useTimeout(function() {
			M.current = !1;
		}, 200), z = G[0], j = function(t, n) {
			M.current = !0, z();
			var e = n.scrollTop, r = t.getBoundingClientRect().top - n.getBoundingClientRect().top + e, a = 2, i = r - n.clientHeight + t.clientHeight + a, l = q ? r - o("WAWebEmojiPanelContentSectionScrollList.react").TOTAL_SEARCH_HEIGHT : r - a;
		...
		var Q = function() {
			...
			var e = t - w.current;
			if (w.current = t, !M.current && !N.current && !X()) {
				var n = Math.abs(e);
				P.current = n > y;
				var r = e >= 0 ? 1 : -1;
			...
			T.current && T.current.focusFirstVisibleEmoji(o("WAWebEmojiPanelContentSectionScrollList.react").TOTAL_SEARCH_HEIGHT);
		}, re = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				A.current = e, yield new (u || (u = (n("Promise"))))(function(e) {
					P.current = !0, B(""), U(!0), e();
				}), N.current = !0;
				var t = T.current ? T.current.scrollToSection(e, 0 - o("WAWebEmojiPanelContentSectionScrollList.react").TOTAL_SEARCH_HEIGHT) : (u || (u = n("Promise"))).resolve();
		...
		return d.jsx(o("WAWebKeyboardHotKeys.react").HotKeys, {
			...
			children: d.jsxs("div", babelHelpers.extends({}, {
			...
			}[(l === o("WAWebPanelsDisplayLocation").DisplayLocation.ExpressionsPanel) << 1 | (l === o("WAWebPanelsDisplayLocation").DisplayLocation.Reactions || l === o("WAWebPanelsDisplayLocation").DisplayLocation.ExpressionsPanel || l === o("WAWebPanelsDisplayLocation").DisplayLocation.Dropdown) << 0], { children: [
				d.jsx(b, {
					transitionName: P.current ? "emoji-search-slide-away-fast" : "emoji-search-slide-away",
					onFocusUp: S,
					searchInputRef: D,
					searchText: O,
					onSearchChange: ee,
				...
				ce != null ? d.jsxs(d.Fragment, { children: [d.jsx(r("WAWebEmojiPanelSearchResultsAnnouncement.react"), {
					data: ce,
					displayLocation: l
				}), d.jsx(v, {
					width: I,
				...
				}[!!O << 0], { children: d.jsx(o("WAWebEmojiPanelContentSectionScrollList.react").EmojiSectionScrollList, {
					data: H,
					width: i.width,
					onFocusUp: te,
