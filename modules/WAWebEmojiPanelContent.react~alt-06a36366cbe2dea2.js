__d("WAWebEmojiPanelContent.react", [
	...
	function b(e) {
		var t = e.displayLocation, n = e.onFocusUp, a = e.onSearchChange, i = e.onSearchDownKey, l = e.onSearchEnterKey, u = e.searchInputRef, c = e.searchText, m = e.transitionName, p = t === o("WAWebPanelsDisplayLocation").DisplayLocation.Reactions ? s._(
			/*BTDS*/
			""
		) : s._(
			/*BTDS*/
	...
	function v(e) {
		...
		return d.jsx("div", {
			...
			children: d.jsx(o("WAWebEmojiPanelContentSectionScrollList.react").EmojiSectionScrollList, {
				data: t,
				width: u,
				initialScrollTop: 0,
