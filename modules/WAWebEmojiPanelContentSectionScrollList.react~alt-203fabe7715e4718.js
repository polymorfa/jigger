__d("WAWebEmojiPanelContentSectionScrollList.react", [
	...
	function E(e) {
		var t = e.displayLocation, n = e.focusAbove, a = e.focusBelow, i = e.numColumns, l = e.onEmoji, s = e.onEmojiFocus, u = e.onRef, c = e.row;
		switch (c.kind) {
			case "title": return p.jsx("div", {
			...
			case "emojis": return p.jsx(o("WAWebEmojiPanelContentEmojiRow.react").EmojiRow, {
				emojis: c.emojis,
				focusAbove: n,
				focusBelow: a,
				numColumns: i,
				...
				onEmojiFocus: s,
				ref: u,
				allowVariantPrompt: c.sectionId !== o("WAWebEmojiPanelEmojiSections").SECTIONS.RECENT,
				displayLocation: t
			});
			default: throw c.kind, r("err")("Invalid row kind: " + c.kind);
		}
	}
