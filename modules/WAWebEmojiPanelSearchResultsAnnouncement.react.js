__d("WAWebEmojiPanelSearchResultsAnnouncement.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(8), n = e.data, a = e.displayLocation, i;
		t[0] !== n ? (i = r("sumBy")(n, m), t[0] = n, t[1] = i) : i = t[1];
		var l = i, c;
		if (a === o("WAWebPanelsDisplayLocation").DisplayLocation.Reactions) {
			...
			), t[4] = l, t[5] = p) : p = t[5], c = p;
		}
		var _;
		return t[6] !== c ? (_ = u.jsx(o("WAWebAccessibility.react").InvisibleAnnouncement, { text: c }), t[6] = c, t[7] = _) : _ = t[7], _;
	}
	function m(e) {
