__d("WAWebEmojiPickerPlugin", [
	...
	function b() {
		var t = o("react-compiler-runtime").c(17), n = o("LexicalComposerContext").useLexicalComposerContext(), a = n[0], i;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (i = {
			minQueryLength: p,
			maxQueryLength: _,
			boundary: !0
		}, t[0] = i) : i = t[0];
		var l = o("useWAWebLexicalTypeAhead").useTypeAhead(a, m, i), s = l.leadOffset, c = l.omitQuery, g = l.query, b = l.replaceQuery, v;
		e: {
			if (g == null) {
				var S;
				t[1] === Symbol.for("react.memo_cache_sentinel") ? (S = [], t[1] = S) : S = t[1], v = S;
				break e;
			}
			var R;
			t[2] !== g ? (R = o("WAWebEmojiKeywordToUnicode").emojiKeywordToUnicodeSearch(g), t[2] = g, t[3] = R) : R = t[3], v = R;
		}
		var L = v, E;
		t[4] !== b ? (E = function(t) {
			o("WAWebRecentEmojiCollection").RecentEmojiCollection.increment(t), b(t);
		}, t[4] = b, t[5] = E) : E = t[5];
		var k = E, I;
		t[6] !== c ? (I = function() {
			c();
		...
		if (t[8] !== L || t[9] !== k) {
			var x;
			t[11] !== k ? (x = function(n, o) {
				return {
					renderFn: function(a) {
						var t = C(n), i = [d.marginInline5, d.padding5];
			...
			}, t[11] = k, t[12] = x) : x = t[12], D = L.map(x), t[8] = L, t[9] = k, t[10] = D;
		} else D = t[10];
		var $ = D, P;
		return t[13] !== T || t[14] !== $ || t[15] !== s ? (P = u.jsx(r("WAWebLexicalTypeAheadRow.react"), {
			items: $,
			itemWidth: h,
			itemHeight: f,
			leadOffset: s,
			onCancel: T
		}), t[13] = T, t[14] = $, t[15] = s, t[16] = P) : P = t[16], P;
	}
	l.default = b;
}), 98);
