__d("WAWebEmojiSkinTonePicker.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = e.action, n = e.base, a = e.preVariant, i = e.unicode, l = o("WAWebEmoji").isBaseMultiSkinToneEmoji(n), u = o("WAWebEmoji").HANDSHAKE === n, c = o("WAWebMiscGatingUtils").multiSkinToneEmojiPickerEnabled() && !(o("WAWebConnModel").Conn.platform === o("WAWebMobilePlatforms").PLATFORMS.IPHONE && u), d = l ? o("WAWebEmoji").getPermutations(o("WAWebEmojiPanelUtil").SKIN_TONE_VARIATIONS.slice(1), 2) : o("WAWebEmojiPanelUtil").SKIN_TONE_VARIATIONS.map(function(e) {
			return [e];
		...
		return l ? c ? s.jsx(r("WAWebMultiSkinTonePicker.react"), {
			base: n,
			action: t,
			unicode: i,
			preVariant: a,
