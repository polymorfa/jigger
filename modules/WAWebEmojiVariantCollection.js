__d("WAWebEmojiVariantCollection", [
	...
	var e = (function(e) {
		...
		var n = t.prototype;
		return n.setVariant = function(t, n) {
			...
			if (o("WAWebEmoji").EmojiUtil.getSkinToneBase(t)) {
				var e = this.get(t);
				return e ? o("WAWebEmoji").EmojiUtil.normalizeEmoji(e.variant) : null;
			}
	...
	e.model = r("WAWebEmojiVariantModel"), e.cachePolicy = {
