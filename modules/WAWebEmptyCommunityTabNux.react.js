__d("WAWebEmptyCommunityTabNux.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(10), n = e.onNewCommunity, a;
		...
		var d = l, p;
		t[2] === Symbol.for("react.memo_cache_sentinel") ? (p = u.jsx(o("WAWebLottieAnimationLoadable").LottieAnimation, {
			loop: !1,
			autoplay: !0,
		...
		var _ = p, f, g;
		t[3] === Symbol.for("react.memo_cache_sentinel") ? (f = u.jsx(r("WAWebFlexItem.react"), {
			...
			weight: "bold",
			children: i
		}), t[3] = f, t[4] = g) : (f = t[3], g = t[4]);
		var h;
		t[5] === Symbol.for("react.memo_cache_sentinel") ? (h = u.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "center",
		...
		var y;
		t[6] !== n ? (y = o("WAWebCommunityGatingUtils").communitiesCreationEnabled() ? u.jsx(m, { onNewCommunity: n }) : null, t[6] = n, t[7] = y) : y = t[7];
		var C;
		return t[8] !== y ? (C = u.jsx(r("WAWebDrawerSection.react"), {
			theme: "full-height",
	...
	function m(e) {
		var t = o("react-compiler-runtime").c(3), n = e.onNewCommunity, a;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (a = s._(
			/*BTDS*/
			""
		), t[0] = a) : a = t[0];
		var i;
		return t[1] !== n ? (i = u.jsx(o("WAWebFlex.react").FlexRow, {
			align: "center",
			justify: "center",
