__d("WAWebEncryptAndSendGroupMsg", [
	...
	var e, s, u, c;
	function d(t) {
		var r, a = t.metricReporter, i = t.msgProtobuf, l = t.msgRecord, d = t.scheduledMsgMetadata, _ = l.data, g = _.id, h = _.to;
		return o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["encryptAndSendGroupMsg: queued ", ""])), g).tags("messaging"), (r = a.sendPerfReporter) == null || r.startWaitingToEncryptStage(), o("WAWebSendMsgQueueMap").sendMsgQueueMap.enqueue(h.toString(), n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e, t, n, r, y, C;
			o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["encryptAndSendGroupMsg: sending ", ""])), g).tags("messaging"), (e = a.sendPerfReporter) == null || e.postWaitingToEncryptStage(), (t = a.sendPerfReporter) == null || t.startReadyToSendStage();
			var b = m(i), v = f(i), S = p(i), R = yield o("WAWebGroupMsgSendUtils").getParticipantRecord(h.toString()), L = yield o("WAWebGroupMsgSendUtils").getGroupData(h.toString(), R, l);
			(n = a.sendReporter) == null || n.setGroupData(L), (r = a.sendPerfReporter) == null || r.setGroupData(L);
			var E = (y = R == null ? void 0 : R.participants.map(function(e) {
				return o("WAWebWidFactory").createUserWidOrThrow(e);
			})) != null ? y : [], k = yield o("WAWebMsgRcatUtils").genContentBindingForMsg(_, E), I = !!L.isLidAddressingMode, T;
			if (L.isCag === !0) {
				var D, x = !!L.amIAdmin;
				o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["encryptAndSendGroupMsg: CAG ", " "])), x ? "admin" : "non-admin").tags("messaging");
				var $ = i == null || (D = i.messageHistoryBundle) == null || (D = D.messageHistoryMetadata) == null ? void 0 : D.historyReceivers;
				if ($ != null && $.length > 0) {
					var P = yield o("WAWebApiParticipantStore").getGroupSenderKeyListFromParticipantRecord(h, R), N = function(t) {
						return t.map(o("WAWebLidMigrationUtils").toAddressingModeFactory(I));
					}, M = yield o("WAWebGroupHistorySendGroupMsgJobUtils").getGroupSendListForGroupHistoryBundle($.map(o("WAWebWidFactory").createWid), P, {
						normalizeAddressingModeFn: N,
						isLidAddressingMode: I
					});
					T = o("WAWebSendGroupMsgJob").filterIncorrectlyAddressedDevices(M, L);
				} else T = yield o("WAWebSendGroupMsgJob").getCagMessageSendList({
					editedMsgKey: v,
					groupId: h,
					isAdmin: x,
					isLidAddressingMode: I,
				...
				var A = yield o("WAWebSendGroupMsgJob").getMessageSendList(h, R, b, v, I, i == null || (w = i.messageHistoryBundle) == null || (w = w.messageHistoryMetadata) == null ? void 0 : w.historyReceivers);
				T = o("WAWebSendGroupMsgJob").filterIncorrectlyAddressedDevices(A, L);
			}
			var F = (L == null ? void 0 : L.isCapiGroup) === !0 ? o("WAWebE2EProtoGenerator").updateGroupMsgProtoWithCapiFlag(i) : i;
			if (T.type === o("WAWebSendGroupMsgJob").GROUP_MSG_TYPE.DIRECT) {
				var O, B, W = T, q = W.deviceList;
				return (O = a.sendReporter) == null || O.setDeviceCount(q.length), (B = a.sendPerfReporter) == null || B.setIsDirectedMessage(!0), o("WAWebSendGroupDirectJob").encryptAndSendGroupDirectMsg({
					deviceList: q,
					groupData: L,
					metricReporter: a,
					msgProtobuf: F,
			...
			return (C = a.sendReporter) == null || C.setDeviceCount(V.skList.length + V.skDistribList.length), o("WAWebSendGroupSkmsgJob").encryptAndSendSenderKeyMsg(l, F, V, L, a, k, d);
		}));
	}
	function m(e) {
