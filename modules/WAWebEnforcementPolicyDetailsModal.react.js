__d("WAWebEnforcementPolicyDetailsModal.react", [
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(9), n = e.icon, a = e.testid, i = e.text, l;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (l = [d.bulletIcon, d.iconColor], t[0] = l) : l = t[0];
		var s;
		t[1] !== n ? (s = u.jsx(o("WAWebFlex.react").FlexColumn, {
			align: "start",
			shrink: 0,
			xstyle: l,
			children: n
		...
		var c;
		t[3] !== i ? (c = u.jsx(o("WAWebFlex.react").FlexColumn, { children: u.jsx(r("WDSText.react"), {
			type: "Body2",
			colorName: "contentDefault",
			children: i
		}) }), t[3] = i, t[4] = c) : c = t[4];
		var m;
		return t[5] !== s || t[6] !== c || t[7] !== a ? (m = u.jsxs(o("WAWebFlex.react").FlexRow, {
			xstyle: d.bulletRow,
			marginBottom: 8,
			paddingBottom: 4,
			paddingStart: 8,
			...
			testid: a,
			children: [s, c]
		}), t[5] = s, t[6] = c, t[7] = a, t[8] = m) : m = t[8], m;
	}
	l.default = m;
}), 226);
