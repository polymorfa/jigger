__d("WAWebEphemeralAfterReadKicNux.react", [
	...
	function d(e) {
		var t = e.duration, n = e.onOk, a = r("useWAWebNux")(o("WAWebNux").NUX.EPHEMERAL), i = a[1], l = r("useWAWebNux")(o("WAWebNux").NUX.EPHEMERAL_AFTER_READ), d = l[1], p = function() {
			i(), d();
		}, _ = function() {
			p(), o("WAWebModalManager").ModalManager.closeSupportOrModal(), n && n();
		}, f = function() {
			p(), o("WAWebExternalLink.react").openExternalLink(o("WAWebFaqUrl").getEphemeralFaqUrl());
		};
			...
			children: [
				...
				u.jsx(m, {
					...
					children: s._(
						/*BTDS*/
						"",
						[s._param("duration", o("WAWebFormatEphemeralSetting").getDisappearingMessageDurationString(t))]
					)
				}),
				u.jsx(m, {
