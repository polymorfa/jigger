__d("WAWebEphemeralDrawer.react", [
	...
	function p(e) {
		var t = o("react-compiler-runtime").c(2), n = e.onClick, a;
		return t[0] !== n ? (a = s._(
			/*BTDS*/
			"",
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(4), n = e.onClick, r;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (r = { className: "x1ubxc9n" }, t[0] = r) : r = t[0];
		var a;
		t[1] === Symbol.for("react.memo_cache_sentinel") ? (a = [16, 0], t[1] = a) : a = t[1];
		var i;
		return t[2] !== n ? (i = c.jsx("div", babelHelpers.extends({}, r, { children: c.jsx(o("WAWebText.react").WAWebTextMuted, {
			margin: a,
			children: c.jsx(p, { onClick: n })
		}) })), t[2] = n, t[3] = i) : i = t[3], i;
	}
	function f(t) {
