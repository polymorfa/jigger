__d("WAWebEphemeralKicNux.react", [
	...
	function m(e) {
		var t = e.chat, n = e.fromMe, a = e.onOk, i = r("useWAWebNux")(o("WAWebNux").NUX.EPHEMERAL), l = i[1], m = r("useWAWebNux")(o("WAWebNux").NUX.KEEP_IN_CHAT), f = m[1], g = r("useWAWebNux")(o("WAWebNux").NUX.EPHEMERAL_AFTER_READ), h = g[1], y = n && o("WAWebAfterReadUtils").isAfterReadOptionAvailable(), C = function() {
			l(), f(), y && h(), o("WAWebModalManager").ModalManager.closeSupportOrModal(), a && a();
		}, b = async function() {
			l(), f(), y && h();
