__d("WAWebEphemeralSettingChangeWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumEphemeralSettingEntryPointType",
	"WAWebWamEnumPreciseSizeBucket",
	"WAWebWamEnumPreviousEphemeralityType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ EphemeralSettingChange: [
		2370,
		{
			afterReadDuration: [7, e.TYPES.INTEGER],
			chatEphemeralityDuration: [1, e.TYPES.INTEGER],
			ephemeralSettingEntryPoint: [3, o("WAWebWamEnumEphemeralSettingEntryPointType").EPHEMERAL_SETTING_ENTRY_POINT_TYPE],
			ephemeralSettingGroupSize: [5, o("WAWebWamEnumPreciseSizeBucket").PRECISE_SIZE_BUCKET],
			...
			previousEphemeralityType: [12, o("WAWebWamEnumPreviousEphemeralityType").PREVIOUS_EPHEMERALITY_TYPE],
