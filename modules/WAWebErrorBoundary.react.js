__d("WAWebErrorBoundary.react", [
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(13), a = e.boundaryName, i = e.error, l;
		t[0] !== i ? (l = i != null ? i : {}, t[0] = i, t[1] = l) : l = t[1];
		var u = l, c = u.stack, m;
		t[2] !== c ? (m = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				c != null && (yield navigator.clipboard.writeText(c), o("WAWebToastManager").ToastManager.open(d.jsx(o("WAWebToast.react").Toast, { msg: "Stack copied" })));
			});
			return function() {
		...
		var g = f, h = "Error stack from " + a, y;
		t[6] !== _ || t[7] !== g || t[8] !== c ? (y = c != null ? d.jsxs(d.Fragment, { children: [d.jsx("div", {
			className: "x126k92a x1hu6azw x190qgfh xqt63rz xw2csxc x1odjw0f x889kno x2vl965 x1a8lsjc xe2zdcy",
			children: d.jsx("code", { children: c })
		}), d.jsxs("div", {
		...
		})] }) : "No error stack found, check console", t[6] = _, t[7] = g, t[8] = c, t[9] = y) : y = t[9];
		var C;
		return t[10] !== h || t[11] !== y ? (C = d.jsx(o("WAWebModal.react").Modal, {
			title: h,
			type: o("WAWebModal.react").ModalTheme.Multiline,
			children: y
		}), t[10] = h, t[11] = y, t[12] = C) : C = t[12], C;
	}
	function g(e) {
