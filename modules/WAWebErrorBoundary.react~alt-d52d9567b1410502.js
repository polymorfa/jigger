__d("WAWebErrorBoundary.react", [
	...
	function f(e) {
		var t = e.boundaryName, a = e.error, i = a != null ? a : {}, l = i.stack, u = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				l != null && (yield navigator.clipboard.writeText(l), o("WAWebToastManager").ToastManager.open(d.jsx(o("WAWebToast.react").Toast, { msg: "Stack copied" })));
			});
			return function() {
