__d("WAWebEventEditAddonMessageProcessor", [
	...
	var e = o("WAWebAddonCreateMsgProcessor").createAddonMsgProcessor({
		...
		beforeUpsert: async function(t, n) {
			var e = n.parents, r = await o("WAWebProcessEncryptedEventEditMsgs").processEncryptedEventEditMsgs(t, e), a = r.filter(function(e) {
				return e.isLatest;
			});
			await o("WAWebDBProcessEditProtocolMsgs").updateMessageEditsLocally(r, a);
			var i = o("WAArrayGroupBy").groupBy(a, function(e) {
				return e.protocolMsg.id.remote.toString();
			});
			return await o("WAWebGenerateEventEditSystemMessages").generateEventEditSystemMessages(i), [];
		},
