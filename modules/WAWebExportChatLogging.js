__d("WAWebExportChatLogging", [
	...
	var e = {
		...
		cancelled: o("WAWebWamEnumExportResultType").EXPORT_RESULT_TYPE.CANCELLED,
		error: o("WAWebWamEnumExportResultType").EXPORT_RESULT_TYPE.ERROR
	}, u = {
		individual: o("WAWebWamEnumMessageChatType").MESSAGE_CHAT_TYPE.INDIVIDUAL,
