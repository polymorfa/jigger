__d("WAWebExportChatMenuItem.react", [
	"fbt",
	...
	function c(e) {
		var t = e.chat;
		if (!o("WAWebExportChatGatingUtils").canExportChat(t) || !o("WAWebExportChatGatingUtils").isExportChatHistorySyncReady()) return null;
		var n = s._(
			/*BTDS*/
			""
		);
