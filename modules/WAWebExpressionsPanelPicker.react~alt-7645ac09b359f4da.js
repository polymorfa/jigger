__d("WAWebExpressionsPanelPicker.react", [
	...
	function v(t) {
		var n = t.getComposeBoxEditorRef, a = t.iconWidth, i = t.onClose, l = t.onEmoji, u = t.onGif, d = t.onSticker, y = t.onStickerFromStore, b = t.onToggleActive, v = t.ref, S = t.size, R = t.wrapperRef, L = f(!1), E = L[0], k = L[1], I = f(o("WAWebComposeBoxPanelTypes").ComposeBoxExpressionPanel.EMOJI), T = I[0], D = I[1], x = m(o("WDSGlobalContext").WDSContext), $ = x.closeAllMenus, P = [
			o("WAWebComposeBoxPanelTypes").ComposeBoxExpressionPanel.EMOJI,
			u ? o("WAWebComposeBoxPanelTypes").ComposeBoxExpressionPanel.GIF : null,
			d ? o("WAWebComposeBoxPanelTypes").ComposeBoxExpressionPanel.STICKER : null
		].filter(Boolean), N = function(t) {
			return P.includes(t);
		}, M = _(null), w = _(null), A = _(null), F = f(""), O = F[0], B = F[1], W = f(null), q = W[0], U = W[1], V = o("WAWebDrawerManagerContext").useMiddleDrawerManagerContext(), H = (V == null ? void 0 : V.drawer) != null, G = r("WAWebL10N").isRTL(), z = function(t) {
			k(t), b == null || b(t);
		}, j = function(t) {
			B(t);
		}, K = async function(t) {
			E || await o("WAWebModalManager").ModalManager.existsAsync() || (D(t), z(!0));
		}, Q = function() {
			B(""), z(!1), i == null || i();
		}, X = function() {
			if (E) z(!1);
				...
				D(e != null && N(e) ? e : o("WAWebComposeBoxPanelTypes").ComposeBoxExpressionPanel.EMOJI), z(!0);
			}
			...
			if (e === o("WAWebComposeBoxPanelTypes").ComposeBoxExpressionPanel.STICKER) return N(o("WAWebComposeBoxPanelTypes").ComposeBoxExpressionPanel.STICKER) ? {
		...
		}), o("useWAWebListener").useListener(o("WAWebCmd").Cmd, "open_compose_box_panel", K), o("useWAWebListener").useListener(o("WAWebCmd").Cmd, "close_expression_panels", Q);
		var te = function(t, r) {
			var e, o = (e = n()) == null || (e = e.editor) == null ? void 0 : e.getRootElement();
			o != null && o.contains(r == null ? void 0 : r.srcElement) || Q();
		}, ne = function() {
			if (q) {
				var e = q.getBoundingClientRect(), t = o("WAWebGetExpressionsPanelOffset").getExpressionsPanelOffset(e, {
					height: document.body.clientHeight,
					width: document.body.clientWidth
				}), n = t.horizontal, r = t.vertical, a = G ? { right: n + "px" } : { left: n + "px" };
				return babelHelpers.extends({}, a, { bottom: r + "px" });
			}
			return {};
		}, re = c.jsx(r("WAWebVelocityTransitionGroup"), { transitionName: "dropdown" }), oe = c.jsxs(r("WAWebPortalThemeWrapper.react"), { children: [ee, c.jsx(o("WAWebFlex.react").FlexRow, {
			justify: "center",
			align: "center",
			...
			children: c.jsx(r("WAWebIconTabs.react"), {
				...
				onSelect: function(t) {
					var e = P[t];
					e !== T && (D(e), o("WAWebUserPrefsGeneral").setLastComposeBoxExpressionPanel(e));
				},
				tabConfigs: Y,
		...
		var ie = r("nullthrows")(document.querySelector("#expressions-panel-container"));
		...
		}), se = o("useWAWebABPropConfigValue").useABPropConfigValue("wds_web_expressions_panel"), ue;
		se ? ue = c.jsx(r("WDSMenuBarItem.react"), {
		...
		var ce = [C.expressionsPanelPickerWrapper];
		return ce.push(C.expressionsPanelPickerWrapperRefresh, g.marginInlineEnd6), c.jsxs(c.Fragment, { children: [c.jsx("div", babelHelpers.extends({ ref: R }, (e || (e = r("stylex"))).props(ce), { children: ue })), re] });
	}
