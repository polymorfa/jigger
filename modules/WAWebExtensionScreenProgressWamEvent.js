__d("WAWebExtensionScreenProgressWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ExtensionScreenProgress: [
		4112,
		{
			...
			entryPointConversationInitiated: [19, o("WAWebWamEnumEntryPointConversationInitiated").ENTRY_POINT_CONVERSATION_INITIATED],
			...
			flowEntryPoint: [23, o("WAWebWamEnumFlowEntryPoint").FLOW_ENTRY_POINT],
