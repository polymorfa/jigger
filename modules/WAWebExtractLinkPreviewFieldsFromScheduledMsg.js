__d("WAWebExtractLinkPreviewFieldsFromScheduledMsg", [
	"WALongInt",
	...
	function e(e) {
		...
		if (t == null || !o("WAWebParseExtendedTextMessageProtoUtils").isUrlExtendedTextMessage(t)) return {};
		var n = t.mediaKeyTimestamp != null ? o("WALongInt").numberOrThrowIfTooLarge(t.mediaKeyTimestamp) : void 0;
		return {
			subtype: "url",
			...
			thumbnailSha256: o("WAWebE2EProtoParserApi").decodeBytes(t.thumbnailSha256),
			thumbnailEncSha256: o("WAWebE2EProtoParserApi").decodeBytes(t.thumbnailEncSha256),
