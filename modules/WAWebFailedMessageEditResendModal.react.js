__d("WAWebFailedMessageEditResendModal.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(10), n = e.failedEditedMsg, r = e.ref, a = o("WAWebMsgActionCapability").canEditText(n), i;
		...
		var f = _, g;
		t[3] !== n ? (g = function() {
			return o("WAWebModalManager").ModalManager.close(), o("WAWebSendMessageEditAction").resendLatestEdit(n);
		}, t[3] = n, t[4] = g) : g = t[4];
		var h = g, y;
		...
		var b;
		return t[7] !== h || t[8] !== r ? (b = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			ref: r,
			tsNavigationData: y,
			okText: l,
			onOK: h,
