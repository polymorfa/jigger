__d("WAWebFavicon.react", [
	...
	function u(e) {
		...
		return t[0] === Symbol.for("react.memo_cache_sentinel") ? (r = [], t[0] = r) : r = t[0], s(c, r), n;
	}
	function c() {
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(1), n = e.children, r;
		return t[0] === Symbol.for("react.memo_cache_sentinel") ? (r = [], t[0] = r) : r = t[0], s(m, r), n;
	}
	function m() {
