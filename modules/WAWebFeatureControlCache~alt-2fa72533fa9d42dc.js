__d("WAWebFeatureControlCache", ["WATimeUtils", "WAWebUserPrefsIndexedDBStorage"], (function(t, n, r, o, a, i, l) {
	"use strict";
	...
	async function p() {
		...
		if ((r == null ? void 0 : r.isUserAA) !== !0) {
			var a = {
				...
				lastFetchedAt: (n = r == null ? void 0 : r.lastFetchedAt) != null ? n : null,
				isUserAA: !0
			};
	...
	l.getPolicy = u, l.getPolicyLastFetchedAt = c, l.getUserIsAA = d, l.setPolicy = m, l.markUserAsAA = p, l.clearPolicy = _;
}), 98);
