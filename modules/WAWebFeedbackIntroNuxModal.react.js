__d("WAWebFeedbackIntroNuxModal.react", [
	"fbt",
	"WAWebABPropsSaga",
	...
	function p(t) {
		var n = r("useWAWebFocusOnMount")(), a = function() {
		...
		o("useWAWebListener").useListener(o("WAWebModalManager").ModalManager, "close_modal", function() {
			r("WAWebNuxSync").acknowledgeNux(o("WAWebNux").NuxSyncKey.FEEDBACK_INTRO);
		});
		var i = {
			width: 24,
			height: 24,
			...
			{
				icon: c.jsx(o("WAWebMessageReportIcon.react").MessageReportIcon, babelHelpers.extends({}, i)),
				description: s._(
					/*BTDS*/
					""
				)
			...
			{
				icon: c.jsx(o("WAWebIcLightbulbIcon.react").IcLightbulbIcon, babelHelpers.extends({}, i)),
				description: s._(
					/*BTDS*/
					""
				)
			...
			{
				icon: c.jsx(r("WDSIconIcImage.react"), babelHelpers.extends({}, i)),
				description: s._(
					/*BTDS*/
					""
				)
		...
		return c.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			testid: "feedback-intro-nux-modal",
			tsNavigationData: {
				surface: "unknown",
			...
			children: c.jsxs(o("WAWebFlex.react").FlexColumn, {
				align: "center",
				children: [
					c.jsx(o("WAWebWdsAnimPhoneNoteFeedbackIcon.react").WdsAnimPhoneNoteFeedbackIcon, { xstyle: d.marginTop8 }),
