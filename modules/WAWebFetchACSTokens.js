		...
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			var a = 1, i = (function() {
				var o = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
					var o = yield s(t, r);
					switch (o.name) {
						case "SignCredentialResponseErrorNoRetry": return n({ result: null });
						case "SignCredentialResponseErrorRetry": return a += 1, a > e ? n({ result: null }) : void 0;
						default: return o.name, n({ result: o.value });
					}
				});
				return function(t) {
