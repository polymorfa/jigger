__d("WAWebFetchBotProfilesGQLQuery.graphql", ["WAWebFetchBotProfilesGQLQuery_facebookRelayOperation"], (function(t, n, r, o, a, i) {
	"use strict";
	var e = (function() {
		var e = [{
			defaultValue: null,
				...
				selections: [{
					...
					selections: [
						...
						l,
						{
							...
							storageKey: "latest_published_version_for_viewer(is_ai_home:false)"
						}
					],
					storageKey: null
				}],
