__d("WAWebFetchMusicConsumptionAvailability", [
	...
	async function m(t, n) {
		...
		try {
			var a, i, l, s, u = p(n, t), c = await o("WAWebACSNetwork").fetchWithACSCredential({
				project: "WA_ChannelsMusic",
				url: d,
				data: u
			});
			if (c == null) throw r("err")("Failed to fetch music consumption availability");
			var m = await c.json(), _ = (a = (i = m.data) == null || (i = i.music_consumption) == null ? void 0 : i.items) != null ? a : [];
			if (_.length === 0) throw r("err")("No items returned in music consumption response");
			var f = (l = (s = _[0]) == null || (s = s.availability_info) == null ? void 0 : s.is_available_for_consumption) != null ? l : !1;
			return f;
		} catch (t) {
