__d("WAWebFetchMusicEligibleCountries", [
	"WALogger",
	"WAWebACSNetwork",
	...
	"use strict";
	var e, s = "8360352280687329", u = "https://acs.whatsapp.com/graphql";
	async function c() {
		...
		try {
			...
			if (n == null) throw r("err")("Failed to fetch music eligible countries");
			var a = await n.json(), i = a.data.xwa_music_eligible_countries.reduce(function(e, t) {
