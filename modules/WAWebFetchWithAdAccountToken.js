__d("WAWebFetchWithAdAccountToken", ["WAWebFetchAdAccountToken", "asyncToGeneratorRuntime"], (function(t, n, r, o, a, i, l) {
	var e = (function(e) {
		function t(t) {
			var n;
			return n = e.call(this, "Failed to fetch ad account token: " + t.type) || this, n.tokenResult = t, n.name = "FetchAdAccountTokenError", n;
		}
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				...
				if (!(n instanceof Error) || !o("WAWebFetchAdAccountToken").hasGraphQLAuthError(n)) throw n;
