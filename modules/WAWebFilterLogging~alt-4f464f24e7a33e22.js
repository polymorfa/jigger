__d("WAWebFilterLogging", [
	...
	async function f(t) {
		var n = t.chatId, r = t.filter, a = t.searchResult, i = t.sessionId, l = {
			...
			targetScreen: o("WAWebWamEnumChatFilterTargetScreen").CHAT_FILTER_TARGET_SCREEN.CHAT_LIST,
			sessionId: i
		}, u = n != null ? await o("WAWebChatThreadLogging").getChatThreadID(n.toJid()) : null;
		s({
			eventData: l,
			filter: r,
			threadId: u
	...
	async function g(t, n, r, a) {
		var i = {
			...
			sessionId: t
		}, l = a != null ? await o("WAWebChatThreadLogging").getChatThreadID(a.toJid()) : null;
		s({
			eventData: i,
			filter: n,
			threadId: l
	...
	l.logOpenFilterEvent = u, l.logSelectFilterEvent = c, l.logEmptyStateViewedFilterEvent = d, l.logSearchFilterEvent = p, l.logSearchWithFilterEvent = _, l.logSearchItemSelectedFilterEvent = f, l.logSearchMsgSentFilterEvent = g, l.logLabelDropdownShownEvent = h;
}), 98);
