__d("WAWebFormatConfiguration", [
	...
	function e(e) {
		var t = e.messageHasSpoiler, n = e.selectable, a = e.spoilerInteractive;
		return t !== !0 || !o("WAWebSpoilerGating").isSpoilerReceiverEnabled() ? null : [[r("WAWebSpoilerFormatMutator"), {
			selectable: n,
			spoilerInteractive: a
		}]];
	}
	function s(e) {
		var t = e === void 0 ? {} : e, n = t.emojiXstyle, o = t.selectable;
		return [[[r("WAWebEmojiFormatMutator"), {
			selectable: o,
			emojiXstyle: n
		}]]];
	}
	function u(e) {
		var t = e === void 0 ? {} : e, n = t.selectable;
		return [[[r("WAWebEmojiFormatMutator"), {
			selectable: n,
			size: "large"
		}]]];
	...
	function c(e) {
		var t = e === void 0 ? {} : e, n = t.dataTab, a = t.emojiXstyle, i = t.links, l = t.linkXstyle, s = t.selectable;
		return [
	...
	function d(e) {
		var t = e === void 0 ? {} : e, n = t.links, a = t.linkXstyle, i = t.selectable;
		return [
	...
	function p(t) {
		var n = t.boundary, a = t.groupMentions, i = t.mentions, l = t.messageHasSpoiler, s = t.selectable, u = t.terms, c = e({
			messageHasSpoiler: l,
			selectable: s
		});
		return [[[r("WAWebTextMentionFormatMutator"), {
			mentions: i,
			selectable: s
	...
	function f(t) {
		t === void 0 && (t = {});
		var n = o("WAWebABProps").getABPropConfigValue("enable_clear_formatted_preview"), a = t, i = a.groupMentions, l = a.isDraftMessage, s = a.mentions, u = a.messageHasSpoiler, c = a.selectable;
		return [
			n ? null : [[o("WAWebCodeFormatMutator").Code, { selectable: c }]],
			s ? [[r("WAWebTextMentionFormatMutator"), {
				mentions: s,
				selectable: c,
				lastMessage: !0,
				isDraftMessage: l
			}]] : null,
			i ? [[o("WAWebGroupMentionFormatMutator").GroupMention, {
				groupMentions: i,
				selectable: c,
				clickable: !1,
				lastMessage: !0,
	...
	function y(e) {
		var t = e.groupMentions, n = e.mentions, a = e.selectable;
		return [
	...
	function C(t) {
		var n = t.groupMentions, a = t.mentions, i = t.messageHasSpoiler, l = t.selectable;
		return [
			...
			[[o("WAWebBulletedListItemFormatMutator").BulletedListItem, { selectable: l }]],
			[[o("WAWebBulletedListItemFormatMutator").HyphenListItem, { selectable: l }]],
			[[r("WAWebBulletedListFormatMutator"), {
				selectable: l,
				quoted: !0
			}]],
			[[o("WAWebNumberedListItemFormatMutator").NumberedListItem, { selectable: l }]],
	...
	function b(e) {
		...
		return [
			[[o("WAWebCodeFormatMutator").Code, { selectable: a }]],
			[[r("WAWebRawMentionMutator"), {
				mentions: n,
				selectable: a
			}]],
			[[o("WAWebRawGroupMentionFormatMutator").RawGroupMention, { groupMentions: t }]],
			[
				[r("WAWebBoldFormatMutator"), { selectable: a }],
				[r("WAWebItalicFormatMutator"), { selectable: a }],
				[r("WAWebStrikethroughFormatMutator"), { selectable: a }]
	...
	function v(e) {
		var t = e.groupMentions, n = e.groupMetadata, a = e.mentions, i = e.selectable;
		return [
			[[o("WAWebCodeFormatMutator").Code, { selectable: i }]],
	...
	function S(e) {
		var t, a = e.links, i = !!e.expandedFormattingEnabled, l = !!((t = e.bulletPointsEnabled) != null ? t : i), s = !0;
		return [
			[[o("WAWebCodeFormatMutator").Code, { selectable: s }]],
			i ? [[r("WAWebInlineCodeFormatMutator"), { selectable: s }]] : null,
			l ? [[o("WAWebBulletedListItemFormatMutator").BulletedListItem, { selectable: s }]] : null,
			l ? [[o("WAWebBulletedListItemFormatMutator").HyphenListItem, { selectable: s }]] : null,
			l ? [[r("WAWebBulletedListFormatMutator"), { selectable: s }]] : null,
			i ? [[o("WAWebNumberedListItemFormatMutator").NumberedListItem, { selectable: s }]] : null,
			...
			[[r("WAWebEmojiFormatMutator"), { selectable: s }]],
			i ? [[o("WAWebBlockQuoteFormatMutator").BlockQuote, { selectable: s }]] : null
		].filter(Boolean);
	}
	function R(e) {
		var t, a = !!(e != null && e.expandedFormattingEnabled), i = !!((t = e == null ? void 0 : e.bulletPointsEnabled) != null ? t : a), l = !0;
		return [
			[[o("WAWebCodeFormatMutator").Code, { selectable: l }]],
			a ? [[r("WAWebInlineCodeFormatMutator"), { selectable: l }]] : null,
			i ? [[o("WAWebBulletedListItemFormatMutator").BulletedListItem, { selectable: l }]] : null,
			i ? [[o("WAWebBulletedListItemFormatMutator").HyphenListItem, { selectable: l }]] : null,
			i ? [[r("WAWebBulletedListFormatMutator"), { selectable: l }]] : null,
			a ? [[o("WAWebNumberedListItemFormatMutator").NumberedListItem, { selectable: l }]] : null,
			...
			[[r("WAWebEmojiFormatMutator"), { selectable: l }]],
			a ? [[o("WAWebBlockQuoteFormatMutator").BlockQuote, { selectable: l }]] : null
		].filter(Boolean);
	}
	function L(e) {
		var t = e === void 0 ? {} : e, n = t.links, o = t.selectable, a = t.trusted;
		return [a === !0 ? [[r("WAWebLinkFormatMutator"), {
			links: n,
			selectable: o
		}]] : null, [[r("WAWebEmojiFormatMutator"), { selectable: o }]]].filter(Boolean);
	}
	function E(t) {
		t === void 0 && (t = {});
		var n = t, a = n.groupMentions, i = n.isDraftMessage, l = n.mentions, s = n.messageHasSpoiler, u = n.selectable;
		return [
			...
			l ? [[r("WAWebTextMentionFormatMutator"), {
				mentions: l,
				selectable: u,
				lastMessage: !0,
				isDraftMessage: i
			}]] : null,
			a ? [[o("WAWebGroupMentionFormatMutator").GroupMention, {
				groupMentions: a,
				selectable: u,
				clickable: !1,
				lastMessage: !0,
	...
	function k(e) {
		var t = e.selectable, n = e.parseHeadings, a = n === void 0 ? !0 : n, i = e.parseHeadlessHeadings, l = i === void 0 ? !1 : i, s = e.parseLists, u = s === void 0 ? !0 : s, c = e.parseQuotes, d = c === void 0 ? !0 : c, m = e.parseInlineCode, p = m === void 0 ? !0 : m, _ = e.showLinks, f = _ === void 0 ? !0 : _, g = e.links, h = e.onLinkClick, y = h === void 0 ? r("WAWebNoop") : h;
		return [
			...
			d ? [[o("WAWebBlockQuoteFormatMutator").BlockQuote, { selectable: t }]] : null,
			u ? [[o("WAWebBulletedListItemFormatMutator").BulletedListItem, { selectable: t }]] : null,
			u ? [[o("WAWebBulletedListItemFormatMutator").HyphenListItem, { selectable: t }]] : null,
			u ? [[r("WAWebBulletedListFormatMutator"), { selectable: t }]] : null,
			u ? [[o("WAWebNumberedListItemFormatMutator").NumberedListItem, { selectable: t }]] : null,
			u ? [[r("WAWebNumberedListFormatMutator"), { selectable: t }]] : null,
			f ? [[r("WAWebLinkFormatMutator"), {
				links: g,
				selectable: t,
				onLinkClick: y
			}]] : null,
			a ? [[o("WAWebHeadingFormatMutator").AIRichResponseHeading, { selectable: t }]] : null,
			l ? [[o("WAWebHeadingFormatMutator").HeadlessHeading, { selectable: t }]] : null
		].filter(Boolean);
	}
	l.spoilerMutatorEntry = e, l.EmojiOnly = s, l.LargeEmojiOnly = u, l.StatusText = c, l.StatusCaption = d, l.Compatibility = m, l.Search = p, l.SearchName = _, l.LastMessage = f, l.FTSMessage = g, l.QuickReply = h, l.Unformat = y, l.QuotedMention = C, l.FormattedNotification = b, l.FormattedGroupNotification = v, l.TrustedGroupDesc = S, l.UntrustedGroupDesc = R, l.HeaderAndFooter = L, l.InlineMessage = E, l.RichResponse = k;
}), 98);
