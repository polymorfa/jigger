__d("WAWebFormatGroupNotification", [
	"fbt",
	"WALogger",
	"WAWebChatGroupUtils",
	...
	function u(t, n) {
		var a = "", i = t.get("type");
		if (i !== "gp2") return a;
		var l = t.get("subtype"), u = o("WAWebMsgModelUtils").getMsgDisplayName(t), c = t.get("author"), d = t.get("body"), m, p, _ = !!n, f = t.recipients || [], g = o("WAWebFormatParticipantNames").getFormattedNames(f, !1), h = f[0], y = h ? o("WAWebContactCollection").ContactCollection.get(h) : void 0, C;
		switch (y ? C = o("WAWebFrontendContactGetters").getFormattedName(y) : h ? C = o("WAWebWidFormat").widToFormattedUser(h) : C = "", l) {
			case "add":
			...
			case "subject":
				...
				break;
			case "modify": {
				var b = o("WAWebContactCollection").ContactCollection.get(c), v = b != null && o("WAWebFrontendContactGetters").getIsUsernameContact(b);
				if (v) {
					a = s._(
						/*BTDS*/
						"",
				...
				m = o("WAWebWidFormat").widToFormattedUser(c), p = o("WAWebWidFormat").widToFormattedUser(h), a = m === u ? s._(
					/*BTDS*/
					"",
					[s._param("name", u), s._param("new_number", p)]
				) : s._(
					/*BTDS*/
					"",
					[s._param("name", u)]
			...
			case "create":
				...
				break;
			case "delete":
				a = o("WAWebFormatDeleteNotification").formatDeleteNotification({ chat: o("WAWebFrontendMsgGetters").getChat(t) });
				break;
			case "promote":
			case "demote":
			case "linked_group_promote":
			case "linked_group_demote":
				a = o("WAWebFormatPromoteDemoteNotification").formatPromoteDemoteNotification({
					subtype: l,
					subject: h,
					subjectClickable: C,
					participantsClickable: g,
				...
				break;
			case "invite":
				a = o("WAWebUserPrefsMeUser").isMeAccount(h) ? s._(
					/*BTDS*/
					""
				) : s._(
					/*BTDS*/
				...
				break;
			case "revoke_invite":
				a = o("WAWebUserPrefsMeUser").isMeAccount(c) ? s._(
					/*BTDS*/
					""
				) : s._(
					/*BTDS*/
				...
				break;
			case "description":
				a = o("WAWebFormatDescriptionNotification").formatDescriptionNotification({
					author: c,
					authorClickable: u,
			...
			case "no_frequently_forwarded":
				d === "on" ? a = o("WAWebUserPrefsMeUser").isMeAccount(c) ? s._(
					/*BTDS*/
					""
				) : s._(
					/*BTDS*/
			...
			case "v4_add_invite_join":
				...
				break;
			case "ephemeral": return o("WAWebFormatEphemeralSetting").formatEphemeralSetting(t);
			case "growth_locked":
				a = s._(
					/*BTDS*/
					""
			...
			case "subgroup_admin_triggered_invite_auto_add":
				a = o("WAWebMessageCommunityWelcomeMemberTitle.react").communityWelcomeMemberTitle();
				break;
			case "sub_group_participant_add_rich":
			case "sub_group_invite_rich":
				a = o("WAWebMessageCommunitySubgroupWelcomeTitle.react").communitySubgroupWelcomeTitle({
					templateParams: t.templateParams,
					clickable: !1,
					author: c
				});
			...
			case "community_link_parent_group_rich":
				a = o("WAWebMessageCommunityLinkGroupTitle.react").communityLinkGroupTitle({
					templateParams: t.templateParams,
					clickable: !1,
					author: c
				});
			...
			case "community_create":
				a = o("WAWebMessageCommunityWelcomeAdminTitle.react").communityWelcomeAdminTitle({
					templateParams: t.templateParams,
					author: c,
					chat: o("WAWebFrontendMsgGetters").getChat(t)
				});
			...
			case "created_membership_requests":
				a = o("WAWebFormatMembershipApprovalNotification").formatMembershipApprovalNotification(l, c, t.templateParams);
				break;
			...
			case "default_sub_group_demote":
				o("WAWebChatGroupUtils").isCommunityAnnouncementGroup(o("WAWebFrontendMsgGetters").getChat(t)) ? a = s._(
					/*BTDS*/
					""
				) : a = s._(
					/*BTDS*/
			...
			case "allow_admin_reports":
				a = o("WAWebFormatReportToAdminNotification").formatReportToAdminNotification(c, t.templateParams);
				break;
			case "allow_non_admin_sub_group_creation":
				a = r("WAWebFormatAllowNonAdminSubGroupCreationNotification")(o("WAWebFrontendMsgGetters").getChat(t), t.templateParams);
				break;
			case "empty_subgroup_create": {
				var R = t.templateParams[2];
				a = o("WAWebMessageCommunityEmptySubgroupWelcomeTitle.react").communityEmptySubgroupWelcomeTitle(R);
				break;
			}
			case "created_subgroup_suggestion": {
				a = r("WAWebFormatCreatedSubgroupSuggestionNotification")(c, t.templateParams, !1);
				break;
			}
			case "general_chat_add": {
				var L = t.templateParams[1];
				a = o("WAWebMessageCommunityGeneralChatWelcomeTitle.react").communityGeneralChatWelcomeTitle(L);
				break;
			}
			case "general_group_auto_add_disabled": {
				var E, k;
				a = o("WAWebMessageCommunityGeneralChatAutoAddDisabledNotification.react").communityGeneralChatAutoAddDisabledNotification((E = (k = o("WAWebFrontendMsgGetters").getChat(t)) == null ? void 0 : k.formattedTitle) != null ? E : "", t.templateParams);
				break;
			}
			case "community_owner_update": {
				a = o("WAWebFormatCommunityOwnerUpdateNotification").formatCommunityOwnerUpdateNotification({
					author: c,
					templateParams: t.templateParams,
					clickable: !1
				});
			...
			default:
				o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["wa:formatGroupNotification:unknown message subtype: ", ""])), l);
				break;
		}
		return r("WAWebL10N").isRTL() && (a = r("WAWebL10N").forceRTL(String(a))), a;
	}
	l.default = u;
}), 226);
