__d("WAWebFormatParse", [
	...
	function s(e, t, n) {
		n === void 0 && (n = 1 / 0);
		var a = r("WAWebFormatMatch")(e, t, n), i = a.length ? r("WAWebFormatParseTree")(e, r("WAWebFormatFilter")(a, t), t) : { children: [{
			type: "text",
			value: e
		...
		if (!(t.limit <= 0)) {
			if (e.type && e.type === "text") {
				if (e.value.length >= t.limit) {
					...
					n.length >= t.limit && (n = n.slice(0, t.limit)), e.value = n.join(""), t.limit -= n.length;
				} else t.limit -= e.value.length;
				return;
			} else if (e.type && e.type === "delimiter") return;
			for (var r = 0; r < e.children.length && (u(e.children[r], t), !(t.limit <= 0));) r++;
