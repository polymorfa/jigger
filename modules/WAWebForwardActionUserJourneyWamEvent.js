__d("WAWebForwardActionUserJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ForwardActionUserJourney: [
		6506,
		{
			appSessionId: [1, e.TYPES.STRING],
			forwardActionUserJourneyAction: [2, o("WAWebWamEnumForwardActionUserJourneyAction").FORWARD_ACTION_USER_JOURNEY_ACTION],
			...
			userJourneyChatType: [7, o("WAWebWamEnumUserJourneyChatType").USER_JOURNEY_CHAT_TYPE],
