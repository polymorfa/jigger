__d("WAWebForwardMessageModal.react", [
	...
	function v(e) {
		var t = o("react-compiler-runtime").c(36), n = e.handleAppendMessage, a = e.handleRemoveCaption, i = e.includeCaption, l = e.isOnlyMetaAiSelected, s = e.mediaMsgsWithCaption, u = e.msgs, c = e.onEditClick, d = e.showEditIcon, m = u.length === 1 && (o("WAWebMsgGetters").getIsMedia(u[0]) ? r("isStringNullOrEmpty")(u[0].caption) : o("WAWebFileUtils").isDocument(u[0]) && o("WAWebForwardDocCaptionGating").isForwardDocCaptionEnabled() && (r("isStringNullOrEmpty")(u[0].caption) || u[0].caption === u[0].filename)), _ = o("WAWebBotForwardCapability").canForwardMsgToMetaAi(u), f;
		t[0] !== l ? (f = l ? S() : void 0, t[0] = l, t[1] = f) : f = t[1];
		var g = f;
		if (u.length === 0) return null;
		var h = u[0], y = o("WAWebFrontendMsgGetters").getMaybeChat(h);
		if (y != null && o("WAWebChatGetters").getIsNewsletter(y)) return null;
		if (s.length > 0) {
			var C;
			t[2] === Symbol.for("react.memo_cache_sentinel") ? (C = { className: "x11uqc5h xv32h1t xh8yej3 x1od0jb8 x9f619 xpx74rz" }, t[2] = C) : C = t[2];
			var b;
			t[3] !== n || t[4] !== a || t[5] !== i || t[6] !== s || t[7] !== u || t[8] !== c || t[9] !== d ? (b = p.jsx(r("WAWebForwardWithCaptionPreview.react"), {
				msgs: s,
				...
				onEditClick: c,
				showEditIcon: d
			}), t[3] = n, t[4] = a, t[5] = i, t[6] = s, t[7] = u, t[8] = c, t[9] = d, t[10] = b) : b = t[10];
			var v;
			return t[11] !== C || t[12] !== b ? (v = p.jsx("div", babelHelpers.extends({}, C, { children: b })), t[11] = C, t[12] = b, t[13] = v) : v = t[13], v;
		}
		if (m) {
			var R;
			t[14] === Symbol.for("react.memo_cache_sentinel") ? (R = { className: "x11uqc5h xv32h1t xh8yej3 x1od0jb8 x9f619 xpx74rz" }, t[14] = R) : R = t[14];
			var L;
			t[15] !== g || t[16] !== n || t[17] !== a || t[18] !== i || t[19] !== u || t[20] !== c || t[21] !== d ? (L = p.jsx(r("WAWebForwardWithCaptionPreview.react"), {
				msgs: u,
				displayCaptionText: i,
				onRemoveCaptionSelect: a,
				onAppendMessage: n,
				captionPlaceholderText: g,
				onEditClick: c,
				showEditIcon: d
			}), t[15] = g, t[16] = n, t[17] = a, t[18] = i, t[19] = u, t[20] = c, t[21] = d, t[22] = L) : L = t[22];
			var E;
			return t[23] !== R || t[24] !== L ? (E = p.jsx("div", babelHelpers.extends({}, R, { children: L })), t[23] = R, t[24] = L, t[25] = E) : E = t[25], E;
		}
		if (_) {
			var k;
			t[26] === Symbol.for("react.memo_cache_sentinel") ? (k = { className: "x11uqc5h xjp8j0k xh8yej3 x1od0jb8 x9f619 xpx74rz" }, t[26] = k) : k = t[26];
			var I;
			t[27] !== g || t[28] !== n || t[29] !== a || t[30] !== i || t[31] !== u ? (I = p.jsx(r("WAWebForwardWithCaptionPreview.react"), {
				msgs: u,
				displayCaptionText: i,
				onRemoveCaptionSelect: a,
				onAppendMessage: n,
				captionPlaceholderText: g
			}), t[27] = g, t[28] = n, t[29] = a, t[30] = i, t[31] = u, t[32] = I) : I = t[32];
			var T;
			return t[33] !== k || t[34] !== I ? (T = p.jsx("div", babelHelpers.extends({}, k, { children: I })), t[33] = k, t[34] = I, t[35] = T) : T = t[35], T;
		}
		return null;
	}
	function S() {
