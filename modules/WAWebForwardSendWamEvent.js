__d("WAWebForwardSendWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ForwardSend: [
		1728,
		{
			disappearingChatInitiator: [21, o("WAWebWamEnumDisappearingChatInitiatorType").DISAPPEARING_CHAT_INITIATOR_TYPE],
			e2eCiphertextType: [12, o("WAWebWamEnumE2eCiphertextType").E2E_CIPHERTEXT_TYPE],
			e2eCiphertextVersion: [11, e.TYPES.INTEGER],
			ephemeralityDuration: [18, e.TYPES.INTEGER],
			ephemeralityInitiator: [24, o("WAWebWamEnumEphemeralityInitiatorType").EPHEMERALITY_INITIATOR_TYPE],
			ephemeralityTriggerAction: [25, o("WAWebWamEnumEphemeralityTriggerActionType").EPHEMERALITY_TRIGGER_ACTION_TYPE],
			fastForwardEnabled: [5, e.TYPES.BOOLEAN],
			forwardOrigin: [28, o("WAWebWamEnumForwardOrigin").FORWARD_ORIGIN],
			forwardPickerOrigin: [27, o("WAWebWamEnumForwardPickerOrigin").FORWARD_PICKER_ORIGIN],
			isForwardedForward: [22, e.TYPES.BOOLEAN],
			isFrequentlyForwarded: [14, e.TYPES.BOOLEAN],
			mediaCaptionPresent: [10, e.TYPES.BOOLEAN],
			messageBizType: [26, o("WAWebWamEnumMessageBizType").MESSAGE_BIZ_TYPE],
			...
			typeOfGroup: [23, o("WAWebWamEnumTypeOfGroupEnum").TYPE_OF_GROUP_ENUM],
