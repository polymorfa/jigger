__d("WAWebFtsManifestReader", [
	...
	var e, s = (function(t) {
		...
		var i = a.prototype;
		return i.$WaWcManifestReader$p_1 = function(t) {
			if (t != null) {
				var e = t.isFullIndexingComplete, n = t.key, r = t.lastMsgKeyViaFullIndexer, a = t.schemaVersion, i = t.tokenizerVersion;
				return {
					tokenizerVersion: i,
					schemaVersion: a,
					isCurrent: n === o("WAWebSchemaManifest").ManifestKeys.CURR_VERSION,
			...
			return this.$WaWcManifestReader$p_2(o("WAWebSchemaManifest").ManifestKeys.PREV_VERSION);
		}, i.$WaWcManifestReader$p_4 = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = yield this.$WaWcManifestReader$p_2(o("WAWebSchemaManifest").ManifestKeys.CURR_VERSION);
			...
			return this.$WaWcManifestReader$p_2(o("WAWebSchemaManifest").ManifestKeys.NEXT_VERSION);
		}, i.versions = function() {
			var t = this;
