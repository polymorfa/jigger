__d("WAWebFtsSQLiteClient", [
	...
	var d = (function() {
		...
		return n.initialize = function() {
			...
			var e, n = o("WAWebWindowsHybridBridgeFactory").getWindowsBridge(r("WAWebWindowsHybridBridgeInitiator").WAWebFtsSQLiteClient), a = n == null ? void 0 : n.sqlite;
			return a != null && (r("WAWebODS").incr("web.hybrid.bridge.fts_sqlite.send.execute_sqlite"), e = await c(o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
				bridge: "fts-sqlite",
			...
			return t.length === 0 ? {
				...
				status: 200,
				messages: []
			} : (await this.$7([["DELETE FROM message WHERE id IN (" + t.map(function(e) {
				return "?";
			}).join(",") + ")"].concat(t)]), {
				eof: !0,
				status: 200,
			...
			var e = t.chatId, n = t.endRowId, r = t.startRowId;
			return await this.$7([[
			...
			return await this.destroyExternalStorage(), this.$9({ operation: "re-init" });
        ...
        END;`]
			...
			var e, a = Array.from(this.$1.tokenize(t)).filter(r("WAFtsIsSearchQueryEligibleForMessageSearch"));
			...
			var i = [a.map(function(e) {
				var t = e.replaceAll("\"", "\"\"");
				return "\"" + t + "\"*";
			}).join(" AND ")], l = ["message_fts MATCH ?"], s = n == null ? void 0 : n.remote;
			s != null && s && (l.push("AND chatId = ?"), i.push(s));
			var u = n == null ? void 0 : n.limit, c = n == null ? void 0 : n.page, d = null, m = `SELECT t.rowid, t.id, t.chatId, t.timestamp, t.text, rank
      FROM message t JOIN message_fts f ON t.rowid = f.rowid
      WHERE ` + l.join(" ") + `
      ORDER BY rank`;
			if (o("WAWebABProps").getABPropConfigValue("web_anr_async_sqlite_bridge_operations") && typeof u == "number" && u > 0) {
				d = u;
				var p = typeof c == "number" && c > 0 ? c : 1, _ = (p - 1) * d;
				m += `
      LIMIT ? OFFSET ?`, i.push(String(d), String(_));
			}
			var f = await this.$7([[m].concat(i)]);
			if (f == null || f.length !== 1) return Promise.resolve({
				canceled: !1,
				eof: !0,
				status: 404,
				messages: []
			...
			if (Array.isArray(t) || typeof t == "boolean") return {
				canceled: !1,
				eof: !0,
				status: 404,
				messages: []
			};
			var e = await o("WAWebFtsClientMessageIdResolver").resolveMsgIds(t.messages), n = e.resolved, r = e.unresolved, a = t.eof, i = t.status;
