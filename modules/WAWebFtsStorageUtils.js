__d("WAWebFtsStorageUtils", [
	...
	function m() {
		return u == null ? (e || (e = n("Promise"))).reject(r("err")("[fts-storage] Storage should be created first before being destroyed")) : u.purge().then(function() {
			u = null;
		}).catch(function(e) {
			throw u = null, e;
		});
