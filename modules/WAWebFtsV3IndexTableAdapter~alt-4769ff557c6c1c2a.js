__d("WAWebFtsV3IndexTableAdapter", ["WAWebDbEncryptionKey", "WAWebFtsStorage"], (function(t, n, r, o, a, i, l) {
	var e = (function() {
		function e() {}
		var t = e.prototype;
		return t.bulkPut = async function(t) {
			...
			return n.length === 1 ? o("WAWebFtsStorage").getIndexV3Table().equals(t, n[0]) : o("WAWebFtsStorage").getIndexV3Table().anyOf(t, n);
		}, t.between = function(t, n, r, a) {
			return o("WAWebFtsStorage").getIndexV3Table().between(t, n, r, {
