__d("WAWebFtsV3MessageSource", [
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			}), s = yield i.bulkGet(l), u = 0; u < n.length; u++) {
				var c = s[u];
				if (c != null) {
					var d = n[u].user;
					if (d != null) {
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			...
			var x = yield o("WAWebSchemaMessage").getMessageTable().postflightDecryptSingleRecord(t), $ = r("nullthrows")(r("WAWebParseMsgKeyString")(x.id)), P = $.remote;
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			for (var n = [], r = 0; r < e.length; r++) {
				var a = yield g(e[r], t);
				n.push(a), yield o("WAAsyncSleep").asyncSleepAfterGivenLoopIteration(r, 100);
			}
			return n;
	...
	var b = (function() {
		...
		return t.getBacklogged = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAWebSchemaFtsIndexingQueue").getFtsIndexingQueueTable().all({
				...
				var n = t.map(function(e) {
					return +e.id;
				}), r = new Set(n), a = yield o("WAWebSchemaMessage").getMessageTable().anyOf(["rowId"], n, { shouldDecrypt: !1 }), i = yield y(a, this.$1), l = yield m(i);
				return l.forEach(function(e) {
					var t = e.id;
					return r.delete(+t);
				}), yield this.removeFromBacklog(Array.from(r.values(), function(e) {
					return "" + e;
				})), l;
			});
			function t(t) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = yield o("WAWebSchemaFtsIndexingQueue").getFtsIndexingQueueTable().count();
				return e > 0;
			});
			function t() {
				return e.apply(this, arguments);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				yield o("WAWebSchemaFtsIndexingQueue").getFtsIndexingQueueTable().bulkRemove(e);
			});
			function t(t) {
				return e.apply(this, arguments);
			}
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = !1, r = yield o("WAWebSchemaMessage").getMessageTable().greaterThan(["rowId"], +e, {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = !1, n = yield o("WAWebSchemaMessage").getMessageTable().all({
					limit: e == null ? void 0 : e.limit,
					offset: e == null ? void 0 : e.offset,
					shouldDecrypt: t
				});
