__d("WAWebFtsWorkerAdapter", [
	...
	var e = null, s = (function() {
		...
		return t.initialize = function(t, n) {
			this.worker = o("WorkerBundleResource").createDedicatedWebWorker(r("WAWebFtsWorkerResource")), r("nullthrows")(this.worker).onmessage = function(e) {
				t(e.data.message);
			}, r("nullthrows")(this.worker).onerror = n, r("WAWebBrokerMainConnect")(this);
