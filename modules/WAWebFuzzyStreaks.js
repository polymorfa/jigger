__d("WAWebFuzzyStreaks", [], (function(t, n, r, o, a, i) {
	"use strict";
	function e(e, t, n) {
		n === void 0 && (n = 0);
	...
	function l(t, n, r) {
		...
		var o = [], a = 0, i = t, l = 0, s, u = !1;
		do
			if (s = e(i, n, a), s != null) l += s.score, o.push(babelHelpers.extends({}, s)), a = s.index + s.length, i = i.substr(s.length);
			else {
