__d("WAWebGalaxyFlowMediaPicker.react", [
	...
	function y(e) {
		var t = e.mediaPayload, n = r("useWAWebUIM")(), a = p(), i = m(function() {
			var e;
			return [
				g(t),
				new Set([h(t)]),
				(e = t.maxItems) != null ? e : _
			];
		}, [t]), l = i[0], u = i[1], y = i[2], C = p(null), b = r("useWAWebUnmountSignal")(), v = m(function() {
			return t.inputType !== o("WAFlowsNativeMediaEventTypes").WAFlowsMediaInputType.CAMERA;
		}, [t.inputType]), S = c(function(e) {
			var n = e.attachments, a = new (r("WAWebAttachMediaCollection"))({ chatParticipantCount: 1 }), i = function() {
			...
			R(), n.length && S({ attachments: n.map(function(e) {
				return { file: e };
			}) });
		}, [R, S]), E = c(function() {
			...
			C.current = n, r("WAPromiseRaceAbort")(t, b).then(function(e) {
				if (e) {
					var t = s.jsx("div", {
		...
		}, [t.inputType, E]), s.jsx(r("WAWebFilePicker.react"), {
			ref: a,
			mimes: l,
			onChange: L,
			multiple: !0
