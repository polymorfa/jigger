__d("WAWebGalaxyFlowMediaView.react", [
	...
	function _(t) {
		var a = t.allowMultipleMedia, i = t.maxFileSizeBytes, l = t.maxItems, c = t.mediaCollection, _ = t.mediaMimeTypes, g = t.mediaPayload.collectionId, h = t.onRender, y = t.suportedMediaTypes, C = m(function(t) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (C(e)) return n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					g != null && o("WAWebUiIdleEventBus").UiIdleEventBus.once("ui_idle", function() {
						var t = [];
						e.forEach(function(e) {
							var n = e.media, r = {};
							r.type = n.type, r.caption = n.caption, r.isMediaCryptoExpectedForChat = !0, r.addEvenWhilePreparing = n.previewable && n.state === o("WAWebAttachMediaModel").ATTACH_MEDIA_STATE.PROCESSING, t.length < 3 && t.push(n.type), o("WAWebGalaxyFlowAttachMediaUtils").sendGalaxyMediaMsg(g, n, r, i);
