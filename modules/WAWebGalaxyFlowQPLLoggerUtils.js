__d("WAWebGalaxyFlowQPLLoggerUtils", [
	"$InternalEnum",
	"WAWebABProps",
	...
	"use strict";
	var e, s = r("qpl")._(200750681, "3410"), u = r("qpl")._(200743350, "3411"), c = (e = n("$InternalEnum"))({
		...
		EXTENSIONS_METADATA_GRAPHQL_RESPONSE_ERROR: "extensions-metadata-graphql-response-error"
	...
	function y(e, t) {
		...
		return {
			string: {
				...
				biz_jid: o("WAWebGalaxyFlowWamLoggerUtils").getFlowBusinessPhoneNumber(e),
				extension_message_id: e.galaxyFlowQPLMessageId
			},
			bool: {
				is_debug_build: !r("gkx")("26258"),
				is_response_flow: !!t.isResponseFlow,
				data_channel_navigation: !o("WAWebGalaxyFlowsUtils").isFlowInitWithoutDataChannel((n = t == null ? void 0 : t.flowAction) != null ? n : "")
			}
		};
	}
	var C = e({
		...
		EXTENSIONS_METADATA_EMPTY_RESPONSE: "extensions-metadata-empty-response",
		EXTENSIONS_METADATA_RESPONSE_ERROR: "extensions-metadata-response-error",
		...
		EXTENSIONS_PUBLIC_KEY_SIGNATURE_VERIFICATION_EXCEPTION: "extensions-public-key-signature-verification-exception",
		EXTENSIONS_PUBLIC_KEY_MISSING_IDENTITY_KEY_ERROR: "extensions-public-key-missing-identity-key-error",
		EXTENSIONS_METADATA_GRAPHQL_RESPONSE_ERROR: "extensions-metadata-graphql-response-error"
	}), v = e({ EXTENSION_METADATA_PERF_TRACKER: "extensionMetadataPerfTracker" }), S = e({
	...
	function D(e) {
		var t = JSON.stringify(e), n = new TextEncoder().encode(t != null ? t : "").length;
	...
	function x(e) {
		...
		for (var n in e) {
			...
			if (typeof r == "string") {
				var o;
				t.string = babelHelpers.extends({}, t.string, (o = {}, o[n] = r, o));
	...
	l.WaeScreenNavigationQPLPoints = c, l.WaeScreenNavigationQPLErrorTypes = d, l.qplWaeScreenNavigationStart = p, l.qplWaeScreenNavigationPoint = _, l.qplWaeScreenNavigationAnnotate = f, l.qplWaeScreenNavigationEnd = g, l.qplWaeScreenNavigationDrop = h, l.getWaeScreenNavigationAnnotations = y, l.WaeMetadataQPLPoints = C, l.WaeMetadataQPLErrorTypes = b, l.qplWaeMetadataStart = L, l.qplWaeMetadataPoint = E, l.qplWaeMetadataAnnotate = k, l.qplWaeMetadataEnd = I, l.qplWaeMetadataDrop = T, l.qplAnnotateMetadataSize = D, l.qplBuildAnnotations = x, l.getWaeMetadataAnnotations = $, l.isGalaxyFlowSanctioned = P, l.clearAllActiveWaeQPLMarkerInstances = N;
}), 98);
