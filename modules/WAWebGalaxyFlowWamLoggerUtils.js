__d("WAWebGalaxyFlowWamLoggerUtils", [
		...
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			yield (s || (s = n("Promise"))).all(t.map((function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
					u(t) && (yield m(t).catch(function(t) {
	...
	l.getFlowBusinessPhoneNumber = g, l.getFlowsMaybeBizPlatform = h, l.logStructuredMessageReceivedWAMEvent = y, l.logStructuredMessageInteractionWAMEvent = b, l.logExtensionScreenProgressWAMEvent = v, l.logFlowsScreenActionWAMEvent = S;
}), 98);
