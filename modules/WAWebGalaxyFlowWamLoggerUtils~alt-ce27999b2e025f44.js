__d("WAWebGalaxyFlowWamLoggerUtils", [
	...
	var e;
	function s(e) {
		return o("WAWebABProps").getABPropConfigValue("flows_wa_web") && e.type === o("WAWebMsgType").MSG_TYPE.INTERACTIVE && e.interactiveType === r("WAWebInteractiveMessageType").NATIVE_FLOW && e.nativeFlowName === r("WAWebInteractiveMessagesNativeFlowName").CTA_FLOW;
	}
	function u(e) {
		var t, n, r;
		return ((t = e.from) == null ? void 0 : t.isGroup()) === !0 ? "group" : ((n = e.broadcastId) == null ? void 0 : n.isBroadcast()) === !0 ? "broadcast" : ((r = e.from) == null ? void 0 : r.isNewsletter()) === !0 ? "newsletter" : "individual";
	}
	function c(e) {
		var t;
	...
	async function d(e) {
		var t = new (o("WAWebStructuredMessageReceiveWamEvent")).StructuredMessageReceiveWamEvent({
		...
		t.commit(), o("WAWebABProps").getABPropConfigValue("payments_br_p2m_buyer_logging_phase_2") && new (o("WAWebStructuredMessageBuyerReceiveWamEvent")).StructuredMessageBuyerReceiveWamEvent({
			messageClass: o("WAWebWamEnumStructuredMessageClass").STRUCTURED_MESSAGE_CLASS.BUTTON_NFM,
			messageMediaType: o("WAWebWamMsgUtils").getWamMediaType(e),
	...
	function m(e) {
		var t, n = [];
		return e.type === o("WAWebMsgType").MSG_TYPE.INTERACTIVE && e.interactiveType === r("WAWebInteractiveMessageType").NATIVE_FLOW && e.nativeFlowName === r("WAWebInteractiveMessagesNativeFlowName").CTA_FLOW && ((t = e.interactivePayload) == null ? void 0 : t.buttons) != null && e.interactivePayload.buttons.forEach(function(t, r) {
			var a, i = o("WAWebGetGalaxyFlowCtaButton").getGalaxyFlowCtaButton((a = t.buttonParamsJson) != null ? a : "", r, e.t);
			i != null && n.push(i);
		}), n.length === 0 ? null : n[0];
	}
	function p(e) {
		...
		return JSON.stringify({
			...
			is_flow_message_with_payload: o("WAWebGalaxyFlowsUtils").isFlowInitWithoutDataChannel((n = l == null || (a = l.data) == null ? void 0 : a.flowAction) != null ? n : ""),
			is_template: e.templateId != null ? 1 : 0,
	...
	function _(e) {
		try {
			...
			if ((t = e.from) != null && t.isLid()) {
				var a, i;
				return (a = (i = o("WAWebApiContact").getPhoneNumber(o("WAWebWidFactory").asUserLidOrThrow(e.from))) == null ? void 0 : i.user) != null ? a : "";
			}
	...
	function f(e) {
		var t;
		if (e.contact.id == null) return o("WAWebWamEnumBizPlatform").BIZ_PLATFORM.UNKNOWN;
		var n = e.contact;
		return n == null || !n.isBusiness ? o("WAWebWamEnumBizPlatform").BIZ_PLATFORM.UNKNOWN : ((t = e.contact) == null || (t = t.privacyMode) == null ? void 0 : t.hostStorage) === o("WAWebHandleMsgTypes.flow").HostStorageEnumType.Facebook ? o("WAWebWamEnumBizPlatform").BIZ_PLATFORM.CLOUDAPI : n.isEnterprise ? o("WAWebWamEnumBizPlatform").BIZ_PLATFORM.ENT : o("WAWebWamEnumBizPlatform").BIZ_PLATFORM.SMB;
	}
	async function g(t) {
		await Promise.all(t.map(async function(t) {
			s(t) && await d(t).catch(function(t) {
				o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[WAM:GALAXY_FLOW] structured msg receive log err: ", ""])), String(t));
			});
		}));
	}
	function h(e, t, n, a, i) {
		var l;
		new (o("WAWebExtensionsStructuredMessageInteractionWamEvent")).ExtensionsStructuredMessageInteractionWamEvent({
			bizPlatform: f(t),
			...
			messageClassAttributes: JSON.stringify(babelHelpers.extends({
				cta: r("WAWebInteractiveMessagesNativeFlowName").CTA_FLOW,
				...
				data_channel_navigation: !o("WAWebGalaxyFlowsUtils").isFlowInitWithoutDataChannel((l = e == null ? void 0 : e.flowAction) != null ? l : "")
			}, i != null ? { error_type: i } : {}))
		}).commit();
	}
	function y(e, t, n) {
		var r;
		new (o("WAWebExtensionScreenProgressWamEvent")).ExtensionScreenProgressWamEvent({
			bizPlatform: f(t),
			...
			extensionsMessageId: n.galaxyFlowWAMMessageId != null ? n.galaxyFlowWAMMessageId : "",
	...
	function C(e) {
		var t = e.bizPlatform, n = e.businessOwnerJid, r = e.clickType, a = e.currentFlowId, i = e.flowsMessageId, l = e.flowsSessionId;
	...
	l.getFlowBusinessPhoneNumber = _, l.getFlowsMaybeBizPlatform = f, l.logStructuredMessageReceivedWAMEvent = g, l.logStructuredMessageInteractionWAMEvent = h, l.logExtensionScreenProgressWAMEvent = y, l.logFlowsScreenActionWAMEvent = C;
}), 98);
