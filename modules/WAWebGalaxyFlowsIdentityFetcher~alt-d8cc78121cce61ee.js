__d("WAWebGalaxyFlowsIdentityFetcher", [
	...
	var e = 3e4, s = 3, u = 1e4, c = (function() {
		function t() {
			var t = this;
		...
		var n = t.prototype;
		return n.fetchIdentityFor = async function(t, n) {
			var e, r, a = t.isLid() ? (e = (r = o("WAWebLidMigrationUtils").toPn(t)) == null ? void 0 : r.toString()) != null ? e : "" : t.toString(), i = this.$1.get(a);
			if (i == null) {
