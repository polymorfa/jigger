__d("WAWebGalaxyFlowsNavBarUtils.react", [
	...
	function g(e) {
		var t = e.isResponseFlow, n = e.msg, a = e.onCancel, i = c(null), l = c(null), g = s._(
			/*BTDS*/
			""
		), h = s._(
			/*BTDS*/
		...
		}), C = u.jsxs(u.Fragment, { children: [!t && u.jsx(o("WAWebClickable.react").Clickable, {
			ref: l,
			xstyle: p.contextMenuIconContainer,
			title: g,
			ariaLabel: g,
			...
			children: [u.jsx(o("WAWebActionMenuItem.react").ActionMenuItem, {
				optionId: "help",
				primary: s._(
					/*BTDS*/
					""
	...
	g.displayName = g.name + " [from " + i.id + "]", l.GALAXY_FLOWS_ARTICLE_IDS = d, l.openHelpCenterArticle = _, l.reportGalaxyFlow = f, l.WAWebGalaxyFlowsNavBar = g;
}), 226);
