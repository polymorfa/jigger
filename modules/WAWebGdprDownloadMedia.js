__d("WAWebGdprDownloadMedia", [
	...
	function e(e) {
		var t, n = o("WABase64").encodeB64((t = r("nullthrows"))(e.fileSha256)), a = o("WAWebMediaStorage").getOrCreateMediaObject(n), i = {
		...
		return a.entries.addEntry(i), a.consolidate(babelHelpers.extends({}, i, {
			filehash: n,
			type: o("WAWebMediaTypes").OUTWARD_TYPES.DOCUMENT
		})), o("WAWebMediaMmsV4Download").downloadMedia({
			downloadEvenIfExpensive: !0,
			downloadOrigin: o("WAWebWamEnumDownloadOriginType").DOWNLOAD_ORIGIN_TYPE.GDPR,
			mediaObject: a,
			...
			var e = o("WAWebMediaInMemoryBlobCache").InMemoryMediaBlobCache.get(n);
			if (e) return e;
			var t = a.mediaBlob;
