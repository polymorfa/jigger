__d("WAWebGenerateProductMessageProto", ["WAWebGenerateImageMessageProto"], (function(t, n, r, o, a, i, l) {
	function e(e) {
		var t = e.contextInfo, n = e.json, o = e.mediaMetadata, a;
		o != null && (a = r("WAWebGenerateImageMessageProto")({
			json: n,
			mediaMetadata: o,
			contextInfo: t
		}).imageMessage);
