__d("WAWebGenerateStickerPackMessageProto", ["WAWebE2EProtoUtils"], (function(t, n, r, o, a, i, l) {
	function e(e) {
		var t = e.json, n = e.mediaMetadata, r = n === void 0 ? {} : n;
		return { stickerPackMessage: {
			...
			thumbnailSha256: o("WAWebE2EProtoUtils").encodeBytes(r.thumbnailSha256),
			thumbnailEncSha256: o("WAWebE2EProtoUtils").encodeBytes(r.thumbnailEncSha256),
