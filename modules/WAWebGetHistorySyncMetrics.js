__d("WAWebGetHistorySyncMetrics", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = e.syncType === o("WAWebProtobufsHistorySync.pb").HistorySync$HistorySyncType.INITIAL_BOOTSTRAP ? o("WAWebWamEnumMdBootstrapPayloadType").MD_BOOTSTRAP_PAYLOAD_TYPE.CRITICAL : o("WAWebWamEnumMdBootstrapPayloadType").MD_BOOTSTRAP_PAYLOAD_TYPE.NON_CRITICAL, r = o("WAWebGetMetricHistorySyncPayloadType").getMetricHistorySyncPayloadType(e.syncType), a = yield o("WAWebSyncdMdSyncFieldstatMeta").MdSyncFieldStatsMeta.getMdSessionId(), i = yield o("WAWebGetHistorySyncProgress").getHistorySyncProgress(e), l = new (o("WAWebMdBootstrapHistoryDataStartDownloadingWamEvent")).MdBootstrapHistoryDataStartDownloadingWamEvent({
			...
			var c = yield o("WAWebSyncdMdSyncFieldstatMeta").MdSyncFieldStatsMeta.getStorageEstimation();
