__d("WAWebGetPlainTextFromBotMsg", [
	...
	function e(e, t) {
		...
		if (e.richResponse != null) {
			var a = o("WAWebRichResponseCopyText").getRichResponseCopyText(e.richResponse);
			if (a != null) return a;
		}
		return (t == null ? void 0 : t.includeBodyFallback) === !1 ? null : e.body;
	}
