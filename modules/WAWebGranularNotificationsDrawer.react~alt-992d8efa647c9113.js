__d("WAWebGranularNotificationsDrawer.react", [
	...
	function p(e) {
		var t, a = e.config, i = e.onClose, l = e.ref, u = a.getNotificationsEnabled, d = a.getNotificationToneSetting, p = a.getReactionsEnabled, _ = a.getSoundsEnabled, f = a.notificationToneDropdownTitle, g = a.setNotificationsEnabled, h = a.setNotificationToneSetting, y = a.setReactionsEnabled, C = a.setSoundsEnabled, b = a.testidPrefix, v = a.title, S = r("useWAWebToggle")(p, function(e) {
			y(e);
		}), R = S[0], L = S[1], E = r("useWAWebToggle")(u, function(e) {
			var t;
			if (g(e), R !== e && (y(e), L()), e && !r("WAWebEnvironment").isWindows && ((t = window.Notification) == null ? void 0 : t.permission) !== o("WAWebNotificationConstants").PERMISSION_ALLOWED) {
		...
		}), k = E[0], I = E[1], T = r("useWAWebToggle")(_, function(e) {
			C(e);
		}), D = T[0], x = T[1], $ = s._(
			/*BTDS*/
			""
			...
			/*BTDS*/
			""
		), M = (t = m == null ? void 0 : m()) != null ? t : !1, w = M && n("cr:7206") != null && d != null && h != null && f != null;
		return c.jsx(r("WAWebDrawer.react"), {
			ref: l,
			testid: b + "-notifications-drawer",
			tsNavigationData: {
				surface: "unknown",
			...
			children: c.jsxs(o("WAWebKeyboardRotateFocus.react").RotateFocus, {
				...
				children: [c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
					testid: "drawer-title-" + b + "-notifications",
					title: v,
					onBack: i,
					...
					children: [
						...
						w && n("cr:7206") != null && d != null && h != null && f != null ? c.jsx("div", {
