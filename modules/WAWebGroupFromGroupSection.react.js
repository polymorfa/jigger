__d("WAWebGroupFromGroupSection.react", [
	...
	function d(e) {
		...
		var p = r("useWAWebEventTargetValue")(n.participants, l, d);
		if (!a || n.groupType === o("WAWebGroupType").GroupType.LINKED_ANNOUNCEMENT_GROUP || n.groupType === o("WAWebGroupType").GroupType.COMMUNITY || n.isSuspendedOrTerminated() || p > o("WAWebGroupGatingUtils").GFG_GROUP_SIZE_THRESHOLD && !i || !o("WAWebABProps").getABPropConfigValue("group_from_group")) return null;
		var g;
		t[3] !== n.participants ? (g = function() {
			var e = n.participants.filter(f).map(_);
