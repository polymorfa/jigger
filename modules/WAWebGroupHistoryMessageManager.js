__d("WAWebGroupHistoryMessageManager", [
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			var a = yield L(t, n);
			return a == null ? (o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[group-history] no join message found for chat ", "; anchoring history at start of chat"])), t.toString()), y(t)) : (yield k(t, a)) ? {
				chatId: t,
				anchorMessage: a,
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield x(e), n = t == null ? void 0 : t.internalId;
			return n == null ? null : {
				chatId: e,
				anchorMessage: null,
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (r >= t) return e;
			var a = yield x(e.chatId), i = (a == null ? void 0 : a.internalId) != null ? o("WAWebDBMessageUtils").getInChatMsgId(a.internalId) : null;
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			try {
				var a, i = yield o("WAWebSchemaMessage").getMessageTable().between(["internalId"], n, r, {
					lowerInclusive: !0,
					upperInclusive: !1,
					reverse: !0,
					limit: 1
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (t != null) {
				var a = yield o("WAWebSchemaMessage").getMessageTable().get(t.toString());
				(a == null ? void 0 : a.internalId) != null && (r = a.internalId);
			}
			r == null && (r = o("WAWebDBMessageUtils").endOfChat(e));
			try {
				var i = yield o("WAWebSchemaMessage").getMessageTable().between(["internalId"], n, r, {
					lowerInclusive: !0,
					upperInclusive: !1,
					reverse: !0,
					limit: 1
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			try {
				var i = yield o("WAWebSchemaMessage").getMessageTable().between(["internalId"], r, a, { limit: f + 1 });
				return i.length > f;
			} catch (t) {
	...
	function D() {
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			try {
				var l = yield o("WAWebSchemaMessage").getMessageTable().between(["internalId"], a, i, {
					lowerInclusive: !0,
					upperInclusive: !1,
					reverse: !0,
					limit: 1
	...
	function $() {
		return $ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				var r = yield o("WAWebSchemaMessage").getMessageTable().between(["internalId"], t, n, {
					lowerInclusive: !0,
					upperInclusive: !0,
					reverse: !1,
					limit: 1
	...
	var P = new Set([o("WAWebGroupHistoryMsgData.flow").MessageHistoryBundleProcessState.FAILED_NO_RETRY, o("WAWebGroupHistoryMsgData.flow").MessageHistoryBundleProcessState.DEDUPED]);
	function N(e, t, n) {
	...
	function M() {
		return M = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			try {
				var s = yield o("WAWebSchemaMessage").getMessageTable().between(["internalId"], i, l, {
	...
	l.findGroupHistoryInsertionAnchor = g, l.ensureAnchorHasRoomForHistory = b, l.findMostRecentJoinSystemMessage = L, l.findLastValidMessageBefore = T, l.hasReceivedBundleForJoinSession = N;
}), 98);
