__d("WAWebGroupHistoryNoticeHandler", [
		...
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			if (t.type === o("WAWebMsgType").MSG_TYPE.MESSAGE_HISTORY_NOTICE && o("WAWebGroupHistoryGating").isGroupHistoryPostJoinSenderOrInternalTesterEnabled(t.id.remote)) {
				...
				if (n != null) {
					...
					r.length !== 0 && (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[group-history][M2] notice rcvd, ", " receivers"])), r.length), yield c(t.id.remote, r));
				}
			}
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			yield m(e, t, o("WAWebGroupHistoryPostJoinTypes").GroupHistorySentState.NOTICE_SENT);
			...
			if (t.length !== 0) {
				...
				yield o("WAWebModelStorageUtils").getStorage().lock(["group-history-participant"], (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						var n, i = e[0], l = yield i.get(a), s = (n = l == null ? void 0 : l.participantMetadataMap) != null ? n : new Map();
						for (var u of t) {
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			return o("WAWebModelStorageUtils").getStorage().lock(["group-history-participant"], (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
	...
	l.maybeHandleGroupHistoryNotice = s, l.markGroupHistoryNoticeSent = c, l.setGroupHistorySentStateForReceivers = m, l.areAllReceiversNoticeSent = _;
}), 98);
