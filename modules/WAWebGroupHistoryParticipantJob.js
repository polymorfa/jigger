__d("WAWebGroupHistoryParticipantJob", [
		...
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			if (o("WAWebGroupHistoryGating").isGroupHistoryAfterJoinPrerequisitesEnabled()) {
				...
				if (a.length !== 0) {
					...
					o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[group-history][M2] Storing join metadata for ", " participants"])), a.length), yield o("WAWebModelStorageUtils").getStorage().lock(["group-history-participant"], (function() {
						var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
							var t, n = e[0], r = yield n.get(i), l = (t = r == null ? void 0 : r.participantMetadataMap) != null ? t : new Map();
							for (var s of a) {
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			if (o("WAWebGroupHistoryGating").isGroupHistoryAfterJoinPrerequisitesEnabled()) {
				...
				yield o("WAWebModelStorageUtils").getStorage().lock(["group-history-participant"], (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						var n = e[0], a = yield n.get(r), i = a == null ? void 0 : a.participantMetadataMap;
						if (!(i == null || i.size === 0)) {
							var l = !1;
							for (var s of t) {
							...
							l && (i.size === 0 ? yield n.remove(r) : yield n.merge(r, { participantMetadataMap: i }));
						}
					});
					return function(t) {
						return e.apply(this, arguments);
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			yield o("WAWebSchemaGroupHistoryParticipant").getGroupHistoryParticipantTable().remove(t);
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var r = yield o("WAWebSchemaGroupHistoryParticipant").getGroupHistoryParticipantTable().get(n);
	...
	l.updateGroupHistoryParticipantMetadataOnJoin = s, l.clearGroupHistoryParticipantStateOnRemove = c, l.clearGroupHistoryParticipantStateForGroup = m, l.getGroupHistoryParticipantMetadataForGroup = _, l.enrichGroupActionWithStoredHistoryState = g;
}), 98);
