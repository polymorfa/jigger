__d("WAWebGroupHistoryParticipantStateHydration", [
	...
	var e, s, u = new Set();
	function c(e) {
		if (!o("WAWebGroupHistoryGating").isGroupHistoryPostJoinSenderOrInternalTesterEnabled(e)) return (s || (s = n("Promise"))).resolve();
		var t;
		try {
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			try {
				var a = yield o("WAWebGroupHistoryParticipantJob").getGroupHistoryParticipantMetadataForGroup(t);
	...
	function p(e, t) {
		f(t.groupHistorySentState) && !f(e.groupHistorySentState) && e.set({ groupHistorySentState: t.groupHistorySentState }), e.joinTime == null && t.joinTime != null && t.joinTime > 0 && e.set({ joinTime: t.joinTime });
	}
	function _(e, t) {
		...
		return a == null ? t : t.map(function(e) {
			...
			var t = a.get(e.id);
			return t != null && f(t.groupHistorySentState) ? babelHelpers.extends({}, e, { groupHistorySentState: void 0 }) : e;
		});
	}
	function f(e) {
	...
	l.initializeGroupHistoryStateForChat = c, l.guardGroupHistorySentStateDowngrade = _;
}), 98);
