__d("WAWebGroupHistoryPostJoinEligibilityFull", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var s = yield o("WAWebGetGroupHistoryBundleMessagesCount").getGroupHistoryBundleMessageCount({
				groupWid: r,
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var c = r != null ? r : i[0].joinTime, d = yield o("WAWebGetGroupHistoryBundleMessagesCount").getGroupHistoryBundleMessageCount({
				groupWid: n,
	...
	l.isEligibleForPostJoinHistoryFull = e, l.isEligibleForPostJoinHistoryFullMulti = u;
}), 98);
