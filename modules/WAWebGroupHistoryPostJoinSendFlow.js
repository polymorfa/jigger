__d("WAWebGroupHistoryPostJoinSendFlow", [
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i) {
			if (i === void 0 && (i = o("WAWebWamEnumTsSurface").TS_SURFACE.GROUP_CHAT), t.length !== 0) {
				var l = o("WAWebWidFactory").asGroupWidOrThrow(e), s = r("WAWebGroupMetadataCollection").get(l);
				if (s == null) {
					o("WALogger").WARN(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[group-history] post-join: missing groupMetadata ", ""])), l.toString()).sendLogs("group-history-post-join-missing-group");
					return;
				}
				if (t.length === 1) {
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a, i, l, u, c) {
			var d, m = (d = i.joinTime) != null ? d : l;
			if (m != null) {
				var g;
				try {
					g = yield o("WAWebGroupHistoryPostJoinEligibilityFull").isEligibleForPostJoinHistoryFull({
						groupMetadata: a,
						groupWid: t,
						joinTimeFallback: l,
						participant: i
				...
				if (!g.eligible) {
					u != null && o("WAWebGroupHistorySenderUserJourneyLogger").GroupHistorySenderUserJourneyLogger.sendIneligibleAtCtaClick({
						ineligibleReason: o("WAWebGroupHistorySenderUserJourneyLogger").mapEligibilityResultToIneligibleReason(g.reason),
						uiSurface: c
					}), I();
					return;
				}
				var h = o("WAWebFrontendContactGetters").getFormattedShortName(i.contact), y = (function() {
					var r = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n, r) {
						var s;
						try {
							s = yield o("WAWebGroupHistoryPostJoinEligibilityFull").isEligibleForPostJoinHistoryFull({
								groupMetadata: a,
								groupWid: t,
								joinTimeFallback: l,
								participant: i
						...
						if (r(), !s.eligible) {
							u != null && o("WAWebGroupHistorySenderUserJourneyLogger").GroupHistorySenderUserJourneyLogger.sendIneligibleAtSendClick({
								ineligibleReason: o("WAWebGroupHistorySenderUserJourneyLogger").mapEligibilityResultToIneligibleReason(s.reason),
								uiSurface: c
							}), I();
							return;
						}
				...
				u != null && o("WAWebGroupHistorySenderUserJourneyLogger").GroupHistorySenderUserJourneyLogger.selectableMessagesLoaded({
				...
				o("WAWebModalManager").ModalManager.openSupportModal(p.jsx(r("WAWebGroupHistoryPostJoinConfirmPopup.react"), {
					...
					children: s._(
						/*BTDS*/
						"",
						[s._param("contactName", h), s._param("recentMessagesLink", R(b))]
					)
				}));
			}
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a, i, l, u, c) {
			var d;
			try {
				d = yield o("WAWebGroupHistoryPostJoinEligibilityFull").isEligibleForPostJoinHistoryFullMulti({
					groupMetadata: a,
					groupWid: t,
					joinTimeFallback: l,
					participants: i
			...
			if (d.eligible.length === 0) {
				if (u != null) {
					...
					o("WAWebGroupHistorySenderUserJourneyLogger").GroupHistorySenderUserJourneyLogger.sendIneligibleAtCtaClick({
						ineligibleReason: o("WAWebGroupHistorySenderUserJourneyLogger").mapEligibilityResultToIneligibleReason((m = d.ineligible[0]) == null ? void 0 : m.reason),
						uiSurface: c
					});
				}
				T(d.ineligible);
			...
			var _ = o("WAWebFrontendContactGetters").getFormattedShortName(i[0].contact), g = i.length - 1, h = (function() {
				var r = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n, r) {
					var s;
					try {
						s = yield o("WAWebGroupHistoryPostJoinEligibilityFull").isEligibleForPostJoinHistoryFullMulti({
							groupMetadata: a,
							groupWid: t,
							joinTimeFallback: l,
							participants: i
					...
					if (r(), s.eligible.length === 0) {
						if (u != null) {
							...
							o("WAWebGroupHistorySenderUserJourneyLogger").GroupHistorySenderUserJourneyLogger.sendIneligibleAtSendClick({
								ineligibleReason: o("WAWebGroupHistorySenderUserJourneyLogger").mapEligibilityResultToIneligibleReason((d = s.ineligible[0]) == null ? void 0 : d.reason),
								uiSurface: c
							});
						}
						T(s.ineligible);
			...
			o("WAWebModalManager").ModalManager.openSupportModal(p.jsx(r("WAWebGroupHistoryPostJoinConfirmPopup.react"), {
				title: p.jsxs(o("WAWebFlex.react").FlexColumn, {
					...
					children: [p.jsx(r("WAWebGroupHistoryParticipantAvatarRow.react"), {
						...
						/*BTDS*/
						"",
						[s._plural(g, "number of other recipients"), s._param("firstPersonName", _)]
					)]
				}),
				okText: s._(
					/*BTDS*/
	...
	function k(t) {
		o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[group-history] post-join eligibility probe failed"]))).catching(r("getErrorSafe")(t)).sendLogs("group-history-post-join-eligibility-failed");
	}
	function I() {
	...
	function N(e, t, n, r, a, i, l) {
		var c = o("WAWebGroupHistoryRestrictionHelper").filterParticipants([t]), d = c.historyReceivers, m = c.nonHistoryReceivers;
		if (d.length !== 0) {
			...
			o("WAWebSendHistoryBundleAction").sendHistoryBundleAction(_, d, m, a, n).then(function() {
				...
				o("WALogger").ERROR(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[group-history] failed to send post-join history bundle: ", ""])), e).sendLogs("group-history-post-join-send-failed");
			});
		}
	}
	function M(e, t, n, r, a, i) {
		...
		if (l != null) {
			var u = o("WAWebGroupHistoryRestrictionHelper").filterParticipants(t.map(function(e) {
				return e.contact.id;
			})), d = u.historyReceivers, m = u.nonHistoryReceivers;
			if (d.length !== 0) {
				...
				o("WAWebSendHistoryBundleAction").sendHistoryBundleAction(g, d, m, r, l).then(function() {
					o("WAWebToastManager").ToastManager.open(p.jsx(o("WAWebToast.react").Toast, { msg: s._(
						/*BTDS*/
						"",
					...
					o("WALogger").ERROR(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[group-history] post-join multi send failed: ", ""])), e).sendLogs("group-history-post-join-send-multi-failed");
				});
			}
		}
	}
