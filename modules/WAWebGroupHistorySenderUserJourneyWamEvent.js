__d("WAWebGroupHistorySenderUserJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ GroupHistorySenderUserJourney: [
		8378,
		{
			bundleSendSource: [1, o("WAWebWamEnumBundleSendSource").BUNDLE_SEND_SOURCE],
			...
			groupHistorySenderActionType: [5, o("WAWebWamEnumGroupHistorySenderActionType").GROUP_HISTORY_SENDER_ACTION_TYPE],
			groupHistorySystemMessageType: [6, o("WAWebWamEnumGroupHistorySystemMessageType").GROUP_HISTORY_SYSTEM_MESSAGE_TYPE],
			groupHistoryUncountedMessagesCount: [7, e.TYPES.INTEGER],
			groupSize: [8, e.TYPES.INTEGER],
			ineligibleReason: [9, o("WAWebWamEnumGroupHistoryIneligibilityReason").GROUP_HISTORY_INELIGIBILITY_REASON],
