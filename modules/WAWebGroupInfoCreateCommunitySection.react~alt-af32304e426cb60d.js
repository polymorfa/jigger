__d("WAWebGroupInfoCreateCommunitySection.react", [
	...
	function m(t) {
		var a = t.chat, i = t.groupMetadata, l = o("useWAWebModelValues").useModelValues(i, [
			"id",
			"parentGroup",
			"isUnnamed"
		]), u = l.id, m = l.isUnnamed, p = l.parentGroup, _ = r("useWAWebIAmGroupAdmin")(i), f = r("useWAWebEventTargetValue")(i.participants, [
			"bulk_add",
			"bulk_remove",
			"reset"
		], function() {
			return i.participants.length;
		}), g = o("WAWebABProps").getABPropConfigValue("parent_group_min_participants_for_group_entry_point"), h = r("useWAWebUnmountSignal")();
		if (!_ || p != null || f < g || i.groupType === o("WAWebGroupType").GroupType.LINKED_ANNOUNCEMENT_GROUP || !o("WAWebCommunityGatingUtils").communitiesCreationEnabled() || i.isSuspendedOrTerminated()) return null;
		var y = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
				var i = t;
				yield r("WAPromiseRaceAbort")(o("WAWebSetSubjectGroupAction").setGroupSubject(a, i), h).catch(o("WAAbortError").catchAbort(r("WAWebNoop"))).catch(function(t) {
					o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["name_group_modal:onSetSubject failed"])));
				}), o("WAWebModalManager").ModalManager.close(), y();
			});
			return function(n, r) {
			...
			if (m) {
				...
				o("WAWebModalManager").ModalManager.open(c.jsx(r("WAWebNameGroupModal.react"), {
					...
					editRestrictionInfo: (t = a.groupMetadata) != null && t.restrict ? b : void 0
				}));
			} else y();
		};
