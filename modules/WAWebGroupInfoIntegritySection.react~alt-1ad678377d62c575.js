__d("WAWebGroupInfoIntegritySection.react", [
	...
	function g(e) {
		var t, n = e.chat, a = e.showAdditionalAction, i = o("useWAWebModelValues").useModelValues(n, ["formattedTitle"]), l = i.formattedTitle, c = o("WAWebChatGroupUtils").isCommunityAnnouncementGroup(n) && !o("WAWebChatGroupUtils").isIntegrityDeactivatedCommunityAnnouncementGroup(n) && !o("WAWebChatGroupUtils").isTerminatedGroup(n) && ((t = n.groupMetadata) == null ? void 0 : t.participants.iAmMember()) === !0, d = function() {
			var e = function() {
			...
			async function t() {
				await o("WAWebSendSpamChatAction").sendReport({
					chat: n,
					spamFlow: o("WAWebSpamConstants").SpamFlow.GroupInfoReport
				}), o("WAWebExitGroupAction").sendExitGroup(n), o("WAWebModalManager").ModalManager.close(), f({ isExit: !0 });
			}
			var i = function() {
				var e, t = (e = n.groupMetadata) == null ? void 0 : e.getParentGroupChat();
				c && t ? o("WAWebSendSpamChatAction").sendReport({
					chat: n,
					spamFlow: o("WAWebSpamConstants").SpamFlow.GroupInfoReport
				}).then(function() {
					o("WAWebLeaveCommunityModalUtils").openLeaveCommunityModal({ chat: t });
				}) : (o("WAWebSendSpamChatAction").sendSpamExitClear(n, o("WAWebSpamConstants").SpamFlow.GroupInfoReport), o("WAWebModalManager").ModalManager.close(), f({ isExit: !0 }));
			};
