__d("WAWebGroupMemberAddingUserJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ GroupMemberAddingUserJourney: [
		5336,
		{
			addSelectedContactsCount: [1, e.TYPES.INTEGER],
			appSessionId: [2, e.TYPES.STRING],
			bundleSendSource: [20, o("WAWebWamEnumBundleSendSource").BUNDLE_SEND_SOURCE],
			frequentlyContactedIndex: [3, e.TYPES.INTEGER],
			groupAddMemberEntryPoint: [28, o("WAWebWamEnumAddMembersEntrypointType").ADD_MEMBERS_ENTRYPOINT_TYPE],
			groupCreateEntryPoint: [16, o("WAWebWamEnumGroupCreateEntryPoint").GROUP_CREATE_ENTRY_POINT],
			...
			groupMemberAddingActionType: [4, o("WAWebWamEnumGroupMemberAddingActionType").GROUP_MEMBER_ADDING_ACTION_TYPE],
			groupMemberAddingMemberType: [24, o("WAWebWamEnumGroupMemberAddingMemberType").GROUP_MEMBER_ADDING_MEMBER_TYPE],
