__d("WAWebGroupMembershipApprovalRequestsFlow.react", [
	...
	function m(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, e), l = i.chat, s = i.onBack, m = o("useWAWebFlow").useFlow(d.Requests, { transitions: o("useWAWebFlow").FlowTransitions.DrawerRight }), p = m[0], _ = m[1], f = c(null), g = f[0], h = f[1], y = c(o("WAWebMembershipApprovalRequestsOrder").MembershipApprovalRequestsOrder.Source), C = y[0], b = y[1], v = function() {
			b(o("WAWebMembershipApprovalRequestsOrder").MembershipApprovalRequestsOrder.Source);
		}, S = function() {
			b(o("WAWebMembershipApprovalRequestsOrder").MembershipApprovalRequestsOrder.Time);
		}, R = (function() {
		...
		switch (_.step) {
			...
			case d.GroupSettings: L = u.jsx(r("WAWebExistingGroupPermissionsDrawer.react"), {
				chat: l,
