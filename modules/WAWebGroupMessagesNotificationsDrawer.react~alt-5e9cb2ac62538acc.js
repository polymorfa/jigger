__d("WAWebGroupMessagesNotificationsDrawer.react", [
	...
	function _(e) {
		var t = e.onClose, n = e.ref, a = s._(
		...
		}), u = o("useWAWebSettingSync").useSettingSync("isGroupMessageNotificationEnabled", function(e) {
			o("WAWebMuteCollection").MuteCollection.setGlobalGroupNotificationsEnabled(e);
		}), d = o("useWAWebSettingSync").useSettingSync("isGroupReactionsNotificationEnabled", function(e) {
			...
			setSoundsEnabled: function(t) {
				o("WAWebMuteCollection").MuteCollection.setGlobalGroupSoundsEnabled(t);
			},
