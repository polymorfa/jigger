__d("WAWebGroupNotificationContextCard.react", [
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(22), n = e.chat, a = e.msg, i;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (i = ["trusted"], t[0] = i) : i = t[0];
		var l = o("useWAWebModelValues").useModelValues(n, i), s = r("useWAWebFocusOnMount")(), c, d;
		t[1] !== a.id ? (c = function() {
			o("WAWebCmd").Cmd.groupNotificationContextCardRendered(a.id);
		}, d = [a.id], t[1] = a.id, t[2] = c, t[3] = d) : (c = t[2], d = t[3]), m(c, d);
		var _;
		t[4] !== n ? (_ = u.jsx(h, { chat: n }), t[4] = n, t[5] = _) : _ = t[5];
		var f, g;
		t[6] !== n || t[7] !== a ? (f = u.jsx(y, {
			chat: n,
			msg: a
		}), g = u.jsx(C, {
			chat: n,
			msg: a
		}), t[6] = n, t[7] = a, t[8] = f, t[9] = g) : (f = t[8], g = t[9]);
		var S, R;
		t[10] !== n ? (S = u.jsx(b, { chat: n }), R = u.jsx(v, { chat: n }), t[10] = n, t[11] = S, t[12] = R) : (S = t[11], R = t[12]);
		var L;
		t[13] !== _ || t[14] !== f || t[15] !== g || t[16] !== S || t[17] !== R ? (L = u.jsxs(o("WAWebFlex.react").FlexColumn, {
			xstyle: p.container,
			align: "center",
		...
		}), t[13] = _, t[14] = f, t[15] = g, t[16] = S, t[17] = R, t[18] = L) : L = t[18];
		var E = L;
		if (!l.trusted) {
			var k;
			return t[19] !== E || t[20] !== s ? (k = u.jsx("div", {
				ref: s,
				role: "alert",
				tabIndex: -1,
				"data-testid": "group-notification-context-card-suspicious-alert",
				children: E
			}), t[19] = E, t[20] = s, t[21] = k) : k = t[21], k;
		}
		return E;
	}
	var g = function(t) {
	...
	function y(e) {
		var t = o("react-compiler-runtime").c(8), n = e.chat, r = e.msg, a;
		e: switch (r.subtype) {
			case "create": {
				var i;
			...
			case "add": {
				var l;
				t[1] !== n || t[2] !== r.author ? (l = r.author ? u.jsx(o("WAWebTrustSignalsUtils").AddGroupCardTitle, {
					chat: n,
					contactId: r.author
				}) : null, t[1] = n, t[2] = r.author, t[3] = l) : l = t[3], a = l;
				break e;
			}
			case "invite": {
				var c;
		...
		var d;
		t[5] === Symbol.for("react.memo_cache_sentinel") ? (d = [p.breakText, p.paddingTop12], t[5] = d) : d = t[5];
		var m;
		return t[6] !== a ? (m = u.jsx(o("WAWebText.react").WAWebTextLarge, {
			xstyle: d,
			weight: "medium",
