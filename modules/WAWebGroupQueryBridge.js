__d("WAWebGroupQueryBridge", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["querying server for groupMetadata of group id ", ""])), t.toLogString()).tags("groups");
			var n = o("WAWebGroupQueryGroupJob").queryGroupJob(t, "out_of_sync_update");
			try {
				var r = yield n;
				if (r.status === "success") {
					var a, i, l, u, c, d, _, f, g, h, y, C, b, v, S, R = r.groupInfo;
					return m(t, R.subject), p(t, (a = R.isLidAddressingMode) != null ? a : !1), {
						id: R.id,
						owner: R.owner,
						creation: R.creation,
						subject: R.subject,
						...
						noFrequentlyForwarded: (u = R.noFrequentlyForwarded) != null ? u : !1,
				...
				} else if (r.status === "terminated_local" || r.status === "terminated" || r.status === "not_member") return {
					id: t,
					stale: !1
				};
				o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["Store:GroupMetadata Unexpected server response"])));
			} catch (e) {
				if (e instanceof o("WAWebBackendErrors").ServerStatusCodeError && e.status >= 400) return {
					id: t,
					stale: !1
				};
				throw e;
	...
	function d(e) {
		return o("WAWebGroupQueryJob").queryGroupInvite(e).then(function(e) {
			return {
				status: 200,
				groupInfo: e
			};
	...
	function m(e, t) {
		o("WATypeUtils").isString(t) && o("WAWebBackendApi").frontendFireAndForget("updateGroupSubject", {
			id: e,
			subject: t
		});
	}
	...
	l.sendQueryGroup = u, l.sendQueryGroupInvite = d, l.updateSubject = m;
}), 98);
