__d("WAWebGroupQueryBridge", [
	...
	async function u(t) {
		...
		try {
			var r = await n;
			if (r.status === "success") {
				var a, i, l, u, c, p, _, f, g, h, y, C, b, v, S, R = r.groupInfo;
				return d(t, R.subject), m(t, (a = R.isLidAddressingMode) != null ? a : !1), {
					id: R.id,
					owner: R.owner,
					creation: R.creation,
					subject: R.subject,
	...
	l.sendQueryGroup = u, l.sendQueryGroupInvite = c, l.updateSubject = d;
}), 98);
