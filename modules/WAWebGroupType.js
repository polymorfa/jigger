__d("WAWebGroupType", [
	...
	}), _ = Object.freeze({ DEFAULT_SUBGROUP_DEMOTE: "default_sub_group_demote" }), f = e({
		APPROVED: "approved",
		REJECTED: "rejected",
		CANCELLED: "cancelled"
	}), g = e.Mirrored([
	...
	function h(e) {
		return e.defaultSubgroup === !0 ? g.LINKED_ANNOUNCEMENT_GROUP : e.generalSubgroup === !0 ? g.LINKED_GENERAL_GROUP : e.parentGroup != null ? g.LINKED_SUBGROUP : e.isParentGroup === !0 ? g.COMMUNITY : g.DEFAULT;
	}
	function y(e) {
		return e === g.LINKED_ANNOUNCEMENT_GROUP ? o("WAWebWamEnumTypeOfGroupEnum").TYPE_OF_GROUP_ENUM.DEFAULT_SUBGROUP : e === g.LINKED_SUBGROUP ? o("WAWebWamEnumTypeOfGroupEnum").TYPE_OF_GROUP_ENUM.SUBGROUP : e === g.DEFAULT || e === g.COMMUNITY || e === g.LINKED_GENERAL_GROUP ? o("WAWebWamEnumTypeOfGroupEnum").TYPE_OF_GROUP_ENUM.GROUP : (function() {
			throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + e);
		})();
	}
	function C(e) {
		if (e != null) return e === g.DEFAULT ? o("WAWebWamEnumGroupTypeClient").GROUP_TYPE_CLIENT.REGULAR_GROUP : e === g.LINKED_SUBGROUP || e === g.LINKED_GENERAL_GROUP ? o("WAWebWamEnumGroupTypeClient").GROUP_TYPE_CLIENT.SUB_GROUP : e === g.LINKED_ANNOUNCEMENT_GROUP ? o("WAWebWamEnumGroupTypeClient").GROUP_TYPE_CLIENT.DEFAULT_SUB_GROUP : e === g.COMMUNITY ? o("WAWebWamEnumGroupTypeClient").GROUP_TYPE_CLIENT.PARENT_GROUP : (function() {
			throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + e);
		})();
	}
	l.GroupSettingChangeSystemMessageToggleEnabled = s, l.GroupSettingChangeSystemMessageIsAdmin = u, l.GeneralChatAutoAddDisabledReasonEnum = c, l.GROUP_ACTIONS = d, l.DELETE_REASON = m, l.ADD_REASON = p, l.REMOVE_REASON = _, l.RevokedSubGroupSuggestionReason = f, l.GroupType = g, l.getGroupTypeFromGroupMetadata = h, l.groupTypeToWamEnum = y, l.groupTypeToGroupTypeClient = C;
}), 98);
