__d("WAWebGroupsV4InviteFlow.react", [
	...
	function _(t) {
		var a = o("useWAWebFlow").useFlow(p.Confirm), i = a[0], l = a[1], c = r("WAWebGroupMetadataCollection").get(t.groupGid), _ = !!(c != null && c.isParentGroup) || !!(c != null && c.isCag), f = function(t, n) {
			return n === void 0 && (n = !1), n ? o("WAWebFrontendContactGetters").getFormattedUser(t) : d.jsx(o("WAWebName.react").Name, { contact: t });
		}, g = function(t, n) {
		...
		}, C = g(t.participantNeedInvite.map(function(e) {
			return e.contact;
		}), !0), b = s._(
			/*BTDS*/
			"",
			...
			"",
			[s._plural(t.participantNeedInvite.length), s._param("member", C)]
		), S = _ ? v : b, R = function(i, l) {
			i === void 0 && (i = ""), o("WAWebModalManager").ModalManager.close(), y(), (u || (u = n("Promise"))).all(t.participantNeedInvite.map((function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var n = e.contact, a = e.invite_code, s = e.invite_code_exp, u = yield o("WAWebFindChatAction").findOrCreateLatestChat(n.id, "groupsV4InviteFlow"), c = u.chat, d = t.groupGid.toString(), m = r("WAWebGroupMetadataCollection").assertGet(d), p = yield o("WAWebChatSendMessages").sendGroupInviteMessage({
						caption: i,
						chat_: c,
						code: a || "",
						exp: s,
		...
		switch (l.step) {
			case p.Confirm:
				...
				break;
			case p.AddComment: I = d.jsx(r("WAWebGroupsV4InviteAddComment.react"), {
