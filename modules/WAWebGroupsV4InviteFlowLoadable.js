__d("WAWebGroupsV4InviteFlowLoadable", [
	"fbt",
	...
	var e, u = e || (e = o("react")), c = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebGroupsV4InviteFlow.react").__setRef("WAWebGroupsV4InviteFlowLoadable").load();
		return e;
	}), "GroupsV4InviteFlow"), d = r("react-loadable")({
		loader: c,
		loading: function(t) {
