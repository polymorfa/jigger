__d("WAWebGuestCoreDownloadCTAClickAction", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			var r, a = new URLSearchParams(window.location.search), i = (r = n != null ? n : o("WAWebGuestCoreCommonUtils").getInviteCodeFromUrlParams(a)) != null ? r : "", l = a.get("sc"), s = yield e(), c = u(t, i, l != null, s);
