__d("WAWebHandleBusinessRemoval", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.toString(), n = yield r("WAWebLidAwareContactsDB").get(t);
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			yield o("WAWebHandleBusinessNameChangeLidHelpers").removeVerifiedNameFromTableLidAware(e), yield o("WAWebBackendApi").frontendSendAndReceive("applyBusinessRemoval", { wid: o("WAWebWidToJid").widToUserJid(e) });
	...
	l.removeBusinessPropsFromContact = e, l.removeVerifiedName = u, l.handleBusinessRemoval = c, l.handleBusinessRemovalNotificationHash = m, l.handleBusinessRemovalNotificationContact = _;
}), 98);
