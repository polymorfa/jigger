__d("WAWebHandleCoexV2Receipt", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var a = t.ack, i = t.ackString, l = t.externalIds, d = t.participant, m = t.recipient, _ = t.ts;
			if (m == null) {
			...
			try {
				var f = p(i, d, m);
				if (f == null) {
					o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[coexv2] receipt: unresolved represented LID for type ", ""])), String(i)).sendLogs("coexv2-relay-receipt-unresolved-lid");
					return;
				}
				...
				o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[coexv2] receipt: failed to process for type ", ""])), String(i)).catching(r("getErrorSafe")(e)).sendLogs("coexv2-relay-receipt-process-failed");
			}
