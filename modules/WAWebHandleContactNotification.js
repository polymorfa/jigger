__d("WAWebHandleContactNotification", [
	...
	var e, s, u, c, d, m, p, _, f = new (r("WADeprecatedWapParser"))("incomingContactsNotification", function(t) {
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			t.oldJid != null && t.jid != null && (yield r("WAWebProcessPhoneNumberChange")(t.oldJid, t.jid));
			var n = yield g(e, t);
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			if (t && o("WAWebLid1X1MigrationGating").Lid1X1MigrationUtils.isLidMigrated()) {
				var n = yield o("WAWebMessageProcessUtils").selectChatForOneOnOneMessage({ lid: t });
				return n.chatId;
			}
			return e;
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield o("WAWebSchemaContact_DO_NOT_USE_DIRECTLY").getContactTable().bulkGet([e.toString()]), a = n[0];
			if (a != null) {
				...
				if (!(!o("WAWebUsernameTypes").isPresentUsername(c) && d == null && s == null && r("isStringNullOrEmpty")(u) && r("isStringNullOrEmpty")(i) && l !== !0)) {
					var m = { id: t.toString() };
					o("WAWebUsernameTypes").isPresentUsername(c) && (m.username = c), d != null && (m.usernameKey = d), s != null && (m.isUsernameContact = s), r("isStringNullOrEmpty")(u) || (m.pushname = u), r("isStringNullOrEmpty")(i) || (m.displayNameLID = i), l === !0 && (m.isEphemeralityDisabled = !0), yield r("WAWebLidAwareContactsDB").bulkCreateOrMerge([m], "propagateContactDataToNewLid"), o("WAWebBackendApi").frontendFireAndForget("propagateIdentityFieldsToLidContact", {
						lid: t,
						username: c,
						usernameKey: d,
						isUsernameContact: s,
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (e.oldJid) {
				var t = e.oldJid, r = e.jid, a = e.oldLid, i = e.lid;
				o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose([
					"handleModifyAction: oldChatPn: ",
					", newChatPn: ",
					""
				])), t.toLogString(), r.toLogString());
				var l = [], c = yield b(t, a), d = yield o("WAWebApiChatCommon").getChatRecord(c);
				d && l.push({
					id: d.id,
					changeNumberNewJid: r.toString(),
					changeNumberOldJid: void 0
				});
				var m = yield b(r, i), p = yield o("WAWebApiChatCommon").getChatRecord(m);
				p && l.push({
					id: p.id,
					changeNumberNewJid: void 0,
					changeNumberOldJid: t.toString()
				}), yield o("WAWebSchemaChat").getChatTable().bulkCreateOrMerge(l), o("WAWebBackendApi").frontendFireAndForget("updateChatChangeNumberJids", { updates: l.map(function(e) {
					return {
						id: e.id.toString(),
						changeNumberNewJid: e.changeNumberNewJid,
						changeNumberOldJid: e.changeNumberOldJid
					};
				}) }), a != null && i != null && (yield o("WAWebDBCreateLidPnMappings").createLidPnMappings({
					mappings: [{
						lid: a,
						pn: t
					}, {
				...
				}), a.equals(i) || (yield S(a, i))), yield (_ || (_ = n("Promise"))).all([y(c, e), y(m, e)]);
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (o("WAWebTextStatusGatingUtils").receiveTextStatusEnabled()) {
				var r = yield o("WAWebApiContact").getContactRecord(o("WAWebWidFactory").asUserWidOrThrow(e));
				r != null && (t = o("WAWebUpdateTextStatusForContact").updateTextStatusForContact({
					contactId: e,
					textString: null,
					emoji: null,
			...
			var a = o("WAWebChangeProfilePicThumb").changeProfilePicThumb(e, o("WAWebProfilePicConstants").ProfilePicCommand.Set);
	...
	function D() {
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			switch (n.type) {
				case "update": return r ? (yield k(r), i(n)) : (o("WALogger").WARN(d || (d = babelHelpers.taggedTemplateLiteralLoose(["handleContactsNotification: update cmd missing jid"]))), i(n));
				case "update_by_hash": {
					var a = yield o("WAWebApiContact").getContactRecordByHash(n.hash);
					return a == null || (yield k(o("WAWebWidFactory").createWid(a.id))), i(n);
				}
				case "modify": return yield L(n), i(n);
				case "sync": return o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["received contact sync notification"]))).tags("contact-sync"), yield o("WAWebContactSyncBridge").doFullContactSync(), i(n);
