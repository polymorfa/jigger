__d("WAWebHandleGroupNotification", [
	"Promise",
	...
	function y(e, t, n) {
		var r = o("WAWebGroupHistoryGating").isGroupHistoryAfterJoinPrerequisitesEnabled();
		return t.mapChildrenWithTag("participant", function(t) {
			var a, i = (a = t.maybeAttrEnum("type", o("WAWebGroupApiConst").GROUP_PARTICIPANT_TYPES)) != null ? a : "participant", l = t.maybeAttrLidUserJid("lid"), s = t.maybeAttrPhoneUserJid("phone_number"), u = {
				displayName: t.maybeAttrString("display_name"),
				id: o("WAWebJidToWid").userJidToUserWid(t.attrUserJid("jid")),
				isSuperAdmin: i === o("WAWebGroupApiConst").GROUP_PARTICIPANT_TYPES.superadmin,
				isAdmin: i === o("WAWebGroupApiConst").GROUP_PARTICIPANT_TYPES.admin || i === o("WAWebGroupApiConst").GROUP_PARTICIPANT_TYPES.superadmin,
				lid: l != null ? o("WAWebJidToWid").userJidToUserWid(l) : null,
				phoneNumber: s != null ? o("WAWebJidToWid").userJidToUserWid(s) : null,
				username: t.maybeAttrString("username"),
				joinTime: r ? t.maybeAttrTime("join_time") : void 0,
				groupHistorySentState: r ? o("WAWebGroupHistoryPostJoinTypes").parseGroupHistorySentState(t.maybeAttrString("group_history_sent_state")) : void 0
			}, c = n === o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.REMOVE;
			return c || C(e, u, n), u;
		});
	}
	function C(t, n, r) {
		try {
			...
			!a && n.displayName == null && n.phoneNumber == null && n.id.isLid() && !o("WAWebUserPrefsMeUser").isMeAccount(n.id) && (o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose([
				"[lid group] no phone mapping for lid tag=",
				" sw=",
				""
			])), r, o("WAWebUserPrefsNotifications").getGlobalOfflineNotifications().toString()), o("WAWebCurrentUser").isEmployee() ? (o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose([
				"[lid group] group id=",
				", lid=",
				""
			])), t.toString(), n.id.toString()), o("WALogger").ERROR(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[lid group] missing group mapping in parser for employee"]))).sendLogs("[lid group] missing group mapping in parser for employee")) : o("WALogger").ERROR(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[lid group] missing group mapping in action parser"]))).sendLogs("[lid group] missing group mapping in action parser"));
		} catch (e) {
	...
	function S(e) {
		return e === "invite" ? o("WAWebGroupType").ADD_REASON.INVITE : e === "accept" ? o("WAWebGroupType").ADD_REASON.ACCEPT : e === "linked_group_join" ? o("WAWebGroupType").ADD_REASON.LINKED_GROUP_JOIN : e === "auto_add" ? o("WAWebGroupType").ADD_REASON.AUTO_ADD : e === "default_sub_group_admin_add" ? o("WAWebGroupType").ADD_REASON.DEFAULT_SUBGROUP_ADMIN_ADD : e === "default_sub_group_promote" ? o("WAWebGroupType").ADD_REASON.DEFAULT_SUBGROUP_PROMOTE : e === "invite_auto_add" ? o("WAWebGroupType").ADD_REASON.INVITE_AUTO_ADD : e === "general_chat_auto_add" ? o("WAWebGroupType").ADD_REASON.GENERAL_CHAT_AUTO_ADD : null;
	}
	function R(e) {
	...
	function I(e) {
		var t = e.attrString("unlink_type"), n = e.hasAttr("unlink_reason") ? e.attrString("unlink_reason") : null, r = e.mapChildrenWithTag("group", function(e) {
			return {
		...
		if (t === "parent_group") {
			if (n === o("WAWebGroupType").DELETE_REASON.DELETE_PARENT) return {
				actionType: o("WAWebGroupType").GROUP_ACTIONS.DELETE_PARENT_GROUP_UNLINK,
				groupDatas: r
			};
			if (n === o("WAWebGroupType").DELETE_REASON.INTEGRITY_DELETE_PARENT) return {
	...
	function T(e, t, n) {
		var r, a, i, l, s, u, c, d = t.child("group"), m = t.hasAttr("type") && t.attrString("type") === "new", p = y(e, d, o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.CREATE), _ = g(d), f = h(d, m), C = o("WAWebGroupsQueryApi").extractLinkedParent(d), b = o("WAWebUsernameGatingUtils").usernameDisplayedEnabled(), S = {
			...
			creatorCountryCode: b && d.hasAttr("creator_country_code") ? o("WAWebAsISOCountryCode").asISOCountryCode(d.attrString("creator_country_code")) : null,
			...
			limitSharingEnabled: o("WAWebLimitSharingGatingUtils").isOpusEnabled() ? !1 : d.hasChild("limit_sharing_enabled"),
			memberLinkMode: (function(e) {
				if (e === o("WAWebGroupMemberLinkMode").MemberLinkMode.ALL_MEMBER_LINK) return o("WAWebGroupMemberLinkMode").MemberLinkMode.ALL_MEMBER_LINK;
				if (e === o("WAWebGroupMemberLinkMode").MemberLinkMode.ADMIN_LINK) return o("WAWebGroupMemberLinkMode").MemberLinkMode.ADMIN_LINK;
	...
	var D = new (r("WADeprecatedWapParser"))("groupNotificationParser", function(e) {
		if (e.assertTag("notification"), e.hasAttr("to")) {
			var t, n = e.attrString("to"), a = o("WAWebUserPrefsMeUser").getMeDeviceLidOrThrow().toJid(), i = (t = o("WAWebUserPrefsMeUser").getMaybeMeDevicePn()) == null ? void 0 : t.toJid(), l = n === a, s = !r("isStringNullOrEmpty")(i) && n === i;
			!l && !s && e.throw("to have \"to\" matching meLid (\"" + a + "\") or mePn (\"" + (i != null ? i : "") + "\"), but instead has \"" + n + "\"");
		}
		var u = o("WAWebJidToWid").groupJidToWid(e.attrGroupJid("from")), c = e.hasAttr("participant") ? o("WAWebJidToWid").userJidToUserWid(e.attrUserJid("participant")) : null, d = null;
		try {
		...
		var _ = o("WAWebUsernameGatingUtils").usernameDisplayedEnabled(), f = e.attrTime("t"), g = e.hasAttr("addressing_mode") ? e.attrString("addressing_mode") === "lid" : !1, h = e.hasAttr("participant_username") && _ ? e.attrString("participant_username") : null, C = e.hasAttr("participant_country_code") && _ ? o("WAWebAsISOCountryCode").asISOCountryCode(e.attrString("participant_country_code")) : null;
		function v(e) {
			return { jid: e.hasAttr("jid") ? o("WAWebJidToWid").groupJidToWid(e.attrGroupJid("jid")) : void 0 };
		}
		var D, x = e.mapChildren(function(t) {
			var n, a = t.tag();
			switch (a) {
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.CREATE: return T(u, t, c);
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.ADD: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.ADD,
					participants: y(u, t, a),
					reason: t.hasAttr("reason") ? S(t.attrString("reason")) : null,
					isLidAddressingMode: g
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.DELETE: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.DELETE,
					reason: t.hasAttr("reason") ? L(t.attrString("reason")) : null,
					groupDatas: [{
						id: u,
						subject: ""
					}]
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.REMOVE: return {
					actionType: o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.REMOVE,
					participants: y(u, t, a),
					reason: t.hasAttr("reason") ? R(t.attrString("reason")) : null,
					isLidAddressingMode: g
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.PROMOTE: return {
					actionType: o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.PROMOTE,
					participants: y(u, t, a)
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.DEMOTE: return {
					actionType: o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.DEMOTE,
					participants: y(u, t, a)
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.LINKED_GROUP_PROMOTE: return babelHelpers.extends({
					actionType: o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.LINKED_GROUP_PROMOTE,
					participants: y(u, t, a)
				}, v(t));
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.LINKED_GROUP_DEMOTE: return babelHelpers.extends({
					actionType: o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.LINKED_GROUP_DEMOTE,
					participants: y(u, t, a)
				}, v(t));
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.MODIFY: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.MODIFY,
					participants: y(u, t, a)
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.SUBJECT: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.SUBJECT,
					subject: t.attrString("subject"),
					s_o: t.hasAttr("s_o") ? o("WAWebJidToWid").userJidToUserWid(t.attrUserJid("s_o")) : null,
					subjectOwnerPn: t.hasAttr("s_o_pn") ? o("WAWebJidToWid").userJidToUserWid(t.attrUserJid("s_o_pn")) : null,
					subjectOwnerUsername: t.maybeAttrString("s_o_username"),
					s_t: t.maybeAttrTime("s_t")
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.DESC: return t.hasChild("delete") ? {
					...
					descId: t.attrString("id"),
					desc: t.hasChild("body") ? t.child("body").contentString() : null,
					descTime: f
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.SUSPENDED: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.SUSPEND,
					value: !0
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.UNSUSPENDED: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.SUSPEND,
					value: !1
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.LOCKED: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.RESTRICT,
					value: !0,
					threshold: (n = t.maybeAttrString("threshold")) != null ? n : void 0
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.UNLOCKED: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.RESTRICT,
					value: !1
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.ANNOUNCE: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.ANNOUNCE,
					value: !0
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.NOT_ANNOUNCE: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.ANNOUNCE,
					value: !1
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.NO_FREQUENTLY_FORWARDED: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.NO_FORWARD,
					value: !0
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.FREQUENTLY_FORWARDED_OK: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.NO_FORWARD,
					value: !1
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.INVITE: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.INVITE_CODE,
					code: t.attrString("code")
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.EPHEMERAL: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.EPHEMERAL,
					duration: t.attrInt("expiration"),
					trigger: t.hasAttr("trigger") ? t.attrInt("trigger") : void 0,
					initiatedByMe: o("WAWebUserPrefsMeUser").isMeAccount(c)
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.NOT_EPHEMERAL: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.EPHEMERAL,
					duration: 0
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.REVOKE_INVITE: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.REVOKE_INVITE,
					participants: t.mapChildrenWithTag("participant", function(e) {
						return {
				...
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.GROWTH_UNLOCKED: return { actionType: o("WAWebGroupType").GROUP_ACTIONS.GROWTH_UNLOCKED };
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.GROWTH_LOCKED: return {
				...
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.LINK: {
					var i = t.attrString("link_type"), l = {
					...
					return {
						...
						groupDatas: t.mapChildrenWithTag("group", function(e) {
							return {
								...
								subject: e.attrString("subject"),
								subjectTime: e.attrInt("s_t"),
								hiddenSubgroup: i !== "parent_group" ? e.hasChild("hidden_group") : void 0
							};
						})
					};
				}
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.UNLINK: return I(t);
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.MEMBERSHIP_APPROVAL_MODE: {
					...
					return {
						...
						value: ((s = t.child("group_join")) == null ? void 0 : s.attrString("state")) === "on",
						triggered: t.hasAttr("triggered") ? t.attrString("triggered") : void 0
					};
				}
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.MEMBERSHIP_APPROVAL_REQUEST: {
					...
					return {
						...
						requestMethod: (d = E[t.attrString("request_method")]) != null ? d : o("WAWebRequestMethodType").RequestMethod.InviteLink,
						parentGroupId: t.hasAttr("parent_group_jid") ? o("WAWebJidToWid").groupJidToWid(t.attrGroupJid("parent_group_jid")) : void 0
					};
				}
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.ALLOW_ADMIN_REPORTS: return {
				...
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.NOT_ALLOW_ADMIN_REPORTS: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.ALLOW_ADMIN_REPORTS,
					shouldSkipGenMsg: !1,
					value: !1,
					author: c,
				...
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.REPORTS: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.ADMIN_REPORT_RECEIVED,
					shouldSkipGenMsg: !0,
					value: f
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.CREATED_MEMBERSHIP_REQUESTS: {
					...
					return {
						...
						requestMethod: (m = E[t.attrString("request_method")]) != null ? m : o("WAWebRequestMethodType").RequestMethod.InviteLink,
						parentGroupId: t.hasAttr("parent_group_jid") ? o("WAWebJidToWid").groupJidToWid(t.attrGroupJid("parent_group_jid")) : void 0,
						requests: t.hasChildren() ? t.mapChildrenWithTag("requested_user", function(e) {
							return {
								wid: o("WAWebJidToWid").userJidToUserWid(e.attrUserJid("jid")),
								username: _ && e.hasAttr("username") ? e.attrString("username") : void 0,
								phoneNumber: e.hasAttr("phone_number") ? o("WAWebJidToWid").userJidToUserWid(e.attrUserJid("phone_number")) : void 0
							};
						}) : [{ wid: r("nullthrows")(c) }],
						skipGenMsg: t.maybeAttrString("suppress_sys_msg") === "true"
					};
				}
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.REVOKED_MEMBERSHIP_REQUESTS: return {
				...
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.ALLOW_NON_ADMIN_SUB_GROUP_CREATION: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.ALLOW_NON_ADMIN_SUB_GROUP_CREATION,
					value: !0
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.NOT_ALLOW_NON_ADMIN_SUB_GROUP_CREATION: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.ALLOW_NON_ADMIN_SUB_GROUP_CREATION,
					value: !1
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.CREATED_SUBGROUP_SUGGESTION: return babelHelpers.extends({
					actionType: o("WAWebGroupType").GROUP_ACTIONS.CREATED_SUBGROUP_SUGGESTION,
					parentGroupId: u
				}, b(t));
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.REVOKED_SUB_GROUP_SUGGESTIONS: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.REVOKED_SUB_GROUP_SUGGESTIONS,
					parentGroupId: u,
					subgroupSuggestions: t.mapChildrenWithTag("sub_group_suggestion", function(e) {
						return {
							id: o("WAWebJidToWid").groupJidToWid(e.attrGroupJid("jid")),
				...
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.CHANGE_NUMBER: return {
					...
					newOwner: o("WAWebJidToWid").userJidToUserWid(t.attrUserJid("jid"))
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.MEMBER_ADD_MODE: return {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.MEMBER_ADD_MODE,
					memberAddMode: o("WAWebSchemaGroupMetadata").MemberAddMode.cast(t.contentString())
				};
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.AUTO_ADD_DISABLED: return { actionType: o("WAWebGroupType").GROUP_ACTIONS.GENERAL_CHAT_AUTO_ADD_DISABLED };
				case o("WAWebHandleGroupNotificationConst").GROUP_NOTIFICATION_TAG.GROUP_SAFETY_CHECK: return {
				...
				default: throw e.createParseError("Unrecognized group action " + a);
			}
		}).filter(Boolean);
		return {
	...
	function x(e) {
		...
		if (t != null && Array.isArray(t) && t.length > 0) {
			var r = t[0], a = r.tag;
			if (a === "groups_dirty") return (_ || (_ = n("Promise"))).resolve(o("WAWebHandleGroupsDirtyNotification").handleGroupsDirtyNotificationJob(e));
		}
		var i = D.parse(e);
		return i.error ? (o("WALogger").ERROR(p || (p = babelHelpers.taggedTemplateLiteralLoose(["Parsing Error: ", ""])), i.error.toString()), (_ || (_ = n("Promise"))).reject(i.error)) : o("WAWebHandleParsedGroupNotification").handleParsedGroupNotification(i.success);
	}
