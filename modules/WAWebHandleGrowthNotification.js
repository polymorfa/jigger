__d("WAWebHandleGrowthNotification", [
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (n == null) {
				yield o("WAWebCreateChat").createChat({ chatId: e }, "createChatOnInviteAccept");
				...
				var a = r.id, i = yield g(a, t), l = yield o("WAWebChatThreadLogging").getChatThreadID(r.id.toJid());
				...
				}).commit(), yield o("WAWebHandleSingleMsgWorkerCompatible").handleSingleMsg({
					chatId: a,
					newMsg: i,
