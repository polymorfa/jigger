__d("WAWebHandleMessageRetryRequest", [
	...
	async function u(t) {
		...
		var a = n.success, i = a.from, l = a.participant, u = a.stanzaId;
		if (u == null) return o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["Received null stanzaID when handling message retry request"]))), Promise.reject(r("err")("Received null stanzaID when handling message retry request"));
		var c = o("WAWap").wap("ack", {
			id: o("WAWap").CUSTOM_STRING(u),
			to: o("WAWebCommsWapMd").JID(i),
			participant: l ? o("WAWebCommsWapMd").DEVICE_JID(l) : o("WAWap").DROP_ATTR,
			class: "receipt",
			type: "retry"
		});
