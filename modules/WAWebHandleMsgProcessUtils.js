__d("WAWebHandleMsgProcessUtils", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			...
			var r = null;
			if (!(yield o("WAWebHandleMsgValidate").isFromKnownDevice(t.author))) {
			...
			return n.messageContextInfo && (r = t.chat.isUser() ? yield o("WAWebIcdcHandlerApi").handleHostedIcdcMetadataInline(t.chat, t.author, n.messageContextInfo) : null, o("WAWebIcdcHandlerApi").handleICDCData(t.author, t.chat.isUser() ? t.chat : null, n.messageContextInfo)), r;
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			yield o("WAWebBackendApi").frontendSendAndReceive("processEphemeralSyncResponse", { msg: t });
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			yield o("WAWebBackendApi").frontendSendAndReceive("processKeepInChatMessage", {
				keepInChatMessage: e,
				allowNotification: !0
			});
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			yield o("WAWebDBProcessEditProtocolMsgs").processEditProtocolMsgs([r], n);
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield o("WAWebShouldUpdateLastAddOnPreview").filterChatsWithAddOnPreviewUpdates(e);
			t.size > 0 && (yield o("WAWebDBUpdateLastAddOnPreviewChat").updateDatabaseForLastAddOnPreview(t), o("WAWebBackendApi").frontendFireAndForget("updateChatLastAddOnPreview", { chatMap: t }));
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			}).toString() + ";", r = yield o("WAWebDBCreateOrUpdateReactions").createOrUpdateReactions(t);
			return r && (yield h(r.map(function(e) {
				return o("WAWebLastAddOnDBSerialization").lastAddOnPreviewCandidateFromReactionRowType(e);
			}))), r;
		}), b.apply(this, arguments);
	}
	l.preProcessMsg = u, l.processEphemeralSyncResponseMsg = d, l.processKeepInChatMsg = p, l.processEditProtocolMsg = f, l.storeReactionMsgBulk = C;
}), 98);
