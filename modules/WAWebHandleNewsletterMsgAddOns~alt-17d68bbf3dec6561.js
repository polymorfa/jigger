__d("WAWebHandleNewsletterMsgAddOns", [
	...
	function e(e, t) {
		switch (e.type) {
			case "reaction": return s(e);
			case "poll_update": return u(e, t);
	...
	async function s(e) {
		...
		if (!(a == null || i == null || t == null || r == null)) {
			...
			var s = await o("WAWebNewsletterDBUtils").getMessageByServerId(a, t.toJid());
			s != null && await o("WAWebBackendApi").frontendFireAndForget("updateChatPreviewFromReaction", {
				reactionMsgObj: l,
				parentMsgKey: s.id
			});
		}
	...
	async function u(e, t) {
		...
		if (!(i == null || l == null || n == null || s == null)) {
			...
			var c = await o("WAWebNewsletterDBUtils").getMessageByServerId(i, n.toJid());
			c != null && await o("WAWebBackendApi").frontendFireAndForget("updateChatPreviewFromVote", {
				voteMsgObj: {
					ack: o("WAAckLevel").ACK.SENT,
					read: !0,
					msgKey: e.id,
