__d("WAWebHandlePushnameUpdate", [
	...
	function c(t, a, i) {
		...
		return s.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var t = void 0;
			...
			(t === !0 || t === void 0) && (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["updatePushName: set pushname for ", ""])), l.toLogString()), o("WAWebDBBulkPersistContact").persistContactUpdateBatched(l, { pushname: a }));
		}));
	}
	l.updatePushname = c;
}), 98);
