__d("WAWebHandleStatusReceipt", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var a, i = t.ack, l = t.ackString, c = t.externalIds, d = t.offline, m = t.participant, p = t.recipient, _ = t.ts, f = c[0];
			if (f != null) {
				...
				var h = o("WAWebUserPrefsMeUser").getMeUserOrThrow(), y = o("WAWebWidFactory").asUserWidOrThrow(m), C = o("WAWebUserPrefsMeUser").isMeAccount(y), b = t.participantPn;
				if (b != null && m.isLid()) {
					var v = o("WAWebWidFactory").asUserLidOrThrow(m), S = o("WAWebWidFactory").asUserWidOrThrow(b);
					...
					if (L != null) {
						...
						n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
							try {
								...
								yield o("WAWebInsertUsernameChangeSystemMsg").maybeInsertUsernameChangeSystemMsgs(E, e, "handleStatusSimpleReceipt");
							} catch (e) {
				...
				var k = ((a = o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.get(o("WAWebUserPrefsKeys").HASHED_KEYS.USER_PRIVACY_SETTINGS)) == null ? void 0 : a.readReceipts) === "none";
				if (!(!C && (k || l !== o("WAWebAck").ACK_STRING.READ))) {
					var I = o("WAWebWidFactory").createWid(o("WAJids").STATUS_JID), T = new (r("WAWebMsgKey"))({
						id: g,
						remote: I,
						fromMe: !C,
						participant: p != null ? p : h
					}), D = [T.toString()], x = d != null && !o("WAWebOfflineHandler").OfflineMessageHandler.isResumeFromRestartComplete(), $ = (u || (u = n("Promise"))).resolve();
					return C ? $ = o("WAWebMessageReceiptBatcher").receiptBatcher.acceptPeerReceipt({
						ts: _,
						msgKeys: D,
						ack: i,
						isOffline: x,
						...
						receiverId: y,
						msgKeys: D
					}), x || o("WAWebMessageReceiptBatcher").receiptBatcher.runActiveBatches(), $;
				}
			}
