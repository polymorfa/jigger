__d("WAWebHandleUsernameSync", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			var r = t.list, a = r.flatMap(function(e) {
				var t;
				return ((t = e.contact) == null ? void 0 : t.type) === "out" ? [] : e.id == null ? [] : "username" in e ? e.username == null || e.username === "" ? [{
					userId: e.id,
					deleteUsername: !0
				}] : [{
					userId: e.id,
			...
			if (a.length !== 0) {
				...
				yield o("WAWebInsertUsernameChangeSystemMsg").maybeInsertUsernameChangeSystemMsgs(a, i, "handleUsernameSync");
			}
