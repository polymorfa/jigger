__d("WAWebHandleVoipCall", [
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				yield t.initWAWebVoip("incoming"), !t.VoipInitEventEmitter.getIsVoipInited() && t.VoipInitEventEmitter.getDidVoipInitError() && (yield t.retryWAWebVoipInitAfterFailure());
			} catch (e) {
	...
	function x() {
		return x = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var r = L().then(T);
			if (!t) return r;
			var a = o("WAWebBackendApi").frontendSendAndReceive("startVoipInitReloadRecovery", { callId: e.call_id }).then(function(e) {
	...
	function N() {
		return N = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i) {
			...
			try {
				var u = yield o("WAWebVoipHandleIncomingSignalingMessage").handleVoipIncomingEncRekey(e, a), c = u.retryCount, d = u.shouldRetry;
				d ? (o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["voip: ENC_REKEY requires retry, retryCount=", ", sending retry receipt"])), String(c != null ? c : 0)), yield r("WAWebVoipSendGroupCallRekeyRetryReceiptJob")(n, e, c)) : W({
					callCreator: l,
					callId: s,
					from: t,
					stanzaId: n,
	...
	function w() {
		return w = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i) {
			var l = e.call_creator, s = e.call_id;
			switch (e.type) {
				case o("WAWebVoipSignalingEnums").TYPE.OFFER:
					if (W({
						...
						var u = yield o("WAWebVoipBackendLoadable").requireVoipJsBackend();
						yield u.WAWebHandleVoipCallOffer.handleVoipCallOffer(e, a);
					} else yield o("WAWebVoipHandleIncomingSignalingMessage").handleVoipIncomingSignalingMessage(e, a, !1);
					return "NO_ACK";
				case o("WAWebVoipSignalingEnums").TYPE.ENC_REKEY: return P(e, t, n, a, i);
				case o("WAWebVoipSignalingEnums").TYPE.ACCEPT:
				case o("WAWebVoipSignalingEnums").TYPE.REJECT: return W({
					callCreator: l,
					callId: s,
					from: t,
					stanzaId: n,
					type: e.type
				}), yield o("WAWebVoipHandleIncomingSignalingMessage").handleVoipIncomingSignalingMessage(e, a, i), "NO_ACK";
	...
	function F() {
		return F = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a, i, l, s, u) {
			if (u && o("WAWebVoipGatingUtils").isGroupCallMessage(e) && !o("WAWebVoipGatingUtils").isGroupCallingEnabled()) {
				var c, d = e.group_jid != null ? {
					isGroup: !0,
				...
				}, d)), (b || (b = n("Promise"))).resolve("NO_ACK");
			}
			if ($(e.type)) return M(e, t, a, i, u);
			switch (e.type) {
				case o("WAWebVoipSignalingEnums").TYPE.OFFER_NOTICE: return r("WAWebEnvironment").isWindows && !o("WAWebVoipGatingUtils").isWinHybridPlusEnabled() ? (o("WALogger").ERROR(g || (g = babelHelpers.taggedTemplateLiteralLoose(["handleVoipIncomingSignalingMessage: offer notice unsupported on win"]))), (b || (b = n("Promise"))).resolve("NO_ACK")) : r("WAWebHandleVoipOfferNotice")(s);
				default: return yield o("WAWebVoipHandleIncomingSignalingMessage").handleVoipIncomingSignalingMessage(e, i, u), q(t, a, l);
			}
	...
	function B() {
		return B = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var a = t.from, i = t.message, l = t.payloadTag, s = t.senderLid, u = t.stanzaId, c = t.voipNode;
			try {
				s != null && (a.isLid() && o("WALogger").ERROR(h || (h = babelHelpers.taggedTemplateLiteralLoose(["handleCall: sender_lid in a lid call"]))).sendLogs("lid-call-sender-lid"), s.isUser() && (yield o("WAWebVoipLidUtils").attemptPersistLidMappingAndUserAttributes({
					jid: s,
					phoneNumber: a.isUser() ? a : null,
					flushImmediately: !0
				}))), yield o("WAWebVoipLidUtils").persistAttributesAndLidMappingsForCall(i);
			} catch (e) {
			...
			o("WAWebVoipGatingUtils").isGuestViewer() && i.group_info_updates != null && o("WAWebBackendApi").frontendFireAndForget("hydrateGuestParticipantContacts", { participants: i.group_info_updates.map(function(e) {
				return {
					jid: e.jid,
			...
			var d = yield D(i);
			return d === "reload_required" ? (o("WALogger").LOG(C || (C = babelHelpers.taggedTemplateLiteralLoose(["voip: retaining call stanza until user reloads, type=", ""])), l), "NO_ACK") : A(i, a, u, c, l, e, d === "available");
	...
	l.canUseVoipStackForCallMessage = L, l.resetVoipInitReloadRequiredForTest = I, l.handleCall = O;
}), 98);
