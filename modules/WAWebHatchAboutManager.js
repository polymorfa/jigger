__d("WAWebHatchAboutManager", [], (function(t, n, r, o, a, i) {
	"use strict";
	var e = (function() {
		function e() {
		...
		return t.subscribe = function(t) {
			...
			var e = this.$3(n);
			if (e != null) {
				var r = e.isInProgress, o = e.title;
				this.$1.set(t, {
					isInProgress: r,
					text: o
				}), this.$4(t, o, r);
			...
			for (var n of e) {
				...
				if (r != null) {
					var o = r.primitives;
					if (o != null) {
						for (var a of o) if (a.__typename === "GenAIBotProgressStatusPrimitive") return {
							title: a.title,
