__d("WAWebHatchApprovalManager", [], (function(t, n, r, o, a, i) {
	"use strict";
	var e = (function() {
		function e() {
			this.$1 = new Map(), this.$2 = [], this.$3 = [], this.$4 = null;
		}
		var t = e.prototype;
		return t.getPendingApprovals = function() {
			return this.$2;
			...
			if (!(n != null && this.$4 != null && n <= this.$4)) {
				n != null && (this.$4 = n);
				var e = new Set();
				for (var r of t) e.add(r.approvalId), this.$1.set(r.approvalId, r);
				for (var o of Array.from(this.$1.keys())) e.has(o) || this.$1.delete(o);
				this.$5();
			}
