__d("WAWebHatchCommandPickerPlugin.react", [
	...
	function g(e) {
		var t = e.chatId, n = o("LexicalComposerContext").useLexicalComposerContext(), a = n[0], i = o("useWAWebLexicalTypeAhead").useTypeAhead(a, d, {
			enabled: !0,
			maxQueryLength: 50
		}), l = i.leadOffset, s = i.omitQuery, f = i.query, g = i.replaceQuery, C = c(function() {
	...
	function y(e) {
		...
		}[!!n << 0], { children: [u.jsx(r("WDSText.react"), {
