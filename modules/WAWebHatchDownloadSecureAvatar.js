__d("WAWebHatchDownloadSecureAvatar", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, a) {
			...
			var i = t.mediaType === "video", l = i ? o("WAWebMmsMediaTypes").MEDIA_TYPES.VIDEO : o("WAWebMmsMediaTypes").MEDIA_TYPES.IMAGE, d = o("WAWebStartMediaDownloadQpl").startMediaDownloadQpl({ entryPoint: "DownloadHatchAvatar" }), m = new AbortController(), p = !1, _ = window.setTimeout(function() {
				p = !0, m.abort();
			}, c);
			try {
				return yield r("WARaceSignal")([a, m.signal], (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						var n, r = yield o("WAWebDownloadManager").downloadManager.downloadAndMaybeDecrypt({
						...
						}), a = (n = t.mimeType) != null ? n : i ? u : s, c = new Blob([r], { type: a });
						o("WAWebMediaInMemoryBlobCache").InMemoryMediaBlobCache.put(t.filehash, c);
				...
				return d.endFailWithError("download_failed", f.message), o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["hatch: secure avatar download failed"]))).catching(f).sendLogs("hatch-secure-avatar-download-failed"), null;
			} finally {
