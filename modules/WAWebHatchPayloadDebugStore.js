__d("WAWebHatchPayloadDebugStore", [], (function(t, n, r, o, a, i) {
	"use strict";
	var e = (function() {
		function e() {
			this.$1 = [], this.$2 = [], this.$3 = [], this.$4 = 0, this.$5 = new Set(), this.$6 = new Map();
		}
		var t = e.prototype;
		return t.noteOutboundMsgId = function(t, n) {
			this.$6.set(t, n);
		}, t.record = function(t) {
			var e = t.action;
			if (e.type === "req") {
			...
			var n = l(t.rawBytes), r = n.raw, o = n.rawByteLength;
			this.$1.push({
				id: String(this.$4++),
