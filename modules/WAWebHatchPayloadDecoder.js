__d("WAWebHatchPayloadDecoder", ["WAWebHatchJsonReaders"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = "agent.status", s = "hitl.approval", u = "hitl.snapshot", c = "identity.updated";
	function d(t) {
		var n = t.opKey, r = t.payload;
		return n === e ? {
			kind: "agent_status",
			status: m(r)
		} : n === s ? {
			...
			approvalSnapshot: b(r)
		} : { kind: "unknown" };
	}
	function m(e) {
		var t = o("WAWebHatchJsonReaders").readString(e, "activity_emoji");
		return babelHelpers.extends({ activityCode: o("WAWebHatchJsonReaders").readString(e, "activity_code") }, t != null && t !== "" ? { activityEmoji: t } : null, { activityText: o("WAWebHatchJsonReaders").readString(e, "activity_text") });
	}
	function p(e) {
		var t, n = (t = o("WAWebHatchJsonReaders")).readField(e, "avatar");
		return {
	...
	function _(e) {
		var t = f(o("WAWebHatchJsonReaders").readString(e, "media_type")), n = g(e, "direct_path"), r = g(e, "media_key_b64"), a = g(e, "file_enc_sha256_b64"), i = g(e, "file_sha256_b64");
		return t == null || n == null || r == null || a == null || i == null ? null : {
			directPath: n,
			mediaKey: r,
			encFilehash: a,
			filehash: i,
	...
	function h(e) {
		...
		var t = {}, n = !1;
		for (var r of e) {
			var a = o("WAWebHatchJsonReaders").readString(r, "variant"), i = _(o("WAWebHatchJsonReaders").readField(r, "media"));
	...
	function y(e) {
		...
		var t = {}, n = !1;
		for (var r of e) {
			var a = o("WAWebHatchJsonReaders").readString(r, "variant"), i = o("WAWebHatchJsonReaders").readString(r, "video_url");
			a != null && a !== "" && i != null && i !== "" && (t[a] = i, n = !0);
		}
		return n ? t : null;
	}
	function C(e) {
	...
	function S(e) {
		var t, n = (t = o("WAWebHatchJsonReaders")).readBool(e, "turn_grant_eligible");
		...
		}, n != null ? { turnGrantEligible: n } : null, R(e));
	}
	function R(e) {
		var t = {}, n = o("WAWebHatchJsonReaders").readBool(e, "space_reader_grant_eligible");
		n != null && (t.spaceReaderGrantEligible = n);
		var r = o("WAWebHatchJsonReaders").readString(o("WAWebHatchJsonReaders").readField(e, "runtime_request_trace"), "space_display_name");
