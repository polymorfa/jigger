__d("WAWebHeader.react", [
	...
	var b = 40, v = 2;
	function S(e) {
		var t = o("react-compiler-runtime").c(24), n = e.badge, a = e.chatAvatarType, i = e.colorId, l = e.initials, s = e.name, u = e.placeholderIcon, d = e.statusId, m = e.statusInteraction, p = e.statusRing, _ = e.videoUrl, f;
		t[0] !== i ? (f = o("WAWebProfilePicThumbCollection").ProfilePicThumbCollection.gadd(i), t[0] = i, t[1] = f) : f = t[1];
		var g = f, h;
		t[2] === Symbol.for("react.memo_cache_sentinel") ? (h = ["img"], t[2] = h) : h = t[2];
		var y = o("useWAWebModelValues").useOptionalModelValues(g, h), C = l === "" ? void 0 : l, S;
		t[3] !== n || t[4] !== C || t[5] !== m || t[6] !== p ? (S = {}, C != null && (S.initials = C), n != null && (S.badge = n), p != null && (S.statusRing = p), m != null && (S.interaction = m), t[3] = n, t[4] = C, t[5] = m, t[6] = p, t[7] = S) : S = t[7];
		var R = y == null ? void 0 : y.img, L;
		t[8] !== i ? (L = o("useWAWebDefaultProfileColors").getWDSProfilePhotoColor(i), t[8] = i, t[9] = L) : L = t[9];
		var E;
		t[10] !== i ? (E = o("useWAWebDefaultProfileColors").getWDSProfilePhotoCustomColor(i), t[10] = i, t[11] = E) : E = t[11];
		var k;
		t[12] !== a || t[13] !== s || t[14] !== S || t[15] !== u || t[16] !== R || t[17] !== L || t[18] !== E || t[19] !== _ ? (k = c.jsx(r("WDSProfilePhoto.react"), babelHelpers.extends({
			type: a,
			name: s,
			src: R,
			videoSrc: _,
			...
			placeholderIcon: u,
			isDecorative: !0
		}, S)), t[12] = a, t[13] = s, t[14] = S, t[15] = u, t[16] = R, t[17] = L, t[18] = E, t[19] = _, t[20] = k) : k = t[20];
		var I = k;
		if (p == null || d == null) return I;
		var T;
		return t[21] !== I || t[22] !== d ? (T = c.jsx(r("WAWebStatusLoadingRingOverlay.react"), {
			id: d,
			size: b,
			stroke: v,
			children: I
		}), t[21] = I, t[22] = d, t[23] = T) : T = t[23], T;
	}
	function R(t) {
		"use no forget";
	...
	function L(e) {
		...
		return t[0] === Symbol.for("react.memo_cache_sentinel") ? (n = c.jsx("div", {
			className: "xh8yej3 x185czh x2lah0s",
			"data-testid": "conversation-header-error-fallback"
		}), t[0] = n) : n = t[0], n;
	}
	function E(e) {
		var t = o("react-compiler-runtime").c(9), n = e.chat, r = e.onSelectMessages, a = e.selectable, i = e.threadId, l;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (l = [o("WAWebFrontendChatGetters").getContact], t[0] = l) : l = t[0];
		var s = o("useWAWebChatValues").useChatValues(n.id, l), u = s[0], d = u != null ? "has-contact" : "no-contact", m;
		t[1] !== n || t[2] !== r || t[3] !== a || t[4] !== i ? (m = c.jsx(R, {
			chat: n,
			onSelectMessages: r,
			selectable: a,
			threadId: i
		}), t[1] = n, t[2] = r, t[3] = a, t[4] = i, t[5] = m) : m = t[5];
		var p;
		return t[6] !== d || t[7] !== m ? (p = c.jsx(o("WAWebErrorBoundary.react").ErrorBoundary, {
			...
			children: m
		}, d), t[6] = d, t[7] = m, t[8] = p) : p = t[8], p;
	}
	l.createLabelsDropdownMenu = o("WAWebHeaderLabelRendering").createLabelsDropdownMenu, l.isCommunityRelatedChat = o("WAWebHeaderLabelRendering").isCommunityRelatedChat, l.openInfoPanel = o("WAWebHeaderInfoPanelActions").openInfoPanel, l.ConversationHeader = R, l.ConversationHeaderWithErrorBoundary = E;
}), 226);
