__d("WAWebHelpCommandPalettePlugin", [
	...
	function c(e) {
		var t = e.trigger, n = o("WAWebToArray").toArray(t);
	...
	function d(e) {
		var t = e.triggeredCommands, n = o("WAWebCommandPaletteController").useCommandPalette();
		return s.jsx(o("WAWebLexicalWAWebMenu.react").LexicalWAWebMenu, { children: r("compactMap")(t, function(e) {
			return e.doc != null ? s.jsx(o("WAWebMenuItems.react").ActionMenuItem, {
				optionId: e.plugin.id,
				detailRight: s.jsx(c, { trigger: e.trigger }),
				primary: e.doc.isDevOnly === !0 ? s.jsx(o("WAWebDevOnlyBadge.react").DevOnlyBadge, { label: e.doc.name }) : e.doc.name,
