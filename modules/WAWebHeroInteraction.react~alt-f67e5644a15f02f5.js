__d("WAWebHeroInteraction.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = e.children, n = e.description, a = e.enableHoldTrigger, i = a === void 0 ? !0 : a, l = e.pageletName, u = e.policy, c = r("useWAWebCometInteractionTracing")(u);
		return s.jsx(o("hero-tracing").HeroInteraction, {
			...
			renderTrackedDOMElement: function(o) {
				return s.jsxs(r("WAWebErrorBoundaryInstrumented.react"), {
					...
					children: [i && s.jsx(r("CometHeroHoldTrigger.react"), {
						description: n,
