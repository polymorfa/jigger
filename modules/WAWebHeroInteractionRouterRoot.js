__d("WAWebHeroInteractionRouterRoot", [
	...
	"use strict";
	var e, s = (e || (e = r("Env"))).brsid != null ? String((e || (e = r("Env"))).brsid) : null, u = r("createHeroInteractionRouterRoot")(), c = null, d = {
		...
		startInitialLoad: function(t) {
			...
			if (c == null) {
				...
				}), (e = c) == null || e.onComplete(function(e) {
					s != null && o("CometAddInlineTiming").addInlineTiming(e.traceId, s, 0);
				});
			}
		},
