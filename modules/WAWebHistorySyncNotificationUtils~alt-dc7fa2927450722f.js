__d("WAWebHistorySyncNotificationUtils", [
	...
	async function p(t, n) {
		...
		await o("WAWebDBGroupParticipant").addPastParticipants(a), a.forEach(function(e) {
		...
		}), o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[history sync] Past Participants completed, ", ""])), o("WAWebHistorySyncLogUtils").getHistorySyncLogDetailsString(n));
	}
	async function _(e, t) {
		var n = await o("WAWebSignalProtocolStore").getPersistSignalProtocolStore().loadIdentityKey(e);
		n != null && n !== t && o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose([
	...
	function f(e, t) {
		var n;
		if (t.isGroup()) {
			var a = (n = e.disappearingMode) == null ? void 0 : n.trigger, i;
			if (a != null) {
				var l = o("WAWebEphemeralityUtils").getDisappearingModeTriggerFromProtobuf(a);
				l != null && (i = l);
			}
			if (e.suspended != null || e.terminated != null || e.createdBy != null || e.createdAt != null || e.description != null || e.support != null || e.isParentGroup != null || e.isDefaultSubgroup != null || e.parentGroupId != null || e.disappearingMode != null || e.appealStatus != null || e.appealUpdateTime != null) {
				var s, c, d = {
					id: t,
					subject: e.name,
					suspended: e.suspended,
					terminated: e.terminated,
					owner: e.createdBy != null ? o("WAWebWidFactory").createWid(e.createdBy) : void 0,
					creation: e.createdAt,
					desc: e.description,
					support: e.support,
					isParentGroup: e.isParentGroup,
					defaultSubgroup: e.isDefaultSubgroup,
					parentGroup: e.parentGroupId != null ? o("WAWebWidFactory").createWid(e.parentGroupId) : void 0,
					disappearingModeInitiatedByMe: (s = e.disappearingMode) == null ? void 0 : s.initiatedByMe,
					disappearingModeTrigger: i,
					suspendAppealStatus: e.appealStatus != null ? e.appealStatus === o("WAWebProtobufsHistorySync.pb").Conversation$GroupAppealStatus.APPEAL_IN_REVIEW ? "IN_REVIEW" : e.appealStatus === o("WAWebProtobufsHistorySync.pb").Conversation$GroupAppealStatus.APPEAL_APPROVED ? "APPROVED" : e.appealStatus === o("WAWebProtobufsHistorySync.pb").Conversation$GroupAppealStatus.APPEAL_REJECTED ? "REJECTED" : e.appealStatus === o("WAWebProtobufsHistorySync.pb").Conversation$GroupAppealStatus.NO_APPEAL ? null : (function() {
						throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + e.appealStatus);
					})() : void 0,
					suspendAppealUpdateTime: e.appealUpdateTime != null ? Number(e.appealUpdateTime) : void 0
				};
				o("WAWebDBGroupsGroupMetadata").persistGroupMetadata(t, babelHelpers.extends({}, d, {
					id: d.id.toString(),
				...
				var m = r("WAWebGroupMetadataCollection").add(babelHelpers.extends({}, d), { merge: !0 })[0], p = (c = e.participant) == null ? void 0 : c.map(function(e) {
				...
				m == null || m.participants.add(p, { merge: !0 }), (e.readOnly === !0 || p.length > 0) && o("WAWebGroupParticipantsJob").updateParticipantsJob({
					group: t,
					...
					o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["updateParticipantsJob: failed: ", ""])), e);
				});
			}
		}
	}
	...
	l.HistorySyncScheduleSource = m, l.processPastParticipants = p, l.getHistorySyncBasicChunkInfoString = o("WAWebHistorySyncLogUtils").getHistorySyncBasicChunkInfoString, l.getHistorySyncLogDetailsString = o("WAWebHistorySyncLogUtils").getHistorySyncLogDetailsString, l.checkSelfHistorySyncIdentity = _, l.saveGroupMetadataForLeftGroup = f, l.handleChatThreadLoggingMetadata = g, l.commitHistoryStartDownloadingMetric = h, l.commitHistoryDownloadedMetric = y, l.commitHistoryDataAppliedMetric = C, l.maybeGetInlinePayload = b, l.getUnprocessedRecentSyncNotifications = v;
}), 98);
