__d("WAWebHistorySyncPausedPopup.react", [
	"fbt",
	...
	function d() {
		...
		var n;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (n = u.jsx(o("WAWebText_DONOTUSE.react").TextHeader, {
			xstyle: c.title,
			children: o("WAWebHistorySyncUIText").SYNCING_PAUSED_POPUP_TITLE()
		}), e[1] = n) : n = e[1];
		var r;
		e[2] === Symbol.for("react.memo_cache_sentinel") ? (r = s._(
			/*BTDS*/
			""
		), e[2] = r) : r = e[2];
		var a;
		return e[3] === Symbol.for("react.memo_cache_sentinel") ? (a = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: t,
			title: n,
