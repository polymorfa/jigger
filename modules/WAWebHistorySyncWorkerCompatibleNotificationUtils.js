__d("WAWebHistorySyncWorkerCompatibleNotificationUtils", [
	"Promise",
	"WALogger",
	"WAWebBackendApi",
	"WAWebChatConstants",
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, r) {
			...
			var a = f(n), i = {
				id: t,
				endOfHistoryTransferType: a
			};
			o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
				"[history sync] update chat ",
				" end of history transfer type to ",
				""
			])), t.toLogString(), a), r && (i.t = 0), yield o("WAWebSchemaChat").getChatTable().merge(t.toString(), { endOfHistoryTransferType: a }), yield o("WAWebBackendApi").frontendSendAndReceive("chatCollectionAdd", {
				things: [i],
				options: {
					merge: !0,
					add: !1
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (e.length !== 0) {
				var t = o("WAWebSchemaChat").getChatTable(), r = [], a = yield (c || (c = n("Promise"))).allSettled(e.map(function(e) {
					var n = e.chat, o = e.endOfHistoryTransferTypeFromProto, a = e.setChatTimeToZero, i = f(o), l = {
						id: n,
						endOfHistoryTransferType: i
					};
					return a === !0 && (l.t = 0), r.length < 3 && r.push(n.toLogString()), t.merge(n.toString(), { endOfHistoryTransferType: i }).then(function() {
						return l;
					});
				}));
				...
				a.forEach(function(e) {
					e.status === "fulfilled" ? i.push(e.value) : o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[history sync] bulkUpdateEndOfHistorySync merge fail: ", ""])), e.reason);
				}), i.length !== 0 && (yield o("WAWebBackendApi").frontendSendAndReceive("chatCollectionAdd", {
					things: i,
					options: {
						merge: !0,
						add: !1
