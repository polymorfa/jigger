__d("WAWebHistorySyncWorkerCompatibleNotificationUtils", [
	...
	async function c(t, n, r) {
		...
		o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			...
			""
		])), t.toLogString(), a), r && (i.t = 0), await o("WAWebSchemaChat").getChatTable().merge(t.toString(), { endOfHistoryTransferType: a }), await o("WAWebBackendApi").frontendSendAndReceive("chatCollectionAdd", {
			things: [i],
			options: {
				merge: !0,
				add: !1
	...
	async function d(e) {
		if (e.length !== 0) {
			var t = o("WAWebSchemaChat").getChatTable(), n = [], r = await Promise.allSettled(e.map(function(e) {
				var r = e.chat, o = e.endOfHistoryTransferTypeFromProto, a = e.setChatTimeToZero, i = m(o), l = {
					id: r,
					endOfHistoryTransferType: i
				};
				return a === !0 && (l.t = 0), n.length < 3 && n.push(r.toLogString()), t.merge(r.toString(), { endOfHistoryTransferType: i }).then(function() {
					return l;
				});
			}));
			...
			r.forEach(function(e) {
				e.status === "fulfilled" ? a.push(e.value) : o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[history sync] bulkUpdateEndOfHistorySync merge fail: ", ""])), e.reason);
			}), a.length !== 0 && await o("WAWebBackendApi").frontendSendAndReceive("chatCollectionAdd", {
				things: a,
				options: {
					merge: !0,
					add: !1
