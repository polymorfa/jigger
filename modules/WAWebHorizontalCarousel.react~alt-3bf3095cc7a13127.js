__d("WAWebHorizontalCarousel.react", [
	...
	function d(e) {
		var t = e.items, n = o("WAWebCarouselScrollButton.react").useScrollableContainer({
			itemWidth: u,
			isLoading: !1,
			itemsLoaded: t.length,
			isFullUnit: !1
		}), r = n.containerRef, a = n.handleScroll, i = n.position, l = n.scrollEndBy, d = n.scrollStartBy, m = s.jsx(o("WAWebFlex.react").FlexColumn, {
			rowGap: 8,
			paddingStart: 24,
