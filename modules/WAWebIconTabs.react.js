__d("WAWebIconTabs.react", [
	...
	var e, s = e || (e = o("react")), u = e.useRef, c = "xehbzi3-B", d = {
		selected: {
		...
		expressionsPanelSelectedTabIcon: {
			color: "x14ug900",
			$$css: !0
		}
	};
	function m(e) {
		var t = e.onSelect, n = e.popupAtLaunch, a = e.refs, i = e.selectedIndex, l = e.tabConfigs, c = e.theme, m = u(null), p = u([]);
		a && l.forEach(function(e, t) {
			return r("nullthrows")(a)[t] = { current: r("nullthrows")(document.body) };
		});
		var _ = {
			right: function() {
				var e, t, n = (e = m.current) != null ? e : l.length - 1, r = n === l.length - 1 ? 0 : n + 1;
				(t = p.current[r]) == null || t.focus();
			},
			left: function() {
				var e, t, n = (e = m.current) != null ? e : 0, r = n === 0 ? l.length - 1 : n - 1;
				(t = p.current[r]) == null || t.focus();
			}
		};
		return s.jsx(o("WAWebKeyboardHotKeys.react").HotKeys, {
			role: "tablist",
			handlers: _,
			children: s.jsx(o("WAWebFlex.react").FlexRow, { children: l.map(function(e, o) {
				var u = e.Icon, _ = e.ariaLabel, f = e.iconStyle, g = e.testid, h = i === o, y = o === 0, C = o === l.length - 1;
				return s.jsx(r("WAWebFlexItem.react"), {
					...
					children: s.jsx(r("WAWebUnstyledButton.react"), {
						...
						xstyle: [
							h && d.selected,
							c === "expression-panels" && h && d.expressionsPanelSelectedTab,
							d.tab,
						...
						children: s.jsx(u, {
							...
							iconXstyle: [
								d.icon,
								f,
								h && c === "expression-panels" ? d.expressionsPanelSelectedTabIcon : void 0
							],
							xstyle: [
