__d("WAWebIdbLazyView", [
	...
	var e, s = (function() {
		function t(e, t, n) {
			this.$1 = e, this.$2 = t, this.$3 = n, o("WAWebDBStats").dbStats.initTable(this.$2);
		}
		var a = t.prototype;
		return a.$4 = function(t) {
			...
			var t = this;
			if (r("WAWebBrokerGlobalAppState").isLogoutInProgress) return (e || (e = n("Promise"))).reject(new (o("WAWebDbErrors")).DbOnLogoutAbort("dropping db read operation due to logout"));
			var i = this.$1(), l = self.performance.now();
			return a(i).then(function(e) {
				return o("WAWebDBStats").dbStats.trackReadTransaction(t.$2, l, t.$4(e)), e;
			}).catch(function(e) {
				throw e;
			});
		}, a.$6 = function(t) {
			throw o("WAWebStorageErrorHandlingUtils").isQuotaExceededError(t) && (o("WAWebStorageCmd").StorageCmd.trigger("storage_not_enough_space"), o("WAWebStorageErrorHandlingUtils").reportQuotaExceededError(t)), t;
		}, a.$7 = function(a, i) {
			var t = this;
			if (i === void 0 && (i = !1), i !== !0 && r("WAWebBrokerGlobalAppState").isLogoutInProgress) return (e || (e = n("Promise"))).reject(new (o("WAWebDbErrors")).DbOnLogoutAbort("dropping db write operation due to logout"));
			var l = self.performance.now(), s = this.$1();
			return a(s).then(function(e) {
				return o("WAWebDBStats").dbStats.trackWriteTransaction(t.$2, l), e;
			}).catch(function(e) {
			...
			return n === void 0 && (n = !1), this.$7(function(e) {
			...
			return t === void 0 && (t = !1), this.$7(function(e) {
				return e.clear();
			}, t);
