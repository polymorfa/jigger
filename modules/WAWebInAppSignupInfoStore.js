__d("WAWebInAppSignupInfoStore", [
	...
	var e, s, u, c = null;
	function d() {
		return o("WAWebSchemaInAppSignupInfo").canUseInAppSignupInfoTable() ? (c == null && (c = o("WAWebSchemaInAppSignupInfo").getInAppSignupInfoTable().all().then(function(e) {
			o("WAWebInAppSignupInfoCache").primeInAppSignupInfoCache(e);
		}).catch(function(t) {
			c = null, o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[ias-store] hydrate failed"]))).catching(r("getErrorSafe")(t)).sendLogs("ias-store-hydrate-failed");
		})), c) : (u || (u = n("Promise"))).resolve();
	}
	function m() {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			if (o("WAWebABProps").getABPropConfigValue("inapp_signup_m1_logging_enabled") && o("WAWebSchemaInAppSignupInfo").canUseInAppSignupInfoTable()) try {
				...
				yield n.createOrMerge(a.id, a), o("WAWebInAppSignupInfoCache").setInAppSignupInfo(a);
			} catch (e) {
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (o("WAWebABProps").getABPropConfigValue("inapp_signup_m1_logging_enabled")) {
				...
				(r == null ? void 0 : r.iasOptinDs) == null && (yield p(e, {
					isIasSubscriber: !0,
					iasOptinDs: C(),
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n;
			o("WAWebABProps").getABPropConfigValue("inapp_signup_m1_logging_enabled") && (yield d(), ((n = o("WAWebInAppSignupInfoCache").getInAppSignupInfo(e)) == null ? void 0 : n.iasOptinDs) == null && (yield p(e, { iasEntryPoint: t })));
	...
	l.ensureInAppSignupInfoHydrated = d, l.clearInAppSignupInfo = m, l.saveOptinDate = f, l.saveEntryPoint = h;
}), 98);
