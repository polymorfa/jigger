	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			if (!r("gkx")("26258") && o("WAWebUA").UA.isChrome && n("cr:5411") != null && n("cr:5411").databases) {
				var a = yield n("cr:5411").databases(), i = new Set(a.map(function(e) {
					return e.name;
				})), l = new Set(t), d = Array.from(i).filter(function(e) {
					return !l.has(e);
				});
				d.length !== 0 && o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["deleteAllIdb: Deletion List missing DBs: ", ""])), d.join(",")).sendLogs("idb-deletion-list-incomplete");
			}
			var m = !1, p = t.map((function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					if (!(e === "__dbnames" || e === "sw" || e === "pb_detect")) try {
						yield o("WAPromiseTimeout").promiseTimeout((u || (u = n("Promise"))).resolve(r("WAWeb-dexie").delete(e)), 7e3);
					} catch (t) {
						m = !0, r("gkx")("26258") || o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose([
