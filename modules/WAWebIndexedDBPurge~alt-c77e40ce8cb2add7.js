__d("WAWebIndexedDBPurge", [
	...
	async function c() {
		...
		if (!r("gkx")("26258") && o("WAWebUA").UA.isChrome && n("cr:5411") != null && n("cr:5411").databases) {
			var a = await n("cr:5411").databases(), i = new Set(a.map(function(e) {
				return e.name;
			})), l = new Set(t), c = Array.from(i).filter(function(e) {
				return !l.has(e);
			});
			c.length !== 0 && o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["deleteAllIdb: Deletion List missing DBs: ", ""])), c.join(",")).sendLogs("idb-deletion-list-incomplete");
		}
		var d = !1, m = t.map(async function(e) {
			if (!(e === "__dbnames" || e === "sw" || e === "pb_detect")) try {
				await o("WAPromiseTimeout").promiseTimeout(Promise.resolve(r("WAWeb-dexie").delete(e)), 7 * 1e3);
			} catch (t) {
				d = !0, r("gkx")("26258") || o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose([
