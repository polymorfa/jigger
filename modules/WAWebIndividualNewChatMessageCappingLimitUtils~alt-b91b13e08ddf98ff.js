__d("WAWebIndividualNewChatMessageCappingLimitUtils", [
	...
	function s() {
		...
		return r ? (R(o("WAWebUserPrefsTypes").NewChatMessageCappingStatusType.NONE), !1) : t.capping_status === o("WAWebUserPrefsTypes").NewChatMessageCappingStatusType.CAPPED;
	}
	function u() {
	...
	function h() {
		...
		if (t == null) return !1;
		var n = o("WATimeUtils").unixTime(), r = n > t.cycle_end_timestamp;
		return r ? (R(o("WAWebUserPrefsTypes").NewChatMessageCappingStatusType.NONE), !1) : t.capping_status === o("WAWebUserPrefsTypes").NewChatMessageCappingStatusType.FIRST_WARNING || t.capping_status === o("WAWebUserPrefsTypes").NewChatMessageCappingStatusType.SECOND_WARNING;
	}
	function y() {
		return h() ? u() : null;
	}
	...
	async function S(t) {
		var n = o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.get(e);
		n != null && await o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.set(e, babelHelpers.extends({}, n, {
	...
	async function R(t) {
		var n = o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.get(e);
		n != null && await o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.set(e, babelHelpers.extends({}, n, { capping_status: t }));
	}
	l.NEW_CHAT_MESSAGE_CAPPING_IDB_KEY = e, l.isUserCapped = s, l.getCappingStatus = u, l.getCappingData = c, l.canSendMsgWhileCapped = d, l.getCappingStatusType = m, l.getCappingOTEStatusType = p, l.getCappingMVStatusType = _, l.getCappingSubscriptionStatusType = f, l.getCappingSubscriptionName = g, l.isUserWarned = h, l.getCappingWarningLevel = y, l.getUsagePercentage = C, l.getCycleEndDateFormatted = b, l.isOTEEligible = v, l.updateCappingDataFromOTEResponse = S, l.resetCappingStatus = R;
}), 98);
