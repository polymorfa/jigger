__d("WAWebInitialSystemMsg", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			if (e.isUser()) {
				if (o("WAWebMobilePlatforms").isSMB() && (yield o("WAWebUserPrefsMultiDevice").getIsHostedMeAccount()) === !0) return [r("nullthrows")(o("WAWebAdvHostedAccountTypeSystemMsg").genAdvMeAccountIsHostedNotificationMsg(e, e))];
			...
			var l = [], s = o("WAWebPrivacyModeSystemMsg").getReducedPrivacyMode(t);
			e: {
				...
				if (s === o("WAWebPrivacyModeSystemMsg").ReducedPrivacyMode.HOSTED_GROUP) {
