__d("WAWebInsertUsernameChangeSystemMsg", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r, a) {
			if (a === void 0 && (a = "unknown"), !!o("WAWebUsernameGatingUtils").usernameDisplayedEnabled()) try {
				var i = new Set(), l = [];
				...
				o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose([
					...
					""
				])), a, t instanceof Error ? t.message : String(t)).sendLogs("username-system-msg-insert-failed");
			}
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.newUsername, r = e.oldUsername, a = e.wid;
			if (!o("WAWebUsernameTypes").isPresentUsername(r) && !o("WAWebUsernameTypes").isPresentUsername(t)) {
				o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[username] old+new username empty ", ""])), a.toLogString()).sendLogs("generateUsernameChangeNotificationSystemMsg-usernames-empty");
				return;
			}
			var i = yield g(a);
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.displayName, n = e.newUsername, r = e.oldUsername, a = e.wid, i = (yield o("WAWebGetChatRecordByAccountLid").getChatRecordByAccountLid(a))[0];
			if (i != null) {
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, r = e.displayName, a = e.newUsername, i = e.oldUsername, l = e.wid, s = o("WAWebSchemaParticipant").getParticipantTable(), c = l.toString(), d = (t = o("WAWebApiContact").getPhoneNumber(l)) == null ? void 0 : t.toString(), m = yield s.anyOf(["participants"], [c, d].filter(Boolean)), p = Array.from(new Set(m.map(function(e) {
				return e.groupId;
			}))), _ = yield o("WAWebSchemaGroupMetadata").getGroupMetadataTable().bulkGet(p);
			yield (u || (u = n("Promise"))).all(p.reduce(function(e, t, n) {
				var s = _[n];
	...
	l.maybeInsertUsernameChangeSystemMsgs = c, l.generateUsernameChangeNotificationSystemMsg = _;
}), 98);
