__d("WAWebInteractiveMessageCarousel.react", [
	...
	function S(e, t) {
		var n = o("react-compiler-runtime").c(2), a;
		n[0] !== t ? (a = function(n) {
			return o("WAWebInteractiveMessageCarouselLogEvents").logViewCarousel(o("WAWebStateUtils").unproxy(t.unsafe()), n);
		}, n[0] = t, n[1] = a) : a = n[1];
		var i = a;
		r("useWAWebMeasureTimeOnScreen")(e, i);
	}
	function R(e) {
		var t = o("react-compiler-runtime").c(10), n = e.children, a = e.msg, i = e.visibilityRef, l = h(), s;
		t[0] !== a ? (s = function(t) {
			return o("WAWebInteractiveMessageCarouselLogEvents").logViewCarouselCard(o("WAWebStateUtils").unproxy(a.unsafe()), t);
		}, t[0] = a, t[1] = s) : s = t[1];
		var u = s;
		...
		var m = r("useWAWebOnScreen")(l, d), _, f;
		t[4] !== m || t[5] !== i ? (_ = function() {
			i(m);
		}, f = [m, i], t[4] = m, t[5] = i, t[6] = _, t[7] = f) : (_ = t[6], f = t[7]), p(_, f);
		var g;
		return t[8] !== n ? (g = c.jsx("span", {
			ref: l,
			children: n
		}), t[8] = n, t[9] = g) : g = t[9], g;
	}
	function L() {
		...
		var n = h(t), r;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (r = function(t, r) {
			n.current[t] = babelHelpers.extends({}, n.current[t], r);
		}, e[1] = r) : r = e[1];
		var a = r, i;
		e[2] === Symbol.for("react.memo_cache_sentinel") ? (i = function(t) {
			var e;
			return (e = n.current[t]) != null ? e : {};
		}, e[2] = i) : i = e[2];
		var l = i, s;
		return e[3] === Symbol.for("react.memo_cache_sentinel") ? (s = [l, a], e[3] = s) : s = e[3], s;
	}
	l.default = b;
}), 98);
