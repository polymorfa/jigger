__d("WAWebInternDogfoodingModal.react", [
	...
	function d() {
		...
		var l = o("WAWebABProps").getABPropConfigValue("web_intern_dogfooding_upsell_content"), d = JSON.parse(l);
		if (d.title == null || d.web_link == null || d.ok_text == null || d.cancel_text == null) return;
		var m = (function() {
