__d("WAWebInvisiblePlaceholderViewModeProcessor", [
	...
	var e = o("WAWebCreateViewModeProcessor").createFullyHiddenViewModeProcessor({
		type: o("WAWebViewMode.flow").ViewModeType.INVISIBLE_PLACEHOLDER,
		compatibleMessageTypes: [o("WAWebMsgType").MSG_TYPE.ALBUM, o("WAWebMsgType").MSG_TYPE.POLL_CREATION]
	});
