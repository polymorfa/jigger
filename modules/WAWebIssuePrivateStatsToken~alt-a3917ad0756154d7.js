__d("WAWebIssuePrivateStatsToken", [
	...
	async function m() {
		...
		try {
			var n = await o("privateStatsToken").getToken(o("WADeprecatedSendIq").deprecatedSendIqWithoutRetry), r = n.metric, a = n.result;
			return r != null && c(r), a || o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Couldn't get a private stats token"]))), a;
		} finally {
			t.release();
		}
	}
