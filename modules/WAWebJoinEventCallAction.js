__d("WAWebJoinEventCallAction", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (t != null) {
				var n = t.data, r = n.callType, a = n.token, i = r === "video", l = o("WAWebChatGetters").getIsGroup(e.chat) ? o("WAWebWamEnumLobbyEntryPointType").LOBBY_ENTRY_POINT_TYPE.EVENT_GROUP_CHAT : o("WAWebWamEnumLobbyEntryPointType").LOBBY_ENTRY_POINT_TYPE.EVENT_INDIVIDUAL_CHAT, s = o("WAWebFrontendContactGetters").getMyUsername(), u = yield o("WAWebVoipStackInterface").getVoipStackInterface();
