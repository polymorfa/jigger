__d("WAWebKaleidoscopeWasmFeatureSupport", ["Promise", "asyncToGeneratorRuntime"], (function(t, n, r, o, a, i) {
	var e, l = null;
	function s() {
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			return l != null || (l = (yield (e || (e = n("Promise"))).all([
				c(),
				_(),
				m()
			])).every(Boolean)), l;
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			try {
				var e = yield WebAssembly.instantiate(new Uint8Array([
					0,
					97,
					115,
					109,
