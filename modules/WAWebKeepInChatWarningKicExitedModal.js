__d("WAWebKeepInChatWarningKicExitedModal", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(10), n = e.content, r = e.onClose, a;
		t[0] !== r ? (a = function() {
			o("WAWebExternalLink.react").openExternalLink(o("WAWebFaqUrl").getEphemeralFaqUrl()), r != null && r(), o("WAWebModalManager").ModalManager.closeSupportOrModal();
		}, t[0] = r, t[1] = a) : a = t[1];
		var i = a, l;
		t[2] !== r ? (l = function() {
			r != null && r(), o("WAWebModalManager").ModalManager.closeSupportOrModal();
		}, t[2] = r, t[3] = l) : l = t[3];
		var c = l, d;
		...
		var p;
		return t[6] !== n || t[7] !== i || t[8] !== c ? (p = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: d,
			onOK: c,
			cancelText: m,
			onCancel: i,
			children: n
		}), t[6] = n, t[7] = i, t[8] = c, t[9] = p) : p = t[9], p;
	}
	function m(e) {
