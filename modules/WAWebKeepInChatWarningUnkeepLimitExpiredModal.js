__d("WAWebKeepInChatWarningUnkeepLimitExpiredModal", [
	"fbt",
	...
	function d(e) {
		var t = e.expiredMessage, n = e.onConfirm, r = e.onDeleteForMe;
		c(function() {
			var e = o("WAWebEphemeralKeepInChatWamUtils").getBaseErrorLog(t, o("WAWebProtobufsE2E.pb").KeepType.UNDO_KEEP_FOR_ALL);
			e.set({ kicErrorCode: o("WAWebWamEnumKicErrorCodeType").KIC_ERROR_CODE_TYPE.KEPT_BEYOND_EXPIRY }), e.commit();
		}, []);
		var a = function() {
