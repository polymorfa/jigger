__d("WAWebKeepInChatWarningUnkeepOwnMsgModal", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = o("react-compiler-runtime").c(12), n = e.onCancel, r = e.onConfirm, a;
		t[0] !== r ? (a = function() {
		...
		var m = d, p;
		t[6] === Symbol.for("react.memo_cache_sentinel") ? (p = {
			surface: "unknown",
		...
		var f;
		return t[8] !== c || t[9] !== i || t[10] !== m ? (f = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: p,
			onOK: i,
			onCancel: c,
			onOverlayClick: m,
			children: _
		}), t[8] = c, t[9] = i, t[10] = m, t[11] = f) : f = t[11], f;
	}
	l.default = c;
}), 226);
