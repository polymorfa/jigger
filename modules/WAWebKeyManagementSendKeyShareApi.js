__d("WAWebKeyManagementSendKeyShareApi", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			e: {
				var l = t;
				if ((typeof l == "object" && l !== null || typeof l == "function") && l.type === "key_rotation" && "keys" in l) {
					var c = l.keys;
					a = m(c), i = yield o("WAWebKeyManagementUtils").getPeerDevices();
					break e;
				}
				if ((typeof l == "object" && l !== null || typeof l == "function") && l.type === "missing_key" && "keys" in l && "orphanKeys" in l && "peerDeviceWid" in l) {
					var d = l.keys, p = l.orphanKeys, _ = l.peerDeviceWid;
					if (a = m(d, p), !o("WAWebUserPrefsMeUser").isMeAccount(_)) {
						o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["syncd: send key share to a non-peer device ", ""])), _.toString()).sendLogs("key-share-non-peer");
						return;
					}
					var f = o("WAWebUserPrefsMeUser").getMeDeviceForOutgoingPeerMessage();
					i = [o("WAWebWidFactory").createDeviceWidFromUserAndDevice(f.user, f.server, _.getDeviceId())];
					break e;
				}
			...
			o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose([
				...
				" due to ",
				""
			])), y, h, t.type), yield o("WAWebApiPeerMessageStore").storePeerMessages(g), yield (u || (u = n("Promise"))).all(g.map(function(e) {
