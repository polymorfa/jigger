	...
	function y(e) {
		...
		return c.jsxs(o("WAWebText_DONOTUSE.react").TextDiv, {
			...
			children: [c.jsx(t, {
				...
				xstyle: m.body,
				children: c.jsx(o("WAWebText_DONOTUSE.react").TextSpan, { children: n })
			})]
		});
	}
	y.displayName = y.name + " [from " + i.id + "]", l.shouldShowKicNux = p, l.openKicNux = _, l.openKicNuxAndWaitForClose = f, l.useKicNux = g;
}), 226);
