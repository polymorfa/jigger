__d("WAWebKmpSyncdServiceLocator", [
	"WAWebKmpAbProps",
	"WAWebKmpBuildInfo",
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = {
				...
				derivedSyncdKeysProvider: o("WAWebKmpDerivedSyncdKeysProvider").derivedSyncdKeysProvider,
				externalMutationDownloader: o("WAWebKmpExternalMutationDownloader").externalMutationDownloader,
				externalMutationUploader: o("WAWebKmpExternalMutationUploader").externalMutationUploader,
				incomingCollectionsJobQueue: o("WAWebKmpIncomingCollectionsJobQueue").incomingCollectionsJobQueue,
				...
				mutationProcessorStore: o("WAWebKmpMutationProcessorStore").mutationProcessorStore,
				syncdKeyManager: o("WAWebKmpSyncdKeyManager").syncdKeyManager,
				wamLogger: yield o("WAWebKmpWamLogger").getWamLogger(),
				incomingMutationHandler: o("WAWebKmpSyncdIncomingMutationHandler").incomingMutationHandler
			};
			o("wa-kmp-syncd-engine-api").JsKmpSyncdServiceLocator.init(e);
		}), u.apply(this, arguments);
	}
	function c() {
		return o("wa-kmp-syncd-engine-api").JsKmpSyncdServiceLocator.isInitialized();
	}
	function d() {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			return yield d(), e == null && (e = new (o("wa-kmp-syncd-engine-api")).JsOutgoingProcessor()), e;
