__d("WAWebKyberPreKeyStore", [
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield o("WAWebSignalStorage").getMetaTable().get(o("WAWebSignalConst").META_KEYS.NEXT_KYBER_PK_ID);
			return p(e, m);
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			return o("WAWebSignalStorageUtils").getStorage().lock(["signal-meta-store"], n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var t = yield o("WAWebSignalStorage").getMetaTable().get(o("WAWebSignalConst").META_KEYS.NEXT_KYBER_PK_ID), n = p(t, m);
				return yield o("WAWebSignalStorage").getMetaTable().createOrReplace({
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			t.length !== 0 && (yield o("WAWebSignalStorageUtils").getStorage().lock(["kyber-prekey-store"], n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAWebSignalStorage").getKyberPreKeyTable().bulkCreateOrReplace(t);
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			yield o("WAWebSignalStorageUtils").getStorage().lock(["kyber-last-resort-key-store"], n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAWebSignalStorage").getKyberLastResortKeyTable().createOrReplace(e);
	...
	function T() {
		return T = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield o("WAWebSignalStorage").getKyberLastResortKeyTable().all();
	...
	function P() {
		return P = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield (d || (d = n("Promise"))).all([o("WAWebSignalStorage").getKyberPreKeyTable().all(), o("WAWebSignalStorage").getKyberLastResortKeyTable().all()]), t = e[0], r = e[1];
			return {
				...
				kyberLastResortKeys: r.map(function(e) {
					return {
						keyId: e.keyId,
						publicKey: new Uint8Array(e.keyPair.pubKey),
	...
	function M() {
		return M = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			yield (d || (d = n("Promise"))).all(e.map((function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var n = yield t.get(e);
					n != null && (yield t.createOrReplace(babelHelpers.extends({}, n, { sentToServer: !0 })));
				});
				return function(t) {
	...
	function O() {
		return O = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			yield o("WAWebSignalStorageUtils").getStorage().lock([
				...
				var e = yield (d || (d = n("Promise"))).all([o("WAWebSignalStorage").getKyberPreKeyTable().all(), o("WAWebSignalStorage").getKyberLastResortKeyTable().all()]), t = e[0], r = e[1];
				yield d.all([].concat(t.map(function(e) {
	...
	function W() {
		return W = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield o("WAWebSignalStorage").getMetaTable().get(o("WAWebSignalConst").META_KEYS.PQ_MIGRATED), t = _(e);
			return t;
	...
	function U() {
		return U = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			yield o("WAWebSignalStorage").getMetaTable().createOrReplace({
				key: o("WAWebSignalConst").META_KEYS.PQ_MIGRATED,
				value: e
			});
		}), U.apply(this, arguments);
	}
	l.getNextKyberPreKeyId = f, l.getNextKyberLastResortKeyId = h, l.reserveKyberPreKeyIds = C, l.saveKyberPreKeys = v, l.saveKyberLastResortKey = R, l.loadKyberPreKey = E, l.loadLatestKyberLastResortKey = I, l.getUnsentKyberPreKeys = D, l.loadKyberKeysForDigest = $, l.markKyberPreKeysAsSent = N, l.removeKyberPreKey = w, l.clearKyberPreKeysAndMigrationState = F, l.isPQMigrated = B, l.setPQMigrated = q;
}), 98);
