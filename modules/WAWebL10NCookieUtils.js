__d("WAWebL10NCookieUtils", [
	...
	function u() {
		return o("WAWebRuntimeEnvironmentUtils").isWorker() ? null : o("WAWebCookieManager").getCookie(e);
	}
	l.setWAWebLocalePrefCookieValue = s, l.getWAWebLocalePrefCookieValue = u;
}), 98);
