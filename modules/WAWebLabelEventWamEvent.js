__d("WAWebLabelEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ LabelEvent: [
		1422,
		{
			...
			labelOperation: [2, o("WAWebWamEnumLabelOperations").LABEL_OPERATIONS],
			labelOperationEntryPoint: [6, e.TYPES.STRING],
			labelTarget: [1, o("WAWebWamEnumLabelTargets").LABEL_TARGETS],
			lastMessageDirection: [14, o("WAWebWamEnumLastMessageDirection").LAST_MESSAGE_DIRECTION],
			messageDepth: [15, e.TYPES.INTEGER],
			predefinedLabelNumber: [3, e.TYPES.INTEGER],
			smbListFeatureName: [19, o("WAWebWamEnumSmbListFeatureNameType").SMB_LIST_FEATURE_NAME_TYPE],
			smbListSurface: [20, o("WAWebWamEnumSmbListSurfaceType").SMB_LIST_SURFACE_TYPE],
