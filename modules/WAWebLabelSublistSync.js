__d("WAWebLabelSublistSync", [
	...
	var e, s, u, c, d = (function(t) {
		...
		return i.getVersion = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var r = this, a = 0, i = 0, l = yield (c || (c = n("Promise"))).all(t.map((function() {
					var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
						var n = t.indexParts, l = n[1], s = n[2];
						try {
							if (t.operation === "set") {
								var u;
								if (!l || !s) return {
								...
								var d = (u = t.value.labelSublistAction) == null ? void 0 : u.subListId;
								if (d == null) return a++, {
									result: o("WAWebSyncdIndexUtils").malformedActionValue(r.collectionName),
									add: null,
									remove: null
								};
				...
				for (var f of l) {
					var g = f.add, h = f.remove;
					g != null && (d.push(g), p.push(g)), h != null && (m.push(h.pk), _.push({
						predefinedId: h.predefinedId,
						chatJid: h.chatJid
					}));
				}
				a > 0 && o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[syncd][label-sublist]: ", " malformed mutations"])), a), i > 0 && o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[syncd][label-sublist]: ", " unsupported operations"])), i), yield c.all(m.map(function(e) {
					return o("WAWebDBLabelSublistDatabaseApi").removeLabelSublist(e);
				})), yield c.all(d.map(function(e) {
					return o("WAWebDBLabelSublistDatabaseApi").addOrEditLabelSublist(e);
				}));
				for (var y of p) o("WAWebBackendApi").frontendFireAndForget("syncLeadSublist", y);
				for (var C of _) o("WAWebBackendApi").frontendFireAndForget("removeLeadSublistFromCollection", C);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				var t = o("WAWebWidFactory").createWid(e), n = yield o("WAWebSyncdGetChat").resolveChatForMutationIndex(t);
				if (n.success === !0) t = o("WAWebWidFactory").createWid(n.chat.id);
				else if (o("WAWebLid1X1MigrationGating").Lid1X1MigrationUtils.isLidMigrated() && t.isLid()) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = e.chatJid, n = e.predefinedId, r = e.subListId, a = o("WATimeUtils").unixTimeMs(), i = yield o("WAWebSyncdGetChat").getWidMutationIndexForWid(o("WAWebWidFactory").createWid(t)), l = { labelSublistAction: { subListId: r } };
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = e.chatJid, n = e.predefinedId, r = o("WATimeUtils").unixTimeMs(), a = yield o("WAWebSyncdGetChat").getWidMutationIndexForWid(o("WAWebWidFactory").createWid(t));
				return o("WAWebSyncdActionUtils").buildPendingMutation({
					collection: this.collectionName,
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, r) {
				...
				yield o("WAWebSyncdCoreApi").lockForSync(["label_sublist"], [a], n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					yield o("WAWebDBLabelSublistDatabaseApi").addOrEditLabelSublist({
						predefinedId: e,
						chatJid: t,
						subListId: r
					});
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				...
				yield o("WAWebSyncdCoreApi").lockForSync(["label_sublist"], [r], n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					yield o("WAWebDBLabelSublistDatabaseApi").removeLabelSublist(o("WAWebSchemaLabelSublist").createLabelSublistPrimaryKey({
						predefinedId: e,
						chatJid: t
					}));
	...
	})(o("WAWebSyncdAction").ChatOrContactSyncdActionBase), m = new d();
	l.default = m;
}), 98);
