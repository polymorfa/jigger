__d("WAWebLandingFooter.react", [
	...
	function p(e) {
		var t = o("react-compiler-runtime").c(13), n = e.isWebReg, a = e.onGetStartedNav, i = e.smsRegistration, l;
		...
		var u = o("WAWebAppRootInteractionContext.react").useInteractionWithAppRootContext(l), d = u.startInteraction, p;
		t[1] !== a || t[2] !== d ? (p = async function() {
			d(), await a();
		}, t[1] = a, t[2] = d, t[3] = p) : p = t[3];
		var g = p, h;
		t[4] !== g || t[5] !== n || t[6] !== i ? (h = o("WAWebLandingPromoGating").isLandingPromoEnabled() ? c.jsx(f, {
			isWebReg: n,
			smsRegistration: i
		}) : c.jsx(_, {
			isWebReg: n,
			onClick: g
		}), t[4] = g, t[5] = n, t[6] = i, t[7] = h) : h = t[7];
		var y;
		t[8] === Symbol.for("react.memo_cache_sentinel") ? (y = c.jsx(o("WAWebFlex.react").FlexItem, { children: c.jsx(o("WAWebLockOutlineIcon.react").LockOutlineIcon, {
			width: 20,
			iconXstyle: m.e2ee
		}) }), t[8] = y) : y = t[8];
		var C, b;
		t[9] === Symbol.for("react.memo_cache_sentinel") ? (C = c.jsxs(o("WAWebFlex.react").FlexRow, {
			columnGap: 4,
			align: "center",
			children: [y, c.jsx(o("WAWebFlex.react").FlexItem, {
				xstyle: m.e2ee,
				children: s._(
					/*BTDS*/
					""
		...
		}), b = c.jsx(o("WAWebLinkDeviceCommonInstructions.react").TCLink, {}), t[9] = C, t[10] = b) : (C = t[9], b = t[10]);
		var v;
		return t[11] !== h ? (v = c.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "center",
