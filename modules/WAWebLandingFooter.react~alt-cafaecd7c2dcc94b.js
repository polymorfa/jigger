__d("WAWebLandingFooter.react", [
	...
	function p(e) {
		var t = e.isWebReg, a = e.onGetStartedNav, i = e.smsRegistration, l = o("WAWebAppRootInteractionContext.react").useInteractionWithAppRootContext({
			manualHold: !1,
			shouldUseNavigationAsInteraction: !0,
			tracePolicy: r("WAWebInteractionTracePolicy").NAVIGATION_LOGIN_GET_STARTED
		}), u = l.startInteraction, d = (function() {
