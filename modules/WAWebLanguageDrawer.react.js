__d("WAWebLanguageDrawer.react", [
	...
	function d(t) {
		var a = t.onClose, i = t.ref, l = c(o("WAWebL10nGetRenderedLocale").WAWebL10nGetRenderedLocale()), s = l[0], d = l[1], m = c([]), p = m[0], _ = m[1];
		function f() {
			return g.apply(this, arguments);
		}
		function g() {
			return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = r("WAWebL10N").getLocale(), t = yield o("WAWebLocaleToLanguages").getLanguageNames(e);
				return t;
		...
		var C = r("useWAWebAsync")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var t = yield h(), n = yield f(), a = r("WAWebL10N").getLocale(), i = [];
			...
			}), i.length === 0 && o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[l10n] WAWebLanguageDrawer: no langs from getLanguageNames"]))), _(i);
		}), []);
		function b(e) {
			d(e), o("WAWebModalManager").ModalManager.open(u.jsx(r("VultureJSDeadComponent.react"), { name: "WAWebConfirmLanguageModal" }));
		}
		var v = null;
		return C.loading || C.error ? v = u.jsx(o("WAWebSpinner.react").Spinner, {}) : v = u.jsx(o("WAWebRadio.react").RadioGroup, {
			name: "language",
