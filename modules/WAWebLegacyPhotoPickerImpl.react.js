__d("WAWebLegacyPhotoPickerImpl.react", [
	...
	function _() {
		...
		return t[0] === Symbol.for("react.memo_cache_sentinel") ? (n = c.jsx("hr", babelHelpers.extends({}, (e || (e = r("stylex"))).props(o("WAWebPhotoPickerStyle").styles.separator, o("WDSMargins.stylex").wdsMargins.marginVer4, m.marginInline1))), t[0] = n) : n = t[0], n;
	}
	l.default = p;
}), 226);
