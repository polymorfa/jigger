__d("WAWebLidMigrationDailyWamEvent", ["WAWebWamCodegenUtils", "WAWebWamEnumLidMigrationSourceType"], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ LidMigrationDaily: [
		5842,
		{
			completedMigrations: [1, e.TYPES.STRING],
			lidMigrationSource: [7, o("WAWebWamEnumLidMigrationSourceType").LID_MIGRATION_SOURCE_TYPE],
			...
			numberOfPnOnlyGroupsNotMemberUnmappedContacts: [22, e.TYPES.INTEGER],
			numberOfPnOnlyGroupsNotMemberUnmappedOutContacts: [23, e.TYPES.INTEGER],
