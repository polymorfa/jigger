__d("WAWebLinkDeviceApiCmdTooltip.react", [
	...
	function p(t) {
		var n = o("react-compiler-runtime").c(4), a, i;
		n[0] === Symbol.for("react.memo_cache_sentinel") ? (a = { className: "x10l6tqk x10w3d4m xbudbmw xvue9z xo5owp6 x1plvlek xryxfnj x2b8uid" }, i = (e || (e = r("stylex"))).props(m.tooltip, d.paddingBlock15, o("WDSPaddings.stylex").wdsPaddings.paddingHor20), n[0] = a, n[1] = i) : (a = n[0], i = n[1]);
		var l;
		return n[2] !== t.tip ? (l = c.jsx("div", babelHelpers.extends({}, a, { children: c.jsx("div", babelHelpers.extends({}, i, { children: t.tip })) })), n[2] = t.tip, n[3] = l) : l = n[3], l;
	}
	function _(e) {
		var t = o("react-compiler-runtime").c(3), n = e.apiCmd;
		if (n) switch (n.resultType) {
			case o("WAWebApi").APICmd.GROUP_INVITE: {
				var r;
				return t[0] === Symbol.for("react.memo_cache_sentinel") ? (r = c.jsx(p, { tip: s._(
					/*BTDS*/
					"",
			...
			case o("WAWebApi").APICmd.MSG_SEND: {
				var a;
				return t[1] === Symbol.for("react.memo_cache_sentinel") ? (a = c.jsx(p, { tip: s._(
					/*BTDS*/
					"",
					[s._implicitParam("=m1", c.jsx(o("WAWebFbtAppName").WAWebAppShortName, { children: s._(
						/*BTDS*/
		...
		var i;
		return t[2] === Symbol.for("react.memo_cache_sentinel") ? (i = c.jsx(c.Fragment, {}), t[2] = i) : i = t[2], i;
	}
	l.default = _;
}), 226);
