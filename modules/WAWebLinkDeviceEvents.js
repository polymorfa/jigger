__d("WAWebLinkDeviceEvents", ["WAWebEventEmitter"], (function(t, n, r, o, a, i, l) {
	var e = (function(e) {
		function t() {
		...
		var n = t.prototype;
		return n.triggerRefreshAltLinkingCode = function() {
			...
			this.trigger("link_device_events:shortcake_verification_code_ready", t, n);
