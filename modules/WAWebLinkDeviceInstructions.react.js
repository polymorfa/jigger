__d("WAWebLinkDeviceInstructions.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = o("react-compiler-runtime").c(6), n = e.codeType, a;
		...
		e: switch (n) {
			case o("WAWebLinkDeviceCodeViewCodeType").LinkDeviceCodeViewCodeType.QR: {
				var l;
				t[1] === Symbol.for("react.memo_cache_sentinel") ? (l = c(), t[1] = l) : l = t[1], i = l;
				break e;
			}
			case o("WAWebLinkDeviceCodeViewCodeType").LinkDeviceCodeViewCodeType.PHONE_NUMBER_LINK_CODE: {
				var u;
				t[2] === Symbol.for("react.memo_cache_sentinel") ? (u = d(), t[2] = u) : u = t[2], i = u;
			}
		}
		var m = i, p = String(n), _;
		return t[3] !== i || t[4] !== p ? (_ = s.jsx(r("WAWebLinkDeviceInstructionsList.react"), {
			instructions: m,
			instructionSource: p
		}), t[3] = i, t[4] = p, t[5] = _) : _ = t[5], _;
	}
	function c() {
		return [
