__d("WAWebLinkDevicePhoneNumber.react", [
	...
	function y(t) {
		var a = g(h.STEP1_PHONE_NUMBER_ENTRY), i = a[0], l = a[1], m = g(null), _ = m[0], y = m[1], C = g(null), b = C[0], v = C[1], S = g(!1), R = S[0], L = S[1], E = function() {
		...
		}, T = r("useWAWebStableCallback")((function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				y(e), L(!1), l(h.STEP2_DISPLAY_CODE);
				try {
					if (r("WAWebNetworkStatus").online) {
						var n = yield o("WAWebLinkDeviceAction").genLinkDeviceCodeForPhoneNumber(e, t);
						v(n);
					}
				} catch (e) {
					if (o("WAWebAltDeviceLinkingQpl").addPointToCurrentMarker("gen_code_exception"), yield o("WAWebLinkDeviceAction").resetLinkDeviceState({ linkDeviceMethod: o("WAWebPairingType").PairingType.ALT_DEVICE_LINKING }), e instanceof o("WAWebAltDeviceLinkingIq").CompanionHelloError) {
						var a;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				i !== h.STEP2_DISPLAY_CODE || _ == null || (v(null), o("WAWebAltDeviceLinkingQpl").addPointToCurrentMarker("refresh_code"), yield o("WAWebLinkDeviceAction").resetLinkDeviceState({ linkDeviceMethod: o("WAWebPairingType").PairingType.ALT_DEVICE_LINKING }), yield T(_, !1));
			});
			return function() {
				return e.apply(this, arguments);
			};
		...
		switch (o("useWAWebListener").useListener(o("WAWebLinkDeviceEvents").WAWebLinkDeviceEvents, "link_device_events:refresh_alt_linking_code", D), o("useWAWebListener").useListener(r("WAWebNetworkStatus"), "change:online", function() {
			...
			case h.STEP2_DISPLAY_CODE: return p.jsx(r("WAWebLinkDevicePhoneNumberCodeScreen.react"), {
				...
				onClickEditPhoneNumber: n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					yield o("WAWebLinkDeviceAction").resetLinkDeviceState({ linkDeviceMethod: o("WAWebPairingType").PairingType.ALT_DEVICE_LINKING }), l(h.STEP1_PHONE_NUMBER_ENTRY), v(null);
				}),
