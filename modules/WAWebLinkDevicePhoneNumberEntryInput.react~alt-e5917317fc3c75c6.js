__d("WAWebLinkDevicePhoneNumberEntryInput.react", [
	...
	function g(t) {
		var n = t.a11yErrorMessage, a = t.countryCodeIso, i = t.icon, l = t.onBlur, u = t.onChange, d = t.onEnter, g = t.onFocus, h = t.phoneNumberWithoutCountryPrefix, y = t.ref, C = t.theme, b = t.xstyle, v = n.errorMessageDOMId, S = n.errorShown, R = C != null ? C === "wds" : o("WAWebHybridRegGating").isHybridRegEnabled(), L = _(!1), E = L[0], k = L[1], I = p(null);
		return m(y, function() {
			...
			dir: "ltr",
			children: c.jsx("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(R ? f.inputWrapperWds : f.inputWrapper, E && !R && f.inputWrapperFocused, b), { children: c.jsx(r("WAWebPhoneNumberInput.react"), {
				theme: R ? "wds" : "default",
				countryCodeIso: a,
				errorMessageDOMId: v,
				errorShown: S,
