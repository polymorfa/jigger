__d("WAWebLinkDeviceQrcode.react", [
	...
	function N(t) {
		var n = t.children, a = t.onLoadingComplete, i = t.theme, l = n, s = f(null), c = g(!1), m = c[0], k = c[1], $ = g(null), P = $[0], N = $[1], M = g(null), w = M[0], A = M[1], F = r("useWAWebDebouncedCallback")(function() {
			k(!0);
		...
		return r("gkx")("26258") || (j = H, w != null && (K = d.jsx("div", {
			...
			onKeyDown: function(t) {
				t.key === "Escape" ? A(null) : (t.key === "Enter" || t.key === " ") && (t.preventDefault(), G());
			},
			style: {
				position: "absolute",
				top: 0,
	...
	function M(e) {
		var t = o("react-compiler-runtime").c(14), n = e.onLoadingComplete, a = e.theme, i = a === "wds" && $.qrCodeWarningThemed, l;
		t[0] !== i ? (l = [
			$.qrCodeWarning,
			i,
			$.qrCodeOfflineWarning,
		...
		var u = a === "wds" && $.qrCodeWarningIconThemed, c;
		t[2] !== u ? (c = d.jsx(o("WAWebFlex.react").FlexItem, {
			xstyle: k.marginBottom10,
			children: d.jsx(o("WAWebConnectionIcon.react").ConnectionIcon, {
				width: 48,
				height: 48,
				iconXstyle: [$.qrCodeWarningIcon, u]
			})
		}), t[2] = u, t[3] = c) : c = t[3];
		var m;
		t[4] === Symbol.for("react.memo_cache_sentinel") ? (m = d.jsx(o("WAWebFlex.react").FlexItem, {
			justify: "center",
			align: "center",
			children: s._(
				/*BTDS*/
		...
		var p;
		t[5] !== c ? (p = d.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "center",
			justify: "center",
			children: [c, m]
		}), t[5] = c, t[6] = p) : p = t[6];
		var _;
		t[7] !== l || t[8] !== p ? (_ = d.jsx(r("WAWebUnstyledButton.react"), {
			xstyle: l,
			onClick: B,
			children: p
		}, "offline"), t[7] = l, t[8] = p, t[9] = _) : _ = t[9];
		var f;
		return t[10] !== n || t[11] !== _ || t[12] !== a ? (f = d.jsx(N, {
			onLoadingComplete: n,
			theme: a,
			children: _
	...
	function w(e) {
		var t = o("react-compiler-runtime").c(14), n = e.onLoadingComplete, a = e.theme, i = A, l = a === "wds" && $.qrCodeWarningThemed, u;
		t[0] !== l ? (u = [
			$.qrCodeWarning,
			l,
			o("WDSMargins.stylex").wdsMargins.marginAuto,
		...
		var c = a === "wds" && $.qrCodeWarningIconThemed, m;
		t[2] !== c ? (m = d.jsx(o("WAWebFlex.react").FlexItem, {
			xstyle: k.marginBottom10,
			children: d.jsx(o("WAWebRefreshLargeIcon.react").RefreshLargeIcon, { iconXstyle: [$.qrCodeWarningIcon, c] })
		}), t[2] = c, t[3] = m) : m = t[3];
		var p;
		t[4] === Symbol.for("react.memo_cache_sentinel") ? (p = d.jsx(o("WAWebFlex.react").FlexItem, { children: s._(
			/*BTDS*/
			""
		) }), t[4] = p) : p = t[4];
		var _;
		t[5] !== m ? (_ = d.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "center",
			justify: "center",
			children: [m, p]
		}), t[5] = m, t[6] = _) : _ = t[6];
		var f;
		t[7] !== u || t[8] !== _ ? (f = d.jsx(r("WAWebUnstyledButton.react"), {
			xstyle: u,
			onClick: i,
			children: _
		}, "expiry"), t[7] = u, t[8] = _, t[9] = f) : f = t[9];
		var g;
		return t[10] !== n || t[11] !== f || t[12] !== a ? (g = d.jsx(N, {
			onLoadingComplete: n,
			theme: a,
			children: f
	...
	function A() {
		S.onReady(F), o("WAWebBackendEventBus").BackendEventBus.triggerRefreshQR();
	}
	function F(e) {
	...
	function O() {
		...
		var n;
		return e[1] === Symbol.for("react.memo_cache_sentinel") ? (n = d.jsx("span", babelHelpers.extends({}, t, { children: d.jsxs("svg", {
