__d("WAWebLinkDeviceScreen.react", [
	...
	function v(e) {
		var t = e.apiCmd, n = e.upsellBannerType, a = [C.upsellBannerContainer];
		return n === o("useWAWebDesktopUpsellQRCodeBannerType").WAWebDesktopUpsellQRCodeBannerType.SLIM && u.jsx("div", {
			className: "x1lliihq xh8yej3",
			children: u.jsx(r("WAWebDesktopUpsellQRCodeSlimBanner.react"), { apiCmd: t })
		});
	}
