__d("WAWebLinkDeviceScreen.react", [
	...
	function b(e) {
		var t = e.apiCmd, n = e.upsellBannerType, a = [y.upsellBannerContainer];
		return n === o("useWAWebDesktopUpsellQRCodeBannerType").WAWebDesktopUpsellQRCodeBannerType.SLIM && s.jsx("div", {
			className: "x1lliihq xh8yej3",
			children: s.jsx(r("WAWebDesktopUpsellQRCodeSlimBanner.react"), { apiCmd: t })
		});
	}
