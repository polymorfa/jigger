__d("WAWebLinkFormatMutator", [
	...
	var e, s, u = s || (s = o("react")), c = (function(t) {
		...
		return babelHelpers.inheritsLoose(n, t), n.jsx = function(n, o, a) {
			var t = a.dataTab, i = a.linkXstyle, l = a.onLinkClick, s = a.selectable, c = s === void 0 ? !1 : s, d = o.href, m = o.suspiciousCharacters;
			return m != null && m.size ? u.jsx(r("WAWebSuspiciousLinkMutatorComponent.react"), {
				onClick: l,
	...
	c.format = !1, c.compatibility = !0, c.match = function(e, t, n) {
		if (!t) return [];
		var r = t.links, o = r === void 0 ? [] : r;
		return o.map(d);
	...
	function d(e) {
		var t = e.index, n = e.url, r = t + n.length - 1;
		return [
			t,
			t,
			r,
	...
	function m(e, t) {
		for (var n = 0, r = 0; n < e.length && r < t.length;) {
			...
			if (o > 0) n++;
				...
				e[n][2] -= a, e[n][3] -= a;
				var i = e[n][5];
				i.href = i.href.slice(0, -a), i.path = i.path && i.path.slice(0, -a), i.url = i.url.slice(0, -a), r++, n++;
			}
		}
	}
	l.default = c;
