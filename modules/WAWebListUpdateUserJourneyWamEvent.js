__d("WAWebListUpdateUserJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ListUpdateUserJourney: [
		5958,
		{
			...
			listUpdateUserJourneyAction: [4, o("WAWebWamEnumListUpdateUserJourneyAction").LIST_UPDATE_USER_JOURNEY_ACTION],
			predefinedId: [5, e.TYPES.INTEGER],
			presetListCount: [8, e.TYPES.INTEGER],
			previousMigrationBucket: [10, e.TYPES.INTEGER],
			updateEntryPoint: [6, o("WAWebWamEnumUpdateEntryPoint").UPDATE_ENTRY_POINT],
