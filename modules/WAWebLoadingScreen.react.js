__d("WAWebLoadingScreen.react", [
	...
	var e, u, c = u || (u = o("react")), d = u.memo, m = "x1w1lziz-B", p = {
		graphic: {
			marginTop: "x1cm6mvd",
			color: "xsq9etf",
	...
	function g(t) {
		...
		var i = t.theme, l = i === void 0 ? f.MULTI_STAGE : i, u = t.stage === _.INITIAL_LOAD, d = t.stage === _.DOWNLOADING, m = t.stage === _.ORGANIZING, g = t.onLogout != null && !u && l !== f.LOGO, y = {
			...
			0: "x10l6tqk x11eg80g x1ahifba x1kuhel0 xh8yej3 x1f6kntn xhslqc4 x2b8uid xg01cxk",
			2: "x10l6tqk x11eg80g x1kuhel0 xh8yej3 x1f6kntn xhslqc4 x2b8uid x1hc1fzr x5epzj0",
			1: "x10l6tqk x11eg80g x1ahifba x1kuhel0 xh8yej3 x1f6kntn xhslqc4 x2b8uid xg01cxk x1lrmtmu",
			3: "x10l6tqk x11eg80g x1kuhel0 xh8yej3 x1f6kntn xhslqc4 x2b8uid x1hc1fzr x5epzj0 x1lrmtmu"
		}[!!d << 1 | !!d << 0], b;
		switch (l) {
			case f.MULTI_STAGE:
				switch (t.stage) {
		...
		var v = [p.graphic];
		return (l === f.LOGO || l === f.MULTI_STAGE && (u || m)) && v.push(p.shimmeringWWW), c.jsxs("div", {
			"data-testid": "wa-web-loading-screen",
			className: "x78zum5 xdt5ytf x6s0dn4 xl56j7k xh8yej3 x5yr21d x87ps6o x6egj2d",
			children: [
				c.jsx(r("CometHeroHoldTrigger.react"), {
					description: "WAWebLoadingScreen_" + String(t.stage),
					hold: !0
				}),
				c.jsx("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(v), { children: c.jsx(h, {}) })),
				c.jsx("div", {
					className: "x1c3i2sq x14ug900 xk82a7y x1nmyh1g",
					children: b
				}),
				c.jsx("div", {
					className: "x1n2onr6 x1oysuqx xqu0tyb xbrszos xea3l6g x18isctg x2q3nzr x6ikm8r x10wlt62 xk82a7y xevwqry",
	...
	function h() {
		...
		return e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = c.jsx("span", { children: c.jsx("svg", {
			width: "250px",
			height: "52px",
			viewBox: "0 0 250 52",
			version: "1.1",
