__d("WAWebLockedChatsDrawer.react", [
	...
	function y(e) {
		var t = o("react-compiler-runtime").c(49), n = e.entryPoint, a = e.focusOnMount, i = e.onClose, l = e.ref, c = e.unlockEntryPoint, m = a === void 0 ? !0 : a, y = o("useWAWebSearchModel").useSearchModel(b), S = y.query, R = y.results, L = o("useWAWebOpenChat").useOpenChat(), E = L.openedChat, k = _(!1), I = k[0], T = k[1], D = R == null ? void 0 : R.query.searchText, x = D != null && D !== "", $;
		t[0] !== D || t[1] !== S || t[2] !== (R == null ? void 0 : R.query.options) ? ($ = function() {
			S(D != null ? D : "", R == null ? void 0 : R.query.options);
		}, t[0] = D, t[1] = S, t[2] = R == null ? void 0 : R.query.options, t[3] = $) : $ = t[3], o("useWAWebListener").useListener(o("WAWebChatCollection").ChatCollection, "change add remove", $);
		var P;
		t[4] !== n || t[5] !== c ? (P = {
		...
		}, t[4] = n, t[5] = c, t[6] = P) : P = t[6];
		var N = o("useWAWebChatLockRestriction").useChatLockRestriction(P), M, w;
		t[7] !== n || t[8] !== N ? (M = function() {
		...
		}, w = [N, n], t[7] = n, t[8] = N, t[9] = M, t[10] = w) : (M = t[9], w = t[10]), d(M, w), r("useWAWebOnUnmount")(o("WAWebChatLockUtils").closeActiveChatIfLocked);
		var A;
		if (t[11] !== (R == null ? void 0 : R.results)) {
			var F;
			A = (F = R == null ? void 0 : R.results.map(C)) != null ? F : [], t[11] = R == null ? void 0 : R.results, t[12] = A;
		} else A = t[12];
		var O = A, B;
		...
		var W = B, q;
		t[14] === Symbol.for("react.memo_cache_sentinel") ? (q = o("WAWebMiscGatingUtils").isPrivacyNarrativeV1Enabled() ? u.jsx(o("WAWebPrivacyNarrativeE2EMessage.react").E2eMessageChatList, { tabOrder: o("WAWebTabOrder").TAB_ORDER.DRAWER_FOOTER }) : null, t[14] = q) : q = t[14];
		var U = q, V = p(null), H = p(null), G;
		t[15] === Symbol.for("react.memo_cache_sentinel") ? (G = new Map(), t[15] = G) : G = t[15];
		var z = p(G), j;
		t[16] === Symbol.for("react.memo_cache_sentinel") ? (j = function(t, n) {
		...
		if (t[18] !== Y || t[19] !== O) {
			...
			}, t[18] = Y, t[19] = O, t[20] = Z, t[21] = ee;
		} else Z = t[20], ee = t[21];
		var ne;
		t[22] !== I ? (ne = function(t) {
			var e = V.current, n = t.relatedTarget;
			!h(e, n) || e != null && e.contains(n) || I || J({
				index: -1,
				id: ""
			});
		}, t[22] = I, t[23] = ne) : ne = t[23];
		var re = ne, oe;
		t[24] !== Z || t[25] !== O || t[26] !== E ? (oe = function(t) {
			var e = t.target, n = V.current;
			if (!(!h(n, e) || e !== n)) {
				var r = 0;
				if (E != null) {
		...
		}, t[24] = Z, t[25] = O, t[26] = E, t[27] = oe) : oe = t[27];
		var ae = oe, ie;
		t[28] === Symbol.for("react.memo_cache_sentinel") ? (ie = new (r("WAWebFlatListController"))(), t[28] = ie) : ie = t[28];
		var le = ie, se;
		t[29] === Symbol.for("react.memo_cache_sentinel") ? (se = s._(
			/*BTDS*/
			""
		), t[29] = se) : se = t[29];
		var ue = i == null ? o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.TAB : o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.SMALL, ce;
		t[30] !== i || t[31] !== ue ? (ce = u.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			title: se,
			onBack: i,
			type: ue
		}), t[30] = i, t[31] = ue, t[32] = ce) : ce = t[32];
		var de;
		t[33] !== Y || t[34] !== re || t[35] !== ae || t[36] !== ee || t[37] !== x || t[38] !== O || t[39] !== E ? (de = O.length === 0 ? u.jsx(o("WAWebEmptyState.react").Empty, { title: x ? s._(
			/*BTDS*/
			""
		) : s._(
			/*BTDS*/
					...
					children: u.jsx(o("WAWebFlatList.react").FlatList, {
						...
						renderItem: function(t) {
							return u.jsx(r("WAWebChatCellV2.react"), {
								...
								active: g(t.chat) === Y.id,
								applyFocusStyles: !1,
								chat: t.chat,
								contextMenuItems: v(t.chat),
								forceActive: E != null && g(E) === g(t.chat),
								showCommunityInfo: !0,
		...
		}), t[33] = Y, t[34] = re, t[35] = ae, t[36] = ee, t[37] = x, t[38] = O, t[39] = E, t[40] = de) : de = t[40];
		var me;
		t[41] !== m || t[42] !== S || t[43] !== de ? (me = u.jsx(r("WAWebDrawerBody.react"), { children: u.jsxs(o("WAWebSearchInput").DrawerSearchInput, {
			tabOrder: o("WAWebTabOrder").TAB_ORDER.DRAWER_CONTENT,
			onSearch: S,
			focusOnMount: m,
			placeholder: W,
			children: [de, U]
		}) }), t[41] = m, t[42] = S, t[43] = de, t[44] = me) : me = t[44];
		var pe;
		return t[45] !== l || t[46] !== ce || t[47] !== me ? (pe = u.jsxs(r("WAWebDrawer.react"), {
			ref: l,
			theme: "archived",
			testid: "settings-drawer",
			tsNavigationData: f,
			children: [ce, me]
		}), t[45] = l, t[46] = ce, t[47] = me, t[48] = pe) : pe = t[48], pe;
	}
	function C(e) {
