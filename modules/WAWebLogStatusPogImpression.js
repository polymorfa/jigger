__d("WAWebLogStatusPogImpression", [
	"Promise",
	"WAWebClock",
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.msg, n = e.pogIndex, r = e.pogOwnerId, a = e.statusViewEntrypoint, i = e.tsSurface, l = yield c(r, t), s = l.statusGroupId, u = l.statusPosterHashId, d = l.statusPosterId, p = new (o("WAWebStatusPogImpressionWamEvent")).StatusPogImpressionWamEvent({
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			...
			if (t.isNewsletter()) {
				var i = yield o("WAWebStatusLoggingUtils").channelStatusPosterHashId(t, a);
				return {
					statusGroupId: null,
			...
			return {
				statusGroupId: c,
				statusPosterHashId: u,
				statusPosterId: s
			};
		}), d.apply(this, arguments);
	}
	function m(e) {
		return e.isNewsletter() ? o("WAWebWamEnumStatusCategory").STATUS_CATEGORY.CHANNEL_STATUS : e.isGroup() ? o("WAWebWamEnumStatusCategory").STATUS_CATEGORY.GROUP_STATUS : o("WAWebWamEnumStatusCategory").STATUS_CATEGORY.REGULAR_STATUS;
	}
