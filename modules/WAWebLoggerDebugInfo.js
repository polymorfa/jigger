__d("WAWebLoggerDebugInfo", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			r("WAWebEnvironment").isWindows && (t.subplatform = o("WAWebCrashlogConstants").CLB_SUBPLATFORM), r("gkx")("26259") ? t.releaseChannel = "intern" : r("gkx")("26258") && (t.releaseChannel = "production");
			var n = o("WAWebUserPrefsMeUser").getMaybeMeDevicePn();
			n && (t.deviceID = n.toString());
			var a = o("WAWebUserPrefsMeUser").getMaybeMePnUser();
			r("gkx")("11584") && a && (t.saga_copy = o("WAWebABPropsSaga").getIsSagaV1Enabled().toString(), t.pn = a.user.toString());
			var i = {};
			for (var l in t) {
				var s = t[l];
				s != null && (i[l] = s);
			}
			i.debugIsExternalBeta = yield o("WAWebUserPrefsGeneral").getWhatsAppWebExternalBetaJoinedIdb(), i.isLidMigrated = o("WAWebLid1X1MigrationGating").Lid1X1MigrationUtils.isLidMigrated(), i.isHistoryLidSession = o("WAWebHistorySyncLidChatGating").isForcedHistoryLidChat();
			var u = yield o("WAWebTasksDailyStatsTask").getLidMigrationStatus();
			if (u.completedMigrations != null && (i.lidCompletedMigrations = u.completedMigrations), e) {
				var d = e.addLanguageFields, m = e.addUserAgentDetails, p = e.convertFields, _ = e.entityId, f = e.supportTag, g = e.user_review_score;
				if (f != null && (i.context = f), _ != null && (i.entityId = _), g != null && (i.user_review_score = g), m === !0 && (i.userAgent = o("WAWebUA").UA.parser.getUA()), d === !0 && (i.lc = r("WAWebL10N").getRegion(), i.lg = r("WAWebL10N").getLanguage()), p === !0) {
					var h = c(i);
					return h;
				}
			}
