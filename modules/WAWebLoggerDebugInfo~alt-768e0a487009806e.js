__d("WAWebLoggerDebugInfo", [
	...
	async function s(e) {
		...
		i.debugIsExternalBeta = await o("WAWebUserPrefsGeneral").getWhatsAppWebExternalBetaJoinedIdb(), i.isLidMigrated = o("WAWebLid1X1MigrationGating").Lid1X1MigrationUtils.isLidMigrated(), i.isHistoryLidSession = o("WAWebHistorySyncLidChatGating").isForcedHistoryLidChat();
		var c = await o("WAWebTasksDailyStatsTask").getLidMigrationStatus();
		if (c.completedMigrations != null && (i.lidCompletedMigrations = c.completedMigrations), e) {
