__d("WAWebLoggerOnError", [
	...
	var e, s, u = [
		...
		{ partialMsg: "SyntaxError: Identifier 'ZapSuiteSvgIcons' has already been declared" },
		{ partialMsg: "SyntaxError: Identifier 'SuiteFunil' has already been declared" },
		{ partialMsg: "SyntaxError: Identifier 'DBZapSuite' has already been declared" },
		...
		{
			partialUserAgent: "Chrome/60.0.3112.113",
			partialMsg: "TypeError: Cannot read properties of null (reading 'children')"
		}
	...
	function _(e) {
		var t = [].concat(c);
		return r("gkx")("26258") && t.push.apply(t, d), t.some(function(t) {
			var n = t.partialMsg, r = t.partialUserAgent;
	...
	function f(e, t) {
		...
		return n || t instanceof Error && t.stack != null && t.stack.includes("evalmachine.<anonymous>");
	}
	function g(e) {
		return e instanceof Error && e.stack != null && e.stack.includes("chrome-extension://");
	}
	function h(t, n, a, i, l) {
		if (_(t)) return o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Ignored Error: ", ""])), t || (l || "").toString()), !0;
		try {
			o("WAWebUim").UIM.pprint(!0);
		} catch (e) {
			o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["UIM Print Failed!"])));
		}
		var u = n.split("?")[0], c;
		if (u && typeof a == "number" ? c = " (" + u + ":" + a + ":" + i + ")" : u ? c = " (" + u + ")" : c = "", t === "Script error." && !l) return o("WAWebLoggerImpl").Logger.logUncaughtError(c + " " + t), o("WAWebCoreActionsODS").isPageLoadComplete() || o("WAWebCoreActionsODS").logPageLoadErrorJsException(), u && o("WAWebCrashlog").upload({
			reason: "script-error",
			hasTaggedMessage: !0,
			sendLogsType: o("WALogger").SendLogsType.UNCAUGHT_EXCEPTION
		}), !1;
		var d = l instanceof Error && l.stack ? l : "" + (t || "Given: " + String(l)), m = o("WAWebLoggerImpl").Logger.logUncaughtError(d);
		return !p(l) || f(t, l) || g(l) || (o("WAWebCoreActionsODS").isPageLoadComplete() || o("WAWebCoreActionsODS").logPageLoadErrorJsException(), o("WAWebCrashlog").upload({
			reason: m,
			hasTaggedMessage: !0,
			sendLogsType: o("WALogger").SendLogsType.UNCAUGHT_EXCEPTION
		}).catch(r("WAWebNoop"))), r("gkx")("26258");
	}
	function y(e) {
		var t = e.promise, n = e.reason, r = o("WAWebLoggerImpl").Logger.logUncaughtError(n, t);
		p(n) && (o("WAWebCoreActionsODS").isPageLoadComplete() || o("WAWebCoreActionsODS").logPageLoadErrorUnhandledRejection(), o("WAWebCrashlog").upload({
			reason: r,
			hasTaggedMessage: !0,
