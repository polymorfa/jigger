__d("WAWebLoginWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ Login: [
		460,
		{
			androidKeystoreState: [10, o("WAWebWamEnumAndroidKeystoreStateType").ANDROID_KEYSTORE_STATE_TYPE],
			appContext: [20, e.TYPES.STRING],
			appContextBitfield: [21, e.TYPES.INTEGER],
			connectionOrigin: [6, o("WAWebWamEnumConnectionOriginType").CONNECTION_ORIGIN_TYPE],
			connectionSequenceStep: [11, o("WAWebWamEnumConnectionSequenceStepType").CONNECTION_SEQUENCE_STEP_TYPE],
			connectionT: [5, e.TYPES.TIMER],
			dnsResolutionMethod: [12, o("WAWebWamEnumDnsResolutionMethodType").DNS_RESOLUTION_METHOD_TYPE],
			loginDnsResolver: [13, o("WAWebWamEnumLoginDnsResolverType").LOGIN_DNS_RESOLVER_TYPE],
			loginHistoryStepResult: [27, e.TYPES.BOOLEAN],
			loginIpSource: [14, o("WAWebWamEnumLoginHostType").LOGIN_HOST_TYPE],
			loginPort: [15, o("WAWebWamEnumLoginPortNumber").LOGIN_PORT_NUMBER],
			loginResolvedPop: [19, e.TYPES.STRING],
			loginResult: [1, o("WAWebWamEnumLoginResultType").LOGIN_RESULT_TYPE],
			loginSocketProvider: [22, o("WAWebWamEnumStreamSocketProviderType").STREAM_SOCKET_PROVIDER_TYPE],
