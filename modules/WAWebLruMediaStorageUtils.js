__d("WAWebLruMediaStorageUtils", [
	...
	var e = "lru-media-storage-idb", u = null;
	function c() {
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (u == null) throw r("err")("[lru-media-storage-idb] Storage should be created first before being destroyed");
			try {
				yield u.purge();
			} finally {
				u = null;
