__d("WAWebLwiEntryPointImpressionWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumLwiEntryPoint",
	"WAWebWamEnumLwiEntryPointImpressionAction",
	"WAWebWamEnumLwiSubEntryPoint"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ LwiEntryPointImpression: [
		2906,
		{
			...
			lwiEntryPoint: [3, o("WAWebWamEnumLwiEntryPoint").LWI_ENTRY_POINT],
			lwiEntryPointImpressionAction: [12, o("WAWebWamEnumLwiEntryPointImpressionAction").LWI_ENTRY_POINT_IMPRESSION_ACTION],
