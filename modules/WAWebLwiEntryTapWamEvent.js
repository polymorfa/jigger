__d("WAWebLwiEntryTapWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ LwiEntryTap: [
		2770,
		{
			...
			lwiSubEntryPoint: [7, o("WAWebWamEnumLwiSubEntryPoint").LWI_SUB_ENTRY_POINT],
			...
			statusTypeMedia: [12, o("WAWebWamEnumStatusTypeMedia").STATUS_TYPE_MEDIA],
