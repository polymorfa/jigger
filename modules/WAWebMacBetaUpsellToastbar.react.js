__d("WAWebMacBetaUpsellToastbar.react", [
	"fbt",
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(15), n = e.sourceType, a;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (a = r("WAWebUserPrefsStore").getUser(_), t[0] = a) : a = t[0];
		var i = m(a === !0), l = i[0], c = i[1], d;
		...
		t[2] !== n ? (g = function() {
			new (o("WAWebWebcNativeUpsellCtaWamEvent")).WebcNativeUpsellCtaWamEvent({
				...
				webcNativeUpsellCtaReleaseChannel: o("WAWebWamEnumWebcNativeUpsellCtaReleaseChannel").WEBC_NATIVE_UPSELL_CTA_RELEASE_CHANNEL.BETA,
		...
		if (t[4] !== n || t[5] !== y ? (C = {
			...
			isBeta: !0,
			isBetaUser: !0
		}, t[4] = n, t[5] = y, t[6] = C) : C = t[6], o("useWAWebDesktopUpsellWamImpression").useWAWebDesktopUpsellWamImpression(C), l) return null;
		var b;
		t[7] !== n ? (b = function() {
		...
		var S;
		t[10] === Symbol.for("react.memo_cache_sentinel") ? (S = u.jsx(o("WAWebFlex.react").FlexRow, { children: u.jsx(o("WAWebText.react").WAWebTextTitleRefreshed, { children: s._(
			/*BTDS*/
			""
		) }) }), t[10] = S) : S = t[10];
		var R;
		t[11] === Symbol.for("react.memo_cache_sentinel") ? (R = u.jsxs(o("WAWebFlex.react").FlexRow, {
			xstyle: p.body,
			align: "center",
			children: [v, u.jsxs(o("WAWebFlex.react").FlexColumn, {
				grow: 1,
				justify: "center",
				align: "start",
				children: [S, u.jsx(o("WAWebFlex.react").FlexRow, { children: u.jsx(o("WAWebText.react").WAWebTextMutedRefreshed, { children: s._(
					/*BTDS*/
					""
				) }) })]
			})]
		...
		var L;
		return t[12] !== h || t[13] !== b ? (L = u.jsx(r("WAWebToastbar.react"), {
			onClick: b,
			dismissible: !0,
			onDismiss: h,
