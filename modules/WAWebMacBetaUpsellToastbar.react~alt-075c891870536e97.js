__d("WAWebMacBetaUpsellToastbar.react", [
	...
	function f(e) {
		var t = e.sourceType, n = m(r("WAWebUserPrefsStore").getUser(_) === !0), a = n[0], i = n[1], l = d(function() {
		...
		return o("useWAWebDesktopUpsellWamImpression").useWAWebDesktopUpsellWamImpression({
			...
			isBeta: !0,
			isBetaUser: !0
		}), a ? null : u.jsx(r("WAWebToastbar.react"), {
			onClick: function() {
			...
			children: u.jsxs(o("WAWebFlex.react").FlexRow, {
				...
				children: [u.jsx(o("WAWebFlex.react").FlexColumn, {
					...
					justify: "center",
					align: "start",
					children: [u.jsx(o("WAWebFlex.react").FlexRow, { children: u.jsx(o("WAWebText.react").WAWebTextTitleRefreshed, { children: s._(
						/*BTDS*/
						""
					) }) }), u.jsx(o("WAWebFlex.react").FlexRow, { children: u.jsx(o("WAWebText.react").WAWebTextMutedRefreshed, { children: s._(
						/*BTDS*/
						""
					) }) })]
				})]
