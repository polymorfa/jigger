__d("WAWebManageAdsDropdownItem.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(7), n = e.activeAccountInfo, a;
		t[0] !== n ? (a = [n], t[0] = n, t[1] = a) : a = t[1], c(m, a);
		var i;
		t[2] !== n ? (i = function(t) {
			t == null || t.preventDefault(), o("WAWebChatlistUtils").handleManageAds({
				activeAccountInfo: n,
		...
		var p = d, _;
		return t[5] !== l ? (_ = u.jsx(r("WDSMenuItem.react"), {
