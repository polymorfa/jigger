__d("WAWebManuallySetMedia", [
	...
	function e(e) {
		var t = e.chatWid, n = e.media, a = e.msg, i = e.rmrReason, l = a.mediaObject;
		l && r("WAWebMediaOpaqueData").createFromData(n, a.mimetype).then(function(e) {
