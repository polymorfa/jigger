__d("WAWebMarkAddOnsAsReadAction", [
	...
	function m() {
		var e = o("react-compiler-runtime").c(5), t = r("useLazyRef")(p), n;
		e[0] !== t ? (n = function() {
			!document.hasFocus() || t.current.size === 0 || (u(t.current), t.current = new Map());
		}, e[0] = t, e[1] = n) : n = e[1];
		var a = n, i;
		e[2] !== a || e[3] !== t ? (i = function(n) {
			var e, r = n.addOns, o = n.addOnType, i = t.current.get(o);
			i == null && (i = [], t.current.set(o, i)), (e = i).push.apply(e, r), a();
