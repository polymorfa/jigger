__d("WAWebMarketingMessagesFeedbackStopConfirmation.react", [
	...
	function C(t) {
		...
		var a = t.chat, i = g(!1), l = i[0], d = i[1], p = _(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			d(!0);
			try {
				yield o("WAWebOptOutBizAction").optOutContact(a.contact, "marketing_messages", o("WAWebOptOutUserJob").convertMarketingEntryPointToOptOutEntryPoint(t.logEntryPoint)), o("WAWebMmSignalSharingLoggingEvents").logMmSignalSharingUserStopOffersVerificationEvent({ chat: a }), o("WAWebMMUserControlsLogger").logMarketingMessageUserControlsJourney({
					action: o("WAWebWamEnumMmUserControlsAction").MM_USER_CONTROLS_ACTION.STOP_CONFIRMATION,
					entryPoint: t.logEntryPoint,
					isSuccess: !0
				}), o("WAWebModalManager").ModalManager.close();
				var n = o("WAWebMarketingMessagesFeedbackSystemMsg").getMarketingMessagesStoppedSystemMsg(a.id);
				o("WAWebGetMessageCache").getMessageCache().addMessages([{ msg: n }], !1).catch(function() {
