			...
			children: [
				c.jsx(o("WAWebText.react").WAWebTextMuted, {
					...
					children: s._(
						/*BTDS*/
						"",
						[s._param("business-name", c.jsx(o("WAWebName.react").Name, { contact: a.senderObj })), s._param("undo-link", i)]
					)
				}),
				!o("WAWebFrontendMsgGetters").getChat(a).contact.isContactOptedOut && o("WAWebMarketingMessagesUserFeedbackGatingUtils").isMMOptOutEnabled() && c.jsxs(c.Fragment, { children: [c.jsx(r("WAWebClickableLink.react"), {
					onClick: n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
						o("WAWebModalManager").ModalManager.close(), yield o("WAPromiseDelays").delayMs(300), o("WAWebModalManager").ModalManager.open(c.jsx(o("WAWebMarketingMessagesFeedbackStopConfirmationLoadable").WAWebMarketingMessagesFeedbackStopConfirmationLoadable, {
					...
					children: c.jsxs(o("WAWebFlex.react").FlexRow, {
						...
						children: [c.jsx(r("WDSIconIcBackHand.react"), {
							...
							/*BTDS*/
							"",
							[s._param("business-name", c.jsx(o("WAWebName.react").Name, { contact: a.senderObj }))]
						) })]
					})
				}), c.jsx(p, {})] }),
				c.jsx(r("WAWebClickableLink.react"), {
					onClick: n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
						o("WAWebModalManager").ModalManager.close(), yield o("WAPromiseDelays").delayMs(300), o("WAWebModalManager").ModalManager.open(c.jsx(r("WAWebBlockBusinessPopup.react"), {
							chat: o("WAWebFrontendMsgGetters").getChat(a),
