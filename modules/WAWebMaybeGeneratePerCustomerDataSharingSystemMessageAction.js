__d("WAWebMaybeGeneratePerCustomerDataSharingSystemMessageAction", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var r = t.accountLid, a = t.entryPoint, i = t.globalDataSharingEntryPoint, l = t.perCustomerDataSharingState;
			yield e.enqueue(r, n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				if (o("WAWebPerCustomerDataSharingUtils").isPerCustomerDataSharingFeatureEnabled(r, e)) {
					var n = o("WAWebWidFactory").createWid(r), s = yield o("WAWebPerCustomerDataSharingUtils").getLastDataSharingState(n), u = o("WAWebCommonCTWADataSharing").isGlobalDataSharingAccepted(e, t), c = l && u;
					if (!(s != null && s === c)) {
