__d("WAWebMaybeGetAppendedViewRepliesThreadId", [
	...
	function e(e) {
		...
		if (!o("WAWebThreadsGating").isViewRepliesThreadIdEnabled()) {
			var n;
			return (n = e.threadIds) == null ? void 0 : n.filter(function(e) {
				return e.type !== o("WAWebThreadUtils").ThreadType.ViewAllReplies;
			});
		}
		if (o("WAWebThreadMsgUtils").getMsgViewAllRepliesThread(e) != null) return e.threadIds;
		var a = e.quotedMsg;
		if (a == null || !o("WAWebViewRepliesChatUtils").isChatSupportedForViewRepliesWid(e.to)) return e.threadIds;
		...
		var u = r("WAWebThreadId").fromMessage(l, o("WAWebThreadUtils").ThreadType.ViewAllReplies), c = (t = e.threadIds) != null ? t : [];
		return [].concat(c, [u]);
	}
