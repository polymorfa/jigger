__d("WAWebMdBootstrapDataAppliedWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MdBootstrapDataApplied: [
		2298,
		{
			appContext: [22, e.TYPES.STRING],
			appContextBitfield: [23, e.TYPES.INTEGER],
			applicationState: [21, o("WAWebWamEnumApplicationState").APPLICATION_STATE],
			...
			mdBootstrapHistoryPayloadType: [10, o("WAWebWamEnumMdBootstrapHistoryPayloadType").MD_BOOTSTRAP_HISTORY_PAYLOAD_TYPE],
			mdBootstrapInlineContactsCount: [25, e.TYPES.INTEGER],
			mdBootstrapMessagesCount: [18, e.TYPES.INTEGER],
			mdBootstrapPayloadType: [3, o("WAWebWamEnumMdBootstrapPayloadType").MD_BOOTSTRAP_PAYLOAD_TYPE],
			mdBootstrapSource: [2, o("WAWebWamEnumMdBootstrapSource").MD_BOOTSTRAP_SOURCE],
			mdBootstrapStepDuration: [6, e.TYPES.INTEGER],
			mdBootstrapStepResult: [12, o("WAWebWamEnumMdBootstrapStepResult").MD_BOOTSTRAP_STEP_RESULT],
