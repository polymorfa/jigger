__d("WAWebMdBootstrapHistoryDataDownloadedWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MdBootstrapHistoryDataDownloaded: [
		2296,
		{
			appContext: [18, e.TYPES.STRING],
			appContextBitfield: [19, e.TYPES.INTEGER],
			applicationState: [17, o("WAWebWamEnumApplicationState").APPLICATION_STATE],
			...
			mdBootstrapHistoryPayloadType: [13, o("WAWebWamEnumMdBootstrapHistoryPayloadType").MD_BOOTSTRAP_HISTORY_PAYLOAD_TYPE],
			...
			mdBootstrapStepResult: [8, o("WAWebWamEnumMdBootstrapStepResult").MD_BOOTSTRAP_STEP_RESULT],
