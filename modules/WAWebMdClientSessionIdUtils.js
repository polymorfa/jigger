__d("WAWebMdClientSessionIdUtils", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			return t === o("WAWebPairingType").PairingType.ALT_DEVICE_LINKING && r("justknobx")._("527") ? u() : d(e);
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = o("WAWebAltDeviceLinkingApi").getCurrentRef(), t = o("WAWebAltDeviceLinkingApi").getCurrentHelloCached();
			if (e == null || (t == null ? void 0 : t.linkCodePairingWrappedCompanionEphemeralPub) == null) return null;
			...
			var a = r.readByteArrayView(), i = yield o("WACryptoSha256").sha256(a);
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = yield o("WAWebUserPrefsInfoStore").waNoiseInfo.get();
			if (!n) return null;
			var r = n == null || (t = n.staticKeyPair) == null ? void 0 : t.pubKey, a = o("WAWebConnModel").Conn.ref;
			if (!a || a.length === 0 || e.byteLength === 0 || r.byteLength === 0) return null;
			var i = new (o("WABinary")).Binary();
			i.writeBuffer(e), i.writeBuffer(r);
			for (var l = 0; l < a.length; l++) i.write(a.charCodeAt(l));
			var s = i.readByteArrayView(), u = yield o("WACryptoSha256").sha256(s);
