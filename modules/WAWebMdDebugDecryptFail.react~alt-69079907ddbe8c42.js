__d("WAWebMdDebugDecryptFail.react", [
	...
	function d() {
		...
		}), n = t[0], a = t[1], i = function(t) {
			o("WAWebUserPrefsMultiDeviceDebug").setDebugDecryptFail(n), o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: "Decryption fail for next " + n + " msgs" }));
		}, l = function(t) {
			var e = t.target;
		...
		return u.jsxs("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(o("WAWebMdDebugSettingStyles").styles.settingItem), { children: [
			u.jsx(r("WAWebMdDebugSettingTitle"), { title: "Decryption Fail" }),
			u.jsxs("label", {
				style: {
					display: "inline",
				...
				children: [
					...
					u.jsx("input", babelHelpers.extends({ onChange: l }, e.props(o("WAWebMdDebugSettingStyles").styles.decryptFailInput), {
						value: n,
						type: "number"
					})),
					u.jsx(o("WAWebText.react").WAWebTextSmall, {
