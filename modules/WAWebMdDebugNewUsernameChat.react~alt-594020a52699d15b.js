__d("WAWebMdDebugNewUsernameChat.react", [
	...
	function d() {
		var t = c(""), a = t[0], i = t[1], l = c(""), s = l[0], d = l[1], m = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				try {
					yield window.Debug.startUsernameChat(s, a), o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: "New username Chat " + a + " : " + s }));
				} catch (e) {
					var t = r("getErrorSafe")(e);
					o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: "StartUsernameChat failed: " + t.message }));
				}
			});
			return function(n) {
		...
		return u.jsxs("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(o("WAWebMdDebugSettingStyles").styles.settingItem), { children: [
			...
			u.jsxs("label", {
				...
				children: [u.jsx(o("WAWebText.react").WAWebTextSmall, {
					as: "span",
					children: "Username"
				}), u.jsx("input", babelHelpers.extends({ onChange: _ }, e.props(o("WAWebMdDebugSettingStyles").styles.createUsernameChatInput), {
					value: a,
					name: "username",
					type: "text"
				}))]
