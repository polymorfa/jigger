__d("WAWebMdDebugSetting.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = o("react-compiler-runtime").c(7), n = e.onExit, a = null, i = null, l;
		t[2] !== n ? (l = function() {
			n == null || n(), o("WAWebModalManager").ModalManager.close();
		}, t[2] = n, t[3] = l) : l = t[3];
		var u;
		t[4] === Symbol.for("react.memo_cache_sentinel") ? (u = s.jsxs("div", {
			style: {
				width: "800px",
				padding: "30px"
			},
		...
		var c;
		return t[5] !== l ? (c = s.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
