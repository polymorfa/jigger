__d("WAWebMdDebugSyncDevice.react", [
	...
	function d() {
		var t = c(""), n = t[0], a = t[1], i = function(t) {
			window.Debug.syncDeviceList(n.split("\n")), o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: "Sync Device for " + n }));
		}, l = function(t) {
			var e = t.target;
		...
		return u.jsxs("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(o("WAWebMdDebugSettingStyles").styles.settingItem), { children: [
			u.jsx(r("WAWebMdDebugSettingTitle"), { title: "Sync Device List" }),
			u.jsxs("label", {
