__d("WAWebMdFatalErrorWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MdFatalError: [
		2304,
		{
			...
			isPureSyncdSession: [48, o("WAWebWamEnumIsPureSyncdSessionEnum").IS_PURE_SYNCD_SESSION_ENUM],
			...
			lidMigrationStage: [49, o("WAWebWamEnumLidMigrationStageEnum").LID_MIGRATION_STAGE_ENUM],
			macFatalCollectionNameMismatch: [18, e.TYPES.BOOLEAN],
			macFatalCurrentLthashMismatch: [19, e.TYPES.BOOLEAN],
			macFatalDidPreviousPatchFailPostSaveValidation: [26, e.TYPES.BOOLEAN],
			macFatalDidUseMacFetchFallback: [36, e.TYPES.BOOLEAN],
			macFatalFirstTwoBytesFromAHashOfSnapshotMacKeyMismatch: [20, e.TYPES.BOOLEAN],
			...
			macFatalPreviousPatchNewLthashToCurrentPatchCurrentLthash: [34, e.TYPES.BOOLEAN],
			macFatalSenderCurrentLthashToLocalCalculatedCurrentLthashMismatch: [35, e.TYPES.BOOLEAN],
			mailboxAgeDays: [13, e.TYPES.INTEGER],
			mdCompanionDeviceAccountType: [43, o("WAWebWamEnumMdCompanionDeviceAccountType").MD_COMPANION_DEVICE_ACCOUNT_TYPE],
			mdFatalErrorCode: [1, o("WAWebWamEnumMdSyncdFatalErrorCode").MD_SYNCD_FATAL_ERROR_CODE],
			...
			recoveryStatus: [51, o("WAWebWamEnumRecoveryStatusEnum").RECOVERY_STATUS_ENUM],
			seqNumber: [45, e.TYPES.INTEGER],
			sessionStartPrimaryAppVersion: [15, e.TYPES.STRING],
			sourceType: [10, o("WAWebWamEnumMdSyncdFatalErrorSource").MD_SYNCD_FATAL_ERROR_SOURCE],
