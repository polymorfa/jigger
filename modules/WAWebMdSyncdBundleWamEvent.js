__d("WAWebMdSyncdBundleWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MdSyncdBundle: [
		5966,
		{
			...
			kmpSyncdFlow: [17, o("WAWebWamEnumKmpSyncdFlowEnum").KMP_SYNCD_FLOW_ENUM],
			...
			syncdCollection: [14, o("WAWebWamEnumSyncdCollectionType").SYNCD_COLLECTION_TYPE],
