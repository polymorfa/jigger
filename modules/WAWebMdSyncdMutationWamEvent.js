__d("WAWebMdSyncdMutationWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MdSyncdMutation: [
		5970,
		{
			...
			mutationBundle: [6, o("WAWebWamEnumMutationBundleType").MUTATION_BUNDLE_TYPE],
			mutationDirection: [7, o("WAWebWamEnumMutationDirectionType").MUTATION_DIRECTION_TYPE],
			mutationMac: [8, e.TYPES.STRING],
			mutationName: [9, e.TYPES.STRING],
			mutationOperation: [10, o("WAWebWamEnumMutationOperationType").MUTATION_OPERATION_TYPE],
			patchMac: [15, e.TYPES.STRING],
			seqNumber: [11, e.TYPES.INTEGER],
			syncdCollection: [12, o("WAWebWamEnumSyncdCollectionType").SYNCD_COLLECTION_TYPE],
