__d("WAWebMeTabFlow.react", [
	...
	function C(e) {
		var t = e.initialSearchText, a = e.onEnd, i = o("useWAWebFlow").useFlow(y, {
			transitions: o("useWAWebFlow").FlowTransitions.DrawerRight,
			onEnd: a
		}), l = i[0], c = i[1], b = r("useWAWebFocusOnMount")(), v = f(null), S = v[0], R = v[1], L = f(t != null ? t : ""), E = L[0], k = L[1], I = _(null), T = o("useWAWebSearchModel").useSearchModel(function() {
			return new (o("WAWebSettingSearchModel")).SettingSearch();
		}), D = T.query, x = T.results, $ = T.searchInstance;
		m(function() {
			t != null && t !== "" && D(t);
		}, [t, D]), m(function() {
			var e;
		...
		var P = p(function() {
			...
			return E === "" ? [] : x != null ? x.results.map(function(e) {
				return e.data;
			}) : [];
		}, [E, x]), M = o("useWAWebExternalBetaOptIn").useMacBetaUpsellOnWeb(), w = o("useWAWebModelValues").useModelValues(o("WAWebConnModel").Conn, ["pushname"]), A = o("WAWebUserPrefsMeUser").getMeLidUserOrThrow(), F = o("WAWebUserPrefsMeUser").getMeUserOrThrow(), O = o("WAWebContactCollection").ContactCollection.assertGet(A), B = f(function() {
			return o("WAWebAboutPrompts").getRandomAboutPromptKey();
		}), W = B[0], q = E !== "", U = d(function() {
			var e;
			k(""), D(""), (e = I.current) == null || e.focus();
		}, [D]), V = d(function() {
			var e;
			(e = I.current) == null || e.focus();
		}, []), H = q ? u.jsx(o("WAWebUimUie.react").UIE, {
			...
			if (e) o("WAWebDrawerManager").DrawerManager.openDrawerMid(r("WAWebGetBizProfileDrawerContent")(o("WAWebWamEnumEntryPoint").ENTRY_POINT.SETTINGS, function() {
				return o("WAWebDrawerManager").DrawerManager.closeDrawerMid();
			}));
			else {
				var t = o("WAWebTextStatusCollection").TextStatusCollection.assertGet(F), a = o("WAWebProfilePicThumbCollection").ProfilePicThumbCollection.assertGet(F), i = o("WAWebContactCollection").ContactCollection.assertGet(F);
			...
			t === o("WAWebSettingsConst").SettingsSteps.PaymentsHome && o("WAWebConsumerPaymentsHomeLogger").logPaymentsRowClick(), R(t), c.push(t);
		}, X = s._(
			/*BTDS*/
			""
			...
			children: [
				u.jsx(o("WAWebNotificationBanners.react").WAWebNotificationBanners, { onSettingClick: Q }),
				u.jsx(r("WAWebDrawerSection.react"), {
					...
					children: u.jsxs(o("WAWebFlex.react").FlexColumn, {
						...
						children: [u.jsx(r("WAWebMeTabSpeechBubble.react"), {
							...
							onClick: K,
							promptKey: W
						}), u.jsx("div", { children: u.jsx(o("WAWebClickable.react").Clickable, {
							onClick: j,
							ariaLabel: G,
				...
				u.jsxs(r("WAWebDrawerSection.react"), {
					...
					children: [
						...
						M && u.jsx(o("WAWebFlex.react").FlexColumn, { xstyle: h.bottomSpace })
					]
				})
			]
		...
		}), Z = q ? J : Y, ee = u.jsxs(o("LexicalComposer").LexicalComposer, {
			initialConfig: {
		...
		return c.step != null && c.step !== y && S != null ? te = u.jsx(o("WAWebSettingsFlowLoadable").SettingsFlowLoadable, {
			initialStep: S,
			onEnd: function() {
				return c.pop();
			}
			...
			children: [
				...
				!q && M && u.jsx(r("WAWebMacBetaUpsellToastbar.react"), { sourceType: o("WAWebWamEnumWebcNativeUpsellCtaSourceType").WEBC_NATIVE_UPSELL_CTA_SOURCE_TYPE.SETTINGS })
			]
		}), u.jsx(l, {
			ref: b,
			flow: c,
