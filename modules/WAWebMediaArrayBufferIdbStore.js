__d("WAWebMediaArrayBufferIdbStore", [
	...
	var e, s = (function(t) {
		function a(e) {
			var n;
			return n = t.call(this) || this, n.name = "indexeddb", n.$ArrayBufferIdbStore$p_1 = new (r("WAWebMediaLruIdbStoreUtils"))(o("WAWebLruMediaStorage").initialize, o("WAWebSchemaLruMediaArrayBuffer").IdbArrayBufferTable), n;
		}
