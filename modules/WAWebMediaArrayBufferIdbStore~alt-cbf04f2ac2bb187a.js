__d("WAWebMediaArrayBufferIdbStore", [
	"WAWebAbstractStore",
	...
	var e = (function(e) {
		function t(t) {
			var n;
			return n = e.call(this) || this, n.name = "indexeddb", n.$ArrayBufferIdbStore$p_1 = new (r("WAWebMediaLruIdbStoreUtils"))(o("WAWebLruMediaStorage").initialize, o("WAWebSchemaLruMediaArrayBuffer").IdbArrayBufferTable), n;
		}
		babelHelpers.inheritsLoose(t, e);
		var n = t.prototype;
		return n.doGet = async function(t) {
			var e = await this.$ArrayBufferIdbStore$p_1.get(t);
			return e ? e.data : null;
		}, n.doQueryByIndex = function(t, n) {
			throw r("err")("Not implemented. Actual Arraybuffer store does not need it.");
		}, n.doGetAll = function() {
			throw r("err")("Not implemented. Actual Arraybuffer store does not need it.");
