__d("WAWebMediaCapture", [
	...
	}, _ = Object.freeze((e = {}, e[o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.MICROPHONE] = 1e3, e[o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.CAMERA] = 3e3, e[o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.CAMERA_AND_MICROPHONE] = 3e3, e));
	function f(e) {
		var t, a = e.featureSurface, i = e.mediaConstraints, l = e.targetWindow, d = e.timeoutCallback, m = e.timeoutLimit, f = e.type, y, b = !1, S = null, R = !1, L = null, E = m != null ? m : _[f];
		function k() {
			S != null && self.clearTimeout(S), E < Number.POSITIVE_INFINITY && (S = self.setTimeout(function() {
				d ? d() : (v(f, a, L), R = !0);
			}, E));
		}
		var I = i != null ? i : h(f), T = l == null || (t = l.navigator) == null ? void 0 : t.mediaDevices, D = f === o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.CAMERA || f === o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.CAMERA_AND_MICROPHONE || f === o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.MICROPHONE ? l != null && T != null ? function(e) {
			return T.getUserMedia(e);
		} : o("WAGetUserMedia").getUserMedia : f === o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.DESKTOP ? l != null && T != null ? function(e) {
			...
			var e;
			L = yield C(f), k();
			var t = (e = l == null ? void 0 : l.navigator) != null ? e : navigator, a = !1;
			if (f === o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.MICROPHONE) {
				var i = yield o("WAWebMediaPermissionsUtils").checkMediaPermissionState("microphone", t), d = i.denied;
				a = d;
			} else if (f === o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.CAMERA) {
				var m = yield o("WAWebMediaPermissionsUtils").checkMediaPermissionState("camera", t), p = m.denied;
				a = p;
			} else f === o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.CAMERA_AND_MICROPHONE && (a = yield o("WAWebMediaPermissionsUtils").isAnyMediaPermissionDenied(["microphone", "camera"], t));
			if (a) throw o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["MediaCapture: permission already denied, fast-failing"]))), new (o("WAWebGetUserMediaErrors")).NotAllowedError();
			return r("WARetryPromise")(function(e) {
				var t = e.failCount, r = e.retry;
				return new (c || (c = (n("Promise"))))(function(e, n) {
					if (k(), !D) o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["MediaCapture:start() no ability to capture media"]))), n(new (o("WAWebGetUserMediaErrors")).GetUserMediaError());
					else {
						var a = I[t];
						D(a).then(function(e) {
							if (b) {
			...
			var t = e instanceof Error ? e == null ? void 0 : e.name : e, n = p[t] || o("WAWebGetUserMediaErrors").GetUserMediaError;
			throw new n();
		}).finally(function() {
			R && o("WAWebModalManager").ModalManager.close(), S && self.clearTimeout(S);
		});
		return {
			asyncStream: x,
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var t = yield (c || (c = n("Promise"))).all([o("WAWebMediaPermissionsUtils").checkMediaPermissionState("microphone"), o("WAWebMediaPermissionsUtils").checkMediaPermissionState("camera")]), r = t[0].granted, a = t[1].granted;
			return {
				micGranted: r,
				camGranted: a
			};
	...
	function v(e, t, n) {
		...
		a != null && o("WAWebModalManager").ModalManager.open(m.jsx(o("WAWebGuidePopup.react").GuidePopup, {
			messaging: a,
	...
	var S;
	function R() {
		return S === void 0 && (S = "srcObject" in document.createElement("video")), S;
	}
