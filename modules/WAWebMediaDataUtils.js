__d("WAWebMediaDataUtils", [
	...
	var e, s, u, c, d, m, p, _ = 2e4;
	function f(e) {
		return A((function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				t(e);
				var o = new Image();
				return yield new (p || (p = (n("Promise"))))(function(t, n) {
					o.onload = t, o.onabort = function() {
	...
	function R(e, t) {
		return A((function() {
			var a = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
				n(e);
				var a = yield o("WAWebMediaLoad").transcode(e.forceToBlob(), t).then(function(e) {
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = t.maxDimension, r = t.minDimension, a = t.transparency, i = yield o("WAWebImageUtils").rotateAndResize(e, n, o("WAWebImageUtils").BLOB, {
				transparency: a,
				minDimension: r
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			try {
				var c, d = yield o("WAWebImageUtils").rotateAndResize(s, a, o("WAWebImageUtils").BLOB | o("WAWebImageUtils").CANVAS, {
					transparency: l,
					minDimension: i
				}), m = d.height, p = d.images, f = d.width;
				if (p == null || p.canvas == null) throw new (o("WAWebMediaFileErrors")).MediaFileFailedLoad();
				var g = yield o("WAWebImageUtils").rotateAndResize(p.canvas, o("WAWebMediaConstants").IMG_THUMB_MAX_EDGE, o("WAWebImageUtils").DATA_URL | o("WAWebImageUtils").CANVAS), h = g.images;
				if (h == null || h.canvas == null) throw new (o("WAWebMediaFileErrors")).MediaFileFailedLoad();
				var y = o("WAWebCanvasUtils").getResizedDataUrl(h.canvas, "image/jpeg", _), C = y != null && y !== "" ? r("WAWebURLUtils").parseDataURL(y).data : null, b = n === o("WAWebWamEnumMediaPickerOriginType").MEDIA_PICKER_ORIGIN_TYPE.STATUS_TAB_CAMERA_PHOTO_LIBRARY || n === o("WAWebWamEnumMediaPickerOriginType").MEDIA_PICKER_ORIGIN_TYPE.STATUS_TAB_CAMERA_CAPTURE || n === o("WAWebWamEnumMediaPickerOriginType").MEDIA_PICKER_ORIGIN_TYPE.STATUS_TAB_CAMERA_MEDIA_STRIP || n === o("WAWebWamEnumMediaPickerOriginType").MEDIA_PICKER_ORIGIN_TYPE.STATUS_TAB_GIF, v = null, S = null;
				if (b && p.canvas != null) {
					var R = yield o("WAWebImageUtils").rotateAndResize(p.canvas, o("WAWebMediaConstants").STATUS_IMG_THUMB_MAX_EDGE, o("WAWebImageUtils").DATA_URL), L = R.images, E = L == null ? void 0 : L.dataUrl;
					E != null && E !== "" && (v = yield r("WAWebMediaOpaqueData").createFromBase64Jpeg(r("WAWebURLUtils").parseDataURL(E).data), S = {
	...
	function D() {
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				var a = yield o("WAWebImageUtils").rotateAndResize(t, o("WAWebABProps").getABPropConfigValue("web_image_max_edge"), o("WAWebImageUtils").BLOB, { transparency: !0 }), i = a.height, l = a.images, s = a.width;
				if (l == null || l.blob == null) throw new (o("WAWebMediaFileErrors")).MediaFileFailedLoad();
				var u = yield o("WAWebImageUtils").toWebpSticker(l.blob), c = yield r("WAWebMediaOpaqueData").createFromData(u, u.type);
				return n.endSuccess(), {
		...
		return $ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				...
				if (!I) {
					...
					if (E ? $ === !0 ? P = yield o("WAWebMediaAnalyzer").transcodeToMp4AndMp4RepairMux(v, !!i, x) : P = yield o("WAWebMediaAnalyzer").checkAndRepair(v, !!i, x) : P = yield o("WAWebMediaAnalyzer").checkAndRepairAudio(v, !!i, x), P.success) {
						var N = P.value;
				...
				if (I || !T && L) {
					...
					var M = yield n("cr:10296") == null ? void 0 : n("cr:10296").transcodeVideo({
						file: v,
						onProgress: y,
						resetMediaPreview: f,
						setMediaPreview: g,
				...
				e: {
					...
					if (W === o("WAWebFileUtils").FILETYPE.VIDEO) {
						...
						var V = yield o("WAWebImageUtils").generateVideoThumbsAndDuration({
							file: O,
						...
						}), H = V.duration, G = V.thumbs, z = G[0], j = G[1], K = yield r("WAWebMediaOpaqueData").createFromBase64Jpeg(r("WAWebURLUtils").parseDataURL(j.url).data);
						return R.set({
					...
					if (W === o("WAWebFileUtils").FILETYPE.AUDIO) {
						var Q, X, Y = (Q = _ == null ? void 0 : _.duration) != null ? Q : yield o("WAWebFileUtils").getAudioDuration(O), J = (X = _ == null ? void 0 : _.waveform) != null ? X : yield o("WAWebWaveformUtils").computeWaveform(O);
						return {
	...
	function N() {
		return N = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (n) {
				...
				var a = Math.min(o("WAWebMimeTypes").MIMETYPE_DETERMINING_LENGTH, e.size), i = yield h(e.slice(0, a)), l = new Uint8Array(i);
	...
	function w() {
		return w = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a, i, l, s) {
			var u = e.forceToBlob(), c = o("WAWebMediaPreProcessQpl").startMediaPreProcessQpl("document", u);
			try {
				var d, m, _ = o("WAWebMediaCleanFileName").cleanFilename(u.name || (t != null ? t : "")), f = yield P(u, _), g = a ? o("WAWebFileUtils").blobToText(u) : null, h = yield (p || (p = n("Promise"))).all([o("WAWebDocumentUploadEnrichment").enrich(u, f, s), g]), y = h[0], C = h[1], b = y.pdfImg, v = (d = b == null || (m = b.microThumbnail) == null ? void 0 : m.dataUrl) != null ? d : b == null ? void 0 : b.thumbUrl, S = r("isStringNullOrEmpty")(v) ? null : r("WAWebURLUtils").parseDataURL(v).data, R = yield r("WAWebMediaOpaqueData").createFromData(u, f);
				return c.endSuccess(), {
					type: l,
					mediaBlob: R,
					mimetype: f,
					...
					parsedVcards: C ? o("WAWebVcardParsingUtils").parseMultiVcard(C) : null
				};
			} catch (e) {
				throw c.endFailWithError(e instanceof Error ? e.name : "processRawDocumentError", e instanceof Error ? e.message : String(e)), e;
			}
	...
	function O() {
		return O = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield r("WAWebNetworkGetResponseIfOnline")(e, "GET", null, r("WAWebXHR").RESP_TYPE.ARRAY_BUFFER);
			return t ? (p || (p = n("Promise"))).resolve({
				result: t.response,
				status: t.status
			...
			try {
				switch (e.type) {
					...
					case o("WAWebMediaTypes").TYPE.PTV: {
						var i = t.forceToBlob(), l = yield o("WAWebImageUtils").generateVideoThumbsAndDuration({
							file: i,
							maxDimensions: [o("WAWebMediaConstants").VIDEO_THUMB_MAX_EDGE],
							debugHint: "gatherAndSetMetadata"
						}), s = l.thumbs, u = s[0], c = l.duration, d = yield r("WAWebMediaOpaqueData").createFromBase64Jpeg(r("WAWebURLUtils").parseDataURL(u.url).data);
						n = {
							mediaBlob: t,
							renderableUrl: t.url(),
	...
	l.getImageWidthHeight = f, l.getImageWidthHeightNoOpaque = g, l.opaqueDataToArrayBuffer = y, l.decodeWebpToRGBANoOpaque = C, l.parseWebpNoOpaque = v, l.getImageMetadata = L, l.processRawImage = k, l.processRawSticker = T, l.processRawAudioVideo = x, l.getRawDocumentMimetype = P, l.processRawDocument = M, l.fetchMedia = F, l.canPlayOgg = B, l.gatherAndSetMetadata = W, l.shouldUseMediaCache = U, l.shouldUseLruMediaStore = V, l.getResizedThumbData = H, l.getHighestQualityThumbnailUrl = G;
}), 98);
