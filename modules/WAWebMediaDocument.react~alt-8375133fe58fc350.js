__d("WAWebMediaDocument.react", [
	...
	function g(t) {
		var n, a, i = t.ref, l = babelHelpers.objectWithoutPropertiesLoose(t, e), u = l.displayAuthor, d = l.displayType, g = l.msg, h = l.quotedMsg, y = l.trusted, C = p(null);
		m(i, function() {
		...
		]), v = b[0], S = b[1], R = b[2], L = b[3], E = b[4], k = b[5], I = b[6], T = b[7], D = b[8], x = b[9], $ = b[10], P = b[11], N = b[12], M = b[13], w = b[14], A = b[15], F = b[16], O = o("useWAWebMsgValues").useMsgValues(l.msg.id, [
			n.getSubtype,
			n.getType,
			n.getIsVcardOverMmsDocument,
			a.getMediaData,
			n.getIsDynamicReplyButtonsMsg
		]), B = O[0], W = O[1], q = O[2], U = O[3], V = O[4], H = r("WAWebL10N").isRTL(), G = r("WAWebEnvironment").isWindows ? c.jsx("div", babelHelpers.extends({}, {
		...
		}[!!H << 0], { children: c.jsx(o("WAWebMessageMeta.react").Meta, {
			msg: g,
			displayType: l.displayType
		}) })) : null, z = A ? c.jsxs("div", babelHelpers.extends({}, {
		...
		}), G] })) : null, j = c.jsxs(r("WAWebMessageContentBox.react"), {
			displayType: d,
			msg: g,
			quotedMsg: h,
			showAuthor: u,
		...
		return c.jsx("div", babelHelpers.extends({}, (s || (s = r("stylex"))).props(_.bubble, !z && !r("WAWebEnvironment").isWindows && _.bubbleExtraPadding, K && _.templateBubble, f.get(d)), { children: j }));
	}
