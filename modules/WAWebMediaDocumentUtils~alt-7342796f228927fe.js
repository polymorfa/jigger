__d("WAWebMediaDocumentUtils", [
	...
	function q(e) {
		var t, n = o("react-compiler-runtime").c(9), r = w(!1), a = r[0], i = r[1], l;
		...
		return n[6] !== c ? (p = function() {
			c();
		}, _ = [c], n[6] = c, n[7] = p, n[8] = _) : (p = n[7], _ = n[8]), M(p, _), a;
	}
	function U(t) {
	...
	function H(e, t) {
		t === void 0 && (t = {});
		var a = o("useWAWebABPropConfigValue").useABPropConfigValue("wa_web_loader_button_uix_improvement"), i = q(e), l = V(e), u = o("useWAWebMsgValues").useMsgValues(e.id, [
		...
		switch (x.mediaStage) {
			...
			case o("WAWebMediaTypes").MediaDataStage.FETCHING: {
				var J = x.mediaStage === o("WAWebMediaTypes").MediaDataStage.FETCHING ? w : U;
	...
	l.displayDownloadingToast = O, l.displayFileOpeningToast = B, l.useIsFileInCacheState = q, l.useIsFileSavedOnFileSystem = V, l.useMediaAction = H;
}), 226);
