__d("WAWebMediaDocumentUtils", [
	...
	function U(t) {
		var n = A(!1), a = n[0], i = n[1], l = o("useWAWebModelValues").useOptionalModelValues(t.mediaData, ["mediaStage", "filehash"]), s = M(function() {
	...
	function H(e, t) {
		t === void 0 && (t = {});
		var a = o("useWAWebABPropConfigValue").useABPropConfigValue("wa_web_loader_button_uix_improvement"), i = U(e), l = V(e), u = o("useWAWebMsgValues").useMsgValues(e.id, [
		...
		switch ($.mediaStage) {
			...
			case o("WAWebMediaTypes").MediaDataStage.FETCHING: {
				var Z = $.mediaStage === o("WAWebMediaTypes").MediaDataStage.FETCHING ? A : H;
	...
	l.displayDownloadingToast = B, l.displayFileOpeningToast = W, l.useIsFileInCacheState = U, l.useIsFileSavedOnFileSystem = V, l.useMediaAction = H;
}), 226);
