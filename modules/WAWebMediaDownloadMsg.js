__d("WAWebMediaDownloadMsg", [
	...
	var e, s;
	function u(t) {
		var a = t.chatWid, i = t.downloadEvenIfExpensive, l = t.isAutoDownload, u = t.isUserClick, c = t.mode, d = t.msg, m = t.rmrData, p = t.rmrReason, _ = t.shouldSequenceDownload, f = t.shouldThrowAbortError, g = d.mediaObject;
		if (g) {
			var h = g.getPendingProcess("fromDisk");
			return h.then(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				u && g.userDownloadAttemptCount++, yield o("WAWebMediaMmsV4Download").downloadMedia({
					mimetype: d.mimetype,
					mediaObject: g,
		...
		return o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			...
			" type: ",
			""
		])), d.id.toString(), d.type).sendLogs("media-fault: downloadMsg msg without mediaObject"), (s || (s = n("Promise"))).resolve();
	}
	l.downloadMsg = u;
}), 98);
