__d("WAWebMediaEditorData", [
	...
	var e = 0, s = (function() {
		function t(e) {
			this.$1 = Object.freeze(babelHelpers.extends({}, e)), Object.freeze(this);
		}
		t.create = function() {
			var n, a, i = o("WAWebMediaEditorUtilsGetDominantColor").DEFAULT_DOMINANT_COLOR.getBackgroundAndTintColors(), l = i.backgroundColor, s = i.tintColor;
			return new t({
				id: Math.random(),
		...
		return n.$2 = function(n) {
			...
			return n.layers != null && (e.layers = n.layers), n.paintLayer !== void 0 && (e.paintLayer = n.paintLayer), n.outlineLayer !== void 0 && (e.outlineLayer = n.outlineLayer), n.background !== void 0 && (e.background = n.background), n.frame !== void 0 && (e.frame = n.frame, e.frame && (e.cropFrame = e.cropFrame.updateXYWidthHeight({
				x: 0,
				y: 0,
				width: e.frame.getWidth(),
				height: e.frame.getHeight()
			}))), n.cropFrame !== void 0 && (e.cropFrame = n.cropFrame), n.selectedLayer !== void 0 && (e.selectedLayer = n.selectedLayer), n.backgroundColor != null && (e.backgroundColor = n.backgroundColor), n.tintColor != null && (e.tintColor = n.tintColor), n.rotation != null && (e.rotation = n.rotation), n.activeFilter != null && (e.activeFilter = n.activeFilter), n.sending != null && (e.sending = n.sending), o("WADeepEquals").deepEqual(this.$1, e) ? this : new t(e);
		}, n.updateLayer = function(t, n) {
			if (t instanceof o("WAWebMediaEditorLayersText").TextLayer && !(n instanceof o("WAWebMediaEditorLayersText").TextLayer) || t instanceof o("WAWebMediaEditorLayersImage").ImageLayer && !(n instanceof o("WAWebMediaEditorLayersImage").ImageLayer)) {
				var e = new TypeError("MediaEditorData: calling _updateLayer with two different layer types");
				throw e.stack, e;
			}
			if (t === n) return this;
			...
			return a === t && (a = n), this.$2({
				layers: r,
				selectedLayer: a
			});
		}, n.setBackground = function(t, n) {
			var e = n != null ? n : {}, a = e.fitToSquare, i = a === void 0 ? !1 : a, l = e.scale, s = l === void 0 ? {
				x: 1,
				y: 1
			} : l, u = o("WAWebMediaEditorLayersImage").ImageLayer.create({
				type: o("WAWebMediaEditorLayersImage").ImageLayerType.Background,
				origin: new (r("WAWebMediaEditorGeometryPoint"))({
					x: 0,
					y: 0
				}),
				...
				editable: !0,
				scale: s
			}), c = u.getFrame().getDimension(), d = i ? r("WAWebMediaEditorGeometryRect").create({
				x: 0,
				y: 0,
				width: c,
				height: c,
				...
				rotation: 0
			}) : u.getFrame(), m = new (r("WAWebMediaEditorGeometryPoint"))({
				x: (d.getWidth() - u.getWidth()) / 2,
				y: (d.getHeight() - u.getHeight()) / 2
			}), p = u.setScale(s).setOrigin(m), _ = o("WAWebMediaEditorUtilsGetDominantColor").getDominantColor(t), f = _.getBackgroundAndTintColors(), g = f.backgroundColor, h = f.tintColor, y = new (o("WAWebMediaEditorLayersDraw")).DrawLayer({
				size: d.getSize(),
			...
			var e, a = (e = this.getBackground()) == null ? void 0 : e.setImage(t).setOrigin(n).setRotation(r).setScale(o);
			return this.$2({
				background: a,
				selectedLayer: a
			}).setShapeLayerBackground(a == null ? void 0 : a.getFrame(), t);
		}, n.addImageLayer = function(t) {
			var e = o("WAWebMediaEditorLayersImage").ImageLayer.create(t), n = [].concat(this.getLayers(), [e]);
			return this.$2({
				layers: n,
				selectedLayer: e
			});
		}, n.addImageLayerToCenter = function(t) {
			var e = this.toCanvasPoint(new (r("WAWebMediaEditorGeometryPoint"))({
			...
			var e = o("WAWebMediaEditorLayersShape").ShapeLayer.create(t), n = [].concat(this.getLayers(), [e]);
			return this.$2({
				layers: n,
				selectedLayer: e
			});
		}, n.addShapeLayerToCenter = function(t) {
			var e, n, o, a, i = this.toCanvasPoint(new (r("WAWebMediaEditorGeometryPoint"))({
				x: this.getScreenWidth() / 2,
				y: this.getScreenHeight() / 2
			})), l = new (r("WAWebMediaEditorGeometryPoint"))({
				x: i.getX() - ((e = (n = t.size) == null ? void 0 : n.getWidth()) != null ? e : t.image.width) / 2,
				y: i.getY() - ((o = (a = t.size) == null ? void 0 : a.getHeight()) != null ? o : t.image.height) / 2
			...
			var e = this.getLayers().map(function(e) {
				var r = e;
				return r instanceof o("WAWebMediaEditorLayersShape").ShapeLayer && (n != null && (r = r.setImage(n)), t != null && (r = r.setShapeBackgroundFrame(t))), r;
			});
			return this.$2({ layers: e });
		}, n.addTextLayer = function(t) {
			var e = t instanceof o("WAWebMediaEditorLayersText").TextLayer ? t : o("WAWebMediaEditorLayersText").TextLayer.create(babelHelpers.extends({}, t, { rotation: -this.getRotation() })), n = [].concat(this.getLayers(), [e]), r = e;
			return this.$2({
				layers: n,
				selectedLayer: r
			});
			...
			if (t % 90 !== 0) throw r("err")("canvas can only be rotated at a 90 degrees interval");
			return this.$2({ rotation: t % 360 });
		}, n.setCrop = function(t, n) {
			if (t.getX() < 0 || t.getY() < 0 || t.getX() + n.getWidth() > this.getWidth() || t.getY() + n.getHeight() > this.getHeight()) throw r("err")("canvas crop must stays within the frame bound");
			...
			var e, n = (e = this.getBackground()) == null ? void 0 : e.setOrigin(t);
			return this.$2({
				background: n,
				selectedLayer: n
			}).setShapeLayerBackground(n == null ? void 0 : n.getFrame());
		}, n.transformLayer = function(t) {
			var e = t.frame, n = t.layer, r = t.rotation, a = t.scale, i = n;
			return e != null && n instanceof o("WAWebMediaEditorLayersShape").ShapeLayer && (i = n.setFrame(e)), i = i.setRotation(r).setScale(a), this.updateLayer(n, i);
		}, n.transformBackground = function(t, n) {
			var e, r = (e = this.getBackground()) == null ? void 0 : e.setRotation(t).setScale(n);
			return this.$2({
				background: r,
				selectedLayer: r
			...
			return t === this.getSelectedLayer() && (n = babelHelpers.extends({}, n, { selectedLayer: null })), this.$2(n);
			...
			return !this.getPaintLayer().isEmpty() || !this.getOutlineLayer().isEmpty() || this.getLayers().length > 0 || this.getRotation() !== e || !this.getSize().equals(this.$1.cropFrame.getSize()) || this.getActiveFilter() !== o("WAWebMediaEditorUtilsFilterType").FilterType.NONE;
			...
			return e instanceof o("WAWebMediaEditorLayersText").TextLayer ? e : null;
			...
			return this.getRotation() % 180 === 0 ? this.getCropWidth() : this.getCropHeight();
		}, n.getScreenHeight = function() {
			return this.getRotation() % 180 === 0 ? this.getCropHeight() : this.getCropWidth();
			...
			var e, n = Math.max(this.getWidth(), this.getHeight()), o = new (e = (r("WAWebMediaEditorGeometryPoint")))({
				x: n / 2,
				y: n / 2
			}), a = new e({
				x: t.getX() + (n - this.getWidth()) / 2,
				y: t.getY() + (n - this.getHeight()) / 2
			}), i = a.rotate(o, this.getRotation()), l = new e({
				x: this.getCropCenter().getX() + (n - this.getWidth()) / 2,
				y: this.getCropCenter().getY() + (n - this.getHeight()) / 2
			}), s = l.rotate(o, this.getRotation()), u = new e({
			...
			var e, n = Math.max(this.getWidth(), this.getHeight()), o = new (e = (r("WAWebMediaEditorGeometryPoint")))({
				x: n / 2,
				y: n / 2
			}), a = this.getCropCenter().rotate(o, this.getRotation()), i = new e({
			...
			return this.setRotation(0).setCrop(new (r("WAWebMediaEditorGeometryPoint"))({
				x: 0,
				y: 0
			...
			return !this.getCropOrigin().equals(new (r("WAWebMediaEditorGeometryPoint"))({
				x: 0,
				y: 0
