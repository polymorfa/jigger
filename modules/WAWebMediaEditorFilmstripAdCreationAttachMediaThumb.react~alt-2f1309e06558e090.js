__d("WAWebMediaEditorFilmstripAdCreationAttachMediaThumb.react", [
	...
	function p(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.attachMedia, l = a.isActive, u = a.onDeleteClick, p = a.onSelectClick, _ = d(!1), f = _[0], g = _[1], h = function(t) {
			t.stopPropagation(), u(o("WAWebStateUtils").unproxy(i), t);
		}, y = function(t) {
			t.stopPropagation(), p(o("WAWebStateUtils").unproxy(i), t);
		}, C = function(t) {
			r("WAWebKeyboardIsKeyActivation")(t) && (t.stopPropagation(), t.preventDefault(), y(t));
		};
		return c.jsxs("button", babelHelpers.extends({}, {
			...
			children: [c.jsx(r("WAWebBizAdCreationCreativeThumbnail.react"), {
				attachMediaProp: i,
				variant: "Editor"
			...
			}[!!f << 0], { children: c.jsx("button", {
				className: "x6s0dn4 x1rk1j4g x1c9tyrk xeusxvb x1pahc9y x1ertn4p x1ejq31n x18oe1m7 x1sy0etr xstzfhl x972fbf x10w94by x1qhh985 x14e42zd x1ypdohk x78zum5 xmix8c7 xl56j7k xexx8yu xyri2b x18d9i69 x1c1uobl x1xp8n7a",
				"aria-label": s._(
					/*BTDS*/
					""
				),
