__d("WAWebMediaEditorGeometrySize", ["WADeepEquals"], (function(t, n, r, o, a, i, l) {
	var e = (function() {
		function e(e) {
		...
		return t.update = function(n) {
			...
			return n.width != null && (t.width = n.width), n.height != null && (t.height = n.height), o("WADeepEquals").deepEqual(this.$1, t) ? this : new e(t);
		}, t.clone = function() {
			return new e(this.$1);
		}, t.toString = function() {
			return "(" + this.getWidth() + "w, " + this.getHeight() + "h)";
		}, t.equals = function(t) {
			return Math.abs(this.getWidth() - t.getWidth()) < Number.EPSILON && Math.abs(this.getHeight() - t.getHeight()) < Number.EPSILON;
		}, t.isEmpty = function() {
