__d("WAWebMediaEditorLayersDraw", [
	"$InternalEnum",
	...
	var e = n("$InternalEnum").Mirrored(["Paint", "Outline"]), s = (function() {
		function e(e) {
			...
			} else e.frame != null && e.paths != null && (this.$2 = e.frame, this.$3 = e.paths);
			e.id != null ? this.$1 = e.id : this.$1 = o("WAWebMediaEditorUtilsGenerateLayerId").generateLayerId(e.type), Object.freeze(this);
		}
		var t = e.prototype;
		return t.delete = function() {}, t.$5 = function(n) {
			var t = this.$3;
			n.paths != null && (t = n.paths);
			var r = this.$2, o = this.$4;
			return new e({
				id: this.getId(),
				paths: t,
				frame: r,
			...
			var e = new TypeError("MediaEditor:DrawLayer resetting origin is not allowed");
			throw e.stack, e;
		}, t.setRotation = function(t) {
			var e = new TypeError("MediaEditor:DrawLayer resetting rotation is not allowed");
			throw e.stack, e;
		}, t.setScale = function(t) {
			var e = new TypeError("MediaEditor:DrawLayer resetting scale is not allowed");
			throw e.stack, e;
		}, t.addPath = function(t) {
			var e = new (r("WAWebMediaEditorGeometryPath"))(t), n = [].concat(this.$3, [e]);
			...
			return this.getPaths().reduce(function(e, t) {
				return !t.getSmoothing() && e.length && e.push(e[e.length - 1]), t.isDrag() && e.push(t.getPoints()[0]), e.push.apply(e, t.getPoints().flatMap(function(e) {
