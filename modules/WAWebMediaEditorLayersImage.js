__d("WAWebMediaEditorLayersImage", [
	"$InternalEnum",
	"WADeepEquals",
	...
	var e = n("$InternalEnum").Mirrored([
		...
		t.create = function(n) {
			var e, a = n.image.width, i = n.image.height;
			if (!a || !i) throw r("err")("Image must have valid width and height");
			return new t({
				id: o("WAWebMediaEditorUtilsGenerateLayerId").generateLayerId("image"),
				type: n.type,
				image: n.image,
				editable: n.editable,
		...
		return n.delete = function() {}, n.setOrigin = function(t) {
			...
			if (n.image != null) {
				...
				if (!a || !i) throw r("err")("Image must have valid width and height");
				e.image = n.image, e.frame = new (r("WAWebMediaEditorGeometryRect"))({
			...
			return n.editable != null && (e.editable = n.editable), n.frame != null && (e.frame = n.frame), o("WADeepEquals").deepEqual(this.$1, e) ? this : new t(e);
		}, n.getImage = function() {
			return this.$1.image;
