__d("WAWebMediaEditorLayersShape", [
	"$InternalEnum",
	"WADeepEquals",
	...
	var e = ["mode"], s = n("$InternalEnum").Mirrored([
		"None",
		"Pixelate",
		"Smooth"
	]), u = (function() {
		...
		t.create = function(a) {
			var n = a.mode, i = n === void 0 ? s.None : n, l = babelHelpers.objectWithoutPropertiesLoose(a, e), u = l.image.width, c = l.image.height;
			if (!u || !c) throw r("err")("Image must have valid width and height");
			var d = l.backgroundFrame.getWidth() / 2 - l.size.getWidth() / 2, m = l.size.getWidth() + d, p = l.backgroundFrame.getHeight() / 2 - l.size.getHeight() / 2, _ = l.size.getHeight() + p, f = l.shape === o("WAWebMediaEditorUtilsShapes").ShapeType.LINE || l.shape === o("WAWebMediaEditorUtilsShapes").ShapeType.ARROW ? [
				d,
				_,
				(d + m) / 2,
				(_ + p) / 2,
			...
			return new t({
				id: o("WAWebMediaEditorUtilsGenerateLayerId").generateLayerId("shape"),
				image: l.image,
				editable: !0,
		...
		var n = t.prototype;
		return n.delete = function() {}, n.setOrigin = function(t) {
			...
			if (n.image != null) {
				var a = n.image.width, i = n.image.height;
				if (!a || !i) throw r("err")("Image must have valid width and height");
				e.image = n.image, e.backgroundFrame = new (r("WAWebMediaEditorGeometryRect"))({
			...
			return n.editable != null && (e.editable = n.editable), n.frame != null && (e.frame = n.frame), n.radius != null && (e.radius = n.radius), n.shape != null && (e.shape = n.shape), n.points != null && (e.points = n.points), n.fillColor != null && (e.fillColor = n.fillColor), n.strokeColor != null && (e.strokeColor = n.strokeColor), n.strokeWidth != null && (e.strokeWidth = n.strokeWidth), n.backgroundFrame != null && (e.backgroundFrame = n.backgroundFrame), n.confirmed != null && (e.confirmed = n.confirmed), n.mode != null && (e.mode = n.mode), o("WADeepEquals").deepEqual(this.$1, e) ? this : new t(e).setConfirmed();
		}, n.getImage = function() {
			return this.$1.image;
			...
			var e;
			return (e = this.$1.fillColor) != null ? e : o("WAWebMediaEditorEnumsColors").getColorValue(o("WAWebMediaEditorEnumsColors").ColorType.BLACK);
		}, n.getStrokeColor = function() {
			var e;
			return (e = this.$1.strokeColor) != null ? e : o("WAWebMediaEditorEnumsColors").getColorValue(o("WAWebMediaEditorEnumsColors").ColorType.BLACK);
			...
			return this.getShape() === o("WAWebMediaEditorUtilsShapes").ShapeType.RECTANGLE;
		}, n.isCircle = function() {
			return this.getShape() === o("WAWebMediaEditorUtilsShapes").ShapeType.CIRCLE;
		}, n.isLine = function() {
			return this.getShape() === o("WAWebMediaEditorUtilsShapes").ShapeType.LINE;
		}, n.isArrow = function() {
			return this.getShape() === o("WAWebMediaEditorUtilsShapes").ShapeType.ARROW;
		}, t;
	})();
