__d("WAWebMediaEditorLayersText", [
	"WADeepEquals",
	...
	var e = 18, s = {
		...
		backgroundShadow: {
			...
			radius: 6,
			spread: 0,
			color: new (o("WAWebMediaEditorUtilsColor")).Color(0, 0, 0, .32)
		}
	}, u = (function() {
		function t(e) {
		...
		t.create = function(n) {
			var e, a = [], i = c(a, s), l = 0;
			return n.rotation != null && (l = n.rotation), new t({
				id: o("WAWebMediaEditorUtilsGenerateLayerId").generateLayerId("text"),
				text: "",
		...
		return n.delete = function() {}, n.setOrigin = function(t) {
			...
			if (a.frame != null && (n.frame = a.frame), a.textColor != null && (n.textColor = a.textColor), a.textBackground != null && (n.textBackground = a.textBackground), a.text != null && a.text !== n.text || a.font != null && a.font !== n.font) {
				var i, l;
				n.text = (i = a.text) != null ? i : n.text, n.font = (l = a.font) != null ? l : n.font, n.lines = o("WAWebMediaEditorUtilsTextInCanvas").getLines({
					font: n.font,
					fontSize: e,
					maxWidth: this.$1.maxWidth,
					originalText: n.text
				});
				var u = c(n.lines, s), d = n.frame.getSize(), m = n.frame.getOrigin(), p = new (r("WAWebMediaEditorGeometryPoint"))({
					x: m.getX() + d.getWidth() / 2 - u.getWidth() / 2,
					y: m.getY() + d.getHeight() / 2 - u.getHeight() / 2
				});
				n.frame = n.frame.update({
					origin: p,
					size: u
				});
			}
			if (a.alignment != null && (n.alignment = a.alignment), this.getFont() !== n.font || this.getText() !== n.text || this.getAlignment() !== n.alignment) {
				var _ = n.lines.map(function(e) {
					return e.width;
				});
				n.backgroundPath = o("WAWebMediaEditorUtilsTextBackground").generateTextBackgroundPath({
					alignment: n.alignment,
					lineWidths: _,
					style: {
			...
			return this.getTextColor().isLight() ? o("WAWebMediaEditorEnumsColors").getColorValue(o("WAWebMediaEditorEnumsColors").ColorType.BLACK) : o("WAWebMediaEditorEnumsColors").getColorValue(o("WAWebMediaEditorEnumsColors").ColorType.WHITE);
	...
	function c(t, n) {
		var o = Math.max.apply(Math, t.map(function(e) {
			return e.width;
		}).concat([0])) + n.lineHorizontalPadding * 2 + n.layerPadding * 2, a = t.length * (e + n.lineVerticalPadding * 2) + n.layerPadding * 2;
