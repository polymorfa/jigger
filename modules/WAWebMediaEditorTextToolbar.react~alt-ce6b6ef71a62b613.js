__d("WAWebMediaEditorTextToolbar.react", [
	...
	function p(e) {
		var t = e.onAlignmentSelect, n = e.onDeleteLayer, a = e.onFontSelect, i = e.onTextBackgroundToggle, l = e.onTextColorSelect, c = e.ref, p = e.textLayer, _ = m(null), f = m(null);
		d(c, function() {
			return {
				isColorPanelVisible: function() {
					var e, t;
					return (e = (t = _.current) == null ? void 0 : t.isPanelVisible()) != null ? e : !1;
				},
				isFontMenuVisible: function() {
					var e, t;
					return (e = (t = f.current) == null ? void 0 : t.isMenuVisible()) != null ? e : !1;
				}
			};
		});
		var g = o("WAWebMediaEditorEnumsColors").getAllColors().map(function(e) {
		...
		return u.jsxs(u.Fragment, { children: [
			...
			u.jsx(o("WAWebMediaEditorToolbarButton.react").ToolbarButton, {
				icon: u.jsx(o("WAWebDeleteIcon.react").DeleteIcon, { displayInline: !0 }),
				title: s._(
					/*BTDS*/
					""
				),
