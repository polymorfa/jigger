__d("WAWebMediaEditorToolbarButton.react", [
	...
	function m(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.children, l = a.onClick, u = a.icon, m = a.caret, p = a.disabled, _ = p === void 0 ? !1 : p, f = a.title, g = a.selected, h = g === void 0 ? !1 : g, y = a.theme, C = y === void 0 ? o("WAWebMediaEditorToolbarColor.react").Theme.Default : y, b = a.testid, v = b === void 0 ? "" : b, S;
		if (m) switch (m) {
			case "up":
		...
		return c.jsxs("button", babelHelpers.extends({
			...
			onClick: l,
			"data-testid": v
		}, (s || (s = r("stylex"))).props(d.container, o("WDSFocusStateStyles").WDSFocusStateStyles.genericFocus, C === o("WAWebMediaEditorToolbarColor.react").Theme.Default && d.paddingAll8, _ && d.disabled, !_ && h && d.selected, a.xstyle), {
			title: f,
			children: [
