__d("WAWebMediaEditorToolbarColor.react", [
	...
	function g(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.colors, l = a.onColorSelect, s = a.selectedColor, c = a.theme, g = c === void 0 ? f.Default : c, h = m(), y = p(null), C = y[0], b = y[1], v = function() {
			b(null);
		}, S = function(t) {
		...
		return C && (k = u.jsx(o("WAWebUimUie.react").UIE, {
			...
			children: [
				...
				g === f.Default && u.jsx(o("WAWebMediaEditorToolbarButton.react").ToolbarButton, {
					ref: h,
					onClick: S,
					caret: C ? "down" : "up"
				}),
	...
	g.displayName = g.name + " [from " + i.id + "]", l.Theme = f, l.ColorToolbar = g;
}), 98);
