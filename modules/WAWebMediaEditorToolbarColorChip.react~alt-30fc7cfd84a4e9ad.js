__d("WAWebMediaEditorToolbarColorChip.react", [
	...
	function _(t) {
		var n = t.onSelect, a = t.primaryColor, i = t.secondaryColor, l = t.selected, s = t.theme, c = t.withBorder, _ = m(!1), f = _[0], g = _[1], h = m(!1), y = h[0], C = h[1], b = d(null), v = function(t) {
			g(!0);
		}, S = function(t) {
			g(!1);
		}, R = function(t) {
		...
		l ? E = 30 : f && (E = 26);
		var k = s === "small", I = s !== "small", T = k || I, D = T && l, x = y && !l ? a.withAlpha(.2).toRgbaString() : "transparent", $ = a.colorType ? o("WAWebMediaEditorEnumsColors").getColorLabel(a.colorType) : null;
		return u.jsx("button", babelHelpers.extends({
			...
			}[(t.theme === "medium") << 3 | !!(c && a.isWhite()) << 2 | !!(T && (f || y)) << 1 | !!(D && (f || y)) << 0],
			style: { backgroundColor: a.toRgbaString() },
			children: [
				a.equals(o("WAWebMediaEditorEnumsColors").getColorValue(o("WAWebMediaEditorEnumsColors").ColorType.TRANSPARENT)) && u.jsx(o("WAWebRecalledIcon.react").RecalledIcon, {
					width: E,
					height: E
				}),
				i && l && u.jsx("div", {
				...
				$ != null && u.jsx(o("WAWebPopoverContext.react").WAWebPopoverController, {
					targetRef: b,
