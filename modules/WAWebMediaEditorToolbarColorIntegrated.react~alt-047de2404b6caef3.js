__d("WAWebMediaEditorToolbarColorIntegrated.react", [
	...
	function p(e) {
		var t = e.onColorSelect, n = e.selectedColor, a = e.strokeProps, i = o("WAWebMediaEditorEnumsColors").getAllColorsAndTransparent().map(function(e) {
			return { primaryColor: o("WAWebMediaEditorEnumsColors").getColorValue(e) };
		}), l = u(!1), p = l[0], _ = l[1], f = u(n), g = f[0], h = f[1], y = function(n) {
			h(n), t(n);
		};
		return s.jsxs(o("WAWebFlex.react").FlexColumn, {
			...
			gap: 8,
			children: [
				p && s.jsx(r("WAWebMediaEditorToolbarColorPicker.react"), {
					onColorSelect: y,
					selectedColor: g,
				...
				s.jsxs(o("WAWebFlex.react").FlexRow, {
					...
					justify: "center",
					gap: 8,
					children: [s.jsx(o("WAWebMediaEditorToolbarColor.react").ColorToolbar, {
						colors: i,
						onColorSelect: y,
						selectedColor: g,
						theme: o("WAWebMediaEditorToolbarColor.react").Theme.Integrated
					}, g.toString()), s.jsx(o("WAWebMediaEditorToolbarButton.react").ToolbarButton, {
