	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (!t) {
				...
				var a = yield o("WAWebFileUtils").blobToArrayBuffer(n), i = (yield r("WAWebWebpToAnimationFrames")(a)).frames[0];
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (e.mediaData.isLottie === !0) {
				var n = o("WAWebInMemoryLottieStickerCache").InMemoryLottieStickerCache.get(e.filehash);
				t = yield o("WAWebCopyStickerToClipboard").createCanvasFromLottieSticker(n);
			} else if (yield o("WAWebFeatureDetectionDetectWebpSupport").detectWebpSupport()) {
				var r = e.mediaData.filehash, a = o("WAWebMediaInMemoryBlobCache").InMemoryMediaBlobCache.getOrCreateURL(r);
				t = yield c(a);
