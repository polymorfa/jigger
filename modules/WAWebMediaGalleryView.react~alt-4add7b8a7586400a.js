__d("WAWebMediaGalleryView.react", [
	...
	function _() {
		return d.jsx("div", { className: "x1n2onr6 xa1il55 xqtp20y x1ohzodl x1hmdwey x1gk22k6" });
	}
	_.displayName = _.name + " [from " + i.id + "]";
	function f(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.chat, l = a.fullCollection, s = a.isRefresh, c = s === void 0 ? !1 : s, f = a.justify, h = a.mediaCollection, y = a.onScroll, C = a.medias || a.productMedias, b = a.theme === "chat-info", v = h.length === 0, S = m(null), R = m(null), L = r("useMergeRefs")(n, S);
		if (!C) return null;
		var E = (u || (u = r("stylex")))(c ? [p.containerRefreshed, p.containerRefreshedPadding] : p.container, !!l && p.drawer, v && p.galleryEmpty, v && o("WAWebStylesEnv").isOSMac && p.fontSmoothing, f === "space-between" && p.justifySpaceBetween, b && v && p.themeChatInfo), k = [].concat(C);
		if (h.queryMediaBefore != null && (l || k.length < 6)) {
			...
			k.push(d.jsxs("div", {
				className: I,
				children: [d.jsx("span", { className: "x1etwn82 x1ukowes x14obwa1" }), d.jsx(o("WAWebSpinner.react").Spinner, {
					stroke: 6,
					size: 24
				})]
			}, "spinner"));
		...
		if (C.length === 0) {
			if (l) {
				if (h.queryMediaBefore != null) return d.jsx("div", {
				...
				if (h.hasMediaBefore !== !0) return d.jsx(o("WAWebMediaHubEmptyGalleryEntryPoint.react").WAWebMediaHubEmptyGalleryEntryPoint, { tabName: o("WAWebMediaHubEmptyGalleryEntryPoint.react").MediaHubTabs.MEDIA });
			}
			if (b) return null;
			h.queryMediaBefore == null && h.hasMediaBefore !== !0 && (E = o("WAWebClassnames").classnamesConvertMeToStylexPlease(E, {
				0: "xqvfhly xexx8yu xr1496l x1f6kntn x1i47q4g x12lhmx5",
				1: "xqvfhly xexx8yu xr1496l x1f6kntn x1i47q4g x12lhmx5 xvmahel xlh3980"
			}[!!o("WAWebStylesEnv").isOSMac << 0]), k = [g(Math.max(i ? i.docCount : 0, 0), Math.max(i ? i.linkCount : 0, 0), Math.max(i ? i.productCount : 0, 0))]);
