__d("WAWebMediaGatherAndSetMetadataNoOpaque", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			var a = yield (e || (e = n("Promise"))).resolve().then(function() {
				switch (t.type) {
					case o("WAWebMediaTypes").TYPE.VIDEO:
					case o("WAWebMediaTypes").TYPE.PTV: return s(r).then(function(e) {
						return {
							fullWidth: e.width,
							fullHeight: e.height,
					...
					case o("WAWebMediaTypes").TYPE.IMAGE: return t.contentInfo.fullHeight != null && t.contentInfo.fullWidth != null && t.size === r.size ? null : o("WAWebMediaDataUtils").getImageWidthHeightNoOpaque(r).then(function(e) {
						return {
							fullWidth: e.width,
							fullHeight: e.height,
							size: r.size
					...
					case o("WAWebMediaTypes").TYPE.STICKER: return o("WAWebStickerUtils").parseStickerMetadata(r, t);
