__d("WAWebMediaHostsMaybeSwitchHost", [], (function(t, n, r, o, a, i) {
	var e = 52428800;
	function l(e, t, n) {
		return e.equals(t) && n != null && t != null && !t.equals(n);
	}
	function s(t, n, r, o) {
		var a = n.fallbackHost, i = n.selectedHost, s = r.fallbackHost, u = r.selectedHost;
		return o < e ? {
			changed: !1,
			host: t
			...
			changed: !0,
			host: i
		} : t.type === "primary" || t.type === "fallback" || t.type === null || t.type === void 0 ? {
			changed: !1,
			host: t
		} : (function() {
