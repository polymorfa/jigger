__d("WAWebMediaHostsWorker", [
	...
	var u = (function() {
		...
		var a = t.prototype;
		return a.acceptSnapshot = function(t) {
			this.$2.set(t == null ? null : s(t));
		}, a.getHostsInfo = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this.$2.get();
				return e.forceRefresh === !0 || o("WAWebMediaHostsStaleness").isExpiredOrMissing(t) ? yield this.$3() : o("WAWebMediaHostsStaleness").needsRefresh(t) && this.$1.fireAndForget("mainthread_mediaHostsSync", "refresh"), this.$4(e);
			});
			function t(t) {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var t = this, o = this.$2.get();
				yield this.$1.sendAndReceive("mainthread_mediaHostsSync", "refresh"), this.$2.get() === o && (yield new (e || (e = (n("Promise"))))(function(e) {
					var n = r("WAWebNoop");
	...
	l.MediaHostsWorker = u, l.getMediaHostsWorker = d, l.createAndSetMediaHostsWorker = m;
}), 98);
