__d("WAWebMediaHubSelectFooter.react", [
	"fbt",
	"WAWebFlex.react",
	...
	function d() {
		"use no forget";
		var e = o("WAWebMediaHubContextProvider").useWAWebMediaHubContext(), t = e.getMultiSelection, n = e.isSelectMode, a = e.setIsSelectMode;
		if (!n) return null;
		var i = function() {
			a(!1);
		}, l = t(), d = l.getSelected(), g = d.length > 0 && d.every(function(e) {
				...
				children: u.jsxs(o("WAWebFlex.react").FlexRow, {
					...
					children: [
						...
						u.jsx(o("WAWebText.react").WAWebTextMutedRefreshed, {
							color: d.length === 0 ? "wdsContentDisabled" : "wdsContentDeemphasized",
							xstyle: [
								c.count,
								c.paddingEnd12,
								c.paddingStart24
							],
							children: u.jsx(r("WAWebMultiSelectCount.react"), { selectedMsgsCount: d.length })
						}),
						u.jsxs(o("WAWebFlex.react").FlexRow, {
							xstyle: c.actionItems,
							justify: "end",
							children: [
								g ? u.jsx(r("WAWebMultiSelectKeep.react"), {
									selectedMessages: l,
									onCancel: function() {
										d.every(function(e) {
								...
								u.jsx(r("WAWebMultiSelectForward.react"), {
									...
									onForwardModalOpen: function() {
										o("WAWebMediaHubLogger").logMediaHubAction({ action: o("WAWebWamEnumActionCode").ACTION_CODE.FORWARD });
									}
								})
							]
						})
	...
	function m() {
		o("WAWebMediaHubLogger").logMediaHubAction({ action: o("WAWebWamEnumActionCode").ACTION_CODE.DELETE });
	}
	function p() {
		o("WAWebMediaHubLogger").logMediaHubAction({ action: o("WAWebWamEnumActionCode").ACTION_CODE.STAR });
	}
	function _() {
		o("WAWebMediaHubLogger").logMediaHubAction({ action: o("WAWebWamEnumActionCode").ACTION_CODE.DOWNLOAD });
	}
	function f() {
