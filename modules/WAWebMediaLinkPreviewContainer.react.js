__d("WAWebMediaLinkPreviewContainer.react", [
	...
	function _(e) {
		var t = e.displayType, a = e.horizontalLayout, i = a === void 0 ? !1 : a, l = e.isInvite, u = e.msg, c = e.onClick, _ = e.reelItem, g = e.theme, h = d(o("WAWebStatusContext").StatusContext), y = h.statusItemViewEventRef, C = p(null), b = C[0], v = C[1], S = p(null), R = S[0], L = S[1], E = o("useWAWebMsgValues").useMsgValues(u.id, [
		...
		]), k = E[0], I = E[1], T = E[2], D = E[3], x = E[4], $ = E[5], P = E[6], N = E[7], M = E[8], w = E[9], A = E[10], F = E[11], O = E[12], B = E[13], W = E[14], q = E[15], U = E[16], V = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				}], n = yield o("WAWebMediaDataUtils").getResizedThumbData(e, t), r = n[0];
		...
		m(function() {
			var e = F;
			e != null && (!e.thumbnailHQ || G !== D) && !o("WAWebMediaLinkPreviewUtils").hqLinkPreviewExpired(k) && r("WAWebMediaDownloadMmsThumbnail")({
				chat: o("WAWebFrontendMsgGetters").getMaybeChat(u),
				msg: e,
				isPreload: !1
			}), q != null && H(q), _ != null && (H(_.thumbnailUrl), V(_.profileIconUrl));
		}, [
			F,
			W,
			k,
		...
		var z = null;
		l || (z = f(M));
		var j = o("WAWebMsgLinks").getLinksFromMsg(u), K = r("WAWebCompactMapString")(j, function(e) {
			return f(e.url);
		});
		if (_ == null && z != null && !K.some(function(e) {
			return e === z;
		})) return s.jsx("div", {});
		var Q = o("WAWebMsgLinks").getSuspiciousLinks(u).filter(function(e) {
			var t = e.url;
			return u.matchedText === t;
		}), X, Y, J, Z, ee, te, ne;
		if (Q.length ? ne = function() {
			var e = Q[0];
			o("WAWebModalManager").ModalManager.open(s.jsx(r("WAWebSuspiciousLinkPopup.react"), { link: e }));
		} : (ne = function() {
			var e, n = (e = _ == null ? void 0 : _.videoUrl) != null ? e : M, a = y == null ? void 0 : y.current;
			if (a && a.urlStatusClicked === o("WAWebWamEnumUrlStatusClicked").URL_STATUS_CLICKED.NO_CLICK && (a.urlStatusClicked = o("WAWebWamEnumUrlStatusClicked").URL_STATUS_CLICKED.ONE_CLICK), t === o("WAWebDisplayType").DISPLAY_TYPE.STATUS) {
				...
				if (i != null) {
					var l = o("WAWebStatusLinkFormatMutator").cleanUrl(i), u = l[0], d = l[1], m = o("WAWebStatusLinkFormatMutator").redactUrl(u, d);
					if (m !== u + d) {
		...
		}, X = N, Y = I, o("WAWebMediaLinkPreviewUtils").hqLinkPreviewExpired(k) || (J = T, Z = D, ee = x, te = $)), t === o("WAWebDisplayType").DISPLAY_TYPE.BOT_REELS_PLUGIN) {
			var re;
		...
		var oe = o("WAWebPaymentLink").getPaymentLinkOrderHeaderComponentDisplayParams(U);
		if (oe != null) return s.jsx(r("WAWebPaymentLinkOrderDetailsHeader.react"), {
			isSentByMe: w,
			matchedText: M,
			onClick: ne,
			parsedAmount: oe
		});
		var ae = l === !0 ? null : r("WAWebParseCallLinkType")(M, !0), ie = ae != null ? s.jsx(r("WAWebCallLinkPreviewThumbnail.react"), { callType: ae }) : null, le = ie != null ? {
			thumbnailJpeg: null,
		...
		return s.jsx(r("WAWebMediaLinkPreview.react"), babelHelpers.extends({
			...
			title: ae != null ? String(r("WAWebGetCallLinkPreviewTitle")(ae)) : P,
			star: A,
			kept: B,
			theme: g,
			matchedText: z != null ? z : M,
			botPluginReferenceIndex: u.botPluginType === o("WAWebProtobufsAICommon.pb").BotPluginMetadata$PluginType.SEARCH ? u.botPluginReferenceIndex : null,
			isLoading: !1,
			horizontalLayout: i
		}));
	}
