__d("WAWebMediaLinkPreviewImage.react", [
	...
	function m(t) {
		var n = t.displayType, a = t.isCompose, i = t.isFullPreview, l = t.isHighQualityLayout, s = t.isInvite, c = t.isStatus, m = t.theme, p = t.thumbnail, _ = t.thumbnailJpeg, f = t.thumbnailJpegDirectPath, g = t.thumbnailJpegHeight, h = t.thumbnailJpegHQ, y = t.thumbnailJpegWidth, C = t.withoutDescription, b = a && h != null && y != null && y > 240, v = m === "bot_plugin_link", S = m === "support_citations_link", R = (e || (e = r("stylex")))([
			...
			i && !l && C && d.fullPreviewNotHighQualityLayoutMediaWithoutDescription,
			s && d.isInviteMedia,
			a && !b && d.composeMedia
		]), L = n === o("WAWebDisplayType").DISPLAY_TYPE.GALLERY;
		if (p != null && p !== "") return u.jsx("div", {
		...
		if (_ != null && _ !== "" || h != null && h !== "") {
			...
			if (E != null) return u.jsx(r("WAWebMediaLinkPreviewImageLayout.react"), {
