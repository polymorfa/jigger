__d("WAWebMediaLruIdbStoreUtils", [
	"Promise",
	"WAWebAbstractStore",
	...
	var e, s = (function(t) {
		function r(e, n) {
			var r;
			return r = t.call(this) || this, r.$IdbStore$p_1 = e, r.$IdbStore$p_2 = n, r;
		}
		babelHelpers.inheritsLoose(r, t);
		var o = r.prototype;
		return o.doGet = (function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = this;
				return yield this.$IdbStore$p_1().then(function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				return yield this.$IdbStore$p_1(), this.$IdbStore$p_2.remove(e);
			});
			function t(t) {
				return e.apply(this, arguments);
			}
