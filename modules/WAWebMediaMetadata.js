__d("WAWebMediaMetadata", [
	...
	function u(t) {
		var n = t.mediaObject;
		if (!n) throw o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			"id: ",
			" type: ",
			""
		])), t.id.toString(), t.type).sendLogs("media-fault: mediaMetadata msg without mediaObject"), r("err")("msg.mediaMetadata with no mediaObject");
		var a = o("WAWebMediaCryptoEligibilityUtils").isMediaCryptoExpectedForMsg(t) ? n.entries.getEntryByEncFilehash({
			encFilehash: t.encFilehash,
			deprecatedMms3Url: t.deprecatedMms3Url
		}) : n.entries.getUnencryptedEntry(t.filehash, t.directPath);
		if (!a) throw o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose([
			"id: ",
			" type: ",
			""
		])), t.id.toString(), t.type).sendLogs("media-fault: mediaMetadata no entry"), r("err")("msg.mediaMetadata with entry mismatch");
		var i = t.mediaData;
		return {
	...
	function c(e, t) {
		if (o("WAWebMediaCryptoEligibilityUtils").isMediaCryptoExpectedForMsg(e)) return t;
