__d("WAWebMediaPanelHeaderButtons.react", [
	...
	function E(e) {
		...
		var p = m, _;
		return t[7] !== p || t[8] !== l ? (_ = l === C.Dropdown ? g.jsx(r("WDSMenuItem.react"), {
			onPress: p,
	...
	function k(e) {
		...
		return t[0] !== n.id ? (a = g.jsx(r("WDSMenuItem.react"), {
	...
	function I(e) {
		var t = o("react-compiler-runtime").c(8), a = e.msg, i = e.onClose, l = e.theme, u = l === void 0 ? "default" : l, c;
		t[0] !== a || t[1] !== i || t[2] !== u ? (c = function(t) {
			i(), o("WAPromiseDelays").delayMs(o("WAWebMediaViewerConstants").CLOSE_ANIMATION_DURATION).then(function() {
				if (u === "media_hub") {
			...
			}).then(b.bind(null, o("WAWebStateUtils").unproxy(a)));
		}, t[0] = a, t[1] = i, t[2] = u, t[3] = c) : c = t[3];
		var d = c, m;
		t[4] === Symbol.for("react.memo_cache_sentinel") ? (m = r("WAWebMediaPanelHeaderTestIds").REPLY_BUTTON.valueOf(), t[4] = m) : m = t[4];
		var p;
		...
		var f;
		return t[6] !== d ? (f = g.jsx(r("WDSMenuBarItem.react"), {
			testid: m,
	...
	function T(e) {
		...
		var d;
		return t[5] !== l ? (d = g.jsx(r("WDSMenuBarItem.react"), {
			testid: u,
	...
	function D(e) {
		...
		var f = _, h;
		return t[6] !== p || t[7] !== a || t[8] !== c ? (h = c === C.Dropdown ? g.jsx(r("WDSMenuItem.react"), {
			onPress: p,
			disabled: !a(),
	...
	function x(e) {
		...
		var c;
		return t[3] !== l ? (c = g.jsx(r("WDSMenuBarItem.react"), {
	...
	function $(e) {
		...
		var c;
		return t[2] !== a || t[3] !== i ? (c = g.jsx(r("WDSMenuBarItem.react"), {
			ref: i,
			testid: l,
	...
	function P(e) {
		...
		var m = o("useWAWebMsgValues").useMsgValues(n.id, d), p = m[0], _ = i === "media_hub", f;
		t[1] !== n || t[2] !== _ ? (f = function(t) {
		...
		var R;
		return t[11] !== l || t[12] !== u || t[13] !== S || t[14] !== c ? (R = g.jsx(r("WDSMenuBarItem.react"), {
			testid: S,
			icon: l,
			title: c,
			onClick: u
	...
	function N(e) {
		...
		var y;
		return t[9] !== u || t[10] !== c || t[11] !== h || t[12] !== d ? (y = g.jsx(r("WDSMenuBarItem.react"), {
			testid: h,
			icon: c,
			title: d,
			onClick: u
	...
	function A(e) {
		...
		var u;
		return t[3] !== i ? (u = g.jsx(r("WDSMenuItem.react"), {
			testid: "mi-msg-reply",
			onPress: i,
	...
	function O(e) {
		...
		var l;
		return t[3] !== a ? (l = g.jsx(r("WDSMenuItem.react"), {
