__d("WAWebMediaPdfSharerIframe.react", [
	...
	function c(e) {
		...
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (a = o("WAWebTPFrameUrlBuilder").getWAWebTPPdfSharerUrl(), t[0] = a) : a = t[0];
		var i = a, l;
		...
		return t[2] !== n ? (u = s.jsx("iframe", babelHelpers.extends({
			...
			ref: n,
			src: i,
			"data-testid": r("WAWebPdfViewerTestIds").EDIT_MODAL_IFRAME
