__d("WAWebMediaStage.react", [
	...
	function m(e) {
		var t = e.mediaData, n = e.msg, a = o("useWAWebModelValues").useModelValues(t, [
			"mediaStage",
			"size",
			"streamable"
		]), i = a.mediaStage, l = a.size;
		...
		switch (i) {
			...
			case o("WAWebMediaTypes").MediaDataStage.NEED_POKE: return s.jsx(r("WAWebMediaStateControlDownload.react"), {
				filesize: l,
				onClick: function(t) {
					return u(t, n);
				}
			...
			case o("WAWebMediaTypes").MediaDataStage.FINALIZING: return s.jsx("div", {
				onClick: function(t) {
					return c(t, n);
				},
				children: s.jsx(o("WAWebMediaStateControls.react").Pending, { cancelable: !0 })
			});
			case o("WAWebMediaTypes").MediaDataStage.ERROR_UNSUPPORTED: return s.jsx(r("WAWebMediaStateControlDownload.react"), {
				filesize: l,
				onClick: function(t) {
					return d(t, n);
				}
