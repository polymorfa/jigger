__d("WAWebMediaStickers", [
	...
	function C(e) {
		y(e, e.mediaObject || g(e), o("WAWebMmsMediaTypes").MEDIA_TYPES.STICKER, !1);
	}
	function b(e) {
		var t = e.mediaObject;
	...
	function v(e) {
		y(e, e.mediaObject || h(e), o("WAWebMmsMediaTypes").MEDIA_TYPES.IMAGE, !0);
	}
	function S(e) {
		var t = e.mediaObject;
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.shouldThrow, a = t === void 0 ? !0 : t, i = e.sticker, l = e.type;
			if (i.isPlaceholder === !0 || i.isCreateButton === !0) return i.mediaData.mediaStage = o("WAWebMediaTypes").MediaDataStage.PREPARING, (p || (p = n("Promise"))).resolve();
			var s = i.mediaObject;
			if (!s) return (p || (p = n("Promise"))).reject(r("err")("media-fault: downloadStickerOrStickerPackIcon sticker/stickerPack without mediaObject"));
			var u = l === "STICKER" ? o("WAWebWamEnumWebcRmrReasonCode").WEBC_RMR_REASON_CODE.STICKER_PANEL_STICKER : o("WAWebWamEnumWebcRmrReasonCode").WEBC_RMR_REASON_CODE.STICKER_PANEL_ICON, c = !1;
			yield s.getPendingProcess("fromDisk").then(function() {
				if (!i.filehash || !i.mediaKey || !i.encFilehash) return c = !0, o("WAWebDownloadManager").downloadManager.rmr({
					mediaObject: s,
				...
				if (e.mediaType !== o("WAWebMmsMediaTypes").MEDIA_TYPES.NEWSLETTER_STICKER) throw o("WALogger").ERROR(m || (m = babelHelpers.taggedTemplateLiteralLoose(["Unexpected RMR error for media type ", ""])), e.mediaType).sendLogs("failed-to-download-sticker-rmr"), e;
			}));
			var d = s.entries.getDownloadEntry(!0);
			c && d instanceof o("WAWebMediaEntry").EncryptedMediaEntry && o("WAWebRecentStickerCollectionMd").RecentStickerCollectionMd.updateStickerMediaData(i.filehash, d);
		}), L.apply(this, arguments);
	}
	function E(e) {
		o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["Prepping sticker"])));
		var t = e.mediaObject, a = e.mediaData.toJSON();
		return a.fullWidth = _, a.fullHeight = _, t ? new (o("WAWebMediaPrep")).MediaPrep(a.type, (p || (p = n("Promise"))).resolve(a)) : (o("WALogger").ERROR(d || (d = babelHelpers.taggedTemplateLiteralLoose(["id: ", ""])), e.id).sendLogs("media-fault: prepSticker sticker without mediaObject"), new (o("WAWebMediaPrep")).MediaPrep(a.type, (p || (p = n("Promise"))).reject(r("err")("non initialized media"))));
	}
	l.registerSticker = C, l.deregisterSticker = b, l.registerStickerPackIcon = v, l.deregisterStickerPackIcon = S, l.downloadStickerOrStickerPackIcon = R, l.prepSticker = E;
}), 98);
