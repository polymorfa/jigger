__d("WAWebMediaStore", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			var t = yield o("WAWebStoreQuotaManager").storeQuotaManager.getQuotaForStore("lru-media-store");
	...
	function p() {
		if (r("WAWebIndexedDB") != null) {
			...
			return "caches" in self ? new (r("WAWebMediaArrayBufferCacheStore"))("lru-media-array-buffer-cache") : e;
		}
		return null;
	}
	var _ = new c();
