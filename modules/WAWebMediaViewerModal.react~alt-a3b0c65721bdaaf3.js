__d("WAWebMediaViewerModal.react", [
	...
	function I(e) {
		if (o("WAWebTPPdfViewerGatingUtils").isWebTPPdfAnnotationsEnabled()) {
			var t;
			return g.jsx(o("WAWebTPEditPdfInWhatsappContext.react").WAWebTPEditPdfInWhatsappProvider, {
				filehash: (t = e.mediaData) == null ? void 0 : t.filehash,
				children: g.jsx(T, babelHelpers.extends({}, e))
			});
		}
		return g.jsx(T, babelHelpers.extends({}, e));
	}
	...
	function D(e) {
		var t = e.children, n = e.hasNavigationButtons, a = e.imgZoomed, i = e.onNext, l = e.onPrev, u = C(o("WAWebMediaIncrementalZoom").MediaIncrementalZoomCtx).isZoomedIn, c = v(), d = v();
		return g.jsxs(g.Fragment, { children: [
			n && g.jsx("div", babelHelpers.extends({}, (p || (p = r("stylex"))).props(r("WAWebMediaViewerModalStyle").mediaNavBtn, r("WAWebMediaViewerModalStyle").mediaNavBtnPrev, u && r("WAWebMediaViewerModalStyle").mediaNavBtnHidden, r("WAWebMediaViewerModalStyle").mediaNavBtnPrevIncrementalZoom), { children: g.jsx("div", {
				onClick: l ? null : P,
			...
			t,
			n && g.jsx("div", babelHelpers.extends({}, (p || (p = r("stylex"))).props(r("WAWebMediaViewerModalStyle").mediaNavBtn, r("WAWebMediaViewerModalStyle").mediaNavBtnNext, u && r("WAWebMediaViewerModalStyle").mediaNavBtnHidden, r("WAWebMediaViewerModalStyle").mediaNavBtnNextIncrementalZoom), { children: g.jsx("div", {
				onClick: i ? null : P,
				children: g.jsx(r("WDSTooltip.react"), {
					id: d,
					label: s._(
