__d("WAWebMediaWorkerProxy", ["asyncToGeneratorRuntime", "cr:36997"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e) {
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield n("cr:36997").detectAiProvenanceInWorker(e), r = t.engineErrorCode, o = t.provenance, a = t.transferredBuffer;
			return {
				transferredBuffer: a,
				provenance: h(o),
				engineErrorCode: r
	...
	l.calculateFilehashInWorker = e, l.hmacSha256InWorker = u, l.transcodeToMp4InWorker = d, l.mp4RepairMuxInWorker = p, l.kaleidoscopeClassifyInWorker = f, l.detectAiProvenanceInWorker = y, l.prewarmMediaWasmWorker = b;
}), 98);
