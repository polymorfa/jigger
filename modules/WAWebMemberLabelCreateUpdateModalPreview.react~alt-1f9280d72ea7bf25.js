__d("WAWebMemberLabelCreateUpdateModalPreview.react", [
	...
	function m(e) {
		var t, n = e.memberLabel, a = o("WAWebUserPrefsMeUser").getMaybeMePnUser(), i = c(function() {
			if (a == null) return null;
			var e = o("WAWebContactCollection").ContactCollection.get(a);
			return e != null ? o("WAWebFrontendContactGetters").getFormattedUser(e) : null;
		}, [a]);
		return u.jsxs(u.Fragment, { children: [u.jsx((t = o("WAWebFlex.react")).FlexRow, {
			xstyle: d.chatTitle,
			align: "stretch",
			...
			children: [u.jsx(r("WAWebConversationBackground.react"), {
				...
				children: u.jsxs(t.FlexRow, {
					...
					children: [u.jsx(t.FlexRow, {
						...
						children: a != null ? u.jsx(o("WAWebDetailImage.react").DetailImage, {
							id: a,
							size: o("WAWebDetailImage.react").DetailImageSize.None
						}) : null
					}), u.jsxs(o("WAWebFlex.react").FlexRow, {
						grow: 1,
						children: [u.jsx(o("WAWebTailInIcon.react").TailInIcon, { xstyle: d.labelPreviewMessageBubbleTail }), u.jsxs(o("WAWebFlex.react").FlexColumn, {
