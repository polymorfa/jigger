__d("WAWebMemberLabelDeleteModal.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(9), a = e.onDelete, i = c(!1), l = i[0], d = i[1], p = m, _;
		...
		var v = b, S;
		t[5] === Symbol.for("react.memo_cache_sentinel") ? (S = u.jsx(r("WDSText.react"), {
			type: "Body1",
			colorName: "contentDeemphasized",
			children: h
		}), t[5] = S) : S = t[5];
		var R;
		return t[6] !== v || t[7] !== l ? (R = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			onOK: v,
			okText: C,
