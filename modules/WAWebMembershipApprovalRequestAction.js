__d("WAWebMembershipApprovalRequestAction", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = o("WAWebStateUtils").unproxy(e), n = (yield o("WAWebApiMembershipApprovalRequestStore").getMembershipApprovalRequests(t.id)).map(function(e) {
	...
	var d = (function() {
		var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, r) {
			...
			try {
				var i, l = yield o("WAWebGroupMembershipRequestsActionJob").membershipApprovalRequestAction(a.id, [o("WAWebGroupMutationParticipantUtils").getGroupMutationParticipant(n.contact, ((i = a.groupMetadata) == null ? void 0 : i.isLidAddressingMode) === !0, "membershipApprovalRequest")], r), u = l[0], c = u.error, d = u.phoneNumber, m = u.username, p = u.wid;
				if (c != null) {
				...
				if (g) {
					...
					yield o("WAWebCreateOrReplaceDisplayNamesAndLidPnMappingsJob").createOrReplaceDisplayNamesAndLidPnMappingsInBatches(h, !0);
				}
				o("WAWebUsernameGatingUtils").usernameDisplayedEnabled() && m != null && (yield o("WAWebSetUsernameJob").setUsernamesJob([{
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			try {
				yield d(e, t, o("WAWebGroupMembershipRequestsActionJob").MembershipApprovalRequestAction.Approve);
			} catch (e) {
				throw a = !1, e;
			} finally {
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			var r = self.performance.now(), a = !0;
			try {
				yield d(e, t, o("WAWebGroupMembershipRequestsActionJob").MembershipApprovalRequestAction.Reject);
			} catch (e) {
				throw a = !1, e;
			} finally {
				var i = self.performance.now() - r;
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				var l = yield o("WAWebGroupCancelMembershipRequestJob").cancelMembershipApprovalRequestJob(t, [i]), u = l[0], c = u.error;
				if (c != null) {
	...
	l.GroupError = e, l.RequestError = s, l.readMembershipApprovalRequestsFromDB = u, l.approveMembershipApprovalRequest = m, l.rejectMembershipApprovalRequest = _, l.cancelMembershipApprovalRequest = g;
}), 98);
