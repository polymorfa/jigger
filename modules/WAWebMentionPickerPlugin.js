__d("WAWebMentionPickerPlugin", [
	...
	function R(t) {
		var a = o("react-compiler-runtime").c(64), i = t.chat, l = t.elevatedPushNamesEnabled, u = t.source, d = o("LexicalComposerContext").useLexicalComposerContext(), m = d[0], R = i.groupMetadata, P = p(!1), N = P[0], M = P[1], w;
		...
		var q = o("useWAWebLexicalTypeAhead").useTypeAhead(m, o("WAWebRichTextInputConst").AT_SYMBOL, W), U = q.leadOffset, V = q.omitQuery, H = q.query, G = q.replaceQuery, z;
		a[6] !== G ? (z = function(t) {
			G(function() {
		...
		var j = z, K;
		a[8] !== i || a[9] !== G ? (K = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				o("WAWebComposeBoxActions").ComposeBoxActions.setNonJidMentions(i, 1), G(D, { trailingSpace: !0 }), o("WAWebMentionPickerActionLoggingUtils").logMentionPickerAction(i, o("WAWebWamEnumMentionType").MENTION_TYPE.EVERYONE);
			});
			return function() {
				return e.apply(this, arguments);
			};
		})(), a[8] = i, a[9] = G, a[10] = K) : K = a[10];
		var Q = K, X = T, Y;
		a[11] !== i || a[12] !== j || a[13] !== Q ? (Y = function(t) {
			if (t.type === "mention_all") {
				Q();
				return;
			}
			if (t.type === "contact" || t.type === "group") if (o("WAWebLimitSharingUIUtils").isLimitSharingReceiverEnabledForUsers(i, [t.id])) o("WAWebLimitSharingUIUtils").showLimitSharingInvokeBlockedPopup(i);
			else {
				j(t.id);
				var e = t.type === "contact" ? o("WAWebWamEnumMentionType").MENTION_TYPE.REGULAR_USER : o("WAWebWamEnumMentionType").MENTION_TYPE.GROUP;
				o("WAWebMentionPickerActionLoggingUtils").logMentionPickerAction(i, e);
			}
		}, a[11] = i, a[12] = j, a[13] = Q, a[14] = Y) : Y = a[14];
		var J = Y, Z;
		a[15] !== i || a[16] !== R || a[17] !== J ? (Z = function(t) {
			if (!(t.type === "contact" && o("WAWebBotUtils").isWidTeeGroupMetaBotFbidWid(t.id)) && X(t)) {
				if (t.type === "mention_all") {
					J(t);
					return;
				}
				...
				n ? o("WAWebBotDisclaimerManager").enterBotTosFlow({
					...
					J(e);
				}).catch(r("WAWebNoop")) : J(e);
			}
		}, a[15] = i, a[16] = R, a[17] = J, a[18] = Z) : Z = a[18];
		var ee = Z, te;
		a[19] !== V ? (te = function() {
			V();
		}, a[19] = V, a[20] = te) : te = a[20];
		var ne = te, re;
		a[21] !== i || a[22] !== m || a[23] !== l || a[24] !== j ? (re = function(n, a) {
			switch (n.type) {
				case "contact": {
					var t = n, u = o("WAWebBotUtils").isWidTeeGroupMetaBotFbidWid(t.id), d = o("WAWebLimitSharingUIUtils").isLimitSharingReceiverEnabledForUsers(i, [t.id]), p = u || d;
					return t.id.isBot() && !o("WAWebBotTos").hasSeenMasterBotTos() && !o("WAWebBotTos").hasSeenInvokeTos() && !p ? c.jsx(r("WAWebBotInvokeUpsellRow.react"), { selected: a }) : c.jsx(o("WAWebMentionsPluginResult.react").UserResult, {
						contact: t.contact,
						term: t.query,
						theme: null,
						selected: a,
				...
				case "mention_all": return c.jsx(o("WAWebMentionsPluginResult.react").MentionAllResult, { selected: a });
				case "non_participant_contact": {
					...
					return c.jsx(o("WAWebMentionsPluginResult.react").NonParticipantUserResult, {
						...
						onAddConfirmed: function(t) {
							M(!1), j(t.id), o("WAWebMentionPickerActionLoggingUtils").logMentionPickerAction(i, o("WAWebWamEnumMentionType").MENTION_TYPE.NON_GROUP_USER, !0);
						},
		...
		}, a[21] = i, a[22] = m, a[23] = l, a[24] = j, a[25] = re) : re = a[25];
		var oe = re, ae;
		e: {
			var ie = o("WAWebTextStatusGatingUtils").receiveTextStatusForNewSurfacesEnabled() ? h : g;
			if (H == null) {
				ae = null;
				break e;
			}
			...
			var se;
			if (a[26] !== O || a[27] !== R || a[28] !== H || a[29] !== u || a[30] !== A) {
				var ue = [], ce = A && O;
				if ((R == null ? void 0 : R.id) != null && $({
					groupMetadata: R,
					query: H,
					source: u
				})) {
					var de;
					a[32] !== R.id || a[33] !== ue.length || a[34] !== H ? (de = {
						type: "mention_all",
						selectable: !0,
						index: ue.length,
						itemKey: "mention-all",
						...
						id: R.id,
						query: H
					}, a[32] = R.id, a[33] = ue.length, a[34] = H, a[35] = de) : de = a[35], ue.push(de);
				}
				if (A) {
					...
					if (me.length !== 0) {
						if (ce) {
							...
							a[36] !== ue.length ? (pe = {
								...
								selectable: !1,
								height: f
							}, a[36] = ue.length, a[37] = pe) : pe = a[37], ue.push(pe);
						}
					...
					if (fe.length !== 0) {
						if (ce) {
							...
							a[38] !== ue.length ? (ge = {
								...
								selectable: !1,
								height: f
							}, a[38] = ue.length, a[39] = ge) : ge = a[39], ue.push(ge);
						}
				...
				se = ue.length ? ue.slice(0, 15) : null, a[26] = O, a[27] = R, a[28] = H, a[29] = u, a[30] = A, a[31] = se;
			} else se = a[31];
			ae = se;
		}
		var ye = ae, Ce;
		e: {
			...
			if (R.groupType === o("WAWebGroupType").GroupType.LINKED_ANNOUNCEMENT_GROUP) {
				Ce = !1;
				break e;
			}
			...
			if (be != null && !R.participants.iAmAdmin()) {
				var ve = r("WAWebGroupMetadataCollection").get(be), Se = o("WAWebCommunityAnnouncementGroupUtils").getCommunityAnnouncementGroup(ve);
				if (Se != null && Se.memberAddMode !== o("WAWebSchemaGroupMetadata").MemberAddMode.ALL_MEMBER_ADD) {
					Ce = !1;
					break e;
				}
			}
		...
		e: {
			...
			var ke = o("WAWebABProps").getABPropConfigValue("enhanced_mention_limit");
			if (ke <= 0) {
				Le = !1;
				break e;
			}
			var Ie = o("WAWebABProps").getABPropConfigValue("enhanced_mention_suggestions_min_mention_char_count");
			if (Ie > 0 && H.length < Ie) {
				Le = !1;
				break e;
			}
		...
		e: {
			...
			var xe;
			a[40] !== R ? (xe = o("WAWebMentionsPluginUtil").getNonParticipantCandidates(R), a[40] = R, a[41] = xe) : xe = a[41], De = xe;
		}
		var $e = De, Pe;
		if (a[42] !== $e || a[43] !== H) {
			e: {
				...
				var Ne = o("WAWebABProps").getABPropConfigValue("enhanced_mention_limit");
				if (Ne <= 0) {
					Pe = null;
					break e;
				}
				...
				var we = o("WAWebTextStatusGatingUtils").receiveTextStatusForNewSurfacesEnabled() ? h : g, Ae = [], Fe;
				a[45] === Symbol.for("react.memo_cache_sentinel") ? (Fe = {
					index: 0,
					itemKey: "section-non-participants-separator",
					type: "non_participant_separator",
					selectable: !1,
					height: y
				}, a[45] = Fe) : Fe = a[45], Ae.push(Fe);
				var Oe;
				a[46] !== H ? (Oe = function(t, n) {
					return {
		...
		e: {
			...
			if (a[48] !== We || a[49] !== ye) {
				...
				if (We != null) {
					var He, Ge;
					a[51] !== We ? (Ge = We.filter(E), a[51] = We, a[52] = Ge) : Ge = a[52];
					var ze = Ge;
		...
		var je = qe, Ke, Qe;
		a[53] !== je || a[54] !== oe || a[55] !== ee || a[56] !== N ? (Ke = N ? [] : (je != null ? je : []).map(function(e) {
			return {
				renderFn: function(n) {
					return oe(e, n);
				},
		...
		}), Qe = Ke.findIndex(L), a[53] = je, a[54] = oe, a[55] = ee, a[56] = N, a[57] = Ke, a[58] = Qe) : (Ke = a[57], Qe = a[58]);
		var Xe = Qe, Ye;
		return a[59] !== Xe || a[60] !== ne || a[61] !== Ke || a[62] !== U ? (Ye = c.jsx(r("WAWebLexicalTypeAheadList.react"), {
			leadOffset: U,
			items: Ke,
			onCancel: ne,
			startingIndex: Xe
		}), a[59] = Xe, a[60] = ne, a[61] = Ke, a[62] = U, a[63] = Ye) : Ye = a[63], Ye;
	}
	function L(e) {
