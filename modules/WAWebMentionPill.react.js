__d("WAWebMentionPill.react", [
	...
	function m(e) {
		var t = e.isLight, n = e.isMe, r = e.isOutgoing, o = e.isQuoted, a = e.isRead;
		return o === !0 ? d.pillQuoted : r ? d.pillOutgoing : n && a ? t ? d.pillMeReadIncomingLight : d.pillMeReadIncomingDark : n ? d.pillMeUnreadIncoming : d.pillOthersIncoming;
	}
	function p(t) {
		var n = o("react-compiler-runtime").c(14), a = t.children, i = t.isMe, l = t.isOutgoing, s = t.isQuoted, p = t.isRead, _ = t.onClick, f = o("WAWebThemeContext").useTheme(), g = f.theme, h, y;
		if (n[0] !== i || n[1] !== l || n[2] !== s || n[3] !== p || n[4] !== g) {
			...
			h = o("WAWebClickable.react").Clickable, y = (e || (e = r("stylex")))([d.pill, C]), n[0] = i, n[1] = l, n[2] = s, n[3] = p, n[4] = g, n[5] = h, n[6] = y;
		} else h = n[5], y = n[6];
		var b = s === !0 ? void 0 : _, v = s === !0 ? -1 : 0, S;
		n[7] === Symbol.for("react.memo_cache_sentinel") ? (S = u.jsx("span", {
		...
		var R;
		return n[8] !== h || n[9] !== a || n[10] !== y || n[11] !== b || n[12] !== v ? (R = u.jsxs(h, {
			className: y,
			onClick: b,
			role: "button",
			tabIndex: v,
			children: [S, a]
		}), n[8] = h, n[9] = a, n[10] = y, n[11] = b, n[12] = v, n[13] = R) : R = n[13], R;
	}
	l.default = p;
}), 98);
