__d("WAWebMenuController.react", [
	...
	function I(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, s), l = i.allowTabNavigation, c = l === void 0 ? !1 : l, m = i.autoScroll, p = m === void 0 ? !0 : m, f = i.border, v = i.children, S = i.colorScheme, R = S === void 0 ? "lighter" : S, L = i.data, E = i.focusOnMount, I = E === void 0 ? !1 : E, T = i.forceSelection, D = i.initialActiveOptionId, x = i.material, $ = x === void 0 ? !1 : x, P = i.maxHeight, N = i.menuControllerRef, M = i.minWidth, w = i.onActiveItemChange, A = i.onHotKeysFocus, F = i.onSelect, O = i.size, B = O === void 0 ? "small" : O, W = i.useLegacyDesign, q = W === void 0 ? !1 : W, U = L, V = y(), H = C(), G = H[0], z = H[1], j = h(function() {
			return new (r("WAWebEventEmitter"))();
		}, []), K = h(function() {
			return G != null ? G : Array.from(U.keys());
		}, [G, U]), Q = o("useWAWebNavigatableList").useNavigatableList(K), X = Q.NavigatableList, Y = Q.activeItem, J = Q.listSelection, Z = (function() {
			...
			if (t != null && t.current != null) {
				var r = t.current;
				r.onSelect == null || r.onSelect(), j.trigger("select", n, r, U), F == null || F(n, r, U);
			...
			if (V.current != null && (t == null ? void 0 : t.current) != null) {
				...
				n != null && o("WAWebDomScroll").scrollIntoViewIfNeeded(n, !1, V.current);
			}
		}, [U]);
		g(function() {
			p === !0 && Y != null && ne(Y);
