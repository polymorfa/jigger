__d("WAWebMerchantComplianceJob", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = yield o("WAWebBizGetMerchantCompliance").getMerchantCompliance({ biz_jid: (t = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(e[0].wid)) != null ? t : e[0].wid.toJid() });
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.customerCareDetails, a = e.entityName, i = e.entityType, l = e.entityTypeCustom, s = e.grievanceOfficerDetails, u = e.isRegistered, c = u === void 0 ? !1 : u, d = o("WAWebUserPrefsMeUser").getMePnUserOrThrow_DO_NOT_USE(), m = {};
			if (m.is_registered = c, a !== void 0 && (m.entity_name = a), m.entity_type = f(i), l !== void 0 && (m.entity_type_custom = l), n) {
				var p = {};
				n.email !== void 0 && (p.email = n.email), n.landlineNumber !== void 0 && (p.landline_number = n.landlineNumber), n.mobileNumber !== void 0 && (p.mobile_number = n.mobileNumber), m.customer_care_details = p;
			}
			if (s) {
				var _ = {};
				s.name !== void 0 && (_.name = s.name), s.email !== void 0 && (_.email = s.email), s.landlineNumber !== void 0 && (_.landline_number = s.landlineNumber), s.mobileNumber !== void 0 && (_.mobile_number = s.mobileNumber), m.grievance_officer_details = _;
			}
			var g = yield o("WAWebBizSetMerchantCompliance").setMerchantCompliance({
				biz_jid: (t = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(d)) != null ? t : d.toJid(),
				merchant_info: m
			});
