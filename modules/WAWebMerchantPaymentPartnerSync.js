	...
	var e, s, u = (function(t) {
		...
		return a.getVersion = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				return o("WAWebMobilePlatforms").isSMB() !== !0 ? (o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[MerchantPaymentPartner] unsupported: not SMB"]))), t.map(function() {
					return { actionState: o("WAWebSyncdConst").SyncActionState.Unsupported };
				})) : (o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[MerchantPaymentPartner] unsupported: ABProp failed"]))), t.map(function() {
					return { actionState: o("WAWebSyncdConst").SyncActionState.Unsupported };
				}));
			});
			function r(e) {
