__d("WAWebMessageBizContentPlaceholder", [
	...
	var e, s = e || (e = o("react"));
	function u() {
		o("WAWebExternalLink.react").openExternalLink("https://faq.whatsapp.com/372839278914311");
	}
	...
	function d(e) {
		var t = e.displayAuthor, n = e.msg, a = s.jsx(r("WAWebUnsupportedMessage"), {
			msg: n,
			displayAuthor: t,
			hideUpdateButton: !0
		}), i = n.unsafe();
		...
		switch (i.bizContentPlaceholderType) {
			case o("WAWebBizContentPlaceholderMsgData.flow").BizContentPlaceholderType.MASK_LINKED_DEVICES: return s.jsx(r("WAWebMessageTextBubble.react"), {
				msg: n,
				displayAuthor: t,
