__d("WAWebMessageCommunityEmptySubgroupWelcome.react", [
	...
	function d(e) {
		var t, n = e.subgroupChat, a = e.templateParams, i = a[0], l = a[1], d = a[2], m = a[3], p = a[4], _ = o("WAWebChatCollection").ChatCollection.get(i), f = (t = _ == null ? void 0 : _.formattedTitle) != null ? t : l, g = d != null ? d : n.formattedTitle, h = m === "true", y = p === "true", C = o("WAWebCommunitySubgroupInviteLinkRestriction").isSubgroupInviteLinkRestrictedByParentCommunity(n.groupMetadata), b = _ ? u.jsx(o("WAWebFlex.react").FlexRow, {
			align: "center",
			justify: "center",
		...
		}) : null, v = r("useWAWebAddParticipantsSelectedContacts")(), S = v.handleClearSelectedContacts, R = v.selectedContactsMap, L = v.updateSelectedContactsState, E = function() {
		...
		return f && (y === !0 ? I = s._(
			...
			u.jsxs("div", {
				className: "x1iw51ew xde1mab x1xrf6ya xscbp6u xso031l x1q0q8m5 x120ee7l",
				children: [
					b,
					...
					u.jsx(o("WAWebFlex.react").FlexRow, {
						justify: "center",
						children: u.jsx(o("WAWebText.react").WAWebTextSmall, { children: u.jsx(o("WAWebEmojiText.react").EmojiText, { text: I }) })
					})
				]
			}),
			...
			!C && u.jsxs(r("WAWebUnstyledButton.react"), {
				onClick: k,
				xstyle: [c.button, c.marginVert20],
				children: [u.jsx(o("WAWebFlex.react").FlexRow, {
					align: "center",
