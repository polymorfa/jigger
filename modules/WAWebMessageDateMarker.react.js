__d("WAWebMessageDateMarker.react", [
	...
	function h(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, u), l = i.chat, c = i.isFocusable, m = i.isGroupHistoryMessage, h = i.timestamp, y = g(null), C = y[0], b = y[1];
		function v() {
			try {
				return o("WAWebClock").Clock.relativeDateStr(h);
			} catch (t) {
				return o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Clock.relativeDateStr(", ")"])), h), o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose(["Clock.relativeDateStr failed: ", ""])), t).sendLogs("relative-date-str-error", { sampling: .001 }), "";
			}
		}
		var S = g(v()), R = S[0], L = S[1], E = f(null), k = f(null), I = g(!1), T = I[0], D = I[1], x = _(function() {
			return h >= r("WAWeb-moment")().startOf("day").subtract(7, "day").unix();
		}, [h]);
		function $() {
			L(v());
		}
		o("useWAWebListener").useListener(x ? o("WAWebCmd").Cmd : null, "midnight", $);
		var P = function() {
			return h;
		}, N = function() {
			T && D(!1);
		...
		var A = o("WAWebSearchByTypeAndDateGatingUtils").dateMarkerCalendarEnabled() && l != null, F = function() {
			b(null);
		}, O = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (o("WAWebCoreActionsODS").logCalendarDateSelectedFromDateMarker(), l != null) {
			...
			A && (o("WAWebCoreActionsODS").logCalendarOpenFromDateMarker(), b({
		...
		if (T) return null;
		var W = C ? d.jsx(o("WAWebUimUie.react").UIE, {
