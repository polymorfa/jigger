__d("WAWebMessageEditAddonMessageProcessor", [
	...
	var e = o("WAWebAddonCreateMsgProcessor").createAddonMsgProcessor({
		...
		beforeUpsert: async function(t, n) {
			var e = n.parents, r = await o("WAWebProcessEncryptedMessageEditMsgs").processEncryptedMessageEditMsgs(t, e), a = r.filter(function(e) {
				return e.isLatest;
			});
			return await o("WAWebDBProcessEditProtocolMsgs").updateMessageEditsLocally(r, a), [];
		},
