__d("WAWebMessageForwardedIndicator.react", [
	...
	function d(t) {
		var n, a = t.className, i = t.msg, l = t.xstyle;
		...
		return u.jsxs("div", {
			...
			className: o("WAWebClassnames").classnamesConvertMeToStylexPlease((e || (e = r("stylex")))(c.container, l), a),
			children: [
				d,
				u.jsx(r("WAWebMessageTopIndicatorText.react"), { children: o("WAWebForwardUtils").getForwardedIndicatorText(i) }),
				u.jsx(r("WAWebMessageForwardedIndicatorSearchTheWeb.react"), { msg: i }),
				u.jsx(r("WAWebForwardedNewsletterMessageInfoHeader.react"), { msg: t.msg }),
				u.jsx(r("WAWebForwardedAiBotMessageInfoHeader.react"), { msg: t.msg })
			]
		});
	}
