__d("WAWebMessageGroupNotification.react", [
	...
	function b(e) {
		var t = e.clickable, n = e.subtype, a = e.type, i = m.jsx(o("WAWebMegaphoneRefreshedIcon.react").MegaphoneRefreshedIcon, {
			directional: !0,
			height: 16,
			width: 16
		});
		if (a === "gp2") {
			if (n === "announce") return m.jsx("div", {
			...
			if (n === "ephemeral" && t) {
				...
				return m.jsx("div", {
					className: "x1rg5ohu xhslqc4 x7g7pl8 xg49k01",
					children: m.jsx(l, { iconXstyle: C.iconDisappearingSvg })
				});
			}
		}
		return null;
