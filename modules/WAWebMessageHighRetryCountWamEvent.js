__d("WAWebMessageHighRetryCountWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MessageHighRetryCount: [
		3132,
		{
			deviceSizeBucket: [5, o("WAWebWamEnumSizeBucket").SIZE_BUCKET],
			e2eSenderType: [3, o("WAWebWamEnumE2eDeviceType").E2E_DEVICE_TYPE],
			encryptionType: [10, o("WAWebWamEnumEncryptionTypeCode").ENCRYPTION_TYPE_CODE],
			...
			sessionScope: [11, o("WAWebWamEnumSessionScopeType").SESSION_SCOPE_TYPE]
		},
		[
			1,
			20,
