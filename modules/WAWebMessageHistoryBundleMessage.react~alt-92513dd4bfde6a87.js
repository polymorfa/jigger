__d("WAWebMessageHistoryBundleMessage.react", [
	...
	function p(e) {
		var t = e.msg, n = e.ref, a = o("useWAWebMsgValues").useMsgValues(t.id, [o("WAWebMsgGetters").getGroupHistoryBundleMetadata]), i = a[0], l = i == null ? void 0 : i.processState;
		d(function() {
			var e;
			l !== o("WAWebGroupHistoryMsgData.flow").MessageHistoryBundleProcessState.NONE || !o("WAWebMsgModelPropUtils").isTrusted(t.unsafe()) || (e = t.id) != null && e.fromMe || r("WAWebDownloadHistoryBundleAction")(t, l, {
				downloadEvenIfExpensive: !1,
				rmrReason: o("WAWebWamEnumWebcRmrReasonCode").WEBC_RMR_REASON_CODE.MSG_RENDER,
				isUserInitiated: !1
			});
		}, [t, l]);
		var s = t.id.fromMe || l === o("WAWebGroupHistoryMsgData.flow").MessageHistoryBundleProcessState.DEDUPED;
		return c.jsx(o("WAWebSystemMessageWithSingleCTA.react").SystemMessageWithSingleCTA, {
			xstyle: [m.messageBody, l === o("WAWebGroupHistoryMsgData.flow").MessageHistoryBundleProcessState.FAILED && m.error],
			bodyText: o("WAWebFormatMessageHistoryBundleBody").formatMessageHistoryBundleBody(t, l),
