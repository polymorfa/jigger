__d("WAWebMessageNewsletterNotification.react", [
	...
	function f(t) {
		var n, a = t.msg, i = o("useWAWebMsgValues").useMsgValues(a.id, [o("WAWebMsgGetters").getSubtype, o("WAWebMsgGetters").getTemplateParams]), l = i[0], s = i[1], u = r("WAWebNewsletterCollection").get(a.id.remote), f = _({
			subtype: l,
			templateParams: s,
			chat: u
		}), g = c.jsx("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props([
			m.channelsIcon,
			d.marginTop3,
			...
			width: 14,
			height: 14
		}) })), h = c.jsx("span", { children: l === "newsletter_privacy" ? c.jsxs(c.Fragment, { children: [g, c.jsx(o("WAWebEmojiText.react").EmojiText, {
			breakWord: !0,
			text: p({
				subtype: l,
				templateParams: s
		...
		}) }), y = f != null ? c.jsx(r("WAWebClickableLink.react"), {
			onClick: f,
			xstyle: m.linkColor,
			children: h
		}) : h, C = l === "newsletter_admin_context_card" && u != null && o("WAWebNewsletterGatingUtils").isNewsletterAdminContextCardEnabled((n = o("WAWebStateUtils").unproxy(u).newsletterMetadata) == null ? void 0 : n.membershipType) ? c.jsx(r("WAWebNewsletterMessageAdminContextCard.react"), { chat: u }) : null;
		return c.jsx("div", {
			"data-testid": l ? "subtype-" + l : null,
			children: C != null ? C : y
		});
	}
