__d("WAWebMessageNotification.react", [
	...
	function R(e) {
		var t = o("react-compiler-runtime").c(23), n = e.chat, a = e.contact, i = e.displayAuthor, l = e.elRef, u = e.forwardClickRef, d = e.isMissedCall, m = e.isVideo, p = e.msg, _;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (_ = new (o("WAWebPreCallUserJourneyLogger")).PreCallUserJourneyLogger(), t[0] = _) : _ = t[0];
		var f = _, h, y, C;
		if (t[1] !== p) {
			h = o("WAWebMsgGetters").getCallDuration(p);
			var b = o("WAWebMsgGetters").getCallParticipants(p);
			y = o("WAWebClock").Clock.callDurationStrSimple(h != null ? h : 0), C = b != null ? r("countWhere")(b, L) : 0, t[1] = p, t[2] = h, t[3] = y, t[4] = C;
		} else h = t[2], y = t[3], C = t[4];
		var v = C, S;
		t[5] !== h || t[6] !== y || t[7] !== v ? (S = h != null && h > 0 ? s._(
			/*BTDS*/
			"",
			[s._param("time", y), s._param("joined-count", v)]
		) : null, t[5] = h, t[6] = y, t[7] = v, t[8] = S) : S = t[8];
		var R = S, E;
		t[9] !== d ? (E = function() {
			o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[voip] group ICCE bubble clicked, opening dropdown"]))), o("WAWebVoipActivityTracker").startUiActivityTracking(), o("WAWebVoipActivityTracker").trackUiActivity(o("WAWebVoipActivityTracker").VoipUiActivity.ICCE_BUBBLE_GROUP_DROPDOWN_OPEN), f.clickCallDropdown(d ? o("WAWebWamEnumSubSurface").SUB_SURFACE.MISSED_ICCE_BUBBLE : o("WAWebWamEnumSubSurface").SUB_SURFACE.ICCE_BUBBLE_OTHER_RESULT);
		}, t[9] = d, t[10] = E) : E = t[10];
		var k = E, I;
		t[11] !== a || t[12] !== i || t[13] !== l || t[14] !== u || t[15] !== p ? (I = function(t) {
			return g.jsx("div", {
				role: "button",
				ref: function(n) {
					l.current = n, t(n);
		...
		}, t[11] = a, t[12] = i, t[13] = l, t[14] = u, t[15] = p, t[16] = I) : I = t[16];
		var T;
		return t[17] !== n || t[18] !== k || t[19] !== R || t[20] !== m || t[21] !== I ? (T = g.jsx(r("WAWebGroupCallDropdownWithTrigger.react"), {
			chat: n,
			initialSubtext: R,
			isVideo: m,
			logger: f,
			onDropdownOpen: k,
			trigger: I
		}), t[17] = n, t[18] = k, t[19] = R, t[20] = m, t[21] = I, t[22] = T) : T = t[22], T;
	}
	function L(e) {
