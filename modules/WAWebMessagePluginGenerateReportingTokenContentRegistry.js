__d("WAWebMessagePluginGenerateReportingTokenContentRegistry", ["WAWebGenerateChatReportingTokenContent", "WAWebGenerateMediaReportingTokenContent"], (function(t, n, r, o, a, i, l) {
	var e, s = [
		{
			type: "album",
			subtype: void 0,
		...
		},
		{
			type: "audio",
			subtype: void 0,
			generateReportingTokenContent: e = r("WAWebGenerateMediaReportingTokenContent")
		},
		{
		...
		},
		{
			type: "chat",
			subtype: "url",
			generateReportingTokenContent: r("WAWebGenerateChatReportingTokenContent")
		},
		{
			type: "chat",
			subtype: void 0,
