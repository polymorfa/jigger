__d("WAWebMessageProcessorCacheWorker", [], (function(t, n, r, o, a, i) {
	function e(e) {
		return {
			...
			checkpointQueueWait: function() {
				return e.sendAndReceive("mainthread_messagecache", "checkpointQueueWait", void 0);
			},
			checkpointQueueSize: function() {
				return e.sendAndReceive("mainthread_messagecache", "checkpointQueueSize", void 0);
			},
			size: function() {
