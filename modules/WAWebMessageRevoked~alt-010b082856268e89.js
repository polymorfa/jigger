__d("WAWebMessageRevoked", [
	...
	function c(e) {
		var t = e.displayAuthor, n = e.displayType, a = e.msg, i = r("useWAWebEventTargetValue")(o("WAWebContactCollection").ContactCollection, [
			"add",
			"remove",
			"change:name"
		], function() {
		...
		return s.jsx(r("WAWebMessageTextBubble.react"), {
			...
			displayType: n,
			displayAuthor: t,
			children: s.jsxs(o("WAWebFlex.react").FlexRow, { children: [s.jsx(r("WAWebFlexItem.react"), {
				xstyle: u.icon,
