__d("WAWebMessageStaticSingleEmoji.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = e.msg, n = o("WAWebEmoji").EmojiUtil.getHeartEmojis().some(function(t) {
			return o("WAWebEmoji").EmojiUtil.normalizeEmoji(t) === o("WAWebEmoji").EmojiUtil.normalizeEmoji(e.emoji);
		}), a = s.jsx(o("WAWebCopyPasteSelectable.react").SelectableDiv, {
			selectable: !0,
			className: "x1n2onr6 xc9l9hb x78zum5 xl56j7k x1yrsyyn xdj266r x1emmycd x1u7kmwd xx6jrq6 x1ed109x",
