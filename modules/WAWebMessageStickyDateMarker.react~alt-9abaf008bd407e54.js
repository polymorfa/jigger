__d("WAWebMessageStickyDateMarker.react", [
	...
	function C(t) {
		var a = t.chat, i = t.ref, l = t.scrollContainerRef, s, c = f(void 0), h = c[0], C = c[1], b = f(void 0), v = b[0], S = b[1], R = f(!0), L = R[0], E = R[1], k = f(0), I = k[0], T = k[1], D = f(null), x = D[0], $ = D[1], P = _(null), N = _(!1), M = _(!1), w = _(!1), A = o("WAWebSearchByTypeAndDateGatingUtils").dateMarkerCalendarEnabled(), F = d(function() {
		...
		var O = function(t, n) {
			...
			t ? (w.current = !1, E(!0)) : A && (N.current || M.current) ? w.current = !0 : (w.current = !1, E(!1));
		};
		p(i, function() {
			return {
				updateDateMarkerText: O,
				setVisibility: B
			};
		});
		var W = o("WAWebSearchByTypeAndDateGatingUtils").dateMarkerCalendarEnabled() && a != null && v != null, q = function() {
			M.current = !1, $(null), F();
		}, U = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (o("WAWebCoreActionsODS").logCalendarDateSelectedFromStickyDateMarker(), a != null) {
					var t = yield o("WAWebSearchByDateUtils").getClosestMessageFromDate(a.id.toString(), e);
					if (q(), t) {
						var n, r = o("WAWebMsgCollection").MsgCollection.get(t.toString()), i = o("WAWebChatMessageSearch").getSearchContext({
							chat: a,
			...
			!W || v == null || (M.current = !0, o("WAWebCoreActionsODS").logCalendarOpenFromStickyDateMarker(), $({
		...
		if (h != null && L) {
			var z = u.jsx(r("WDSText.react"), {
				...
				dir: "auto",
				children: h
			}), j = x ? u.jsx(o("WAWebUimUie.react").UIE, {
			...
			s = u.jsxs("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(y.stickyRefreshed(I), A && y.interactable), { children: [W ? u.jsx("div", {
				ref: P,
				onClick: V,
				onMouseEnter: H,
				onMouseLeave: G,
