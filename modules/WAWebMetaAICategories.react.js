__d("WAWebMetaAICategories.react", [
	"WALogger",
	...
	function d(t) {
		var n = t.onPromptSelect, a = c(null), i = a[0], l = a[1], s = function(n) {
			o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[WAWebMetaAICategories] category selected=", ""])), n), l(n);
		}, d = function() {
			l(null);
		}, m = function(t) {
			n(t), l(null);
		...
		return u.jsx("div", {
			...
			children: i == null ? u.jsx(r("WAWebMetaAIActionPills.react"), {
