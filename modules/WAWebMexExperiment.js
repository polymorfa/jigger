__d("WAWebMexExperiment", ["WAWebABProps", "WAWebMexEventWamEvent"], (function(t, n, r, o, a, i, l) {
	var e = (function() {
		function e(t) {
			this.$1 = !1, this.$2 = "not provided", this.$3 = -1, this.$4 = -1, this.$2 = t, this.$1 = e.isGraphQLenabled();
		}
		var t = e.prototype;
		return t.toUseGraphQL = function() {
			return this.$1;
		}, t.start = function() {
			this.$3 = Date.now();
		}, t.stop = function() {
			...
			var t = n.envelopeResponseStatus, r = n.payloadResponseStatus;
			e.isExperimentEnabled() && new (o("WAWebMexEventWamEvent")).MexEventWamEvent({
				isMex: this.$1,
			...
			var e = o("WAWebABProps").getABPropConfigValue("mex_phase3_status_flags");
			return (e & t) === t;
		}, e;
	})();
