__d("WAWebMexFetchNewsletterDirectorySearchResultsJob", [
	"WAWebMexClient",
	...
	var e, s = e !== void 0 ? e : e = n("WAWebMexFetchNewsletterDirectorySearchResultsJobQuery.graphql");
	function u(e) {
		return c.apply(this, arguments);
	}
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.categories, n = e.cursorToken, r = e.limit, a = e.searchText, i = {
				input: {
					search_text: a,
