__d("WAWebMexFetchNewsletterFollowersJob", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			} }, l = yield o("WAWebMexClient").fetchQuery(u, i), c = l.xwa2_newsletter_followers;
			...
			var p = o("WAWebUsernameWorkerCompatibleGatingUtils").isNewsletterUsernamePnPrivacyEnabled();
			return p && (yield f(d)), { followers: (a = r("compactMap")(d, function(e) {
				...
				return {
					...
					username: p ? (t = l.username_info) == null ? void 0 : t.username : void 0,
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			t.length !== 0 && (yield o("WAWebDBCreateLidPnMappings").createLidPnMappings({
				mappings: t,
				flushImmediately: !0,
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			}), n = yield o("WAWebApiContactUsernameFields").bulkGetContactToUsernameInfoMap(t.filter(Boolean)), a = r("compactMap")(e, function(e) {
