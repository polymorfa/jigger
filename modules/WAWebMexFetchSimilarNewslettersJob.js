__d("WAWebMexFetchSimilarNewslettersJob", [
	"WAWebMexClient",
	...
	"use strict";
	var e, s = e !== void 0 ? e : e = n("WAWebMexFetchSimilarNewslettersJobQuery.graphql");
	function u(e) {
		return c.apply(this, arguments);
	}
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.countryCodes, r = e.limit, a = e.newsletterId, i = {
				input: {
					newsletter_id: a,
					limit: r,
