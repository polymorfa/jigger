__d("WAWebMexGetUsernameJob", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				var r, a = yield o("WAWebMexClient").fetchQuery(t, {}), i = (r = a.xwa2_username_get) == null ? void 0 : r.username_info;
				return {
				...
				if (e instanceof o("WAWebBackendErrors").ServerStatusCodeError && e.statusCode === 404) return {
					username: null,
					state: null,
					pin: null
				};
