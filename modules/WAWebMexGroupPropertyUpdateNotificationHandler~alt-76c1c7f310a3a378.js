__d("WAWebMexGroupPropertyUpdateNotificationHandler", [
	...
	async function s(t, n) {
		var r, a, i, l = n.xwa2_notify_group_on_prop_change, s = l.id, u = l.lid_migration_state, c = l.properties, d = l.update_time, m = l.updated_by, p = m.id, _ = m.notify_name, f = m.pn, g;
		switch (t.OperationName) {
			case "NotificationGroupPropertyUpdate": {
				c.allow_non_admin_sub_group_creation != null && (g = {
			...
			case "NotificationGroupMemberLinkPropertyUpdate":
				g = {
					...
					value: o("WAWebGroupMemberLinkMode").getMemberLinkModeFromMexType(c.member_link_mode)
				};
				break;
			case "NotificationGroupMemberShareGroupHistoryModePropertyUpdate":
				g = {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.MEMBER_SHARE_GROUP_HISTORY_MODE,
					value: o("WAWebGroupHistoryShareMode").getMemberShareGroupHistoryModeFromMexType(c.member_share_group_history_mode)
				};
				break;
			case "NotificationGroupAppealStatusUpdate":
				g = {
					actionType: o("WAWebGroupType").GROUP_ACTIONS.SUSPEND_APPEAL,
					appealStatus: o("WAWebSuspendAppealStatusType").toSuspendAppealStatus(c.appeal_status),
		...
		if (g != null) {
			var h = {
				...
				authorPhoneNumber: f != null ? o("WAWebWidFactory").createWid(f) : null,
				isLidAddressingMode: (u == null ? void 0 : u.addressing_mode) === "LID",
				pushname: _,
			...
			try {
				await o("WAWebHandleParsedGroupNotification").handleParsedGroupNotification(h);
			} catch (t) {
				o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[mex][group-prop-update] update failed"]))).tags("mex").sendLogs("mex-group-property-update-notification-fail");
			}
		}
	}
