__d("WAWebMexLidChangeNotificationHandler", [
	...
	async function s(t, n) {
		if (o("WAWebUsernameGatingUtils").usernameDisplayedEnabled()) {
			var r = o("WAWebMexLidChangeNotification").parseLidChangeNotification(n), a = r.newLid, i = r.oldLid, l = (await o("WAWebGetChatRecordByAccountLid").getChatRecordByAccountLid(i))[0], s = l != null ? o("WAWebWidFactory").createWid(l.id) : i, u = await e(s, a.toString());
