__d("WAWebMexLogging", ["WAWebMexEventV2WamEvent"], (function(t, n, r, o, a, i, l) {
	var e = (function() {
		function e(e) {
			this.$1 = !1, this.$2 = "", this.$3 = "", this.$4 = -1, this.$5 = -1, this.$6 = -1, this.$7 = !1, this.$8 = "", this.$9 = "", this.$1 = e;
		}
		var t = e.prototype;
		return t.start = function() {
			...
			return {
				errors: JSON.stringify(t),
				errorCodes: JSON.stringify(e)
			};
		}, e;
	})();
	function s(e, t) {
	...
	l.MexPerfTracker = e, l.createLoggingClientError = u, l.createLoggingTransportError = c;
}), 98);
