	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			try {
				...
				var I = o("WAJids").toNewsletterJid(l), T = o("WAWebJidToWid").newsletterJidToWid(I), D = o("WAWebWidFactory").createWid(f), x = {
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			if (!(((r = t.preview) == null ? void 0 : r.direct_path) !== "" || n != null)) {
				...
				yield o("WAWebNewsletterAdminNotificationJob").updateProfilePictureDeletionAlertState(a), o("WAWebBackendApi").frontendFireAndForget("updateProfilePictureDeletionAlertState", { newsletterWid: o("WAWebWidFactory").asNewsletterWidOrThrow(i) });
			}
