__d("WAWebMexTextStatusUpdateNotificationHandler", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = t.xwa2_notify_text_status_on_update_side_sub, r = yield o("WAWebApiContact").getContactRecordByHash(n.hash);
			if (r == null) {
	...
	l.mexHandleTextStatusUpdate = u, l.mexHandleTextStatusUpdateSideSub = d;
}), 98);
