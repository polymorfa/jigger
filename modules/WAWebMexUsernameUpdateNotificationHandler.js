__d("WAWebMexUsernameUpdateNotificationHandler", [
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			if (o("WAWebUsernameGatingUtils").usernameDisplayedEnabled()) {
				...
				yield o("WAWebInsertUsernameChangeSystemMsg").maybeInsertUsernameChangeSystemMsgs(s, u, "mexHandleUsernameChange");
			}
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (o("WAWebUsernameGatingUtils").usernameDisplayedEnabled()) {
				...
				var r = t.xwa2_notify_username_delete, a = r.lid, i = (n = r.display_name) != null ? n : "", l = o("WAWebWidFactory").createUserLidOrThrow(a), u = yield o("WAWebSetUsernameJob").deleteUsernamesJob([{
					userId: l,
					displayNameLID: i
				}]);
				yield o("WAWebInsertUsernameChangeSystemMsg").maybeInsertUsernameChangeSystemMsgs([{
					userId: l,
					deleteUsername: !0,
					displayNameLID: i
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			if (o("WAWebUsernameGatingUtils").usernameDisplayedEnabled()) {
				...
				var n = t.xwa2_notify_username_on_update_side_sub.hash, a = yield o("WAWebApiContact").getContactRecordByHash(n);
				if (a == null) {
				...
				if (!o("WAWebUserPrefsMeUser").isMeAccount(i)) {
					...
					if (!(s == null || s.usernameChanged !== !0)) {
						...
						yield o("WAWebInsertUsernameChangeSystemMsg").generateUsernameChangeNotificationSystemMsg({
							wid: i,
	...
	l.mexHandleUsernameChange = p, l.mexHandleUsernameDelete = f, l.mexHandleUsernameChangeForSideSub = h;
}), 98);
