__d("WAWebMexUsersGetUsername", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = o("WAWebABProps").getABPropConfigValue("username_antiscraping_send_cached_un") === !0 ? yield o("WAWebApiContactUsernameFields").bulkGetContactToUsernameInfoMap([].concat(e)) : null, n = e.map(function(e) {
