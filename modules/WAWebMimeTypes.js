__d("WAWebMimeTypes", [
	...
	}, m = d, p = r("filterObject")(m, function(e) {
		return (e == null ? void 0 : e.msgType) === "document";
	}), _ = "*", f = "image/*", g = "video/mp4,video/3gpp,video/quicktime", h = "video/mp4,video/3gpp,video/quicktime,video/webm,video/x-matroska";
	function y() {
		return o("WAWebABProps").getABPropConfigValue("transcode_and_repair_videos") === !0 ? h : g;
	}
	var C = g, b = "audio/wav,audio/mp3,audio/ogg,audio/aac,audio/mpeg", v = r("WAWebMimeTypesBuildExtToMime")(), S = r("filterObject")(d, function(e) {
		return (e == null ? void 0 : e.msgType) === "document" && e.canSend === !0 && e.ext != null;
	});
	function R(e, t, n) {
		n === void 0 && (n = !1);
		for (var r in S) {
			var o = d[r];
			if (o != null) {
				var a = o.ext, i = o.signatureMimetype, l = n ? i : r;
				if (l === e && a != null && t != null && t.toLowerCase().endsWith(a.toLowerCase())) return r;
			}
		}
		return e === "image/svg+xml" ? null : n || e != null ? e : "application/octet-stream";
	}
	function L(e) {
		var t, n = d[e];
		return n ? "." + ((t = n.ext) != null ? t : e.split("/")[1]).toLowerCase() : "";
	}
	function E(e) {
		var t = d[e];
	...
	function k(t, n) {
		var a = n.subarray(0, e), i = r("file-type")(a);
		if (i) return i.mime;
		if (t === "image") return "image/jpeg";
		if (t === "group-history") return "application/protobuf";
		throw new (o("WAWebMediaFileErrors")).MediaEncryptionError("unknown mime decrypt error for type:" + t);
	}
	var I = "audio/ogg";
	function T(e) {
