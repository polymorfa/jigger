__d("WAWebMixedMultiSelectBar.react", [
	...
	function g(e) {
		var t = e.Icon, n = e.customIcon, o = e.directional, a = e.disabled, i = e.onClick, l = e.testid, s = e.title, c = e.wdsIcon, m = e.xstyle;
		return d.jsx("button", babelHelpers.extends({ "data-testid": l != null ? l : "btn-icon" }, (u || (u = r("stylex"))).props(p.multiselectIcon, m), {
			title: s,
			onClick: i,
			disabled: a === !0,
			children: c != null ? c : t != null && d.jsx(t, { directional: o })
		}));
	}
