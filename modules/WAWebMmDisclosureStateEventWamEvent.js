__d("WAWebMmDisclosureStateEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MmDisclosureStateEvent: [
		6552,
		{
			businessLidOrJid: [1, e.TYPES.STRING],
			deltaTimeReceived: [15, e.TYPES.INTEGER],
			disclosureEventType: [3, o("WAWebWamEnumDisclosureEventType").DISCLOSURE_EVENT_TYPE],
			disclosureInteraction: [4, o("WAWebWamEnumDisclosureInteraction").DISCLOSURE_INTERACTION],
			disclosureSource: [5, o("WAWebWamEnumDisclosureSource").DISCLOSURE_SOURCE],
			disclosureSuppressionReason: [6, o("WAWebWamEnumDisclosureSuppressionReason").DISCLOSURE_SUPPRESSION_REASON],
			disclosureSurface: [7, o("WAWebWamEnumDisclosureSurface").DISCLOSURE_SURFACE],
