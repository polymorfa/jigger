__d("WAWebMmDisclosureStateFsEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MmDisclosureStateFsEvent: [
		6796,
		{
			disclosureEventType: [1, o("WAWebWamEnumDisclosureEventType").DISCLOSURE_EVENT_TYPE],
			disclosureInteraction: [2, o("WAWebWamEnumDisclosureInteraction").DISCLOSURE_INTERACTION],
			disclosureSource: [3, o("WAWebWamEnumDisclosureSource").DISCLOSURE_SOURCE],
			disclosureSuppressionReason: [4, o("WAWebWamEnumDisclosureSuppressionReason").DISCLOSURE_SUPPRESSION_REASON],
			disclosureSurface: [5, o("WAWebWamEnumDisclosureSurface").DISCLOSURE_SURFACE],
