__d("WAWebMmSignalSharingVerificationEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MmSignalSharingVerificationEvent: [
		6554,
		{
			accountLinked: [28, e.TYPES.BOOLEAN],
			businessLidOrJid: [1, e.TYPES.STRING],
			collectionWindowId: [3, e.TYPES.STRING],
			consentSource: [29, o("WAWebWamEnumConsentSource").CONSENT_SOURCE],
			...
			mmDirectionFrom: [27, o("WAWebWamEnumMmDirectionFrom").MM_DIRECTION_FROM],
			onePdSignalNotSharedReason: [5, o("WAWebWamEnumOnePdSignalNotSharedReason").ONE_PD_SIGNAL_NOT_SHARED_REASON],
			signalCanceledReason: [6, o("WAWebWamEnumSignalCanceledReason").SIGNAL_CANCELED_REASON],
			signalMessageState: [7, o("WAWebWamEnumSignalMessageState").SIGNAL_MESSAGE_STATE],
			signalMessageType: [8, o("WAWebWamEnumSignalMessageType").SIGNAL_MESSAGE_TYPE],
			signalOrigin: [9, o("WAWebWamEnumSignalOrigin").SIGNAL_ORIGIN],
			signalSharingStatus: [10, o("WAWebWamEnumSignalSharingStatus").SIGNAL_SHARING_STATUS],
			signalSurface: [11, o("WAWebWamEnumSignalSurface").SIGNAL_SURFACE],
			signalType: [12, o("WAWebWamEnumSignalType").SIGNAL_TYPE],
			signalTypeOrigin: [23, e.TYPES.STRING],
			spSignalNotSharedReason: [13, o("WAWebWamEnumSpSignalNotSharedReason").SP_SIGNAL_NOT_SHARED_REASON],
