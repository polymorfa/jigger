__d("WAWebMmSignalSharingVerificationFsEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MmSignalSharingVerificationFsEvent: [
		6798,
		{
			accountLinked: [19, e.TYPES.BOOLEAN],
			consentSource: [20, o("WAWebWamEnumConsentSource").CONSENT_SOURCE],
			...
			mmDirectionFrom: [18, o("WAWebWamEnumMmDirectionFrom").MM_DIRECTION_FROM],
			onePdSignalNotSharedReason: [3, o("WAWebWamEnumOnePdSignalNotSharedReason").ONE_PD_SIGNAL_NOT_SHARED_REASON],
			signalCanceledReason: [4, o("WAWebWamEnumSignalCanceledReason").SIGNAL_CANCELED_REASON],
			signalMessageState: [5, o("WAWebWamEnumSignalMessageState").SIGNAL_MESSAGE_STATE],
			signalMessageType: [6, o("WAWebWamEnumSignalMessageType").SIGNAL_MESSAGE_TYPE],
			signalOrigin: [7, o("WAWebWamEnumSignalOrigin").SIGNAL_ORIGIN],
			signalSharingStatus: [8, o("WAWebWamEnumSignalSharingStatus").SIGNAL_SHARING_STATUS],
			...
			spSignalNotSharedReason: [11, o("WAWebWamEnumSpSignalNotSharedReason").SP_SIGNAL_NOT_SHARED_REASON],
