__d("WAWebMmSignalSharingVerificationWithSignalDataEventWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MmSignalSharingVerificationWithSignalDataEvent: [
		6856,
		{
			accountLinked: [23, e.TYPES.BOOLEAN],
			consentSource: [24, o("WAWebWamEnumConsentSource").CONSENT_SOURCE],
			...
			mmDirectionFrom: [22, o("WAWebWamEnumMmDirectionFrom").MM_DIRECTION_FROM],
			mmSignalData: [5, e.TYPES.STRING],
			onePdSignalNotSharedReason: [6, o("WAWebWamEnumOnePdSignalNotSharedReason").ONE_PD_SIGNAL_NOT_SHARED_REASON],
			signalCanceledReason: [7, o("WAWebWamEnumSignalCanceledReason").SIGNAL_CANCELED_REASON],
			signalMessageState: [8, o("WAWebWamEnumSignalMessageState").SIGNAL_MESSAGE_STATE],
			signalMessageType: [9, o("WAWebWamEnumSignalMessageType").SIGNAL_MESSAGE_TYPE],
			signalOrigin: [10, o("WAWebWamEnumSignalOrigin").SIGNAL_ORIGIN],
			signalSharingStatus: [11, o("WAWebWamEnumSignalSharingStatus").SIGNAL_SHARING_STATUS],
			signalSurface: [12, o("WAWebWamEnumSignalSurface").SIGNAL_SURFACE],
			signalType: [13, o("WAWebWamEnumSignalType").SIGNAL_TYPE],
			signalTypeOrigin: [18, e.TYPES.STRING],
			spSignalNotSharedReason: [14, o("WAWebWamEnumSpSignalNotSharedReason").SP_SIGNAL_NOT_SHARED_REASON]
		},
		[
			1,
			1,
