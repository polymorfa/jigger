__d("WAWebMmSignalWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumConsentSource",
	"WAWebWamEnumMmDirectionFrom",
	"WAWebWamEnumMmSignalType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ MmSignal: [
		5572,
		{
			consentSource: [10, o("WAWebWamEnumConsentSource").CONSENT_SOURCE],
			...
			mmDirectionFrom: [9, o("WAWebWamEnumMmDirectionFrom").MM_DIRECTION_FROM],
