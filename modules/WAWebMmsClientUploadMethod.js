__d("WAWebMmsClientUploadMethod", [
	...
	"use strict";
	var e = ["ciphertextHmac"], s, u, c, d, m;
	function p(t) {
		return a;
		function a(e) {
		...
		function i() {
			return i = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
				var a = n.encFilehash, i = n.onUploadAttemptSuccess, c = n.type, d = {
					encFilehash: a,
					type: c
				};
				...
				try {
					...
					var f = yield l(n), g = f.response, h = f.retryStartTime;
					return i(Date.now() - h), o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["mmsClient.upload: success"]))), r("nullthrows")(g);
				} catch (e) {
		...
		function p() {
			return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var a = e.byteOffset, i = e.ciphertextHmac, l = e.encFilehash, s = e.generateThumbnailOnServer, u = e.mediaId, d = e.onProgress, p = e.onUploadAttemptError, f = e.onUploadHostFound, g = e.signal, h = e.type, y = !1, C = Date.now(), b = {
					encFilehash: l,
					type: h
				}, v = null, S = yield o("WAExponentialBackoff").exponentialBackoff(babelHelpers.extends({}, r("WAWebMmsClientMmsBackoffOptions"), { signal: g }), (function() {
					var b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (b, S) {
						var R = function(n) {
						...
						C = Date.now(), o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["mmsClient.upload: attempt #", ""])), S + 1);
						try {
							yield t.networkStatus.waitIfOffline();
							var L = yield R(), E = L.auth, k = L.fallbackHost, I = L.selectedHost, T = {
								selectedHost: I,
								fallbackHost: k
							...
							return v = D, f({
								...
								hostClass: D.class,
								failCount: S
							}), yield r("WARetryPromise")((function() {
								var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
									var c = t.retry, p = yield _({
										auth: E,
										encFilehash: l,
									...
									}), f = new AbortController(), C = f.signal, b = yield r("WARaceSignal")([g, C], function(t) {
										var a = o("WAWebMmsClientPollMediaHosts").shouldPollUploadHosts(h, i.byteLength) ? o("WAWebMmsClientPollMediaHosts").pollMediaHosts({
											connectionBlock: T,
											getHost: function() {
												return D;
											},
										...
										}) : null, c = r("WAWebMmsClientMmsUpload")({
											auth: E,
											ciphertextHmac: p > 0 ? new Uint8Array(i).subarray(p) : i,
											hostname: D.hostname,
											encFilehash: l,
											type: h,
											signal: g,
										...
										return (m || (m = n("Promise"))).race([c, a].filter(Boolean)).finally(function() {
											return f.abort();
										});
									});
									return b.kind === "host-changed" ? (D = b.host, v = D, c()) : b.value;
								});
								return function(e) {
							...
							y = !1;
							var $ = o("WAWebMmsClientIsErrorRetryable").isErrorRetryable(x), P = !$ || S === r("WAWebMmsClientMmsBackoffOptions").retries;
							if (P || p(x, Date.now() - C, S, o("WAWebWamEnumOverallLastUploadRetryPhaseType").OVERALL_LAST_UPLOAD_RETRY_PHASE_TYPE.UPLOAD), $) return b(x);
							throw x;
						}
					});
					return function(e, t) {
