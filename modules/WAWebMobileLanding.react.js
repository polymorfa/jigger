	...
	function y() {
		...
		var a = _(), i = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield g("dismiss"), o("WAWebExternalLink.react").openExternalLink("https://www.whatsapp.com/", { target: o("WAWebExternalLink.react").ExternalLinkTarget.CURRENT_TAB });
			});
			return function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					yield navigator.share == null ? void 0 : navigator.share(a), yield g("click", "success");
				} catch (t) {
					yield g("click", t), o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Error while sharing"]))).catching(r("getErrorSafe")(t));
				}
			});
			return function() {
			...
			children: d.jsxs(o("WAWebFlex.react").FlexColumn, {
				...
				children: [
					...
					d.jsx(o("WAWebFlex.react").FlexItem, {
						...
						align: "center",
						grow: 1,
						children: (navigator.canShare == null ? void 0 : navigator.canShare(a)) && d.jsx("button", babelHelpers.extends({}, (u || (u = r("stylex"))).props(p.shareButton, o("WDSPaddings.stylex").wdsPaddings.paddingVer16), {
							onClick: l,
