__d("WAWebMoment-be", ["WAWeb-moment"], (function(t, n, r, o, a, i, l) {
	function e(e, t) {
		var n = e.split("_");
	...
	function s(t, n, r) {
		...
		return r === "m" ? n ? "хвіліна" : "хвіліну" : r === "h" ? n ? "гадзіна" : "гадзіну" : t + " " + e(o[r], +t);
	}
	var u = r("WAWeb-moment").defineLocale("be", {
		...
		ordinal: function(t, n) {
			switch (n) {
				...
				case "DDD":
				case "w":
				case "W": return (t % 10 === 2 || t % 10 === 3) && t % 100 !== 12 && t % 100 !== 13 ? t + "-і" : t + "-ы";
				case "D": return t + "-га";
				default: return t;
			}
		},
