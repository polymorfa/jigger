__d("WAWebMoment-sr", ["WAWeb-moment"], (function(t, n, r, o, a, i, l) {
	var e = {
		words: {
			ss: [
				"sekunda",
		...
		translate: function(n, r, o, a) {
			var t = e.words[o], i;
			return o.length === 1 ? o === "y" && r ? "jedna godina" : a || r ? t[0] : t[1] : (i = e.correctGrammaticalCase(n, t), o === "yy" && r && i === "godinu" ? n + " godina" : n + " " + i);
		}
