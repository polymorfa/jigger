__d("WAWebMoveResizeResizers.react", [
	...
	function f(t) {
		var n = t.currentAction, a = t.directions, i = a === void 0 ? Array.from(o("WAWebMoveResizeComponentUtils").ResizeDirections.members()) : a, l = t.getResizeCallback;
		return i.map(function(t) {
			var a = l(_(t));
			return u.jsx("div", babelHelpers.extends({ "data-testid": "move_resize_component_resizer_" + t }, (e || (e = r("stylex"))).props([
				p(t),
				m.resizer,
				n === o("WAWebMoveResizeComponentUtils").UserActions.RESIZE && m.defaultCursor
			]), { onMouseDown: a }), t);
		});
	}
