__d("WAWebMsgBridgeApi", [
	...
	var e, s, u = {
		processMultipleMessages: function(t) {
			var e = t.chatId, n = t.chatMsgsCollection, r = t.meta, a = t.msgObjs, i = t.preserveOrder, l = t.processMessagesOrigin;
			return o("WAWebMsgCollection").MsgCollection.processMultipleMessages(e, a, r, l, n, i);
		},
		addInitialBotTypingIndicatorToChat: function(t) {
			var e = t.chatId, n = t.msgKey;
			return o("WAWebMsgCollection").MsgCollection.addInitialBotTypingIndicatorToChat(e, n);
		},
		...
		processKeepInChatMessages: function(t) {
			var e = t.allowNotification, n = t.keepInChatMessages;
			return o("WAWebKeepInChatMsgAction").processKeepInChatMessages(n, e);
		},
		updateUnattributedMessages: function(t) {
			var e = t.messageInfo, n = t.messages;
			return o("WAWebBizAgentAction").updateUnattributedMessages(e, n);
		},
		processKeepInChatMessage: function(t) {
			var e = t.allowNotification, n = t.keepInChatMessage;
			return o("WAWebKeepInChatMsgAction").processKeepInChatMessage(n, { allowNotification: e });
		},
		updateEditedMessagesAction: function(t) {
			var e = t.messageEdits;
			return o("WAWebUpdateEditedMessagesAction").updateEditedMessagesAction(e);
		},
		updateMessageUI: function(t) {
			var e = t.chatId, n = t.isOffline, r = t.messageOverwriteOption, a = t.msg, i = t.preserveOrder;
		...
		updateReactionUI: function(t) {
			var e = t.msg, n = t.reparsing;
			return o("WAWebUpdateReactionMessageUIAction").updateReactionUI(e, n);
		},
		updateReactionCollection: function(t) {
			var e = t.allowNotifications, n = t.msgs, r = t.removeReactions;
			return o("WAWebUpdateReactionMessageUIAction").updateReactionCollection(n, r, { allowNotify: e });
		},
		...
		processEphemeralSyncResponse: function(t) {
			var e = t.msg;
			return o("WAWebEphemeralSyncResponse").processEphemeralSyncResponse(e);
		},
		...
		changeOptInStatusForExternalWebBeta: function() {
			o("WAWebExternalBetaEvents").WAWebExternalBetaEvents.triggerBetaOptInStatusChanges();
		},
		...
		updateMsgModelHostedBizEncStateMismatchFlagToTrue: function(t) {
			var e = t.msgId, n = o("WAWebMsgCollection").MsgCollection.get(e);
		...
		addGalaxyDisableCTAMessageId: function(t) {
			var e = t.messageId;
			o("WAWebGalaxyDisableCTACollection").GalaxyDisableCTACollection.addMessageId(e);
		},
		addGalaxyDisableCTAByAgmId: function(t) {
			var e = t.agmId, n = t.chatId;
			o("WAWebGalaxyDisableCTACollection").GalaxyDisableCTACollection.addByAgmId(e, n);
		},
		hydrateReactionsForMessages: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = e.messageIds;
				yield (s || (s = n("Promise"))).all(t.map(function(e) {
		...
		updateCrosspostingInfo: function(t) {
			var e, n = t.crosspostingInfo, r = t.statusMessageId, a = o("WAWebMsgCollection").MsgCollection.get(r);
			if (a != null) {
		...
		updateMusicBlocklist: function(t) {
			var e = t.countryBlocklist, n = t.msgKey;
			return o("WAWebUpdateMusicBlocklistAction").updateMusicBlocklist(e, n);
		},
		deleteMessageFromCollectionForSync: (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var n = t.msgKey, r = o("WAWebMsgCollection").MsgCollection.get(n);
				if (r) {
					var a = o("WAWebFrontendMsgGetters").getChat(r);
					a.msgs.length === 1 && (yield o("WAWebChatLoadMessages").loadEarlierMsgs({ chat: a })), r.delete();
				} else o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["delete_message_for_me_sync: ", " storage+ collection-"])), n);
			});
			function r(e) {
		...
		removeScheduledMsgModelForReveal: function(t) {
			var e = t.msgKey, n = o("WAWebMsgCollection").MsgCollection.get(e);
			n != null && n.delete();
		},
		updateMsgRcat: function(t) {
			var e = t.msgKey, n = t.rcat, r = o("WAWebMsgCollection").MsgCollection.get(e);
			r != null && (r.rcat = n);
		}
	};
	l.MsgBridgeApi = u;
