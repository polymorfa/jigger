__d("WAWebMsgBridgeApi", [
	...
	var e, s = {
		...
		deleteMessageFromCollectionForSync: async function(n) {
			var t = n.msgKey, r = o("WAWebMsgCollection").MsgCollection.get(t);
			if (r) {
				var a = o("WAWebFrontendMsgGetters").getChat(r);
				a.msgs.length === 1 && await o("WAWebChatLoadMessages").loadEarlierMsgs({ chat: a }), r.delete();
			} else o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["delete_message_for_me_sync: ", " storage+ collection-"])), t);
		},
