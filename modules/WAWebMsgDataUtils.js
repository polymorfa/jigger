__d("WAWebMsgDataUtils", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			var a, i = t.id, l = o("WAWebUserPrefsMeUser").getMePnUserOrThrow_DO_NOT_USE(), s = o("WAWebUserPrefsMeUser").getMeLidUserOrThrow(), u = t.id.isLid() ? s : l, c = void 0;
			if (o("WAWebChatGetters").getIsGroup(t)) {
				var d;
				if (u = ((d = t.groupMetadata) == null ? void 0 : d.isLidAddressingMode) === !0 ? s : l, c = o("WAWebWidFactory").asUserWidOrThrow(u), o("WAWebCurrentUser").isEmployee()) {
					var m;
					o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
						...
						", participant: ",
						""
					])), i.toString(), t.groupMetadata != null, (m = t.groupMetadata) == null ? void 0 : m.isLidAddressingMode, c);
				}
			...
			var p = new (r("WAWebMsgKey"))({
				...
				participant: c,
				selfDir: "out"
			}), _ = (a = t.contact.businessProfile) == null ? void 0 : a.automatedType, f;
			return _ && (f = _ === o("WAWebBotTypes").BizBotAutomatedType.PARTIAL_1P ? o("WAWebBotTypes").BizBotType.BIZ_1P : _ === o("WAWebBotTypes").BizBotAutomatedType.FULL_3P ? o("WAWebBotTypes").BizBotType.BIZ_3P : _ === o("WAWebBotTypes").BizBotAutomatedType.UNKNOWN ? null : (function() {
