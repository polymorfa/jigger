__d("WAWebMsgNotification", [
	...
	var e, s, u = (e = n("cr:3133")) != null ? e : {}, c = u.getContextMenuItems, d = u.isReplyable, m = u.shouldIgnoreSquelchForGroupMention, p = (function(e) {
		function t(t) {
			var n, r = t.msg;
		...
		return a.shouldPlaySound = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				if (!e.trusted && e.promises.integritySignals != null && o("WAWebFMXGatingUtils").isSuspiciousFmxEnabled()) {
					var t = yield (s || (s = n("Promise"))).all([o("WAWebNotificationIconUtils").getChatNotificationIcon(e, this.abortController.signal, this.getDefaultIcon()), e.promises.integritySignals]), r = t[0];
					return e.promises.integritySignals = null, e.isSenderSuspicious === !0 ? o("WAWebNotificationIconUtils").getDefaultChatNotificationIcon(e) : r;
				}
			...
			var e = this.msg, t = o("WAWebNotificationsMsgNotification").getNotificationParts(e), a = o("WAWebGetNotificationStrings").getNotificationBody(babelHelpers.extends({}, t, { msgDir: o("WAWebFrontendMsgGetters").getDir(e) })), i = o("WAWebFrontendMsgGetters").getChat(this.msg), l = (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = yield o("WAWebChatThreadLogging").getChatThreadID(i.id.toJid());
			...
			return {
				...
				tag: o("WAWebNotificationsMsgNotification").shouldReplaceMsgNotificationManually() ? this.msg.id.toString() : i.id.toString(),
