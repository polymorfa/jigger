__d("WAWebMsgProcessingDecryptionHandler", [
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.handlerState, a = e.hasInactiveMsg, i = e.isOrphanAddon, l = e.parsedMsgPayload, s = (t = n.skMsgFailedEnc) != null ? t : n.pkOrMsgFailedEnc, u = s != null && n.accessedEncs.has(o("WAWebBackendJobs.flow").CiphertextType.Skmsg) && n.skMsgFailedEnc == null;
			if (s == null || u) return {
			...
			T(l, n), x(l, n);
			var c = s.enc, d = s.error, m = s.errorType, p = !1, _;
			return (d instanceof o("WAWebSignalCommonErrors").SignalDecryptionError || d instanceof o("WAWebHandleMsgError").UnknownDeviceMessageError || d instanceof o("WAWebEphemeralDecodeBroadcastSetting").BroadcastEphSettingsError) && (_ = o("WAWebSendRetryReceiptJob").getRetryReasonFromError(d), m !== b.SignalDuplicateMessage ? c.hideFail || (p = yield o("WAWebHandleMsgProcess").processPlaceholderMsg({
				type: o("WAWebMsgType").MSG_TYPE.CIPHERTEXT,
				msgMeta: l.msgMeta,
				msgInfo: l.msgInfo,
				placeholderType: o("WAWebHandleMsgTypes.flow").PlaceholderType.E2E,
				placeholderAddReason: o("WAWebBackendJobsCommon").getPlaceholderAddReason(d, l)
			})) : l.msgInfo.chat.isGroup() && o("WALogger").WARN(C || (C = babelHelpers.taggedTemplateLiteralLoose([
				"GroupLidInfra: duplicate-skip drop with no placeholder, skmsg = ",
				", group = ",
				", participant = ",
				""
			])), String(n.accessedEncs.has(o("WAWebBackendJobs.flow").CiphertextType.Skmsg)), l.msgInfo.chat, l.msgInfo.author).sendLogs("grouplidinfra-duplicate-skip-drop", { sampling: .01 })), m === b.SignalRetryable || m === b.UnknownDevice ? {
				...
				failedEnc: c
			} : m === b.DeviceSentMessage ? { result: o("WAWebHandleMsgTypes.flow").E2EProcessResult.PARSE_VALIDATION_ERROR } : m === b.InvalidProtobuf ? {
				result: o("WAWebHandleMsgTypes.flow").E2EProcessResult.PARSE_VALIDATION_ERROR,
				e2eFailureReason: d instanceof o("WAWebHandleMsgError").MessageValidationError ? d.e2eFailureReason : void 0
			} : m === b.HsmMismatch ? { result: o("WAWebHandleMsgTypes.flow").E2EProcessResult.HSM_MISMATCH } : m === b.BroadcastEphSettings ? {
				result: o("WAWebHandleMsgTypes.flow").E2EProcessResult.RETRY,
				retryCount: c.retryCount,
				retryReason: _,
				placeholderCreated: p,
				e2eFailureReason: o("WAWebWamEnumE2eFailureReason").E2E_FAILURE_REASON.INVALID_BROADCAST_STANZA_ATTRIBUTE
			} : m === b.OrphanBotMsg ? s.error instanceof r("WAWebOrphanBotMsgError") ? {
				result: o("WAWebHandleMsgTypes.flow").E2EProcessResult.DEFERRED,
				targetMsgKey: s.error.targetMsgKey
			} : { result: o("WAWebHandleMsgTypes.flow").E2EProcessResult.PARSE_ERROR } : m === b.Unknown ? { result: o("WAWebHandleMsgTypes.flow").E2EProcessResult.PARSE_ERROR } : (function() {
	...
	function D(t, n) {
		var a, i = t.msgBotInfo, l = t.msgInfo, h = t.msgMeta, y = n.enc, C = n.error, v = n.errorType, S = o("WAWebMsgProcessingApiUtils").getFrom(l);
		switch (o("WAWebPostE2eMessageRecvMetric").postFailureE2eMessageRecvMetric({
			...
			" error:",
			""
		])), l.externalId, y.e2eType, (a = C.stack) != null ? a : String(C)).tags("messaging"), v) {
			case b.SignalDuplicateMessage: break;
			case b.SignalRetryable:
			case b.UnknownDevice: {
				r("gkx")("26258") || o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose([
			...
			case b.InvalidProtobuf: {
				C instanceof o("WAWebHandleMsgError").MessageValidationError && (o("WAWebIsOfficialClient").isUnofficialStanzaId(l.externalId) ? o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose([
					"decryptE2EPayload: e2eType:",
					" error:",
					""
				])), y.e2eType, C).tags("messaging").sendLogs("handleMsg from UC: " + C.name, { sampling: C.sendLogs === !0 ? .01 : C.sendLogs }) : r("gkx")("26259") && C instanceof o("WAWebHandleMsgError").MessageProtobufInvalidMessageTypes ? o("WALogger").WARN(c || (c = babelHelpers.taggedTemplateLiteralLoose([
					"decryptE2EPayload: e2eType:",
					" error:",
					""
				])), y.e2eType, C).tags("messaging").sendLogs("(intern) handleMsg: " + C.name) : o("WALogger").WARN(d || (d = babelHelpers.taggedTemplateLiteralLoose([
					"decryptE2EPayload: e2eType:",
					" error:",
					""
			...
			case b.DeviceSentMessage: {
				o("WALogger").WARN(m || (m = babelHelpers.taggedTemplateLiteralLoose([
					...
					" error:",
					""
				])), y.e2eType, l.type, l.isDirect, C).tags("messaging").sendLogs("handleMsg: parse device sent message error");
				break;
			}
			case b.HsmMismatch: {
			...
			case b.OrphanBotMsg: {
				o("WALogger").WARN(f || (f = babelHelpers.taggedTemplateLiteralLoose(["decryptE2EPayload: e2eType:", " orphan bot msg deferred"])), y.e2eType).tags("messaging").sendLogs("handleMsg: orphan bot message deferred");
				break;
			}
			case b.Unknown: {
	...
	function $() {
		if (!r("gkx")("26258")) {
			...
			if (t == null) return;
			switch (o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose(["Dropping incoming message with ", " error"])), t), t) {
