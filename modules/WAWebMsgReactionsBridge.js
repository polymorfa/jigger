__d("WAWebMsgReactionsBridge", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (r && r.hasReaction !== t) {
				var a = { hasReaction: t };
				yield o("WAWebDBUpdateMessageTable").updateMessageTable(r.id, a), r.set(a);
			}
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n;
			try {
				if (n = yield o("WAWebDBGetReactions").getReactions(t.id.toString()), n.reactions.length === 0 && t.id.remote.isStatus()) {
					var a = o("WAWebLidMigrationUtils").getAlternateMsgKey(t.id);
					a && (n = yield o("WAWebDBGetReactions").getReactions(a.toString()));
				}
			} catch (t) {
			...
			return yield u(t.id.toString(), s), babelHelpers.extends({}, n, {
				id: t.id,
				reactions: l
			});
