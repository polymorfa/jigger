__d("WAWebMsgSendFailIcon.react", [
	...
	function h(t) {
		var n = t.displayType, a = t.msgs, i = t.showForAddOns, l = t.showForMessages, d = r("nullthrows")(a[0]), m = o("useWAWebMsgValues").useMsgValues(d.id, [o("WAWebMsgGetters").getIsSentByMe]), p = m[0], _ = o("WAWebFrontendMsgGetters").getChat(d.unsafe()), f = l ? a : [], h = r("useWAWebEventTargetValue")(f, "change:ack change:isSendFailure", function() {
			return f.filter(function(e) {
				return o("WAWebMsgGetters").getIsFailed(e);
			});
		}), v = f[0] != null && o("WAWebMsgGetters").getIsEdited(f[0]), S = i ? a : [], R = S.map(function(e) {
			return e.id;
		}), E = r("useWAWebReactionsByMe")(R, a.some(function(e) {
			return o("WAWebMsgGetters").getHasReaction(e);
		})), k = r("useWAWebEventTargetValue")(E, "change:isFailed", function() {
			return E.filter(function(e) {
				return e.isFailed;
			});
		}), I = S[0], T = r("useWAWebPollVotesToResend")(I.unsafe()), D = r("useWAWebPinsToResend")(R), x = r("useWAWebEventResponsesToResend")(R);
		if (h.length === 0 && k.length === 0 && T.length === 0 && D.length === 0 && x.length === 0) return null;
		var $ = function() {
			v && k.length === 0 ? (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["MsgSendFailIcon:handleClick: edit send failure"]))), y(d, _)) : L(T) ? (o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["MsgSendFailIcon:handleClick: ended poll vote failure"]))), b(T)) : (o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["MsgSendFailIcon:handleClick: generic send failure"]))), C({
				messagesToResend: h,
				reactionsToResend: k,
				votesToResend: T,
				pinsToResend: D,
	...
	function C(e) {
		var t = v(e), n = e.messagesToResend[0], a = n != null ? o("WAWebFrontendMsgGetters").getChat(n.unsafe()) : null, i = n != null && (o("WAWebMsgGetters").getBroadcastId(n) != null || a != null && o("WAWebChatGetters").getIsBroadcast(a));
	...
	l.MsgSendFailIcon = h, l.showResendDialog = C;
}), 226);
