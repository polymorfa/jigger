__d("WAWebMsgType", [], (function(t, n, r, o, a, i) {
	var e = {
		...
		DOC_MSG: 2,
		HAS_LINK: 4
	}, s = new Set(Object.keys(e).map(function(t) {
		return e[t];
	})), u = [
	...
	i.MSG_TYPE = e, i.MESSAGE_TYPE_FLAGS = l, i.ALL_MSG_TYPES_SET = s, i.SYSTEM_MESSAGE_TYPES = u, i.MsgKind = c;
}), 66);
