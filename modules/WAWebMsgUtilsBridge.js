__d("WAWebMsgUtilsBridge", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var a = !!t.caption;
			t.type === o("WAWebMsgType").MSG_TYPE.DOCUMENT && (a = t.isCaptionByUser);
			var i = {
			...
			t.ephemeralDuration != null && (i.ephemeralityDuration = t.ephemeralDuration);
			...
			if (u != null && (i.ephemeralityInitiator = u), o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["createMessageForwardMetric"]))), !o("WAWebMsgGetters").getIsGroupMsg(t)) {
				var c = o("WAWebUserPrefsMeUser").getMaybeMePnUser(), d = yield (s || (s = n("Promise"))).all([c != null ? r("WAWebLidAwareContactsDB").get(c.toJid()) : null, r("WAWebLidAwareContactsDB").get(t.to.toJid())]), m = d[0], p = d[1], _ = o("WAWebEphemeralityResolver").getEphemeralDurationForUser(m);
				_ != null && (i.senderDefaultDisappearingDuration = _);
				var f = o("WAWebEphemeralityResolver").getEphemeralDurationForUser(p);
			...
			var h = yield o("WAWebWamGroupMetadataMetricUtils").getGroupTypeFromChatWid(t.to);
			return h != null && (i.typeOfGroup = h), new (o("WAWebForwardSendWamEvent")).ForwardSendWamEvent(i);
	...
	l.createMessageForwardMetric = u, l.logMessageSendForChatThreadLogging = p, l.logMessageMetric = f;
}), 98);
