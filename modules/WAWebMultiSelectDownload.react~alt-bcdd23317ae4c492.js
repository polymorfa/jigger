__d("WAWebMultiSelectDownload.react", [
	...
	function m(e) {
		var t, n = e.downloadButton, a = e.isMediaHub, i = a === void 0 ? !1 : a, l = e.onCancel, m = e.onDownload, p = e.selectedMessages, _ = e.tabOrder, f = _ === void 0 ? o("WAWebTabOrder").TAB_ORDER.CHAT_SELECT_BAR : _, g = c((t = p == null ? void 0 : p.getSelected()) != null ? t : []), h = g[0], y = g[1], C = h.every(function(e) {
		...
		}), S = v && o("WAWebMiscGatingUtils").isGroupSuspendV2Enabled(), R = h.length;
		...
		var L = n && !S;
		if (!L) return null;
		var E = r("WAWebEnvironment").isWindows ? s._(
			/*BTDS*/
			""
		) : s._(
			/*BTDS*/
		...
		return u.jsx(r("WDSMenuBarItem.react"), {
			...
			title: E,
			onClick: function() {
				o("WAWebMediaHubMessageActionHandlers").handleMessageDownloadClick(h, l, i ? "media_hub" : void 0), m == null || m();
			},
