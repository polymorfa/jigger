__d("WAWebMusicAttributionLoadable.react", [
	...
	var e, s = e || (e = o("react")), u = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebMusicStatusAttribution.react").__setRef("WAWebMusicAttributionLoadable.react").load();
		return e.MusicAttribution;
	}), "MusicStatusAttribution"), c = r("WAWebLoadable")({
		loader: u,
		loading: function(t) {
