__d("WAWebMuteCollection", [
	...
	var c = !0, d = !0, m = !0, p = !1, _ = !1, f = !1, g = !1, h = !1, y = !1, C = !1, b = !1, v = !0, S = !1, R = !1, L = !0, E = !1, k = !1, I = !0, T = (function(t) {
		...
		return a.initializeFromCache = function(t) {
			...
			g = t, o("WAWebUserPrefsNotifications").setCollapseMuted(t), this.trigger("change:collapseMuted", g);
		}, a.getOutgoingMessageSound = function() {
			return h;
		}, a.setOutgoingMessageSound = function(t) {
			h = t, o("WAWebUserPrefsNotifications").setOutgoingMessageSound(t);
		}, a.getIgnoreNondirectGroupMsg = function() {
			return r("gkx")("26258") ? !1 : y;
		}, a.setIgnoreNondirectGroupMsg = function(t) {
			r("gkx")("26258") || (y = t, o("WAWebUserPrefsNotifications").setIgnoreNondirectGroupMsg(t));
		}, a.getGlobalNotificationsEnabled = function() {
			return C;
		}, a.setGlobalNotificationsEnabled = function(t) {
			C = t, o("WAWebUserPrefsNotifications").setGlobalNotificationsEnabled(t), this.trigger("change:notificationsEnabled"), this.isGranularNotificationsEnabled && this.setGlobalNotifications(t);
		}, a.getGlobalNotificationReactionsEnabled = function() {
			return b;
		}, a.setGlobalNotificationReactionsEnabled = function(t) {
			b = t, o("WAWebUserPrefsNotifications").setGlobalNotificationReactionsEnabled(t), this.isGranularNotificationsEnabled && (t ? this.globalReactionsMute().unmute() : this.globalReactionsMute().mute({ expiration: -1 }));
		}, a.getGlobalSoundsEnabled = function() {
			return v;
		}, a.setGlobalSoundsEnabled = function(t) {
			v = t, o("WAWebUserPrefsNotifications").setGlobalSoundsEnabled(t), this.isGranularNotificationsEnabled && this.setGlobalSounds(t);
		}, a.getGlobalGroupNotificationsEnabled = function() {
			return S;
		}, a.setGlobalGroupNotificationsEnabled = function(t) {
			S = t, o("WAWebUserPrefsNotifications").setGlobalGroupNotificationsEnabled(t), this.trigger("change:notificationsEnabled");
		}, a.getGlobalGroupNotificationReactionsEnabled = function() {
			return R;
		}, a.setGlobalGroupNotificationReactionsEnabled = function(t) {
			R = t, o("WAWebUserPrefsNotifications").setGlobalGroupNotificationReactionsEnabled(t);
		}, a.getGlobalGroupSoundsEnabled = function() {
			return L;
		}, a.setGlobalGroupSoundsEnabled = function(t) {
			L = t, o("WAWebUserPrefsNotifications").setGlobalGroupSoundsEnabled(t);
		}, a.getGlobalStatusNotificationsEnabled = function() {
			return E;
		}, a.setGlobalStatusNotificationsEnabled = function(t) {
			E = t, o("WAWebUserPrefsNotifications").setGlobalStatusNotificationsEnabled(t), this.trigger("change:notificationsEnabled");
		}, a.getGlobalStatusNotificationReactionsEnabled = function() {
			return k;
		}, a.setGlobalStatusNotificationReactionsEnabled = function(t) {
			k = t, o("WAWebUserPrefsNotifications").setGlobalStatusNotificationReactionsEnabled(t);
		}, a.getGlobalStatusSoundsEnabled = function() {
			return I;
		}, a.setGlobalStatusSoundsEnabled = function(t) {
			I = t, o("WAWebUserPrefsNotifications").setGlobalStatusSoundsEnabled(t);
		}, a.setAllNotificationsAndReactions = function(t) {
			this.setGlobalNotificationReactionsEnabled(t), this.setGlobalGroupNotificationReactionsEnabled(t), this.setGlobalStatusNotificationReactionsEnabled(t), this.isGranularNotificationsEnabled ? (this.setGlobalNotificationsEnabled(t), this.setGlobalGroupNotificationsEnabled(t), this.setGlobalStatusNotificationsEnabled(t)) : (this.setGlobalNotifications(t), t ? this.globalReactionsMute().unmute() : this.globalReactionsMute().mute({ expiration: -1 }));
		}, n;
	})(o("WAWebBaseCollection").BaseCollection);
	T.model = o("WAWebMuteModel").Mute, T.cachePolicy = {
