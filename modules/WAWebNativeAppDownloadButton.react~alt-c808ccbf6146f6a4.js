__d("WAWebNativeAppDownloadButton.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = e.apiCmd, a = e.inline, i = a === void 0 ? !1 : a, l = e.sourceType, c = o("WAWebDesktopUpsellQRCodeBannerExperiment").getWAWebDesktopUpsellQRCodeBannerExperiment(), d = o("WAWebDesktopUpsellPlatformAwareHooks").useWAWebDesktopUpsellPlatformAwareOsVersionCheck(), m = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("useWAWebDesktopUpsellQplImpression").logDesktopUpsellQplEvent("click", l, t), o("WAWebDesktopUpsellStoreOpener").openExternalWhatsAppDesktopDownloadUrl({
					ctaSource: l,
		...
		return l === o("WAWebWamEnumWebcNativeUpsellCtaSourceType").WEBC_NATIVE_UPSELL_CTA_SOURCE_TYPE.QR_SLIM_BANNER && i && (p = s._(
			/*BTDS*/
			""
			...
			children: u.jsxs(o("WAWebFlex.react").FlexRow, {
				align: "center",
				columnGap: 4,
				children: [p, u.jsx(o("WAWebChevronIcon.react").ChevronIcon, {
					width: 16,
					height: 16
				})]
			})
