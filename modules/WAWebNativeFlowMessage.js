__d("WAWebNativeFlowMessage", [
	...
	function p(e) {
		var t = o("react-compiler-runtime").c(38), n = e.displayAuthor, a = e.displayType, i = e.msg, l, u;
		if (i.nativeFlowName === r("WAWebInteractiveMessagesNativeFlowName").PAYMENT_INFO) {
			var p;
			t[0] !== i ? (p = o("WAWebOrderDetails").getOrderInfo(i), t[0] = i, t[1] = p) : p = t[1];
			var f = p;
			if (f) {
				var y;
				t[2] !== i ? (y = o("WAWebMsgGetters").getIsSentByMe(i), t[2] = i, t[3] = y) : y = t[3];
				var C;
				t[4] !== f || t[5] !== y ? (C = c.jsx(r("WAWebNativeFlowPaymentInfoOrderDetailsHeader"), {
					isSentByMe: y,
					orderInfo: f
				}), t[4] = f, t[5] = y, t[6] = C) : C = t[6], l = C;
				var b;
				t[7] !== i || t[8] !== f ? (b = h(f, i), t[7] = i, t[8] = f, t[9] = b) : b = t[9];
				var v;
				t[10] !== b ? (v = [b], t[10] = b, t[11] = v) : v = t[11], u = v;
			}
		} else if (i.nativeFlowName === r("WAWebInteractiveMessagesNativeFlowName").ORDER_DETAILS) if (t[12] !== a || t[13] !== i) {
			var S = o("WAWebOrderDetails").getOrderInfo(i), R = S == null ? void 0 : S.referenceId, L = R != null && o("WAWebOrderStatus").findOrderStatus(o("WAWebFrontendMsgGetters").getChat(i.unsafe()), R) === o("WAWebOrderStatus").OrderStatus.Pending, E;
			t[16] === Symbol.for("react.memo_cache_sentinel") ? (E = { className: "x1198e8h x1lxpwgx xzueoph xw01apr" }, t[16] = E) : E = t[16];
			var k = c.jsx(r("WAWebInteractiveNativeFlowOrderHeader"), {
				msg: i,
				displayType: a
			}), I;
			t[17] !== k ? (I = c.jsx("div", babelHelpers.extends({}, E, { children: k })), t[17] = k, t[18] = I) : I = t[18], l = I;
			var T;
			t[19] !== L ? (T = L ? s._(
				/*BTDS*/
				""
		...
		else if (i.nativeFlowName === r("WAWebInteractiveMessagesNativeFlowName").ORDER_STATUS) {
			var P;
			t[23] === Symbol.for("react.memo_cache_sentinel") ? (P = { className: "x1198e8h x1lxpwgx xzueoph xw01apr" }, t[23] = P) : P = t[23];
			var N;
			t[24] !== a || t[25] !== i ? (N = c.jsx("div", babelHelpers.extends({}, P, { children: c.jsx(r("WAWebInteractiveNativeFlowOrderHeader"), {
				msg: i,
				displayType: a
			}) })), t[24] = a, t[25] = i, t[26] = N) : N = t[26], l = N;
		} else {
			var M;
			t[27] !== i ? (M = r("isStringNullOrEmpty")(i.title) ? null : c.jsx(o("WAWebEmojiText.react").EmojiText, {
				text: i.title,
			...
			}), t[27] = i, t[28] = M) : M = t[28], l = M;
			var w;
			if (t[29] !== i.nativeFlowButtons) {
				var A;
				w = (A = i.nativeFlowButtons) == null ? void 0 : A.map(_), t[29] = i.nativeFlowButtons, t[30] = w;
			} else w = t[30];
			u = w;
		}
		var F = i.nativeFlowName !== r("WAWebInteractiveMessagesNativeFlowName").ORDER_STATUS, O;
		return t[31] !== u || t[32] !== n || t[33] !== a || t[34] !== l || t[35] !== i || t[36] !== F ? (O = c.jsx(r("WAWebInteractiveBubble.react"), {
			msg: i,
			displayAuthor: n,
			displayFooter: F,
			header: l,
			displayType: a,
			actions: u
		}), t[31] = u, t[32] = n, t[33] = a, t[34] = l, t[35] = i, t[36] = F, t[37] = O) : O = t[37], O;
	}
	function _(e) {
		var t, n;
		return {
