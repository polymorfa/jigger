__d("WAWebNewChatButtonGatingUtils", ["$InternalEnum", "gkx"], (function(t, n, r, o, a, i, l) {
	"use strict";
	...
	function s() {
		if (!r("gkx")("26258")) {
			var t = new URLSearchParams(window.location.search), n = t.get("new_chat_button_variant");
			if (n != null) {
				var o = parseInt(n, 10);
