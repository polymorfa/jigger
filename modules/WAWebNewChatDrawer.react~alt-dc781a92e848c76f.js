__d("WAWebNewChatDrawer.react", [
	...
	function v(e) {
		var t = o("react-compiler-runtime").c(14), n = e.detailRight, a = e.image, i = e.onClick, l = e.primary, c = e.ref, m = e.testid, p;
		t[0] !== l ? (p = s._(
			/*BTDS*/
			"",
		...
		var _ = p, f;
		t[2] === Symbol.for("react.memo_cache_sentinel") ? (f = (u || (u = r("stylex"))).props(o("WDSFlex.stylex").wdsFlex.flex, C.pinnedItem), t[2] = f) : f = t[2];
		var g;
		t[3] === Symbol.for("react.memo_cache_sentinel") ? (g = [y.paddingInlineStart13], t[3] = g) : g = t[3];
		var h;
		t[4] !== l ? (h = d.jsxs(o("WAWebText.react").WAWebTextTitle, { children: [l, " "] }), t[4] = l, t[5] = h) : h = t[5];
		var b;
		return t[6] !== n || t[7] !== a || t[8] !== i || t[9] !== _ || t[10] !== c || t[11] !== h || t[12] !== m ? (b = d.jsx("div", babelHelpers.extends({}, f, { children: d.jsx(r("WAWebCellV2.react"), {
			ref: c,
			size: "medium",
			material: !0,
			detailLeft: a,
			...
			ariaLabel: _,
			testid: m
		}) })), t[6] = n, t[7] = a, t[8] = i, t[9] = _, t[10] = c, t[11] = h, t[12] = m, t[13] = b) : b = t[13], b;
	}
	function S(e) {
