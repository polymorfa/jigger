__d("WAWebNewChatFlow.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(71), a = e.onEnd, i = e.ref, l = e.viewType;
		...
		var _ = o("useWAWebFlow").useFlow(o("WAWebNewChatFlowTypes").NewChatFlowStep.NewChatDrawer, p), f = _[0], g = _[1], h;
		t[2] !== g ? (h = function() {
			g.end();
		}, t[2] = g, t[3] = h) : h = t[3];
		var y = h;
		...
		var S = v, R;
		t[8] !== g || t[9] !== b || t[10] !== l ? (R = function(t) {
			var e = t.contactId, n = t.firstName, a = t.lastName, i = t.phoneNumber, s = t.username, u;
			...
			b({
				...
				contact: c
			}), l === r("WAWebDrawerViewType").FLYOUT ? o("WAWebModalManager").ModalManager.close() : g.end();
		}, t[8] = g, t[9] = b, t[10] = l, t[11] = R) : R = t[11];
		var L = R, E;
		t[12] !== g || t[13] !== l ? (E = function(t) {
			if (o("WAWebReachoutTimelockUtils").isUserReachoutTimelocked()) {
				o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebReachoutTimelockRestrictedModalLoadable").ReachoutTimelockRestrictedModalLoadable, {}));
				return;
			}
			l === r("WAWebDrawerViewType").FLYOUT ? (g.end(), o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebModal.react").Modal, {
		...
		}, t[12] = g, t[13] = l, t[14] = E) : E = t[14];
		var k = E, I;
		t[15] !== g || t[16] !== l ? (I = function(t) {
			if (o("WAWebReachoutTimelockUtils").isUserReachoutTimelocked()) {
				o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebReachoutTimelockRestrictedModalLoadable").ReachoutTimelockRestrictedModalLoadable, {}));
				return;
			}
			...
			}))) : g.push(o("WAWebNewChatFlowTypes").NewChatFlowStep.NewBroadcastFlow);
		}, t[15] = g, t[16] = l, t[17] = I) : I = t[17];
		var T = I, D;
		t[18] !== g || t[19] !== l ? (D = function(t) {
			l === r("WAWebDrawerViewType").FLYOUT ? (g.end(), o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebModal.react").Modal, {
				type: o("WAWebModal.react").ModalTheme.Tower,
		...
		t[21] !== g || t[22] !== L || t[23] !== l ? ($ = function(t) {
			...
			}))) : g.push(o("WAWebNewChatFlowTypes").NewChatFlowStep.NewContactFlow);
		}, t[21] = g, t[22] = L, t[23] = l, t[24] = $) : $ = t[24];
		var P = $, N;
		t[25] !== g || t[26] !== l ? (N = function(t) {
			if (o("WAWebReachoutTimelockUtils").isUserReachoutTimelocked()) {
				o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebReachoutTimelockRestrictedModalLoadable").ReachoutTimelockRestrictedModalLoadable, {}));
				return;
			}
			...
			}))) : g.push(o("WAWebNewChatFlowTypes").NewChatFlowStep.DialerPadFlow);
		}, t[25] = g, t[26] = l, t[27] = N) : N = t[27];
		var M = N, w;
		t[28] !== g ? (w = function() {
			if (g.step === o("WAWebNewChatFlowTypes").NewChatFlowStep.NewContactFlow) {
				var e;
				(e = d.current) == null || e.handleDismiss();
			}
			g.pop();
		}, t[28] = g, t[29] = w) : w = t[29];
		var A = w;
		...
		e: switch (g.step) {
			case o("WAWebNewChatFlowTypes").NewChatFlowStep.NewChatDrawer: {
				var O;
				t[30] === Symbol.for("react.memo_cache_sentinel") ? (O = s._(
					/*BTDS*/
					""
				), t[30] = O) : O = t[30];
				var B;
				t[31] !== g ? (B = function() {
					return g.end();
				}, t[31] = g, t[32] = B) : B = t[32];
				var W = l != null ? l : r("WAWebDrawerViewType").DRAWER, q;
				t[33] !== S || t[34] !== M || t[35] !== T || t[36] !== x || t[37] !== P || t[38] !== k || t[39] !== B || t[40] !== W ? (q = u.jsx(r("WAWebNewChatDrawer.react"), {
					title: O,
					onBack: B,
					onClick: S,
					onNewGroup: k,
					...
					onDialerPad: M,
					viewType: W
				}), t[33] = S, t[34] = M, t[35] = T, t[36] = x, t[37] = P, t[38] = k, t[39] = B, t[40] = W, t[41] = q) : q = t[41], F = q;
				break e;
			}
			case o("WAWebNewChatFlowTypes").NewChatFlowStep.NewGroupFlow: {
				...
				})(), t[42] = g, t[43] = U) : U = t[43];
				var V = l != null ? l : r("WAWebDrawerViewType").DRAWER, H;
				t[44] !== g.pop || t[45] !== U || t[46] !== V ? (H = u.jsx(o("WAWebNewGroupFlowLoadable").NewGroupFlowLoadable, {
					onCreateGroup: U,
					onEnd: g.pop,
					viewType: V
				}), t[44] = g.pop, t[45] = U, t[46] = V, t[47] = H) : H = t[47], F = H;
				break e;
			}
			case o("WAWebNewChatFlowTypes").NewChatFlowStep.NewBroadcastFlow: {
				...
				t[48] !== g ? (G = function() {
					return g.end();
				}, t[48] = g, t[49] = G) : G = t[49];
				var z = l != null ? l : r("WAWebDrawerViewType").DRAWER, j;
				t[50] !== g.pop || t[51] !== G || t[52] !== z ? (j = u.jsx(r("WAWebNewChatFlowBroadcastContainer.react"), {
					onCloseEntireFlow: G,
					onBack: g.pop,
					viewType: z
				}), t[50] = g.pop, t[51] = G, t[52] = z, t[53] = j) : j = t[53], F = j;
				break e;
			}
			case o("WAWebNewChatFlowTypes").NewChatFlowStep.NewCommunityFlow: {
				var K = l === r("WAWebDrawerViewType").MODAL ? g.end : void 0, Q = l != null ? l : r("WAWebDrawerViewType").DRAWER, X;
				t[54] !== g.pop || t[55] !== K || t[56] !== Q ? (X = u.jsx(r("WAWebNewCommunityInfoDrawer.react"), {
					onBack: g.pop,
					onCreateCommunity: K,
					viewType: Q
				}), t[54] = g.pop, t[55] = K, t[56] = Q, t[57] = X) : X = t[57], F = X;
				break e;
			}
			case o("WAWebNewChatFlowTypes").NewChatFlowStep.NewContactFlow: {
				var Y = l != null ? l : r("WAWebDrawerViewType").DRAWER, J;
				t[58] !== g.pop || t[59] !== L || t[60] !== Y ? (J = u.jsx(r("WAWebContactEditDrawer.react"), {
					ref: d,
					origin: o("WAWebContactLogging").ContactSourceType.NewChat,
					onSave: L,
					onBack: g.pop,
					viewType: Y
				}), t[58] = g.pop, t[59] = L, t[60] = Y, t[61] = J) : J = t[61], F = J;
				break e;
			}
			case o("WAWebNewChatFlowTypes").NewChatFlowStep.DialerPadFlow: {
				var Z = l != null ? l : r("WAWebDrawerViewType").DRAWER, ee;
				t[62] !== g.pop || t[63] !== Z ? (ee = u.jsx(o("WAWebDialerPadFlowLoadable").WAWebDialerPadFlowLoadable, {
					onEnd: g.pop,
					viewType: Z
				}), t[62] = g.pop, t[63] = Z, t[64] = ee) : ee = t[64], F = ee;
			}
		}
		var te;
		return t[65] !== f || t[66] !== F || t[67] !== g || t[68] !== A || t[69] !== i ? (te = u.jsx(f, {
			ref: i,
			flow: g,
			requestDismiss: A,
			children: F
		}), t[65] = f, t[66] = F, t[67] = g, t[68] = A, t[69] = i, t[70] = te) : te = t[70], te;
	}
	function m(e) {
