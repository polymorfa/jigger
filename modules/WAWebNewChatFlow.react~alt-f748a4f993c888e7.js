__d("WAWebNewChatFlow.react", [
	...
	function d(e) {
		var t = e.onEnd, a = e.ref, i = e.viewType;
		o("WAWebContactCollection").ContactCollection.ensureSorted();
		var l = c(), d = o("useWAWebFlow").useFlow(o("WAWebNewChatFlowTypes").NewChatFlowStep.NewChatDrawer, {
			transitions: o("useWAWebFlow").FlowTransitions.DrawerRight,
			onEnd: t
		}), m = d[0], p = d[1], _ = function() {
			p.end();
		};
		...
		var f = function(t) {
			...
			f({
				...
				contact: c
			}), i === r("WAWebDrawerViewType").FLYOUT ? o("WAWebModalManager").ModalManager.close() : p.end();
		}, y = function(t) {
			if (o("WAWebReachoutTimelockUtils").isUserReachoutTimelocked()) {
				o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebReachoutTimelockRestrictedModalLoadable").ReachoutTimelockRestrictedModalLoadable, {}));
				return;
			}
			i === r("WAWebDrawerViewType").FLYOUT ? (p.end(), o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebModal.react").Modal, {
			...
			}))) : p.push(o("WAWebNewChatFlowTypes").NewChatFlowStep.NewBroadcastFlow);
		}, b = function(t) {
			i === r("WAWebDrawerViewType").FLYOUT ? (p.end(), o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebModal.react").Modal, {
				type: o("WAWebModal.react").ModalTheme.Tower,
			...
			if (p.step === o("WAWebNewChatFlowTypes").NewChatFlowStep.NewContactFlow) {
				var e;
		...
		switch (p.step) {
			...
			case o("WAWebNewChatFlowTypes").NewChatFlowStep.NewCommunityFlow:
				L = u.jsx(r("WAWebNewCommunityInfoDrawer.react"), {
					onBack: p.pop,
					onCreateCommunity: i === r("WAWebDrawerViewType").MODAL ? p.end : void 0,
					viewType: i != null ? i : r("WAWebDrawerViewType").DRAWER
				});
				break;
			...
			case o("WAWebNewChatFlowTypes").NewChatFlowStep.DialerPadFlow:
				L = u.jsx(o("WAWebDialerPadFlowLoadable").WAWebDialerPadFlowLoadable, {
					onEnd: p.pop,
					viewType: i != null ? i : r("WAWebDrawerViewType").DRAWER
				});
				break;
