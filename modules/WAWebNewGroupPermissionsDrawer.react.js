__d("WAWebNewGroupPermissionsDrawer.react", [
	...
	function m(e) {
		var t = o("react-compiler-runtime").c(16), a = e.icon, i = e.secondaryTitle, l = e.settingType, s = e.setValue, u = e.title, d = e.value, m = d === !0 ? "off" : "on", p;
		t[0] !== m || t[1] !== s || t[2] !== l ? (p = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				s(!e);
				var t = o("WAWebActionToast.react").genId(), n = o("WAWebSetPropertyGroupAction").getActionString(l, m)[1];
		...
		})(), t[0] = m, t[1] = s, t[2] = l, t[3] = p) : p = t[3];
		var _ = p, f;
		t[4] !== _ || t[5] !== d ? (f = function() {
			return void _(d);
		}, t[4] = _, t[5] = d, t[6] = f) : f = t[6];
		var g;
		t[7] !== f || t[8] !== u || t[9] !== d ? (g = c.jsx(r("WDSSwitch.react"), {
			"aria-label": u,
			value: d,
			onChange: f
		}), t[7] = f, t[8] = u, t[9] = d, t[10] = g) : g = t[10];
		var h = g, y;
		return t[11] !== a || t[12] !== i || t[13] !== u || t[14] !== h ? (y = c.jsx(o("WAWebChatInfoDrawerRow.react").ChatInfoDrawerRow, {
			icon: a,
			side: h,
			title: u,
			secondaryTitle: i,
			spaced: !0
		}), t[11] = a, t[12] = i, t[13] = u, t[14] = h, t[15] = y) : y = t[15], y;
	}
	function p(t) {
