__d("WAWebNewGroupPermissionsDrawer.react", [
	...
	function m(e) {
		var t = e.icon, n = e.secondaryTitle, a = e.settingType, i = e.setValue, l = e.title, s = e.value, u = s === !0 ? "off" : "on", d = async function(t) {
			i(!t);
			var e = o("WAWebActionToast.react").genId(), n = o("WAWebSetPropertyGroupAction").getActionString(a, u)[1];
			o("WAWebToastManager").ToastManager.open(c.jsx(o("WAWebToast.react").Toast, {
				id: e,
				msg: n
			}));
		}, m = c.jsx(r("WDSSwitch.react"), {
			"aria-label": l,
			value: s,
			onChange: function() {
				return void d(s);
