__d("WAWebNewSubgroupSuggestionDrawer.react", [
	...
	function p(e) {
		var t = e.onGroupPermissions, n = c.jsx(o("WAWebChevronIcon.react").ChevronIcon, {
	...
	function _(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.description, l = a.loading, u = l === void 0 ? !1 : l, _ = a.onBack, f = a.onGroupPermissions, g = a.onSubmit, h = a.parentGroup, y = a.subject, C = d(y || ""), b = C[0], v = C[1], S = d(i || ""), R = S[0], L = S[1], E = r("useWAWebCallbackOnce")(function() {
			g(b, R);
		}), k = function(t) {
			v(t), a.handleLiftGroupInfo == null || a.handleLiftGroupInfo({ text: t });
		}, I = function(t) {
			L(t), a.handleLiftGroupInfo == null || a.handleLiftGroupInfo({ description: t });
		}, T = function() {
			return b.trim().length > 0;
		}, D = c.jsx(o("WAWebFlex.react").FlexRow, {
			justify: "center",
			children: c.jsx(o("WAWebImgWithFallback.react").ImgWithFallback, {
				fallbackSVG: c.jsx(o("WAWebDefaultGroupIcon.react").DefaultGroupIcon, { innerStyles: {
			...
			children: [c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				children: T() === !0 ? c.jsx("div", {
					...
					children: c.jsx(o("WAWebRound.react").Round, {
						...
						children: u ? c.jsx(o("WAWebSpinner.react").Spinner, { size: 16 }) : c.jsx(r("WDSIconIcCheck.react"), {})
					})
				}) : null
			})] })]
		});
