__d("WAWebNewsletterAcceptAdminInviteModal.react", [
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(20), r = e.chat, a = e.expiration, i = e.extendedNux, l;
		t[0] !== r ? (l = (function() {
		...
		var m = c, _;
		t[4] === Symbol.for("react.memo_cache_sentinel") ? (_ = h.acceptInvite(), t[4] = _) : _ = t[4];
		var y;
		t[5] === Symbol.for("react.memo_cache_sentinel") ? (y = h.closeModal(), t[5] = y) : y = t[5];
		var C;
		t[6] !== r ? (C = u.jsx(f, { chat: r }), t[6] = r, t[7] = C) : C = t[7];
		var b;
		t[8] !== i ? (b = u.jsx(g, { extendedNux: i }), t[8] = i, t[9] = b) : b = t[9];
		var v;
		t[10] !== a ? (v = h.expiration(a), t[10] = a, t[11] = v) : v = t[11];
		var S;
		t[12] !== v ? (S = u.jsx(o("WAWebText.react").WAWebTextSmall, {
			marginTop: 20,
			xstyle: d.expirationDate,
			children: v
		}), t[12] = v, t[13] = S) : S = t[13];
		var R;
		return t[14] !== m || t[15] !== s || t[16] !== C || t[17] !== b || t[18] !== S ? (R = u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			okText: _,
			onOK: s,
			cancelText: y,
			onCancel: m,
		...
		}), t[14] = m, t[15] = s, t[16] = C, t[17] = b, t[18] = S, t[19] = R) : R = t[19], R;
	}
	function f(e) {
