__d("WAWebNewsletterAddAiContentLabelFlow", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, a, i) {
			i === void 0 && (i = o("WAWebActionToast.react").genId());
			var l = o("WAWebFrontendMsgGetters").getChat(t), u = o("WAJids").toNewsletterJid(l.id.toJid()), m = t.serverId, p = m != null ? o("WAWebNewsletterAddAiContentLabelAction").WAWebNewsletterAddAiContentLabelAction(u, m.toString(), a) : (e || (e = n("Promise"))).resolve(!1), _ = s._(
				/*BTDS*/
				""
			), f = s._(
				/*BTDS*/
	...
	function p(t, a, i) {
		...
		var l = s._(
			...
			actionText: r("WAWebFbtCommon")("Try again"),
			actionHandler: function() {
				return r("WAWebNetworkStatus").online ? d(t, a, i) : (p(t, a, i), (e || (e = n("Promise"))).resolve());
			}
		});
