__d("WAWebNewsletterAdminProfileEnforcementDetailScreenDrawerLoadable", [
	...
	var e, s = e || (e = o("react")), u = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebNewsletterAdminProfileEnforcementDetailScreenDrawer.react").__setRef("WAWebNewsletterAdminProfileEnforcementDetailScreenDrawerLoadable").load();
		return e;
