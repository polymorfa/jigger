__d("WAWebNewsletterAdminSelectionFlow.react", [
	...
	function f(e) {
		var t, n = r("useWAWebNux")(o("WAWebNux").NUX.NEWSLETTER_MULTI_ADMIN), a = n[0], i = n[1], l = _(e, a), s = o("useWAWebFlow").useFlow(l, { transitions: o("useWAWebFlow").FlowTransitions.Modal }), c = s[0], f = s[1], y = m((t = e.invitees) != null ? t : []), C = d(function(e) {
			var t = e.selectedItems;
			y.current = t, f.push(p.Confirmation);
		}, [f]), b = d(function(t, n) {
			var r = y.current;
			o("WAWebModalManager").ModalManager.close(), o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: g.sendingInvites(r.length) })), h({
				inviteMessage: t,
				base64Thumb: n,
				invitees: r,
				chat: e.chat
	...
	function h(e) {
		...
		return o("WAWebNewsletterBulkSendAdminInviteAction").sendBulkNewsletterAdminInviteAction({
			...
			if (i.length === 0) {
				o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: g.invitesSent(r.length) }));
				return;
			}
	...
	function C(e) {
		o("WAWebModalManager").ModalManager.open(u.jsx(f, babelHelpers.extends({}, e)), { transition: "modal-flow" });
	}
	l.startAdminInviteFlow = C;
}), 226);
