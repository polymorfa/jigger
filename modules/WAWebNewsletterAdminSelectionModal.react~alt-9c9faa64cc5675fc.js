__d("WAWebNewsletterAdminSelectionModal.react", [
	...
	function d(e) {
		var t = e.chat, n = e.onConfirm, r = o("useWAWebChatValues").useChatValues(t.id, [
			o("WAWebChatGetters").getId,
			o("WAWebFrontendChatGetters").getNewsletterMetadata,
			o("WAWebChatGetters").getIsNewsletter,
			o("WAWebChatGetters").getId
		]), a = r[0], i = r[1], l = r[2], s = o("useWAWebNewsletterPendingInvites").useNewsletterPendingInvites(t), d = o("useWAWebNewsletterAdmins").useNewsletterAdmins(t), p = o("useWAWebNewsletterSubscribers").useNewsletterAllSubscribers(t), _ = c(function() {
			return o("WAWebNewsletterInviteSelectionModal.react").contactsToIdSet(s);
		}, [s]), f = c(function() {
			return o("WAWebNewsletterInviteSelectionModal.react").contactsToIdSet(d);
		}, [d]), g = o("WAWebABProps").getABPropConfigValue("channels_multi_admin_max_admin_count") - (d.length + s.length), h = function(t) {
			...
			return o("WAWebNewsletterInviteSelectionModal.react").getInviteModalData(p, t);
		};
