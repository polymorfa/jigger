__d("WAWebNewsletterContactIPReporterStepTwoDrawer.react", [
	"fbt",
	...
	function p(t) {
		...
		var l = a, u = l.enforcementIpData, p = l.onBack, g;
		n[3] === Symbol.for("react.memo_cache_sentinel") ? (g = [], n[3] = g) : g = n[3], d(f, g);
		var h;
		...
		var R;
		n[8] !== p ? (R = c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			title: S,
			onBack: p,
			testid: "newsletter-contact-ip-reporter-flow-step-2-drawer",
			type: o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.SMALL
		}), n[8] = p, n[9] = R) : R = n[9];
		var L;
		n[10] === Symbol.for("react.memo_cache_sentinel") ? (L = c.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "center",
			justify: "center",
			wrap: "wrap",
			margin: 24,
			testid: "newsletter-contact-ip-reporter-flow-step-2-subheader",
			paddingStart: 24,
			paddingEnd: 24,
		...
		var E;
		n[11] !== u ? (E = o("WAWebContactReporterInformation").getReporterDetails(u).map(_), n[11] = u, n[12] = E) : E = n[12];
		var k;
		n[13] !== E ? (k = c.jsx(r("WAWebDrawerBody.react"), { children: c.jsxs(r("WAWebDrawerSection.react"), {
			theme: "full-height",
			animation: !1,
			children: [L, E]
		}) }), n[13] = E, n[14] = k) : k = n[14];
		var I;
		return n[15] !== i || n[16] !== R || n[17] !== k ? (I = c.jsxs(r("WAWebDrawer.react"), {
			theme: "gallery",
			ref: i,
			testid: "newsletter-contact-ip-reporter-flow-step2-drawer",
			tsNavigationData: v,
			children: [R, k]
		}), n[15] = i, n[16] = R, n[17] = k, n[18] = I) : I = n[18], I;
	}
	function _(e, t) {
		return c.jsxs("div", {
	...
	function f() {
		r("WAWebEnforcementActionLogging").setSurface(o("WAWebWamEnumInteractionSurface").INTERACTION_SURFACE.CONTACT_REPORTER_SCREEN_2);
	}
	l.default = p;
}), 226);
