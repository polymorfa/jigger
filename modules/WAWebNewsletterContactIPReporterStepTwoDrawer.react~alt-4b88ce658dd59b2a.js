__d("WAWebNewsletterContactIPReporterStepTwoDrawer.react", [
	...
	function p(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.enforcementIpData, l = a.onBack;
		d(function() {
		...
		return c.jsxs(r("WAWebDrawer.react"), {
			...
			children: [c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				}), o("WAWebContactReporterInformation").getReporterDetails(i).map(function(e, t) {
					return c.jsxs("div", {
