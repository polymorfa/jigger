__d("WAWebNewsletterContextMenu", [
	...
	function d(e) {
		...
		return t[0] !== n ? (a = u.jsx(r("WAWebChatContextMenuItemPin.react"), { chat: n }, "pin"), t[0] = n, t[1] = a) : a = t[1], a;
	}
	function m(e) {
		var t = o("react-compiler-runtime").c(5), a = e.chat, i;
		t[0] !== a ? (i = (function() {
		...
		return t[3] !== l ? (m = u.jsx(r("WDSMenuItem.react"), {
			...
			title: d
		}, "Info"), t[3] = l, t[4] = m) : m = t[4], m;
	}
	function p(e) {
		var t = o("react-compiler-runtime").c(7), n = e.chat, a = o("useWAWebNewsletterMuteState").useNewsletterMuteState(n), i = a.isMuted, l = a.toggleMuteState, c;
		t[0] !== i || t[1] !== l ? (c = function() {
			var e = i ? s._(
				/*BTDS*/
				""
			) : s._(
		...
		}, t[0] = i, t[1] = l, t[2] = c) : c = t[2];
		var d = c, m;
		return t[3] !== n || t[4] !== d || t[5] !== i ? (m = u.jsx(r("WAWebMuteMenuItem.react"), {
			onMute: d,
			isMuted: i,
			chat: n
		}, "mute"), t[3] = n, t[4] = d, t[5] = i, t[6] = m) : m = t[6], m;
	}
	function _(e) {
		var t = o("react-compiler-runtime").c(2), n = e.chat, a;
		return t[0] !== n ? (a = u.jsx(r("WAWebChatContextMenuItemMarkUnread.react"), { chat: n }), t[0] = n, t[1] = a) : a = t[1], a;
	}
	function f(e) {
		var t, n = o("react-compiler-runtime").c(5), a = e.chat, i = (t = a.newsletterMetadata) == null ? void 0 : t.inviteCode;
		if (i == null) return null;
		var l;
		n[0] !== i ? (l = function() {
			return o("useWAWebNewsletterInviteLink").copyInviteLink(o("useWAWebNewsletterInviteLink").getInviteLink(i));
		}, n[0] = i, n[1] = l) : l = n[1];
		var c = l, d;
		n[2] === Symbol.for("react.memo_cache_sentinel") ? (d = s._(
			/*BTDS*/
			""
		), n[2] = d) : d = n[2];
		var m = d, p;
		return n[3] !== c ? (p = u.jsx(r("WDSMenuItem.react"), {
			testid: "mi-copy-link",
			onPress: c,
			Icon: r("WDSIconIcLink.react"),
			title: m
		}, "HandleCopy"), n[3] = c, n[4] = p) : p = n[4], p;
	}
	function g(e) {
		var t = o("react-compiler-runtime").c(5), n = e.chat;
		if (!o("WAWebNewsletterGatingUtils").canEmbedNewsletterChannel(n.newsletterMetadata)) return null;
		var a;
		t[0] !== n ? (a = function() {
			return o("WAWebNewsletterMsgLinkUtils").handleNewsletterChannelEmbedClick(n);
		}, t[0] = n, t[1] = a) : a = t[1];
		var i = a, l;
		...
		return t[3] !== i ? (d = u.jsx(r("WDSMenuItem.react"), {
			...
			title: c
		}, "EmbedChannel"), t[3] = i, t[4] = d) : d = t[4], d;
	}
	function h(e) {
		var t = o("react-compiler-runtime").c(5), a = e.chat, i;
		t[0] !== a ? (i = (function() {
		...
		return t[3] !== l ? (m = u.jsx(r("WDSMenuItem.react"), {
			...
			title: d,
			destructive: !0
		}, "HandleUnfollow"), t[3] = l, t[4] = m) : m = t[4], m;
	}
	function y(e) {
		var t = o("react-compiler-runtime").c(5), a = e.chat, i;
		t[0] !== a ? (i = (function() {
		...
		return t[3] !== l ? (m = u.jsx(r("WDSMenuItem.react"), {
			...
			title: d,
			destructive: !0
		}, "DeleteNewsletter"), t[3] = l, t[4] = m) : m = t[4], m;
	}
