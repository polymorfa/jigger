__d("WAWebNewsletterCreateQueryJob", [
	...
	function e(e) {
		var t = e.description, n = e.name, r = e.picture;
		return s(n, t, r);
	}
	function s(e, t, n) {
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			var i = yield o("WAWebNewsletterRpcUtils").runWithBackoff(function() {
				return o("WAWebMexCreateNewsletterJob").mexCreateNewsletter(e, t, a);
			});
			return o("WAWebMexNewsletterParseUtils").parseMexNewsletterResponse(i.xwa2_newsletter_create);
