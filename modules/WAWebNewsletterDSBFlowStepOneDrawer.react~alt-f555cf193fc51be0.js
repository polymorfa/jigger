__d("WAWebNewsletterDSBFlowStepOneDrawer.react", [
	"fbt",
	"WAWebButton.react",
	...
	function p(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.onBack, l = a.onClickContinue;
		d(function() {
			r("WAWebEnforcementActionLogging").setSurface(o("WAWebWamEnumInteractionSurface").INTERACTION_SURFACE.DSB_FLOW_SCREEN_1);
		}, []);
		var u = s._(
			/*BTDS*/
			""
		...
		return c.jsxs(r("WAWebDrawer.react"), {
			theme: "gallery",
			ref: n,
			testid: "newsletter-dsb-flow-step1-drawer",
			tsNavigationData: {
				surface: "unknown",
			...
			children: [c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				onBack: i,
				testid: "newsletter-dsb-flow-step-1-drawer",
				...
				children: [
					c.jsxs(o("WAWebFlex.react").FlexRow, {
						...
						wrap: "wrap",
						margin: 24,
						testid: "newsletter-dsb-flow-step-1-subheader",
						paddingStart: 24,
						paddingEnd: 24,
						children: [c.jsx(o("WAWebText.react").WAWebTextLarge, {
							xstyle: m.header,
							weight: "medium",
							testid: "newsletter-dsb-flow-step-1-header",
							color: "primary",
							children: u
					...
					c.jsx(o("WAWebFlex.react").FlexColumn, {
						...
						paddingStart: 24,
						paddingEnd: 24,
						children: c.jsx(o("WAWebNewsletterModalsUtils.react").BulletPointList, { bullets: _() })
					}),
					c.jsx(o("WAWebFlex.react").FlexColumn, {
						paddingStart: 24,
						paddingEnd: 24,
						...
						children: c.jsx(o("WAWebButton.react").WAWebButtonPrimary, {
							onClick: l,
							testid: "newsletter-dsb-flow-step-1-next-button",
							children: s._(
								/*BTDS*/
								""
							)
