__d("WAWebNewsletterDescriptionSection.react", [
	...
	function g(e) {
		var t = o("react-compiler-runtime").c(30), a = e.adminFunnelLogger, i = e.chat, l = e.focusOnMount, u = f(l != null ? l : !1), c = u[0], m = u[1], p;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (p = [
			o("WAWebChatGetters").getId,
			o("WAWebChatGetters").getIsNewsletter,
			o("WAWebChatGetters").getId,
			o("WAWebFrontendChatGetters").getNewsletterMetadata
		], t[0] = p) : p = t[0], o("useWAWebChatValues").useChatValues(i.id, p);
		var g;
		t[1] === Symbol.for("react.memo_cache_sentinel") ? (g = [
			"description",
			"creationTime",
			"membershipType"
		], t[1] = g) : g = t[1];
		var y = o("useWAWebModelValues").useOptionalModelValues(i.newsletterMetadata, g), C;
		t[2] === Symbol.for("react.memo_cache_sentinel") ? (C = ["change:description"], t[2] = C) : C = t[2];
		var b;
		t[3] !== (y == null ? void 0 : y.description) ? (b = function() {
			return (y == null ? void 0 : y.description) || "";
		}, t[3] = y == null ? void 0 : y.description, t[4] = b) : b = t[4];
		var v = r("useWAWebEventTargetValue")(y, C, b), S;
		t[5] === Symbol.for("react.memo_cache_sentinel") ? (S = function() {
			m(!0);
		}, t[5] = S) : S = t[5], o("useWAWebListener").useListener(o("WAWebCmd").Cmd, "edit_newsletter_description", S);
		var R = f(v), L = R[0], E = R[1], k = _(v), I;
		t[6] !== a || t[7] !== L ? (I = function() {
			L !== k.current && (k.current = L, a.logEvent(o("WAWebWamEnumChannelAdminAction").CHANNEL_ADMIN_ACTION.CHANNEL_DESCRIPTION_SET));
		}, t[6] = a, t[7] = L, t[8] = I) : I = t[8];
		var T = I, D;
		t[9] !== a || t[10] !== i || t[11] !== T ? (D = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = t === void 0 ? "" : t;
				T(), a.logEvent(o("WAWebWamEnumChannelAdminAction").CHANNEL_ADMIN_ACTION.CHANNEL_ADMIN_FLOW_CONFIRMATION_TAP), yield h({
					chat: i,
					desc: n,
					adminFunnelLogger: a,
					setIsEditing: m
		...
		})(), t[9] = a, t[10] = i, t[11] = T, t[12] = D) : D = t[12];
		var x = D;
		if (y == null) return null;
		var $;
		t[13] === Symbol.for("react.memo_cache_sentinel") ? ($ = s._(
			/*BTDS*/
			""
		), t[13] = $) : $ = t[13];
		var P = $, N = y.creationTime, M;
		t[14] !== N || t[15] !== y.creationTime ? (M = N != null ? o("WAWebClock").Clock.newsletterDescriptionCreatedStr(y.creationTime) : null, t[14] = N, t[15] = y.creationTime, t[16] = M) : M = t[16];
		var w = M, A;
		if (t[17] !== y) {
			var F;
			A = (F = y == null ? void 0 : y.iAmAdminOrOwner()) != null ? F : !1, t[17] = y, t[18] = A;
		} else A = t[18];
		var O;
		t[19] !== T ? (O = function() {
			T(), m(!1);
		}, t[19] = T, t[20] = O) : O = t[20];
		var B;
		return t[21] !== i || t[22] !== w || t[23] !== v || t[24] !== l || t[25] !== x || t[26] !== c || t[27] !== A || t[28] !== O ? (B = d.jsx(r("WAWebChatInfoDescriptionSection.react"), {
			description: v,
		...
		}), t[21] = i, t[22] = w, t[23] = v, t[24] = l, t[25] = x, t[26] = c, t[27] = A, t[28] = O, t[29] = B) : B = t[29], B;
	}
	function h(t) {
