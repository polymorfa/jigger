__d("WAWebNewsletterDirectoryCategoriesDropdown.react", [
	...
	function c(e) {
		var t = o("react-compiler-runtime").c(5), n = e.categories, a = e.onCategorySelect, i;
		if (t[0] !== n || t[1] !== a) {
			var l;
			t[3] !== a ? (l = function(t, n) {
				return s.jsx(o("WAWebKeyboardHotKeys.react").HotKeys, {
					...
					children: s.jsx(r("WAWebCellV2.react"), {
						...
						testid: "categories-dropdown-item-" + o("WAWebNewsletterDirectoryCategoryUtils").getNewsletterSectionFromCategoryType(t.type).toLowerCase(),
						size: "small",
