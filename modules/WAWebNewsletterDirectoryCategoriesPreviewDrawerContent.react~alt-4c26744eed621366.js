__d("WAWebNewsletterDirectoryCategoriesPreviewDrawerContent.react", [
	...
	function y() {
		...
		return u.jsx(r("WAWebNewsletterDirectoryCategoriesShimmer.react"), { height: e.height - f - g });
	}
	y.displayName = y.name + " [from " + i.id + "]";
	function C(e) {
		var t = e.countrySelector, n = e.data, a = e.onSeeAllNewsletters, i = e.onSelect, l = e.selectionRef;
		switch (n.type) {
			case o("useWAWebNewsletterDirectorySections").TabCellDataType.NEWSLETTER_DIRECTORY_SECTION_HEADER: return u.jsx(r("WAWebDrawerSection.react"), {
				animation: !1,
				children: u.jsx(r("WAWebNewsletterDirectoryEntrySectionHeader.react"), {
					...
					onSeeAllNewsletters: function() {
						...
						a({
							...
							category: (e = o("WAWebNewsletterDirectoryCategoryUtils").getNewsletterCategoryFromSection(n.section)) != null ? e : void 0,
			...
			case o("useWAWebNewsletterDirectorySections").TabCellDataType.NEWSLETTER_DIRECTORY_CELL: return u.jsx(r("WAWebDrawerSection.react"), {
				animation: !1,
				children: u.jsx(r("WAWebNewsletterDirectoryCell.react"), {
					...
					testid: "newsletter-directory-section-" + n.sectionIndex + "-cell-" + n.index
				})
			});
			default: return n.type, null;
		}
	}
	C.displayName = C.name + " [from " + i.id + "]";
	function b(e) {
		var t = e.countryCode, n = e.newsletterDirectoryFunnelLogger, a = e.onCategoriesLoad, i = e.onSeeAllNewsletters, l = _(), c = r("useLazyRef")(function() {
		...
		var f = _(), g = p(function() {
			return new (r("WAWebFlatListController"))();
		}, []), b = _(), v = _(!1), S = o("useWAWebNewsletterDirectorySections").useNewsletterDirectorySections({
			countryCode: t,
			newsletterDirectoryFunnelLogger: n,
			onCategoriesLoad: a
		}), R = S[0], L = S[1], E = S[2], k = S[3], I = S[4], T = S[5], D = S[6], x = S[7], $ = function(t) {
			c.current.setVal(t);
		}, P = d(function() {
			f.current && r("WAWebFocusTracer").focus(f.current);
		}, []);
		m(function() {
			R.length && v.current === !1 && (g.setScrollFromStart(0), v.current = !0);
		}, [R, g]);
		var N = function() {
			if (b.current) {
		...
		var F = function(t) {
			...
			l.current != null && o("WAWebNewsletterTabDrawerUtils").isScrollAtBottomOfList(l.current) && L() && k();
		}, B = R.length > 0 ? u.jsx(o("WAWebFlatList.react").FlatList, {
			ref: b,
			data: R,
