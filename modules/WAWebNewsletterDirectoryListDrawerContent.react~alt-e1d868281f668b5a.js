__d("WAWebNewsletterDirectoryListDrawerContent.react", [
	...
	function y() {
		var e = r("useWAWebWindowSize")(), t = e.height, n = Math.floor(t / g) - h;
		return u.jsx(r("WAWebNewsletterDirectoryShimmer.react"), { count: n });
	}
	y.displayName = y.name + " [from " + i.id + "]";
	function C(e) {
		var t = e.country, n = e.data, a = e.discoverySurface, i = e.index, l = e.listView, s = e.newsletterCategory, c = e.onSelect, d = e.selectionRef;
		return u.jsx(r("WAWebDrawerSection.react"), {
			...
			children: u.jsx(r("WAWebNewsletterDirectoryCell.react"), {
				...
				discoverySurface: a,
				newsletterDirectorySectionName: s ? o("WAWebNewsletterDirectoryCategoryUtils").getNewsletterSectionFromCategoryType(s) : "EXPLORE",
				country: t,
				listView: l
			})
		});
