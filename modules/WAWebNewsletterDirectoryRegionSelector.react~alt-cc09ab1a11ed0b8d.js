__d("WAWebNewsletterDirectoryRegionSelector.react", [
	...
	function b(t) {
		...
		var p = u.list, g = u.map, y = function() {
			o("WAWebModalManager").ModalManager.open(c.jsx(S, {
				countryList: p,
	...
	function v(e) {
		var t = e.active, n = e.country, a = e.onClick, i = e.selected, l = r("useWAWebActiveSelection")(t, n.code), s = l[0], u = l[1], d = function() {
			a(n);
		}, m = {
			enter: d,
			space: d
		...
		return c.jsx(o("WAWebKeyboardHotKeys.react").HotKeys, {
			...
			children: c.jsx(r("WAWebCellV2.react"), {
				...
				primary: c.jsx(o("WAWebText.react").WAWebTextTitle, { children: n.name }),
				detailLeft: c.jsx(r("WDSBaseRadio.react"), {
					value: String(n.code),
					name: "region",
					checked: i,
					disabled: !1,
					testid: "wds-radio-input-" + (i ? "checked" : "unchecked"),
	...
	S.displayName = S.name + " [from " + i.id + "]", l.NewsletterDirectoryRegionSelectorTheme = C, l.NewsletterDirectoryRegionSelector = b;
}), 226);
