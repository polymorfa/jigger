__d("WAWebNewsletterDismissAdminPopup.react", [
	...
	function m(e) {
		var t = o("react-compiler-runtime").c(21), n = e.contact, a = e.isMe, i = e.newsletter, l = r("useWAWebToggle")(!1), c = l[0], m = l[1], _;
		t[0] !== n || t[1] !== a ? (_ = a ? s._(
			/*BTDS*/
			""
		) : s._(
			/*BTDS*/
			"",
			[s._param("admin-dismissal-contact-first-name", o("WAWebParticipantListUtils").getFirstNameForContact(n))]
		...
		var h = g, y;
		t[5] !== n || t[6] !== a || t[7] !== i || t[8] !== c ? (y = async function() {
			await p({
				isMe: a,
				newsletter: i,
				contact: n,
				shouldUnfollowNewsletter: c
			});
		}, t[5] = n, t[6] = a, t[7] = i, t[8] = c, t[9] = y) : y = t[9];
		var C = y, b;
		t[10] !== a || t[11] !== c || t[12] !== m ? (b = a ? u.jsxs(o("WAWebFlex.react").FlexRow, {
			columnGap: 8,
			paddingTop: 16,
			paddingBottom: 16,
		...
		}) : null, t[10] = a, t[11] = c, t[12] = m, t[13] = b) : b = t[13];
		var v = b, S;
		t[14] !== h ? (S = u.jsx(o("WAWebText.react").WAWebTextTitle, {
			color: "secondary",
			children: h
		}), t[14] = h, t[15] = S) : S = t[15];
		var R;
		return t[16] !== C || t[17] !== S || t[18] !== f || t[19] !== v ? (R = u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			title: f,
			onOK: C,
			onCancel: o("WAWebModalManager").closeModalManager,
			children: [S, v]
		}), t[16] = C, t[17] = S, t[18] = f, t[19] = v, t[20] = R) : R = t[20], R;
	}
	async function p(e) {
