__d("WAWebNewsletterEnforcementAlertModelUtils", ["WAWebCommonNewsletterEnums", "WAWebWidFactory"], (function(t, n, r, o, a, i, l) {
	function e(e) {
		return e === o("WAWebCommonNewsletterEnums").ViolatingContentType.STATUS ? "STATUS" : "MESSAGE";
	}
	function s(e, t, n) {
		var r, a = e.contentType === o("WAWebCommonNewsletterEnums").ViolatingContentType.STATUS ? n : t;
		return {
			serverId: e.serverId,
			msgData: (r = a == null ? void 0 : a.get(e.serverId)) != null ? r : null
		};
	}
	function u(t, n, r, a) {
		var i = [], l;
		return t == null || t.map(function(t) {
			var s, u, c, d = (s = t.enforcementExtraData) == null ? void 0 : s.enforcementTargetData, m = (u = d == null ? void 0 : d.serverId) != null ? u : null, p = (d == null ? void 0 : d.contentType) === o("WAWebCommonNewsletterEnums").ViolatingContentType.STATUS ? r : n, _ = m != null && (c = p == null ? void 0 : p.get(m)) != null ? c : null, f = new Map(), g = {
				id: t.enforcementId,
				...
				msgData: _,
				violatingContentData: d != null ? {
					contentType: d.contentType,
					serverId: d.serverId
				} : null
			};
			if (m != null && _ != null) {
				var h, y = e((h = d == null ? void 0 : d.contentType) != null ? h : o("WAWebCommonNewsletterEnums").ViolatingContentType.MESSAGE);
				f.set(y + "_" + m, g);
			}
			l = {
				id: t.enforcementId,
	...
	function c(t, n, r, a) {
		var i = new Map();
		t.map(function(t) {
			var l = t.violatingContentData, u = s(l, n, r), c = u.msgData, d = u.serverId, m = {
				id: t.enforcementId,
				chatId: o("WAWebWidFactory").createWid(a),
				appealReasonOptions: t.appealReasonOptions,
				enforcementViolationCategory: t.enforcementViolationCategory,
		...
		var u = l.violatingContentData, c = s(u, n, r), d = c.msgData;
		return {
			id: l.enforcementId,
			chatId: o("WAWebWidFactory").createWid(a),
	...
	function _(e, t, n, r) {
		var o = [];
		if ((e == null ? void 0 : e.suspensions) != null && o.push.apply(o, u(e == null ? void 0 : e.suspensions, t, n, r)), (e == null ? void 0 : e.geoSuspensions) != null && o.push.apply(o, p(e == null ? void 0 : e.geoSuspensions, t, n, r)), (e == null ? void 0 : e.profilePictureDeletions) != null && o.push.apply(o, d(e == null ? void 0 : e.profilePictureDeletions, r)), (e == null ? void 0 : e.adminProfiles) != null && o.push.apply(o, m(e == null ? void 0 : e.adminProfiles, r)), (e == null ? void 0 : e.violatingMessages) != null) {
