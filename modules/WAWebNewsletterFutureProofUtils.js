__d("WAWebNewsletterFutureProofUtils", [
	...
	function u() {
		return r("WAWebCompactSet")(o("WAWebABProps").getABPropConfigValue("channel_supported_message_types").split(","), function(e) {
	...
	function c(e) {
		var t = u().has(e);
		switch (e) {
			case o("WAWebMsgType").MSG_TYPE.PTT: return o("WAWebNewsletterGatingUtils").isNewsletterPTTReceivingEnabled();
			case o("WAWebMsgType").MSG_TYPE.PTV: return !0;
			case o("WAWebMsgType").MSG_TYPE.POLL_CREATION:
			case o("WAWebMsgType").MSG_TYPE.POLL_UPDATE: return o("WAWebNewsletterGatingUtils").isNewsletterPollsReceivingEnabled();
			case o("WAWebMsgType").MSG_TYPE.POLL_RESULT_SNAPSHOT: return !0;
			case o("WAWebMsgType").MSG_TYPE.AUDIO: return o("WAWebNewsletterGatingUtils").isNewsletterAudioFileReceivingEnabled();
			case o("WAWebMsgType").MSG_TYPE.ALBUM: return o("WAWebNewsletterGatingUtils").isNewsletterAlbumsV2ReceiverEnabled();
			case o("WAWebMsgType").MSG_TYPE.NEWSLETTER_FOLLOWER_INVITE: return o("WAWebNewsletterGatingUtils").isChannelInviteContactsToFollowConsumerEnabled();
			default: return t;
		}
	}
	function d(e) {
		var t = e.type === o("WAWebMsgType").MSG_TYPE.UNKNOWN ? e.futureproofType : e.type;
		return t == null ? { supported: !1 } : c(t) ? o("WAWebMsgGetters").getIsReply(e) && !o("WAWebNewsletterGatingUtils").isNewsletterReceivingAdminRepliesEnabled() ? { supported: !1 } : o("WAWebMsgGetters").getIsQuestion(e) && !o("WAWebQuestionsGatingUtils").isQuestionReceiverEnabledForMsg(e) ? { supported: !1 } : o("WAWebMsgGetters").getIsQuestionReply(e) && !o("WAWebQuestionsGatingUtils").isQuestionReplyReceiverEnabledForMsg(e) ? { supported: !1 } : o("WAWebMsgGetters").getPollType(e) === o("WAWebPollCreationUtils").PollType.QUIZ && !o("WAWebNewsletterGatingUtils").isNewsletterQuizReceiverEnabled() ? { supported: !1 } : e.newsletterAdminProfile != null && !o("WAWebNewsletterGatingUtils").isNewsletterAdminProfilesReceiverEnabled() ? { supported: !1 } : o("WAWebMsgGetters").isNewsletterMsgWithMusic(e) && !o("WAWebMsgGetters").getIsNewsletterStatus(e) && !o("WAWebMusicGatingUtils").isStatusMusicReceiverEnabledForNewsletter() ? {
			supported: !1,
			reason: "phone_only_feature"
