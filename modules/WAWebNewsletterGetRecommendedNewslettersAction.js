__d("WAWebNewsletterGetRecommendedNewslettersAction", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			var t = yield o("WAWebNewsletterDirectorySearchJob").getRecommendedNewsletters(o("WAWebLinkDevicePhoneNumberEntryInputFormatUtils").getMaybeMyCountryCodeIso()), n = yield o("WAWebGetNewsletterDirectoryChats").getDirectoryNewsletterChats(t, { skipSubscribedNewsletters: !0 });
