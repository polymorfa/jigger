__d("WAWebNewsletterInfoSubject.react", [
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(18), a = e.adminFunnelLogger, i = e.chat, l;
		...
		var u = o("useWAWebModelValues").useOptionalModelValues(i.newsletterMetadata, l), d = _(i.formattedTitle), m = d[0], f = d[1], h = p(i.formattedTitle), y;
		t[1] !== a || t[2] !== m ? (y = function() {
			m !== h.current && (h.current = m, a.logEvent(o("WAWebWamEnumChannelAdminAction").CHANNEL_ADMIN_ACTION.CHANNEL_NAME_SET));
		}, t[1] = a, t[2] = m, t[3] = y) : y = t[3];
		var C = y, b;
		t[4] !== a || t[5] !== i || t[6] !== C ? (b = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				C(), e !== i.formattedTitle && (a.logEvent(o("WAWebWamEnumChannelAdminAction").CHANNEL_ADMIN_ACTION.CHANNEL_ADMIN_FLOW_CONFIRMATION_TAP), yield g(i, e, a));
			});
			return function(n) {
				return e.apply(this, arguments);
			};
		})(), t[4] = a, t[5] = i, t[6] = C, t[7] = b) : b = t[7];
		var v = b;
		if (u == null) return null;
		if (u.isSuspendedOrTerminated || !u.iAmAdminOrOwner()) {
			var S;
			return t[8] !== i ? (S = c.jsx(r("WDSText.react"), {
				type: "Headline1",
		...
		var R;
		t[10] !== u ? (R = u.iAmAdminOrOwner() && !u.isSuspendedOrTerminated, t[10] = u, t[11] = R) : R = t[11];
		var L;
		...
		var E;
		return t[13] !== i.formattedTitle || t[14] !== C || t[15] !== v || t[16] !== R ? (E = c.jsx(r("WAWebGroupInfoSubjectInput.react"), {
			...
			onBlur: C,
			direction: "ltr"
		}), t[13] = i.formattedTitle, t[14] = C, t[15] = v, t[16] = R, t[17] = E) : E = t[17], E;
	}
	function g(t, n, a, i) {
