__d("WAWebNewsletterMetadataQueryJob", [
	"WABase64",
	...
	function e() {
		var e = async function() {
			return o("WAWebMexFetchAllNewslettersMetadataJob").handleMexGetAllNewsletters();
		};
		return o("WAWebNewsletterRpcUtils").runWithBackoff(e);
	}
	function s(e, t) {
		var n = o("WAWebNewsletterQueryUtils").getNewsletterMetadataQueryParamArgs(e, t, {
			creationTime: !0,
			name: !0,
			picture: !0,
			description: !0,
	...
	function u(e, t, n) {
		var r = o("WAWebNewsletterQueryUtils").getNewsletterMetadataQueryParamArgs(e, t, n);
		return o("WAWebNewsletterRpcUtils").runWithBackoff(function() {
			return c(r);
		});
	}
	async function c(e) {
		return o("WAWebNewsletterHandleMexGetNewsletter").handleMexGetNewsletter(e);
	}
	function d(e, t, n) {
		return p(e, t, n);
	}
	...
	async function p(e, t, n) {
		var r = t.editDescription, a = t.editName, i = t.editPicture, l = t.editReactionCodesSetting, s = n.description, u = n.name, c = n.picture, d = n.reactionCodesSetting, m;
		c != null && (m = o("WABase64").encodeB64(c));
		var p = _(i, m), f = _(a, u), g = _(r, s), h = l === !0 ? d : null, y = await o("WAWebNewsletterRpcUtils").runWithBackoff(function() {
		...
		return o("WAWebMexNewsletterParseUtils").parseMexNewsletterResponse(y.xwa2_newsletter_update);
	}
	function _(e, t) {
		if (e === !0) return t != null ? t : "";
	}
	l.queryAllNewslettersMetadata = e, l.queryNewsletterMetadataByInviteCode = s, l.queryNewsletterMetadataByJid = u, l.editNewsletterMetadataQuery = d, l.emptyNewsletterMetadataType = m;
}), 98);
