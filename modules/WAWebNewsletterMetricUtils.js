__d("WAWebNewsletterMetricUtils", ["$InternalEnum", "WATimeUtils"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = 86400, s = 30, u = "infinite";
	function c(t) {
	...
	function m(e) {
		var t = e.flatMap(function(e) {
			...
			var n = e.enumSet, r = e.metricRequests, o = d.cast(t.id);
	...
	l.INSIGHT_DAYS_COVERED = s, l.DELTA_INFINITE = u, l.getInsightPeriodStart = c, l.NewsletterInsightMetricQuery = d, l.getUniqueMetricRequests = m, l.isDeltaValueZero = p, l.roundToNearestDay = _;
}), 98);
