__d("WAWebNewsletterNotificationSettingsBanner.react", [
	...
	function m(e) {
		var t = e.chat, n = e.onClose, a = e.ref, i = c(function() {
		...
		return u.jsx(o("WAWebUimUie.react").UIE, {
			...
			children: u.jsx(r("WAWebConversationBanner.react"), {
				...
				children: u.jsxs(o("WAWebFlex.react").FlexRow, {
					align: "center",
					children: [u.jsx(o("WAWebUnmuteNotificationsRefreshedIcon.react").UnmuteNotificationsRefreshedIcon, { iconXstyle: d.icon }), u.jsxs(r("WDSText.react"), {
						type: "Body2",
