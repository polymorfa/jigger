	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (a != null) {
				...
				var i = o("WAWebNewsletterPinDisplay").filterActiveNewsletterPins((n = (r = e.newsletterMetadata) == null ? void 0 : r.pinnedMessages) != null ? n : [], o("WATimeUtils").unixTime()).length >= c, l = yield o("WAWebConfirmPopup.react").waitForConfirmPopup(i ? {
					title: s._(
						/*BTDS*/
						""
					),
				...
				l && (yield _(o("WAWebNewsletterPinMessageAction").pinNewsletterMessage, e, a));
			}
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (n != null) {
				...
				r && (yield _(o("WAWebNewsletterPinMessageAction").unpinNewsletterMessage, e, n));
			}
		}), b.apply(this, arguments);
	}
	l.runPinNewsletterMessageFlow = h, l.runUnpinNewsletterMessageFlow = C;
}), 226);
