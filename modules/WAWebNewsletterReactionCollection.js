		...
		function t() {
			...
			return t = e.call.apply(e, [this].concat(i)) || this, t.findImpl = (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield o("WAWebdbCRUDOperationsNewsletterReaction").getNewsletterReaction(e), n = yield o("WAWebMsgCollection").MsgCollection.hydrateOrGetMessages([e]), a = n[0];
					if (a == null) throw new (o("WAWebGetUserMediaErrors")).NotFoundError("No reactions found");
					var i = a.id.remote.toJid(), l = a.serverId, s = l != null ? yield o("WAWebNewsletterDBUtils").craftNewsletterMsgKeyFromServerId(l, i) : null, u = s != null ? yield o("WAWebDBGetReactions").existsReactionAddressingModeInsensitive({
