__d("WAWebNewsletterReactionDetailsPane.react", [
	...
	function C(e) {
		var t = e.chat, n = e.count, r = e.multipleMsgs, a = s._(
			/*BTDS*/
			"",
		...
		return u.jsx(o("WAWebFlex.react").FlexRow, {
			align: "center",
			justify: o("WAWebNewsletterExtendedGatingUtils").isNewsletterReactionSenderListEnabled(t, r) ? "start" : "center",
			xstyle: [
				f.paddingTop20,
				f.paddingBottom8,
				f.paddingHoriz16,
			...
			children: o("WAWebNewsletterExtendedGatingUtils").isNewsletterReactionSenderListEnabled(t, r) ? u.jsx(o("WAWebText.react").WAWebTextTitle, {
				weight: "semibold",
				children: a
