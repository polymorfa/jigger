__d("WAWebNewsletterReactionModel", [
	"WATimeUtils",
	"WAWebBaseModel",
	"WAWebModelUtils",
	"WAWebMsgKey",
	...
	var e = (function(e) {
		...
		return n.initialize = function() {
			var t;
			e.prototype.initialize.call(this), this.reactionCountMap = (t = this.reactionCountMap) != null ? t : new Map();
		}, n.updateMyReaction = function(t) {
			return t === o("WAWebReactionsBEUtils").REVOKED_REACTION_TEXT ? this.$NewsletterMessageReactionsImpl$p_1() : this.$NewsletterMessageReactionsImpl$p_2(t);
		}, n.$NewsletterMessageReactionsImpl$p_2 = function(t) {
			var e, n = this.myReaction;
			this.reactionCountMap = (e = this.reactionCountMap) != null ? e : new Map();
			var r = this.reactionCountMap, o = r.get(t);
			...
			var e, t = this.myReaction;
			if (t != null) {
				this.reactionCountMap = (e = this.reactionCountMap) != null ? e : new Map();
				var n = this.reactionCountMap, r = n.get(t);
				r != null && (r > 1 ? n.set(t, r - 1) : n.delete(t), this.$NewsletterMessageReactionsImpl$p_3(null));
			}
		}, n.$NewsletterMessageReactionsImpl$p_3 = function(t) {
			this.myReactionTs = o("WATimeUtils").unixTime(), this.myReaction = t;
		}, t;
