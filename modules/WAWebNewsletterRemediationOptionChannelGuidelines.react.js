__d("WAWebNewsletterRemediationOptionChannelGuidelines.react", [
	"fbt",
	...
	function d() {
		...
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = u.jsx(r("WDSIconWdsIcChannels.react"), {
			height: 24,
			width: 24,
		...
		var a;
		return e[2] === Symbol.for("react.memo_cache_sentinel") ? (a = u.jsx(r("WAWebNewsletterAlertsRowComponent.react"), {
			icon: t,
			onClick: m,
			showBottomBorder: !1,
			showDetailRight: !1,
