__d("WAWebNewsletterRemediationOptionContactDSB.react", [
	...
	function d(e) {
		var t = e.enforcementSource, n = e.onClickDSBFlow;
		return t === "IP_SRT" || !o("WAWebNewsletterGatingUtils").isDSAEUOnlyNoticeEnabled() ? null : u.jsx(r("WAWebNewsletterAlertsRowComponent.react"), {
