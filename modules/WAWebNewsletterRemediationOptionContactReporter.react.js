__d("WAWebNewsletterRemediationOptionContactReporter.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(5), n = e.onClickEmailReporter, a;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (a = u.jsx(r("WDSIconIcMail.react"), {
			height: 24,
			width: 24,
		...
		var d;
		return t[3] !== n ? (d = u.jsx(r("WAWebNewsletterAlertsRowComponent.react"), {
			icon: a,
			onClick: n,
			showBottomBorder: !1,
			showDetailRight: !1,
