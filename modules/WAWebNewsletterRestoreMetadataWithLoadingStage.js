__d("WAWebNewsletterRestoreMetadataWithLoadingStage", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				yield o("WAWebNewsletterMetadataInitFromStorage").restoreNewsletterMetadata(), e && o("WAWebNewsletterLoadingStageManager").NewsletterLoadingStageManager.stage === o("WAWebNewsletterLoadingStageManager").NewsletterLoadingStage.Loading && o("WAWebNewsletterLoadingStageManager").NewsletterLoadingStageManager.end();
			} catch (t) {
