__d("WAWebNewsletterRevokeInvitePopup.react", [
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(16), r = e.chat, a = e.contact, i;
		t[0] !== r || t[1] !== a ? (i = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield m({
					chat: r,
					contact: a
		...
		var l = i, c;
		t[3] !== a ? (c = o("WAWebParticipantListUtils").getFirstNameForContact(a), t[3] = a, t[4] = c) : c = t[4];
		var d = c, p;
		t[5] !== d ? (p = s._(
			/*BTDS*/
			"",
		...
		var g = f, h;
		t[9] === Symbol.for("react.memo_cache_sentinel") ? (h = o("WAWebCommonNewsletterStrings").getRevokeButtonFullText(), t[9] = h) : h = t[9];
		var y;
		t[10] !== g ? (y = u.jsx(o("WAWebText.react").WAWebTextTitle, {
			color: "secondary",
			children: g
		}), t[10] = g, t[11] = y) : y = t[11];
		var C;
		return t[12] !== l || t[13] !== y || t[14] !== _ ? (C = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			title: _,
			onOK: l,
			onCancel: o("WAWebModalManager").closeModalManager,
			okText: h,
			children: y
		}), t[12] = l, t[13] = y, t[14] = _, t[15] = C) : C = t[15], C;
	}
	function f(e) {
	...
	function g(e) {
		var t = o("react-compiler-runtime").c(10), r = e.chat, a = e.contact, i;
		t[0] !== r || t[1] !== a ? (i = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield m({
					chat: r,
		...
		var l = i, s;
		t[3] !== r ? (s = u.jsx(f, { chat: r }), t[3] = r, t[4] = s) : s = t[4];
		var c = s, p, _;
		t[5] === Symbol.for("react.memo_cache_sentinel") ? (p = o("WAWebCommonNewsletterStrings").getRevokeButtonFullText(), _ = [d.buttonGroup, o("WDSPaddings.stylex").wdsPaddings.padding0], t[5] = p, t[6] = _) : (p = t[5], _ = t[6]);
		var g;
		return t[7] !== l || t[8] !== c ? (g = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			title: c,
			onOK: l,
			onCancel: o("WAWebModalManager").closeModalManager,
			okText: p,
			buttonGroupStyle: _
		}), t[7] = l, t[8] = c, t[9] = g) : g = t[9], g;
	}
	l.NewsletterRevokeInvitePopupWithContactName = _, l.NewsletterRevokeInvitePopupWithNewsletterInformation = g;
}), 226);
