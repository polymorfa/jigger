__d("WAWebNewsletterSendMsgActionUtils", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var a = yield r("WAWebMediaUploadMmsThumbnail")({
				thumbnail: yield r("WAWebMediaOpaqueData").createFromBase64Jpeg(n),
	...
	function d(e, t) {
		if (e.quotedParticipant != null && e.quotedParticipant !== t.id) throw new (o("WAWebNewsletterErrors")).UnexpectedNewsletterQuotedParticipantMismatchError();
	}
