__d("WAWebNewsletterSendStatusAction", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			var a = o("WAWebWidToJid").widToNewsletterJid(e), i = yield o("WAWebStatusMsgDataUtils").createTextStatusMsgData(t, e);
			i != null || s(0, 143976);
			...
			u.wamMessageSendReporter = new (o("WAWebMessageSendReporter")).MessageSendReporter(u, { frontendDeps: o("WAWebMessageSendReporterFrontendDeps").MAIN_WEB_MESSAGE_SEND_REPORTER_FRONTEND_DEPS }), yield o("WAWebStatusCollection").StatusCollection.addStatusMessages(e, [u]), c(e, l.t), yield o("WAWebDBProcessMessage").storeMessages([l], e);
			...
			try {
				var m = yield o("WAWebNewsletterSendStatusJob").sendNewsletterStatus({
					type: "text",
					msg: u,
					newsletterJid: a
				}), p = h(u, m);
				...
				var _, g;
				throw u.updateAck(o("WAWebAck").ACK.FAILED), (_ = u.wamMessageSendReporter) == null || _.postFailure({
					...
					failureReason: (g = r("getErrorSafe")(e)) == null ? void 0 : g.message,
					retryCount: 0
				}), e;
			} finally {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			d.wamMessageSendReporter = new (o("WAWebMessageSendReporter")).MessageSendReporter(d, { frontendDeps: o("WAWebMessageSendReporterFrontendDeps").MAIN_WEB_MESSAGE_SEND_REPORTER_FRONTEND_DEPS }), yield o("WAWebStatusCollection").StatusCollection.addStatusMessages(a, [d]), c(a, l.t), yield o("WAWebDBProcessMessage").storeMessages([l], a);
			try {
				yield t(d);
			} catch (e) {
				var m;
			...
			var p = d.mediaHandle;
			p != null || s(0, 144005);
			var _ = o("WAWebSendStatusMsgAction").getContentTypeForLogging(d.type), g = new (o("WAWebStatusPosterActionsLogger")).StatusPosterActionsLogger(n == null ? void 0 : n.sessionId, a);
			g.logPostStatusRequest(_, 0, n == null ? void 0 : n.entryPoint);
			try {
				var y = yield o("WAWebNewsletterSendStatusJob").sendNewsletterStatus({
					type: "media",
					msg: d,
					newsletterJid: i,
					mediaHandle: p
	...
	l.sendNewsletterStatusTextMsgAction = d, l.sendNewsletterStatusMediaMsgAction = p;
}), 98);
