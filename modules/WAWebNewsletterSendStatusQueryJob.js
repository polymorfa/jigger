	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var t = {
				...
				clientPostNewsletterStatusAndServerOrPostNewsletterStatusIDMixinGroupArgs: u(e)
			}, n = yield o("WASmaxStatusPublishPostNewsletterStatusRPC").sendPostNewsletterStatusRPC(t);
			switch (n.name) {
