__d("WAWebNewsletterSendViewReceiptJob", [
	"WABatcher",
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			var a, i = (a = e.get(t)) != null ? a : o("WABatcher").createSimpleBatcher({ delayMs: s }, (function() {
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			return o("WAWebOrchestratorNonPersistedJob").createNonPersistedJob("sendNewsletterViewReceipt", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				}), yield o("WAWebNewsletterDBUtils").updateMsgViewReceipt(t.map(function(e) {
					return e.itemId;
				}));
