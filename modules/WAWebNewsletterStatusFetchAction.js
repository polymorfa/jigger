__d("WAWebNewsletterStatusFetchAction", [
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			if (t.length !== 0) try {
				var r = yield o("WAWebNewsletterDBUtils").bulkGetMessagesByServerIds(t.map(function(e) {
					return e.serverId;
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (n != null) {
				...
				if (a.size !== 0) try {
					var u = yield o("WAWebDBGetReactions").getAllReactionsFromParentMsgs(Array.from(a.keys())), c = u.filter(function(e) {
					...
					yield o("WAWebDBCreateOrUpdateReactions").createOrUpdateReactions(c.map(function(e) {
						return {
							parentMsgKey: e,
							senderUserJid: m,
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				var a, i, l = yield o("WAWebNewsletterGetStatusesJob").getNewsletterStatuses(e, n, {}), s = l.from, d = l.msgs, p = l.reactionCounts, _ = l.revokedServerIds, f = l.viewCounts;
				if (o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose([
					"[newsletter][status] fetched ",
					" statuses for ",
					""
				])), String(d.length), e), yield L(s, _ != null ? _ : []), d.length === 0) return x(s, e);
				yield k({
					from: s,
					msgs: d,
					viewCounts: f,
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			yield o("WAWebNewsletterStatusProcessingUtils").addAndPersistStatusMessages(t, r);
			...
			if (i.size > 0 ? (yield o("WAWebNewsletterBackendAddOnsUtils").persistNewsletterStatusInteractions({
				ids: l,
				reactionIdsToRemove: u,
				reactions: c,
				timestamp: Date.now(),
				viewCounts: i
			}), o("WAWebNewsletterStatusProcessingUtils").updateStatusViewCounts(t, r, i), yield o("WAWebNewsletterBridgeMsgAddOnsUtils").updateReactions({
				ids: l,
				reactionIdsToRemove: u,
				reactions: c
	...
	function D() {
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var n = yield o("WAWebNewsletterUpdateMsgsRecordsJob").getNewsletterMsgAckValues(t);
	...
	l.FetchResult = m, l.fetchNewsletterStatuses = _, l.fetchMyStatusReactions = g, l.hydrateMyStatusReactions = y, l.reconcileMyStatusReactions = b;
}), 98);
