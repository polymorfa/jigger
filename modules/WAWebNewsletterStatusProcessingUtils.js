__d("WAWebNewsletterStatusProcessingUtils", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			...
			a != null && (a.isSyntheticFromMetadata = !1), yield (e || (e = n("Promise"))).all([o("WAWebNewsletterUpdateMsgsRecordsJob").addNewsletterMsgsRecords(r), d(t, r)]);
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r) {
			...
			if (a != null) {
				var i = f(a, t, n, r != null ? r : o("WATimeUtils").unixTime()), l = i.ids, s = i.reactionIdsToRemove, u = i.reactions, c = i.viewCounts;
				l.length !== 0 && (yield o("WAWebNewsletterBackendAddOnsUtils").persistNewsletterStatusInteractions({
					ids: l,
					reactionIdsToRemove: s,
					reactions: u,
					timestamp: Date.now(),
					viewCounts: c
				}), n != null && (yield o("WAWebNewsletterBridgeMsgAddOnsUtils").updateReactions({
					ids: l,
					reactionIdsToRemove: s,
					reactions: u
				})));
	...
	l.syncFilledStatusCursor = s, l.syncStatusMetadata = u, l.computeMaxServerId = c, l.addAndPersistStatusMessages = m, l.updateStatusViewCounts = _, l.applyAndPersistInteractions = g, l.prepareReactionsForPersist = y, l.updateStatusUnreadCount = C;
}), 98);
