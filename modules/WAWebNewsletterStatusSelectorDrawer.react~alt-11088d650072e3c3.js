__d("WAWebNewsletterStatusSelectorDrawer.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = e.onClose, n = e.onNewsletterSelected, a = e.selectedNewsletterWid, i = o("WAWebNewsletterStatusPostingUtils").getStatusPostableNewsletters(), l = function(r) {
			n(r), t();
		};
		return u.jsx(o("WAWebModal.react").Modal, {
			type: o("WAWebModal.react").ModalTheme.Tower,
			children: u.jsxs(r("WAWebDrawer.react"), {
				testid: "newsletter-status-selector-drawer",
				children: [u.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
					...
					children: u.jsx("div", {
						...
						children: i.map(function(e) {
							var t, n, i = o("WAWebWidFactory").asNewsletterWidOrThrow(e.id), s = (t = (n = e.newsletterMetadata) == null ? void 0 : n.name) != null ? t : e.formattedTitle;
