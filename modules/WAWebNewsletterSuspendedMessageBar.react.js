__d("WAWebNewsletterSuspendedMessageBar.react", [
	"WAWebButton.react",
	...
	function c(e) {
		...
		t[0] !== n ? (a = function() {
			o("WAWebDrawerManager").DrawerManager.openDrawerRight(s.jsx(r("WAWebNewsletterDeleteDrawer.react"), {
				chat: n,
				onCancel: o("WAWebDrawerManager").closeDrawerRight
			}));
		}, t[0] = n, t[1] = a) : a = t[1];
		var i = a, l;
		t[2] === Symbol.for("react.memo_cache_sentinel") ? (l = o("WAWebCommonNewsletterStrings").getDeleteChannelText(), t[2] = l) : l = t[2];
		var u;
		if (t[3] !== i) {
