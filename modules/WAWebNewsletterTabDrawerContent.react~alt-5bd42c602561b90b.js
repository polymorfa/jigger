__d("WAWebNewsletterTabDrawerContent.react", [
	...
	function C(e) {
		var t = e.children;
		return o("WAWebTimeSpentLoggingNavigation").useTsNavigation({ surface: "channel-updates-home" }), t;
	}
	C.displayName = C.name + " [from " + i.id + "]";
	function b(e) {
		var t = e.children;
		return o("WAWebTimeSpentLoggingNavigation").useTsNavigation({ surface: "channel-updates-home-search" }), t;
	}
