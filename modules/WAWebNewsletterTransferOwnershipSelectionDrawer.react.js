__d("WAWebNewsletterTransferOwnershipSelectionDrawer.react", [
	...
	function h(e) {
		var t = o("react-compiler-runtime").c(4), n = e.chat, r, a;
		...
		var i;
		return t[2] !== n ? (i = c.jsx(o("WAWebEmptyState.react").EmptyErrorStateWithButton, {
			xstyle: f.marginTop20,
			center: !1,
			text: r,
			buttonText: a,
			onClick: function() {
				o("WAWebNewsletterAdminSelectionFlow.react").startAdminInviteFlow({ chat: n });
			},
