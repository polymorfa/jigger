__d("WAWebNoteCollection", ["WAWebBaseCollection", "WAWebNoteModel"], (function(t, n, r, o, a, i, l) {
	var e = (function(e) {
		function t() {
			var t;
		...
		var n = t.prototype;
		return n.maybeGetNoteByChatJid = function(t) {
			...
			this.queriedChatJids.add(t), n != null && this.add(new (o("WAWebNoteModel")).Note(n), { merge: !0 });
