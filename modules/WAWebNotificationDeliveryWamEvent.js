__d("WAWebNotificationDeliveryWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ NotificationDelivery: [
		3748,
		{
			...
			notificationAction: [2, o("WAWebWamEnumNotificationActionType").NOTIFICATION_ACTION_TYPE],
			notificationDeliveryT: [3, e.TYPES.INTEGER],
			notificationDestination: [4, o("WAWebWamEnumNotificationDestinationType").NOTIFICATION_DESTINATION_TYPE],
			notificationId: [5, e.TYPES.STRING],
			notificationSource: [6, o("WAWebWamEnumNotificationSourceType").NOTIFICATION_SOURCE_TYPE],
			peripheralDeviceOrigin: [9, o("WAWebWamEnumPeripheralDeviceType").PERIPHERAL_DEVICE_TYPE],
			...
			uiNotificationType: [8, o("WAWebWamEnumNotificationTypeEnum").NOTIFICATION_TYPE_ENUM]
		},
		[
			1,
			1,
