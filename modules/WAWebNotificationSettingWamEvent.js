__d("WAWebNotificationSettingWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumInAppNotificationAlertStyle",
	"WAWebWamEnumNotificationSoundTone",
	"WAWebWamEnumUnreadBadgeSettingType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ NotificationSetting: [
		3684,
		{
			groupReactionNotification: [1, e.TYPES.BOOLEAN],
			groupShowNotification: [2, e.TYPES.BOOLEAN],
			groupSoundTone: [3, o("WAWebWamEnumNotificationSoundTone").NOTIFICATION_SOUND_TONE],
			inAppNotificationAlertStyle: [4, o("WAWebWamEnumInAppNotificationAlertStyle").IN_APP_NOTIFICATION_ALERT_STYLE],
			...
			messageSoundTone: [9, o("WAWebWamEnumNotificationSoundTone").NOTIFICATION_SOUND_TONE],
			...
			statusSoundTone: [17, o("WAWebWamEnumNotificationSoundTone").NOTIFICATION_SOUND_TONE],
			unreadBadgeSetting: [13, o("WAWebWamEnumUnreadBadgeSettingType").UNREAD_BADGE_SETTING_TYPE]
		},
		[
			1,
			1,
