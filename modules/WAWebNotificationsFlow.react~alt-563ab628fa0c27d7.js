__d("WAWebNotificationsFlow.react", [
	...
	function c(e) {
		var t = e.onEnd, n = o("useWAWebFlow").useFlow(u.Notifications, {
			transitions: o("useWAWebFlow").FlowTransitions.DrawerRight,
			onEnd: t
		}), a = n[0], i = n[1], l = r("useWAWebFocusOnMount")();
		...
		switch (i.step) {
			...
			case u.DirectMessages:
				d = s.jsx(r("WAWebDirectMessagesNotificationsDrawer.react"), { onClose: c });
				break;
			case u.GroupMessages:
				d = s.jsx(r("WAWebGroupMessagesNotificationsDrawer.react"), { onClose: c });
				break;
			case u.StatusUpdates:
				d = s.jsx(r("WAWebStatusUpdatesNotificationsDrawer.react"), { onClose: c });
				break;
			case u.Calls:
	...
	c.displayName = c.name + " [from " + i.id + "]", l.NotificationsFlow = c;
}), 98);
