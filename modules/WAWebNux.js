__d("WAWebNux", ["$InternalEnum"], (function(t, n, r, o, a, i) {
	var e = {
		...
		MESSAGE_LABEL_DEPRECATION_MIGRATED_PERMANENT: "message_label_deprecation_migrated_permanent",
		...
		NEWSLETTER_QUESTIONS_RESPONSE_PRIVACY_BANNER: "newsletter_questions_response_privacy_banner",
		NEWSLETTER_QUESTIONS_PRIVACY_BANNER: "newsletter_questions_privacy_banner",
		BUSINESS_BROADCAST_AUDIENCE_UPLOAD: "business_broadcast_audience_upload",
		NOTIFICATION_GRANULARITY_AWARENESS_BANNER: "notification_granularity_awareness_banner",
		...
		NEWSLETTER_ADMIN_NOTIFICATION_SETTINGS_BANNER: "newsletter_admin_notification_settings_banner",
		BUSINESS_BROADCAST_CHAT_LIST_UPSELL: "business_broadcast_chat_list_upsell",
	...
	var f = n("$InternalEnum")({
		...
		TOOLTIP_STATUS_ENTRY_POINT: "tooltip_status_entry_point",
		STATUS_PRIVATE_MENTIONS: "status_private_mentions",
		MESSAGE_LABEL_DEPRECATION_MIGRATED: "message_label_deprecation_migrated",
		ADD_TO_LISTS: "add_to_lists",
		WEB_UI_REFRESH: "web_ui_refresh",
		DO_AUTOMATIC_LABEL: "do_automatic_label",
		...
		COOL_OFF_NUX: {
			...
			MESSAGE_LABEL_DEPRECATION_MIGRATED_CHAT_LIST: "message_label_deprecation_migrated_chat_list",
			WHATS_NEW: "whats_new"
		},
		VIEW_COUNT_NUX: {
			SAFARI_LIMITED_SUPPORT: "safari_limited_support",
		...
		MESSAGE_LABEL_DEPRECATION_MIGRATED_CHAT_LIST: "message_label_deprecation_migrated_chat_list_key",
		WHATS_NEW: "whats_new_cool_off_key"
	};
	function y(e) {
		return e + "_cool_off";
	}
	i.NUX = e, i.getCommunityAdminPromotionNuxKey = l, i.isCommunityAdminPromotionNuxKey = s, i.getChatAutoMutedNuxKey = u, i.isChatAutoMutedNuxKey = c, i.getMembershipApprovalRequestsBannerNuxKey = d, i.getNewsletterAlertsBannerNuxKey = m, i.getSubgroupSuggestionsBannerNuxKey = p, i.getAILabelBannerNuxKey = _, i.NuxSyncKey = f, i.NuxKeyTypes = g, i.CoolOffPeriodKeys = h, i.asCoolOffNuxType = y;
}), 66);
