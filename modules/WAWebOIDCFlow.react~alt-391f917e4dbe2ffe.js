__d("WAWebOIDCFlow.react", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				var l = yield r("WAWebFetchOIDCState")(), u = r("WAWebEnvironment").getSubPlatform() === "win_hybrid", d = window.location.origin + (u ? "/oidc_callback/hybrid/" : "/oidc_callback/"), m = new (e || (e = (r("URI"))))(i);
				m.addQueryData({
					app_id: a,
					redirect_uri: d,
					response_type: "code",
	...
	function _(e) {
		...
		return d(function() {
			...
			var e = function(n) {
				var e = n.code, r = n.state;
				o("WAWebOIDCExchangeToken").exchangeOIDCToken(e, r, t);
			};
	...
	_.displayName = _.name + " [from " + i.id + "]", l.launchOIDCFlow = m, l.OIDCEventListener = _;
}), 226);
