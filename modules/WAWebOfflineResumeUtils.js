__d("WAWebOfflineResumeUtils", [
	...
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b = (e = n("cr:37442")) != null ? e : {}, v = b.reconcileMetaAiUnreadCounts, S = {
		MIN_MESSAGE: 20,
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			e.push(o("WAWebMessageReceiptBatcher").receiptBatcher.runActiveBatches()), yield (C || (C = n("Promise"))).all(e);
		}), L.apply(this, arguments);
	}
	function E() {
		return r("WAWebNetworkStatus").online ? o("WAPromiseLoop").promiseLoop((function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				...
				try {
					return yield o("WAWebClearDanglingReceipts").clearDanglingReceipts(), o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["[offline-resume][utils] runReceiptCleanUpLoop: done."]))), e();
				} catch (t) {
		...
		})()) : (o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[offline-resume][utils] runReceiptCleanUpLoop: offline skip"]))), (C || (C = n("Promise"))).resolve());
	}
	function k() {
		var e;
		...
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			try {
				if (e.shouldUpdateReceipts === !0) {
					yield o("WAWebOffdStorageUpdateOfflinePeerReceipts").updatePeerReceipts();
					try {
				...
				yield o("WAWebWorkerSafeBackendApi").workerSafeSendAndReceive("restoreChatsAndMessages"), o("WAWebBlocklistMigration").applyBlocklistV2Rules() && (yield o("WAWebBackendApi").frontendSendAndReceive("restoreBlocklist"));
			} catch (e) {
				I("chats", e);
			}
	...
	function $() {
		return $ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var t = o("WAWebABProps").getABPropConfigValue("web_anr_async_contacts_restore_from_db_enabled"), r = o("WAWebWorkerSafeBackendApi").workerSafeSendAndReceive("restoreProfilePictures").catch(function(e) {
				I("profile-pictures", e);
			});
			if (t) yield (C || (C = n("Promise"))).all([T(e), r]), yield o("WAWebWorkerSafeBackendApi").workerSafeSendAndReceive("restoreGroupsAndContacts").catch(function(e) {
				I("groups-and-contacts", e);
			});
			else {
				var a = o("WAWebWorkerSafeBackendApi").workerSafeSendAndReceive("restoreGroupsAndContacts").catch(function(e) {
					I("groups-and-contacts", e);
				});
	...
	function N() {
		return N = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				yield o("WAWebPruneExpiredMessagesWithAddOns").pruneExpiredMessagesWithAddOns().catch(function(e) {
				...
				}), n("cr:11133") != null && n("cr:11133")() ? (yield o("WAWebDbEncryptionKey").DbEncKeyStore.waitForFinalDbMsgEncKey(), M(), yield x(e).catch(function(e) {
				...
				})) : (yield x(e), M()), o("WAWebBackendEventBus").BackendEventBus.triggerOfflineProcessReady(), o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose(["[offline-resume] loadMainScreen complete"])));
			} finally {
	...
	function w(e, t) {
		return e + t > S.MAX_STANZA || e > S.MIN_MESSAGE && e + t > S.LIMIT_WITH_MESSAGE;
	}
	l.clearOfflineSnapShot = R, l.runReceiptCleanUpLoop = E, l.refreshWindow = k, l.loadMainScreen = P, l.exceedResumeWithOpenTabLimit = w;
}), 98);
