__d("WAWebOfflineSimulatorMockSignal", [
	...
	var e, u = 1, c = (function() {
		...
		return a.init = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				(this.regId == null || !this.identityKeyPair || !this.signedPreKey) && (this.regId = yield r("WAWebCryptoLibraryUtilsApi").makeRegistrationId(), this.identityKeyPair = yield r("WAWebCryptoLibraryUtilsApi").makeKeyPair(), this.signedPreKey = o("WAWebSignalKeyApi").generateSignedKeyPair(this.identityKeyPair, 1));
			});
			function t() {
			...
			return this.identity = o("WAWebProtocolStoreCommonApi").stringifyIdentityKey(a), (e || (e = n("Promise"))).resolve();
			...
			return (e || (e = n("Promise"))).reject(r("err")("not implemented"));
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = yield o("WAWebSignalProtocolStore").getPersistSignalProtocolStore().getLocalRegistrationId(), n = yield o("WAWebSignalProtocolStore").getPersistSignalProtocolStore().getIdentityKeyPair(), r = yield o("WAWebSignalStoreApi").waSignalStore.getSignedPreKeyById(u);
			...
			var a = {
				...
				signedPreKey: {
					keyId: r.keyId,
					publicKey: o("WAWebCryptoCurve25519").toSignalCurvePubKey(r.keyPair.pubKey),
					signature: r.signature
				}
			}, i = d.get(e);
			i || (i = new c(), yield i.init(), d.set(e, i)), yield o("WAWebCryptoLibrarySessionApi").createSignalSession(a, o("WAWebUserPrefsMeUser").getMeDeviceLidOrThrow());
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = d.get(e);
			return n || (yield m(e), n = d.get(e)), n != null || s(0, 72600), o("WAWebCryptoLibrary").encryptSignalProto(o("WAWebUserPrefsMeUser").getMeDeviceLidOrThrow(), t);
