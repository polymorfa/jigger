__d("WAWebOfflineSimulatorNotification", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			e === void 0 && (e = 1);
			for (var t = yield o("WAWebModelStorageUtils").getStorage().lock(["contact"], function() {
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			e === void 0 && (e = 1);
			for (var t = yield o("WAWebModelStorageUtils").getStorage().lock(["group-metadata"], function(e) {
				var t = e[0];
				return t.all();
	...
	l.createGroupChangeNotifications = e, l.createGroupSubjectNotifications = c, l.createIdentityChangeNotification = d, l.createCommunityLinkNotification = p;
}), 98);
