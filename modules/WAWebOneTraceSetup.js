__d("WAWebOneTraceSetup", [
	...
	function s() {
		if (!e) {
			var t;
			e = !0, r("one-trace").setup({
				Image: { enableTracking: !1 },
				Longtask: { enableTracking: !1 },
				LoAF: {
					enableTracking: (t = r("gkx"))("18841"),
					enableLogging: function() {
						return o("LongAnimationFrameConfig").shouldLogLoAF("" + 0x97e965c4439a);
					},
					enableScriptPositionConversion: function() {
						return r("justknobx")._("5031");
					},
					config: o("LongAnimationFrameConfig").getLoAFAppConfig("" + 0x97e965c4439a)
				},
				INP: {
				...
				r("one-trace").addAnnotations(e.annotations, {
					string: {
						...
						encrypted_rid: o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.loadedUserPrefs != null ? o("WAWebEncryptedRid").getEncryptedRid() : ""
					},
	...
	function u(e) {
		...
		switch (e.traceType) {
			...
			case "SCROLL": return r("qpl")._(891431964, "3274");
			case "LONG_ANIMATION_FRAME": return ((t = e.annotations.bool) == null ? void 0 : t.isLoggingSample) === !0 ? r("qpl")._(891427004, "3275") : null;
			case "LONGTASK": return null;
			case "TYPING": return r("qpl")._(891422674, "918");
			case "RESPONSIVENESS": return null;
			case "INP": return r("qpl")._(891431786, "3252");
		}
		return null;
	}
	l.default = s;
