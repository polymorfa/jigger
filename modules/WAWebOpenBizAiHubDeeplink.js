__d("WAWebOpenBizAiHubDeeplink", [
	...
	var e, s = e || (e = o("react")), u = new Map([
		...
		["/lead-gen-collect-info", o("WAWebBizAIDrawerStep").BizAIStep.LeadGenList],
		["/purchase-info", o("WAWebBizAIDrawerStep").BizAIStep.PurchaseInfo],
		["/select-catalog", o("WAWebBizAIDrawerStep").BizAIStep.Bestsellers]
	]);
	function c(e) {
		if (!e.startsWith(o("WAWebBizAiHubDeeplinkScheme").BIZ_AI_HUB_DEEPLINK_SCHEME)) return null;
		var t = e.slice(o("WAWebBizAiHubDeeplinkScheme").BIZ_AI_HUB_DEEPLINK_SCHEME.length), n = t.indexOf("?");
	...
	function d(e) {
		...
		var n = u.get(t);
		return n == null || !o("WAWebChatAssignmentGatingUtils").isBizAIToolsSettingsEnabled() || !o("WAWebBizAiAgentStatusUtils").hasOnboardedAiAgent() ? !1 : (o("WAWebDrawerManager").DrawerManager.openDrawerRight(s.jsx(o("WAWebBizAIDrawerLoadable.react").WAWebBizAIDrawerLoadable, {
