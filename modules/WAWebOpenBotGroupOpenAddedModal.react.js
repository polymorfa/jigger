__d("WAWebOpenBotGroupOpenAddedModal.react", [
	...
	function m() {
		var t = o("react-compiler-runtime").c(15), n = p, a = r("useWAWebFocusOnMount")(), i;
		...
		var _;
		t[3] === Symbol.for("react.memo_cache_sentinel") ? (_ = [o("WDSMargins.stylex").wdsMargins.marginVerAuto, o("WDSPaddings.stylex").wdsPaddings.paddingBottom16], t[3] = _) : _ = t[3];
		var f;
		t[4] === Symbol.for("react.memo_cache_sentinel") ? (f = c.jsx(r("WAWebBox.react"), {
			xstyle: [
				d.headerText,
		...
		var g;
		t[5] === Symbol.for("react.memo_cache_sentinel") ? (g = (e || (e = r("stylex")))(o("WDSMargins.stylex").wdsMargins.marginHor8, o("WDSMargins.stylex").wdsMargins.marginVer16), t[5] = g) : g = t[5];
		var h;
		...
		var C;
		t[8] === Symbol.for("react.memo_cache_sentinel") ? (C = c.jsx(o("WAWebFlex.react").FlexRow, {
			className: g,
		...
		var v;
		t[10] === Symbol.for("react.memo_cache_sentinel") ? (v = [o("WDSPaddings.stylex").wdsPaddings.paddingHor8, d.sectionTitle], t[10] = v) : v = t[10];
		var S;
		t[11] === Symbol.for("react.memo_cache_sentinel") ? (S = c.jsx(o("WAWebText.react").WAWebTextTitle, { children: s._(
			/*BTDS*/
			""
		) }), t[11] = S) : S = t[11];
		var R;
		t[12] === Symbol.for("react.memo_cache_sentinel") ? (R = c.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "center",
			xstyle: _,
			children: [
				f,
				...
				c.jsx(o("WAWebFlex.react").FlexRow, {
					...
					children: c.jsxs(o("WAWebFlex.react").FlexItem, {
						xstyle: v,
						children: [S, c.jsx(o("WAWebText.react").WAWebTextMuted, { children: s._(
							/*BTDS*/
							""
						) })]
					})
		...
		var L;
		return t[13] !== a ? (L = c.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			okText: u,
			onOK: n,
			cancelText: m,
