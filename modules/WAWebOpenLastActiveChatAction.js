__d("WAWebOpenLastActiveChatAction", [
	"Promise",
	"WAWebBotGating",
	"WAWebBotUtils",
	"WAWebChatCollection",
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				var r = t != null ? o("WAWebChatCollection").ChatCollection.get(t) : null;
				return o("WAWebDrawerManager").DrawerManager.closeDrawerMid(), r != null && !r.isLocked ? o("WAWebBotUtils").isMetaAiBot(r.id) && o("WAWebBotGating").isAiChatThreadsEnabled() ? !1 : o("WAWebCmd").Cmd.openChatFromUnread({
					chat: r,
