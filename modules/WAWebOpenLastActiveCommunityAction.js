__d("WAWebOpenLastActiveCommunityAction", [
	"Promise",
	"WALogger",
	...
	var e, s, u, c = u || (u = o("react")), d = function() {
		return o("WAWebDrawerManager").DrawerManager.openDrawerMid(o("WAWebAdaptiveLayoutGatingUtils").shouldUseDrawerDescriptor() ? {
			descriptorType: "mid_drawer_empty_state",
			navBarItem: o("WAWebNavBarTypes").NavBarItems.Communities
		} : c.jsx(o("WAWebMidDrawerEmptyState.react").MidDrawerEmptyState, { type: o("WAWebNavBarTypes").NavBarItems.Communities }), {
			transition: "none",
		...
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				...
				switch (r.groupType) {
					...
					case o("WAWebGroupType").GroupType.LINKED_GENERAL_GROUP: return o("WAWebDrawerManager").DrawerManager.closeDrawerMid(), o("WAWebCmd").Cmd.openChatFromUnread({
						chat: r,
						chatEntryPoint: o("WAWebChatEntryPoint").ChatEntryPoint.CommunitiesTab
					});
					case o("WAWebGroupType").GroupType.DEFAULT: return o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["openLastActiveCommunity: non-community group"]))).sendLogs("open-last-active-community-error-not-a-community-group"), d();
				}
			} catch (e) {
