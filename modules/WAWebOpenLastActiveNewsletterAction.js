__d("WAWebOpenLastActiveNewsletterAction", [
	"Promise",
	...
	var e, s, u = s || (s = o("react")), c = function() {
		...
		o("WAWebDrawerManager").DrawerManager.openDrawerMid(o("WAWebAdaptiveLayoutGatingUtils").shouldUseDrawerDescriptor() ? {
			...
			navBarItem: e
		} : u.jsx(o("WAWebMidDrawerEmptyState.react").MidDrawerEmptyState, { type: e }), {
			transition: "none",
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var t = o("WAWebSideNavButtonsActivityModel").getLastActiveNewsletter();
			if (t == null) return c(), (e || (e = n("Promise"))).resolve(!1);
			try {
				var a = r("WAWebNewsletterCollection").get(t);
				return a == null ? (c(), (e || (e = n("Promise"))).resolve(!1)) : (o("WAWebDrawerManager").DrawerManager.closeDrawerMid(), o("WAWebCmd").Cmd.openChatFromUnread({
					chat: a,
					chatEntryPoint: o("WAWebSideNavButtonsActivityModel").getLastActiveNewsletterEntryPoint()
				}));
			} catch (t) {
