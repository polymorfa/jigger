__d("WAWebOpenLastActiveNewsletterAction", [
	...
	var e, s = e || (e = o("react")), u = function() {
		...
		o("WAWebDrawerManager").DrawerManager.openDrawerMid(o("WAWebAdaptiveLayoutGatingUtils").shouldUseDrawerDescriptor() ? {
			...
			navBarItem: e
		} : s.jsx(o("WAWebMidDrawerEmptyState.react").MidDrawerEmptyState, { type: e }), {
			transition: "none",
	...
	async function c() {
		...
		try {
			...
			return t == null ? (u(), Promise.resolve(!1)) : (o("WAWebDrawerManager").DrawerManager.closeDrawerMid(), o("WAWebCmd").Cmd.openChatFromUnread({
				chat: t,
