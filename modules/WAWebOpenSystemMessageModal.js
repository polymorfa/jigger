__d("WAWebOpenSystemMessageModal", [
	"fbt",
	...
	function c(e, t, n) {
		...
		n != null ? l = u.jsx(r("WAWebClickableLink.react"), {
			href: t,
			onClick: a,
			children: n
		}) : i = {
		...
		var c = u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			extraButtonProps: i,
			children: [e, l != null ? u.jsxs(u.Fragment, { children: ["\xA0", l] }) : null]
		});
