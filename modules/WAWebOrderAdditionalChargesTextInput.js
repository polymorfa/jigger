__d("WAWebOrderAdditionalChargesTextInput", [
	...
	function d(e) {
		var t = e.currency, n = e.label, a = e.priceValue, i = e.setError, l = e.setSymbol, d = e.setText, m = e.symbol, p = e.testid, _ = e.text, f = c(function() {
			var e = o("WAWebOrderDetailErrorUtils").additionalChargeErrorHandler({
				currency: t,
		...
		return u.jsxs("div", {
			...
			children: [u.jsx(o("WAWebRichTextField.react").RichTextField, {
				...
				placeholder: s._(
					/*BTDS*/
					"",
					[s._param("input_label", n), s._param("currency_or_percentage", m)]
				),
				onChange: function(t) {
					return d(t.text);
				},
