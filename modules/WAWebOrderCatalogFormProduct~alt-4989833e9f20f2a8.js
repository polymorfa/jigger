__d("WAWebOrderCatalogFormProduct", [
	...
	function d(e) {
		var t = e.onProductSelectChange, n = e.product, o = e.productsSelection, a = Number(o.getVal(n)) || 0, i = c(!1), l = i[0], d = i[1];
		return u.jsx("div", {
			...
			children: u.jsx(r("WAWebProductCatalogListItem.react"), {
				product: n,
				detail: (l || o.isSelected(n)) && u.jsx(r("WAWebCommonQuantityControls.react"), {
					quantity: a,
					quantityTitle: s._(
						/*BTDS*/
						""
