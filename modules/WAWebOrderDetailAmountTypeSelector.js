__d("WAWebOrderDetailAmountTypeSelector", [
	"fbt",
	"WAWebCurrencyUtils",
	...
	function d(e) {
		var t = e.currency, n = e.onChange, a = e.value, i = o("WAWebCurrencyUtils").formatLocalSymbol(t), l = r("fbs")._(
			/*BTDS*/
			""
		), d = [{
			id: "percentage",
			label: s._(
				/*BTDS*/
				"",
				[s._param("percentage-symbol", o("WAWebOrderDetailMath").PERCENTAGE_SYMBOL)]
			),
