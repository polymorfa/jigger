__d("WAWebOrderDetailItems", [
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(27), n = e.currency, a = e.details, i = e.items, l = e.onAddItem, c = e.onDeleteItem, d = e.onItemQuantityChange, f = e.onPriceChange, h = e.priceMap, y = m(null), C = y[0], b = y[1], v;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (v = {}, t[0] = v) : v = t[0];
		var S = m(v), R = S[0], L = S[1], E;
		t[1] !== h ? (E = function(t) {
			return t.price != null ? o("WAWebOrderCatalogProductPrice").PriceStage.Readonly : (h == null ? void 0 : h[t.id]) != null ? o("WAWebOrderCatalogProductPrice").PriceStage.EditableFilled : o("WAWebOrderCatalogProductPrice").PriceStage.EditableBlank;
		}, t[1] = h, t[2] = E) : E = t[2];
		var k = E, I;
		t[3] === Symbol.for("react.memo_cache_sentinel") ? (I = function(t, n) {
			L(function(e) {
				var r;
		...
		var T = I, D = !!a, x;
		t[4] !== n || t[5] !== k || t[6] !== C || t[7] !== c || t[8] !== f || t[9] !== h || t[10] !== R ? (x = function(t, a) {
			var e, i;
			return u.jsxs("div", {
				...
				children: [u.jsx(o("WAWebOrderCatalogProductPrice").CatalogProductPrice, {
					...
					className: "xpcyujq",
					children: u.jsx(r("WAWebCartDeleteIcon.react"), { onClick: function(n) {
						n.stopPropagation(), _(function() {
							return c == null ? void 0 : c(a);
						}, t.name);
					} })
				})]
			});
		}, t[4] = n, t[5] = k, t[6] = C, t[7] = c, t[8] = f, t[9] = h, t[10] = R, t[11] = x) : x = t[11];
		var $ = x, P;
		t[12] !== l || t[13] !== D ? (P = !D && (o("WAWebOrderGatingUtils").orderDetailsFromCatalogEnabled() || o("WAWebOrderGatingUtils").orderDetailsCustomItemEnabled()) && u.jsx(r("WAWebOrderAddItem"), {
			title: s._(
				/*BTDS*/
				""
			),
		...
		}), t[12] = l, t[13] = D, t[14] = P) : P = t[14];
		var N;
		if (t[15] !== $ || t[16] !== i || t[17] !== d || t[18] !== D) {
			var M;
			t[20] !== $ || t[21] !== d || t[22] !== D ? (M = function(t, n) {
				var e, a, i = (e = (a = t.properties) == null ? void 0 : a.map(g)) != null ? e : [], l = s._(
					/*BTDS*/
					"",
					[s._param("item-quantity", t.quantity)]
				), c = u.jsxs(o("WAWebFlex.react").FlexColumn, { children: [D ? l : u.jsx(r("WAWebCommonQuantityControls.react"), {
					quantity: t.quantity,
			...
			}, t[20] = $, t[21] = d, t[22] = D, t[23] = M) : M = t[23], N = i.map(M), t[15] = $, t[16] = i, t[17] = d, t[18] = D, t[19] = N;
		} else N = t[19];
		var w;
		return t[24] !== P || t[25] !== N ? (w = u.jsxs(o("WAWebFlex.react").FlexColumn, {
			align: "stretch",
			xstyle: p.orderItemsContainer,
			children: [P, N]
		}), t[24] = P, t[25] = N, t[26] = w) : w = t[26], w;
	}
	function g(e) {
		var t = e[0], n = e[1];
