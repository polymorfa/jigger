__d("WAWebOrderDetailRadioButton.react", [
	...
	function c(e) {
		var t = e.checked, n = e.isCanceled, a = e.label, i = e.onClick, l = e.testid;
		return s.jsx(o("WAWebClickable.react").Clickable, {
			onClick: i,
			dataTestId: l != null ? l : "",
			children: s.jsxs(o("WAWebFlex.react").FlexRow, { children: [s.jsx(o("WAWebFlex.react").FlexColumn, {
