__d("WAWebOrderDetailSelector", [
	...
	var e, s, u = s || (s = o("react")), c = s, d = c.useRef, m = c.useState, p = { paddingTop13: {
		paddingTop: "x1d0ri9u",
		$$css: !0
	} }, _ = {
		chipButtonRTL: {
	...
	function f(t) {
		var n = t["aria-label"], a = t.defaultIndex, i = a === void 0 ? 0 : a, l = t.onChange, s = t.options, c = d(null), f = m(!1), g = f[0], h = f[1], y = m(i), C = y[0], b = y[1], v = s.map(function(t, n) {
			var a = t.id, i = t.label;
			return u.jsx(o("WAWebDropdownItem.react").DropdownItem, {
				testid: "mi-" + a,
				action: function() {
					l(t), b(n);
				},
				children: u.jsx("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props([
					_.option,
					...
					role: "button",
					"aria-label": i,
					children: n === C ? u.jsx(o("WAWebText_DONOTUSE.react").TextSpan, {
						weight: "bold",
						children: i
					}) : i
				}))
		...
		return u.jsxs("div", {
			ref: c,
			children: [u.jsx(r("WAWebChipButton.react"), {
			...
			}), g && c.current && u.jsx(o("WAWebUimUie.react").UIE, {
