__d("WAWebOrderStatusUpdateDrawer.react", [
	...
	function b(e) {
		var t = e.xstyle;
		return p.jsx("div", babelHelpers.extends({}, (d || (d = r("stylex"))).props(C.spacer, C.marginTop16, t)));
	}
	...
	function R(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, c), i = h(S), l = i[0], d = i[1], m = h(""), _ = m[0], R = m[1], L = g(function() {
			return o("WAWebOrderStatus").findOrderStatus(a.chat, a.orderInfo.referenceId);
		}, [a.chat, a.orderInfo.referenceId]), E = g(function() {
			return o("WAWebOrderPaymentStatus").findLastOrderPaymentStatusInfo(a.chat, a.orderInfo.referenceId);
		}, [a.chat, a.orderInfo.referenceId]), k = h(L), I = k[0], T = k[1], D = h((E == null ? void 0 : E.paymentStatus) === o("WAWebOrderPaymentStatus").OrderPaymentStatus.Captured), x = D[0], $ = D[1];
		f(function() {
			var e = function(t) {
				return d(t === o("WASmaxInBizSettingsEnums").ENUM_FALSE_NOTSET_TRUE.true);
			};
		...
		var P = a.chat, N = a.orderInfo, M = a.sellerJid, w = "no_method_confirmed", A = function() {
			var e, t, n = (e = (t = N.externalPaymentConfigurations) == null || (t = t.at(0)) == null ? void 0 : t.type) != null ? e : w;
		...
		function F(e, t, n, r) {
			o("WAWebDrawerManager").DrawerManager.closeDrawerRight(), e && (B({
				nextOrderStatus: n,
				nextPaymentState: r,
				shouldIncludeNote: !t
		...
		function O(t, n) {
			var i = o("WAWebUserPrefsMeUser").getMeUserOrThrow(), s = o("WAWebBusinessProfileUtils").hasCatalog(o("WAWebBusinessProfileCollection").BusinessProfileCollection.get(i));
			new (o("WAWebOrderDetailsActionsSmbWamEvent")).OrderDetailsActionsSmbWamEvent({
				actionCategory: String(r("WAWebOrderDetailsActionCategory").ORDER_DETAILS_MANAGEMENT),
				hasCatalog: s,
				hasNote: !!_,
				...
				o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Error sending order status in chat"]))).verbose();
			}), o("WAWebSmbMarkAsXOrderAction").markOrderAsUpdatedStatusAction(P, l, I, x), o("WAWebSmb3pdConversionSignalAction").log3pdConversionSignalForOrders({
				chat: P,
				orderStatus: I,
				paidData: {
					amount: String(N.totalAmount),
				...
				o("WALogger").ERROR(u || (u = babelHelpers.taggedTemplateLiteralLoose(["Error opening chat"]))).verbose();
			});
		}
		function B(e) {
			var t = e.nextOrderStatus, n = e.nextPaymentState, r = e.shouldIncludeNote;
		...
		function q() {
			var e = W(I), t = W(L), n = (E == null ? void 0 : E.paymentStatus) === o("WAWebOrderPaymentStatus").OrderPaymentStatus.Captured, a = e !== t, i = n !== x, l = !a && !i, u = e < t, c = I, d = x;
			o("WAWebOrderGatingUtils").isOrderStatusM1Enabled() && (i && (x ? I === o("WAWebOrderStatus").OrderStatus.PaymentRequested && (c = o("WAWebOrderStatus").OrderStatus.PreparingToShip) : I === o("WAWebOrderStatus").OrderStatus.PreparingToShip && (c = o("WAWebOrderStatus").OrderStatus.PaymentRequested)), a && x && I === o("WAWebOrderStatus").OrderStatus.PaymentRequested && (d = !1)), l ? o("WAWebModalManager").ModalManager.open(p.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
				title: s._(
					/*BTDS*/
					""
				),
				...
				children: o("WAWebOrderGatingUtils").isOrderContentOptimizationEnabled() ? s._(
					/*BTDS*/
					"",
					[s._param("originalOrderStatus", o("WAWebBizOrderStatusLabels").getWAWebBizOrderStatusLabel(L))]
				) : s._(
					/*BTDS*/
					"",
					[s._param("originalOrderStatus", o("WAWebBizOrderStatusLabels").getWAWebBizOrderStatusLabel(L))]
				...
				onOK: function() {
					F(i, a, c, d), o("WAWebModalManager").closeModalManager();
				},
				cancelText: s._(
					/*BTDS*/
					""
				...
				children: o("WAWebOrderGatingUtils").isOrderContentOptimizationEnabled() ? s._(
					/*BTDS*/
					"",
					[s._param("originalOrderStatus", o("WAWebBizOrderStatusLabels").getWAWebBizOrderStatusLabel(L)), s._param("orderStatus", o("WAWebBizOrderStatusLabels").getWAWebBizOrderStatusLabel(I))]
				) : s._(
					/*BTDS*/
					"",
					[s._param("originalOrderStatus", o("WAWebBizOrderStatusLabels").getWAWebBizOrderStatusLabel(L)), s._param("orderStatus", o("WAWebBizOrderStatusLabels").getWAWebBizOrderStatusLabel(I))]
		...
		var U = s._(
			...
			var e = !x;
			$(e), e && I === o("WAWebOrderStatus").OrderStatus.PaymentRequested && T(o("WAWebOrderStatus").OrderStatus.PreparingToShip);
		};
		return p.jsxs(r("WAWebDrawer.react"), {
			...
			}), p.jsx(r("WAWebDrawerBody.react"), { children: p.jsxs(r("WAWebDrawerSection.react"), { children: [
				o("WAWebOrdersExpansionUtils").isOrderExpansionEnabled() && p.jsxs(p.Fragment, { children: [p.jsxs(o("WAWebFlex.react").FlexRow, {
					align: "center",
					...
					children: p.jsx(o("WAWebFlex.react").FlexColumn, {
						...
						children: y.map(function(e) {
							return p.jsx(r("WAWebOrderDetailRadioButton.react"), {
								...
								checked: I === e,
								onClick: function() {
									T(e), e === o("WAWebOrderStatus").OrderStatus.PaymentRequested && x && $(!1);
								}
							}, e);
						})
					})
