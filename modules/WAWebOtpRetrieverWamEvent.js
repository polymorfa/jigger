__d("WAWebOtpRetrieverWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ OtpRetriever: [
		3468,
		{
			...
			chatsFolderType: [12, o("WAWebWamEnumChatsFolderType").CHATS_FOLDER_TYPE],
			ctaFallbackReason: [2, o("WAWebWamEnumCtaFallbackReason").CTA_FALLBACK_REASON],
			...
			otpEventSource: [5, o("WAWebWamEnumOtpEventSource").OTP_EVENT_SOURCE],
			...
			otpProductType: [7, o("WAWebWamEnumOtpProductType").OTP_PRODUCT_TYPE],
