__d("WAWebOutContactPillItem.react", [
	...
	function d(e) {
		var t = e.onDelete, n = e.outContact, a = o("useWAWebOutContactValues").useWAWebOutContactValues(n.id, [o("WAWebOutContactGetters").getName]), i = a[0];
		return u.jsx(r("WAWebChatCell.react"), {
			...
			detail: u.jsx(r("WDSTooltip.react"), {
				...
				children: u.jsx(r("WAWebUnstyledButton.react"), {
					dataTab: 2,
					xstyle: [o("WDSFocusStateStyles").WDSFocusStateStyles.genericFocus, c.outContactDeleteButton],
					role: "button",
					onClick: function(r) {
					...
					children: u.jsx(r("WDSIconIcClose.react"), { "aria-hidden": !0 })
				}, "chat-controls")
			}),
			idle: !0
		}, n.id.toString());
