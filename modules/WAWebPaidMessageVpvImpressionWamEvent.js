__d("WAWebPaidMessageVpvImpressionWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ PaidMessageVpvImpression: [
		7652,
		{
			bodyUrlCountInt: [1, e.TYPES.INTEGER],
			bodyUrlUniqueCountInt: [2, e.TYPES.INTEGER],
			buttonValueJsonArray: [3, e.TYPES.STRING],
			chatsFolderType: [4, o("WAWebWamEnumChatsFolderType").CHATS_FOLDER_TYPE],
			...
			messageBodyType: [25, o("WAWebWamEnumMessageBodyTypeEnum").MESSAGE_BODY_TYPE_ENUM],
