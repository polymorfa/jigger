__d("WAWebParseImageMessageProto", [
	"WALongInt",
	"WATimeUtils",
	...
	function e(e) {
		var t = e.baseMessage, n = e.messageAssociation, r = e.messageProtobuf, a = e.msgContext, i = e.msgMeta, l = r.imageMessage;
		if (l != null) {
			if (o("WAWebMediaProtoUtils").isEmptyImageMessage(l) && o("WAWebBotBaseGating").isLoadingMediaMessagesEnabled(t)) return {
			...
			var s = l.annotations, u = l.caption, c = l.contextInfo, d = l.directPath, m = l.height, p = l.jpegThumbnail, _ = l.mediaKeyTimestamp, f = l.mimetype, g = l.scanLengths, h = l.scansSidecar, y = l.staticUrl, C = l.thumbnailDirectPath, b = l.thumbnailEncSha256, v = l.thumbnailSha256, S = l.viewOnce, R = l.width, L = o("WAWebMediaMessageGetValidatedProperties").getValidatedMediaMessageProperties(l, t, a, o("WAWebMsgType").MSG_TYPE.IMAGE), E = L.fileEncSha256, k = L.fileLength, I = L.fileSha256, T = L.mediaKey, D = L.url, x = babelHelpers.extends({}, t, {
				...
				staticUrl: y || "",
				mimetype: f || "",
				caption: o("WAWebE2EProtoUtils").convertToTextWithoutSpecialEmojis(u),
				...
				mediaKeyTimestamp: _ != null ? o("WALongInt").numberOrThrowIfTooLarge(_) : o("WATimeUtils").unixTime(),
			...
			if (o("WAWebE2EProtoParserApi").validateRequiredMediaProperties(x, l), n && o("WAWebMessageAssociationGatingUtils").isMessageAssociationInfraEnabled()) {
				var $ = o("WAWebAssociationProtoUtils").getValidatedAssociationFieldsFromProto(n, t, a), P = $.associationParentMsgKey, N = $.associationType, M = $.viewMode;
				if (N === o("WAWebMessageAssociation.flow").MessageAssociationType.MEDIA_POLL && !o("WAWebIsPhotoPollReceiverEnabled").isPhotoPollReceiverEnabled(t)) return {
					msgData: babelHelpers.extends({}, t, {
				...
				if (N === o("WAWebMessageAssociation.flow").MessageAssociationType.MEDIA_ALBUM && !o("WAWebIsAlbumV2ReceiverEnabled").isAlbumV2MsgReceiverEnabled(t)) return {
					msgData: babelHelpers.extends({}, t, {
						type: o("WAWebMsgType").MSG_TYPE.UNKNOWN,
						kind: o("WAWebMsgType").MsgKind.Unknown,
						futureproofType: o("WAWebMsgType").MSG_TYPE.IMAGE,
