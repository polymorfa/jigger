__d("WAWebParseLocationMessageProto", [
	"WALongInt",
	...
	function e(e, t) {
		var n, r, a = ((n = e.name) != null ? n : "") || ((r = e.address) != null ? r : "");
		e.name != null && e.name !== "" && e.address != null && e.address !== "" && (a = e.name + "\n" + e.address);
		var i = e.degreesLatitude !== void 0 ? e.degreesLatitude : void 0, l = e.degreesLongitude !== void 0 ? e.degreesLongitude : void 0, s = babelHelpers.extends({}, t, {
	...
	function s(e, t, n) {
		...
		n && (r = {
			...
			finalThumbnail: o("WAWebE2EProtoParserApi").decodeBytes(n.jpegThumbnail) || "",
		...
		var a = babelHelpers.extends({}, t, r, {
			...
			comment: o("WAWebE2EProtoUtils").convertToTextWithoutSpecialEmojis(e.caption),
	...
	function u(t) {
		var n = t.baseMessage, r = t.finalLocation, o = t.messageProtobuf, a = o.liveLocationMessage, i = o.locationMessage, l = null;
