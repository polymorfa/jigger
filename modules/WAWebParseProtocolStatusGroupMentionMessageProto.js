__d("WAWebParseProtocolStatusGroupMentionMessageProto", [
	"WAWebBatchedStatusIdUtils",
	"WAWebMsgType",
	"WAWebStatusGatingUtils"
], (function(t, n, r, o, a, i, l) {
	function e(e) {
		var t = e.baseMessage, n = e.messageProtobuf, r = e.msgContext, a = n.groupStatusMentionMessage;
		if (!(a == null || (a == null ? void 0 : a.message) == null)) {
			if (o("WAWebStatusGatingUtils").isStatusMentionMessageEnabled()) {
				var i, l = a.message, s = l == null || (i = l.protocolMessage) == null ? void 0 : i.key, u = s == null ? void 0 : s.id;
				return {
					...
					contextInfo: {
						stanzaId: u != null ? o("WAWebBatchedStatusIdUtils").normalizeStatusStanzaId(u) : u,
						mentionedJid: [],
						groupMentions: [],
						statusAttributions: []
					}
