__d("WAWebParseVideoMessageProto", [
	"WALongInt",
	"WATimeUtils",
	...
	function e(e) {
		var t = e.baseMessage, n = e.messageAssociation, r = e.messageProtobuf, a = e.msgContext, i = e.msgMeta, l = r.videoMessage;
		if (l != null) {
			if (o("WAWebMediaProtoUtils").isEmptyVideoMessage(l) && o("WAWebBotBaseGating").isLoadingMediaMessagesEnabled(t)) return {
			...
			var s = l.accessibilityLabel, u = l.annotations, c = l.caption, d = l.contextInfo, m = l.directPath, p = l.gifAttribution, _ = l.gifPlayback, f = l.height, g = l.interactiveAnnotations, h = l.jpegThumbnail, y = l.mediaKeyTimestamp, C = l.mimetype, b = l.seconds, v = l.staticUrl, S = l.streamingSidecar, R = l.thumbnailDirectPath, L = l.thumbnailEncSha256, E = l.thumbnailSha256, k = l.viewOnce, I = l.width, T = o("WAWebMediaMessageGetValidatedProperties").getValidatedMediaMessageProperties(l, t, a, o("WAWebMsgType").MSG_TYPE.VIDEO), D = T.fileEncSha256, x = T.fileLength, $ = T.fileSha256, P = T.mediaKey, N = T.url, M = babelHelpers.extends({}, t, {
				...
				staticUrl: v || "",
				mimetype: C,
				caption: o("WAWebE2EProtoUtils").convertToTextWithoutSpecialEmojis(c),
				...
				mediaKeyTimestamp: y != null ? o("WALongInt").numberOrThrowIfTooLarge(y) : o("WATimeUtils").unixTime(),
				duration: "" + (b || 0),
			...
			if (o("WAWebE2EProtoParserApi").validateRequiredMediaProperties(M, l), n && o("WAWebMessageAssociationGatingUtils").isMessageAssociationInfraEnabled()) {
				var w = o("WAWebAssociationProtoUtils").getValidatedAssociationFieldsFromProto(n, t, a), A = w.associationParentMsgKey, F = w.associationType, O = w.viewMode;
				if (F === o("WAWebMessageAssociation.flow").MessageAssociationType.MEDIA_ALBUM && !o("WAWebIsAlbumV2ReceiverEnabled").isAlbumV2MsgReceiverEnabled(t)) return {
					msgData: babelHelpers.extends({}, t, {
