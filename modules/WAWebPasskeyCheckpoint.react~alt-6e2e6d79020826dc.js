__d("WAWebPasskeyCheckpoint.react", [
	...
	function _(e) {
		var t = e.onLogout, n = e.onPasskeyComplete, a = e.onPasskeyError, i = e.passkeyChallenge, l = m("idle"), c = l[0], _ = l[1], f = d(function() {
			_("pending"), (async function() {
				try {
					var e = await o("WAWebIntegrityChallengeUtils").performPasskeyAssertion(i);
					_("success"), await n(e);
				} catch (e) {
