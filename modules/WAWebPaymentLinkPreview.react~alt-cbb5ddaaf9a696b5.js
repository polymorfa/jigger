__d("WAWebPaymentLinkPreview.react", [
	...
	function m(e) {
		var t = e.isLoading, n = e.previewMetadata, a = e.title, i = e.urlElement, l = null, c = null, m = o("WAWebPaymentLinkPreviewWithAmountFeature").computeAmount1000(n.amount, n.offset, n.currency);
		if (m != null) {
			var p = o("WAWebCurrencyUtils").formatAmount1000ToParts(m.currency, m.amount1000), _ = p.integer.replace(/\D/g, ""), f = p.decimal.replace(/\D/g, ""), g = _.length + f.length;
			g <= u ? l = s.jsx(o("WAWebFlex.react").FlexRow, {
				shrink: 0,
		...
		return s.jsxs(o("WAWebFlex.react").FlexRow, {
			...
			children: [
				s.jsxs(o("WAWebFlex.react").FlexColumn, {
					xstyle: d.body,
					children: [
						!t && a != null && s.jsx(o("WAWebFlex.react").FlexRow, {
							xstyle: d.title,
							children: a
						}),
						!t && c,
