__d("WAWebPaymentRequestMsgAction", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = new (o("WAWebMsgCollection")).MsgCollection.constructor.model(e), n = yield o("WAWebDBProcessPaymentMessages").processPaymentMessages([t]);
