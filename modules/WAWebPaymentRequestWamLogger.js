__d("WAWebPaymentRequestWamLogger", [
	...
	"use strict";
	var e, s, u, c = "pix", d = "payment_request", m = "payment_request_template_cta", p = "payment_request_text_cta", _ = "receiver_log_key", f = "buyer_order_fs_log", g = "individual", h = "group", y = "broadcast", C = "newsletter";
	function b(e) {
		return e === o("WAWebBrPaymentRequest").PaymentRequestCtaType.PIX_DYNAMIC_CODE ? c : e;
	}
	function v(e) {
	...
	function R(e) {
		var t, n, r;
		return ((t = e.from) == null ? void 0 : t.isGroup()) === !0 ? h : ((n = e.broadcastId) == null ? void 0 : n.isBroadcast()) === !0 ? y : ((r = e.from) == null ? void 0 : r.isNewsletter()) === !0 ? C : g;
	}
	function L(e) {
		var t;
	...
	function k() {
		return k = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = new (o("WAWebP2XFunnelIdGenerator")).P2XFunnelIdGenerator(e, t), r = yield n.genFunnelInfo(), a = r.funnel_id;
			return a;
	...
	function T() {
		return T = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.templateId != null, r = e.id.id + e.to.toJid(), a = yield E(_, r), i = yield E(a, f), l = {
				cta: d,
				p2m_flow: n ? m : p,
	...
	function x() {
		return x = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			yield (u || (u = n("Promise"))).all(e.map((function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					v(e) && (yield I(e).catch(function(e) {
						o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[WAM:PAYMENT_REQUEST] structured msg receive log err: ", ""])), e);
					}));
				});
				return function(t) {
	...
	function $(t, n, r) {
		...
		new (o("WAWebPsStructuredMessageInteractionWamEvent")).PsStructuredMessageInteractionWamEvent({
			...
			messageMediaType: o("WAWebWamEnumMediaType").MEDIA_TYPE.INTERACTIVE_NFM,
			bizPlatform: o("WAWebWamEnumBizPlatform").BIZ_PLATFORM.CLOUDAPI,
			businessOwnerJid: (a = t.senderObj) == null || (a = a.id) == null ? void 0 : a.user,
			messageClassAttributes: JSON.stringify(s),
			templateId: (i = t.templateId) != null ? i : void 0
		}).commit(), P(t, s).catch(function(t) {
			o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[WAM:PAYMENT_REQUEST] buyer interaction log err: ", ""])), t);
		});
	}
	function P(e, t) {
	...
	function N() {
		return N = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = e.id.id + e.to.toJid(), r = yield E(_, n), a = yield E(r, f);
	...
	l.logPaymentRequestReceivedWAMEvent = D, l.logPaymentRequestInteractionWAMEvent = $;
}), 98);
