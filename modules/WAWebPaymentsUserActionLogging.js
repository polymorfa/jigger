__d("WAWebPaymentsUserActionLogging", [
	"WALogger",
	...
	function c(t) {
		var n = {
			...
			screen: t.screen
		}, r = new (o("WAWebPaymentsUserActionWamEvent")).PaymentsUserActionWamEvent(n);
		o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Payments Log"]))), r.commit();
	}
	function d(e) {
		var t, n = {
		...
		o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["Payments Log"]))), r.commit();
	}
