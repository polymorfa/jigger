__d("WAWebPdfViewerAppConfig", [
	...
	"use strict";
	function e() {
		var e = o("WAWebUserPrefsGeneral").getSystemThemeMode(), t = o("WAWebUserPrefsGeneral").getTheme(), n = o("WAWebConnModel").Conn.isSMB;
		return e ? n ? "smbSystem" : "system" : t === "dark" ? n ? "smbDark" : "dark" : n ? "smbLight" : "light";
	}
	function s() {
		return {
			theme: e(),
			...
			useUpdatedPdfSharerConsentCopy: o("WAWebABProps").getABPropConfigValue("wa_webtp_pdf_sharer_consent_copy_v2")
		};
	}
