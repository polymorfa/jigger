__d("WAWebPerCustomerDataSharingUtils", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = (yield o("WAWebSchemaMessage").getMessageTable().between(["internalId"], o("WAWebDBMessageUtils").beginningOfChat(e), o("WAWebDBMessageUtils").endOfChat(e), { reverse: !0 })).filter(function(e) {
	...
	l.isPerCustomerDataSharingFeatureEnabled = u, l.getCurrentDataSharingState = c, l.getCustomerAdsDataSharingState = d, l.getLastDataSharingState = m, l.getModalForPerCustomerDataSharing = _;
}), 98);
