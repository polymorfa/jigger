__d("WAWebPersistBotProfiles", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			yield o("WAWebSchemaBotProfile").getBotProfileTable().bulkCreateOrMerge(t.map(function(t) {
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			yield o("WAWebSchemaBotProfile").getBotProfileTable().bulkCreateOrMerge([babelHelpers.extends({ id: e.toString() }, t)]), o("WAWebBotProfileCollection").BotProfileCollection.gadd(babelHelpers.extends({ id: e }, t));
		}), d.apply(this, arguments);
	}
	function m(e) {
		return o("WAWebBotProfileCollection").BotProfileCollection.get(e) != null;
	}
	l.persistBotProfiles = s, l.mergeBotSupportFields = c, l.isBotProfileCached = m;
}), 98);
