__d("WAWebPersistedJobManager", [
	...
	function m(e) {
		e.forEach(function(e) {
			e.step === o("WAPersistedJobManager").FINISHED_JOB || e.stepHardStartCountAfterTimeout >= o("WAPersistedJobManager").MAX_STEP_HARD_START_COUNT_AFTER_TIMEOUT || p(e.type);
		});
	}
	function p(e) {
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var r, a, i, l = o("WAWebSchemaJobs").getTable(), s = JSON.stringify([t.type, (r = t.uniqKey) != null ? r : o("WARandomHex").randomHex(32)]), u = {
				type: t.type,
				uniqKey: s,
				...
				waitUntil: (i = t == null ? void 0 : t.waitUntil) != null ? i : null,
				stepFirstStartTime: null,
				stepHardStartCountAfterTimeout: 0,
				stepUnexpectedErrorCount: 0,
				backedOffCount: 0
			};
			if (t.uniqKey == null) return l.createOrReplace(u).then(function(e) {
				return {
					id: e,
					newlyCreated: !0
				};
			...
			if (c.length === 0) return l.createOrReplace(u).then(function(e) {
				return {
					id: e,
					newlyCreated: !0
				};
			...
			var d = [], m = null;
			for (var p of c) p.step !== o("WAPersistedJobManager").FINISHED_JOB ? m = p : d.push(l.remove(p.jobId));
			return yield (e || (e = n("Promise"))).all(d), m != null ? {
				id: m.jobId,
				newlyCreated: !1
	...
	l.startWebPersistedJobManager = u, l.maybeCreateJob = f, l.getJobManager = h;
}), 98);
