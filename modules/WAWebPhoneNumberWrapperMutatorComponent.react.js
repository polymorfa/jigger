__d("WAWebPhoneNumberWrapperMutatorComponent.react", [
	...
	function p(t) {
		var a = t.fromMe, i = t.phoneNumber, l = t.selectable, u = d(null), p = u[0], _ = u[1], f = d(null), g = f[0], h = f[1], y = d(null), C = y[0], b = y[1], v = d(null), S = v[0], R = v[1];
		function L(t) {
			var r;
			C && C.isCached(i) ? r = C : (r = o("WAWebGetOrQueryUsyncInfoContactAction").usyncContactCached(), b(r));
			function a(e, t) {
			...
			function l() {
				return l = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
					try {
						...
						k(null, n), R(null), o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["handlePhoneClick getUsync failed with exceptions ", ""])), t).sendLogs("handlePhoneClick-getUsync");
					}
		...
		function k(e, t) {
			var n = [];
			if (e != null && e.wid) {
				var l = o("WAWebPhoneUtils").formatPhone(i);
				n.push(c.jsx(o("WAWebDropdownItem.react").DropdownItem, {
					testid: "mi-message-on-whatsapp",
					xstyle: m.menuItem,
					action: function(n) {
						return o("WAWebPhoneNumberContactAction").handleOpenChat(n, e.wid, a);
					},
			...
			n.push(c.jsx(o("WAWebDropdownItem.react").DropdownItem, {
				...
				xstyle: m.menuItem,
				action: function() {
					return o("WAWebPhoneNumberContactAction").handleCopyPhoneNumber(i, e == null ? void 0 : e.wid, a);
				},
			...
			}, "copy-phone-number")), h(null), _({
				menu: n,
				event: t
			}), R(e == null ? void 0 : e.wid), o("WAWebPhoneNumberContactAction").logClickOnPhoneNumber(e == null ? void 0 : e.wid, a);
		}
		var I = null, T = null;
		return p && (I = c.jsx(o("WAWebUimUie.react").UIE, {
			displayName: "ContextMenu",
			escapable: !0,
			popable: !0,
			dismissOnWindowResize: !0,
			requestDismiss: function() {
				_(null), o("WAWebPhoneNumberContactAction").logCloseDialog(S, a);
			},
			children: c.jsx(r("WAWebUimUieMenu.react"), { contextMenu: p })
		})), g && (T = c.jsx(o("WAWebUimUie.react").UIE, {
