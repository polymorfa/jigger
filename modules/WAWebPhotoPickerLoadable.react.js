	...
	function g(e) {
		...
		switch (e.type) {
			...
			case o("WAWebPhotoPickerConstants").PhotoPickerType.GENERAL_GROUP: {
				var n;
				return t[0] !== e ? (n = s.jsx(d, babelHelpers.extends({}, e, { testid: "group-pic-picker" })), t[0] = e, t[1] = n) : n = t[1], n;
			}
			case o("WAWebPhotoPickerConstants").PhotoPickerType.COMMUNITY: {
				var r;
				return t[2] !== e ? (r = s.jsx(m, babelHelpers.extends({}, e, { testid: "community-pic-picker" })), t[2] = e, t[3] = r) : r = t[3], r;
			}
			case o("WAWebPhotoPickerConstants").PhotoPickerType.PROFILE: {
				var a;
				return t[4] !== e ? (a = s.jsx(c, babelHelpers.extends({}, e, { testid: f })), t[4] = e, t[5] = a) : a = t[5], a;
			}
			case o("WAWebPhotoPickerConstants").PhotoPickerType.COVER_PHOTO: {
				var i;
				return t[6] !== e ? (i = s.jsx(p, babelHelpers.extends({}, e, { testid: _ })), t[6] = e, t[7] = i) : i = t[7], i;
			}
		}
	}
