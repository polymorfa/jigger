__d("WAWebPinInChatInteractionWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ PinInChatInteraction: [
		4436,
		{
			...
			pinInChatInteractionType: [7, o("WAWebWamEnumPinInChatInteractionType").PIN_IN_CHAT_INTERACTION_TYPE],
