__d("WAWebPinInChatMessageSendWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ PinInChatMessageSend: [
		4438,
		{
			groupRole: [1, o("WAWebWamEnumGroupRoleType").GROUP_ROLE_TYPE],
			groupTypeClient: [2, o("WAWebWamEnumGroupTypeClient").GROUP_TYPE_CLIENT],
			...
			pinInChatType: [6, o("WAWebWamEnumPinInChatType").PIN_IN_CHAT_TYPE],
