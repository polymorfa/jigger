__d("WAWebPinMsgParseWebMsgInfoPinInChat", [
	"WALogger",
	"WALongInt",
	...
	function c(t, n) {
		...
		try {
			...
			if (t.pinInChat != null && n.pinInChat != null) l.push(n.pinInChat);
				...
				for (var c of t.messageAddOns) if (c.messageAddOnType === o("WAWebProtobufsWeb.pb").MessageAddOn$MessageAddOnType.PIN_IN_CHAT) {
					var d, m = (d = c.messageAddOn) == null ? void 0 : d.pinInChatMessage;
					m != null && l.push({
						key: m.key,
			...
			for (var p of l) {
				var _ = p.key, f = p.messageAddOnContextInfo, g = p.senderTimestampMs, h = p.serverTimestampMs, y = p.type, C = r("nullthrows")(o("WAWebAddOnParseWebMsgInfo").buildAddonMsgKey({ key: r("nullthrows")(_) })), b = C.msgKey, v = C.sender;
				if (v == null) o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["parseWebMsgInfoPinInChat: pinInChat sender should be a wid."])));
				else {
					var S;
					a.push({
						msgKey: b,
						...
						senderTimestampMs: o("WALongInt").numberOrThrowIfTooLarge(r("nullthrows")(g)),
						t: (S = o("WAWebAddOnParseWebMsgInfo").getAddonServerTimestamp(h)) != null ? S : void 0,
						pinType: r("nullthrows")(y),
						sender: v,
						pinExpiryDuration: f == null ? void 0 : f.messageAddOnDurationInSecs
					});
				}
			}
		} catch (e) {
			...
			o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose([
				...
				" stack=",
				""
			])), R == null ? void 0 : R.name, R == null ? void 0 : R.stack);
		}
		return a;
	}
