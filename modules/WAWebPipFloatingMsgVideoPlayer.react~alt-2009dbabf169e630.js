__d("WAWebPipFloatingMsgVideoPlayer.react", [
	...
	function c(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = o("useWAWebModelValues").useModelValues(a.mediaData, ["preview", "aspectRatio"]), l = i.preview instanceof r("WAWebMediaOpaqueData") ? "url(" + i.preview.url() + ")" : void 0;
		return u.jsx(o("WAWebPipFloatingVideoPlayer.react").FloatingVideoPlayer, {
			ref: n,
			...
			children: u.jsx(o("WAWebPipMsgVideoPlayer.react").WrappedMsgVideoPlayer, {
				msg: a.msg,
				mediaData: i,
