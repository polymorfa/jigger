__d("WAWebPipVideoRefControls.react", ["WAWebPipVideoControls.react", "react"], (function(t, n, r, o, a, i, l) {
	var e = ["ref"], s, u = s || (s = o("react"));
	function c(t) {
		var n = t.ref, o = babelHelpers.objectWithoutPropertiesLoose(t, e), a = o.disableAudioControls, i = o.refVideo, l = function() {
			i == null || i.play();
		}, s = function() {
			i == null || i.pause();
		}, c = function(t) {
		...
		if (!p) return null;
		var _ = a === !0 ? 0 : p.volume, f = a === !0 ? !0 : p.muted;
		return u.jsx(r("WAWebPipVideoControls.react"), {
			...
			onPlay: l,
			onPause: s,
			onProgressChange: o.handleSetCurrentTimeByControls ? o.handleSetCurrentTimeByControls : c,
	...
	c.displayName = c.name + " [from " + i.id + "]", l.VideoRefControls = c;
}), 98);
