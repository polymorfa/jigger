__d("WAWebPlaceholderActivityWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ PlaceholderActivity: [
		1980,
		{
			...
			e2eSenderType: [16, o("WAWebWamEnumE2eDeviceType").E2E_DEVICE_TYPE],
			encryptionType: [22, o("WAWebWamEnumEncryptionTypeCode").ENCRYPTION_TYPE_CODE],
			isHostedChat: [19, e.TYPES.BOOLEAN],
			isLid: [12, e.TYPES.BOOLEAN],
			isSimpleSignal: [23, e.TYPES.BOOLEAN],
			localAddressingMode: [20, o("WAWebWamEnumAddressingMode").ADDRESSING_MODE],
			...
			placeholderActionInd: [2, o("WAWebWamEnumPlaceholderAction").PLACEHOLDER_ACTION],
			placeholderAddReason: [11, o("WAWebWamEnumPlaceholderReasonType").PLACEHOLDER_REASON_TYPE],
			placeholderChatTypeInd: [3, o("WAWebWamEnumPlaceholderChatType").PLACEHOLDER_CHAT_TYPE],
			placeholderPopulationType: [17, o("WAWebWamEnumPlaceholderPopulationType").PLACEHOLDER_POPULATION_TYPE],
			placeholderTimePeriod: [4, e.TYPES.INTEGER],
			placeholderTypeInd: [1, o("WAWebWamEnumPlaceholderType").PLACEHOLDER_TYPE],
