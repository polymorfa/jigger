__d("WAWebPnhCagDailyUtils", ["$InternalEnum", "WAWebDailyAggregatedStatsCollection"], (function(t, n, r, o, a, i, l) {
	...
	function s(t, n) {
		var r = o("WAWebDailyAggregatedStatsCollection").DailyAggregatedStatsCollection.gaddForToday(), a = r.pnhCagActions[t.toString()];
		switch (a == null && (a = {
			pnhIndicatorClicksChat: 0,
			pnhIndicatorClicksInfoScreen: 0,
			reactionDeleteCount: 0,
			reactionOpenTrayCount: 0
		}, r.pnhCagActions[t.toString()] = a), n) {
