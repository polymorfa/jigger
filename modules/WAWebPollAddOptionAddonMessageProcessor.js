__d("WAWebPollAddOptionAddonMessageProcessor", [
	...
	var e = o("WAWebAddonCreateMsgProcessor").createAddonMsgProcessor({
		...
		convert: { fromHistorySyncMsg: r("WAWebPollAddOptionFromHistorySyncMsg") },
		...
		beforeUpsert: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = t.parents, r = yield o("WAWebProcessEncryptedPollAddOptionMsgs").processEncryptedPollAddOptionMsgs(e, n);
				return yield o("WAWebStorePollAddOptionDecryptedMsgs").storePollAddOptionDecryptedMsgs(r), [];
			});
			function t(t, n) {
				return e.apply(this, arguments);
			}
