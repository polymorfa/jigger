__d("WAWebPollAddOptionAddonMessageProcessor", [
	...
	var e = o("WAWebAddonCreateMsgProcessor").createAddonMsgProcessor({
		...
		beforeUpsert: async function(t, n) {
			var e = n.parents, r = await o("WAWebProcessEncryptedPollAddOptionMsgs").processEncryptedPollAddOptionMsgs(t, e);
			return await o("WAWebStorePollAddOptionDecryptedMsgs").storePollAddOptionDecryptedMsgs(r), [];
		},
