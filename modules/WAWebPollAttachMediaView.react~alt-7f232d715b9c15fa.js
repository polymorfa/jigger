__d("WAWebPollAttachMediaView.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = e.activeOptionIndex, a = e.allowMultipleMedia, i = e.chat, l = e.correctOptionKey, u = e.getComposeBoxEditorRef, c = e.mediaCollection, d = e.onCancel, m = e.onComplete, p = e.onSend, _ = e.options, f = e.pollType, g = e.question, h = function(t) {
			t === void 0 && (t = !0), t && y(), m == null || m(!1), d == null || d(), c.mediaPickerStatsLogger.logCancel(), o("WAWebModalManager").ModalManager.open(s.jsx(o("WAWebPollsCreatePollModal").CreatePollModal, {
				chat: i,
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				})), o("WAWebModalManager").ModalManager.closeMedia(), y(), p == null || p();
			});
			return function(n) {
