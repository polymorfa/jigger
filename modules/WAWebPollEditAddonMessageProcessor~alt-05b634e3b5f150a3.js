__d("WAWebPollEditAddonMessageProcessor", [
	...
	var e = o("WAWebAddonCreateMsgProcessor").createAddonMsgProcessor({
		...
		beforeUpsert: async function(t, n) {
			var e = n.parents, r = await o("WAWebProcessEncryptedPollEditMsgs").processEncryptedPollEditMsgs(t, e), a = r.filter(function(e) {
				return e.isLatest;
			});
