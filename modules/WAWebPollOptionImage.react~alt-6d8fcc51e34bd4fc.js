__d("WAWebPollOptionImage.react", [
	...
	function m(t) {
		var n, a = t.mediaData, i = t.xstyle;
		return u.jsx(r("WAWebImg.react"), {
			className: (e || (e = r("stylex")))(i),
			src: (n = o("WAWebMediaDataUtils").getHighestQualityThumbnailUrl(a)) != null ? n : ""
		});
	}
	m.displayName = m.name + " [from " + i.id + "]";
	function p(e) {
		var t = e.msg, n = e.onClick, a = e.size, i = t.mediaData, l = a === "small" ? c.small : c.large, s = function() {
