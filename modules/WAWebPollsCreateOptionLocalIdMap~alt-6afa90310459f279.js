__d("WAWebPollsCreateOptionLocalIdMap", [
	"WAHex",
	...
	async function e(e) {
		var t = await Promise.all(e.map(async function(e) {
			var t = await s(e), n = o("WAHex").toHex(new Uint8Array(t));
			return {
				hash: t,
				hexHash: n,
				localId: e.localId
		...
		for (var i of t) {
			var l = i.hash, u = i.hexHash, c = i.localId;
			n.set(u, c), a.set(c, l);
		}
		return {
			...
			getLocalIdForHash: function(t) {
				return r("nullthrows")(n.get(o("WAHex").toHex(new Uint8Array(t))));
			},
			getHashForLocalId: function(t) {
				return r("nullthrows")(a.get(t));
			},
