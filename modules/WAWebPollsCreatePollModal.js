__d("WAWebPollsCreatePollModal", [
	...
	function S(t) {
		var a, i = t.chat, l = t.getComposeBoxEditorRef, u = t.initialCheckedKey, d = t.initialOptions, C = t.initialQuestion, S = t.onSend, R = t.pollType, L = r("useLazyRef")(function() {
			var e, t;
			return (e = (t = l()) == null || (t = t.getTextContent()) == null ? void 0 : t.substring(0, o("WAWebPollsGatingUtils").getMaxPollNameLength())) != null ? e : "";
		}).current, E = h(L), k = E[0], I = E[1], T = h(!1), D = T[0], x = T[1], $ = h(u), P = $[0], N = $[1], M = h(!1), w = M[0], A = M[1], F = h(null), O = F[0], B = F[1], W = h(!1), q = W[0], U = W[1], V = g(), H = h(void 0), G = H[0], z = H[1], j = h(!1), K = j[0], Q = j[1], X = h(!1), Y = X[0], J = X[1], Z = h(null), ee = Z[0], te = Z[1], ne = (a = o("useWAWebChatValues").useOptionalChatValues(i.id, [o("WAWebChatGetters").getIsNewsletter, o("WAWebFrontendChatGetters").getNewsletterMetadata])) != null ? a : [!1, null], re = ne[0], oe = ne[1], ae = f(function() {
			var e = o("WAWebChatEphemerality").calculateEphemeralDurationForChat(i);
			return e == null ? null : e * 1e3;
		}, [i]), ie = o("WAWebPollsGatingUtils").getMaxPollOptionCount(), le = h(function() {
			return o("WAWebPollOptionsRenderUtils").formatOptions(d != null ? d : [], { maxOptionsCount: ie });
		}), se = le[0], ue = le[1], ce = g(new Map()), de = g(null), me = g(), pe = r("useWAWebUIM")(), _e = m(function(e, t) {
			ue(o("WAWebPollOptionsRenderUtils").formatOptions(e, {
				maxOptionsCount: ie,
				focusedKey: t
			}));
		}, [ie]);
		...
		var fe = g(), ge = g(se.length);
		_(function() {
			var e = de.current, t = ge.current, n = se.findIndex(function(e) {
				return e.key === fe.current;
			});
			e != null && t < se.length && n === se.length - 2 && se[se.length - 1].name === "" && e.scroll({
				top: e.scrollHeight,
				behavior: "smooth"
		...
		p(function() {
			i.isComposingPoll = k.length > 0 || se.some(function(e) {
		...
		var be = se[ie - 2], ve = se[ie - 1], Se = se.length === ie && !o("WAWebPollOptionsRenderUtils").isEmptyAfterTrimming(be) && o("WAWebPollOptionsRenderUtils").isEmptyAfterTrimming(ve), Re = g(), Le = function(t) {
			t === void 0 && (t = !1), o("WAWebModalManager").ModalManager.close(), t && o("WAWebAttachmentMenuLogger").AttachmentMenuLogger.logAttachmentCancel(i, o("WAWebAttachmentMenuLogger").AttachmentMenuTarget.POLL);
		}, Ee = k !== "" || se.some(function(e) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t;
				J(!0), Le(!1), yield o("WAWebBizBotTosUtils").maybeShowBizBot1pTos(i);
				...
				o("WAWebPollsSendPollCreationMsgAction").sendPollCreation({
					...
					isWamoSub: e === o("WAWebNewsletterWamoSubMessageType").NewsletterWamoSubMessageType.WamoSub
				}), i.composeQuotedMsg = null, i.setComposeContents({}), (t = l()) == null || t.reset(), o("WAWebAttachmentMenuLogger").AttachmentMenuLogger.logAttachmentSend(i, o("WAWebAttachmentMenuLogger").AttachmentMenuTarget.POLL);
			});
			return function(n) {
				return e.apply(this, arguments);
			};
		})(), De = function() {
			if (re && o("WAWebNewsletterWamoSubUtils").newsletterSupportsSubscriptions(oe) && me.current && o("WAWebNewsletterGatingUtils").isWamoSubCreatorExperienceSupported()) {
				var e = function(t) {
					Te(t);
				};
				te({
					popupAnchorEl: me.current,
					handleSelect: e
				});
			} else Te();
			S == null || S();
			...
			var n = [].concat(se);
			n[e] = babelHelpers.extends({}, se[e], { image: void 0 }), _e(n, t);
		}, [se, _e]), Ne = m(function(e) {
			var t = se[e], n = babelHelpers.extends({
				question: k,
			...
			if (t.image) {
				var a = t.image, l = new (r("WAWebAttachMediaCollection"))({ chatParticipantCount: i.getParticipantCount() });
				l.add(a), l.forEach(function(e) {
					e.updateCaption(t.name);
				}), l.setActive(a), pe == null || pe.requestDismiss();
					...
					children: c.jsxs(r("WAWebDrawer.react"), {
						...
						children: [
							c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
								title: R === o("WAWebPollCreationUtils").PollType.QUIZ ? s._(
									/*BTDS*/
									""
								) : s._(
									/*BTDS*/
							...
							c.jsx(r("WAWebDrawerBody.react"), { children: c.jsxs("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(v.bodyContainer, o("WDSPaddings.stylex").wdsPaddings.paddingTop32), { children: [
								...
								c.jsxs("div", babelHelpers.extends({ ref: de }, e.props(v.optionsContainer, o("WDSMargins.stylex").wdsMargins.marginTop2, y.marginBottom10), { children: [c.jsx(r("WAWebPollsOrderableList"), {
									items: se,
									onReordered: _e,
									renderItem: function(t) {
										...
										return c.jsx(r("WAWebPollsOptionInput"), {
											...
											onPhotoIconClick: function() {
												var e;
												return (e = V.current) == null ? void 0 : e.open();
											},
											initialText: n.name,
											error: Ce.get(n.key),
											testid: "poll-option-input-" + e,
											onTextInputRef: function(t) {
												t ? ce.current.set(n.key, t) : ce.current.delete(n.key);
											},
											pollType: R,
											isPhotoPoll: ye,
											onChange: function(r) {
												var t = [].concat(se);
												t[e] = babelHelpers.extends({}, n, { name: r }), _e(t, n.key);
											},
											...
											handleCheckBoxClick: function() {
												return n.key === P ? N(null) : N(n.key);
											},
											checked: n.key === P
										});
									}
								}), R === o("WAWebPollCreationUtils").PollType.QUIZ && !Ee && c.jsx("div", {
									className: "x889kno",
								...
								R === o("WAWebPollCreationUtils").PollType.POLL && o("WAWebPollsGatingUtils").isSingleOptionPollsSendingEnabled(i.id) && c.jsxs("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(v.singleOptionContainer, o("WDSPaddings.stylex").wdsPaddings.paddingBottom20), { children: [c.jsx("label", babelHelpers.extends({ htmlFor: "polls-single-option-switch" }, (e || (e = r("stylex"))).props(v.singleOptionLabel, o("WDSPaddings.stylex").wdsPaddings.paddingVer4), { children: s._(
									/*BTDS*/
									""
								...
								R === o("WAWebPollCreationUtils").PollType.POLL && !re && o("WAWebPollsGatingUtils").isPollHideVotersSendingEnabled(i.id) && c.jsxs("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(v.singleOptionContainer, o("WDSPaddings.stylex").wdsPaddings.paddingBottom20), { children: [c.jsx("label", babelHelpers.extends({ htmlFor: "polls-hide-voter-names-switch" }, (e || (e = r("stylex"))).props(v.singleOptionLabel, o("WDSPaddings.stylex").wdsPaddings.paddingVer4), { children: s._(
									/*BTDS*/
									""
								) })), c.jsx(r("WDSSwitch.react"), {
								...
								R === o("WAWebPollCreationUtils").PollType.POLL && !re && o("WAWebPollsGatingUtils").isPollEndTimeSendingEnabled(i.id) && c.jsx(r("WAWebPollsEndTimeSection"), {
									enabled: w,
									maxDurationMs: ae,
									onToggle: A,
									pollEndTime: O,
