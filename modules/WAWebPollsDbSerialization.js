__d("WAWebPollsDbSerialization", ["WAWebMsgKey", "WAWebWidFactory"], (function(t, n, r, o, a, i, l) {
	function e(e) {
		var t = {
		...
		return e.t != null && (t.t = e.t), e.ack != null && (t.ack = e.ack), e.lastSuccessfulSelectedOptionLocalIds != null && (t.lastSuccessfulSelectedOptionLocalIds = new Uint8Array(e.lastSuccessfulSelectedOptionLocalIds).buffer), t;
	}
	function s(e) {
		var t;
		return {
			...
			lastSuccessfulSelectedOptionLocalIds: e.lastSuccessfulSelectedOptionLocalIds != null ? Array.from(new Uint8Array(e.lastSuccessfulSelectedOptionLocalIds)) : void 0
		};
	}
