__d("WAWebPollsDetailsDrawer", [
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(8), n = e.associatedMessages, r = e.msg, a = e.onClose, i = e.onOpenContactInfo, l = e.onViewAllVotes, s = e.ref, u = o("useWAWebNewsletterPollsResults").useNewsletterPollsResults(r), c;
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(8), n = e.associatedMessages, r = e.msg, a = e.onClose, i = e.onOpenContactInfo, l = e.onViewAllVotes, s = e.ref, u = o("WAWebPollsUseResults").useResults(r), c;
		return t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== i || t[4] !== l || t[5] !== u || t[6] !== s ? (c = d.jsx(g, {
			mode: "e2ee",
			ref: s,
			msg: r,
	...
	function h(t) {
		...
		var i;
		return n[3] !== r || n[4] !== a ? (i = o("WAWebMsgGetters").getIsNewsletterMsg(r.msg) ? d.jsx(_, babelHelpers.extends({}, r, { ref: a })) : d.jsx(f, babelHelpers.extends({}, r, { ref: a })), n[3] = r, n[4] = a, n[5] = i) : i = n[5], i;
	}
	var y = h;
	l.DetailsDrawer = y;
}), 226);
