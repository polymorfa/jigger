__d("WAWebPollsDetailsFlow", [
	...
	var e, s = e || (e = o("react")), u = e, c = u.useEffect, d = u.useState, m = n("$InternalEnum").Mirrored([
		"Details",
		"ViewAll",
		"ContactInfo"
	]);
	function p(e) {
		var t = e.associatedMessages, n = e.msg, a = o("useWAWebFlow").useFlow(m.Details, { transitions: o("useWAWebFlow").FlowTransitions.DrawerRight }), i = a[0], l = a[1], u = d(null), p = u[0], _ = u[1], f = d(null), g = f[0], h = f[1], y = o("WAWebFrontendMsgGetters").getChat(n.unsafe()), C = function(t) {
			h(t), l.push(m.ContactInfo);
		};
		if (c(function() {
			o("WAWebPollsActionsMetricUtils").commitPollsActionsMetric(babelHelpers.extends({
				action: o("WAWebWamEnumPollActionType").POLL_ACTION_TYPE.VIEW_RESULTS_MODAL,
				chat: y
			}, o("WAWebPollsActionsMetricUtils").getPollMetricFieldsFromCreationMsg(n)));
