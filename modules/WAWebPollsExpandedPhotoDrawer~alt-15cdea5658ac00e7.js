__d("WAWebPollsExpandedPhotoDrawer", [
	...
	function d(e) {
		var t = e.associatedMessages, n = e.chatName, a = e.correctOptionIndex, i = e.isPollEnded, l = e.isPollInvalid, d = e.isSentByMe, m = e.msg, p = e.onDetailImageClick, _ = e.pollEndTime, f = e.pollHideVoterNames, g = e.pollName, h = e.readonly, y = e.ref, C = e.selectableOptionsCount, b = e.trusted, v = o("useWAWebNewsletterPollsResults").useNewsletterPollsResults(m), S = u(function() {
			...
			children: [s.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				children: [s.jsx(r("WAWebDrawerSection.react"), {
					...
					children: s.jsx(r("WAWebPollMessageHeader"), {
						...
						pollSelectableOptionsCount: m.pollType === o("WAWebPollCreationUtils").PollType.QUIZ && d ? null : C,
