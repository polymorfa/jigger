__d("WAWebPollsOptionMetadataRow", [
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(8), n = e.count, r = e.isCurrentLeader, a;
		t[0] !== r ? (a = r ? [o("WAWebTag.react").TagTheme.Primary, o("WAWebTag.react").TagIconName.STAR] : [o("WAWebTag.react").TagTheme.Secondary, null], t[0] = r, t[1] = a) : a = t[1];
		var i = a, l = i[0], u = i[1], d;
		t[2] !== n ? (d = s._(
			/*BTDS*/
			"",
			[s._plural(n, "vote")]
		...
		var m;
		return t[4] !== u || t[5] !== d || t[6] !== l ? (m = c.jsx(o("WAWebTag.react").Tag, {
			theme: l,
			icon: u,
			children: d
		}), t[4] = u, t[5] = d, t[6] = l, t[7] = m) : m = t[7], m;
	}
	function f(e) {
		var t = o("react-compiler-runtime").c(6), n = e.count, r = e.isCorrectOption, a;
		t[0] !== r ? (a = r ? [o("WAWebTag.react").TagTheme.Primary, o("WAWebTag.react").TagIconName.CHECK] : [o("WAWebTag.react").TagTheme.Secondary, o("WAWebTag.react").TagIconName.CLOSE], t[0] = r, t[1] = a) : a = t[1];
		var i = a, l = i[0], s = i[1], u;
		return t[2] !== n || t[3] !== s || t[4] !== l ? (u = c.jsx(o("WAWebTag.react").Tag, {
			theme: l,
			icon: s,
			children: n
		}), t[2] = n, t[3] = s, t[4] = l, t[5] = u) : u = t[5], u;
	}
	l.default = p;
}), 226);
