	...
	var e = (function(e) {
		...
		return n.delete = function() {
			...
			return {
				...
				ack: this.ack,
				read: this.read,
				lastSuccessfulSelectedOptionLocalIds: this.lastSuccessfulSelectedOptionLocalIds
			};
		}, t;
