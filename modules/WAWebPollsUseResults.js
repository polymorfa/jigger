__d("WAWebPollsUseResults", [
	...
	function d(e) {
		...
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (n = ["id", "pollOptions"], t[0] = n) : n = t[0];
		var a = o("useWAWebModelValues").useModelValues(e, n), i = a.id, l = a.pollOptions, s;
		t[1] !== i ? (s = o("WAWebPollsPollVoteCollection").PollVoteCollection.getForParentAddressingModeInsensitive([i]), t[1] = i, t[2] = s) : s = t[2];
		var c = s, d = c[0], f;
		t[3] !== d ? (f = function() {
			return d.toArray();
		}, t[3] = d, t[4] = f) : f = t[4];
		var g = r("useWAWebEventTargetValue")(d, "add remove reset", f), h = o("WAWebMarkAddOnsAsReadAction").useMarkAddOnsAsRead(), y, C;
		t[5] !== i ? (y = function() {
			o("WAWebAddonHydrationUtils").hydrateAddons({
				ids: [i],
				hydrationType: o("WAWebMsgType").MSG_TYPE.POLL_UPDATE
			});
		}, C = [i], t[5] = i, t[6] = y, t[7] = C) : (y = t[6], C = t[7]), u(y, C);
		var b, v;
		t[8] !== h || t[9] !== g ? (b = function() {
			var e = g.filter(p);
			e.length !== 0 && h({
				addOnType: o("WAWebMessageAddOnType").MessageAddOnType.PollVote,
				addOns: e.map(m)
			});
		}, v = [g, h], t[8] = h, t[9] = g, t[10] = b, t[11] = v) : (b = t[10], v = t[11]), u(b, v);
		var S;
		return t[12] !== l || t[13] !== g ? (S = _(g, l), t[12] = l, t[13] = g, t[14] = S) : S = t[14], S;
	}
	function m(e) {
		return {
			msgKey: e.msgKey,
