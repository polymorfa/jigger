__d("WAWebPollsUseStickySortedResults", [
	"nullthrows",
	"react",
	"useLazyRef"
	...
	function u(e) {
		...
		return s(function() {
			var n = t.current, o = Array.from(e), a = o.filter(function(e) {
				var t = e[0];
			...
			return o.sort(function(e, t) {
				var o = e[0], a = t[0];
				return r("nullthrows")(n.get(o.localId)) - r("nullthrows")(n.get(a.localId));
			});
		}, [t, e]);
	}
