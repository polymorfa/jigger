__d("WAWebPollsValidationError", [
	...
	var e, s, u = (s = n("$InternalEnum"))({
		...
		function t() {
			...
			return t = e.call.apply(e, [this].concat(r)) || this, t.name = "PollCreationValidationError", babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})((e = o("WAWebHandleMsgError")).MessageValidationError), d = s({
		...
		function t() {
			for (var t, n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o];
			return t = e.call.apply(e, [this].concat(r)) || this, t.name = "PollUpdateValidationError", babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(e.MessageValidationError), p = s({
		...
		function t(t) {
			var n;
			return n = e.call(this, t) || this, n.name = "PollVoteValidationError", n.code = t, n;
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(o("WACustomError").CustomError), f = s({
		INVALID_NAME: "poll_result_snapshot_invalid_name",
		INVALID_POLL_VOTES_SNAPSHOTS_COUNT: "poll_result_snapshot_invalid_poll_votes_snapshots_count",
		INVALID_OPTIONS_COUNT: "poll_result_snapshot_invalid_options_count",
		INVALID_OPTION: "poll_result_snapshot_invalid_option",
		INVALID_OPTION_VOTE_COUNT: "poll_result_snapshot_invalid_option_vote_count",
		...
		MISSING_OPTION_VOTE_COUNT: "poll_result_snapshot_missing_option_vote_count",
		DUPLICATE_OPTIONS: "poll_result_snapshot_duplicate_options"
	}), g = (function(e) {
		function t() {
			for (var t, n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o];
			return t = e.call.apply(e, [this].concat(r)) || this, t.name = "PollResultSnapshotValidationError", babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(e.MessageValidationError), h = s({
		...
		INVALID_PROTOCOL_MESSAGE_TYPE: "poll_edit_invalid_protocol_message_type",
		MISSING_SENDER_TIMESTAMP: "poll_edit_missing_sender_timestamp",
		MISSING_MESSAGE_SECRET: "poll_edit_missing_message_secret",
		MISSING_POLL_CREATION_MESSAGE: "poll_edit_missing_poll_creation_message",
		...
		function t() {
			for (var t, n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o];
			return t = e.call.apply(e, [this].concat(r)) || this, t.name = "PollEditValidationError", babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(e.MessageValidationError), C = s({
		MISSING_TARGET_MESSAGE_KEY: "poll_add_option_missing_target_message_key",
		...
		function t() {
			for (var t, n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o];
			return t = e.call.apply(e, [this].concat(r)) || this, t.name = "PollAddOptionValidationError", babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(e.MessageValidationError);
	l.PollCreationValidationErrorCode = u, l.PollCreationValidationError = c, l.PollUpdateValidationErrorCode = d, l.PollUpdateValidationError = m, l.PollVoteValidationErrorCode = p, l.PollVoteValidationError = _, l.PollResultSnapshotValidationErrorCode = f, l.PollResultSnapshotValidationError = g, l.PollEditValidationErrorCode = h, l.PollEditValidationError = y, l.PollAddOptionValidationErrorCode = C, l.PollAddOptionValidationError = b;
}), 98);
