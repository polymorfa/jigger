__d("WAWebPollsViewAllVotesDrawer", [
	...
	function m(e) {
		...
		var a = n, i = a.msg, l;
		return t[3] !== i.id.remote || t[4] !== n || t[5] !== r ? (l = i.id.remote.isNewsletter() ? d.jsx(f, babelHelpers.extends({}, n, { ref: r })) : d.jsx(_, babelHelpers.extends({}, n, { ref: r })), t[3] = i.id.remote, t[4] = n, t[5] = r, t[6] = l) : l = t[6], l;
	}
	var p = m;
	function _(e) {
		var t = o("react-compiler-runtime").c(8), n = e.associatedMessages, r = e.msg, a = e.onBack, i = e.onOpenContactInfo, l = e.optionLocalId, s = e.ref, u = o("WAWebPollsUseResults").useResults(r), c;
		return t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== i || t[4] !== l || t[5] !== u || t[6] !== s ? (c = d.jsx(g, {
			...
			msg: r,
			ref: s
		}), t[0] = n, t[1] = r, t[2] = a, t[3] = i, t[4] = l, t[5] = u, t[6] = s, t[7] = c) : c = t[7], c;
	}
	function f(e) {
		var t = o("react-compiler-runtime").c(10), n = e.associatedMessages, r = e.msg, a = e.onBack, i = e.onOpenContactInfo, l = e.optionLocalId, s = e.ref, u;
		t[0] !== l ? (u = { pollVoteLocalId: l }, t[0] = l, t[1] = u) : u = t[1];
		var c = o("useWAWebNewsletterPollsResults").useNewsletterPollsResults(r, u), m;
		return t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== i || t[6] !== l || t[7] !== c || t[8] !== s ? (m = d.jsx(g, {
			associatedMessages: n,
			mode: "newsletter",
			withSectioning: !0,
			onBack: a,
			...
			msg: r,
			ref: s
		}), t[2] = n, t[3] = r, t[4] = a, t[5] = i, t[6] = l, t[7] = c, t[8] = s, t[9] = m) : m = t[9], m;
	}
	function g(t) {
