__d("WAWebPopoverArrow.react", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = e.coords, n = e.popoverPosition, a = e.width, i = e.xstyle, l;
		switch (n) {
	...
	u.displayName = u.name + " [from " + i.id + "]", l.PopoverAlignment = o("WAWebPopoverPosition").PopoverAlignment, l.PopoverPosition = o("WAWebPopoverPosition").PopoverPosition, l.PopoverArrow = u;
}), 98);
