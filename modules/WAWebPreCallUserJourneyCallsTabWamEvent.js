__d("WAWebPreCallUserJourneyCallsTabWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ PreCallUserJourneyCallsTab: [
		5680,
		{
			appSessionId: [1, e.TYPES.STRING],
			callSizeType: [7, o("WAWebWamEnumCallSizeType").CALL_SIZE_TYPE],
			callsTabSource: [2, o("WAWebWamEnumCallsTabSource").CALLS_TAB_SOURCE],
			genaiBots: [11, e.TYPES.STRING],
			itemPosition: [10, e.TYPES.INTEGER],
			preCallActionType: [3, o("WAWebWamEnumPreCallActionType").PRE_CALL_ACTION_TYPE],
