	...
	var e = (function(e) {
		...
		return a.getVersion = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this, n = [], a = 0, i = e.map(function(e) {
					try {
						var r = e.indexParts, i = r[1], l = r[2];
						return !i || !l ? t.malformedActionIndex() : e.operation === "set" ? o("WAWebPremiumMessageCollection").PremiumMessageCollection.find(i) == null ? { actionState: o("WAWebSyncdConst").SyncActionState.Orphan } : (n.push({
							messageId: l,
							premiumMessageId: i
				...
				return a > 0, yield r("WAWebPremiumMessageAddSendAction")(n), i;
			});
			function t(t) {
