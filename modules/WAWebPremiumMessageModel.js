__d("WAWebPremiumMessageModel", [
	...
	var e = (function(e) {
		...
		return n.initialize = function() {
			var t = this;
			e.prototype.initialize.call(this), this.listenTo(this, "change:message change:sentMessageIds change:type", function() {
				return t.hydrateMessages();
			});
		}, n.hydrateMessages = function() {
			var e = this;
			o("WAWebMsgCollection").MsgCollection.getModelsArray().filter(function(t) {
				return t.smbClientCampaignId === e.id;
			}).forEach(function(t) {
				o("WAWebPremiumMessageHydrateMessageAction").hydratePremiumMessage(t, e);
			});
		}, t;
