__d("WAWebPresenceBridgeApi", [
	...
	var e = {
		changePresenceHandler: function(t) {
			var e = t.id, n = t.participant, a = t.type;
		...
		resetPresence: function(t) {
			var e = t.id, n = o("WAWebPresenceCollection").PresenceCollection.get(o("WAWebWidFactory").createWid(e));
			n && n.reset();
		}
	};
