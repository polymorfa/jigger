__d("WAWebPrivacyModeContext", [
	...
	function y(e) {
		var t = e.children, n = f(o("WAWebUserPrefsPrivacyMode").isPrivacyScreenEnabled), r = n[0], a = n[1], i = f(function() {
			var e = new Map();
			for (var t of o("WAWebPrivacyModeBlurConfig").BlurCategory.members()) e.set(t, o("WAWebUserPrefsPrivacyMode").getBlurPreset(t));
			return e;
		}), l = i[0], u = i[1], c = d(function(e) {
		...
		var m = d(function(e) {
			var t, n = (t = l.get(e)) != null ? t : o("WAWebPrivacyModeBlurConfig").defaultPresetForCategory(e);
			return o("WAWebPrivacyModeBlurConfig").blurValueForPreset(n);
		}, [l]), g = d(function(e, t) {
			o("WAWebUserPrefsPrivacyMode").setBlurPreset(e, t), u(function(n) {
				var r = new Map(n);
				return r.set(e, t), r;
			});
		}, []), y = d(function() {
