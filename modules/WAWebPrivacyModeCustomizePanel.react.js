__d("WAWebPrivacyModeCustomizePanel.react", [
	...
	"use strict";
	var e, s = e || (e = o("react")), u = { chevronIcon: {
		color: "x1164gpu",
		height: "x17rw0jw",
		$$css: !0
	} }, c = [{
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(11), n = e.onBack, a = e.onOpenBlurPreset, i;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (i = {
			surface: "unknown",
			viewName: "privacy-screen-customize"
		}, t[0] = i) : i = t[0];
		var l;
		t[1] === Symbol.for("react.memo_cache_sentinel") ? (l = o("WAWebPrivacyModeSettingsFBT").privacyModeCustomizeTitle(), t[1] = l) : l = t[1];
		var d;
		t[2] !== n ? (d = s.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			testid: "drawer-title-privacy-screen-customize",
			title: l,
		...
		t[4] !== a ? (m = c.map(function(e, t) {
			...
			return s.jsx(r("WAWebDrawerItem.react"), {
				...
				testid: "privacy-blur-category-" + e.category,
		...
		var p;
		t[6] !== m ? (p = s.jsx(r("WAWebDrawerBody.react"), { children: s.jsx(r("WAWebDrawerSection.react"), {
			theme: "padding-no-vertical",
			animation: !1,
			children: m
		}) }), t[6] = m, t[7] = p) : p = t[7];
		var _;
		return t[8] !== d || t[9] !== p ? (_ = s.jsxs(r("WAWebDrawer.react"), {
			testid: "privacy-screen-customize-drawer",
			tsNavigationData: i,
			children: [d, p]
