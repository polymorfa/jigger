__d("WAWebPrivacySettingsDrawer.react", [
	...
	function C(t) {
		var a, i, l, u, c = t.onClose, d = t.onOpenBlockedContacts, p = t.onOpenEphemeralityDrawer, C = t.onOpenPrivacyScreenCustomize, b = t.onOpenScreenLockDrawer, E = t.onOpenStatusPrivacySettingDrawer, I = t.onOpenVisibilityEditDrawer, T = t.ref, D = f(function() {
			...
			profile: null,
			pix: null
		}), N = P[0], M = P[1], w = o("useWAWebStatusPrivacySettingConfig").useWAWebStatusPrivacySettingConfig(), A = w.statusPostingPrivacyConfig, F = r("nullthrows")(o("WAWebContactCollection").ContactCollection.getMeContact()), O = o("useWAWebModelValues").useModelValues(F, ["disappearingModeDuration"]), B = O.disappearingModeDuration;
		function W(e) {
			...
			$(t), M(o("WAWebApiPrivacyDisallowedList").disallowedRowsToLists(e.privacyDisallowedRows));
		}
		_(function() {
			var t = new AbortController();
			return x == null && n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					var n = yield o("WAWebAccountSyncJob").updatePrivacySettings();
					if (t.signal.aborted) return;
					W(n);
				} catch (t) {
					t instanceof Error && o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["privacy_settings_drawer: get privacy settings failed"]))).catching(t).sendLogs("privacy_settings_drawer: get privacy settings failed"), c(), o("WAWebToastManager").ToastManager.open(m.jsx(o("WAWebToast.react").Toast, { msg: s._(
						/*BTDS*/
						""
					) }));
				}
		...
		o("useWAWebListener").useListener(o("WAWebUserPrefsGeneral").privacySettingsEventEmitter, "all", function() {
			...
			n != null && n.disallowAllP2p !== (x == null ? void 0 : x.disallowAllP2p) && $(n);
		});
		var Q = s._(
			/*BTDS*/
			""
		);
		if (!x) return m.jsx(r("WAWebLoadingDrawer.react"), {
			title: Q,
			error: !1
		});
		var X = o("WAWebMiscGatingUtils").isDefaultDisappearingMessagesEnabled(), Y = x.about, J = x.disableLinkPreviews, Z = x.disallowAllP2p, ee = x.groupAdd, te = x.lastSeen, ne = x.messages, re = x.online, oe = x.profilePicture, ae = x.readReceipts, ie = [R(te, (a = N.last) == null ? void 0 : a.disallowedList.length)];
		te !== o("WAWebPrivacySettings").VISIBILITY.all && re === o("WAWebPrivacySettings").ONLINE_VISIBILITY.all && ie.push(R(re));
		var le = r("WAWebFbtIntlList")(ie, r("WAWebFbtIntlList").CONJUNCTIONS.NONE, r("WAWebFbtIntlList").DELIMITERS.COMMA), se = m.jsx(v, {
			title: o("WAWebSettingsFBT").privacyLastSeenOnlineEnabledTitle(),
			onClick: function() {
				I("lastSeen"), h(o("WAWebWamEnumPrivacyControlItemType").PRIVACY_CONTROL_ITEM_TYPE.LAST_SEEN_AND_ONLINE, o("WAWebWamEnumPrivacyControlEntryPointType").PRIVACY_CONTROL_ENTRY_POINT_TYPE.PRIVACY_SETTINGS);
			},
			testid: "last-seen-and-online-privacy-settings-item",
			children: m.jsxs("span", { children: [" ", le] })
		}), ue = o("WAWebBlocklistCollection").BlocklistCollection.dedupedList().length, ce = s._(
			/*BTDS*/
			""
		), de = s._(
			/*BTDS*/
			""
		), me = m.jsx(r("WAWebDrawerItem.react"), {
			...
			icon: m.jsx("div", {
				...
				children: m.jsx(r("WDSSwitch.react"), {
					value: ne === o("WAWebPrivacySettings").ALL_CONTACTS.contacts || K,
					disabled: K,
			...
			onDisabledClick: function() {
				z != null && o("WAWebDefenseModeLockedInterstitial.react").openDefenseModeLockedInterstitialGlobal(z, ne === o("WAWebPrivacySettings").ALL_CONTACTS.contacts ? "on" : "off");
			},
			onClick: function() {
				k({
					messages: ne,
		...
		}), pe = o("WAWebVoipGatingUtils").isCallingEnabled() ? m.jsx(r("WAWebDrawerItem.react"), {
			...
			onClick: function() {
				...
				var e = !Z, t = babelHelpers.extends({}, x, { disallowAllP2p: e });
			...
			children: m.jsx("span", { children: o("WAWebStatusPostingUtils").formatStatusSetting(A) })
		}) : null, fe = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				$(babelHelpers.extends({}, x, { disableLinkPreviews: e })), o("WAWebDisableLinkPreviewsAction").setDisableLinkPreviews(e);
			});
			return function(n) {
			...
			children: m.jsx(o("WAWebKeyboardRotateFocus.react").RotateFocus, {
				...
				children: m.jsxs("div", {
					...
					children: [m.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
						...
						m.jsxs(r("WAWebDrawerSection.react"), {
							...
							children: [
								...
								m.jsx(v, {
									...
									onClick: function() {
										I("profilePicture"), h(o("WAWebWamEnumPrivacyControlItemType").PRIVACY_CONTROL_ITEM_TYPE.PROFILE_PHOTO, o("WAWebWamEnumPrivacyControlEntryPointType").PRIVACY_CONTROL_ENTRY_POINT_TYPE.PRIVACY_SETTINGS);
									},
									testid: "profile-photo-privacy-settings-item",
									children: m.jsx("span", { children: R(oe, (i = N.profile) == null ? void 0 : i.disallowedList.length) })
								}),
								m.jsx(v, {
									title: o("WAWebSettingsFBT").privacyAboutTitle(),
									onClick: function() {
										I("about"), h(o("WAWebWamEnumPrivacyControlItemType").PRIVACY_CONTROL_ITEM_TYPE.ABOUT, o("WAWebWamEnumPrivacyControlEntryPointType").PRIVACY_CONTROL_ENTRY_POINT_TYPE.PRIVACY_SETTINGS);
									},
									testid: "about-privacy-settings-item",
									children: m.jsx("span", { children: R(Y, (l = N.about) == null ? void 0 : l.disallowedList.length) })
								}),
								_e,
								m.jsx(r("WAWebDrawerItem.react"), {
									...
									icon: m.jsx("div", {
										className: "x1849jeq x78zum5 xl56j7k",
										children: m.jsx(r("WDSSwitch.react"), {
											value: ae === o("WAWebPrivacySettings").ALL_NONE.all,
											"aria-label": o("WAWebSettingsFBT").privacyReadReceiptsTitle().toString() + ". " + ce.toString()
										})
									}),
									theme: "privacy",
									isLastItem: !0,
									disableKeydownHandling: !0,
									onClick: function() {
										h(o("WAWebWamEnumPrivacyControlItemType").PRIVACY_CONTROL_ITEM_TYPE.READ_RECEIPT, o("WAWebWamEnumPrivacyControlEntryPointType").PRIVACY_CONTROL_ENTRY_POINT_TYPE.PRIVACY_SETTINGS), L(x, $, ae);
									},
						...
						X && m.jsx(r("WAWebDrawerSection.react"), {
							theme: "padding-no-vertical",
							title: s._(
								/*BTDS*/
								""
							...
							children: m.jsx(v, {
								...
								onClick: function() {
									h(o("WAWebWamEnumPrivacyControlItemType").PRIVACY_CONTROL_ITEM_TYPE.DDM_TIMER, o("WAWebWamEnumPrivacyControlEntryPointType").PRIVACY_CONTROL_ENTRY_POINT_TYPE.PRIVACY_SETTINGS), p();
								},
								isLastItem: !0,
								testid: "ddm-settings-item",
								children: m.jsx("span", {
									"data-testid": "ddm-settings-item-value",
									children: o("WAWebEphemeralityDurations").durationToLabel(B)
								})
							})
						}),
						m.jsxs(r("WAWebDrawerSection.react"), {
							...
							children: [
								m.jsx(v, {
									...
									onClick: function() {
										h(o("WAWebWamEnumPrivacyControlItemType").PRIVACY_CONTROL_ITEM_TYPE.GROUPS, o("WAWebWamEnumPrivacyControlEntryPointType").PRIVACY_CONTROL_ENTRY_POINT_TYPE.PRIVACY_SETTINGS), I("groupAdd");
									},
									testid: "groups-privacy-settings-item",
									children: m.jsx("span", { children: R(ee, (u = N.groupadd) == null ? void 0 : u.disallowedList.length) })
								}),
								m.jsx(v, {
									title: o("WAWebSettingsFBT").privacyBlockedTitle(),
									onClick: function() {
										h(o("WAWebWamEnumPrivacyControlItemType").PRIVACY_CONTROL_ITEM_TYPE.BLOCKED, o("WAWebWamEnumPrivacyControlEntryPointType").PRIVACY_CONTROL_ENTRY_POINT_TYPE.PRIVACY_SETTINGS), d();
									},
									testid: "blocked-contacts-settings-item",
									children: m.jsx("span", { children: ue === 0 ? s._(
										/*BTDS*/
										""
									) : ue })
								}),
								m.jsx(v, {
									...
									isLastItem: !0,
									onClick: function() {
										h(o("WAWebWamEnumPrivacyControlItemType").PRIVACY_CONTROL_ITEM_TYPE.SCREEN_LOCK, o("WAWebWamEnumPrivacyControlEntryPointType").PRIVACY_CONTROL_ENTRY_POINT_TYPE.PRIVACY_SETTINGS), b();
									},
						...
						m.jsxs(r("WAWebDrawerSection.react"), {
							...
							animation: !1,
							children: [
								m.jsx(o("WAWebPrivacyScreenModeToggle.react").WAWebPrivacyScreenModeToggle, { onOpenCustomize: C }),
								me,
								pe,
								m.jsx(r("WAWebDrawerItem.react"), {
									...
									icon: m.jsx("div", {
										...
										children: m.jsx(r("WDSSwitch.react"), {
											value: J || H,
											disabled: H,
											"aria-label": o("WAWebSettingsFBT").privacyLinkPreviewsTitle().toString() + ". " + de.toString()
										})
									}),
									theme: "privacy",
									isLastItem: !0,
									...
									disabled: H,
									onDisabledClick: function() {
										U != null && o("WAWebDefenseModeLockedInterstitial.react").openDefenseModeLockedInterstitialGlobal(U, J ? "on" : "off");
									},
									onClick: function() {
										fe(!J);
									},
	...
	function v(e) {
		var t = e.children, n = e.disabled, a = e.icon, i = e.isLastItem, l = e.onClick, s = e.tabIndex, u = s === void 0 ? 0 : s, c = e.testid, d = e.title, p = a != null ? a : b();
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			try {
				r === o("WAWebPrivacySettings").ALL_NONE.none ? yield o("WAWebSetPrivacyForOneCategoryAction").setPrivacyForOneCategory({
					name: "readreceipts",
					value: "none"
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				a === o("WAWebPrivacySettings").ALL_CONTACTS.all ? yield o("WAWebSetPrivacyForOneCategoryAction").setPrivacyForOneCategory({
					name: "messages",
					value: "all"
				}) : yield o("WAWebSetPrivacyForOneCategoryAction").setPrivacyForOneCategory({
					name: "messages",
