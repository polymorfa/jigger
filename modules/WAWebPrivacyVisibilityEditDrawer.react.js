__d("WAWebPrivacyVisibilityEditDrawer.react", [
	...
	function m(t) {
		var a = t.category, i = t.onClose, l = t.onOpenContactsExceptModal, u = t.ref, m = d(function() {
			var e, t, n, r = o("WAWebUserPrefsGeneral").getUserPrivacySettings();
			switch (a) {
				case "about": return (e = r.about) != null ? e : o("WAWebPrivacySettings").VISIBILITY.all;
				case "profilePicture": return (t = r.profilePicture) != null ? t : o("WAWebPrivacySettings").VISIBILITY.all;
				case "groupAdd": return (n = r.groupAdd) != null ? n : o("WAWebPrivacySettings").VISIBILITY.all;
			}
		}), f = m[0], g = m[1], h = d(function() {
			return o("WAWebDefenseModeUtils").getWamEnumIfSettingLockedByDefenseMode(a);
		}), y = h[0], C = h[1], b = o("WAWebUseContactManagementAvailability").useAccountIntegrityState();
		function v(e) {
			return S.apply(this, arguments);
		}
		function S() {
			return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				if (t !== o("WAWebPrivacySettings").VISIBILITY.contact_blacklist && t !== f) {
					g(t);
					var n = o("WAWebSetPrivacyForOneCategoryAction").privacyWebNameToServerName(a);
					if (n === "readreceipts" || n === "online" || n === "calladd" || n === "messages") throw r("err")("visibility_edit_drawer: category can not be " + n);
					try {
						switch (t) {
							case o("WAWebPrivacySettings").VISIBILITY.none:
								if (n === "groupadd") throw r("err")("visibility_edit_drawer: groupadd can not be none");
		...
		var R = function() {
			...
			l != null ? l(e) : o("WAWebModalManager").ModalManager.open(c.jsx(r("WAWebSelectContactsExceptModal.react"), {
				category: a,
				onConfirm: e
			}));
		};
		o("useWAWebListener").useListener(o("WAWebUserPrefsGeneral").privacySettingsEventEmitter, "all", function() {
			var e, t = o("WAWebDefenseModeUtils").getWamEnumIfSettingLockedByDefenseMode(a);
			C(t);
			var n = o("WAWebUserPrefsGeneral").getUserPrivacySettings(), r = (e = a === "about" ? n.about : a === "profilePicture" ? n.profilePicture : a === "groupAdd" ? n.groupAdd : (function() {
		...
		var L = function(t) {
			return y == null ? t : babelHelpers.extends({}, t, {
				disabled: !0,
				onDisabledClick: function() {
					o("WAWebDefenseModeLockedInterstitial.react").openDefenseModeLockedInterstitialGlobal(y, t.value);
				}
			});
		}, E = [
			L({
		...
		].filter(Boolean), k = a === "groupAdd" ? c.jsx(o("WAWebText.react").WAWebTextMuted, {
			margin: [20, 0],
			children: s._(
				/*BTDS*/
				""
			)
		}) : null, I = a === "groupAdd" ? c.jsx(o("WAWebText.react").WAWebTextMuted, {
			margin: [20, 0],
			children: s._(
				/*BTDS*/
				""
		...
		return b === o("WAWebUseContactManagementAvailability").AccountIntegrityState.TIMELOCK && (f === o("WAWebPrivacySettings").VISIBILITY.contacts || f === o("WAWebPrivacySettings").VISIBILITY.contact_blacklist) && (T = c.jsx(r("WAWebAccountTakeOverBanner.react"), { entryPoint: "privacy-settings" })), c.jsxs(r("WAWebDrawer.react"), {
			ref: u,
			...
			children: [c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				testid: "drawer-title-" + a,
				title: p(a),
				onBack: i,
				focusBackOrCancel: !0,
				type: o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.SMALL
			}), c.jsxs(r("WAWebDrawerBody.react"), { children: [T, c.jsxs(r("WAWebDrawerSection.react"), {
