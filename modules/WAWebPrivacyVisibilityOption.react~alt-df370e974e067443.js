__d("WAWebPrivacyVisibilityOption.react", [
	...
	function c(e) {
		var t = e.disabled, n = e.onClick, a = e.onDisabledClick, i = e.ref, l = e.selected, c = e.subText, d = e.testid, m = e.text;
		return s.jsx(r("WAWebUnstyledButton.react"), {
			...
			disabled: t,
			testid: d,
			children: s.jsxs(o("WAWebFlex.react").FlexRow, { children: [s.jsx(o("WAWebFlex.react").FlexItem, {
				align: "center",
				...
				}[(t === !0) << 0], { children: m })), s.jsx(o("WAWebText.react").WAWebTextSmall, { children: c })]
			})] })
		});
	}
