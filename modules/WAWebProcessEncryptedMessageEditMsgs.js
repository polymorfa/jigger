__d("WAWebProcessEncryptedMessageEditMsgs", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, a) {
			...
			var l = yield (u || (u = n("Promise"))).allSettled(Array.from(i.entries()).map(function(e) {
				var t = e[0], n = e[1];
				return m(t, n);
			}));
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			var _ = {
				...
				encryptedAddOn: s
			}, f = o("WAWebWidFactory").asUserWidOrThrow(d), g = yield o("WAWebAddonEncryption").decryptAddOn(_, {
				messageSecret: u,
				iv: l,
				stanzaId: t.id.id,
			...
			return C != null && (b.messageSecret = new Uint8Array(C)), yield o("WAWebHandleMsgValidate").validateAndProcessReportingTokenInfo({
				renderableMsgs: [b],
