__d("WAWebProcessPhoneNumberMapping", [
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n, r = [], a = e.author, i = e.peerRecipientPn, l = e.recipientLatestLid, u = e.recipientPn, c = m(e), p = o("WAWebWidFactory").asUserLidOrThrow(a);
			if (o("WAWebUserPrefsMeUser").isMeAccount(a)) {
				...
				if (u != null) n = {
					...
					(f == null || (f == null ? void 0 : f.shareOwnPn) !== !0) && d({
						lid: o("WAWebWidFactory").asUserLidOrThrow(c),
						data: { shareOwnPn: !0 },
						shouldWaitForJob: !1,
						processingResult: r
					});
				} else c.isBot() || o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[extractMappingsForOneToOneLidMessages] peer message with non-LID chat: ", ""])), c.toLogString()).sendLogs("peer-message-non-lid-chat");
				if (_ !== "ctwa") {
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.author, r = e.peerRecipientLid, a = e.recipientLatestLid, i = e.recipientLid, l = m(e);
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var a, i = [], l = t.author, s = t.participantLid, c = t.participantPn;
			c != null ? a = {
			...
			var m = t.displayName;
			return !o("WAWebUserPrefsMeUser").isMeAccount(l) && m != null && d({
				lid: o("WAWebWidFactory").asUserLidOrThrow(l),
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			return t.isUser() ? h(e) : t.isGroup() || t.isBroadcast() ? C(e) : { lidMetadataUpdates: [] };
	...
	function T() {
		return T = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n, r, a = yield R(e), i = a.lidMetadataUpdates, l = a.mapping, s = o("WAArrayUtils").groupByAndMap(i, function(e) {
				return e.shouldWaitForJob ? "waitForJob" : "fireAndForget";
			}, function(e) {
				return e.jobArgs;
			}), u = (n = s.get("waitForJob")) != null ? n : [], c = (r = s.get("fireAndForget")) != null ? r : [];
			return c.length > 0 && o("WAWebUpdateLidMetadataJob").updateLidMetadataJob(c), u.length > 0 && (yield o("WAWebUpdateLidMetadataJob").updateLidMetadataJob(u)), l != null && typeof l == "object" && (yield S({
				mapping: l,
				flushImmediately: t
			})), l;
