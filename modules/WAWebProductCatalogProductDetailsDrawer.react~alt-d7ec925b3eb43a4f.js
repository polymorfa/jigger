__d("WAWebProductCatalogProductDetailsDrawer.react", [
	...
	function I(e) {
		var t = e.isAvailable, n = e.productCatalogFetchState, a = e.productFetchState, i = e.productSanctioned, l;
		a === "ERROR" || a === "TOKEN_RECOVERY_REQUIRED" ? l = y.jsx(o("WAWebText.react").WAWebTextSmall, {
			as: "span",
			xstyle: [k.text, L.marginInline10],
			color: "critical",
			children: s._(
				/*BTDS*/
				""
			)
		}) : t ? l = [y.jsx(o("WAWebSpinner.react").Spinner, {
			size: 14,
			color: "highlight"
		}, "DetailDrawer-loadingBar-spinner"), y.jsx(o("WAWebText.react").WAWebTextSmall, {
			as: "span",
			xstyle: [
				k.text,
				L.marginInline10,
		...
		}, "DetailDrawer-loadingBar-msg")] : i === !0 && o("WAWebBizCatalogGatingUtils").isCountryOfOriginEnabled() ? l = y.jsx(o("WAWebText.react").WAWebTextSmall, {
			as: "span",
			xstyle: [k.text, L.marginInline10],
			color: "critical",
			children: s._(
		...
		}) : l = y.jsx(o("WAWebText.react").WAWebTextSmall, {
			as: "span",
			xstyle: [k.text, L.marginInline10],
			color: "critical",
			children: s._(
		...
		var u = a === "PENDING" || n === "PENDING", c = u || !t;
		return y.jsx("div", babelHelpers.extends({}, (g || (g = r("stylex"))).props(c && k.loadingContainer, !c && k.shiftUp, c && o("WDSPaddings.stylex").wdsPaddings.padding8), { children: l }));
	}
	I.displayName = I.name + " [from " + i.id + "]";
	function T(e) {
		var t = e.handleBack, n = e.menu;
		return y.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			title: s._(
				/*BTDS*/
				""
			),
