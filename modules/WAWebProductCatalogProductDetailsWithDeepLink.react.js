__d("WAWebProductCatalogProductDetailsWithDeepLink.react", [
	"fbt",
	"WAFilteredCatch",
	"WAWebBackendErrors",
	...
	function _(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.onBack, l = a.productInfo, u = l.businessOwnerJid, d = l.productId, _ = p(function() {
			return r("WAWebProductCatalogGetLatestProduct")({
				productId: d,
				businessOwnerJid: u
			});
		}), f = _[0], g = _[1], h = p(function() {
			return f ? "NONE" : "PENDING";
		}), y = h[0], C = h[1], b = function() {
			i(), o("WAWebModalManager").ModalManager.open(c.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			o("WAWebCatalogCollection").CatalogCollection.findProduct({
				...
				g(r("nullthrows")(t).productCollection.get(d)), C("SUCCESS");
		...
		return m(function() {
			f || v();
		}, []), f ? c.jsx(r("WAWebProductCatalogProductDetailsDrawer.react"), {
			ref: n,
			chat: a.chat,
			product: f,
			onEnd: a.onEnd,
			...
			}), c.jsx(r("WAWebDrawerBody.react"), { children: c.jsx(r("WAWebProductCatalogFetchStateTopBar.react"), { fetchState: y }) })]
