__d("WAWebProductCatalogProductListDrawer.react", [
	...
	function h(e) {
		var t = e.businessProfile, n = e.canManageCatalog, o = e.contact, a = e.loadingMore, i = e.onAddProduct, l = e.productCatalogList, s;
		return n && i && (s = c.jsx(r("WAWebManageAddItemCta.react"), {
			onClick: i,
			theme: "in-list",
			testid: "add-item"
		})), c.jsxs(c.Fragment, { children: [t && c.jsx("div", {
		...
		}), c.jsxs("div", babelHelpers.extends({ "data-testid": "catalog-items" }, {
