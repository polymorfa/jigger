__d("WAWebProductCatalogProductTile.react", [
	...
	function c(e) {
		var t = e.fetching, n = e.isAvailable, a = u(o("WAWebDrawerContext").DrawerContext), i = o("useWAWebModelValues").useModelValues(e.product, [
			...
			o("WAWebProductCatalogLogEvents").logDetailImageClick({
				...
				catalogContext: o("WAWebProductCatalogContext").getProductCatalogContext(a)
			});
			var e = function() {
				return t;
			}, r = {
			...
			o("WAWebCmd").Cmd.productImageViewerModal(r, o("WAWebProductCatalogContext").getProductCatalogSessionId(a));
