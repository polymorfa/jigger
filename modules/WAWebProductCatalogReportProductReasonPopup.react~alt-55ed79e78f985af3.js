__d("WAWebProductCatalogReportProductReasonPopup.react", [
	...
	function _(t) {
		var n = t.ref, r = babelHelpers.objectWithoutPropertiesLoose(t, e), a = r.onCancel, i = r.onTellUsMoreSubmit, l = d(null), u = l[0], m = l[1], _ = function() {
			a == null || a();
		}, g = function(t) {
			m(t);
		}, h = function() {
		...
		}), v = c.jsx(o("WAWebButton.react").Button, {
		...
		}, "ReportProductReasonPopup-submitButton"), S = c.jsx(o("WAWebButton.react").Button, {
			type: "secondary",
		...
		}, "ReportProductReasonPopup-cancelButton"), R = { escape: _ }, L = c.jsxs("div", {
			className: "x78zum5 x1s70e7g",
			children: [S, v]
		});
