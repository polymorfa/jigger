__d("WAWebProductCollModel", ["WAWebBaseModel", "WAWebProductCollection"], (function(t, n, r, o, a, i, l) {
	var e = (function(e) {
		function t() {
		...
		return n.initialize = function() {
			e.prototype.initialize.call(this), this.productCollection = new (o("WAWebProductCollection")).ProductCollection(), this.afterCursor = void 0;
