__d("WAWebProductCollectionCollectionsManagementDrawer.react", [
	...
	function S(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, e), l = i.editCollection, u = i.isReorder, d = u === void 0 ? !1 : u, y = i.onBack, S = i.onReorderCollection, R = i.onSeeCollection, L = i.setScrollOffset, E = f(function() {
			return new (r("WAWebFlatListController"))();
		}, []), k = g(null), I = h(!0), T = I[0], D = I[1], x = g(null), $ = h(null), P = $[0], N = $[1], M = h([]), w = M[0], A = M[1], F = h(!1), O = F[0], B = F[1], W = h(!1), q = W[0], U = W[1], V = g(!0), H = p(o("WAWebDrawerContext").DrawerContext), G = f(function() {
			return o("WAWebSelfCatalogLookup").getSelfCatalog();
		}, []), z = m(function(e) {
			var t = (function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					if (G) try {
						var t = new (o("WAWebBizCatalogUtils")).CollectionsDataSource(G, !0, o("WAWebProductCatalogCatalogConstants").PRODUCT_LIST_ITEM_HEIGHT, e);
						if (yield t == null ? void 0 : t.loadInitialItems(), !V.current || !t) return;
						var n = new (o("WAWebBizCatalogUtils")).CatalogListItemScrollHelper(t);
						x.current = t, N(n), A(t.getData()), D(!1), e && o("WAWebUtilsLogQplEvents").qplEndCollectionsManagementView(2);
					} catch (t) {
		...
		_(function() {
			if (G) {
				var e = i.isPushed, t = e === void 0 ? !0 : e;
				G.collections.on("add remove", function() {
					!V.current || !x.current || A(function(e) {
						var t, n = ((t = x.current) == null ? void 0 : t.getData()) || [];
		...
		var j = r("useWAWebThrottledCallback")(function(e, t) {
			L == null || L(t.scrollTop), P != null && P.willLoadMore(t) && D(!0), P == null || P.onScroll(e, t).then(function(e) {
				e && D(!1);
			}).catch(function(e) {
				throw D(!1), e;
			});
			...
			var e = (G == null ? void 0 : G.collections.map(function(e) {
				return e.id;
			...
			var e = (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					try {
						...
						if (!G) return;
						U(!0);
						var t = o("WAWebProductCatalogContext").getProductCatalogContext(H), n = (G == null ? void 0 : G.collections.map(function(e) {
							return e.id;
						...
						var l = yield o("WAWebManageActions").handleCollectionReorder(i, t);
			...
			children: [
				c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
					...
					menu: c.jsx(r("WAWebProductCollectionCollectionsManagementDrawerMenu"), {
						isReorderEnabled: !o("WAWebUA").UA.isSafari && !d && w.length > 1,
						onReorder: S
					})
				}),
