__d("WAWebProductModel", [
	...
	var e = 0, s = 4503599627370496, u = 10, c = (function(e) {
		...
		return n.initialize = function() {
			...
			}), (n = this.videos) == null || n.forEach(function(e, n) {
				t.productImageCollection.gadd({
					id: "_" + (n + r + 1),
			...
			}), this.productImageCollection.filter(function(e, t) {
				return t > r;
			}).forEach(function(e) {
				return e.markOld();
			});
		}, n.triggerMainImageUpdate = function() {
			if (this.imageCdnUrl != null && this.imageCdnUrl !== "") this.productImageCollection.gadd({
				id: "_0",
				...
				var e;
				(e = this.productImageCollection.get("_0")) == null || e.markOld();
			}
		}, n.initImageUpdate = function() {
			if (!this.fetchedFromServer && this.productMsgMediaData) {
				for (var e = 0; e < this.imageCount; e++) this.productImageCollection.gadd({
					id: "_" + e,
					type: "product",
					mediaData: new (r("WAWebMediaData"))({ mediaStage: o("WAWebMediaTypes").MediaDataStage.PREPARING }),
					fetchedFromServer: this.fetchedFromServer,
					old: !1
				}, { merge: !0 });
				return;
			...
			return this.triggerAdditionalImageUpdate(), this.productImageCollection;
			...
			var e, t = this.name, n = this.productImageCollection, r = n.head();
			if (r) {
				var a, i = (e = r.mediaData) == null ? void 0 : e.mediaBlob;
				if (i instanceof Blob ? a = i : a = i.getBlob(), a != null) {
					var l = o("WAWebFileUtils").createFile([a], t + ".jpg", { type: "image/jpeg" });
					return l;
				}
			}
	...
	l.MIN_PRICE = e, l.MAX_PRICE = s, l.MAX_PRODUCT_IMAGES = u, l.Product = d;
}), 98);
