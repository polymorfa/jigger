__d("WAWebProfileCropTool.react", [
	...
	function T(t) {
		var a = t.ref, i = babelHelpers.objectWithoutPropertiesLoose(t, e), l = i.cropOverlay, u = i.drawCanvas, d = i.editedMedia, T = _(0), D = f(""), x = D[0], $ = D[1], P = f(null), N = P[0], M = P[1], w = function(t, n) {
			var e = d.editData, r = T.current * R, o = (t - e.width / 2) * e.scale, a = (t + e.width / 2) * e.scale, i = (n + e.height / 2) * e.scale, l = (n - e.height / 2) * e.scale, s = r / 2, u = r / 2 * S;
			return {
			...
			var e = d.editData, r = T.current, o = (t - e.width / 2) * e.scale, a = (t + e.width / 2) * e.scale, i = (n + e.height / 2) * e.scale, l = (n - e.height / 2) * e.scale;
			return {
				x: o < -r && a > r,
				y: l < -r && i > r
			};
		}, F = function(t, n) {
			var e = d.editData, r = e.offsetX + t / e.scale, o = e.offsetY + n / e.scale, a = i.cropShape === E.RECT ? w(r, o) : A(r, o);
			a.x && (e.offsetX = r), a.y && (e.offsetY = o), u(), Q(t, n, a);
		}, O = function(t, n) {
			var e = t.stageX - n.x, r = t.stageY - n.y;
			F(e, r), n.x = t.stageX, n.y = t.stageY;
		}, B = function(t) {
			var e = T.current, n = d.editData, r = e * R, o = Math.max(t, r / n.width), a = Math.max(t, o);
			n.scale = a;
			...
			var e = T.current, n = d.editData, r = Math.max(2 * e / n.width, 2 * e / n.height), o = Math.max(t, r);
			...
			t === void 0 && (t = y);
			var e = d.editData, n = t !== 0 ? t : y, r = q(e.scale * n);
			r && (e.scale = r.scale, e.offsetX = r.offsetX, e.offsetY = r.offsetY, u()), K(t, k.ENLARGE);
		}, V = function(t) {
			t === void 0 && (t = y);
			var e = d.editData, n = t !== 0 ? t : y, r = q(e.scale / n);
			r && (e.scale = r.scale, e.offsetX = r.offsetX, e.offsetY = r.offsetY, u()), K(t, k.REDUCE);
		};
		o("useWAWebListener").useListener(l.canvas, "mousewheel", function(e) {
			e.deltaY > 0 ? U(C) : V(C);
		}), m(function() {
			d.saveEdits();
			var e = d.editData, t = l.canvas, n;
			...
			var a = t.getContext("2d"), s = t.width, u = t.height, c = s / u > v / b ? u / b : s / v;
			T.current = Math.min(b, v) / 2 * .9 * c;
			var m = T.current, p;
			if (a.fillStyle = h, a.fillRect(0, 0, s, u), a.globalCompositeOperation = "destination-out", a.beginPath(), i.cropShape === E.CIRCLE) a.arc(s / 2, u / 2, m, 0, 2 * Math.PI, !0);
			...
			a.fillStyle = "#ffffff", p ? a.fill(p) : a.fill(), l.addChild(r), l.update();
		}, []);
		var H = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e, t = d.editData, n = (e = d.editedImage) == null ? void 0 : e.src, a = T.current;
				...
				var s = a * R, u = a * R * S, c = yield o("WAWebImageUtils").crop({
					dHeight: l * S,
					dWidth: l,
					...
					sX: t.width / 2 - s / 2,
					sY: t.height / 2 - u / 2
				}), m = c, p = c.images.dataUrl;
				return {
					thumb: m.images.dataUrl,
					full: p
				};
			});
			return function() {
		...
		var j = _(null);
		function K(e, t) {
			var n = 1 - e, r = N != null ? N : 1;
			t === k.ENLARGE ? r += n : r -= n, M(r), Y(r, t);
		}
		function Q(e, t, n) {
			e < 0 ? X(I.RIGHT, n) : e > 0 ? X(I.LEFT, n) : t < 0 ? X(I.DOWN, n) : t > 0 && X(I.UP, n);
		}
		function X(e, t) {
			switch (e) {
				case I.DOWN:
