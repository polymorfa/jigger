__d("WAWebProfileDrawerCoverPhoto.react", [
	...
	function p(e) {
		...
		return o("WAWebABProps").getABPropConfigValue("wds_web_profile_photo") ? u.jsx(r("WAWebFlexItem.react"), {
			xstyle: m.container,
		...
		}) : u.jsx(_, { profilePicThumb: t });
	}
	p.displayName = p.name + " [from " + i.id + "]";
	function _(e) {
		var t, n = e.profilePicThumb, a = o("useWAWebModelValues").useModelValues(n, ["id"]), i = c(null), l = function() {
			var e;
