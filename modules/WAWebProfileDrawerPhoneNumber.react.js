__d("WAWebProfileDrawerPhoneNumber.react", [
	"fbt",
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(14), n = e.myPn, a;
		t[0] !== n ? (a = o("WAWebWidFormat").widToFormattedUser(n), t[0] = n, t[1] = a) : a = t[1];
		var i = a, l;
		...
		var g = f, h;
		t[6] !== _ ? (h = u.jsx(o("WAWebFlex.react").FlexRow, {
			justify: "end",
		...
		var y;
		t[8] === Symbol.for("react.memo_cache_sentinel") ? (y = u.jsx(o("WAWebPhoneIcon.react").PhoneIcon, { xstyle: c.phoneIcon }), t[8] = y) : y = t[8];
		var C;
		t[9] !== i ? (C = u.jsxs(o("WAWebFlex.react").FlexRow, {
			gap: 24,
			align: "center",
			children: [y, u.jsx(o("WAWebFlex.react").FlexColumn, {
				gap: 8,
				children: u.jsx("div", {
		...
		var b;
		if (t[11] !== h || t[12] !== C) {
			var v = u.jsx(r("WAWebDrawerBlock.react"), {
				separator: !1,
				side: h,
				children: C
			});
