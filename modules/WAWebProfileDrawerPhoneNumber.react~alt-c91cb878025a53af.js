__d("WAWebProfileDrawerPhoneNumber.react", [
	...
	function d(e) {
		var t = e.myPn, n = o("WAWebWidFormat").widToFormattedUser(t), a = s._(
			/*BTDS*/
			""
		), i = function() {
			o("WAWebCopyToClipboard").copyTextToClipboard(n).then(function(e) {
			...
			children: u.jsxs(o("WAWebFlex.react").FlexRow, {
				gap: 24,
				align: "center",
				children: [u.jsx(o("WAWebPhoneIcon.react").PhoneIcon, { xstyle: c.phoneIcon }), u.jsx(o("WAWebFlex.react").FlexColumn, {
					gap: 8,
					children: u.jsx("div", {
