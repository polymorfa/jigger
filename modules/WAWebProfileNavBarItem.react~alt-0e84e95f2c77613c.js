__d("WAWebProfileNavBarItem.react", [
	...
	function m(e) {
		var t = e.activeNavBarItem, a = e.updateActiveNavBarItem, i = o("WAWebUserPrefsMeUser").getMeUserOrThrow(), l = async function() {
			if (t !== o("WAWebNavBarTypes").NavBarItems.Profile) {
				...
				if (c) {
					var d = await o("WAWebDrawerManager").DrawerManager.closeDrawerLeftAsync();
					if (!d) return;
				...
				var m = await o("WAWebDrawerManager").DrawerManager.openDrawerLeftAsync(u.jsx(n("cr:1923"), {
					status: e,
					profilePicThumb: l,
					contact: s,
