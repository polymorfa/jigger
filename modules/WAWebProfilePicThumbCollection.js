__d("WAWebProfilePicThumbCollection", [
	...
	var e, s, u, c, d, m, p, _, f = new Set(), g = (function(t) {
		function a() {
			var a, i;
			i = t.call(this) || this, i.findImpl = function(t) {
				var a, i, l, s;
				if (!(t instanceof r("WAWebWid"))) return o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["ProfilePicThumbCollection.findImpl non-WAWebWid id"]))).sendLogs("profile-pic-find-invalid-id"), (_ || (_ = n("Promise"))).reject(r("err")("ProfilePicThumbCollection.findImpl called with a non-WAWebWid id"));
				var u = t.isNewsletter() ? r("WAWebNewsletterCollection") : o("WAWebChatCollection").ChatCollection, c = u.get(t), d = (c == null || (a = c.groupMetadata) == null ? void 0 : a.groupType) === o("WAWebGroupType").GroupType.COMMUNITY, m = r("WAWebUnjoinedSubgroupMetadataCollection").get(t.toString());
				if (c != null && c.isReadOnly && !d && !(c != null && o("WAWebChatGetters").getIsNewsletter(c)) && m == null || c != null && (i = c.groupMetadata) != null && i.terminated || c != null && (l = c.newsletterMetadata) != null && l.terminated || c != null && (s = c.newsletterMetadata) != null && s.isPreview) return (_ || (_ = n("Promise"))).resolve({
					id: t,
					stale: !0
				});
				if (t.isAiHub() || o("WAWebBotUtils").isBotChannelFBID(t) || o("WAWebBotUtils").isWidTeeGroupMetaBotFbidWid(t)) return (_ || (_ = n("Promise"))).resolve({ id: t });
				if ((r("WAWebWid").isUser(t) || r("WAWebWid").isGroup(t) || r("WAWebWid").isNewsletter(t)) && !r("WAWebWid").isPSA(t)) {
					var p, f = d ? t : c == null || (p = c.groupMetadata) == null ? void 0 : p.parentGroup;
					m != null && (f = m.parentGroupId);
					var g = o("WAWebSocketModel").Socket.stream !== o("WAWebSocketConstants").SOCKET_STREAM.DISCONNECTED || o("WAWebVoipGatingUtils").isGuestViewer() && o("WAComms").isSocketConnected();
					if (g) {
						var h;
						if (r("WAWebWid").isUser(t)) {
							var y, C = o("WAWebContactCollection").ContactCollection.get(t), b = o("WAWebChatCollection").ChatCollection.get(t);
							return o("WAWebContactProfilePicThumbBridge").requestProfilePicFromServer({
								id: t,
								parentGroupId: f,
								tcToken: b == null ? void 0 : b.tcToken,
								commonGid: (b == null ? void 0 : b.tcToken) == null ? C == null || (y = C.maybeCommonGroupChatModel) == null ? void 0 : y.id : null
							});
						}
						return o("WAWebContactProfilePicThumbBridge").requestProfilePicFromServer({
							id: t,
							parentGroupId: f,
							newsletterRole: t.isNewsletter() ? (h = r("WAWebNewsletterMetadataCollection").get(t)) == null ? void 0 : h.membershipType : void 0
						});
					}
		...
		return i._mirrorMeRow = function(t) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this;
				try {
					var n = yield o("WAWebContactProfilePicThumbBridge").profilePicResync(e.map(function(e) {
						if (e.isRegularUser()) {
					...
					o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["ProfilePicThumbStore:resyncPictures success"]))), n.forEach(function(e) {
						var n = t._getUpdatedProfilePicModel(e), r = t.get(e.id);
			...
			var e = this;
			return t.length === 0 ? (_ || (_ = n("Promise"))).resolve() : o("WAWebContactProfilePicThumbBridge").profilePicResync(t.map(function(e) {
	...
	g.model = o("WAWebProfilePicThumbModel").ProfilePicThumb, g.cachePolicy = {
