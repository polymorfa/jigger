__d("WAWebPruneExpiredMessagesWithAddOns", [
	...
	async function s() {
		...
		var t = await o("WAWebDBEphemeralMessage").pruneExpiredMessages(), n = t.length;
		if (n > 0) {
			var a = [], i = new Set();
