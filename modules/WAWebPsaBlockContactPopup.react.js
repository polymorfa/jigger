__d("WAWebPsaBlockContactPopup.react", [
	"fbt",
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = e.onBlock, n = e.onCancel, a = u.jsxs(u.Fragment, { children: [
			s._(
				/*BTDS*/
				""
			),
		...
		] }), i = o("WAWebFaqUrl").getWAChatFaqUrl(), l = function(t) {
			t.preventDefault(), o("WAWebModalManager").ModalManager.close("none"), self.setTimeout(function() {
