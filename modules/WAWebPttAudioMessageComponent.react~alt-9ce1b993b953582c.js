__d("WAWebPttAudioMessageComponent.react", [
	...
	function _(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.msg, l = o("useWAWebMsgValues").useMsgValues(a.msg.id, [
		...
		]), u = l[0], d = l[1], _ = l[2], g = l[3], h = p(null);
		if (o("useWAWebMsgDownloadMedia").useMsgDownloadMedia(i), m(n, function() {
			return { handleKeyActivation: function(t) {
				var e;
				(e = h.current) == null || e.handleKeyActivation(t);
			} };
		}), _ != null && !u) {
			var y = a.enableKbSeekSpeedChange, C = babelHelpers.objectWithoutPropertiesLoose(a, s);
			return c.jsx(o("WAWebPttMessageComponent.react").Ptt, babelHelpers.extends({}, C));
		}
		var b = a.displayAuthor && d ? c.jsx(r("WAWebMessageAuthor.react"), {
			msg: i,
			contact: d,
	...
	function f(e) {
		...
		]), r = n[0], a = n[1], i = n[2], l = n[3], s = c.jsx(o("WAWebDetailImage.react").DetailImage, {
			id: l,
			size: 55
		});
		return i ? s : r == null ? c.jsx("div", {
