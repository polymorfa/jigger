__d("WAWebPttComposer.react", [
	...
	function g(e) {
		var t, a = e.chat, i = e.onComplete, l = e.recordingSession, u = m(), g = m(), C = p(function() {
			switch (l.recordingState) {
				...
				default: throw r("err")("Invalid recording session state: " + l.recordingState);
			}
		}), b = C[0], v = C[1], S = (t = o("useWAWebChatValues").useOptionalChatValues(a.id, [
			...
			null,
			null
		], R = S[0], L = S[1], E = S[2], k = p(null), I = k[0], T = k[1], D = p(function() {
			return b === _.PREVIEW ? l.getAudioForPlayback() : null;
		}), x = D[0], $ = D[1];
		d(function() {
			if (x != null) return o("WAWebPttTsExternalLogger").attachPttPlayTimeSpentLogger(x.getAudio());
		}, [x]);
		var P = function() {
			$(null), x == null || x.dispose();
		}, N = x == null ? void 0 : x.getAudio(), M = m(), w = m(), A = m(l);
		A.current = l;
		...
		var G = p(null), z = G[0], j = G[1], K = o("useWAWebPttRecordingSessionValues").usePttRecordingSessionValues(l, [
		...
		]), Q = K[0], X = K[1], Y = K[2], J = o("useWAWebSetModelValue").useSetModelValue(l, "isViewOnce"), Z = p(Y), ee = Z[0], te = Z[1], ne = function() {
			te(!1), J(!Y);
		};
		o("useWAWebListener").useListener(l, "change:recordingState", function() {
			(l.recordingState === o("WAWebRecordingSessionStateEnum").RecordingSessionState.STOPPED || l.recordingState === o("WAWebRecordingSessionStateEnum").RecordingSessionState.ERROR) && i();
		});
		var re = r("useWAWebEventTargetValue")(N, ["play", "pause"], function() {
			return N != null && !N.paused;
		}), oe = h(), ae = function() {
			l.stop(o("WAWebPttComposerRecordingSession").RecordingSessionStopReason.CANCEL_BUTTON), o("WAWebPttMessageUserJourneyLogger").PttMessageUserJourneyLogger.delete(a.id, E != null);
		};
		d(function() {
			...
			b === _.PREVIEW && (A.current.markDraftPreviewSeen(), self.setTimeout(function() {
				var e;
				(e = w.current) == null || e.focus();
			}, 100));
		}, [b]), r("useWAWebOnUnmount")(function() {
		...
		var ie = function(n) {
			...
			if (Q) {
				var t = g.current;
				if (R && o("WAWebNewsletterWamoSubUtils").newsletterSupportsSubscriptions(L) && t && o("WAWebNewsletterGatingUtils").isWamoSubCreatorExperienceSupported()) {
					var n = function(t) {
						ie(t === o("WAWebNewsletterWamoSubMessageType").NewsletterWamoSubMessageType.WamoSub);
					};
					T({
						popupAnchorEl: t,
						handleSelect: n
				...
				e.onSend == null || e.onSend(), o("WAWebPttMessageUserJourneyLogger").PttMessageUserJourneyLogger.send(a.id, E != null);
			}
		};
		o("useWAWebListener").useListener(l, "change:recordingState", function() {
			if (!o("WAWebPttComposerRecordingSessionGetters").getIsRecording(l) && l.recordingState === o("WAWebRecordingSessionStateEnum").RecordingSessionState.PAUSED) {
				P();
		...
		var se = function() {
			l.incrementPauseButtonCount(), l.pause(), o("WAWebPttMessageUserJourneyLogger").PttMessageUserJourneyLogger.pause(a.id, E != null);
		}, ue = function() {
			n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				N == null || N.pause(), v(_.RECORDER);
				var e = yield l.resume();
				e || v(_.PREVIEW), o("WAWebPttMessageUserJourneyLogger").PttMessageUserJourneyLogger.resume(a.id, E != null);
			})();
		}, ce = function() {
			var e = r("nullthrows")(N);
		...
		o("useWAWebListener").useListener(o("WAWebCmd").Cmd, "pause_ptt_recording", function() {
			...
			e();
		}), o("useWAWebListener").useListener(o("WAWebCmd").Cmd, "send_ptt_recording", le), o("useWAWebListener").useListener(N, "ended", function() {
			r("nullthrows")(N).load();
		});
		var de = c(function() {
			var e;
			return (e = N == null ? void 0 : N.currentTime) != null ? e : 0;
		}, [N]), me = r("useWAWebStableCallback")(function() {
			...
			H(e), j(null), r("nullthrows")(N).currentTime = e, l.incrementDraftSeekCount();
		...
		}), be = !a.contact.isEnterprise && !o("WAWebUserPrefsMeUser").isMeAccount(a.contact.id) ? s.jsx(r("WAWebAttachMediaViewOnceInChat.react"), {
			chat: a,
		...
		}) : null, ve = z != null ? z : U ? F : B, Se = s.jsxs("div", {
			...
			children: [
				...
				s.jsx("div", {
					...
					children: s.jsxs(r("WAWebVelocityTransitionGroup"), {
						transitionName: "fade",
						children: [b === _.RECORDER ? Ce : null, b === _.PREVIEW ? Se : null]
					})
				}),
				ye,
				be,
				...
				I != null && s.jsx(r("WAWebNewsletterWamoSubMessageTypePopup.react"), {
	...
	function h() {
		var e = o("react-compiler-runtime").c(2), t = p(!1), n = t[0], r = t[1], a, i;
	...
	function y(e) {
		var t = o("react-compiler-runtime").c(5), n = e.time, r;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (r = { className: "x2c5eco xunn93x" }, t[0] = r) : r = t[0];
		var a;
		t[1] !== n ? (a = o("WAWebClock").Clock.durationStr(n), t[1] = n, t[2] = a) : a = t[2];
		var i;
		return t[3] !== a ? (i = s.jsx("div", babelHelpers.extends({}, r, {
			role: "timer",
			children: a
		})), t[3] = a, t[4] = i) : i = t[4], i;
	}
