__d("WAWebPttComposerRecordingSession", [
	...
	var e, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $, P, N, M, w, A = w || (w = o("react")), F = 1, O = 8.5, B = 64, W = (function(t) {
		function a() {
		...
		return i.initialize = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				}), i = a.handleEncryptionStart, l = a.handleEncryptionSuccess, s = a.handleSendMessageStart, u = a.handleStreamUploadStart, f = a.handleUploadAttemptError, g = a.handleUploadAttemptSuccess, h = a.handleUploadError, y = a.handleUploadHostFound, C = a.handleUploadProgress, b = a.handleUploadSuccess;
				...
				try {
					if (o("WAWebUploadStreamerRefactorGatingUtils").isUploadStreamerRefactorEnabled()) {
						...
						this._earlyUploadPromise = new (M || (M = (n("Promise"))))(function(e) {
							t._resolveEarlyUploadPromise = e;
						});
						var S = new AbortController();
						this._uploaderAbortController = S;
						var R = yield o("WAMediaCalculateFilehash").getRandomFilehash(), L = new (o("WAWebMmsClientUploadStreamer")).UploadStreamer({
							encFilehash: R,
							token: R,
							type: o("WAWebMmsMediaTypes").MEDIA_TYPES.PTT,
							signal: S.signal,
						...
						L.startUploadFromClient(), this._encryptor = yield o("WAWebPttComposerStreamingEncryptor").createStreamingEncryptor({
							mediaKey: v.key,
							onChunkEncrypted: (function() {
								var a = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
									try {
										...
										if (t._resolveEarlyUploadPromise == null || t._resolveEarlyUploadPromise(null), t._hasStreamingUploadFailed = !0, a.name === o("WAAbortError").ABORT_ERROR) return;
										o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["onChunkEncrypted: ptt-streaming-upload-error"]))).catching(a), o("WALogger").ERROR(c || (c = babelHelpers.taggedTemplateLiteralLoose(["PTT Streaming Upload cancelled due to a problem uploading"]))).sendLogs("ptt-streaming-upload-failed"), h(a);
									}
								});
								function i(e) {
							...
							onEncryptionCompleted: (function() {
								var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, n) {
									...
									try {
										...
										if (t._resolveEarlyUploadPromise == null || t._resolveEarlyUploadPromise(null), t._hasStreamingUploadFailed = !0, i.name === o("WAAbortError").ABORT_ERROR) return;
										o("WALogger").ERROR(d || (d = babelHelpers.taggedTemplateLiteralLoose(["onEncryptionCompleted: ptt-streaming-upload-error"]))).catching(i), o("WALogger").ERROR(m || (m = babelHelpers.taggedTemplateLiteralLoose(["PTT Streaming Upload cancelled due to a problem when finalizing upload"]))).sendLogs("ptt-streaming-upload-failed"), h(i);
									}
								});
								function a(t, n) {
					...
					var E;
					throw (E = this._uploadQpl) == null || E.endFailWithError("upload_setup_failed", r("getErrorSafe")(e).message), this._uploadQpl = null, e;
				}
				try {
					var k, I = !0;
					this._recorder = new (r("WAPttComposerRecorder"))({
						...
						onPage: function(n, r) {
							if (!(!o("WAWebUploadStreamerRefactorGatingUtils").isUploadStreamerRefactorEnabled() || t._hasStreamingUploadFailed)) try {
								var e;
								I && (i(), I = !1), (e = t._encryptor) == null || e.encryptChunk(n, r);
							} catch (e) {
					...
					if (T) return this.recordingState = o("WAWebRecordingSessionStateEnum").RecordingSessionState.RECORDING, o("WAWebAppTracker").AppTracker.start(o("WAWebAppTracker").AppTrackerType.RecordPTT), o("WAWebPresenceCollection").PresenceCollection.update(this._chat.presence.id), o("WAWebPttDailyUtils").incrementPttDailyCount(o("WAWebPttDailyUtils").PttDailyCountKind.RECORD, r("nullthrows")(o("WAWebFrontendChatGetters").getKind(this._chat))), !0;
					(k = this._uploadQpl) == null || k.endFailWithError("recording_failed", "recorder_did_not_start"), this._uploadQpl = null;
				} catch (e) {
					var D;
					(D = this._uploadQpl) == null || D.endFailWithError("recording_failed", r("getErrorSafe")(e).message), this._uploadQpl = null, o("WALogger").ERROR(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["PTT Recording Error"]))).catching(r("getErrorSafe")(e));
				}
			...
			return r("WAPttComposerScaleWaveform")(this.getCorrectedWaveformSamples(), B).map(function(e) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				try {
					var e = r("nullthrows")(this._recorder), t = yield e.resume();
			...
			if (this.recordingState !== o("WAWebRecordingSessionStateEnum").RecordingSessionState.STOPPED && (this.recordingState = o("WAWebRecordingSessionStateEnum").RecordingSessionState.STOPPED, o("WAWebAppTracker").AppTracker.stop(o("WAWebAppTracker").AppTrackerType.RecordPTT), this._endSession(), this._endUploadQpl(t), this._recorder != null)) {
				t === o("WAWebPttComposerRecordingStopReason").RecordingSessionStopReason.SENT ? o("WAWebPttDailyUtils").incrementPttDailyCount(o("WAWebPttDailyUtils").PttDailyCountKind.SEND, r("nullthrows")(o("WAWebFrontendChatGetters").getKind(this._chat))) : this.duration > F && o("WAWebPttDailyUtils").incrementPttDailyCount(o("WAWebPttDailyUtils").PttDailyCountKind.CANCEL, r("nullthrows")(o("WAWebFrontendChatGetters").getKind(this._chat))), t !== o("WAWebPttComposerRecordingStopReason").RecordingSessionStopReason.SENT && this._uploaderAbortController && this._uploaderAbortController.abort();
				var e = V(t);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					...
					var e = r("nullthrows")(this._recorder), t = yield e.getCompleteRecording();
					o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose([
						"WAWebPttComposerRecordingSession: Got complete recording, size: ",
						" bytes, type: ",
						""
					])), t.size, t.type);
					var n = yield r("WAWebMediaOpaqueData").createFromData(t, t.type);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = r("nullthrows")(this._recorder), t = yield e.getPartialRecording(), n = yield o("WAWebMediaLoad").transcode(t);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = e.isQuestion, n = t === void 0 ? !1 : t, a = e.isViewOnce, i = a === void 0 ? !1 : a, l = e.isWamoSub, s = e.questionReplyQuotedMessage, u = e.threadId;
				try {
					var c, d;
					...
					try {
						yield _.catch(o("WAAbortError").catchAbort(r("WAWebNoop"))), o("WALogger").LOG(x || (x = babelHelpers.taggedTemplateLiteralLoose(["WAWebPttComposerRecordingSession: getData completed or was aborted"])));
					} catch (e) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t, n = r("nullthrows")(this._recorder), a = yield n.getCompleteRecording();
				new (o("WAWebPttWamEvent")).PttWamEvent({
					...
					pttSize: Math.round(((t = a.size) != null ? t : 0) / 1e3) * 1e3,
	...
	function G() {
		return G = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (r("WAWebCallCollection").activeCall) return o("WAWebModalManager").ModalManager.open(A.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			try {
				...
				if (e instanceof o("WAWebGetUserMediaErrors").NotAllowedError) {
					var i;
					return o("WAWebModalManager").ModalManager.open(A.jsx((i = o("WAWebGuidePopup.react")).GuidePopup, {
	...
	var z = (function() {
		function e(e) {
			...
			this._audio = r, this._unregisterFromAudioChannel = o("WAWebPttAudioChannels").MainAudioChannel.registerMedia(r), n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = yield t._opaqueDataPromise, n = t._audio;
				n != null && (n.src = e.url());
			})();
		}
		var t = e.prototype;
		return t.getAudio = function() {
			...
			t != null && (this._unregisterFromAudioChannel(), this._audio = null, n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var t = yield e._opaqueDataPromise;
				t.autorelease();
			})());
		}, e;
	})();
	l.RecordingSessionStopReason = o("WAWebPttComposerRecordingStopReason").RecordingSessionStopReason, l.RecordingSession = q, l.createRecordingSession = U, l.AudioResource = z;
}), 226);
