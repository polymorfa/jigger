__d("WAWebPttPlayPauseButton.react", [
	...
	function p(t) {
		var n = t.ref, o = babelHelpers.objectWithoutPropertiesLoose(t, e), a = o.disabled, i = a === void 0 ? !1 : a, l = o.onConfirm, c = o.paused, p = o.tabOrder, _ = o.theme, f = function(t) {
			t != null && l(t);
		}, g = c ? s._(
			/*BTDS*/
			""
		...
		return d.jsx("div", babelHelpers.extends({ "aria-label": g }, (u || (u = r("stylex"))).props([
			...
			tabOrder: p,
			title: g,
			icon: r(c ? "WDSIconIcPlayArrowFilled.react" : "WDSIconIcPauseFilled.react")
		}) }));
	}
