__d("WAWebPttPlaybackWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ PttPlayback: [
		2044,
		{
			audioStreamType: [19, o("WAWebWamEnumAudioStreamType").AUDIO_STREAM_TYPE],
			...
			pttAudioRouteInitial: [21, o("WAWebWamEnumAudioOutputRoute").AUDIO_OUTPUT_ROUTE],
			pttAudioRouteLast: [22, o("WAWebWamEnumAudioOutputRoute").AUDIO_OUTPUT_ROUTE],
			...
			pttPlaybackSpeed: [10, o("WAWebWamEnumPttPlaybackSpeedType").PTT_PLAYBACK_SPEED_TYPE],
