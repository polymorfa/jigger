__d("WAWebPttWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ Ptt: [
		458,
		{
			audioDriverRestartCount: [52, e.TYPES.INTEGER],
			audioDriverRestartReason: [53, e.TYPES.INTEGER],
			deviceAgcState: [54, o("WAWebWamEnumDeviceAgcStateType").DEVICE_AGC_STATE_TYPE],
			deviceNsState: [55, o("WAWebWamEnumDeviceNsStateType").DEVICE_NS_STATE_TYPE],
			...
			pttWaveformResult: [51, o("WAWebWamEnumPttWaveformResult").PTT_WAVEFORM_RESULT]
		},
		[
			1,
			1,
