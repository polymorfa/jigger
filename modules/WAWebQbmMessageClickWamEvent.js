__d("WAWebQbmMessageClickWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ QbmMessageClick: [
		5178,
		{
			bizTrustTier: [10, e.TYPES.STRING],
			bodyUrlCountInt: [27, e.TYPES.INTEGER],
			bodyUrlUniqueCountInt: [28, e.TYPES.INTEGER],
			buttonClickedType: [1, o("WAWebWamEnumQbmMessageClickButtonClickedType").QBM_MESSAGE_CLICK_BUTTON_CLICKED_TYPE],
			buttonValueJsonArray: [20, e.TYPES.STRING],
			chatsFolderType: [2, o("WAWebWamEnumChatsFolderType").CHATS_FOLDER_TYPE],
			...
			iasEntryPoint: [33, o("WAWebWamEnumSignupEntryPoint").SIGNUP_ENTRY_POINT],
			...
			pillEntryPoint: [37, o("WAWebWamEnumPillEntryPoint").PILL_ENTRY_POINT],
			...
			thumbnailType: [12, o("WAWebWamEnumThumbnailType").THUMBNAIL_TYPE],
