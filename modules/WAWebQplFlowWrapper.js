__d("WAWebQplFlowWrapper", ["QPLUserFlow"], (function(t, n, r, o, a, i, l) {
	var e = {
		markerStart: function(t, n) {
			var e, o = (e = n == null ? void 0 : n.instanceKey) != null ? e : 0;
			return r("QPLUserFlow").start(t, {
				...
				addPoint: function(n, a) {
					...
					}), (a == null ? void 0 : a.data) != null && r("QPLUserFlow").addAnnotations(t, a.data, { instanceKey: o });
				},
				end: function(n, r) {
					s(t, n, {
						instanceKey: o,
		...
		markerAnnotate: function(t, n, o) {
			r("QPLUserFlow").addAnnotations(t, n, { instanceKey: o == null ? void 0 : o.instanceKey });
		},
		markerPoint: function(t, n, o) {
			r("QPLUserFlow").addPoint(t, n, {
				instanceKey: o == null ? void 0 : o.instanceKey,
				timestamp: o == null ? void 0 : o.timestamp
			}), (o == null ? void 0 : o.data) != null && r("QPLUserFlow").addAnnotations(t, o.data, { instanceKey: o == null ? void 0 : o.instanceKey });
		},
	...
	function s(e, t, n) {
		var o = n == null ? void 0 : n.instanceKey, a = n == null ? void 0 : n.timestamp;
		e: {
			if (t === 2) {
