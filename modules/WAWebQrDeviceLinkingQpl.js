__d("WAWebQrDeviceLinkingQpl", [
	...
	var e, s = (e = r("justknobx")._("4967")) != null ? e : 3e5, u = r("qpl")._(891431698, "3260"), c = function(t) {
		...
		return t.$4 = function(t) {
			...
			var e, n;
			(e = this.$1) == null || e.end(t), this.$1 = null, window.clearTimeout(this.$2), (n = this.$3) == null || n.call(this);
		}, t.initialize = function(t) {
			var e = this;
			this.$1 != null && this.$5(105), r("justknobx")._("4836") && (this.$1 = o("WAWebQplFlowWrapper").QPL.markerStart(u, {
				trackedForLoss: !0,
				cancelOnUnload: !0,
				annotations: {
					bool: { in_auto_logout_iframe: o("WAWebAutoLogoutGating").isRunningInAutoLogoutIframe() },
					int: { md_link_device_experience_id: o("WAWebLinkDeviceExperience").getWebCompanionLinkDeviceExperienceId(t) },
					string: { code_type: o("WAWebPairingType").PairingType.QR_CODE }
				}
			...
			this.$4(t ? "stay_logged_in_enabled" : "stay_logged_in_disabled"), this.$5(105);
		}, e;
	})(), m = new d();
