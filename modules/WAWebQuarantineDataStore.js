__d("WAWebQuarantineDataStore", [
	...
	function e(e) {
		...
		for (var n of e) {
			...
			if (o("WAWebCommonMsgUtils").isQuarantinedMsg(n.type) && r != null) {
				var a, i, l = (a = (i = t[0]) == null ? void 0 : i.createdAt) != null ? a : o("WATimeUtils").unixTimeMs();
				t.push({
					msgId: n.id.toString(),
					originalProtobuf: r,
					createdAt: l
	...
	l.extractQuarantineDataFromMessages = e, l.bulkCreateOrReplaceQuarantineData = s, l.bulkDeleteQuarantineData = c, l.getQuarantineData = m, l.getQuarantineDataBatchOlderThan = _, l.getQuarantineDataBatch = g, l.deleteQuarantineData = y;
}), 98);
