__d("WAWebQueryAndUpdateNewslettersMetadataAction", [
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			...
			try {
				var a, i, l = o("WAWebNewsletterRoleIdentifier").getRoleByIdentifier(t), c = yield o("WAWebNewsletterMetadataJob").getNewsletterMetadata(t, l, n == null ? void 0 : n.fields);
				if (c == null) return;
				var d = o("WAWebNewsletterModelUtils").mapNewsletterToChat(c), m = o("WAWebNewsletterModelUtils").mapNewsletterToMetadata(c), p = (a = c.newsletterPictureMetadataMixin) == null ? void 0 : a.picture, _ = p ? [o("WAWebNewsletterModelUtils").mapPicturesToProfilePicThumb(t, p)] : [], f = yield v(t, n == null ? void 0 : n.adminFields), g = f.adminCount, h = f.adminProfile, y = f.adminProfilesSettingEnabled, C = void 0;
				return (n == null || (i = n.adminFields) == null ? void 0 : i.capabilities) === !0 && (C = yield o("WAWebNewsletterGetAdminCapabilitiesJob").getNewsletterAdminCapabilities(t)), yield R({
					chats: [d],
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			var l = yield o("WAWebNewsletterGetAdminInfoJob").getNewsletterAdminInfo(e);
			return {
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.addSystemMsgs, a = e.chats, i = e.messageCount, l = e.metadata, s = e.pics, u = e.qplEvent;
			o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[newsletters][updateCollections] Start"])));
			var C = E(a, l, s), b = C.filteredChats, v = C.filteredMetadata, S = C.filteredPics;
			u == null || u.addPoint("updateNewsletterChatRecords_start"), yield o("WAWebNewsletterUpdateNewslettersRecordsJob").updateNewsletterChatRecords(b.map(o("WAWebCreateChat").createNewsletterObjectForStorage)), u == null || u.addPoint("updateNewsletterChatRecords_end"), o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[newsletters][updateCollections][chat] Persist changes to DB"]))), u == null || u.addPoint("updateNewsletterMetadata_start"), yield o("WAWebNewsletterMetadataJob").updateNewsletterMetadata(v.map(o("WAWebNewsletterStorageUtils").createNewsletterMetadataObjectForStorage)), u == null || u.addPoint("updateNewsletterMetadata_end"), o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["[updateCollections][metadata] persisted to DB"]))), u == null || u.addPoint("bulkPersistProfilePicChanges_start"), yield o("WAWebDBBulkPersistProfilePic").bulkPersistProfilePicChanges(r("compactMap")(S, function(e) {
				var t, n, r, a;
			...
			}))), u == null || u.addPoint("pullNewsletterMessagesFromServer_end"), o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["[queryAndUpdateAllNewsletterMetadataAction][msg] end"]))), u == null || u.addPoint("contactUpdates_start");
			...
			o("WAWebContactCollection").ContactCollection.add(R, { merge: !0 }), u == null || u.addPoint("contactUpdates_end");
	...
	l.NewsletterMetadataUpdateEntryPoint = o("WAWebCommonNewsletterEnums").NewsletterMetadataUpdateEntryPoint, l.queryAndUpdateNewsletterMetadataAction = C, l.updateCollections = R;
}), 98);
