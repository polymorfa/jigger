__d("WAWebQueryCatalog", [
	...
	var e, s, u, c = (function() {
		var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				var r, a, i, l, u = t.afterCursor, c = t.allowShopSource, d = t.catalogWid, m = t.checkmarkCollectionId, p = t.directConnectionEncryptedInfo, _ = t.height, f = t.limit, g = t.variantInfoFields, h = t.variantThumbnailHeight, y = t.variantThumbnailWidth, C = t.width, b = yield o("WAWebRelayClient").fetchQuery(e !== void 0 ? e : e = n("WAWebQueryCatalogQuery.graphql"), { request: { product_catalog: {
					jid: (r = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(d)) != null ? r : d.toString(),
		...
		var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.afterCursor, r = e.allowShopSource, a = e.catalogWid, i = e.checkmarkCollectionId, l = e.directConnectionEncryptedInfo, s = l === void 0 ? null : l, c = e.height, d = e.limit, m = e.variantInfoFields, p = e.variantThumbnailHeight, _ = e.variantThumbnailWidth, f = e.width;
			if (o("WAWebBizCatalogGatingUtils").commerceFeaturesDisabledBySanctions()) throw new (o("WAWebBackendErrors")).E451();
			var g = yield o("WAWebBizCatalogManagementFetchCatalog").fetchCatalog({
				product_catalog: {
					jid: (t = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(a)) != null ? t : a.toJid(),
					after: n,
					limit: String(d),
					width: String(f),
					height: String(c),
