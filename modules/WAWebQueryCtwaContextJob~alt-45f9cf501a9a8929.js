__d("WAWebQueryCtwaContextJob", [
	...
	var e, s = new (r("WADeprecatedWapParser"))("ctwaContext", function(e) {
		...
		if (e.hasChild("error")) throw c(e.child("error")), r("err")("invalid response");
		var n = {
	...
	async function u(e, t, n) {
		...
		}, a.wap("account_number", null, i), a.wap("code", null, t), a.wap("expected_source_url", null, n)), u = await o("WADeprecatedSendIq").deprecatedSendIq(l, s);
