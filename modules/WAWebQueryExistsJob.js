__d("WAWebQueryExistsJob", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			e.type === "phone" ? (r.withContactProtocol(o("WAWebUsync").USYNC_ADDRESSING_MODE.LID), n.withPhone(e.phone)) : n.withId(e.wid), o("WAWebABProps").getABPropConfigValue("username_antiscraping_send_cached_un") === !0 && (yield _(n, e)), r.withUser(n), r.withBusinessProtocol(), r.withDisappearingModeProtocol(), r.withUsernameProtocol();
			...
			var u = s[0], c = u.business, d = u.contact, m = u.id, p = u.lid, f = u.pn, g = u.username, h = s[0].disappearingMode;
			...
			var C = null, b = null;
			return m.isLid() ? (C = f, b = m) : (C = m, p != null && (b = o("WAWebWidFactory").createUserWidOrThrow(p, "lid"))), C != null && b != null && (yield o("WAWebDBCreateLidPnMappings").createLidPnMappings({
				mappings: [{
					pn: C,
					lid: b
				}],
			...
			}), !m.isLid() && o("WAWebUsernameWorkerCompatibleGatingUtils").onlyShowLidContacts() && (y.wid = b)), yield o("WAWebHandleUsernameSync").handleUsernameSync(i), o("WAWebContactSyncLogger").contactSyncLogger.logSuccess(a, i), y;
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = p(t);
			if (n != null) {
				var r = o("WAWebUsernameTypes").serializeMaybeUsername(yield o("WAWebApiContactUsernameFields").getContactUsername(n));
		...
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (e.isLid()) {
				...
				if (o("WAWebABProps").getABPropConfigValue("mex_usync_username_query")) {
					var a = o("WAWebWidFactory").createUserWidOrThrow(e.toString()), i = yield o("WAWebMexUsersGetUsername").getMexUserUsername(a);
				...
				if (n != null) {
					...
					if (m != null) {
						...
						s = (_ == null ? void 0 : _.usernameChanged) === !0, u = (_ == null ? void 0 : _.wasPreviouslyKnown) === !0, c = (_ == null ? void 0 : _.isPhoneNumberKnown) === !0, d = o("WAWebUsernameTypes").serializeMaybeUsername(_ == null ? void 0 : _.oldUsername);
					} else if (r === !0) {
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			if (p != null) {
				p.isLid() && d != null && d.pn != null && (yield o("WAWebDBCreateLidPnMappings").createLidPnMappings({
					mappings: [{
						pn: d.pn,
						lid: p
					}],
	...
	l.queryWidExists = u, l.queryPhoneExists = c, l.queryExist = d, l.queryWidUsernameExists = y, l.queryUsernameExists = b;
}), 98);
