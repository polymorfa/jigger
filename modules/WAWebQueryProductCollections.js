__d("WAWebQueryProductCollections", [
	...
	var e, u, c, d = (function() {
		var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				var r, a = t.afterCursor, i = t.catalogWid, l = t.directConnectionEncryptedInfo, s = t.height, c = t.limit, d = t.productsCount, m = t.variantInfoFields, p = t.variantThumbnailHeight, _ = t.variantThumbnailWidth, f = t.width, g = yield o("WAWebRelayClient").fetchQuery(e !== void 0 ? e : e = n("WAWebQueryProductCollectionsQuery.graphql"), { request: { collections: {
					biz_jid: (r = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(i)) != null ? r : i.toString(),
		...
		var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t;
			if (o("WAWebBizCatalogGatingUtils").commerceFeaturesDisabledBySanctions()) throw new (o("WAWebBackendErrors")).E451();
			var n = e.afterCursor, r = e.catalogWid, a = e.directConnectionEncryptedInfo, i = e.height, l = e.limit, s = e.productsCount, u = e.variantInfoFields, d = e.variantThumbnailHeight, m = e.variantThumbnailWidth, p = e.width, _ = yield o("WAWebBizCatalogManagementFetchCollections").fetchCollections({ collections: {
				biz_jid: (t = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(r)) != null ? t : r.toJid(),
				after: n,
