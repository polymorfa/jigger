__d("WAWebQueryProductListCatalogJob", [
	...
	var e, s, u, c = new (r("WADeprecatedWapParser"))("productListResponse", function(e) {
		...
		var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.catalogWid, a = e.directConnectionEncryptedInfo, i = e.height, l = e.productIds, s = e.width, u = (t = o("WAWap")).wap("iq", {
				to: t.S_WHATSAPP_NET,
				type: "get",
				smax_id: t.SMAX_ID(r("WAWapDeprecatedSmaxID").CatalogGetProductList),
				xmlns: "w:biz:catalog",
				id: t.generateId()
			}, t.wap("product_list", { jid: o("WAWebCommsWapMd").USER_JID(o("WAWebWidFactory").createWid(n)) }, l.map(function(e) {
		...
		var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			try {
				var a, i, l = t.catalogWid, u = t.directConnectionEncryptedInfo, c = t.height, m = t.productIds, p = t.width, _ = yield o("WAWebRelayClient").fetchQuery(e !== void 0 ? e : e = n("WAWebQueryProductListCatalogJobQuery.graphql"), { request: { product_list: {
					jid: (a = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(o("WAWebWidFactory").createWid(l))) != null ? a : l.toString(),
				...
				return e instanceof o("WAWebGraphQLServerError").GraphQLServerError && o("WAWebMaybeThrowCatalogErrors").maybeThrowLocalErrorForCatalogQuery(e), o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["xwa_product_catalog_get_product_list failed, IQ fallback"]))), d(t);
			}
		});
		return function(n) {
		...
		var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.catalogWid, r = e.directConnectionEncryptedInfo, a = e.height, i = e.productIds, l = e.width, s = yield o("WAWebBizCatalogManagementFetchProductList").fetchProductList({ product_list: {
				jid: (t = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(o("WAWebWidFactory").createWid(n))) != null ? t : n.toString(),
			...
			return s.type === "success" ? s.productsResult : (s.type === "graphql-error" ? o("WAWebMaybeThrowCatalogErrors").maybeThrowLocalErrorForCatalogQuery(s.error) : s.type, o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["queryProductListGraphQLByOwner: unhandled error ", ""])), JSON.stringify(s)), d(e));
		});
		return function(n) {
			return e.apply(this, arguments);
		};
