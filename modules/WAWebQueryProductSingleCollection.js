__d("WAWebQueryProductSingleCollection", [
	...
	var e, s, u, c = (function() {
		var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				var r, a, i = t.afterCursor, l = t.catalogWid, u = t.collectionId, c = t.directConnectionEncryptedInfo, d = t.height, m = t.limit, p = t.variantInfoFields, _ = t.variantThumbnailHeight, f = t.variantThumbnailWidth, g = t.width, h = yield o("WAWebRelayClient").fetchQuery(e !== void 0 ? e : e = n("WAWebQueryProductSingleCollectionQuery.graphql"), { request: { collection: {
					biz_jid: (r = o("WAWebGetFormattedCatalogJid").getFormattedCatalogJid(l)) != null ? r : l.toString(),
					id: u,
					limit: String(m),
					after: i,
					width: String(g),
		...
		var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t;
			if (o("WAWebBizCatalogGatingUtils").commerceFeaturesDisabledBySanctions()) throw new (o("WAWebBackendErrors")).E451();
			var n = e.afterCursor, r = e.catalogWid, a = e.collectionId, i = e.directConnectionEncryptedInfo, l = e.height, s = e.limit, c = e.variantInfoFields, d = e.variantThumbnailHeight, m = e.variantThumbnailWidth, p = e.width, _ = yield o("WAWebBizCatalogManagementFetchSingleCollection").fetchSingleCollection({ collection: {
