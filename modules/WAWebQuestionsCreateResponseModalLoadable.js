__d("WAWebQuestionsCreateResponseModalLoadable", [
	"fbt",
	...
	var e, u = e || (e = o("react")), c = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebQuestionsCreateResponseModal.react").__setRef("WAWebQuestionsCreateResponseModalLoadable").load();
		return e.CreateQuestionResponseModal;
	}), "CreateQuestionResponseModal"), d = r("react-loadable")({
		loader: c,
		loading: function(t) {
