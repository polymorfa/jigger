__d("WAWebQuickPromotionDebugSnapshot", [
	"WAWebABProps",
	...
	function s(e) {
		var t, n, r, o, a = e.promotion, i = a.data, l = a.ts;
		return {
			...
			contentAttributeKeys: (t = (n = i.contentAttributes) == null || (n = n.attribute) == null ? void 0 : n.map(function(e) {
				return e.key;
			})) != null ? t : [],
			primaryActionDeepLink: (r = i.primaryAction) == null ? void 0 : r.deepLink,
			primaryActionUniversalLink: (o = i.primaryAction) == null ? void 0 : o.universalLink
		};
	}
	function u(e) {
	...
	function d(e) {
		var t = o("WAWebQuickPromotionCollection").QuickPromotionCollection.filter(function(t) {
		...
		return {
			...
			counters: n,
			abProps: {
				smb_core_rec_card: o("WAWebABProps").getABPropConfigValue("smb_core_rec_card"),
				qp_campaign_client_enabled: o("WAWebABProps").getABPropConfigValue("qp_campaign_client_enabled"),
				smb_qp_emergency_force_fetch_nonce: o("WAWebABProps").getABPropConfigValue("smb_qp_emergency_force_fetch_nonce")
			}
		};
	}
