__d("WAWebQuickRepliesDrawerItem.react", [
	...
	function p(e) {
		var t, a = e.quickReply, i = m(!1), l = i[0], c = i[1], p = m(null), _ = p[0], f = p[1], g = d(null), h = d(null), y = r("WAWebL10N").isRTL() ? "left" : "right", C = (t = {}, t[y] = function() {
			var e;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					yield o("WAWebDeleteQuickReplyAction").deleteQuickReplyAction(a.id), o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: s._(
						/*BTDS*/
						""
					) }));
				} catch (e) {
		...
		}, I = _ && u.jsx(o("WAWebUimUie.react").UIE, {
