			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var r = this, a = 0, i = 0, l = yield (u || (u = n("Promise"))).all(t.map((function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						try {
							if (e.operation === "set") {
								var t = e.indexParts, n = e.value, l = t[1];
								if (!l) return r.malformedActionIndex();
								var s = n.quickReplyAction;
								if (!s) return a++, o("WAWebSyncdIndexUtils").malformedActionValue(r.collectionName);
								if (s.deleted === !0) return yield o("WAWebSchemaQuickReply").getQuickReplyTable().remove(l), o("WAWebBackendApi").frontendFireAndForget("removeQuickReplyFromCollection", { id: l }), { actionState: o("WAWebSyncdConst").SyncActionState.Success };
								var u = s.message, c = s.shortcut;
								if (c == null || c === "" || u == null || u === "") return a++, o("WAWebSyncdIndexUtils").malformedActionValue(r.collectionName);
								...
								return yield o("WAWebSchemaQuickReply").getQuickReplyTable().createOrReplace(p), o("WAWebBackendApi").frontendFireAndForget("updateQuickReplyCollection", {
									count: m,
									id: l,
									keywords: d,
									message: u,
				...
				return a > 0 && o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["quick replies sync: ", " malformed mutations"])), a), i > 0 && o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["quick replies sync: ", " operations not supported"])), i), l;
			});
			function r(e) {
