__d("WAWebQuickReplyBridgeApi", [
	...
	var e, s = {
		...
		updateQuickReplyCollection: function(t) {
			var e = t.count, n = t.id, r = t.keywords, a = t.message, i = t.shortcut;
		...
		restoreQuickReplies: function() {
			return o("WAWebQuickReplyGatingUtils").canSendQuickReply() ? o("WAWebSchemaQuickReply").getQuickReplyTable().all().then(function(e) {
				o("WAWebQuickReplyCollection").QuickReplyCollection.initializeFromCache(e);
