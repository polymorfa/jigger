__d("WAWebQuickReplyCollection", [
	...
	var e = (function(e) {
		function t() {
			...
			return t = e.call.apply(e, [this].concat(r)) || this, t.smartDefaultsAdded = !1, t.sortQuickReply = function(e, t) {
				var n = o("WAWebFrontendQuickReplyGetters").getTotalCount(e), r = o("WAWebFrontendQuickReplyGetters").getTotalCount(t);
				return n === r ? e.id < t.id ? -1 : 1 : n > r ? -1 : 1;
			}, babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		babelHelpers.inheritsLoose(t, e);
		var n = t.prototype;
		return n.addSmartDefaultsIfNeeded = function() {
			this.smartDefaultsAdded === !1 && (o("WAWebQuickReplySmartDefaults").addSmartDefaults(), this.smartDefaultsAdded = !0);
