__d("WAWebReachoutTimelockRestrictedModal.react", [
	...
	function f(e) {
		var t = e.enforcementEndTs, a = (t - o("WATimeUtils").unixTime() * 1e3) / 1e3, i = p(a < 0 ? 0 : a), l = i[0], s = i[1], c = m(!1);
		return d(function() {
			if (!(l < 0)) {
				var e = (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
						if (!c.current) {
							c.current = !0;
							try {
								yield o("WAWebGetReachoutTimelockJob").fetchReachoutTimelock();
								...
								if (e != null) {
									...
									n <= 0 && window.clearInterval(t), s(n > 0 ? n : 0);
	...
	function C() {
		var e = o("react-compiler-runtime").c(5), t = o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.get(o("WAWebReachoutTimelockUtils").REACHOUT_TIMELOCK_IDB_KEY), a = r("useVisibility")({ onVisible: function() {
			var e = (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					if (t != null) {
						var e = t.state !== o("WAWebUserPrefsTypes").ReachoutTimelockState.VISIBLE, n = t.time_enforcement_ends, r = o("WATimeUtils").unixTime() * 1e3, a = r >= n;
						if (e && new (o("WAWebReachoutTimelockEnforcementSheetInfoWamEvent")).ReachoutTimelockEnforcementSheetInfoWamEvent({
						...
						e && (yield o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.set(o("WAWebReachoutTimelockUtils").REACHOUT_TIMELOCK_IDB_KEY, babelHelpers.extends({}, t, { state: o("WAWebUserPrefsTypes").ReachoutTimelockState.VISIBLE })), o("WAWebCmd").Cmd.reachoutTimelockStateChange());
					}
				});
				function r() {
					return e.apply(this, arguments);
		...
		var d;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (d = s._(
			/*BTDS*/
			""
		), e[1] = d) : d = e[1];
		var m = o("WAWebFlex.react").FlexColumn, p = "start", C = "start", R = l.map(b), L;
		return e[2] !== m || e[3] !== R ? (L = u.jsx(m, {
			align: p,
			justify: C,
			children: R
		}), e[2] = m, e[3] = R, e[4] = L) : L = e[4], u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: c,
	...
	S.displayName = S.name + " [from " + i.id + "]", l.ReachoutTimelockRestrictedModal = C;
}), 226);
