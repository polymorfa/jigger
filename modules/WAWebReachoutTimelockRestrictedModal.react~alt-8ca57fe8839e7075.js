			...
			function r() {
				return r = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					if (e != null) {
						...
						t && (yield o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.set(o("WAWebReachoutTimelockUtils").REACHOUT_TIMELOCK_IDB_KEY, babelHelpers.extends({}, e, { state: o("WAWebUserPrefsTypes").ReachoutTimelockState.VISIBLE })), o("WAWebCmd").Cmd.reachoutTimelockStateChange());
					}
