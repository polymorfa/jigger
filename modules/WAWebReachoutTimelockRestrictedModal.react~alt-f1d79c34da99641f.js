__d("WAWebReachoutTimelockRestrictedModal.react", [
	...
	function C() {
		var e = o("react-compiler-runtime").c(5), t = o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.get(o("WAWebReachoutTimelockUtils").REACHOUT_TIMELOCK_IDB_KEY), n = r("useVisibility")({ onVisible: function() {
			var e = async function() {
				if (t != null) {
					...
					e && (await o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.set(o("WAWebReachoutTimelockUtils").REACHOUT_TIMELOCK_IDB_KEY, babelHelpers.extends({}, t, { state: o("WAWebUserPrefsTypes").ReachoutTimelockState.VISIBLE })), o("WAWebCmd").Cmd.reachoutTimelockStateChange());
				}
			};
			e();
		} }), a = n[0];
		...
		var c;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (c = s._(
			/*BTDS*/
			""
		), e[1] = c) : c = e[1];
		var d = o("WAWebFlex.react").FlexColumn, m = "start", p = "start", C = i.map(b), R;
		return e[2] !== d || e[3] !== C ? (R = u.jsx(d, {
			align: m,
			justify: p,
			children: C
		}), e[2] = d, e[3] = C, e[4] = R) : R = e[4], u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: l,
