__d("WAWebReactAddonMessageProcessorUtils", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = new Map(), r = t.map(e), a = yield o("WAWebAddonDBTable").addonDBTable.bulkGetByParentAndSender(o("WAWebMsgType").MSG_TYPE.REACTION, r);
			for (var i of a) {
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			}, d = yield o("WAWebSchemaReactions").getReactionsTable().anyOf(["parentMsgKey", "senderUserJid"], a), m = new Set();
