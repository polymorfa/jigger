	...
	function b(t) {
		...
		return c.jsx(o("WAWebFlex.react").FlexRow, {
			...
			children: c.jsxs(r("WAWebFlexItem.react"), {
				...
				}) : c.jsx("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(f.emojiCount, f.emoji, o("WAWebReactionEmoji.react").tabScale), { children: c.jsx(o("WAWebReactionEmoji.react").ReactionEmoji, { reaction: a }) })), c.jsx("div", {
					"data-testid": "total-emoji-count",
					className: "xdj266r xat24cr x1lziwak x1rg5ohu xt7dq6l x6prxxf x1fc57z9 xhslqc4 xmpx0yj",
