__d("WAWebReactionDetailsPaneV2.react", [
	...
	function p(e) {
		...
		return t == null || !o("WAWebReactionsUtils").canReactToMessage(t) ? null : t;
	}
	var _ = function(t, n) {
		t === void 0 && (t = []);
	...
	function f(e, t) {
		var n = o("WAWebReactionsUtils").getReactionAggregates(e), r = [], a = [], i = [];
		n.forEach(function(e) {
			var t = e.reactionSenders;
			if (!(t.length <= 0)) {
				var n = !1;
				t.forEach(function(e) {
					o("WAWebUserPrefsMeUser").isSerializedWidMe(e.senderUserJid) ? (a.push(e), n = !0) : r.push(e);
				}), i.push({
		...
		var l = _(t, r);
		return l.unshift.apply(l, a), {
			allSenders: l,
			aggregates: i
		};
	}
	var g = { focusTrapContainer: {
		position: "x1n2onr6",
		$$css: !0
	} };
	function h(e) {
		var t, n, a = r("useLazyRef")(function() {
			return new (r("WAWebFlatListController"))();
		}), i = d(null), l = d(null), u = (t = (n = e.msgIds) == null ? void 0 : n[0]) != null ? t : "", _ = r("useWAWebSelectedReactions")(u), h = m(function() {
			return f(e.reactionsModels).allSenders;
		}), y = h[0], C = h[1], b = m(function() {
			return f(e.reactionsModels).aggregates;
		}), v = b[0], S = b[1], R = r("useWAWebFocusOnMount")(), L = r("useWAWebReactionPillOrder")(v), E = p(e.msgIds), k = function(t) {
			var e = f(t, y), n = e.aggregates, r = e.allSenders, o = L(n);
			C(r), S(o);
		};
		r("useWAWebReactions")(e.msgIds, k), c(function() {
			y.length === 0 && (e.onEmpty == null || e.onEmpty());
		}, [e, y]);
		var I = function(t, n) {
			if (E != null) {
				var e = n ? o("WAWebReactionsBEUtils").REVOKED_REACTION_TEXT : t;
				n ? o("WAWebReactionUserJourneyLogger").ReactionUserJourneyLogger.reactionUnselect() : o("WAWebReactionUserJourneyLogger").ReactionUserJourneyLogger.reactionSelect(t), o("WAWebSendReactionMsgAction").sendReactionToMsg(E, e);
			}
		}, T = r("useWAWebReactionEmojiPicker")({
			msgId: u != null ? u : "",
			onEmojiSelected: function(t) {
				if (E != null) {
					var e = t === _ ? o("WAWebReactionsBEUtils").REVOKED_REACTION_TEXT : t;
					o("WAWebReactionUserJourneyLogger").ReactionUserJourneyLogger.reactionSelect(t), o("WAWebSendReactionMsgAction").sendReactionToMsg(E, e).catch(function(e) {});
				}
			},
		...
		return s.jsxs(r("WAWebKeyboardRotateFocusModal.react"), {
			...
			children: [
				...
				s.jsx(r("WAWebReactionPillsContainer.react"), {
					addReactionPill: E ? s.jsx(r("WAWebAddReactionPill.react"), {
						ref: l,
						onClick: D
					}) : null,
				...
				s.jsx(o("WAWebFlex.react").FlexColumn, {
					...
					children: s.jsx(r("WAWebReactionDetailsList.react"), {
						...
						onCloseDetailsPane: e.onCloseDetailsPane ? e.onCloseDetailsPane : r("WAWebNoop"),
