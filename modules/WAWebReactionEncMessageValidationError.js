__d("WAWebReactionEncMessageValidationError", ["$InternalEnum", "WAWebHandleMsgError"], (function(t, n, r, o, a, i, l) {
	var e = n("$InternalEnum")({
		...
		function t() {
			...
			return t = e.call.apply(e, [this].concat(r)) || this, t.name = "ReactionEncMessageValidationError", babelHelpers.assertThisInitialized(t) || babelHelpers.assertThisInitialized(t);
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(o("WAWebHandleMsgError").MessageValidationError);
	l.ReactionEncValidationErrorCode = e, l.ReactionEncMessageValidationError = s;
}), 98);
