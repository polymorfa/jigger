__d("WAWebReactionEncryptMsgData", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield o("WAWebBackendApi").frontendSendAndReceive("getGroupMetadata", { groupWid: e.id.remote });
			if (n != null && n.isCag) {
				...
				}, s = o("WAWebAddonEncryptionError").getValidatedMessageSecret(a.MsgKind.ReactionDecrypted, t), u = yield o("WAWebAddonEncryption").encryptAddOn(l, {
					messageSecret: s,
					iv: i,
					stanzaId: t.id.id,
