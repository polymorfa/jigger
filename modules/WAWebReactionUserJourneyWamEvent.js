__d("WAWebReactionUserJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ReactionUserJourney: [
		5752,
		{
			...
			reactionUserJourneyAction: [5, o("WAWebWamEnumReactionUserJourneyAction").REACTION_USER_JOURNEY_ACTION],
			reactionUserJourneyEntryPoint: [6, o("WAWebWamEnumReactionUserJourneyEntryPoint").REACTION_USER_JOURNEY_ENTRY_POINT],
			uiSurface: [7, o("WAWebWamEnumTsSurface").TS_SURFACE],
			unifiedSessionId: [12, e.TYPES.STRING],
			userJourneyChatType: [8, o("WAWebWamEnumUserJourneyChatType").USER_JOURNEY_CHAT_TYPE],
