__d("WAWebReactionsMsgAction", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (i ? l = yield o("WAWebReactionsCollection").ReactionsCollection.find(r) : l = o("WAWebReactionsCollection").ReactionsCollection.getAddressingModeInsensitive(r), l) {
			...
			} else e.reactionText !== o("WAWebReactionsBEUtils").REVOKED_REACTION_TEXT && (yield o("WAWebMsgReactionsBridge").updateHasReactionInParent(r, !0));
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield o("WAWebDBCreateOrUpdateReactions").createOrUpdateReactions([e]), r = n[0];
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var a = o("WAWebMsgCollection").MsgCollection.get(e.parentMsgKey), i = e.parentMsgKey, l = e.msgKey;
			if (a) {
				var s = i.remote, u = o("WAWebReactionsMsgActionUtils").getFromForReactionMessage(a), c = yield o("WAWebReactionsMsgActionUtils").getReactionMsgData({
					from: u,
				...
				if (o("WAWebAddonGatingUtils").isUnifiedInfraEnabled(c)) {
					var d = yield o("WAWebSendAddonMsgChatAction").addAndSendAddonToChat(c);
					if (d.messageSendResult !== o("WAWebSendMsgResultAction").SendMsgResult.OK) throw r("err")("Reaction send error");
					return;
				}
				var m = new (o("WAWebMsgModel")).Msg(c);
				return yield o("WAWebAddOnsUpdateSendStatesAction").updateAddOnSendStatesAction(new Map([[o("WAWebMessageAddOnType").MessageAddOnType.Reaction, [{
					msgKey: e.msgKey.toString(),
					ack: o("WAWebAck").ACK.CLOCK,
					isSendFailure: !1
				}]]])), o("WAWebOrchestratorNonPersistedJob").createNonPersistedJob("sendMessage", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
	...
	l.addOrUpdateReactionsModelCollection = u, l.addOrUpdateReactions = d, l.resendUpdateFailedPropsForSentReactionsDBAndModel = p, l.handleReactionNotification = h;
}), 98);
