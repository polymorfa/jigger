__d("WAWebReactionsPanel.react", [
	...
	function m(e) {
		var t = e.msgId, n = e.onSelection, a = r("useWAWebSelectedReactions")(t), i = d(!1);
		c(function() {
			return function() {
		...
		var l = function(t) {
			var e = t;
			t === a && (e = o("WAWebReactionsBEUtils").REVOKED_REACTION_TEXT), n(e), o("WAWebCmd").Cmd.closeContextMenu();
		};
		return s.jsx(r("WAWebReactionsSelectionContext").Provider, {
			...
			children: s.jsx(r("WAWebEmojiPanel.react"), {
				...
				onChange: function() {
					i.current || (o("WAWebReactionUserJourneyLogger").ReactionUserJourneyLogger.reactionSearch(), i.current = !0);
				}
			})
		});
	}
