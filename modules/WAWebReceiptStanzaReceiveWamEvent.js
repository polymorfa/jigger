__d("WAWebReceiptStanzaReceiveWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ ReceiptStanzaReceive: [
		2496,
		{
			...
			receiptAggregation: [11, o("WAWebWamEnumReceiptAggregationType").RECEIPT_AGGREGATION_TYPE],
			...
			receiptStanzaStage: [9, o("WAWebWamEnumReceiptStanzaStage").RECEIPT_STANZA_STAGE],
