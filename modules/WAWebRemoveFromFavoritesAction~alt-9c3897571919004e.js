__d("WAWebRemoveFromFavoritesAction", [
	...
	async function p(t, n) {
		if (o("WAWebInboxFiltersGatingUtils").inboxFavoritesEnabled()) {
			var a = t.toString();
			n.entryPoint != null && o("WAWebFavoritesLogging").logRemovingMessagingFavorites([a], n.entryPoint);
			var i = await o("WAWebDBFavoriteDatabaseApi").getAllFavorites(), l = i.find(function(e) {
				var t = e.id;
				return t === a;
			}), u = i.filter(function(e) {
				var t = e.id;
				return t !== a;
			}), p = o("WATimeUtils").unixTime(), _ = await r("WAWebFavoritesSync").getFavoritesMutation(u, p);
			o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[Favorites] removeFromFavoritesAction, mutation generated"])));
			var f = o("WAWebSyncdCoreApi").lockForSync(["favorite", "chat"], [_], async function() {
			...
			if (n.suppressToast === !0) await f;
				...
				var g = new (o("WAWebActionToast.react")).ActionType(d()), h = f.then(function() {
					return new (o("WAWebActionToast.react")).ActionType(m(), l ? {
						actionText: s._(
							/*BTDS*/
							""
						),
						actionHandler: function() {
							return o("WAWebAddToFavoritesAction").addToFavoritesAction(l, { entryPoint: n.entryPoint });
						}
					} : void 0);
				});
