__d("WAWebRemoveLinkJoinedMembersModal.react", [
	...
	function h(e) {
		var t = e.chat, a = e.groupMetadata, i = e.messageTimestamp, l = _([]), u = l[0], d = l[1], f = _(!0), h = f[0], y = f[1];
		m(function() {
			var e = (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					try {
						var e = i != null ? o("WATimeUtils").castToUnixTime(i - o("WAWebGroupLinkJoinUtils").JOIN_FLOOD_WINDOW_SECS) : void 0, n = i != null ? o("WATimeUtils").castToUnixTime(i + o("WAWebGroupLinkJoinUtils").JOIN_FLOOD_COOLDOWN_SECS) : void 0, r = yield o("WAWebGroupLinkJoinUtils").getParticipantsJoinedViaLink(t.id.toString(), e, n), l = [], s = a.participants;
						for (var u of r) {
							var c = o("WAWebWidFactory").createWid(u), m = s.get(c);
							m != null && l.push(m);
						}
						d(l);
					} finally {
		...
		var C = function() {
			...
			o("WAWebLinkJoinedMembersUtils").logGroupBulkRemovalWamEvent(o("WAWebWamEnumGroupBulkRemovalAction").GROUP_BULK_REMOVAL_ACTION.TAP_REMOVE_BUTTON, t.id, u.length), u.length > 0 && o("WAWebModifyParticipantsGroupAction").removeParticipants(t, u), o("WAWebModalManager").closeModalManager();
		}, v = u.length, S = p(function() {
			if (i == null) return null;
			var e = o("WAWebLinkJoinedMembersUtils").calculateTimeRange(i), t = e.endTime, n = e.startTime;
		...
		return c.jsx(o("WAWebModal.react").Modal, {
			...
			children: c.jsxs(r("WAWebDrawer.react"), {
				...
				children: [
					...
					c.jsx(r("WAWebDrawerBody.react"), { children: h ? c.jsx("div", {
	...
	function y(t, r, a) {
		var i = (function() {
			var i = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					var n = yield o("WAWebLinkJoinedMembersUtils").fetchRemainingParticipants(t, r, a);
					if (n.length === 0) {
						o("WAWebMembersRemovedAlert.react").openMembersRemovedAlert(t, r, a);
						return;
					}
