__d("WAWebRenderPttPreviewIcon", [
	...
	var e, s = e || (e = o("react"));
	function u(e) {
		var t = e.msg, n = e.options, a = o("useWAWebMsgValues").useMsgValues(t.id, [o("WAWebMsgGetters").getAck, o("WAWebMsgGetters").getIsViewOnce]), i = a[0], l = a[1];
		if (l) return n.viewOnceStatic === !0 || !o("WAWebViewOnceState").isViewed(t.safe()) ? s.jsx(r("WDSIconWdsIcViewOnce.react"), {
			width: 20,
			height: 20,
