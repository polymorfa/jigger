__d("WAWebReportContactPopup.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t, a = e.chat, i = e.spamFlow, l = (t = o("WAWebUseBusinessProfile.react").useBusinessProfile(a.contact.id, ["isBizBot3p"])) != null ? t : {}, c = l.isBizBot3p, d = c === void 0 ? !1 : c, m = o("useWAWebContactValues").useContactValues(a.contact.id, [o("WAWebFrontendContactGetters").getIsContactBlocked]), p = m[0], _ = (function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (d || a.contact.isBusiness) {
					...
					var e = o("WAWebBlocklistUtils").getBlockEntryPointFromSpamFlow(i);
		...
		}), h = u.jsx(o("WAWebName.react").Name, { contact: a.contact }), y = function() {
			return d ? s._(
				/*BTDS*/
				"",
				[s._param("link to learn more", g)]
			) : a.contact.isBusiness ? s._(
				/*BTDS*/
				"",
				[s._param("link to learn more", g)]
			) : s._(
		...
		return u.jsx(o("WAWebReportPopupBase.react").ReportPopupBase, {
			...
			reportSubText: y(),
			additionalActionLabelText: o("WAWebReportPopupBase.react").getBlockLabelText(d, h),
			additionalActionSubText: o("WAWebReportPopupBase.react").getBlockSubText({
				...
				isCommunityAnnouncementGroup: o("WAWebChatGroupUtils").isCommunityAnnouncementGroup(a)
			}),
			onSendReport: _,
