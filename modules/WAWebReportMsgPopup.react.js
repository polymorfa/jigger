__d("WAWebReportMsgPopup.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t, a = e.msg, i = e.spamFlow, l = o("WAWebFrontendMsgGetters").getChat(a), c = (t = o("WAWebUseBusinessProfile.react").useBusinessProfile(l.contact.id, ["isBizBot3p"])) != null ? t : {}, m = c.isBizBot3p, p = m === void 0 ? !1 : m, _ = d(a), f = o("useWAWebContactValues").useContactValues(_.id, [o("WAWebFrontendContactGetters").getIsContactBlocked]), g = f[0], h = r("useWAWebContactFormattedUsernameOrPhoneByChat")(l, _), y = h.formattedUsernameOrPhone, C = h.isPhoneNumberForceMasked, b = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAWebSendSpamChatAction").sendMessageReport(a, i).then(function(e) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (p || l.contact.isBusiness) {
					var e;
					yield o("WAWebSendSpamChatAction").sendMessageReport(a, i).then(function(t) {
						e = t;
					}), o("WAWebModalManager").ModalManager.close();
					var t = o("WAWebBlocklistUtils").getBlockEntryPointFromSpamFlow(i);
		...
		}), R = C === !0 ? u.jsx(o("WAWebEmojiText.react").EmojiText, {
			text: y,
			direction: "auto",
			inlineblock: !0
		}) : u.jsx(o("WAWebName.react").Name, { contact: _ }), L = function() {
			return p ? s._(
				/*BTDS*/
				"",
				[s._param("link to learn more", S)]
			) : l.contact.isBusiness ? s._(
				/*BTDS*/
				"",
				[s._param("link to learn more", S)]
			) : o("WAWebChatGetters").getIsGroup(l) && o("WAWebGroupHistoryUtils").shouldReportGroupHistoryBundleSender(a) ? s._(
				/*BTDS*/
				"",
				[s._param("name of the group history bundle sender", R), s._param("link to learn more", S)]
			) : o("WAWebChatGetters").getIsGroup(l) && !o("WAWebChatGroupUtils").isCommunityAnnouncementGroup(l) && o("WAWebBlocklistUtils").isRBIForGroupsEnabled() ? s._(
				/*BTDS*/
				"",
				[s._param("link to learn more", S)]
			) : s._(
		...
		return u.jsx(o("WAWebReportPopupBase.react").ReportPopupBase, {
			...
			reportSubText: L(),
			additionalActionLabelText: o("WAWebReportPopupBase.react").getBlockLabelText(p, R),
			additionalActionSubText: o("WAWebReportPopupBase.react").getBlockSubText({
				...
				isCommunityAnnouncementGroup: o("WAWebChatGroupUtils").isCommunityAnnouncementGroup(l)
			}),
			onSendReport: b,
