__d("WAWebReportNewsletterPostPopup.react", [
	"fbt",
	"WAWebCheckBox.react",
	...
	function p(t) {
		var n = t.chat, a = t.msg, i = t.spamFlow, l = d(!1), u = l[0], p = l[1], _ = o("useWAWebShouldShowNewsletterUnfollowUpsell").useShouldShowNewsletterUnfollowUpsell(n), f = s._(
			/*BTDS*/
			""
		), g = c.jsx(o("WAWebExternalLink.react").ExternalLink, {
			href: o("WAWebFaqUrl").getNewsletterReportLearnMoreUrl(),
			children: r("WAWebFbtCommon")("Learn more")
		}), h = o("WAWebNewsletterGatingUtils").isNewsletterUKOSAReportingEnabled() ? s._(
			/*BTDS*/
			"",
			...
			/*BTDS*/
			""
		), y = o("WAWebCommonNewsletterStrings").getUnfollowNewsletterText(), C, b = function() {
			o("WAWebModalManager").ModalManager.closeMedia(), o("WAWebSendSpamChatAction").sendReport({
				spamFlow: i,
				chat: n,
				msg: a
			}).then(function(e) {
				return e != null && (C = e), u && o("WAWebNewsletterUnsubscribeAction").unsubscribeFromNewsletterAction(n, {
		...
		return c.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			title: f,
			children: [_ && c.jsxs("div", babelHelpers.extends({}, (e || (e = r("stylex"))).props(m.checkboxRow, o("WDSMargins.stylex").wdsMargins.marginVer12, o("WDSPaddings.stylex").wdsPaddings.paddingBottom20, m.border, o("WDSMargins.stylex").wdsMargins.marginEnd0), { children: [c.jsx(o("WAWebCheckBox.react").CheckBox, {
				onChange: function() {
					return p(function(e) {
						return !e;
					});
