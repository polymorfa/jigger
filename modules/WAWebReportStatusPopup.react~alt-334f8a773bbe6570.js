__d("WAWebReportStatusPopup.react", [
	...
	function d(e) {
		var t = e.contact, r = e.onCancel, a = e.onReport, i = o("useWAWebContactValues").useContactValues(t.id, [o("WAWebFrontendContactGetters").getIsContactBlocked]), l = i[0], d = u.jsx(o("WAWebName.react").Name, { contact: t }), m = (function() {
		...
		return u.jsx(o("WAWebReportPopupBase.react").ReportPopupBase, {
			...
			reportSubText: _(),
			additionalActionLabelText: o("WAWebReportPopupBase.react").getBlockLabelText(!1, d),
