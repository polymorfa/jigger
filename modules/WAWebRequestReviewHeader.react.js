__d("WAWebRequestReviewHeader.react", [
	...
	function c(e) {
		var t = o("react-compiler-runtime").c(4), n = e.height, r = e.width, a;
		...
		var i;
		return t[1] !== n || t[2] !== r ? (i = s.jsx(o("WAWebWdsPictoTextFeedbackWarningIcon.react").WdsPictoTextFeedbackWarningIcon, {
			width: n,
			height: r,
			innerStyles: a
