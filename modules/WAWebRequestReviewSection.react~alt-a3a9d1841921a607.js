__d("WAWebRequestReviewSection.react", [
	...
	function d(e) {
		var t = e.appealState, n = e.onClickRequestReview, a = e.onClickSeeReviewDetails, i = function(t) {
		...
		switch (t) {
			...
			case "NOT_APPEALED": {
				d = {
					icon: u.jsx(r("WDSIconWdsIcChatSupport.react"), { xstyle: c.icon }),
					title: o("WAWebCommonNewsletterIntegrityStrings").getRequestAppealRemediationOptionsRowText(),
					subtitle: s._(
						/*BTDS*/
						""
					),
		...
		return d != null && d.icon != null ? u.jsx(r("WAWebNewsletterAlertsRowComponent.react"), {
			icon: d.icon,
