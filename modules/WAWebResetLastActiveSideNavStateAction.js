__d("WAWebResetLastActiveSideNavStateAction", [
	...
	var e, s = e || (e = o("react")), u = function() {
		...
		} : s.jsx(o("WAWebMidDrawerEmptyState.react").MidDrawerEmptyState, { type: o("WAWebNavBarTypes").NavBarItems.Communities }), { transition: "none" });
	}, c = function() {
		o("WAWebDrawerManager").DrawerManager.openDrawerMid(o("WAWebAdaptiveLayoutGatingUtils").shouldUseDrawerDescriptor() ? {
			descriptorType: "mid_drawer_empty_state",
			navBarItem: o("WAWebNavBarTypes").NavBarItems.Newsletters
		} : s.jsx(o("WAWebMidDrawerEmptyState.react").MidDrawerEmptyState, { type: o("WAWebNavBarTypes").NavBarItems.Newsletters }), { transition: "none" });
	};
	function d(e) {
		...
		if (t != null) switch (t) {
			...
			case o("WAWebNavBarTypes").NavBarItems.Newsletters:
				o("WAWebChatGetters").getIsNewsletter(e) && (o("WAWebSideNavButtonsActivityModel").setLastActiveNewsletter(null), c());
				break;
			case o("WAWebNavBarTypes").NavBarItems.Communities:
				if (e.groupType != null) switch (e.groupType) {
					...
					case o("WAWebGroupType").GroupType.LINKED_GENERAL_GROUP:
						o("WAWebSideNavButtonsActivityModel").setLastActiveCommunity(null), u();
						break;
