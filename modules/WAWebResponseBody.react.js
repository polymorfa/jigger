__d("WAWebResponseBody.react", [
	...
	"use strict";
	var e, s, u = s || (s = o("react")), c = s.useContext, d = { container: {
		width: "xh8yej3",
		minWidth: "xeuugli",
		maxWidth: "x193iq5w",
		flex: "x1cqoux5",
	...
	function p(t) {
		var n = o("react-compiler-runtime").c(7), a = t.response, i = c(r("WAWebSearchHighlightTermsContext.react")), l;
		n[0] === Symbol.for("react.memo_cache_sentinel") ? (l = (e || (e = r("stylex")))([d.container]), n[0] = l) : l = n[0];
		var s;
		n[1] !== i || n[2] !== a ? (s = function(t) {
			var e = t.textLimit, n = o("WAWebFormatConfigurationConversation").Conversation({
				trusted: g(a),
				links: _(o("WAWebStateUtils").unproxy(a), m),
				phoneNumbers: f(o("WAWebStateUtils").unproxy(a), m),
				selectable: !0,
				parseInlineCode: !0,
				parseQuotes: !0,
				parseLists: !0,
		...
		}, n[1] = i, n[2] = a, n[3] = s) : s = n[3];
		var p;
		return n[4] !== a.body || n[5] !== s ? (p = u.jsx(r("WAWebFlexItem.react"), {
			className: l,
		...
		}), n[4] = a.body, n[5] = s, n[6] = p) : p = n[6], p;
	}
	function _(e, t) {
		var n = e.body;
	...
	function g(e) {
		...
		var t = o("WAWebChatCollection").ChatCollection.get(e.parentMsgKey.remote);
