__d("WAWebResponsesListDrawerLoadable", [
	...
	var e, u = e || (e = o("react")), c = r("WAWebLazyLoadedRetriable")(async function() {
		var e = await r("JSResourceForInteraction")("WAWebResponsesListDrawer.react").__setRef("WAWebResponsesListDrawerLoadable").load();
	...
	function m() {
		...
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = u.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			title: d(),
			type: o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.SMALL,
			onCancel: o("WAWebDrawerManager").closeDrawerRight
		}), e[0] = t) : t = e[0];
		var n;
		return e[1] === Symbol.for("react.memo_cache_sentinel") ? (n = u.jsxs(r("WAWebDrawer.react"), {
			disableNavigationLogging: !0,
			children: [t, u.jsx(r("WAWebDrawerBody.react"), { children: u.jsx(r("WAWebResponsesListShimmer.react"), { description: "WAWebResponsesListDrawerLoading" }) })]
		}), e[1] = n) : n = e[1], n;
	}
