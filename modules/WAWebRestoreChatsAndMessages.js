__d("WAWebRestoreChatsAndMessages", [
	...
	var e = ["id"], s, u, c, d, m, p, _, f, g, h, y = 20, C = 5, b = 100;
	function v(e, t) {
	...
	function L(e, t) {
		var n = v(e, t), a = n.chats, i = n.newsletters;
	...
	function k() {
		return k = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			o("WAWebRegionReadinessSignals").markChatlistRowsReady(t), yield o("WAWebRegionReadinessSignals").waitForChatlistRowsPaint(t && (n("cr:11133") == null ? void 0 : n("cr:11133")()) === !0);
		}), k.apply(this, arguments);
	}
	var I = null, T = !1, D = null, x = !1;
	function $(e) {
		return (n("cr:11133") == null ? void 0 : n("cr:11133")()) !== !0 || x || T || o("WAWebCmd").Cmd.isMainStreamReadyMd ? (h || (h = n("Promise"))).resolve() : (D = e, I != null || (I = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (yield o("WAWebDbEncryptionKey").DbEncKeyStore.waitForFinalDbMsgEncKey(), yield o("WAWebModelStorageInitialize").initializeWithoutGKs(), !(x || T || o("WAWebCmd").Cmd.isMainStreamReadyMd)) {
				var e = yield S();
				L(e, D), T = !0, yield E();
			}
		})().catch(function(e) {
	...
	function N() {
		return N = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			var e = !1;
			try {
				return I != null && (yield I), o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addPoint("RestoreChatsAndMessages_start"), yield o("WAWebDbEncryptionKey").DbEncKeyStore.waitForFinalDbMsgEncKey(), o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[init-from-storage] load DbEncKeyStore key"]))), o("WAWebAppTracker").AppTracker.start(o("WAWebAppTracker").AppTrackerType.InitialChatLoad), e = !0, yield o("WAWebModelStorageInitialize").initializeWithoutGKs().then(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e;
					...
					var n = o("WAWebThreadMetadata").getOfflineThreadMetaPreview(), a = L(t, n == null ? void 0 : n.chatTimestamp), i = a.chats, l = a.newsletters;
					o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.logOfflineChatThreadCount(t.length), yield E(), o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addPoint("RCMFilterChats_end"), o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addPoint("RestoreChats_end"), o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addPoint("RestoreChatsAndMessagesFirstChunk_start");
					var s = o("WAWebABProps").getABPropConfigValue("web_init_chat_batch_size") || b;
					o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addAnnotations({ int: { web_init_chat_batch_size: s } }), o("WAWebNewsletterCommonGatingUtils").isNewsletterEnabled() && (l.sort(r("WAWebChatComparator")), r("WAWebNewsletterCollection") == null || r("WAWebNewsletterCollection").add(l, { merge: !0 }), M(K(l), s));
					var u = yield M(K(i), s);
					...
					throw o("WALogger").ERROR(m || (m = babelHelpers.taggedTemplateLiteralLoose(["restoreChatsAndMessages: failed with error"]))).catching(r("getErrorSafe")(e)), e;
				});
			} finally {
				x = !1, e && o("WAWebAppTracker").AppTracker.stop(o("WAWebAppTracker").AppTrackerType.InitialChatLoad);
			}
		}), N.apply(this, arguments);
	}
	function M(e, t) {
		for (var a = (h || (h = n("Promise"))).resolve(), i = new (o("WAWebPromiseQueue")).PromiseQueue(), l = function(s) {
			var l = e.slice(s, s + t), u = (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = self.performance.now();
					s === 0 && o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addPoint("RCMChatMetadata_start");
					var t = yield w(l);
					s === 0 && o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addPoint("RCMChatMetadata_end"), s === 0 && o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addPoint("RCMRestoreMessages_start"), yield A(t), s === 0 && o("WAWebWamOfflineResumeReporter").OfflineResumeReporter.qpl.addPoint("RCMRestoreMessages_end");
					var n = [];
					...
					}), yield o("WAWebRestoreGroupParticipantsAction").restoreGroupParticipantsForChats(n);
				});
				return function() {
					return e.apply(this, arguments);
				};
			})();
			s === 0 ? a = i.enqueue(function() {
				return o("WAWebOrchestratorNonPersistedJob").createNonPersistedJob("initialChatLoad", u, { priority: o("WAJobOrchestratorTypes").JOB_PRIORITY.SKIP }).waitUntilCompleted();
			}) : i.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				return yield o("WAWebEventsWaitForOfflineDeliveryEnd").waitForOfflineDeliveryEnd(), o("WAWebOrchestratorNonPersistedJob").createNonPersistedJob("initialChatLoad", u).waitUntilCompleted();
			}));
		}, s = 0; s < e.length; s += t) l(s);
		return a;
	}
	function w(e) {
		return (h || (h = n("Promise"))).all(e.map(function(e) {
			var t = F(e);
	...
	function A(e) {
		var t = O(e), r = t.lastMessageKeys, a = t.missingAnchorCount, i = t.missingAnchorIds, l = t.tasks;
		return l.push(G(r)), (h || (h = n("Promise"))).all(l).then(function() {
			a > 0 && o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose([
				"",
	...
	function W() {
		return W = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["restoreMessagesForChat: restoring last ", " messages."])), e.unreadCount + C);
			var n = [];
			if (t) {
			...
			var i = yield o("WAWebDBQueryChatVisibleMessageHelper").queryChatVisibleMessageHelper({
				lowerBound: e.id + "_/",
				upperBound: e.id + "_g",
				options: { reverse: !0 },
			...
			yield o("WAWebMsgCollection").MsgCollection.processMultipleMessages(o("WAWebWidFactory").createWidFromWidLike(e.id), i.map(function(e) {
	...
	function U() {
		return U = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (t != null && t.internalId != null) {
				...
				t && l != null && l.canRenderInUi(i) && r.push(t.id.toString()), n = yield o("WAWebDBQueryChatVisibleMessageHelper").queryChatVisibleMessageHelper({
					lowerBound: a,
					upperBound: e.id + "_g",
				...
				var s = 1;
				n = yield o("WAWebDBQueryChatVisibleMessageHelper").queryChatVisibleMessageHelper({
					lowerBound: e.id + "_/",
					upperBound: e.id + "_g",
					options: { reverse: !0 },
					count: s
			...
			o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["processPreviewMessageInChat: restoring ", " message."])), n.length), o("WAWebMsgCollection").MsgCollection.processMultipleMessages(o("WAWebWidFactory").createWidFromWidLike(e.id), n.map(function(e) {
	...
	function H() {
		return H = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (r("isStringNullOrEmpty")(t)) return o("WALogger").WARN(f || (f = babelHelpers.taggedTemplateLiteralLoose(["unreadMsgAnchorId is not defined"]))), (h || (h = n("Promise"))).resolve();
			yield o("WAWebSchemaMessage").getMessageTable().equals(["id"], t).then(function(t) {
				if (t.length === 0) {
					o("WALogger").WARN(g || (g = babelHelpers.taggedTemplateLiteralLoose(["Unread anchor message does not exist in message table"])));
					return;
				}
				var a = o("WAWebDBMessageUtils").getInChatMsgId(t[0].internalId || ""), i = z(e, a, C), l = j(e, a, C), s = (h || (h = n("Promise"))).all([i, l]).then(function(e) {
					var t = e[0], n = e[1];
					return [].concat(t, n);
				});
				return s.then(function(t) {
					var n = t.length - C;
					if (!(n < 0)) {
						var a = t[t.length - C].id, i = t.map(function(e) {
							return o("WAWebDBMessageSerialization").messageFromDbRow(e, function(e) {
								e.invis = !0;
							});
						});
	...
	function G(e) {
		...
		return o("WAWebSchemaMessage").getMessageTable().bulkGet(e).then((function() {
			...
			throw o("WALogger").ERROR(c || (c = babelHelpers.taggedTemplateLiteralLoose(["loadLastMessagesFromDB: failed with error"]))).catching(r("getErrorSafe")(e)), e;
		});
	}
	function z(e, t, n) {
		var r = {
