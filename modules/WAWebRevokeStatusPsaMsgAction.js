__d("WAWebRevokeStatusPsaMsgAction", [
	"Promise",
	"WALogger",
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			n.length > 0 && (t.revokeMsgs(n), yield o("WAWebDBMessageDelete").removeMessagesFromHistory(n), o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["revokeStatusPSA completed"]))).tags("revoke-status-psa"));
