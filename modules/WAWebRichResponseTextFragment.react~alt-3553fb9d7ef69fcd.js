		...
		return s.jsx(o("WAWebExpandableText.react").ExpandableText, {
			...
			children: function(t) {
				...
				return s.jsx(o("WAWebEmojiText.react").EmojiText, {
					...
					dirMismatch: o("WAWebFrontendMsgGetters").getRtl(n) !== r("WAWebL10N").isRTL(),
