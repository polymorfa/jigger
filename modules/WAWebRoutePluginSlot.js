__d("WAWebRoutePluginSlot", [
	...
	function h(t, r) {
		var a = o("react-compiler-runtime").c(4), i = c(t), l = m(null), s, u;
		a[0] !== i || a[1] !== r ? (s = function() {
			if (n("cr:7455") != null) {
				var t = l.current;
				t != null && t !== r && n("cr:7455").DEV(e || (e = babelHelpers.taggedTemplateLiteralLoose(["useRegisterRoutePluginSlotValue: registered value reference changed between renders for the same slot. The value MUST be a stable reference (module-level export or useCallback) — see WAWebRoutePluginSlot JSDoc. Unstable references thrash the slot and re-run the layout effect on every render."]))), l.current = r;
			}
			return i == null || i.applyValue(r), (function() {
				i == null || i.applyValue(null);
			});
		}, u = [i, r], a[0] = i, a[1] = r, a[2] = s, a[3] = u) : (s = a[2], u = a[3]), d(s, u);
	}
