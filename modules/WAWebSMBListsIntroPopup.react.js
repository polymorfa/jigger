__d("WAWebSMBListsIntroPopup.react", [
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(6), n = g, a;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (a = c.jsx(r("WAWebClickableLink.react"), {
			onClick: n,
			children: s._(
				/*BTDS*/
				""
		...
		var m = d, p;
		return t[4] !== e ? (p = c.jsx(h, babelHelpers.extends({ content: m }, e)), t[4] = e, t[5] = p) : p = t[5], p;
	}
	function g() {
	...
	function y(e) {
		var t = o("react-compiler-runtime").c(13), n = e.Icon, a = e.description, i = e.title, l;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (l = "x1iw51ew xyo0t3i", t[0] = l) : l = t[0];
		var s;
		t[1] !== n ? (s = c.jsx(r("WAWebFlexItem.react"), {
			shrink: 0,
			className: l,
			children: c.jsx(n, {
				width: 24,
		...
		var u;
		t[3] !== i ? (u = c.jsx(r("WDSText.react"), {
			type: "Body1",
			colorName: "contentDefault",
			children: i
		}), t[3] = i, t[4] = u) : u = t[4];
		var d;
		t[5] !== a ? (d = a != null && c.jsx(r("WDSText.react"), {
			type: "Body2",
			colorName: "contentDeemphasized",
			children: a
		}), t[5] = a, t[6] = d) : d = t[6];
		var m;
		t[7] !== u || t[8] !== d ? (m = c.jsxs(r("WAWebFlexItem.react"), { children: [u, d] }), t[7] = u, t[8] = d, t[9] = m) : m = t[9];
		var p;
		return t[10] !== s || t[11] !== m ? (p = c.jsxs(o("WAWebFlex.react").FlexRow, {
			align: "center",
			xstyle: _.contentItemRow,
			children: [s, m]
		}), t[10] = s, t[11] = m, t[12] = p) : p = t[12], p;
	}
