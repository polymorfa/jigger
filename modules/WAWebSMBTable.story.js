__d("WAWebSMBTable.story", [
	...
	function f(e) {
		...
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (r = { className: "xx42vgk xbogo7e x120ee7l x1vb5itz xyi3aci xwf5gio x1p453bz x1suzm8a x13fuv20 x18b5jzi x1q0q8m5 x1t7ytsu x178xt8z x1lun4ml xso031l xpilrb4 x9f619 x6ikm8r x10wlt62 xh8yej3" }, t[0] = r) : r = t[0];
		var a;
	...
	function h() {
		var e = o("react-compiler-runtime").c(14), t = p(), n = c(null), a = n[0], i = n[1], l;
		e[0] !== a ? (l = function(t) {
			return t.id === a;
		}, e[0] = a, e[1] = l) : l = e[1];
		var d = t.find(l), m;
		e[2] === Symbol.for("react.memo_cache_sentinel") ? (m = { className: "x1h3rtpe xyi3aci xwf5gio x1p453bz x1suzm8a x1e56ztr x1y1aw1k xwib8y2 x1g0dm76 xpdmqnj" }, e[2] = m) : m = e[2];
		var h;
		e[3] !== d ? (h = u.jsx("div", babelHelpers.extends({}, m, { children: u.jsx(r("WDSText.react"), {
			type: "Body2",
			colorName: "contentDeemphasized",
			children: d != null ? s._(
				/*BTDS*/
				"",
				[s._param("contact-name", d.name)]
			) : s._(
				/*BTDS*/
				""
			)
		...
		var y;
		e[5] === Symbol.for("react.memo_cache_sentinel") ? (y = g(), e[5] = y) : y = e[5];
		var C;
		e[6] !== i ? (C = function(t) {
			return i(t.id);
		}, e[6] = i, e[7] = C) : C = e[7];
		var b;
		e[8] !== t || e[9] !== C ? (b = u.jsx(f, { children: u.jsx(r("WAWebSMBTable.react"), {
			columns: y,
			items: t,
			getItemKey: _,
			onRowClick: C
		}) }), e[8] = t, e[9] = C, e[10] = b) : b = e[10];
		var v;
		return e[11] !== h || e[12] !== b ? (v = u.jsxs(u.Fragment, { children: [h, b] }), e[11] = h, e[12] = b, e[13] = v) : v = e[13], v;
	}
	function y() {
		var e, t, n = o("react-compiler-runtime").c(5), a;
		n[0] === Symbol.for("react.memo_cache_sentinel") ? (a = p(), n[0] = a) : a = n[0];
		var i = a, l = c((e = (t = i[0]) == null ? void 0 : t.id) != null ? e : ""), s = l[0], d = l[1], m;
		n[1] === Symbol.for("react.memo_cache_sentinel") ? (m = g(), n[1] = m) : m = n[1];
		var h;
		n[2] === Symbol.for("react.memo_cache_sentinel") ? (h = function(t) {
			return d(t.id);
		}, n[2] = h) : h = n[2];
		var y;
		return n[3] !== s ? (y = u.jsx(f, { children: u.jsx(r("WAWebSMBTable.react"), {
			columns: m,
			items: i,
			getItemKey: _,
			onRowClick: h,
