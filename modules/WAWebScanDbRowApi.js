__d("WAWebScanDbRowApi", ["WAWebMsgType"], (function(t, n, r, o, a, i, l) {
	var e, s = new Set([
	...
	function u(e, t) {
		if (t === "lru-media-meta-info") {
			var n = 0;
			return e.size != null && typeof e.size == "number" && (n += e.size), n += m(e), n;
		}
		return m(e);
	}
	function c(e, t) {
	...
	function d(e, t, n) {
		return t === "lru-media-meta-info" && n === "lru-media-storage-idb" ? 1 : e;
	}
	function m(e) {
		var t = 0;
		return JSON.stringify(e, function(e, n) {
			if (typeof e == "string" && (t += 2 * e.length), n instanceof ArrayBuffer) t += n.byteLength;
