__d("WAWebSchemaChatThreadLoggingPendingEvents", [
	...
	function s() {
		var t = o("WAWebModelStorageUtils").getStorage(), n = o("WAWebStorageMutationBuilder").columnBuilder(t.config), r = n.addColumn, a = n.addCompositePrimaryKey, i = n.addIndex;
		t.add(e).version(o("WAWebModelStorageVersions").addChatThreadLoggingTable(), [
			a(["chatId", "startTs"]),
			i("chatId"),
			i("startTs"),
			r("msgsSent"),
		...
		].concat([].concat(o("WAWebChatThreadLoggingCountFields").COUNT_FIELD_NAMES, o("WAWebChatThreadLoggingBoolFlagFields").FLAG_FIELD_NAMES).map(function(e) {
			return r(e);
		}))).view(function(e) {
			return e;
		});
