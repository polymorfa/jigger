__d("WAWebSchemaGroupMetadata", [
	...
	function s() {
		...
		e.add_OPTIMIZED_EXPERIMENT("group-metadata", function(e, t) {
			var n, r = t.addColumn, a = t.addIndex, i = t.addUserDefinedPrimaryKey, l = t.removeColumn;
			return e.version((n = o("WAWebModelStorageVersions")).groupMetadataCreateTable(), [
				i("id"),
				r("subject"),
				r("subjectTime"),
				r("creation"),
