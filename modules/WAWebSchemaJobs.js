__d("WAWebSchemaJobs", [
	...
	var e = o("WAWebStorageMutationBuilder").columnBuilder(), s = e.addAutoIncrementingPrimaryKey, u = e.addColumn, c = e.addIndex, d = e.removeColumn;
	function m() {
		o("WAWebJobsStorageUtils").getStorage().add("jobs-store").version(o("WAWebJobsStorageVersions").jobsCreateV1Table(), [
			s("jobId"),
			u("type"),
			u("uniqKey"),
			c("uniqKey"),
			...
			u("backedOffCount"),
			u("version")
		]).version(o("WAWebJobsStorageVersions").jobsCreateV2Table(), [u("stepUnexpectedErrorCount"), d("endTime")]).view(function(e) {
			return {
				jobId: e.jobId,
				type: e.type,
				uniqKey: e.uniqKey,
