__d("WAWebScreenLockChatlistHeaderDropdownItem.react", [
	"fbt",
	...
	function c() {
		...
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = o("WAWebUserPrefsScreenLock").getScreenLockEnabled(), e[0] = t) : t = e[0];
		var n = t, a;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (a = function(t) {
			if (t == null || t.stopPropagation(), o("WAWebChatlistHeaderDropdownLogEvents").logMenuEvent(o("WAWebWamEnumWebcMenuItemLabel").WEBC_MENU_ITEM_LABEL.APP_LOCK), !n) {
				o("WAWebDrawerManager").DrawerManager.openDrawerLeft(o("WAWebAdaptiveLayoutGatingUtils").shouldUseDrawerDescriptor() ? {
					...
					initialStep: o("WAWebSettingsConst").SettingsSteps.ScreenLock
			...
			e ? o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
				tsNavigationData: {
					surface: "unknown",
