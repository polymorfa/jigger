__d("WAWebScreenLockChatlistHeaderDropdownItem.react", [
	...
	var e, u = e || (e = o("react"));
	function c() {
		var e = o("WAWebUserPrefsScreenLock").getScreenLockEnabled(), t = function(n) {
			if (n == null || n.stopPropagation(), o("WAWebChatlistHeaderDropdownLogEvents").logMenuEvent(o("WAWebWamEnumWebcMenuItemLabel").WEBC_MENU_ITEM_LABEL.APP_LOCK), !e) {
			...
			t ? o("WAWebModalManager").ModalManager.open(u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
				tsNavigationData: {
					surface: "unknown",
