__d("WAWebSearchInput", [
	...
	function h(e) {
		var t = e.children, n = e.colorScheme, a = e.containerXStyle, i = e.detailLeft, l = e.detailRight, c = e.filter, h = e.focusOnMount, y = h === void 0 ? !0 : h, C = e.loading, b = e.onArrowDown, v = e.onCancel, S = e.onClearFilter, R = e.onClick, L = e.onSearch, E = e.padding, k = e.placeholder, I = e.searchInputA11yLabel, T = e.showBackButton, D = T === void 0 ? !1 : T, x = e.showCloseButton, $ = x === void 0 ? !1 : x, P = e.tabOrder, N = p(""), M = N[0], w = N[1], A = m(), F = m(), O = M || c != null, B = p(!1), W = B[0], q = B[1], U = function(t) {
			var e = t.text;
			w(e), L == null || L(e);
		}, V = function() {
			A.current && (o("WAWebLexicalUtils").setTextContent(A.current, ""), U({
				text: "",
				parsableText: "",
				data: {}
			}));
		...
		var Z = null, ee = u.jsx(o("WAWebSearchRefreshedThinIcon.react").SearchRefreshedThinIcon, { xstyle: _.iconColorRefreshed }), te = D ? u.jsxs("button", {
			"aria-label": s._(
				/*BTDS*/
				""
			),
		...
		C === !0 ? Z = u.jsx(o("WAWebFlex.react").FlexRow, {
			marginEnd: 16,
		...
		}) : (O || $) && (Z = u.jsx(o("WAWebFlex.react").FlexRow, {
			paddingEnd: 20,
		...
		}, ie = c != null && u.jsx(r("WAWebSearchFilterChip.react"), {
			onClearFilter: re,
			ref: F,
			text: c,
	...
	y.displayName = y.name + " [from " + i.id + "]", l.SearchInput = h, l.DrawerSearchInput = y;
}), 226);
