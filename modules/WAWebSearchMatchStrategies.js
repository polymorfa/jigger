__d("WAWebSearchMatchStrategies", [
	...
	function s(e, t) {
		...
		if (o("WAWebContactSearchGatingUtils").isTokenizedSearchEnabled()) {
			...
			var a = [];
			for (var i of r) {
				var l = o("WAWebL10NRemoveDiacritics").removeDiacritics(i).toLowerCase(), s = o("WAWebMatchesAtWordBoundary").matchesAtWordBoundary(n, l);
				if (s === -1) return null;
				a.push({
					startIndex: s,
					length: l.length
		...
		var u = o("WAWebL10NRemoveDiacritics").removeDiacritics(t).toLowerCase(), c = o("WAWebMatchesAtWordBoundary").matchesAtWordBoundary(n, u);
		return c === -1 ? null : [{
			startIndex: c,
			length: u.length
		}];
