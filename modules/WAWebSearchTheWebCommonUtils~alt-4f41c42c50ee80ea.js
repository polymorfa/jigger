__d("WAWebSearchTheWebCommonUtils", [
	...
	function E(e) {
		var t = e.onSearchClick, n = e.searchType, a = c(!1), i = a[0], l = a[1];
		return u.jsx(o("WAWebFlex.react").FlexItem, {
			...
			children: u.jsx(r("WAWebCellV2.react"), {
				...
				onClick: async function() {
					r("WAWebNetworkStatus").online ? (l(!0), await t(), l(!1), new (o("WAWebHfmTextSearchCompleteWamEvent")).HfmTextSearchCompleteWamEvent().commit(), o("WAWebModalManager").ModalManager.close()) : g(f());
				},
				...
				primaryRight: i ? u.jsx(o("WAWebSpinner.react").Spinner, {
					size: 20,
					color: "accent"
				}) : null
			})
