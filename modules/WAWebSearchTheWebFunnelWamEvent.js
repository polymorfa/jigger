__d("WAWebSearchTheWebFunnelWamEvent", [
	...
	var e = o("WAWebWamCodegenUtils").defineEvents({ SearchTheWebFunnel: [
		5702,
		{
			imageSearchFailedErrorType: [5, o("WAWebWamEnumImageSearchFailedErrorType").IMAGE_SEARCH_FAILED_ERROR_TYPE],
			...
			stwInteraction: [4, o("WAWebWamEnumStwInteraction").STW_INTERACTION]
		},
		[
			1,
			1,
