__d("WAWebSearchTheWebModal.react", [
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(33), a = e.entryPoint, i = e.message, l = e.stwFormat, c = u(!1), d = c[0], p = c[1], _;
		t[0] !== i ? (_ = o("WAWebSearchTheWebGetSupportedSearchOptions").getSupportedSearchOptions(i), t[0] = i, t[1] = _) : _ = t[1];
		var f = _;
		if (f.size < 1) return null;
		var g;
		t[2] !== a || t[3] !== i || t[4] !== l ? (g = function() {
		...
		}, t[2] = a, t[3] = i, t[4] = l, t[5] = g) : g = t[5];
		var h = g, y;
		t[6] !== a || t[7] !== i || t[8] !== f || t[9] !== l ? (y = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (!r("WAWebNetworkStatus").online) o("WAWebSearchTheWebCommonUtils").showSearchFailureToast(o("WAWebSearchTheWebCommonUtils").getNoInternetToastMsg());
					...
					var e;
					p(!0), yield (e = f.values().next().value) == null ? void 0 : e.handleSearchAction({
						stwEntryPoint: a,
						stwInteraction: o("WAWebWamEnumStwInteraction").STW_INTERACTION.SEARCH_CLICKED,
						stwFormat: l,
						messageType: o("WAWebWamMsgUtils").getWamMessageType(i)
					}), p(!1), new (o("WAWebHfmTextSearchCompleteWamEvent")).HfmTextSearchCompleteWamEvent().commit(), o("WAWebModalManager").ModalManager.close();
				}
			});
			return function() {
				return e.apply(this, arguments);
			};
		})(), t[6] = a, t[7] = i, t[8] = f, t[9] = l, t[10] = y) : y = t[10];
		var C = y, b, v, S, R, L, E;
		if (t[11] !== a || t[12] !== h || t[13] !== C || t[14] !== d || t[15] !== i || t[16] !== f || t[17] !== l) {
			var k = o("WAWebFrontendMsgGetters").getChat(i), I = o("WAWebSearchTheWebCommonUtils").getModalHeaderText({
				entryPoint: a,
				isNewsletter: o("WAWebChatGetters").getIsNewsletter(k),
				messageType: o("WAWebWamMsgUtils").getWamMessageType(i),
				stwFormat: l
			}), T = o("WAWebChatGetters").getIsNewsletter(k) ? null : o("WAWebSearchTheWebCommonUtils").getModalHeaderSubtext();
			v = s.jsx(m, {
				onCancel: h,
				onOk: C,
				isSearching: d,
				headerText: I,
				headerSubText: T
			}), b = r("WAWebMultiSearchModal.react"), S = f, R = a, L = l, E = o("WAWebChatGetters").getIsNewsletter(k), t[11] = a, t[12] = h, t[13] = C, t[14] = d, t[15] = i, t[16] = f, t[17] = l, t[18] = b, t[19] = v, t[20] = S, t[21] = R, t[22] = L, t[23] = E;
		} else b = t[18], v = t[19], S = t[20], R = t[21], L = t[22], E = t[23];
		var D;
		t[24] !== i ? (D = o("WAWebWamMsgUtils").getWamMessageType(i), t[24] = i, t[25] = D) : D = t[25];
		var x;
		t[26] !== b || t[27] !== S || t[28] !== R || t[29] !== L || t[30] !== E || t[31] !== D ? (x = s.jsx(b, {
			searchOptions: S,
			entryPoint: R,
			stwFormat: L,
			isNewsletter: E,
			messageType: D
		}), t[26] = b, t[27] = S, t[28] = R, t[29] = L, t[30] = E, t[31] = D, t[32] = x) : x = t[32];
		var $ = x;
		return f.size === 1 ? v : $;
	}
	function m(e) {
