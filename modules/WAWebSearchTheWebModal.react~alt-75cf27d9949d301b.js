__d("WAWebSearchTheWebModal.react", [
	...
	function d(e) {
		var t = e.entryPoint, a = e.message, i = e.stwFormat, l = u(!1), c = l[0], d = l[1], p = o("WAWebSearchTheWebGetSupportedSearchOptions").getSupportedSearchOptions(a);
		...
		var _ = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (!r("WAWebNetworkStatus").online) o("WAWebSearchTheWebCommonUtils").showSearchFailureToast(o("WAWebSearchTheWebCommonUtils").getNoInternetToastMsg());
					...
					var e;
					d(!0), yield (e = p.values().next().value) == null ? void 0 : e.handleSearchAction({
						stwEntryPoint: t,
		...
		})(), g = o("WAWebFrontendMsgGetters").getChat(a), h = o("WAWebSearchTheWebCommonUtils").getModalHeaderText({
			entryPoint: t,
			isNewsletter: o("WAWebChatGetters").getIsNewsletter(g),
			messageType: o("WAWebWamMsgUtils").getWamMessageType(a),
			stwFormat: i
		}), y = o("WAWebChatGetters").getIsNewsletter(g) ? null : o("WAWebSearchTheWebCommonUtils").getModalHeaderSubtext(), C = s.jsx(m, {
			onCancel: _,
			onOk: f,
			isSearching: c,
			headerText: h,
