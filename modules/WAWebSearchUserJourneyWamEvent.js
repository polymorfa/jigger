__d("WAWebSearchUserJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ SearchUserJourney: [
		6358,
		{
			searchDsSendContentType: [32, o("WAWebWamEnumSearchDsSendContentType").SEARCH_DS_SEND_CONTENT_TYPE],
			...
			searchSelectedMessageSource: [24, o("WAWebWamEnumSearchSelectedMessageSource").SEARCH_SELECTED_MESSAGE_SOURCE],
			...
			searchUjCriteriaType: [5, o("WAWebWamEnumSearchUjCriteriaType").SEARCH_UJ_CRITERIA_TYPE],
			searchUjDismissType: [6, o("WAWebWamEnumSearchUjDismissType").SEARCH_UJ_DISMISS_TYPE],
			searchUjFilterCount: [7, e.TYPES.INTEGER],
			searchUjFilterType: [8, o("WAWebWamEnumSearchUjFilterType").SEARCH_UJ_FILTER_TYPE],
			...
			searchUjItemType: [11, o("WAWebWamEnumSearchUjItemType").SEARCH_UJ_ITEM_TYPE],
			...
			searchUseCase: [15, o("WAWebWamEnumSearchUseCase").SEARCH_USE_CASE],
			searchUserJourneyAction: [16, o("WAWebWamEnumSearchUserJourneyAction").SEARCH_USER_JOURNEY_ACTION],
