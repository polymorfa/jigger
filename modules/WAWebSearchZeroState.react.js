__d("WAWebSearchZeroState.react", [
	...
	function h(e) {
		var t = e.onBlur, a = e.onChatClick, i = e.onClearAll, l = e.onKeyDown, c = e.onSearchFocus, h = e.onSetShowingClearConfirmation, y = e.recentChats, C = e.ref, b = p([]), v = p(0), S = _(0), R = S[0], L = S[1], E = p(null), k = p(null), I = p(!1), T = d(function(e) {
			v.current = e, L(e);
		}, []), D = function() {
			var e;
		...
		var x = function(t, n) {
			...
			switch (t.keyCode) {
				case r("Keys").TAB:
					if (!t.shiftKey) k.current != null && t.target instanceof Node && k.current.contains(t.target) ? (t.preventDefault(), t.stopPropagation(), D()) : (t.preventDefault(), t.stopPropagation(), A());
					else {
						var e = k.current;
			...
			var e = t.target;
			e instanceof HTMLElement && e.closest("button, a, [role=\"button\"]") == null && (t.preventDefault(), c());
		}, B = function(n) {
			var e = E.current, o = n.relatedTarget;
			r("setTimeout")(function() {
				I.current || e != null && o instanceof Node && e.contains(o) || t == null || t();
			}, 0);
		}, W = (function() {
				...
				children: [u.jsxs(o("WAWebFlex.react").FlexRow, {
					...
					children: y.map(function(e, t) {
						return u.jsx(r("WAWebSearchZeroStateRecentSearchItem.react"), {
							...
							tabIndex: t === R ? o("WAWebTabOrder").TAB_ORDER.CHAT_LIST_SEARCH : -1
						}, e.id.toString());
					})
				})]
			})
