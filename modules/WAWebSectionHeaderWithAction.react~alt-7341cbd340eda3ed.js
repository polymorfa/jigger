__d("WAWebSectionHeaderWithAction.react", [
	...
	function m(e) {
		var t = e.actionText, n = e.active, a = e.onClick, i = e.subtitle, l = e.title, u = e.xstyle, c = function(t) {
		...
		return s.jsxs(o("WAWebFlex.react").FlexRow, {
			...
			children: [s.jsxs(o("WAWebFlex.react").FlexColumn, { children: [s.jsx(r("WDSText.react"), {
				...
				children: l
			}), s.jsx(o("WAWebText.react").WAWebTextSmall, { children: i })] }), s.jsx(p, {
				active: n,
				onClick: a,
				testid: c(t) + "-" + c(l),
				text: t
	...
	function p(e) {
		var t = e.active, n = e.onClick, o = e.testid, a = e.text, i = d();
		return c(function() {
