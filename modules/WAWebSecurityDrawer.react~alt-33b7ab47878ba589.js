__d("WAWebSecurityDrawer.react", [
	...
	function _() {
		return u.jsxs(u.Fragment, { children: [u.jsxs(o("WAWebFlex.react").FlexColumn, {
			xstyle: p.icon,
			align: "center",
			justify: "center",
			children: [u.jsx(r("WAWebFlexItem.react"), { children: u.jsx(o("WAWebSecurityShieldIcon.react").SecurityShieldIcon, {}) }), u.jsx(o("WAWebFlex.react").FlexColumn, {
				xstyle: p.iconLock,
				align: "center",
				justify: "center",
			...
			className: "x1h678fw xcldk2z xv6tirj x1phvje8 x1nmyh1g x1jchvi3 x1o2sk6j",
			children: [
				s._(
					/*BTDS*/
					""
	...
	function f(e) {
		var t = e.onClose, n = e.ref, a = r("useWAWebToggle")(o("WAWebUserPrefsNotifications").getGlobalSecurityNotifications, o("WAWebUserPrefsNotifications").setGlobalSecurityNotifications), i = a[0], l = a[1], c = s._(
			/*BTDS*/
			""
		), p = o("WAWebMiscGatingUtils").isPrivacyNarrativeV1Enabled(), f = m(function() {
			return o("WAWebDefenseModeUtils").getWamEnumIfSettingLockedByDefenseMode("securityNotifications");
		}), h = f[0], y = f[1], C = h != null;
		...
		var b = d(function() {
			h != null ? o("WAWebDefenseModeLockedInterstitial.react").openDefenseModeLockedInterstitialGlobal(h, i ? "on" : "off") : l();
		}, [
			h,
			i,
			l
		...
		return u.jsx(r("WAWebDrawer.react"), {
			...
			children: u.jsx(o("WAWebKeyboardRotateFocus.react").RotateFocus, {
				...
				children: u.jsxs("div", {
					...
					children: [u.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
						...
						animation: !1,
						children: [
							p ? u.jsx(o("WAWebPrivacyNarrativeE2ESummary.react").E2eSummarySecurityDrawer, {}) : u.jsx(_, {}),
