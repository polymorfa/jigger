__d("WAWebSeeReviewDetailScreenDrawer.react", [
	...
	function f(e) {
		var t, n, r = o("react-compiler-runtime").c(20), a = e.currentEnforcementAppeal, i = ((t = a.violatingContentData) == null ? void 0 : t.contentType) === o("WAWebCommonNewsletterEnums").ViolatingContentType.STATUS || ((n = a.enforcementExtraData) == null || (n = n.enforcementTargetData) == null ? void 0 : n.contentType) === o("WAWebCommonNewsletterEnums").ViolatingContentType.STATUS, l;
		r[0] !== a.appealState || r[1] !== a.enforcementType || r[2] !== i ? (l = o("WAWebNewsletterIntegrityUtils").getTitleBasedOnEnforcementTypeAndOutcome(a.appealState, a.enforcementType, i), r[0] = a.appealState, r[1] = a.enforcementType, r[2] = i, r[3] = l) : l = r[3];
		var u;
		r[4] !== l ? (u = c.jsx(o("WAWebFlex.react").FlexRow, {
			align: "center",
			justify: "center",
		...
		var d;
		r[6] !== a.appealState || r[7] !== a.countryCode || r[8] !== a.enforcementType || r[9] !== a.enforcementViolationCategory || r[10] !== i ? (d = o("WAWebNewsletterIntegrityUtils").getHeaderBodyTextBasedOnEnforcementTypeAndOutcome({
			...
			isStatusContent: i
		}), r[6] = a.appealState, r[7] = a.countryCode, r[8] = a.enforcementType, r[9] = a.enforcementViolationCategory, r[10] = i, r[11] = d) : d = r[11];
		var m;
		r[12] !== d ? (m = c.jsx(o("WAWebFlex.react").FlexRow, {
			align: "center",
			justify: "center",
		...
		}), r[12] = d, r[13] = m) : m = r[13];
		var _;
		r[14] !== a.appealCreationTime ? (_ = c.jsx(o("WAWebFlex.react").FlexRow, {
			align: "center",
			justify: "center",
			children: c.jsx(o("WAWebText.react").WAWebTextMuted, {
				...
				children: s._(
					/*BTDS*/
					"",
					[s._param("appeal_creation_time", o("WAWebDSADateUtils").getDSADateDisplayString(a.appealCreationTime))]
				)
			})
		}), r[14] = a.appealCreationTime, r[15] = _) : _ = r[15];
		var f;
		return r[16] !== u || r[17] !== m || r[18] !== _ ? (f = c.jsxs(c.Fragment, { children: [
			u,
			m,
			_
		] }), r[16] = u, r[17] = m, r[18] = _, r[19] = f) : f = r[19], f;
	}
	l.default = _;
}), 226);
