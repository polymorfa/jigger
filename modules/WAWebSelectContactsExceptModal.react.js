__d("WAWebSelectContactsExceptModal.react", [
	...
	function h(t) {
		var a, i, l, c, d, m = t.category, h = t.onBack, v = t.onConfirm, S = t.onDismiss, R = (a = h != null ? h : S) != null ? a : b, L = r("useWAWebAsync")(function() {
			var t = (function() {
					...
					try {
						var t = (function() {
							var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
								var e = f(m);
								yield o("WAWebSyncPrivacyDisallowedLists").syncSinglePrivacyDisallowedList(e);
						...
						return yield o("WAPromiseTimeout").promiseTimeout(t(), o("WAWebSettingsConst").WAIT_FOR_PRIVACY_LIST_SYNC_TIMEOUT_MS);
					} catch (t) {
						var a = r("getErrorSafe")(t);
						throw t instanceof o("WACustomError").TimeoutError || o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["error: ", ""])), String(a.stack)).sendLogs("SelectContactsExceptModal:failed to get privacyDisallowedList"), o("WAWebToastManager").ToastManager.open(p.jsx(o("WAWebToast.react").Toast, { msg: s._(
							/*BTDS*/
							""
						) })), R(), t;
					}
			...
			return t();
		}, [m]), E = r("useWAWebFilteredContacts")();
		if (L.error != null) return null;
		var k = (i = (l = L.value) == null ? void 0 : l.excludedContacts) != null ? i : [], I = (c = (d = L.value) == null ? void 0 : d.dhash) != null ? c : null, T = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				...
				}), i = o("WAArrayDifferenceBy").differenceBy(a, n, function(e) {
				...
				}), l = o("WAArrayDifferenceBy").differenceBy(n, a, function(e) {
					return e.wid.toString();
				}).map(function(e) {
					return {
				...
				}), c = [].concat(i, l), d = o("WAWebSetPrivacyForOneCategoryAction").privacyWebNameToServerName(m);
				if (d === "readreceipts" || d === "online" || d === "calladd" || d === "messages") throw r("err")("select_contacts_except_modal: name can not be " + d);
				try {
		...
		return p.jsx(o("WAWebSelectModal.react").SelectModal, babelHelpers.extends({ title: g(m) }, h != null ? { onBack: R } : { onCancel: R }, {
