__d("WAWebSelectMenuItem.react", [
	...
	function h(e) {
		var t = e.children, r = e.initialSelection, a = e.multiselect, i = o("WAWebMenuController.react").useMenu(), l = o("useWAWebSet").useSet(), s = l[0], c = l[1], m = c.clear, p = c.toggle, f = d.map(t, function(e) {
			return e.props.optionId;
		}), h = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
				var r;
				a === !0 ? r = yield p(t) : r = yield m([t]), e.onSelect == null || e.onSelect(t, n, r);
			});
			return function(n, r) {
				return t.apply(this, arguments);
			};
		})();
		o("useWAWebListener").useListener(i.events, "select", (function() {
