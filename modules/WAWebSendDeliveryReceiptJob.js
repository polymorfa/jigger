__d("WAWebSendDeliveryReceiptJob", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = t.isPeerMsg, a = t.isStatusContext, i = t.msgId, l = t.participant, s = t.receiptModeBitmask, u = s === void 0 ? 0 : s, d = t.recipient, m = t.response, p = t.to, _ = p.isUser() && o("WAWebUserPrefsMeUser").isMeAccount(p) || l != null && o("WAWebUserPrefsMeUser").isMeAccount(l), f = m.hasInactiveMsg === !0 && !_, g = !f;
			c({
				externalId: i,
				isActiveReceipt: g,
				isFromPeer: _,
