__d("WAWebSendEventResponseMsgAction", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (o("WAWebAddonSendMsgData").isOptimisticAddonSendSupported(t)) n = yield o("WAWebSendAddonMsgChatAction").addAndSendAddonToChat(t);
			else {
				var a = yield o("WAWebCreateEncryptedEventResponseMsgData").createEncryptedEventResponseMsgData(t, e.eventCreationMsg);
