__d("WAWebSendGroupSkmsgJob", [
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			if ((n = l.sendPerfReporter) == null || n.startPrekeysFetchStage(), (r = l.sendPerfReporter) == null || r.setFetchedPrekeyCount(0), s.length > 0) try {
				var u, c = yield o("WAWebManageE2ESessionsJob").ensureE2ESessions({
					identityChanged: !1,
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a, i, l, s, u) {
			var c, d, m, p;
			(c = l.sendPerfReporter) == null || c.startClientEncryptStage();
			var _ = o("WAWebSendMsgCommonApi").encodeAndPad(a), f = (u == null ? void 0 : u.kind) === "schedule" ? u.originalMediaType : o("WAWebBackendJobsCommon").mediaTypeFromProtobuf(a), g = o("WAWebBotBaseGating").isBotEnabled() && ((d = e.invokedBotWid) == null ? void 0 : d.isBot()) === !0, h = o("WAWebBotBaseGating").isBotEnabled() && o("WAWebMsgGetters").getIsBotFeedbackMessage(e), y = o("WAWebMsgGetters").getIsRevokeForMsgFromOrDeliveredToBot(e), C = yield o("WAWebEncryptMsgProtobuf").encryptMsgSenderKey(e, t, _, i), b = C.ciphertext, v = C.senderKeyBytes, S;
			n.length > 0 && (S = yield o("WAWebGetGroupKeyDistributionMsg").getKeyDistributionMsg(e, t, n, v, !1)), (m = l.sendPerfReporter) == null || m.postClientEncryptStage();
			var R = null, E = !1;
			S && S.length > 0 && !h ? R = o("WAWap").wap("participants", null, S.map(function(e) {
			...
			})) : s != null && (R = o("WAWap").wap("participants", null, r.map(function(e) {
			...
			var k = h ? null : o("WAWap").wap("enc", {
				...
				"decrypt-fail": o("WAWebBackendJobsCommon").encodeMaybeDecryptFail(o("WAWebE2EProtoUtils").decryptFailAttributeFromProtobuf(a))
			}, b), I = null, T = g || h || y || o("WAWebBotGroupGatingUtils").isOpenGroupBotSendEnabled() && i.isOpenBotGroup === !0 ? yield L({
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a, i, l, h, C) {
			var v, S, L, E, k, I, T = e.data, D = T.id, x = T.to, $ = e.data;
			o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["encryptAndSendSenderKeyMsg: sending ", ""])), D).tags("messaging");
			var P = D.id, N = a.rotateKey, M = a.skDistribList, w = a.skList;
			R(x, l), (v = l.sendPerfReporter) == null || v.setSenderKeyDistributionCount(M.length);
			var A = w.concat(M), F = o("WAWebUserPrefsMeUser").getMeDeviceLidOrThrow(), O = yield o("WAWebPhashUtils").phashV2([].concat(A, [F]), o("WAWebBotGroupGatingUtils").isOpenGroupBotParticipantAddEnabled() && i.isOpenBotGroup === !0, o("WAWebBotGroupGatingUtils").isTEEGroupBotParticipantAddEnabled() && i.isTeeBotGroup === !0), B = o("WAWebMsgGetters").getIsBotFeedbackMessage($);
			yield o("WAWebApiMessageInfoStore").createOrMergeReceiptRecords(A.map(function(e) {
				return {
					msgKey: D,
					receiverId: e
				};
			})), N && (yield o("WAWebSignal").Session.deleteGroupSenderKeyInfo(x, F)), yield g({
				groupData: i,
				metricReporter: l,
				skDistribList: M
			});
			var W = yield y($, x, M, w, t, i, l, h, C), q = W.botMsgNode, U = W.identityNode, V = W.keyDistributionMsg, H = W.skeyEncryptedGroupMsg, G = h == null ? void 0 : h.get(o("WAWebWidToJid").widToUserJid(o("WAWebWidFactory").asUserWidOrThrow(F))), z = G != null ? o("WAWap").wap("sender_content_binding", null, G) : null, j = i.isLidAddressingMode === !0 ? o("WAWebHandleMsgCommon").STANZA_MSG_ADDRESSING_MODE.lid : o("WAWebHandleMsgCommon").STANZA_MSG_ADDRESSING_MODE.pn, K = yield o("WAWebReportingTokenUtils").genReportingTokenBodyForStanza($, t, D.toString()), Q = o("WAWap").wap("message", {
				id: o("WAWap").CUSTOM_STRING(P),
				to: o("WAWebCommsWapMd").CHAT_JID(x),
				phash: B ? o("WAWap").DROP_ATTR : o("WAWap").CUSTOM_STRING(O),
				type: (S = C == null ? void 0 : C.originalStanzaType) != null ? S : o("WAWebE2EProtoUtils").typeAttributeFromProtobuf(t),
				edit: o("WAWebSendMsgCommonApi").editAttribute(t, $.subtype),
				addressing_mode: o("WAWap").CUSTOM_STRING(j)
			}, V, H, U, b(t, e), o("WAWebSendMsgMetaNode").genMetaNode({
				chatId: x,
				groupData: i,
				includeAttributes: {},
				msgProtobuf: t,
				msgRecord: e
			}), C != null ? o("WAWebScheduledMsgStanzaContributor").genScheduledMsgMetaNode(C) : null, q, z, K);
			yield o("WAWebSendMsgCommonApi").updateIdentityRange(e, A), yield o("WAWebSignalProtocolStore").getSignalProtocolStore().flushBufferToDiskIfNotMemOnlyMode(), (L = l.sendPerfReporter) == null || L.postReadyToSendStage(), (E = l.sendPerfReporter) == null || E.startWrittenWireStage(), n("cr:10199") == null || n("cr:10199").printEncNode(t);
			var X = yield o("WAWebDeprecatedSendIqWorkerCompatible").deprecatedSendStanzaAndReturnAck(Q, o("WAWebCommsAckParser").toCoreAckTemplate({
				id: P,
				class: "message",
				from: x,
				participant: null
			...
			if (V) {
				var Y;
				(Y = l.sendReporter) == null || Y.setMessageDistributionType(o("WAWebWamEnumMessageDistributionEnumType").MESSAGE_DISTRIBUTION_ENUM_TYPE.SENDER_KEY_DISTRIBUTION_MESSAGE);
			}
			(k = l.sendPerfReporter) == null || k.postWrittenWireStage(), l.sendPerfReporter = null, (I = l.sendReporter) == null || I.postSuccess(), l.sendReporter = null;
			var J = o("WAWebSendMsgCommonApi").sendMsgAckSyncParser.parse(X);
			if (J.error) return o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose(["encryptAndSendSenderKeyMsg: invalid ack from server for ", ""])), $.id).tags("messaging"), (f || (f = n("Promise"))).reject(r("err")("[messaging] encryptAndSendSenderKeyMsg: Invalid ack from server"));
			var Z = J.success.error;
			if (Z === o("WAWebCreateNackFromStanza").NackReason.StaleGroupAddressingMode) return o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["encryptAndSendSenderKeyMsg: ack with error code 421"]))).tags("messaging"), (f || (f = n("Promise"))).resolve().then(function() {
			...
			}), e.type === o("WAWebSendMsgTypes").SendMessageRecordType.Message && e.data.updateAck(o("WAWebAck").ACK.FAILED, !1), f.reject(r("err")("[messaging] encryptAndSendSenderKeyMsg: ack with error code 421"));
			yield o("WAWebApiParticipantStore").markHasSenderKey(x, M);
			var ee = J.success, te = ee.addressingMode, ne = ee.count, re = ee.phash;
			return re != null && re !== O ? (o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose([
				"encryptAndSendSenderKeyMsg: phash mismatch ",
				" server=",
				""
			])), $.id, re).tags("messaging"), o("WAWebResendGroupMsg").resendPersistedGroupMsgWrapper({
				isDirect: !1,
				msgRecord: e,
				msgProtobuf: t,
				oldList: A,
			...
			})) : te != null && te !== j && o("WAWebGroupHandleAddressingModeMismatch").handleAddressingModeMismatch(x, {
				localAddressingMode: j,
				serverAddressingMode: te,
				mismatchOrigin: o("WAWebWamEnumMismatchOriginType").MISMATCH_ORIGIN_TYPE.ACK_OUTGOING_MESSAGE
			}), ne != null && o("WAWebSchemaMessage").getMessageTable().merge(String(D), { count: ne }), J.success;
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var c = yield o("WAWebE2EProtoGenerator").updateBotInvokeMsgProtoCopyForCapi({
				message: r,
			...
			var d = yield o("WAWebEncryptMsgProtobuf").encryptMsgProtobuf(i, 0, c, n, 0), m = d.ciphertext, p = d.type;
