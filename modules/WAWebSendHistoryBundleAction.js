__d("WAWebSendHistoryBundleAction", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, r, a, i) {
			var l = yield o("WAWebGenerateGroupHistoryBundleMsgData").generateGroupHistoryBundleMsgData({
				chatId: t,
				historyReceivers: n,
				nonHistoryReceivers: r,
				selectedMessageCount: a,
				targetStartMessageTime: i
			}), u = yield o("WAWebFindChatAction").findExistingChat(o("WAWebJidToWid").groupJidToWid(t), "messageHistorySend"), c = o("WAWebSendMsgChatAction").addAndSendMsgToChat(u, l), d = c[0], p = c[1], _ = yield p, f = _.messageSendResult;
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield o("WAWebGenerateGroupHistoryNoticeMsgData").generateGroupHistoryNoticeMsgData({
				chat: e,
			...
			var r = o("WAWebSendMsgChatAction").addAndSendMsgToChat(e, n), a = r[0], i = r[1], l = yield i, s = l.messageSendResult;
			...
			yield o("WAWebGroupHistoryNoticeHandler").markGroupHistoryNoticeSent(e.id, t.historyReceivers);
		...
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (o("WAWebMsgGetters").getType(e) === o("WAWebMsgType").MSG_TYPE.MESSAGE_HISTORY_BUNDLE && o("WAWebGroupHistoryGating").isGroupHistoryPostJoinSenderOrInternalTesterEnabled(e.id.remote)) {
				...
				if (t != null) {
					...
					if (n.length !== 0 && !(yield o("WAWebGroupHistoryNoticeHandler").areAllReceiversNoticeSent(e.id.remote, n))) {
						var r = yield o("WAWebFindChatAction").findExistingChat(e.id.remote, "messageHistorySend");
						yield m(r, t);
					}
				}
			}
	...
	l.sendHistoryBundleAction = c, l.completeGroupHistorySend = m, l.completeGroupHistorySendOnBundleResend = _;
}), 98);
