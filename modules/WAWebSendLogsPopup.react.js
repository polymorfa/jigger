__d("WAWebSendLogsPopup.react", [
	...
	function v(e) {
		var t = o("react-compiler-runtime").c(7), n = e.onDeleteScreenshot, a = e.screenshots, i;
		t[0] !== n ? (i = function(t, r) {
			if (t.url == null) return null;
			var e = "url(" + t.url + ")", a = t.url + "-" + r;
			return u.jsx("div", {
		...
		var l;
		t[2] !== a || t[3] !== i ? (l = r("compactMap")(a, i), t[2] = a, t[3] = i, t[4] = l) : l = t[4];
		var s = l, c;
		return t[5] !== s ? (c = s.length !== 0 ? u.jsx("div", {
			className: "x78zum5 x1tiyuxx x1uc92m x1nbhmlj x181vq82 x1q7yeco",
			children: s
		}) : null, t[5] = s, t[6] = c) : c = t[6], c;
	}
	function S(e) {
		var t = o("react-compiler-runtime").c(6), n = e.isDragging, r = e.onAttachClick, a = e.reachedMaxScreenshots;
		if (a) {
			var i;
			return t[0] === Symbol.for("react.memo_cache_sentinel") ? (i = u.jsx("div", {
			...
			var l;
			return t[1] === Symbol.for("react.memo_cache_sentinel") ? (l = u.jsx("div", {
		...
		var c;
		t[2] === Symbol.for("react.memo_cache_sentinel") ? (c = { className: "x9f619 x78zum5 xdt5ytf x6s0dn4 xl56j7k xh8yej3 xlup9mm xexx8yu xyri2b x18d9i69 x1c1uobl x98l61r x1pg5gke xo1mcw5 x2b8uid xtvhhri x1ypdohk xjbqb8w" }, t[2] = c) : c = t[2];
		var d;
		...
		var m;
		return t[4] !== r ? (m = u.jsx("div", babelHelpers.extends({}, c, {
			onClick: r,
			children: d
		})), t[4] = r, t[5] = m) : m = t[5], m;
	}
	function R(e) {
		var t, a = e.entityId, i = e.onCancel, l = e.onSend, c = e.supportTag, R = p(""), L = R[0], E = R[1], k = p(void 0), I = k[0], T = k[1], D = p(""), x = D[0], $ = D[1], P = p(void 0), N = P[0], M = P[1], w = p(b().toString()), A = w[0], F = w[1], O = p(void 0), B = O[0], W = O[1], q = p((t = e.description) != null ? t : ""), U = q[0], V = q[1], H = p(void 0), G = H[0], z = H[1], j = p([]), K = j[0], Q = j[1], X = p(!1), Y = X[0], J = X[1], Z = p(!1), ee = Z[0], te = Z[1], ne = m(null), re = m(null);
		d(function() {
			var e;
			return (e = ne.current) == null || e.restoreFocus(), te(o("WAWebABPropsSaga").getIsSagaV1Enabled()), function() {
				K.map(function(e) {
					var t = e.url;
		...
		var oe = function(t) {
			...
			var e = L.trim();
			L && !o("WALinkify").validateEmail(e) && T(s._(
				/*BTDS*/
				""
			)), E(e);
		}, de = function(t) {
			...
			t.preventDefault(), t.stopPropagation(), !ie() && o("WAWebEventFiles").getFiles(t, "image/*").then(function(e) {
				...
				if (t.length < e.length && o("WAWebToastManager").ToastManager.open(u.jsx(o("WAWebToast.react").Toast, { msg: s._(
					...
					var n = y - K.length, r = t.slice(0, n), a = r.map(function(e) {
						return {
							file: e,
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = 0, t = L.trim(), n = x.trim();
				if (E(t), $(n), o("WALinkify").validateEmail(t) || (T(s._(
					/*BTDS*/
					""
				)), e += 1), ae(n) || (M(s._(
					/*BTDS*/
			...
			var e = K.slice(), n = e.splice(t, 1), r = n[0];
			URL.revokeObjectURL(r.url), Q(e);
		}, be = u.jsxs("div", { children: [
			u.jsx(v, {
				screenshots: K,
				onDeleteScreenshot: Ce
			}),
			u.jsx(S, {
		...
		return u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			children: u.jsxs(o("WAWebKeyboardHotKeys.react").HotKeys, {
				...
				children: [
					...
					be,
					ee && u.jsxs(o("WAWebText.react").WAWebTextMuted, {
						marginTop: 20,
						children: [
