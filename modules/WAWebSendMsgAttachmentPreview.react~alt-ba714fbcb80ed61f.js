__d("WAWebSendMsgAttachmentPreview.react", [
	...
	function m(e) {
		var t = e.attachments, n = e.onAppendMessage, a = o("useWAWebModelValues").useModelValues(r("WAWebChatPreferenceCollection").getDefault(), [
			"spellcheck",
			"transformTextEmoji",
			"enterIsSend"
		]), i = c(), l = i[0], m = i[1], p = s._(
			/*BTDS*/
			""
		), _ = function() {
			l == null || l.focus();
			...
			n(t.text);
		}, g = t[0], h = u.jsx(r("WAWebSendMsgSharedUtils.react"), { file: g }), y = u.jsx(r("WAWebFlexItem.react"), {
			grow: 0,
		...
		return u.jsxs(u.Fragment, { children: [u.jsx(o("WAWebFlex.react").FlexRow, {}), u.jsx("div", {
			className: "x1n2onr6 xcbkimw x3p9ev8 x1od0jb8 x16ovd2e x1nzty39 x12xbjc7 x12w63v0",
