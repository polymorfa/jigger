__d("WAWebSendMsgCreateDeviceStanza", [
	...
	var e, u, c = n("$InternalEnum").Mirrored(["Retry", "AppStateSync"]), d = n("$InternalEnum")({ OnDemand: 1 });
	function m(e, t, n, r) {
		return p.apply(this, arguments);
	}
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r) {
			var a = n.option, i = n.recipient, l = n.to, u = t;
			return yield o("WAWebManageE2ESessionsJob").ensureE2ESessions({
				identityChanged: !1,
				sessionScope: o("WAWebSessionScope").SessionScope.DEFAULT,
				wids: [l]
			}), o("WAWebUserPrefsMeUser").isMeAccount(l) && a.type !== c.AppStateSync ? (i != null || s(0, 56363), u = o("WAWebDeviceSentMessageProtoUtils").wrapDeviceSentMessage(t, i), yield o("WAWebICDCMetaApi").populateICDCMeta(o("WAWebWidFactory").asUserWidOrThrow(i), u)) : yield o("WAWebICDCMetaApi").populateICDCMeta(o("WAWebWidFactory").asUserWidOrThrow(l), u), g({
				msgProtobuf: u,
				msgRecord: e,
				origin: r,
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a) {
			var i = a.option, l = a.participant, s = a.to;
			if (yield o("WAWebManageE2ESessionsJob").ensureE2ESessions({
				identityChanged: !1,
				sessionScope: o("WAWebSessionScope").SessionScope.DEFAULT,
				wids: [l]
			}), i.type === c.AppStateSync) return (u || (u = n("Promise"))).reject(r("err")("[messaging] createGroupDeviceMsgStanza: not expect for App State Sync message"));
			var d = e.data.id.remote;
			if (!d.isGroup()) return (u || (u = n("Promise"))).reject(r("err")("[messaging] createGroupDeviceMsgStanza: function called for non group WID"));
			var m = yield o("WAWebGroupMsgSendUtils").getParticipantRecord(d.toString()), p = yield o("WAWebGroupMsgSendUtils").getGroupData(d.toString(), m, e), _ = o("WAWebUserPrefsMeUser").isMeAccount(l) ? o("WAWebDeviceSentMessageProtoUtils").wrapDeviceSentMessage(t, s) : t;
			return yield o("WAWebICDCMetaApi").populateICDCMeta(o("WAWebWidFactory").asUserWidOrThrow(l), _), g({
				msgProtobuf: _,
				msgRecord: e,
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n, r, a, i = t.msgProtobuf, l = t.msgRecord, u = t.origin, d = t.params, m = l.data, p = d.botMessageSecret, _ = d.isLidBot, f = d.option, g = d.to, h, y;
			...
			if ((a = y) != null && a.isBot() && o("WAWebBotGroupGatingUtils").isOpenGroupBotSendEnabled()) {
				var D = l.data.id.remote, x = yield o("WAWebGroupMsgSendUtils").getGroupData(D.toString(), void 0);
				T = x.isOpenBotGroup === !0;
			}
			var $ = C.isHosted() && o("WAWebMessagingGatingUtils").isSimpleSignalEnabled(), P = I && p ? yield o("WAWebE2EProtoGenerator").updateBotInvokeMsgProtoCopyForCapi({
				message: i,
				botMessageSecret: p,
				isOpenBotGroup: T,
				mentionedJidList: m.mentionedJidList
			}) : i, N = d.type === "user" && f.type === c.Retry && !I && !o("WAWebUserPrefsMeUser").isMeAccount(g), M = yield o("WAWebPQSessionScope").resolvePqSendScope(C, N), w = yield o("WAWebEncryptMsgProtobuf").encryptMsgProtobuf(C, b, P, m, R, M, $), A = w.ciphertext, F = w.type, O = null;
			...
			f.type !== c.Retry && (yield o("WAWebSendMsgCommonApi").updateIdentityRange(l, [C])), yield o("WAWebSignalProtocolStore").getSignalProtocolStore().flushBufferToDiskIfNotMemOnlyMode();
			var W;
			f.pushPriority != null ? W = o("WAWap").CUSTOM_STRING(f.pushPriority) : W = f.type === c.AppStateSync ? "high" : o("WAWap").DROP_ATTR;
			var q = null;
			...
			var z = !o("WAWebUserPrefsMeUser").isMeAccount(g) && l.data.kind !== o("WAWebMsgType").MsgKind.PeerMessage ? yield o("WAWebReportingTokenUtils").genReportingTokenBody(l.data, i) : null, j = o("WAWebLid1X1MigrationGating").Lid1X1MigrationUtils.isLidMigrated(), K, Q, X;
			...
			return o("WAWap").wap("message", {
				...
				category: f.type === c.AppStateSync ? "peer" : o("WAWap").DROP_ATTR,
				push_priority: W,
	...
	l.MsgType = c, l.PrivacySensitiveType = d, l.createUserDeviceMsgStanza = m, l.createGroupDeviceMsgStanza = _;
}), 98);
