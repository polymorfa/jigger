__d("WAWebSendMsgMetricReporter", [
	"WAWebCoreActionsODS",
	...
	function s(t, n, r) {
		return new (o("WAWebMessageSendReporter")).MessageSendReporter(t, babelHelpers.extends({}, r, {
			frontendDeps: n,
			odsDeps: e
		}));
	}
	function u(e, t) {
		...
		return Object.defineProperty(n, "sendReporter", {
			get: function() {
	...
	function c(e, t) {
		var n = s(e, t), r = new (o("WAWebMessageSendPerfReporter")).MessageSendPerfReporter({
			chatWid: e.to,
		...
		return Object.defineProperty(i, "sendReporter", {
			get: function() {
				return n;
			},
			set: function(t) {
