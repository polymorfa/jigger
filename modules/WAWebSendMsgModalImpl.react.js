__d("WAWebSendMsgModalImpl.react", [
	...
	function y(t) {
		var a, i, l = t.attachments, c = t.msgText, m = t.preSelectedContactLid, h = t.urlText, y = f(null), C = y[0], b = y[1], v = f(null), S = v[0], R = v[1], L = _(!1), E = function(t) {
			b(t);
		};
		p(function() {
			if (m != null && m !== "") try {
		...
		var k = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				...
				if (!L.current) {
					L.current = !0;
					var s = c;
					if (C != null && C !== "" && (s != null && s !== "" ? s = s + "\n" + C : s = C), i.length === 1) {
						var d = i[0];
						yield g(d).then((function() {
							var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
								if (r("isStringNullOrEmpty")(s) || (d.urlText = h, yield o("WAWebSendTextMsgChatAction").sendTextMsgToChat(d, s)), l != null && l.length > 0) {
									var t = new (r("WAWebAttachMediaCollection"))({ chatParticipantCount: d.getParticipantCount() });
									yield t.processAttachmentsForChat(l.map(function(e) {
										return {
											file: e,
											filename: e.name,
											mimetype: e.type
									...
									t.forEach(function(e) {
										e.previewable && a.push(e.sendToChat({
											chat: d,
											options: {
												caption: e.caption || "",
												mentionedJidList: [],
					...
					} else yield (u || (u = n("Promise"))).all(i.map((function() {
						var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
							if (yield g(e), r("isStringNullOrEmpty")(s) || (e.urlText = h, yield o("WAWebSendTextMsgChatAction").sendTextMsgToChat(e, s)), l != null && l.length > 0) {
								...
								t.forEach(function(t) {
									t.previewable && a.push(t.sendToChat({
										chat: e,
										options: {
											caption: t.caption || "",
											mentionedJidList: [],
					...
					})())), r("isStringNullOrEmpty")(s) || o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["handleConfirmed inside WAWebSendMsgModalImpl for ", " chats"])), i.length), yield o("WAWebCmd").Cmd.openChatFromUnread({
						chat: i[0],
						chatEntryPoint: o("WAWebChatEntryPoint").ChatEntryPoint.SendMessage
					});
		...
		}, (a = S == null || (i = S.id) == null ? void 0 : i.toString()) != null ? a : "no-preselection");
	}
