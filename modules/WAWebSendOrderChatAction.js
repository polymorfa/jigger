__d("WAWebSendOrderChatAction", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, a, i, l, u) {
			...
			if (o("WAWebUserPrefsMeUser").isMeAccount(t.id)) return o("WAWebSendMsgChatAction").addAndSendMsgToChat(t, c)[0].then(r("WAWebNoop")).catch(function(t) {
				throw o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Order message send to chat failure: ", ""])), t), t;
			});
			try {
				var m = yield o("WAWebSendMsgChatAction").addAndSendMsgToChat(t, c)[1];
