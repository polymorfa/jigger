__d("WAWebSendPixPaymentRequestCustomerProfileRow.react", [
	...
	function c(e) {
		var t = e.chat, n = o("useWAWebChatValues").useChatValues(t.id, [o("WAWebChatGetters").getId]), a = n[0], i = t.contact, l = o("useWAWebContactValues").useContactValues(i.id, [o("WAWebContactGetters").getIsMe, o("WAWebContactGetters").getShowBusinessCheckmarkAsPrimary]), c = l[0], d = l[1];
