__d("WAWebSendPixPaymentRequestOptionalModal.react", [
	...
	function h(e) {
		var t = e.chat, a = e.headerButton, i = e.onEditCredential, l = e.pixData, c = e.previousScreenName, h = e.referral, y = "pix_payment_request", C = m(p), b = C[0], v = C[1], S = function(t) {
			v(t.trim());
		};
		d(function() {
		...
		var R = function() {
			if (b === "" || !o("WAWebCurrencyUtils").validateAmountString(g, b)) return !1;
			var e = o("WAWebCurrencyUtils").valueFromString(g, b);
			return e >= _ && e <= f;
		}, L = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				R() ? (yield o("WAWebBizSendOrderAction").sendPixPaymentRequestMessage(t, l, o("WAWebCurrencyUtils").valueFromString(g, b), o("WAWebOrderDetailMath").DEFAULT_OFFSET), o("WAWebPixWamLogger").logPixSenderEvent(o("WAWebWamEnumPaymentActionTargets").PAYMENT_ACTION_TARGETS.PIX_PAYMENT_REQUEST_SEND_BUTTON, o("WAWebWamEnumPaymentActionTypes").PAYMENT_ACTION_TYPES.ENTER, c, h, y, t, l, {
					amount: b,
					currency: g
				}), o("WAWebPaymentsPixBannerUtils").shouldDismissTryItPixKeyPromo()) : (o("WAWebBizSendOrderAction").sendPixQuickReplyMessageAndDismissTryItPixKeyPromoBanner(t, null), o("WAWebPixWamLogger").logPixSenderEvent(o("WAWebWamEnumPaymentActionTargets").PAYMENT_ACTION_TARGETS.PIX_PAYMENT_REQUEST_SEND_BUTTON, o("WAWebWamEnumPaymentActionTypes").PAYMENT_ACTION_TYPES.CLICK, c, h, y, t, l)), o("WAWebModalManager").ModalManager.close();
			});
			return function() {
