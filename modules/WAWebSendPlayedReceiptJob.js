__d("WAWebSendPlayedReceiptJob", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = e.broadcastId || t, r = e.id.id, a = n.isUser() ? null : e.author, i = u(t), l = yield o("WAWebPnlessStanzaMigration").getStanzaToFromChatId(n, i), s = o("WAWap").wap("receipt", {
			...
			return yield o("WAWebDeprecatedSendIqWorkerCompatible").deprecatedSendStanzaAndWaitForAck(s, o("WAWebCommsAckParser").toCoreAckTemplate({
				id: r,
				class: "receipt",
				type: i,
				from: l,
