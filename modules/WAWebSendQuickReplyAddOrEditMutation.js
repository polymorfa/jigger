__d("WAWebSendQuickReplyAddOrEditMutation", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.count, a = e.id, i = e.keywords, l = e.message, u = e.shortcut;
			o("WAWebQuickReplyGatingUtils").quickRepliesManagementEnabled() || s(0, 73617);
			var c = o("WATimeUtils").unixTime(), d = r("WAWebQuickRepliesSync").getQuickReplyAddOrEditMutation({
				count: t,
				id: a,
				keywords: i,
				message: l,
			...
			yield o("WAWebSyncdCoreApi").lockForSync(["quick-reply"], [d], (function() {
