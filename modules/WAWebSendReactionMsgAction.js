__d("WAWebSendReactionMsgAction", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			...
			var i = o("WAWebFrontendMsgGetters").getChat(t).id, l = o("WAWebReactionsMsgActionUtils").getFromForReactionMessage(t), s = o("WAWebChatGetters").getIsGroup(o("WAWebFrontendMsgGetters").getChat(t)) ? o("WAWebWidFactory").asUserWidOrThrow(l) : void 0, u = new (r("WAWebMsgKey"))({
				...
				participant: s,
				selfDir: "out"
			}), c = o("WATimeUtils").unixTime(), m = c * 1e3, p = {
				msgKey: u.toString(),
			...
			}, _ = o("WAWebMsgKeyUtils").msgKeyToTargetInfo(u, o("WAWebMsgKeyUtils").TranslateMsgKeyType.Addon), f = yield o("WAWebDBGetReactions").existsReactionAddressingModeInsensitive({
			...
			if (o("WAWebAddonSendMsgData").isOptimisticAddonSendSupported(g)) return d(g);
			var h = yield o("WAWebReactionsMsgActionUtils").getReactionMsgData({
				from: l,
				globalClockUnixTimeSeconds: c,
				msg: t,
				msgKey: u,
				reaction: n,
				reactionTimestamp: m,
			...
			var y = yield o("WAWebSendAddonMsgChatAction").addAndSendAddonToChat(h);
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var u = yield o("WAWebSendAddonMsgChatAction").addAndSendAddonToChat(e);
