__d("WAWebSentForAdminReviewReportersDrawer.react", [
	"fbt",
	...
	var e = ["ref"], u, c = u || (u = o("react")), d = 68;
	function m(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = a.msg, l = a.onBack, u = r("useLazyRef")(function() {
			return new (r("WAWebFlatListController"))();
		});
		if (i.reporterJidList == null) return null;
		var m = i.reporterJidList.map(function(e) {
			var t = o("WAWebContactCollection").ContactCollection.assertGet(e), n = o("WAWebFrontendContactGetters").getFormattedName(t);
			return {
				id: e,
				itemKey: e.toString(),
				contactName: n
	...
	function p(e) {
		return c.jsx(r("WAWebSentForAdminReviewReporterRow.react"), { reporter: e });
	}
