__d("WAWebSetUsernameDrawer.react", [
	...
	function g(e) {
		var t = e.contactId, a = e.contactUsername, i = e.headerText, l = e.onBack, c = e.ref, _ = m(a), g = _[0], h = _[1], y = m(null), C = y[0], b = y[1], v = m(!1), S = v[0], R = v[1], L = m(!1), E = L[0], k = L[1], I = r("useLazyRef")(function() {
			return new AbortController();
		}), T = m(!1), D = T[0], x = T[1], $ = r("useWAWebUnmountSignal")(), P = r("useWAWebFocusOnMount")(), N = r("isStringNullOrEmpty")(a) ? o("WAWebWamEnumUsernameCreationCurrentScreen").USERNAME_CREATION_CURRENT_SCREEN.USERNAME_EDUCATION : o("WAWebWamEnumUsernameCreationCurrentScreen").USERNAME_CREATION_CURRENT_SCREEN.USERNAME_EDIT;
		d(function() {
		...
		var M = function(t) {
			...
			if (I.current.abort(), I.current = new AbortController(), b(null), r("isStringNullOrEmpty")(t)) k(!1);
			else {
				k(!0);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				...
				if (!t.aborted) {
					...
					try {
						...
						if (t.aborted) return;
						i(s), M({ isAvailable: s }), s || b(o("WAWebUsernameStringUtils").getUsernameUnavailableMessage());
					} catch (e) {
						i(!1), M({ isAvailable: !1 }), b(o("WAWebUsernameStringUtils").getUsernameUnavailableMessage());
					}
					M({ isPending: !1 });
				}
			});
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				o("WAWebUsernameCreationActionLogger").UsernameCreationActionLogger.log({
					...
					usernameCreationFlowType: o("WAWebWamEnumUsernameCreationFlowType").USERNAME_CREATION_FLOW_TYPE.CREATION
				}), x(!0), yield o("WAWebSetContactUsernameAction").setMyUsername(g).then(function(e) {
					if (!$.aborted && e) {
					...
					$.aborted || o("WAWebUsernameErrorUtils").handleErrorBasedOnErrorCode(e, F);
				}).finally(function() {
					$.aborted || x(!1);
				});
			});
			...
			/*BTDS*/
			""
		), W = a != null ? B : O, q = u.jsx(o("WAWebFlex.react").FlexItem, {
			...
			children: u.jsx("div", {
				...
				children: u.jsx(r("WDSTextField.react"), {
					...
					EndIcon: S === !0 && E === !1 && g !== a ? r("WDSIconIcCheckCircleFilled.react") : void 0,
					loading: E === !0,
					bottomText: S === !0 && E === !1 && g !== a ? o("WAWebUsernameStringUtils").getUsernameAvailableMessage() : "",
					ref: P
				})
			})
		});
			...
			children: [u.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
				...
				children: u.jsx(o("WAWebFlex.react").FlexRow, {
					...
					children: u.jsx(o("WAWebButton.react").WAWebButtonPrimary, {
						...
						disabled: g == null || (g == null ? void 0 : g.length) === 0 || S !== !0 || E === !0 || g === a || D,
						children: s._(
							/*BTDS*/
							""
						)
