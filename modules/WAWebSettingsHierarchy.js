__d("WAWebSettingsHierarchy", [
	...
	var e, s, u, c, d = (e = n("cr:7288")) != null ? e : {}, m = d.ShowNotificationBannerSettingsItem, p = (s = n("cr:1131")) != null ? s : {}, _ = p.GeneralSettingsItem, f = p.SystemTraySettingsItem, g = (u = n("cr:17208")) != null ? u : {}, h = g.AudioOutputSettingsItem, y = g.DeviceSettingsParentItem, C = g.MicrophoneSettingsItem, b = g.WebcamSettingsItem, v = (c = n("cr:687")) != null ? c : {}, S = v.TaskbarNotificationSettingsItem;
	function R(e) {
		return e === void 0 && (e = !1), [
			{ business_tools: [
		...
		].concat(e === !1 ? ["bugnub", "download_logs"] : [], ["logout"], e === !0 ? ["divider"] : [], e === !0 ? ["bugnub", "download_logs"] : [], [{ developer: [
			"developer_abprops",
	...
	var L = {
		...
		isAvailable: !0,
		searchCriteria: String(o("WAWebSettingsFBT").requestAccountInfoTitle()).toLowerCase(),
		title: o("WAWebSettingsFBT").requestAccountInfoTitle,
		testid: "li-request-account-info",
		wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.REQUEST_ACCOUNT_INFO
	}, E = {
		...
		id: "delete_account",
		isAvailable: !0,
		searchCriteria: String(o("WAWebSettingsFBT").deleteAccountTitle()).toLowerCase(),
		title: o("WAWebSettingsFBT").deleteAccountTitle
	}, I = {
		step: o("WAWebSettingsConst").SettingsSteps.Wallpaper,
		id: "wallpaper",
		isAvailable: !0,
		searchCriteria: String(o("WAWebSettingsFBT").wallpaperTitle()).toLowerCase(),
		title: o("WAWebSettingsFBT").wallpaperTitle,
		testid: "li-wallpaper",
		wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.CHAT_WALLPAPER
	}, T = {
		...
		searchCriteria: String(o("WAWebSettingsFBT").chatThemeTitle()).toLowerCase(),
		...
		isAvailable: !0,
		searchCriteria: String(o("WAWebSettingsFBT").mediaAutoDownloadTitle()).toLowerCase(),
		title: o("WAWebSettingsFBT").mediaAutoDownloadTitle,
		testid: "li-media-auto-download",
		wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.MEDIA_AUTO_DOWNLOAD
	}, $ = {
		step: o("WAWebSettingsConst").SettingsSteps.MediaUploadQuality,
		id: "media_upload_quality",
		isAvailable: !0,
		searchCriteria: String(o("WAWebSettingsFBT").mediaUploadQualityTitle()).toLowerCase(),
		title: o("WAWebSettingsFBT").mediaUploadQualityTitle,
		testid: "li-media-upload-quality"
	};
	function P(e) {
		e === void 0 && (e = !1);
		var t = o("WAWebBizToolsGatingUtils").isBizToolsDrawerEnabled(), n = [
			{
				...
				testid: "li-biz-tools",
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.BUSINESS_TOOLS
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.BusinessTools,
				id: "business_tools_business_profile",
				isAvailable: t,
				searchCriteria: String(o("WAWebSettingsFBT").businessToolsBusinessProfileTitle()),
				title: o("WAWebSettingsFBT").businessToolsBusinessProfileTitle
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.BusinessTools,
				id: "business_tools_business_ai",
				isAvailable: t && o("WAWebChatAssignmentGatingUtils").isBizAIToolsSettingsEnabled() && (o("WAWebBizAiAgentStatusUtils").hasOnboardedAiAgent() || o("WAWebChatAssignmentGatingUtils").isBizAiWebOnboardingHandoffEnabled()),
				searchCriteria: String(o("WAWebSettingsFBT").businessToolsBusinessAITitle()),
				title: o("WAWebBizAiAgentStatusUtils").hasOnboardedAiAgent() ? o("WAWebSettingsFBT").businessToolsBusinessAIOnboardedTitle : o("WAWebSettingsFBT").businessToolsBusinessAITitle
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.BusinessTools,
				id: "business_tools_catalog",
				isAvailable: t,
				searchCriteria: String(o("WAWebSettingsFBT").businessToolsCatalogTitle()),
			...
			},
			{
				...
				isAvailable: t,
				searchCriteria: String(o("WAWebSettingsFBT").businessToolsOrdersTitle()),
			...
			},
			{
				...
				isAvailable: t,
				searchCriteria: String(o("WAWebSettingsFBT").businessToolsAdvertiseTitle()),
			...
			},
			{
				...
				isAvailable: t,
				searchCriteria: String(o("WAWebSettingsFBT").businessToolsQuickRepliesTitle()),
			...
			},
			{
				...
				isAvailable: t,
				searchCriteria: String(o("WAWebSettingsFBT").businessToolsLabelsTitle()),
			...
			},
			{
				...
				isAvailable: t,
				searchCriteria: String(o("WAWebSettingsFBT").businessToolsHelpCenterTitle()),
			...
			S,
			{
				...
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.NOTIFICATIONS
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.PaymentsHome,
				id: "payments",
				isAvailable: o("WAWebPaymentsGatingUtils").consumerPaymentsHomeEnabled,
				...
				testid: "li-payments",
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.PAYMENTS
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Notifications,
				...
				searchCriteria: [String(o("WAWebSettingsFBT").messageNotificationsTitle()), String(o("WAWebSettingsFBT").messageNotificationsSubtitle())].join(" ").toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Notifications,
				id: "show_previews",
				...
				searchCriteria: String(o("WAWebSettingsFBT").showPreviewsTitle()).toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Notifications,
				...
				searchCriteria: String(o("WAWebSettingsFBT").showReactionsTitle()).toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Notifications,
				...
				searchCriteria: String(o("WAWebSettingsFBT").showCallsTitle()).toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Notifications,
				...
				searchCriteria: String(o("WAWebSettingsFBT").playCallRingtoneTitle()).toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Notifications,
				id: "sounds",
				...
				searchCriteria: [String(o("WAWebSettingsFBT").soundsTitle()), String(o("WAWebSettingsFBT").soundsSubtitle())].join(" ").toLowerCase()
			},
			{
				...
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.PRIVACY
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.PrivacyVisibilityEditLastSeen,
				id: "wcs_last_seen",
				isAvailable: !0,
				title: o("WAWebSettingsFBT").privacyLastSeenOnlineEnabledTitle,
				searchCriteria: String(o("WAWebSettingsFBT").privacyLastSeenOnlineEnabledTitle()).toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.PrivacyVisibilityEditProfilePicture,
				id: "wcs_profile_photo",
				isAvailable: !0,
				title: o("WAWebSettingsFBT").privacyProfilePhotoTitle,
				searchCriteria: String(o("WAWebSettingsFBT").privacyProfilePhotoTitle()).toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.PrivacyVisibilityEditAbout,
				id: "wcs_about_status",
				isAvailable: !0,
				title: o("WAWebSettingsFBT").privacyAboutTitle,
				searchCriteria: String(o("WAWebSettingsFBT").privacyAboutTitle()).toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.PrivacySettings,
				...
				searchCriteria: String(o("WAWebSettingsFBT").privacyReadReceiptsTitle()).toLowerCase()
			},
			{
				...
				searchCriteria: [String(o("WAWebSettingsFBT").privacyDDMTitle()), String(o("WAWebSettingsFBT").privacyDMTitle())].join(" ").toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.PrivacyVisibilityEditGroupAdd,
				id: "privacy_groups",
				isAvailable: !0,
				title: o("WAWebSettingsFBT").privacyGroupsTitle,
				searchCriteria: String(o("WAWebSettingsFBT").privacyGroupsTitle()).toLowerCase()
			},
			{
				...
				searchCriteria: String(o("WAWebSettingsFBT").privacyBlockedTitle()).toLowerCase()
			},
			{
				...
				searchCriteria: String(o("WAWebSettingsFBT").privacyScreenlockTitle()).toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.DataSharing,
				id: "data_sharing",
				isAvailable: o("WAWebCommonCTWADataSharing").shouldDisplayDataSharingSetting(),
				searchCriteria: String(o("WAWebSettingsFBT").dataSharingTitle()).toLowerCase(),
				title: o("WAWebSettingsFBT").dataSharingTitle,
				testid: "li-data-sharing",
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.DATA_SHARING
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Lists,
				id: "lists",
				isAvailable: o("WAWebListsGatingUtils").isListsM2Enabled(),
				searchCriteria: [String(o("WAWebSettingsFBT").listsTitle()), String(o("WAWebSettingsFBT").listsSecondaryTitle())].join(" ").toLowerCase(),
			...
			},
			{
				...
				id: "language",
				isAvailable: !1,
				searchCriteria: String(o("WAWebSettingsFBT").languageTitle()).toLowerCase(),
			...
			x,
			{
				...
				searchCriteria: [String(o("WAWebSettingsFBT").spellCheckTitle()), String(o("WAWebSettingsFBT").spellCheckSubtitle())].join(" ").toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Chats,
				id: "emoji",
				...
				searchCriteria: [String(o("WAWebSettingsFBT").emojiReplacementTitle()), String(o("WAWebSettingsFBT").emojiReplacementSubtitle())].join(" ").toLowerCase()
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Chats,
				id: "enter",
				...
				searchCriteria: [String(o("WAWebSettingsFBT").enterIsSendTitle()), String(o("WAWebSettingsFBT").enterIsSendSubtitle())].join(" ").toLowerCase()
			},
			L,
			{
				...
				isAvailable: !0,
				searchCriteria: String(o("WAWebSettingsFBT").keyboardShortcutsTitle()).toLowerCase(),
				title: o("WAWebSettingsFBT").keyboardShortcutsTitle,
				secondaryTitle: o("WAWebSettingsFBT").keyboardShortcutsSecondaryTitle,
				testid: "li-keyboard-shortcuts",
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.KEYBOARD_SHORTCUTS
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Help,
				id: "help",
				isAvailable: !0,
				searchCriteria: String(o("WAWebSettingsFBT").helpTitle()).toLowerCase(),
			...
			},
			{
				...
				id: "help_center",
				isAvailable: !0,
				searchCriteria: String(o("WAWebSettingsFBT").helpCenterTitle()).toLowerCase(),
			...
			},
			{
				...
				id: "send_feedback",
				isAvailable: function() {
					return o("WAWebABProps").getABPropConfigValue("web_internal_in_app_bug_reporting_enable");
				},
				searchCriteria: String(o("WAWebSettingsFBT").sendFeedbackTitle()).toLowerCase(),
			...
			},
			{
				...
				isAvailable: !0,
				searchCriteria: String(o("WAWebSettingsFBT").newsletterReportsTitle()).toLowerCase(),
			...
			},
			{
				...
				id: "terms",
				isAvailable: !0,
				searchCriteria: String(o("WAWebSettingsFBT").termsTitle()).toLowerCase(),
			...
			},
			{
				...
				id: "download_logs",
				isAvailable: function() {
					return o("WAWebCurrentUser").isEmployee() || o("WAWebABProps").getABPropConfigValue("enable_web_log_download");
				},
		...
		].concat(r("gkx")("26258") ? [] : [
			{
				...
				searchCriteria: String(o("WAWebSettingsFBT").developerTitle()),
				title: o("WAWebSettingsFBT").developerTitle,
				secondaryTitle: o("WAWebSettingsFBT").developerSecondaryTitle,
				testid: "li-developer",
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.DEVELOPER,
				isDevOnly: !0
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.DeveloperABProps,
				id: "developer_abprops",
				isAvailable: !r("gkx")("26258"),
				searchCriteria: String(o("WAWebSettingsFBT").developerABPropsTitle()),
			...
			{
				step: o("WAWebSettingsConst").SettingsSteps.DeveloperGroupABProps,
				id: "developer_group_abprops",
				isAvailable: !r("gkx")("26258"),
				searchCriteria: String(o("WAWebSettingsFBT").developerGroupABPropsTitle()),
			...
			{
				step: o("WAWebSettingsConst").SettingsSteps.DeveloperInfraSettings,
				id: "developer_infra_settings",
				isAvailable: !r("gkx")("26258"),
				searchCriteria: String(o("WAWebSettingsFBT").developerInfraSettingsTitle()),
			...
			},
			{
				...
				id: "developer_infra_settings",
				isAvailable: !r("gkx")("26258"),
				searchCriteria: String(o("WAWebSettingsFBT").developerWWWSettingsTitle()),
		...
		], [
			{
				...
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.LOGOUT,
				testid: "li-logout",
				color: "critical"
			},
			{
				...
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.PROFILE,
				testid: "li-profile"
			},
			{
				...
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.ACCOUNT,
				testid: "li-account"
			},
			{
				step: o("WAWebSettingsConst").SettingsSteps.Chats,
				...
				wamName: o("WAWebWamEnumSettingsItemType").SETTINGS_ITEM_TYPE.CHATS,
				testid: "li-chats"
			},
			{
			...
			b,
			h
		]).filter(Boolean), a = n.reduce(function(e, t) {
			return e.set(t.id, t), e;
		}, new Map()), i = [];
		function l(e, t) {
			for (var n of t) if (typeof n == "string") {
				var r = a.get(n);
				r != null && (r.parentId = e, i.push(r));
			} else for (var o of Object.getOwnPropertyNames(n)) {
				var s = a.get(o);
	...
	function N(e) {
		...
		return e.map(function(e) {
			...
			return t[n.id] == null && (t[n.id] = n), n.searchCriteria != null && (n.searchCriteria = n.searchCriteria.toLowerCase()), n.parentId != null && (n.parent = t[n.parentId], n.parent != null && n.parent.searchCriteria != null && (n.searchCriteria == null && (n.searchCriteria = ""), n.parent.searchCriteria != null && (n.searchCriteria += n.parent.searchCriteria))), n;
		});
	}
	l.RequestAccountInfoSettingsItem = L, l.SecuritySettingsItem = E, l.DeleteAccountSettingsItem = k, l.ThemeSettingsItem = D, l.MediaAutoDownloadSettingsItem = x, l.MediaUploadQualitySettingsItem = $, l.getSettingsSearchHierarchy = P, l.buildSearchableHierarchy = N;
}), 98);
