__d("WAWebSharableEventNotificationHandler", [
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			yield o("WAWebSharableEventShowNotificationBridge").showSharableEventNotificationFromBackend({
				eventId: n,
				title: a,
				body: t,
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				yield t(l), o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose([
					"[sharable_event][mex][",
					"] apply eventId=",
					""
				])), i, l.eventId);
		...
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			return b({
				...
				apply: (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						var t = e.eventName;
						if (e.eventStatus === o("WAWebSharableEventNotificationConstants").SharableEventStatus.Suspended) {
							yield o("WAWebSharableEventShowNotificationBridge").showSharableEventNotificationFromBackend({
								eventId: e.eventId,
								title: "",
								body: { kind: "suspended" },
						...
						if (!(e.eventStatus !== o("WAWebSharableEventNotificationConstants").SharableEventStatus.Active || t == null)) {
							var n = o("WAWebSharableEventResolveSender").normalizeSharableEventSenderLid(e.creatorLid);
							f("update", n, e.eventId) || (yield g({
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			return b({
				...
				apply: (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						var t = e.eventName, n = e.rsvpStatus;
						if (!(t == null || n == null || n === o("WAWebSharableEventNotificationConstants").SharableEventNotificationRsvpStatus.NoResponse)) {
							var r = o("WAWebSharableEventResolveSender").normalizeSharableEventSenderLid(e.inviteeLid);
							f("rsvp", r, e.eventId) || (yield g({
	...
	function $() {
		return $ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			return b({
				...
				apply: (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
						var t = e.eventName, n = e.reminderType;
						t == null || n == null || (yield o("WAWebSharableEventShowNotificationBridge").showSharableEventNotificationFromBackend({
							eventId: e.eventId,
							title: t,
							body: {
								kind: "reminder",
	...
	l.handleSharableEventResponse = b, l.mexHandleSharableEventInviteNotification = S, l.mexHandleSharableEventUpdateNotification = L, l.mexHandleSharableEventRsvpNotification = k, l.mexHandleSharableEventDeleteNotification = T, l.mexHandleSharableEventReminderNotification = x, l.mexHandleSharableEventInviteRemoveNotification = P;
}), 98);
