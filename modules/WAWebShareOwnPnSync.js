	...
	var e, s, u = (function(t) {
		...
		return a.getVersion = function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				...
				return a > 0 && o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["share_own_pn sync: ", " operations not supported"])), a), i > 0 && o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["share_own_pn sync: ", " malformed mutations - invalid key"])), i), yield o("WAWebUpdateLidMetadataJob").updateLidMetadataJob(r), l;
			});
			function r(e) {
