__d("WAWebShareOwnPnSync", [
	...
	var e, s, u = (function(t) {
		...
		return r.getVersion = function() {
			...
			return a > 0 && o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["share_own_pn sync: ", " operations not supported"])), a), i > 0 && o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["share_own_pn sync: ", " malformed mutations - invalid key"])), i), await o("WAWebUpdateLidMetadataJob").updateLidMetadataJob(r), l;
		}, n;
