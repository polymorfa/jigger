__d("WAWebSideNavButtonsActivityModel", [
	"$InternalEnum",
	"WAWebBotGating",
	"WAWebBotUtils",
	"WAWebChatEntryPoint",
	...
	function v(e) {
		if (!(o("WAWebBotUtils").isMetaAiBot(e.id) && o("WAWebBotGating").isAiChatThreadsEnabled())) {
			var t = e.id.toString(), n = d();
			if (n == null) {
				_(t);
				return;
			}
			switch (n) {
				...
				case o("WAWebNavBarTypes").NavBarItems.Communities:
					if (e.groupType != null) switch (e.groupType) {
				...
				case o("WAWebNavBarTypes").NavBarItems.TeamLink: break;
			}
		}
	}
	l.getLastActiveButton = d, l.setLastActiveButton = m, l.getLastActiveChat = p, l.setLastActiveChat = _, l.getLastActiveNewsletter = f, l.setLastActiveNewsletter = g, l.setLastActiveNewsletterEntryPoint = h, l.getLastActiveNewsletterEntryPoint = y, l.getLastActiveCommunity = C, l.setLastActiveCommunity = b, l.setLastSideBarActivityBasedOnChat = v;
}), 98);
