__d("WAWebSignalStoreApi", [
	...
	var e, s, u = 1, c = (function() {
		function t() {
			this.idToSignedPreKey = new Map();
		}
		var a = t.prototype;
		return a.getMeta = function(t) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = o("WAWebSignalStorage").getMetaTable(), r = e.map(function(e) {
			...
			this.putMeta([{
				key: o("WAWebSignalConst").META_KEYS.SERVER_HAS_KEY,
				value: t
			}]);
			...
			return this.getMeta(o("WAWebSignalConst").META_KEYS.ADV_SIGNED_IDENTITY);
			...
			var e = this;
			return this.getMeta(o("WAWebSignalConst").META_KEYS.LAST_SPK_ID).then(function(t) {
				return e.getSignedPreKeyById(t);
			});
		}, a.getSignedPreKeyById = function(t) {
			var e = this;
			if (this.idToSignedPreKey.has(t)) return (s || (s = n("Promise"))).resolve(this.idToSignedPreKey.get(t));
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = o("WAWebSignalStorage").getSignedPreKeyTable(), a = e.map(function(e) {
					var n = e.keyId, o = e.keyPair, a = e.signature;
					return t.get(n).then(function(e) {
						if (e) throw r("err")("signed preKey id " + n + " already exists");
						var i = {
							keyId: n,
							keyPair: o,
							signature: a
			...
			var e = o("WAWebSignalStorage").getBaseKeyTable();
			return e.equals(["address", "originalMsgId"], [t, n]).then(function(e) {
				return e && e.length !== 0 ? e[0].baseKey : null;
			});
		}, a.deleteBaseKey = function(t, n) {
			var e = o("WAWebSignalStorage").getBaseKeyTable();
			return e.equals(["address", "originalMsgId"], [t, n]).then(function(t) {
			...
			return e.equals(["senderId"], t).then(function(t) {
				return e.bulkRemove(t.map(function(e) {
			...
			return (s || (s = n("Promise"))).all(t.map(function(e) {
				return e.clear();
			})).then(r("WAWebNoop"));
		}, a.getRegistrationInfo = function() {
			var e = this;
			return this.registrationInfo != null ? (s || (s = n("Promise"))).resolve(this.registrationInfo) : (s || (s = n("Promise"))).all([
				...
				if (!(!r || !a || !i)) return (s || (s = n("Promise"))).all([o("WAWebSignalCommonUtils").decryptRegistrationMaterial(a), o("WAWebSignalCommonUtils").decryptRegistrationMaterial(i)]).then(function(t) {
					var n = t[0], o = t[1];
					return e.registrationInfo = {
						registrationId: r,
						identityKeyPair: {
							pubKey: n,
							privKey: o
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this;
				yield (s || (s = n("Promise"))).all([o("WAWebSignalCommonUtils").encryptRegistrationMaterial(e.identityKeyPair.pubKey), o("WAWebSignalCommonUtils").encryptRegistrationMaterial(e.identityKeyPair.privKey)]).then(function(r) {
					var a = r[0], i = r[1];
					return (s || (s = n("Promise"))).all([t.putMeta([
						{
			...
			var t = this;
			return o("WAWebSignalStorageUtils").getStorage().lock(["signal-meta-store", "prekey-store"], function() {
				return (s || (s = n("Promise"))).all([t.getMeta(o("WAWebSignalConst").META_KEYS.FIRST_UNUPLOAD_PK_ID), t.getMeta(o("WAWebSignalConst").META_KEYS.NEXT_PK_ID)]).then(function(n) {
					var i = n[0], l = n[1], s = i || u, c = l || u, m = c - s, p = r - m;
					if (p <= 0) return o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
						"[getPreKeys] no gen needed avail=",
						" need=",
						""
					])), m, r), t.getPreKeysByRange(s, r);
			...
			return this.getOrGenPreKeys(1, t).then(function(e) {
				if (e.length !== 1) throw r("err")("Expected to get exactly one key but got " + e.length);
				return e[0];
			});
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (e.length !== 0) {
					var t = e[e.length - 1];
					yield (s || (s = n("Promise"))).all([this.putMeta([{
			...
			var e = this;
			return (s || (s = n("Promise"))).all([this.getMeta(o("WAWebSignalConst").META_KEYS.FIRST_UNUPLOAD_PK_ID), this.getMeta(o("WAWebSignalConst").META_KEYS.NEXT_PK_ID)]).then(function(n) {
				var a = n[0], i = n[1];
				if (t < 0 || !i || t >= i) throw r("err")("markKeyAsUploaded: key " + t + " is out of boundary.");
			...
			var e = this;
			return o("WAWebSignalStorageUtils").getStorage().lock(["signal-meta-store", "signed-prekey-store"], function() {
				return e.getMeta(o("WAWebSignalConst").META_KEYS.LAST_SPK_ID).then(function(a) {
					var i = a == null || a + 1 >= o("WASignalKeys").PRE_KEY_NON_INCLUSIVE_UPPER_BORDER ? u : a + 1, l = r(t, i);
					return (s || (s = n("Promise"))).all([e.putSignedPreKeys([l]), e.putMeta([{
