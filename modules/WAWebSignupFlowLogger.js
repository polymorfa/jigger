__d("WAWebSignupFlowLogger", [
	...
	"use strict";
	var e, s, u = 7 * o("WATimeUtils").DAY_SECONDS, c = 30 * o("WATimeUtils").DAY_SECONDS;
	function d(e) {
		if (e != null) {
			var t = o("WATimeUtils").unixTime() - e;
			return t <= o("WATimeUtils").DAY_SECONDS ? o("WAWebWamEnumThreadCreationTime").THREAD_CREATION_TIME.LESS_THAN_1_DAY_AGO : t <= u ? o("WAWebWamEnumThreadCreationTime").THREAD_CREATION_TIME.LESS_THAN_7_DAYS_AGO : t <= c ? o("WAWebWamEnumThreadCreationTime").THREAD_CREATION_TIME.LESS_THAN_30_DAYS_AGO : o("WAWebWamEnumThreadCreationTime").THREAD_CREATION_TIME.MORE_THAN_30_DAYS_AGO;
		}
	}
	function m(e) {
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (e.isLid()) try {
				var t = yield r("JSResourceForInteraction")("WAWebLidMigrationUtils").__setRef("WAWebSignupFlowLogger").load(), n = t.toPn, o = n(e);
				return {
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var r = t.businessWid, a = t.chatTimestamp, i = t.operation, l = t.signupId, u = r == null ? void 0 : r.toString(), c = yield (s || (s = n("Promise"))).all([f(r), u != null ? o("WAWebChatThreadLogging").getChatThreadIDHMAC(u).catch(function() {
				return o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[signup] getChatThreadIDHMAC failed"]))), null;
			}) : null]), d = c[0], m = d.businessLid, _ = d.businessPhoneNumber, g = c[1];
			return p({
				operation: i,
				signupId: l,
	...
	l.SIGNUP_USER_JOURNEY_OPERATION = o("WAWebWamEnumSignupUserJourneyOperation").SIGNUP_USER_JOURNEY_OPERATION, l.computeThreadCreationTime = d, l.parseBusinessPhoneNumber = m, l.logSignupFlowEvent = p, l.logSignupFlowOp = h;
}), 98);
