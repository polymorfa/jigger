__d("WAWebSimilarNewslettersUnits.react", [
	...
	function C(t) {
		var n = o("react-compiler-runtime").c(11), a = t.discoverySurface, i = t.eventSurface, l = t.isLoading, s = t.newsletters, c = t.ref, d = t.similarNewslettersSessionId, m = l === void 0 ? !1 : l, p;
		n[0] === Symbol.for("react.memo_cache_sentinel") ? (p = (e || (e = r("stylex"))).props(o("WDSMargins.stylex").wdsMargins.marginBottom12), n[0] = p) : p = n[0];
		var _;
		n[1] === Symbol.for("react.memo_cache_sentinel") ? (_ = u.jsx("div", babelHelpers.extends({}, p, { children: u.jsx(o("WAWebText.react").WAWebTextSmall, { children: o("WAWebCommonNewsletterStrings").getNewsletterSimilarNewslettersTitle() }) })), n[1] = _) : _ = n[1];
		var f;
		n[2] !== a || n[3] !== i || n[4] !== m || n[5] !== s || n[6] !== d ? (f = u.jsx(r("WAWebNewsletterRecommendedV2Unit.react"), {
		...
		}), n[2] = a, n[3] = i, n[4] = m, n[5] = s, n[6] = d, n[7] = f) : f = n[7];
		var g;
		return n[8] !== c || n[9] !== f ? (g = u.jsxs("div", {
			ref: c,
			children: [_, f]
		}), n[8] = c, n[9] = f, n[10] = g) : g = n[10], g;
	}
	l.SimilarNewslettersConversationBanner = h, l.SimilarNewslettersInfoDrawerUnit = y;
}), 98);
