__d("WAWebSingleEmojiDailyUtils", [
	"$InternalEnum",
	...
	function s(t) {
		...
		if (n != null) {
			...
			u(r ? e.ANIMATED_EMOJI_SEND : e.SINGLE_EMOJI_SEND), o("WAWebMsgGetters").getQuotedMsg(t) && u(e.EMOJI_REPLY);
		}
	}
	function u(t) {
		var n = o("WAWebDailyAggregatedStatsCollection").DailyAggregatedStatsCollection.gaddForToday();
		switch (t) {
