__d("WAWebSlider.react", [
	...
	function g(t) {
		var n = o("react-compiler-runtime").c(27), a, i, l, u;
		n[0] !== t ? (i = t.displayValue, l = t.theme, u = t.width, a = babelHelpers.objectWithoutPropertiesLoose(t, e), n[0] = t, n[1] = a, n[2] = i, n[3] = l, n[4] = u) : (a = n[1], i = n[2], l = n[3], u = n[4]);
		var d = i === void 0 ? !1 : i, g = l === void 0 ? f.Default : l, h = u === void 0 ? 128 : u, y = m(!1), C = p(a.value), b = C[0], v = C[1], S;
		n[5] === Symbol.for("react.memo_cache_sentinel") ? (S = function(t) {
			y.current = !0;
		}, n[5] = S) : S = n[5];
		var R = S, L;
		n[6] === Symbol.for("react.memo_cache_sentinel") ? (L = function(t) {
			y.current = !1;
		}, n[6] = L) : L = n[6];
		var E = L, k;
		n[7] !== a ? (k = function(t) {
			t.preventDefault(), a.onChange(parseInt(t.target.value, 10), y.current), v(parseInt(t.target.value, 10)), y.current = !1;
		}, n[7] = a, n[8] = k) : k = n[8];
		var I = k, T = g === f.Crescendo && _.crescendoBarContainer, D;
		n[9] !== g ? (D = (s || (s = r("stylex")))([g === f.Default && _.bar, g === f.Crescendo && _.crescendoBar]), n[9] = g, n[10] = D) : D = n[10];
		var x;
		n[11] !== h ? (x = { width: h }, n[11] = h, n[12] = x) : x = n[12];
		var $;
		n[13] !== b || n[14] !== I || n[15] !== a.max || n[16] !== a.min || n[17] !== D || n[18] !== x ? ($ = c.jsx("input", {
			type: "range",
			className: D,
			style: x,
			min: a.min,
			...
			onMouseUp: E,
			onChange: I
		}), n[13] = b, n[14] = I, n[15] = a.max, n[16] = a.min, n[17] = D, n[18] = x, n[19] = $) : $ = n[19];
		var P;
		n[20] !== b || n[21] !== d ? (P = d ? c.jsx("span", {
			className: "xvy4d1p x1f6kntn xhslqc4 x1hm9lzh x1ty9z65",
			children: b
		}) : null, n[20] = b, n[21] = d, n[22] = P) : P = n[22];
		var N;
		return n[23] !== $ || n[24] !== P || n[25] !== T ? (N = c.jsxs(o("WAWebFlex.react").FlexRow, {
			align: "center",
			xstyle: T,
			children: [$, P]
		}), n[23] = $, n[24] = P, n[25] = T, n[26] = N) : N = n[26], N;
	}
