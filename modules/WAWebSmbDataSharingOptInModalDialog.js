__d("WAWebSmbDataSharingOptInModalDialog", [
	...
	function x(e) {
		...
		i ? p.jsx(o("WAWebBusinessDataSharingIllustrationDarkIcon.react").BusinessDataSharingIllustrationDarkIcon, {}) : p.jsx(o("WAWebBusinessDataSharingIllustrationLightIcon.react").BusinessDataSharingIllustrationLightIcon, {});
		var l, u;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (u = p.jsx(o("WAWebWdsSmbPictoArrowsTransferIcon.react").WdsSmbPictoArrowsTransferIcon, {}), t[0] = u) : u = t[0], l = u;
		var c;
		t[1] === Symbol.for("react.memo_cache_sentinel") ? (c = p.jsx(o("WAWebFlex.react").FlexRow, {
			xstyle: [
				y.paddingTop24,
				y.paddingBottom24,
				y.illustration
		...
		var f;
		t[5] !== m ? (f = p.jsx(o("WAWebFlex.react").FlexRow, { children: p.jsx(o("WAWebText_DONOTUSE.react").TextDiv, {
			size: "20",
			color: "dark",
			weight: "medium",
			xstyle: m,
		...
		var g = a ? "secondary" : "dark", h = a && y.centered_text, C;
		t[7] !== h ? (C = [y.paragraph, h], t[7] = h, t[8] = C) : C = t[8];
		var b;
		t[9] !== n ? (b = n ? s._(
			/*BTDS*/
			""
		...
		var v;
		t[11] === Symbol.for("react.memo_cache_sentinel") ? (v = p.jsx(o("WAWebExternalLink.react").ExternalLink, {
		...
		var S;
		t[12] !== b || t[13] !== g || t[14] !== C ? (S = p.jsx(o("WAWebFlex.react").FlexColumn, {
		...
		var R = a ? y.iconColorNew : y.iconColor, L;
		t[16] !== R ? (L = p.jsx(r("WDSIconIcVisibilityOff.react"), {
			height: 22,
			width: 22,
			xstyle: R
		...
		var k;
		t[19] !== a ? (k = p.jsx(o("WAWebText_DONOTUSE.react").TextSpan, {
			size: "16",
			color: "dark",
			xstyle: E,
			children: a ? s._(
		...
		var I;
		t[21] !== L || t[22] !== k ? (I = p.jsxs(o("WAWebFlex.react").FlexRow, {
			align: "center",
			xstyle: y.marginBottom12,
			children: [L, k]
		}), t[21] = L, t[22] = k, t[23] = I) : I = t[23];
		var T = a ? y.iconColorNew : y.iconColor, D;
		t[24] !== T ? (D = p.jsx(r("WDSIconIcSettings.react"), { xstyle: T }), t[24] = T, t[25] = D) : D = t[25];
		var x;
		...
		var $;
		t[27] !== a ? ($ = p.jsx(o("WAWebText_DONOTUSE.react").TextSpan, {
			size: "16",
			color: "dark",
			xstyle: x,
			children: s._(
		...
		var P;
		t[29] !== D || t[30] !== $ ? (P = p.jsxs(o("WAWebFlex.react").FlexRow, {
			align: "center",
			xstyle: y.marginBottom12,
			children: [D, $]
		}), t[29] = D, t[30] = $, t[31] = P) : P = t[31];
		var N;
		t[32] !== a ? (N = a && p.jsxs(o("WAWebFlex.react").FlexRow, {
			align: "center",
			xstyle: y.marginBottom12,
		...
		var A;
		t[35] !== M ? (A = p.jsx(o("WAWebFlex.react").FlexRow, { children: p.jsx(r("WDSText.react"), {
			type: "Body2",
		...
		var F;
		return t[37] !== S || t[38] !== I || t[39] !== P || t[40] !== N || t[41] !== A || t[42] !== f ? (F = p.jsxs(o("WAWebFlex.react").FlexColumn, { children: [
			c,
			f,
			S,
			I,
	...
	function M(e) {
		var t = o("react-compiler-runtime").c(28), a = e.callback, i = e.chats, l = e.entrypoint, u = h(!1), m = u[0], _ = u[1], y;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (y = o("WAWebCTWAGatingUtils").isCtwa3pdAggregatedConversionEnabled(), t[0] = y) : y = t[0];
		var C = y, v;
		t[1] === Symbol.for("react.memo_cache_sentinel") ? (v = o("WAWebCTWAGatingUtils").isPerCustomerDataSharingControlsEnabled() || C, t[1] = v) : v = t[1];
		var L = v, k = g(null), I, T;
		t[2] !== l ? (I = function() {
		...
		}, T = [l], t[2] = l, t[3] = I, t[4] = T) : (I = t[3], T = t[4]), f(I, T);
		var D;
		t[5] !== a || t[6] !== i || t[7] !== l ? (D = function(t) {
			var e = o("WAWebCTWADataSharingModel").CTWADataSharingModel.getValue() === o("WASmaxInBizSettingsEnums").ENUM_FALSE_NOTSET_TRUE.false;
			_(!0), E(t, l, k.current).then(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (t === o("WASmaxInBizSettingsEnums").ENUM_FALSE_TRUE.true && i != null && i.length > 0) {
					var s = r("compactMap")(i, F), u = s.filter(A), m = u.map(function(e) {
					...
					}), p = yield (d || (d = n("Promise"))).allSettled(m), _ = p.some(w);
		...
		}, t[11] = M, t[12] = W) : W = t[12];
		var q = W, U;
		t[13] !== a || t[14] !== l ? (U = function() {
			N(a, l, k.current);
		}, t[13] = a, t[14] = l, t[15] = U) : U = t[15];
		var V = U, H;
		...
		var G = H, z;
		t[17] === Symbol.for("react.memo_cache_sentinel") ? (z = s._(
			/*BTDS*/
			""
		), t[17] = z) : z = t[17];
		var j = z, K;
		t[18] === Symbol.for("react.memo_cache_sentinel") ? (K = s._(
			/*BTDS*/
			""
		), t[18] = K) : K = t[18];
		var Q = K, X;
		...
		var Y = X, J;
		t[20] !== m ? (J = m ? p.jsx($, {}) : p.jsx(x, {
			useNewLayout: L,
			isEpd: C
		}), t[20] = m, t[21] = J) : J = t[21];
		var Z;
		return t[22] !== q || t[23] !== V || t[24] !== B || t[25] !== m || t[26] !== J ? (Z = p.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			cancelText: L ? Q : Y,
			children: J
		}), t[22] = q, t[23] = V, t[24] = B, t[25] = m, t[26] = J, t[27] = Z) : Z = t[27], Z;
	}
	function w(e) {
