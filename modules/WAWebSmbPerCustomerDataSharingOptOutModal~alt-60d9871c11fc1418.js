__d("WAWebSmbPerCustomerDataSharingOptOutModal", [
	...
	function y() {
		var e = o("react-compiler-runtime").c(5), t = o("WAWebThemeContext").useIsDarkTheme();
		...
		var n, r;
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (r = u.jsx(o("WAWebWdsSmbPictoArrowsTransferIcon.react").WdsSmbPictoArrowsTransferIcon, {}), e[0] = r) : r = e[0], n = r;
		var a;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (a = u.jsx(o("WAWebFlex.react").FlexRow, {
			xstyle: [
				h.paddingTop24,
				h.paddingBottom24,
				h.illustration
		...
		var i;
		e[2] === Symbol.for("react.memo_cache_sentinel") ? (i = u.jsx(o("WAWebFlex.react").FlexRow, { children: u.jsx(o("WAWebText_DONOTUSE.react").TextDiv, {
			size: "20",
			color: "dark",
			weight: "medium",
			xstyle: [
		...
		var l;
		e[3] === Symbol.for("react.memo_cache_sentinel") ? (l = s._(
			/*BTDS*/
			""
		), e[3] = l) : l = e[3];
		var c;
		return e[4] === Symbol.for("react.memo_cache_sentinel") ? (c = u.jsxs(o("WAWebFlex.react").FlexColumn, { children: [
			a,
			i,
	...
	function b(e) {
		var t = e.accountLid, n = e.entryPoint, a = m(!1), i = a[0], l = a[1];
		f(n);
		var c = async function() {
			l(!0);
			try {
				var e = o("WAWebWidFactory").createUserLidOrThrow(t);
				await r("WAWebCtwaPerCustomerDataSharingSync").sendPerCustomerDataSharingUpdate({
					accountLid: e,
					entryPoint: n,
					isEnabled: !1
				});
