__d("WAWebSmbUpsellSmbDownloadQrCode.react", [
	"WAWebFlex.react",
	...
	var e, s, u = s || (s = o("react")), c = s.useContext, d = { marginBlock15: {
		marginTop: "xcxhlts",
	...
	}, p = "https://www.whatsapp.com/business/download", _ = "#122e31";
	function f() {
		var t = o("react-compiler-runtime").c(2), n = c(o("WAWebThemeContext").ThemeContext), a = n.theme, i;
		return t[0] !== a ? (i = u.jsx(o("WAWebFlex.react").FlexRow, {
			align: "center",
			justify: "center",
			xstyle: d.marginBlock15,
			children: u.jsx(r("WAWebQRCode.react"), {
				data: p,
				colorDark: _,
				size: o("WAWebFrontendConstants").QR_EDGE / 2,
				children: function(n) {
					return u.jsx("div", babelHelpers.extends({ ref: n }, (e || (e = r("stylex"))).props(a === "dark" && m.codeDarkMode, m.code, o("WDSPaddings.stylex").wdsPaddings.padding12), { children: u.jsx(g, { theme: a }) }));
				}
			})
		}), t[0] = a, t[1] = i) : i = t[1], i;
	}
	function g() {
		return u.jsx("div", {
			className: "xs2sona x90ne7k xbudbmw x10l6tqk xwa60dl x11lhmoz x87ps6o x1691je0 xhtitgo",
			children: u.jsxs("svg", {
				width: "100%",
				viewBox: "0 0 64 64",
