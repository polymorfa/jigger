__d("WAWebSmbUpsellSmbDownloadQrCode.react", [
	...
	function f() {
		var t = c(o("WAWebThemeContext").ThemeContext), n = t.theme;
		return u.jsx(o("WAWebFlex.react").FlexRow, {
			...
			children: u.jsx(r("WAWebQRCode.react"), {
				...
				children: function(a) {
					return u.jsx("div", babelHelpers.extends({ ref: a }, (e || (e = r("stylex"))).props(n === "dark" && m.codeDarkMode, m.code, o("WDSPaddings.stylex").wdsPaddings.padding12), { children: u.jsx(g, { theme: n }) }));
				}
			})
		});
	}
