__d("WAWebSocketBridgeApi", [
	...
	var e = {
		socketLogout: function(t) {
			var e = t.reason;
			r("WAWebEnvironment").isWindows && o("WAWebCurrentUser").isEmployee() ? o("WAWebCmd").Cmd.onUnexpectedLogoutModalFromBridge(e) : o("WAWebSocketModel").Socket.logout(e);
		},
		...
		forceAppUpdate: function(t) {
			var e = t.belowHard, n = t.belowSoft, r = t.version;
