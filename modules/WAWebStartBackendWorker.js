__d("WAWebStartBackendWorker", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f = ["serializedError"], g;
	function h(e) {
		throw new TypeError("\"" + e + "\" is read-only");
	}
	var y = "WAWebBackendWorker-" + o("WAWebUserPrefsTabMutex").THIS_TAB, C = "worker-killswitch-stolen", b = r("qpl")._(891427260, "2714"), v = new Map(), S = {
	...
	function L() {
		var t, a = o("WAWebBackendWorkerBridge").createBridge([
			{
				...
				handlers: {
					...
					deletePersistedJob: (function() {
						var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
							var t = e.jobId;
							yield o("WAWebPersistedJobManagerWorkerCompatible").getJobManager().accessors.deletePersistedJob(t);
						});
						function t(t) {
			...
			},
			{
				...
				handlers: {
					...
					handleStanza: (function() {
						var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
							var t = e.size, a = e.socketId, i = e.stanza, l = yield o("WAWap").decodeStanza(i, function(e) {
							...
							if (s instanceof o("WAWap").WapNode) {
								...
								return o("WATransferableResult").withTransferables(u, [u.buffer]);
							}
							return s;
						});
						function t(t) {
		...
		return a.setNamespaceHandler("event", function(e, t, n) {
	...
	var E = null, k = null, I = 3, T = 10;
	function D(e) {
		return x.apply(this, arguments);
	}
	function x() {
		return x = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, a, i = (t = e == null ? void 0 : e.retryStart) != null ? t : 0, l = (a = e == null ? void 0 : e.qpl) != null ? a : o("QPLFlow").startQPLFlow(b, {
				annotations: {
					bool: {
			...
			try {
				...
				var s = o("WAWebUA").UA.isFirefox && parseInt(o("WAWebUA").UA.browserVersion.split(".")[0], 10) <= 115, u = o("WebWorkerV4Resource").createDedicatedV4WebWorker(r("WAWebBackendWorkerV2Resource"), S, y, s), c = u.initReady, f = u.worker;
				l.addPoint("worker_connect_start"), yield (g || (g = n("Promise"))).all([c, $(f)]), l.addPoint("worker_connect_end");
				var h;
				o("WAWebBackendWorkerClient").isBackendWorkerBridgeReady() ? h = yield o("WAWebBackendWorkerClient").getBackendWorkerBridge() : h = L();
				var v = R(f);
				o("WAWebBackendWorkerBridge").attachBridgeToPortal(h, v, [
					...
					E == null || E(), e.fireAndForget("mediaHostsSync", "snapshot", { data: o("WAWebMediaHostsRawStateManager").mediaHostsRawStateManager.get() }), E = o("WAWebMediaHostsRawStateManager").mediaHostsRawStateManager.onSet(function(t) {
					...
					k == null || k(), e.fireAndForget("networkStatusSync", "updateNetworkStatus", { online: o("WAWebNetworkStatusStateManager").networkStatusStateManager.get() }), k = o("WAWebNetworkStatusStateManager").networkStatusStateManager.onSet(function(t) {
				...
				}), o("WAWebBackendWorkerClient").setBackendWorkerBridge(h), l.addPoint("init_data_start"), yield o("WAWebBackendWorkerInitState").sendInitState(h), l.addPoint("init_data_end"), l.addPoint("create_worker_end"), l.endSuccess(), o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["WAWebBackendWorker is initialised"]))), globalThis.navigator.locks != null && globalThis.navigator.locks.request(y + "-kill-switch-lock", function() {
					i < T && D({ retryStart: i + 1 });
				});
			} catch (t) {
				var x;
				globalThis.navigator.locks != null && (yield globalThis.navigator.locks.request(y + "-kill-switch-lock", { steal: !0 }, function() {
					return (g || (g = n("Promise"))).resolve();
				}));
				var P = r("getErrorSafe")(t);
				if (o("WALogger").ERROR(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["WAWebBackendWorkerClient init fails"]))).catching(P).sendLogs("main-thread-backend-worker-init-fails"), P.message.includes(C)) {
					l.endFail(o("getSafeQplErrorMessage").getSafeQPLErrorMessage(t));
					return;
				}
				var N = (x = e == null ? void 0 : e.retryInit) != null ? x : 0;
				N < I && globalThis.navigator.locks != null ? (l.addPoint("retry_" + N), D({
					qpl: l,
					retryInit: N + 1
				})) : l.endFail(o("getSafeQplErrorMessage").getSafeQPLErrorMessage(t));
			}
