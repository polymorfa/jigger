__d("WAWebStatusAudio.react", [
	...
	var e, u = e || (e = o("react")), c = e, d = c.useEffect, m = c.useRef, p = function(t) {
	...
	function _(e) {
		var t = e.markRead, n = e.msg, a = e.pause, i = e.play, l = e.playbackController, c = e.status, _ = m(null), f = o("useWAWebModelValues").useModelValues(e.mediaData, ["mediaStage"]);
		d(function() {
		...
		d(function() {
			i(), f.mediaStage === o("WAWebMediaTypes").MediaDataStage.RESOLVED && t(c, n);
		}, [
			t,
			f.mediaStage,
			n,
		...
		return u.jsx("div", {
			...
			children: u.jsx(r("WAWebMediaUrlProvider"), {
				...
				placeholderRenderer: function() {
					return u.jsx("div", {
						className: "x9f619 x78zum5 x6s0dn4 xl56j7k xh8yej3 x1lwm3bp x11t971q xvc5jky x47corl xmz0i5r x1sbjjv6",
				...
				children: function(t) {
					return u.jsxs(u.Fragment, { children: [u.jsx("div", {
						className: "x9f619 x78zum5 x6s0dn4 xl56j7k xh8yej3 x1lwm3bp x11t971q xvc5jky x47corl xmz0i5r",
						children: u.jsx(r("WAWebStatusAudioBubble.react"), {
							msg: n,
							mediaData: f,
							playbackController: l,
