__d("WAWebStatusButton.react", [
	"WAWebExternalLink.react",
	"WAWebUnstyledButton.react",
	"react",
	"react-compiler-runtime"
], (function(t, n, r, o, a, i, l) {
	var e, s = e || (e = o("react")), u = "x1ahdber-B", c = "xedog2w-B", d = { button: {
		display: "x78zum5",
		...
		transform: "x1eu86dj",
		opacity: "xg01cxk",
		backgroundColor: "x15ncwns",
		color: "x17t9dm2",
		alignItems: "x6s0dn4",
		justifyContent: "xl56j7k",
		animationName: "xh1muhg",
	...
	function m(e) {
		var t = o("react-compiler-runtime").c(5), n = e.text, a = e.url, i;
		t[0] !== a ? (i = function() {
			o("WAWebExternalLink.react").openExternalLink(a);
		}, t[0] = a, t[1] = i) : i = t[1];
		var l = i, u;
		return t[2] !== l || t[3] !== n ? (u = s.jsx(r("WAWebUnstyledButton.react"), {
			xstyle: d.button,
			onClick: l,
			children: n
		}), t[2] = l, t[3] = n, t[4] = u) : u = t[4], u;
	}
	l.default = m;
}), 98);
