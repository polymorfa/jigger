__d("WAWebStatusEventHandlersMap", ["objectEntries"], (function(t, n, r, o, a, i, l) {
	var e = Object.freeze({
		OnPlay: "onPlay",
		OnPause: "onPause",
		OnEnd: "onEnd",
	...
	function s() {
		var e = {}, t = function(n) {
			...
			execute: function(n) {
				for (var e, r = arguments.length, o = new Array(r > 1 ? r - 1 : 0), a = 1; a < r; a++) o[a - 1] = arguments[a];
				(e = t(n)) == null || e.forEach(function(e) {
					e.apply(void 0, o);
				});
			},
			set: n,
