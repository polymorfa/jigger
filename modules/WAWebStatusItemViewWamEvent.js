__d("WAWebStatusItemViewWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ StatusItemView: [
		1658,
		{
			bytesDownloadedStartView: [47, e.TYPES.NUMBER],
			estimatedBandwidth: [48, e.TYPES.NUMBER],
			externalSourceDomainType: [34, o("WAWebWamEnumInlineVideoType").INLINE_VIDEO_TYPE],
			...
			pairedMediaType: [38, o("WAWebWamEnumPairedMediaType").PAIRED_MEDIA_TYPE],
			...
			psaLinkOpenResult: [20, o("WAWebWamEnumPsaLinkOpenResult").PSA_LINK_OPEN_RESULT],
			reshareSource: [41, o("WAWebWamEnumReshareSource").RESHARE_SOURCE],
			statusCategory: [46, o("WAWebWamEnumStatusCategory").STATUS_CATEGORY],
			...
			statusItemViewResult: [3, o("WAWebWamEnumStatusItemViewResult").STATUS_ITEM_VIEW_RESULT],
			statusItemViewTime: [6, e.TYPES.TIMER],
			statusMediaHeight: [42, e.TYPES.INTEGER],
			statusMediaWidth: [43, e.TYPES.INTEGER],
			statusPairedMediaQuality: [39, o("WAWebWamEnumStatusPairedMediaQuality").STATUS_PAIRED_MEDIA_QUALITY],
			statusPosterContactType: [57, o("WAWebWamEnumStatusPosterContactType").STATUS_POSTER_CONTACT_TYPE],
			statusRowIndex: [2, e.TYPES.INTEGER],
			statusRowSection: [11, o("WAWebWamEnumStatusRowSection").STATUS_ROW_SECTION],
			...
			urlStatusClicked: [26, o("WAWebWamEnumUrlStatusClicked").URL_STATUS_CLICKED],
			urlStatusType: [27, o("WAWebWamEnumUrlStatusType").URL_STATUS_TYPE]
		},
		[
			1,
			1,
