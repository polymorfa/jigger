__d("WAWebStatusLoggingUtils", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n, r, a = e.id.id, i = (t = e.id.remote) == null ? void 0 : t.toString({ legacy: !0 }), l = yield S();
			if (!l || !i) return a;
			var u = e.id.fromMe ? 1 : 0, c = e.id.fromMe ? "0" : (n = (r = e.id.participant) == null ? void 0 : r.toString({ legacy: !0 })) != null ? n : "0", d = s([
				...
				u,
				c
			].join("_")), m = yield o("WACryptoHmac").hmacSha256(l, d);
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			return o("WAWebStatusGatingUtils").isStatusViewerSidePosterIdentifiersEnabled() ? b(e.toJid(), t) : null;
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = e.id.remote;
			return !o("WAWebStatusGatingUtils").isStatusViewerSidePosterIdentifiersEnabled() || !o("WAWebMsgGetters").getIsGroupStatus(e) || n == null ? null : b(n.toJid(), t);
		}), C.apply(this, arguments);
	}
	function b(e, t) {
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = o("WAWebStatusGatingUtils").statusPogIdRotationWindowDays(), r = yield S();
			if (n === -1 || !r) return null;
			var a = R(t, n), i = yield o("WACryptoHmac").hmacSha256(r, s(e + a));
	...
	l.statusIdForLogging = u, l.statusPosterHashIdForLogging = d, l.statusPosterIdForLogging = p, l.channelStatusPosterHashId = f, l.channelStatusCid = h, l.statusGroupIdForLogging = y;
}), 98);
