__d("WAWebStatusMuteWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ StatusMute: [
		2978,
		{
			...
			statusCategory: [13, o("WAWebWamEnumStatusCategory").STATUS_CATEGORY],
			statusItemIndex: [3, e.TYPES.INTEGER],
			statusPosterContactType: [14, o("WAWebWamEnumStatusPosterContactType").STATUS_POSTER_CONTACT_TYPE],
