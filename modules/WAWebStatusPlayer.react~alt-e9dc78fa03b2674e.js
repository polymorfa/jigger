__d("WAWebStatusPlayer.react", [
	...
	function V(t) {
		...
		v(function() {
			...
			de && (async function() {
				var e = await o("WAWebNewsletterGetStatusUpdatesJob").fetchNewsletterStatusUpdates(o("WAJids").toNewsletterJid(Y.id.remote.toString()));
				e != null && await o("WAWebNewsletterStatusProcessingUtils").applyAndPersistInteractions(e.from, e.viewsByServerId, e.reactionsByServerId, e.serverTimestamp);
			})().catch(function(e) {
	...
	function H(e) {
		var t = o("react-compiler-runtime").c(6), n = e.handleVerificationDrawerClose, a = e.lid, i = e.msgAuthor, l;
		t[0] !== i ? (l = o("WAWebContactCollection").ContactCollection.assertGet(i), t[0] = i, t[1] = l) : l = t[1];
		var s = l, u;
		return t[2] !== s || t[3] !== n || t[4] !== a ? (u = y.jsx(r("WAWebVerificationDrawerLoadable").VerificationDrawerLoadable, {
			lid: a,
			contact: s,
			isFirstLevel: !0,
			onClose: n
		}), t[2] = s, t[3] = n, t[4] = a, t[5] = u) : u = t[5], u;
	}
	function G(e) {
		var t = o("react-compiler-runtime").c(8), n = e.authorContact, a = e.msg, i = e.statusContact;
		if (o("WAWebMsgGetters").getIsGroupStatus(a)) {
			if (n != null) {
				var l;
				return t[0] !== n.id || t[1] !== i.id ? (l = y.jsx(r("WAWebGroupStatusAuthorImage.react"), {
					primaryContactId: i.id,
					secondaryContactId: n.id
				}), t[0] = n.id, t[1] = i.id, t[2] = l) : l = t[2], l;
			}
			var s;
			t[3] === Symbol.for("react.memo_cache_sentinel") ? (s = { className: "x100vrsf x1vqgdyp" }, t[3] = s) : s = t[3];
			var u;
			return t[4] !== i.id ? (u = y.jsx("div", babelHelpers.extends({}, s, { children: y.jsx(o("WAWebDetailImage.react").DefaultIcon, {
				id: i.id,
				theme: o("WAWebDetailImage.react").DefaultIconThemeType.GroupStatus
			}) })), t[4] = i.id, t[5] = u) : u = t[5], u;
		}
		var c;
		return t[6] !== i.id ? (c = y.jsx(o("WAWebDetailImage.react").DetailImage, {
			id: i.id,
			theme: "status",
			size: 40
		}), t[6] = i.id, t[7] = c) : c = t[7], c;
	}
	function z(e) {
		return $(e) && e.mediaStage !== o("WAWebMediaTypes").MediaDataStage.RESOLVED;
	}
	function j(e) {
		var t = o("react-compiler-runtime").c(7), n = e.mediaData, a;
		t[0] === Symbol.for("react.memo_cache_sentinel") ? (a = ["mediaStage", "type"], t[0] = a) : a = t[0];
		var i = o("useWAWebModelValues").useModelValues(n, a), l;
		t[1] !== i ? (l = z(i), t[1] = i, t[2] = l) : l = t[2];
		var s = l, u;
		t[3] !== s ? (u = s ? y.jsx("div", {
		...
		}) : null, t[3] = s, t[4] = u) : u = t[4];
		var c = u, d;
		return t[5] !== c ? (d = y.jsx(r("WAWebVelocityTransitionGroup"), {
	...
	function K() {
		...
		return e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = y.jsx("div", { className: "xh8yej3 x5yr21d x42x0ya x10l6tqk x13vifvy x1o0tod x197sbye x12xzxwr" }), e[0] = t) : t = e[0], t;
	}
	function Q(e, t) {
		var n = !1;
		if (e.id.isGroup()) {
	...
	function ee(e) {
		var t, n, a, i, l, s = o("react-compiler-runtime").c(44), c = e.ref, d = babelHelpers.objectWithoutPropertiesLoose(e, u), m = w(d.mediaData, d.msg), p = z(d.mediaData), _ = o("WAWebClock").Clock.getServerTime(), f = parseFloat((t = d.mediaData) == null ? void 0 : t.duration), g = o("WAWebMsgGetters").getIsNewsletterStatus(d.msg), h = g ? r("WAWebNewsletterMetadataCollection").get(d.msg.id.remote) : null, C = o("WAWebWamEnumStatusCategory").STATUS_CATEGORY.REGULAR_STATUS;
		g ? C = o("WAWebWamEnumStatusCategory").STATUS_CATEGORY.CHANNEL_STATUS : d.isGroupStatus && (C = o("WAWebWamEnumStatusCategory").STATUS_CATEGORY.GROUP_STATUS);
		var b = o("WAWebMessageAIContentLabel.react").useShouldShowAiContentLabel(d.msg.safe()), v = X(d.msg.id), S = o("WAWebStatusLoggingUtils").statusIdForLogging(d.msg), R = o("WAWebStatusLoggingUtils").statusPosterHashIdForLogging(d.msg, _), L = o("WAWebStatusLoggingUtils").statusPosterIdForLogging(d.msg, _), E = o("WAWebStatusLoggingUtils").statusGroupIdForLogging(d.msg, _), k = N(m), I = o("WAWebMsgGetters").getIsSentByMe(d.msg), T = A(d.msg, d.statusItemLastImpressionTimestampMap), D = o("WAWebStatusGatingUtils").isStatusCloseFriendsViewerSideEnabled() && d.msg.statusAudienceMetadata != null, x = d.statusIsUnread, $ = d.msgIdx + 1 >= d.totalMsgs, P = d.containsMusic, M = !d.canPlaybackAudio, B = (n = d.rowSection) != null ? n : o("WAWebWamEnumStatusRowSection").STATUS_ROW_SECTION.RECENT_STORIES, W = d.sessionId, q = d.viewerSessionId, U = d.statusPogIndex, H = d.msgIdx, G = C, j = o("WAWebStatusLoggingUtils").channelStatusCid(d.msg.id.remote), K = g && (a = d.msg.serverId) != null ? a : void 0, Q = g ? o("WAWebNewsletterLoggingUtils").getChannelUserTypeFromMembershipType(h) : void 0, ee;
		s[0] !== f ? (ee = Number.isFinite(f) ? f : void 0, s[0] = f, s[1] = ee) : ee = s[1];
		var ne = d.msg.campaignId, re = ((i = d.msg.actionLink) == null ? void 0 : i.url) != null, oe = p ? function() {
			return d.statusItemViewEventRef.current.statusItemLoadTime;
		} : te, ae = function() {
			return d.statusItemViewEventRef.current.urlStatusType;
		}, ie = d.status.contact.isBusiness, le = !1, se = function() {
			return d.statusItemViewEventRef.current.statusItemViewTime > 0;
		}, ue = function() {
			return d.statusItemViewEventRef.current.statusItemViewResult;
		}, ce = (l = d.statusViewEntryMethod) != null ? l : F(d.statusRowEntryMethod), de = function() {
			return d.statusViewExitMethodRef.current;
		}, me = function() {
			return O(d.viewSequenceIndexRef);
		}, pe = Y(d.msg), _e = J(d.msg), fe = Z(d.msg), ge = g ? b : void 0, he;
		s[2] !== g ? (he = g ? o("WAWebNewsletterGatingUtils").isChannelSGIUiLabelEnabled() : void 0, s[2] = g, s[3] = he) : he = s[3];
		var ye;
		s[4] !== m || s[5] !== d || s[6] !== C || s[7] !== v || s[8] !== $ || s[9] !== M || s[10] !== B || s[11] !== S || s[12] !== j || s[13] !== K || s[14] !== Q || s[15] !== ee || s[16] !== re || s[17] !== oe || s[18] !== ae || s[19] !== R || s[20] !== se || s[21] !== ue || s[22] !== ce || s[23] !== de || s[24] !== me || s[25] !== pe || s[26] !== _e || s[27] !== fe || s[28] !== ge || s[29] !== he || s[30] !== L || s[31] !== E || s[32] !== k || s[33] !== I || s[34] !== T || s[35] !== D ? (ye = {
			itemId: v,
			encryptedStatusIdPromise: S,
			userRidPromise: R,
			statusPosterIdPromise: L,
			statusGroupIdPromise: E,
			statusContentType: k,
			mediaType: m,
			isSelfView: I,
			isSubImpression: T,
			...
			channelStatusId: K,
			channelUserType: Q,
			statusPostPlaybackDuration: ee,
			psaCampaignId: ne,
			psaLinkAvailable: re,
			statusLoadTime: oe,
			urlStatusType: ae,
			isPosterBiz: ie,
			statusContainsQuestion: le,
			isSuccessfulView: se,
			statusItemViewResult: ue,
			entryMethod: ce,
			statusViewExitMethod: de,
			viewSequenceIndex: me,
			isResharable: pe,
			isReshare: _e,
			pairedMediaType: fe,
			aiProvenanceLabelShown: ge,
			aiProvenanceLabelEnabled: he
		}, s[4] = m, s[5] = d, s[6] = C, s[7] = v, s[8] = $, s[9] = M, s[10] = B, s[11] = S, s[12] = j, s[13] = K, s[14] = Q, s[15] = ee, s[16] = re, s[17] = oe, s[18] = ae, s[19] = R, s[20] = se, s[21] = ue, s[22] = ce, s[23] = de, s[24] = me, s[25] = pe, s[26] = _e, s[27] = fe, s[28] = ge, s[29] = he, s[30] = L, s[31] = E, s[32] = k, s[33] = I, s[34] = T, s[35] = D, s[36] = ye) : ye = s[36];
		var Ce = r("useWAWebStatusVisibilityLogger")(ye), be = Ce[0], ve;
		s[37] === Symbol.for("react.memo_cache_sentinel") ? (ve = { className: "x10l6tqk x13vifvy x1o0tod xh8yej3 x5yr21d x1280gxy" }, s[37] = ve) : ve = s[37];
		var Se;
		s[38] !== d || s[39] !== c ? (Se = y.jsx(V, babelHelpers.extends({ ref: c }, d)), s[38] = d, s[39] = c, s[40] = Se) : Se = s[40];
		var Re;
		return s[41] !== be || s[42] !== Se ? (Re = y.jsx("div", babelHelpers.extends({ ref: be }, ve, { children: Se })), s[41] = be, s[42] = Se, s[43] = Re) : Re = s[43], Re;
	}
	function te() {
		return 0;
	}
	function ne(e) {
		...
		var i;
		t[3] === Symbol.for("react.memo_cache_sentinel") ? (i = [o("WAWebMsgGetters").getIsGroupStatus, o("WAWebMsgGetters").isStatusWithMusic], t[3] = i) : i = t[3];
		var l = o("useWAWebMsgValues").useMsgValues(n.msg.id, i), s = l[0], u = l[1], d = o("useWAWebCanPlaybackAudio").useCanPlaybackAudio(n.msg), m = E(null), p;
		t[4] !== s || t[5] !== n.msg.id || t[6] !== n.statusItemViewMap ? (p = function() {
			var e;
			return (e = n.statusItemViewMap.get(n.msg.id.toString())) != null ? e : new (o("WAWebStatusItemViewWamEvent")).StatusItemViewWamEvent({
				...
				statusCategory: s ? o("WAWebWamEnumStatusCategory").STATUS_CATEGORY.GROUP_STATUS : o("WAWebWamEnumStatusCategory").STATUS_CATEGORY.REGULAR_STATUS
			});
		}, t[4] = s, t[5] = n.msg.id, t[6] = n.statusItemViewMap, t[7] = p) : p = t[7];
		var _ = r("useLazyRef")(p), f;
		t[8] !== d || t[9] !== u || t[10] !== s || t[11] !== n || t[12] !== _ ? (f = babelHelpers.extends({}, n, {
			statusItemViewEventRef: _,
			isGroupStatus: s,
			containsMusic: u,
			canPlaybackAudio: d,
			statusViewExitMethodRef: m
		}), t[8] = d, t[9] = u, t[10] = s, t[11] = n, t[12] = _, t[13] = f) : f = t[13];
		var g = f, h;
		return t[14] !== g || t[15] !== a ? (h = y.jsx(ee, babelHelpers.extends({ ref: a }, g)), t[14] = g, t[15] = a, t[16] = h) : h = t[16], h;
	}
	l.default = ne;
}), 226);
