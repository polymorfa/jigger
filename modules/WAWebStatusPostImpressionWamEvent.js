__d("WAWebStatusPostImpressionWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ StatusPostImpression: [
		6364,
		{
			aiProvenanceLabelEnabled: [54, e.TYPES.BOOLEAN],
			aiProvenanceLabelShown: [55, e.TYPES.BOOLEAN],
			channelStatusId: [46, e.TYPES.INTEGER],
			channelUserType: [47, o("WAWebWamEnumChannelUserType").CHANNEL_USER_TYPE],
			cid: [48, e.TYPES.STRING],
			entryMethod: [29, o("WAWebWamEnumStatusViewEntryMethod").STATUS_VIEW_ENTRY_METHOD],
			externalSourceDomainType: [1, o("WAWebWamEnumInlineVideoType").INLINE_VIDEO_TYPE],
			groupStatusSizeBucket: [41, o("WAWebWamEnumGroupStatusSizeBucket").GROUP_STATUS_SIZE_BUCKET],
			...
			pairedMediaType: [51, o("WAWebWamEnumPairedMediaType").PAIRED_MEDIA_TYPE],
			...
			statusCategory: [25, o("WAWebWamEnumStatusCategory").STATUS_CATEGORY],
			...
			statusContentType: [10, o("WAWebWamEnumStatusContentType").STATUS_CONTENT_TYPE],
			statusGroupId: [39, e.TYPES.STRING],
			statusId: [11, e.TYPES.STRING],
			statusItemViewResult: [31, o("WAWebWamEnumStatusItemViewResult").STATUS_ITEM_VIEW_RESULT],
			statusLoadTime: [12, e.TYPES.TIMER],
			statusMediaType: [13, o("WAWebWamEnumMediaType").MEDIA_TYPE],
			statusPlaceholderType: [56, o("WAWebWamEnumStatusPlaceholderType").STATUS_PLACEHOLDER_TYPE],
			statusPogIndex: [15, e.TYPES.INTEGER],
			statusPostIndex: [16, e.TYPES.INTEGER],
			statusPostPlaybackDuration: [17, e.TYPES.TIMER],
			statusPosterContactType: [35, o("WAWebWamEnumStatusPosterContactType").STATUS_POSTER_CONTACT_TYPE],
			statusPosterHashId: [26, e.TYPES.STRING],
			statusPosterId: [40, e.TYPES.STRING],
			statusViewEntrypoint: [18, o("WAWebWamEnumStatusRowSection").STATUS_ROW_SECTION],
			statusViewExitMethod: [44, o("WAWebWamEnumStatusViewExitMethod").STATUS_VIEW_EXIT_METHOD],
			...
			urlStatusType: [23, o("WAWebWamEnumUrlStatusType").URL_STATUS_TYPE],
