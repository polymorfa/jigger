__d("WAWebStatusPrivacySettingOptionsDrawer.react", [
	...
	function m(t) {
		var n = o("react-compiler-runtime").c(60), a = t.isModal, i = t.onAllowListClick, l = t.onBack, u = t.onClose, m = t.onContactClick, f = t.onDenyListClick, g = t.ref, h = t.statusPostingPrivacyConfig, y = a === void 0 ? !1 : a, C;
		...
		n[30] !== f || n[31] !== ae || n[32] !== ie ? (le = c.jsx(r("WAWebPrivacyVisibilityOption.react"), {
			text: oe,
			subText: ae,
			testid: "status-contacts-except",
			selected: ie,
			onClick: f
		}), n[30] = f, n[31] = ae, n[32] = ie, n[33] = le) : le = n[33];
		var se;
	...
	async function p(e) {
		try {
			await o("WAWebCrosspostingAutoShareAction").toggleCrosspostAutoShare("ig", e);
		} catch (e) {
	...
	async function _(e) {
		try {
			await o("WAWebCrosspostingAutoShareAction").toggleCrosspostAutoShare("fb", e);
		} catch (e) {
			o("WAWebToastManager").ToastManager.open(c.jsx(o("WAWebToast.react").Toast, { msg: s._(
				/*BTDS*/
				""
