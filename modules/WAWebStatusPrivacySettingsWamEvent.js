__d("WAWebStatusPrivacySettingsWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ StatusPrivacySettings: [
		3200,
		{
			allowForwarding: [10, e.TYPES.BOOLEAN],
			allowResharing: [9, e.TYPES.BOOLEAN],
			contactSuggestion: [12, o("WAWebWamEnumContactSuggestion").CONTACT_SUGGESTION],
			...
			statusPrivacySettingsAction: [5, o("WAWebWamEnumStatusPrivacySettingsAction").STATUS_PRIVACY_SETTINGS_ACTION],
			statusPrivacySettingsView: [11, o("WAWebWamEnumStatusPrivacySettingsView").STATUS_PRIVACY_SETTINGS_VIEW],
			statusPrivacySurface: [4, o("WAWebWamEnumStatusPrivacySurface").STATUS_PRIVACY_SURFACE]
		},
		[
			1,
			1,
