__d("WAWebStatusReplyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ StatusReply: [
		1180,
		{
			...
			messageSendResult: [20, o("WAWebWamEnumMessageSendResultType").MESSAGE_SEND_RESULT_TYPE],
			postContainedPrompt: [15, e.TYPES.BOOLEAN],
			quickReplySource: [26, o("WAWebWamEnumQuickReplySource").QUICK_REPLY_SOURCE],
			replyEntryMethod: [13, o("WAWebWamEnumReplyEntryMethod").REPLY_ENTRY_METHOD],
			replyExitMethod: [14, o("WAWebWamEnumReplyExitMethod").REPLY_EXIT_METHOD],
			statusCategory: [17, o("WAWebWamEnumStatusCategory").STATUS_CATEGORY],
			statusContentType: [8, o("WAWebWamEnumStatusContentType").STATUS_CONTENT_TYPE],
			statusId: [23, e.TYPES.STRING],
			statusPosterContactType: [25, o("WAWebWamEnumStatusPosterContactType").STATUS_POSTER_CONTACT_TYPE],
			statusReplyMessageType: [3, o("WAWebWamEnumStatusReplyMessageType").STATUS_REPLY_MESSAGE_TYPE],
			statusReplyResult: [2, o("WAWebWamEnumStatusReplyResult").STATUS_REPLY_RESULT],
