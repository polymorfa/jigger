__d("WAWebStatusSnapshot", [
	...
	var e, s, u, c, d, m, p = (function(e) {
		...
		return babelHelpers.inheritsLoose(t, e), t;
	})(o("WACustomError").CustomError), f = (function(e) {
		function t(t) {
			var n;
			return n = e.call(this, t != null ? t : "") || this, n.name = "StatusMsgNotFound", n;
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(o("WACustomError").CustomError), g = function(r, a, i, l) {
		var t = this;
		if (a === void 0 && (a = !1), l === void 0 && (l = !1), this.$2 = function(e, n) {
			...
			if (i !== -1) {
				var l = t.statuses[i], u = l.readMsgKeys, c;
				return a ? (c = l.msgs ? l.msgs.findIndex(function(e) {
					return a && e.id.toString() === a.toString();
				}) : -1, c >= 0 ? (m || (m = n("Promise"))).resolve({
					msgIdx: c,
					statusIdx: i
				}) : (m || (m = n("Promise"))).reject(new p())) : (c = l.msgs ? l.msgs.findIndex(function(e) {
					return !u.has(e.id.toString());
				}) : -1, c === -1 && e.msgs.msgLoadState.noEarlierMsgs ? (r ? c = 0 : c = l.msgs.length - 1, (m || (m = n("Promise"))).resolve({
					msgIdx: c,
					statusIdx: i
				})) : c !== -1 ? (m || (m = n("Promise"))).resolve({
					msgIdx: c,
					statusIdx: i
				}) : l.unreadCount === 0 && r && l.msgs.length > 0 ? (m || (m = n("Promise"))).resolve({
					msgIdx: 0,
					statusIdx: i
				}) : t.$7(e).then(function() {
					return t.getFirstUnread(e, r, a);
				}).catch(function(e) {
					throw o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["error while getting first unread status: ", ""])), String(e)), new p();
				}));
			}
			...
			if (e.msgIdx + 1 < r.totalCount && e.msgIdx + 1 < r.msgs.length) return (m || (m = n("Promise"))).resolve({
				msgIdx: e.msgIdx + 1,
				statusIdx: e.statusIdx
			});
			if (e.msgIdx + 1 < r.totalCount) return a.msgs.msgLoadState.noEarlierMsgs ? (o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose([
				"[status] loaded ",
				"/",
				" msgs, noEarlierMsgs, re-syncing"
			])), r.msgs.length, r.totalCount), o("WAWebStatusCollection").StatusCollection.sync(), (m || (m = n("Promise"))).reject(new p())) : t.$7(a).then(function() {
				return t.getNext(e);
			}).catch(function(n) {
			...
			if (e.msgIdx > 0) return (m || (m = n("Promise"))).resolve({
				msgIdx: e.msgIdx - 1,
				statusIdx: e.statusIdx
			});
			if (e.statusIdx > 0) {
			...
			var a = t.statuses[e.statusIdx], i = a.status;
			return r < a.msgs.length ? (m || (m = n("Promise"))).resolve({
				msgIdx: r,
				statusIdx: e.statusIdx
			}) : i.msgs.msgLoadState.noEarlierMsgs ? (m || (m = n("Promise"))).reject(new p()) : t.$7(i).then(function() {
				return t.statusAt(e, r);
			}).catch(function(e) {
				throw o("WALogger").WARN(d || (d = babelHelpers.taggedTemplateLiteralLoose(["error while loading more status msgs: ", ""])), String(e)), new p();
			});
		}, this.$7 = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var r = yield o("WAPromiseLoop").promiseLoop((function() {
		...
		} else a && (!o("WAWebContactGetters").getIsMe(r.contact) || l) && !o("WAWebContactGetters").getCalculatedStatusMute(r.contact) ? this.statuses = r.unreadCount > 0 && !o("WAWebContactGetters").getIsMe(r.contact) ? this.$2(r, l) : this.$3(r, l) : this.statuses = [this.$4(r)];
		this.$5();
	};
	l.InvalidStatusIterator = p, l.StatusLoadingError = _, l.StatusMsgNotFound = f, l.StatusSnapshot = g;
}), 98);
