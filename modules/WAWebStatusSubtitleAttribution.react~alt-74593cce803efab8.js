__d("WAWebStatusSubtitleAttribution.react", [
	...
	function f(e) {
		var t = e.children, n = e.enableChevronIcon, a = e.icon, i = e.isCloseFriends, l = e.onClick, u = d(null), c = d(null);
		_(u, c);
		var m = s.jsxs(s.Fragment, { children: [
			...
			n && s.jsx(o("WAWebFlex.react").FlexItem, {
				shrink: 0,
				xstyle: p.centerIcon,
		...
		return s.jsx(o("WAWebFlex.react").FlexRow, {
			...
			justify: "start",
			className: "xeuugli",
			children: i ? s.jsxs(o("WAWebFlex.react").FlexRow, {
				align: "center",
				justify: "start",
