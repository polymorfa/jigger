__d("WAWebStatusUpdatesNotificationsDrawer.react", [
	...
	function _(e) {
		var t = e.onClose, n = e.ref, a = s._(
			...
			/*BTDS*/
			""
		), l = o("useWAWebSettingSync").useMappedSettingSync({
			settingName: "statusNotificationToneId",
			originalSetter: p != null ? p : r("WAWebNoop"),
			toProtobufValue: function(t) {
				return t;
			}
		}), u = o("useWAWebSettingSync").useSettingSync("isStatusNotificationEnabled", function(e) {
			o("WAWebMuteCollection").MuteCollection.setGlobalStatusNotificationsEnabled(e);
		}), d = o("useWAWebSettingSync").useSettingSync("isStatusReactionsNotificationEnabled", function(e) {
			...
			setSoundsEnabled: function(t) {
				o("WAWebMuteCollection").MuteCollection.setGlobalStatusSoundsEnabled(t), o("WAWebSettingsSyncBridge").sendSettingChange("statusNotificationToneId", t ? 1 : 0);
			},
