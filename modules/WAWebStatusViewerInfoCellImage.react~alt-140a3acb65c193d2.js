__d("WAWebStatusViewerInfoCellImage.react", [
	...
	function c(e) {
		var t = e.contact, n = e.reactionText, a = o("useWAWebContactValues").useContactValues(t.id, [o("WAWebContactGetters").getId]), i = a[0], l = o("WAWebThemeContext").useIsDarkTheme(), c = null;
		return n && (c = n === String.fromCodePoint(128154) ? s.jsx("span", {
			className: "x10l6tqk x12mlbjr x4i5khs",
			children: s.jsx(o("WAWebStatusLikeIcon.react").StatusLikeIcon, { innerStyles: { border: l ? u.darkIcon : u.lightIcon } })
