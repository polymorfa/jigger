__d("WAWebStickerAddToFavoriteWamEvent", [
	"WAWebWamCodegenUtils",
	"WAWebWamEnumStickerAddToFavoriteOriginType",
	"WAWebWamEnumStickerMakerSourceType"
], (function(t, n, r, o, a, i, l) {
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ StickerAddToFavorite: [
		1842,
		{
			stickerAddToFavoriteOrigin: [1, o("WAWebWamEnumStickerAddToFavoriteOriginType").STICKER_ADD_TO_FAVORITE_ORIGIN_TYPE],
			...
			stickerMakerSourceType: [7, o("WAWebWamEnumStickerMakerSourceType").STICKER_MAKER_SOURCE_TYPE]
		},
		[
			1,
			1,
