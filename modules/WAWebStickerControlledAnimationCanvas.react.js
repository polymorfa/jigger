__d("WAWebStickerControlledAnimationCanvas.react", [
	"WAAbortError",
	...
	function p(e) {
		var t = e.animationFrames, n = e.maxLoops, a = e.startAnimation, i = r("useWAWebUnmountSignal")(), l = d(!1), u = d(0), p = d(!1), _ = m(null), f = _[0], g = _[1], h = function() {
			l.current || (l.current = !0, r("WAWebAnimateStickerOnCanvas")({
				animationFrames: t,
				signal: i,
		...
		return f ? s.jsx(r("WAWebRgbaCanvas.react"), {
			rgbaBuffer: f,
