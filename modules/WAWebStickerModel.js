__d("WAWebStickerModel", [
	...
	var e, s = r("once")(function() {
		...
		return a.initialize = function() {
			...
			this.addChild("mediaData", n), o("WAWebABProps").getABPropConfigValue("web_sticker_suggestions_enable") && this.listenTo(n, "change:emojis", function(t) {
				t.emojis != null && (t.emojis.length && e.trigger("sticker_mediaData_emojis_updated"), e.stopListening(n, "change:emojis"));
			}), !this.isPlaceholder && !this.isCreateButton && o("WAWebMedia").registerSticker(this);
		}, a.downloadMedia = function(n) {
			var t = this;
			return o("WAWebMedia").downloadStickerOrStickerPackIcon({
				shouldThrow: n,
				sticker: this,
				type: "STICKER"
			}).catch(function(n) {
				o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["id: ", ", error"])), t.id).catching(r("getErrorSafe")(n)).tags("non-sad").sendLogs("sticker-panel:sticker download failed");
			});
		}, a.toDbData = function() {
			return {
				...
				mediaKeyTimestamp: this.mediaKeyTimestamp != null ? this.mediaKeyTimestamp : o("WATimeUtils").unixTime(),
			...
			t.prototype.delete.call(this), o("WAWebMedia").deregisterSticker(this);
		}, n;
