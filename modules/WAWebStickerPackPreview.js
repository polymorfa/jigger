	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			try {
				...
				if (n == null) return;
				var a = o("WAWebStateUtils").unproxy(t.unsafe()).mediaData.mediaBlob, i = yield o("WAWebStickerPackUtils").decompressStickerPackMedia(a, t), l = yield o("WAWebStickerPackUtils").generateStickerGridThumbnail(i), s = yield o("WAWebCanvasUtils").canvasToBlob(l, "image/png");
				n.consolidate({
					fullPreviewData: yield r("WAWebMediaOpaqueData").createFromData(s, "image/png"),
					fullPreviewSize: {
