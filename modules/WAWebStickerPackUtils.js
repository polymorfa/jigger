__d("WAWebStickerPackUtils", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			var l = yield o("WABlobToArrayBuffer").blobToArrayBuffer(i), s = new Uint8Array(l), u = yield o("fflate").unzipSync(s), c = [], d = function* () {
				var e = m[0], t = m[1];
				if (e === a) return 1;
				if (t instanceof Uint8Array) {
					var r, i = t.buffer, l = yield o("WAMediaCalculateFilehash").calculateFilehash(i), s = n == null ? void 0 : n.find(function(t) {
						return t.fileName === e;
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			for (var t = e.context, n = e.gap, r = n === void 0 ? o("WAWebStickerPackConstants").PADDING : n, a = e.imageL, i = a === void 0 ? o("WAWebStickerPackConstants").IMAGE_LENGTH : a, l = e.imageW, s = l === void 0 ? o("WAWebStickerPackConstants").IMAGE_WIDTH : l, u = e.recentStickers, c = e.stickerCount, d = e.thumbL, m = d === void 0 ? o("WAWebStickerPackConstants").THUMBNAIL_LENGTH : d, p = e.thumbW, _ = p === void 0 ? o("WAWebStickerPackConstants").THUMBNAIL_WIDTH : p, f = e.x, g = e.y, h = f, y = g, C = 0; C < c; C++) {
				...
				if (v != null) {
					var S = window.URL.createObjectURL(v), R = yield o("WAWebMediaLoad").loadImage(S);
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a) {
			...
			var s = o("WAWebRecentStickerCollectionMd").RecentStickerCollectionMd.map(function(e) {
				return e.sticker;
			}), u = Math.min(s.length, e != null ? e : 4), c = o("WAWebStickerPackConstants").PADDING, d = o("WAWebStickerPackConstants").PADDING;
			switch (u) {
				case 1:
					c = t / 2 - r / 2, d = n / 2 - a / 2;
					break;
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r) {
			r === void 0 && (r = o("WAWebStickerPackConstants").STICKER_GRID_COUNT);
			var a = o("WAWebCanvasUtils").createCanvas(o("WAWebStickerPackConstants").THUMBNAIL_LENGTH, o("WAWebStickerPackConstants").THUMBNAIL_WIDTH), i = a.getContext("2d"), l = t.slice(0, r);
			if (l.length < r) {
				var s = yield C(l[0]);
				return s != null && i.drawImage(s, 0, 0, o("WAWebStickerPackConstants").THUMBNAIL_LENGTH, o("WAWebStickerPackConstants").THUMBNAIL_WIDTH), a;
			}
			var u = yield (e || (e = n("Promise"))).all(l.map((function() {
			...
			for (var c of u) if (c != null) {
				var d = c.image, m = c.index, p = m % 2, _ = Math.floor(m / 2), f = o("WAWebStickerPackConstants").PADDING + p * (o("WAWebStickerPackConstants").IMAGE_LENGTH + o("WAWebStickerPackConstants").GRID_GAP), g = o("WAWebStickerPackConstants").PADDING + _ * (o("WAWebStickerPackConstants").IMAGE_WIDTH + o("WAWebStickerPackConstants").GRID_GAP);
				i.drawImage(d, f, g, o("WAWebStickerPackConstants").IMAGE_LENGTH, o("WAWebStickerPackConstants").IMAGE_WIDTH);
			}
			return a;
	...
	l.compressedRecentStickers = s, l.decompressStickerPackMedia = c, l.extractStickerPackIdFromUrl = _, l.generateStickerPackThumbnail = f, l.generateStickerGridThumbnail = h;
}), 98);
