__d("WAWebStickersPackDetailsDrawerModal.react", [
	...
	function g(e, t) {
		...
		}, n[0] = e, n[1] = t, n[2] = a) : a = n[2];
		var i = r("useWAWebEventTargetValue")(o("WAWebStickerPackCollectionMd").StickerPackCollectionMd, "add remove reset", a);
		if (i) return i;
	...
	function h(e) {
		...
		var a = r("useWAWebEventTargetValue")(e, "add remove reset", n), i = r("useWAWebUiIdle")(), l, s;
		return t[2] !== e || t[3] !== i ? (l = function() {
			i(function() {
				e == null || e.fetch();
			});
		}, s = [e, i], t[2] = e, t[3] = i, t[4] = l, t[5] = s) : (l = t[4], s = t[5]), p(l, s), a;
	}
	function y(e) {
		...
		var a = r("useWAWebEventTargetValue")(o("WAWebStickerPackCollectionMd").StickerPackCollectionMd, "change:packFetchState", n);
		return a;
	}
	function C(t) {
		var a, i = t.ref, l = babelHelpers.objectWithoutPropertiesLoose(t, u), d = r("useLazyRef")(function() {
			return new (r("WAWebFlatListController"))();
		}), p = l.msg, C = l.onBack, v = l.onClose, S = l.onStickerClick, R = l.onStickerEnter, L = l.stickerPack, E = l.stickerPackId, k = g(L, E), I = (a = o("useWAWebStickerPackValues").useOptionalStickerPackValues(k == null ? void 0 : k.id, [o("WAWebFrontendStickerPackModelMdGetters").getStickers])) != null ? a : [], T = I[0], D = h(T), x = y(E), $ = function(t, n) {
			k && S(t, k, n);
		}, P = function(t, n) {
			k && R(t, k, n);
		}, N = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, r) {
				var a = yield o("WAWebLinkPreviewChatAction").getLinkPreview(t, n), i = a == null ? void 0 : a.data;
				o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["sendTextMsgToChat inside WAWebStickersPackDetailsDrawerModal"]))), o("WAWebSendTextMsgChatAction").sendTextMsgToChat(n, r, { linkPreview: i });
			});
			...
			if (k != null) t = b(k.id);
			else if (E != null) t = b(E);
			else return;
			if (e != null && t != null) {
				var n = o("WAWebLinkify").findLink({ text: t });
				n != null && N(n, e, t).then(o("WAWebDrawerManager").closeDrawerRight);
			}
		}, w;
		return (E && x === o("WAWebStickerPackCollectionMd").FetchState.PENDING || (D == null ? void 0 : D.length) === 0) && (w = m.jsx(o("WAWebFlexBox.react").FlexRow, {
			justify: "center",
			align: "center",
			xstyle: f.spinner,
			...
			children: [
				...
				m.jsx(r("WAWebDrawerBody.react"), {
					...
					children: m.jsxs(r("WAWebDrawerSection.react"), {
						...
						children: [
							k ? m.jsxs(m.Fragment, { children: [
								m.jsx(o("WAWebText.react").WAWebTextTitle, {
									...
									children: m.jsxs("div", babelHelpers.extends({}, (c || (c = r("stylex"))).props(o("WDSFlex.stylex").wdsFlex.flexAlignCenter), { children: [
										k.premium > 0 && m.jsx("div", babelHelpers.extends({}, (c || (c = r("stylex"))).props(o("WDSFlex.stylex").wdsFlex.flexAlignCenter, f.auraIcon), { children: m.jsx(r("WDSIconWdsIcAuraFill.react"), {
											height: 16,
											width: 16
										}) })),
										...
										k.animated ? m.jsx(o("WAWebRoundPlayIcon.react").RoundPlayIcon, {
								...
								k.publisher && m.jsxs(o("WAWebText.react").WAWebTextMuted, {
									marginBottom: 16,
									children: [
										...
										m.jsx("span", {
											dir: "ltr",
											children: o("WAWebL10nFilesize").getL10nFilesize(k.fileSize)
										})
									]
								}),
								k.description && m.jsx(o("WAWebText.react").WAWebTextMuted, {
									marginBottom: 16,
									children: m.jsx(o("WAWebEmojiText.react").EmojiText, { text: k.description })
								}),
								w,
								m.jsx("div", {
									className: "xrvj5dj x1xfd4i4 x40hh3e xi32cqo x1qughib xh8yej3 x5yr21d",
									children: D == null ? void 0 : D.map(function(e) {
							...
							!k && E && x === o("WAWebStickerPackCollectionMd").FetchState.PENDING ? w : null,
							!k && (!E || x !== o("WAWebStickerPackCollectionMd").FetchState.PENDING) ? m.jsxs(m.Fragment, { children: [m.jsx("div", {
				...
				m.jsx("div", {
					...
					children: m.jsx(r("WAWebStickerPackDrawerButton.react"), { handleClick: M })
				})
			]
