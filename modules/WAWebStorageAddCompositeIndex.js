__d("WAWebStorageAddCompositeIndex", [
	"invariant",
	...
	var e = (function(e) {
		...
		return n.validate = function(t) {
			...
			}), this.columns.length > 1 || s(0, 56264), o("WAWebStorageSchema").findIndex(t, this.$AddCompositeIndex$p_1()) === -1 || s(0, 75735, String(this.columns), t.name);
			var n = t.columns.filter(function(e) {
				return e.primaryKey && e.primaryKey === o("WAWebStorageSchema").PrimaryKeyType.COMPOSITE;
			}).map(function(e) {
				return e.name;
			});
			n.length !== this.columns.length || n.some(function(t) {
