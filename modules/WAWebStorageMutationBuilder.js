__d("WAWebStorageMutationBuilder", [
	...
	function c(e, t) {
		...
		if (e != null && e.packColumns && t == null) throw r("err")("[storage-config-error] packing columns enabled, but packing data does not exist");
		var o = e != null && e.packColumns && t ? t : {}, a = function(t) {
			...
			return new (r("WAWebStorageCompositePrimaryKey"))(t.map(function(e) {
				return {
					name: e,
					packedName: a(e)
				};
			...
			return new (r("WAWebStorageAddCompositeIndex"))(t.map(function(e) {
				return a(e);
			}), n);
		}, f = function(t) {
			...
			return new (r("WAWebStorageRemoveCompositeIndex"))(t.map(function(e) {
				return a(e);
			}), n);
		};
		return {
