__d("WAWebStorageMutationUtils", [
	...
	function c(t, n) {
		var r = e.indexOf(t.constructor), o = e.indexOf(n.constructor);
		return r !== -1 || s(0, 75730, t.constructor.name), o !== -1 || s(0, 75730, n.constructor.name), r - o;
	}
	l.sortMutations = u;
}), 98);
