__d("WAWebStorageRemoveIndex", [
	...
	var e = (function(e) {
		...
		return n.validate = function(t) {
			o("WAWebStorageSchema").findIndex(t, this.$RemoveIndex$p_1()) !== -1 || s(0, 75718, this.column, t.name);
		}, n.apply = function(t) {
			var e = o("WAWebStorageSchema").cloneSchema(t), n = o("WAWebStorageSchema").findIndex(t, this.$RemoveIndex$p_1());
