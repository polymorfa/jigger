__d("WAWebStructuredMessageBuyerInteractionWamEvent", [
	...
	var e = o("WAWebWamCodegenUtils").defineEvents({ StructuredMessageBuyerInteraction: [
		7518,
		{
			bizPlatform: [1, o("WAWebWamEnumBizPlatform").BIZ_PLATFORM],
			messageClass: [2, o("WAWebWamEnumStructuredMessageClass").STRUCTURED_MESSAGE_CLASS],
			messageClassAttributes: [3, o("WAWebWamCodegenUtils").TYPES.STRING],
			messageInteraction: [4, o("WAWebWamEnumInteractionType").INTERACTION_TYPE],
