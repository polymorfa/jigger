__d("WAWebStructuredMessageReceiveWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ StructuredMessageReceive: [
		3222,
		{
			...
			lastMessageDirection: [10, o("WAWebWamEnumLastMessageDirection").LAST_MESSAGE_DIRECTION],
