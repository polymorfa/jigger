__d("WAWebSubgroupSuggestionAction", [
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			try {
				var n = yield f(e, t, o("WAWebSubgroupSuggestionsActionJob").SubgroupSuggestionAction.CANCEL);
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			try {
				var n = yield f(e, t, o("WAWebSubgroupSuggestionsActionJob").SubgroupSuggestionAction.REJECT);
		...
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			if (e.groupMetadata) {
				...
				if (i <= 0) {
					...
					return;
				} else if (t.length > i && !(yield o("WAWebCommunitySubgroupSuggestionsModals.react").confirmCommunityFull(i, t.length))) return;
				t == null || t.forEach(function(e) {
					e.currentState = o("WAWebCellRequestState").State.Loading;
				});
				try {
					var l = yield f(e, t, o("WAWebSubgroupSuggestionsActionJob").SubgroupSuggestionAction.APPROVE);
	...
	l.cancelSubgroupSuggestions = g, l.rejectSubgroupSuggestions = y, l.approveSubgroupSuggestions = b;
}), 226);
