__d("WAWebSubgroupSuggestionModel", [
	"WAWebBaseModel",
	...
	var e = (function(e) {
		...
		return n.initialize = function() {
			e.prototype.initialize.call(this), this.addChild("ownerContact", o("WAWebContactCollection").ContactCollection.gadd(this.owner)), this.resetState();
		}, n.resetState = function() {
			this.currentState = o("WAWebCellRequestState").State.Pending, this.error = void 0;
		}, t;
