__d("WAWebSubscriptionUserActionWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ SubscriptionUserAction: [
		7458,
		{
			wsuaAction: [1, o("WAWebWamEnumWsuaAction").WSUA_ACTION],
			wsuaActionTarget: [2, o("WAWebWamEnumWsuaActionTarget").WSUA_ACTION_TARGET],
			wsuaActiveSubscriptions: [10, e.TYPES.STRING],
			wsuaBenefitGroup: [11, e.TYPES.STRING],
			wsuaBenefitsShown: [9, e.TYPES.STRING],
			wsuaProductType: [3, o("WAWebWamEnumWsuaProductType").WSUA_PRODUCT_TYPE],
			...
			wsuaScreenElement: [7, o("WAWebWamEnumWsuaScreenElement").WSUA_SCREEN_ELEMENT],
