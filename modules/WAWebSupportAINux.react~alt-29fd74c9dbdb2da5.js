__d("WAWebSupportAINux.react", [
	...
	function d(e) {
		var t = e.canCancel, a = e.isSending, i = e.okText, l = e.onOK, d = r("useWAWebNux")(o("WAWebNux").NUX.SUPPORT_AI), m = d[0], p = d[1];
		return u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			okDisabled: a,
			cancelDisabled: a,
			onCancel: t === !0 ? o("WAWebModalManager").closeModalManager : null,
					...
					children: [
						u.jsx(o("WAWebFlex.react").FlexItem, {
							...
							children: u.jsx(r("WAWebCellV2.react"), {
								...
								detailLeft: u.jsx(r("WDSIconIcShieldVerified.react"), {
						...
						u.jsx(o("WAWebFlex.react").FlexItem, {
							...
							children: u.jsx(r("WAWebCellV2.react"), {
								...
								interactive: !1,
								colorScheme: "lightest",
								detailLeft: u.jsx(r("WDSIconIcThumbsUpDown.react"), {
									iconXstyle: c.iconColor,
									height: 20,
									width: 20
								}),
					...
					children: u.jsx(o("WAWebFlex.react").FlexItem, {
						...
						children: u.jsx("label", {
							...
							children: u.jsxs(o("WAWebText.react").WAWebTextMuted, { children: [
								o("WAWebMobilePlatforms").isSMB() ? s._(
									/*BTDS*/
									""
								) : s._(
									/*BTDS*/
