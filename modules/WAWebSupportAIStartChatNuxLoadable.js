__d("WAWebSupportAIStartChatNuxLoadable", [
	...
	var e, s = e || (e = o("react")), u = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebSupportAIStartChatNux.react").__setRef("WAWebSupportAIStartChatNuxLoadable").load();
		return e;
	}), "SupportAIStartChatNux"), c = r("react-loadable")({
		loader: u,
		loading: function(t) {
