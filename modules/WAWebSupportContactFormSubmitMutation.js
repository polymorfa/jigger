__d("WAWebSupportContactFormSubmitMutation", [
	"WAWebRelayClient",
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var r = yield o("WAWebRelayClient").commitMutation(e !== void 0 ? e : e = n("WAWebSupportContactFormSubmitMutation.graphql"), { input: t }, { environmentType: "whatsapp_web" }), a = r == null ? void 0 : r.xwa_wa_support_contact_form_submit;
			return a == null ? {
				success: !1,
				error_code: 500,
