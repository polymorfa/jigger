__d("WAWebSuspendedCommunityModal.react", [
	...
	function p(e) {
		var t, n = o("react-compiler-runtime").c(33), a = e.community;
		m(a);
		var i;
		n[0] !== a ? (i = function() {
			var e;
		...
		n[4] !== a ? (f = function() {
			o("WAWebSuspendedGroupUtils").logGroupSuspensionAppealEvent({
				...
				uiSurface: o("WAWebWamEnumGroupSuspensionAppealUiSurface").GROUP_SUSPENSION_APPEAL_UI_SURFACE.COMMUNITY_SUSPENSION_BOTTOM_SHEET
			}), o("WAWebLeaveCommunityModalUtils").openLeaveCommunityModal({ chat: a });
		}, n[4] = a, n[5] = f) : f = n[5];
		var g = f, h;
		n[6] === Symbol.for("react.memo_cache_sentinel") ? (h = u.jsxs(o("WAWebFlex.react").FlexRow, {
			justify: "center",
			align: "center",
		...
		var y = h, C;
		n[7] === Symbol.for("react.memo_cache_sentinel") ? (C = u.jsx(o("WAWebFlex.react").FlexRow, {
			justify: "center",
		...
		var b = C, v;
		n[8] === Symbol.for("react.memo_cache_sentinel") ? (v = u.jsx(o("WAWebFlex.react").FlexRow, {
			justify: "center",
			margin: 16,
		...
		var S = v, R;
		if (n[9] !== ((t = a.groupMetadata) == null ? void 0 : t.participants) || n[10] !== l) {
			var L, E;
			if (R = [], (L = a.groupMetadata) != null && L.participants.iAmAdmin()) {
				var k;
				n[12] !== l ? (k = {
				...
				}, n[12] = l, n[13] = k) : k = n[13], R.push(k);
			}
			var I;
			n[14] === Symbol.for("react.memo_cache_sentinel") ? (I = {
			...
			}, n[14] = I) : I = n[14], R.push(I), n[9] = (E = a.groupMetadata) == null ? void 0 : E.participants, n[10] = l, n[11] = R;
		} else R = n[11];
		var T;
		n[15] === Symbol.for("react.memo_cache_sentinel") ? (T = s._(
			/*BTDS*/
			""
		), n[15] = T) : T = n[15];
		var D = T, x;
		n[16] !== a ? (x = o("WAWebChatCommunityUtils").isCommunitySuperAdmin(a) ? s._(
			/*BTDS*/
			""
		) : s._(
			/*BTDS*/
			""
		), n[16] = a, n[17] = x) : x = n[17];
		var $ = x, P;
		n[18] !== a ? (P = function() {
			o("WAWebSuspendedGroupUtils").logGroupSuspensionAppealEvent({
				chat: a,
		...
		}, n[18] = a, n[19] = P) : P = n[19];
		var N = P, M;
		n[20] !== a || n[21] !== p || n[22] !== g ? (M = o("WAWebChatCommunityUtils").isCommunitySuperAdmin(a) ? p : g, n[20] = a, n[21] = p, n[22] = g, n[23] = M) : M = n[23];
		var w = M, A = o("WAWebChatCommunityUtils").isCommunitySuperAdmin(a) ? "solid-warning" : "primary", F;
		n[24] === Symbol.for("react.memo_cache_sentinel") ? (F = {
			surface: "unknown",
			viewName: "suspended-community"
		}, n[24] = F) : F = n[24];
		var O;
		n[25] !== R ? (O = u.jsx(o("WAWebFlex.react").FlexColumn, { children: R.map(_) }), n[25] = R, n[26] = O) : O = n[26];
		var B;
		return n[27] !== N || n[28] !== w || n[29] !== A || n[30] !== $ || n[31] !== O ? (B = u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: F,
			onOK: w,
			okText: $,
			cancelText: D,
		...
		}), n[27] = N, n[28] = w, n[29] = A, n[30] = $, n[31] = O, n[32] = B) : B = n[32], B;
	}
	function _(e) {
	...
	_.displayName = _.name + " [from " + i.id + "]", l.SuspendedCommunityModal = p;
}), 226);
