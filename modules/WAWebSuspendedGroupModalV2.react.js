__d("WAWebSuspendedGroupModalV2.react", [
	"fbt",
	"WAWebABPropsSaga",
	...
	function d(e) {
		...
		t[0] !== e ? (n = function() {
			o("WAWebSuspendedGroupUtils").logGroupSuspensionAppealEvent({
				...
				uiSurface: o("WAWebWamEnumGroupSuspensionAppealUiSurface").GROUP_SUSPENSION_APPEAL_UI_SURFACE.GROUP_SUSPENSION_BOTTOM_SHEET
			});
		}, r = [e], t[0] = e, t[1] = n, t[2] = r) : (n = t[1], r = t[2]), c(n, r);
	}
	var m = {
		mainPic: {
			width: "x1exxlbk",
	...
	function p(e) {
		var t, n, a = o("react-compiler-runtime").c(25), i = e.chat;
		d(i);
		var l;
		a[0] !== i ? (l = function() {
			var e;
			o("WAWebSuspendedGroupUtils").logGroupSuspensionAppealEvent({
				...
				supportTag: o("WAWebSuspendedGroupUtils").SUSPENDED_GROUP_SUPPORT_TAG,
		...
		a[4] !== i ? (g = function() {
			o("WAWebSuspendedGroupUtils").logGroupSuspensionAppealEvent({
				...
				uiSurface: o("WAWebWamEnumGroupSuspensionAppealUiSurface").GROUP_SUSPENSION_APPEAL_UI_SURFACE.GROUP_SUSPENSION_BOTTOM_SHEET
			}), new (o("WAWebSuspendedGroupDeleteWamEvent")).SuspendedGroupDeleteWamEvent({ deleteBtnSource: o("WAWebWamEnumDeleteSuspendedGroupBtn").DELETE_SUSPENDED_GROUP_BTN.BOTTOM_SHEET_BTN }).commit(), o("WAWebModalManager").ModalManager.close(), o("WAWebSuspendedGroupUtils").openExitAndDeleteGroupModal(i);
		}, a[4] = i, a[5] = g) : g = a[5];
		var h = g, y;
		a[6] === Symbol.for("react.memo_cache_sentinel") ? (y = s._(
			/*BTDS*/
			""
		), a[6] = y) : y = a[6];
		var C = y, b;
		...
		var v = b, S;
		a[8] === Symbol.for("react.memo_cache_sentinel") ? (S = u.jsxs(o("WAWebFlex.react").FlexRow, {
			justify: "center",
			align: "center",
		...
		var R = S, L;
		a[9] === Symbol.for("react.memo_cache_sentinel") ? (L = u.jsx(o("WAWebFlex.react").FlexRow, {
			justify: "center",
		...
		var E = L, k;
		a[10] === Symbol.for("react.memo_cache_sentinel") ? (k = u.jsx(o("WAWebFlex.react").FlexRow, {
			justify: "center",
			children: u.jsx(o("WAWebText_DONOTUSE.react").TextParagraph, { children: s._(
				/*BTDS*/
				"",
		...
		var I = k, T;
		if (a[11] !== ((t = i.groupMetadata) == null ? void 0 : t.participants) || a[12] !== ((n = i.groupMetadata) == null ? void 0 : n.terminated) || a[13] !== c) {
			var D, x, $, P;
			if (T = [], !((D = i.groupMetadata) != null && D.terminated) && (x = i.groupMetadata) != null && x.participants.iAmAdmin()) {
				var N;
				a[15] !== c ? (N = {
				...
				}, a[15] = c, a[16] = N) : N = a[16], T.push(N);
			}
			var M;
			a[17] === Symbol.for("react.memo_cache_sentinel") ? (M = {
			...
			}, a[17] = M) : M = a[17], T.push(M), a[11] = ($ = i.groupMetadata) == null ? void 0 : $.participants, a[12] = (P = i.groupMetadata) == null ? void 0 : P.terminated, a[13] = c, a[14] = T;
		} else T = a[14];
		var w;
		a[18] === Symbol.for("react.memo_cache_sentinel") ? (w = {
			surface: "unknown",
			viewName: "suspended-group-v2"
		}, a[18] = w) : w = a[18];
		var A;
		a[19] !== T ? (A = u.jsx(o("WAWebFlex.react").FlexColumn, { children: T.map(_) }), a[19] = T, a[20] = A) : A = a[20];
		var F;
		return a[21] !== f || a[22] !== h || a[23] !== A ? (F = u.jsxs(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: w,
			onOK: h,
			okText: v,
			cancelText: C,
