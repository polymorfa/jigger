	...
	function p(e) {
		...
		var i = function() {
			...
			o("WAWebSuspendedGroupUtils").logGroupSuspensionAppealEvent({
				...
				uiSurface: o("WAWebWamEnumGroupSuspensionAppealUiSurface").GROUP_SUSPENSION_APPEAL_UI_SURFACE.GROUP_SUSPENSION_BOTTOM_SHEET
			}), new (o("WAWebSuspendedGroupDeleteWamEvent")).SuspendedGroupDeleteWamEvent({ deleteBtnSource: o("WAWebWamEnumDeleteSuspendedGroupBtn").DELETE_SUSPENDED_GROUP_BTN.BOTTOM_SHEET_BTN }).commit(), o("WAWebModalManager").ModalManager.close(), o("WAWebSuspendedGroupUtils").openExitAndDeleteGroupModal(a);
		}, p = s._(
			/*BTDS*/
			""
		), _ = s._(
		...
		return !((t = a.groupMetadata) != null && t.terminated) && (n = a.groupMetadata) != null && n.participants.iAmAdmin() && y.push({
			...
			children: [
				...
				g,
				h,
				u.jsx(o("WAWebFlex.react").FlexColumn, { children: y.map(function(e) {
