__d("WAWebSyncdAction", [
	...
	var e, s, u, c = (function() {
		function t() {}
		var a = t.prototype;
		return a.malformedActionIndex = function() {
			var e = this.asSyncdActionHandler();
			return o("WAWebSyncdIndexUtils").malformedActionIndex(e.collectionName, e.getAction());
		}, a.resolveConflicts = function(t, r) {
			var e = r.timestamp;
			return e >= t.timestamp ? (u || (u = n("Promise"))).resolve(o("WAWebSyncdConst").ConflictResolutionState.ApplyRemoteAndDropLocal) : (u || (u = n("Promise"))).resolve(o("WAWebSyncdConst").ConflictResolutionState.SkipRemote);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				switch (e.operation) {
					case "remove": return this.getValidatedContentRemove(e);
					case "set": return this.getValidatedContentSet(e);
				}
			});
			function t(t) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				throw r("err")("You must implement getValidatedContent on your handler before using `withValidatedContent`");
			});
			function t(t) {
				return e.apply(this, arguments);
			}
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
				var r = yield this.getValidatedContent(t), a = this.asSyncdActionHandler();
				switch (r.result) {
					case "malformed_index": return this.malformedActionIndex();
					case "malformed_value": return o("WAWebSyncdIndexUtils").malformedActionValue(a.collectionName);
					case "unsupported": return { actionState: o("WAWebSyncdConst").SyncActionState.Unsupported };
					case "ok": return n(r.content).catch(function(t) {
						...
						return o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose([
							...
							": ",
							""
						])), a.getAction(), n), { actionState: o("WAWebSyncdConst").SyncActionState.Failed };
					});
				}
			});
			function r(e, n) {
		...
		var n = t.prototype;
		return n.isAccountSyncdAction = function() {
			return !0;
		...
		babelHelpers.inheritsLoose(t, e);
		var n = t.prototype;
		return n.isChatSyncdAction = function() {
			return !0;
			...
			var e = this.asChatSyncdActionHandler(), n = t[e.chatJidIndex];
			if (n == null) return !1;
			try {
				return o("WAWebWidFactory").createWid(n).isLid();
			} catch (e) {
				var a = r("getErrorSafe")(e);
				return o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["isLidMutation: invalid wid in mutation index, error: ", ""])), a.message).sendLogs("syncd: isLidMutation invalid wid"), !1;
			}
		}, t;
	})(c), p = (function(e) {
		function t() {
		...
		babelHelpers.inheritsLoose(t, e);
		var n = t.prototype;
		return n.isChatOrContactSyncdAction = function() {
			return !0;
		...
		babelHelpers.inheritsLoose(t, e);
		var n = t.prototype;
		return n.isMessageSyncdAction = function() {
			return !0;
		...
		babelHelpers.inheritsLoose(t, e);
		var n = t.prototype;
		return n.isChatMessageRangeSyncdAction = function() {
			return !0;
	...
	l.AccountSyncdActionBase = d, l.ChatSyncdActionBase = m, l.ChatOrContactSyncdActionBase = p, l.MessageSyncdActionBase = _, l.ChatMessageRangeSyncdActionBase = f;
}), 98);
