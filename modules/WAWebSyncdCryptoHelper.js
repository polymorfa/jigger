__d("WAWebSyncdCryptoHelper", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			return {
				...
				valueEncryptionKey: n.slice(t.INDEX_KEY_END, t.VALUE_ENCRYPTION_KEY_END),
	...
	function u(e) {
		return o("WACryptoHkdf").extractAndExpand(o("WASyncdKeyTypes").fromSyncKeyData(e), o("WAWebSyncdCryptoConst").HKDF_INFO, o("WAWebSyncdCryptoConst").DERIVED_KEY_LENGTH);
	}
