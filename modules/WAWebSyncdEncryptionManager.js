__d("WAWebSyncdEncryptionManager", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r) {
			var a = yield o("WAWebSyncdCrypto").generateEncryptionKeys(e), i = a.snapshotMacKey, l = o("WAEncodeString").toUtf8(r).buffer, s = o("WAWebSyncdCryptoUtils").to64BitNetworkOrder(n);
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.collection, n = e.keyData, r = e.patchVersion, a = e.snapshotMac, i = e.valueMacs, l = yield o("WAWebSyncdCrypto").generateEncryptionKeys(n), s = l.patchMacKey, u = o("WAEncodeString").toUtf8(t).buffer, c = o("WAWebSyncdCryptoUtils").to64BitNetworkOrder(r);
