__d("WAWebSyncdFatalExceptionNotificationApi", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			}, n = o("WAWebOutgoingPeerMsgKey").buildOutgoingPeerMsgKey(yield r("WAWebMsgKey").newId()), a = {
				id: n,
			...
			return yield o("WAWebApiPeerMessageStore").storePeerMessages([a]), o("WAWebSendAppStateSyncMsgJob").encryptAndSendKeyMsg({ msg: a });
