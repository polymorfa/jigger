__d("WAWebSyncdKmpEncryptionManager", [
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, r) {
			try {
				var a = o("WAWebSyncdKmpConversion").toKmpSyncdCryptoMutationKey(n, r), i = o("WAWebSyncdKmpConversion").toKmpSyncdMutationDataForEncryption(n, t), l = _.encrypt(a, i), u = yield l.toPromise();
				return {
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var l = yield _.calculatePatchMac(t, o("wa-kmp-syncd-engine-crypto-api").KmpLong.fromDecimalString(r.toString()), o("WAWebSyncdKmpConversion").toKmpSyncdCryptoMutationKeyData(n), new Int8Array(o("WAWebSyncdCryptoUtils").combine(i)), new Int8Array(a)).toPromise();
			return l.buffer;
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r) {
			...
			var a = yield _.calculateSnapshotMac(r, o("wa-kmp-syncd-engine-crypto-api").KmpLong.fromDecimalString(n.toString()), new Int8Array(t), o("WAWebSyncdKmpConversion").toKmpSyncdCryptoMutationKeyData(e)).toPromise();
			return a.buffer;
