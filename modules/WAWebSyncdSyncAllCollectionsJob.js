__d("WAWebSyncdSyncAllCollectionsJob", [
	...
	var e;
	function s() {
		return o("WAWebOrchestratorNonPersistedJob").createNonPersistedJob("syncdSyncAllCollections", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["syncd: periodic sync for all collection"]))), yield o("WAWebSyncd").markCollectionsForSync([
			...
			]), yield o("WAWebUserPrefsAppStateSync").setLastPeriodicAppStateSyncTs(o("WATimeUtils").unixTime());
		}), {
