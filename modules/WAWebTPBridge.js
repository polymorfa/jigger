__d("WAWebTPBridge", [
	...
	var e = (function() {
		function e(e, t, n) {
			var o = this;
			this.$1 = !1, this.$5 = new Set(), this.$6 = new Set(), this.$7 = new (r("WAWebTypedEventEmitter"))(), this.$9 = new Set(), this.$2 = e, this.$3 = t.endsWith("/") ? t.slice(0, -1) : t, this.$8 = n, this.$4 = new (r("SecureMessageListener"))(window, "webtpbridge").setSupportedOrigins([n]).setEventHandler(function(e) {
				return o.$10(e);
			}), this.initialize();
		}
		var t = e.prototype;
		return t.initialize = function() {
			...
			if (this.$1) {
				...
				o("SecurePostMessage").sendMessageToSpecificOrigin(this.$2, e, this.$3, r);
			...
			return l > 0 && (s = window.setTimeout(function() {
				c(), i(new (o("WACustomError")).TimeoutError(t + ", timeoutMs: " + l));
			}, l), this.$6.add(s)), c;
		}, t.destroy = function() {
			if (this.$1) {
			...
			if (!(!this.$1 || t.origin !== this.$3 || t.source !== this.$2)) {
				var n = t.data;
				this.$7.trigger(n.type, o("WAWebTPMessage").decodeWAWebTPMessage(n));
				for (var r of this.$5) r.onMessage(n, function(t, n) {
