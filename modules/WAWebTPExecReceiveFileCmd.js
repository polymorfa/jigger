__d("WAWebTPExecReceiveFileCmd", [
	...
	"use strict";
	function e(e) {
		var t = e.sessionId, a = e.utmCampaign;
		...
		try {
			if (t == null) return !1;
			o("WAWebTPLoggingUtils").logPdfReceiverFileForwardedEvent(t), o("WAWebTPPdfViewerQpl").pdfViewerQpl.receiverForwardStart(), s(t).then((function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					...
					var n = new File([e.fileBuffer], e.fileName, { type: "application/pdf" });
					yield o("WAWebWebTPSharedSessionUtils").clearWebTPSharedSessionFileBuffer(t), o("WAWebTPPdfViewerQpl").pdfViewerQpl.receiverForwardComplete(), o("WAWebTPPdfViewerGatingUtils").isPdfPreviewBeforeSendEnabled() ? (o("WAWebTPLoggingUtils").logPdfReceiverPreviewOpenEvent(t, a), o("WAWebCmd").Cmd.trigger("open_file_forward_modal_with_preview", n, {
						showPreview: !0,
						onSend: function() {
					...
					})) : o("WAWebCmd").Cmd.trigger("open_file_forward_modal", n);
				});
				return function(t) {
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			return n == null ? null : o("WATimeUtils").unixTime() > n.expiresAt ? (yield t.remove(e), null) : n;
