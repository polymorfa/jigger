__d("WAWebTPMediaEditorPreviewPdf.react", [
	...
	function d(e) {
		var t = e.captionInput, n = e.documentPageCount, a = e.filename, i = e.fullPreview, l = e.isPasswordProtected, d = l === void 0 ? !1 : l, m = e.onClose;
		return d === !0 ? u.jsxs(o("WAWebFlex.react").FlexColumn, {
			xstyle: c.container,
			align: "center",
			children: [
			...
			children: [
				...
				u.jsxs(o("WAWebFlex.react").FlexColumn, {
					...
					children: [u.jsx("img", {
						alt: a,
						src: i,
						className: "x193iq5w xmz0i5r x2lwn1j xs83m0k x8jj4xb x178xt8z x1lun4ml xso031l xpilrb4 x13fuv20 x18b5jzi x1q0q8m5 x1t7ytsu xnj1f2r x2uibgs xkveyfu x12llq9 xyi3aci xwf5gio x1p453bz x1suzm8a xos98db"
					}), r("justknobx")._("2389") && o("WAWebTPPdfViewerGatingUtils").isWebTPThumbnailAttributionEnabled() && u.jsx("div", {
						className: "x1de0gy xdqhqc9 x2lah0s",
						children: u.jsx(r("WAWebTPPoweredByLoadable"), {
							persistent: !0,
