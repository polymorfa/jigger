__d("WAWebTPPdfViewer", [
	...
	"use strict";
	var e, s = r("justknobx")._("5486"), u = (function() {
		function t(e) {
		...
		var a = t.prototype;
		return a.publishAppConfig = (function() {
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r, o) {
				...
				return new (e || (e = (n("Promise"))))(function(e, n) {
					a.$1.listenOnce("RENDER_PDF_PREVIEW_RESPONSE", function(t) {
					...
					}), a.$1.publishWhenReady("RENDER_PDF_PREVIEW", {
						file: t,
						fileName: r,
			...
			var t = this, a = r("WAWebPonyfillsCryptoRandomUUID")();
			return new (e || (e = (n("Promise"))))(function(e, n) {
				var r = null, i = t.$1.listen("GET_UPDATED_PDF_BUFFER_RESPONSE", function(t) {
					t.requestId === a && (r != null && window.clearTimeout(r), i(), e(o("WAWebTPNormalizePdfDataBuffer").normalizePdfDataBuffer(t.buffer)));
				});
				r = window.setTimeout(function() {
					i(), n(new (o("WACustomError")).TimeoutError("GET_UPDATED_PDF_BUFFER_RESPONSE, timeoutMs: " + s));
				}, s), t.$1.publishWhenReady("GET_UPDATED_PDF_BUFFER", { requestId: a }).catch(function(e) {
