__d("WAWebTPPdfViewerQpl", [
	"WAWebEnvironment",
	"WAWebQplFlowWrapper",
	"qpl"
], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = r("qpl")._(891426979, "2244"), s = function(t) {
		...
		function t() {}
		var n = t.prototype;
		return n.$3 = function(t) {
			var e, n;
			(e = this.$1) == null || e.end(t), this.$1 = null, (n = this.$2) == null || n.call(this);
		}, n.$4 = function(t, n) {
			var e;
			(e = this.$1) == null || e.addPoint(t, n);
		}, n.initialize = function(n) {
			var t = this;
			this.$1 != null && this.$3(105), this.$1 = o("WAWebQplFlowWrapper").QPL.markerStart(e, {
				trackedForLoss: !0,
				cancelOnUnload: !0,
				annotations: { string: {
