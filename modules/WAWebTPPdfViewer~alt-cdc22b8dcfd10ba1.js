__d("WAWebTPPdfViewer", [
	...
	"use strict";
	var e = r("justknobx")._("5486"), s = (function() {
		function t(e) {
			this.$1 = new (o("WAWebTPWhatsAppNetBridge")).WAWebTPWhatsAppNetBridge(e), this.$1.registerListener(new (o("WAWebTPPerformanceListener")).WAWebTPPerformanceListener(Date.now()));
		}
		var n = t.prototype;
		return n.publishAppConfig = async function(t) {
			return this.$1.publishWhenReady("APP_CONFIG", t);
		}, n.renderPdf = async function(n, r, o) {
			var t = this;
			return new Promise(function(a, i) {
				t.$1.listenOnce("RENDER_PDF_PREVIEW_RESPONSE", function(e) {
				...
				}), t.$1.publishWhenReady("RENDER_PDF_PREVIEW", {
					file: n,
					fileName: r,
			...
			var t = this, n = r("WAWebPonyfillsCryptoRandomUUID")();
			return new Promise(function(r, a) {
				var i = null, l = t.$1.listen("GET_UPDATED_PDF_BUFFER_RESPONSE", function(e) {
					e.requestId === n && (i != null && window.clearTimeout(i), l(), r(o("WAWebTPNormalizePdfDataBuffer").normalizePdfDataBuffer(e.buffer)));
				});
				i = window.setTimeout(function() {
					l(), a(new (o("WACustomError")).TimeoutError("GET_UPDATED_PDF_BUFFER_RESPONSE, timeoutMs: " + e));
				}, e), t.$1.publishWhenReady("GET_UPDATED_PDF_BUFFER", { requestId: n }).catch(function(e) {
