__d("WAWebTableRowCountsLogger", [
	...
	function s() {
		return s = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = o("WAWebModelStorageUtils").getStorage().getExistingTables(), t = [], n = function* (n) {
				t.push(yield o("WAWebModelStorageUtils").getStorage().table(n).count().then(function(e) {
					return [n, e];
