__d("WAWebTeeDebugPanel.react", [
	...
	function C() {
		...
		if (e[0] !== t || e[1] !== r) {
			var d;
			c = r != null ? r : (d = t.find(R)) == null ? void 0 : d.id, e[0] = t, e[1] = r, e[2] = c;
		} else c = e[2];
		var g = c, h = S, y = v, C = b, L;
		e[3] !== g || e[4] !== t ? (L = g != null ? t.find(function(e) {
			return e.id === g;
		}) : null, e[3] = g, e[4] = t, e[5] = L) : L = e[5];
		var k = L, I = m(null), T = I[0], D = I[1], x;
		...
		e[36] !== ee ? (te = babelHelpers.extends({}, E.textarea, { opacity: ee }), e[36] = ee, e[37] = te) : te = e[37];
		var ne;
		...
		e[51] !== t.length ? (le = s.jsxs("div", {
			...
			style: babelHelpers.extends({}, E.triggerBtn, { marginLeft: "auto" }),
			onClick: q,
		...
		if (e[62] !== g || e[63] !== t) {
			...
			e[65] !== g ? (pe = function(t) {
				return s.jsxs("div", {
					style: babelHelpers.extends({}, E.entry, { backgroundColor: g === t.id ? "#f0f2f5" : "transparent" }),
					children: [s.jsxs("div", {
						style: {
							display: "flex",
							alignItems: "center",
	...
	var L = {
		...
		triggerBtn: babelHelpers.extends({}, L, {
			border: "1px solid #ccc",
			backgroundColor: "#fff",
			color: "#111b21",
			fontWeight: "normal"
		}),
		quickBtn: babelHelpers.extends({}, L, {
			border: "1px solid #00a884",
			backgroundColor: "#e8f5e9",
			color: "#00a884"
		}),
		quickBtnWarn: babelHelpers.extends({}, L, {
			border: "1px solid #f0a030",
			backgroundColor: "#fff8e1",
			color: "#f0a030"
		}),
		quickBtnDanger: babelHelpers.extends({}, L, {
			border: "1px solid #e53935",
			backgroundColor: "#ffebee",
			color: "#e53935"
		}),
		sendBtn: babelHelpers.extends({}, L, {
			fontSize: "12px",
