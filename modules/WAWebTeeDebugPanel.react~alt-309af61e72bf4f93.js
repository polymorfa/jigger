__d("WAWebTeeDebugPanel.react", [
	...
	function h() {
		...
		return s.jsxs("div", {
			...
			children: [
				...
				s.jsxs("div", {
					...
					children: [
						...
						s.jsx("textarea", {
							...
							disabled: d == null,
							style: babelHelpers.extends({}, C.textarea, { opacity: d == null ? .4 : 1 })
						}),
						s.jsx("div", {
							style: C.btnRow,
				...
				s.jsxs("div", {
					...
					children: [s.jsxs("div", {
						...
						children: [s.jsxs("div", {
							...
							style: babelHelpers.extends({}, C.triggerBtn, { marginLeft: "auto" }),
							onClick: x,
				...
				t.map(function(e) {
					return s.jsxs("div", {
						style: babelHelpers.extends({}, C.entry, { backgroundColor: d === e.id ? "#f0f2f5" : "transparent" }),
						children: [s.jsxs("div", {
							style: {
								display: "flex",
								alignItems: "center",
	...
	var y = {
		...
		triggerBtn: babelHelpers.extends({}, y, {
			border: "1px solid #ccc",
			backgroundColor: "#fff",
			color: "#111b21",
			fontWeight: "normal"
		}),
		quickBtn: babelHelpers.extends({}, y, {
			border: "1px solid #00a884",
			backgroundColor: "#e8f5e9",
			color: "#00a884"
		}),
		quickBtnWarn: babelHelpers.extends({}, y, {
			border: "1px solid #f0a030",
			backgroundColor: "#fff8e1",
			color: "#f0a030"
		}),
		quickBtnDanger: babelHelpers.extends({}, y, {
			border: "1px solid #e53935",
			backgroundColor: "#ffebee",
			color: "#e53935"
		}),
		sendBtn: babelHelpers.extends({}, y, {
			fontSize: "12px",
