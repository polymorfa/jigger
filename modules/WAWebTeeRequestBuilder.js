__d("WAWebTeeRequestBuilder", ["WAWebTeeEnums"], (function(t, n, r, o, a, i, l) {
	function e() {
		return {
			identifier: crypto.randomUUID(),
			locale: navigator.language,
			timezone_offset_hour: Math.round(-(new Date().getTimezoneOffset() / 60)),
	...
	function c(t, n, r, a, i) {
		var l = { tee_chat_request: {
			message: t,
			conversation_history: n,
			additional_context: r != null ? { conversation_context: [r] } : void 0,
			config_overrides: a,
	...
	l.buildSummaryRequest = s, l.buildWriteWithAIRequest = u, l.buildSideChatRequest = c;
}), 98);
