__d("WAWebTextFormatPreviewPlugin.react", [
	...
	function c(e) {
		var t = e.blockQuoteEnabled, n = e.bulletPointsEnabled, r = e.highlightedBotCommands, a = e.inlineCodeEnabled, i = e.internLinksEnabled, l = e.linksEnabled, s = e.numberedListEnabled, c = e.phoneNumbersEnabled, m = e.spoilerEnabled, p = o("LexicalComposerContext").useLexicalComposerContext(), _ = p[0];
		return u(function() {
			var e = !1;
			function u() {
				d(_, {
			...
			var p = _.registerTextContentListener(function() {
				e = !0;
			}), f = _.registerUpdateListener(function() {
				_.isComposing() || !e || (e = !1, u());
			}), g = _.registerMutationListener(o("Lexical").ParagraphNode, function(e) {
				for (var t of e) {
					var n = t[1];
