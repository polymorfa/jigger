__d("WAWebTextMentionWrapperMutatorComponent.react", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			try {
				var n = yield o("WAWebFindChatAction").findOrCreateLatestChat(t, "textMentionWrapper"), r = n.chat;
	...
	function _(e) {
		var t = o("react-compiler-runtime").c(8), n = e.contact, a = e.lastMessage, i = e.selectable, l = e.theme, u = d(r("WAWebWrapperDisplayTypeContext")), p;
		t[0] !== n ? (p = function() {
			var e, t, r = (e = o("WAWebSimpleSignalPNToFBIDMigration").getDeprecatedPnChatForFbidInvoke(n.id)) != null ? e : n.id, a = (t = o("WAWebBotProfileCollection").BotProfileCollection.getDefaultBot()) == null ? void 0 : t.id;
		...
		var g;
		return t[2] !== n || t[3] !== a || t[4] !== f || t[5] !== i || t[6] !== l ? (g = c.jsx(r("WAWebTextMentionMutatorComponent.react"), {
			contact: n,
			theme: l,
			selectable: i,
			onClick: f,
			lastMessage: a
		}), t[2] = n, t[3] = a, t[4] = f, t[5] = i, t[6] = l, t[7] = g) : g = t[7], g;
	}
	l.default = _;
}), 226);
