__d("WAWebTextMessageUserJourneyWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ TextMessageUserJourney: [
		5404,
		{
			appSessionId: [1, e.TYPES.STRING],
			botType: [10, o("WAWebWamEnumBotType").BOT_TYPE],
			chatbarInitialState: [6, o("WAWebWamEnumChatbarInitialState").CHATBAR_INITIAL_STATE],
			textMessageUserJourneyAction: [2, o("WAWebWamEnumTextMessageUserJourneyAction").TEXT_MESSAGE_USER_JOURNEY_ACTION],
			...
			userJourneyChatType: [4, o("WAWebWamEnumUserJourneyChatType").USER_JOURNEY_CHAT_TYPE],
