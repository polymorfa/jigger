__d("WAWebTextStatusAction", [
	...
	var e, u, c = u || (u = o("react")), d = 6e4, m = new Map();
	function p(e) {
		var t = m.get(e);
	...
	function g() {
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			if (o("WAWebTextStatusGatingUtils").receiveTextStatusEnabled()) {
				var n = e.toString();
				if (!p(n)) {
					var r = o("WAWebContactCollection").ContactCollection.get(e), a = _({
						contactModel: r,
						id: e,
						lastUpdateTime: t
					}), i = a.fetchPromise, l = a.isOwnFetch, s = yield i;
					if (l) {
						if (s.error) {
							m.set(n, Date.now()), s.error instanceof o("WAWebBackendErrors").ServerStatusCodeError && s.error.statusCode === 401 && o("WAWebUpdateTextStatusForContact").updateTextStatusForContact({
								contactId: e,
								textString: null,
								emoji: null,
						...
						m.delete(n), o("WAWebUpdateTextStatusForContact").updateTextStatusForContact({
							contactId: e,
							textString: s.text,
							emoji: s.emoji,
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, r, a, i, l) {
			if (i === void 0 && (i = o("WAWebActionToast.react").genId()), l === void 0 && (l = !1), !!o("WAWebTextStatusGatingUtils").sendTextStatusEnabled()) {
				var u = o("WAWebContactCollection").ContactCollection.getMeContact();
				if (u) {
					var d = !t && !r, m = o("WAWebContactTextStatusBridge").setTextStatus(t, r, a), p = s._(
						/*BTDS*/
						""
					), _ = s._(
						/*BTDS*/
						""
					), f = new (o("WAWebActionToast.react")).ActionType(p), g = u.textStatusEmoji, y = u.textStatusEphemeralDuration, C = u.textStatusString, b = m.then(function(c) {
						if (c.result === "SUCCESS") {
							...
							var m = l ? void 0 : {
								...
								actionHandler: function() {
									return C != null && y != null ? h(C, g, y, i, !0) : (e || (e = n("Promise"))).resolve();
								}
							};
							return new (o("WAWebActionToast.react")).ActionType(p, m);
						} else if (c.result === "FAILURE") return new (o("WAWebActionToast.react")).ActionType(_);
					}).catch(function(e) {
	...
	l.getTextStatus = f, l.setMyTextStatus = h, l.getSuggestions = C, l.setSuggestions = v;
}), 226);
