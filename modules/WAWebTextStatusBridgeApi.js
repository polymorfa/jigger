	...
	var e, s = {
		...
		refreshTextStatus: (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = e.contactId, n = o("WAWebWidFactory").createWid(t), r = o("WAWebTextStatusCollection").TextStatusCollection.get(n);
				if (r != null) {
					var a = yield o("WAWebStatusContactAction").getStatus(o("WAWebWidFactory").asUserWidOrThrow(n));
