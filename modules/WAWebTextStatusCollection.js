__d("WAWebTextStatusCollection", [
	...
	var e = (function(e) {
		function t() {
			...
			return t = e.call.apply(e, [this].concat(a)) || this, t.findImpl = function(e) {
				var t = e instanceof r("WAWebWid") ? o("WAWebWidFactory").asUserWidOrThrow(e) : o("WAWebWidFactory").createUserWidOrThrow(e);
