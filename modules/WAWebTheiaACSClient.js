__d("WAWebTheiaACSClient", [
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			var n = new (o("WAWebACSServerProvider")).WAWebACSServerProvider(), a = yield n.getPublicParameters(t, "");
			if (a.cipherSuite !== e) throw r("err")("WAWebTheiaACSClient: expected cipher_suite=2, got " + String(a.cipherSuite));
			var i = yield p(n, t, a), l = yield g(i.sharedSecret.slice(), u);
			return {
				projectName: t,
				attributeIdentifier: "",
	...
	function _() {
		return _ = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			var r = o("WAWebTheiaVoprfJsEd25519").createWAWebTheiaVoprfJsEd25519Module(), a = f(s), i = r.blind(a), l = i.blindedElement, u = i.blindingFactor, c = yield e.getCredentials({
				blindedTokens: [l],
				config: n,
				projectName: t,
				requestProof: !0
			}), d = y(c), m = C(c), p = r.verifiableUnblind(m.c, m.s, u, d, l, n.publicKey, !0), _ = p.unblindedElement, g = r.clientFinalize(a, _), h = g.finalEvaluation;
			return {
				nonce: a,
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = yield self.crypto.subtle.importKey("raw", e, {
				hash: "SHA-256",
				name: "HMAC"
			}, !1, ["sign"]), r = yield self.crypto.subtle.sign("HMAC", n, t);
