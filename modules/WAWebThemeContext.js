__d("WAWebThemeContext", [
	...
	var e, s = e || (e = o("react")), u = s.createContext, c = s.useContext, d = {
		light: [{
			id: "bg-chat-light",
	...
	function m() {
		return o("WAWebUserPrefsGeneral").getSystemThemeMode() ? r("WAWebSystemTheme").getCurrentTheme() : o("WAWebUserPrefsGeneral").getTheme();
	}
	function p(e) {
	...
	function f(e) {
		var t = document.body, n = e === "dark";
		t == null || t.classList.toggle("dark", n), g(), o("WAWebBizAiAssetResolver").applyAiHubProfileTheme(n);
	}
	function g() {
		var e = getComputedStyle(document.body).getPropertyValue("--navbar-background"), t = document.querySelectorAll("meta[name=\"theme-color\"]");
	...
	l.THEME_ASSETS = d, l.getTheme = m, l.setTheme = p, l.isDarkTheme = _, l.applyThemeToUI = f, l.resetPwaTitlebarColor = g, l.ThemeContext = y, l.useTheme = C, l.useIsDarkTheme = b;
}), 98);
