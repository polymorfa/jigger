__d("WAWebThemePopup.react", [
	...
	function _() {
		var e = d(o("WAWebThemeContext").ThemeContext), t = m(e.systemThemeMode ? "system" : e.theme), n = t[0], a = t[1], i = function(t) {
			a(t);
		}, l = function() {
			n === "system" ? (e.setSystemThemeMode(!0), e.setTheme(r("WAWebSystemTheme").getCurrentTheme())) : (e.setSystemThemeMode(!1), e.setTheme(n)), f(n), o("WAWebModalManager").ModalManager.close();
		}, s = u.jsx(o("WAWebRadio.react").RadioGroup, {
			name: "theme",
		...
		return u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			...
			children: u.jsx("form", { children: u.jsx("ol", { children: s }) })
		});
	}
