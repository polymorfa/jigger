	...
	function s(t) {
		try {
			t.forEach(function(e) {
				var t, n = e.event, r = e.threadDs, a = e.threadId, i = n.contactInfo, l = {
					threadDs: r,
					threadId: a,
					...
					typeOfGroup: i.groupType != null ? o("WAWebGroupType").groupTypeToWamEnum(i.groupType) : void 0,
					isArchived: n.isArchived,
					isPinned: n.isPinned,
					chatMuted: n.isMuted ? o("WAWebWamEnumChatMutedType").CHAT_MUTED_TYPE.MUTED_NO_NOTIFICATIONS : o("WAWebWamEnumChatMutedType").CHAT_MUTED_TYPE.NOT_MUTED,
					...
					oppositeVisibleIdentification: n.oppositeVisibleIdentification != null ? n.oppositeVisibleIdentification : void 0,
				...
				}, s = new (o("WAWebThreadInteractionDataCoreConsumerWamEvent")).ThreadInteractionDataCoreConsumerWamEvent(l);
				s.commit();
			});
		} catch (t) {
			var n = t instanceof Error ? t : r("err")(String(t));
			o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["ctlv2: error uploading Core Consumer WAM event"]))).catching(n).sendLogs("thread-logging-core-consumer-upload-failure");
		}
	}
