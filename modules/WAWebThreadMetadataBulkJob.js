__d("WAWebThreadMetadataBulkJob", [
	...
	function p(t) {
		return t.length === 0 ? (s || (s = n("Promise"))).resolve([]) : o("WAWebModelStorageUtils").getStorage().lock(["thread-metadata"], (function() {
			var a = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
				...
				}), s = yield a.bulkGet(l), u = 0, c = r("compactMap")(t, function(e, t) {
					var n, r, o = s[t];
	...
	function _(e) {
		var t = e.threadIds;
		return o("WAWebOrchestratorNonPersistedJob").createNonPersistedJob("bulkDeleteThreadsMetadata", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (t.length !== 0) {
	...
	function f(e, t) {
		return o("WAWebOrchestratorNonPersistedJob").createNonPersistedJob("bulkDeleteThreads", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var a = [];
			...
			yield _({ threadIds: i });
			var l = yield (s || (s = n("Promise"))).all(t.map(function(e) {
				return g(e);
			}));
			for (var u of l) a.push.apply(a, u);
			return yield o("WAWebPersistedJobManagerWorkerCompatible").getJobManager().waitUntilPersisted(o("WAWebPersistedJobDefinitions").jobSerializers.deleteAddOns(e.toString(), a)), o("WAWebBackendApi").frontendFireAndForget("deleteModelsForLastAddOnPreview", { messagesIds: a }), a;
		}), { priority: o("WAJobOrchestratorTypes").JOB_PRIORITY.UI_ACTION }).waitUntilCompleted();
	}
	function g(e) {
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = o("WAWebFetchMessagesInThread").beginningOfThread(e), r = o("WAWebFetchMessagesInThread").endOfThread(e), a = yield o("WAWebSchemaMessage").getMessageTable().between(["internalThreadIDs"], t, r, {
				lowerInclusive: !1,
				upperInclusive: !1,
				returnKeyType: "primary_key"
			}), i = [o("WAWebSchemaMessage").getMessageTable().bulkRemove(a)];
			return o("WAWebMessageAssociationGatingUtils").isMessageAssociationInfraEnabled() && i.push(o("WAWebDBDeleteAssociatedMsgsByMsgKey").bulkDeleteMessagesByMsgKeys(a)), yield (s || (s = n("Promise"))).all(i), a;
		}), h.apply(this, arguments);
	}
	l.bulkUpdateThreadUnreadCountWithTable = u, l.bulkUpdateThreadUnreadEditTimestampWithTable = d, l.bulkIncrementThreadUnreadCount = p, l.bulkDeleteThreadsMetadata = _, l.bulkDeleteThreads = f, l.queryAndRemoveThreadMessages = g;
}), 98);
