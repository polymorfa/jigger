__d("WAWebThreadWriteThroughAction", ["WAWebThreadModelResolver", "WAWebThreadMsgUtils"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e, t) {
		var n = t.filter(o("WAWebThreadMsgUtils").isThreadMsg);
		if (n.length !== 0) for (var r of n) {
			var a = r.threadIds;
			if (a != null) for (var i of a) {
