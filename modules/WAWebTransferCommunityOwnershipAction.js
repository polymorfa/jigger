__d("WAWebTransferCommunityOwnershipAction", [
	"fbt",
	...
	function d(e, t, n) {
		...
		var a = new (o("WAWebActionToast.react")).ActionType(s._(
			...
			role_updates: [{
				...
				user_jid: t.id.toString()
			}]
		}, l = ((r = e.groupMetadata) == null ? void 0 : r.isLidAddressingMode) === !0, c = o("WAWebMexTransferCommunityOwnershipJob").mexTransferCommunityOwnershipJob({
			mexInput: i,
			...
			return new (o("WAWebActionToast.react")).ActionType(s._(
				/*BTDS*/
				"",
				[s._param("contact_name", o("WAWebFrontendContactGetters").getFormattedName(t))]
			));
		}, m = c.then(function() {
			return d();
		}).catch(function() {
