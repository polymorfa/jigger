__d("WAWebTriangle.react", ["react", "stylex"], (function(t, n, r, o, a, i, l) {
	"use strict";
	...
	function m(t) {
		var n = t.borderRadius, o = n === void 0 ? "4px" : n, a = t.direction, i = a === void 0 ? "down" : a, l = t.width, s = t.xstyle, m = i === "up" || i === "down" ? {
			width: l + "px",
			height: l / 2 + "px"
		} : {
			height: l + "px",
