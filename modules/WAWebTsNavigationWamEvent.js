__d("WAWebTsNavigationWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ TsNavigation: [
		4334,
		{
			aiSessionId: [39, e.TYPES.STRING],
			canonicalEntLastValidationTsMs: [38, e.TYPES.INTEGER],
			cid: [19, e.TYPES.STRING],
			entryPointConversationInitiated: [23, o("WAWebWamEnumEntryPointConversationInitiated").ENTRY_POINT_CONVERSATION_INITIATED],
			...
			navigationDestinationProductArea: [34, o("WAWebWamEnumProductArea").PRODUCT_AREA],
			...
			networkRadioTypeEventLevel: [40, o("WAWebWamEnumRadioType").RADIO_TYPE],
			networkRadioTypeOpNumber: [42, e.TYPES.INTEGER],
			referrerAction: [31, o("WAWebWamEnumReferrerAction").REFERRER_ACTION],
			...
			typeOfGroup: [6, o("WAWebWamEnumTypeOfGroupEnum").TYPE_OF_GROUP_ENUM],
