__d("WAWebUiActionWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ UiAction: [
		472,
		{
			agentEngagementType: [9, o("WAWebWamEnumAgentEngagementEnumType").AGENT_ENGAGEMENT_ENUM_TYPE],
			...
			localAddressingMode: [10, o("WAWebWamEnumAddressingMode").ADDRESSING_MODE],
			...
			uiActionChatType: [7, o("WAWebWamEnumUiActionChatType").UI_ACTION_CHAT_TYPE],
