__d("WAWebUnformatMsg", [
	...
	var e;
	function s() {
		return e || (e = o("WAWebFormatConfiguration").Unformat({ mentions: {} })), e;
	}
	function u(e, t) {
		var n = t != null ? t : "";
		...
		var i = o("WAWebMsgMentionMap").calculateMsgMentionMap(e), l = o("WAWebMsgMentionMap").calculateMsgGroupMentionMap(e);
		if (!i && !l) return c(n);
