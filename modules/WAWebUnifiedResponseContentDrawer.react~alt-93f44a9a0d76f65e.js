__d("WAWebUnifiedResponseContentDrawer.react", [
	...
	function c(e) {
		var t = e.contentView, n = t.content, a = t.contentType, i = o("WAWebGetUnifiedContentResponseTitle").getUnifiedResponseContentTitle(a);
	...
	c.displayName = c.name + " [from " + i.id + "]", l.WAWebUnifiedResponseContentDrawer = c;
}), 98);
