__d("WAWebUnjoinedSubgroupBridgeApi", [
	"WAWebSchemaUnjoinedSubgroupMetadata",
	"WAWebUnjoinedSubgroupMetadataCollection",
	"WAWebWidFactory"
], (function(t, n, r, o, a, i, l) {
	var e = { restoreUnjoinedSubgroups: async function() {
		var e = await o("WAWebSchemaUnjoinedSubgroupMetadata").getUnjoinedSubgroupMetadataTable().all();
