__d("WAWebUnnamedNewGroupAlreadyExistsModal.react", [
	...
	var e, u = e || (e = o("react"));
	function c(e) {
		var t = o("react-compiler-runtime").c(16), n = e.existingUnnamedGroup, r = e.onCancel, a = e.onCreateNewGroupClick, i = e.onEnd, l = e.ref, c;
		...
		var g;
		t[5] !== n || t[6] !== i ? (g = function() {
			i(), o("WAWebFindChatAction").findOrCreateLatestChat(n, "existingUnnamedGroup").then(d);
		}, t[5] = n, t[6] = i, t[7] = g) : g = t[7];
		var h, y;
		...
		var b;
		return t[11] !== p || t[12] !== r || t[13] !== l || t[14] !== g ? (b = u.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
			tsNavigationData: _,
			ref: l,
			title: f,
			onOK: g,
			...
			extraButtonProps: p,
			children: C
		}), t[11] = p, t[12] = r, t[13] = l, t[14] = g, t[15] = b) : b = t[15], b;
	}
	function d(e) {
		var t = e.chat;
