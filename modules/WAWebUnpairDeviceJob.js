__d("WAWebUnpairDeviceJob", [
	...
	var e = new (r("WADeprecatedWapParser"))("unpairResponse", function(e) {
		...
		var t = e.attrString("type"), n = 200;
		return t === "error" && (n = e.child("error").attrInt("code")), { status: n };
	});
	function s(e) {
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n, r = (n = o("WAWap")).wap("iq", {
				...
				jid: o("WAWebCommsWapMd").DEVICE_JID(o("WAWebUserPrefsMeUser").getMeDevicePnOrThrow_DO_NOT_USE()),
