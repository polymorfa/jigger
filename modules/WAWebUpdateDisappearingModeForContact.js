__d("WAWebUpdateDisappearingModeForContact", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = t.contactId, r = t.newDuration, a = t.newEphemeralityDisabled, i = t.newSettingTimestamp, l = o("WAWebWidFactory").createUserWidOrThrow(n.user, n.server), s = yield o("WAWebApiContact").getContactRecord(l);
			if (s) {
				var u = c(s, r, i, a);
				if (u) {
					var d = u.contactChange, m = u.effectiveDuration, p = u.effectiveSettingTimestamp, _ = u.ephemeralityDisabledInFrontend;
					yield o("WAWebDBUpdateContactTable").updateContactTable(l, d), o("WAWebBackendApi").frontendFireAndForget("updateDisappearingMode", {
