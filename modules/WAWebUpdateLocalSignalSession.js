__d("WAWebUpdateLocalSignalSession", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n, a) {
			...
			t.isStatus() && f && (yield r("WAWebUserPrefsStatus").markForgetStatusSenderKey([f])), t.isBroadcastList() && f && o("WAWebBroadcastSenderKeyManager").markForgetBroadcastSenderKey(o("WAWebWidFactory").createDeviceWidFromWidOrThrow(f), t.toString());
			var h = o("WAWebWidFactory").asUserWidOrThrow(f), y = yield o("WAWebSignal").Session.getRemoteRegId(f);
			...
			var C = t.isUser() && !o("WAWebUserPrefsMeUser").isMeAccount(h), b = yield o("WAWebProcessRetryKeyBundle").processKeyBundle({
				is1on1: C,
				keyBundle: l,
				offline: c,
				remoteRegId: p,
			...
			b || y != null && y !== p && (o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose([
				...
				", received: ",
				""
			])), y, p), yield o("WAWebSignal").Session.deleteRemoteSession(f));
			var v = 2;
