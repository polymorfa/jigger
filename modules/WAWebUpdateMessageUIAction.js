__d("WAWebUpdateMessageUIAction", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = t.chatId, a = t.isOffline, i = a === void 0 ? !1 : a, l = t.messageOverwriteOption, c = l === void 0 ? o("WAWebHandleMsgTypes.flow").MessageOverwriteOption.NO_OVERWRITE : l, d = t.msg, m = t.preserveOrder, p = m === void 0 ? !0 : m, f = {
				add: "after",
				update: c !== o("WAWebHandleMsgTypes.flow").MessageOverwriteOption.NO_OVERWRITE,
				isHistory: !1
			}, g = !i, h = yield o("WAWebHandleForMessageRange").handleForActiveMessageRange(n, d, g);
			if (!h.has(o("WAWebHandleForMessageRangeEnums").ActiveRangeHandlerAction.DropMessage)) {
				...
				try {
					o("WAWebMsgGetters").getIsStatus(d) && o("WAWebStatusCollection").StatusCollection.handleUpdate(d, !1), y || (yield o("WAWebMsgCollection").MsgCollection.processMultipleMessages(n, [babelHelpers.extends({}, d, {
						recvFresh: !0,
						isNewMsg: !0,
						expiredTimestamp: _(d)
					})], f, "updateMessageUIAction", null, p));
				} catch (t) {
