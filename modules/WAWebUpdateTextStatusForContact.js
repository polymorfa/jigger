__d("WAWebUpdateTextStatusForContact", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = t.contactId, r = t.emoji, a = t.ephemeralDuration, i = t.newUpdateTime, l = t.source, u = t.textString, c = o("WAWebWidFactory").createUserWidOrThrow(n.user, n.server), d = yield o("WAWebApiContact").getContactRecord(c);
			if (!d) {
			...
			m && (yield o("WAWebDBUpdateContactTable").updateContactTable(c, babelHelpers.extends({}, m)), o("WAWebBackendApi").frontendFireAndForget("updateTextStatus", babelHelpers.extends({}, m, { contactId: c })));
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (e.length !== 0) {
				for (var t = e.map(function(e) {
				...
				}), n = yield o("WAWebApiContact").bulkGetContactRecord(t.map(function(e) {
					...
					if (u) {
						...
						if (c) {
							...
							a.push(babelHelpers.extends({ id: d }, c)), i.push({
								contactChange: c,
				...
				if (a.length !== 0) {
					yield r("WAWebLidAwareContactsDB").bulkMergeOnly(a, "updateTextStatusForContactsBatch");
					for (var m of i) o("WAWebBackendApi").frontendFireAndForget("updateTextStatus", babelHelpers.extends({}, m.contactChange, { contactId: m.contactId }));
				}
			}
	...
	l.updateTextStatusForContact = u, l.updateTextStatusForContactsBatch = d;
}), 98);
