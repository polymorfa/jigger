__d("WAWebUpdatesTabSearchWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ UpdatesTabSearch: [
		4838,
		{
			...
			updateTabSearchEventType: [4, o("WAWebWamEnumUpdateTabSearchEventType").UPDATE_TAB_SEARCH_EVENT_TYPE],
			updatesTabSearchModeType: [11, o("WAWebWamEnumUpdatesTabSearchModeType").UPDATES_TAB_SEARCH_MODE_TYPE],
			updatesTabSearchResultType: [9, o("WAWebWamEnumUpdatesTabSearchResultType").UPDATES_TAB_SEARCH_RESULT_TYPE],
