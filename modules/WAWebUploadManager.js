__d("WAWebUploadManager", [
	...
	var e = (function() {
		function e() {}
		var t = e.prototype;
		return t.encryptAndUpload = function(t) {
			...
			}), n = o("WAWebABProps").getABPropConfigValue("web_media_encrypt_upload_in_worker_enabled"), a = r(n ? "WAWebUploadManagerWorkerBridge" : "WAWebUploadManagerMainThread");
