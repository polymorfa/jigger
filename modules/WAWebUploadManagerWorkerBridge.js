	...
	var e = (function(e) {
		...
		return a.encryptAndUpload = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = e.blob, r = yield o("WAWebBackendWorkerClient").getBackendWorkerBridge(), a = o("WAWebUploadManagerBase").getNextUploadId();
				if (e.signal.aborted) throw new (o("WAAbortError")).AbortError();
				o("WAWebMainThreadUploadManagerHandler").registerUploadCallbacks(a, t);
				var i = function() {
				...
				try {
					var l = yield r.sendAndReceive("media", "encryptAndUpload", {
						...
						token: e.token,
						uploadId: a,
						serializedUploadQpl: o("WAWebMainThreadQplHandler").serializeQplForBridge(e.uploadQpl)
					});
					if (l.success) return l.value;
					throw o("WAWebDeserializeBridgedError").deserializeBridgedError(l.error);
				} finally {
					e.signal.removeEventListener("abort", i), o("WAWebMainThreadUploadManagerHandler").unregisterUploadCallbacks(a);
				}
			});
			function t(t, n) {
