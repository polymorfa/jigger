__d("WAWebUploadManagerWorkerBridgeHandler", [
	...
	function s(t, a, i) {
		...
		function u() {
			return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (n) {
				var s = n.serializedUploadQpl, u = n.uploadId, d = babelHelpers.objectWithoutPropertiesLoose(n, e), m = new AbortController();
				l.set(u, m);
