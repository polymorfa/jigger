	...
	function s(e, t) {
		...
		return d(t, async function(e) {
			var r = await o("privateStatsUpload").upload_UNSAFE_INTERNAL_DO_NOT_USE([{
				key: t,
				content: n
			}], o("WAWebIssuePrivateStatsToken").getToken), a = r.metrics, i = r.uploadedBufferKeys;
	...
	function d(t, n) {
		return o("WAPromiseLoop").promiseLoop(async function(a, i, l) {
			...
			try {
				...
				return l > 1 ? (o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[wam] sendLogs failure error: ", ""])), String(n)), a(t)) : s;
			}
		});
	}
	l.default = s;
