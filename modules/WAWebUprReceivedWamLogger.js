__d("WAWebUprReceivedWamLogger", [
	...
	"use strict";
	var e, s, u = "receiver_log_key", c = "buyer_order_fs_log", d = "individual", m = "group", p = "broadcast", _ = "newsletter";
	function f(e) {
		...
		return g = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			yield (s || (s = n("Promise"))).all(t.map((function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
					...
					n != null && (yield h(t, n).catch(function(t) {
						o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[WAM:UPR] structured msg receive log err: ", ""])), t);
					}));
				});
				return function(e) {
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = v(e), r = t.paymentOptions.length === 1, a = e.id.id + e.to.toJid(), i = yield C(u, a), l = yield C(i, c), s = {
				flow: "upr",
				is_single_option: r,
				chat_type: n,
				order_funnel_id: i,
	...
	function v(e) {
		var t, n, r;
		return ((t = e.from) == null ? void 0 : t.isGroup()) === !0 ? m : ((n = e.broadcastId) == null ? void 0 : n.isBroadcast()) === !0 ? p : ((r = e.from) == null ? void 0 : r.isNewsletter()) === !0 ? _ : d;
	}
	function S(e) {
		var t;
