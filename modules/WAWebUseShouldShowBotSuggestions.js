__d("WAWebUseShouldShowBotSuggestions", [
	...
	function u(e, t) {
		var n = o("react-compiler-runtime").c(9), a;
		n[0] !== e || n[1] !== t ? (a = o("WAWebThreadModelResolver").resolveThreadOrChat(e, t), n[0] = e, n[1] = t, n[2] = a) : a = n[2];
		var i = a, l;
		n[3] !== i.msgs ? (l = [i.msgs, i.msgs.msgLoadState], n[3] = i.msgs, n[4] = l) : l = n[4];
		var s = l, u;
		n[5] !== e || n[6] !== i ? (u = function() {
			var t = o("WAWebBotBaseGating").isBotEnabled() && e.id.isBot();
			if (!t || o("WAWebBotBaseGating").isMetaAIHomeEnabled() || o("WAWebBotUtils").isMetaAiBot(e.id) && o("WAWebBotFrontendUtils").isMetaAiChatEmpty(i) && i.msgs.msgLoadState.noEarlierMsgs && o("WAWebBotBaseGating").isMetaAiNullStateEnabled()) return !1;
			if (i.msgs.length === 0) return !0;
			if (i.msgs.length === 1) {
				var n, r = (n = i.msgs.last()) == null ? void 0 : n.subtype;
				return r === "bot_init";
			}
			return !1;
		}, n[5] = e, n[6] = i, n[7] = u) : u = n[7];
		var c;
		return n[8] === Symbol.for("react.memo_cache_sentinel") ? (c = [], n[8] = c) : c = n[8], r("useWAWebEventTargetValue")(s, "add remove change:noEarlierMsgs", u, c);
	}
	function c(e, t) {
		var n = o("react-compiler-runtime").c(5), a;
		n[0] !== t || n[1] !== e.msgs ? (a = function() {
		...
		}, n[0] = t, n[1] = e.msgs, n[2] = a) : a = n[2];
		var i;
		return n[3] !== t ? (i = [t], n[3] = t, n[4] = i) : i = n[4], r("useWAWebEventTargetValue")(e.msgs, "add remove", a, i);
	}
	function d(e) {
