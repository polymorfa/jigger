__d("WAWebUserPrefsDebugMsgs", [
	...
	function s(e) {
		r("WAWebUserPrefsStore").set(r("WAWebUserPrefsDebugKeys").DEBUG_SHOWN_MSGS, e);
	}
	function u() {
		var t = {}, n = r("WAWebUserPrefsStore").get(r("WAWebUserPrefsDebugKeys").DEBUG_SHOWN_MSGS);
	...
	l.DEFAULT_VALUES = e, l.setDebugShownMsgs = s, l.getDebugShownMsgs = u;
}), 98);
