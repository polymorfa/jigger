__d("WAWebUserPrefsScreenLockWorkerCompatible", ["nullthrows"], (function(t, n, r, o, a, i, l) {
	var e;
	function s(t) {
		e = t;
	}
	...
	l.setInstance = s, l.getScreenLockEnabled = c, l.getScreenLockIterations = d, l.getScreenLockIvString = m, l.getScreenLockSalt = p, l.setScreenLockIterations = _, l.setScreenLockIvString = f, l.setScreenLockSalt = g;
}), 98);
