__d("WAWebUsernameCreationActionLogger", [
	"WATimeUtils",
	...
	var e = (function() {
		...
		return t.log = function(t) {
			var e = t.errorCode, n = t.usernameCreationActionName, r = t.usernameCreationCurrentScreen, a = t.usernameCreationFlowType, i = t.usernameSource, l = i === void 0 ? o("WAWebWamEnumUsernameSource").USERNAME_SOURCE.USER_INPUT : i, s = new (o("WAWebUsernameCreationActionWamEvent")).UsernameCreationActionWamEvent({
				...
				usernameCreationEntrypoint: o("WAWebWamEnumUsernameCreationEntrypoint").USERNAME_CREATION_ENTRYPOINT.PROFILE_SETTING,
				usernameCreationFlowType: a,
				usernameSource: l
			});
			s.commit();
		}, t.logBackClicked = function(t, n) {
			var e = new (o("WAWebUsernameCreationActionWamEvent")).UsernameCreationActionWamEvent({
				userJourneyEventMs: o("WATimeUtils").unixTimeMs(),
				usernameCreationUsernameSessionId: this.$1,
				usernameCreationCurrentScreen: t,
				usernameCreationActionName: o("WAWebWamEnumUsernameCreationActionName").USERNAME_CREATION_ACTION_NAME.CLICK_BACK_BUTTON,
				usernameCreationErrorCd: 0,
				usernameCreationEntrypoint: o("WAWebWamEnumUsernameCreationEntrypoint").USERNAME_CREATION_ENTRYPOINT.PROFILE_SETTING,
				usernameCreationFlowType: n,
				usernameSource: o("WAWebWamEnumUsernameSource").USERNAME_SOURCE.USER_INPUT
			});
			e.commit();
