__d("WAWebUsernameEditDropdown.react", [
	...
	function p(e) {
		var t = e.contactId, n = e.onBack, r = e.username;
		return c.jsxs(c.Fragment, { children: [c.jsx(_, {
			contactId: t,
			onBack: n,
			username: r,
	...
	function _(t) {
		var n = t.contactId, a = t.dropdownItem, i = t.label, l = t.onBack, s = t.optionId, u = t.username;
		return c.jsx(o("WAWebDropdownItem.react").DropdownItem, {
			testid: s,
			action: function() {
				a === d.CHANGE ? (o("WAWebUsernameCreationActionLogger").UsernameCreationActionLogger.log({
					...
					usernameCreationFlowType: o("WAWebWamEnumUsernameCreationFlowType").USERNAME_CREATION_FLOW_TYPE.MANAGEMENT
				}), o("WAWebModalManager").ModalManager.open(c.jsx(r("WAWebUsernameDeleteModal.react"), { onDeleteUsername: l })));
			},
