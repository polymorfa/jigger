__d("WAWebUsernameKeyInput.react", [
	...
	function m(e) {
		return u.jsx("div", {
			...
			children: u.jsx(p, babelHelpers.extends({}, e))
		});
	}
	m.displayName = m.name + " [from " + i.id + "]";
	function p(t) {
		var n = t.invalidKeyError, a = t.numberOfKeyDigits, i = t.setInvalidKeyError, l = t.setUsernameKeyInput, s = t.usernameKeyInput, m = c([]), p = function(t, r) {
			if (n && i(!1), /^\d?$/.test(r)) {
			...
			if (n.key === o("WAWebKeyboardConstants").KEYBOARD_EVENT_KEY_VALUE.BACKSPACE && !s[t] && t > 0) {
				var e;
