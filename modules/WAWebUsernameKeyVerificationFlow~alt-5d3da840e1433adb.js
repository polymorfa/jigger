__d("WAWebUsernameKeyVerificationFlow", [
	...
	var e, s = e || (e = o("react"));
	async function u(e) {
		var t = e.initWithError, n = e.onInvalidKeyError, r = e.username, a = o("WAWebUsernameUtils").getLIDByUsername(r);
		return a || new Promise(function(e) {
			var a = s.jsx(o("WAWebUsernameKeyVerificationModalLoadable").UsernameKeyVerificationModalLoadable, {
				username: r,
