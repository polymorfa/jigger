__d("WAWebUsernameUtils", [
	...
	function s(e) {
		var t = o("WAWebContactCollection").ContactCollection.findFirst(function(t) {
			return o("WAWebUsernameTypes").serializeMaybeUsername(t.username) === e;
		});
	...
	l.generateUsernameKeySuggestion = e, l.getLIDByUsername = s, l.usernameInputStateIsValid = u;
}), 98);
