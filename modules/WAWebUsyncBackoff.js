__d("WAWebUsyncBackoff", ["Promise", "WALogger"], (function(t, n, r, o, a, i, l) {
	var e, s, u, c = new Map();
	function d(t, r) {
		o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			...
			" protocol: ",
			"ms backoff started"
		])), t, r), c.set(t, new (u || (u = (n("Promise"))))(function(e) {
	...
	function m(e) {
		return p(e) ? (u || (u = n("Promise"))).all(e.protocols.map(function(e) {
	...
	function p(e) {
		...
		return !(t.includes("devices") && (e.context === "message" || e.context === "voip"));
	}
