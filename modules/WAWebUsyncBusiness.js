__d("WAWebUsyncBusiness", [
	...
	function e(e) {
		...
		var n = e.maybeChild("verified_name"), a = n ? r("WAWebCommonParsersVerifiedName")(n) : null, i = e.hasAttr("pn_jid") ? o("WAWebJidToWid").deviceJidToUserWid(e.attrDeviceJid("pn_jid")) : null;
		return {
			pn: i,
			verifiedName: a
		};
	...
	var s = (function() {
		...
		return t.getName = function() {
			...
			return o("WAWap").wap("business", null, o("WAWap").wap("verified_name", null));
