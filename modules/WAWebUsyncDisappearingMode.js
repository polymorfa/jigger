__d("WAWebUsyncDisappearingMode", ["WAWap", "WAWebABProps"], (function(t, n, r, o, a, i, l) {
	function e(e) {
		...
		var n = e.attrInt("duration", 0), r = e.attrInt("t"), a = {
			duration: n,
			t: r
		}, i = e.maybeAttrString("ephemerality_disabled") === "true";
		return i && o("WAWebABProps").getABPropConfigValue("paa_support_for_disabled_epehemerality") && (a.ephemeralityDisabled = !0), a;
	}
	var s = (function() {
		function e() {}
		var t = e.prototype;
