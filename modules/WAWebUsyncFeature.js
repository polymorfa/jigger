__d("WAWebUsyncFeature", ["WAWap", "err"], (function(t, n, r, o, a, i, l) {
	var e, s = {
	...
	var c = (function() {
		function e(e) {
			if (this.queries = e, e.length === 0) throw r("err")("must specify at least one query");
		}
		var t = e.prototype;
		return t.getName = function() {
			return "feature";
		}, t.getQueryElement = function() {
			return o("WAWap").wap("feature", null, this.queries && this.queries.map(function(e) {
				return s[e];
			}));
