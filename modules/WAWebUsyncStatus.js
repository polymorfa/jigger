__d("WAWebUsyncStatus", ["WAWap", "WAWebABProps"], (function(t, n, r, o, a, i, l) {
	var e = null;
	function s(t) {
		t.assertTag("status");
		...
		} : t.hasContent() ? t.contentString().length !== 0 ? t.contentString() : e : t.hasAttr("code") && t.attrInt("code") === 401 ? "" : e;
	}
	var u = (function() {
		function e() {}
		var t = e.prototype;
		return t.getName = function() {
			...
			if (!o("WAWebABProps").getABPropConfigValue("profile_scraping_privacy_token_in_about_usync")) return null;
			var e = t.getTcToken();
