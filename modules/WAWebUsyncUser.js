__d("WAWebUsyncUser", [
	...
	var e, s = (function() {
		...
		return n.withId = function(t) {
			...
			return this.$5 = o("WAWebNonEmptyString").asMaybeNonEmptyString(t), this;
		}, n.withTs = function(t) {
			...
			if (this.$1 == null && this.$4 == null && this.$9 == null && this.$3 == null) throw r("err")("user must have an id, phone, username or pnJid");
			if (this.$1) {
				var t = o("WAWebWidValidator").validateWid(this.$1.toString());
				if (!t) {
					var n;
					o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["USync user created with invalid jid: ", ""])), (n = this.$1) == null ? void 0 : n.toString());
				}
				return t;
			}
			return !0;
