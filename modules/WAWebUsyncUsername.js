__d("WAWebUsyncUsername", ["WAWap"], (function(t, n, r, o, a, i, l) {
	function e(e) {
		...
		} : e.hasContent() ? e.contentString() : null;
	}
	var s = (function() {
		function e() {}
		var t = e.prototype;
		return t.getName = function() {
			...
			var e = t.getUsername();
			return e != null ? o("WAWap").wap("username", { username: o("WAWap").CUSTOM_STRING(e) }) : null;
		}, e;
	})();
