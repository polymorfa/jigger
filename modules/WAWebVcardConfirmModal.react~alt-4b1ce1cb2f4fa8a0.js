__d("WAWebVcardConfirmModal.react", [
	...
	function f(e) {
		var t = e.contact, n = e.options, a = e.setOptions, i = o("WAWebVcardParsingUtils").parseVcard(o("WAWebFrontendVcardUtils").vcardFromContactModel(t).vcard);
		return i ? o("WAWebUsernameGatingUtils").usernameContactUiVcardEnabled() ? c.jsx("div", {
			...
			children: c.jsx(r("WAWebVcardModalDetails.react"), {
				...
				username: o("WAWebUsernameTypes").serializeMaybeUsername(t.username),
	...
	function g(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, e), i = p(null), l = r("useMergeRefs")(n, i), u = a.chat, d = a.contactList, g = a.onBack, h = a.onSend, y = _(function() {
		...
		var v = o("useWAWebChatValues").useChatValues(u.id, [o("WAWebFrontendChatGetters").getKind]), S = v[0], R;
		if (S != null) switch (S) {
		...
		var L = R != null ? c.jsx(o("WAWebEmojiText.react").EmojiText, {
			text: R,
			direction: "auto",
			titlify: !0,
			ellipsify: !0
		}) : null, E = C.some(function(e) {
		...
		return c.jsx(o("WAWebModal.react").Modal, {
			...
			children: c.jsxs(r("WAWebDrawer.react"), {
				...
				children: [
					...
					c.jsx(r("WAWebDrawerBody.react"), { children: c.jsx(o("WAWebKeyboardHotKeys.react").HotKeys, { children: c.jsx("div", {
						className: "x889kno",
