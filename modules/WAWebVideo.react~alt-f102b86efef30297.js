__d("WAWebVideo.react", [
	...
	function S(e) {
		var t = e.ref, n = babelHelpers.objectWithoutPropertiesLoose(e, u), a = n.autoPlay, i = n.controls, l = i === void 0 ? !1 : i, s = n.disableAutoplayManagement, c = n.loop, m = c === void 0 ? !1 : c, _ = n.muted, C = n.onAudioChannelRelease, b = n.onEnded, S = n.onLoadedData, R = n.onLoadedMetadata, L = n.onLoop, E = n.onPlaying, k = n.onStoppedPlaying, I = n.onTimeUpdate, T = n.renderVideoPixelsFit, D = n.src, x = n.srcObject, $ = n.xstyle, P = o("useVideoPlayerXAPIOutsideVideoPlayerSurface").useVideoPlayerXAPIOutsideVideoPlayerSurface(), N = P[0], M = P[1].controller, w = P[2], A = f(function() {
			m || b == null || b();
		}, [m, b]);
		g(function() {
		...
		var F = y(function() {
			return {
				onAudioChannelRelease: C != null ? C : function() {
		...
		h(t, function() {
			return {
				...
				getPaused: function() {
					var e;
					return (e = M == null ? void 0 : M.getCurrentState().paused) != null ? e : !0;
				},
				...
				getVideoDimensions: function() {
					return M == null ? void 0 : M.internal_getVideoPixelsDecodedDimensions();
				},
				...
				drawFrameToContext: function(t) {
					...
					return r.length === 4 ? t.drawImage.apply(t, [e].concat(r)) : t.drawImage.apply(t, [e].concat(r)), !0;
				}
			};
		});
		var O = n.onClick != null ? { onClick: n.onClick } : {}, B = n.width != null || n.height != null ? babelHelpers.extends({}, n.style, {
			width: n.width,
			height: n.height
		}) : n.style;
		return p.jsx("div", babelHelpers.extends({
			className: o("WAWebClassnames").classnamesConvertMeToStylexPlease((d || (d = r("stylex")))(v.video, $), n.className),
			style: B
		}, O, { children: p.jsx(o("WAWebVideoPlayerXLoadable.react").WAWebVideoPlayerXLoadable, {
			apiRef: N,
			src: D,
			mediaStream: x,
			...
			children: p.jsx(o("WAWebVideoPlayerSurfaceLoadable.react").WAWebVideoPlayerSurfaceLoadable, {
				...
				onStoppedPlaying: k,
				onTimeUpdate: I,
				children: l ? p.jsx(o("WAWebVideoPlayerXBasicControlsLoadable.react").WAWebVideoPlayerXBasicControlsLoadable, {}) : null
			})
		}) }));
	}
