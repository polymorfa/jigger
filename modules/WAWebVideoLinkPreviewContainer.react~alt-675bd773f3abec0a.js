__d("WAWebVideoLinkPreviewContainer.react", [
	...
	function m(e) {
		var t = e.msg, n = o("useWAWebMsgValues").useMsgValues(e.msg.id, [
			o("WAWebMsgGetters").getT,
			o("WAWebMsgGetters").getThumbnailHQ,
			o("WAWebFrontendMsgGetters").getAsUrl,
			o("WAWebMsgGetters").getIsSentByMe
		]), a = n[0], i = n[1], l = n[2], u = n[3];
		return d(function() {
			var e = l;
			e && !o("WAWebMediaLinkPreviewUtils").hqLinkPreviewExpired(a) && !e.thumbnailHQ && r("WAWebMediaDownloadMmsThumbnail")({
