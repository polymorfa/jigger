__d("WAWebVideoTranscoderWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ VideoTranscoder: [
		1802,
		{
			...
			sourceFormat: [14, o("WAWebWamEnumVideoTranscoderSourceFormatType").VIDEO_TRANSCODER_SOURCE_FORMAT_TYPE],
			...
			targetFormat: [22, o("WAWebWamEnumVideoTranscoderTargetFormatType").VIDEO_TRANSCODER_TARGET_FORMAT_TYPE],
			...
			transcoderAlgorithm: [1, o("WAWebWamEnumVideoTranscoderAlgorithmType").VIDEO_TRANSCODER_ALGORITHM_TYPE],
			...
			transcoderResult: [2, o("WAWebWamEnumVideoTranscoderResultType").VIDEO_TRANSCODER_RESULT_TYPE],
