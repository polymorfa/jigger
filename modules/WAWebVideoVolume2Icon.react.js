__d("WAWebVideoVolume2Icon.react", [
	...
	var e, s, u = s || (s = o("react")), c = "video-volume-2";
	function d(t) {
		...
		var C;
		n[14] === Symbol.for("react.memo_cache_sentinel") ? (C = u.jsxs("defs", { children: [
			h,
			y,
			u.jsxs("filter", {
				id: "WAWebVideoVolume2Icon__f",
				width: "230.1%",
				height: "130.4%",
				x: "-63.5%",
				y: "-7.7%",
		...
		var b;
		n[15] === Symbol.for("react.memo_cache_sentinel") ? (b = u.jsxs("g", {
			fill: "none",
			fillRule: "evenodd",
			children: [
				u.jsx("use", {
					xlinkHref: "#WAWebVideoVolume2Icon__a",
					fill: "black",
					filter: "url(#WAWebVideoVolume2Icon__b)"
				}),
				u.jsx("use", {
					xlinkHref: "#WAWebVideoVolume2Icon__a",
					fill: "#FFFFFF"
				...
				u.jsx("use", {
					xlinkHref: "#WAWebVideoVolume2Icon__c",
					fill: "black",
					filter: "url(#WAWebVideoVolume2Icon__d)"
				}),
				u.jsx("use", {
					xlinkHref: "#WAWebVideoVolume2Icon__c",
					fill: "#FFFFFF"
				...
				u.jsx("use", {
					xlinkHref: "#WAWebVideoVolume2Icon__e",
					fill: "black",
					filter: "url(#WAWebVideoVolume2Icon__f)"
				}),
				u.jsx("use", {
					xlinkHref: "#WAWebVideoVolume2Icon__e",
					fill: "#FFFFFF",
