__d("WAWebViewCommunityMembersModal.react", [
	...
	function C(e) {
		var t = e.onInviteMembersClick, n = e.parentChat, a = _(function() {
			return o("WAWebCommunityAnnouncementGroupUtils").getCommunityAnnouncementGroup(n.groupMetadata);
		}, [n.groupMetadata]), i = o("useWAWebCommunityMembers").useCommunityMembers(n, a), l = i.announcementGroupParticipants, s = i.loading, u = i.members, c = i.parentGroupParticipants, d = !!(c != null && c.iAmAdmin()), p = r("useWAWebSplitCommunityParticipants")(d, l, u), f = p.members, g = p.membersNotInCAG, h = {
			parentChat: n,
		...
		return m.jsx(r("WAWebCommunityMembersFlow.react"), babelHelpers.extends({
			members: f,
			membersNotInCAG: g
		}, h));
	}
	...
	function b(t) {
		var n = t.ref, a = babelHelpers.objectWithoutPropertiesLoose(t, c), i = a.parentChat, l = a.onInviteMembersClick, d = a.onMembersNotInAnnouncementsClick, p = a.members, _ = a.announcementGroupParticipants, b = a.parentGroupParticipants, v = a.theme, S = v === void 0 ? h.Members : v, R = a.loading, L = a.onBack, E = r("useWAWebAddParticipantsSelectedContacts")(), k = E.handleClearSelectedContacts, I = E.selectedContactsMap, T = E.updateSelectedContactsState, D = f(), x = D[0], $ = D[1], P = !!(b != null && b.iAmAdmin()), N = function(t, n) {
			var e = y({
				parentChat: i,
			...
			var t, n = (t = o("WAWebCommunityAnnouncementGroupUtils").getCommunityAnnouncementGroup(i.groupMetadata)) == null ? void 0 : t.id;
			if (n == null) {
				o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["Community add participants clicked but no CAG found"])));
				return;
			}
			var a = o("WAWebStateUtils").unproxy(o("WAWebChatCollection").ChatCollection.assertGet(n)), s = function() {
		...
		x && (F = m.jsx(o("WAWebUimUie.react").UIE, {
		...
		var O = !!(b != null && b.iAmAdmin()), B, W, q, U, V;
		switch (S) {
			case h.Members: {
				O || (B = s._(
					/*BTDS*/
				...
				q = P ? m.jsx(o("WAWebDrawerButton.react").DrawerButtonSimple, {
				...
				U = P ? m.jsx(o("WAWebDrawerButton.react").DrawerButtonSimple, {
		...
		return W != null || u(0, 72429), m.jsxs("div", {
			ref: n,
			children: [m.jsx(r("WAWebContactsModal.react"), {
				contacts: p != null ? p : [],
				title: W,
				onCancel: L ? void 0 : o("WAWebModalManager").closeModalManager,
				onBack: L,
				participantCollection: r("nullthrows")(b),
	...
	b.displayName = b.name + " [from " + i.id + "]", l.CommunityMembersSearchTheme = h, l.getMemberContextMenuItems = y, l.ViewCommunityMembersModal = C, l.CommunityMembersSearch = b;
}), 226);
