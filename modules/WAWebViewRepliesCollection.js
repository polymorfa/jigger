__d("WAWebViewRepliesCollection", [
	...
	var s = (function(e) {
		...
		var a = t.prototype;
		return a.initializeViewRepliesThreads = (function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					var e = yield o("WAWebThreadMetadataJob").getAllViewRepliesThreadsFromChatId(o("WAWebWidToJid").widToChatJid(this.$ViewRepliesCollection$p_1));
