__d("WAWebViewRepliesContextMenuUtils", ["WAWebThreadMsgUtils", "WAWebThreadsGating"], (function(t, n, r, o, a, i, l) {
	"use strict";
	function e(e, t) {
		if (!o("WAWebThreadsGating").isViewRepliesContextMenuEnabled(t)) return null;
