__d("WAWebVoipAcquireMediaStream", [
	...
	"use strict";
	var e = ["type"], s = ["type"], u = ["type"], c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $, P, N, M, w, A, F, O, B, W, q, U, V, H, G, z, j, K, Q = K || (K = o("react"));
	function X() {
		return o("WAWebABProps").getABPropConfigValue("enable_web_voip_virtual_video_capture_driver") === !0;
	}
	var Y = 200, J = new WeakMap();
	function Z(e) {
		var t = J.get(e);
		if (t != null) return t;
		var r = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var t = Date.now(), n = yield ot(e), r = Date.now() - t;
	...
	var ee = n("$InternalEnum").Mirrored([
		"None",
		"Ideal",
		"Exact"
	]), te = new Set([
	...
	var ie = 1e3, le = 1e4, se = 3e4, ue = 1e4, ce = 1e3, de = 3e4, me = null;
	function pe(e) {
		return me !== e;
	}
	function _e(e) {
	...
	function Ce(e, t) {
		return e !== "prompt" || o("WAWebUA").UA.isSafari ? le : t.isCallLinkPreview ? se : null;
	}
	function be(e) {
	...
	function Se() {
		return Se = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (!ge(e, "unmute start")) {
				var t = yield o("WAWebVoipStackInterface").getVoipStackInterface();
				if (!ge(e, "after stack load") && (t == null ? void 0 : t.type) === "web") {
					var n = yield t.setCallVideoMute(!1);
					o("WALogger").LOG(k || (k = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:acquireCameraStream] camera permission retry setCallVideoMute(false) status: ", ""])), n);
				}
			}
	...
	function Le() {
		return Le = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (!pe(e) && !ge(e, "before permission query")) {
				var t = yield xe(!0), n = t.cameraPermission;
				if (!pe(e) && !ge(e, "after permission query")) {
					if (n === "granted") {
						o("WALogger").LOG(I || (I = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:acquireCameraStream] camera permission granted after timeout; retrying video capture"])));
						try {
							yield ve(e);
						} finally {
							_e(e);
					...
					if (n === "denied" || !e.isCallLinkPreviewRetry && r >= de) {
						_e(e), o("WALogger").LOG(T || (T = babelHelpers.taggedTemplateLiteralLoose([
	...
	function Ee(e) {
		self.setTimeout(function() {
			pe(e) || Re(e).catch(function(e) {
				o("WALogger").ERROR(m || (m = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:acquireCameraStream] camera permission retry poll failed: ", ""])), e).sendLogs("voip-camera-retry-poll-fail");
			});
		}, ce);
	}
	function ke(e) {
		...
		if (!(!o("WAWebUA").UA.isSafari && !e.isCallLinkPreview)) {
			...
			if (r != null) {
				o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:acquireCameraStream] camera permission retry not scheduled: ", ""])), r);
				return;
			}
			me = n, o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose([
				"voip: [AV:acquireCameraStream] camera permission prompt timed out; waiting for grant to retry (callId=",
				", callLinkPreview=",
				", safari=",
				")"
			])), (t = n.scheduledCallId) != null ? t : "none", n.isCallLinkPreviewRetry, String(o("WAWebUA").UA.isSafari)), Ee(n);
		}
	}
	function Ie(e, t, a, i, l) {
		var s = null, u = !1;
		return e.catch(r("WAWebNoop")), (j || (j = n("Promise"))).race([e, new j(function(e) {
			s = self.setTimeout(function() {
				u = !0, s = null, o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose([
					"voip: [AV:",
					"] getUserMedia timed out after ",
					"ms"
				])), i, a), l == null || l(), t(), e(null);
			}, a);
		})]).finally(function() {
	...
	function Me() {
		return Me = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (r("WAWebEnvironment").isWindows && !o("WAWebVoipGatingUtils").isWinHybridPlusEnabled()) return oe.microphone = !0, oe.camera = !0, !0;
			var t = e && !X(), n = yield xe(e);
			try {
				...
				var a = t ? o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.CAMERA_AND_MICROPHONE : o("WAWebMediaCaptureStreamType").WAWebMediaCaptureStreamType.MICROPHONE, i = yield we(a, t);
				return i ? (yield o("WAWebMediaCapture").stop(i), o("WAWebVoipActivityTracker").trackUiActivity(t ? o("WAWebVoipActivityTracker").VoipUiActivity.PERMISSION_REQUEST_CAMERA_AND_MIC_END : o("WAWebVoipActivityTracker").VoipUiActivity.PERMISSION_REQUEST_MIC_END), oe.microphone = !0, t && (oe.camera = !0), !0) : !1;
			} catch (e) {
				if (e instanceof o("WAWebGetUserMediaErrors").NotAllowedError) {
					o("WAWebCoreActionsODS").logCallPermissionDenied();
					var l = Pe(t, n);
					o("WAWebModalManager").ModalManager.open(Q.jsx(o("WAWebGuidePopup.react").GuidePopup, {
						messaging: l,
				...
				} else e instanceof o("WAWebGetUserMediaErrors").GetUserMediaError && o("WAWebModalManager").ModalManager.open(Q.jsx(o("WAWebGuidePopup.react").GuidePopup, {
	...
	function Ae() {
		return Ae = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n = he(t) ? Number.POSITIVE_INFINITY : void 0, r = Be(t);
			try {
				return yield Fe(e, n, r);
			} catch (t) {
				if (r == null || !We(t)) throw t;
				return o("WALogger").LOG(D || (D = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:checkVoipDevicePermissions] selected camera unavailable, retrying permission check with default camera: ", ""])), t), Fe(e, n);
			}
	...
	function Oe() {
		return Oe = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			var r = {
				type: e,
				featureSurface: o("WAWebGuidePopup.react").FeatureSurface.VOIP
			};
			t != null && (r.timeoutLimit = t), n != null && (r.mediaConstraints = n);
			var a = yield o("WAWebMediaCapture").start(r), i = a.asyncStream;
			return i;
	...
	function Ue() {
		return Ue = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			return !navigator.mediaDevices || !navigator.mediaDevices.getUserMedia ? (o("WALogger").ERROR(x || (x = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV] getUserMedia not supported"]))), null) : (function(t) {
	...
	function He() {
		...
		if (Ve == null) {
			...
			o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["voip: [EarlyMicAcquire] Acquiring microphone in gesture (device=", ")"])), (e = t == null ? void 0 : t.slice(0, 8)) != null ? e : "default");
			var n = Ve = qe({
				type: "microphone",
				selectedDeviceId: t != null ? t : void 0,
				suppressErrorPopup: !0
			}).then(function(e) {
				return e != null && o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip: [EarlyMicAcquire] Microphone acquired successfully"]))), e;
			}).catch(function(e) {
				return o("WALogger").WARN(y || (y = babelHelpers.taggedTemplateLiteralLoose(["voip: [EarlyMicAcquire] Microphone acquire failed: ", ""])), e), Ve === n && (Ve = null), null;
			});
		}
	}
	function Ge() {
		if (Ve != null) {
			var e = Ve;
			Ve = null, e.then(function(e) {
				e != null && (o("WAWebMediaCapture").stop(e), o("WALogger").LOG(C || (C = babelHelpers.taggedTemplateLiteralLoose(["voip: [EarlyMicAcquire] Cleaned up unused early-acquired microphone stream"]))));
			}).catch(function(e) {
				o("WALogger").WARN(b || (b = babelHelpers.taggedTemplateLiteralLoose(["voip: [EarlyMicAcquire] Cleanup failed: ", ""])), e);
			});
		}
	}
	function ze(e) {
	...
	function je() {
		return je = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var l = i != null ? o("WAWebVoipPopoutModalManager").VoipPopoutModalManager : o("WAWebModalManager").ModalManager, s = he(!1), u = yield o("WAWebMediaCapture").start({
			...
			if (!s) try {
				var p, _, f = yield (p = navigator.permissions) == null ? void 0 : p.query({ name: "microphone" });
				m = (_ = f == null ? void 0 : f.state) != null ? _ : null;
			} catch (e) {}
			var g = s ? ue : be(m), h = g != null ? Ie(c, d, g, "acquireMicrophoneStream") : c;
			return h.then(function(e) {
				if (e != null) try {
					Ke(e);
				} catch (e) {
					o("WALogger").LOG(P || (P = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:detectBrowserAudioProcessing] failed: ", ""])), String(e));
				}
				return e;
				...
				if (o("WAWebCoreActionsODS").logCallMediaMicError(), a !== !0) {
					var e;
					l.open(Q.jsx((e = o("WAWebGuidePopup.react")).GuidePopup, {
	...
	function Ke(e) {
		...
		if (r != null) {
			...
			ne = {
				supported: n,
				applied: l
			}, o("WAWebVoipBrowserAudioStatus").setBrowserAudioProcessingApplied(l), o("WALogger").LOG(v || (v = babelHelpers.taggedTemplateLiteralLoose([
		...
		}, o("WALogger").LOG(S || (S = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:detectBrowserAudioProcessing] no audio track found in stream"])));
	}
	function Qe(e, t, n) {
		var r;
		t === void 0 && (t = "exact");
		...
		return e != null && t === "exact" ? a.audio = babelHelpers.extends({}, a.audio, { deviceId: { exact: e } }) : e != null && t === "ideal" && (a.audio = babelHelpers.extends({}, a.audio, { deviceId: { ideal: e } })), o("WALogger").LOG(R || (R = babelHelpers.taggedTemplateLiteralLoose([
	...
	function Ye() {
		return Ye = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			return c ? (o("WALogger").LOG(N || (N = babelHelpers.taggedTemplateLiteralLoose([
	...
	function Ze() {
		return Ze = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var l = yield Te();
			if (l === "denied") {
				o("WALogger").LOG(M || (M = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:acquireCameraStream] camera permission denied, skipping camera acquisition"])));
			...
			if (u != null) return u;
			var c = n === !0 ? o("WAWebGuidePopup.react").FeatureSurface.VOIP_VIDEO_UPGRADE : o("WAWebGuidePopup.react").FeatureSurface.VOIP, d = i != null ? o("WAWebVoipPopoutModalManager").VoipPopoutModalManager : o("WAWebModalManager").ModalManager, m = ye(), p = Date.now();
			...
			var _ = yield o("WAWebMediaCapture").start({
				...
				mediaConstraints: r ? [
					...
					et({
						device: {
							deviceId: a,
							constraintType: ee.Ideal
						},
						params: r
					}),
					et({ params: r })
				] : void 0
			}), f = _.asyncStream, g = _.disposeStream, h = Ce(l, m), y = h != null ? Ie(f, g, h, "acquireCameraStream", function() {
				l === "prompt" && ke(m);
			}) : f;
			return y.then(function(e) {
				...
				} else o("WALogger").LOG(F || (F = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:acquireCameraStream] returned null stream after ", "ms"])), t);
				return e;
			}).catch(o("WAFilteredCatch").filteredCatch(o("WAWebGetUserMediaErrors").NotAllowedError, function() {
				o("WAWebCoreActionsODS").logCallMediaCameraError();
				var e = Date.now() - p;
				o("WALogger").LOG(O || (O = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:acquireCameraStream] NotAllowedError after ", "ms"])), e), d.open(Q.jsx(o("WAWebGuidePopup.react").GuidePopup, {
				...
				o("WALogger").LOG(B || (B = babelHelpers.taggedTemplateLiteralLoose([
					...
					"ms: ",
					""
				])), t, e), d.open(Q.jsx(o("WAWebGuidePopup.react").GuidePopup, {
					messaging: o("WAWebGuidePopup.react").Messaging.CAMERA_FAIL,
					type: o("WAWebGuidePopup.react").GuidePopupType.GUIDE_UNBLOCK,
					featureSurface: c,
					onConfirm: function() {
	...
	function et(e) {
		...
		return o("WALogger").LOG(L || (L = babelHelpers.taggedTemplateLiteralLoose([
			...
			", params=",
			""
		])), t == null ? void 0 : t.deviceId, t == null ? void 0 : t.constraintType, n), t && !r("isStringNullOrEmpty")(t.deviceId) && (a.video = t.constraintType === ee.None ? a.video : t.constraintType === ee.Exact ? babelHelpers.extends({}, a.video, { deviceId: { exact: t.deviceId } }) : t.constraintType === ee.Ideal ? babelHelpers.extends({}, a.video, { deviceId: { ideal: t.deviceId } }) : (function() {
	...
	function rt() {
		return rt = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				...
				if (!(d != null && d.enumerateDevices)) return o("WALogger").ERROR(q || (q = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:getAvailableVideoDevices] mediaDevices API not supported"]))), [];
				var m = r === !0 || o("WAWebUA").UA.isSafari && n === !0, p = o("WAWebUA").UA.isFirefox && a != null;
				if (!(c || m)) {
					if (!X()) {
						var _ = p ? { granted: !1 } : yield o("WAWebMediaPermissionsUtils").checkMediaPermissionState("camera", a == null ? void 0 : a.navigator), f = _.granted;
						if (!f) try {
							yield Z(d);
						} catch (e) {
							if (n !== !0) throw e;
				...
				var g = yield o("WAWebAudioDeviceManager").coalescedEnumerateDevices(d), h = g.filter(function(e) {
				...
				return o("WALogger").LOG(U || (U = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:getAvailableVideoDevices] loaded ", "\n      video devices"])), h.length), h;
			} catch (e) {
				return (!(e instanceof Error) || !e.name.includes("NotAllowed")) && o("WALogger").ERROR(V || (V = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:getAvailableVideoDevices] error loading devices: ", ""])), e), [];
			}
	...
	function at() {
		return at = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = o("WAWebUserPrefsVoip").getSelectedVideoInputDevice();
			...
			try {
				...
				if (!We(t)) throw t;
				return o("WALogger").LOG(H || (H = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:getAvailableVideoDevices] selected camera unavailable, falling back to default camera: ", ""])), t), e.getUserMedia({ video: !0 });
			}
	...
	function lt() {
		return lt = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r) {
			var a = yield nt({
				isInActiveCall: n,
			...
			return a.some(function(t) {
				return t.deviceId === e;
			}) ? !0 : (o("WALogger").ERROR(G || (G = babelHelpers.taggedTemplateLiteralLoose(["voip: getIsValidVideoDevice: device not found in available devices: ", ""])), e), !1);
		}), lt.apply(this, arguments);
	}
	var st = 25e3, ut = 250, ct = 500;
	function dt(e) {
		var t = e;
		return t.closed === !0;
	}
	...
	function pt(e, t, n) {
		var a = new AbortController(), i = !1, l = function(n) {
			i || (i = !0, o("WALogger").LOG(E || (E = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:acquireDesktopStream] aborted: ", ""])), n), t(), a.abort());
		}, s = self.setTimeout(function() {
			return l("getDisplayMedia timed out after " + st + "ms");
		}, st), u = n != null ? mt(n, l) : null;
	...
	function ft() {
		return ft = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = e.params, r = e.targetWindow, a = n ? tt(n) : { video: !0 }, i = ((t = o("WAWebABProps").getABPropConfigValue("calling_audio_share_version")) != null ? t : 1) > 0, l = babelHelpers.extends({}, a, {
				audio: i,
				preferCurrentTab: !1,
			...
			try {
				...
				return pt(c, d, r).catch(function(e) {
					if (e instanceof o("WAWebGetUserMediaErrors").NotAllowedError) {
						...
						if (t < ie) {
							...
							n.open(Q.jsx(o("WAWebGuidePopup.react").GuidePopup, {
				...
				if (e instanceof o("WAWebGetUserMediaErrors").NotAllowedError) {
					...
					if (m < ie) {
						...
						p.open(Q.jsx(o("WAWebGuidePopup.react").GuidePopup, {
							messaging: o("WAWebGuidePopup.react").Messaging.SCREEN_SHARE_FAIL,
							type: o("WAWebGuidePopup.react").GuidePopupType.GUIDE_UNBLOCK,
							featureSurface: o("WAWebGuidePopup.react").FeatureSurface.VOIP,
							onConfirm: function() {
	...
	l.getBrowserAudioProcessingStatus = re, l.resetPermissionsCheckedForTest = ae, l.queryCameraPermissionStrict = Te, l.queryPermissionStatus = xe, l.checkVoipDevicePermissions = Ne, l.acquireVoipMediaStream = qe, l.earlyAcquireMic = He, l.cleanupEarlyAcquiredMic = Ge, l.getAvailableVideoDevices = nt, l.getIsValidVideoDevice = it;
}), 98);
