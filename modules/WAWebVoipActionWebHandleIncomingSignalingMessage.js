__d("WAWebVoipActionWebHandleIncomingSignalingMessage", [
	...
	function u(t, n) {
		...
		o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["voip:handleIncomingSignalingMsg: type: \"", "\" msg: "])), a);
		var i = r("WAWebCallCollection").processIncomingCall(t.call_id, t.peer_jid, {
		...
		if (!i) {
			o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["voip:disabled: sig type ", ", call not found"])), t.type);
			return;
		}
		switch (t.type) {
			case o("WAWebVoipSignalingEnums").TYPE.OFFER:
				if (t.t != null && (i.offerTime = t.t), i.isVideo = !!t.isVideoCall, i.setState(o("WAWebVoipWaCallEnums").CallState.ReceivedCall), i.isVoiceChat = t.silence_reason === "vc_init" || t.silence_reason === "vc_wave_all", i.silenceReason = t.silence_reason, t.silence_reason === "vc_wave_all") {
					var l = i.isGroup ? {
						isGroup: !0,
						groupJid: i.groupJid
					} : { isGroup: !1 };
					o("WAWebVoipActionWriteCallLogOfferNotice").generateCallLogOfferNotice(babelHelpers.extends({
			...
			case o("WAWebVoipSignalingEnums").TYPE.TERMINATE: {
				if (o("WAWebVoipCameraPrewarm").cleanupPrewarmedCamera(), i.isVoiceChat) {
					var u;
					t.silence_reason = (u = i.silenceReason) != null ? u : "";
				}
				i.setState(o("WAWebVoipWaCallEnums").CallState.CallStateEnding);
				var c = n.maybeAttrString("reason"), d = c === "group_call_ended", m = d ? {
					isGroup: !0,
					groupJid: i.groupJid
				} : { isGroup: !1 }, p;
				switch (c) {
				...
				p && o("WAWebVoipActionWriteCallLogOfferNotice").generateCallLogOfferNotice(babelHelpers.extends({
