__d("WAWebVoipActionWriteCallLogEventCallEnding", [
	...
	async function d(t) {
		try {
			...
			var L = o("WAWebVoipOngoingCallCollection").WAWebVoipOngoingCallCollection.getByCallId(l), E = i != null ? i : m ? o("WAWebUserPrefsMeUser").getMeDevicePnOrThrow_DO_NOT_USE() : g, k = await o("WAWebCallLogUtils").getCallLogTargetDetails({
				callCreatorWid: E,
				peerWid: g,
				callId: l,
				groupJid: p,
			...
			if (L != null) {
				var $ = babelHelpers.extends({}, L.toJSON(), {
					...
					bytesSent: v,
					bytesReceived: S
				}), P = await o("WAWebVoipActionWriteCallLogImpl").writeVoipCallLogMessageImpl(T, $, !1);
				...
				var N = {
					...
					bytesSent: v,
					bytesReceived: S
				}, M = await o("WAWebVoipActionWriteCallLogImpl").writeVoipCallLogMessageImpl(T, N, !1);
