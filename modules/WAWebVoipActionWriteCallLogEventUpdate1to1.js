__d("WAWebVoipActionWriteCallLogEventUpdate1to1", [
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			try {
				var n = t.CallId, a = t.PeerJid, i = t.Result, l = yield o("WAWebCallLogUtils").getCallLogTargetDetails({
					callId: n,
					peerWid: a,
					groupJid: null,
					callCreatorWid: a
				...
				yield o("WAWebVoipActionWriteCallLogImpl").updateVoipCallLogOutcomeImpl(u, p, s(i));
			} catch (t) {
