__d("WAWebVoipActivityTracker", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f, g, h, y, C = "call-attempt", b = n("$InternalEnum")({
		...
		RECEIVED_INCOMING_VIDEO_GROUP_CALL: "received_incoming_video_group_call",
		RECEIVED_INCOMING_AUDIO_GROUP_CALL: "received_incoming_audio_group_call",
		...
		CONTROL_PANEL_PARTICIPANT_DRAWER_TOGGLE: "control_panel_participant_drawer_toggle",
		...
		PERMISSION_REQUEST_CAMERA_AND_MIC_START: "permission_request_camera_and_mic_start",
		PERMISSION_REQUEST_CAMERA_AND_MIC_END: "permission_request_camera_and_mic_end",
	...
	}), S = null, R = null, L = null, E = null, k = !1, I = null, T = null, D = null, x = null, $ = null, P = null, N = !1, M = !1, w = 0;
	function A() {
		k || (S = null, R = null, L = null, E = null, I = Date.now(), T = null, k = !0, o("WAWebVoipPhaseTracker").notePreCallStart(C), o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[voip:activityTracker] started"]))));
	}
	function F(e, t) {
		if (k) {
			var n = e, r = t != null ? n + ":" + t : n;
			S = r, R = Date.now(), o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[voip:activityTracker] activity=", ""])), S);
		}
	}
	function O(e) {
	...
	function W() {
		if (!k) return null;
		if (T == null) return o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[voip:activityTracker] consumed, no ANR occurred"]))), q(), null;
		var e = L, t = null, n = null;
		return T != null && I != null && (t = Math.floor((T - I) / 1e3)), E != null && I != null && (n = Math.floor((E - I) / 1e3)), o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose([
			"[voip:activityTracker] consumed act=",
			" anrT=",
			"s actT=",
			"s"
		])), e != null ? e : "none", t != null ? t : "none", n != null ? n : "none"), q(), {
			lastVoipActivity: e,
	...
	function q() {
		var e = k;
		S = null, R = null, L = null, E = null, T = null, k = !1, e && o("WAWebVoipPhaseTracker").notePreCallEnd(C), o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["[voip:activityTracker] cleared"])));
	}
	function U() {
		M || (D = null, x = null, $ = null, P = null, N = !1, M = !0, w += 1, o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["[voip:uiActivityTracker] started"]))));
	}
	function V() {
		M && (N || (N = !0, $ = D, P = x, o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["[voip:uiActivityTracker] frozen on first ANR: uiActivity=", ""])), $ != null ? $ : "none")));
	}
	function H(e, t) {
		if (M) {
			var n = e, r = t != null ? n + ":" + t : n;
			D = r, x = Date.now(), w += 1, o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["[voip:uiActivityTracker] uiActivity=", ""])), D);
		}
	}
	function G(e, t) {
		...
		var i = w;
		return function() {
			!M || w !== i || (D = n, x = a, w += 1, o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["[voip:uiActivityTracker] restored uiActivity=", ""])), D != null ? D : "none"));
		};
	}
	function z() {
		if (!M) return null;
		var e = $, t = null;
		return P != null && I != null && (t = Math.floor((P - I) / 1e3)), o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose([
			"[voip:uiActivityTracker] consumed act=",
			" ts=",
			"s"
		])), e != null ? e : "none", t != null ? t : "none"), K(), {
			lastVoipUiActivity: e,
			lastVoipUiActivityTimestampSec: t
		};
	}
	function j() {
		if (!k && !M) return null;
		...
		}, n = L != null ? L : S, r = E != null ? E : R, o = $ != null ? $ : D, a = P != null ? P : x;
		return {
			lastVoipActivity: n,
	...
	function K() {
		D = null, x = null, $ = null, P = null, N = !1, M = !1, w += 1, o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose(["[voip:uiActivityTracker] cleared"])));
	}
	function Q() {
		q(), K(), I = null;
	}
	l.VoipActivity = b, l.VoipUiActivity = v, l.startActivityTracking = A, l.trackActivity = F, l.trackCallStateChange = O, l.recordFirstAnrTimestamp = B, l.consumeActivityData = W, l.clearActivityTracking = q, l.startUiActivityTracking = U, l.trackUiActivity = H, l.trackUiActivityTemporarily = G, l.consumeUiActivityData = z, l.peekVoipActivitySnapshot = j, l.clearUiActivityTracking = K, l.clearAllActivityTracking = Q;
}), 98);
