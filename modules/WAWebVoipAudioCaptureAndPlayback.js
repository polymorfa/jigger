__d("WAWebVoipAudioCaptureAndPlayback", [
	...
	function M() {
		return M = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			return E ? !0 : yield o("WAPromiseDelays").withTimeout(I.promise, e, o("WAWebBoolFunc").returnFalse);
		}), M.apply(this, arguments);
	}
	var w = new (o("WAWebVoipOperationQueue")).WAWebVoipOperationQueue("AudioCapture"), A = new (o("WAWebVoipOperationQueue")).WAWebVoipOperationQueue("AudioPlayback"), F = !1;
	function O() {
	...
	function W() {
		return W = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
	...
	function q() {
		F || (o("WAWebVoipPopoutWindowState").WAWebVoipUiPopoutWindowEventEmitter.on("requestAudioReacquisition", B), F = !0);
	}
	function U() {
	...
	function H() {
		return H = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if (e.device_type !== o("WAWebAudioUtility").AudioCaptureDevType.kInternalAudio) {
				var t = O(), r = t ? R() : S;
				q(), w.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					if (!(t && r !== S)) {
						v == null && (v = new (o("WAWebVoipAudioCaptureBase")).WAWebVoipAudioCaptureBase());
						var n = v, a = o("WAWebVoipAvDriverInitQpl").startVoipAvDriverInitQpl();
						...
						try {
							yield n.initCaptureDriver(e), o("WAWebVoipAvDriverInitQpl").voipAvDriverInitQplAddPoint(a, o("WAWebVoipAvDriverInitQpl").VoipAvDriverInitQplPoint.CAPTURE_DRIVER_INIT_END), o("WAWebVoipAvDriverInitQpl").endVoipAvDriverInitQplSuccess(a);
						} catch (e) {
	...
	function z() {
		return z = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			if ((e == null ? void 0 : e.device_type) !== o("WAWebAudioUtility").AudioCaptureDevType.kInternalAudio) {
				var t = O(), r = S;
				w.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e;
					if (!(t && r !== S)) {
						if (v == null) {
						...
						if (yield v.startCapture(t ? function() {
							return r !== S;
						} : void 0), !(t && r !== S)) {
							var n = (e = L) == null ? void 0 : e.playbackAudioContext;
							if (n != null && n.state === "suspended") try {
	...
	function K() {
		return K = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			(e == null ? void 0 : e.device_type) !== o("WAWebAudioUtility").AudioCaptureDevType.kInternalAudio && (O() && R(), w.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (v == null) {
	...
	function X() {
		return X = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = x();
			A.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (t === k) {
					...
					try {
						yield n.initPlaybackDriver(e), o("WAWebVoipAvDriverInitQpl").voipAvDriverInitQplAddPoint(r, o("WAWebVoipAvDriverInitQpl").VoipAvDriverInitQplPoint.PLAYBACK_DRIVER_INIT_END), o("WAWebVoipAvDriverInitQpl").endVoipAvDriverInitQplSuccess(r);
					} catch (e) {
		...
		return J = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			A.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (t === k) {
					...
					try {
						yield L.startPlayback(e ? function() {
							return t !== k;
						} : void 0), D(!0, t);
					} catch (e) {
						throw D(!1, t), e;
	...
	function ne() {
		return ne = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = O(), t = e ? null : k;
			e && x(), A.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = L;
				if (e == null) {
	...
	function oe() {
		return oe = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, r) {
			var a = new (o("WAResolvable")).Resolvable();
			return w.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					if (v == null) {
						o("WALogger").ERROR(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:switchAudioDevice] capture instance is null."]))), a.resolve(!1);
						return;
					}
					var n = yield v.switchDevice(e, t, r);
					a.resolve(n);
				} catch (e) {
					o("WALogger").ERROR(y || (y = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:switchAudioInputDevice] failed: ", ""])), e).sendLogs("voip: switchAudioInputDevice failed"), a.resolve(!1);
				}
			}), "switchInputDevice"), a.promise;
	...
	function ie() {
		return ie = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			return A.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					if (L == null) {
	...
	l.getPlaybackSampleRate = o("WAWebVoipAudioPlaybackState").getPlaybackSampleRate, l.getEstimatedPlaybackOutputLagSamples = P, l.waitForPlaybackStart = N, l.getCaptureParams = U, l.initCaptureDriverJS = V, l.startCaptureJS = G, l.stopCaptureJS = j, l.initPlaybackDriverJS = Q, l.startPlaybackJS = Y, l.consumeAudioPlaybackMetrics = ee, l.stopPlaybackJS = te, l.switchAudioInputDevice = re, l.switchAudioOutputDevice = ae;
}), 98);
