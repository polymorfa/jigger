__d("WAWebVoipAudioCaptureSharedBufferWorklet", [
	...
	var E = (function() {
		...
		var t = e.prototype;
		return t.startAudioCapture = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var n = this, a = t.audioContext, i = t.framesPerChunk, l = t.isStartCancelled, s = t.mediaStreamSource;
				if (!l()) {
					var u = ++e.$1, c = !1;
					try {
						...
						this.ringBufferPtr = yield o("WAWebAudioUtility").mallocWasmBuffer(f), R(l);
						...
						this.audioWorkletNode = y, y.port.onmessage = function(e) {
							var t = e.data;
							if (!(typeof t != "object" || t == null)) if (t.type === "ready") {
								var r;
								n.isProcessorReady = !0, (r = n.processorReadyResolvable) == null || r.resolve(), n.processorReadyResolvable = null;
							} else C(t, "Capture");
						}, yield this.waitForProcessorReady(), R(l);
						...
						if (L(e, l) || (o("WALogger").ERROR(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Capture] Failed to start capture: ", ""])), e), c = !0, yield this.stopAudioCapture(u), l())) return;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				if (this.workletPreloadPromise != null && (yield this.workletPreloadPromise, R(t)), !this.isWorkletPreloaded) {
					var n = r("WAWebVoipSharedBufferCaptureProcessorConfig").module_url;
					if (n === "") throw r("err")("voip: [AV:SharedBuffer:Capture] Missing worklet module url");
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				try {
					var n = t != null ? t : this.$3, r = n == null ? e.$2 == null : e.$2 === n, a = o("WAWebAudioUtility").getCachedWasmModule();
					if (r && a != null) try {
						a.isAudioReaderThreadRunning() && a.stopAudioReaderThread(), e.$2 === n && (e.$2 = null), this.$3 === n && (this.$3 = null);
					} catch (e) {
