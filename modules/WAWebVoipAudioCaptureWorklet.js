	...
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v = (function() {
		...
		return a.startAudioCapture = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this, n = e.audioBuffer, a = e.audioContext, i = e.channels, l = e.framesPerChunk, s = e.mediaStreamSource, u = e.sampleRate;
				...
				try {
					if (this.workletPreloadPromise != null && (yield this.workletPreloadPromise), !this.isWorkletPreloaded) {
						...
						yield a.audioWorklet.addModule(f), o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:Worklet:Capture] worklet processor module loaded"])));
					}
					...
					g != null && (g.port.onmessage = function(e) {
						var n = e.data;
						if (!(typeof n != "object" || n == null)) {
							var r = n, a = r.type;
							if (a === "ready") t.isProcessorReady = !0, o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:Worklet:Capture] processor ready"])));
							else if (a === "audioData") {
								var i = r.audioData, l = r.sampleRate;
								i instanceof Float32Array && typeof l == "number" && t.handleAudioData(i, l);
							}
						}
					}), yield this.waitForProcessorReady(), this.audioWorkletNode != null && s.connect(this.audioWorkletNode), this.audioWorkletNode != null && this.audioWorkletNode.port.postMessage({ type: "start" }), o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:Worklet:Capture] capture started +"])));
				} catch (e) {
