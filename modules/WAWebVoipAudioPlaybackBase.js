__d("WAWebVoipAudioPlaybackBase", [
	...
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D = n("$InternalEnum").Mirrored([
		...
		var a = t.prototype;
		return a.initPlaybackDriver = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this, a = e.bits_per_sample, i = e.channels, l = e.frames_per_chunk, p = e.sample_rate;
				if (this.audioPlaybackInitState !== D.Uninitialized) {
					o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:initPlaybackDriver] invalid initialization. state = ", ""])), this.audioPlaybackInitState).sendLogs("voip: invalid playback initialization. state = ${this.audioPlaybackInitState}"), yield this.cleanup();
					return;
				}
				...
				try {
					...
					}), o("WAWebVoipPerfOptimizations").isPerfOptimizationEnabled(o("WAWebVoipPerfOptimizations").PerfOptimizationFlag.WORKLET_PRELOAD) && ((f = this.implementation) == null ? void 0 : f.preloadWorkletModule) != null && this.playbackAudioContext != null && this.playbackAudioContext.state !== "suspended" && this.implementation.preloadWorkletModule(this.playbackAudioContext);
					var h = (function() {
						var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
							try {
								var e = o("WAWebAudioDeviceManager").getCurrentSelectedAudioOutputDevice(), n = yield o("WAWebAudioDeviceManager").selectAudioOutputDevice();
								n != null && n !== e ? (o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:AudioOutputHandleDeviceChange] Auto-switching output to device: ", ""])), n), yield t.switchOutputDevice(n, !0)) : n == null && o("WALogger").WARN(c || (c = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:AudioOutputHandleDeviceChange] Output device change detected but new deviceId is null"])));
							} catch (e) {
					...
					this.deviceChangeHandler = r("WAWebDebounce")(h, 500), navigator.mediaDevices && navigator.mediaDevices.addEventListener("devicechange", this.deviceChangeHandler), this.audioPlaybackInitState = D.Ready, (g = this.audioPlaybackInitResolvable) == null || g.resolve();
				} catch (e) {
					var y;
					o("WALogger").ERROR(m || (m = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:initPlaybackDriver] error: ", ""])), e), this.audioPlaybackInitState = D.Error, (y = this.audioPlaybackInitResolvable) == null || y.reject(e), yield this.cleanup();
				}
			});
			function t(t) {
				return e.apply(this, arguments);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				try {
					var t;
					return yield (t = this.audioPlaybackInitResolvable) == null ? void 0 : t.promise, !e();
				} catch (t) {
					return e() || o("WALogger").ERROR(g || (g = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:startPlayback] error: ", ""])), t).sendLogs("voip: startPlayback error: ${error}"), !1;
				}
			});
			function t(t) {
				return e.apply(this, arguments);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				try {
					if (e.state === "suspended") {
						if (o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:startPlayback] resuming suspended AudioContext"]))), yield e.resume(), n()) return;
						o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:startPlayback] AudioContext resumed successfully"])));
					}
					var r = t.framesPerChunk * 4, a = yield o("WAWebAudioUtility").mallocWasmBuffer(r);
					if (this.playbackBuffer = a, n()) {
						yield this.$3(a);
						return;
					}
					if (this.implementation != null && (yield this.implementation.startAudioPlayback({
						audioContext: e,
					...
					if (n()) return;
					if (o("WALogger").ERROR(C || (C = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:startPlayback] failed to start audio playback: ", ""])), t), e.state !== "suspended") throw t;
				}
			});
			function t(t, n, r) {
				return e.apply(this, arguments);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					...
					this.implementation != null && (yield this.implementation.stopAudioPlayback()), this.playbackAudioContext && (this.playbackAudioContext.state !== "closed" && this.playbackAudioContext.close().then(function() {}).catch(function(e) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				if (o("WALogger").LOG(L || (L = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:switchOutputDevice] switchOutputDevice called with deviceId: ", ""])), e), this.audioPlaybackInitState !== D.Ready) return o("WALogger").WARN(E || (E = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:switchOutputDevice] playback not ready", ""])), t === !0 ? "" : ", saving preference"), t !== !0 && o("WAWebAudioDeviceManager").saveAudioOutputDevicePreference(e, "AV:switchOutputDevice"), !1;
				var n = this.implementation;
				if (n == null) return o("WALogger").WARN(k || (k = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:switchOutputDevice] playback implementation not initialized", ""])), t === !0 ? "" : ", saving preference"), t !== !0 && o("WAWebAudioDeviceManager").saveAudioOutputDevicePreference(e, "AV:switchOutputDevice"), !1;
				var r = n.switchOutputDevice != null ? yield n.switchOutputDevice(e, t) : yield o("WAWebAudioDeviceManager").switchAudioOutputDeviceInternal(e, n.getAudioElement(), t);
				return r ? o("WALogger").LOG(I || (I = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:switchOutputDevice] Successfully switched output to device: ", ""])), e) : o("WALogger").ERROR(T || (T = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:switchOutputDevice] Failed to switch output to device: ", ""])), e), r;
			});
			function t(t, n) {
				return e.apply(this, arguments);
			}
