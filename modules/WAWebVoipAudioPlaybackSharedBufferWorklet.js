	...
	var q = (function() {
		function t() {
			...
			this.audioWorkletNode = null, this.playbackAudioContext = null, this.playbackAudioElement = null, this.playbackMediaStreamDestination = null, this.playbackOutputSink = null, this.playbackOutputRoute = "none", this.playbackSampleRate = 0, this.ringBufferPtr = null, this.hasLoggedOutputLagEstimationFailure = !1, this.isProcessorReady = !1, this.processorReadyResolvable = null, this.workletPreloadPromise = null, this.isWorkletPreloaded = !1, this.$3 = 0, this.$4 = 0, this.$5 = 0, this.$6 = 0, this.$7 = 0, this.$8 = 0, this.$9 = 0, this.$10 = null, this.preloadWorkletModule = function(n) {
				...
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, n) {
					var r = t.playbackOutputRoute, a = t.playbackOutputSink, i = F(r), l = yield o("WAWebAudioDeviceManager").switchAudioOutputSinkIdInternal(e, a, i, n);
		...
		return a.$11 = function(t) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var n = this, a = e.audioContext, i = e.channels, l = e.framesPerChunk, s = e.isStartCancelled, u = e.sampleRate;
				if (!s()) {
					var c = ++t.$1;
					...
					try {
						...
						this.ringBufferPtr = yield o("WAWebAudioUtility").mallocWasmBuffer(y), M(s);
						...
						this.audioWorkletNode = v, v.port.onmessage = function(e) {
							var t = e.data;
							if (!(typeof t != "object" || t == null)) {
								var r = t.type;
								if (r === "ready") {
									var o;
									n.isProcessorReady = !0, (o = n.processorReadyResolvable) == null || o.resolve(), n.processorReadyResolvable = null;
								} else r === "sharedBufferReady" || r === "diagnostics" && n.$11(t);
							}
						}, o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Playback] waiting for processor ready"]))), yield this.waitForProcessorReady(), M(s);
						...
						v.port.postMessage({
							...
							heapBufferOffset: C,
							bufferSize: h
						}), yield this.connectOutputRoute(a, s), M(s), o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Playback] starting writer thread"])));
						...
						yield this.waitForStartupPrebufferIfNeeded(E, h, l, s), M(s), yield this.$13(v, s), M(s), o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Playback] Audio playback started successfully"])));
					} catch (e) {
						if (w(e, s) || (o("WALogger").ERROR(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Playback] Failed to start playback: ", ""])), e), f = !0, yield this.stopAudioPlayback(c), s())) return;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				if (this.workletPreloadPromise != null && (o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Playback] awaiting worklet preload"]))), yield this.workletPreloadPromise, M(t)), !this.isWorkletPreloaded) {
					o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Playback] loading worklet module (contextState=", ")"])), e.state);
					var n = r("WAWebVoipSharedBufferPlaybackProcessorConfig").module_url;
					if (n === "") throw r("err")("voip: [AV:SharedBuffer:Playback] Missing worklet module url");
					yield e.audioWorklet.addModule(n), M(t), o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Playback] Worklet processor module loaded"])));
				}
			});
			function t(t, n) {
				return e.apply(this, arguments);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				if (!this.isProcessorReady) {
					...
					try {
						var a;
						yield (a = this.processorReadyResolvable) == null ? void 0 : a.promise;
					} finally {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				var n = A(e), r = this.audioWorkletNode;
				if (n != null && r != null) {
					var a = yield o("WAWebAudioDeviceManager").applyPreferredAudioOutputSink(n, "AV:SharedBuffer:Playback:AudioContext");
					if (t()) return;
					r.connect(e.destination), this.playbackOutputSink = n, this.playbackOutputRoute = "direct_audio_context", o("WALogger").LOG(C || (C = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:SharedBuffer:Playback] connected worklet directly to AudioContext.destination, setSinkIdApplied=", ""])), String(a));
					return;
				}
				this.playbackMediaStreamDestination = e.createMediaStreamDestination(), this.audioWorkletNode != null && this.audioWorkletNode.connect(this.playbackMediaStreamDestination), this.playbackAudioElement = new Audio(), this.playbackMediaStreamDestination != null && (this.playbackAudioElement.srcObject = this.playbackMediaStreamDestination.stream);
				var i = this.playbackAudioElement;
				if (i != null) {
					if (yield o("WAWebAudioDeviceManager").applyPreferredAudioOutputSink(i, "AV:SharedBuffer:Playback:AudioElement"), t()) return;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r) {
				for (var a = O(t, n), i = self.performance.now(), l = 0;;) {
					if (r()) return;
					var s = Atomics.load(e, 0), u = Atomics.load(e, 1);
				...
				o("WALogger").LOG(S || (S = babelHelpers.taggedTemplateLiteralLoose([
					...
					" samples, elapsed=",
					"ms"
				])), l >= a ? "target_reached" : "timeout", l, a, Math.round(m));
			});
			function t(t, n, r, o) {
				return e.apply(this, arguments);
			}
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				try {
					var n = e != null ? e : this.$10, r = n == null ? t.$2 == null : t.$2 === n, a = o("WAWebAudioUtility").getCachedWasmModule();
					if (r && a != null) try {
						a.isAudioWriterThreadRunning() && a.stopAudioWriterThread(), t.$2 === n && (t.$2 = null), this.$10 === n && (this.$10 = null);
					} catch (e) {
