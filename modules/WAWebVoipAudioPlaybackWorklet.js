	...
	var e, s, u, c, d, m, p, _ = (function() {
		...
		return a.startAudioPlayback = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this, n = e.audioContext, a = e.channels, i = e.framesPerChunk, l = e.playbackBuffer, s = e.sampleRate;
				...
				try {
					...
					p != null && (p.port.onmessage = function(e) {
						var n = e.data;
						if (!(typeof n != "object" || n == null)) {
							var r = n, a = r.type;
							if (a === "ready") {
								var i;
								t.isProcessorReady = !0, (i = t.processorReadyResolvable) == null || i.resolve(), t.processorReadyResolvable = null;
							} else if (a === "requestPlaybackData") t.sendAudioChunk();
							else if (a === "underrun") {
								var l = r.count;
					...
					}), this.playbackAudioElement != null && (yield o("WAWebAudioDeviceManager").applyPreferredAudioOutputSink(this.playbackAudioElement, "AV:Worklet:Playback")), this.audioWorkletNode != null && this.audioWorkletNode.port.postMessage({ type: "start" });
				} catch (e) {
