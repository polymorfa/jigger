	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				...
				var l = yield o("WAWebVoipBackendCallLogTargetResolverWorker").getCallLogTargetDetailsWorker({
				...
				var c = l.callCreatorUserWid, d = l.chatId, m = l.fromMe, p = l.msgKeyId, _ = l.participant, f = (a = i.groupJid) != null ? a : d, g = new (r("WAWebMsgKey"))({
					...
					id: p,
					participant: _
				}), h = yield o("WAWebSchemaMessage").getMessageTable().get(String(g), !1);
				if (h != null) {
				...
				o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[voip:sw] writing offline placeholder for callId=", ""])), i.callId), yield o("WAWebDBProcessMessage").storeMessages([y], f);
			} catch (e) {
