__d("WAWebVoipBridgeActivityHandlers", [
	...
	var e = {
		startAnrTracking: function() {
			o("WAWebVoipCrashContext").ensureVoipCrashContextRegistered(), o("WAWebVoipAnrTracker").startAnrTracking();
		},
		...
		consumeOutgoingCallSetupActiveMs: function(t) {
			var e = t.callId;
			return o("WAWebVoipOutgoingSetupLatencyStore").consumeOutgoingCallSetupActiveMsForCall(e);
		}
	};
