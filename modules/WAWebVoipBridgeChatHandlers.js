	...
	var e, s, u, c, d = {
		getTcToken: (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var n = t.wid;
				if (!n.isUser()) return o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["voip: getTcToken: wid is not a user wid, wid domain: ", ""])), n.server), { tcToken: null };
				try {
					var r = o("WAWebWidFactory").asUserWidOrThrow(n), a = yield o("WAWebCallLogUtils").get1x1CallLidOrPnDestination({ callDestinationWid: r }), i = o("WAWebChatCollection").ChatCollection.get(a);
					return i == null && o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["voip: getTcToken: chat not found, chat domain: ", ""])), n.server), { tcToken: i == null ? void 0 : i.tcToken };
				} catch (e) {
