__d("WAWebVoipBrowserMetrics", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			u.isActive() && (c = _(), yield u.stop(), o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[voip:browserMetrics] stopped"]))));
		}), p.apply(this, arguments);
	}
	function _() {
		if (!u.isActive()) return c;
		u.sampleMemory();
		var t = u.finalizePressurePcts(), n = u.finalizeMemoryStats(), r = u.getCapabilities();
		return o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			...
			"MB peak=",
			"MB"
		])), String(t.nominalPct), String(t.fairPct), String(t.seriousPct), String(t.criticalPct), String(n.avgUsedMb), String(n.peakUsedMb)), {
	...
	l.startBrowserMetrics = d, l.stopBrowserMetrics = m, l.snapshotBrowserMetrics = _, l.resetBrowserMetrics = f, l.getBrowserMetricsCapabilities = g;
}), 98);
