__d("WAWebVoipCallControls.story", [
	...
	function f(e) {
		e === void 0 && (e = "granted"), d(function() {
			var t = "permissions", r = navigator[t];
			if (!(r == null || typeof r.query != "function")) {
				var o = r.query.bind(r);
				return r.query = (function() {
					var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
						return t.name === "microphone" || t.name === "camera" ? _(e) : o(t);
					});
					return function(e) {
