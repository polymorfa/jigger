__d("WAWebVoipCallControls.story", [
	...
	function f(e) {
		var t = o("react-compiler-runtime").c(3), n = e === void 0 ? "granted" : e, r, a;
		t[0] !== n ? (r = function() {
			var e = navigator.permissions;
			if (!(e == null || typeof e.query != "function")) {
				var t = e.query.bind(e);
				return e.query = async function(e) {
					return e.name === "microphone" || e.name === "camera" ? _(n) : t(e);
				}, (function() {
					e.query = t;
				});
			}
		}, a = [n], t[0] = n, t[1] = r, t[2] = a) : (r = t[1], a = t[2]), d(r, a);
	}
	var g = {
