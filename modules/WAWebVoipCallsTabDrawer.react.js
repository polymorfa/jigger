__d("WAWebVoipCallsTabDrawer.react", [
	...
	function p(e) {
		var t = o("react-compiler-runtime").c(19), n = e.onBack, a = e.onClickNewCall, i = e.ref, l = d(), u;
		...
		var g = f, h;
		t[2] === Symbol.for("react.memo_cache_sentinel") ? (h = o("WAWebABProps").getABPropConfigValue("calls_tab_username_global_search_enabled"), t[2] = h) : h = t[2];
		var y = h, C;
		t[3] === Symbol.for("react.memo_cache_sentinel") ? (C = c.jsx(r("WAWebDrawerSection.react"), {
			theme: "full-height",
			animation: !1,
			xstyle: m.container,
		...
		var b = C, v;
		t[4] === Symbol.for("react.memo_cache_sentinel") ? (v = c.jsx(o("WAWebMenuBar.react").MenuBarItem, {
		...
		var S = v, R = !o("useWAWebABPropConfigValue").useABPropConfigValue("web_calls_tab_empty_state_buttons"), L;
		t[5] === Symbol.for("react.memo_cache_sentinel") ? (L = s._(
			/*BTDS*/
			""
		), t[5] = L) : L = t[5];
		var E;
		t[6] !== a ? (E = c.jsx(r("WDSMenuBarItem.react"), {
			icon: r("WDSIconIcAddCall.react"),
			title: L,
			onClick: a,
			tabOrder: o("WAWebTabOrder").TAB_ORDER.CHATLIST_HEADER
		}), t[6] = a, t[7] = E) : E = t[7];
		var k = E, I = R ? S : null, T;
		t[8] !== k || t[9] !== I ? (T = [I, k].filter(Boolean), t[8] = k, t[9] = I, t[10] = T) : T = t[10];
		var D = T, x;
		t[11] === Symbol.for("react.memo_cache_sentinel") ? (x = { surface: "status" }, t[11] = x) : x = t[11];
		var $;
		t[12] !== D || t[13] !== n ? ($ = c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			title: p,
			type: o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.TAB,
			onBack: n,
			menu: D
		}), t[12] = D, t[13] = n, t[14] = $) : $ = t[14];
		var P;
		t[15] === Symbol.for("react.memo_cache_sentinel") ? (P = c.jsx(r("WAWebDrawerBody.react"), { children: b }), t[15] = P) : P = t[15];
		var N;
		return t[16] !== i || t[17] !== $ ? (N = c.jsx(o("WAWebKeyboardHotKeys.react").HotKeys, {
			ref: l,
			"aria-label": g,
