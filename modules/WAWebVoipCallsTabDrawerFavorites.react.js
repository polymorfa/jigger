__d("WAWebVoipCallsTabDrawerFavorites.react", [
	"fbt",
	...
	function f(e) {
		"use no forget";
		var t = e.onBack, n = e.ref, a = m(), i = p(!1), l = i[0], c = i[1], f = d(function() {
			return new (r("WAWebSingleSelection"))([], function() {
				return "";
			});
		}, []), g = o("useWAWebForceUpdate").useForceUpdateDONOTUSE(), h = r("useWAWebDebouncedCallback")(g, 300, { maxWait: 500 });
		o("useWAWebListener").useListener(o("WAWebFavoriteCollection").FavoriteCollection, "add remove change", h), o("useWAWebListener").useListener(o("WAWebChatCollection").ChatCollection, "add remove", h);
		var y = l ? u.jsx(o("WAWebText.react").WAWebTextTitle, {
			weight: "semibold",
			children: s._(
				/*BTDS*/
				""
			...
			/*BTDS*/
			""
		), b = o("WAWebFavoritesUtils").getFavoriteItems(), v = function() {
			c(!l);
		}, S = function(t) {
			t.chat != null ? o("WAWebCmd").Cmd.favoriteChat(t.chat, !1, o("WAWebWamEnumFavoritesUpdateEntryPoint").FAVORITES_UPDATE_ENTRY_POINT.CALLING_TAB_FAVORITE_EDIT) : o("WAWebRemoveFromFavoritesAction").removeFromFavoritesAction(t.wid, { entryPoint: o("WAWebWamEnumFavoritesUpdateEntryPoint").FAVORITES_UPDATE_ENTRY_POINT.CALLING_TAB_FAVORITE_EDIT }).catch(r("WAWebNoop"));
		}, R = function() {
			...
			onClick: v
		}, "edit-favorites"), u.jsx(r("WDSMenuBarItem.react"), {
			...
			onClick: R
		}, "add-favorites")], E = b.length > 0 ? u.jsx(o("WAWebFlex.react").FlexColumn, {
			...
			children: b.map(function(e) {
				return u.jsx(o("WAWebFlex.react").FlexItem, {
					...
					children: l ? u.jsxs(o("WAWebFlex.react").FlexRow, {
						align: "center",
			...
			children: [
				u.jsx(o("WAWebFlex.react").FlexItem, { children: u.jsx(o("WAWebWdsIllFavoritesIcon.react").WdsIllFavoritesIcon, { width: 180 }) }),
				...
				u.jsx(o("WAWebFlex.react").FlexItem, { children: u.jsx(r("WDSButton.react"), {
					size: "medium",
					variant: "outline",
					tabOrder: o("WAWebTabOrder").TAB_ORDER.DRAWER_CONTENT,
					onPress: R,
