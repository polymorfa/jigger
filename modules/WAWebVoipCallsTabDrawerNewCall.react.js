__d("WAWebVoipCallsTabDrawerNewCall.react", [
	...
	function m(e) {
		var t = e.onBack, a = e.ref, i = o("useWAWebABPropConfigValue").useABPropConfigValue("group_call_max_participants") - 1, l = c([]), m = l[0], p = l[1], _ = u.jsxs(o("WAWebFlex.react").FlexRow, {
			wrap: "wrap",
			justify: "center",
			xstyle: d.buttonRow,
				...
				children: [u.jsx(r("WAWebFlexItem.react"), { children: u.jsx(r("WDSButton.react"), {
					...
					onPress: function() {
						n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
							yield o("WAWebVoipStartCall").startWAWebVoipGroupCallFromContacts(m, !1, o("WAWebWamEnumCallFromUi").CALL_FROM_UI.CALLS_TAB_NEW_CALL, o("WAWebWamEnumLobbyEntryPointType").LOBBY_ENTRY_POINT_TYPE.NOT_OPENED), t == null || t();
						})();
					}
					...
					onPress: function() {
						n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
							yield o("WAWebVoipStartCall").startWAWebVoipGroupCallFromContacts(m, !0, o("WAWebWamEnumCallFromUi").CALL_FROM_UI.CALLS_TAB_NEW_CALL, o("WAWebWamEnumLobbyEntryPointType").LOBBY_ENTRY_POINT_TYPE.NOT_OPENED), t == null || t();
						})();
					}
				}) })]
			})]
