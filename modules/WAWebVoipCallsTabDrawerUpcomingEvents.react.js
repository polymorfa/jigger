__d("WAWebVoipCallsTabDrawerUpcomingEvents.react", [
	...
	function f(e) {
		"use no forget";
		var t = e.onBack, a = e.ref, i = m(), l = m(new (o("WAWebPreCallUserJourneyLogger")).PreCallUserJourneyLogger()), c = new (r("WAWebSingleSelection"))([], function() {
			return "";
		}), f = p([]), g = f[0], h = f[1], y = r("useWAWebStableCallback")(function() {
			(function() {
		...
		o("useWAWebListener").useListener(o("WAWebMsgCollection").MsgCollection, "add remove", C), o("useWAWebListener").useListener(o("WAWebEventResponseCollection").EventResponseCollection, "add remove change", C);
		...
		d(function() {
			l.current.clickEventMore(o("WAWebWamEnumSubSurface").SUB_SURFACE.NONE), (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					try {
						var e = yield o("WAWebEventUtils").getUpcomingEvents();
						h(e);
		...
		var S = function(t) {
			l.current.clickEventMoreDetail(o("WAWebWamEnumSubSurface").SUB_SURFACE.NONE);
			...
			var n = E.indexOf(e), r = E.indexOf(t);
			if (n !== -1 && r !== -1) return n - r;
			if (n !== -1) return -1;
			if (r !== -1) return 1;
			var o = new Date(e).getTime(), a = new Date(t).getTime();
			return o - a;
		}), I = g.length > 0 ? u.jsx(o("WAWebFlex.react").FlexColumn, {
