__d("WAWebVoipCameraDeviceSelector.react", [
	...
	function F() {
		var e = $(null), t = e[0], o = e[1], a = r("useWAWebStableCallback")(o);
		return r("useWAWebAsync")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (!(navigator === void 0 || !navigator.permissions || t != null)) {
				var e = function() {
					a(null);
				}, n = yield navigator.permissions.query({ name: "camera" });
				return a(n.state), n.onchange = e, function() {
					n.onchange = null;
				};
			}
		}), [t]), t;
