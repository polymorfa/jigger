__d("WAWebVoipCameraUnavailableBanner.react", [
	...
	function d(e) {
		var t = e.noCameraDevice, n = t === void 0 ? !1 : t, a = o("WAWebUA").UA.browser, i = u.jsx("div", {
		...
		}), d = a === "edge" ? l : a === "chrome" ? i : a === "opera" ? l : a === "firefox" ? i : null, m = function() {
			return n ? s._(
				/*BTDS*/
				""
			) : s._(
			...
			return n ? r("WAWebEnvironment").isWindows ? s._(
				/*BTDS*/
				""
			) : s._(
				/*BTDS*/
				...
				/*BTDS*/
				"",
				[s._param("browser_permissions_icon", d), s._implicitParam("=m5", u.jsx(r("WDSText.react"), {
