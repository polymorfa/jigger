__d("WAWebVoipDebugInfoOverlay.react", [
	...
	function _() {
		var e = m(o("WAWebDebugVoipInfo").isVoipDebugInfoEnabled), t = e[0], a = e[1], i = m("none"), l = i[0], u = i[1], _ = m(""), f = _[0], g = _[1];
		d(function() {
		...
		return d(function() {
			var e = !0, t = null, r = (function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					...
					try {
						...
						var n;
						if (l === "short" ? n = yield t.getShortStatisticString() : n = yield t.getDebugStatisticString(), e) {
							var r = "";
							try {
								var a, i = o("WAWebVoipVideoRendererRegistry").videoRendererRegistry.getRendererType(), s = (a = o("WAWebVoipVideoRendererInterface").WAWebVoipVideoRendererType.getName(i)) != null ? a : "unknown", u = o("WAWebVoipWebCodecsEncoderState").isWebCodecsEncoderEnabled() ? "WebCodecs H264" : "VoIP Stack (WASM)";
								r = "Renderer: " + s + "\nEncoder: " + u + "\n";
							} catch (e) {}
							var c = r + n;
							g(c.length > 0 ? c : "Statistic is not available\n");
						}
					} catch (t) {
			...
			return r(), l !== "none" && (t = window.setInterval(function() {
				r();
			}, p)), function() {
				e = !1, t != null && window.clearInterval(t);
			};
		}, [l]), t ? s.jsxs(s.Fragment, { children: [s.jsx("div", {
