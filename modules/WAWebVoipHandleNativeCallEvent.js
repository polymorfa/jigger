__d("WAWebVoipHandleNativeCallEvent", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $, P, N, M, w, A, F, O, B, W, q;
	function U(e) {
	...
	var z = G(), j = 90, K = null, Q = null, X = 60, Y = null, J = null;
	function Z() {
	...
	function ee(t, n) {
		...
		if (!(H != null || t === o("WAWebVoipWaCallEnums").CallState.CallStateEnding)) {
			var a = n.callId;
			H = a, o("WAWebBackendApi").frontendSendAndReceive("initializeVoipWasm").then(function(e) {
				H === a && o("WAWebVoipWasmHeapMonitor").startWasmHeapMonitor(e);
			}).catch(function(t) {
				H === a && (H = null), o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["voip: [WasmHeap] failed to start monitor"]))).catching(r("getErrorSafe")(t));
			});
		}
	}
	function te() {
		K != null && (window.clearTimeout(K), K = null, Q = null, o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["voip: caller timeout cleared"]))));
	}
	function ne(e, t, n) {
		return re.apply(this, arguments);
	}
	function re() {
		return re = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a) {
			if (e.type === "web") {
				var i = o("WAWebVoipCallStateUtils").isCallTerminal(t) || o("WAWebVoipCallStateUtils").isCallActive(t);
				if (i) {
					te();
					return;
				}
				var l = o("WAWebVoipCallStateUtils").isCallOutgoing(t), s = a.isCaller === !0, u = a.isGroupCall === !0;
				if (l && s && !u) {
					if (K != null) return;
					var c = a.callId;
					if (c == null) {
						o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["voip: caller timeout not set, callId is null"])));
						return;
					}
					Q = c;
					var d = j;
					try {
						...
						o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["voip: failed to get caller timeout param, using default: ", ""])), e);
					}
					if (Q !== c) {
						o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip: caller timeout skipped, state changed"])));
						return;
					}
					o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose(["voip: setting caller timeout for outgoing call: ", "s"])), d), K = window.setTimeout(function() {
						if (Q !== c) {
							o("WALogger").LOG(C || (C = babelHelpers.taggedTemplateLiteralLoose(["voip: caller timeout fired but call ID changed, ignoring"])));
							return;
						}
						o("WALogger").LOG(b || (b = babelHelpers.taggedTemplateLiteralLoose(["voip: caller timeout fired, ending call"]))), K = null, Q = null, (q || (q = n("Promise"))).resolve(e.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Timeout, !0)).catch(function(e) {
							o("WALogger").ERROR(v || (v = babelHelpers.taggedTemplateLiteralLoose(["voip: failed to end call on caller timeout"]))).catching(r("getErrorSafe")(e));
						});
					}, d * 1e3);
				}
			}
	...
	function oe() {
		Y != null && (window.clearTimeout(Y), Y = null, J = null, o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["voip: callee ringing timeout cleared"]))));
	}
	function ae(e) {
		var t = e.callInfo, a = e.callState, i = e.voipStackInterface;
		if (i.type === "web") {
			var l = o("WAWebVoipCallStateUtils").isCallTerminal(a) || o("WAWebVoipCallStateUtils").isCallActive(a) || o("WAWebVoipCallStateUtils").isCallConnecting(a);
			if (l) {
				oe();
				return;
			}
			if (a === o("WAWebVoipWaCallEnums").CallState.ReceivedCall && t.isCaller !== !0) {
				if (Y != null) return;
				var s = t.callId;
				if (s == null) {
					o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["voip: callee ringing timeout not set, callId is null"])));
					return;
				}
				J = s;
				var u = X;
				o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose([
					...
					" (",
					"s)"
				])), s, u), Y = window.setTimeout(function() {
					if (J !== s) {
						o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["voip: callee ringing timeout fired, callId changed"])));
						return;
					}
					o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["voip: callee ringing timeout fired: ", ""])), s), Y = null, J = null, (q || (q = n("Promise"))).resolve(i.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Timeout, !0)).catch(function(e) {
						o("WALogger").ERROR(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["voip: failed to end call on callee ringing timeout"]))).catching(r("getErrorSafe")(e));
	...
	function ue() {
		return ue = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			o("WALogger").LOG(S || (S = babelHelpers.taggedTemplateLiteralLoose(["voip: LidCallerDisplayInfo"]))), yield o("WAWebVoipHandleLidCallerDisplayInfo").handleWAWebVoipLidCallerDisplayInfoJson(e).catch(function(e) {
	...
	function pe() {
		return pe = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t, n = r("nullthrows")(yield o("WAWebVoipStackInterface").getVoipStackInterface()), a = n.parsers.parseCallStateChangedData(e), i = (t = a.CallState) != null ? t : o("WAWebVoipWaCallEnums").CallState.None, l = a.call_info;
			...
			c == null || c.onCallStateChanged(i), n.type === "web" && ee(i, l), o("WAWebVoipCallStateUtils").isCallTerminal(i) || (o("WAWebBackendApi").frontendFireAndForget("startAnrTracking", {}), o("WAWebBackendApi").frontendFireAndForget("startActivityTracking", {}), o("WAWebBackendApi").frontendFireAndForget("startUiActivityTracking", {}));
			var d = U(i);
			if (o("WAWebBackendApi").frontendFireAndForget("trackVoipCallStateChange", { stateName: d }), o("WAWebBackendApi").frontendFireAndForget("setCallState", {
				...
				o("WALogger").LOG(T || (T = babelHelpers.taggedTemplateLiteralLoose([
					...
					V === m && o("WAWebVoipPersistentFS").startPeriodicVoipSync(e);
				}).catch(function(e) {
				...
				}), o("WAWebVoipBrowserMetrics").startBrowserMetrics(), o("WAWebVoipWindowMetrics").startWindowMetrics(), o("WAWebVoipBatteryDiagnostics").startBatteryDiagnostics(), z.callIsActive = !0;
	...
	function fe() {
		return fe = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = r("nullthrows")(yield o("WAWebVoipStackInterface").getVoipStackInterface()), n = t.parsers.parseRelayListUpdateData(e), a = n.relays.some(function(e) {
				return e.addresses.some(function(e) {
					return e.port === 3478 || e.port_v6 === 3478;
				});
			});
			a && o("WAWebCoreActionsODS").logCallRelayPort3478(), o("WAWebVoipGatingUtils").isWebTransportEnabled() ? o("WAWebVoipWebTransportConnectionManager").handleRelayListUpdate(n) : yield o("WAWebVoipSctpConnectionManager").handleRelayListUpdate(n), z.cachedRelayListData = n, z.relayListReceived = !0, ge().catch(function(e) {
				var t = r("getErrorSafe")(e);
	...
	function Ce() {
		return Ce = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			if (e.type === "web") {
				...
				if (t === "") {
					o("WALogger").LOG(w || (w = babelHelpers.taggedTemplateLiteralLoose(["voip: initP2PConnectionIfEnabled: Failed to get call info"]))), z.initStarted = !1;
					return;
				}
				...
				if (yield o("WAWebVoipP2PConnectionManager").refreshP2PEnablement(a), !o("WAWebVoipP2PConnectionManager").isP2PEnabled()) {
				...
				if (!i && n.peerJid != null && (yield o("WAWebVoipContactUtils").isCallerNotContact(n.peerJid))) {
				...
				yield o("WAWebVoipP2PConnectionManager").initP2PConnection(i, s, f, u);
			}
		}), Ce.apply(this, arguments);
	}
	l.requestStoredFieldstatsSend = o("WAWebVoipHandleNativeCallEventFieldstatsHandlers").requestStoredFieldstatsSend, l.handleWAWebVoipNativeCallEvent = ie;
}), 98);
