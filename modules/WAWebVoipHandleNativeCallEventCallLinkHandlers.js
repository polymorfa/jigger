__d("WAWebVoipHandleNativeCallEventCallLinkHandlers", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b = [], v = 2e3, S = "busy", R = 5e3, L = null, E = null, k = new Set();
	function I() {
		E != null && (window.clearTimeout(E), E = null), L != null && (window.clearTimeout(L), L = null, o("WAWebBackendApi").frontendFireAndForget("stopBusyTone", {})), k.clear();
	}
	function T(e) {
	...
	function D() {
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = r("nullthrows")(yield o("WAWebVoipStackInterface").getVoipStackInterface()), n = t.parsers.parseGroupInfoChangedData(e);
			if (o("WAWebBackendApi").frontendFireAndForget("generateCallLogFromEventGroupInfoChanged", { groupInfoChangedData: n }), t.type === "web") {
				var a, i;
				o("WAWebBackendApi").frontendFireAndForget("handleGroupInfoChangedGroupCall", { groupInfoChangedPayload: n });
				var l = (a = (i = n.CallParticipants) == null ? void 0 : i.filter(function(e) {
					return e.outcome === o("WAWebVoipWaCallEnums").CallParticipantState.Connected;
				}).map(function(e) {
					return e.participant.toString();
				})) != null ? a : b, u = l.some(function(e) {
					return !k.has(e);
				});
				if (u) {
					var c = yield t.getCallInfo();
					if (c !== "") {
						var d = t.parsers.parseCallInfo(c), m = d.linkToken != null && d.linkToken !== "";
						m && d.videoEnabled && (l.forEach(function(e) {
							return k.add(e);
						}), E != null && window.clearTimeout(E), E = window.setTimeout(function() {
							E = null, t.broadcastVideoState().catch(function(e) {
								o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["voip: [GroupInfoChanged] broadcastVideoState failed"]))).catching(r("getErrorSafe")(e));
							});
						}, v));
					}
				}
	...
	var x = 50, $ = o("WAThrottle").throttle(function() {
		M().catch(function(t) {
			o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["voip: handleCallGridRankingChanged: dispatch failed"]))).catching(r("getErrorSafe")(t)).sendLogs("voip-grid-ranking-dispatch-failed");
		});
	}, x, {
		leading: !0,
		trailing: !0
	...
	function w() {
		return w = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = ++P, t = r("nullthrows")(yield o("WAWebVoipStackInterface").getVoipStackInterface());
			if (t.type === "web") {
	...
	function V() {
		return V = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (t.type === "web") {
				...
				o("WAWebBackendApi").frontendFireAndForget("handleCallLinkNacked", { nackCode: n.nackCode }), yield t.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Unknown, !1);
			}
	...
	function Z() {
		return Z = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (t.type === "web") {
				...
				if (i === "") {
					o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["voip: handleCallRejectReceived: no call info, ending"]))), yield t.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Unknown, !1);
					return;
				}
				var l = t.parsers.parseCallInfo(i), s = l.isGroupCall === !0;
				if (s) {
					o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["voip: handleCallRejectReceived: skip endCall (group)"])));
					return;
				}
				if (a.reason === S) {
					o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["voip: handleCallRejectReceived: peer busy, showing busy UI"]))), o("WAWebBackendApi").frontendFireAndForget("setPeerBusy", {}), o("WAWebBackendApi").frontendFireAndForget("playBusyTone", {}), L != null && window.clearTimeout(L);
					var h = a.callId;
					L = window.setTimeout(function() {
						L = null, o("WAWebBackendApi").frontendFireAndForget("stopBusyTone", {}), n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
							try {
								var e = yield t.getCallInfo();
								if (e === "") {
									o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["voip: handleCallRejectReceived: no active call at busy timeout, skipping endCall for callId=", ""])), h);
									return;
								}
								var n = t.parsers.parseCallInfo(e).callId;
								if (n !== h) {
									o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["voip: handleCallRejectReceived: active call changed, skipping endCall for callId=", ""])), h);
									return;
								}
								o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["voip: handleCallRejectReceived: busy tone timeout, ending callId=", ""])), h), yield t.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Unknown, !1);
							} catch (e) {
				...
				yield t.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Unknown, !1);
			}
	...
	function re() {
		return re = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = r("nullthrows")(yield o("WAWebVoipStackInterface").getVoipStackInterface());
			t.type === "web" && (yield new (C || (C = (n("Promise"))))(function(e) {
				return window.setTimeout(e, 2500);
			}), yield t.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Timeout, !1));
	...
	function ae() {
		return ae = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (t.type === "web") {
				...
				o("WAWebCoreActionsODS").logCallErrorTerminal(), yield o("WAWebBackendApi").frontendSendAndReceive("handleRelayBindsFailed", {}), yield t.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Unknown, !1);
			}
		...
		return de = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (t.type === "web") {
				...
				if (o("WAWebUserPrefsMeUser").isMeAccount(n.removeeJid)) {
					...
					o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip: User was removed from call by ", ""])), l != null ? l : "unknown"), o("WAWebBackendApi").frontendFireAndForget("showUserRemovedDialog", { removerJid: l }), yield t.endCall(o("WAWebVoipSignalingEnums").EndCallReason.Unknown, !0);
				} else {
					var s = n.removeeJid;
	...
	l.resetCallLinkHandlerState = I, l.handleGroupInfoChanged = T, l.handleCallGridRankingChanged = N, l.handleRxTrafficStateForPeerChanged = A, l.handleNetHealthStatusChanged = O, l.handleCallLinkStateChanged = W, l.handleCallLinkNacked = U, l.handleCallOfferNacked = H, l.handleLobbyNacked = z, l.handleLobbyTimeout = j, l.handleWaitingRoomDenied = K, l.handleWaitingRoomStateChanged = X, l.handleCallRejectReceived = J, l.handleCallFatal = ee, l.handleRTCPByeReceived = ne, l.handleRelayBindsFailed = oe, l.handleP2PTransportUpdate = ie, l.handleGroupCallReminder = se, l.handleUserRemoved = ce;
}), 98);
