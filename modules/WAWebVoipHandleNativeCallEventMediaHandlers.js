__d("WAWebVoipHandleNativeCallEventMediaHandlers", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (t.type === "web") {
				...
				o("WAWebBackendApi").frontendFireAndForget("handleVideoStateChange", { videoStateData: n }), n.isSelf === !0 && m().catch(function(e) {
					o("WALogger").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose(["voip: handleUpdateVoipSettings: dispatch failed"]))).catching(r("getErrorSafe")(e));
				});
			}
	...
	var g = o("WAThrottle").throttle(function() {
		C().catch(function(t) {
			o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["voip: handleMuteStateChanged: dispatch failed"]))).catching(r("getErrorSafe")(t)).sendLogs("voip-mute-state-dispatch-failed");
		});
	}, u, {
		leading: !0,
		trailing: !0
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = ++h, t = r("nullthrows")(yield o("WAWebVoipStackInterface").getVoipStackInterface());
			if (t.type === "web") {
	...
	l.handleVideoStateChanged = c, l.handleUpdateVoipSettings = m, l.handlePeerVideoPermissionChanged = _, l.handleMuteStateChanged = y, l.handleAudioDriverRestart = v, l.handleSpeakerStatusChanged = R, l.handleReactionStateChanged = E, l.handleScreenShareStateChanged = I, l.handleRaiseHandStateChanged = D, l.handleEncodeTargetFpsChanged = $, l.handleEncodeParamsChanged = N, l.resetWebCodecsEncoderState = o("WAWebVoipWebCodecsEncoderState").resetWebCodecsEncoderState;
}), 98);
