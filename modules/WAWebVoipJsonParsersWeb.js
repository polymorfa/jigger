__d("WAWebVoipJsonParsersWeb", [
	...
	var e, s, u, c = 0, d = {
		...
		parseUpdateJoinableCallLogData: function(t) {
			var e, n = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (n == null) throw r("err")("Invalid update joinable call log data");
			...
			return {
				...
				SelfOtherDeviceConnected: (e = n.self_other_device_connected) != null ? e : !1
			};
		},
		parseRejectedDecryptionFailureData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null) throw r("err")("Invalid call ending data");
			return babelHelpers.extends({}, e, { PeerDeviceJid: p(e.PeerDeviceJid) });
		},
		parseSyncDeviceData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null || e.sync_devices == null) throw r("err")("Invalid sync device data");
			if (!Array.isArray(e.sync_devices)) throw r("err")("Invalid sync device data: expected array");
			return e.sync_devices.map(function(e) {
				return {
					PHash: e.phash,
					UserJid: p(e.user_jid)
				};
			});
		},
		parseCallEndingData: function(t) {
			var e, n, a = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			...
			return {
				...
				connectTime: a.connect_time != null ? Math.floor(a.connect_time / 1e3) : null,
				...
				terminatedByDeviceSwitch: (n = a.terminated_by_device_switch) != null ? n : !1,
				bytesSent: a.bytes_sent,
				bytesReceived: a.bytes_received
			};
		},
		parseCallMissedData: function(t) {
			var e, n, a, i, l, s, u = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (u == null) throw r("err")("Invalid call missed data");
			var c = (e = u.group_info) != null && e.participants ? u.group_info.participants.map(function(e) {
				return {
					jid: p(e.user_jid),
					result: e.state
				};
			}) : (n = (a = u.call_participant_infos) == null ? void 0 : a.map(function(e) {
				return {
					jid: p(e.jid),
					result: e.state
				};
			...
			return {
				...
				GroupInfo: u.group_info ? { Participants: (i = u.group_info.participants) == null ? void 0 : i.map(function(e) {
					return {
						UserJid: p(e.user_jid),
						State: e.state
					};
				...
				TimeElapsedSinceCallOffer: (l = u.time_elapsed_since_call_offer) != null ? l : 0,
		...
		parseGroupInfoChangedData: function(t) {
			...
			var n = null;
			return e.participants != null && (n = e.participants.map(function(e) {
				var t, n, r, o = (t = (n = e.push_name) != null ? n : e.guest_name) != null ? t : null;
				return {
					participant: p(e.jid),
					outcome: e.state,
		...
		parseSpeakerStatusChangedData: function(t) {
			...
			return {
				CallId: a.call_id,
				Participants: (e = (n = a.participants) == null ? void 0 : n.map(function(e) {
					return {
						Jid: p(e.jid),
		...
		parseRelayListUpdateData: function(t) {
			...
			return {
				...
				enable_web_relay_connection_stagger: e.enable_web_relay_connection_stagger
			};
		},
		parseFieldstatsData: function(n) {
			...
			if (t.call_ended_stats != null) {
				var a = Object.entries(t.call_ended_stats), i = Object.fromEntries(r("compactMap")(a, function(t) {
					var n = t[0], a = t[1], i = n === "abtest_bucket" ? "callTestBucket" : r("WACamelCase")(n, { treatNumbersAsWordBoundaries: !1 });
					if (i == null) return null;
					try {
						var l = o("WAWebWamCodegenUtils").metrics.getEvent("Call", i);
						return l.type === "boolean" ? [i, !!a] : [i, a];
					} catch (t) {
						return o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["voip: fieldstats ready: metric undefined for ", ""])), i), null;
					}
				}));
				return {
					eventType: o("WAWebVoipJsonParserPayloads").FieldstatsPayloadType.Call,
					stats: i,
			...
			if (t.joinable_call_stats != null) {
				var l = Object.entries(t.joinable_call_stats), u = Object.fromEntries(r("compactMap")(l, function(e) {
					var t = e[0], n = e[1], a = r("WACamelCase")(t, { treatNumbersAsWordBoundaries: !1 });
					try {
						var i = o("WAWebWamCodegenUtils").metrics.getEvent("JoinableCall", a);
						return i.type === "boolean" ? [a, !!n] : [a, n];
					} catch (e) {
						return o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["voip: fieldstats ready: metric undefined for ", ""])), a), null;
					}
				}));
				return {
					eventType: o("WAWebVoipJsonParserPayloads").FieldstatsPayloadType.JoinableCall,
					stats: u,
					uploadInRealtime: t.upload_in_realtime,
					isLastFieldStatsReport: t.is_last_field_stats_report
				};
		...
		parsePeerVideoPermissionChangedData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null) throw r("err")("Invalid peer video permission changed data");
			return {
		...
		parseAudioDriverRestartData: function(t) {
			...
			return {
				...
				audioRestartBeforeFallbackCount: e.audio_restart_before_fallback_count,
				isDueToSilenceDetected: e.is_due_to_silence_detected
			};
		},
		parseCallInfo: function(t) {
			var e, n, a, i, l, s = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			...
			return {
				...
				isUpgradedGroupCallBeforeConnected: s.is_upgraded_group_call_before_connected,
				...
				callWaitingInfo: {
					...
					waitingPeerJid: _((e = s.call_waiting_info.peer_jids) == null ? void 0 : e[0]),
				...
				waitingRoomUsersCount: (i = s.waiting_room_users_count) != null ? i : 0,
				waitingRoomUsers: ((l = s.waiting_room_users) != null ? l : []).map(function(e) {
					return p(e.jid);
				})
			};
		},
		...
		parseScreenShareStateChangedData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null) throw r("err")("Invalid screen share state changed data");
			return {
				state: e.state,
				reason: e.reason,
		...
		parseRxTrafficStateForPeerChangedData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null) throw r("err")("Invalid rx traffic state for peer changed data");
			return {
				jid: p(e.jid),
		...
		parseNetHealthStatusChangedData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null) throw r("err")("Invalid net health status changed data");
			return {
		...
		parseRaiseHandStateChangedData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null) throw r("err")("Invalid raise hand state changed data");
			return {
				jid: p(e.jid),
		...
		parseCallOfferNackedData: function(t) {
			var e, n, a = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (a == null || a.errors == null || a.nack_code != null && typeof a.nack_code != "number" || a.is_fatal_nack != null && typeof a.is_fatal_nack != "boolean") throw r("err")("Invalid call offer nacked data");
			return {
				errors: a.errors.map(function(e) {
					return {
						errorCode: e.error_code,
						errorJid: _(e.error_jid)
					};
				}),
		...
		parseCallLinkNackedData: function(t) {
			var e, n = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			return { nackCode: (e = n == null ? void 0 : n.nack_code) != null ? e : 0 };
		},
		parseUserRemovedData: function(t) {
			...
			return {
				...
				removerJid: e.remover_jid != null ? o("WAWebWidFactory").createWid(e.remover_jid.raw_jid) : null
			};
		},
		parseEncodeTargetFpsChangedData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null) throw r("err")("Invalid encode target FPS changed data");
		...
		parseGroupCallReminderData: function(t) {
			var e, n, a, i, l = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			...
			return {
				...
				participants: ((n = l.participants) != null ? n : []).map(function(e) {
					return {
						jid: p(e.jid),
						state: e.state
					};
				}),
				waitingRoomUsers: ((a = l.waiting_room_users) != null ? a : []).map(function(e) {
					return p(e.jid);
				}),
				waitingRoomUsersCount: (i = l.waiting_room_users_count) != null ? i : 0
			};
		},
		parseVoiceChatWaveReceivedData: function(t) {
			var e = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(t);
			if (e == null) throw r("err")("Invalid voice chat wave received data");
			return {
				callId: e.call_id,
	...
	function _(e) {
		...
		try {
			...
			return o("WALogger").ERROR(u || (u = babelHelpers.taggedTemplateLiteralLoose(["createVoipJid: failed to create wid from raw jid"]))).sendLogs("create-voip-jid-failed"), null;
		}
	}
	function f(e) {
		var t, n, r, o = (t = (n = e.push_name) != null ? n : e.guest_name) != null ? t : null;
