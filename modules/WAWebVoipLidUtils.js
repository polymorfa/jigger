__d("WAWebVoipLidUtils", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = !e.is_offline, r = e.peer_jid;
			if (r.isUser()) {
				var a = e.caller_pn;
				yield c({
					jid: r,
			...
			if (i != null) {
				for (var l = -1, s = 0; s < i.length; s++) i[s].jid.isUser() && (l = s);
				yield o("WAPromiseEach").promiseEach(i, (function() {
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var n = t.accountKind, a = t.countryCode, i = t.flushImmediately, l = t.jid, s = t.phoneNumber, u = t.pushName, c = t.username, d = o("WAWebWidFactory").asUserWidOrThrow(l), p = m(n);
			if (p != null && o("WAWebABProps").getABPropConfigValue("web_guest_calling_representation_enabled") && o("WAWebUpdateContactExternalUserState").updateContactExternalUserState(l, p), r("isStringNullOrEmpty")(u) || o("WAWebHandlePushnameUpdate").updatePushname(l, u, !1), !!d.isLid()) {
				if (c != null && o("WAWebUsernameGatingUtils").usernameDisplayedEnabled()) {
					...
					if (_ != null) {
						...
						if (yield o("WAWebSetUsernameJob").setUsernamesJob([f]), s != null && o("WAWebABProps").getABPropConfigValue("enable_calling_phone_number_privacy")) {
				...
				s != null && !o("WAWebVoipGatingUtils").isGuestViewer() && (yield o("WAWebDBCreateLidPnMappings").createLidPnMappings({
					mappings: [{
						lid: d,
	...
	l.persistAttributesAndLidMappingsForCall = s, l.attemptPersistLidMappingAndUserAttributes = c;
}), 98);
