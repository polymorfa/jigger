		...
		return a.start = function() {
			...
			this.$4.onmessage = function(n) {
				...
				if (!(a == null || typeof a != "object")) {
					var i = Number(a.id), l = t.$3.get(i);
					if (l == null) {
						o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["voip: [RPC] Response for unknown id=", ""])), i);
						return;
					}
					t.$3.delete(i), a.error != null ? l.reject(r("err")(String(a.error))) : l.resolve(a.result);
				}
			}, this.$4.start();
			...
			return new (c || (c = (n("Promise"))))(function(n, l) {
				var s = window.setTimeout(function() {
					e.$3.delete(i), l(r("err")("voip: [RPC] timeout for " + t + " (id=" + i + ")"));
				}, 3e4);
				e.$3.set(i, {
					resolve: function(t) {
			...
			var e = this, d = i.absoluteMs, m = i.foregroundMs, p = i.onBackgroundPauseSuccess, _ = i.onTimeout, f = this.$2++;
			return new (c || (c = (n("Promise"))))(function(n, i) {
				var c = o("WAWebVisibilityAwareTimeout").startVisibilityAwareTimeout({
					foregroundMs: m,
					absoluteMs: d,
					onTimeout: function(o, a) {
						e.$3.delete(f), _(o);
						var n = o === "foreground" ? "foreground timeout" : "absolute timeout";
						i(r("err")("voip: [RPC] timeout for " + t + " (id=" + f + ", reason=" + n + ", wallElapsed=" + a.wallMs.toFixed(1) + "ms, visibleElapsed=" + a.visibleMs.toFixed(1) + "ms)"));
					},
					onPause: function(n) {
