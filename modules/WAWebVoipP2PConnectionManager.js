__d("WAWebVoipP2PConnectionManager", [
	...
	function je() {
		return je = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			if (!(ve == null || Se == null || Re == null || Le == null || ue == null || xe == null) && !(Te || Ie)) {
				...
				try {
					if (me) {
						...
						o("WALogger").LOG(P || (P = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Applying synthetic answer SDP (caller, ICE role=controlling)"]))), yield e.setRemoteDescription({
							sdp: t,
							type: "answer"
						});
					} else {
						var n, r = We(xe, ve, Se, Re, Le, [], !1, pe);
						o("WALogger").LOG(N || (N = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Applying synthetic offer SDP (callee, ICE role=controlled)"]))), yield e.setRemoteDescription({
							sdp: r,
							type: "offer"
						});
						var a = yield e.createAnswer(), i = (n = a.sdp) != null ? n : "", l = Ce;
						if (l != null) {
							var s = o("WAWebVoipRelayConnectionUtils").extractIceCredentials(i);
							s != null && s.ufrag !== l.ufrag && (o("WALogger").LOG(M || (M = babelHelpers.taggedTemplateLiteralLoose([
						...
						if (yield e.setLocalDescription({
							type: "answer",
							sdp: i
							...
							o("WALogger").ERROR(w || (w = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to extract credentials from answer SDP"]))), Ie = !1, Ve("credential_extraction_failed");
							return;
						}
						o("WALogger").LOG(A || (A = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Callee local credentials extracted from answer"])));
						var u = Ae;
						if (u != null) try {
							u(Ce.ufrag, Ce.pwd, be.algorithm, be.fingerprint, []);
						} catch (e) {
							o("WALogger").ERROR(F || (F = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to send callee transport: ", ""])), e);
						}
					}
					o("WALogger").LOG(O || (O = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Remote description applied successfully"]))), Te = !0, Ie = !1, Ge();
				} catch (e) {
					Ie = !1, Te = !1, o("WALogger").ERROR(B || (B = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to apply remote description: ", ""])), e), Ve("remote_description_failed");
				}
			}
			...
			if (i != null) {
				...
				if (l != null && s != null) {
					...
					if (u != null) try {
						...
						o("WALogger").ERROR(_ || (_ = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to send candidate transport: ", ""])), e);
					}
				}
			}
		} else o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] ICE gathering complete"])));
	}
	function Qe() {
		if (ue != null) {
			...
			o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose([
				...
				o("WALogger").WARN(b || (b = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] getStats failed"]))).catching(r("getErrorSafe")(e)).sendLogs("p2p-getstats-failed");
			}), t === "failed" && Ve("ice_connection_failed");
		}
	}
	function Xe() {
		var e, t = "N/A";
		$e.connectionReadyTime !== 0 && Pe > 0 && (t = ($e.connectionReadyTime - Pe).toString()), o("WALogger").LOG(v || (v = babelHelpers.taggedTemplateLiteralLoose([
	...
	function Ye() {
		o("WALogger").LOG(S || (S = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Data channel opened"]))), qe(o("WAWebVoipRelayConnectionUtils").ConnectionState.Open), $e.connectionReadyTime = Date.now(), _e || o("WAWebVoipSctpStatsInstrumentation").addConnectionSource("p2p", Fe), De != null && (window.clearTimeout(De), De = null);
	}
	function Je() {
		o("WALogger").LOG(R || (R = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Data channel closed"]))), de !== o("WAWebVoipRelayConnectionUtils").ConnectionState.Failed && de !== o("WAWebVoipRelayConnectionUtils").ConnectionState.Closed && (qe(o("WAWebVoipRelayConnectionUtils").ConnectionState.Closed), Ue());
	}
	function Ze(e) {
	...
	function et(e) {
		o("WALogger").ERROR(L || (L = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Data channel error"]))), Ve("data_channel_error");
	}
	function tt(e) {
		e.onopen = function() {
			Ye();
	...
	function rt() {
		return rt = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a) {
			ue != null && (o("WALogger").WARN(W || (W = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] initP2PConnection called while already initialized, cleaning up"]))), ot()), ie = !0, o("WALogger").LOG(q || (q = babelHelpers.taggedTemplateLiteralLoose([
			...
			ue = i, i.onicecandidate = function(e) {
				...
				o("WALogger").LOG(U || (U = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] PeerConnection state: ", ""])), i.connectionState);
			}, i.onicegatheringstatechange = function() {
				o("WALogger").LOG(V || (V = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] ICE gathering state: ", ""])), i.iceGatheringState);
			}, i.onsignalingstatechange = function() {
				o("WALogger").LOG(H || (H = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Signaling state: ", ""])), i.signalingState);
			};
			...
			if (s && o("WALogger").LOG(G || (G = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] DC transfer disabled for current browser, using main-thread path"]))), u != null && re != null && ae != null) {
				...
				_ ? (_e = !0, fe = !0, ge = m, o("WALogger").LOG(z || (z = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] DataChannel transferred to worker thread as ", ""])), m)) : o("WALogger").WARN(j || (j = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] DataChannel transfer failed, using main-thread path"])));
			}
			if (_e || tt(l), e) {
				var f, g = yield i.createOffer();
				...
				if (xe = h, Ce = o("WAWebVoipRelayConnectionUtils").extractIceCredentials(h), be = o("WAWebVoipRelayConnectionUtils").extractDtlsFingerprint(h), Ce == null || be == null) {
					o("WALogger").ERROR(K || (K = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to extract local credentials from offer SDP"]))), Ve("credential_extraction_failed");
					return;
				}
				o("WALogger").LOG(Q || (Q = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Caller offer created, local credentials extracted"])));
				var y = Ae;
				if (y != null && Ce != null && be != null) {
					o("WALogger").LOG(X || (X = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Sending initial credentials to remote peer"])));
					try {
						y(Ce.ufrag, Ce.pwd, be.algorithm, be.fingerprint, []);
					} catch (e) {
						o("WALogger").ERROR(Y || (Y = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to send initial transport"]))).catching(r("getErrorSafe")(e)).sendLogs("p2p-caller-send-initial-transport-failed");
					}
				}
			} else {
				var C, b = yield i.createOffer(), v = (C = b.sdp) != null ? C : "";
				if (xe = v, Ce = o("WAWebVoipRelayConnectionUtils").extractIceCredentials(v), be = o("WAWebVoipRelayConnectionUtils").extractDtlsFingerprint(v), Ce == null || be == null) {
					o("WALogger").ERROR(J || (J = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to extract local credentials from callee template SDP"]))).sendLogs("p2p-callee-credential-extraction-failed"), Ve("credential_extraction_failed");
					return;
				}
				...
				if (S != null) try {
					...
					o("WALogger").ERROR(ee || (ee = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to send callee initial transport"]))).catching(r("getErrorSafe")(e)).sendLogs("p2p-callee-send-initial-transport-failed");
				}
			}
	...
	function st(e) {
		if (Te && ue != null) {
			...
			t.addIceCandidate(new RTCIceCandidate({
				...
				o("WALogger").WARN(I || (I = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to add remote candidate: ", ""])), e);
			});
		} else ke.length < se.MAX_BUFFERED_CANDIDATES ? ke.push(e) : o("WALogger").WARN(T || (T = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Dropping remote ICE candidate, buffer full (", ")"])), ke.length);
	}
	function ut(e) {
		if (_e) return !0;
		if (de === o("WAWebVoipRelayConnectionUtils").ConnectionState.Open && ce != null && ce.readyState === "open") try {
			...
			return o("WALogger").ERROR(D || (D = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Failed to send P2P data: ", ""])), e), !1;
		}
		return !1;
	}
	function ct(e) {
	...
	function ft() {
		return ft = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = le;
			try {
				var n = yield o("WAWebVoipStackInterface").getVoipStackInterface(), a = n != null && n.type === "web" ? yield n.isWebP2PEnabled(e) : !1;
				t === le && (ie = a);
			} catch (e) {
				o("WALogger").ERROR(te || (te = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] refreshP2PEnablement failed"]))).catching(r("getErrorSafe")(e)), t === le && (ie = !1);
			}
	...
	function bt() {
		_e && (o("WALogger").LOG(x || (x = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Worker reported P2P channel opened"]))), Ye());
	}
	function vt(e) {
		var t = _e || he;
		t && (o("WALogger").LOG($ || ($ = babelHelpers.taggedTemplateLiteralLoose(["voip: [P2PConnectionManager] Worker reported P2P channel closed"]))), e != null && ($e.sentPackets += e.sentPackets, $e.sentBytes += e.sentBytes, $e.receivedPackets += e.receivedPackets, $e.receivedBytes += e.receivedBytes, e.firstSendTime > 0 && $e.firstSendRequestTime === 0 && ($e.firstSendRequestTime = e.firstSendTime), e.firstResponseRecvTime > 0 && $e.firstResponseRecvTime === 0 && ($e.firstResponseRecvTime = e.firstResponseRecvTime)), Xe(), he = !1, ye = null, $e = o("WAWebVoipRelayConnectionUtils").createEmptyConnectionStats(), Pe = 0, fe = !1, _e && (de !== o("WAWebVoipRelayConnectionUtils").ConnectionState.Failed && de !== o("WAWebVoipRelayConnectionUtils").ConnectionState.Closed && qe(o("WAWebVoipRelayConnectionUtils").ConnectionState.Closed), _e = !1, ge = null, Ue()));
	}
	l.parseSdpCandidateToTransport = Oe, l.initP2PConnection = nt, l.cleanupP2PConnection = ot, l.getLocalIceCredentials = at, l.getLocalDtlsFingerprint = it, l.handleRemoteCredentials = lt, l.handleRemoteCandidate = st, l.sendP2PData = ut, l.registerOnDataChannelMessage = ct, l.registerOnDataChannelStateChange = dt, l.registerOnIceCandidate = mt, l.isP2PEnabled = pt, l.refreshP2PEnablement = _t, l.initP2PVirtualAddresses = gt, l.isP2PVirtualAddress = ht, l.getP2PConnectionId = yt, l.isP2PConnectionId = Ct, l.handleWorkerP2PChannelOpened = bt, l.handleWorkerP2PChannelClosed = vt;
}), 98);
