__d("WAWebVoipParticipantsModal.react", [
	...
	function C(t) {
		var a = t.call, i = r("useWAWebEventTargetValue")(a, o("WAWebVoipEventConstants").getChangeEvent(o("WAWebVoipEventConstants").VoipCallModelEvents.WAITING_ROOM_STATE), function() {
			var e;
			return (e = a == null ? void 0 : a.waitingRoomUsers) != null ? e : [];
		}), l = (a == null ? void 0 : a.callLinkCreatorJid) != null && o("WAWebUserPrefsMeUser").isMeAccount(a.callLinkCreatorJid), d = _(function(t) {
			...
			n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					...
					t != null && t.type === "web" && (yield t.waitingRoomDeny(e.toString({ legacy: !0 })));
				} catch (e) {
			...
			o("WAWebModalManager").ModalManager.openSupportModal(m.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
				onOK: function() {
					o("WAWebModalManager").ModalManager.closeSupportOrModal(), f();
				},
				onCancel: function() {
		...
		return (a == null ? void 0 : a.isCallLink) !== !0 || !l ? null : m.jsx(m.Fragment, { children: i.length > 0 && m.jsxs(m.Fragment, { children: [
			m.jsxs(o("WAWebFlex.react").FlexRow, {
				...
				}), i.length >= 2 && m.jsx(r("WDSButton.react"), {
					variant: "borderless",
					type: "default",
					size: "small",
					label: s._(
