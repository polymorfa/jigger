__d("WAWebVoipQplHelpers", [
	"$InternalEnum",
	"WAWebQplFlow",
	"qpl"
], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e, s, u = (s = r("qpl"))._(891422152, "3402"), c = (e = n("$InternalEnum"))({
	...
	function m(e) {
		...
		return n != null && t.addAnnotations({ int: { session_age_ms: Math.round(n.now()) } }), t;
	}
	function p(e, t) {
		var n;
	...
	function _(e) {
		var t;
		(t = d) == null || t.addAnnotations({ bool: { using_dedicated_worker: e } });
	}
	function f(e, t, n) {
		var r;
		(r = d) == null || r.addAnnotations({
	...
	var y = s._(891426543, "3400"), C = 12e4, b = e({
	...
	var E = s._(891426840, "3404"), k = 14400 * 1e3, I = e({
		PIP_OPENED: "pip_opened",
		POPOUT_OPENED: "popout_opened"
	}), T = null;
	function D(e) {
		T = o("WAWebQplFlow").startQplFlow(E, {
			timeoutInMs: k,
			annotations: e
		});
	}
	...
	var P = s._(891424539, "3405"), N = 12e4, M = e({
	...
	l.VoipInitQplPoint = c, l.startVoipInitQpl = m, l.voipInitQplAddPoint = p, l.voipInitQplAnnotateExecutionMode = _, l.voipInitQplAnnotateThreadPool = f, l.endVoipInitQplSuccess = g, l.endVoipInitQplFail = h, l.VoipEndCallQplPoint = b, l.startVoipEndCallQpl = S, l.voipEndCallQplAddPoint = R, l.endVoipEndCallQplSuccess = L, l.VoipUiLifecycleQplPoint = I, l.startVoipUiLifecycleQpl = D, l.voipUiLifecycleQplAddPoint = x, l.endVoipUiLifecycleQplSuccess = $, l.VoipWorkerSetupQplPoint = M, l.startVoipWorkerSetupQpl = w, l.voipWorkerSetupQplAddPoint = A, l.endVoipWorkerSetupQplSuccess = F, l.endVoipWorkerSetupQplFail = O;
}), 98);
