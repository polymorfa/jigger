__d("WAWebVoipReportCallJob", [
	...
	function e(e) {
		...
		return o("WASmaxSpamIndividualReportRPC").sendIndividualReportRPC(n).then(o("WAWebParseReportResponse").parseIndividualReportResponse);
	}
	l.reportVoipCall = e;
}), 98);
