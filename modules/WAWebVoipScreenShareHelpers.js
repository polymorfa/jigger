__d("WAWebVoipScreenShareHelpers", [
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			var a, i, l, u = t.closeModal, c = t.isCallLink, m = c === void 0 ? !1 : c, _ = t.isSelfScreenSharing, f = t.isVideoCall, g = t.isVideoMuted, h = t.onVideoMuteToggle, C = t.openModal, v = t.targetWindow;
			if (!f) {
				if (m) {
					C(p.jsx(o("WAWebVoipScreenShareConfirmPopup.react").WAWebVoipScreenShareConfirmPopup, {
						closeModal: u,
						hideCancel: !0,
						message: s._(
							/*BTDS*/
				...
				C(p.jsx(o("WAWebVoipScreenShareConfirmPopup.react").WAWebVoipScreenShareConfirmPopup, { closeModal: u }));
				return;
			}
			if (_) {
				yield b();
			...
			(a = r("WAWebCallCollection").activeCall) == null || a.setSelfScreenShareRejected(!1);
			var S = !((i = (l = r("WAWebCallCollection").activeCall) == null ? void 0 : l.isDualStreamScreenShareEnabled()) != null && i);
			if (g && S) {
				C(p.jsx(o("WAWebVoipScreenShareConfirmPopup.react").WAWebVoipScreenShareConfirmPopup, {
					closeModal: u,
					message: s._(
					...
					onOK: n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
						try {
							yield (d || (d = n("Promise"))).resolve(h()), yield y(v);
						} catch (t) {
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var t = yield o("WAWebVoipVideoDesktopCapture").WAWebVoipVideoDesktopCapture.preflightAcquireDesktopStream(e);
			if (t != null) try {
				var n = yield o("WAWebVoipStackInterface").getVoipStackInterface();
				if ((n == null ? void 0 : n.type) === "web") yield n.startScreenShare();
				else {
					var a;
				...
				o("WALogger").ERROR(c || (c = babelHelpers.taggedTemplateLiteralLoose(["voip: UI: screen share: screen share operation failed"]))).catching(r("getErrorSafe")(e)), yield o("WAWebVoipVideoDesktopCapture").WAWebVoipVideoDesktopCapture.stopCapture(!0);
			}
	...
	l.getScreenShareIcon = _, l.getScreenShareLabel = f, l.handlePressScreenShare = g;
}), 226);
