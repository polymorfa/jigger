__d("WAWebVoipSctpDataChannelThreadManager", [
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (b != null) {
				...
				try {
					var n, a;
					return v = yield b, o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["voip: [DCThread] Existing promise resolved, thread active: ", ""])), String((n = (a = v) == null ? void 0 : a.isActive()) != null ? n : !1)), v != null && v.isActive();
				} catch (e) {
	...
	function D() {
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			var e = v;
			v = null, yield e.shutdown(), o("WALogger").LOG(C || (C = babelHelpers.taggedTemplateLiteralLoose(["voip: [DCThread] WASM pthread shutdown complete"])));
		}), D.apply(this, arguments);
	}
	l.initDataChannelWorker = L, l.isDataChannelThreadActive = k, l.getDataChannelThread = I, l.stopDataChannelWorker = T;
}), 98);
