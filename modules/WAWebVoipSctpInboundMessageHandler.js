__d("WAWebVoipSctpInboundMessageHandler", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			var a = o("WAWebVoipSctpConnectionState").sctpConnections.get(n.id), i = r("nullthrows")(yield o("WAWebVoipStackInterface").getVoipStackInterface());
			if (i.type === "web" && a) {
				var l = yield o("WAWebVoipRelayConnectionUtils").dataToArrayBuffer(t.data);
				if (l == null) {
				...
				a.stats.receivedPackets++, a.stats.receivedBytes += l.byteLength, a.stats.firstResponseRecvTime === 0 && (a.stats.firstResponseRecvTime = Date.now()), a.lastRxPacketTime = Date.now(), a.hasReceivedFirstPacket || (a.hasReceivedFirstPacket = !0), yield i.handleOnTransportMessage(l, n.ip, u(n));
