__d("WAWebVoipSctpPrewarm", [
	...
	var e, s, u, c = 5e3, d = null;
	function m(e) {
		if (d != null) return d;
		var t = (e == null ? void 0 : e.force) === !0;
		return !t && !o("WAWebVoipPerfOptimizations").isPerfOptimizationEnabled(o("WAWebVoipPerfOptimizations").PerfOptimizationFlag.SCTP_PREWARM) ? (u || (u = n("Promise"))).resolve() : (d = _(), d);
	}
	function p(e) {
		if (e.iceGatheringState === "complete" && e.localDescription != null) {
			var t = e.localDescription, r = t.sdp, o = t.type;
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var t = self.performance.now(), a = o("WAWebVoipSctpPrewarmQpl").startVoipSctpPrewarmQpl(), i = null, l = null, d = null;
			try {
				o("WAWebAppTracker").AppTracker.mark(o("WAWebAppTracker").AppTrackerType.VoipSctpPrewarm), i = new RTCPeerConnection(), l = new RTCPeerConnection(), yield (u || (u = n("Promise"))).race([g(i, l), new u(function(e, t) {
					d = window.setTimeout(function() {
						t(r("err")("SctpPrewarm timeout"));
					}, c);
				})]);
				var m = (self.performance.now() - t).toFixed(1);
				o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["voip: [SctpPrewarm] completed in ", "ms"])), m), o("WAWebVoipSctpPrewarmQpl").endVoipSctpPrewarmQplSuccess(a);
			} catch (e) {
				...
				o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose([
					...
					"ms: ",
					""
				])), p, String(e)), o("WAWebVoipSctpPrewarmQpl").endVoipSctpPrewarmQplFail(a, "prewarm_failed");
			} finally {
				var _, f;
				d != null && window.clearTimeout(d), (_ = i) == null || _.close(), (f = l) == null || f.close();
			}
