__d("WAWebVoipSendSignalingXmpp", [
	...
	"use strict";
	var e, u, c, d, m, p, _, f, g, h, y, C, b = ["offer", "enc_rekey"];
	function v(e) {
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			var i = Date.now(), l = t.peerJid, s = t.xmlPayload, d = yield o("WAWap").decodeStanza(s, function(e) {
				return (C || (C = n("Promise"))).resolve(e);
			}), m = Date.now(), p = o("WAWebWidFactory").createWid(l), _ = b.includes(d.tag), f, g = d;
			if (p.isGroupCall()) f = o("WAWebCommsWapMd").GROUP_CALL_JID(p);
			else if (!_) f = o("WAWap").DEVICE_JID(o("WAJids").unsafeCoerceToDeviceJid(l)), yield o("WAWebManageE2ESessionsJob").ensureE2ESessions({
				identityChanged: !1,
			...
			var y = Date.now(), v = g.tag, S = function(t) {
			...
			if (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
				...
				" callStanzaRecipient = ",
				""
			])), v, S(p.toJid()), S(f.toString())), v === "reject" && !p.isGroupCall()) {
				var L = o("WAWebVoipWapNodeUtils").toVoipParsableWapNode(d), E = L.maybeAttrString("call-creator");
				if (E != null) try {
					var k = o("WAWebWidFactory").createWid(f.toString()), I = o("WAWebWidFactory").createWid(E);
					k.server !== I.server && o("WALogger").WARN(u || (u = babelHelpers.taggedTemplateLiteralLoose([
						"voip: reject stanza domain mismatch: peer=",
						" recipient=",
						" creatorDomain=",
						""
					])), S(l), S(f.toString()), I.server);
				} catch (e) {}
			}
			var T = o("WAWap").generateId(), D = o("WAWap").wap("call", {
				to: f,
				id: T
			}, g), x = yield o("WAWebDeprecatedSendIqWorkerCompatible").deprecatedSendStanzaAndReturnAck(D, o("WAWebCommsAckParser").toCoreAckTemplate({
				id: String(T),
				class: "call",
				from: p,
				participant: null
			})), $ = Date.now(), P = o("WAWebVoipWapNodeUtils").toVoipParsableWapNode(x), N = yield (C || (C = n("Promise"))).all([o("WAWebVoipPeerTcToken").fetchPeerTcToken(p), o("WAWebVoipStackInterface").getVoipStackInterface()]), M = N[0], w = N[1];
			d.tag === "offer" && o("WAWebVoipGatingUtils").markCurrentCallAsFna(o("WAWebVoipGatingUtils").hasFnaRelay(P)), yield w == null ? void 0 : w.handleIncomingSignalingAck({
				ackInfoError: (r = P.maybeAttrString("error")) != null ? r : "0",
			...
			var A = Date.now() - i;
			A > 100 && o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose([
				"voip: [SignalingPerf] ",
				": total=",
				"ms, decode=",
				"ms, e2e+encrypt=",
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			return o("WAWebVoipWapNodeUtils").replaceVoipWapChild(e, c), f && (yield x(e)), [o("WAWap").DEVICE_JID(o("WAJids").unsafeCoerceToDeviceJid(o("WAWebWidFactory").createDeviceWidFromUserAndDevice(a.user, t.endsWith("lid") ? "lid" : "c.us", (n = a.device) != null ? n : o("WAJids").DEFAULT_DEVICE_ID).toJid())), e];
	...
	function k() {
		return k = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, r) {
			...
			var a = o("WAWebVoipWapNodeUtils").getVoipWapChild(e, "destination"), i = t.child("destination"), l = i.mapChildren(function(e) {
			...
			var u = !1, c = !1;
			return yield o("WAWebVoipWapNodeUtils").mapVoipWapChildrenAsync(a, (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, n) {
					...
					if (r.hasChild("enc")) {
						...
						try {
							var s, d, m = yield T({
								callKeyProtobuf: a,
								count: (s = (d = t.maybeChild("enc")) == null ? void 0 : d.maybeAttrInt("count")) != null ? s : 0,
								deviceWid: i,
								shouldFlush: !1
							}), p = m.encNode, _ = m.shouldHaveIdentity;
							return c || (c = _), o("WAWebVoipWapNodeUtils").replaceVoipWapChild(e, p), e;
						} catch (e) {
			...
			})()), u ? (o("WALogger").WARN(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip:encryptMsgCallKey: Removing all enc nodes due to encryption failure"]))), o("WAWebVoipWapNodeUtils").mapVoipWapChildren(a, function(e) {
				return o("WAWebVoipWapNodeUtils").filterVoipWapNodeChildren(e, function(e) {
					return e.tag !== "enc";
				});
			})) : (yield o("WAWebSignalProtocolStore").getSignalProtocolStore().flushBufferToDiskIfNotMemOnlyMode(), c && (yield x(e))), [o("WAWebCommsWapMd").USER_JID(r), e];
	...
	function D() {
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.callKeyProtobuf, n = e.count, r = e.deviceWid, a = e.shouldFlush, i = a === void 0 ? !0 : a, l = Date.now(), s = yield o("WAWebSignal").Cipher.encryptSignalProto(r, o("WAWebSendMsgCommonApi").encodeAndPad(t)), u = s.ciphertext, c = s.type, d = Date.now();
			i && (yield o("WAWebSignalProtocolStore").getSignalProtocolStore().flushBufferToDiskIfNotMemOnlyMode()), o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose([
			...
			return {
				encNode: m,
				shouldHaveIdentity: c === o("WAWebBackendJobs.flow").CiphertextType.Pkmsg && P()
			};
