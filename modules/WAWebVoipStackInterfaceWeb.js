		...
		return {
			...
			voipInit: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
					...
					})) : o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["voip: [WebTransport] SCTP fallback disabled (abprop off) — no handler registered"])))), o("WAWebVoipStorageInit").initVoipStorageAndMLCache(r);
					var a = !1, s = !1;
					try {
						yield o("WAWebVoipVideoRendererRegistry").videoRendererRegistry.init();
						...
						var b = o("WAWebABProps").getABPropConfigValue("enable_webcodec_video_encode"), v = a || (yield o("WAWebVoipVideoWebCodecsRenderer").WAWebVoipVideoWebCodecsRenderer.checkAvailability());
						s = !o("WAWebUA").UA.isFirefox && v && b === !0 ? yield o("WAWebVoipWebCodecsEncoderState").checkEncoderSupport() : !1;
					} catch (e) {
					...
					o("WALogger").LOG(_ || (_ = babelHelpers.taggedTemplateLiteralLoose([
						...
						" ptEnc=",
						""
					])), a, s), o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose(["voip: [webcodec-encode] enabled=", ""])), s), o("WAWebVoipWebCodecsEncoderState").setWebCodecsEncoderEnabled(s), o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["voip: [webcodec-encode] WebCodecs encoder state ", ""])), s), yield o("WAWebReleaseToEventLoop").releaseToEventLoop(), o("WAWebVoipQplHelpers").voipInitQplAddPoint(o("WAWebVoipQplHelpers").VoipInitQplPoint.VOIP_STACK_INIT_START);
					try {
						o("WAWebVoipStackInterfaceWebHelpers").setABPropsOnWasm(r), r.setABPropBool("enable_passthrough_video_decoder", a), r.setABPropBool("enable_webcodec_video_encode", s), o("WAWebLowEndDeviceExperimentGating").shouldDisableSoftwareAudioProcessing() && (r.setABPropBool("ns_builtin_available", !0), r.setABPropBool("disable_sw_ns_when_builtin_available", !0), r.setABPropBool("ml_ns_skip_processing", !0), r.setABPropBool("disable_agc", !0), r.setABPropBool("hw_aec_available", !0), r.setABPropBool("disable_sw_ec_when_builtin_available", !0), r.setABPropBool("disable_standalone_agc", !0), r.setABPropBool("disable_eq", !0)), r.initVoipStack(e, t, n);
					} catch (e) {
						throw o("WAWebVoipNativeStackTraceLogger").logNativeStackTrace(r, e), e;
					} finally {
						o("WAWebVoipQplHelpers").voipInitQplAddPoint(o("WAWebVoipQplHelpers").VoipInitQplPoint.VOIP_STACK_INIT_END);
					}
					o("WAWebVoipWasmHeapMonitor").logWasmHeapSnapshot(r, "voip_stack_init"), o("WAWebVoipPerfOptimizations").isPerfOptimizationEnabled(o("WAWebVoipPerfOptimizations").PerfOptimizationFlag.LOG_RING_BUFFER) && o("WAWebVoipLogDrainer").startLogDrainer(r);
					var S = r.getWebP2PVirtualIpv4(), R = r.getWebP2PVirtualIpv6(), L = r.getWebP2PVirtualPort();
					o("WAWebVoipP2PConnectionManager").initP2PVirtualAddresses(S, R, L), o("WAWebVoipP2PConnectionManager").registerOnDataChannelMessage(function(e) {
						var t = new Uint8Array(e), n = o("WAWebVoipWasmHeapBuffer").ensureHeapBuffer(r, i, t.byteLength);
						r.GROWABLE_HEAP_U8().set(t, n), r.handleOnMessageFromHeap(n, t.byteLength, S, L);
					});
					var E = !1;
					o("WAWebVoipP2PConnectionManager").registerOnDataChannelStateChange(function(e) {
						e === o("WAWebVoipRelayConnectionUtils").ConnectionState.Open ? (E = !0, o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip: P2P DataChannel opened, notifying WASM active=true"]))), r.notifyWebP2PChannelReady(!0, !1)) : E && (E = !1, o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose(["voip: P2P DataChannel state changed to ", " after being open, notifying WASM active=false"])), e), r.notifyWebP2PChannelReady(!1, !1));
					});
				});
				function t(t, n, r) {
			...
			setHideMyIp: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					o("WALogger").LOG(C || (C = babelHelpers.taggedTemplateLiteralLoose(["voip: setHideMyIp called with hideMyIp=", ""])), e);
					var t = yield l;
					t.setHideMyIp(e);
				});
				function t(t) {
			...
			startCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a, i, s) {
					o("WAWebVoipGatingUtils").markCurrentCallAsGroup(!1);
					var u = yield l;
					o("WAWebBweMLModelManager").initBweMLModelsForCall(u).catch(function(e) {
			...
			startGroupCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a, i, s, u, c, d, m, p, _) {
					...
					var f = yield l;
					o("WAWebBweMLModelManager").initBweMLModelsForCall(f).catch(function(e) {
					...
					var C = f.startVoipGroupCall(g, h, y, r, a, i, s, u, c, d, m != null ? m : 0, p != null ? p : 0, _ != null ? _ : "");
			...
			acceptCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
					...
					try {
						...
						throw o("WAWebVoipNativeStackTraceLogger").logNativeStackTrace(n, e), e;
					}
				});
				function t(t, n) {
					return e.apply(this, arguments);
			...
			rejectCallWithoutCallContext: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, o, a, i) {
					var s = yield l;
			...
			joinOngoingCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i, s, u, c, d, m, p, _, f, g, h, y, C) {
					if (o("WAWebVoipGatingUtils").markCurrentCallAsGroup(!0), !o("WAWebVoipGatingUtils").isGroupCallingEnabled()) {
						o("WALogger").ERROR(E || (E = babelHelpers.taggedTemplateLiteralLoose(["voip: joinOngoingCall: Web group calling is not enabled"])));
						return;
					}
					var b = yield l, v = new b.StringList();
					...
					try {
						var L = b.joinVoipOngoingCall(e, t, n, v, S, R, u, c, d, m, p, _, f, g, h, y != null ? y : 0, C != null ? C : !1);
			...
			previewCallLink: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a) {
					...
					var i = 22;
					if (e.length !== i) return o("WALogger").ERROR(T || (T = babelHelpers.taggedTemplateLiteralLoose([
					...
					var s = yield l;
					try {
						var u = s.previewCallLink(e, t, n != null ? n : 0, r != null ? r : "", a != null ? a : !1);
			...
			previewAndJoinCallLink: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a, i) {
					...
					var s = yield l;
					try {
						o("WAWebBweMLModelManager").initBweMLModelsForCall(s).catch(function(e) {
							o("WALogger").WARN(N || (N = babelHelpers.taggedTemplateLiteralLoose(["voip: [initBweMLModelsForCall] unhandled error: ", ""])), e);
						});
						var u = s.previewAndJoinCallLink(e, t, n != null ? n : 0, r != null ? r : "", a != null ? a : !1, i != null ? i : "");
			...
			handleIncomingSignalingOffer: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i, s, u, c, d) {
					var m = yield l;
					o("WAWebBweMLModelManager").initBweMLModelsForCall(m).catch(function(e) {
					...
					var _ = o("WABase64").encodeB64(o("WAWap").encodeStanza(p)), f = H(m, d), g = a != null ? String(a) : "0", h = i != null ? String(i) : "0";
					try {
						m.handleIncomingSignalingOffer(_, t, n, g, h, s, u, c, f);
					} catch (e) {
						throw o("WAWebVoipNativeStackTraceLogger").logNativeStackTrace(m, e), e;
					}
				});
			...
			handleIncomingSignalingMessage: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a, i, s, u) {
					var c = yield l, d = o("WABase64").encodeB64(o("WAWap").encodeStanza(e.node())), m = H(c, u), p = r != null ? String(r) : "0", _ = a != null ? String(a) : "0";
					try {
						c.handleIncomingSignalingMessage(d, t, n, p, _, i, s, m);
					} catch (e) {
						throw o("WAWebVoipNativeStackTraceLogger").logNativeStackTrace(c, e), e;
					}
				});
			...
			handleIncomingSignalingAck: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = e.ackInfoError, n = e.ackInfoType, a = e.peerJid, i = e.tcToken, s = e.xmlNode, u = yield l, c = s.node();
			...
			handleIncomingSignalingReceipt: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
					var r = yield l, a = o("WABase64").encodeB64(o("WAWap").encodeStanza(e.node())), i = H(r, n);
					try {
			...
			handleOnTransportMessage: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
					var r = V != null ? V : yield l, a = new Uint8Array(e), s = o("WAWebVoipWasmHeapBuffer").ensureHeapBuffer(r, i, a.byteLength);
					s !== 0 && (r.GROWABLE_HEAP_U8().set(a, s), r.handleOnMessageFromHeap(s, a.byteLength, t, n));
				});
				function t(t, n, r) {
					return e.apply(this, arguments);
				}
			...
			setCallMute: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield l, n = t.setCallMute(e);
					return n;
				});
				function t(t) {
					return e.apply(this, arguments);
			...
			setCallVideoMute: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield l, n = t.setCallVideoMute(e);
					return n;
				});
				function t(t) {
					return e.apply(this, arguments);
			...
			videoStreamPause: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = yield l, t = e.videoStreamPause();
					return t;
				});
				function t() {
					return e.apply(this, arguments);
			...
			videoStreamResume: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = yield l, t = e.videoStreamResume();
					return t;
				});
				function t() {
					return e.apply(this, arguments);
			...
			broadcastVideoState: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = yield l, t = e.broadcastVideoState();
					return t;
				});
				function t() {
					return e.apply(this, arguments);
			...
			notifyUiViewChange: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
					var n = yield l, r = n.notifyUiViewChange(e, t != null ? t : "");
					return r;
				});
				function t(t, n) {
					return e.apply(this, arguments);
			...
			requestVideoUpgrade: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = yield l, t = e.requestVideoUpgrade();
					return t;
				});
				function t() {
					return e.apply(this, arguments);
			...
			acceptPeerVideo: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = e.jid, n = yield l, r = n.acceptPeerVideo(t);
			...
			requestPeerMute: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield l, n = t.requestPeerMute(e);
					return n;
				});
				function t(t) {
					return e.apply(this, arguments);
			...
			removeCallParticipant: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield l, n = t.removeCallParticipant(e);
					return n;
				});
				function t(t) {
					return e.apply(this, arguments);
			...
			waitingRoomAdmit: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield l, n = t.waitingRoomAdmit(e);
					return n;
				});
				function t(t) {
					return e.apply(this, arguments);
			...
			waitingRoomDeny: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield l, n = t.waitingRoomDeny(e);
					return n;
				});
				function t(t) {
					return e.apply(this, arguments);
			...
			waitingRoomAdmitAll: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = yield l, t = e.waitingRoomAdmitAll();
					return t;
				});
				function t() {
					return e.apply(this, arguments);
			...
			waitingRoomToggleActiveCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield l, n = t.waitingRoomToggleActiveCall(e);
					return n;
				});
				function t(t) {
					return e.apply(this, arguments);
			...
			updateParticipantsRxSubscription: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
					var n = yield l, r = new n.StringList();
					e.forEach(function(e) {
						r.push_back(e);
					});
					var o = new n.IntList();
			...
			startScreenShare: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = yield l, t = e.startScreenShare();
					return t;
				});
				function t() {
					return e.apply(this, arguments);
			...
			stopScreenShare: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var e = yield l, t = e.stopScreenShare();
					return t;
				});
				function t() {
					return e.apply(this, arguments);
			...
			startVideoPreview: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
					var n = yield l, r = n.startVideoPreview(e, t);
					return r;
				});
				function t(t, n) {
					return e.apply(this, arguments);
			...
			requestKeyFrame: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = yield l, n = o("WAWebVoipScreenShareStreamKey").getBaseJidFromStreamKey(e), r = o("WAWebVoipScreenShareStreamKey").isScreenShareStreamKey(e), a = r ? t.requestAuxiliaryKeyFrame(n) : t.requestKeyFrame(n);
					return a;
				});
				function t(t) {
					return e.apply(this, arguments);
			...
			updateNetworkMedium: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
					var n = yield l;
					n.updateNetworkMedium(e, 0), o("WALogger").LOG(O || (O = babelHelpers.taggedTemplateLiteralLoose(["voip: updateNetworkMedium: medium=", ", mtu=0"])), e);
				});
				function t(t, n) {
					return e.apply(this, arguments);
				}
			...
			getNetworkConditionerState: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					try {
						var e = yield l, t = e.isTxNetworkConditionerOn(), n = e.isRxNetworkConditionerOn(), r = null, o = null;
			...
			getVoipParam: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					try {
						var t = yield l, n = t.getVoipParam(e);
			...
			sendWebP2PTransport: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, o, a) {
					var i = yield l, s = JSON.stringify(a);
			...
			inviteToCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
					var r = yield l, o = new r.StringList();
					n.forEach(function(e) {
