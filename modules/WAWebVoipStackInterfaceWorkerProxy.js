__d("WAWebVoipStackInterfaceWorkerProxy", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $, P, N, M, w, A, F, O, B, W, q, U, V, H, G, z, j, K;
	function Q() {
		var t = {};
	...
	var X = 9e4, Y = 300 * 1e3, J = 45 * 1e3, Z = 600 * 1e3, ee = 9e4, te = 300 * 1e3;
	function ne() {
	...
	function ie() {
		var e, t = o("WAWebBackendApi").frontendSendAndReceive("initializeVoipWasm"), a = 0, i = null, l = !1;
		function ie(e, t, a) {
			return new (K || (K = (n("Promise"))))(function(n, i) {
				var l = !1, p = null, _ = !1, f = null, g = function() {
					...
					if (!l) {
						...
						var e = n === "foreground" ? "foreground timeout" : "absolute timeout";
						o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose([
							...
							"ms ",
							""
						])), t, e, u.wallMs.toFixed(1), u.visibleMs.toFixed(1), ne()), i(r("err")("voip: [WorkerProxy] timeout waiting for RPC ready (token=" + t + ", reason=" + e + ")"));
					}
				}, C = function(n) {
					o("WAWebCoreActionsODS").logCallVoipRpcReadyHiddenGraceStarted(), o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose([
						...
						"ms ",
						""
					])), t, n.wallMs.toFixed(1), ne()), f = o("WAWebVisibilityAwareTimeout").startVisibilityAwareTimeout({
						foregroundMs: J,
						absoluteMs: Z,
				...
				p = e.worker.addMessageListener("voipRpcReady", function(e) {
					if (e.token === t && !l) {
						l = !0;
						var r = b.cancel();
						g(), _ && o("WAWebCoreActionsODS").logCallVoipRpcReadyHiddenGraceRecovered(), h(), r.wasBackgroundPaused && o("WAWebCoreActionsODS").logCallVoipRpcReadyBackgroundPauseSuccess(), o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose([
							"voip: [WorkerProxy] RPC ready ack token=",
							" wallElapsed=",
							"ms visibleElapsed=",
							"ms ",
							""
						])), t, r.wallMs.toFixed(1), r.visibleMs.toFixed(1), ne()), n();
					}
				});
			});
		}
		function le() {
			...
			var s = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				var n = yield r("WAWebVoipJsWorkerThread").create(e).finally(function() {
				...
				var i = new MessageChannel(), s = new (o("WAWebVoipMessagePortRpc")).MessagePortRpc(i.port1);
				s.start(), o("WAWebVoipQplHelpers").voipInitQplAddPoint(o("WAWebVoipQplHelpers").VoipInitQplPoint.RPC_SETUP_START);
				var u = a++, c = ie(n, u, s);
				o("WALogger").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose([
					"voip: [WorkerProxy] posting startVoipRpc token=",
					" ",
					""
				])), u, ne()), n.worker.postMessage({
					type: "cmd",
					cmd: "jsWorkerCmd",
				...
				try {
					...
					throw s.close("RPC ready failure"), o("WAWebCoreActionsODS").logCallVoipRpcReadyCleanupShutdownAttempted(), n.shutdown().catch(function(e) {
				...
				return o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose(["voip: [WorkerProxy] RPC channel ready"]))), l && (l = !1, o("WAWebCoreActionsODS").logCallVoipRpcReadyRetrySuccess()), {
					jsWorker: n,
					rpc: s
				};
			})();
			return i = s, s.catch(function(e) {
				i === s && (i = null, l = !0, o("WALogger").WARN(y || (y = babelHelpers.taggedTemplateLiteralLoose([
		...
		function ue() {
			return ue = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				var r = yield le(), o = r.rpc;
				o.fire(e, t, n);
		...
		function de() {
			return de = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				var r = yield le(), o = r.rpc;
		...
		function pe() {
			return pe = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
				var r = yield le(), a = r.rpc;
		...
		function _e(e) {
			var t = i;
			t != null && (i = null, l = !0, o("WAWebVoipLogDrainer").stopLogDrainer(), o("WALogger").WARN(C || (C = babelHelpers.taggedTemplateLiteralLoose([
				"voip: [WorkerProxy] cleared worker lifecycle after init failure: ",
				" ",
				""
			])), String(e), ne()), t.then(function(e) {
		...
		return {
			...
			voipInit: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, n, r) {
					var a = yield le(), i = a.rpc, l = yield t;
					...
					try {
						...
						var d = o("WAWebABProps").getABPropConfigValue("enable_webcodec_video_encode"), m = s || (yield o("WAWebVoipVideoWebCodecsRenderer").WAWebVoipVideoWebCodecsRenderer.checkAvailability());
						u = !o("WAWebUA").UA.isFirefox && m && d === !0 ? yield o("WAWebVoipWebCodecsEncoderState").checkEncoderSupport() : !1;
					} catch (e) {
					...
					o("WAWebVoipP2PConnectionManager").registerOnDataChannelStateChange(function(e) {
						e === o("WAWebVoipRelayConnectionUtils").ConnectionState.Open ? (h = !0, o("WALogger").LOG(D || (D = babelHelpers.taggedTemplateLiteralLoose(["voip: P2P DataChannel opened, notifying WASM active=true"]))), se("notifyWebP2PChannelReady", {
							active: !0,
							useIPv6: !1
						})) : h && (h = !1, o("WALogger").LOG(x || (x = babelHelpers.taggedTemplateLiteralLoose(["voip: P2P DataChannel ", " (was open), WASM active=false"])), e), se("notifyWebP2PChannelReady", {
							active: !1,
							useIPv6: !1
						}));
					});
			...
			setHideMyIp: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					o("WALogger").LOG($ || ($ = babelHelpers.taggedTemplateLiteralLoose(["voip: setHideMyIp called with hideMyIp=", ""])), e), yield me("setHideMyIp", { hideMyIp: e });
				});
				function t(t) {
					return e.apply(this, arguments);
				}
			...
			handleSignOut: function() {
				if (o("WALogger").LOG(P || (P = babelHelpers.taggedTemplateLiteralLoose(["voip: handleSignOut: cleaning up all connections"]))), l = !1, o("WAWebVoipLogDrainer").stopLogDrainer(), o("WAWebVoipGatingUtils").isWebTransportEnabled() ? o("WAWebVoipWebTransportConnectionManager").closeAllConnections() : (o("WAWebVoipWebTransportConnectionManager").closeAllConnections(), o("WAWebVoipSctpConnectionManager").cleanupAllConnections()), o("WAWebVoipTransportFallbackTracker").finalizeFallbackOutcome(), o("WAWebVoipTransportFallbackTracker").resetFallbackTracker(), o("WAWebVoipGatingUtils").resetWebTransportFallbackState(), i != null) {
					var e = i;
					i = null, e.then(function(e) {
						var t = e.jsWorker, n = e.rpc;
			...
			startCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, n, r, a, i, l, s) {
			...
			startGroupCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, n, r, a, i, l, s, u, c, d, m, p, _) {
					...
					o("WAWebVoipLobbyEntryPointStore").setLobbyEntryPoint(p != null ? p : null, a);
					var f = yield t;
			...
			acceptCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
					o("WAWebVoipLobbyEntryPointStore").resetLobbyEntryPoint(), yield se("acceptCall", {
						isMicEnabled: e,
						isCameraEnabled: t
					});
				});
			...
			joinOngoingCall: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a, i, l, s, u, c, d, m, p, _, f, g, h) {
					if (o("WAWebVoipGatingUtils").markCurrentCallAsGroup(!0), !o("WAWebVoipGatingUtils").isGroupCallingEnabled()) {
						o("WALogger").ERROR(F || (F = babelHelpers.taggedTemplateLiteralLoose(["voip: joinOngoingCall: Web group calling is not enabled"])));
						return;
					}
					o("WAWebVoipLobbyEntryPointStore").setLobbyEntryPoint(g != null ? g : null, e), yield se("joinOngoingCall", {
						callId: e,
						callCreatorJid: t,
						initialPeerJid: n,
			...
			previewCallLink: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, r, a) {
					...
					var i = 22;
					if (e.length !== i) return o("WALogger").ERROR(B || (B = babelHelpers.taggedTemplateLiteralLoose([
						"voip: previewCallLink: invalid token length ",
						", expected ",
						""
					])), e.length, i), -1;
					o("WAWebVoipLobbyEntryPointStore").setLobbyEntryPoint(n != null ? n : null, null);
			...
			previewAndJoinCallLink: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, n, r, a, i, l) {
					if (!o("WAWebVoipGatingUtils").callLinksEnabled()) {
			...
			handleIncomingSignalingOffer: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, n, a, i, l, s, u, c, d) {
					var m = yield t;
					...
					var _ = o("WABase64").encodeB64(o("WAWap").encodeStanza(p)), f = i != null ? String(i) : "0", g = l != null ? String(l) : "0";
			...
			handleIncomingSignalingMessage: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n, a, i, l, s, u) {
					var c = e.node();
					r("justknobx")._("360") && o("WAWebVoipRelayOverrides").overrideRelayIp(c);
					var d = o("WABase64").encodeB64(o("WAWap").encodeStanza(c)), m = a != null ? String(a) : "0", p = i != null ? String(i) : "0";
			...
			handleIncomingSignalingAck: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = e.ackInfoError, n = e.ackInfoType, a = e.peerJid, i = e.tcToken, l = e.xmlNode, s = l.node();
			...
			handleIncomingSignalingReceipt: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
					var a = e.node();
					r("justknobx")._("360") && o("WAWebVoipRelayOverrides").overrideRelayIp(a);
			...
			handleOnTransportMessage: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
					yield se("handleOnTransportMessage", {
						packet: e,
						ip: t,
						port: n
					}, [e]);
			...
			acceptPeerVideo: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					...
					return t !== 0 && o("WALogger").ERROR(z || (z = babelHelpers.taggedTemplateLiteralLoose(["voip: acceptPeerVideo: Failed with status ", ""])), String(t)), Number(t);
				});
				function t(t) {
					return e.apply(this, arguments);
				}
			...
			startVideoPreview: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
					var n = yield ce("startVideoPreview", {
						callId: e,
						selfJid: t
					});
					return Number(n);
			...
			requestKeyFrame: (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					var t = o("WAWebVoipScreenShareStreamKey").getBaseJidFromStreamKey(e), n = yield ce(o("WAWebVoipScreenShareStreamKey").isScreenShareStreamKey(e) ? "requestAuxiliaryKeyFrame" : "requestKeyFrame", { userJid: t });
					return Number(n);
				});
				function t(t) {
					return e.apply(this, arguments);
