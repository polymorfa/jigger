__d("WAWebVoipStatsTracker", [], (function(t, n, r, o, a, i) {
	"use strict";
	var e = 1e4;
	function l(e) {
		return {
	...
	var s = (function() {
		...
		var t = e.prototype;
		return t.record = function(t, n) {
			var e = this.$1.get(t);
			e == null ? this.$1.set(t, l(n)) : (e.min = Math.min(e.min, n), e.max = Math.max(e.max, n), e.total += n, e.samples++);
			...
			return "min=" + e.min + ", max=" + e.max + ", avg=" + n + ", samples=" + e.samples;
			...
			return t.samples + " samples, min=" + t.min + ", max=" + t.max + ", avg=" + n;
		}, t.resetAll = function() {
			for (var e of this.$1.values()) e.min = 1 / 0, e.max = 0, e.total = 0, e.samples = 0;
		}, t.remove = function(t) {
			this.$1.delete(t);
		}, t.clear = function() {
			this.$1.clear();
			...
			var e = this;
			this.$3 == null && (this.$2 = t, this.$3 = globalThis.setInterval(function() {
				t.onInterval(e), t.resetPerInterval === !0 && e.resetAll();
			}, t.intervalMs));
		}, t.stopPolling = function() {
			this.$3 != null && (globalThis.clearInterval(this.$3), this.$3 = null), this.$2 = null;
