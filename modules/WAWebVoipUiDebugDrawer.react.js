__d("WAWebVoipUiDebugDrawer.react", [
	...
	function h(t) {
		...
		var l = a, u = l.onBack, d;
		n[3] === Symbol.for("react.memo_cache_sentinel") ? (d = s._(
			/*BTDS*/
			""
		), n[3] = d) : d = n[3];
		var m;
		n[4] !== u ? (m = c.jsx(o("WAWebDrawerHeader.react").DrawerHeader, {
			title: d,
			onBack: u,
			type: o("WAWebDrawerHeader.react").DRAWER_HEADER_TYPE.SMALL
		}), n[4] = u, n[5] = m) : m = n[5];
		var p;
		n[6] === Symbol.for("react.memo_cache_sentinel") ? (p = c.jsxs(r("WAWebDrawerBody.react"), { children: [
			c.jsx(y, {
		...
		var _;
		return n[7] !== i || n[8] !== m ? (_ = c.jsxs(r("WAWebDrawer.react"), {
			ref: i,
			theme: "settings",
			testid: "voip-ui-debug-drawer",
			children: [m, p]
		}), n[7] = i, n[8] = m, n[9] = _) : _ = n[9], _;
	}
	function y(e) {
		var t, a, i = e.isGroupCall, l = i === void 0 ? !1 : i, u = e.isVideoCall, d = e.title, h = r("useWAWebEventTargetValue")(r("WAWebCallCollection"), o("WAWebVoipEventConstants").getChangeEvent(o("WAWebVoipEventConstants").VoipCallCollectionEvents.ACTIVE_CALL), function() {
			return r("WAWebCallCollection").activeCall != null;
		}), y = p(null), v = y[0], S = y[1], R = p(null), L = R[0], E = R[1], k = p(f), I = k[0], T = k[1], D = r("useWAWebStableCallback")(function() {
			L != null && o("WAWebMsgCollection").MsgCollection.remove(L.id), r("WAWebCallCollection").setActiveCall(null), E(null), S(null);
		});
		m(function() {
			return function() {
				D();
			...
			var e = l ? o("WAWebVoipWaCallEnums").CallState.CallActive : o("WAWebVoipWaCallEnums").CallState.Calling;
			if (v !== e) return;
			var t = null;
			function a() {
			...
			function i() {
				return i = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					...
					if (e.length !== 0) {
						...
						t = a.id, o("WAWebMsgCollection").MsgCollection.add([a]), E(a);
						var i = new (r("WAWebCallModel"))();
						if (i.id = a.id.id, i.peerJid = n.contact.id, i.isVideo = u, i.isGroup = l, i.groupJid = null, i.msg = a, l) {
							var s = e.map(function(e) {
								return e.contact.id;
							});
							i.groupCallParticipantsConnected = s;
						}
						o("WAWebVoipUiManager").setupVoipActiveCallChangeListener(), r("WAWebCallCollection").setActiveCall(i), i.setState(l ? o("WAWebVoipWaCallEnums").CallState.CallActive : r("nullthrows")(v));
					}
				}), i.apply(this, arguments);
			}
			return a(), function() {
				t != null && v == null && (o("WAWebMsgCollection").MsgCollection.remove(t), r("WAWebCallCollection").setActiveCall(null));
			};
		}, [
			v,
			u,
			...
			if (v != null && r("WAWebCallCollection").activeCall) {
				var e;
				S((e = r("WAWebCallCollection").activeCall) == null ? void 0 : e.getState());
			}
		});
		var x = r("useWAWebStableCallback")(function() {
			...
			if (!(t == null || !l)) {
				...
				if (!(n.length >= g)) {
					...
					if (a != null) {
						var i = [].concat(n, [a]);
						t.groupCallParticipantsConnected = i, t.trigger(o("WAWebVoipEventConstants").getChangeEvent(o("WAWebVoipEventConstants").VoipCallModelEvents.GROUP_CALL_PARTICIPANTS_CONNECTED)), T(i.length);
					}
				}
			}
			...
			if (!(t == null || !l)) {
				...
				if (!(n.length <= 1)) {
					var a = n.slice(0, -1);
					t.groupCallParticipantsConnected = a, t.trigger(o("WAWebVoipEventConstants").getChangeEvent(o("WAWebVoipEventConstants").VoipCallModelEvents.GROUP_CALL_PARTICIPANTS_CONNECTED)), T(a.length);
				}
			}
		});
		if (v == null) {
			if (l) {
				...
				return c.jsx("div", {
					...
					children: c.jsxs((P = o("WAWebFlex.react")).FlexColumn, {
						gap: 12,
						children: [
							c.jsx(P.FlexItem, { children: c.jsx("span", {
								className: "x117nqv4",
								children: d
							}) }),
							c.jsx(P.FlexItem, { children: s._(
								/*BTDS*/
								""
							) }),
							c.jsxs(P.FlexRow, {
								...
								children: [c.jsx(o("WAWebSelect.react").Select, {
									...
									onClick: function() {
										return S(o("WAWebVoipWaCallEnums").CallState.CallActive);
									},
									disabled: h,
									children: s._(
										/*BTDS*/
		...
		var N = (t = (a = r("WAWebCallCollection").activeCall) == null || (a = a.groupCallParticipantsConnected) == null ? void 0 : a.length) != null ? t : I;
		return c.jsx("div", {
			className: "xso031l x1q0q8m5 x120ee7l x16ovd2e x12xbjc7 xb0esv5 x1nzty39",
			children: c.jsxs(o("WAWebFlex.react").FlexColumn, {
				gap: 12,
				children: [
					...
					l && c.jsxs(c.Fragment, { children: [c.jsx(o("WAWebFlex.react").FlexItem, { children: s._(
						/*BTDS*/
						"",
						[s._param("count", N)]
