__d("WAWebVoipUiDocPipLoadable", [
	...
	var e, s = e || (e = o("react")), u = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebVoipUiDocPip.react").__setRef("WAWebVoipUiDocPipLoadable").load();
		return e.WAWebVoipUiDocPip;
	}), "WAWebVoipUiDocPip"), c = r("WAWebLoadable")({
		loader: u,
		loading: function(t) {
