__d("WAWebVoipUiPopoutWindowPortalHelpers", [
	...
	var I = r("WAWebLazyLoadedRetriable")(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
		var e = yield r("JSResourceForInteraction")("WAWebVoipVideoCameraCapture").__setRef("WAWebVoipUiPopoutWindowPortalHelpers").load();
		...
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			if (((n = r("WAWebCallCollection").activeCall) == null ? void 0 : n.id) === t) {
				...
				if (((o = r("WAWebCallCollection").activeCall) == null ? void 0 : o.id) === t) {
					...
					l == null || l === "" || s == null || u == null || (yield i.startCameraCapture({
	...
	l.POPOUT_WINDOW_CALL_END_CLOSE_DELAY_MS = f, l.SAFARI_POPOUT_CLOSE_POLL_INTERVAL_MS = g, l.STREAM_REACQUISITION_POLL_INTERVAL_MS = h, l.STREAM_REACQUISITION_TIMEOUT_MS = y, l.setMediaStream = v, l.clearActiveStreams = S, l.getStreamsFromPopout = L, l.primeSafariMediaPermissions = E, l.reacquireCameraInTargetWindow = T, l.reacquireCameraReusingStreamForPopout = x, l.emitPopoutWindowVisibilityChanged = P;
}), 98);
