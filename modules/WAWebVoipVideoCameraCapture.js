__d("WAWebVoipVideoCameraCapture", [
	...
	var ae = (function(e) {
		...
		var a = t.prototype;
		return a.startCameraCapture = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this, a = e.camera_id_requested, i = e.height, l = e.isAVUpgrade, s = e.max_fps, C = e.targetWindow, b = e.width;
				o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose([
					...
					" targetWindow=",
					""
				])), a, b, i, s, l, String(C != null)), this.__lastTargetWindow = C != null ? C : null;
				var v = a;
				if (r("isStringNullOrEmpty")(v)) {
					var S = o("WAWebUserPrefsVoip").getLandingPageVideoDeviceId();
					S != null && (v = S, o("WAWebUserPrefsVoip").clearLandingPageVideoDeviceId());
				}
				if (r("isStringNullOrEmpty")(v) && this.currentDeviceId != null && (v = this.currentDeviceId), r("isStringNullOrEmpty")(v)) {
					var R = o("WAWebUserPrefsVoip").getSelectedVideoInputDevice();
					R != null && (v = R);
				}
				var L = C != null ? C : o("WAWebUA").UA.isFirefox ? o("WAWebVoipPopoutWindowState").getPopoutWindow() : null;
				if (!r("isStringNullOrEmpty")(v)) try {
					var E = yield o("WAWebBackendApi").frontendSendAndReceive("getIsValidVideoDevice", {
						deviceId: v,
						targetWindow: L,
						isInActiveCall: !0
					});
					E || (o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[AV:startCameraCapture] device ", " no longer available, falling back to default"])), v), v = "");
				} catch (e) {
				...
				var k = null, I = (function() {
					var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
						if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
							var e = yield o("WAWebBackendApi").frontendSendAndReceive("voipAcquireMediaStream", {
								type: "camera",
								selectedDeviceId: v,
							...
							if (e == null) {
								...
								return (a == null ? void 0 : a.type) === "web" && (yield a.setCallVideoMute(!0)), null;
							}
							t.__lastCapturedStream = e, ne.add(e);
							var i = e.getVideoTracks().at(0);
							if (i != null) {
								var s, u = i.getSettings();
								u.deviceId != null && u.deviceId !== "" && (k = u.deviceId), o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose([
									...
									"x",
									""
								])), i.readyState, String(i.muted), String(i.enabled), (s = u.deviceId) != null ? s : "unknown", String(u.width), String(u.height));
							...
							return i == null || i.addEventListener("ended", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
								if (o("WAWebVoipPopoutWindowState").getIsCameraStreamReacquisitionInProgress() || t.__lastCapturedStream !== e) {
								...
								(n == null ? void 0 : n.type) === "web" && (yield n.setCallVideoMute(!0));
							})), e;
						}
				...
				yield this.__startCapture(babelHelpers.extends({
					getMediaStream: I,
					onVideoDataFnType: "onVideoDataFromJs"
				}, r("nullthrows")(this.captureParams)));
				var T = this.__lastCapturedStream;
				T != null && (o("WAWebVoipVideoRendererRegistry").videoRendererRegistry.resetFirstFrameReceivedForJid(o("WAWebVoipVideoRendererInterface").selfPreviewJid), this.__monitorFrameProduction(T));
				var D = k != null ? k : v;
				this.currentDeviceId !== D && (this.currentDeviceId = D, r("isStringNullOrEmpty")(D) || o("WAWebUserPrefsVoip").setSelectedVideoInputDevice(D), te.trigger("deviceSelectionChanged", [D]), o("WALogger").LOG(h || (h = babelHelpers.taggedTemplateLiteralLoose([
					"[AV:startCameraCapture] device changed: requested=",
					", actual=",
					""
				])), v, D)), o("WAWebUA").UA.isFirefox && C != null && (te.trigger("deviceListRefreshRequested", []), o("WALogger").LOG(y || (y = babelHelpers.taggedTemplateLiteralLoose(["[AV:startCameraCapture] Firefox popout camera capture ready, refreshing device list"]))));
			});
			function t(t) {
				return e.apply(this, arguments);
			}
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, a, i, l) {
				var s = this;
				if (l === void 0 && (l = !1), o("WALogger").LOG(C || (C = babelHelpers.taggedTemplateLiteralLoose([
					...
					" track=",
					""
				])), t, a, i, String(l)), this.captureParams = {
					width: t,
					height: a,
					maxFps: i
				}, this.__lastTargetWindow = null, yield this.__startCapture({
					...
					u != null && u !== e && ne.delete(u), this.__lastCapturedStream = e, ne.add(e);
					var c = e.getVideoTracks().at(0);
					c == null || c.addEventListener("ended", n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
						if (!(o("WAWebVoipPopoutWindowState").getIsCameraStreamReacquisitionInProgress() || s.__lastCapturedStream !== e)) {
							...
							try {
								...
								(t == null ? void 0 : t.type) === "web" && (yield t.setCallVideoMute(!0));
							} catch (e) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
				...
				if (o("WALogger").LOG(S || (S = babelHelpers.taggedTemplateLiteralLoose([
					...
					" switching to device: ",
					""
				])), n, e), !(yield this.__ensureRestartableForSwitch(n))) return !1;
				var r = this.captureParams;
				if (r == null) return o("WALogger").ERROR(R || (R = babelHelpers.taggedTemplateLiteralLoose(["", " capture params not available"])), n), !1;
				var a = yield o("WAWebBackendApi").frontendSendAndReceive("getIsValidVideoDevice", {
					deviceId: e,
					targetWindow: t,
					isInActiveCall: !0
				});
				...
				try {
					yield this.__cleanup(), yield this.startCameraCapture({
					...
					if (o("WALogger").ERROR(E || (E = babelHelpers.taggedTemplateLiteralLoose(["voip: [AV:switchVideoDevice] error switching device: ", ""])), e), i != null && i !== "") {
						...
						try {
							...
							l != null && (yield this.startCameraCapture({
				...
				return o("WALogger").LOG(T || (T = babelHelpers.taggedTemplateLiteralLoose(["[AV:switchVideoDevice] switched to: ", ""])), e), !0;
			});
			function t(t, n) {
				return e.apply(this, arguments);
			}
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				if (this.captureInitState === o("WAWebVoipVideoCaptureBase").CaptureInitState.Initializing && this.captureInitResolvable != null) {
					...
					o("WALogger").LOG(D || (D = babelHelpers.taggedTemplateLiteralLoose(["", " capture still initializing, waiting for ready"])), e);
					var n = !1;
					try {
						yield t.promise;
					} catch (t) {
						n = !0, o("WALogger").ERROR(x || (x = babelHelpers.taggedTemplateLiteralLoose(["", " capture initialization failed while waiting"])), e);
					}
					if (this.captureInitResolvable !== t) return o("WALogger").LOG($ || ($ = babelHelpers.taggedTemplateLiteralLoose(["", " capture init resolvable changed while waiting, aborting switch"])), e), !1;
					if (!n && this.captureInitState !== o("WAWebVoipVideoCaptureBase").CaptureInitState.Ready) return o("WALogger").LOG(P || (P = babelHelpers.taggedTemplateLiteralLoose(["", " capture not ready after init wait, aborting switch"])), e), !1;
					n && o("WALogger").LOG(N || (N = babelHelpers.taggedTemplateLiteralLoose(["", " continuing switch after failed capture initialization"])), e);
				}
				return this.captureInitState !== o("WAWebVoipVideoCaptureBase").CaptureInitState.Ready && this.captureInitState !== o("WAWebVoipVideoCaptureBase").CaptureInitState.Error && this.captureInitState !== o("WAWebVoipVideoCaptureBase").CaptureInitState.Uninitialized ? (o("WALogger").ERROR(M || (M = babelHelpers.taggedTemplateLiteralLoose([
					...
					""
				])), e, this.captureInitState), !1) : (this.captureInitState !== o("WAWebVoipVideoCaptureBase").CaptureInitState.Ready && o("WALogger").LOG(w || (w = babelHelpers.taggedTemplateLiteralLoose([
					"",
					" restarting capture from state: ",
					""
				])), e, this.captureInitState), !0);
			});
			function t(t) {
				return e.apply(this, arguments);
			}
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var n;
				t === void 0 && (t = !1), this.__stopping = !0, (n = this.__frameMonitorCleanup) == null || n.call(this), this.__frameMonitorCleanup = null;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				try {
					var r;
					return yield this.__cleanup(), yield this.startCameraCapture({
