__d("WAWebVoipVideoCaptureAndRendering", [
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				var n = yield o("WAPromiseDelays").withTimeout(o("WAWebBackendApi").frontendSendAndReceive("getVoipCameraPermissionState", void 0), c, function() {
					return d;
				});
				return n === "prompt";
			} catch (t) {
	...
	var _ = new (o("WAWebVoipOperationQueue")).WAWebVoipOperationQueue("VideoCapture", void 0, m), f = null;
	function g() {
	...
	function y() {
		return y = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			o("WAWebVoipPerfMeasurement").startMeasurement(o("WAWebVoipPerfMeasurement").PerfMeasurement.FIRST_CAMERA_FRAME), _.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (g()) {
					o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["voip: [VirtualVideoCapture] creating driver"]))), f != null && f.stop(), f = new (o("WAWebVoipVirtualVideoCaptureDriver")).WAWebVoipVirtualVideoCaptureDriver();
					var t = f.start();
					yield o("WAWebVoipVideoCameraCapture").WAWebVoipVideoCameraCapture.startWithStream(t, 1280, 720, 30);
					return;
				}
				var n = e.camera_id, r = e.height, a = e.isAVUpgrade, i = a === void 0 ? !1 : a, l = e.max_fps, u = e.width;
				yield o("WAWebVoipVideoCameraCapture").WAWebVoipVideoCameraCapture.startCameraCapture({
	...
	function b() {
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			_.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = f;
				e != null && (e.stop(), f = null), yield o("WAWebVoipVideoCameraCapture").WAWebVoipVideoCameraCapture.stopCapture();
			}), "stopVideoCapture");
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = e.format, n = e.frameBuffer, r = e.height, a = e.isKeyFrame, i = e.isScreenShare, l = i === void 0 ? !1 : i, s = e.orientation, u = e.timestamp, c = e.userJid, d = e.width, m = v(c, l);
	...
	function E() {
		return E = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			_.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				yield o("WAWebVoipVideoDesktopCapture").WAWebVoipVideoDesktopCapture.startDesktopCapture({
					width: r,
					height: t,
					maxFps: n
				});
	...
	function I() {
		return I = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			_.enqueue(n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield o("WAWebVoipVideoDesktopCapture").WAWebVoipVideoDesktopCapture.stopCapture();
			}), "stopDesktopCapture");
	...
	l.startVideoCaptureJS = h, l.stopVideoCaptureJS = C, l.onVideoFrameWasmToJs = S, l.startDesktopCaptureJS = L, l.stopDesktopCaptureJS = k, l.releaseDesktopStreamJS = T;
}), 98);
