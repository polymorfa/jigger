__d("WAWebVoipVideoDesktopCapture", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S = 8192, R = (function(t) {
		function a() {
		...
		var i = a.prototype;
		return i.preflightAcquireDesktopStream = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t;
				return this.desktopStream = { streamPromise: o("WAWebBackendApi").frontendSendAndReceive("voipAcquireMediaStream", {
					type: "desktop",
					params: (t = o("WAWebVoipVideoCameraCapture").WAWebVoipVideoCameraCapture.captureParams) != null ? t : void 0,
					targetWindow: e
			...
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var a, i, l = t.height, m = t.maxFps, p = t.width;
				...
				if (_ == null) {
					o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[AV:startDesktopCapture] stream failed, canceling"]))), yield this.$WAWebVoipVideoDesktopCaptureImpl$p_2();
					return;
				}
				var f = _.getVideoTracks().at(0), g = f == null ? void 0 : f.getSettings(), h = (a = g == null ? void 0 : g.width) != null ? a : p, y = (i = g == null ? void 0 : g.height) != null ? i : l;
				(h !== p || y !== l) && o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose([
					"[AV:startDesktopCapture] actual=",
					"x",
					" req=",
					"x",
					""
				])), h, y, p, l), this.captureParams = {
					width: h,
					height: y,
					maxFps: m
				};
				var C = _.clone();
				if (yield this.__startCapture({
					...
					o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[AV:startDesktopCapture] capture pipeline not ready, canceling share"]))), this.releaseDesktopStream(), yield this.$WAWebVoipVideoDesktopCaptureImpl$p_2();
					return;
				}
				...
				if (b.length > 0) try {
					...
					yield this.$WAWebVoipVideoDesktopCaptureImpl$p_4(), o("WALogger").ERROR(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[AV:systemAudio] failed to start"]))).catching(r("getErrorSafe")(e)).sendLogs("system-audio-start-failed");
				}
			});
			function a(e) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				this.releaseDesktopStream(), this.desktopStream || (yield this.preflightAcquireDesktopStream());
				var l = (e = yield (t = this.desktopStream) == null ? void 0 : t.streamPromise) != null ? e : null;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				...
				if (t.length !== 0) {
					...
					var a = o("WAWebVoipAudioCaptureAndPlayback").getCaptureParams(), i = a.framesPerChunk, l = a.sampleRate, s = S;
					...
					var m = 8, p = m + s * Float32Array.BYTES_PER_ELEMENT, _ = yield o("WAWebAudioUtility").mallocWasmBuffer(p);
					this.systemAudioSabBuffer = _;
					var h = u.GROWABLE_HEAP_U8();
					h.fill(0, _, _ + p);
					var y = r("WAWebVoipSharedBufferCaptureProcessorConfig").module_url;
					if (y === "") throw r("err")("voip: [AV:SystemAudio] Missing worklet module url");
					yield c.audioWorklet.addModule(y);
					var C = new AudioWorkletNode(c, "voip-shared-buffer-capture-processor", {
						numberOfInputs: 1,
						numberOfOutputs: 0
					});
					...
					}), R = yield o("WAPromiseDelays").withTimeout(b, 5e3, o("WAWebBoolFunc").returnFalse);
					if (R === !1) throw r("err")("AudioWorklet processor not ready within 5s");
					...
					if (!E) throw r("err")("Failed to start system audio reader thread");
					C.port.postMessage({ type: "start" }), o("WALogger").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose(["[AV:systemAudio] capture started"])));
				}
			});
			function t(t) {
				return e.apply(this, arguments);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				if (this.systemAudioTracks = [], this.systemAudioSourceNode && (this.systemAudioSourceNode.disconnect(), this.systemAudioSourceNode = null), this.systemAudioContext && (this.systemAudioContext.close().catch(function(e) {
					...
					try {
						yield o("WAWebAudioUtility").freeWasmBuffer(this.systemAudioSabBuffer);
					} catch (e) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				yield this.$WAWebVoipVideoDesktopCaptureImpl$p_4(), yield t.prototype.__cleanup.call(this), this.desktopStream = null;
			});
			function r() {
				return e.apply(this, arguments);
			}
	...
	})(o("WAWebVoipVideoCaptureBase").WAWebVoipVideoCaptureBase), L = new R();
