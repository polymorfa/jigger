__d("WAWebVoipVideoRendererRegistry", [
	...
	var e, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $, P, N, M, w, A, F, O = 30, B = 5e3, W = 500;
	function q(e) {
	...
	var V = (function() {
		...
		return a.init = (function() {
			...
			var e, c;
			q(t) ? o("WAWebVoipPerfMeasurement").endMeasurement(o("WAWebVoipPerfMeasurement").PerfMeasurement.FIRST_CAMERA_FRAME) : o("WAWebVoipPerfMeasurement").endMeasurement(o("WAWebVoipPerfMeasurement").PerfMeasurement.FIRST_PEER_FRAME);
			var d = this.$20.get(t);
			...
			if (!q(t) && !this.$23 && !this.$12.isEnabled() && this.$24(), this.$12.isEnabled() && !q(t)) {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				return n !== o("WAWebVoipVideoRendererInterface").WAWebVoipVideoRendererType.DEFAULT ? (o("WALogger").LOG(L || (L = babelHelpers.taggedTemplateLiteralLoose(["[VideoRendererRegistry] rendererType=", " (ABProp)"])), n), n) : ((yield o("WAWebVoipVideoWebCodecsRenderer").WAWebVoipVideoWebCodecsRenderer.checkAvailability()) ? n = o("WAWebVoipVideoRendererInterface").WAWebVoipVideoRendererType.WEBCODECS_H264 : (yield r("WAWebVoipVideoWebGPURenderer").checkAvailability()) ? n = o("WAWebVoipVideoRendererInterface").WAWebVoipVideoRendererType.WEBGPU : r("WAWebVoipVideoWebGLRenderer").checkAvailability() ? n = o("WAWebVoipVideoRendererInterface").WAWebVoipVideoRendererType.WEBGL : (yield o("WAWebVoipVideoRasterRenderer").WAWebVoipVideoFrameRenderer.checkAvailability()) ? n = o("WAWebVoipVideoRendererInterface").WAWebVoipVideoRendererType.VIDEOFRAME : n = o("WAWebVoipVideoRendererInterface").WAWebVoipVideoRendererType.RASTER, o("WALogger").LOG(E || (E = babelHelpers.taggedTemplateLiteralLoose(["[VideoRendererRegistry] rendererType=", " (compat)"])), n), n);
			});
			function t() {
				return e.apply(this, arguments);
			}
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				if (!this.$37) {
					...
					try {
						...
						var r = yield (F || (F = n("Promise"))).all([t.getVoipParam("options.video_brightness_setting"), t.getVoipParam("options.video_sharpening_setting")]), a = r[0], i = r[1];
						if (e !== this.$38) return;
						var l = U(a), s = U(i);
						this.$35 = {
							brightness: l,
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				this.$23 = !0;
				try {
					var e, t = yield o("WAWebVoipAudioCaptureAndPlayback").waitForPlaybackStart(B);
					if (!t) {
						this.$23 = !1, o("WALogger").WARN(N || (N = babelHelpers.taggedTemplateLiteralLoose(["voip: VideoRendererRegistry: timed out waiting ", "ms for audio playback start before enabling A/V sync"])), B);
						return;
					}
					var n = yield o("WAWebBackendApi").frontendSendAndReceive("initializeVoipWasm"), r = (e = o("WAWebVoipAudioPlaybackState").getPlaybackSampleRate()) != null ? e : 16e3;
					this.$39(r, function() {
