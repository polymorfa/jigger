__d("WAWebVoipVideoWebCodecsRenderer", [
	...
	"use strict";
	var e, s, u, c, d, m, p, _, f, g, h, y, C = (function(e) {
		function t() {
			return e.apply(this, arguments) || this;
		}
		return babelHelpers.inheritsLoose(t, e), t;
	})(babelHelpers.wrapNativeSuper(Error)), b = null;
	function v(e) {
		b = e;
	}
	var S = "voip: WAWebVoipVideoWebCodecsRenderer: ", R = 5, L = 500, E = 30, k = 5e3, I = 320, T = 240, D = (function(t) {
		function a(e, n) {
			var r;
		...
		var i = a.prototype;
		return i.$WAWebVoipVideoWebCodecsRenderer$p_4 = function() {
			var t = this, n = this.$WAWebVoipVideoWebCodecsRenderer$p_2, r = new this.$WAWebVoipVideoWebCodecsRenderer$p_1({
				output: function(r) {
					try {
						if (n !== t.$WAWebVoipVideoWebCodecsRenderer$p_2) return;
						t.$WAWebVoipVideoWebCodecsRenderer$p_5 = 0, t.$WAWebVoipVideoWebCodecsRenderer$p_6 = 0, t.$WAWebVoipVideoWebCodecsRenderer$p_7++, t.$WAWebVoipVideoWebCodecsRenderer$p_8 = r.displayWidth, t.$WAWebVoipVideoWebCodecsRenderer$p_9 = r.displayHeight, t.applyPendingResize();
						var e = t.$WAWebVoipVideoWebCodecsRenderer$p_10(r.timestamp), o = e.mirror, a = e.orientation;
						t.renderVideoFrameToCanvas(r, r.displayWidth, r.displayHeight, a, o, !0);
					} finally {
						r.close();
					}
				},
				error: function(i) {
					n === t.$WAWebVoipVideoWebCodecsRenderer$p_2 && (t.$WAWebVoipVideoWebCodecsRenderer$p_3 === r && (t.$WAWebVoipVideoWebCodecsRenderer$p_3 = null), t.$WAWebVoipVideoWebCodecsRenderer$p_11.clear(), t.$WAWebVoipVideoWebCodecsRenderer$p_5++, t.$WAWebVoipVideoWebCodecsRenderer$p_12 = Date.now(), b == null || b(), t.$WAWebVoipVideoWebCodecsRenderer$p_5 > R ? o("WAWebVoipVideoRendererLogging").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose([
						"",
						"H264 decoder fatal error, max recovery attempts (",
						") exceeded. ",
						""
					])), S, R, i) : o("WAWebVoipVideoRendererLogging").ERROR(s || (s = babelHelpers.taggedTemplateLiteralLoose([
						"",
						"H264 decoder fatal error, will attempt recovery (",
						"/",
						"). ",
						""
					])), S, t.$WAWebVoipVideoWebCodecsRenderer$p_5, R, i));
				}
			});
			...
			if ((e == null ? void 0 : e.state) === "configured") {
				...
				e.reset(), e.configure(a.$WAWebVoipVideoWebCodecsRenderer$p_13), o("WAWebVoipVideoRendererLogging").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose([
					"",
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				return a.$WAWebVoipVideoWebCodecsRenderer$p_17 == null && (a.$WAWebVoipVideoWebCodecsRenderer$p_17 = a.$WAWebVoipVideoWebCodecsRenderer$p_18()), a.$WAWebVoipVideoWebCodecsRenderer$p_17;
			});
			function t() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				var t = yield window.VideoDecoder.isConfigSupported(a.$WAWebVoipVideoWebCodecsRenderer$p_13), n = t.supported;
				if (n == null || !n) return o("WAWebVoipVideoRendererLogging").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["", "H264 decoder not supported"])), S), !1;
				if (typeof window.VideoEncoder != "function") return o("WAWebVoipVideoRendererLogging").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["", "VideoEncoder not available, skipping decode probe"])), S), !1;
				var r = !1;
				try {
					r = yield a.$WAWebVoipVideoWebCodecsRenderer$p_19();
				} catch (e) {}
				var i = Math.round(window.performance.now() - e);
				return r ? (o("WAWebVoipVideoRendererLogging").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose(["", ""])), S + "H264 decoder supported and probe passed in " + i + "ms"), !0) : (o("WAWebVoipVideoRendererLogging").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["", ""])), S + "H264 decoder probe failed in " + i + "ms — falling back to WASM decode"), !1);
			});
			function t() {
				return e.apply(this, arguments);
			}
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = 2e3, t = null, i = null, l = null;
				try {
					var s = yield new (y || (y = (n("Promise"))))(function(n) {
								...
								if (!p) {
									...
									try {
										...
										o("WAWebVoipVideoRendererLogging").WARN(_ || (_ = babelHelpers.taggedTemplateLiteralLoose([
											...
											""
										])), S, String(e)), window.clearTimeout(m), d(!1);
										return;
									}
						...
						l = new f(g, {
							...
							codedHeight: T,
							timestamp: 0
						}), (s = t) == null || s.encode(l, { keyFrame: !0 }), (u = t) == null || u.flush().catch(function() {
							window.clearTimeout(m), d(!1);
						});
					});
					return s;
					...
					var u;
					(u = l) == null || u.close(), t != null && t.state !== "closed" && t.close(), i != null && i.state !== "closed" && i.close();
				}
			});
			function t() {
				return e.apply(this, arguments);
			...
			if (e === o("WAWebVoipMediaEnums").WAWebVoipVideoFormat.H264) {
				if (!this.$WAWebVoipVideoWebCodecsRenderer$p_3) throw this.$WAWebVoipVideoWebCodecsRenderer$p_5 === 0 ? new C(r("err")(S + "Decoder not available, awaiting reset")) : this.$WAWebVoipVideoWebCodecsRenderer$p_5 > R ? r("err")(S + "H264 Decoder closed due to fatal error") : Date.now() - this.$WAWebVoipVideoWebCodecsRenderer$p_12 < L ? new C(r("err")(S + "Decoder recovery cooldown")) : (o("WAWebVoipVideoRendererLogging").LOG(f || (f = babelHelpers.taggedTemplateLiteralLoose([
					"",
					"Recreating H264 decoder after fatal error (attempt ",
					"/",
					")"
				])), S, this.$WAWebVoipVideoWebCodecsRenderer$p_5, R), this.$WAWebVoipVideoWebCodecsRenderer$p_14(), new C(r("err")(S + "Decoder recovered, requesting key frame")));
				var m = c * 1e3 / 90;
				try {
					...
					var p = Date.now();
					p - this.$WAWebVoipVideoWebCodecsRenderer$p_16 >= k && (o("WAWebVoipVideoRendererLogging").LOG(g || (g = babelHelpers.taggedTemplateLiteralLoose([
						"",
						"[webcodec-decode] fed=",
						" decoded=",
						" last=",
						...
						" pending=",
						""
					])), S, this.$WAWebVoipVideoWebCodecsRenderer$p_15, this.$WAWebVoipVideoWebCodecsRenderer$p_7, this.$WAWebVoipVideoWebCodecsRenderer$p_8, this.$WAWebVoipVideoWebCodecsRenderer$p_9, this.$WAWebVoipVideoWebCodecsRenderer$p_6), this.$WAWebVoipVideoWebCodecsRenderer$p_16 = p), this.$WAWebVoipVideoWebCodecsRenderer$p_22();
				} catch (e) {
					throw e instanceof Error && e.name === "DataError" ? new C(e) : e;
				}
				return;
			}
			...
			if (this.$WAWebVoipVideoWebCodecsRenderer$p_6 >= E) throw o("WAWebVoipVideoRendererLogging").ERROR(h || (h = babelHelpers.taggedTemplateLiteralLoose([
				"",
				"Watchdog: no output after ",
				" frames, resetting decoder"
			])), S, this.$WAWebVoipVideoWebCodecsRenderer$p_6), this.$WAWebVoipVideoWebCodecsRenderer$p_14(), new C(r("err")(S + "Decoder output stalled"));
		}, a;
	})(o("WAWebVoipVideoRasterRenderer").WAWebVoipVideoFrameRenderer);
	D.$WAWebVoipVideoWebCodecsRenderer$p_13 = {
		codec: o("WAWebVoipWebCodecsEncoderState").WEBCODECS_H264_CODEC,
		optimizeForLatency: !0
	}, l.KeyFrameNeededError = C, l.setFatalErrorCallback = v, l.WAWebVoipVideoWebCodecsRenderer = D;
}), 98);
