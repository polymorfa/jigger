__d("WAWebVoipWaCallEnums", ["$InternalEnum", "WAWebProtobufSyncAction.pb"], (function(t, n, r, o, a, i, l) {
	var e, s = (e = n("$InternalEnum"))({
		None: 0,
		Calling: 1,
		PreacceptReceived: 2,
		ReceivedCall: 3,
	...
	function d(e) {
		switch (e) {
			case c.Connected:
			case c.ConnectedLonely: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.CONNECTED;
			case c.Missed: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.MISSED;
			case c.Rejected: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.REJECTED;
			case c.Canceled: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.CANCELLED;
			case c.AcceptedElsewhere: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.ACCEPTEDELSEWHERE;
			case c.Unavailable:
			case c.Failed: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.UNAVAILABLE;
			case c.Invalid: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.INVALID;
		}
	}
	function m(e) {
		switch (e) {
			case u.Connected: return c.Connected;
			case u.Missed:
			case u.MissedNotificationsMuted: return c.Missed;
			case u.Declined: return c.Rejected;
			case u.Canceled: return c.Canceled;
			case u.Unavailable: return c.Unavailable;
			case u.AcceptedElsewhere: return c.AcceptedElsewhere;
			case u.Undefined: return c.Invalid;
		}
	}
	var p = e({
		Invalid: 0,
	...
	function f(e) {
		switch (e) {
			case p.Connected: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.CONNECTED;
			case p.Incoming:
			case p.Receipt:
			case p.Terminated:
			case p.TimedOut:
			case p.CancelOffer: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.MISSED;
			case p.Rejected: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.REJECTED;
			case p.Invited:
			case p.CreatingCall:
			case p.Invisible:
			case p.Visible:
			case p.Invalid: return o("WAWebProtobufSyncAction.pb").CallLogRecord$CallResult.INVALID;
		}
	}
	var g = e({
		None: 0,
		...
		JoinSent: 3,
		JoinAcked: 4
	}), D = e({ RelayBindsFailed: "relay_binds_failed" }), x = e({
		Legacy: 0,
	...
	l.CallState = s, l.CallResult = u, l.CallLogResult = c, l.getSyncCallResultFromCallLogResult = d, l.convertCallResultToCallLogResult = m, l.CallParticipantState = p, l.CallSummaryUserState = _, l.getSyncParticipantCallResultFromParticipantState = f, l.CallEvent = g, l.DeviceTypeEnum = h, l.VideoState = y, l.CallFatalReasonCode = C, l.CallAudioRestartReason = b, l.ReactionState = v, l.ScreenShareState = S, l.ScreenShareEndReason = R, l.ScreenShareVersion = L, l.ReconnectingOption = E, l.NetHealthStatus = k, l.CallUserType = I, l.CallLinkState = T, l.CallFailedReason = D, l.ServerReminderType = x, l.AccountKind = $, l.wireStringToAccountKind = N, l.WaitingRoomFilter = M, l.wireStringToWaitingRoomFilter = A, l.UiViewMode = F, l.ClientPlatform = O;
}), 98);
