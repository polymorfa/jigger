__d("WAWebVoipWasmArtifactGating", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			...
			try {
				return yield o("WAWebABPropsCache").waitForABPropConfigsReady(), o("WAWebABPropsConfigs").ABPropConfigs.web_voip_use_content_addressed_wasm == null ? !1 : o("WAWebABProps").getABPropConfigValue("web_voip_use_content_addressed_wasm") === !0;
			} catch (t) {
