__d("WAWebVoipWasmHeapMonitor", ["WALogger"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e, s, u, c, d = 1048576, m = 1e3, p = null, _ = null, f = null, g = null, h = 0, y = 0, C = 0;
	function b(e) {
	...
	function E(t, n) {
		o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
			...
			" peakMb=",
			""
		])), t, n.bytes, b(n.bytes), n.deltaBytes, b(n.peakBytes));
	}
	function k(e) {
		o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose([
			...
			" peakMb=",
			""
		])), "call_state_non_none", e.bytes, b(e.bytes), e.deltaBytes, b(e.peakBytes));
	}
	function I(e) {
		...
		if (p != null) {
			...
			if (_ = null, e != null) {
				...
				o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose([
					...
					" polls=",
					""
				])), "call_state_none", t.bytes, b(t.bytes), t.deltaBytes, b(t.peakBytes), t.bytes - y, C), y = 0, C = 0;
			}
		}
	}
	l.logWasmHeapSnapshot = D, l.startWasmHeapMonitor = x, l.stopWasmHeapMonitor = $;
}), 98);
