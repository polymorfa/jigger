__d("WAWebVoipWebTransportCallSummary", ["$InternalEnum"], (function(t, n, r, o, a, i) {
	"use strict";
	var e = n("$InternalEnum")({
		...
		var n = t.prototype;
		return n.recordAttemptStart = function(t) {
			this.$1.push({
				connectionId: t,
				startMs: Date.now(),
				elapsedMs: null,
			...
			for (var e = this.$1.length - 1; e >= 0; e--) {
				...
				if (o.connectionId === t && o.outcome == null) {
					o.elapsedMs = Date.now() - o.startMs, o.outcome = n, o.likelyCause = r;
					return;
				}
			}
	...
	i.WtRelayOutcome = e, i.recordWtRelayAttemptStart = c, i.recordWtRelayAttemptComplete = d, i.hasWtActivityThisCall = m, i.getWtCallSummary = p, i.markWtCallSummaryClosed = _;
}), 66);
