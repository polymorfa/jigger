	...
	var e = ["type", "__name"], s, u, c = r("bx").getURL(r("bx")("32180"), { cacheBreaker: "1786008825082" }), d = (function() {
		...
		return function(r) {
			...
			function Oe() {
				var e = {
					env: ki,
					wasi_snapshot_preview1: ki
				};
				function t(e, t) {
					var n = e.exports;
					return W = n, mn(W._emscripten_tls_init), re = W.__indirect_function_table, H(re, "table not found in wasm exports"), ge(W.__wasm_call_ctors), q = t, Le("wasm-instantiate"), n;
				}
				Re("wasm-instantiate");
				var n = h;
				function r(e) {
			...
			function ht(e) {
				...
				var t = nn.pthreads[e];
				delete nn.pthreads[e], gt(t), tl(e), nn.runningWorkers.splice(nn.runningWorkers.indexOf(t), 1), t.pthread_ptr = 0;
			}
			function yt(e) {
			...
			var Pt = function() {
				...
				stream_ops: {
					...
					write: function(t, n, r, o, a, l) {
						if (H(!(n instanceof ArrayBuffer)), n.buffer === i().buffer && (l = !1), !o) return 0;
						var e = t.node;
						if (e.timestamp = Date.now(), n.subarray && (!e.contents || e.contents.subarray)) {
							if (l) return H(a === 0, "canOwn must imply no weird position inside the file"), e.contents = n.subarray(r, r + o), e.usedBytes = o, o;
					...
					mmap: function(t, n, r, o, a) {
						...
						if (!(a & 2) && s.buffer === i().buffer) l = !1, e = s.byteOffset;
							...
							if ((r > 0 || r + n < s.length) && (s.subarray ? s = s.subarray(r, r + n) : s = Array.prototype.slice.call(s, r, r + n)), l = !0, e = wt(n), !e) throw new Kt.ErrnoError(48);
							i().set(s, e);
						}
						return {
							ptr: e,
			...
			var Jt = function(t, n) {
				...
				ae(), t instanceof WebAssembly.RuntimeError && ml() <= 0 && A("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 1048576)"), R(1, t);
			}, nn = {
				unusedWorkers: [],
				runningWorkers: [],
				tlsInitFunctions: [],
				...
				debugInit: function() {
					function e() {
						var e = 0;
						return ue && typeof wi != "undefined" && (e = wi()), "w:" + (h.workerID || 0) + ",t:" + en(e) + ": ";
					}
					var t = Ge;
					Ge = function(r) {
						return t(e() + r);
				...
				initMainThread: function() {
					for (var e = typeof h.pthreadPoolSizeOverride == "number" ? h.pthreadPoolSizeOverride : 20; e--;) nn.allocateUnusedWorker();
					fe(function() {
						Re("loading-workers");
						var e = 15e3, t = !1, n = function(o) {
							if (!t) {
								...
								try {
									if (o) {
										var a = [], i = [];
										for (var l of nn.unusedWorkers) l.loaded ? a.push(l) : i.push(l);
										for (var l of i) try {
											gt(l);
										} catch (e) {
											A("voip: ThreadPoolManager: failed to terminate timed-out pthread worker " + l.workerID + ": " + e);
										}
										n = i.length, nn.unusedWorkers = a, A("voip: ThreadPoolManager: pthread worker prewarm timed out after " + e + "ms; continuing with " + a.length + " ready workers");
									}
								} finally {
									Le("loading-workers");
								}
				...
				returnWorkerToPool: function(t) {
					var e = t.pthread_ptr;
					delete nn.pthreads[e], nn.unusedWorkers.push(t), nn.runningWorkers.splice(nn.runningWorkers.indexOf(t), 1), t.pthread_ptr = 0, tl(e);
				},
					...
					return new (u || (u = (n("Promise"))))(function(n) {
						o.addMessageListener("cmd", function(e) {
							...
							if (t.targetThread && t.targetThread != wi()) {
								...
								a ? a.postMessage(babelHelpers.extends({}, t, { type: "cmd" }), t.transferList) : A("Internal error! Worker sent a message \"" + r + "\" to target pthread " + t.targetThread + ", but that thread no longer exists!");
								return;
							}
							r === "checkMailbox" ? Qo() : r === "spawnThread" ? vt(t) : r === "cleanupThread" ? Ct(t.thread) : r === "killThread" ? ht(t.thread) : r === "cancelThread" ? yt(t.thread) : r === "loaded" ? (o.loaded = !0, n(o)) : r === "alert" ? alert("Thread " + t.threadId + ": " + t.text) : t.target === "setimmediate" ? o.postMessage(babelHelpers.extends({}, t, { type: "cmd" })) : r === "callHandler" ? h[t.handler].apply(h, t.args) : r && A("worker sent an unknown command " + r);
							...
							throw o.pthread_ptr && (t = "Pthread " + en(o.pthread_ptr) + " sent an error!"), A(t + " " + e.filename + ":" + e.lineno + ": " + e.message), e;
						...
						for (var l of i) Object.prototype.hasOwnProperty.call(h, l) && r.push(l);
						o.workerID = nn.nextWorkerID++, o.postMessage({
							cmd: "load",
							handlers: r,
				...
				loadWasmModuleToAllWorkers: function(t) {
					if (T) return t();
					var e = (u || (u = n("Promise"))).all(nn.unusedWorkers.map(nn.loadWasmModuleToWorker));
					e.then(t);
				},
			...
			function on() {
				var e = wi(), t = p()[e + 52 >> 2], n = p()[e + 56 >> 2], r = t - n;
				H(t != 0), H(r != 0), H(t > r, "stackHigh must be higher then stackLow"), ll(t, r), cl(t), oe();
			}
			...
			function hn(e) {
				var t = new vn(e);
				return t.get_caught() || (t.set_caught(!0), gn--), t.set_rethrown(!1), fn.push(t), qi(t.excPtr), t.get_exception_ptr();
			}
			function yn() {
			...
			var Hn = function(t, n, r) {
				return H(typeof r == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), xt(t, l(), n, r);
			};
			function Gn(e, t, n) {
				...
				try {
					...
					for (var o = 280, a = 0, l = Kt.llseek(r, 0, 1), s = Math.floor(l / o); s < r.getdents.length && a + o <= n;) {
						...
						H(u), J[t + a >> 3] = BigInt(u), J[t + a + 8 >> 3] = BigInt((s + 1) * o), d()[t + a + 16 >> 1] = 280, i()[t + a + 18 >> 0] = c, Hn(m, t + a + 19, 256), a += o, s += 1;
					}
					...
					switch (t) {
						...
						case 21508: {
							...
							if (r.tty.ops.ioctl_tcsets) {
								for (var a = Xt.get(), s = p()[a >> 2], u = p()[a + 4 >> 2], c = p()[a + 8 >> 2], m = p()[a + 12 >> 2], _ = [], l = 0; l < 32; l++) _.push(i()[a + l + 17 >> 0]);
			...
			function Mo(e, t) {
				...
				mr(e, {
					...
					toWireType: function(t, r) {
						...
						var a = xi(4 + e + 1), i = a + 4;
						if (_()[a >> 2] = e, n && o) Hn(r, i, e + 1);
						else if (o) for (var s = 0; s < e; ++s) {
							var u = r.charCodeAt(s);
							u > 255 && ($i(i), lr("String has UTF-16 code units that do not fit in 8 bits")), l()[i + s] = u;
						}
			...
			var wo = typeof TextDecoder != "undefined" ? new TextDecoder("utf-16le") : void 0, Ao = function(t, n) {
				...
				if (e = r << 1, e - t > 32 && wo) return wo.decode(l().slice(t, e));
				...
				n === 2 ? (e = Ao, o = Fo, i = Oo, a = function() {
					...
					toWireType: function(t, a) {
						...
						var e = i(a), s = xi(4 + e + n);
						return _()[s >> 2] = e >> l, o(a, s + 4, e + n), t !== null && t.push($i, s), s;
					},
					argPackAdvance: 8,
					readValueFromPointer: no,
					destructorFunction: function(t) {
			...
			var pa = function(t) {
				...
				return va(), setTimeout(function() {
					Sa(), jo(t);
				}, n);
			};
			function La(e, t) {
				if (Ia.mainLoop.timingMode = e, Ia.mainLoop.timingValue = t, !Ia.mainLoop.func) return A("emscripten_set_main_loop_timing: Cannot set timing mode for main loop since a main loop does not exist! Call emscripten_set_main_loop first to set one up."), 1;
				if (Ia.mainLoop.running || (va(), Ia.mainLoop.running = !0), e == 0) Ia.mainLoop.scheduler = function() {
					var e = Math.max(0, Ia.mainLoop.tickStartTime + t - Ea()) | 0;
					setTimeout(Ia.mainLoop.runner, e);
				}, Ia.mainLoop.method = "timeout";
				else if (e == 1) Ia.mainLoop.scheduler = function() {
			...
			function ka(e, t, n, r, o) {
				H(!Ia.mainLoop.func, "emscripten_set_main_loop: there can only be one main loop function at once: call emscripten_cancel_main_loop to cancel the previous one before setting a new one with different parameters."), Ia.mainLoop.func = e, Ia.mainLoop.arg = r;
				var a = Ia.mainLoop.currentlyRunningMainloop;
				function i() {
					return a < Ia.mainLoop.currentlyRunningMainloop ? (Sa(), !1) : !0;
				}
				if (Ia.mainLoop.running = !1, Ia.mainLoop.runner = function() {
					if (!U) {
						if (Ia.mainLoop.queue.length > 0) {
							var t = Date.now(), n = Ia.mainLoop.queue.shift();
							if (n.func(n.arg), Ia.mainLoop.remainingBlockers) {
								var r = Ia.mainLoop.remainingBlockers, o = r % 1 == 0 ? r - 1 : Math.floor(r);
								n.counted ? Ia.mainLoop.remainingBlockers = o : (o = o + .5, Ia.mainLoop.remainingBlockers = (8 * r + o) / 9);
							}
							if (w("main loop blocker \"" + n.name + "\" took " + (Date.now() - t) + " ms"), Ia.mainLoop.updateStatus(), !i()) return;
							setTimeout(Ia.mainLoop.runner, 0);
							return;
						}
						if (i()) {
							if (Ia.mainLoop.currentFrameNumber = Ia.mainLoop.currentFrameNumber + 1 | 0, Ia.mainLoop.timingMode == 1 && Ia.mainLoop.timingValue > 1 && Ia.mainLoop.currentFrameNumber % Ia.mainLoop.timingValue != 0) {
								Ia.mainLoop.scheduler();
								return;
							} else Ia.mainLoop.timingMode == 0 && (Ia.mainLoop.tickStartTime = Ea());
							Ia.mainLoop.method === "timeout" && h.ctx && (pn("Looks like you are rendering without using requestAnimationFrame for the main loop. You should use 0 for the frame rate in emscripten_set_main_loop in order to use requestAnimationFrame, as that can greatly improve your frame rates!"), Ia.mainLoop.method = ""), Ia.mainLoop.runIter(e), ae(), i() && (typeof SDL == "object" && SDL.audio && SDL.audio.queueNewAudioData && SDL.audio.queueNewAudioData(), Ia.mainLoop.scheduler());
						}
					}
				}, o || (t && t > 0 ? La(0, 1e3 / t) : La(1, 1), Ia.mainLoop.scheduler()), n) throw "unwind";
			}
			var Ia = {
				mainLoop: {
					running: !1,
					...
					queue: [],
					pause: function() {
						Ia.mainLoop.scheduler = null, Ia.mainLoop.currentlyRunningMainloop++;
					},
					resume: function() {
						Ia.mainLoop.currentlyRunningMainloop++;
						var e = Ia.mainLoop.timingMode, t = Ia.mainLoop.timingValue, n = Ia.mainLoop.func;
						Ia.mainLoop.func = null, ka(n, 0, !1, Ia.mainLoop.arg, !0), La(e, t), Ia.mainLoop.scheduler();
					},
					updateStatus: function() {
						if (h.setStatus) {
							var e = h.statusMessage || "Please wait...", t = Ia.mainLoop.remainingBlockers, n = Ia.mainLoop.expectedBlockers;
				...
				init: function() {
					...
					e.canHandle = function(t) {
						...
						e.size !== t.length && (e = new Blob([new Uint8Array(t).buffer], { type: Ia.getMimetype(n) }));
						...
						i.onload = function() {
							...
							o.drawImage(i, 0, 0), Si[n] = e, URL.revokeObjectURL(a), r && r(t);
					...
					t.canHandle = function(t) {
						...
						var i = new Blob([t], { type: Ia.getMimetype(n) }), l = URL.createObjectURL(i);
					...
					function n() {
						Ia.pointerLock = document.pointerLockElement === h.canvas || document.mozPointerLockElement === h.canvas || document.webkitPointerLockElement === h.canvas || document.msPointerLockElement === h.canvas;
					}
					var r = h.canvas;
					r && (r.requestPointerLock = r.requestPointerLock || r.mozRequestPointerLock || r.webkitRequestPointerLock || r.msRequestPointerLock || function() {}, r.exitPointerLock = document.exitPointerLock || document.mozExitPointerLock || document.webkitExitPointerLock || document.msExitPointerLock || function() {}, r.exitPointerLock = r.exitPointerLock.bind(document), document.addEventListener("pointerlockchange", n, !1), document.addEventListener("mozpointerlockchange", n, !1), document.addEventListener("webkitpointerlockchange", n, !1), document.addEventListener("mspointerlockchange", n, !1), h.elementPointerLock && r.addEventListener("click", function(e) {
						!Ia.pointerLock && h.canvas.requestPointerLock && (h.canvas.requestPointerLock(), e.preventDefault());
					}, !1));
				},
				createContext: function(t, n, r, o) {
					...
					return e ? (r && (n || H(typeof GLctx == "undefined", "cannot set in module if GLctx is used, but we are a non-GL context that would replace it"), h.ctx = e, n && GL.makeContextCurrent(a), h.useWebGL = n, Ia.moduleContextCreatedCallbacks.forEach(function(e) {
						return e();
					}), Ia.init()), e) : null;
				},
				...
				requestFullscreen: function(t, n) {
					Ia.lockPointer = t, Ia.resizeCanvas = n, typeof Ia.lockPointer == "undefined" && (Ia.lockPointer = !0), typeof Ia.resizeCanvas == "undefined" && (Ia.resizeCanvas = !1);
					var e = h.canvas;
					function r() {
						Ia.isFullscreen = !1;
						var t = e.parentNode;
						(document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === t ? (e.exitFullscreen = Ia.exitFullscreen, Ia.lockPointer && e.requestPointerLock(), Ia.isFullscreen = !0, Ia.resizeCanvas ? Ia.setFullscreenCanvasSize() : Ia.updateCanvasDimensions(e)) : (t.parentNode.insertBefore(e, t), t.parentNode.removeChild(t), Ia.resizeCanvas ? Ia.setWindowedCanvasSize() : Ia.updateCanvasDimensions(e)), h.onFullScreen && h.onFullScreen(Ia.isFullscreen), h.onFullscreen && h.onFullscreen(Ia.isFullscreen);
					}
					Ia.fullscreenHandlersInstalled || (Ia.fullscreenHandlersInstalled = !0, document.addEventListener("fullscreenchange", r, !1), document.addEventListener("mozfullscreenchange", r, !1), document.addEventListener("webkitfullscreenchange", r, !1), document.addEventListener("MSFullscreenChange", r, !1));
				...
				safeRequestAnimationFrame: function(t) {
					return va(), Ia.requestAnimationFrame(function() {
						Sa(), jo(t);
					});
				},
				...
				calculateMouseEvent: function(t) {
					if (Ia.pointerLock) t.type != "mousemove" && "mozMovementX" in t ? Ia.mouseMovementX = Ia.mouseMovementY = 0 : (Ia.mouseMovementX = Ia.getMovementX(t), Ia.mouseMovementY = Ia.getMovementY(t)), typeof SDL != "undefined" ? (Ia.mouseX = SDL.mouseX + Ia.mouseMovementX, Ia.mouseY = SDL.mouseY + Ia.mouseMovementY) : (Ia.mouseX += Ia.mouseMovementX, Ia.mouseY += Ia.mouseMovementY);
					else {
						...
						if (H(typeof o != "undefined" && typeof a != "undefined", "Unable to retrieve scroll position, mouse positions likely broken."), t.type === "touchstart" || t.type === "touchend" || t.type === "touchmove") {
							...
							if (t.type === "touchstart") Ia.lastTouches[i.identifier] = u, Ia.touches[i.identifier] = u;
							else if (t.type === "touchend" || t.type === "touchmove") {
								var c = Ia.touches[i.identifier];
								c || (c = u), Ia.lastTouches[i.identifier] = c, Ia.touches[i.identifier] = u;
							}
							return;
						}
						var d = t.pageX - (o + e.left), m = t.pageY - (a + e.top);
						d = d * (n / e.width), m = m * (r / e.height), Ia.mouseMovementX = d - Ia.mouseX, Ia.mouseMovementY = m - Ia.mouseY, Ia.mouseX = d, Ia.mouseY = m;
					}
				},
				resizeListeners: [],
				...
				setCanvasSize: function(t, n, r) {
					var e = h.canvas;
					Ia.updateCanvasDimensions(e, t, n), r || Ia.updateResizeListeners();
				},
				windowedWidth: 0,
				windowedHeight: 0,
			...
			function Aa(e, t) {
				...
				return ln(function() {
					for (var o = n * 2, a = dl(o * 8), i = a >> 3, l = 0; l < n; l++) {
						var s = r[2 + l];
			...
			var Fa = [];
			function Oa(e, t, n, r) {
				nn.currentProxiedOperationCallerThread = t, n /= 2, Fa.length = n;
				for (var o = r >> 3, a = 0; a < n; a++) J[o + 2 * a] ? Fa[a] = J[o + 2 * a + 1] : Fa[a] = g()[o + 2 * a + 1];
				var i = e < 0, l = i ? ze[-e - 1] : Li[e];
				return H(l.length == n, "Call args mismatch in emscripten_receive_on_main_thread_js"), l.apply(null, Fa);
			}
			var Ba = function(t) {
				...
				if (!Ga.strings) {
					...
					for (var n in Va) Va[n] === void 0 ? delete t[n] : t[n] = Va[n];
					var r = [];
				...
				for (var e = 0; e < t.length; ++e) H(t.charCodeAt(e) === (t.charCodeAt(e) & 255)), i()[n++ >> 0] = t.charCodeAt(e);
				i()[n >> 0] = 0;
			};
			function ja(e, t) {
				if (T) return Aa(19, 1, e, t);
				var n = 0;
				return Ga().forEach(function(r, o) {
					var a = t + n;
			...
			function Ya(e, t, n, r, o) {
				...
				try {
					...
					var a = Xt.getStreamFromFD(e), i = Xa(a, t, n, r);
					return _()[o >> 2] = i, 0;
				} catch (e) {
					if (typeof Kt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			function ei(e, t, n, r) {
				...
				try {
					var o = Xt.getStreamFromFD(e), a = Xa(o, t, n);
					return _()[r >> 2] = a, 0;
				} catch (e) {
					if (typeof Kt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			var oi = function(t, n) {
				...
				for (t.startsWith("::") ? t = t.replace("::", "Z:") : t = t.replace("::", ":Z:"), t.indexOf(".") > 0 ? (t = t.replace(new RegExp("[.]", "g"), ":"), e = t.split(":"), e[e.length - 4] = ii(e[e.length - 4]) + ii(e[e.length - 3]) * 256, e[e.length - 3] = ii(e[e.length - 2]) + ii(e[e.length - 1]) * 256, e = e.slice(0, e.length - 2)) : e = t.split(":"), r = 0, o = 0, n = 0; n < e.length; n++) if (typeof e[n] == "string") if (e[n] === "Z") {
				...
				lookup_name: function(t) {
					...
					if (si.address_map.addrs[t]) n = si.address_map.addrs[t];
						...
						H(r < 65535, "exceeded max address mappings of 65535"), n = "172.29." + (r & 255) + "." + (r & 65280), si.address_map.names[n] = t, si.address_map.addrs[t] = n;
					}
					return n;
				},
				...
				var a = xi(12);
				return _()[a >> 2] = a + 8, _()[a + 4 >> 2] = 0, p()[a + 8 >> 2] = ai(si.lookup_name(t)), _()[e + 16 >> 2] = a, e;
			};
			function ci(e) {
			...
			var mi = function(t, n) {
				...
				for (var e = new Date(t.getTime()); n > 0;) {
					var r = oa(e.getFullYear()), o = e.getMonth(), a = (r ? pi : _i)[o];
				...
				H(t.length >= 0, "writeArrayToMemory array must have a length (should be an array or typed array)"), i().set(t, n);
			}, hi = function(t, n, r, o) {
				var e = p()[o + 40 >> 2], a = {
					tm_sec: p()[o >> 2],
					tm_min: p()[o + 4 >> 2],
				...
				function g(e) {
					var t = fi(new Date(e.tm_year + 1900, 0, 1), e.tm_yday), n = new Date(t.getFullYear(), 0, 4), r = new Date(t.getFullYear() + 1, 0, 4), o = f(n), a = f(r);
				...
				var h = {
					...
					"%j": function(t) {
						return m(t.tm_mday + mi(oa(t.tm_year + 1900) ? pi : _i, t.tm_mon - 1), 3);
					},
					"%m": function(t) {
			...
			}), Kt.FSNode = Ci, Kt.createPreloadedFile = Wt, Kt.staticInit(), Gt = {
				EPERM: 63,
				ENOENT: 44,
				ESRCH: 71,
				EINTR: 27,
			...
			var ki = {
				...
				strftime_l: yi
			}, Ii = Oe(), Ti = De("__wasm_call_ctors"), Di = De("__cxa_free_exception"), xi = h._malloc = De("malloc"), $i = h._free = De("free"), Pi = h._wasm_throw_ml_abort = De("wasm_throw_ml_abort"), Ni = h._fflush = De("fflush"), Mi = De("__errno_location"), wi = h._pthread_self = function() {
				return (wi = h._pthread_self = W.pthread_self)();
			}, Ai = De("ntohs"), Fi = De("htonl"), Oi = De("htons"), Bi = h.__ZN5folly15SharedMutexImplILb1EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj = De("_ZN5folly15SharedMutexImplILb1EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj"), Wi = h.__ZN5folly15SharedMutexImplILb0EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj = De("_ZN5folly15SharedMutexImplILb0EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj"), qi = De("__cxa_increment_exception_refcount"), Ui = De("__cxa_decrement_exception_refcount"), Vi = h.__emscripten_tls_init = De("_emscripten_tls_init"), Hi = De("emscripten_builtin_memalign"), Gi = De("__getTypeName"), zi = h.__embind_initialize_bindings = De("_embind_initialize_bindings"), ji = h.__emscripten_thread_init = De("_emscripten_thread_init"), Ki = h.__emscripten_thread_crashed = De("_emscripten_thread_crashed"), Qi = De("emscripten_main_thread_process_queued_calls"), Xi = De("emscripten_main_runtime_thread_id"), Yi = De("_emscripten_run_in_main_runtime_thread_js"), Ji = De("emscripten_dispatch_to_thread_"), Zi = function() {
				return (Zi = W.emscripten_stack_get_base)();
			}, el = function() {
				return (el = W.emscripten_stack_get_end)();
			}, tl = De("_emscripten_thread_free_data"), nl = h.__emscripten_thread_exit = De("_emscripten_thread_exit"), rl = h.__emscripten_check_mailbox = De("_emscripten_check_mailbox"), ol = De("setThrew"), al = De("setTempRet0"), il = function() {
				return (il = W.emscripten_stack_init)();
			}, ll = function(t, n) {
				return (ll = W.emscripten_stack_set_limits)(t, n);
			}, sl = function() {
				return (sl = W.emscripten_stack_get_free)();
			}, ul = De("stackSave"), cl = De("stackRestore"), dl = De("stackAlloc"), ml = function() {
				return (ml = W.emscripten_stack_get_current)();
			}, pl = h.___get_exception_message = De("__get_exception_message"), _l = De("__cxa_can_catch"), fl = De("__cxa_is_pointer_type"), gl = h.___start_em_js = 1331564, hl = h.___stop_em_js = 1336996;
			function yl(e, t, n, r) {
				var o = ul();
				try {
					cn(e)(t, n, r);
			...
			function gs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v) {
				var S = ul();
				try {
			...
			function hs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R) {
				var L = ul();
				try {
			...
			function bs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b) {
				var v = ul();
				try {
			...
			function Ys(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C) {
				var b = ul();
				try {
			...
			function Su(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $) {
				var P = ul();
				try {
			...
			h.keepRuntimeAlive = de, h.wasmMemory = B, h.GROWABLE_HEAP_U8 = l, h.GROWABLE_HEAP_F32 = f, h.ExitStatus = ft, h.FS = Kt, h.PThread = nn, h.registeredTypes = or;
			var Xu = [
				"writeI53ToI64",
			...
			function ec() {
				...
				if (me(), ye > 0) return;
				function e() {
					Ju || (Ju = !0, h.calledRun = !0, !U && (pe(), y(h), h.onRuntimeInitialized && h.onRuntimeInitialized(), H(!h._main, "compiled without a main, but one is present. if you added it from JS, use Module[\"onRuntimeInitialized\"]"), _e()));
				}
			...
			function tc() {
				...
				try {
					Ni(0), ["stdout", "stderr"].forEach(function(e) {
