__d("WAWebVoipWebWasmLoader.worker", [
	"WorkerBundleResource",
	"WorkerClient",
	"WorkerMessagePort",
	"bx"
], (function(t, n, r, o, a, i, l) {
	var e = ["type", "__name"], s, u = r("bx").getURL(r("bx")("32180"), { cacheBreaker: "1786008825082" }), c = (function() {
		...
		return function(r) {
			...
			function Ke() {
				...
				Le = function(n) {
					if (self.__inMLInference && g._wasm_throw_ml_abort) {
						...
						var t = Tt(n) + 1, r = sl(), o = cl(t);
						Vn(n, o, t), g._wasm_throw_ml_abort(o), ul(r);
						return;
					}
					e(n);
				};
			...
			function gt(e) {
				...
				var t = tn.pthreads[e];
				delete tn.pthreads[e], ft(t), el(e), tn.runningWorkers.splice(tn.runningWorkers.indexOf(t), 1), t.pthread_ptr = 0;
			}
			function ht(e) {
...
`)), !e) return null;
			...
			var Yt = function(t, n) {
				...
				oe(), t instanceof WebAssembly.RuntimeError && dl() <= 0 && w("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 1048576)"), S(1, t);
			}, tn = {
				unusedWorkers: [],
				runningWorkers: [],
				tlsInitFunctions: [],
				...
				debugInit: function() {
					function e() {
						var e = 0;
						return se && typeof Mi != "undefined" && (e = Mi()), "w:" + (g.workerID || 0) + ",t:" + Zt(e) + ": ";
					}
					var t = He;
					He = function(r) {
						return t(e() + r);
				...
				returnWorkerToPool: function(t) {
					var e = t.pthread_ptr;
					delete tn.pthreads[e], tn.unusedWorkers.push(t), tn.runningWorkers.splice(tn.runningWorkers.indexOf(t), 1), t.pthread_ptr = 0, el(e);
				},
			...
			function rn() {
				var e = Mi(), t = m()[e + 52 >> 2], n = m()[e + 56 >> 2], r = t - n;
				V(t != 0), V(r != 0), V(t > r, "stackHigh must be higher then stackLow"), il(t, r), ul(t), re();
			}
			g.establishStackSpace = rn;
			function on(e) {
				if (I) return wa(2, 0, e);
				Jt(e);
			}
			var an = function(t) {
				var e = sl(), n = t();
			...
			function gn(e) {
				var t = new bn(e);
				return t.get_caught() || (t.set_caught(!0), fn--), t.set_rethrown(!1), _n.push(t), Wi(t.excPtr), t.get_exception_ptr();
			}
			function hn() {
				if (!_n.length) return 0;
				var e = _n[_n.length - 1];
				return Wi(e.excPtr), e.excPtr;
			}
			var yn = 0;
			function Cn() {
				rl(0, 0), V(_n.length > 0);
				var e = _n.pop();
				qi(e.excPtr), yn = 0;
			}
			function bn(e) {
			...
			function $n(e) {
				zi(e, !L, 1, !R, 1048576, !1), tn.threadInitTLS();
			}
			function Pn(e) {
				I ? postMessage({
					cmd: "cleanupThread",
			...
			function Nn(e, t, n, r) {
				return I ? wa(3, 1, e, t, n, r) : Mn(e, t, n, r);
			}
			function Mn(e, t, n, r) {
...
` + n.replace(/^Error(:[^\n]*)?\n/, ""));
			...
			function No(e, t) {
				...
				dr(e, {
					...
					toWireType: function(t, r) {
						...
						var a = Di(4 + e + 1), i = a + 4;
						if (p()[a >> 2] = e, n && o) Vn(r, i, e + 1);
						else if (o) for (var s = 0; s < e; ++s) {
							var u = r.charCodeAt(s);
							u > 255 && (xi(i), ir("String has UTF-16 code units that do not fit in 8 bits")), l()[i + s] = u;
						}
			...
			var Mo = typeof TextDecoder != "undefined" ? new TextDecoder("utf-16le") : void 0, wo = function(t, n) {
				...
				n === 2 ? (e = wo, o = Ao, i = Fo, a = function() {
					...
					toWireType: function(t, a) {
						...
						var e = i(a), s = Di(4 + e + n);
						return p()[s >> 2] = e >> l, o(a, s + 4, e + n), t !== null && t.push(xi, s), s;
					},
					argPackAdvance: 8,
					readValueFromPointer: to,
					destructorFunction: function(t) {
			...
			function ua(e, t, n, r, o, a, i) {
				if (I) return wa(16, 1, e, t, n, r, o, a, i);
			...
			function ca(e, t, n, r, o, a) {
				if (I) return wa(17, 1, e, t, n, r, o, a);
			...
			function da(e, t, n, r, o, a) {
				if (I) return wa(18, 1, e, t, n, r, o, a);
				e = qn(e), t = qn(t), a = qn(a);
				try {
			...
			function Ra(e, t) {
				if (ka.mainLoop.timingMode = e, ka.mainLoop.timingValue = t, !ka.mainLoop.func) return w("emscripten_set_main_loop_timing: Cannot set timing mode for main loop since a main loop does not exist! Call emscripten_set_main_loop first to set one up."), 1;
				if (ka.mainLoop.running || (ba(), ka.mainLoop.running = !0), e == 0) ka.mainLoop.scheduler = function() {
					var e = Math.max(0, ka.mainLoop.tickStartTime + t - La()) | 0;
					setTimeout(ka.mainLoop.runner, e);
				}, ka.mainLoop.method = "timeout";
				else if (e == 1) ka.mainLoop.scheduler = function() {
			...
			function Ea(e, t, n, r, o) {
				V(!ka.mainLoop.func, "emscripten_set_main_loop: there can only be one main loop function at once: call emscripten_cancel_main_loop to cancel the previous one before setting a new one with different parameters."), ka.mainLoop.func = e, ka.mainLoop.arg = r;
				var a = ka.mainLoop.currentlyRunningMainloop;
				function i() {
					return a < ka.mainLoop.currentlyRunningMainloop ? (va(), !1) : !0;
				}
				if (ka.mainLoop.running = !1, ka.mainLoop.runner = function() {
					if (!q) {
						if (ka.mainLoop.queue.length > 0) {
							var t = Date.now(), n = ka.mainLoop.queue.shift();
							if (n.func(n.arg), ka.mainLoop.remainingBlockers) {
								var r = ka.mainLoop.remainingBlockers, o = r % 1 == 0 ? r - 1 : Math.floor(r);
								n.counted ? ka.mainLoop.remainingBlockers = o : (o = o + .5, ka.mainLoop.remainingBlockers = (8 * r + o) / 9);
							}
							if (M("main loop blocker \"" + n.name + "\" took " + (Date.now() - t) + " ms"), ka.mainLoop.updateStatus(), !i()) return;
							setTimeout(ka.mainLoop.runner, 0);
							return;
						}
						if (i()) {
							if (ka.mainLoop.currentFrameNumber = ka.mainLoop.currentFrameNumber + 1 | 0, ka.mainLoop.timingMode == 1 && ka.mainLoop.timingValue > 1 && ka.mainLoop.currentFrameNumber % ka.mainLoop.timingValue != 0) {
								ka.mainLoop.scheduler();
								return;
							} else ka.mainLoop.timingMode == 0 && (ka.mainLoop.tickStartTime = La());
							ka.mainLoop.method === "timeout" && g.ctx && (mn("Looks like you are rendering without using requestAnimationFrame for the main loop. You should use 0 for the frame rate in emscripten_set_main_loop in order to use requestAnimationFrame, as that can greatly improve your frame rates!"), ka.mainLoop.method = ""), ka.mainLoop.runIter(e), oe(), i() && (typeof SDL == "object" && SDL.audio && SDL.audio.queueNewAudioData && SDL.audio.queueNewAudioData(), ka.mainLoop.scheduler());
						}
					}
				}, o || (t && t > 0 ? Ra(0, 1e3 / t) : Ra(1, 1), ka.mainLoop.scheduler()), n) throw "unwind";
			}
			var ka = {
				mainLoop: {
					running: !1,
					...
					queue: [],
					pause: function() {
						ka.mainLoop.scheduler = null, ka.mainLoop.currentlyRunningMainloop++;
					},
					resume: function() {
						ka.mainLoop.currentlyRunningMainloop++;
						var e = ka.mainLoop.timingMode, t = ka.mainLoop.timingValue, n = ka.mainLoop.func;
						ka.mainLoop.func = null, Ea(n, 0, !1, ka.mainLoop.arg, !0), Ra(e, t), ka.mainLoop.scheduler();
					},
					updateStatus: function() {
						if (g.setStatus) {
							var e = g.statusMessage || "Please wait...", t = ka.mainLoop.remainingBlockers, n = ka.mainLoop.expectedBlockers;
				...
				init: function() {
					...
					e.canHandle = function(t) {
						...
						e.size !== t.length && (e = new Blob([new Uint8Array(t).buffer], { type: ka.getMimetype(n) }));
						...
						i.onload = function() {
							...
							o.drawImage(i, 0, 0), vi[n] = e, URL.revokeObjectURL(a), r && r(t);
					...
					t.canHandle = function(t) {
						...
						var i = new Blob([t], { type: ka.getMimetype(n) }), l = URL.createObjectURL(i);
					...
					function n() {
						ka.pointerLock = document.pointerLockElement === g.canvas || document.mozPointerLockElement === g.canvas || document.webkitPointerLockElement === g.canvas || document.msPointerLockElement === g.canvas;
					}
					var r = g.canvas;
					r && (r.requestPointerLock = r.requestPointerLock || r.mozRequestPointerLock || r.webkitRequestPointerLock || r.msRequestPointerLock || function() {}, r.exitPointerLock = document.exitPointerLock || document.mozExitPointerLock || document.webkitExitPointerLock || document.msExitPointerLock || function() {}, r.exitPointerLock = r.exitPointerLock.bind(document), document.addEventListener("pointerlockchange", n, !1), document.addEventListener("mozpointerlockchange", n, !1), document.addEventListener("webkitpointerlockchange", n, !1), document.addEventListener("mspointerlockchange", n, !1), g.elementPointerLock && r.addEventListener("click", function(e) {
						!ka.pointerLock && g.canvas.requestPointerLock && (g.canvas.requestPointerLock(), e.preventDefault());
					}, !1));
				},
				createContext: function(t, n, r, o) {
					...
					return e ? (r && (n || V(typeof GLctx == "undefined", "cannot set in module if GLctx is used, but we are a non-GL context that would replace it"), g.ctx = e, n && GL.makeContextCurrent(a), g.useWebGL = n, ka.moduleContextCreatedCallbacks.forEach(function(e) {
						return e();
					}), ka.init()), e) : null;
				},
				...
				requestFullscreen: function(t, n) {
					ka.lockPointer = t, ka.resizeCanvas = n, typeof ka.lockPointer == "undefined" && (ka.lockPointer = !0), typeof ka.resizeCanvas == "undefined" && (ka.resizeCanvas = !1);
					var e = g.canvas;
					function r() {
						ka.isFullscreen = !1;
						var t = e.parentNode;
						(document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === t ? (e.exitFullscreen = ka.exitFullscreen, ka.lockPointer && e.requestPointerLock(), ka.isFullscreen = !0, ka.resizeCanvas ? ka.setFullscreenCanvasSize() : ka.updateCanvasDimensions(e)) : (t.parentNode.insertBefore(e, t), t.parentNode.removeChild(t), ka.resizeCanvas ? ka.setWindowedCanvasSize() : ka.updateCanvasDimensions(e)), g.onFullScreen && g.onFullScreen(ka.isFullscreen), g.onFullscreen && g.onFullscreen(ka.isFullscreen);
					}
					ka.fullscreenHandlersInstalled || (ka.fullscreenHandlersInstalled = !0, document.addEventListener("fullscreenchange", r, !1), document.addEventListener("mozfullscreenchange", r, !1), document.addEventListener("webkitfullscreenchange", r, !1), document.addEventListener("MSFullscreenChange", r, !1));
				...
				safeRequestAnimationFrame: function(t) {
					return ba(), ka.requestAnimationFrame(function() {
						va(), zo(t);
					});
				},
				...
				calculateMouseEvent: function(t) {
					if (ka.pointerLock) t.type != "mousemove" && "mozMovementX" in t ? ka.mouseMovementX = ka.mouseMovementY = 0 : (ka.mouseMovementX = ka.getMovementX(t), ka.mouseMovementY = ka.getMovementY(t)), typeof SDL != "undefined" ? (ka.mouseX = SDL.mouseX + ka.mouseMovementX, ka.mouseY = SDL.mouseY + ka.mouseMovementY) : (ka.mouseX += ka.mouseMovementX, ka.mouseY += ka.mouseMovementY);
					else {
						...
						if (V(typeof o != "undefined" && typeof a != "undefined", "Unable to retrieve scroll position, mouse positions likely broken."), t.type === "touchstart" || t.type === "touchend" || t.type === "touchmove") {
							...
							if (t.type === "touchstart") ka.lastTouches[i.identifier] = u, ka.touches[i.identifier] = u;
							else if (t.type === "touchend" || t.type === "touchmove") {
								var c = ka.touches[i.identifier];
								c || (c = u), ka.lastTouches[i.identifier] = c, ka.touches[i.identifier] = u;
							}
							return;
						}
						var d = t.pageX - (o + e.left), m = t.pageY - (a + e.top);
						d = d * (n / e.width), m = m * (r / e.height), ka.mouseMovementX = d - ka.mouseX, ka.mouseMovementY = m - ka.mouseY, ka.mouseX = d, ka.mouseY = m;
					}
				},
				resizeListeners: [],
				...
				setCanvasSize: function(t, n, r) {
					var e = g.canvas;
					ka.updateCanvasDimensions(e, t, n), r || ka.updateResizeListeners();
				},
				windowedWidth: 0,
				windowedHeight: 0,
				setFullscreenCanvasSize: function() {
					...
					ka.updateCanvasDimensions(g.canvas), ka.updateResizeListeners();
				},
			...
			function wa(e, t) {
				...
				return an(function() {
					for (var o = n * 2, a = cl(o * 8), i = a >> 3, l = 0; l < n; l++) {
						var s = r[2 + l];
			...
			var Aa = [];
			function Fa(e, t, n, r) {
				tn.currentProxiedOperationCallerThread = t, n /= 2, Aa.length = n;
				for (var o = r >> 3, a = 0; a < n; a++) Y[o + 2 * a] ? Aa[a] = Y[o + 2 * a + 1] : Aa[a] = f()[o + 2 * a + 1];
				var i = e < 0, l = i ? Ge[-e - 1] : Ri[e];
				return V(l.length == n, "Call args mismatch in emscripten_receive_on_main_thread_js"), l.apply(null, Aa);
			}
			var Oa = function(t) {
				...
				if (!Ha.strings) {
					...
					for (var n in Ua) Ua[n] === void 0 ? delete t[n] : t[n] = Ua[n];
					var r = [];
			...
			function za(e, t) {
				if (I) return wa(19, 1, e, t);
				var n = 0;
				return Ha().forEach(function(r, o) {
					var a = t + n;
					p()[e + o * 4 >> 2] = a, Ga(r, a), n += r.length + 1;
				}), 0;
			}
			function ja(e, t) {
				if (I) return wa(20, 1, e, t);
				var n = Ha();
				p()[e >> 2] = n.length;
				var r = 0;
			...
			function Xa(e, t, n, r, o) {
				if (I) return wa(22, 1, e, t, n, r, o);
				t = qn(t), n = qn(n), r = qn(r), o = qn(o);
				try {
					if (isNaN(r)) return 61;
					var a = Qt.getStreamFromFD(e), i = Qa(a, t, n, r);
					return p()[o >> 2] = i, 0;
				} catch (e) {
					if (typeof jt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			function Za(e, t, n, r) {
				if (I) return wa(24, 1, e, t, n, r);
				try {
					var o = Qt.getStreamFromFD(e), a = Qa(o, t, n);
					return p()[r >> 2] = a, 0;
				} catch (e) {
					if (typeof jt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			var ri = function(t, n) {
				...
				for (t.startsWith("::") ? t = t.replace("::", "Z:") : t = t.replace("::", ":Z:"), t.indexOf(".") > 0 ? (t = t.replace(new RegExp("[.]", "g"), ":"), e = t.split(":"), e[e.length - 4] = ai(e[e.length - 4]) + ai(e[e.length - 3]) * 256, e[e.length - 3] = ai(e[e.length - 2]) + ai(e[e.length - 1]) * 256, e = e.slice(0, e.length - 2)) : e = t.split(":"), r = 0, o = 0, n = 0; n < e.length; n++) if (typeof e[n] == "string") if (e[n] === "Z") {
				...
				lookup_name: function(t) {
					...
					if (li.address_map.addrs[t]) n = li.address_map.addrs[t];
						...
						V(r < 65535, "exceeded max address mappings of 65535"), n = "172.29." + (r & 255) + "." + (r & 65280), li.address_map.names[n] = t, li.address_map.addrs[t] = n;
					}
					return n;
				},
				...
				var a = Di(12);
				return p()[a >> 2] = a + 8, p()[a + 4 >> 2] = 0, m()[a + 8 >> 2] = oi(li.lookup_name(t)), p()[e + 16 >> 2] = a, e;
			};
			function ui(e) {
				return I ? wa(28, 1, e) : si(Kt(e));
			}
			function ci(e) {
				return e;
			}
			var di = function(t, n) {
				...
				for (var e = new Date(t.getTime()); n > 0;) {
					var r = ra(e.getFullYear()), o = e.getMonth(), a = (r ? mi : pi)[o];
				...
				function g(e) {
					var t = _i(new Date(e.tm_year + 1900, 0, 1), e.tm_yday), n = new Date(t.getFullYear(), 0, 4), r = new Date(t.getFullYear() + 1, 0, 4), o = f(n), a = f(r);
				...
				var h = {
					...
					"%j": function(t) {
						return p(t.tm_mday + di(ra(t.tm_year + 1900) ? mi : pi, t.tm_mon - 1), 3);
					},
					"%m": function(t) {
...
`;
			...
			}), jt.FSNode = yi, jt.createPreloadedFile = Bt, jt.staticInit(), Ht = {
				EPERM: 63,
				ENOENT: 44,
				ESRCH: 71,
				EINTR: 27,
			...
			var Ei = {
				...
				invoke_iiiidd: wu,
				invoke_iiiifiii: ys,
				invoke_iiiifiiiiii: Ss,
				invoke_iiiii: Il,
				invoke_iiiiid: Hu,
				invoke_iiiiii: Nl,
				invoke_iiiiiii: Ll,
				invoke_iiiiiiiddiiid: Fu,
				invoke_iiiiiiii: $l,
				invoke_iiiiiiiidi: Ou,
				invoke_iiiiiiiifii: nu,
				invoke_iiiiiiiii: Tl,
				invoke_iiiiiiiiii: xl,
				invoke_iiiiiiiiiiffiii: _s,
				invoke_iiiiiiiiiii: Hl,
				invoke_iiiiiiiiiiii: bs,
				invoke_iiiiiiiiiiiiffiii: hs,
				invoke_iiiiiiiiiiiii: Rs,
				invoke_iiiiiiiiiiiiii: Ol,
				invoke_iiiiiiiiiiiiiiffiiiii: Cs,
				invoke_iiiiiiiiiiiiiii: Is,
				invoke_iiiiiiiiiiiiiiiffiiiii: fs,
				invoke_iiiiiiiiiiiiiiii: zs,
				invoke_iiiiiiiiiiiiiiiiiffiiiii: gs,
				invoke_iiiiiiiiiiiiiiiiii: Bl,
				invoke_iiiiiiiiiiji: Kl,
				invoke_iiiiiiiiij: qs,
				invoke_iiiiiiiij: Os,
				invoke_iiiiiiij: Ms,
				invoke_iiiiiiijjii: Ks,
				invoke_iiiiiij: Bs,
				invoke_iiiiiijiiii: Us,
				invoke_iiiiiijjijiiiiiiiiii: Xs,
				invoke_iiiiij: Tu,
				invoke_iiiiiji: As,
				invoke_iiiiijjii: ls,
				invoke_iiiiijjiii: ss,
				invoke_iiiiijjjii: as,
				invoke_iiiiijjjiii: is,
				invoke_iiiij: ks,
				invoke_iiiijiii: cu,
				invoke_iiiijiiji: Zl,
				invoke_iiiijjii: cs,
				...
				invoke_viiiii: Pl,
				invoke_viiiiii: Fl,
				invoke_viiiiiidiii: Xl,
				invoke_viiiiiii: Al,
				invoke_viiiiiiiddiii: zl,
				invoke_viiiiiiii: wl,
				invoke_viiiiiiiii: Ml,
				invoke_viiiiiiiiii: Ql,
				invoke_viiiiiiiiiiii: Ds,
				invoke_viiiiiiiiiiiii: Pu,
				invoke_viiiiiiiiiiiiiii: Ku,
				invoke_viiiiiiiiiiiiiiiiiiiiiiiiiiiiiii: vu,
				invoke_viiiiiiij: $u,
				invoke_viiiiij: su,
				invoke_viiiiiji: Wu,
				invoke_viiiij: uu,
				invoke_viiiijiiii: vs,
				invoke_viiij: ku,
				invoke_viiiji: es,
				invoke_viij: xs,
				invoke_viiji: eu,
				...
				strftime_l: hi
			}, ki = Fe(), Ii = Te("__wasm_call_ctors"), Ti = Te("__cxa_free_exception"), Di = g._malloc = Te("malloc"), xi = g._free = Te("free"), $i = g._wasm_throw_ml_abort = Te("wasm_throw_ml_abort"), Pi = g._fflush = Te("fflush"), Ni = Te("__errno_location"), Mi = g._pthread_self = function() {
				return (Mi = g._pthread_self = B.pthread_self)();
			}, wi = Te("ntohs"), Ai = Te("htonl"), Fi = Te("htons"), Oi = g.__ZN5folly15SharedMutexImplILb1EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj = Te("_ZN5folly15SharedMutexImplILb1EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj"), Bi = g.__ZN5folly15SharedMutexImplILb0EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj = Te("_ZN5folly15SharedMutexImplILb0EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj"), Wi = Te("__cxa_increment_exception_refcount"), qi = Te("__cxa_decrement_exception_refcount"), Ui = g.__emscripten_tls_init = Te("_emscripten_tls_init"), Vi = Te("emscripten_builtin_memalign"), Hi = Te("__getTypeName"), Gi = g.__embind_initialize_bindings = Te("_embind_initialize_bindings"), zi = g.__emscripten_thread_init = Te("_emscripten_thread_init"), ji = g.__emscripten_thread_crashed = Te("_emscripten_thread_crashed"), Ki = Te("emscripten_main_thread_process_queued_calls"), Qi = Te("emscripten_main_runtime_thread_id"), Xi = Te("_emscripten_run_in_main_runtime_thread_js"), Yi = Te("emscripten_dispatch_to_thread_"), Ji = function() {
				return (Ji = B.emscripten_stack_get_base)();
			}, Zi = function() {
				return (Zi = B.emscripten_stack_get_end)();
			}, el = Te("_emscripten_thread_free_data"), tl = g.__emscripten_thread_exit = Te("_emscripten_thread_exit"), nl = g.__emscripten_check_mailbox = Te("_emscripten_check_mailbox"), rl = Te("setThrew"), ol = Te("setTempRet0"), al = function() {
				return (al = B.emscripten_stack_init)();
			}, il = function(t, n) {
				return (il = B.emscripten_stack_set_limits)(t, n);
			}, ll = function() {
				return (ll = B.emscripten_stack_get_free)();
			}, sl = Te("stackSave"), ul = Te("stackRestore"), cl = Te("stackAlloc"), dl = function() {
				return (dl = B.emscripten_stack_get_current)();
			}, ml = g.___get_exception_message = Te("__get_exception_message"), pl = Te("__cxa_can_catch"), _l = Te("__cxa_is_pointer_type"), fl = g.___start_em_js = 1331564, gl = g.___stop_em_js = 1336996;
			function hl(e, t, n, r) {
				var o = sl();
				try {
					un(e)(t, n, r);
				} catch (e) {
					if (ul(o), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function yl(e) {
				...
				try {
					...
					if (ul(t), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function Cl(e, t, n) {
				...
				try {
					...
					if (ul(r), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function bl(e, t) {
				...
				try {
					...
					if (ul(n), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function vl(e, t, n) {
			...
			function Ll(e, t, n, r, o, a, i) {
				...
				try {
					...
					if (ul(l), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function El(e, t) {
			...
			function kl(e, t, n, r, o) {
				...
				try {
					...
					if (ul(a), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			...
			function Tl(e, t, n, r, o, a, i, l, s) {
				...
				try {
					...
					if (ul(u), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function Dl(e, t, n, r) {
			...
			function xl(e, t, n, r, o, a, i, l, s, u) {
				...
				try {
					...
					if (ul(c), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function $l(e, t, n, r, o, a, i, l) {
				...
				try {
					...
					if (ul(s), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function Pl(e, t, n, r, o, a) {
				...
				try {
					...
					if (ul(i), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			...
			function Ol(e, t, n, r, o, a, i, l, s, u, c, d, m, p) {
				var _ = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d, m, p);
				} catch (e) {
					if (ul(_), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function Bl(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h) {
				var y = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h);
				} catch (e) {
					if (ul(y), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function Wl(e) {
			...
			function Hl(e, t, n, r, o, a, i, l, s, u, c) {
				...
				try {
					...
					if (ul(d), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			...
			function zl(e, t, n, r, o, a, i, l, s, u, c, d, m) {
				...
				try {
					...
					if (ul(p), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			...
			function Kl(e, t, n, r, o, a, i, l, s, u, c, d) {
				var m = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d);
				} catch (e) {
					if (ul(m), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			...
			function ts(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f) {
				var g = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f);
				} catch (e) {
					if (ul(g), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			...
			function _s(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _) {
				var f = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _);
				} catch (e) {
					if (ul(f), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function fs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v) {
				var S = sl();
				try {
			...
			function gs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R) {
				var L = sl();
				try {
			...
			function hs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g) {
				var h = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g);
				} catch (e) {
					if (ul(h), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			...
			function Cs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b) {
				var v = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b);
				} catch (e) {
					if (ul(v), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function bs(e, t, n, r, o, a, i, l, s, u, c, d) {
				var m = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d);
				} catch (e) {
			...
			function qs(e, t, n, r, o, a, i, l, s, u) {
				var c = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u);
				} catch (e) {
			...
			function Xs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C) {
				var b = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C);
				} catch (e) {
					if (ul(b), !(e instanceof De)) throw e;
					rl(1, 0);
				}
			}
			function Ys(e, t, n) {
			...
			function vu(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $) {
				var P = sl();
				try {
			...
			function Fu(e, t, n, r, o, a, i, l, s, u, c, d, m) {
				var p = sl();
				try {
					return un(e)(t, n, r, o, a, i, l, s, u, c, d, m);
				} catch (e) {
			...
			function Ku(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f) {
				var g = sl();
				try {
			...
			function Zu() {
				...
				if (de(), he > 0) return;
				function e() {
					Yu || (Yu = !0, g.calledRun = !0, !q && (me(), h(g), g.onRuntimeInitialized && g.onRuntimeInitialized(), V(!g._main, "compiled without a main, but one is present. if you added it from JS, use Module[\"onRuntimeInitialized\"]"), pe()));
				}
			...
			function ec() {
				...
				try {
					Pi(0), ["stdout", "stderr"].forEach(function(e) {
