__d("WAWebVoipWebWasmLoader_ContentAddressed_internal", [
	...
	var e = ["type", "__name"], s, u = null, c;
	try {
		c = r("bx").getURL(r("bx")("14100"), { cacheBreaker: "1786008825082" });
	} catch (e) {
		u = e;
	}
	var d = (function() {
		...
		return function(a) {
			...
			var y = a;
			if (o("WAWebVoipWasmArtifactRegistry").recordSelectedVoipWasmUri("/wasm/whatsapp/versioned/e55e43babf85e2c0fc76ec65dcb8d47beba0f58b03b135b37a5aaaff7fe70e2f/wa_voip_shared.wasm"), u != null) throw o("WAWebCoreActionsODS").logCallVoipInitWasmArtifactContentAddressedBxLookupFailure(), String(u).includes("Unknown file path") && o("WAWebCoreActionsODS").logCallVoipInitWasmArtifactContentAddressedBxKeyMissing(), u;
			o("WAWebVoipWasmArtifactRegistry").recordSelectedVoipWasmUri(c);
			var C, b;
			y.ready = new Promise(function(e, t) {
				C = e, b = t;
			}), [
				"_malloc",
				"_free",
			...
			function yt(e) {
				...
				var t = rn.pthreads[e];
				delete rn.pthreads[e], ht(t), nl(e), rn.runningWorkers.splice(rn.runningWorkers.indexOf(t), 1), t.pthread_ptr = 0;
			}
			function Ct(e) {
...
`)), !e) return null;
			...
			var Zt = function(t, n) {
				...
				ie(), t instanceof WebAssembly.RuntimeError && pl() <= 0 && F("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 1048576)"), L(1, t);
			}, rn = {
				unusedWorkers: [],
				runningWorkers: [],
				tlsInitFunctions: [],
				...
				debugInit: function() {
					function e() {
						var e = 0;
						return ce && typeof Ai != "undefined" && (e = Ai()), "w:" + (y.workerID || 0) + ",t:" + tn(e) + ": ";
					}
					var t = ze;
					ze = function(r) {
						return t(e() + r);
				...
				returnWorkerToPool: function(t) {
					var e = t.pthread_ptr;
					delete rn.pthreads[e], rn.unusedWorkers.push(t), rn.runningWorkers.splice(rn.runningWorkers.indexOf(t), 1), t.pthread_ptr = 0, nl(e);
				},
					...
					return new Promise(function(n) {
						r.addMessageListener("cmd", function(e) {
							...
							if (t.targetThread && t.targetThread != Ai()) {
								...
								a ? a.postMessage(babelHelpers.extends({}, t, { type: "cmd" }), t.transferList) : F("Internal error! Worker sent a message \"" + o + "\" to target pthread " + t.targetThread + ", but that thread no longer exists!");
								return;
							}
							o === "checkMailbox" ? Xo() : o === "spawnThread" ? St(t) : o === "cleanupThread" ? bt(t.thread) : o === "killThread" ? yt(t.thread) : o === "cancelThread" ? Ct(t.thread) : o === "loaded" ? (r.loaded = !0, n(r)) : o === "alert" ? alert("Thread " + t.threadId + ": " + t.text) : t.target === "setimmediate" ? r.postMessage(babelHelpers.extends({}, t, { type: "cmd" })) : o === "callHandler" ? y[t.handler].apply(y, t.args) : o && F("worker sent an unknown command " + o);
							...
							throw r.pthread_ptr && (t = "Pthread " + tn(r.pthread_ptr) + " sent an error!"), F(t + " " + e.filename + ":" + e.lineno + ": " + e.message), e;
						...
						for (var l of a) Object.prototype.hasOwnProperty.call(y, l) && o.push(l);
						r.workerID = rn.nextWorkerID++, r.postMessage({
							cmd: "load",
							handlers: o,
				...
				loadWasmModuleToAllWorkers: function(t) {
					if (D) return t();
					var e = Promise.all(rn.unusedWorkers.map(rn.loadWasmModuleToWorker));
					e.then(t);
				},
			...
			function an() {
				var e = Ai(), t = _()[e + 52 >> 2], n = _()[e + 56 >> 2], r = t - n;
				G(t != 0), G(r != 0), G(t > r, "stackHigh must be higher then stackLow"), sl(t, r), dl(t), ae();
			}
			...
			function yn(e) {
				var t = new Sn(e);
				return t.get_caught() || (t.set_caught(!0), hn--), t.set_rethrown(!1), gn.push(t), Ui(t.excPtr), t.get_exception_ptr();
			}
			function Cn() {
...
` + n.replace(/^Error(:[^\n]*)?\n/, ""));
				...
				pr(e, {
					...
					toWireType: function(t, r) {
						...
						if (f()[a >> 2] = e, n && o) Gn(r, i, e + 1);
							...
							s > 255 && (Pi(i), sr("String has UTF-16 code units that do not fit in 8 bits")), d()[i + l] = s;
						}
			...
			var _a = function(t) {
				...
				return Sa(), setTimeout(function() {
					Ra(), Ko(t);
				}, n);
			};
			function Ea(e, t) {
				if (Ta.mainLoop.timingMode = e, Ta.mainLoop.timingValue = t, !Ta.mainLoop.func) return F("emscripten_set_main_loop_timing: Cannot set timing mode for main loop since a main loop does not exist! Call emscripten_set_main_loop first to set one up."), 1;
				if (Ta.mainLoop.running || (Sa(), Ta.mainLoop.running = !0), e == 0) Ta.mainLoop.scheduler = function() {
					var e = Math.max(0, Ta.mainLoop.tickStartTime + t - ka()) | 0;
					setTimeout(Ta.mainLoop.runner, e);
				}, Ta.mainLoop.method = "timeout";
				else if (e == 1) Ta.mainLoop.scheduler = function() {
			...
			function Ia(e, t, n, r, o) {
				G(!Ta.mainLoop.func, "emscripten_set_main_loop: there can only be one main loop function at once: call emscripten_cancel_main_loop to cancel the previous one before setting a new one with different parameters."), Ta.mainLoop.func = e, Ta.mainLoop.arg = r;
				var a = Ta.mainLoop.currentlyRunningMainloop;
				function i() {
					return a < Ta.mainLoop.currentlyRunningMainloop ? (Ra(), !1) : !0;
				}
				if (Ta.mainLoop.running = !1, Ta.mainLoop.runner = function() {
					if (!V) {
						if (Ta.mainLoop.queue.length > 0) {
							var t = Date.now(), n = Ta.mainLoop.queue.shift();
							if (n.func(n.arg), Ta.mainLoop.remainingBlockers) {
								var r = Ta.mainLoop.remainingBlockers, o = r % 1 == 0 ? r - 1 : Math.floor(r);
								n.counted ? Ta.mainLoop.remainingBlockers = o : (o = o + .5, Ta.mainLoop.remainingBlockers = (8 * r + o) / 9);
							}
							if (A("main loop blocker \"" + n.name + "\" took " + (Date.now() - t) + " ms"), Ta.mainLoop.updateStatus(), !i()) return;
							setTimeout(Ta.mainLoop.runner, 0);
							return;
						}
						if (i()) {
							if (Ta.mainLoop.currentFrameNumber = Ta.mainLoop.currentFrameNumber + 1 | 0, Ta.mainLoop.timingMode == 1 && Ta.mainLoop.timingValue > 1 && Ta.mainLoop.currentFrameNumber % Ta.mainLoop.timingValue != 0) {
								Ta.mainLoop.scheduler();
								return;
							} else Ta.mainLoop.timingMode == 0 && (Ta.mainLoop.tickStartTime = ka());
							Ta.mainLoop.method === "timeout" && y.ctx && (_n("Looks like you are rendering without using requestAnimationFrame for the main loop. You should use 0 for the frame rate in emscripten_set_main_loop in order to use requestAnimationFrame, as that can greatly improve your frame rates!"), Ta.mainLoop.method = ""), Ta.mainLoop.runIter(e), ie(), i() && (typeof SDL == "object" && SDL.audio && SDL.audio.queueNewAudioData && SDL.audio.queueNewAudioData(), Ta.mainLoop.scheduler());
						}
					}
				}, o || (t && t > 0 ? Ea(0, 1e3 / t) : Ea(1, 1), Ta.mainLoop.scheduler()), n) throw "unwind";
			}
			var Ta = {
				mainLoop: {
					running: !1,
					...
					queue: [],
					pause: function() {
						Ta.mainLoop.scheduler = null, Ta.mainLoop.currentlyRunningMainloop++;
					},
					resume: function() {
						Ta.mainLoop.currentlyRunningMainloop++;
						var e = Ta.mainLoop.timingMode, t = Ta.mainLoop.timingValue, n = Ta.mainLoop.func;
						Ta.mainLoop.func = null, Ia(n, 0, !1, Ta.mainLoop.arg, !0), Ea(e, t), Ta.mainLoop.scheduler();
					},
					updateStatus: function() {
						if (y.setStatus) {
							var e = y.statusMessage || "Please wait...", t = Ta.mainLoop.remainingBlockers, n = Ta.mainLoop.expectedBlockers;
				...
				init: function() {
					...
					e.canHandle = function(t) {
						...
						e.size !== t.length && (e = new Blob([new Uint8Array(t).buffer], { type: Ta.getMimetype(n) }));
					...
					t.canHandle = function(t) {
						...
						var i = new Blob([t], { type: Ta.getMimetype(n) }), l = URL.createObjectURL(i);
					...
					function n() {
						Ta.pointerLock = document.pointerLockElement === y.canvas || document.mozPointerLockElement === y.canvas || document.webkitPointerLockElement === y.canvas || document.msPointerLockElement === y.canvas;
					}
					var r = y.canvas;
					r && (r.requestPointerLock = r.requestPointerLock || r.mozRequestPointerLock || r.webkitRequestPointerLock || r.msRequestPointerLock || function() {}, r.exitPointerLock = document.exitPointerLock || document.mozExitPointerLock || document.webkitExitPointerLock || document.msExitPointerLock || function() {}, r.exitPointerLock = r.exitPointerLock.bind(document), document.addEventListener("pointerlockchange", n, !1), document.addEventListener("mozpointerlockchange", n, !1), document.addEventListener("webkitpointerlockchange", n, !1), document.addEventListener("mspointerlockchange", n, !1), y.elementPointerLock && r.addEventListener("click", function(e) {
						!Ta.pointerLock && y.canvas.requestPointerLock && (y.canvas.requestPointerLock(), e.preventDefault());
					}, !1));
				},
				createContext: function(t, n, r, o) {
					...
					return e ? (r && (n || G(typeof GLctx == "undefined", "cannot set in module if GLctx is used, but we are a non-GL context that would replace it"), y.ctx = e, n && GL.makeContextCurrent(a), y.useWebGL = n, Ta.moduleContextCreatedCallbacks.forEach(function(e) {
						return e();
					}), Ta.init()), e) : null;
				},
				...
				requestFullscreen: function(t, n) {
					Ta.lockPointer = t, Ta.resizeCanvas = n, typeof Ta.lockPointer == "undefined" && (Ta.lockPointer = !0), typeof Ta.resizeCanvas == "undefined" && (Ta.resizeCanvas = !1);
					var e = y.canvas;
					function r() {
						Ta.isFullscreen = !1;
						var t = e.parentNode;
						(document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === t ? (e.exitFullscreen = Ta.exitFullscreen, Ta.lockPointer && e.requestPointerLock(), Ta.isFullscreen = !0, Ta.resizeCanvas ? Ta.setFullscreenCanvasSize() : Ta.updateCanvasDimensions(e)) : (t.parentNode.insertBefore(e, t), t.parentNode.removeChild(t), Ta.resizeCanvas ? Ta.setWindowedCanvasSize() : Ta.updateCanvasDimensions(e)), y.onFullScreen && y.onFullScreen(Ta.isFullscreen), y.onFullscreen && y.onFullscreen(Ta.isFullscreen);
					}
					Ta.fullscreenHandlersInstalled || (Ta.fullscreenHandlersInstalled = !0, document.addEventListener("fullscreenchange", r, !1), document.addEventListener("mozfullscreenchange", r, !1), document.addEventListener("webkitfullscreenchange", r, !1), document.addEventListener("MSFullscreenChange", r, !1));
				...
				safeRequestAnimationFrame: function(t) {
					return Sa(), Ta.requestAnimationFrame(function() {
						Ra(), Ko(t);
					});
				},
				...
				calculateMouseEvent: function(t) {
					if (Ta.pointerLock) t.type != "mousemove" && "mozMovementX" in t ? Ta.mouseMovementX = Ta.mouseMovementY = 0 : (Ta.mouseMovementX = Ta.getMovementX(t), Ta.mouseMovementY = Ta.getMovementY(t)), typeof SDL != "undefined" ? (Ta.mouseX = SDL.mouseX + Ta.mouseMovementX, Ta.mouseY = SDL.mouseY + Ta.mouseMovementY) : (Ta.mouseX += Ta.mouseMovementX, Ta.mouseY += Ta.mouseMovementY);
					else {
						...
						if (G(typeof o != "undefined" && typeof a != "undefined", "Unable to retrieve scroll position, mouse positions likely broken."), t.type === "touchstart" || t.type === "touchend" || t.type === "touchmove") {
							...
							if (t.type === "touchstart") Ta.lastTouches[i.identifier] = u, Ta.touches[i.identifier] = u;
							else if (t.type === "touchend" || t.type === "touchmove") {
								var c = Ta.touches[i.identifier];
								c || (c = u), Ta.lastTouches[i.identifier] = c, Ta.touches[i.identifier] = u;
							}
							return;
						}
						var d = t.pageX - (o + e.left), m = t.pageY - (a + e.top);
						d = d * (n / e.width), m = m * (r / e.height), Ta.mouseMovementX = d - Ta.mouseX, Ta.mouseMovementY = m - Ta.mouseY, Ta.mouseX = d, Ta.mouseY = m;
					}
				},
				resizeListeners: [],
				...
				setCanvasSize: function(t, n, r) {
					var e = y.canvas;
					Ta.updateCanvasDimensions(e, t, n), r || Ta.updateResizeListeners();
				},
				windowedWidth: 0,
				windowedHeight: 0,
			...
			var Oa = [];
			function Ba(e, t, n, r) {
				rn.currentProxiedOperationCallerThread = t, n /= 2, Oa.length = n;
				for (var o = r >> 3, a = 0; a < n; a++) Z[o + 2 * a] ? Oa[a] = Z[o + 2 * a + 1] : Oa[a] = h()[o + 2 * a + 1];
				var i = e < 0, l = i ? je[-e - 1] : Ei[e];
				return G(l.length == n, "Call args mismatch in emscripten_receive_on_main_thread_js"), l.apply(null, Oa);
			}
			var Wa = function(t) {
			...
			function Ja(e, t, n, r, o) {
				...
				try {
					...
					var a = Yt.getStreamFromFD(e), i = Ya(a, t, n, r);
					return f()[o >> 2] = i, 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			function ti(e, t, n, r) {
				...
				try {
					var o = Yt.getStreamFromFD(e), a = Ya(o, t, n);
					return f()[r >> 2] = a, 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			var ai = function(t, n) {
				...
				lookup_name: function(t) {
					...
					if (ui.address_map.addrs[t]) n = ui.address_map.addrs[t];
						...
						G(r < 65535, "exceeded max address mappings of 65535"), n = "172.29." + (r & 255) + "." + (r & 65280), ui.address_map.names[n] = t, ui.address_map.addrs[t] = n;
					}
					return n;
				},
				...
				var a = $i(12);
				return f()[a >> 2] = a + 8, f()[a + 4 >> 2] = 0, _()[a + 8 >> 2] = ii(ui.lookup_name(t)), f()[e + 16 >> 2] = a, e;
			};
			function di(e) {
			...
			var pi = function(t, n) {
				...
				for (var e = new Date(t.getTime()); n > 0;) {
					var r = aa(e.getFullYear()), o = e.getMonth(), a = (r ? _i : fi)[o];
				...
				var h = {
					...
					"%j": function(t) {
						return m(t.tm_mday + pi(aa(t.tm_year + 1900) ? _i : fi, t.tm_mon - 1), 3);
					},
					"%m": function(t) {
...
`;
			...
			}), Qt.FSNode = bi, Qt.createPreloadedFile = qt, Qt.staticInit(), zt = {
				EPERM: 63,
				ENOENT: 44,
				ESRCH: 71,
				EINTR: 27,
			...
			var Ii = {
				...
				strftime_l: Ci
			}, Ti = Be(), Di = xe("__wasm_call_ctors"), xi = xe("__cxa_free_exception"), $i = y._malloc = xe("malloc"), Pi = y._free = xe("free"), Ni = y._wasm_throw_ml_abort = xe("wasm_throw_ml_abort"), Mi = y._fflush = xe("fflush"), wi = xe("__errno_location"), Ai = y._pthread_self = function() {
				return (Ai = y._pthread_self = q.pthread_self)();
			}, Fi = xe("ntohs"), Oi = xe("htonl"), Bi = xe("htons"), Wi = y.__ZN5folly15SharedMutexImplILb1EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj = xe("_ZN5folly15SharedMutexImplILb1EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj"), qi = y.__ZN5folly15SharedMutexImplILb0EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj = xe("_ZN5folly15SharedMutexImplILb0EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj"), Ui = xe("__cxa_increment_exception_refcount"), Vi = xe("__cxa_decrement_exception_refcount"), Hi = y.__emscripten_tls_init = xe("_emscripten_tls_init"), Gi = xe("emscripten_builtin_memalign"), zi = xe("__getTypeName"), ji = y.__embind_initialize_bindings = xe("_embind_initialize_bindings"), Ki = y.__emscripten_thread_init = xe("_emscripten_thread_init"), Qi = y.__emscripten_thread_crashed = xe("_emscripten_thread_crashed"), Xi = xe("emscripten_main_thread_process_queued_calls"), Yi = xe("emscripten_main_runtime_thread_id"), Ji = xe("_emscripten_run_in_main_runtime_thread_js"), Zi = xe("emscripten_dispatch_to_thread_"), el = function() {
				return (el = q.emscripten_stack_get_base)();
			}, tl = function() {
				return (tl = q.emscripten_stack_get_end)();
			}, nl = xe("_emscripten_thread_free_data"), rl = y.__emscripten_thread_exit = xe("_emscripten_thread_exit"), ol = y.__emscripten_check_mailbox = xe("_emscripten_check_mailbox"), al = xe("setThrew"), il = xe("setTempRet0"), ll = function() {
				return (ll = q.emscripten_stack_init)();
			}, sl = function(t, n) {
				return (sl = q.emscripten_stack_set_limits)(t, n);
			}, ul = function() {
				return (ul = q.emscripten_stack_get_free)();
			}, cl = xe("stackSave"), dl = xe("stackRestore"), ml = xe("stackAlloc"), pl = function() {
				return (pl = q.emscripten_stack_get_current)();
			}, _l = y.___get_exception_message = xe("__get_exception_message"), fl = xe("__cxa_can_catch"), gl = xe("__cxa_is_pointer_type"), hl = y.___start_em_js = 1331564, yl = y.___stop_em_js = 1336996;
			function Cl(e, t, n, r) {
				var o = cl();
				try {
					dn(e)(t, n, r);
			...
			function tc() {
				...
				if (pe(), Ce > 0) return;
				function e() {
					Zu || (Zu = !0, y.calledRun = !0, !V && (_e(), C(y), y.onRuntimeInitialized && y.onRuntimeInitialized(), G(!y._main, "compiled without a main, but one is present. if you added it from JS, use Module[\"onRuntimeInitialized\"]"), fe()));
				}
