__d("WAWebVoipWebWasmLoader_ProdLab_internal.worker", [
	"Promise",
		...
		return function(r) {
				...
				mr(e, {
					...
					toWireType: function(t, r) {
						...
						if (_()[a >> 2] = e, n && o) Hn(r, i, e + 1);
							...
							u > 255 && (Ni(i), lr("String has UTF-16 code units that do not fit in 8 bits")), l()[i + s] = u;
						}
			...
			var qa = function(t) {
				...
				for (var r = function(t, n) {
					...
					var i = Math.min(n, r(Math.max(t, a), 65536)), s = qa(i);
					if (s) return !0;
				}
