__d("WAWebVoipWebWasmLoader_ProdLabvideo_internal", [
	...
	var e = ["type", "__name"], s, u, c = r("bx").getURL(r("bx")("78865"), { cacheBreaker: "1786009127559" }), d = (function() {
		...
		return function(a) {
			...
			y.ready = new (u || (u = (n("Promise"))))(function(e, t) {
				...
				Object.getOwnPropertyDescriptor(y.ready, e) || Object.defineProperty(y.ready, e, {
					get: function() {
						return ke("You are getting " + e + " on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
					},
					set: function() {
						return ke("You are setting " + e + " on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
					}
				});
			});
			var v = Object.assign({}, y), S = [], R = "./this.program", L = function(t, n) {
				throw n;
			}, E = typeof window == "object", k = typeof importScripts == "function", I = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string", T = !E && !I && !k;
			if (y.ENVIRONMENT) throw new Error("Module.ENVIRONMENT has been deprecated. To force the environment, use the ENVIRONMENT compile-time option (for example, -sENVIRONMENT=web or -sENVIRONMENT=node)");
			var D = y.ENVIRONMENT_IS_PTHREAD || !1, x = "";
			function $(e) {
			...
			if (T) {
				...
				typeof read != "undefined" && (P = read), M = function(t) {
				...
				}), typeof scriptArgs != "undefined" ? S = scriptArgs : typeof arguments != "undefined" && (S = arguments), typeof quit == "function" && (L = function(t, n) {
					throw setTimeout(function() {
						if (!(n instanceof gt)) {
							var e = n;
							n && typeof n == "object" && n.stack && (e = [n, n.stack]), F("exiting due to exception: " + e);
						}
						quit(t);
					}), n;
				...
				if (k ? x = self.location.href : typeof document != "undefined" && document.currentScript && (x = document.currentScript.src), t && (x = t), x.indexOf("blob:") !== 0 ? x = x.substr(0, x.replace(/[?#].*/, "").lastIndexOf("/") + 1) : x = "", !(typeof window == "object" || typeof importScripts == "function")) throw new Error("not compiled for this environment (did you build to HTML and try to run it not on the web, or set ENVIRONMENT to something - like node - and run it someplace else - like on the web?)");
				P = function(t) {
			...
			function ne() {
				var e = W.buffer;
				y.HEAP8 = z = new Int8Array(e), y.HEAP16 = K = new Int16Array(e), y.HEAP32 = X = new Int32Array(e), y.HEAPU8 = j = new Uint8Array(e), y.HEAPU16 = Q = new Uint16Array(e), y.HEAPU32 = Y = new Uint32Array(e), y.HEAPF32 = J = new Float32Array(e), y.HEAPF64 = te = new Float64Array(e), y.HEAP64 = Z = new BigInt64Array(e), y.HEAPU64 = ee = new BigUint64Array(e);
			}
			G(!y.STACK_SIZE, "STACK_SIZE can no longer be set at runtime.  Use -sSTACK_SIZE at link time"), G(typeof Int32Array != "undefined" && typeof Float64Array != "undefined" && Int32Array.prototype.subarray != null && Int32Array.prototype.set != null, "JS engine does not provide full typed array support");
			var re = y.INITIAL_MEMORY || 10485760;
			if (We("INITIAL_MEMORY", "INITIAL_MEMORY"), G(re >= 1048576, "INITIAL_MEMORY should be larger than STACK_SIZE, was " + re + "! (STACK_SIZE=1048576)"), D) W = y.wasmMemory;
			else if (y.wasmMemory) W = y.wasmMemory;
			else if (W = new WebAssembly.Memory({
				initial: re / 65536,
			...
			function ae() {
				var e = rl();
				G((e & 3) == 0), e == 0 && (e += 4), f()[e >> 2] = 34821223, f()[e + 4 >> 2] = 2310721022, f()[0] = 1668509029;
			}
			function ie() {
				if (!V) {
					var e = rl();
					e == 0 && (e += 4);
					var t = f()[e >> 2], n = f()[e + 4 >> 2];
					(t != 34821223 || n != 2310721022) && ke("Stack overflow! Stack cookie has been overwritten at " + tn(e) + ", expected hex dwords 0x89BACDFE and 0x2135467, but received " + tn(n) + " " + tn(t)), f()[0] != 1668509029 && ke("Runtime error: The application has corrupted its heap memory area (address zero)!");
				}
			}
			(function() {
			...
			var le = [], se = [], ue = [], ce = !1, de = 0;
			function me() {
				return B || de > 0;
			}
			function pe() {
				if (G(!D), y.preRun) for (typeof y.preRun == "function" && (y.preRun = [y.preRun]); y.preRun.length;) ge(y.preRun.shift());
				on(le);
			}
			function _e() {
				G(!ce), ce = !0, !D && (ie(), !y.noFSInit && !Qt.init.initialized && Qt.init(), Qt.ignorePermissions = !1, Mt.init(), on(se));
			}
			function fe() {
				if (ie(), !D) {
					if (y.postRun) for (typeof y.postRun == "function" && (y.postRun = [y.postRun]); y.postRun.length;) ye(y.postRun.shift());
					on(ue);
				}
			}
			function ge(e) {
			...
			function Le(e) {
				Ce++, y.monitorRunDependencies && y.monitorRunDependencies(Ce), e ? (G(!Se[e]), Se[e] = 1, be === null && typeof setInterval != "undefined" && (be = setInterval(function() {
					if (V) {
						clearInterval(be), be = null;
						return;
					}
					var e = !1;
					for (var t in Se) e || (e = !0, F("still waiting on run dependencies:")), F("dependency: " + t);
					e && F("(end of list)");
				}, 1e4))) : F("warning: run dependency added without ID");
			}
			function Ee(e) {
				if (Ce--, y.monitorRunDependencies && y.monitorRunDependencies(Ce), e ? (G(Se[e]), delete Se[e]) : F("warning: run dependency removed without ID"), Ce == 0 && (be !== null && (clearInterval(be), be = null), ve)) {
					var t = ve;
					ve = null, t();
				}
			}
			...
			})(babelHelpers.wrapNativeSuper(Error)), Pe = (function(e) {
				function t() {
					return e.apply(this, arguments) || this;
				}
				return babelHelpers.inheritsLoose(t, e), t;
			...
			function Ae(e) {
				return !O && (E || k) && typeof fetch == "function" ? fetch(e, { credentials: "same-origin" }).then(function(t) {
			...
			function Fe(e, t, n) {
				return Ae(e).then(function(e) {
					return WebAssembly.instantiate(e, t);
				}).then(function(e) {
					return e;
				}).then(n, function(e) {
					F("failed to asynchronously prepare wasm: " + e), De(Me) && F("warning: Loading from a file URI (" + Me + ") is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing"), ke(e);
				});
			}
			function Oe(e, t, n, r) {
				return !e && typeof WebAssembly.instantiateStreaming == "function" && !Te(t) && typeof fetch == "function" ? fetch(t, { credentials: "same-origin" }).then(function(e) {
					var o = WebAssembly.instantiateStreaming(e, n);
					return o.then(r, function(e) {
						return F("wasm streaming compile failed: " + e), F("falling back to ArrayBuffer instantiation"), Fe(t, n, r);
					});
				}) : Fe(t, n, r);
			}
			function Be() {
				var e = {
					env: Di,
					wasi_snapshot_preview1: Di
				};
				function t(e, t) {
					var n = e.exports;
					return q = n, pn(q._emscripten_tls_init), oe = q.__indirect_function_table, G(oe, "table not found in wasm exports"), he(q.__wasm_call_ctors), U = t, Ee("wasm-instantiate"), o("WAWebVoipQplHelpers").voipInitQplAddPoint(o("WAWebVoipQplHelpers").VoipInitQplPoint.WASM_FETCH_END), n;
				}
				o("WAWebVoipQplHelpers").voipInitQplAddPoint(o("WAWebVoipQplHelpers").VoipInitQplPoint.WASM_FETCH_START), Le("wasm-instantiate");
				var n = y;
				function r(e) {
					G(y === n, "the Module object should not be replaced during async compilation - perhaps the order of HTML elements is wrong?"), n = null, t(e.instance, e.module);
				}
			...
			function We(e, t, n) {
				n === void 0 && (n = !0), Object.getOwnPropertyDescriptor(y, e) || Object.defineProperty(y, e, {
					configurable: !0,
					get: function() {
			...
			function qe(e) {
				Object.getOwnPropertyDescriptor(y, e) && ke("`Module." + e + "` was supplied but `" + e + "` not included in INCOMING_MODULE_JS_API");
			}
			function Ue(e) {
			...
			function He(e) {
				typeof globalThis != "undefined" && !Object.getOwnPropertyDescriptor(globalThis, e) && Object.defineProperty(globalThis, e, {
					...
					get: function() {
						...
						n.startsWith("_") || (n = "$" + e), t += " (e.g. -sDEFAULT_LIBRARY_FUNCS_TO_INCLUDE='" + n + "')", Ue(e) && (t += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), _n(t);
					}
				}), Ge(e);
			}
			function Ge(e) {
				Object.getOwnPropertyDescriptor(y, e) || Object.defineProperty(y, e, {
					configurable: !0,
					get: function() {
						var t = "'" + e + "' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the Emscripten FAQ)";
						Ue(e) && (t += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), ke(t);
					}
				});
			}
			function ze(e) {
			...
			var je = {
				...
				1383914: function() {
					typeof Qt != "undefined" && Qt.syncfs && Qt.syncfs(!1, function(e) {});
				}
			};
			function Ke(e, t) {
				var n = t ? Xt(t) : "";
			...
			function Xe() {
				...
				ke = function(n) {
					if (self.__inMLInference && y._wasm_throw_ml_abort) {
						...
						var t = xt(n) + 1, r = ml(), o = _l(t);
						Gn(n, o, t), y._wasm_throw_ml_abort(o), pl(r);
						return;
					}
					e(n);
				};
			...
			function Je(e) {
				var t = e ? Xt(e) : null, n = self.WhatsAppVoipWasmWorkerCompatibleCallbacks.getBweModelPath({ versionName: t });
				if (n) {
					var r = xt(n) + 1, o = Ni(r);
					return Gn(n, o, r), o;
				}
			...
			function yt(e) {
				G(!D, "Internal Error! killThread() can only ever be called from main application thread!"), G(e, "Internal Error! Null pthread_ptr in killThread!");
				var t = rn.pthreads[e];
				delete rn.pthreads[e], ht(t), ol(e), rn.runningWorkers.splice(rn.runningWorkers.indexOf(t), 1), t.pthread_ptr = 0;
			}
			function Ct(e) {
				G(!D, "Internal Error! cancelThread() can only ever be called from main application thread!"), G(e, "Internal Error! Null pthread_ptr in cancelThread!");
				var t = rn.pthreads[e];
				t.postMessage({
					cmd: "cancel",
					type: "cmd"
			...
			function bt(e) {
				G(!D, "Internal Error! cleanupThread() can only ever be called from main application thread!"), G(e, "Internal Error! Null pthread_ptr in cleanupThread!");
				var t = rn.pthreads[e];
			...
			function St(e) {
				G(!D, "Internal Error! spawnThread() can only ever be called from main application thread!"), G(e.pthread_ptr, "Internal error, no pthread ptr!");
				var t = rn.getNewWorker();
				if (!t) return 6;
				G(!t.pthread_ptr, "Internal error!"), rn.runningWorkers.push(t), rn.pthreads[e.pthread_ptr] = t, t.pthread_ptr = e.pthread_ptr;
				var n = {
					cmd: "run",
			...
			var Rt = {
				...
				normalize: function(t) {
					var e = Rt.isAbs(t), n = t.substr(-1) === "/";
					return t = Rt.normalizeArray(t.split("/").filter(function(e) {
						return !!e;
					}), !e).join("/"), !t && !e && (t = "."), t && n && (t += "/"), (e ? "/" : "") + t;
				},
				dirname: function(t) {
					var e = Rt.splitPath(t), n = e[0], r = e[1];
				...
				ke("no cryptographic support found for randomDevice. consider polyfilling it if you want to use something insecure like Math.random(), e.g. put this in a --pre-js: var crypto = { getRandomValues: (array) => { for (var i = 0; i < array.length; i++) array[i] = (Math.random()*256)|0 } };");
			}, Et = function(t) {
				return (Et = Lt())(t);
			}, kt = {
				resolve: function() {
			...
			}, It = typeof TextDecoder != "undefined" ? new TextDecoder("utf8") : void 0, Tt = function(t, n, r) {
				...
				for (var a = ""; n < o;) {
					...
					var s = t[n++] & 63;
					if ((i & 240) == 224 ? i = (i & 15) << 12 | l << 6 | s : ((i & 248) != 240 && _n("Invalid UTF-8 leading byte " + tn(i) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), i = (i & 7) << 18 | l << 12 | s << 6 | t[n++] & 63), i < 65536) a += String.fromCharCode(i);
					else {
						var u = i - 65536;
				...
				for (var e = r, a = r + o - 1, i = 0; i < t.length; ++i) {
					...
					if (l <= 127) {
						...
						if (r + 3 >= a) break;
						l > 1114111 && _n("Invalid Unicode code point " + tn(l) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), n[r++] = 240 | l >> 18, n[r++] = 128 | l >> 12 & 63, n[r++] = 128 | l >> 6 & 63, n[r++] = 128 | l & 63;
					}
				}
				return n[r] = 0, r - e;
			};
			function Pt(e, t, n) {
				var r = n > 0 ? n : xt(e) + 1, o = new Array(r), a = $t(e, o, 0, o.length);
			...
			var Nt = function() {
				...
				stream_ops: {
					...
					read: function(t, n, r, o, a) {
						if (!t.tty || !t.tty.ops.get_char) throw new Qt.ErrnoError(60);
					...
					write: function(t, n, r, o, a) {
						if (!t.tty || !t.tty.ops.put_char) throw new Qt.ErrnoError(60);
						try {
				...
				default_tty_ops: {
					...
					put_char: function(t, n) {
						n === null || n === 10 ? (A(Tt(t.output, 0)), t.output = []) : n != 0 && t.output.push(n);
					},
					fsync: function(t) {
						t.output && t.output.length > 0 && (A(Tt(t.output, 0)), t.output = []);
					},
				...
				default_tty1_ops: {
					put_char: function(t, n) {
						n === null || n === 10 ? (F(Tt(t.output, 0)), t.output = []) : n != 0 && t.output.push(n);
					},
					fsync: function(t) {
						t.output && t.output.length > 0 && (F(Tt(t.output, 0)), t.output = []);
					}
				}
			}, wt = function(t, n) {
				...
				createNode: function(t, n, r, o) {
					...
					return Qt.isDir(e.mode) ? (e.node_ops = Ft.ops_table.dir.node, e.stream_ops = Ft.ops_table.dir.stream, e.contents = {}) : Qt.isFile(e.mode) ? (e.node_ops = Ft.ops_table.file.node, e.stream_ops = Ft.ops_table.file.stream, e.usedBytes = 0, e.contents = null) : Qt.isLink(e.mode) ? (e.node_ops = Ft.ops_table.link.node, e.stream_ops = Ft.ops_table.link.stream) : Qt.isChrdev(e.mode) && (e.node_ops = Ft.ops_table.chrdev.node, e.stream_ops = Ft.ops_table.chrdev.stream), e.timestamp = Date.now(), t && (t.contents[n] = e, t.timestamp = e.timestamp), e;
				},
				...
				node_ops: {
					getattr: function(t) {
						var e = {};
						return e.dev = Qt.isChrdev(t.mode) ? t.id : 1, e.ino = t.id, e.mode = t.mode, e.nlink = 1, e.uid = 0, e.gid = 0, e.rdev = t.rdev, Qt.isDir(t.mode) ? e.size = 4096 : Qt.isFile(t.mode) ? e.size = t.usedBytes : Qt.isLink(t.mode) ? e.size = t.link.length : e.size = 0, e.atime = new Date(t.timestamp), e.mtime = new Date(t.timestamp), e.ctime = new Date(t.timestamp), e.blksize = 4096, e.blocks = Math.ceil(e.size / e.blksize), e;
					},
					setattr: function(t, n) {
						n.mode !== void 0 && (t.mode = n.mode), n.timestamp !== void 0 && (t.timestamp = n.timestamp), n.size !== void 0 && Ft.resizeFileStorage(t, n.size);
					},
					lookup: function(t, n) {
					...
					rename: function(t, n, r) {
						if (Qt.isDir(t.mode)) {
							...
							if (e) for (var o in e.contents) throw new Qt.ErrnoError(55);
						}
				...
				stream_ops: {
					...
					write: function(t, n, r, o, a, i) {
						...
						if (e.timestamp = Date.now(), n.subarray && (!e.contents || e.contents.subarray)) {
							if (i) return G(a === 0, "canOwn must imply no weird position inside the file"), e.contents = n.subarray(r, r + o), e.usedBytes = o, o;
						...
						if (Ft.expandFileStorage(e, a + o), e.contents.subarray && n.subarray) e.contents.set(n.subarray(r, r + o), a);
						else for (var s = 0; s < o; s++) e.contents[a + s] = n[r + s];
						return e.usedBytes = Math.max(e.usedBytes, a + o), o;
					},
					llseek: function(t, n, r) {
						var e = n;
						if (r === 1 ? e += t.position : r === 2 && Qt.isFile(t.node.mode) && (e += t.node.usedBytes), e < 0) throw new Qt.ErrnoError(28);
						return e;
					},
					allocate: function(t, n, r) {
						Ft.expandFileStorage(t.node, n + r), t.node.usedBytes = Math.max(t.node.usedBytes, n + r);
					},
					mmap: function(t, n, r, o, a) {
						...
						if (!(a & 2) && s.buffer === l().buffer) i = !1, e = s.byteOffset;
							...
							if ((r > 0 || r + n < s.length) && (s.subarray ? s = s.subarray(r, r + n) : s = Array.prototype.slice.call(s, r, r + n)), i = !0, e = At(n), !e) throw new Qt.ErrnoError(48);
							l().set(s, e);
						}
						return {
							ptr: e,
			...
			function qt(e, t, n, r, o, a, i, l, s, u) {
				var c = t ? kt.resolve(Rt.join2(e, t)) : e, d = Re("cp " + c);
				function m(n) {
					function m(n) {
						u && u(), l || Qt.createDataFile(e, t, n, r, o, s), a && a(), Ee(d);
					}
					Wt(n, c, m, function() {
						i && i(), Ee(d);
					}) || m(n);
				}
				Le(d), typeof n == "string" ? Ot(n, function(e) {
					return m(e);
				}, i) : m(n);
			}
			function Ut(e) {
			...
			var Ht = {
				...
				indexedDB: (function(e) {
					...
					var e = null;
					return typeof window == "object" && (e = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB), G(e, "IDBFS used, but indexedDB not supported"), e;
				}),
				DB_VERSION: 21,
				...
				getDB: function(t, n) {
					...
					r.onupgradeneeded = function(e) {
						...
						t.objectStoreNames.contains(Ht.DB_STORE_NAME) ? r = n.objectStore(Ht.DB_STORE_NAME) : r = t.createObjectStore(Ht.DB_STORE_NAME), r.indexNames.contains("timestamp") || r.createIndex("timestamp", "timestamp", { unique: !1 });
				...
				getLocalSet: function(t, n) {
					...
					for (var a = Qt.readdir(t.mountpoint).filter(r).map(o(t.mountpoint)); a.length;) {
						var i = a.pop(), l;
						try {
							l = Qt.stat(i);
						} catch (e) {
						...
						Qt.isDir(l.mode) && a.push.apply(a, Qt.readdir(i).filter(r).map(o(i))), e[i] = { timestamp: l.mtime };
					}
					return n(null, {
						type: "local",
						entries: e
				...
				getRemoteSet: function(t, n) {
					...
					Ht.getDB(t.mountpoint, function(t, r) {
						...
						try {
							...
							var a = o.objectStore(Ht.DB_STORE_NAME), i = a.index("timestamp");
				...
				loadLocalEntry: function(t, n) {
					...
					return Qt.isDir(e.mode) ? n(null, {
						timestamp: e.mtime,
						mode: e.mode
					}) : Qt.isFile(e.mode) ? (r.contents = Ft.getFileDataAsTypedArray(r), n(null, {
						timestamp: e.mtime,
						mode: e.mode,
						contents: r.contents
				...
				storeLocalEntry: function(t, n, r) {
					try {
						...
						else if (Qt.isFile(n.mode)) Qt.writeFile(t, n.contents, { canOwn: !0 });
				...
				removeLocalEntry: function(t, n) {
					try {
						var e = Qt.stat(t);
						Qt.isDir(e.mode) ? Qt.rmdir(t) : Qt.isFile(e.mode) && Qt.unlink(t);
					} catch (e) {
						return n(e);
					}
					n(null);
				...
				reconcile: function(t, n, r) {
					...
					var l = !1, s = t.type === "remote" ? t.db : n.db, u = s.transaction([Ht.DB_STORE_NAME], "readwrite"), c = u.objectStore(Ht.DB_STORE_NAME);
					function d(e) {
					...
					u.onerror = function(e) {
						...
						n.type === "local" ? Ht.loadRemoteEntry(c, e, function(t, n) {
							if (t) return d(t);
						...
						n.type === "local" ? Ht.removeLocalEntry(e, d) : Ht.removeRemoteEntry(c, e, d);
					});
				}
			}, Gt = {
				0: "Success",
			...
			function jt(e) {
				return _n("warning: build with -sDEMANGLE_SUPPORT to link in libcxxabi demangling"), e;
			}
			function Kt(e) {
				var t = /\b_Z[\w\d_]+/g;
			...
			var Qt = {
				...
				lookupPath: function(t, n) {
					if (n === void 0 && (n = {}), t = kt.resolve(t), !t) return {
						path: "",
						node: null
					};
					var e = {
					...
					if (n = Object.assign(e, n), n.recurse_count > 8) throw new Qt.ErrnoError(32);
					for (var r = t.split("/").filter(function(e) {
						return !!e;
					}), o = Qt.root, a = "/", i = 0; i < r.length; i++) {
						var l = i === r.length - 1;
						if (l && n.parent) break;
						if (o = Qt.lookupNode(o, r[i]), a = Rt.join2(a, r[i]), Qt.isMountpoint(o) && (!l || l && n.follow_mount) && (o = o.mounted.root), !l || n.follow) for (var s = 0; Qt.isLink(o.mode);) {
							var u = Qt.readlink(a);
							a = kt.resolve(Rt.dirname(a), u);
							var c = Qt.lookupPath(a, { recurse_count: n.recurse_count + 1 });
				...
				hashRemoveNode: function(t) {
					...
					else for (var n = Qt.nameTable[e]; n;) {
						if (n.name_next === t) {
				...
				lookupNode: function(t, n) {
					...
					for (var r = Qt.hashName(t.id, n), o = Qt.nameTable[r]; o; o = o.name_next) {
						var a = o.name;
				...
				nodePermissions: function(t, n) {
					return Qt.ignorePermissions ? 0 : n.includes("r") && !(t.mode & 292) || n.includes("w") && !(t.mode & 146) || n.includes("x") && !(t.mode & 73) ? 2 : 0;
				},
				...
				mayOpen: function(t, n) {
					return t ? Qt.isLink(t.mode) ? 32 : Qt.isDir(t.mode) && (Qt.flagsToPermissionString(n) !== "r" || n & 512) ? 31 : Qt.nodePermissions(t, Qt.flagsToPermissionString(n)) : 44;
				},
				MAX_OPEN_FDS: 4096,
				nextfd: function() {
					for (var e = 0; e <= Qt.MAX_OPEN_FDS; e++) if (!Qt.streams[e]) return e;
				...
				createStream: function(t, n) {
					return n === void 0 && (n = -1), Qt.FSStream || (Qt.FSStream = function() {
						this.shared = {};
					}, Qt.FSStream.prototype = {}, Object.defineProperties(Qt.FSStream.prototype, {
						object: {
							get: function() {
								return this.node;
							},
					...
					})), t = Object.assign(new Qt.FSStream(), t), n == -1 && (n = Qt.nextfd()), t.fd = n, Qt.streams[n] = t, t;
				},
				...
				syncfs: function(t, n) {
					typeof t == "function" && (n = t, t = !1), Qt.syncFSRequests++, Qt.syncFSRequests > 1 && F("warning: " + Qt.syncFSRequests + " FS.syncfs operations in flight at once, probably just doing extra work");
					var e = Qt.getMounts(Qt.root.mount), r = 0;
					function o(e) {
				...
				mount: function(t, n, r) {
					...
					if (!e && !o) {
						...
						if (r = i.path, a = i.node, Qt.isMountpoint(a)) throw new Qt.ErrnoError(10);
					...
					return s.mount = l, l.root = s, e ? Qt.root = s : a && (a.mounted = l, a.mount && a.mount.mounts.push(l)), s;
				},
				unmount: function(t) {
					var e = Qt.lookupPath(t, { follow_mount: !1 });
					if (!Qt.isMountpoint(e.node)) throw new Qt.ErrnoError(28);
					var n = e.node, r = n.mounted, o = Qt.getMounts(r);
				...
				mknod: function(t, n, r) {
					var e = Qt.lookupPath(t, { parent: !0 }), o = e.node, a = Rt.basename(t);
				...
				create: function(t, n) {
					return n = n !== void 0 ? n : 438, n &= 4095, n |= 32768, Qt.mknod(t, n, 0);
				},
				mkdir: function(t, n) {
					return n = n !== void 0 ? n : 511, n &= 1023, n |= 16384, Qt.mknod(t, n, 0);
				},
				...
				mkdev: function(t, n, r) {
					return typeof r == "undefined" && (r = n, n = 438), n |= 8192, Qt.mknod(t, n, r);
				},
				symlink: function(t, n) {
					if (!kt.resolve(t)) throw new Qt.ErrnoError(44);
					var e = Qt.lookupPath(n, { parent: !0 }), r = e.node;
					if (!r) throw new Qt.ErrnoError(44);
					var o = Rt.basename(n), a = Qt.mayCreate(r, o);
					if (a) throw new Qt.ErrnoError(a);
					if (!r.node_ops.symlink) throw new Qt.ErrnoError(63);
					return r.node_ops.symlink(r, o, t);
				},
				rename: function(t, n) {
					var e = Rt.dirname(t), r = Rt.dirname(n), o = Rt.basename(t), a = Rt.basename(n), i, l, s;
					if (i = Qt.lookupPath(t, { parent: !0 }), l = i.node, i = Qt.lookupPath(n, { parent: !0 }), s = i.node, !l || !s) throw new Qt.ErrnoError(44);
					if (l.mount !== s.mount) throw new Qt.ErrnoError(75);
					var u = Qt.lookupNode(l, o), c = kt.relative(t, r);
					if (c.charAt(0) !== ".") throw new Qt.ErrnoError(28);
					if (c = kt.relative(n, e), c.charAt(0) !== ".") throw new Qt.ErrnoError(55);
					var d;
					try {
						d = Qt.lookupNode(s, a);
					} catch (e) {}
					if (u !== d) {
						var m = Qt.isDir(u.mode), p = Qt.mayDelete(l, o, m);
						if (p) throw new Qt.ErrnoError(p);
						if (p = d ? Qt.mayDelete(s, a, m) : Qt.mayCreate(s, a), p) throw new Qt.ErrnoError(p);
						if (!l.node_ops.rename) throw new Qt.ErrnoError(63);
						if (Qt.isMountpoint(u) || d && Qt.isMountpoint(d)) throw new Qt.ErrnoError(10);
						if (s !== l && (p = Qt.nodePermissions(l, "w"), p)) throw new Qt.ErrnoError(p);
						Qt.hashRemoveNode(u);
						try {
				...
				rmdir: function(t) {
					var e = Qt.lookupPath(t, { parent: !0 }), n = e.node, r = Rt.basename(t), o = Qt.lookupNode(n, r), a = Qt.mayDelete(n, r, !0);
					if (a) throw new Qt.ErrnoError(a);
				...
				readdir: function(t) {
					var e = Qt.lookupPath(t, { follow: !0 }), n = e.node;
					if (!n.node_ops.readdir) throw new Qt.ErrnoError(54);
					return n.node_ops.readdir(n);
				},
				unlink: function(t) {
					var e = Qt.lookupPath(t, { parent: !0 }), n = e.node;
					if (!n) throw new Qt.ErrnoError(44);
					var r = Rt.basename(t), o = Qt.lookupNode(n, r), a = Qt.mayDelete(n, r, !1);
					if (a) throw new Qt.ErrnoError(a);
				...
				utime: function(t, n, r) {
					var e = Qt.lookupPath(t, { follow: !0 }), o = e.node;
					o.node_ops.setattr(o, { timestamp: Math.max(n, r) });
				},
				open: function(t, n, r) {
					if (t === "") throw new Qt.ErrnoError(44);
					n = typeof n == "string" ? Ut(n) : n, r = typeof r == "undefined" ? 438 : r, n & 64 ? r = r & 4095 | 32768 : r = 0;
					var e;
					...
					if (Qt.isChrdev(e.mode) && (n &= -513), n & 65536 && !Qt.isDir(e.mode)) throw new Qt.ErrnoError(54);
					if (!a) {
					...
					return l.stream_ops.open && l.stream_ops.open(l), y.logReadFiles && !(n & 1) && (Qt.readFiles || (Qt.readFiles = {}), t in Qt.readFiles || (Qt.readFiles[t] = 1)), l;
				},
				close: function(t) {
				...
				llseek: function(t, n, r) {
					if (Qt.isClosed(t)) throw new Qt.ErrnoError(8);
					if (!t.seekable || !t.stream_ops.llseek) throw new Qt.ErrnoError(70);
				...
				allocate: function(t, n, r) {
					...
					if ((t.flags & 2097155) === 0) throw new Qt.ErrnoError(8);
					if (!Qt.isFile(t.node.mode) && !Qt.isDir(t.node.mode)) throw new Qt.ErrnoError(43);
					if (!t.stream_ops.allocate) throw new Qt.ErrnoError(138);
					t.stream_ops.allocate(t, n, r);
				},
				mmap: function(t, n, r, o, a) {
					if ((o & 2) !== 0 && (a & 2) === 0 && (t.flags & 2097155) !== 2) throw new Qt.ErrnoError(2);
				...
				readFile: function(t, n) {
					...
					var e, r = Qt.open(t, n.flags), o = Qt.stat(t), a = o.size, i = new Uint8Array(a);
					return Qt.read(r, i, 0, a, 0), n.encoding === "utf8" ? e = Tt(i, 0) : n.encoding === "binary" && (e = i), Qt.close(r), e;
				},
				writeFile: function(t, n, r) {
					r === void 0 && (r = {}), r.flags = r.flags || 577;
					var e = Qt.open(t, r.flags, r.mode);
					if (typeof n == "string") {
						var o = new Uint8Array(xt(n) + 1), a = $t(n, o, 0, o.length);
						Qt.write(e, o, 0, a, void 0, r.canOwn);
					} else if (ArrayBuffer.isView(n)) Qt.write(e, n, 0, n.byteLength, void 0, r.canOwn);
				...
				createDefaultDirectories: function() {
					Qt.mkdir("/tmp"), Qt.mkdir("/home"), Qt.mkdir("/home/web_user");
				},
				createDefaultDevices: function() {
					Qt.mkdir("/dev"), Qt.registerDevice(Qt.makedev(1, 3), {
						read: function() {
							return 0;
						},
						write: function(t, n, r, o, a) {
					...
					}), Qt.mkdev("/dev/null", Qt.makedev(1, 3)), Mt.register(Qt.makedev(5, 0), Mt.default_tty_ops), Mt.register(Qt.makedev(6, 0), Mt.default_tty1_ops), Qt.mkdev("/dev/tty", Qt.makedev(5, 0)), Qt.mkdev("/dev/tty1", Qt.makedev(6, 0));
					var e = new Uint8Array(1024), t = 0, n = function() {
						return t === 0 && (t = Et(e).byteLength), e[--t];
					};
					Qt.createDevice("/dev", "random", n), Qt.createDevice("/dev", "urandom", n), Qt.mkdir("/dev/shm"), Qt.mkdir("/dev/shm/tmp");
				},
				createSpecialDirectories: function() {
					Qt.mkdir("/proc");
					var e = Qt.mkdir("/proc/self");
					Qt.mkdir("/proc/self/fd"), Qt.mount({ mount: function() {
						var t = Qt.createNode(e, "fd", 16895, 73);
						return t.node_ops = { lookup: function(t, n) {
							var e = +n, r = Qt.getStreamChecked(e), o = {
								parent: null,
				...
				createStandardStreams: function() {
					y.stdin ? Qt.createDevice("/dev", "stdin", y.stdin) : Qt.symlink("/dev/tty", "/dev/stdin"), y.stdout ? Qt.createDevice("/dev", "stdout", null, y.stdout) : Qt.symlink("/dev/tty", "/dev/stdout"), y.stderr ? Qt.createDevice("/dev", "stderr", null, y.stderr) : Qt.symlink("/dev/tty1", "/dev/stderr");
					var e = Qt.open("/dev/stdin", 0), t = Qt.open("/dev/stdout", 1), n = Qt.open("/dev/stderr", 1);
					G(e.fd === 0, "invalid handle for stdin (" + e.fd + ")"), G(t.fd === 1, "invalid handle for stdout (" + t.fd + ")"), G(n.fd === 2, "invalid handle for stderr (" + n.fd + ")");
				},
				ensureErrnoError: function() {
					Qt.ErrnoError || (Qt.ErrnoError = function(t, n) {
						this.name = "ErrnoError", this.node = n, this.setErrno = function(e) {
							this.errno = e;
							for (var t in zt) if (zt[t] === e) {
								this.code = t;
								break;
							}
						}, this.setErrno(t), this.message = Gt[t], this.stack && (Object.defineProperty(this, "stack", {
							value: new Error().stack,
							writable: !0
						}), this.stack = Kt(this.stack));
					}, Qt.ErrnoError.prototype = new Error(), Qt.ErrnoError.prototype.constructor = Qt.ErrnoError, [44].forEach(function(e) {
						Qt.genericErrors[e] = new Qt.ErrnoError(e), Qt.genericErrors[e].stack = "<generic error, no stack>";
					}));
				},
				staticInit: function() {
					Qt.ensureErrnoError(), Qt.nameTable = new Array(4096), Qt.mount(Ft, {}, "/"), Qt.createDefaultDirectories(), Qt.createDefaultDevices(), Qt.createSpecialDirectories(), Qt.filesystems = {
						MEMFS: Ft,
						IDBFS: Ht
					};
				},
				init: function(t, n, r) {
					G(!Qt.init.initialized, "FS.init was previously called. If you want to initialize later with custom parameters, remove any earlier calls (note that one is automatically added to the generated code)"), Qt.init.initialized = !0, Qt.ensureErrnoError(), y.stdin = t || y.stdin, y.stdout = n || y.stdout, y.stderr = r || y.stderr, Qt.createStandardStreams();
				},
				quit: function() {
					Qt.init.initialized = !1, Ai(0);
				...
				analyzePath: function(t, n) {
					...
					try {
						...
						r.parentExists = !0, r.parentPath = e.path, r.parentObject = e.node, r.name = Rt.basename(t), e = Qt.lookupPath(t, { follow: !n }), r.exists = !0, r.path = e.path, r.object = e.node, r.name = e.node.name, r.isRoot = e.path === "/";
					} catch (e) {
						r.error = e.errno;
					}
					return r;
				...
				createFile: function(t, n, r, o, a) {
					var e = Rt.join2(typeof t == "string" ? t : Qt.getPath(t), n), i = Vt(o, a);
					return Qt.create(e, i);
				},
				createDataFile: function(t, n, r, o, a, i) {
					var e = n;
					t && (t = typeof t == "string" ? t : Qt.getPath(t), e = n ? Rt.join2(t, n) : t);
					var l = Vt(o, a), s = Qt.create(e, l);
					if (r) {
						if (typeof r == "string") {
						...
						Qt.chmod(s, l | 146);
						var m = Qt.open(s, 577);
						Qt.write(m, r, 0, r.length, 0, i), Qt.close(m), Qt.chmod(s, l);
					}
					return s;
				},
				createDevice: function(t, n, r, o) {
					var e = Rt.join2(typeof t == "string" ? t : Qt.getPath(t), n), a = Vt(!!r, !!o);
					Qt.createDevice.major || (Qt.createDevice.major = 64);
					var i = Qt.makedev(Qt.createDevice.major++, 0);
					return Qt.registerDevice(i, {
						open: function(t) {
							t.seekable = !1;
						},
						close: function(t) {
				...
				forceLoadFile: function(t) {
					...
					if (P) try {
						t.contents = Pt(P(t.url), !0), t.usedBytes = t.contents.length;
					} catch (e) {
						throw new Qt.ErrnoError(29);
					}
				...
				createLazyFile: function(t, n, r, o, a) {
					...
					if (e.prototype.get = function(t) {
						...
						var l = function(n, o) {
							...
							return e.response !== void 0 ? new Uint8Array(e.response || []) : Pt(e.responseText || "", !0);
						}, s = this;
						s.setDataGetter(function(e) {
							...
							return s.chunks[e];
						}), (a || !t) && (i = t = 1, t = this.getter(0).length, i = t, A("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = t, this._chunkSize = i, this.lengthKnown = !0;
				...
				doStat: function(t, n, r) {
					try {
						...
						if (e && e.node && Rt.normalize(n) !== Rt.normalize(Qt.getPath(e.node))) return -54;
						throw e;
					}
					_()[r >> 2] = e.dev, _()[r + 4 >> 2] = e.mode, f()[r + 8 >> 2] = e.nlink, _()[r + 12 >> 2] = e.uid, _()[r + 16 >> 2] = e.gid, _()[r + 20 >> 2] = e.rdev, Z[r + 24 >> 3] = BigInt(e.size), _()[r + 32 >> 2] = 4096, _()[r + 36 >> 2] = e.blocks;
					var o = e.atime.getTime(), a = e.mtime.getTime(), i = e.ctime.getTime();
					return Z[r + 40 >> 3] = BigInt(Math.floor(o / 1e3)), f()[r + 48 >> 2] = o % 1e3 * 1e3, Z[r + 56 >> 3] = BigInt(Math.floor(a / 1e3)), f()[r + 64 >> 2] = a % 1e3 * 1e3, Z[r + 72 >> 3] = BigInt(Math.floor(i / 1e3)), f()[r + 80 >> 2] = i % 1e3 * 1e3, Z[r + 88 >> 3] = BigInt(e.ino), 0;
				},
			...
			function Jt(e) {
				if (D) return Ca(1, 1, e);
				H = e, me() || (rn.terminateAllThreads(), y.onExit && y.onExit(e), V = !0), L(e, new gt(e));
			}
			var Zt = function(t, n) {
				if (H = t, ac(), D) throw G(!n), ln(t), "unwind";
				if (me() && !n) {
					var e = "program exited (with status: " + t + "), but keepRuntimeAlive() is set (counter=" + de + ") due to an async operation, so halting execution but not exiting the runtime or preventing further async execution (you can use emscripten_force_exit, if you want to force a true shutdown)";
					b(e), F(e);
				}
				Jt(t);
			}, en = Zt, tn = function(t) {
				...
				ie(), t instanceof WebAssembly.RuntimeError && fl() <= 0 && F("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 1048576)"), L(1, t);
			}, rn = {
				unusedWorkers: [],
				runningWorkers: [],
				tlsInitFunctions: [],
				...
				debugInit: function() {
					function e() {
						var e = 0;
						return ce && typeof Oi != "undefined" && (e = Oi()), "w:" + (y.workerID || 0) + ",t:" + tn(e) + ": ";
					}
					var t = ze;
					ze = function(r) {
						return t(e() + r);
				...
				initMainThread: function() {
					var e = typeof y.pthreadPoolSizeOverride == "number" ? y.pthreadPoolSizeOverride : 20;
					for (o("WAWebVoipQplHelpers").voipInitQplAddPoint(o("WAWebVoipQplHelpers").VoipInitQplPoint.WORKER_POOL_ALLOC_START); e--;) rn.allocateUnusedWorker();
					ge(function() {
						Le("loading-workers");
						var e = 15e3, t = !1, n = function(a) {
							if (!t) {
								...
								try {
									if (a) {
										var i = [], l = [];
										for (var s of rn.unusedWorkers) s.loaded ? i.push(s) : l.push(s);
										for (var s of l) try {
											ht(s);
										} catch (e) {
											F("voip: ThreadPoolManager: failed to terminate timed-out pthread worker " + s.workerID + ": " + e);
										}
										n = l.length, rn.unusedWorkers = i, F("voip: ThreadPoolManager: pthread worker prewarm timed out after " + e + "ms; continuing with " + i.length + " ready workers");
									}
								} finally {
									Ee("loading-workers"), o("WAWebVoipQplHelpers").voipInitQplAddPoint(o("WAWebVoipQplHelpers").VoipInitQplPoint.WORKER_POOL_ALLOC_END, {
										bool: { worker_pool_alloc_timed_out: a },
										int: {
											worker_pool_ready_count: rn.unusedWorkers.length,
				...
				terminateAllThreads: function() {
					...
					rn.unusedWorkers = [], rn.runningWorkers = [], rn.pthreads = [];
				},
				returnWorkerToPool: function(t) {
					var e = t.pthread_ptr;
					delete rn.pthreads[e], rn.unusedWorkers.push(t), rn.runningWorkers.splice(rn.runningWorkers.indexOf(t), 1), t.pthread_ptr = 0, ol(e);
				},
					...
					return new (u || (u = (n("Promise"))))(function(n) {
						o.addMessageListener("cmd", function(e) {
							...
							if (t.targetThread && t.targetThread != Oi()) {
								...
								a ? a.postMessage(babelHelpers.extends({}, t, { type: "cmd" }), t.transferList) : F("Internal error! Worker sent a message \"" + r + "\" to target pthread " + t.targetThread + ", but that thread no longer exists!");
								return;
							}
							r === "checkMailbox" ? Xo() : r === "spawnThread" ? St(t) : r === "cleanupThread" ? bt(t.thread) : r === "killThread" ? yt(t.thread) : r === "cancelThread" ? Ct(t.thread) : r === "loaded" ? (o.loaded = !0, n(o)) : r === "alert" ? alert("Thread " + t.threadId + ": " + t.text) : t.target === "setimmediate" ? o.postMessage(babelHelpers.extends({}, t, { type: "cmd" })) : r === "callHandler" ? y[t.handler].apply(y, t.args) : r && F("worker sent an unknown command " + r);
							...
							throw o.pthread_ptr && (t = "Pthread " + tn(o.pthread_ptr) + " sent an error!"), F(t + " " + e.filename + ":" + e.lineno + ": " + e.message), e;
						}, G(W instanceof WebAssembly.Memory, "WebAssembly memory should have been loaded by now!"), G(U instanceof WebAssembly.Module, "WebAssembly Module should have been loaded by now!");
						var r = [], a = [
							"onExit",
							"onAbort",
							"print",
						...
						o.workerID = rn.nextWorkerID++, o.postMessage({
							cmd: "load",
							handlers: r,
				...
				loadWasmModuleToAllWorkers: function(t) {
					if (D) return t();
					var e = (u || (u = n("Promise"))).all(rn.unusedWorkers.map(rn.loadWasmModuleToWorker));
					e.then(t);
				},
				allocateUnusedWorker: function() {
					var e, t = o("WorkerBundleResource").createDedicatedWebWorker(r("WAWebVoipWebWasmWorkerResource"));
					e = new (o("WorkerMessagePort")).WorkerMessagePort(t, "WAWebVoipWebWasmWorker"), o("WorkerClient").init(e), rn.unusedWorkers.push(e);
				},
				getNewWorker: function() {
					return rn.unusedWorkers.length == 0 && (F("Tried to spawn a new thread, but the thread pool is exhausted.\nThis might result in a deadlock unless some threads eventually exit or the code explicitly breaks out to the event loop.\nIf you want to increase the pool size, use setting `-sPTHREAD_POOL_SIZE=...`.\nIf you want to throw an explicit error instead of the risk of deadlocking in those cases, use setting `-sPTHREAD_POOL_SIZE_STRICT=2`."), rn.allocateUnusedWorker(), rn.loadWasmModuleToWorker(rn.unusedWorkers[0])), rn.unusedWorkers.pop();
				}
			};
			y.PThread = rn;
			var on = function(t) {
			...
			function an() {
				var e = Oi(), t = _()[e + 52 >> 2], n = _()[e + 56 >> 2], r = t - n;
				G(t != 0), G(r != 0), G(t > r, "stackHigh must be higher then stackLow"), cl(t, r), pl(t), ae();
			}
			y.establishStackSpace = an;
			function ln(e) {
				if (D) return Ca(2, 0, e);
				en(e);
			}
			var sn = function(t) {
				var e = ml(), n = t();
				...
				return sn(function() {
					var e = _l(4), n = _l(4);
					gl(t, e, n);
					var r = f()[e >> 2], o = f()[n >> 2], a = Xt(r);
					Mi(r);
					var i;
					return o && (i = Xt(o), Mi(o)), [a, i];
				});
			};
			function cn(e) {
				return un(e);
			...
			var _n = function(t) {
				_n.shown || (_n.shown = {}), _n.shown[t] || (_n.shown[t] = 1, F(t));
			}, fn = function(t, n, r, o) {
				ke("Assertion failed: " + Xt(t) + ", at: " + [
			...
			function yn(e) {
				var t = new Sn(e);
				return t.get_caught() || (t.set_caught(!0), hn--), t.set_rethrown(!1), gn.push(t), Hi(t.excPtr), t.get_exception_ptr();
			}
			function Cn() {
			...
			function Dn() {
				...
				var t = e.excPtr;
				throw e.get_rethrown() || (gn.push(e), e.set_rethrown(!0), e.set_caught(!1), hn++), bn = new Ne(t), bn;
			}
			function xn(e) {
				if (e) {
					var t = new Sn(e);
			...
			function Nn(e) {
				Xi(e, !k, 1, !E, 1048576, !1), rn.threadInitTLS();
			}
			function Mn(e) {
				D ? postMessage({
					cmd: "cleanupThread",
			...
			function wn(e, t, n, r) {
				return D ? Ca(3, 1, e, t, n, r) : An(e, t, n, r);
			}
			function An(e, t, n, r) {
				if (typeof SharedArrayBuffer == "undefined") return F("Current environment does not support SharedArrayBuffer, pthreads are not available!"), 6;
				var o = [], a = 0;
				...
				return D ? (i.cmd = "spawnThread", postMessage(babelHelpers.extends({}, i, { type: "cmd" }), o), 0) : St(i);
			}
			function Fn(e) {
				if (D) return Ca(4, 1, e);
				try {
			...
			var qn = 9007199254740992, Un = -9007199254740992;
			function Vn(e) {
				return e < Un || e > qn ? NaN : Number(e);
			}
			function Hn(e, t) {
				if (D) return Ca(7, 1, e, t);
				t = Vn(t);
				try {
			...
			var Gn = function(t, n, r) {
				return G(typeof r == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), $t(t, d(), n, r);
			};
			function zn(e, t, n) {
				if (D) return Ca(8, 1, e, t, n);
				try {
					var r = Yt.getStreamFromFD(e);
					r.getdents || (r.getdents = Qt.readdir(r.path));
					for (var o = 280, a = 0, i = Qt.llseek(r, 0, 1), s = Math.floor(i / o); s < r.getdents.length && a + o <= n;) {
						var u, c, d = r.getdents[s];
						if (d === ".") u = r.node.id, c = 4;
							...
							u = _.id, c = Qt.isChrdev(_.mode) ? 2 : Qt.isDir(_.mode) ? 4 : Qt.isLink(_.mode) ? 10 : 8;
						}
						G(u), Z[t + a >> 3] = BigInt(u), Z[t + a + 8 >> 3] = BigInt((s + 1) * o), m()[t + a + 16 >> 1] = 280, l()[t + a + 18 >> 0] = c, Gn(d, t + a + 19, 256), a += o, s += 1;
					}
					...
					switch (t) {
						...
						case 21505: {
							...
							if (r.tty.ops.ioctl_tcgets) {
								var o = r.tty.ops.ioctl_tcgets(r), a = Yt.get();
								_()[a >> 2] = o.c_iflag || 0, _()[a + 4 >> 2] = o.c_oflag || 0, _()[a + 8 >> 2] = o.c_cflag || 0, _()[a + 12 >> 2] = o.c_lflag || 0;
						...
						case 21508: {
							...
							if (r.tty.ops.ioctl_tcsets) {
								for (var a = Yt.get(), s = _()[a >> 2], u = _()[a + 4 >> 2], c = _()[a + 8 >> 2], d = _()[a + 12 >> 2], p = [], i = 0; i < 32; i++) p.push(l()[a + i + 17 >> 0]);
						...
						case 21523: {
							...
							if (r.tty.ops.ioctl_tiocgwinsz) {
								var f = r.tty.ops.ioctl_tiocgwinsz(r.tty), a = Yt.get();
			...
			function Qn(e, t, n) {
				if (D) return Ca(11, 1, e, t, n);
				try {
					return t = Yt.getStr(t), t = Yt.calculateAt(e, t), t = Rt.normalize(t), t[t.length - 1] === "/" && (t = t.substr(0, t.length - 1)), Qt.mkdir(t, n, 0), 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return -e.errno;
				}
			...
			function Xn(e, t, n, r) {
				if (D) return Ca(12, 1, e, t, n, r);
				try {
					t = Yt.getStr(t);
					var o = r & 256, a = r & 4096;
					return r = r & -6401, G(!r, "unknown flags in __syscall_newfstatat: " + r), t = Yt.calculateAt(e, t, a), Yt.doStat(o ? Qt.lstat : Qt.stat, t, n);
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return -e.errno;
				}
			...
			function Zn(e, t, n) {
				if (D) return Ca(15, 1, e, t, n);
				try {
					return t = Yt.getStr(t), t = Yt.calculateAt(e, t), n === 0 ? Qt.unlink(t) : n === 512 ? Qt.rmdir(t) : ke("Invalid flags passed to unlinkat"), 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return -e.errno;
				}
			...
			function dr(e, t, n) {
				...
				t.forEach(function(e, t) {
					Object.prototype.hasOwnProperty.call(ar, e) ? o[t] = ar[e] : (a.push(e), Object.prototype.hasOwnProperty.call(or, e) || (or[e] = []), or[e].push(function() {
			...
			function mr(e, t, n) {
				n === void 0 && (n = {});
				var r = t.name;
				if (e || sr("type \"" + r + "\" must have a positive integer typeid pointer"), Object.prototype.hasOwnProperty.call(ar, e)) {
					if (n.ignoreDuplicateRegistrations) return;
					sr("Cannot register type '" + r + "' twice");
				}
				if (ar[e] = t, delete ir[e], Object.prototype.hasOwnProperty.call(or, e)) {
					var o = or[e];
					delete or[e], o.forEach(function(e) {
						return e();
					});
				}
			}
			...
			function fr(e, t, n, r, o) {
				t = rr(t);
				var a = gr(n), i = t.indexOf("u") != -1;
				i && (o = (BigInt(1) << BigInt(64)) - BigInt(1)), pr(e, {
					name: t,
					fromWireType: function(t) {
						return t;
					},
					toWireType: function(n, a) {
						if (typeof a != "bigint" && typeof a != "number") throw new TypeError("Cannot convert \"" + er(a) + "\" to " + this.name);
						if (a < r || a > o) throw new TypeError("Passing a number \"" + er(a) + "\" from JS side to C/C++ side to an argument of type \"" + t + "\", which is outside the valid range [" + r + ", " + o + "]!");
						return a;
					},
					argPackAdvance: 8,
			...
			function Tr() {
				var e = [];
				for (var t in Mr) Object.prototype.hasOwnProperty.call(Mr, t) && e.push(Mr[t]);
				return e;
			}
			var Dr = [];
			function xr() {
			...
			function Nr() {
				y.getInheritedInstanceCount = Ir, y.getLiveInheritedInstances = Tr, y.flushPendingDeletes = xr, y.setDelayFunction = Pr;
			}
			var Mr = {};
			function wr(e, t) {
				for (t === void 0 && sr("ptr should not be undefined"); e.baseClass;) t = e.upcast(t), e = e.baseClass;
				return t;
			}
			function Ar(e, t) {
			...
			function Fr(e, t) {
				(!t.ptrType || !t.ptr) && cr("makeClassHandle requires ptr and ptrType");
				var n = !!t.smartPtrType, r = !!t.smartPtr;
				return n !== r && cr("Both smartPtrType and smartPtr must be specified"), t.count = { value: 1 }, Br(Object.create(e, { $$: { value: t } }));
			}
			function Or(e) {
				...
				var a = this.registeredClass.getActualType(t), i = kr[a];
				...
				return s === null ? o.call(this) : this.isSmartPointer ? Fr(l.registeredClass.instancePrototype, {
					ptrType: l,
					ptr: s,
					smartPtrType: this,
					smartPtr: e
			...
			var Br = function(t) {
				return typeof FinalizationRegistry == "undefined" ? (Br = function(t) {
					return t;
				}, t) : (vr = new FinalizationRegistry(function(e) {
					e.leakWarning.stack.replace(/^Error: /, ""), Lr(e.$$);
				}), Br = function(t) {
					var e = t.$$, n = !!e.smartPtr;
					if (n) {
						var r = { $$: e }, o = e.ptrType.registeredClass;
						r.leakWarning = new Error("Embind found a leaked C++ instance " + o.name + " <" + tn(e.ptr) + ">.\nWe'll free it automatically in this case, but this functionality is not reliable across various environments.\nMake sure to invoke .delete() manually once you're done with the instance instead.\nOriginally allocated"), "captureStackTrace" in Error && Error.captureStackTrace(r.leakWarning, Or), vr.register(t, r, t);
					}
					return t;
				}, Sr = function(t) {
			...
			function Wr() {
				if (this.$$.ptr || br(this), this.$$.preservePointerOnDelete) return this.$$.count.value += 1, this;
				var e = Br(Object.create(Object.getPrototypeOf(this), { $$: { value: Cr(this.$$) } }));
				return e.$$.count.value += 1, e.$$.deleteScheduled = !1, e;
			}
			function qr() {
				this.$$.ptr || br(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && sr("Object already scheduled for deletion"), Sr(this), Lr(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
			}
			function Ur() {
				return !this.$$.ptr;
			}
			function Vr() {
				return this.$$.ptr || br(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && sr("Object already scheduled for deletion"), Dr.push(this), Dr.length === 1 && $r && $r(xr), this.$$.deleteScheduled = !0, this;
			}
			function Hr() {
				Gr.prototype.isAliasOf = yr, Gr.prototype.clone = Wr, Gr.prototype.delete = qr, Gr.prototype.isDeleted = Ur, Gr.prototype.deleteLater = Vr;
			}
			function Gr() {}
			var zr = 48, jr = 57;
			function Kr(e) {
			...
			function Xr(e, t, n) {
				if (e[t].overloadTable === void 0) {
					var r = e[t];
					e[t] = function() {
						return Object.prototype.hasOwnProperty.call(e[t].overloadTable, arguments.length) || sr("Function '" + n + "' called with an invalid number of arguments (" + arguments.length + ") - expects one of (" + e[t].overloadTable + ")!"), e[t].overloadTable[arguments.length].apply(this, arguments);
					}, e[t].overloadTable = [], e[t].overloadTable[r.argCount] = r;
				}
			}
			function Yr(e, t, n) {
				Object.prototype.hasOwnProperty.call(y, e) ? ((n === void 0 || y[e].overloadTable !== void 0 && y[e].overloadTable[n] !== void 0) && sr("Cannot register public name '" + e + "' twice"), Xr(y, e, e), Object.prototype.hasOwnProperty.call(y, n) && sr("Cannot register multiple overloads of a function with the same number of arguments (" + n + ")!"), y[e].overloadTable[n] = t) : (y[e] = t, n !== void 0 && (y[e].numArguments = n));
			}
			...
			function Zr(e, t, n) {
				for (; t !== n;) t.upcast || sr("Expected null or instance of " + n.name + ", got an instance of " + t.name), e = t.upcast(e), t = t.baseClass;
				return e;
			}
			function eo(e, t) {
				if (t === null) return this.isReference && sr("null is not a valid " + this.name), 0;
				t.$$ || sr("Cannot pass \"" + er(t) + "\" as a " + this.name), t.$$.ptr || sr("Cannot pass deleted object as a pointer of type " + this.name);
				var n = t.$$.ptrType.registeredClass, r = Zr(t.$$.ptr, n, this.registeredClass);
				return r;
			}
			function to(e, t) {
				var n;
				if (t === null) return this.isReference && sr("null is not a valid " + this.name), this.isSmartPointer ? (n = this.rawConstructor(), e !== null && e.push(this.rawDestructor, n), n) : 0;
				t.$$ || sr("Cannot pass \"" + er(t) + "\" as a " + this.name), t.$$.ptr || sr("Cannot pass deleted object as a pointer of type " + this.name), !this.isConst && t.$$.ptrType.isConst && sr("Cannot convert argument of type " + (t.$$.smartPtrType ? t.$$.smartPtrType.name : t.$$.ptrType.name) + " to parameter type " + this.name);
				var r = t.$$.ptrType.registeredClass;
				if (n = Zr(t.$$.ptr, r, this.registeredClass), this.isSmartPointer) switch (t.$$.smartPtr === void 0 && sr("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
					case 0:
						t.$$.smartPtrType === this ? n = t.$$.smartPtr : sr("Cannot convert argument of type " + (t.$$.smartPtrType ? t.$$.smartPtrType.name : t.$$.ptrType.name) + " to parameter type " + this.name);
						break;
					case 1:
						n = t.$$.smartPtr;
						break;
					case 2:
						if (t.$$.smartPtrType === this) n = t.$$.smartPtr;
							...
							var o = t.clone();
							n = this.rawShare(n, To.toHandle(function() {
								o.delete();
							})), e !== null && e.push(this.rawDestructor, n);
						}
						break;
					default: sr("Unsupporting sharing policy");
				}
				return n;
			}
			function no(e, t) {
				if (t === null) return this.isReference && sr("null is not a valid " + this.name), 0;
				t.$$ || sr("Cannot pass \"" + er(t) + "\" as a " + this.name), t.$$.ptr || sr("Cannot pass deleted object as a pointer of type " + this.name), t.$$.ptrType.isConst && sr("Cannot convert argument of type " + t.$$.ptrType.name + " to parameter type " + this.name);
				var n = t.$$.ptrType.registeredClass, r = Zr(t.$$.ptr, n, this.registeredClass);
				return r;
			}
			function ro(e) {
			...
			function lo() {
				so.prototype.getPointee = oo, so.prototype.destructor = ao, so.prototype.argPackAdvance = 8, so.prototype.readValueFromPointer = ro, so.prototype.deleteObject = io, so.prototype.fromWireType = Or;
			}
			function so(e, t, n, r, o, a, i, l, s, u, c) {
				this.name = e, this.registeredClass = t, this.isReference = n, this.isConst = r, this.isSmartPointer = o, this.pointeeType = a, this.sharingPolicy = i, this.rawGetPointee = l, this.rawConstructor = s, this.rawShare = u, this.rawDestructor = c, !o && t.baseClass === void 0 ? r ? (this.toWireType = eo, this.destructorFunction = null) : (this.toWireType = no, this.destructorFunction = null) : this.toWireType = to;
			}
			function uo(e, t, n) {
				Object.prototype.hasOwnProperty.call(y, e) || cr("Replacing nonexistant public symbol"), y[e].overloadTable !== void 0 && n !== void 0 ? y[e].overloadTable[n] = t : (y[e] = t, y[e].argCount = n);
			}
			function co(e, t) {
				e = rr(e);
				function n() {
				...
				var r = n();
				return typeof r != "function" && sr("unknown function pointer with signature " + e + ": " + t), r;
			}
			function mo(e, t) {
			...
			function go(e, t, n, r, o, a, i, l, s, u, c, d, m) {
				c = rr(c), a = co(o, a), l && (l = co(i, l)), u && (u = co(s, u)), m = co(d, m);
				var p = Kr(c);
				Yr(p, function() {
					...
					t = t[0];
					var n, o;
					r ? (n = t.registeredClass, o = n.instancePrototype) : o = Gr.prototype;
					var i = Qr(p, function() {
						if (Object.getPrototypeOf(this) !== s) throw new lr("Use 'new' to construct " + c);
						if (d.constructor_body === void 0) throw new lr(c + " has no accessible constructor");
						var e = d.constructor_body[arguments.length];
						if (e === void 0) throw new lr("Tried to invoke ctor of " + c + " with invalid number of parameters (" + arguments.length + ") - expected (" + Object.keys(d.constructor_body).toString() + ") parameters instead!");
						return e.apply(this, arguments);
					...
					var _ = new so(c, d, !0, !1, !1), f = new so(c + "*", d, !1, !1, !1), g = new so(c + " const*", d, !1, !0, !1);
					return kr[e] = {
						pointerType: f,
						constPointerType: g
					}, uo(p, i), [
			...
			function Co(e, t, n, r, o, a) {
				var i = t.length;
				i < 2 && sr("argTypes array size mismatch! Must at least get return value and 'this' types!"), G(!a, "Async bindings are only supported with JSPI.");
				...
				return function() {
					arguments.length !== d && sr("function " + e + " called with " + arguments.length + " arguments, expected " + d + " args!"), _.length = 0;
					var n;
			...
			function bo(e, t, n, r, o, a) {
				G(t > 0);
				var i = ho(t, n);
				o = co(r, o), dr([], [e], function(e) {
					e = e[0];
					var n = "constructor " + e.name;
					if (e.registeredClass.constructor_body === void 0 && (e.registeredClass.constructor_body = []), e.registeredClass.constructor_body[t - 1] !== void 0) throw new lr("Cannot register multiple constructors with identical number of parameters (" + (t - 1) + ") for class '" + e.name + "'! Overload resolution is currently only performed using the parameter count, not actual type info!");
					return e.registeredClass.constructor_body[t - 1] = function() {
						fo("Cannot construct " + e.name + " due to unbound types", i);
					}, dr([], i, function(r) {
						return r.splice(1, 0, null), e.registeredClass.constructor_body[t - 1] = Co(n, r, null, o, a), [];
					}), [];
				});
			}
			function vo(e, t, n, r, o, a, i, l, s) {
				var u = ho(n, r);
				t = rr(t), a = co(o, a), dr([], [e], function(e) {
					e = e[0];
					var r = e.name + "." + t;
					...
					return d === void 0 || d.overloadTable === void 0 && d.className !== e.name && d.argCount === n - 2 ? (o.argCount = n - 2, o.className = e.name, c[t] = o) : (Xr(c, t, r), c[t].overloadTable[n - 2] = o), dr([], u, function(o) {
			...
			function ko() {
				for (var e = 0, t = Lo.reserved; t < Lo.allocated.length; ++t) Lo.allocated[t] !== void 0 && ++e;
				return e;
			}
			function Io() {
				Lo.allocated.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), Lo.reserved = Lo.allocated.length, y.count_emval_handles = ko;
			}
			var To = {
				toValue: function(t) {
					return t || sr("Cannot use deleted val. handle = " + t), Lo.get(t).value;
				},
				toHandle: function(t) {
					switch (t) {
			...
			function $o(e, t, n) {
				...
				t = rr(t), pr(e, {
					...
					toWireType: function(t, n) {
						if (typeof n != "number" && typeof n != "boolean") throw new TypeError("Cannot convert " + er(n) + " to " + this.name);
						return n;
					},
					argPackAdvance: 8,
			...
			function Po(e, t, n, r, o, a, i) {
				var l = ho(t, n);
				e = rr(e), o = co(r, o), Yr(e, function() {
					fo("Cannot call " + e + " due to unbound types", l);
				}, t - 1), dr([], l, function(n) {
					var r = [n[0], null].concat(n.slice(1));
					return uo(e, Co(e, r, null, o, a, i), t - 1), y.__WA_INVOKER_FUNCS == null && (y.__WA_INVOKER_FUNCS = new Map()), y.__WA_INVOKER_FUNCS.set(e, {
						argTypes: n.slice(1),
						returnType: n[0]
					}), [];
				});
			...
			function No(e, t, n, r, o) {
				...
				var s = t.includes("unsigned"), u = function(n, a) {
					if (typeof n != "number" && typeof n != "boolean") throw new TypeError("Cannot convert \"" + er(n) + "\" to " + a);
					if (n < r || n > o) throw new TypeError("Passing a number \"" + er(n) + "\" from JS side to C/C++ side to an argument of type \"" + t + "\", which is outside the valid range [" + r + ", " + o + "]!");
				}, c;
				s ? c = function(t, n) {
			...
			function wo(e, t) {
				...
				pr(e, {
					...
					toWireType: function(t, r) {
						...
						o || r instanceof Uint8Array || r instanceof Uint8ClampedArray || r instanceof Int8Array || sr("Cannot pass non-string to std::string"), n && o ? e = xt(r) : e = r.length;
						var a = Ni(4 + e + 1), i = a + 4;
						if (f()[a >> 2] = e, n && o) Gn(r, i, e + 1);
						else if (o) for (var l = 0; l < e; ++l) {
							var s = r.charCodeAt(l);
							s > 255 && (Mi(i), sr("String has UTF-16 code units that do not fit in 8 bits")), d()[i + l] = s;
						}
			...
			var Ao = typeof TextDecoder != "undefined" ? new TextDecoder("utf-16le") : void 0, Fo = function(t, n) {
				G(t % 2 == 0, "Pointer passed to UTF16ToString must be aligned to two bytes!");
				for (var e = t, r = e >> 1, o = r + n / 2; !(r >= o) && p()[r];) ++r;
				if (e = r << 1, e - t > 32 && Ao) return Ao.decode(d().slice(t, e));
				...
				if (G(n % 2 == 0, "Pointer passed to stringToUTF16 must be aligned to two bytes!"), G(typeof r == "number", "stringToUTF16(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), r === void 0 && (r = 2147483647), r < 2) return 0;
				r -= 2;
				...
				if (G(n % 4 == 0, "Pointer passed to stringToUTF32 must be aligned to four bytes!"), G(typeof r == "number", "stringToUTF32(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), r === void 0 && (r = 2147483647), r < 4) return 0;
				...
				r = rr(r);
				var e, o, a, i, l;
				n === 2 ? (e = Fo, o = Oo, i = Bo, a = function() {
					return p();
				}, l = 1) : n === 4 && (e = Wo, o = qo, i = Uo, a = function() {
					return f();
				}, l = 2), pr(t, {
					name: r,
					...
					toWireType: function(t, a) {
						typeof a != "string" && sr("Cannot pass non-string to C++ string type " + r);
						var e = i(a), s = Ni(4 + e + n);
						return f()[s >> 2] = e >> l, o(a, s + 4, e + n), t !== null && t.push(Mi, s), s;
					},
					argPackAdvance: 8,
					readValueFromPointer: ro,
					destructorFunction: function(t) {
			...
			function Jo(e, t, n) {
				return F("emscripten_set_offscreencanvas_size: Build with -sOFFSCREENCANVAS_SUPPORT=1 to enable transferring canvases to pthreads."), -1;
			}
			function Zo(e) {}
			var ea = function() {
				throw new Pe();
			...
			function oa(e, t) {
				...
				_()[t >> 2] = n.getUTCSeconds(), _()[t + 4 >> 2] = n.getUTCMinutes(), _()[t + 8 >> 2] = n.getUTCHours(), _()[t + 12 >> 2] = n.getUTCDate(), _()[t + 16 >> 2] = n.getUTCMonth(), _()[t + 20 >> 2] = n.getUTCFullYear() - 1900, _()[t + 24 >> 2] = n.getUTCDay();
			...
			var aa = function(t) {
				...
				var e = aa(t.getFullYear()), n = e ? ia : la, r = n[t.getMonth()] + t.getDate() - 1;
				return r;
			};
			function ua(e, t) {
				e = Vn(e), t = Vn(t);
				var n = new Date(e * 1e3);
				_()[t >> 2] = n.getSeconds(), _()[t + 4 >> 2] = n.getMinutes(), _()[t + 8 >> 2] = n.getHours(), _()[t + 12 >> 2] = n.getDate(), _()[t + 16 >> 2] = n.getMonth(), _()[t + 20 >> 2] = n.getFullYear() - 1900, _()[t + 24 >> 2] = n.getDay();
				var r = sa(n) | 0;
			...
			var ca = function(t) {
				t = Vn(t);
				var e = (function() {
					var e = new Date(_()[t + 20 >> 2] + 1900, _()[t + 16 >> 2], _()[t + 12 >> 2], _()[t + 8 >> 2], _()[t + 4 >> 2], _()[t >> 2], 0), n = _()[t + 32 >> 2], r = e.getTimezoneOffset(), o = new Date(e.getFullYear(), 0, 1), a = new Date(e.getFullYear(), 6, 1).getTimezoneOffset(), i = o.getTimezoneOffset(), l = Math.min(i, a);
					...
					_()[t + 24 >> 2] = e.getDay();
					var c = sa(e) | 0;
					return _()[t + 28 >> 2] = c, _()[t >> 2] = e.getSeconds(), _()[t + 4 >> 2] = e.getMinutes(), _()[t + 8 >> 2] = e.getHours(), _()[t + 12 >> 2] = e.getDate(), _()[t + 16 >> 2] = e.getMonth(), _()[t + 20 >> 2] = e.getYear(), e.getTime() / 1e3;
				})();
				return BigInt(e);
			};
			function da(e, t, n, r, o, a, i) {
				if (D) return Ca(16, 1, e, t, n, r, o, a, i);
				e = Vn(e), o = Vn(o), a = Vn(a), i = Vn(i);
				try {
					if (isNaN(o)) return 61;
					var l = Yt.getStreamFromFD(r), s = Qt.mmap(l, e, o, t, n), u = s.ptr;
			...
			function ma(e, t, n, r, o, a) {
				if (D) return Ca(17, 1, e, t, n, r, o, a);
				e = Vn(e), t = Vn(t), a = Vn(a);
				try {
					return isNaN(a) ? 61 : (Yt.doMsync(e, Yt.getStreamFromFD(o), t, r, a), 0);
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return -e.errno;
				}
			...
			function pa(e, t, n, r, o, a) {
				if (D) return Ca(18, 1, e, t, n, r, o, a);
				e = Vn(e), t = Vn(t), a = Vn(a);
				try {
			...
			var _a = function(t) {
				...
				for (n >>= 2; e = d()[t++];) {
					...
					o.push("j"), G(o.includes(r), "Invalid character " + e + "(\"" + r + "\") in readEmAsmArgs! Use only [" + o + "], and do not specify \"v\" for void return argument."), n += e != 105 & n, ha.push(e == 105 ? _()[n] : (e == 106 ? Z : h())[n++ >> 1]), ++n;
				}
				return ha;
			};
			function Ca(e, t) {
				...
				return sn(function() {
					for (var o = n * 2, a = _l(o * 8), i = a >> 3, l = 0; l < n; l++) {
						var s = r[2 + l];
						typeof s == "bigint" ? (Z[i + 2 * l] = BigInt(1), Z[i + 2 * l + 1] = s) : (Z[i + 2 * l] = BigInt(0), h()[i + 2 * l + 1] = s);
					}
					return el(e, o, a, t);
				});
			}
			var ba = function(t, n, r, o) {
				var e = ya(n, r);
				return D ? Ca.apply(null, [-1 - t, o].concat(e)) : (Object.prototype.hasOwnProperty.call(je, t) || ke("No EM_ASM constant found at address " + t), je[t].apply(null, e));
			}, va = function(t, n, r) {
				return ba(t, n, r, 0);
			}, Sa = function(t, n, r) {
				var e = ya(n, r);
				return Object.prototype.hasOwnProperty.call(je, t) || ke("No EM_ASM constant found at address " + t), je[t].apply(null, e);
			}, Ra = function(t, n, r) {
				return Sa(t, n, r);
			}, La = function(t, n, r) {
				return Sa(t, n, r);
			...
			function Ta(e, t) {
				if ($a.mainLoop.timingMode = e, $a.mainLoop.timingValue = t, !$a.mainLoop.func) return F("emscripten_set_main_loop_timing: Cannot set timing mode for main loop since a main loop does not exist! Call emscripten_set_main_loop first to set one up."), 1;
				if ($a.mainLoop.running || (Ea(), $a.mainLoop.running = !0), e == 0) $a.mainLoop.scheduler = function() {
					var e = Math.max(0, $a.mainLoop.tickStartTime + t - Da()) | 0;
					setTimeout($a.mainLoop.runner, e);
				}, $a.mainLoop.method = "timeout";
				else if (e == 1) $a.mainLoop.scheduler = function() {
					...
					if (typeof setImmediate == "undefined") {
						...
						addEventListener("message", o, !0), setImmediate = function(t) {
							n.push(t), k ? (y.setImmediates === void 0 && (y.setImmediates = []), y.setImmediates.push(t), postMessage({
								target: r,
								type: "cmd"
			...
			function xa(e, t, n, r, o) {
				G(!$a.mainLoop.func, "emscripten_set_main_loop: there can only be one main loop function at once: call emscripten_cancel_main_loop to cancel the previous one before setting a new one with different parameters."), $a.mainLoop.func = e, $a.mainLoop.arg = r;
				var a = $a.mainLoop.currentlyRunningMainloop;
				function i() {
					return a < $a.mainLoop.currentlyRunningMainloop ? (ka(), !1) : !0;
				}
				if ($a.mainLoop.running = !1, $a.mainLoop.runner = function() {
					if (!V) {
						if ($a.mainLoop.queue.length > 0) {
							var t = Date.now(), n = $a.mainLoop.queue.shift();
							if (n.func(n.arg), $a.mainLoop.remainingBlockers) {
								var r = $a.mainLoop.remainingBlockers, o = r % 1 == 0 ? r - 1 : Math.floor(r);
								n.counted ? $a.mainLoop.remainingBlockers = o : (o = o + .5, $a.mainLoop.remainingBlockers = (8 * r + o) / 9);
							}
							if (A("main loop blocker \"" + n.name + "\" took " + (Date.now() - t) + " ms"), $a.mainLoop.updateStatus(), !i()) return;
						...
						if (i()) {
							if ($a.mainLoop.currentFrameNumber = $a.mainLoop.currentFrameNumber + 1 | 0, $a.mainLoop.timingMode == 1 && $a.mainLoop.timingValue > 1 && $a.mainLoop.currentFrameNumber % $a.mainLoop.timingValue != 0) {
								...
								return;
							} else $a.mainLoop.timingMode == 0 && ($a.mainLoop.tickStartTime = Da());
							$a.mainLoop.method === "timeout" && y.ctx && (_n("Looks like you are rendering without using requestAnimationFrame for the main loop. You should use 0 for the frame rate in emscripten_set_main_loop in order to use requestAnimationFrame, as that can greatly improve your frame rates!"), $a.mainLoop.method = ""), $a.mainLoop.runIter(e), ie(), i() && (typeof SDL == "object" && SDL.audio && SDL.audio.queueNewAudioData && SDL.audio.queueNewAudioData(), $a.mainLoop.scheduler());
						}
					}
				}, o || (t && t > 0 ? Ta(0, 1e3 / t) : Ta(1, 1), $a.mainLoop.scheduler()), n) throw "unwind";
			}
			var $a = {
				mainLoop: {
					running: !1,
					...
					resume: function() {
						...
						var e = $a.mainLoop.timingMode, t = $a.mainLoop.timingValue, n = $a.mainLoop.func;
						$a.mainLoop.func = null, xa(n, 0, !1, $a.mainLoop.arg, !0), Ta(e, t), $a.mainLoop.scheduler();
					},
					updateStatus: function() {
						if (y.setStatus) {
							var e = y.statusMessage || "Please wait...", t = $a.mainLoop.remainingBlockers, n = $a.mainLoop.expectedBlockers;
				...
				init: function() {
					...
					e.canHandle = function(t) {
						...
						e.size !== t.length && (e = new Blob([new Uint8Array(t).buffer], { type: $a.getMimetype(n) }));
						...
						i.onload = function() {
							...
							o.drawImage(i, 0, 0), Ei[n] = e, URL.revokeObjectURL(a), r && r(t);
					...
					t.canHandle = function(t) {
						return !y.noAudioDecoding && t.substr(-4) in {
							".ogg": 1,
							".wav": 1,
							".mp3": 1
						};
						...
						var i = new Blob([t], { type: $a.getMimetype(n) }), l = URL.createObjectURL(i);
					...
					function n() {
						$a.pointerLock = document.pointerLockElement === y.canvas || document.mozPointerLockElement === y.canvas || document.webkitPointerLockElement === y.canvas || document.msPointerLockElement === y.canvas;
					}
					var r = y.canvas;
					r && (r.requestPointerLock = r.requestPointerLock || r.mozRequestPointerLock || r.webkitRequestPointerLock || r.msRequestPointerLock || function() {}, r.exitPointerLock = document.exitPointerLock || document.mozExitPointerLock || document.webkitExitPointerLock || document.msExitPointerLock || function() {}, r.exitPointerLock = r.exitPointerLock.bind(document), document.addEventListener("pointerlockchange", n, !1), document.addEventListener("mozpointerlockchange", n, !1), document.addEventListener("webkitpointerlockchange", n, !1), document.addEventListener("mspointerlockchange", n, !1), y.elementPointerLock && r.addEventListener("click", function(e) {
						!$a.pointerLock && y.canvas.requestPointerLock && (y.canvas.requestPointerLock(), e.preventDefault());
					}, !1));
				},
				createContext: function(t, n, r, o) {
					...
					return e ? (r && (n || G(typeof GLctx == "undefined", "cannot set in module if GLctx is used, but we are a non-GL context that would replace it"), y.ctx = e, n && GL.makeContextCurrent(a), y.useWebGL = n, $a.moduleContextCreatedCallbacks.forEach(function(e) {
						return e();
					}), $a.init()), e) : null;
				},
				...
				requestFullscreen: function(t, n) {
					$a.lockPointer = t, $a.resizeCanvas = n, typeof $a.lockPointer == "undefined" && ($a.lockPointer = !0), typeof $a.resizeCanvas == "undefined" && ($a.resizeCanvas = !1);
					var e = y.canvas;
					function r() {
						$a.isFullscreen = !1;
						var t = e.parentNode;
						(document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === t ? (e.exitFullscreen = $a.exitFullscreen, $a.lockPointer && e.requestPointerLock(), $a.isFullscreen = !0, $a.resizeCanvas ? $a.setFullscreenCanvasSize() : $a.updateCanvasDimensions(e)) : (t.parentNode.insertBefore(e, t), t.parentNode.removeChild(t), $a.resizeCanvas ? $a.setWindowedCanvasSize() : $a.updateCanvasDimensions(e)), y.onFullScreen && y.onFullScreen($a.isFullscreen), y.onFullscreen && y.onFullscreen($a.isFullscreen);
					}
					$a.fullscreenHandlersInstalled || ($a.fullscreenHandlersInstalled = !0, document.addEventListener("fullscreenchange", r, !1), document.addEventListener("mozfullscreenchange", r, !1), document.addEventListener("webkitfullscreenchange", r, !1), document.addEventListener("MSFullscreenChange", r, !1));
				...
				safeRequestAnimationFrame: function(t) {
					return Ea(), $a.requestAnimationFrame(function() {
						ka(), Ko(t);
					});
				},
				...
				calculateMouseEvent: function(t) {
					if ($a.pointerLock) t.type != "mousemove" && "mozMovementX" in t ? $a.mouseMovementX = $a.mouseMovementY = 0 : ($a.mouseMovementX = $a.getMovementX(t), $a.mouseMovementY = $a.getMovementY(t)), typeof SDL != "undefined" ? ($a.mouseX = SDL.mouseX + $a.mouseMovementX, $a.mouseY = SDL.mouseY + $a.mouseMovementY) : ($a.mouseX += $a.mouseMovementX, $a.mouseY += $a.mouseMovementY);
					else {
						var e = y.canvas.getBoundingClientRect(), n = y.canvas.width, r = y.canvas.height, o = typeof window.scrollX != "undefined" ? window.scrollX : window.pageXOffset, a = typeof window.scrollY != "undefined" ? window.scrollY : window.pageYOffset;
						if (G(typeof o != "undefined" && typeof a != "undefined", "Unable to retrieve scroll position, mouse positions likely broken."), t.type === "touchstart" || t.type === "touchend" || t.type === "touchmove") {
							var i = t.touch;
							if (i === void 0) return;
							...
							if (t.type === "touchstart") $a.lastTouches[i.identifier] = u, $a.touches[i.identifier] = u;
							else if (t.type === "touchend" || t.type === "touchmove") {
								var c = $a.touches[i.identifier];
								c || (c = u), $a.lastTouches[i.identifier] = c, $a.touches[i.identifier] = u;
							}
							return;
						}
						var d = t.pageX - (o + e.left), m = t.pageY - (a + e.top);
						d = d * (n / e.width), m = m * (r / e.height), $a.mouseMovementX = d - $a.mouseX, $a.mouseMovementY = m - $a.mouseY, $a.mouseX = d, $a.mouseY = m;
					}
				},
				resizeListeners: [],
				...
				setCanvasSize: function(t, n, r) {
					var e = y.canvas;
					$a.updateCanvasDimensions(e, t, n), r || $a.updateResizeListeners();
				},
				windowedWidth: 0,
				windowedHeight: 0,
				setFullscreenCanvasSize: function() {
					...
					$a.updateCanvasDimensions(y.canvas), $a.updateResizeListeners();
				},
				...
				updateCanvasDimensions: function(t, n, r) {
					...
					var e = n, o = r;
					if (y.forcedAspectRatio && y.forcedAspectRatio > 0 && (e / o < y.forcedAspectRatio ? e = Math.round(o * y.forcedAspectRatio) : o = Math.round(e / y.forcedAspectRatio)), (document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === t.parentNode && typeof screen != "undefined") {
						var a = Math.min(screen.width / e, screen.height / o);
						e = Math.round(e * a), o = Math.round(o * a);
					}
					$a.resizeCanvas ? (t.width != e && (t.width = e), t.height != o && (t.height = o), typeof t.style != "undefined" && (t.style.removeProperty("width"), t.style.removeProperty("height"))) : (t.width != n && (t.width = n), t.height != r && (t.height = r), typeof t.style != "undefined" && (e != n || o != r ? (t.style.setProperty("width", e + "px", "important"), t.style.setProperty("height", o + "px", "important")) : (t.style.removeProperty("width"), t.style.removeProperty("height"))));
				}
			};
			function Pa(e, t, n) {
				function r() {
			...
			function Na() {
				k || _n("Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread");
			}
			var Ma = function(t) {
			...
			var Wa = [];
			function qa(e, t, n, r) {
				rn.currentProxiedOperationCallerThread = t, n /= 2, Wa.length = n;
				for (var o = r >> 3, a = 0; a < n; a++) Z[o + 2 * a] ? Wa[a] = Z[o + 2 * a + 1] : Wa[a] = h()[o + 2 * a + 1];
				var i = e < 0, l = i ? je[-e - 1] : Ii[e];
				return G(l.length == n, "Call args mismatch in emscripten_receive_on_main_thread_js"), l.apply(null, Wa);
			}
			var Ua = function(t) {
				var e = W.buffer, n = t - e.byteLength + 65535 >>> 16;
				try {
					return W.grow(n), ne(), 1;
				} catch (n) {
					F("growMemory: Attempted to grow heap from " + e.byteLength + " bytes to " + t + " bytes, but got error: " + n);
				}
			}, Va = function(t) {
				var e = d().length;
				if (t >>>= 0, t <= e) return !1;
				var n = Fa();
				if (t > n) return F("Cannot enlarge memory, asked to go up to " + t + " bytes, but the limit is " + n + " bytes!"), !1;
				for (var r = function(t, n) {
					return t + (n - t % n) % n;
				}, o = 1; o <= 4; o *= 2) {
					var a = e * (1 + .2 / o);
					a = Math.min(a, t + 100663296);
					var i = Math.min(n, r(Math.max(t, a), 65536)), l = Ua(i);
					if (l) return !0;
				}
				return F("Failed to grow the heap from " + e + " bytes to " + i + " bytes, not enough memory!"), !1;
			}, Ha = ka, Ga = Ea, za = {}, ja = function() {
				...
				for (var e = 0; e < t.length; ++e) G(t.charCodeAt(e) === (t.charCodeAt(e) & 255)), l()[n++ >> 0] = t.charCodeAt(e);
				l()[n >> 0] = 0;
			};
			function Xa(e, t) {
				if (D) return Ca(19, 1, e, t);
				var n = 0;
				return Ka().forEach(function(r, o) {
					var a = t + n;
					f()[e + o * 4 >> 2] = a, Qa(r, a), n += r.length + 1;
				}), 0;
			}
			function Ya(e, t) {
				if (D) return Ca(20, 1, e, t);
				var n = Ka();
				f()[e >> 2] = n.length;
				var r = 0;
			...
			function ei(e, t, n, r, o) {
				if (D) return Ca(22, 1, e, t, n, r, o);
				t = Vn(t), n = Vn(n), r = Vn(r), o = Vn(o);
				try {
					if (isNaN(r)) return 61;
					var a = Yt.getStreamFromFD(e), i = Za(a, t, n, r);
					return f()[o >> 2] = i, 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			function ni(e, t, n, r, o) {
				if (D) return Ca(23, 1, e, t, n, r, o);
				t = Vn(t), n = Vn(n), r = Vn(r), o = Vn(o);
				try {
					if (isNaN(r)) return 61;
					var a = Yt.getStreamFromFD(e), i = ti(a, t, n, r);
					return f()[o >> 2] = i, 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			function ri(e, t, n, r) {
				if (D) return Ca(24, 1, e, t, n, r);
				try {
					var o = Yt.getStreamFromFD(e), a = Za(o, t, n);
					return f()[r >> 2] = a, 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			function oi(e, t, n, r) {
				if (D) return Ca(25, 1, e, t, n, r);
				t = Vn(t), r = Vn(r);
				try {
					if (isNaN(t)) return 61;
					var o = Yt.getStreamFromFD(e);
					return Qt.llseek(o, t, n), Z[r >> 3] = BigInt(o.position), o.getdents && t === 0 && n === 0 && (o.getdents = null), 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
				}
			...
			function ii(e, t, n, r) {
				if (D) return Ca(27, 1, e, t, n, r);
				try {
					var o = Yt.getStreamFromFD(e), a = ti(o, t, n);
					return f()[r >> 2] = a, 0;
				} catch (e) {
					if (typeof Qt == "undefined" || e.name !== "ErrnoError") throw e;
					return e.errno;
			...
			var li = function(t, n) {
				...
				for (t.startsWith("::") ? t = t.replace("::", "Z:") : t = t.replace("::", ":Z:"), t.indexOf(".") > 0 ? (t = t.replace(new RegExp("[.]", "g"), ":"), e = t.split(":"), e[e.length - 4] = ui(e[e.length - 4]) + ui(e[e.length - 3]) * 256, e[e.length - 3] = ui(e[e.length - 2]) + ui(e[e.length - 1]) * 256, e = e.slice(0, e.length - 2)) : e = t.split(":"), r = 0, o = 0, n = 0; n < e.length; n++) if (typeof e[n] == "string") if (e[n] === "Z") {
				...
				lookup_name: function(t) {
					...
					if (di.address_map.addrs[t]) n = di.address_map.addrs[t];
						...
						G(r < 65535, "exceeded max address mappings of 65535"), n = "172.29." + (r & 255) + "." + (r & 65280), di.address_map.names[n] = t, di.address_map.addrs[t] = n;
					}
					return n;
				},
				...
				var a = Ni(12);
				return f()[a >> 2] = a + 8, f()[a + 4 >> 2] = 0, _()[a + 8 >> 2] = si(di.lookup_name(t)), f()[e + 16 >> 2] = a, e;
			};
			function pi(e) {
				return D ? Ca(28, 1, e) : mi(Xt(e));
			}
			function _i(e) {
				return e;
			}
			var fi = function(t, n) {
				...
				for (var e = new Date(t.getTime()); n > 0;) {
					var r = aa(e.getFullYear()), o = e.getMonth(), a = (r ? gi : hi)[o];
				...
				G(t.length >= 0, "writeArrayToMemory array must have a length (should be an array or typed array)"), l().set(t, n);
			}, bi = function(t, n, r, o) {
				var e = _()[o + 40 >> 2], a = {
					tm_sec: _()[o >> 2],
					tm_min: _()[o + 4 >> 2],
				...
				function g(e) {
					var t = yi(new Date(e.tm_year + 1900, 0, 1), e.tm_yday), n = new Date(t.getFullYear(), 0, 4), r = new Date(t.getFullYear() + 1, 0, 4), o = f(n), a = f(r);
				...
				var h = {
					...
					"%j": function(t) {
						return m(t.tm_mday + fi(aa(t.tm_year + 1900) ? gi : hi, t.tm_mon - 1), 3);
					},
					"%m": function(t) {
			...
			var Si = function(t, n, r, o) {
				t || (t = this), this.parent = t, this.mount = t.mount, this.mounted = null, this.id = Qt.nextInode++, this.name = n, this.mode = r, this.node_ops = {}, this.stream_ops = {}, this.rdev = o;
			}, Ri = 365, Li = 146;
			Object.defineProperties(Si.prototype, {
			...
			}), Qt.FSNode = Si, Qt.createPreloadedFile = qt, Qt.staticInit(), zt = {
				EPERM: 63,
				ENOENT: 44,
				ESRCH: 71,
				EINTR: 27,
				...
				EOWNERDEAD: 62,
				ESTRPIPE: 135
			}, tr(), lr = y.BindingError = (function(e) {
				function t(t) {
					var n;
					return n = e.call(this, t) || this, n.name = "BindingError", n;
				}
				return babelHelpers.inheritsLoose(t, e), t;
			})(babelHelpers.wrapNativeSuper(Error)), ur = y.InternalError = (function(e) {
				function t(t) {
					var n;
					return n = e.call(this, t) || this, n.name = "InternalError", n;
				}
				return babelHelpers.inheritsLoose(t, e), t;
			})(babelHelpers.wrapNativeSuper(Error)), Hr(), Nr(), lo(), po = y.UnboundTypeError = mo(Error, "UnboundTypeError"), So(), Io(), y.requestFullscreen = function(t, n) {
			...
			var Di = {
				...
				emscripten_asm_const_async_on_main_thread: va,
				...
				strftime_l: vi
			}, xi = Be(), $i = xe("__wasm_call_ctors"), Pi = xe("__cxa_free_exception"), Ni = y._malloc = xe("malloc"), Mi = y._free = xe("free"), wi = y._wasm_throw_ml_abort = xe("wasm_throw_ml_abort"), Ai = y._fflush = xe("fflush"), Fi = xe("__errno_location"), Oi = y._pthread_self = function() {
				return (Oi = y._pthread_self = q.pthread_self)();
			}, Bi = xe("ntohs"), Wi = xe("htonl"), qi = xe("htons"), Ui = y.__ZN5folly15SharedMutexImplILb1EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj = xe("_ZN5folly15SharedMutexImplILb1EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj"), Vi = y.__ZN5folly15SharedMutexImplILb0EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj = xe("_ZN5folly15SharedMutexImplILb0EvNSt3__26atomicENS_24SharedMutexPolicyDefaultEE25wakeRegisteredWaitersImplERjj"), Hi = xe("__cxa_increment_exception_refcount"), Gi = xe("__cxa_decrement_exception_refcount"), zi = y.__emscripten_tls_init = xe("_emscripten_tls_init"), ji = xe("emscripten_builtin_memalign"), Ki = xe("__getTypeName"), Qi = y.__embind_initialize_bindings = xe("_embind_initialize_bindings"), Xi = y.__emscripten_thread_init = xe("_emscripten_thread_init"), Yi = y.__emscripten_thread_crashed = xe("_emscripten_thread_crashed"), Ji = xe("emscripten_main_thread_process_queued_calls"), Zi = xe("emscripten_main_runtime_thread_id"), el = xe("_emscripten_run_in_main_runtime_thread_js"), tl = xe("emscripten_dispatch_to_thread_"), nl = function() {
				return (nl = q.emscripten_stack_get_base)();
			}, rl = function() {
				return (rl = q.emscripten_stack_get_end)();
			}, ol = xe("_emscripten_thread_free_data"), al = y.__emscripten_thread_exit = xe("_emscripten_thread_exit"), il = y.__emscripten_check_mailbox = xe("_emscripten_check_mailbox"), ll = xe("setThrew"), sl = xe("setTempRet0"), ul = function() {
				return (ul = q.emscripten_stack_init)();
			}, cl = function(t, n) {
				return (cl = q.emscripten_stack_set_limits)(t, n);
			}, dl = function() {
				return (dl = q.emscripten_stack_get_free)();
			}, ml = xe("stackSave"), pl = xe("stackRestore"), _l = xe("stackAlloc"), fl = function() {
				return (fl = q.emscripten_stack_get_current)();
			}, gl = y.___get_exception_message = xe("__get_exception_message"), hl = xe("__cxa_can_catch"), yl = xe("__cxa_is_pointer_type"), Cl = y.___start_em_js = 1378172, bl = y.___stop_em_js = 1383604;
			function vl(e, t, n, r) {
				var o = ml();
				try {
					dn(e)(t, n, r);
				} catch (e) {
					if (pl(o), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Sl(e) {
				...
				try {
					...
					if (pl(t), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Rl(e, t, n) {
				...
				try {
					...
					if (pl(r), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Ll(e, t) {
				...
				try {
					...
					if (pl(n), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function El(e, t, n) {
			...
			function Tl(e, t, n, r, o, a, i) {
				...
				try {
					...
					if (pl(l), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Dl(e, t) {
			...
			function xl(e, t, n, r, o) {
				...
				try {
					...
					if (pl(a), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			...
			function Pl(e, t, n, r, o, a, i, l, s) {
				...
				try {
					...
					if (pl(u), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Nl(e, t, n, r) {
			...
			function Ml(e, t, n, r, o, a, i, l, s, u) {
				...
				try {
					...
					if (pl(c), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function wl(e, t, n, r, o, a, i, l) {
				...
				try {
					...
					if (pl(s), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Al(e, t, n, r, o, a) {
				...
				try {
					...
					if (pl(i), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			...
			function Ul(e, t, n, r, o, a, i, l, s, u, c, d, m, p) {
				...
				try {
					...
					if (pl(_), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Vl(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h) {
				...
				try {
					...
					if (pl(y), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Hl(e) {
			...
			function Kl(e, t, n, r, o, a, i, l, s, u, c) {
				...
				try {
					...
					if (pl(d), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			...
			function Xl(e, t, n, r, o, a, i, l, s, u, c, d, m) {
				...
				try {
					...
					if (pl(p), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			...
			function Jl(e, t, n, r, o, a, i, l, s, u, c, d) {
				...
				try {
					...
					if (pl(m), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			...
			function as(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f) {
				...
				try {
					...
					if (pl(g), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			...
			function ys(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _) {
				...
				try {
					...
					if (pl(f), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function Cs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v) {
				var S = ml();
				try {
					return dn(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v);
				} catch (e) {
					if (pl(S), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function bs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R) {
				var L = ml();
				try {
					return dn(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R);
				} catch (e) {
					if (pl(L), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			...
			function vs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g) {
				...
				try {
					...
					if (pl(h), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			...
			function Rs(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b) {
				var v = ml();
				try {
					return dn(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b);
				} catch (e) {
					if (pl(v), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			...
			function eu(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C) {
				var b = ml();
				try {
					return dn(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C);
				} catch (e) {
					if (pl(b), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			}
			function tu(e, t, n) {
			...
			function Eu(e, t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $) {
				var P = ml();
				try {
					dn(e)(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L, E, k, I, T, D, x, $);
				} catch (e) {
					if (pl(P), !(e instanceof $e)) throw e;
					ll(1, 0);
				}
			...
			y.keepRuntimeAlive = me, y.wasmMemory = W, y.GROWABLE_HEAP_U8 = d, y.GROWABLE_HEAP_F32 = g, y.ExitStatus = gt, y.FS = Qt, y.PThread = rn, y.registeredTypes = ar;
			var ec = [
				"writeI53ToI64",
			...
			function oc() {
				...
				if (pe(), Ce > 0) return;
				function e() {
					nc || (nc = !0, y.calledRun = !0, !V && (_e(), C(y), y.onRuntimeInitialized && y.onRuntimeInitialized(), G(!y._main, "compiled without a main, but one is present. if you added it from JS, use Module[\"onRuntimeInitialized\"]"), fe()));
				}
				y.setStatus ? (y.setStatus("Running..."), setTimeout(function() {
					setTimeout(function() {
						y.setStatus("");
					}, 1), e();
				}, 1)) : e(), ie();
			...
			function ac() {
				...
				try {
					Ai(0), ["stdout", "stderr"].forEach(function(e) {
						var t = Qt.analyzePath("/dev/" + e);
						if (t) {
							var r = t.object, o = r.rdev, a = Mt.ttys[o];
							a && a.output && a.output.length && (n = !0);
						}
					});
				} catch (e) {}
				A = e, F = t, n && _n("stdio streams had content in them that was not flushed. you should set EXIT_RUNTIME to 1 (see the Emscripten FAQ), or make sure to emit a newline when you printf etc.");
			}
			if (y.preInit) for (typeof y.preInit == "function" && (y.preInit = [y.preInit]); y.preInit.length > 0;) y.preInit.pop()();
			return oc(), a.ready;
		};
	})();
	typeof l == "object" && typeof i == "object" ? i.exports = d : typeof define == "function" && define.amd && define([], function() {
		return d;
	});
}), 34);
