__d("WAWebVoipWebWasmVariantLoader", [
	...
	function v() {
		return v = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var t = yield r("JSResourceForInteraction")("WAWebVoipWebWasmLoader").__setRef("WAWebVoipWebWasmVariantLoader").load(), n = yield t(e != null ? e : C());
	...
	function R() {
		return R = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var t = yield r("JSResourceForInteraction")("WAWebVoipWebWasmLoader_ContentAddressed_internal").__setRef("WAWebVoipWebWasmVariantLoader").load(), n = yield t(e != null ? e : C());
	...
	function D() {
		return D = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			if (o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose([
				...
				"', validated variant: '",
				"'"
			])), String(r), a), !f.has(a)) return o("WALogger").LOG(m || (m = babelHelpers.taggedTemplateLiteralLoose(["voip: Variant '", "' not available, using default loader"])), a), k(_, e);
			var i = C(), l = E(a);
