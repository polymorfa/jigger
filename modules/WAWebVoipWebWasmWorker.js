__d("WAWebVoipWebWasmWorker", [
	...
	var d = new (o("WorkerMessagePort")).WorkerSyncedMessagePort(self, "VoipWebWasmWorker");
	o("WAWebLoggerWorker").initializeWAWebLogger(), o("WorkerSelf").init(d), self.WhatsAppVoipWasmWorkerCompatibleCallbacks = {
		...
		loggingCallback: function(t) {
			d.postMessage(babelHelpers.extends({
				type: "waWasmWorkerCompatibleCallback",
	...
	function b() {
		try {
			var e, t, n;
			(e = m.wasmMemory) == null || e.grow(0), (t = (n = m).GROWABLE_HEAP_U8) == null || t.call(n);
		} catch (e) {}
	}
	function v(e) {
	...
	function S(e) {
		...
		if (t != null) for (var n = 0; n <= C; n++) try {
			t(e);
			return;
		} catch (e) {
			if (!v(e) || n === C) throw e;
	...
	function L(e) {
		try {
			if (e.cmd === "load") {
				var t = e.handlers, a = e.wasmMemory, i = e.wasmModule, l = e.wasmVariant, s = e.workerID, c = [], f = function(t) {
					c.push(t);
				};
				d.removeMessageListener("cmd", L), d.addMessageListener("cmd", f);
				var g = !1, C = !1, v = function() {
					if (g && C) {
						d.postMessage({
							type: "cmd",
							cmd: "loaded"
						...
						for (var e of c) L(e);
						d.removeMessageListener("cmd", f), d.addMessageListener("cmd", L);
					}
				};
				...
				for (var k of t) E(k);
				m.wasmMemory = a, m.buffer = m.wasmMemory.buffer, m.workerID = s, m.ENVIRONMENT_IS_PTHREAD = !0, m.onAbort = function(e) {
				...
				var I, T, D, x, $, P, N = e.pthread_ptr;
				if (b(), (I = (T = m).__emscripten_thread_init) == null || I.call(T, N, 0, 0, 1), S(N), _(!!N, "pthread_ptr is required in event " + e.cmd), (D = (x = m).establishStackSpace) == null || D.call(x), ($ = m.PThread) == null || $.receiveObjectTransfer(e), (P = m.PThread) == null || P.threadInitTLS(), !p) {
					var M, w;
					(M = (w = m).__embind_initialize_bindings) == null || M.call(w), p = !0;
				}
				try {
					var A, F;
					(A = (F = m).invokeEntryPoint) == null || A.call(F, e.start_routine, e.arg);
				} catch (e) {
					if (e !== "unwind") throw e;
				}
			...
			} else e.cmd === "jsWorkerCmd" ? o("WAWebVoipJsWorkerMessageHandler").handleJsWorkerMessage(y, e) : e.cmd && (h("worker.js received unknown command " + e.cmd), h(e));
		} catch (e) {
			var H = r("getErrorSafe")(e);
			if (h("worker.js onmessage() captured an uncaught exception: " + String(e)), H.stack && h(H.stack), R(e), m.__emscripten_thread_crashed) {
				var G, z;
				(G = (z = m).__emscripten_thread_crashed) == null || G.call(z);
			}
			if (e instanceof WebAssembly.RuntimeError) h("[VoIP WASM] RuntimeError suppressed: " + e.message);
			else throw e;
		}
	}
	d.addMessageListener("cmd", L), d.addMessageListener("jsWorkerCmd", function(e) {
		try {
			o("WAWebVoipJsWorkerMessageHandler").handleJsWorkerMessage(y, e);
		} catch (e) {
			throw h("worker.js jsWorkerCmd handler captured an uncaught exception: " + String(e)), e != null && typeof e == "object" && "stack" in e && h(String(e.stack)), R(e), e;
		}
	});
	function E() {}
	l.default = E;
