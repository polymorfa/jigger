__d("WAWebWAWCCommon", [], (function(t, n, r, o, a, i) {
	function e(e) {
		e.version(1).stores({ logs: "line,log" }), e.version(2).stores({
			logs: "line,log",
		...
		}), e.version(13).stores({ logs: "line,timestamp" }), e.version(14).stores({ logs: "line,timestamp,&count" });
	}
	i.applyVersions = e;
}), 66);
