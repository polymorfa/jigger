__d("WAWebWWAISendRequest", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			var i = o("WAWebWWAIRequestBuilder").buildRewriteRequest(e, t, n), l = i.request;
			o("WAWebWWAILogging").logRequestSent(t, l.requestId);
			try {
				return yield d(a.sendRequest(l), o("WAWebWWAIConstants").DEFAULT_REQUEST_TIMEOUT_MS);
			} catch (e) {
				var s = c(e);
	...
	function c(e) {
		return e instanceof Error ? e.name === "TimeoutError" ? "timeout" : e.name === "WWAIServerError" ? "server" : "unknown" : "unknown";
	}
	function d(t, o) {
