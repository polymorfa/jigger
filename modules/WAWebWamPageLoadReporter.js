__d("WAWebWamPageLoadReporter", [
	...
	var e, s, u, c = new (o("WAWebWebcPageLoadWamEvent")).WebcPageLoadWamEvent(), d, m = {}, p, _, f = !1, g = !1;
	function h() {
		return {
			uiTimingComplete: f,
			wsTimingComplete: g
	...
	function R(e) {
		e: {
			...
			if (e === o("WAWebStreamModel").StreamInfo.OFFLINE || e === o("WAWebStreamModel").StreamInfo.SYNCING || e === o("WAWebStreamModel").StreamInfo.RESUMING || e === o("WAWebStreamModel").StreamInfo.CONNECTING) break e;
			throw Error("Match: No case succesfully matched. Make exhaustive or add a wildcard case using '_'. Argument: " + e);
		}
	}
	function L(e) {
		o("WAWebPageLoadLogging").addPageLoadQplPoint("webc_initial_panel_mount_t"), d = e;
	}
	function E(e) {
	...
	window.document && (v = !document.hidden, document.addEventListener("visibilitychange", T)), u.all([y, C]).then(function() {
		D(), r("WAWebWamResourceLoadReporter")(), b || (b = !0, o("WAWebWam").Wam.resumeJobs());
	});
	function I(e) {
		return !self.performance || !self.performance.timing || !self.performance.timing.navigationStart ? null : e - self.performance.timing.navigationStart;
	}
	function T() {
	...
	function D() {
		var t;
		if (!((t = self.performance) != null && t.timing && self.performance.navigation)) {
			o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["MetricReporter:logPageLoad metrics not provided by browser!"])));
			return;
		}
		if (!c) return;
		var r = c, a = self.performance.timing, i = self.performance.navigation, l = a.navigationStart, u = a.loadEventEnd - l;
		if (u <= 0) {
			o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["MetricReporter:logPageLoad delayed"]))), self.setTimeout(D, 1e4);
			return;
		}
		function p(e) {
			var t = a[e];
	...
	function P(e) {
		W.hasStarted() || N(e) && (E(e), W.start(), o("WAWebPageLoadLogging").addPageLoadQplPoint("webc_initial_panel_mount_start_t"), window.requestAnimationFrame(function() {
			W.end(), o("WAWebPageLoadLogging").addPageLoadQplPoint("webc_initial_panel_render_t"), A("initialPanelRenderTRecorded");
		}));
	}
	function N(e) {
	...
	var M = !1, w = !1;
	function A(e) {
		e === "initialPanelMountTRecorded" && (M = !0), e === "initialPanelRenderTRecorded" && (w = !0), M && w && k();
	}
	...
	l.getWamPageLoadTimingCompletion = h, l.streamInfoChange = S, l.logWamPageLoad = D, l.maybeLogInitialScreenRenderStart = P, l.logFirstRenderMountTimeOnce = F, l.exeTimer = O, l.mainScriptTimer = B;
}), 98);
