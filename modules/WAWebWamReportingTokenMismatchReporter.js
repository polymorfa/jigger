__d("WAWebWamReportingTokenMismatchReporter", [
	"WAWebMsgGetters",
	"WAWebMsgKeyUtils",
	"WAWebMsgType",
	...
	function e(e) {
		var t, n = e.groupHistoryBundleMessageId, r = e.isPartOfGroupHistory, a = e.msg, i = e.reason, l = e.reportingTokenVersion, s = (t = a.senderWithDevice) != null ? t : o("WAWebMsgGetters").getSender(a);
		new (o("WAWebReportingTokenValidationFailureWamEvent")).ReportingTokenValidationFailureWamEvent({
			...
			isLid: o("WAWebMsgKeyUtils").isLidMsgKey(a.id, o("WAWebMsgKeyUtils").TranslateMsgKeyType.Message),
			...
			isSecretEncryptedMsg: a.kind === o("WAWebMsgType").MsgKind.CommentEncrypted,
		...
		new (o("WAWebReportingTokenValidationFailureSenderWamEvent")).ReportingTokenValidationFailureSenderWamEvent(u).commit();
	}
