__d("WAWebWamStorage", [
		...
		return b = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			...
			return a.wam.add({
				...
				o("WALogger").LOG(p || (p = babelHelpers.taggedTemplateLiteralLoose([
					...
					"\\n",
					""
				])), String(e), r("getErrorSafe")(e).stack);
			});
	...
	function S() {
		return S = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			var a = 0;
			try {
				a = yield r("WAWebWAWCStorage").idb().then(function(r) {
					return r.wam.update(e, {
						key: e,
						buffer: n,
						channel: t
					});
	...
	function L() {
		return L = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = {};
			try {
				yield r("WAWebWAWCStorage").idb().then(function(n) {
					return n.wam.where("channel").equals(e).modify(function(e, n) {
	...
	function k() {
		return k = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			try {
				...
				yield i.transaction("rw", ["wam_meta"], n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var n = yield i.wam_meta.where("streamId").equals(e).count();
					n === 0 ? (yield i.wam_meta.add({
						streamId: e,
						seqNum: 1
					}), t = 1) : yield i.wam_meta.where("streamId").equals(e).modify(function(e) {
						return t = e.seqNum + 1, t >= a && (t = 1), e.seqNum = t, e;
					});
				}));
			} catch (e) {
			...
			if (t === -1) throw r("gkx")("26258") || o("WALogger").ERROR(h || (h = babelHelpers.taggedTemplateLiteralLoose(["[wam] getNextSequenceNumberForStream failed"]))).sendLogs("getNextSequenceNumberForStreamFailed"), r("err")("could not get seq number for streamId " + e);
			return t;
		}), k.apply(this, arguments);
	}
	function I(t) {
		return r("WAWebWAWCStorage").idb().then(function(e) {
			...
			o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
				...
				"\\n",
				""
			])), String(t), r("getErrorSafe")(t).stack);
		});
	}
	function T() {
		return r("WAWebWAWCStorage").idb().then(function(e) {
	...
	function D(e) {
		return r("WAWebWAWCStorage").idb().then(function(t) {
	...
	function K() {
		return K = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
			var e = yield r("WAWebWAWCStorage").idb();
			try {
				yield e.transaction("rw", ["worker_wam_events"], n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					yield e.worker_wam_events.limit(o("WAWebWamConstants").WAM_WORKER_DATA_BATCH_SIZE).modify(function(e, t) {
