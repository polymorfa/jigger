...
`,
	...
	async function b(e, t, n) {
		var a = 0;
		try {
			a = await r("WAWebWAWCStorage").idb().then(function(r) {
...
`,
	...
	async function v(e) {
		var t = {};
		try {
			await r("WAWebWAWCStorage").idb().then(function(n) {
	...
	async function S(e) {
		...
		try {
			...
			await a.transaction("rw", ["wam_meta"], async function() {
				...
				r === 0 ? (await a.wam_meta.add({
					streamId: e,
					seqNum: 1
				}), t = 1) : await a.wam_meta.where("streamId").equals(e).modify(function(e) {
					return t = e.seqNum + 1, t >= n && (t = 1), e.seqNum = t, e;
				});
			});
		} catch (e) {
			var i = r("getErrorSafe")(e);
...
`,
		...
		if (t === -1) throw r("gkx")("26258") || o("WALogger").ERROR(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[wam] getNextSequenceNumberForStream failed"]))).sendLogs("getNextSequenceNumberForStreamFailed"), r("err")("could not get seq number for streamId " + e);
		return t;
	}
	function R(e) {
	...
	async function A() {
		...
		try {
			await e.transaction("rw", ["worker_wam_events"], async function() {
				await e.worker_wam_events.limit(o("WAWebWamConstants").WAM_WORKER_DATA_BATCH_SIZE).modify(function(e, t) {
