__d("WAWebWasaRootSecretWriter", [
	...
	function u() {
		return u = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			yield o("WAWebWasaRootSecretDb").upsertWasaRootSecretForId(e, t, n), yield o("WAWebWasaUserPrefs").setWasaActiveTargetId(e.user, t);
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			t != null && (yield o("WAWebWasaRootSecretDb").removeWasaRootSecretForId(e, t)), yield o("WAWebWasaUserPrefs").clearWasaActiveTargetId(e.user);
	...
	function p() {
		return p = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			try {
				var a = yield _(t, n);
				return a == null ? !1 : (yield o("WAWebWasaRootSecretDb").upsertWasaRootSecretForId(t, a.stanzaId, a.secret), !0);
			} catch (t) {
	...
	function f() {
		return f = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			var n, r, a = "[\"" + o("WAWebSyncdConst").Actions.WasaRootSecret + "\",\"" + e.toJid() + "\"]", i = yield o("WAWebSyncdDb").getSyncAction(a);
	...
	l.applyWasaRootSecretForId = s, l.clearWasaRootSecret = c, l.maybeRecoverWasaRootSecretFromStore = m;
}), 98);
