__d("WAWebWasaUserPrefs", ["WAWebUserPrefsIndexedDBStorage", "asyncToGeneratorRuntime"], (function(t, n, r, o, a, i, l) {
	...
	function c() {
		return c = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, n) {
			...
			a[t] = n, yield o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.set(e, a);
	...
	function m() {
		return m = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			if (!(n == null || n[t] == null)) {
				...
				delete r[t], yield o("WAWebUserPrefsIndexedDBStorage").userPrefsIdb.set(e, r);
			}
		}), m.apply(this, arguments);
	}
	l.getWasaActiveTargetId = s, l.setWasaActiveTargetId = u, l.clearWasaActiveTargetId = d;
}), 98);
