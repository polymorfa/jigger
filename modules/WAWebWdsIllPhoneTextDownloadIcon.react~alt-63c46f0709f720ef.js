__d("WAWebWdsIllPhoneTextDownloadIcon.react", [
	"WAWebSvgComponentBase",
	"WAWebSvgIconHelpers",
	"react",
	"stylex"
], (function(t, n, r, o, a, i, l) {
	var e, s, u = s || (s = o("react")), c = "wds-ill-phone-text-download";
	function d(t) {
		var n = o("WAWebSvgIconHelpers").resolveSvgIcon(t, c, 153, 229, null);
		return u.jsx(o("WAWebSvgComponentBase").BaseSvgSpan, babelHelpers.extends({}, n.otherProps, {
			...
			children: u.jsxs("svg", {
				...
				children: [
					...
					u.jsxs("g", {
						clipPath: "url(#WAWebWdsIllPhoneTextDownloadIcon__a)",
						children: [
							u.jsx("path", {
								fill: "#25D366",
								stroke: "#111B21",
					...
					u.jsx("defs", { children: u.jsx("clipPath", {
						id: "WAWebWdsIllPhoneTextDownloadIcon__a",
						children: u.jsx("path", {
							fill: "#fff",
	...
	d.displayName = d.name + " [from " + i.id + "]", l.WdsIllPhoneTextDownloadIcon = d;
}), 98);
