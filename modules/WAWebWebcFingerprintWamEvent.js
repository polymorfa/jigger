__d("WAWebWebcFingerprintWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ WebcFingerprint: [
		1704,
		{
			...
			platformEstimate: [34, o("WAWebWamEnumPlatformName").PLATFORM_NAME],
			...
			webcWindowNavigatorWebdriver: [21, o("WAWebWamEnumWebcWindowNavigatorWebdriverType").WEBC_WINDOW_NAVIGATOR_WEBDRIVER_TYPE]
		},
		[
			1,
			1,
