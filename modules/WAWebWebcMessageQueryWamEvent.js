__d("WAWebWebcMessageQueryWamEvent", [
	...
	var e, s = (e = o("WAWebWamCodegenUtils")).defineEvents({ WebcMessageQuery: [
		1876,
		{
			...
			webcMessageQueryTrigger: [19, o("WAWebWamEnumWebcQueryTriggerType").WEBC_QUERY_TRIGGER_TYPE],
			webcMessageQueryType: [3, o("WAWebWamEnumWebcMessageQueryDirection").WEBC_MESSAGE_QUERY_DIRECTION],
