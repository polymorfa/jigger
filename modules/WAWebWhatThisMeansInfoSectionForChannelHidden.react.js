__d("WAWebWhatThisMeansInfoSectionForChannelHidden.react", [
	"fbt",
	"WAWebFlex.react",
	...
	function d() {
		...
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (t = [{
			...
			iconSize: 24,
			testid: "what-this-means-bffd-bullet-1",
