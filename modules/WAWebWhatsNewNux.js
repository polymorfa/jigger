__d("WAWebWhatsNewNux", ["WAWebNux", "WAWebNuxCoolOff"], (function(t, n, r, o, a, i, l) {
	var e = {
	...
	function s(t) {
		return t === void 0 && (t = 30), new (o("WAWebNuxCoolOff")).CoolOffNux(o("WAWebNux").NuxKeyTypes.COOL_OFF_NUX.WHATS_NEW, babelHelpers.extends({}, e, { COOL_OFF_DURATION_IN_DAYS: t }));
	}
	function u(e) {
