__d("WAWebWidJsonReviver", [
	...
	function u(t, n, a, i) {
		a === void 0 && (a = r("WAWebWid").isWid), i === void 0 && (i = o("WAWebWidFactory").createWid);
		var l = n;
		switch (t) {
			case "accountLid":
			case "author":
			...
			default: {
				...
				if (!isNaN(u) && a(n)) l = i(n);
					...
					a(n) && o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[widReviver] Value under key ", " resembles a WID, but not included in revived fields. Consider carefully if you want to revive it or add it to the ignore list."])), t).sendLogs("widReviver-wid-key-" + t);
				}
				break;
			}
		}
