__d("WAWebWindowsFsaFileSaver", [
	...
	function p(t) {
		return o("WAWebWindowsGatingUtils").hasFsaSaveFilePickerSupport() ? r("WAWebODS").incr("web.windows.fsa_save_as.supported") : r("WAWebODS").incr("web.windows.fsa_save_as.unsupported"), o("WAWebWindowsGatingUtils").isFsaSaveAsEnabled() ? (r("WAWebODS").incr("web.windows.fsa_save_as.started"), _(t).catch(function(t) {
			o("WALogger").ERROR(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[fsa-save-as] Unexpected error in save flow"]))).catching(r("getErrorSafe")(t)).sendLogs("fsa-save-as-unexpected"), L();
		}), !0) : !1;
	}
	function _(e) {
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			var t = o("WAWebFilenameManager").getDefaultName(e), n = S(e);
			try {
				return yield showSaveFilePicker(n != null ? {
					suggestedName: t,
					types: n
				} : { suggestedName: t });
			} catch (t) {
	...
	function C() {
		return C = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			try {
				var n = yield o("WAWebFileSaverDownloadData").getMultiMsgDownloadData(e, !0), a = n.blob;
				if (a == null) {
					var i = new Error("No blob available to save");
					throw i.stack, i;
				}
				yield b(t, a), r("WAWebODS").incr("web.windows.fsa_save_as.saved"), R();
			} catch (e) {
				...
				o("WALogger").ERROR(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[fsa-save-as] Failed to write file after picker"]))).catching(l).sendLogs("fsa-save-as-write-failed"), r("WAWebODS").incr("web.windows.fsa_save_as.failed"), L();
			}
