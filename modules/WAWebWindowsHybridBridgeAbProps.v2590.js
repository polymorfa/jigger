__d("WAWebWindowsHybridBridgeAbProps.v2590", [
	"WALogger",
	"WAWebABPropsCache",
	...
	var e, s = (function() {
		function t(t) {
			...
			this.$2 = !1, this.$4 = (function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
					var n;
					r.$3 == null && (r.$3 = o("WAWebHybridABProps").getAllHybridExpoKeys());
					var a = t.toString(), i = (n = r.$3) == null ? void 0 : n.get(a);
					if (i == null) {
						o("WALogger").WARN(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[abprops][windows hybrid] unknown exposure key: ", ""])), a);
						return;
					}
					o("WAWebABPropsCache").saveExposure(i), r.$1.acknowledgeExposure(a);
				});
				return function(e) {
		...
		return r.initialize = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = this;
				if (!this.$2) {
					this.$2 = !0, yield o("WAWebABPropsCache").waitForABPropConfigsReady(), this.$1.addEventListener("exposureLogged", this.$4), this.$1.subscribe(null);
