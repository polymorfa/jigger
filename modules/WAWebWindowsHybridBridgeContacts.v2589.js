__d("WAWebWindowsHybridBridgeContacts.v2589", [
	"WALogger",
	"WAWebBackendApi",
	...
	var e, s = r("qpl")._(891427936, "2894"), u = (function() {
		function t(e, t, a) {
				...
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					...
					if (t.length !== 0) {
						...
						o.forEach(function(e) {
							return i.$5.delete(e);
						}), i.$1.updateContacts(o, JSON.stringify(r("filterNulls")(n)));
					}
				});
				return function(t) {
			...
			})(), this.$1 = e, this.$2 = t, this.$3 = a, e.addEventListener("requestUpdateEvent", this.$6), e.addEventListener("requestFrequentContactsEvent", this.$7), e.subscribe(null);
		}
		var a = t.prototype;
		return a.initialize = (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				if (r("WAWebLidAwareContactsDB").setUpdateListener(function(e) {
					...
					this.$3 = !0;
					try {
						var n = 200, a = yield o("WAWebSchemaContact_DO_NOT_USE_DIRECTLY").getContactTable().all({
							limit: n,
							offset: 0
						});
						do {
							var i, l = (i = a[a.length - 1]) == null ? void 0 : i.id;
							a = yield o("WAWebContactsDbLidMigrationUtils").replacePnRowsWithLidData(a), yield this.$1.updateContacts([], JSON.stringify(a)), a = yield o("WAWebSchemaContact_DO_NOT_USE_DIRECTLY").getContactTable().greaterThan(["id"], l, { limit: n });
						} while (a.length > 0);
