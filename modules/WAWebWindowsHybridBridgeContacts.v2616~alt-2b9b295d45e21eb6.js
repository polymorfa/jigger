		...
		function t(t, n, a) {
			...
			this.$4 = "contacts", this.$5 = new Set(), this.$6 = async function(t) {
				...
				if (n.length !== 0) {
					...
					var c = self.performance.now(), d = JSON.stringify(r("filterNulls")(l)), m = self.performance.now() - c;
					o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
						...
						"ms bytes=",
						""
					])), n.length, u.length, s.toFixed(0), m.toFixed(0), d.length), i.$1.updateContacts(u, d);
				}
				...
				try {
					...
					r("WAWebODS").incr("web.hybrid.bridge.contacts.send.frequent"), i.$1.receiveFrequentContacts(l);
				} catch (e) {
					r("WAWebODS").incr("web.hybrid.bridge.contacts.send.frequent"), i.$1.receiveFrequentContacts(JSON.stringify([]));
				}
			}, this.$1 = t, this.$2 = n, this.$3 = a, t.addEventListener("requestUpdateEvent", this.$6), t.addEventListener("requestFrequentContactsEvent", this.$7), t.subscribe(null);
		}
		var n = t.prototype;
			...
			if (r("WAWebLidAwareContactsDB").setUpdateListener(function(t, n) {
				...
				try {
					...
					do {
						...
						n = await o("WAWebContactsDbLidMigrationUtils").replacePnRowsWithLidData(n), r("WAWebODS").incr("web.hybrid.bridge.contacts.send.initial_sync_chunk"), await this.$1.updateContacts([], JSON.stringify(n)), n = await o("WAWebSchemaContact_DO_NOT_USE_DIRECTLY").getContactTable().greaterThan(["id"], i, { limit: t });
					} while (n.length > 0);
