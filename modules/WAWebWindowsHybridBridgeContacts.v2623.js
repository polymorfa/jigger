__d("WAWebWindowsHybridBridgeContacts.v2623", [
	"WALogger",
	"WAWebABProps",
	"WAWebBackendApi",
	...
	"use strict";
	var e, s, u, c, d = r("qpl")._(891427936, "2894"), m = new Set([
		"phoneNumber",
		"name",
		"pushname",
	...
	var _ = (function() {
		function t(t, a, i) {
			var l = this;
			this.$4 = "contacts", this.$5 = new Set(), this.$6 = (function() {
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
					...
					if (n.length !== 0) {
						...
						var a = self.performance.now(), i = yield r("WAWebLidAwareContactsDB").bulkGet(n), s = self.performance.now() - a;
						...
						var c = self.performance.now(), d = JSON.stringify(r("filterNulls")(i)), m = self.performance.now() - c, p = self.performance.now();
				...
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
					...
					try {
						var a = yield o("WAWebBackendApi").frontendSendAndReceive("getFrequentContacts", {
							count: t,
			...
			})(), this.$8 = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				try {
					var e = yield o("WAWebBackendApi").frontendSendAndReceive("getFrequentChatsForSharing", {});
					r("WAWebODS").incr("web.hybrid.bridge.contacts.send.frequent_chats_for_sharing"), o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
						...
						return l.$1.receiveFrequentChatsForSharing(JSON.stringify(e));
					});
				} catch (e) {
					o("WALogger").WARN(s || (s = babelHelpers.taggedTemplateLiteralLoose(["[WinUi] getFrequentChatsForSharing error ", ""])), e), r("WAWebODS").incr("web.hybrid.bridge.contacts.send.frequent_chats_for_sharing"), o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
						...
						return l.$1.receiveFrequentChatsForSharing(JSON.stringify([]));
					});
				}
			}), this.$1 = t, this.$2 = a, this.$3 = i, t.addEventListener("requestUpdateEvent", this.$6), t.addEventListener("requestFrequentContactsEvent", this.$7), t.addEventListener("requestFrequentChatsForSharingEvent", this.$8), t.subscribe(null);
		}
		var a = t.prototype;
		return a.initialize = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				...
				if (r("WAWebLidAwareContactsDB").setUpdateListener(function(t, n) {
					o("WAWebABProps").getABPropConfigValue("web_anr_skip_unused_contacts_db_updates_enabled") && n != null && !p(n) || e.$9(t);
				}), yield r("WAWebEventsWaitForMainStreamReadyMd")(), !this.$3 && !r("WAWebSyncBootstrap").isSyncDBootstrapInProcess()) {
					this.$3 = !0;
					try {
						var t = 200, n = yield o("WAWebSchemaContact_DO_NOT_USE_DIRECTLY").getContactTable().all({
							limit: t,
							offset: 0
						});
						do {
							var a, i = (a = n[n.length - 1]) == null ? void 0 : a.id;
							n = yield o("WAWebContactsDbLidMigrationUtils").replacePnRowsWithLidData(n), r("WAWebODS").incr("web.hybrid.bridge.contacts.send.initial_sync_chunk"), yield o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
								bridge: "contacts",
								method: "updateContacts-1",
								type: "async"
							}, function() {
								return e.$1.updateContacts([], JSON.stringify(n));
							}), n = yield o("WAWebSchemaContact_DO_NOT_USE_DIRECTLY").getContactTable().greaterThan(["id"], i, { limit: t });
						} while (n.length > 0);
