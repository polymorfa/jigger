__d("WAWebWindowsHybridBridgeDebugFeatures.v2607", [
	"WALogger",
	"WAWebBackendApi",
	...
	var e, s, u = 1e3, c = (function() {
		function t(t) {
			...
			this.$2 = null, this.$3 = null, this.ping = function(t) {
				...
				n.$2 = a, i > 1300 && o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
					...
					o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["WindowsHybridBridgeDebugFeatures:ping:", " no ping received for 10s"])), t);
				}, 1e4);
		...
		var r = t.prototype;
		return r.startHangsMonitor = function() {
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield o("WAWebBackendApi").frontendSendAndReceive("getWebLogs"), n = this.limitStringSize(t, 30 * u);
