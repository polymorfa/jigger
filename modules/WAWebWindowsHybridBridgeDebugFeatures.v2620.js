__d("WAWebWindowsHybridBridgeDebugFeatures.v2620", [
	"WALogger",
	"WAWebAppTracker",
	"WAWebBackendApi",
	"WAWebODS",
	...
	var e, s, u = 1e3, c = (function() {
		...
		var a = t.prototype;
		return a.startHangsMonitor = function() {
			var e = this;
			r("WAWebODS").incr("web.hybrid.bridge.debug.send.start_hangs_monitor"), o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
				bridge: "debugFeatures",
			...
			var e = this;
			r("WAWebODS").incr("web.hybrid.bridge.debug.send.save_native_logs"), o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
				bridge: "debugFeatures",
			...
			var e = this;
			r("WAWebODS").incr("web.hybrid.bridge.debug.send.send_admin_requested_logs"), o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
				bridge: "debugFeatures",
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				var e = this;
				return r("WAWebODS").incr("web.hybrid.bridge.debug.send.request_native_logs"), o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
					bridge: "debugFeatures",
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = this, n = yield o("WAWebBackendApi").frontendSendAndReceive("getWebLogs"), a = this.limitStringSize(n, 30 * u);
				r("WAWebODS").incr("web.hybrid.bridge.debug.send.send_web_log_string"), o("WAWebWindowsHybridBridgeTrace").traceBridgeCall({
					bridge: "debugFeatures",
