__d("WAWebWindowsHybridBridgeMetaConfig.v2631", [
	"WAWebABPropsCache",
	...
	var e = (function() {
		...
		return t.initialize = (function() {
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
				this.$2 || (this.$2 = !0, yield o("WAWebABPropsCache").waitForABPropConfigsReady(), o("WAWebHybridMetaConfigEnabled").isHybridMetaConfigEnabled() && (this.$1.addEventListener("exposureLogged", this.$3), this.$1.subscribe(null), this.$4()));
			});
			function t() {
