__d("WAWebWindowsHybridBridgePictures.v2602", [
	"WAJids",
	"WALogger",
	...
	var e, s, u, c, d = (function() {
				...
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
					...
					for (var a of n) {
						...
						if (o("WAJids").validateGroupJid(a.id.toString())) {
							...
							(l == null ? void 0 : l.eurl) !== a.eurl && r.$1.setProfilePictures(JSON.stringify([{
						...
						if (c == null && u != null && (c = yield o("WAWebProfilePicThumbCollection").ProfilePicThumbCollection.resyncPicturesByWid([u])), ((i = c) == null ? void 0 : i.eurl) !== a.eurl) {
							var d, m;
							r.$1.setProfilePictures(JSON.stringify([{
		...
		var r = t.prototype;
		return r.notifyUpdate = function(t) {
			if (t != null) {
