__d("WAWebWindowsHybridBridgeVoip.v2586", [
	"WABase64",
	"WAWebBackendApi",
	...
	var e = (function() {
		function e(e, t) {
			...
			this.handleVoipReady = function() {
				...
				var t, r = e.peerJid, o = e.callId, a = e.payload, i = e.shouldEncryptBeforeSending;
				(t = n.$3) == null || t.onSignalingXmpp(r, o, a, i);
			}, this.handleCallEvent = function(e) {
				var t, r = e.eventType, o = e.userData, a = e.eventDataJson;
		...
		return t.setHandlers = function(t) {
		...
		}, t.handleIncomingSignalingOffer = function(t, n, r, a, i, l, s, u, c, d) {
		...
		}, t.startGroupCall = function(t, n, r, o, a, i, l, s, u, c, d, m, p, _) {
			var e;
		...
		}, t.joinOngoingCall = function(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g) {
			var e;
		...
		}, t.checkOngoingCalls = function(t, n) {}, t.simulateNativeAnr = function(t, n) {
			var e;
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield this.$1.getDeviceCountAsync(e), n = t.error, r = t.deviceCount;
				return {
					error: n,
					deviceCount: r
				};
