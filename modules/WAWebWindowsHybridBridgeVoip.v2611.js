__d("WAWebWindowsHybridBridgeVoip.v2611", [
	"WABase64",
	"WALogger",
	"WAWebBackendApi",
	...
	var e, s = (function() {
		function t(t, n) {
			...
			this.handleVoipReady = function() {
				...
				var n, a = t.callId, i = t.payload, l = t.peerJid, s = t.shouldEncryptBeforeSending, u = function(t) {
				...
				o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose([
					...
					" encrypt=",
					""
				])), u(l), a, s), (n = r.$3) == null || n.onSignalingXmpp(l, a, i, s);
			}, this.handleCallEvent = function(e) {
				var t, n = e.eventDataJson, o = e.eventType, a = e.userData;
				...
				var t, n = e.isVideoCall, o = e.peerJid;
				...
				var t;
				(t = r.$3) == null || t.onRequestJoinCall == null || t.onRequestJoinCall(String(e));
		...
		var r = t.prototype;
		return r.setHandlers = function(t) {
			this.$3 = t;
		}, r.cleanup = function() {
		...
		}, r.handleIncomingSignalingOffer = function(t, n, r, a, i, l, s, u, c, d) {
		...
		}, r.handleIncomingSignalingMessage = function(t, n, r, a, i, l, s, u) {
		...
		}, r.startGroupCall = function(t, n, r, o, a, i, l, s, u, c, d, m, p, _) {
			var e;
		...
		}, r.joinOngoingCall = function(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h) {
			var e;
			(e = this.$1) == null || e.joinOngoingCall(t, n, r, o, a, i, l, s, u, c, d, m, p, _, f, g, h != null ? h : !1);
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield this.$1.requestObtainDevicePermissionAsync(e), n = t.error, r = t.permissionGranted;
				return {
					error: n,
					permissionGranted: r
				};
			...
			var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
				var t = yield this.$1.getDeviceCountAsync(e), n = t.deviceCount, r = t.error;
				return {
					error: r,
					deviceCount: n
				};
