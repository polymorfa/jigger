__d("WAWebWindowsLanguageDropdownButton.react", [
	...
	function L() {
		var e = o("react-compiler-runtime").c(7), t = h(!1), n = t[0], r = t[1], a;
		e[0] === Symbol.for("react.memo_cache_sentinel") ? (a = async function(t) {
			await S(t), r(!0);
		}, e[0] = a) : a = e[0];
		var i = a, l;
		e[1] === Symbol.for("react.memo_cache_sentinel") ? (l = m.jsx(k, {
			disabled: !0,
			spinner: !0,
			children: s._(
				/*BTDS*/
		...
		var u = l, c;
		e[2] === Symbol.for("react.memo_cache_sentinel") ? (c = m.jsx(k, {
			disabled: !0,
			children: s._(
				/*BTDS*/
				""
		...
		var d = c, p;
		e[3] === Symbol.for("react.memo_cache_sentinel") ? (p = o("WAWebLanguageDropdownUtils").getLanguageDropdownItems(), e[3] = p) : p = e[3];
		var f = p, g;
		e[4] === Symbol.for("react.memo_cache_sentinel") ? (g = { className: "x1yrsyyn x78zum5 xdt5ytf" }, e[4] = g) : g = e[4];
		var y;
		return e[5] !== n ? (y = m.jsx("div", babelHelpers.extends({}, g, { children: n ? m.jsx(k, {
			disabled: !0,
			spinner: !0,
			children: s._(
				/*BTDS*/
			...
			children: m.jsx(_, {
				fallback: u,
				children: m.jsx(E, {
					handleLocaleChange: i,
					languageDropdownItemsPromise: f
				})
			})
		}) })), e[5] = n, e[6] = y) : y = e[6], y;
	}
