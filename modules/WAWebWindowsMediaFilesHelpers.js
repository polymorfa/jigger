__d("WAWebWindowsMediaFilesHelpers", [
	...
	function H() {
		return H = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t, a) {
			var i;
			...
			try {
				o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["[openMediaFile] Ensuring media file is saved for msg ", ""])), t.id.toString()), yield j(t), o("WALogger").LOG(d || (d = babelHelpers.taggedTemplateLiteralLoose(["[openMediaFile] opening cached file for msg ", ""])), t.id.toString()), a == null || a(t);
	...
	function z() {
		return z = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			var l = i.mediaFileHash, s = i.suggestedFileName, u = yield a.isCachedMediaFileExist(l, s);
		...
		return K = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			var _ = (function() {
				var r = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					...
					var r = null;
					yield o("WAWebFileSaver").FileSaver.downloadAsync(e, (function() {
					...
					var a = r;
					a != null && a !== "" && (o("WALogger").LOG(S || (S = babelHelpers.taggedTemplateLiteralLoose(["[saveMediaFile] waiting for download for msg ", ""])), e.id.toString()), yield i.waitTillMediaDownloadCompletes(a, m, d), o("WALogger").LOG(R || (R = babelHelpers.taggedTemplateLiteralLoose(["[saveMediaFile] Media download completed for msg ", ""])), e.id.toString()));
				});
				return function() {
			...
			var T = (function() {
				var r = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					var n = yield o("WAWebFileSaverDownloadData").getMsgDownloadData(e, t), r = n.blob;
					if (r.size > B) return "oversize";
					var a = q(), l = yield i.requestSharedBufferForMediaFile == null ? void 0 : i.requestSharedBufferForMediaFile(a, r.size);
					if (l == null) return "unsupported";
					yield Q(l, r);
					var s = yield i.saveMediaFileFromSharedBuffer == null ? void 0 : i.saveMediaFileFromSharedBuffer(a, d, m);
					if (s !== !0) {
				...
				var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					try {
						e: {
							var t = yield T();
							if (t === "oversize") {
								r("WAWebODS").incr("web.hybrid.bridge.media_files.open_with.oversize_routed_post_fetch"), yield _();
								break e;
							}
							if (t === "unsupported") {
								r("WAWebODS").incr("web.hybrid.bridge.media_files.open_with.unsupported_routed"), yield _();
								break e;
							}
							if (t === "ok") {
			...
			if (!p) {
				...
				x && $ ? yield D() : (x && r("WAWebODS").incr("web.hybrid.bridge.media_files.open_with.oversize_routed_pre_fetch"), yield _());
			}
	...
	function X() {
		return X = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
			...
			try {
				for (var u = babelHelpers.asyncIterator(o("WAStreamAsyncIterator").streamAsyncIterator(t.stream())), c; i = !(c = yield u.next()).done; i = !1) {
					var d = c.value;
	...
	function Z() {
		return Z = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			yield o("WAWebFileSaver").FileSaver.downloadAsync(e, (function() {
				var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
					yield a.prepareForZipArchiveSavingAndUnarchiveToFolder(e, l, t, n);
				});
				return function(t, n, r) {
					return e.apply(this, arguments);
				};
	...
	function ne() {
		return ne = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
			...
			o("WALogger").LOG(M || (M = babelHelpers.taggedTemplateLiteralLoose(["[copyMediaFile] Ensuring media file is saved for msg ", ""])), e.id.toString()), yield j(e), o("WALogger").LOG(w || (w = babelHelpers.taggedTemplateLiteralLoose(["[copyMediaFile] copying cached file for msg ", ""])), e.id.toString());
	...
	l.getMediaFileInfo = U, l.openMediaFile = V, l.isMediaFileSaved = G, l.saveMediaFile = j, l.copyBlobIntoSharedBuffer = Q, l.supportsBulkMediaSaving = Y, l.selectFolderAndSaveFiles = J, l.supportsMediaFileCopy = ee, l.copyMediaFile = te;
}), 98);
