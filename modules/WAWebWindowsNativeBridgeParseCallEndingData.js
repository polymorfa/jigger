__d("WAWebWindowsNativeBridgeParseCallEndingData", [
	"WATimeUtils",
	...
	"use strict";
	function e(e) {
		var t, n, a, i = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(e);
		if (i == null) throw r("err")("Invalid call ending data");
		return babelHelpers.extends({}, i, {
			peerJid: o("WAWebWidFactory").createWid(i.peerJid),
			fromMe: i.fromMe,
			groupJid: i.groupJid ? o("WAWebWidFactory").createWid(i.groupJid) : null,
			callId: i.callId,
			...
			connectTime: i.connectTime != null ? Math.floor(i.connectTime / 1e3) : null,
			endTime: o("WATimeUtils").castToUnixTime(i.endTime),
			result: o("WAWebVoipWaCallEnums").convertCallResultToCallLogResult(i.result),
			...
			callCreatorJid: r("isStringNullOrEmpty")(i.callCreatorJid) ? null : o("WAWebWidFactory").createWid(i.callCreatorJid),
			initialPeerJid: r("isStringNullOrEmpty")(i.initialPeerJid) ? null : o("WAWebWidFactory").createWid(i.initialPeerJid),
			timeSeriesPath: i.timeSeriesPath,
			userRatingInterval: -1,
			terminatedByDeviceSwitch: (t = i.terminatedByDeviceSwitch) != null ? t : !1,
