__d("WAWebWindowsNativeBridgeParseCallStateChangedData", [
	...
	"use strict";
	function e(e) {
		var t, n, a, i, l, s, u, c, d, m, p, _, f, g, h, y, C, b, v, S, R, L = o("WAWebVoipJsonParserNative").parseJsonFromNativeBridge(e);
		if (L == null) throw r("err")("Invalid call ending data");
		var E = r("nullthrows")(o("WAWebVoipWaCallEnums").CallState.cast(L.CallState)), k = o("WAWebWidFactory").createWid(L.CreatorJid.str), I = o("WAWebWidFactory").createWid(L.PeerJid), T = r("isStringNullOrEmpty")(L.GroupJid) ? null : o("WAWebWidFactory").createWid(L.GroupJid), D = L.Participants ? L.Participants.map(function(e) {
			var t, n;
			return {
				jid: o("WAWebWidFactory").createWid(e.Jid),
				state: r("nullthrows")(o("WAWebVoipWaCallEnums").CallParticipantState.cast(e.State)),
				videoState: (t = e.VideoState) != null ? t : o("WAWebVoipWaCallEnums").VideoState.Disabled,
		...
		return {
			...
			call_info: {
				...
				creatorJid: o("WAWebWidFactory").createUserWidOrThrow(k.user, k.server),
				creatorDeviceJid: k,
				...
				callResult: (l = o("WAWebVoipWaCallEnums").CallResult.cast(L.CallResult)) != null ? l : o("WAWebVoipWaCallEnums").CallResult.Undefined,
				...
				initialGroupTransactionId: (p = L.InitialGroupTransactionId) != null ? p : 0,
				connectedLimit: (_ = L.ConnectedLimit) != null ? _ : 0,
				participantCount: D.length,
				participants: D,
				canInviteNewParticipant: (f = L.CanInviteNewParticipant) != null ? f : !1,
				...
				scheduledId: r("isStringNullOrEmpty")(L.ScheduledId) ? null : L.ScheduledId,
				...
				waitingRoomUsers: ((R = L.WaitingRoomUsers) != null ? R : []).map(function(e) {
