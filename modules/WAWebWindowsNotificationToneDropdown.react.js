__d("WAWebWindowsNotificationToneDropdown.react", [
	"WALogger",
	"WAWebButton.react",
	...
	function m(t) {
		var n, a, i = t.initialTone, l = t.onToneSelect, s = t.overrideDefaultTone, m = t.title, p = u.createRef(), _ = c(i != null ? i : o("WAWebWindowsNotificationToneOption").NotificationToneOption.Default), f = _[0], g = _[1], h = c(f), y = h[0], C = h[1], b = (n = (a = o("WAWebWindowsNotificationToneOptions").NotificationToneOptions.find(function(e) {
			return e.value === f;
		})) == null ? void 0 : a.label()) != null ? n : "", v = function(n, r) {
			if (o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["[notification] playing tone ", ""])), r), n.stopPropagation(), s != null && r === o("WAWebWindowsNotificationToneOption").NotificationToneOption.Default) {
				o("WAWebWindowsNotificationHelpers").playTone(s);
				return;
			}
			o("WAWebWindowsNotificationHelpers").playTone(r);
		}, S = o("WAWebWindowsNotificationToneOptions").NotificationToneOptions.reduce(function(e, t) {
			return e.push(u.jsx(o("WAWebMenuItems.react").SelectMenuItem, {
				...
				detailLeft: f === t.value ? u.jsx(r("WDSIconIcCheck.react"), {
				...
				primaryRight: t.value !== o("WAWebWindowsNotificationToneOption").NotificationToneOption.None && y === t.value ? u.jsx(r("WAWebIconButton.react"), {
					xstyle: d.playButton,
					onClick: function(n) {
						return v(n, t.value);
					},
					icon: u.jsx(r("WDSIconIcPlayArrowFilled.react"), {
						height: 24,
						width: 24
					})
				}) : null
			...
			var e = o("WAWebWindowsNotificationToneOption").NotificationToneOption.cast(Number(t));
			e != null && e !== f && (l(e), g(e));
		};
		return u.jsxs("div", {
				...
				u.jsx(o("WAWebButton.react").WAWebButtonSecondary, {
					...
					children: u.jsxs(o("WAWebFlex.react").FlexRow, {
						...
						children: [
							...
							u.jsx(o("WAWebIcChevronDownMenuIcon.react").IcChevronDownMenuIcon, { iconXstyle: d.chevronIcon })
						]
					})
				}),
