__d("WAWebWindowsTaskbarNotificationSettingsDrawer.react", [
	...
	function d(e) {
		...
		var l;
		t[1] === Symbol.for("react.memo_cache_sentinel") ? (l = o("WAWebWindowsTaskbarNotificationSettingsHelpers").taskbarNotificationSettingsTitle(), t[1] = l) : l = t[1];
		var u;
	...
	function m() {
		...
		if (e[0] === Symbol.for("react.memo_cache_sentinel")) {
			var n;
			t = (n = o("WAWebWindowsUserPrefsNotifications").getTaskbarNotificationSetting()) != null ? n : o("WAWebWindowsTaskbarNotificationOption").TaskbarNotificationOption.Always, e[0] = t;
		} else t = e[0];
		var a = u(t), i = a[0], l = a[1], d;
		e[1] !== i ? (d = function(t) {
			i !== t && (l(t), o("WAWebWindowsTaskbarController").WATaskbarController.ChangeTaskbarNotificationSetting(t), o("WAWebSettingsSyncBridge").sendSettingChange("unreadCounterBadgeDisplayMode", o("WAWebWindowsTaskbarNotificationOption").toDisplayMode(t)));
		}, e[1] = i, e[2] = d) : d = e[2];
		var m = d, p;
		e[3] === Symbol.for("react.memo_cache_sentinel") ? (p = [o("WDSPaddings.stylex").wdsPaddings.paddingHor0], e[3] = p) : p = e[3];
		var _ = i, f;
		e[4] !== m ? (f = o("WAWebWindowsTaskbarNotificationSettingOptions").TaskbarNotificationSettingOptions.map(function(e) {
			...
			return {
				...
				onChange: function(t) {
					var e;
					return m((e = o("WAWebWindowsTaskbarNotificationOption").TaskbarNotificationOption.cast(t)) != null ? e : o("WAWebWindowsTaskbarNotificationOption").TaskbarNotificationOption.Always);
				},
				xstyle: c.paddingBlock10
			};
		}), e[4] = m, e[5] = f) : f = e[5];
		var g;
		return e[6] !== _ || e[7] !== f ? (g = s.jsx(r("WAWebDrawerSection.react"), {
			animation: !1,
			titleXStyle: p,
