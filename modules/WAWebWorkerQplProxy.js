__d("WAWebWorkerQplProxy", ["nullthrows"], (function(t, n, r, o, a, i, l) {
	"use strict";
	var e = null;
	function s(t) {
		e = t;
	...
	function u(t) {
		var n = r("nullthrows")(e, "WAWebWorkerQplProxy: bridge not initialized"), o = t.instanceKey, a = t.markerId, i = !1;
		return {
			addAnnotations: function(t) {
				i || n.fireAndForget("qpl", "dispatch", {
					type: "addAnnotations",
					markerId: a,
					instanceKey: o,
					annotations: t
			...
			endSuccess: function(t) {
				i || (i = !0, n.fireAndForget("qpl", "dispatch", {
					type: "endSuccess",
					markerId: a,
					instanceKey: o,
