__d("WAWebWrapperMessageActionButtonsRow", [
	"WAWebFlex.react",
	"WAWebFlexItem.react",
	"react"
	...
	function c(e) {
		var t = e.hasReaction, n = e.isMsgGallery, a = e.isOutgoingMsg, i = e.messageActionButtons, l = e.positionLeft, c = e.positionRight, d = e.transparentGaps, m = d === void 0 ? !1 : d, p = (a ? i.reverse() : i).map(function(e, t) {
			return e && !n ? s.jsx(r("WAWebFlexItem.react"), {
				xstyle: [u.buttonWrapper, m && u.interactiveButton],
				children: e
			}, t) : e;
		}), _ = "end";
		return !n && !a && (_ = "start"), s.jsx(o("WAWebFlex.react").FlexRow, {
			justify: _,
			align: "center",
			className: {
