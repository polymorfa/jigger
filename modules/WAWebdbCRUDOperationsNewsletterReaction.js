__d("WAWebdbCRUDOperationsNewsletterReaction", [
	...
	function e(e) {
		...
		}), o("WAWebModelStorageUtils").getStorage().lock(["newsletter-reactions"], (function() {
	...
	function s(e) {
		return o("WAWebModelStorageUtils").getStorage().lock(["newsletter-reactions"], (function() {
			var t = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
				var n = t[0], r = e.parentMsgKey, o = yield d(r);
