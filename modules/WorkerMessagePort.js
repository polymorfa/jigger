__d("WorkerMessagePort", [
	...
	var _ = (function() {
		function e(e, t) {
			var n = this;
			this.$1 = {}, this.onUnhandledMessage = new d(), this.onMessage = new d(), this.onPostMessage = new d(), this.onError = new d(), this.$2 = e, this.name = t, this.$2.addEventListener("message", function(e) {
				...
				var t = p(e);
				if (t != null) {
					var a = t.sendDateTime, i = t.sendTimestamp, l = (u || (u = r("performanceAbsoluteNow")))(), s = Date.now();
					t.receiveTimestamp = l, t.receiveDateTime = s, t.sendDelayHighPrecision = l - i, t.sendDelayLowPrecision = s - a, o("WorkerMessagePortLogging").logMessageTiming(n.name, t);
				}
			});
		}
		var t = e.prototype;
		return t.onMessageHandler = function(t) {
			try {
			...
			this.onPostMessage.call(t), n ? this.$2.postMessage(t, n) : this.$2.postMessage(t);
			...
			return this.$2 instanceof o("VirtualMessageChannel").VirtualMessagePort;
		}, e;
	})();
	function f(e) {
		return e;
	...
	var g = (function(t) {
		function a(a, i) {
			...
			var u = l, d = new (r("Deferred"))(), m = d.getPromise();
			...
			return (e || (e = o("PromiseAnnotate"))).setDisplayName(m, "endpoint_started"), e.setDisplayName(_, "endpoint_started_received"), u.postMessage({
				endpoint: l.name,
				...
				var t = p(e);
				t != null && o("WorkerMessagePortLogging").logMessageTiming(l.name, t, !0);
			}), l.fullyConnected = (s || (s = n("Promise"))).race([m, _]).then(function() {
				return l;
			}), l;
		}
		return babelHelpers.inheritsLoose(a, t), a;
	})(_);
	l.getMessageTiming = p, l.WorkerMessagePort = _, l.CastWorkerMessagePort = f, l.WorkerSyncedMessagePort = g;
}), 98);
