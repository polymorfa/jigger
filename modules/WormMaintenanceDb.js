__d("WormMaintenanceDb", [
	...
	function d() {
		return d = n("asyncToGeneratorRuntime").asyncToGenerator(function* (t) {
			...
			try {
				var m = o("WormMaintenanceSchema").makeWormMaintenanceSchema(i, d, a, l, function(t) {
	...
	function m() {
		if (s == null) throw r("err")("WormMaintenanceDb is not initialized");
		return s;
	}
	l.makeWormMaintenanceDb = c, l.getWormMaintenanceDb = m;
}), 98);
