__d("fb-error", ["performanceNow", "removeFromArray"], (function(t, n, r, o, a, i) {
	...
	var u = !1, c = { errorListener: function(n) {
		var e = t.console, r = e[n.type] ? n.type : "error";
	...
	var f = { access_token: null }, g = 6, h = 6e4, y = 10 * h, C = new Map(), b = 0;
	function v() {
	...
	var k = typeof window == "undefined" ? "<self.onerror>" : "<window.onerror>", I;
	function T(e) {
	...
	var D = { setup: function(n) {
		...
		findDeferredSource: function() {
			for (var e of x) if (e.deferredSource != null) return e.deferredSource;
		}
	};
	function P(e) {
	...
	function A(e, t) {
		...
		if (!Object.isFrozen(e)) {
			...
			var l = (n = e.messageFormat) !== null && n !== void 0 ? n : e.message, s = (r = e.messageParams) !== null && r !== void 0 ? r : [];
			...
			var c = t.forcedKey, d = e.forcedKey, m = c != null && d != null ? c + "_" + d : c != null ? c : d;
			e.forcedKey = m;
		}
	}
	function F(e) {
	...
	function O(e, t) {
		var n = 0, r = String(e), o = r.replace(/%s/g, function() {
	...
	function K() {
		...
		for (var o of n) if (o != null) for (var a = o.length, i = 0; i < a; i++) e = (e << 5) - e + o.charCodeAt(i);
	...
	function Y(e) {
		var t = e.message, n = e.name, r = e.stack;
		...
		if (t != null && t !== "") {
			var i = ": " + t + "\n", l = r.indexOf(i), s = r.substring(0, l);
			if (/^\w+$/.test(s)) return r.substring(l + i.length);
		}
		return r.replace(X, "");
	}
	function J(e) {
		var t = e.trim(), n = t, r, o, a;
	...
	function ne(e) {
		var t = e.column, n = e.identifier, r = e.line, o = e.script, a = "    at " + (n != null ? n : "<unknown>");
		return o != null && r != null && t != null && (a += " (" + o + ":" + r + ":" + t + ")"), a;
	}
	function re(r) {
		var o, a, i, s, u, c, d, m, p, _, f = ee(r), g = (o = r.taalOpcodes) !== null && o !== void 0 ? o : [], h = r.framesToPop;
		if (h != null) for (var y = Math.min(h, f.length), C = 0; C < y; C++) g.unshift(l.PREVIOUS_FRAME);
		var b = (a = r.messageFormat) !== null && a !== void 0 ? a : r.message, v = ((i = r.messageParams) !== null && i !== void 0 ? i : []).map(function(e) {
			return String(e);
		}), S = te(r.componentStack), R = S == null ? null : S.map(J), L = r.metadata ? r.metadata.format() : new M().format();
		L.length === 0 && (L = void 0);
		var E = f.map(function(e) {
			return e.text;
		}).join("\n"), k = (s = r.errorName) !== null && s !== void 0 ? s : r.name, I = P(r), T = r.loggingSource, D = r.project, x = (u = r.lineNumber) !== null && u !== void 0 ? u : r.line, $ = (c = r.columnNumber) !== null && c !== void 0 ? c : r.column, N = (d = r.fileName) !== null && d !== void 0 ? d : r.sourceURL, w = f.length > 0;
		w && x == null && (x = f[0].line), w && $ == null && ($ = f[0].column), w && N == null && (N = f[0].script);
		var A = {
		...
		r.forcedKey != null && (A.forcedKey = r.forcedKey), g.length > 0 && (A.taalOpcodes = g);
		var F = t.location;
	...
	}, ie = "<global.react>", le = [], se = [], ue = 50, ce = !1, de = {
		history: se,
	...
	var me = "<anonymous guard>", pe = !1, _e = {
		applyWithGuard: function(t, n, r, o) {
			...
			try {
				...
				try {
					var e, a = o != null ? o : babelHelpers.extends({}, null), i = a.deferredSource, l = a.onError, s = a.onNormalizedError, u = E(n), c = {
						deferredSource: i,
					...
					u == null && t && (d.extra[t.toString().substring(0, 100)] = "function", r != null && r.length && (d.extra[Array.from(r).toString().substring(0, 100)] = "args")), d.guardList = $.cloneGuardList(), l && l(u), s && s(d), de.reportNormalizedError(d);
				} catch (e) {}
			} finally {
				$.popGuard();
			}
	...
	function Re(e, t) {
		var n, r, o, a, i = {
			...
			additional_client_revisions: Array.from((a = t.additional_client_revisions) !== null && a !== void 0 ? a : []).map(ye),
			...
			xFBDebug: e.xFBDebug,
			tags: e.tags
		}, l = e.blameModule, s = e.deferredSource;
		return l != null && (i.blameModule = String(l)), s && s.stackFrames && (i.deferredSource = { stackFrames: ve(s.stackFrames) }), e.metadata && (i.metadata = e.metadata), e.loadingUrls && (i.loadingUrls = e.loadingUrls), e.serverHash != null && (i.serverHash = e.serverHash), e.windowLocationURL != null && (i.windowLocationURL = e.windowLocationURL), e.loggingSource != null && (i.loggingSource = e.loggingSource), i;
	}
	function Le(e, t, n) {
		var r;
		if (he++, t.sample_weight === 0) return !1;
		var o = R.shouldLog(e);
		if (o == null || (r = t.projectBlocklist) !== null && r !== void 0 && r.includes(e.project)) return !1;
		var a = Re(e, t);
		return Object.assign(a, {
			ancestors: ge.slice(),
			clientWeight: ye(o),
			page_position: ye(he)
		}), ge.length < 15 && ["fatal", "error"].includes(e.type) && ge.push(e.hash), n(a), !0;
	}
	var Ee = {
	...
	function Te(e) {
		if (ke != null) {
			var t = ke, n = e.reason, r, o = E(n), a = null;
			if (n !== o && typeof n == "object" && n !== null) {
				if (r = Object.keys(n).sort().slice(0, 3), typeof n.message != "string" && typeof n.messageFormat == "string" && (n.message = n.messageFormat, o = E(n)), typeof n.message != "string" && typeof n.errorMsg == "string") if (/^\s*\<!doctype/i.test(n.errorMsg)) {
	...
	var xe = {
		...
		return t.$1 = function(n, r) {
			...
			if (!s.isEmpty()) if (d.metadata == null) d.metadata = s.format();
			else {
				var f = d.metadata.concat(s.format()), g = new Set(f);
			...
			return d.tags = Array.from(this.loggerTags), de.reportNormalizedError(d), c;
		}, t.fatal = function(t) {
			...
			var t = n.concat(Array.from(this.loggerTags)), r = new e(this.project, t);
			...
			var e = this.loggerTags.size > 0 ? "[" + Array.from(this.loggerTags).join("|") + "] " : "";
			return e;
		}, e;
	})(), Me = function(t, n) {
		var e = new Ne(t);
