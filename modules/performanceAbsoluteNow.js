__d("performanceAbsoluteNow", ["performance", "performanceAbsoluteNowOnAdjust"], (function(t, n, r, o, a, i, l) {
	...
	var c = 0, d = -1, m = typeof (e || (e = r("performance"))) == "object", p = m && typeof (e || (e = r("performance"))).now == "function";
	...
	C.setFallback = y.setFallback, C.fromRelativeTime = y.fromRelativeTime, C.__adjust = y.__adjust, C.adjusted = y.adjusted, l.default = C;
}), 98);
