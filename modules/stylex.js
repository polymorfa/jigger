__d("stylex", [
	...
	"use strict";
	var e, s;
	!r("gkx")("21107") && !(s || (s = r("ExecutionEnvironment"))).isInWorker && o("CometStyleXSheet").rootStyleSheet.injectTheme();
	function u(e) {
		for (var t = e.reverse(), n = {}; t.length;) {
			...
			var a = r;
			if (a != null && typeof a == "object") for (var i in a) {
				var l = a[i];
