__d("useWAWebBizAdManagementOpenAdPaymentModal", [
	"fbt",
	...
	function d(e) {
		var t = o("react-compiler-runtime").c(2), n = _, a = p, i;
		t[0] !== e ? (i = function() {
			o("WAWebModalManager").ModalManager.open(u.jsx(r("WAWebBizAdManagementAdPaymentModal.react"), {
				onClose: m,
				onError: a,
				onSuccess: n,
				relayEnvironment: e
