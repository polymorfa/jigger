__d("useWAWebCommentMessages", [
	...
	function d(e) {
		var t = o("useWAWebAggregatedMultiple").useAggregatedMultiple(o("WAWebCommentCollection").CommentCollection.byParent, c(function() {
			return e;
		}, []));
		return u(function() {
