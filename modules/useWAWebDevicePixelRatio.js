__d("useWAWebDevicePixelRatio", [
	...
	function d() {
		var e = o("react-compiler-runtime").c(2), t = c(m), n = t[0], r = t[1], a, i;
	...
	var p = r("once")(function() {
		...
		return t.subscribe = function(t) {
			var e = this;
			if (this.$1.has(t)) throw r("err")("Callback can only be added once.");
			return this.$1.add(t), this.$3(), function() {
				e.$1.delete(t), e.$3();
			};
		}, t.getValue = function() {
			var e;
			...
			if (this.$2 == null) {
				var n = matchMedia("(resolution: " + this.getValue() + "dppx)"), r = function() {
					e.$2 == null || e.$2();
					var t = e.getValue();
				...
				n.addListener(r), this.$2 = function() {
