__d("useWAWebLinkPreview", [
	...
	var e, s, u, c, d, m = d || (d = o("react")), p = m.useEffect, _ = m.useState;
	function f(e) {
		var t = o("WAWebCodeFormatMutator").removeCodeBlocks(e), n = o("WAWebLinkify").findLinks(t, !0)[0];
		if (n) return n;
	}
	function g(e, t, n) {
	...
	function h() {
		return h = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t, n) {
			if (e.thumbnailDirectPath != null) return o("WALogger").LOG(s || (s = babelHelpers.taggedTemplateLiteralLoose(["link preview: use cached mms details (useLinkPreview)"]))), {
				mediaKey: e.mediaKey,
			...
			o("WALogger").LOG(u || (u = babelHelpers.taggedTemplateLiteralLoose(["link preview: upload to mms"])));
			try {
				if (e.thumbnailHQ == null) return null;
				var a = yield r("WAPromiseRaceAbort")(r("WAWebMediaOpaqueData").createFromBase64Jpeg(e.thumbnailHQ), t), i = yield r("WAWebMediaUploadMmsThumbnail")({
					thumbnail: a,
				...
				o("WALogger").LOG(c || (c = babelHelpers.taggedTemplateLiteralLoose(["useLinkPreview.uploadHQPreview: error"])));
			}
		}), h.apply(this, arguments);
	}
	function y(t, a) {
		var i = _(null), l = i[0], s = i[1], u = function() {
			s(null);
		};
		return p(function() {
			if (u(), !!t) {
				var i = new AbortController(), l = i.signal;
				return n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
					try {
						var n = yield r("WAPromiseRaceAbort")(o("WAWebLinkPreviewChatAction").getLinkPreview(t, a), l), i = n == null ? void 0 : n.data;
						...
						o("WALogger").LOG(e || (e = babelHelpers.taggedTemplateLiteralLoose(["useLinkPreview: error"])));
					}
				})(), function() {
