export enum CHATFILTERACTIONTYPES {
  OPEN = 1,
  SELECT_FILTER = 2,
  ...
  AI_HOME_BOUNCE_250_MS = 203,
  AI_HOME_BOUNCE_750_MS = 205,
  AI_HOME_BOUNCE_1000_MS = 206,
  AI_HOME_BOUNCE_2000_MS = 207,
  AI_HOME_BOUNCE_3000_MS = 208,
  AI_HOME_BOUNCE_5000_MS = 209,
