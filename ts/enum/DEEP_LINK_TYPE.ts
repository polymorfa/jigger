export enum DEEPLINKTYPE {
  ...
  DEEP_LINK_SETTINGS_ACCOUNT_2_FA = 67,
  ...
  DEEP_LINK_PAYMENT_UPI_SET_2_FA = 127,
  ...
  DEEP_LINK_3_P_OAUTH_ACCOUNT_LINKING_BLOKS_REDIRECT = 214,
  DEEP_LINK_3_P_OAUTH_ACCOUNT_LINKING_NATIVE_REDIRECT = 215,
